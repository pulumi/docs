// /resources/ overview filter: narrows the directory to a single labeled section
...
//
// DOM contract (rendered by layouts/resources/list.html):
//   [data-resources-filter]                    the filter bar
//   [data-resources-filter] [data-section]     a pill ("" = All), .is-active
//   section[data-section]                    one section, matched by id

document.addEventListener("DOMContentLoaded", () => {
    const filterBar = document.querySelector<HTMLElement>("[data-resources-filter]");
    if (!filterBar) {
        return;
    }
