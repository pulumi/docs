                ...
                <div class="content">
                    <div class="inputs">
                            ...
                            <div class="details">
                                ...
                                <div class="input">
                                    <input
                                        ...
                                        type="number"
                                        min="0"
                                        onInput={event => this.updateResourceCount(event as any)}
                        ...
                        <div class="field">
                            ...
                            <div class="details">
                                <div class="description">
                                    If you have resources that are being spun up and down throughout the day, estimate the percentage of the time the total resource count will be
                                    reached.
                                </div>
                                <div class="utilization">
                                    <div class="input">
                                        <input type="number" min="1" max="100" onInput={event => this.updateUtilization(event as any)} value={this.utilization}></input>
                                    ...
                                    <input
                                        ...
                                        max="100"
                                        step="1"
                                        onInput={event => this.updateUtilization(event as any)}
                        ...
                        <div class={this.deploymentsExpanded ? "deployments" : "deployments collapsed"}>
                            <div class="default">
                                ...
                                <button onClick={() => this.updateDeploymentsExpanded()}>
                                    <i class={this.deploymentsExpanded ? "fas fa-minus" : "fas fa-plus"}></i>
                                </button>
                            </div>
                            ...
                            <div class={this.deploymentsExpanded ? "field visible" : "field"}>
                                ...
                                <div class="details">
                                    <div class="description">
                                        Deployment minutes refer to the duration of time elapsed when running deployments on Pulumi’s compute. Use your current update times and add
                                        buffer for any workflows that need to happen.
                                    </div>
                                    <div class="input">
                    ...
                    <div class="outputs">
                        ...
                        <div class="contents">
                            <div class="duration">
                                <button class={this.duration === "day" ? "active" : null} onClick={() => this.updateDuration("day")}>
                                    Per day
                                </button>
                                <button class={this.duration === "month" ? "active" : null} onClick={() => this.updateDuration("month")}>
                                    Per month
                                </button>
                            </div>
                            <div class="items">
                                <div class="item">
                                    <span>Estimated credits per {this.duration}</span>
                                    <span>{this.formatNumber(this.getEstimatedCredits())}</span>
                                </div>
                                <div class="item">
                                    <span>Free credits included</span>
                                    <span>{this.formatNumber(this.getFreeCredits())}</span>
                                </div>
                                <div class="item">
                                    <span>Cost per credit</span>
                                    <span>${this.getCostPerCredit()}</span>
                                </div>

                                <div class={this.deploymentsExpanded ? "deployment-total visible" : "deployment-total"}>
                                    <div class="subtitle">Deployments</div>
                                    <div class="item">
                                        <span>Estimated deployment minutes per {this.duration}</span>
                                        <span>{this.formatNumber(this.getEstimatedDeploymentMinutes())}</span>
                                    </div>
                                    <div class="item">
                                        <span>Deployment minutes included</span>
                                        <span>{this.formatNumber(this.getFreeDeploymentMinutes())}</span>
                                    </div>
                                    <div class="item">
                                        <span>Cost per deployment minute</span>
                                        <span>${this.getCostPerDeploymentMinute()}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class={this.isTotalOverMax() ? "total over-max" : "total"}>
                                <span class="contact">
                                    <a href="/contact/?form=sales">Contact sales</a>for bulk discounts
                                </span>
