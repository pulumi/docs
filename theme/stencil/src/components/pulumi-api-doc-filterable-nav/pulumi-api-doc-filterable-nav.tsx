...
export class PulumiApiDocFilterableNav {
    ...
    getLoadingState() {
        return (
            <div class="loading">
                <svg class="loading-icon ph-icon ph-icon--regular animate-spin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true" focusable="false">
