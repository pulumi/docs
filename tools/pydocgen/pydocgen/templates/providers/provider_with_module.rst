...
{% if provider.terraform_provider_name is ne "" %}
    ...
    `pulumi/pulumi-{{provider.pulumi_provider_name}} repo 
    <https://github.com/pulumi/pulumi-{{provider.pulumi_provider_name}}/issues>`__; however, if that doesn't turn up 
