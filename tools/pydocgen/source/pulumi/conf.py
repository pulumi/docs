# -*- coding: utf-8 -*-
# Sphinx configuration for the Pulumi (Python) SDK reference docs.
...
html_baseurl = 'https://www.pulumi.com/docs/reference/pkg/python/pulumi/'
templates_path = ['../_shared/templates']
seo_display_name = 'Pulumi SDK'
seo_pypi_name = 'pulumi'
