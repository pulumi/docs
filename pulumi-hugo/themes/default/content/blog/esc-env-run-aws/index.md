...
Now to the fun part! With your environment set up, you can run AWS commands without local configuration. Let’s test this out by listing all of the S3 buckets in our AWS account as shown below:
