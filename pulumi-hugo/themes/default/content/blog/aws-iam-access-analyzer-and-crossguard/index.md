...
To give it a try, [download and install Pulumi](/docs/quickstart/), [grab the code from GitHub](https://gist.github.com/joeduffy/ecb6946d94312f96c22153d659b5dfb4), and [get started with policy as code](/docs/using-pulumi/crossguard/get-started/), all using free open source.
