...
2. [Running a Policy Pack locally](/docs/guides/crossguard/get-started#running-locally) to speed up development and testing of policies. Validate infrastructure before deployment.
...
4. [Apply a Policy Pack](/docs/guides/crossguard/get-started#enforcing-a-policy-pack) across an organization to validate all the infrastructure deployed
