...
[Install Pulumi CLI]({{< ref "/docs/quickstart" >}}) and set up your [AWS credentials]({{< ref "/docs/quickstart/aws" >}}). Initialize a new [Pulumi project]({{< ref "/docs/reference/project" >}}) from available templates. We use `aws-typescript` template here to install all library dependencies.
