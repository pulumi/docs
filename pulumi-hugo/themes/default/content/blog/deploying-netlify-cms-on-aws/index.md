...
`PULUMI_ACCESS_TOKEN` is required for the automatic process and can be generated by selecting "New Access Token" in the [Pulumi Service](https://app.pulumi.com) settings.
