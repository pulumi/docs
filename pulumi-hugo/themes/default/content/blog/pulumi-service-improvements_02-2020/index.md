...
based on stack tags. For example, you can now use filters to rapidly add stacks to [Pulumi teams]({{< relref "/docs/intro/pulumi-service/teams" >}}).
...
The Enterprise Edition supports [role-based access control]({{< relref "/docs/intro/pulumi-service/projects-and-stacks#stack-permissions" >}})
using [teams]({{< relref "/docs/intro/pulumi-service/teams" >}}). But a common problem we've heard from people in large organizations
