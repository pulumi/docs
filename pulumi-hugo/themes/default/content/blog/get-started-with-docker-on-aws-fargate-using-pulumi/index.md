...
> Update: Check out the [Learning Machine Case Study]({{< ref "/content/case-studies/learning-machine.md" >}}) where provisioning went from 3 weeks to 1 hour with Pulumi and AWS.
