...
([Kubernetes]({{< relref "/registry/packages/kubernetes/api-docs" >}}) and
[OpenStack]({{< relref "/registry/packages/openstack/api-docs" >}})), is faster
...
documentation]({{< relref "/registry/packages/kubernetes/api-docs" >}})
...
Check out the [API documentation]({{< relref "/registry/packages/openstack/api-docs" >}})
