...
[LaunchConfiguration]({{< relref "/registry/packages/aws/api-docs/ec2/launchconfiguration" >}}) and
[AutoScalingGroup]({{< relref "/registry/packages/aws/api-docs/autoscaling/group" >}}) for details on how to do so.
