...
| `pluginDownloadURL` | `string`                                   | No       | PluginDownloadURL is the URL to use to acquire the provider plugin binary, if any. See [Authoring & Publishing](/docs/guides/pulumi-packages/how-to-author#publish-your-package) for more details. |
