...
1. Replace the contents of `index.js` with the following:
    ...
    - **Cloud infrastructure**. S3 bucket for videos and still frames. We define a [stack output property](/docs/intro/concepts/stack#outputs) `bucketName`, to easily retrieve this value after the project has been deployed.
