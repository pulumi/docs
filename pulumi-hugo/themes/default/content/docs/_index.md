...
<div class="flex justify-center py-6">
    <a class="btn btn-lg mx-2 my-1" href="{{< relref "/docs/get-started" >}}">Get Started</a>
    <a class="btn btn-secondary btn-lg mx-2 my-1" href="{{< relref "/docs/get-started/install" >}}">Download</a>
</div>
