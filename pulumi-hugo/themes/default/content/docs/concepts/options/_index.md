...
- [deletedWith](/docs/concepts/options/deletedwith/): If set, the providers Delete method will not be called for this resource if the specified resource is being deleted as well.
