...
- **Headings**: Always include a blank line after all headings before content begins
- **Links**: Use standard Markdown links for internal links: `[Text](/path/to/page)`
- **Lists**: Always include a blank line before the first bullet point in any list
...
- **File Endings**: All Markdown files must end with a blank line
