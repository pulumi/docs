...
require (
	github.com/pulumi/pulumi-hugo/themes/default v0.0.0-20220429180456-e3b5624b391f // indirect
	github.com/pulumi/registry/themes/default v0.0.0-20220429170448-a069d9b5abdc // indirect
