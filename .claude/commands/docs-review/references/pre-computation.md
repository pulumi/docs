...
| Readthrough coherence | `readthrough.py` (per-file Sonnet reader) | `.readthrough-findings.json` | Changed `content/**/*.md` — added pages, plus any `content/blog/**` or `content/customers/**` file |
