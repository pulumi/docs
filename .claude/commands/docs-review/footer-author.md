...
<details>
<summary><strong>How to answer</strong> — fix it, disagree with it, or accept it as-is (click for the exact replies)</summary>
...
Full mechanics: [CONTRIBUTING.md §AI-assisted contributions](%%CONTRIBUTING_URL%%).
