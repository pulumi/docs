...
REVIEW_BODY = (
    f"{MARKER}\n"
    "🧹 **Style suggestions** — optional rewrites for advisory style findings "
    "from the pre-merge review. Apply the ones that read better and dismiss "
    "the rest; **Add suggestion to batch** on several, then **Commit "
    "suggestions** to take them in one commit. None of these block the PR.\n\n"
    "---\n"
