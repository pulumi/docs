---
description: Analyze content for search engine and AI discoverability. Use when writing new blog posts, documentation, or learn explainer pages, or when reviewing existing content for SEO and AEO (evaluates titles, meta descriptions, headings, and AEO patterns).
---
...
- `/seo-analyze content/learn/what-is-infrastructure-as-code.md` - Analyze a learn explainer page
