...
# ═══════════════════════════════════════════════════════════════════════════
# 3. PRs — retired. The adjudication queue is `/pr-review` (scripts/review-v3/
#    collect.py → analyze.py → render.py); this section only reports the count.
# ═══════════════════════════════════════════════════════════════════════════

PRS_WITH_PRIORITY="$TMPDIR/prs_with_priority.json"
