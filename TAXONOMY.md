...
3. Marketing also publishes the tutorials at **pulumi.com/dev**, which are occasionally referred to as guides.
...
- **Lives at:** [pulumi.com/dev/tutorials](https://www.pulumi.com/dev/tutorials/) — **not in this repository**; published from pulumi/marketing-web (`apps/www/src/content/tutorials/`) — and `content/docs/*/get-started`
...
- **Lives at:** [pulumi.com/dev/templates](https://www.pulumi.com/dev/templates/) — **not in this repository**; published from pulumi/marketing-web, which syncs the starters from https://github.com/pulumi/templates and authors the architecture-template pages alongside them.
- **Owns:** Marketing
...
| Tutorials | Sequenced hands-on learning | pulumi/marketing-web → `/dev/tutorials/` | Marketing | Docs, Eng/Product | Newcomers, learners |
...
| Templates | Runnable starting points | pulumi/marketing-web → `/dev/templates/` | Marketing | Eng/Product, Community Eng | Practitioners |
