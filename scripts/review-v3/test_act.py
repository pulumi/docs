...
def test_route_team_vs_user_and_defect_comment_carries_footer():
    ...
    try:
        ...
        assert comment.startswith("Routing to @pulumi/docs-guild") and comment.endswith("_Generated by [Claude Code](https://claude.ai/code)_")
        assert "`review:absent`" in comment
    finally:
        env.close()
