...
case ${PULUMI_ACTION} in
    ...
    update)
        ...
        #
        # No trailing slash, deliberately: "/docs/*" misses /docs/ itself, which left
        # each section landing page stale. / and /index.html stay explicit — the root's
        # only glob form is /*, which would sweep the fingerprinted assets.
