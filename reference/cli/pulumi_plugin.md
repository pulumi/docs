...
* [pulumi plugin install](pulumi_plugin_install.md)	 - Install one or more plugins
* [pulumi plugin ls](pulumi_plugin_ls.md)	 - List plugins
* [pulumi plugin rm](pulumi_plugin_rm.md)	 - Remove one or more plugins from the download cache
