...
```
  ...
  -r, --refresh                   Refresh the state of the stack's resources before this update
      --secrets-provider string   The name of the provider that should be used to encrypt and decrypt secrets. Only used when creating a new stack from an existing template.
