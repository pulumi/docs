...
<a href="../index.html">@pulumi/cloudflare</a> &gt; config
...
* <a href="#apiClientLogging">let apiClientLogging</a>
* <a href="#email">let email</a>
* <a href="#maxBackoff">let maxBackoff</a>
* <a href="#minBackoff">let minBackoff</a>
* <a href="#orgId">let orgId</a>
* <a href="#retries">let retries</a>
* <a href="#rps">let rps</a>
* <a href="#token">let token</a>
* <a href="#useOrgFromZone">let useOrgFromZone</a>
...
<a class="pdoc-member-name" href="/config/vars.ts#L12">let <b>apiClientLogging</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L16">let <b>email</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
<pre class="highlight"><span class='kd'>let</span> email: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span> = <span class='s2'> utilities.requireWithDefault(() =&gt; __config.require(&#34;email&#34;), utilities.getEnv(&#34;CLOUDFLARE_EMAIL&#34;))</span>;</pre>

A registered Cloudflare email address.

</div>
<h2 class="pdoc-module-header" id="maxBackoff">
<a class="pdoc-member-name" href="/config/vars.ts#L20">let <b>maxBackoff</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L24">let <b>minBackoff</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L28">let <b>orgId</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L32">let <b>retries</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L36">let <b>rps</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
...
<a class="pdoc-member-name" href="/config/vars.ts#L40">let <b>token</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
<pre class="highlight"><span class='kd'>let</span> token: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span> = <span class='s2'> utilities.requireWithDefault(() =&gt; __config.require(&#34;token&#34;), utilities.getEnv(&#34;CLOUDFLARE_TOKEN&#34;))</span>;</pre>

The token key for API operations.

</div>
<h2 class="pdoc-module-header" id="useOrgFromZone">
<a class="pdoc-member-name" href="/config/vars.ts#L44">let <b>useOrgFromZone</b></a>
</h2>
<div class="pdoc-module-contents" markdown="1">
