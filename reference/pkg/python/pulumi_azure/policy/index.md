...
<em class="property">class </em><code class="descclassname">pulumi_azure.policy.</code><code class="descname">Assignment</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>description=None</em>, <em>display_name=None</em>, <em>identity=None</em>, <em>location=None</em>, <em>name=None</em>, <em>not_scopes=None</em>, <em>parameters=None</em>, <em>policy_definition_id=None</em>, <em>scope=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_azure.policy.Assignment" title="Permalink to this definition">¶</a></dt>
...
<li><strong>identity</strong> (<em>pulumi.Input</em><em>[</em><em>dict</em><em>]</em>) – An <cite>identity</cite> block.</li>
...
<li><strong>not_scopes</strong> (<em>pulumi.Input</em><em>[</em><em>list</em><em>]</em>) – A list of the Policy Assignment’s excluded scopes. The list must contain Resource IDs (such as Subscriptions e.g. <cite>/subscriptions/00000000-0000-0000-000000000000</cite> or Resource Groups e.g.`/subscriptions/00000000-0000-0000-000000000000/resourceGroups/myResourceGroup`).</li>
...
<dd><p>An <cite>identity</cite> block.</p>
</dd></dl>
...
<dd><p>A list of the Policy Assignment’s excluded scopes. The list must contain Resource IDs (such as Subscriptions e.g. <cite>/subscriptions/00000000-0000-0000-000000000000</cite> or Resource Groups e.g.`/subscriptions/00000000-0000-0000-000000000000/resourceGroups/myResourceGroup`).</p>
</dd></dl>
...
<em class="property">class </em><code class="descclassname">pulumi_azure.policy.</code><code class="descname">Definition</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>description=None</em>, <em>display_name=None</em>, <em>management_group_id=None</em>, <em>metadata=None</em>, <em>mode=None</em>, <em>name=None</em>, <em>parameters=None</em>, <em>policy_rule=None</em>, <em>policy_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_azure.policy.Definition" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="descclassname">pulumi_azure.policy.</code><code class="descname">PolicySetDefinition</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>description=None</em>, <em>display_name=None</em>, <em>management_group_id=None</em>, <em>metadata=None</em>, <em>name=None</em>, <em>parameters=None</em>, <em>policy_definitions=None</em>, <em>policy_type=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_azure.policy.PolicySetDefinition" title="Permalink to this definition">¶</a></dt>
<dd><p>Manages a policy set definition.</p>
<p>-&gt; <strong>NOTE:</strong>  Policy set definitions (also known as policy initiatives) do not take effect until they are assigned to a scope using a Policy Set Assignment.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
<li><strong>policy_type</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – The policy set type. Possible values are <cite>BuiltIn</cite> or <cite>Custom</cite>. Changing this forces a new resource to be created.</li>
</ul>
</td>
</tr>
</tbody>
...
<dd><p>The policy set type. Possible values are <cite>BuiltIn</cite> or <cite>Custom</cite>. Changing this forces a new resource to be created.</p>
</dd></dl>
