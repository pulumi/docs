...
<em class="property">class </em><code class="descclassname">pulumi_azure.msi.</code><code class="descname">UserAssignedIdentity</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>location=None</em>, <em>name=None</em>, <em>resource_group_name=None</em>, <em>tags=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_azure.msi.UserAssignedIdentity" title="Permalink to this definition">¶</a></dt>
<dd><p>Create a UserAssignedIdentity resource with the given unique name, props, and options.</p>
