...
<blockquote>
<div><p><strong>NOTE:</strong> The Azure Active Directory resources have been split out into <a class="reference external" href="http://terraform.io/docs/providers/azuread/">a new AzureAD Provider</a> - as such the AzureAD resources within the AzureRM Provider are deprecated and will be removed in the next major version (2.0). Information on how to migrate from the existing resources to the new AzureAD Provider can be found here.</p>
