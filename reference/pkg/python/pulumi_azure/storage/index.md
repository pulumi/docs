...
<cite>StorageV2</cite> and <cite>BlobStorage</cite>. Changing this forces a new resource to be created.
Defaults to <cite>Storage</cite>.</li>
<li><strong>account_replication_type</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – Defines the type of replication to use for this storage account. Valid options are <cite>LRS</cite>, <cite>GRS</cite>, <cite>RAGRS</cite> and <cite>ZRS</cite>.</li>
<li><strong>account_tier</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – Defines the Tier to use for this storage account. Valid options are <cite>Standard</cite> and <cite>Premium</cite>. Changing this forces a new resource to be created</li>
</ul>
</td>
</tr>
</tbody>
...
:param pulumi.Input[dict] custom_domain: A <cite>custom_domain</cite> block as documented below.
:param pulumi.Input[bool] enable_blob_encryption: Boolean flag which controls if Encryption Services are enabled for Blob storage, see [here](<a class="reference external" href="https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/">https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/</a>) for more information. Defaults to <cite>true</cite>.
:param pulumi.Input[bool] enable_file_encryption: Boolean flag which controls if Encryption Services are enabled for File storage, see [here](<a class="reference external" href="https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/">https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/</a>) for more information. Defaults to <cite>true</cite>.
:param pulumi.Input[bool] enable_https_traffic_only: Boolean flag which forces HTTPS if enabled, see [here](<a class="reference external" href="https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/">https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/</a>)</p>
<blockquote>
...
<li><strong>network_rules</strong> (<em>pulumi.Input</em><em>[</em><em>dict</em><em>]</em>) – A <cite>network_rules</cite> block as documented below.</li>
...
<dd><p>Defines the access tier for <cite>BlobStorage</cite> and <cite>StorageV2</cite> accounts. Valid options are <cite>Hot</cite> and <cite>Cool</cite>, defaults to <cite>Hot</cite>.</p>
</dd></dl>
...
<dd><p>The Encryption Source for this Storage Account. Possible values are <cite>Microsoft.Keyvault</cite> and <cite>Microsoft.Storage</cite>. Defaults to <cite>Microsoft.Storage</cite>.</p>
</dd></dl>
...
<dd><p>Defines the Kind of account. Valid options are <cite>Storage</cite>,
<cite>StorageV2</cite> and <cite>BlobStorage</cite>. Changing this forces a new resource to be created.
Defaults to <cite>Storage</cite>.</p>
</dd></dl>
...
<dd><p>Defines the type of replication to use for this storage account. Valid options are <cite>LRS</cite>, <cite>GRS</cite>, <cite>RAGRS</cite> and <cite>ZRS</cite>.</p>
</dd></dl>
...
<dd><p>Defines the Tier to use for this storage account. Valid options are <cite>Standard</cite> and <cite>Premium</cite>. Changing this forces a new resource to be created</p>
</dd></dl>
...
<dd><p>A <cite>custom_domain</cite> block as documented below.</p>
</dd></dl>
...
<dd><p>Boolean flag which controls if Encryption Services are enabled for Blob storage, see [here](<a class="reference external" href="https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/">https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/</a>) for more information. Defaults to <cite>true</cite>.</p>
</dd></dl>
...
<dd><p>Boolean flag which forces HTTPS if enabled, see [here](<a class="reference external" href="https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/">https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/</a>)
...
<dd><p>A <cite>network_rules</cite> block as documented below.</p>
</dd></dl>
...
<li><strong>parallelism</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – The number of workers per CPU core to run for concurrent uploads. Defaults to <cite>8</cite>.</li>
<li><strong>resource_group_name</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – The name of the resource group in which to
create the storage container. Changing this forces a new resource to be created.</li>
<li><strong>size</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – Used only for <cite>page</cite> blobs to specify the size in bytes of the blob to be created. Must be a multiple of 512. Defaults to 0.</li>
<li><strong>source</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – An absolute path to a file on the local system. Cannot be defined if <cite>source_uri</cite> is defined.</li>
...
for the blob to be created. Changing this forces a new resource to be created. Cannot be defined if <cite>source</cite> is defined.</li>
...
<li><strong>type</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – The type of the storage blob to be created. One of either <cite>block</cite> or <cite>page</cite>. When not copying from an existing blob,
...
<dd><p>The number of attempts to make per page or block when uploading. Defaults to <cite>1</cite>.</p>
</dd></dl>
...
<dd><p>The content type of the storage blob. Cannot be defined if <cite>source_uri</cite> is defined. Defaults to <cite>application/octet-stream</cite>.</p>
</dd></dl>
...
<dd><p>The number of workers per CPU core to run for concurrent uploads. Defaults to <cite>8</cite>.</p>
</dd></dl>
...
<dd><p>Used only for <cite>page</cite> blobs to specify the size in bytes of the blob to be created. Must be a multiple of 512. Defaults to 0.</p>
</dd></dl>
...
<dd><p>An absolute path to a file on the local system. Cannot be defined if <cite>source_uri</cite> is defined.</p>
</dd></dl>
...
for the blob to be created. Changing this forces a new resource to be created. Cannot be defined if <cite>source</cite> is defined.</p>
</dd></dl>
...
<dd><p>The type of the storage blob to be created. One of either <cite>block</cite> or <cite>page</cite>. When not copying from an existing blob,
...
<dd><p>The ‘interface’ for access the container provides. Can be either <cite>blob</cite>, <cite>container</cite> or <cite>private</cite>. Defaults to <cite>private</cite>.</p>
</dd></dl>
...
<dd><p>The access tier for <cite>BlobStorage</cite> accounts.</p>
</dd></dl>
...
<dd><p>Are Encryption Services are enabled for Blob storage? See [here](<a class="reference external" href="https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/">https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/</a>)
for more information.</p>
</dd></dl>
...
<dd><p>Are Encryption Services are enabled for File storage? See [here](<a class="reference external" href="https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/">https://azure.microsoft.com/en-us/documentation/articles/storage-service-encryption/</a>)
for more information.</p>
</dd></dl>
...
<dd><p>Is traffic only allowed via HTTPS? See [here](<a class="reference external" href="https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/">https://docs.microsoft.com/en-us/azure/storage/storage-require-secure-transfer/</a>)
for more information.</p>
</dd></dl>
...
<p>Note that this is an [Account SAS](<a class="reference external" href="https://docs.microsoft.com/en-us/rest/api/storageservices/constructing-an-account-sas">https://docs.microsoft.com/en-us/rest/api/storageservices/constructing-an-account-sas</a>)
and <em>not</em> a [Service SAS](<a class="reference external" href="https://docs.microsoft.com/en-us/rest/api/storageservices/constructing-a-service-sas">https://docs.microsoft.com/en-us/rest/api/storageservices/constructing-a-service-sas</a>).</p>
</dd></dl>
