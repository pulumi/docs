...
<li><strong>max_size_bytes</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – The max data size of the elastic pool in bytes. Conflicts with <code class="docutils literal notranslate"><span class="pre">max_size_gb</span></code>.</li>
