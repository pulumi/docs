...
conflict and will overwrite attachments.</p>
<p>## Note on ECDSA Key Algorithm</p>
<p>If the ARN of the <cite>ssl_certificate_id</cite> that is pointed to references a
certificate that was signed by an ECDSA key, note that ELB only supports the
P256 and P384 curves.  Using a certificate signed by a key using a different
curve could produce the error <cite>ERR_SSL_VERSION_OR_CIPHER_MISMATCH</cite> in your
browser.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
