...
[AWS Client VPN Administrator’s Guide](<a class="reference external" href="https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/what-is.html">https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/what-is.html</a>).</p>
...
<li><strong>transport_protocol</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – The transport protocol to be used by the VPN session. Default value is <cite>udp</cite>.</li>
</ul>
</td>
</tr>
</tbody>
...
<dd><p>The transport protocol to be used by the VPN session. Default value is <cite>udp</cite>.</p>
</dd></dl>
