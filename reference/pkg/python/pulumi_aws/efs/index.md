...
<code class="docutils literal notranslate"><span class="pre">Creation</span> <span class="pre">Token</span></code> which Amazon EFS uses to ensure idempotent file system creation. By
