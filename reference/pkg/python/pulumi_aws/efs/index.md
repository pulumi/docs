...
<em class="property">class </em><code class="descclassname">pulumi_aws.efs.</code><code class="descname">FileSystem</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>creation_token=None</em>, <em>encrypted=None</em>, <em>kms_key_id=None</em>, <em>performance_mode=None</em>, <em>provisioned_throughput_in_mibps=None</em>, <em>reference_name=None</em>, <em>tags=None</em>, <em>throughput_mode=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_aws.efs.FileSystem" title="Permalink to this definition">¶</a></dt>
...
<li><strong>performance_mode</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – The file system performance mode. Can be either <cite>“generalPurpose”</cite> or <cite>“maxIO”</cite> (Default: <cite>“generalPurpose”</cite>).</li>
<li><strong>provisioned_throughput_in_mibps</strong> (<em>pulumi.Input</em><em>[</em><em>float</em><em>]</em>) – The throughput, measured in MiB/s, that you want to provision for the file system. Only applicable with <cite>throughput_mode</cite> set to <cite>provisioned</cite>.</li>
<li><strong>reference_name</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – <strong>DEPRECATED</strong> (Optional) A reference name used when creating the
<cite>Creation Token</cite> which Amazon EFS uses to ensure idempotent file system creation. By
default generated by Terraform.</li>
<li><strong>tags</strong> (<em>pulumi.Input</em><em>[</em><em>dict</em><em>]</em>) – A mapping of tags to assign to the file system.</li>
<li><strong>throughput_mode</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – Throughput mode for the file system. Defaults to <cite>bursting</cite>. Valid values: <cite>bursting</cite>, <cite>provisioned</cite>. When using <cite>provisioned</cite>, also set <cite>provisioned_throughput_in_mibps</cite>.</li>
</ul>
</td>
</tr>
</tbody>
...
<dd><p>The DNS name for the filesystem per [documented convention](<a class="reference external" href="http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html">http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html</a>).</p>
</dd></dl>
...
<dd><p>The file system performance mode. Can be either <cite>“generalPurpose”</cite> or <cite>“maxIO”</cite> (Default: <cite>“generalPurpose”</cite>).</p>
</dd></dl>
...
<dd><p>The throughput, measured in MiB/s, that you want to provision for the file system. Only applicable with <cite>throughput_mode</cite> set to <cite>provisioned</cite>.</p>
</dd></dl>

<dl class="attribute">
<dt id="pulumi_aws.efs.FileSystem.reference_name">
<code class="descname">reference_name</code><em class="property"> = None</em><a class="headerlink" href="#pulumi_aws.efs.FileSystem.reference_name" title="Permalink to this definition">¶</a></dt>
<dd><p><strong>DEPRECATED</strong> (Optional) A reference name used when creating the
<cite>Creation Token</cite> which Amazon EFS uses to ensure idempotent file system creation. By
default generated by Terraform.</p>
</dd></dl>
...
<dd><p>Throughput mode for the file system. Defaults to <cite>bursting</cite>. Valid values: <cite>bursting</cite>, <cite>provisioned</cite>. When using <cite>provisioned</cite>, also set <cite>provisioned_throughput_in_mibps</cite>.</p>
</dd></dl>
...
<dd><p>The DNS name for the given subnet/AZ per [documented convention](<a class="reference external" href="http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html">http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html</a>).</p>
</dd></dl>
...
<em class="property">class </em><code class="descclassname">pulumi_aws.efs.</code><code class="descname">MountTarget</code><span class="sig-paren">(</span><em>__name__</em>, <em>__opts__=None</em>, <em>file_system_id=None</em>, <em>ip_address=None</em>, <em>security_groups=None</em>, <em>subnet_id=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_aws.efs.MountTarget" title="Permalink to this definition">¶</a></dt>
