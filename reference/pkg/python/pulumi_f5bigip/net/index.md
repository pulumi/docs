...
<dd><p><cite>bigip_net_route</cite> Manages a route configuration</p>
...
<dd><p><cite>bigip_net_selfip</cite> Manages a selfip configuration</p>
...
<li><strong>traffic_group</strong> (<em>pulumi.Input</em><em>[</em><em>str</em><em>]</em>) – Specifies the traffic group, defaults to <cite>traffic-group-local-only</cite> if not specified.</li>
...
<dd><p>Specifies the traffic group, defaults to <cite>traffic-group-local-only</cite> if not specified.</p>
</dd></dl>
...
<dd><p><cite>bigip_net_vlan</cite> Manages a vlan configuration</p>
<p>For resources should be named with their “full path”. The full path is the combination of the partition + name of the resource. For example /Common/my-pool.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
...
<li><strong>tag</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – Specifies a number that the system adds into the header of any frame passing through the VLAN.</li>
</ul>
</td>
</tr>
</tbody>
