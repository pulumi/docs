...
repo: pulumi-aws
subpath: opsworks/mysqlLayer.d.ts
---
import * as fabric from "@pulumi/pulumi-fabric";
export declare class MysqlLayer extends fabric.Resource {
    ...
    readonly rootPassword?: fabric.Computed<string>;
    readonly rootPasswordOnAllInstances?: fabric.Computed<boolean>;
