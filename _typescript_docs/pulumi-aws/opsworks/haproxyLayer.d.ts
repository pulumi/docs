...
repo: pulumi-aws
subpath: opsworks/haproxyLayer.d.ts
---
import * as fabric from "@pulumi/pulumi-fabric";
export declare class HaproxyLayer extends fabric.Resource {
    ...
    readonly healthcheckMethod?: fabric.Computed<string>;
    readonly healthcheckUrl?: fabric.Computed<string>;
    ...
    readonly statsEnabled?: fabric.Computed<boolean>;
    readonly statsPassword: fabric.Computed<string>;
    readonly statsUrl?: fabric.Computed<string>;
    readonly statsUser?: fabric.Computed<string>;
