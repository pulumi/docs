...
curl -fsSL --retry 3 --retry-all-errors --retry-delay 5 \
  --retry-max-time 300 --connect-timeout 10 --max-time 120 \
  -o /tmp/vale.tar.gz "https://github.com/errata-ai/vale/releases/download/v${VALE_VERSION}/vale_${VALE_VERSION}_Linux_64-bit.tar.gz"
