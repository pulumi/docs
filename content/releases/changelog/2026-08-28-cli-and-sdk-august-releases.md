...
* Automatic, encrypted logging of every operation, securely shareable with [`pulumi logs share`](/docs/iac/cli/commands/pulumi_logs_share/) and [`pulumi logs decrypt`](/docs/iac/cli/commands/pulumi_logs_decrypt/) ([v3.254](https://github.com/pulumi/pulumi/releases/tag/v3.254.0))
