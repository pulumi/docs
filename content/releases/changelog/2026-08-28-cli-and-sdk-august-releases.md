...
* Automatic, encrypted logging of every operation, so you can securely share exactly what happened when you need help — with [`pulumi logs share`](/docs/iac/cli/commands/pulumi_logs_share/) and [`pulumi logs decrypt`](/docs/iac/cli/commands/pulumi_logs_decrypt/) ([v3.254](https://github.com/pulumi/pulumi/releases/tag/v3.254.0))
...
* A new [`pulumi state promote`](/docs/iac/cli/commands/pulumi_state_promote/) command that turns the stateful snippets created by [`pulumi do`](/docs/iac/cli/commands/pulumi_do/) into Pulumi program code ([v3.260](https://github.com/pulumi/pulumi/releases/tag/v3.260.0))
...
We also retired the AI mode of `pulumi new` in favor of [`pulumi neo`](/docs/ai/) ([v3.256](https://github.com/pulumi/pulumi/releases/tag/v3.256.0)), and made a raft of improvements to [`pulumi do`](/docs/iac/cli/direct-resource-operations/) as well.
