...
To get details about an instance, run the command using `pulumi esc run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, `<your-environment-name>`, and `<your-aws-region>` with the names of your own Pulumi organization, environment, and desired AWS region respectively:

```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws ec2 describe-instances --region <your-aws-region>
```
