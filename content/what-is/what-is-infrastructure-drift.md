...
* **Guardrails** through resource options ([`ignoreChanges`](/docs/iac/concepts/resources/options/ignorechanges/), [`protect`](/docs/iac/concepts/resources/options/protect/)) and [Pulumi Policy](/docs/discovery-governance/concepts/policy-as-code/) enforcement that spans both preview-time prevention and audit of live resources.
