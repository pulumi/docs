...
```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -i aws s3api create-bucket --bucket <your-bucket-name> --region <your-aws-region>
```
...
To copy the local file to your S3 bucket, run the command using `pulumi esc run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, and `<your-environment-name>` with the names of your own Pulumi organization and environment respectively:

```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -i aws s3 cp test.txt s3://<your-bucket-name>/copied-file.txt
```
...
```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -i aws s3api list-objects-v2 --bucket <your-bucket-name>
```
