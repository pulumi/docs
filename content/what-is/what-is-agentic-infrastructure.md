...
**Step 4: Define your policies.** Encode your team's standards in [Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/) before expanding Neo's autonomy. Policies run on every preview and block non-compliant changes automatically.
