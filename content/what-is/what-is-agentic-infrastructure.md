...
**Step 4: Define your policies.** Encode your team's standards in [Pulumi Policies](/docs/discovery-governance/policy/) before expanding Neo's autonomy. Policies run on every preview and block non-compliant changes automatically.
...
[Pulumi Neo](/product/neo/) writes and modifies infrastructure in Python, TypeScript, JavaScript, Go, .NET, or Java, as well as YAML and HCL. For the general-purpose languages, AI agents draw on richer training data and can apply full software engineering patterns (loops, functions, tests, package imports) to infrastructure code.
