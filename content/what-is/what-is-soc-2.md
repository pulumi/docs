...
* **Policy as code in CI.** [Pulumi Policies](/docs/discovery-governance/policy/) block insecure configurations (public storage, missing encryption, wildcard IAM) in CI before they ever reach production. The auditor's question "how do you prevent public S3 buckets?" has a code-and-CI-log answer.
