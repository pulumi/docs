...
meta_desc: |
    Azure Key Vault securely stores secrets, keys, and certificates and controls access to them. Learn to create Key Vault secrets and centralize them with Pulumi ESC.
