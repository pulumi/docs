...
Regardless of which database suits your needs, standing them up shouldn't be a chore. With Pulumi, provisioning either one is a breeze in the programming language of your choice. Try deploying [Azure Cosmos DB with Pulumi](/registry/packages/azure-native/api-docs/documentdb/) or get started with [MongoDB Atlas](/registry/packages/mongodbatlas/).
