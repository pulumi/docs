...
type: what-is
date: 2023-12-15T13:29:12-06:00
...
To list the details of the calling entity, run the command using `pulumi env run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, and `<your-environment-name>` with the names of your own Pulumi organization and environment respectively:

```bash
pulumi env run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws sts get-caller-identity
```
