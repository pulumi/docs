...
To get a list of S3 buckets, run the command using `pulumi esc run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, and `<your-environment-name>` with the names of your own Pulumi organization and environment respectively:

```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws s3 ls
```
