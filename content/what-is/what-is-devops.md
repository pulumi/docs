...
* **Policy as code.** Encode security, compliance, and cost rules as code that runs against every change. [Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/) can be written in the same language as your infrastructure and enforced in CI.
