...
As DevOps practices mature, many organizations are evolving toward [platform engineering](/what-is/what-is-platform-engineering/) — a discipline that builds on DevOps principles by creating internal developer platforms (IDPs) that provide self-service infrastructure capabilities. While DevOps focuses on culture and practices, platform engineering focuses on building the tools and platforms that make those practices scalable across large organizations. The two disciplines are complementary: platform engineering teams apply DevOps principles to build platforms that empower development teams to move faster while maintaining security and compliance.
...
* **Continuous integration and continuous delivery (CI/CD)**: For integrating CI/CD processes with Pulumi, visit our [CI/CD integration documentation](https://www.pulumi.com/docs/iac/guides/continuous-delivery/).
...
* **Version control**: Learn about version control systems supported by Pulumi in our [version control documentation](https://www.pulumi.com/docs/iac/concepts/state-and-backends/).
