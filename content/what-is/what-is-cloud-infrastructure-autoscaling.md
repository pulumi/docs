...
* **Policy as code for scaling guardrails.** [Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/) can enforce "every production ASG must have a non-zero max," "no ASG without scale-in protection in stateful tiers," "production database autoscaling must have an upper bound."
