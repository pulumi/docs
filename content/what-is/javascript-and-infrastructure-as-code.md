...
* **Policy as code in TypeScript.** [Pulumi policies](/docs/discovery-governance/concepts/policy-as-code/) can be written in the same language as the IaC, with the same typing over the resource model.
