...
To start a stopped instance, run the command using `pulumi esc run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, `<your-environment-name>`, and `<your-stopped-instance-id>` with the names of your own Pulumi organization, environment, and desired EC2 instance ID respectively:

```bash
pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws ec2 start-instances --instance-ids <your-stopped-instance-id>
```
