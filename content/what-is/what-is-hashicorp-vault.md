...
You can wire Vault into that layer with [Pulumi ESC](/docs/pulumi-cloud/esc/)'s [vault-secrets](/docs/pulumi-cloud/esc/providers/vault-secrets/) provider to dynamically import secrets from HashiCorp Vault into your environments.
