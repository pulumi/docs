...
You can wire Vault into that layer with [Pulumi ESC](/docs/esc/)'s [vault-secrets](/docs/esc/providers/secrets/vault-secrets/) provider to dynamically import secrets from HashiCorp Vault into your environments.
