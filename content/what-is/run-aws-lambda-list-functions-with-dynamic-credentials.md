...
To get the list of Lambda functions, run the command using `pulumi esc run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, `<your-environment-name>`, and `<aws-region>` with the names of your own Pulumi organization, ESC environment, and AWS Region, respectively.

```bash
$ pulumi esc run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws lambda list-functions --region <aws-region>
```
