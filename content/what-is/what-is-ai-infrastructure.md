...
- **Policy as code** evaluates every proposed change, human or agent-authored, against organizational rules before it can apply. See [what policy as code is](/what-is/what-is-policy-as-code/) and [Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/), Pulumi's implementation.
