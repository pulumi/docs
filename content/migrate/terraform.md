...
sections:
  ...
  - type: section_header_with_image
    ...
    description: |
      ...
      In return you get encrypted state, automatic locking, update history, role-based access control, and audit policies, plus a single view of Terraform-managed and Pulumi-managed resources together in [resource search](/docs/discovery-governance/guides/search-resources/).
