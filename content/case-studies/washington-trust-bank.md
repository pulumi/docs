...
description: |
    Washington Trust Bank is the largest independently-owned full-service commercial bank in the Northwest. It wanted to maintain secure, reliable, and compliant cloud resources while also empowering more agile development teams as it modernized its software development and infrastructure. The bank used Pulumi to automate building and deploying its cloud infrastructure, eliminate infrastructure provisioning as a bottleneck, and empower developers to self-service infrastructure and increase productivity.
meta_desc: |
    Washington Trust Bank is the largest independently-owned full-service commercial bank in the Northwest. It wanted to maintain secure, reliable, and compliant cloud resources while also empowering more agile development teams as it modernized its software development and infrastructure. The bank used Pulumi to automate building and deploying its cloud infrastructure, eliminate infrastructure provisioning as a bottleneck, and empower developers to self-service infrastructure and increase productivity.
