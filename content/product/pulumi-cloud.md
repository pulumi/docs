        ...
        - header: Pulumi CrossGuard
          ...
          details:
            - title: Proactive compliance enforcement
              description: |
                Set guardrails for developers deploying with Pulumi by creating [policy packs](/docs/iac/packages-and-automation/crossguard/configuration/) that enforce your [deployment rules](/docs/iac/packages-and-automation/crossguard/).

              more_info: |
                Define [Policy as Code](/docs/iac/packages-and-automation/crossguard/) rules for security, best practices, and more.

                Assign [policy packs](/docs/iac/packages-and-automation/crossguard/configuration/) that run on specific stacks (e.g., dev/test/staging rules).
