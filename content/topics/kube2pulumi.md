...
<div id="pulumi-code-download-icon" class="float-right mt-4 mr-1 hidden">
    <button class="copy-button" onclick="downloadCode('kube2pulumi.zip')"><i class="fa fa-download text-xl" title="Download"></i></button>
</div>
...
<div class="text-center py-8">
    <a id="pulumi-code-download-button"
        class="btn btn-lg mr-4 opacity-50 cursor-not-allowed" onclick="downloadCode('kube2pulumi.zip')">Download Code</a>
</div>
