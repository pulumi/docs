...
- **Custom Compute**: Run Pulumi operations, [Insights](/docs/insights/) discovery scans, and [policy evaluations](/docs/insights/policy/) on your own infrastructure with [customer-managed workflow runners](/docs/deployments/deployments/runners/).
