...
- **Zero Touch CI/CD**: App teams can select a template from Pulumi Cloud's [New Project Wizard](/docs/idp/concepts/new-project-wizard) and deploy infrastructure in minutes. Learn how with our [Getting Started guide](/docs/deployments/get-started/).
- **Git Integration**: Automatically preview infrastructure changes on pull requests and deploy on merge with our [version control integrations](/docs/integrations/version-control/).
...
- **Custom Compute**: Run Pulumi operations, [Insights](/docs/insights/) discovery scans, and [policy evaluations](/docs/insights/policy/) on your own infrastructure with [customer-managed workflow runners](/docs/deployments/deployments/runs/customer-managed-agents).
...
1. Follow our [Getting Started guide](/docs/deployments/get-started/) to configure an existing project
...
[Get Started](/docs/deployments/get-started/) today!
