...
For [Terraform remote-execution stacks](/docs/iac/get-started/terraform/terraform-remote-execution/), a source is optional. Select **None** to configure only the [Pulumi Cloud role](/docs/deployments/concepts/settings/pulumi-cloud-role/) that runs use.
