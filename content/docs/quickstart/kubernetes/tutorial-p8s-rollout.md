...
![gatedDeployment](/assets/images/docs/quickstart/kubernetes/gatedDeployment.gif "Deployment gated by Prometheus check")
...
[configuration]: {{< relref "/docs/quickstart/kubernetes/setup.md" >}}
