...
![configmapRollout](/assets/images/docs/quickstart/kubernetes/cm-rollout.gif "ConfigMap-induced Rollout")
...
1. **Answer the questions prompted by** `pulumi new`**.** This will bring up a CLI prompt that looks
   ...
   for all questions except `isMinikube`, where it is important to answer `false`.
    ...
    ![Pulumi CLI questions](/assets/images/docs/quickstart/kubernetes/questions.png "Pulumi CLI questions prompt")
...
![Allocating a public IP to a Deployment](/assets/images/docs/quickstart/kubernetes/exposed-deploy.gif "Allocating a public IP to a Deployment")
...
1. **Get a high-level view of the changes with** `pulumi preview`**.** It should look something like
   ...
   will silently sync the new version of the file to the containers.
    ...
    ![Preview](/assets/images/docs/quickstart/kubernetes/preview.png "Preview")
...
1. **Get a more detailed view of the changes with** `pulumi preview --diff`**.**. It will look
   conceptually something like the following gif (though this gif is a different app).
    ...
    ![diff](/assets/images/docs/quickstart/kubernetes/diff.gif "Diff")
...
1. **Run** `pulumi up`**.**
    ...
    ![configmapRollout](/assets/images/docs/quickstart/kubernetes/cm-rollout.gif)
...
[install]: {{< relref "/docs/quickstart/install.md" >}}
