...
aliases:
  ...
  - /docs/discovery-governance/discovery/accounts/
...
{{% notes type="info" %}}
To onboard many AWS, Azure, or Google Cloud accounts at once, use the [Connect cloud accounts wizard](/docs/discovery-governance/guides/connect-cloud-accounts/). This page covers connecting a single account using a [Pulumi ESC (Environments, Secrets, and Configuration)](/docs/esc/) environment you configure yourself.
{{% /notes %}}
...
1. After logging into the Pulumi Cloud Console, navigate to **Resources** > **Discovery**.  
