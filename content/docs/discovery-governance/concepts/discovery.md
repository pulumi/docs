...
- /docs/discovery-governance/discovery/
...
1. **Account management**: Create and configure cloud accounts on the [**Accounts** page](/docs/discovery-governance/concepts/cloud-accounts/) in Pulumi Cloud, where you can view scan status, monitor progress, and manage settings.
...
3. **Exploration**: Once scanning completes, explore your infrastructure through [Resource Search](/docs/discovery-governance/guides/search-resources/), which provides powerful filtering, grouping, and natural language queries via [Pulumi Neo](/docs/ai/).
...
Resources are displayed in a paginated table showing up to 10,000 results. For larger datasets, use the [Data Export](/docs/discovery-governance/guides/export-resource-data/) feature or the [Pulumi Cloud REST API](/docs/reference/cloud-rest-api/resource-search/).
...
- [Get started with Discovery](/docs/discovery-governance/get-started/)
