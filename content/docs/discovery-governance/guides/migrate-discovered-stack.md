---
title: Migrate a discovered stack
title_tag: "Migrate from a Discovered Stack | Discovery & governance"
h1: Migrate a discovered stack to Pulumi IaC
...
menu:
  discovery-governance:
    name: Migrate a discovered stack
    parent: dg-guides
    weight: 40
aliases:
- /docs/insights/discovery/discovered-stacks/migrate/
- /docs/discovery-governance/discovery/discovered-stacks/migrate/
