...
title: Import resources with Visual Import
h1: Import resources with Visual Import
menu:
  discovery-governance:
    name: Import with Visual Import
    parent: dg-guides
    weight: 30
aliases:
...
- /docs/discovery-governance/discovery/visual-import/
