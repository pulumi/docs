...
Oracle Cloud and Kubernetes accounts connect through an ESC environment that you configure yourself. If you're connecting one of those providers, set up the environment first by following [Create and manage cloud accounts](/docs/discovery-governance/concepts/discovery/cloud-accounts/#configure-esc-credentials).
