...
Pulumi Discovery supports self-hosted operation through [customer-managed workflow runners](/docs/deployments/concepts/customer-managed-runners/). This allows you to run [Discovery scans](/docs/discovery-governance/discovery/) and [policy evaluations](/docs/discovery-governance/policy/) within your own infrastructure, giving you full control over where your data is processed while retaining the power of Pulumi Discovery.
