...
- /docs/administration/access-identity/rbac/scopes/org-settings/
pulumi_cloud_feature: rbac
---

This document defines all the available scopes in Pulumi Cloud, organized by [entity type](/docs/administration/concepts/rbac/entities#entity-types) and group.
