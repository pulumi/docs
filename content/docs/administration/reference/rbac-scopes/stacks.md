...
- /docs/administration/access-identity/rbac/scopes/stacks/
pulumi_cloud_feature: rbac
---

This document defines all the available [scopes](/docs/administration/concepts/rbac/scopes/) in Pulumi Cloud assignable to specific stacks or sets of stacks.

Note that creating, listing, or restoring stacks are organization-level operations, and these scopes can be found in the [organization settings scopes](/docs/administration/reference/rbac-scopes/org-settings).
