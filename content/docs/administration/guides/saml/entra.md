...
menu:
  administration:
    name: Entra ID
    parent: administration-guides-saml
    weight: 30
...
- /docs/administration/access-identity/saml/entra/
pulumi_cloud_feature: saml-sso
---

This guide walks you through configuring Microsoft Entra ID as a [SAML SSO](/docs/administration/guides/saml/) identity provider
