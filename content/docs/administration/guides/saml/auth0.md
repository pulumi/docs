...
- /docs/administration/access-identity/saml/auth0/
pulumi_cloud_feature: saml-sso
---

This guide walks you through configuring your Auth0 Authentication Platform as a [SAML SSO](/docs/administration/guides/saml/) identity provider
