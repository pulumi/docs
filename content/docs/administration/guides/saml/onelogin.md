...
- /docs/administration/access-identity/saml/onelogin/
pulumi_cloud_feature: saml-sso
---

This guide walks you through configuring OneLogin as a [SAML SSO](/docs/administration/guides/saml/) identity provider (IdP) for Pulumi Cloud.
