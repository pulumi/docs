...
aliases:
  - /docs/administration/access-identity/saml/troubleshooting/
---
...
As mentioned in the [Name ID Format](/docs/administration/guides/saml/sso/#name-id-format) section, Pulumi expects specific values in your IdP metadata XML.
