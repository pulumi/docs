...
- /docs/administration/access-identity/saml/sso/
...
{{% notes type="info" %}}
For examples of setting up SAML SSO with popular identity providers, refer to our [integration guides](/docs/administration/guides/saml#integration-guides).
{{% /notes %}}
...
For information on the SAML admin role and how to configure it, see [SAML admin](/docs/administration/guides/saml/saml-admin/).

## Troubleshooting

For help resolving SAML SSO configuration issues, see [SAML SSO troubleshooting](/docs/administration/guides/saml/troubleshooting/).
