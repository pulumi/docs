...
- /docs/administration/access-identity/saml/okta/
pulumi_cloud_feature: saml-sso
---

This guide walks you through configuring Okta as a [SAML SSO](/docs/administration/guides/saml/) identity provider (IdP) for Pulumi Cloud.
...
If you plan on using [SCIM](/docs/administration/guides/scim/okta/), you will need to provide the above attributes, in addition to the `email` attribute.
