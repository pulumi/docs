...
Set up an external key management system so Pulumi Cloud encrypts your organization's data with a key you own and can revoke. For how customer managed keys work and what they cover, see [Customer managed keys](/docs/administration/concepts/customer-managed-keys/).
