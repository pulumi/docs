...
aliases:
  ...
  - /docs/administration/access-identity/scim/troubleshooting/
...
These errors can occur when attempting to create (POST), replace (PUT), or update (PATCH) a user. If you encounter difficulties resolving these issues, contact [customer support](/support/new/).
...
- [SCIM overview](/docs/administration/guides/scim/)
