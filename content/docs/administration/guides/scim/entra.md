...
menu:
  administration:
    name: Entra ID
    parent: administration-guides-scim
    weight: 1
...
aliases:
  ...
  - /docs/administration/access-identity/scim/entra/
...
* Your organization must already be configured to use [SAML SSO](/docs/administration/guides/saml/entra/) with Pulumi.
