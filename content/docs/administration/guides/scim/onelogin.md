...
aliases:
  ...
  - /docs/administration/access-identity/scim/onelogin/
...
* Your organization must already be configured to use [SAML SSO](/docs/administration/guides/saml/onelogin/) with Pulumi.
