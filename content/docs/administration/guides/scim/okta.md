...
aliases:
  ...
  - /docs/administration/access-identity/scim/okta/
...
* Your organization must already be configured to use [SAML SSO](/docs/administration/guides/saml/okta/) with Pulumi.
