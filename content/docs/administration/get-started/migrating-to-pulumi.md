...
aliases:
  ...
  - /docs/administration/onboarding-guide/migrating-to-pulumi/
weight: 4
menu:
    administration:
        name: Migrating to Pulumi
        parent: administration-get-started
