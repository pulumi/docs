...
aliases:
  ...
  - /docs/administration/onboarding-guide/ways-of-working/
weight: 2
menu:
    administration:
...
4. Set up [Pulumi Cloud access tokens](/docs/administration/concepts/access-tokens/) for automation
