...
aliases:
  ...
  - /docs/administration/onboarding-guide/setting-up-for-success/
weight: 3
menu:
    administration:
...
**[Templates](/docs/idp/concepts/organization-templates/)** are blueprints that scaffold entirely new projects. While components encapsulate cloud resource usage patterns, templates provide standard starting points for complete projects with many resources. [Pulumi offers templates](/dev/templates/) for common architectures and patterns, but you can create your own. You can also register your organization's templates in the Pulumi Cloud New Project Wizard for convenient access.
