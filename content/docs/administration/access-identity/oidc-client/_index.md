...
menu:
  administration:
    ...
    weight: 4
    identifier: administration-access-identity-oidc-client
aliases:
...
Navigate to **Access Management** under **Settings**, select **OIDC Issuers** on the top menu and then click on **Register issuer**
...
It is possible to use the following wildcard notation for flexible matching for the claim values and team:
...
- [Configuring OIDC for Github](/docs/administration/access-identity/oidc-client/github/)
- [Configuring OIDC for Google Kubernetes Engine](/docs/administration/access-identity/oidc-client/kubernetes-gke/)
