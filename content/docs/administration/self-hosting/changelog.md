...
{{< notes type="warning" >}}
Breaking Change: Ensure your [AWS KMS](/docs/administration/self-hosting/components/api/#aws-kms) or [Azure Key Vault](/docs/administration/self-hosting/components/api/#azure-key-vault) encryption service permissions are up-to-date.
{{< /notes >}}
