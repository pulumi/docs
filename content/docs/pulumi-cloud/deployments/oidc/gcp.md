...
{{< notes type="info" >}}
Pulumi ESC should be the preferred approach over the Deployments OIDC integrations since it's more portable and easier to set up. For ESC OIDC setup instructions, see [Configuring OIDC for GCP in ESC](/docs/esc/environments/configuring-oidc/gcp/).
{{< /notes >}}
