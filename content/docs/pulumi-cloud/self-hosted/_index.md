...
{{% notes type="info" %}}
Self-hosting is not the same thing as using self-managed backends to track state. To use a open source, self-managed backend, such as a cloud storage bucket, see [State and Backends](/docs/concepts/state/).
{{% /notes %}}
