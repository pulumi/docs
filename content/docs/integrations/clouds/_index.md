---
title_tag: "Clouds | Pulumi Integrations"
meta_desc: Pulumi integrates with AWS, Azure, Google Cloud, Kubernetes, and thousands of other providers through the Pulumi Registry.
title: Clouds
linktitle: Clouds
h1: Clouds
docs_home: true
...
menu:
  integrations:
    name: Clouds
    identifier: integrations-clouds
...
- type: button-cards
  ...
  - image: /logos/tech/kubernetes.svg
    heading: Kubernetes
    description: Kubernetes provider, Pulumi Kubernetes Operator, cluster management packages, architecture templates, and guides.
    link: /docs/integrations/clouds/kubernetes/

- type: flat
  heading: More providers
  description: <p>Browse the <a href="/registry/">Pulumi Registry</a> for thousands of additional cloud and SaaS providers, including Docker, Datadog, Cloudflare, Auth0, and many more.</p>
---
