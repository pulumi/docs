...
- [Container service on AWS](/learn/official-templates/container-service/aws/) — containerized service on Amazon ECS Fargate.
- [Serverless application on AWS](/learn/official-templates/serverless-application/aws/) — AWS Lambda behind API Gateway with supporting resources.
- [Static website on AWS](/learn/official-templates/static-website/aws/) — S3-hosted static site with CloudFront CDN.
- [Virtual machine on AWS](/learn/official-templates/virtual-machine/aws/) — EC2 instance with configurable networking.
- [Kubernetes cluster on AWS](/learn/official-templates/kubernetes/aws/) — Amazon EKS cluster ready for workloads.
