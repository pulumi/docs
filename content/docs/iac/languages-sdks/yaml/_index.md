...
To learn more about building and working with custom templates, see [Custom Templates](/docs/platform/developer-platforms/templates) and the [`pulumi new`](/docs/cli/commands/pulumi_new/) docs.
