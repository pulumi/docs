...
Pulumi Policy as Code policies cannot be authored in Java. Policies are written in [TypeScript/JavaScript, Python, or OPA (Rego)](/docs/discovery-governance/concepts/policy-as-code/#languages) and can be applied to Pulumi programs written in any language, including Java.
