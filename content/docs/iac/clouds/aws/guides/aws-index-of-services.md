...
- /docs/iac/clouds/aws/guides/aws-index-of-services/
---
...
| [Amazon API Gateway](https://aws.amazon.com/api-gateway/) | Secure, scalable APIs | [User Guide](/docs/iac/clouds/aws/guides/api-gateway/) | [apigateway](/registry/packages/aws/api-docs/apigateway/) |
...
| [AWS Auto Scaling](https://aws.amazon.com/autoscaling) | Automatic scaling policies | [User Guide](/docs/iac/clouds/aws/guides/autoscaling/) | [autoscaling](/registry/packages/aws/api-docs/autoscaling/) |
...
| [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/) | Application and infrastructure monitoring | [User Guide](/docs/iac/clouds/aws/guides/cloudwatch/) | [cloudwatch](/registry/packages/aws/api-docs/cloudwatch/) |
| [AWS CodeBuild](https://aws.amazon.com/codebuild/) | Build and test code | [User Guide](/docs/iac/packages-and-automation/continuous-delivery/aws-code-services/) | [codebuild](/registry/packages/aws/api-docs/codebuild/) |
| [AWS CodeCommit](https://aws.amazon.com/codecommit/) | Host private Git repos | [User Guide](/docs/iac/packages-and-automation/continuous-delivery/aws-code-services/) | [codecommit](/registry/packages/aws/api-docs/codecommit/) |
| [AWS CodeDeploy](https://aws.amazon.com/codedeploy/) | Automate code deployments | [User Guide](/docs/iac/packages-and-automation/continuous-delivery/aws-code-services/) | [codedeploy](/registry/packages/aws/api-docs/codedeploy/) |
| [AWS CodePipeline](https://aws.amazon.com/codepipeline) | Continuous delivery pipelines | [User Guide](/docs/iac/packages-and-automation/continuous-delivery/aws-code-services/) | [codepipeline](/registry/packages/aws/api-docs/codepipeline/) |
...
| [Amazon Elastic Container Registry (ECR)](https://aws.amazon.com/ecr/) | Private container registries | [User Guide](/docs/iac/clouds/aws/guides/ecr/) | [ecr](/registry/packages/aws/api-docs/ecr/) |
| [Amazon Elastic Container Service (ECS)](https://aws.amazon.com/ecs/) | Run containerized apps | [User Guide](/docs/iac/clouds/aws/guides/ecs/) | [ecs](/registry/packages/aws/api-docs/ecs/) |
...
| [Amazon Elastic Kubernetes Service (EKS)](https://aws.amazon.com/eks/) | Managed Kubernetes service | [User Guide](/docs/iac/clouds/aws/guides/eks/) | [eks](/registry/packages/aws/api-docs/eks/) |
...
| [AWS Elastic Load Balancing (ELB)](https://aws.amazon.com/elasticloadbalancing/) | Scale across many instances | [User Guide](/docs/iac/clouds/aws/guides/elb/) | [lb](/registry/packages/aws/api-docs/lb/) |
...
| [AWS Identity and Access Management (IAM)](https://aws.amazon.com/iam/) | Securely manage access | [User Guide](/docs/iac/clouds/aws/guides/iam/) | [iam](/registry/packages/aws/api-docs/iam/) |
...
| [AWS Lambda](https://aws.amazon.com/lambda/) | Run serverless code | [User Guide](/docs/iac/clouds/aws/guides/lambda/) | [lambda](/registry/packages/aws/api-docs/lambda/) |
...
| [Amazon Virtual Private Cloud (VPC)](https://aws.amazon.com/vpc/) | Secure, isolated networks | [User Guide](/docs/iac/clouds/aws/guides/vpc/) | [vpc](/docs/reference/pkg/nodejs/pulumi/awsx/ec2#Vpc) |
...
* [Pulumi AWS Get Started guide](/docs/iac/get-started/aws/)
