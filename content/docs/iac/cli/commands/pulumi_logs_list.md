...
title: "pulumi logs list | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_logs_list/
  - /docs/iac/cli/commands/pulumi_logs_ls/
  - /docs/reference/cli/pulumi_logs_ls/
meta_desc: "Learn about the pulumi logs list command."
---
