...
title: "pulumi env tag remove | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_tag_remove/
  - /docs/iac/cli/commands/pulumi_env_tag_rm/
  - /docs/reference/cli/pulumi_env_tag_rm/
  - /docs/iac/cli/commands/pulumi_env_tag_delete/
  - /docs/reference/cli/pulumi_env_tag_delete/
meta_desc: "Learn about the pulumi env tag remove command."
---
...
```
pulumi env tag remove [<org-name>/][<project-name>/]<environment-name> <tag-name> [flags]
```
