...
aliases:
  ...
  - /docs/iac/cli/commands/pulumi_api_ls/
  - /docs/reference/cli/pulumi_api_ls/
...
```
      --filter string        Show only operations whose ID, path, tag, summary, or description contains this text (case-insensitive)
