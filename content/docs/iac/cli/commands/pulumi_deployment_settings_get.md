...
title: "pulumi deployment settings get | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_deployment_settings_get/
meta_desc: "Learn about the pulumi deployment settings get command."
---
...
```
pulumi deployment settings get [flags]
```
