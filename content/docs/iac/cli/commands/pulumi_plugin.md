...
meta_desc: "Learn how to use the pulumi plugin command in Pulumi CLI for infrastructure as code management."
---
...
* [pulumi plugin ls](/docs/iac/cli/commands/pulumi_plugin_ls/)	 - List plugins
* [pulumi plugin rm](/docs/iac/cli/commands/pulumi_plugin_rm/)	 - Remove one or more plugins from the download cache
