...
aliases:
  ...
  - /docs/iac/cli/commands/pulumi_stack_webhook_create/
  - /docs/reference/cli/pulumi_stack_webhook_create/
  - /docs/iac/cli/commands/pulumi_stack_webhook_setup/
  - /docs/reference/cli/pulumi_stack_webhook_setup/
