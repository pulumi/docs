...
title: "pulumi policy install | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_policy_install/
meta_desc: "Learn about the pulumi policy install command."
---
