...
aliases:
  ...
  - /docs/iac/cli/commands/pulumi_stack_hist/
  - /docs/reference/cli/pulumi_stack_hist/
...
* [pulumi stack history events](/docs/iac/cli/commands/pulumi_stack_history_events/)	 - [EXPERIMENTAL] Retrieve engine events for an update
