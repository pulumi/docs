...
title: "pulumi plugin list | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_plugin_list/
  - /docs/iac/cli/commands/pulumi_plugin_ls/
  - /docs/reference/cli/pulumi_plugin_ls/
meta_desc: "Learn about the pulumi plugin list command."
---
