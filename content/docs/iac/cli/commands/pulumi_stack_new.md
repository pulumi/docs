...
title: "pulumi stack new | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_stack_new/
  - /docs/iac/cli/commands/pulumi_stack_init/
  - /docs/reference/cli/pulumi_stack_init/
  - /docs/iac/cli/commands/pulumi_stack_create/
  - /docs/reference/cli/pulumi_stack_create/
  - /docs/iac/cli/commands/pulumi_stack_setup/
  - /docs/reference/cli/pulumi_stack_setup/
meta_desc: "Learn about the pulumi stack new command."
---
...
```
pulumi stack new [org-name/]<stack-name> [flags]
```
...
```
  ...
  -y, --yes                       Skip interactive prompts; fail if required information is missing
```
