...
```
  ...
  -h, --help                        help for azure
      ...
      --policy string               the role assigned per subscription: Contributor (required for Deployments), Reader (required for Discovery), or any other role definition ID; prompted for when omitted
