...
title: "pulumi package remove | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_package_remove/
  - /docs/iac/cli/commands/pulumi_package_rm/
  - /docs/reference/cli/pulumi_package_rm/
  - /docs/iac/cli/commands/pulumi_package_delete/
  - /docs/reference/cli/pulumi_package_delete/
meta_desc: "Learn about the pulumi package remove command."
---
...
```
pulumi package remove <source>/<publisher>/<name>@<version> [flags]
```
