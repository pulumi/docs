...
aliases:
  ...
  - /docs/iac/cli/commands/pulumi_esc/
  - /docs/reference/cli/pulumi_esc/
...
* [pulumi env list](/docs/iac/cli/commands/pulumi_env_list/)	 - List environments.
...
* [pulumi env remove](/docs/iac/cli/commands/pulumi_env_remove/)	 - Remove an environment or a value from an environment.
