...
```
  ...
  -h, --help                   help for aws
      ...
      --policy string          the policy attached to the OIDC role: AdministratorAccess (required for Deployments), ReadOnlyAccess (required for Discovery), or any other policy ARN; prompted for when omitted
