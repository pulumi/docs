...
```
  -h, --help                 help for gcp
      ...
      --policy string        the role granted to the service account: roles/editor (required for Deployments), roles/viewer (required for Discovery), or any other role; prompted for when omitted
