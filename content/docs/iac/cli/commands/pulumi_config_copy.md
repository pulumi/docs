...
title: "pulumi config copy | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_config_copy/
  - /docs/iac/cli/commands/pulumi_config_cp/
  - /docs/reference/cli/pulumi_config_cp/
meta_desc: "Learn about the pulumi config copy command."
---
