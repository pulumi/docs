...
* [pulumi config env list](/docs/iac/cli/commands/pulumi_config_env_list/)	 - Lists imported environments.
* [pulumi config env remove](/docs/iac/cli/commands/pulumi_config_env_remove/)	 - Remove environment from a stack
