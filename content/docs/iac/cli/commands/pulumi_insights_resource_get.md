...
Get a single resource discovered by Pulumi Insights
...
```
  ...
  -o, --output string    Output format. One of: default, json (default "default")
```
...
* [pulumi insights resource](/docs/iac/cli/commands/pulumi_insights_resource/)	 - Inspect resources discovered by Pulumi Insights
