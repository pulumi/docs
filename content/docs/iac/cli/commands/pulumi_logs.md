...
* [pulumi logs ls](/docs/iac/cli/commands/pulumi_logs_ls/)	 - List automatic log files
* [pulumi logs rm](/docs/iac/cli/commands/pulumi_logs_rm/)	 - Remove automatic log files
