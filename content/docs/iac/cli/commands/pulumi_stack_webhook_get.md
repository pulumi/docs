...
title: "pulumi stack webhook get | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_stack_webhook_get/
meta_desc: "Learn about the pulumi stack webhook get command."
---
...
```
pulumi stack webhook get <id> [flags]
```
