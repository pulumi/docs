...
* [pulumi stack list](/docs/iac/cli/commands/pulumi_stack_list/)	 - List stacks
* [pulumi stack migrate](/docs/iac/cli/commands/pulumi_stack_migrate/)	 - Migrate a stack from another backend to the currently logged-in backend
...
* [pulumi stack remove](/docs/iac/cli/commands/pulumi_stack_remove/)	 - Remove a stack and its configuration
