...
title: "pulumi env webhook rm | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_webhook_rm/
meta_desc: "Learn about the pulumi env webhook rm command."
---
...
```
pulumi env webhook rm [<org-name>/][<project-name>/]<environment-name> <webhook-name> [flags]
```
