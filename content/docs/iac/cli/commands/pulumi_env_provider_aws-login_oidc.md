...
title: "pulumi env provider aws-login oidc | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_provider_aws-login_oidc/
meta_desc: "Learn about the pulumi env provider aws-login oidc command."
---
...
```
pulumi env provider aws-login oidc [<org>/][<project>/]<environment-name> <role-arn> <session-name> [flags]
```
