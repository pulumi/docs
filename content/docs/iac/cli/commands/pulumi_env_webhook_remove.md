...
title: "pulumi env webhook remove | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_webhook_remove/
  - /docs/iac/cli/commands/pulumi_env_webhook_rm/
  - /docs/reference/cli/pulumi_env_webhook_rm/
  - /docs/iac/cli/commands/pulumi_env_webhook_delete/
  - /docs/reference/cli/pulumi_env_webhook_delete/
meta_desc: "Learn about the pulumi env webhook remove command."
---
...
```
pulumi env webhook remove [<org-name>/][<project-name>/]<environment-name> <webhook-name> [flags]
```
