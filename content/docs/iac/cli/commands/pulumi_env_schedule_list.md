...
title: "pulumi env schedule list | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_schedule_list/
  - /docs/iac/cli/commands/pulumi_env_schedule_ls/
  - /docs/reference/cli/pulumi_env_schedule_ls/
meta_desc: "Learn about the pulumi env schedule list command."
---
...
```
pulumi env schedule list [<org-name>/][<project-name>/]<environment-name> [flags]
```
