...
To use organization templates from the Private Registry:
* `pulumi new private/<org>/<template-name>` - Use the latest version
* `pulumi new private/<org>/<template-name>@1.0.0` - Use a specific version
