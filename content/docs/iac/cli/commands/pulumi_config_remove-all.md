...
title: "pulumi config remove-all | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_config_remove-all/
  - /docs/iac/cli/commands/pulumi_config_rm-all/
  - /docs/reference/cli/pulumi_config_rm-all/
  - /docs/iac/cli/commands/pulumi_config_delete-all/
  - /docs/reference/cli/pulumi_config_delete-all/
meta_desc: "Learn about the pulumi config remove-all command."
---
...
```
pulumi config remove-all <key>... [flags]
```

## Options

```
  -h, --help   help for remove-all
