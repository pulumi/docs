...
title: "pulumi env provider aws-login | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_provider_aws-login/
meta_desc: "Learn about the pulumi env provider aws-login command."
---
...
* [pulumi env provider aws-login oidc](/docs/iac/cli/commands/pulumi_env_provider_aws-login_oidc/)	 - Add an AWS OIDC login provider to an environment
* [pulumi env provider aws-login static](/docs/iac/cli/commands/pulumi_env_provider_aws-login_static/)	 - Add an AWS static-credentials login provider to an environment
