...
title: "pulumi env list | CLI commands"
aliases:
  - /docs/reference/cli/pulumi_env_list/
  - /docs/iac/cli/commands/pulumi_env_ls/
  - /docs/reference/cli/pulumi_env_ls/
meta_desc: "Learn about the pulumi env list command."
---
