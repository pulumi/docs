...
menu:
  iac:
    ...
    name: Azure
    identifier: iac-guides-clouds-azure
    weight: 2
aliases:
- /docs/integrations/clouds/azure/guides/
- /docs/integrations/clouds/azure/guides/providers/
- /docs/iac/clouds/azure/guides/
- /docs/iac/clouds/azure/guides/providers/
