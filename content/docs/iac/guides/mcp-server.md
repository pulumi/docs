...
2. Provide your [Pulumi access token](https://www.pulumi.com/docs/administration/access-identity/access-tokens/#creating-personal-access-tokens), which can be obtained from the Access tokens section in the sidebar of the Pulumi Console
3. Click "Enable"
