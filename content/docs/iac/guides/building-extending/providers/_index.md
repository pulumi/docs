...
- **Do you actually need a provider?** If your goal is to group resources into a reusable abstraction, reach for a [component](/docs/iac/guides/building-extending/components/build-a-component/) first. For one-off programmatic resources, a [dynamic provider](/docs/iac/concepts/providers/dynamic-providers/) may be simpler than a full provider package.
