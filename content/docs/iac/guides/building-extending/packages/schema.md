...
| `pluginDownloadURL` | `string`                                   | No       | PluginDownloadURL is the URL to use to acquire the provider plugin binary, if any. See [Authoring & Publishing](/docs/iac/guides/building-extending/packages/publishing-packages/#publish-your-package) for more details. |
...
|---------------------------------------------------------|----------------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| All [`ObjectType`](#objecttype) properties, as well as: |                                              |          |                                                                                                                                                                      |
| `inputProperties`                                       | [`map[Property]`](#property)                 | No       | InputProperties is a map from property name to Property that describes the resource's input properties.                                                              |
