...
There are some things that do not map cleanly between CloudFormation and Pulumi. These will have to be handled on a case by case basis.
...
### AWS::CloudFormation::Init and helper scripts
...
TODO: fill out some info on the import.json file.
