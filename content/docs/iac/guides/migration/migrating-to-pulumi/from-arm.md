...
* **[Discovered Stacks](/docs/discovery-governance/discovery/discovered-stacks/)**: Scan your Azure account and Pulumi Cloud automatically groups your ARM resources by resource group into discovered stacks you can migrate from the console, with per-resource status tracking.
...
1. **Prerequisites**:
   * Install the [Pulumi GitHub app](/docs/integrations/version-control/github-app/) with access to your repository that contains your ARM template files
