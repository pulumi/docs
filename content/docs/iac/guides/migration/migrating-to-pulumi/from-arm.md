...
* **[Discovered stacks](/docs/discovery-governance/concepts/discovered-stacks/)**: Scan your Azure account and Pulumi Cloud automatically groups your ARM resources by resource group into discovered stacks you can migrate from the console, with per-resource status tracking.
