...
1. **Prerequisites**:
    * Install the [Pulumi GitHub app](/docs/integrations/version-control/github-app/) with access to your repository
...
* **[Policy as code](/docs/discovery-governance/concepts/policy-as-code/)**: enforce compliance and security rules across all your infrastructure
* **Multi-cloud support**: use the same tool and workflows across AWS, Azure, Google Cloud, and [hundreds of providers](/registry/)
