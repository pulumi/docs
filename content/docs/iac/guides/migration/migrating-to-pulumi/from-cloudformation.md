...
* **[Discovered Stacks](/docs/discovery-governance/discovery/discovered-stacks/)**: Scan your AWS account and Pulumi Cloud automatically groups your CloudFormation stacks into discovered stacks you can migrate from the console, with per-resource status tracking.
