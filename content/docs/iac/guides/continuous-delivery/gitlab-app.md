...
1. [Generate a Pulumi](https://www.pulumi.com/docs/administration/access-identity/access-tokens/) token using the account that you would like to post the merge request notes. Save this token as we will use this momentarily in a following step.
