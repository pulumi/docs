...
In the [`pulumi/pulumi`](https://github.com/pulumi/pulumi) repo the [`sdk/go/common/util/ciutil`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil) package contains all of the logic necessary for the above. Every stack `preview` or `update` calls the functions exported from this package.

### Detecting the CI system

- Add an entry to the `detectors` slice in [`detect.go`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil/detect.go) where all of the CI systems are registered.
...
- Add a new file to the [`sdk/go/common/util/ciutil`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil) folder with the name of the CI system for which you are adding support.
- Define a new struct for the CI system and embed `baseCI` in its definition. Refer to any of the pre-existing implementations, such as the [`travis.go`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil/travis.go) file.
...
You can also find these variables in the [`generic.go`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil/generic.go) file in the [`sdk/go/common/util/ciutil`](https://github.com/pulumi/pulumi/blob/5f23ee4dc81a96b08cafeb77da048728beda2531/sdk/go/common/util/ciutil) folder.
