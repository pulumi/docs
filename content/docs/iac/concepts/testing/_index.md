...
[**Learn more and get started with Unit Testing**](/docs/iac/concepts/testing/unit).

## Property Testing

Property tests are based on [Policy as Code](/docs/iac/packages-and-automation/crossguard/) (also known as "CrossGuard"), Pulumi's offering to set guardrails and enforce compliance for cloud resources. In addition to authoring company-wide policies, CrossGuard enables another type of infrastructure testing. Each policy becomes a property, an invariant, that a test evaluates and asserts.
...
[**Learn more and get started with Property Testing**](/docs/iac/concepts/testing/property-testing).
...
[**Learn more and get started with Integration Testing**](/docs/iac/concepts/testing/integration).
