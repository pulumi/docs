...
In addition to the packages in the Pulumi Registry, you can write your own [components](/docs/iac/concepts/components/) and distribute them as resource plugins, enabling consumption in any Pulumi language. Components can be published to [Pulumi IDP](/docs/idp/) for discoverability within your organization or shared directly via Git references.
