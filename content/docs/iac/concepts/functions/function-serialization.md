...
{{% notes "warning" %}}
Function serialization is not supported when using Bun as the TypeScript/JavaScript runtime. If your program uses magic functions or function serialization, use Node.js instead.
{{% /notes %}}
