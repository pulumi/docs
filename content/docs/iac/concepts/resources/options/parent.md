...
* [`provider`](/docs/iac/concepts/resources/options/provider/): Child resources inherit their parent's provider in order to ensure that child resources are created in the same cloud context (account, region, etc.) as their parent.
