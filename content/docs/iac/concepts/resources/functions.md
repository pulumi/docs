...
Provider functions are exposed in each language as regular functions, in two variations:
 ...
 1. The **output form** accepts Pulumi Inputs as arguments and returns a Pulumi as a result. For more information on these types, see [Inputs and Outputs](/docs/concepts/inputs-outputs/).
