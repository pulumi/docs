...
If you haven't written much code in one of these languages, [Language Essentials](/docs/iac/guides/language-essentials/) translates the HCL you already know into the small set of constructs a Pulumi program actually uses.
