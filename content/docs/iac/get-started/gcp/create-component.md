...
To deploy the componentized version, run `pulumi up` again. Just like before, you'll see a preview before any changes
are applied. Choosing `yes` will deploy the component's resources and export the website URL, which you can then access.
