...
meta_desc: Deploy an NGINX web server to Kubernetes with Pulumi in TypeScript, Python, Go, C#, Java, YAML, or HCL. Step-by-step tutorial with no cluster required to start.
title: Kubernetes
