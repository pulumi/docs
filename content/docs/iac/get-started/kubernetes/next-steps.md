...
Learn how Pulumi works from its architecture to key concepts, including [stacks](/docs/concepts/stack/), [state](/docs/iac/concepts/state-and-backends/), [configuration](/docs/concepts/config/), and [secrets](/docs/concepts/secrets/).
