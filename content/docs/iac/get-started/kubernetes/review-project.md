---
title_tag: Review the Project | Kubernetes
title: Review the project files
h1: "Review the project files"
meta_desc: This page walks through the files in a newly created Kubernetes + Pulumi project.
weight: 5
menu:
    iac:
...
- <span>{{< langfile >}}</span> contains your program, which declares an NGINX deployment
