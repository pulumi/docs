...
| Policy as code | Built-in ([Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/)) | Sentinel/OPA (HCP Terraform or separate tooling) | CloudFormation Guard, cdk-nag (separate tooling) |
