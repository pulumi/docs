...
| Policy as code | [Pulumi Policies](/docs/discovery-governance/concepts/policy-as-code/) in Python, TypeScript, or Open Policy Agent Rego; open source, with centralized management and [compliance packs](/docs/discovery-governance/guides/pre-built-policy-packs/) in Pulumi Cloud | [Rego policies](https://docs.spacelift.io/concepts/policy/) evaluated at multiple decision points — login, access, approval, plan, push, trigger, and notification |
