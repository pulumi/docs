...
The Pulumi CLI and SDKs are open source under Apache 2.0 and free to use. [Pulumi Cloud](/docs/iac/concepts/pulumi-cloud/) includes managed state in its Free edition. Paid editions add multi-user collaboration, RBAC, audit logs, and policy management. Crossplane itself is free under Apache 2.0; managed control planes and an enterprise distribution are sold separately by Upbound.
