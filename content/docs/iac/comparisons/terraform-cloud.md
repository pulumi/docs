...
* Search every Terraform-managed resource in [Pulumi Insights](/docs/discovery-governance/) next to your Pulumi-managed ones.
...
| Estate visibility | [Pulumi Insights](/docs/discovery-governance/) inventories every resource across every provider, however it was provisioned, including resources in Terraform-backed stacks | No equivalent; visibility is scoped to what's tracked in HCP Terraform workspaces |
