...
| --- | --- | --- |
| Language support | {{< pulumi-languages >}} — general-purpose languages with familiar syntax for loops, conditionals, and abstractions | TypeScript, JavaScript, Python, Go, C#, and Java |
