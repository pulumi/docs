...
| --- | --- | --- |
| Language support | Python, TypeScript, JavaScript, Go, .NET, Java, YAML, and HCL — general-purpose languages with familiar syntax for loops, conditionals, and abstractions | TypeScript, JavaScript, Python, Go, C#, and Java |
