---
title_tag: "Troubleshooting CI/CD"
...
menu:
    iac:
        ...
        weight: 80
        identifier: iac-operations-troubleshooting-cicd
aliases:
...
* Ensure that the account represented by the token you are using has access to the stack.
  ...
  One way to check this is, that you are able to navigate to the stack in the [Pulumi Cloud](https://app.pulumi.com/signin) using the same account you are using in CI.
