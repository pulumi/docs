...
For a complete worked example that provisions resources, moves them between two stacks in different projects, and updates the program code on both sides, see the [Move Resources Between Stacks](/dev/tutorials/move-resources-between-stacks/) tutorial. For the motivation behind splitting a monolithic stack in the first place, see [Organizing projects & stacks](/docs/iac/guides/basics/organizing-projects-stacks/).
...
* [Move Resources Between Stacks](/dev/tutorials/move-resources-between-stacks/) — a full tutorial covering this workflow end to end, including cross-project moves and resolving dependencies with stack references.
