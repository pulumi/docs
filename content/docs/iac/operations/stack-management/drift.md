...
- [Components](/docs/iac/concepts/components/), [Pulumi IDP](/docs/idp/), and [Pulumi Policy](/docs/discovery-governance/concepts/policy-as-code/) — codify best practices to reduce the rate at which drift is introduced.
