...
- **[IaC providers](/docs/esc/providers/iac/)** — import the outputs of an existing Pulumi stack or Terraform state file into your environment, so stacks and teams can share values without copying them by hand.
