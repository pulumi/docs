...
Then, open your first environment (e.g. `my-project/dev-environment`) via Pulumi Cloud or the Pulumi CLI and add the following configuration to the top of your file:
...
{{% notes type="info" %}}
To test this, try retrieving the imported value via the console or CLI. See [Managing secrets](/docs/esc/operations/managing-secrets/#retrieving-secrets) for details on retrieving values.
{{% /notes %}}
...
- [Managing secrets](/docs/esc/operations/managing-secrets/) - Learn more about storing and retrieving values
