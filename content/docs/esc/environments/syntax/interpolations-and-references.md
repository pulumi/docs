...
In the context of ESC, references either refer to properties in the evaluated environment in which they are contained or to [built-in properties](/docs/esc/environments/syntax/builtin-properties).
...
Interpolations evaluate to the [string representation](/docs/esc/environments/syntax/builtin-functions/fn-to-string) of the referenced value.
