...
{{< video title="Creating a global config environment in the Pulumi Console" src="../assets/esc-create-global-config.mp4" autoplay="true" loop="true" >}}
...
{{< video title="Importing the global config environment in the Pulumi Console" src="../assets/esc-import-global-config.mp4" autoplay="true" loop="true" >}}
...
{{< video title="Importing the global config environment in the Pulumi Console" src="../assets/esc-add-import-table-view.mp4" autoplay="true" loop="true" >}}
