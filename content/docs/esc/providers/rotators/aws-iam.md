...
The `aws-iam` rotator enables you to rotate access credentials for an AWS IAM user in your Environment. Check out the [aws-login documentation](/docs/esc/providers/login/aws-login/) to learn more about authenticating with AWS.
