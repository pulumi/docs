...
{{% notes type="info" %}}
This is different from installing the Pulumi GitHub App for Deployments and CI/CD integration, which should be installed according to the instructions in the [GitHub App documentation](/docs/iac/integrations/github-app/#installation-and-configuration).
{{% /notes %}}
