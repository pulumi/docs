...
to connect to an AWS EKS cluster using AWS OIDC credentials returned by the [aws-login](/docs/esc/integrations/dynamic-login-credentials/aws-login/) provider.
