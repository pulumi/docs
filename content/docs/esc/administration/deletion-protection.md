...
error: cannot delete environment: deletion protection is enabled. Disable deletion protection with 'pulumi env settings set myorg/myproject/prod deletion-protected false' before deleting
```
