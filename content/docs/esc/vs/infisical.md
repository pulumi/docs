...
There are a couple of fundamental differences between Infisical and Pulumi ESC. First, ESC and Infisical differ in that Infisical can only add and manage secrets stored in Infisical. ESC adopts a truly open ecosystem approach, allowing you to pull secrets stored in most secret and password managers during runtime and use them anywhere. This reduces the time to take full inventory of your secrets across your organization , enabling you to utilize the best solution for the purpose.  Second, the composability and hierarchical nature of ESC offers a familiar and powerful experience for users, reducing duplication and allowing them to get up and running quickly. Third, ESC takes a software engineering approach to versioning with ability to add tags and import specific collections of secrets and configuration via those tags, similar to Docker. Fourth, ESC takes a secure limited privilege path to provisioning dynamic short-term credentials compared to Infisical.
