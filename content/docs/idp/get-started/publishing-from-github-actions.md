...
- **Deployment Hooks**: Set up Pulumi Cloud [webhooks](/docs/platform/deployments/using/triggers/#deployment-webhooks) to trigger deployments when new component versions are published
