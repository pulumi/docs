...
menu:
  platform:
    ...
    weight: 40
    identifier: platform-pulumi-button
aliases:
...
To learn more about building your own custom templates, see [Custom Templates](/docs/platform/developer-platforms/templates).
