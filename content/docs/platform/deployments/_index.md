...
- **Zero Touch CI/CD**: App teams can select a template from Pulumi Cloud's [New Project Wizard](/docs/platform/developer-platforms/new-project-wizard) and deploy infrastructure in minutes. Learn how with our [Getting Started guide](/docs/platform/deployments/get-started).
...
1. Create a new project using the Pulumi Cloud [New Project Wizard](/docs/platform/developer-platforms/new-project-wizard), which will automatically configure Deployments for your repository
