...
This guide describes how to start using Pulumi Deployments with a new Pulumi IaC project created via the Pulumi Cloud [New Project Wizard](/docs/platform/developer-platforms/new-project-wizard/).
...
{{% notes "info" %}}
If you select "Use a template" and your Pulumi administrator has configured [custom templates](/docs/platform/developer-platforms/templates) for your organization, you will be able to choose from your organization's custom templates in a later step.
...
This section allows you to provide values for any necessary configuration if you're using a [template](/docs/platform/developer-platforms/templates) that declares required configuration keys.
