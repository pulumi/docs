...
* [pulumi package gen-sdk](/docs/reference/cli/pulumi_package_gen-sdk/)	 - Generate SDK(s) from a package or schema
* [pulumi package get-schema](/docs/reference/cli/pulumi_package_get-schema/)	 - Get the schema.json from a package
