...
meta_desc: "Explore the GetImage function of the DigitalOcean package, including examples, input properties, output properties, and supporting types. "
---
