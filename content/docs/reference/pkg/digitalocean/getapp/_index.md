...
<a href="#domains_csharp" style="color: inherit; text-decoration: inherit;">Domains</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}This attribute has been replaced by `domain` which supports additional functionality.{{% /md %}}</p></dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
