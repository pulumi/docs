...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the VolumeSnapshot resource produces the following computed outputs.
