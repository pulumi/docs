...
meta_desc: "Explore the GetDomain function of the DigitalOcean package, including examples, input properties, output properties, and supporting types. "
---
