...
meta_desc: "Explore the CustomImage resource of the DigitalOcean package, including examples, input properties, output properties, lookup functions, and supporting types. Provides a resource which can be used to create a custom Image from a URL"
---
