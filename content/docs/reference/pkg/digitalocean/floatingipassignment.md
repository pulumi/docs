...
All [input](#inputs) properties are implicitly available as output properties. The FloatingIpAssignment resource does not produce any additional output properties.
