...
<a href="#maintenancepolicies_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getkubernetesclustermaintenancepolicy">List&lt;Pulumi.<wbr>Digital<wbr>Ocean.<wbr>Outputs.<wbr>Get<wbr>Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy&gt;</a></span>
    </dt>
    <dd>{{% md %}}The maintenance policy of the Kubernetes cluster. Digital Ocean has a default maintenancen window.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<a href="#maintenancepolicies_go" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getkubernetesclustermaintenancepolicy">[]Get<wbr>Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}The maintenance policy of the Kubernetes cluster. Digital Ocean has a default maintenancen window.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#maintenance_policies_python" style="color: inherit; text-decoration: inherit;">maintenance_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getkubernetesclustermaintenancepolicy">Sequence[Get<wbr>Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy]</a></span>
    </dt>
    <dd>{{% md %}}The maintenance policy of the Kubernetes cluster. Digital Ocean has a default maintenancen window.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<h4 id="getkubernetesclustermaintenancepolicy">Get<wbr>Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy</h4>
...
<a href="#day_csharp" style="color: inherit; text-decoration: inherit;">Day</a>
    ...
    <dd>{{% md %}}The day for the service window of the Kubernetes cluster.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#duration_csharp" style="color: inherit; text-decoration: inherit;">Duration</a>
    ...
    <dd>{{% md %}}The duration of the operation.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The start time of the upgrade operation.
{{% /md %}}</dd></dl>
{{% /choosable %}}
