...
title_tag: "digitalocean.getLoadBalancer"
meta_desc: "Documentation for the digitalocean.getLoadBalancer function with examples, input properties, output properties, and supporting types."
---
