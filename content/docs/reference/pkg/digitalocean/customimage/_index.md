...
<a href="#distribution_csharp" style="color: inherit; text-decoration: inherit;">Distribution</a>
    ...
    <dd>{{% md %}}An optional distribution name for the image. Valid values are documented [here](https://docs.digitalocean.com/reference/api/api-reference/#operation/create_custom_image)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
