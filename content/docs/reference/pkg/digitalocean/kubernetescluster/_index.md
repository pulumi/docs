...
<a href="#maintenancepolicy_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermaintenancepolicy">Pulumi.<wbr>Digital<wbr>Ocean.<wbr>Inputs.<wbr>Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}A block representing the cluster's maintenance window. Updates will be applied within this window. If not specified, a default maintenance window will be chosen. `auto_upgrade` must be set to `true` for this to have an effect.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a href="#maintenancepolicy_go" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermaintenancepolicy">Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}A block representing the cluster's maintenance window. Updates will be applied within this window. If not specified, a default maintenance window will be chosen. `auto_upgrade` must be set to `true` for this to have an effect.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">node_pool</span><span class="p">:</span> <span class="nx">Optional[KubernetesClusterNodePoolArgs]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[Union[str, Region]]</span> = None<span class="p">,</span>
        <span class="nx">service_subnet</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<h4 id="kubernetesclustermaintenancepolicy">Kubernetes<wbr>Cluster<wbr>Maintenance<wbr>Policy</h4>
...
<a href="#day_csharp" style="color: inherit; text-decoration: inherit;">Day</a>
    ...
    <dd>{{% md %}}The day of the maintenance window policy. May be one of "monday" through "sunday", or "any" to indicate an arbitrary week day.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The start time in UTC of the maintenance window policy in 24-hour clock format / HH:MM notation (e.g., 15:00).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodes_csharp" style="color: inherit; text-decoration: inherit;">Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusternodepoolnode">List&lt;Pulumi.<wbr>Digital<wbr>Ocean.<wbr>Inputs.<wbr>Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Node&gt;</a></span>
    </dt>
...
<a href="#taints_csharp" style="color: inherit; text-decoration: inherit;">Taints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusternodepooltaint">List&lt;Pulumi.<wbr>Digital<wbr>Ocean.<wbr>Inputs.<wbr>Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Taint&gt;</a></span>
    </dt>
    <dd>{{% md %}}A block representing a taint applied to all nodes in the pool. Each taint exports the following attributes (taints must be unique by key and effect pair):
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#taints_go" style="color: inherit; text-decoration: inherit;">Taints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusternodepooltaint">[]Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Taint</a></span>
    </dt>
    <dd>{{% md %}}A block representing a taint applied to all nodes in the pool. Each taint exports the following attributes (taints must be unique by key and effect pair):
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodes_python" style="color: inherit; text-decoration: inherit;">nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusternodepoolnode">Sequence[Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Node]</a></span>
    </dt>
    <dd>{{% md %}}A list of nodes in the pool. Each node exports the following attributes:
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#taints_python" style="color: inherit; text-decoration: inherit;">taints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusternodepooltaint">Sequence[Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Taint]</a></span>
    </dt>
    <dd>{{% md %}}A block representing a taint applied to all nodes in the pool. Each taint exports the following attributes (taints must be unique by key and effect pair):
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="kubernetesclusternodepooltaint">Kubernetes<wbr>Cluster<wbr>Node<wbr>Pool<wbr>Taint</h4>
