...
<span class="k">def </span><span class="nx">Policy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">policy</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PolicyPolicyArgs]]</span> = None<span class="p">,</span>
...
<a href="#policy_nodejs" style="color: inherit; text-decoration: inherit;">policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypolicy">pulumi<wbr>Input<Policy<wbr>Policy<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The settings of the policy. The structure is
described below.
{{% /md %}}</dd><dt class="property-required"
...
<a href="#policy_python" style="color: inherit; text-decoration: inherit;">policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policypolicy">Input[Policy<wbr>Policy<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The settings of the policy. The structure is
described below.
{{% /md %}}</dd><dt class="property-required"
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">policy</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PolicyPolicyArgs]]</span> = None<span class="p">,</span>
        <span class="nx">vhost</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> Policy</code></pre></div>
{{% /choosable %}}
