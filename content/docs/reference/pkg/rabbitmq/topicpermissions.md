...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">TopicPermissions</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>permissions=None<span class="p">, </span>user=None<span class="p">, </span>vhost=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
The TopicPermissions resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
