...
<dl class="resources-properties">
    ...
    <dd>{{% md %}}Auth backend to which user mapping will be congigured.
{{% /md %}}</dd>
    ...
    <dd>{{% md %}}Policies to be assigned to this user.
{{% /md %}}</dd>
