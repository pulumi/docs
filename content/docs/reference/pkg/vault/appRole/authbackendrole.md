...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}use `secret_id_bound_cidrs` instead{{% /md %}}</p></dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
