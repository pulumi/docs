...
<a href="#mongodbatlas_csharp" style="color: inherit; text-decoration: inherit;">Mongodbatlas</a>
    ...
    <dd>{{% md %}}A nested block containing configuration options for MongoDB Atlas connections.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privatekey_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Key</a>
    ...
    <dd>{{% md %}}The Private Programmatic API Key used to connect with MongoDB Atlas API.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
    ...
    <dd>{{% md %}}The Project ID the Database User should be created within.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#publickey_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Key</a>
    ...
    <dd>{{% md %}}The Public Programmatic API Key used to authenticate with the MongoDB Atlas API.
{{% /md %}}</dd></dl>
{{% /choosable %}}
