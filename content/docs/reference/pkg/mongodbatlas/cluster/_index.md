...
<span class="k">def </span><span class="nx">Cluster</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">bi_connector</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">cloud_backup</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
<a href="#backupenabled_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Clusters running MongoDB FCV 4.2 or later and any new Atlas clusters of any type do not support this parameter
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudbackup_csharp">
<a href="#cloudbackup_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#pitenabled_csharp" style="color: inherit; text-decoration: inherit;">Pit<wbr>Enabled</a>
    ...
    <dd>{{% md %}}- Flag that indicates if the cluster uses Continuous Cloud Backup. If set to true, cloud_backup must also be set to true.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#providerbackupenabled_csharp" style="color: inherit; text-decoration: inherit;">Provider<wbr>Backup<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Flag indicating if the cluster uses Cloud Backup for backups. **Deprecated** use `cloud_backup` instead.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}This field is deprecated,please use cloud_backup instead{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudbackup_go">
<a href="#cloudbackup_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudbackup_nodejs">
<a href="#cloudbackup_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloud_backup_python">
<a href="#cloud_backup_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#connectionstrings_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">List&lt;Cluster<wbr>Connection<wbr>String&gt;</a></span>
    </dt>
...
<a href="#connectionstrings_go" style="color: inherit; text-decoration: inherit;">Connection<wbr>Strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">[]Cluster<wbr>Connection<wbr>String</a></span>
    </dt>
    <dd>{{% md %}}Set of connection strings that your applications use to connect to this cluster. More info in [Connection-strings](https://docs.mongodb.com/manual/reference/connection-string/). Use the parameters in this object to connect your applications to this cluster. To learn more about the formats of connection strings, see [Connection String Options](https://docs.atlas.mongodb.com/reference/faq/connection-changes/). NOTE: Atlas returns the contents of this object after the cluster is operational, not while it builds the cluster.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connection_strings_python" style="color: inherit; text-decoration: inherit;">connection_<wbr>strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">Sequence[Cluster<wbr>Connection<wbr>String]</a></span>
    </dt>
    <dd>{{% md %}}Set of connection strings that your applications use to connect to this cluster. More info in [Connection-strings](https://docs.mongodb.com/manual/reference/connection-string/). Use the parameters in this object to connect your applications to this cluster. To learn more about the formats of connection strings, see [Connection String Options](https://docs.atlas.mongodb.com/reference/faq/connection-changes/). NOTE: Atlas returns the contents of this object after the cluster is operational, not while it builds the cluster.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">cluster_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">connection_strings</span><span class="p">:</span> <span class="nx">Optional[Sequence[ClusterConnectionStringArgs]]</span> = None<span class="p">,</span>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_cloudbackup_csharp">
<a href="#state_cloudbackup_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#state_connectionstrings_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">List&lt;Cluster<wbr>Connection<wbr>String<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Set of connection strings that your applications use to connect to this cluster. More info in [Connection-strings](https://docs.mongodb.com/manual/reference/connection-string/). Use the parameters in this object to connect your applications to this cluster. To learn more about the formats of connection strings, see [Connection String Options](https://docs.atlas.mongodb.com/reference/faq/connection-changes/). NOTE: Atlas returns the contents of this object after the cluster is operational, not while it builds the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_cloudbackup_go">
<a href="#state_cloudbackup_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#state_connectionstrings_go" style="color: inherit; text-decoration: inherit;">Connection<wbr>Strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">[]Cluster<wbr>Connection<wbr>String<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Set of connection strings that your applications use to connect to this cluster. More info in [Connection-strings](https://docs.mongodb.com/manual/reference/connection-string/). Use the parameters in this object to connect your applications to this cluster. To learn more about the formats of connection strings, see [Connection String Options](https://docs.atlas.mongodb.com/reference/faq/connection-changes/). NOTE: Atlas returns the contents of this object after the cluster is operational, not while it builds the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_cloudbackup_nodejs">
<a href="#state_cloudbackup_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_cloud_backup_python">
<a href="#state_cloud_backup_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>backup</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#state_connection_strings_python" style="color: inherit; text-decoration: inherit;">connection_<wbr>strings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstring">Sequence[Cluster<wbr>Connection<wbr>String<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Set of connection strings that your applications use to connect to this cluster. More info in [Connection-strings](https://docs.mongodb.com/manual/reference/connection-string/). Use the parameters in this object to connect your applications to this cluster. To learn more about the formats of connection strings, see [Connection String Options](https://docs.atlas.mongodb.com/reference/faq/connection-changes/). NOTE: Atlas returns the contents of this object after the cluster is operational, not while it builds the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="clusterconnectionstring">Cluster<wbr>Connection<wbr>String</h4>
...
<a href="#privateendpoints_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpoint">List&lt;Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privateendpoints_go" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpoint">[]Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#private_endpoints_python" style="color: inherit; text-decoration: inherit;">private_<wbr>endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpoint">Sequence[Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="clusterconnectionstringprivateendpoint">Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint</h4>
...
<a href="#endpoints_csharp" style="color: inherit; text-decoration: inherit;">Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpointendpoint">List&lt;Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint<wbr>Endpoint&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#endpoints_go" style="color: inherit; text-decoration: inherit;">Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpointendpoint">[]Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint<wbr>Endpoint</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#endpoints_python" style="color: inherit; text-decoration: inherit;">endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterconnectionstringprivateendpointendpoint">Sequence[Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint<wbr>Endpoint]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="clusterconnectionstringprivateendpointendpoint">Cluster<wbr>Connection<wbr>String<wbr>Private<wbr>Endpoint<wbr>Endpoint</h4>
...
<a href="#regions_configs_python" style="color: inherit; text-decoration: inherit;">regions_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterreplicationspecregionsconfig">Sequence[Cluster<wbr>Replication<wbr>Spec<wbr>Regions<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}Physical location of the region. Each regionsConfig document describes the region’s priority in elections and the number and type of MongoDB nodes Atlas deploys to the region. You must order each regionsConfigs document by regionsConfig.priority, descending. See Region Config below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#policies_python" style="color: inherit; text-decoration: inherit;">policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustersnapshotbackuppolicypolicy">Sequence[Cluster<wbr>Snapshot<wbr>Backup<wbr>Policy<wbr>Policy]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#policy_items_python" style="color: inherit; text-decoration: inherit;">policy_<wbr>items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustersnapshotbackuppolicypolicypolicyitem">Sequence[Cluster<wbr>Snapshot<wbr>Backup<wbr>Policy<wbr>Policy<wbr>Policy<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
