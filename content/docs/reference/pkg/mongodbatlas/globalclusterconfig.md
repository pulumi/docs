...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/mongodbatlas/#GlobalClusterConfig">GlobalClusterConfig</a></span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>cluster_name=None<span class="p">, </span>custom_zone_mappings=None<span class="p">, </span>managed_namespaces=None<span class="p">, </span>project_id=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
