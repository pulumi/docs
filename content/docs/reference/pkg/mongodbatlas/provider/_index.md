...
<span class="k">def </span><span class="nx">Provider</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">realm_base_url</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span>
...
<a href="#baseurl_csharp" style="color: inherit; text-decoration: inherit;">Base<wbr>Url</a>
    ...
    <dd>{{% md %}}MongoDB Atlas Base URL
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="realmbaseurl_csharp">
<a href="#realmbaseurl_csharp" style="color: inherit; text-decoration: inherit;">Realm<wbr>Base<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}MongoDB Realm Base URL
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="realmbaseurl_go">
<a href="#realmbaseurl_go" style="color: inherit; text-decoration: inherit;">Realm<wbr>Base<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="realmbaseurl_nodejs">
<a href="#realmbaseurl_nodejs" style="color: inherit; text-decoration: inherit;">realm<wbr>Base<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="realm_base_url_python">
<a href="#realm_base_url_python" style="color: inherit; text-decoration: inherit;">realm_<wbr>base_<wbr>url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
