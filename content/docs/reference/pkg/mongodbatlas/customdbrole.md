...
<span class="k">def </span><span class="nx">CustomDbRole</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">actions</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[CustomDbRoleActionArgs]]]]</span> = None<span class="p">,</span>
                 <span class="nx">inherited_roles</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[CustomDbRoleInheritedRoleArgs]]]]</span> = None<span class="p">,</span>
...
The CustomDbRole resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#actions_nodejs" style="color: inherit; text-decoration: inherit;">actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleaction">pulumi<wbr>Input<pulumi<wbr>Input<Custom<wbr>Db<wbr>Role<wbr>Action<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inheritedroles_nodejs" style="color: inherit; text-decoration: inherit;">inherited<wbr>Roles</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleinheritedrole">pulumi<wbr>Input<pulumi<wbr>Input<Custom<wbr>Db<wbr>Role<wbr>Inherited<wbr>Role<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#actions_python" style="color: inherit; text-decoration: inherit;">actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleaction">Input[Custom<wbr>Db<wbr>Role<wbr>Action<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inherited_roles_python" style="color: inherit; text-decoration: inherit;">inherited_<wbr>roles</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleinheritedrole">Input[Custom<wbr>Db<wbr>Role<wbr>Inherited<wbr>Role<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">inherited_roles</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[CustomDbRoleInheritedRoleArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">project_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">role_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> CustomDbRole</code></pre></div>
{{% /choosable %}}
...
<a href="#resources_nodejs" style="color: inherit; text-decoration: inherit;">resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleactionresource">pulumi<wbr>Input<pulumi<wbr>Input<Custom<wbr>Db<wbr>Role<wbr>Action<wbr>Resource<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Contains information on where the action is granted. Each object in the array either indicates a database and collection on which the action is granted, or indicates that the action is granted on the cluster resource.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#resources_python" style="color: inherit; text-decoration: inherit;">resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdbroleactionresource">Input[Custom<wbr>Db<wbr>Role<wbr>Action<wbr>Resource<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Contains information on where the action is granted. Each object in the array either indicates a database and collection on which the action is granted, or indicates that the action is granted on the cluster resource.
{{% /md %}}</dd></dl>
{{% /choosable %}}
