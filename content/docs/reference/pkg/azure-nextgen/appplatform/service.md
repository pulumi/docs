...
meta_desc: "Documentation for the azure-nextgen.appplatform.Service resource with examples, input properties, output properties, lookup functions, and supporting types."
---
