...
title_tag: "azure-nextgen.dbforpostgresql.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-nextgen.dbforpostgresql.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
private_endpoint_connection = azure_nextgen.dbforpostgresql.PrivateEndpointConnection("privateEndpointConnection",
    ...
    private_link_service_connection_state=azure_nextgen.dbforpostgresql.PrivateLinkServiceConnectionStatePropertyArgs(
        description="Approved by johndoe@contoso.com",
        status="Approved",
    ),
...
```sh
$ pulumi import azure-nextgen:dbforpostgresql:PrivateEndpointConnection private-endpoint-connection-name /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.DBforPostgreSQL/servers/test-svr/privateEndpointConnections/private-endpoint-connection-name 
```
