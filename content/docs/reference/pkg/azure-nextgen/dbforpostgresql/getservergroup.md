...
---
title: "GetServerGroup"
title_tag: "Function GetServerGroup | Module dbforpostgresql | Package Azure NextGen"
meta_desc: "Explore the GetServerGroup function of the dbforpostgresql module, including examples, input properties, output properties, and supporting types. "
---
...
## Using GetServerGroup {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getServerGroup<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetServerGroupArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetServerGroupResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_server_group(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">server_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetServerGroupResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupServerGroup<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupServerGroupArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupServerGroupResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetServerGroup </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetServerGroupResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetServerGroupArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#delegatedsubnetarguments_csharp" style="color: inherit; text-decoration: inherit;">Delegated<wbr>Subnet<wbr>Arguments</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servergrouppropertiesresponsedelegatedsubnetarguments">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>DBfor<wbr>Postgre<wbr>SQL.<wbr>Outputs.<wbr>Server<wbr>Group<wbr>Properties<wbr>Response<wbr>Delegated<wbr>Subnet<wbr>Arguments</a></span>
    </dt>
...
<a href="#maintenancewindow_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maintenancewindowresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>DBfor<wbr>Postgre<wbr>SQL.<wbr>Outputs.<wbr>Maintenance<wbr>Window<wbr>Response</a></span>
    </dt>
...
<a href="#serverrolegroups_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Role<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverrolegroupresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>DBfor<wbr>Postgre<wbr>SQL.<wbr>Outputs.<wbr>Server<wbr>Role<wbr>Group<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#delegatedsubnetarguments_go" style="color: inherit; text-decoration: inherit;">Delegated<wbr>Subnet<wbr>Arguments</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servergrouppropertiesresponsedelegatedsubnetarguments">Server<wbr>Group<wbr>Properties<wbr>Response<wbr>Delegated<wbr>Subnet<wbr>Arguments</a></span>
    </dt>
    <dd>{{% md %}}The delegated subnet arguments for a server group.{{% /md %}}</dd>
    <dt class="property-"
            title="">
...
<a href="#serverrolegroups_go" style="color: inherit; text-decoration: inherit;">Server<wbr>Role<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverrolegroupresponse">[]Server<wbr>Role<wbr>Group<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The list of server role groups.{{% /md %}}</dd>
    <dt class="property-"
            title="">
...
<a href="#server_role_groups_python" style="color: inherit; text-decoration: inherit;">server_<wbr>role_<wbr>groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverrolegroupresponse">Sequence[Server<wbr>Role<wbr>Group<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The list of server role groups.{{% /md %}}</dd>
    <dt class="property-"
            title="">
