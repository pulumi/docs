...
title_tag: "azure-nextgen.insights.ManagementGroupDiagnosticSetting"
meta_desc: "Documentation for the azure-nextgen.insights.ManagementGroupDiagnosticSetting resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var managementGroupDiagnosticSetting = new AzureNextGen.Insights..ManagementGroupDiagnosticSetting("managementGroupDiagnosticSetting", new AzureNextGen.Insights..ManagementGroupDiagnosticSettingArgs
        {
            ...
            Logs = 
            {
                new AzureNextGen.Insights..Inputs.ManagementGroupLogSettingsArgs
                {
...
management_group_diagnostic_setting = azure_nextgen.insights.ManagementGroupDiagnosticSetting("managementGroupDiagnosticSetting",
    ...
    logs=[
        azure_nextgen.insights.ManagementGroupLogSettingsArgs(
            category="Administrative",
            enabled=True,
        ),
        azure_nextgen.insights.ManagementGroupLogSettingsArgs(
...
const managementGroupDiagnosticSetting = new azure_nextgen.insights.ManagementGroupDiagnosticSetting("managementGroupDiagnosticSetting", {
    eventHubAuthorizationRuleId: "/subscriptions/fb9f25f9-5785-4510-a38f-a62f188eb9f8/resourceGroups/montest/providers/microsoft.eventhub/namespaces/mynamespace/eventhubs/myeventhub/authorizationrules/myrule",
    eventHubName: "myeventhub",
    logs: [
        {
...
<a href="#logs_csharp" style="color: inherit; text-decoration: inherit;">Logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managementgrouplogsettings">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Insights..<wbr>Inputs.<wbr>Management<wbr>Group<wbr>Log<wbr>Settings<wbr>Args&gt;</a></span>
    </dt>
...
```sh
$ pulumi import azure-nextgen:insights:ManagementGroupDiagnosticSetting setting1 providers/Microsoft.Management/managementGroups/testChildMG7/providers/microsoft.insights/diagnosticSettings/setting1 
```
