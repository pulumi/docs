...
meta_desc: "Documentation for the azure-nextgen.kusto.Database resource with examples, input properties, output properties, lookup functions, and supporting types."
---
