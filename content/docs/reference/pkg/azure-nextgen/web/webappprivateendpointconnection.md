...
meta_desc: "Documentation for the azure-nextgen.web.WebAppPrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
```sh
$ pulumi import azure-nextgen:web/latest:WebAppPrivateEndpointConnection myresource1 <Azure resource ID> 
```
