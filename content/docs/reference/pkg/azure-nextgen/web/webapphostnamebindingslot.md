...
meta_desc: "Explore the WebAppHostNameBindingSlot resource of the web module, including examples, input properties, output properties, lookup functions, and supporting types. A hostname binding object."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">WebAppHostNameBindingSlot</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx">WebAppHostNameBindingSlotArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWebAppHostNameBindingSlot</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx">WebAppHostNameBindingSlotArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WebAppHostNameBindingSlot</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">WebAppHostNameBindingSlot</span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx">WebAppHostNameBindingSlotArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#azureresourcetype_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Resource<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Web.<wbr>Azure<wbr>Resource<wbr>Type</span>
    </dt>
...
<a href="#customhostnamednsrecordtype_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Web.<wbr>Custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</span>
    </dt>
...
<a href="#hostnametype_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Web.<wbr>Host<wbr>Name<wbr>Type</span>
    </dt>
...
<a href="#azureresourcetype_nodejs" style="color: inherit; text-decoration: inherit;">azure<wbr>Resource<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">enums.<wbr>Azure<wbr>Resource<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Azure resource type.{{% /md %}}</dd>
...
<a href="#customhostnamednsrecordtype_nodejs" style="color: inherit; text-decoration: inherit;">custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">enums.<wbr>Custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Custom DNS record type.{{% /md %}}</dd>
...
<a href="#hostnametype_nodejs" style="color: inherit; text-decoration: inherit;">host<wbr>Name<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">enums.<wbr>Host<wbr>Name<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Hostname type.{{% /md %}}</dd>
...
<a href="#azure_resource_type_python" style="color: inherit; text-decoration: inherit;">azure_<wbr>resource_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Azure<wbr>Resource<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Azure resource type.{{% /md %}}</dd>
...
<a href="#custom_host_name_dns_record_type_python" style="color: inherit; text-decoration: inherit;">custom_<wbr>host_<wbr>name_<wbr>dns_<wbr>record_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Custom DNS record type.{{% /md %}}</dd>
...
<a href="#host_name_type_python" style="color: inherit; text-decoration: inherit;">host_<wbr>name_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Host<wbr>Name<wbr>Type</span>
    </dt>
    <dd>{{% md %}}Hostname type.{{% /md %}}</dd>
