...
meta_desc: "Documentation for the azure-nextgen.aadiam.DiagnosticSetting resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language csharp %}}
<dl class="tabular">
    <dt>Audit<wbr>Logs</dt>
    <dd>AuditLogs</dd>
    <dt>Sign<wbr>In<wbr>Logs</dt>
    <dd>SignInLogs</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Category<wbr>Audit<wbr>Logs</dt>
    <dd>AuditLogs</dd>
    <dt>Category<wbr>Sign<wbr>In<wbr>Logs</dt>
    <dd>SignInLogs</dd>
</dl>
{{% /choosable %}}
