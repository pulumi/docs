...
class MyStack : Stack
{
    public MyStack()
    {
        var monitor = new AzureNextGen.Datadog..Monitor("monitor", new AzureNextGen.Datadog..MonitorArgs
        {
...
import (
	datadog "github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure/datadog"
...
monitor = azure_nextgen.datadog.Monitor("monitor",
...
const monitor = new azure_nextgen.datadog.Monitor("monitor", {
    monitorName: "myMonitor",
    resourceGroupName: "myResourceGroup",
});
...
```sh
$ pulumi import azure-nextgen:datadog:Monitor myMonitor /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/monitors/myMonitor 
```
