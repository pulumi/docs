...
```sh
$ pulumi import azure-nextgen:authorization:ManagementLockAtSubscriptionLevel myresource1 /subscriptions/{subscriptionId}/providers/Microsoft.Authorization/locks/{lockName} 
```
