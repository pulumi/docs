...
meta_desc: "Documentation for the azure-nextgen.logic.IntegrationAccountBatchConfiguration resource with examples, input properties, output properties, lookup functions, and supporting types."
---
