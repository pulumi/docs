...
class MyStack : Stack
{
    public MyStack()
    {
        var resourceTypeRegistration = new AzureNextGen.ProviderHub..ResourceTypeRegistration("resourceTypeRegistration", new AzureNextGen.ProviderHub..ResourceTypeRegistrationArgs
        {
...
resource_type_registration = azure_nextgen.providerhub.ResourceTypeRegistration("resourceTypeRegistration",
...
const resourceTypeRegistration = new azure_nextgen.providerhub.ResourceTypeRegistration("resourceTypeRegistration", {
    providerNamespace: "Microsoft.Contoso",
    resourceType: "employees",
});
...
```sh
$ pulumi import azure-nextgen:providerhub:ResourceTypeRegistration employees /subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/resourcetypeRegistrations/{resourceType} 
```
