...
class MyStack : Stack
{
    public MyStack()
    {
        var skus = new AzureNextGen.ProviderHub..Skus("skus", new AzureNextGen.ProviderHub..SkusArgs
        {
...
skus = azure_nextgen.providerhub.Skus("skus",
...
const skus = new azure_nextgen.providerhub.Skus("skus", {
    providerNamespace: "Microsoft.Contoso",
    resourceType: "testResourceType",
    sku: "testSku",
});
...
```sh
$ pulumi import azure-nextgen:providerhub:Skus Microsoft.Contoso/ /subscriptions/ab7a8701-f7ef-471a-a2f4-d0ebbf494f77providers/Microsoft.ProviderHub/providerRegistrations/Microsoft.Contoso/ 
```
