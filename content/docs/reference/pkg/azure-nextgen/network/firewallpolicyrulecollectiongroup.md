...
<a href="#rule_collections_python" style="color: inherit; text-decoration: inherit;">rule_<wbr>collections</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Network:Firewall<wbr>Policy<wbr>Filter<wbr>Rule<wbr>Collection, Azure-Nextgen:Network:Firewall<wbr>Policy<wbr>Nat<wbr>Rule<wbr>Collection, Default=>]</span>
    </dt>
    <dd>{{% md %}}Group of Firewall Policy rule collections.{{% /md %}}</dd>
...
<a href="#rules_python" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Network:Application<wbr>Rule, Azure-Nextgen:Network:Nat<wbr>Rule, Azure-Nextgen:Network:Network<wbr>Rule, Default=>]</span>
    </dt>
    <dd>{{% md %}}List of rules included in a rule collection.{{% /md %}}</dd>
