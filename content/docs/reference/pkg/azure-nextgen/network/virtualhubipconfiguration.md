...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/network?tab=doc#PublicIPAddressTypeArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
