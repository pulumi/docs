...
class MyStack : Stack
{
    public MyStack()
    {
        var virtualHubIpConfiguration = new AzureNextGen.Network..VirtualHubIpConfiguration("virtualHubIpConfiguration", new AzureNextGen.Network..VirtualHubIpConfigurationArgs
        {
...
virtual_hub_ip_configuration = azure_nextgen.network.VirtualHubIpConfiguration("virtualHubIpConfiguration",
...
const virtualHubIpConfiguration = new azure_nextgen.network.VirtualHubIpConfiguration("virtualHubIpConfiguration", {
    ipConfigName: "ipconfig1",
    resourceGroupName: "rg1",
    subnet: {
        id: "/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/vnet1/subnets/subnet1",
...
```sh
$ pulumi import azure-nextgen:network:VirtualHubIpConfiguration ipconfig1 /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/hub1/ipConfigurations/ipconfig1 
```
