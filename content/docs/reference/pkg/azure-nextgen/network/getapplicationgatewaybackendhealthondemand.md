...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_application_gateway_backend_health_on_demand(</span><span class="nx">application_gateway_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">backend_address_pool</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">backend_http_settings</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">host</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">match</span><span class="p">:</span> <span class="nx">Optional[Dict[ApplicationGatewayProbeHealthResponseMatch]]</span> = None<span class="p">, </span><span class="nx">path</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">pick_host_name_from_backend_http_settings</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">protocol</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">timeout</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetApplicationGatewayBackendHealthOnDemandResult</code></pre></div>
{{% /choosable %}}
...
<a href="#backend_address_pool_python" style="color: inherit; text-decoration: inherit;">backend_<wbr>address_<wbr>pool</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationgatewaybackendaddresspoolresponse">Dict[Application<wbr>Gateway<wbr>Backend<wbr>Address<wbr>Pool<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Reference to an ApplicationGatewayBackendAddressPool resource.{{% /md %}}</dd>
...
<a href="#backend_health_http_settings_python" style="color: inherit; text-decoration: inherit;">backend_<wbr>health_<wbr>http_<wbr>settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationgatewaybackendhealthhttpsettingsresponse">Dict[Application<wbr>Gateway<wbr>Backend<wbr>Health<wbr>Http<wbr>Settings<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Application gateway BackendHealthHttp settings.{{% /md %}}</dd>
...
<a href="#backendhttpsettings_python" style="color: inherit; text-decoration: inherit;">backend<wbr>Http<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationgatewaybackendhttpsettingsresponse">Dict[Application<wbr>Gateway<wbr>Backend<wbr>Http<wbr>Settings<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Reference to an ApplicationGatewayBackendHttpSettings resource.{{% /md %}}</dd>
...
<a href="#servers_python" style="color: inherit; text-decoration: inherit;">servers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationgatewaybackendhealthserverresponse">List[Application<wbr>Gateway<wbr>Backend<wbr>Health<wbr>Server<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of ApplicationGatewayBackendHealthServer resources.{{% /md %}}</dd>
...
<a href="#health_python" style="color: inherit; text-decoration: inherit;">health</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="healthprobelog_python">
<a href="#healthprobelog_python" style="color: inherit; text-decoration: inherit;">health<wbr>Probe<wbr>Log</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
