...
meta_desc: "Documentation for the azure-nextgen.network.ExpressRouteCircuitAuthorization resource with examples, input properties, output properties, lookup functions, and supporting types."
---
