...
title_tag: "azure-nextgen.network.PrivateLinkService"
meta_desc: "Documentation for the azure-nextgen.network.PrivateLinkService resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var privateLinkService = new AzureNextGen.Network..PrivateLinkService("privateLinkService", new AzureNextGen.Network..PrivateLinkServiceArgs
        {
            AutoApproval = new AzureNextGen.Network..Inputs.PrivateLinkServicePropertiesAutoApprovalArgs
            {
                Subscriptions = 
                {
                    "subscription1",
            ...
            IpConfigurations = 
            {
                new AzureNextGen.Network..Inputs.PrivateLinkServiceIpConfigurationArgs
                {
                    Name = "fe-lb",
            ...
            ServiceName = "testPls",
            Visibility = new AzureNextGen.Network..Inputs.PrivateLinkServicePropertiesVisibilityArgs
            {
                Subscriptions = 
                {
                    "subscription1",
...
private_link_service = azure_nextgen.network.PrivateLinkService("privateLinkService",
    auto_approval=azure_nextgen.network.PrivateLinkServicePropertiesAutoApprovalArgs(
        subscriptions=[
            "subscription1",
            "subscription2",
        ],
    ...
    ip_configurations=[azure_nextgen.network.PrivateLinkServiceIpConfigurationArgs(
        name="fe-lb",
    ...
    load_balancer_frontend_ip_configurations=[azure_nextgen.network.FrontendIPConfigurationArgs(
        id="/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/frontendIPConfigurations/fe-lb",
    )],
    location="eastus",
    resource_group_name="rg1",
    service_name="testPls",
    visibility=azure_nextgen.network.PrivateLinkServicePropertiesVisibilityArgs(
        subscriptions=[
            "subscription1",
            "subscription2",
            "subscription3",
...
const privateLinkService = new azure_nextgen.network.PrivateLinkService("privateLinkService", {
    autoApproval: {
        subscriptions: [
            "subscription1",
            "subscription2",
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">PrivateLinkService</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx">PrivateLinkServiceArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">PrivateLinkService</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">auto_approval</span><span class="p">:</span> <span class="nx">Optional[PrivateLinkServicePropertiesAutoApprovalArgs]</span> = None<span class="p">, </span><span class="nx">enable_proxy_protocol</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">extended_location</span><span class="p">:</span> <span class="nx">Optional[ExtendedLocationArgs]</span> = None<span class="p">, </span><span class="nx">fqdns</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">, </span><span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">ip_configurations</span><span class="p">:</span> <span class="nx">Optional[Sequence[PrivateLinkServiceIpConfigurationArgs]]</span> = None<span class="p">, </span><span class="nx">load_balancer_frontend_ip_configurations</span><span class="p">:</span> <span class="nx">Optional[Sequence[FrontendIPConfigurationArgs]]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">service_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">visibility</span><span class="p">:</span> <span class="nx">Optional[PrivateLinkServicePropertiesVisibilityArgs]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPrivateLinkService</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx">PrivateLinkServiceArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PrivateLinkService</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">PrivateLinkService</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx">PrivateLinkServiceArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type">PrivateLinkServiceArgs</span>
    </dt>
    <dd>
...
<a href="#autoapproval_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Approval</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkservicepropertiesautoapproval">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Properties<wbr>Auto<wbr>Approval<wbr>Args</a></span>
    </dt>
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceipconfiguration">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Ip<wbr>Configuration<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#loadbalancerfrontendipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancer<wbr>Frontend<wbr>Ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#frontendipconfiguration">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Frontend<wbr>IPConfiguration<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#visibility_csharp" style="color: inherit; text-decoration: inherit;">Visibility</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkservicepropertiesvisibility">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Properties<wbr>Visibility<wbr>Args</a></span>
    </dt>
...
<a href="#protectioncoverage_csharp" style="color: inherit; text-decoration: inherit;">Protection<wbr>Coverage</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#ddossettingsprotectioncoverage">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Ddos<wbr>Settings<wbr>Protection<wbr>Coverage</a></span>
    </dt>
...
<a href="#ddossettings_csharp" style="color: inherit; text-decoration: inherit;">Ddos<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ddossettings">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Ddos<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#publicipaddresssku">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Inputs.<wbr>Public<wbr>IPAddress<wbr>Sku<wbr>Args</a></span>
    </dt>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#publicipaddressskuname">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Public<wbr>IPAddress<wbr>Sku<wbr>Name</a></span>
    </dt>
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#publicipaddressskutier">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network..<wbr>Public<wbr>IPAddress<wbr>Sku<wbr>Tier</a></span>
    </dt>
...
```sh
$ pulumi import azure-nextgen:network:PrivateLinkService testPls /subscriptions/subId/resourceGroups/rg1/providers/Microsoft.Network/privateLinkServices/testPls 
```
