...
title_tag: "azure-nextgen.network.VirtualNetwork"
meta_desc: "Documentation for the azure-nextgen.network.VirtualNetwork resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var virtualNetwork = new AzureNextGen.Network..VirtualNetwork("virtualNetwork", new AzureNextGen.Network..VirtualNetworkArgs
        {
...
virtual_network = azure_nextgen.network.VirtualNetwork("virtualNetwork",
...
const virtualNetwork = new azure_nextgen.network.VirtualNetwork("virtualNetwork", {
    addressSpace: {
...
class MyStack : Stack
{
    public MyStack()
    {
        var virtualNetwork = new AzureNextGen.Network..VirtualNetwork("virtualNetwork", new AzureNextGen.Network..VirtualNetworkArgs
        {
            ...
            BgpCommunities = new AzureNextGen.Network..Inputs.VirtualNetworkBgpCommunitiesArgs
            {
            ...
            Subnets = 
            {
                new AzureNextGen.Network..Inputs.SubnetArgs
                {
...
virtual_network = azure_nextgen.network.VirtualNetwork("virtualNetwork",
    ...
    bgp_communities=azure_nextgen.network.VirtualNetworkBgpCommunitiesArgs(
        virtual_network_community="12076:20000",
    ),
    location="eastus",
    resource_group_name="rg1",
    subnets=[azure_nextgen.network.SubnetArgs(
        ...
        var virtualNetwork = new AzureNextGen.Network..VirtualNetwork("virtualNetwork", new AzureNextGen.Network..VirtualNetworkArgs
        {
            ...
            Subnets = 
            {
                new AzureNextGen.Network..Inputs.SubnetArgs
                {
                    ...
                    Delegations = 
                    {
                        new AzureNextGen.Network..Inputs.DelegationArgs
                        {
                            Name = "myDelegation",
...
virtual_network = azure_nextgen.network.VirtualNetwork("virtualNetwork",
    ...
    subnets=[azure_nextgen.network.SubnetArgs(
        address_prefix="10.0.0.0/24",
        delegations=[azure_nextgen.network.DelegationArgs(
            name="myDelegation",
        ...
        var virtualNetwork = new AzureNextGen.Network..VirtualNetwork("virtualNetwork", new AzureNextGen.Network..VirtualNetworkArgs
        {
            ...
            Subnets = 
            {
                new AzureNextGen.Network..Inputs.SubnetArgs
                {
                    ...
                    {
                        new AzureNextGen.Network..Inputs.ServiceEndpointPolicyArgs
                        {
...
virtual_network = azure_nextgen.network.VirtualNetwork("virtualNetwork",
    ...
    subnets=[azure_nextgen.network.SubnetArgs(
        address_prefix="10.0.0.0/16",
        name="test-1",
        service_endpoint_policies=[azure_nextgen.network.ServiceEndpointPolicyArgs(
            id="/subscriptions/subid/resourceGroups/vnetTest/providers/Microsoft.Network/serviceEndpointPolicies/ServiceEndpointPolicy1",
        )],
        service_endpoints=[azure_nextgen.network.ServiceEndpointPropertiesFormatArgs(
            service="Microsoft.Storage",
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">VirtualNetwork</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx">VirtualNetworkArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">VirtualNetwork</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">address_space</span><span class="p">:</span> <span class="nx">Optional[AddressSpaceArgs]</span> = None<span class="p">, </span><span class="nx">bgp_communities</span><span class="p">:</span> <span class="nx">Optional[VirtualNetworkBgpCommunitiesArgs]</span> = None<span class="p">, </span><span class="nx">ddos_protection_plan</span><span class="p">:</span> <span class="nx">Optional[SubResourceArgs]</span> = None<span class="p">, </span><span class="nx">dhcp_options</span><span class="p">:</span> <span class="nx">Optional[DhcpOptionsArgs]</span> = None<span class="p">, </span><span class="nx">enable_ddos_protection</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">enable_vm_protection</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">extended_location</span><span class="p">:</span> <span class="nx">Optional[ExtendedLocationArgs]</span> = None<span class="p">, </span><span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">ip_allocations</span><span class="p">:</span> <span class="nx">Optional[Sequence[SubResourceArgs]]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">subnets</span><span class="p">:</span> <span class="nx">Optional[Sequence[SubnetArgs]]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">virtual_network_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">virtual_network_peerings</span><span class="p">:</span> <span class="nx">Optional[Sequence[VirtualNetworkPeeringArgs]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewVirtualNetwork</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx">VirtualNetworkArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">VirtualNetwork</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">VirtualNetwork</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx">VirtualNetworkArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#dhcp_options_python" style="color: inherit; text-decoration: inherit;">dhcp_<wbr>options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dhcpoptions">Dhcp<wbr>Options<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#virtual_network_peerings_python" style="color: inherit; text-decoration: inherit;">virtual_<wbr>network_<wbr>peerings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkpeering">Sequence[Virtual<wbr>Network<wbr>Peering<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A list of peerings in a Virtual Network.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-nextgen:network:VirtualNetwork test-vnet /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworks/test-vnet 
```
