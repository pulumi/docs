...
meta_desc: "Documentation for the azure-nextgen.network.Subnet resource with examples, input properties, output properties, lookup functions, and supporting types."
---
