...
title_tag: "Function GetVirtualApplianceSite | Module network/latest | Package Azure NextGen"
...
<a href="#o365policy_csharp" style="color: inherit; text-decoration: inherit;">O365Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#office365policypropertiesresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network.<wbr>Latest.<wbr>Outputs.<wbr>Office365Policy<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/network/latest?tab=doc#BreakOutCategoryPoliciesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Network.Latest.Outputs.BreakOutCategoryPoliciesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/network/latest?tab=doc#Office365PolicyPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Network.Latest.Outputs.Office365PolicyPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#breakoutcategories_csharp" style="color: inherit; text-decoration: inherit;">Break<wbr>Out<wbr>Categories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#breakoutcategorypoliciesresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Network.<wbr>Latest.<wbr>Inputs.<wbr>Break<wbr>Out<wbr>Category<wbr>Policies<wbr>Response<wbr>Args</a></span>
    </dt>
