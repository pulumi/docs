...
meta_desc: "Documentation for the azure-nextgen.sql.ManagedDatabaseSensitivityLabel resource with examples, input properties, output properties, lookup functions, and supporting types."
---
