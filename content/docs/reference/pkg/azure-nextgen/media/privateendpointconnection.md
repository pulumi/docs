...
title_tag: "azure-nextgen.media.PrivateEndpointConnection"
...
private_endpoint_connection = azure_nextgen.media.latest.PrivateEndpointConnection("privateEndpointConnection",
    ...
    name="connectionName1",
    private_link_service_connection_state=azure_nextgen.media.latest.PrivateLinkServiceConnectionStateArgs(
        description="Test description.",
        status="Approved",
    ),
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="property-type"> | </span><span class="property-type">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Media.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</span>
    </dt>
