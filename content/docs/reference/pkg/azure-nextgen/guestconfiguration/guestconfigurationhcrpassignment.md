...
title_tag: "azure-nextgen.guestconfiguration.GuestConfigurationHCRPAssignment"
meta_desc: "Documentation for the azure-nextgen.guestconfiguration.GuestConfigurationHCRPAssignment resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var guestConfigurationHCRPAssignment = new AzureNextGen.GuestConfiguration.Latest.GuestConfigurationHCRPAssignment("guestConfigurationHCRPAssignment", new AzureNextGen.GuestConfiguration.Latest.GuestConfigurationHCRPAssignmentArgs
        {
...
guest_configuration_hcrpassignment = azure_nextgen.guestconfiguration.latest.GuestConfigurationHCRPAssignment("guestConfigurationHCRPAssignment",
...
const guestConfigurationHCRPAssignment = new azure_nextgen.guestconfiguration.latest.GuestConfigurationHCRPAssignment("guestConfigurationHCRPAssignment", {
    guestConfigurationAssignmentName: "WhitelistedApplication",
    location: "westcentralus",
    machineName: "myMachineName",
    name: "WhitelistedApplication",
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">GuestConfigurationHCRPAssignment</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx">GuestConfigurationHCRPAssignmentArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewGuestConfigurationHCRPAssignment</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx">GuestConfigurationHCRPAssignmentArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">GuestConfigurationHCRPAssignment</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">GuestConfigurationHCRPAssignment</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx">GuestConfigurationHCRPAssignmentArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type">GuestConfigurationHCRPAssignmentArgs</span>
    </dt>
    <dd>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestconfigurationassignmentproperties">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Guest<wbr>Configuration<wbr>Assignment<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<h4 id="actionafterreboot">Action<wbr>After<wbr>Reboot</h4>

{{% choosable language csharp %}}
<dl class="tabular">
    <dt>Continue<wbr>Configuration</dt>
    <dd>ContinueConfiguration</dd>
    <dt>Stop<wbr>Configuration</dt>
    <dd>StopConfiguration</dd>
</dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular">
    <dt>Action<wbr>After<wbr>Reboot<wbr>Continue<wbr>Configuration</dt>
    <dd>ContinueConfiguration</dd>
    <dt>Action<wbr>After<wbr>Reboot<wbr>Stop<wbr>Configuration</dt>
    <dd>StopConfiguration</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular">
    <dt>CONTINUE_CONFIGURATION</dt>
    <dd>ContinueConfiguration</dd>
    <dt>STOP_CONFIGURATION</dt>
    <dd>StopConfiguration</dd>
</dl>
{{% /choosable %}}

<h4 id="allowmoduleoverwrite">Allow<wbr>Module<wbr>Overwrite</h4>
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Allow<wbr>Module<wbr>Overwrite<wbr>True</dt>
    <dd>True</dd>
    <dt>Allow<wbr>Module<wbr>Overwrite<wbr>False</dt>
    <dd>False</dd>
</dl>
{{% /choosable %}}
...
<a href="#configuration_csharp" style="color: inherit; text-decoration: inherit;">Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationinforesponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Configuration<wbr>Info<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#reasons_csharp" style="color: inherit; text-decoration: inherit;">Reasons</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#assignmentreportresourcecompliancereasonresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Assignment<wbr>Report<wbr>Resource<wbr>Compliance<wbr>Reason<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#assignment_csharp" style="color: inherit; text-decoration: inherit;">Assignment</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#assignmentinforesponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Assignment<wbr>Info<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#assignmentreportresourceresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Assignment<wbr>Report<wbr>Resource<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#vm_csharp" style="color: inherit; text-decoration: inherit;">Vm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vminforesponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>VMInfo<wbr>Response<wbr>Args</a></span>
    </dt>
...
<h4 id="configurationmode">Configuration<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular">
    <dt>Apply<wbr>Only</dt>
    <dd>ApplyOnly</dd>
    <dt>Apply<wbr>And<wbr>Monitor</dt>
    <dd>ApplyAndMonitor</dd>
    <dt>Apply<wbr>And<wbr>Auto<wbr>Correct</dt>
    <dd>ApplyAndAutoCorrect</dd>
</dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular">
    <dt>Configuration<wbr>Mode<wbr>Apply<wbr>Only</dt>
    <dd>ApplyOnly</dd>
    <dt>Configuration<wbr>Mode<wbr>Apply<wbr>And<wbr>Monitor</dt>
    <dd>ApplyAndMonitor</dd>
    <dt>Configuration<wbr>Mode<wbr>Apply<wbr>And<wbr>Auto<wbr>Correct</dt>
    <dd>ApplyAndAutoCorrect</dd>
</dl>
{{% /choosable %}}
...
<dl class="tabular">
    <dt>APPLY_ONLY</dt>
    <dd>ApplyOnly</dd>
    <dt>APPLY_AND_MONITOR</dt>
    <dd>ApplyAndMonitor</dd>
    <dt>APPLY_AND_AUTO_CORRECT</dt>
    <dd>ApplyAndAutoCorrect</dd>
</dl>
{{% /choosable %}}
...
<a href="#actionafterreboot_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>After<wbr>Reboot</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#actionafterreboot">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Action<wbr>After<wbr>Reboot</a></span>
    </dt>
...
<a href="#allowmoduleoverwrite_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Module<wbr>Overwrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#allowmoduleoverwrite">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Allow<wbr>Module<wbr>Overwrite</a></span>
    </dt>
...
<a href="#configurationmode_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#configurationmode">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Configuration<wbr>Mode</a></span>
    </dt>
...
<a href="#rebootifneeded_csharp" style="color: inherit; text-decoration: inherit;">Reboot<wbr>If<wbr>Needed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#rebootifneeded">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Reboot<wbr>If<wbr>Needed</a></span>
    </dt>
...
<a href="#actionafterreboot_go" style="color: inherit; text-decoration: inherit;">Action<wbr>After<wbr>Reboot</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#actionafterreboot">Action<wbr>After<wbr>Reboot</a></span>
    </dt>
    <dd>{{% md %}}Specifies what happens after a reboot during the application of a configuration. The possible values are ContinueConfiguration and StopConfiguration{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#allowmoduleoverwrite_go" style="color: inherit; text-decoration: inherit;">Allow<wbr>Module<wbr>Overwrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#allowmoduleoverwrite">Allow<wbr>Module<wbr>Overwrite</a></span>
    </dt>
    <dd>{{% md %}}If true - new configurations downloaded from the pull service are allowed to overwrite the old ones on the target node. Otherwise, false{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#configurationmode_go" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#configurationmode">Configuration<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}Specifies how the LCM(Local Configuration Manager) actually applies the configuration to the target nodes. Possible values are ApplyOnly, ApplyAndMonitor, and ApplyAndAutoCorrect.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#rebootifneeded_go" style="color: inherit; text-decoration: inherit;">Reboot<wbr>If<wbr>Needed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#rebootifneeded">Reboot<wbr>If<wbr>Needed</a></span>
    </dt>
    <dd>{{% md %}}Set this to true to automatically reboot the node after a configuration that requires reboot is applied. Otherwise, you will have to manually reboot the node for any configuration that requires it. The default value is false. To use this setting when a reboot condition is enacted by something other than DSC (such as Windows Installer), combine this setting with the xPendingReboot module.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#action_after_reboot_python" style="color: inherit; text-decoration: inherit;">action_<wbr>after_<wbr>reboot</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#actionafterreboot">Action<wbr>After<wbr>Reboot</a></span>
    </dt>
    <dd>{{% md %}}Specifies what happens after a reboot during the application of a configuration. The possible values are ContinueConfiguration and StopConfiguration{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#allow_module_overwrite_python" style="color: inherit; text-decoration: inherit;">allow_<wbr>module_<wbr>overwrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#allowmoduleoverwrite">Allow<wbr>Module<wbr>Overwrite</a></span>
    </dt>
    <dd>{{% md %}}If true - new configurations downloaded from the pull service are allowed to overwrite the old ones on the target node. Otherwise, false{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#configuration_mode_python" style="color: inherit; text-decoration: inherit;">configuration_<wbr>mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#configurationmode">Configuration<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}Specifies how the LCM(Local Configuration Manager) actually applies the configuration to the target nodes. Possible values are ApplyOnly, ApplyAndMonitor, and ApplyAndAutoCorrect.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#reboot_if_needed_python" style="color: inherit; text-decoration: inherit;">reboot_<wbr>if_<wbr>needed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#rebootifneeded">Reboot<wbr>If<wbr>Needed</a></span>
    </dt>
    <dd>{{% md %}}Set this to true to automatically reboot the node after a configuration that requires reboot is applied. Otherwise, you will have to manually reboot the node for any configuration that requires it. The default value is false. To use this setting when a reboot condition is enacted by something other than DSC (such as Windows Installer), combine this setting with the xPendingReboot module.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#guestconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestconfigurationnavigation">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Guest<wbr>Configuration<wbr>Navigation<wbr>Args</a></span>
    </dt>
...
<a href="#guestconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestconfigurationnavigationresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Guest<wbr>Configuration<wbr>Navigation<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The guest configuration to assign.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#latestassignmentreport_csharp" style="color: inherit; text-decoration: inherit;">Latest<wbr>Assignment<wbr>Report</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#assignmentreportresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Assignment<wbr>Report<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#configurationparameter_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Parameter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationparameter">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Configuration<wbr>Parameter<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#configurationsetting_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Setting</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationsetting">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Configuration<wbr>Setting<wbr>Args</a></span>
    </dt>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#kind">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Kind</a></span>
    </dt>
...
<a href="#configurationparameter_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Parameter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationparameterresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Configuration<wbr>Parameter<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}The configuration parameters for the guest configuration.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#configurationsetting_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Setting</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationsettingresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Guest<wbr>Configuration.<wbr>Inputs.<wbr>Configuration<wbr>Setting<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The configuration setting for the guest configuration.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<h4 id="rebootifneeded">Reboot<wbr>If<wbr>Needed</h4>
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Reboot<wbr>If<wbr>Needed<wbr>True</dt>
    <dd>True</dd>
    <dt>Reboot<wbr>If<wbr>Needed<wbr>False</dt>
    <dd>False</dd>
</dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-nextgen:guestconfiguration/latest:GuestConfigurationHCRPAssignment WhitelistedApplication /subscriptions/mysubscriptionid/resourceGroups/myResourceGroupName/providers/HybridRP.Compute/virtualMachines/myvm/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/WhitelistedApplication 
```
