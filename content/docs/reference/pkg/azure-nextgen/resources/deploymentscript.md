...
meta_desc: "Documentation for the azure-nextgen.resources.DeploymentScript resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language csharp %}}
<dl class="tabular">
    <dt>Azure<wbr>Power<wbr>Shell</dt>
    <dd>AzurePowerShell</dd>
    <dt>Azure<wbr>CLI</dt>
    <dd>AzureCLI</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Script<wbr>Type<wbr>Azure<wbr>Power<wbr>Shell</dt>
    <dd>AzurePowerShell</dd>
    <dt>Script<wbr>Type<wbr>Azure<wbr>CLI</dt>
    <dd>AzureCLI</dd>
</dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-nextgen:resources/v20191001preview:DeploymentScript MyName <Azure resource ID> 
```
