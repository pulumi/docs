...
meta_desc: "Documentation for the azure-nextgen.cognitiveservices.Account resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language csharp %}}
<dl class="tabular">
    <dt>Microsoft_Cognitive<wbr>Services</dt>
    <dd>Microsoft.CognitiveServices</dd>
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Key<wbr>Source_Microsoft_Cognitive<wbr>Services</dt>
    <dd>Microsoft.CognitiveServices</dd>
...
{{% choosable language python %}}
<dl class="tabular">
    <dt>MICROSOFT_COGNITIVE_SERVICES</dt>
    <dd>Microsoft.CognitiveServices</dd>
