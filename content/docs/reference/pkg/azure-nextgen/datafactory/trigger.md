...
<a href="#depends_on_python" style="color: inherit; text-decoration: inherit;">depends_<wbr>on</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Datafactory:Self<wbr>Dependency<wbr>Tumbling<wbr>Window<wbr>Trigger<wbr>Reference, Azure-Nextgen:Datafactory:Trigger<wbr>Dependency<wbr>Reference, Default=>]</span>
    </dt>
    <dd>{{% md %}}Triggers that this trigger depends on. Only tumbling window triggers are supported.{{% /md %}}</dd>
...
<a href="#depends_on_python" style="color: inherit; text-decoration: inherit;">depends_<wbr>on</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Datafactory:Self<wbr>Dependency<wbr>Tumbling<wbr>Window<wbr>Trigger<wbr>Reference<wbr>Response, Azure-Nextgen:Datafactory:Trigger<wbr>Dependency<wbr>Reference<wbr>Response, Default=>]</span>
    </dt>
    <dd>{{% md %}}Triggers that this trigger depends on. Only tumbling window triggers are supported.{{% /md %}}</dd>
