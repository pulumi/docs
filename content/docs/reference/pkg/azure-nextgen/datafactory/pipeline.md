...
<a href="#activities_python" style="color: inherit; text-decoration: inherit;">activities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Datafactory:Control<wbr>Activity, Azure-Nextgen:Datafactory:Execution<wbr>Activity, Default=>]</span>
    </dt>
    <dd>{{% md %}}List of activities in pipeline.{{% /md %}}</dd>
