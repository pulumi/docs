...
meta_desc: "Documentation for the azure-nextgen.portal.UserSettings resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
```sh
$ pulumi import azure-nextgen:portal/latest:UserSettings myresource1 <Azure resource ID> 
```
