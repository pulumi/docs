...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Union&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Virtual<wbr>Machine<wbr>Images..<wbr>Outputs.<wbr>Image<wbr>Template<wbr>Managed<wbr>Image<wbr>Source<wbr>Response, Union&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Virtual<wbr>Machine<wbr>Images..<wbr>Outputs.<wbr>Image<wbr>Template<wbr>Platform<wbr>Image<wbr>Source<wbr>Response, Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Virtual<wbr>Machine<wbr>Images..<wbr>Outputs.<wbr>Image<wbr>Template<wbr>Shared<wbr>Image<wbr>Version<wbr>Source<wbr>Response&gt;&gt;</span>
    </dt>
...
<a href="#distribute_python" style="color: inherit; text-decoration: inherit;">distribute</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Managed<wbr>Image<wbr>Distributor<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Shared<wbr>Image<wbr>Distributor<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Vhd<wbr>Distributor<wbr>Response, Default=>]</span>
    </dt>
    <dd>{{% md %}}The distribution targets where the image output needs to go to.{{% /md %}}</dd>
...
<a href="#customize_python" style="color: inherit; text-decoration: inherit;">customize</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>File<wbr>Customizer<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Power<wbr>Shell<wbr>Customizer<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Restart<wbr>Customizer<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Shell<wbr>Customizer<wbr>Response, Azure-Nextgen:Virtualmachineimages:Image<wbr>Template<wbr>Windows<wbr>Update<wbr>Customizer<wbr>Response, Default=>]</span>
    </dt>
    <dd>{{% md %}}Specifies the properties used to describe the customization steps of the image, like Image source etc{{% /md %}}</dd>
