...
private_endpoint_connection = azure_nextgen.eventgrid.PrivateEndpointConnection("privateEndpointConnection",
    ...
    private_link_service_connection_state=azure_nextgen.eventgrid.ConnectionStateArgs(
