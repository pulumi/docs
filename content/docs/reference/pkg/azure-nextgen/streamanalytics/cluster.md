...
meta_desc: "Documentation for the azure-nextgen.streamanalytics.Cluster resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<dl class="tabular">
    <dt>Default</dt>
    <dd>Default{{% md %}}The default SKU.{{% /md %}}</dd>
</dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular">
    <dt>Cluster<wbr>Sku<wbr>Name<wbr>Default</dt>
    <dd>Default{{% md %}}The default SKU.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
