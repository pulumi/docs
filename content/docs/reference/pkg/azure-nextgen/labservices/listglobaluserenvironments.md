...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listGlobalUserEnvironments<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/labservices/#ListGlobalUserEnvironmentsArgs">ListGlobalUserEnvironmentsArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/labservices/#ListGlobalUserEnvironmentsResult">ListGlobalUserEnvironmentsResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>ListGlobalUserEnvironments<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices?tab=doc#ListGlobalUserEnvironmentsArgs">ListGlobalUserEnvironmentsArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices?tab=doc#ListGlobalUserEnvironmentsResult">ListGlobalUserEnvironmentsResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListGlobalUserEnvironments </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Labservices.ListGlobalUserEnvironmentsResult.html">ListGlobalUserEnvironmentsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Labservices.ListGlobalUserEnvironmentsArgs.html">ListGlobalUserEnvironmentsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#environments_csharp" style="color: inherit; text-decoration: inherit;">Environments</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentdetailsresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Labservices.<wbr>Outputs.<wbr>Environment<wbr>Details<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices?tab=doc#EnvironmentDetailsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Labservices.Outputs.EnvironmentDetailsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#latestoperationresult_csharp" style="color: inherit; text-decoration: inherit;">Latest<wbr>Operation<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#latestoperationresultresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Labservices.<wbr>Inputs.<wbr>Latest<wbr>Operation<wbr>Result<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#virtualmachinedetails_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinedetailsresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Labservices.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Details<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices?tab=doc#VirtualMachineDetailsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Labservices.Outputs.VirtualMachineDetailsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
