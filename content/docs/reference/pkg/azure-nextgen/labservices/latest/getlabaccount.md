...
---
title: "GetLabAccount"
title_tag: "Function GetLabAccount | Module labservices/latest | Package Azure NextGen"
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getLabAccount<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/labservices/latest/#GetLabAccountArgs">GetLabAccountArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/labservices/latest/#GetLabAccountResult">GetLabAccountResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupLabAccount<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#LookupLabAccountArgs">LookupLabAccountArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#LookupLabAccountResult">LookupLabAccountResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetLabAccount </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Labservices/latest.GetLabAccountResult.html">GetLabAccountResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.LabServices.Latest.GetLabAccountArgs.html">GetLabAccountArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#latestoperationresult_csharp" style="color: inherit; text-decoration: inherit;">Latest<wbr>Operation<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#latestoperationresultresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Lab<wbr>Services.<wbr>Latest.<wbr>Outputs.<wbr>Latest<wbr>Operation<wbr>Result<wbr>Response</a></span>
    </dt>
...
<a href="#sizeconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Size<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sizeconfigurationpropertiesresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Lab<wbr>Services.<wbr>Latest.<wbr>Outputs.<wbr>Size<wbr>Configuration<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#EnvironmentSizeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.LabServices.Latest.Outputs.EnvironmentSizeResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#vmsizes_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Sizes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sizeinforesponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Lab<wbr>Services.<wbr>Latest.<wbr>Inputs.<wbr>Size<wbr>Info<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#LatestOperationResultResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.LabServices.Latest.Outputs.LatestOperationResultResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#SizeConfigurationPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.LabServices.Latest.Outputs.SizeConfigurationPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#environmentsizes_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Sizes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentsizeresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Lab<wbr>Services.<wbr>Latest.<wbr>Inputs.<wbr>Environment<wbr>Size<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/labservices/latest?tab=doc#SizeInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.LabServices.Latest.Outputs.SizeInfoResponse.html">output</a> API doc for this type.
{{% /choosable %}}
