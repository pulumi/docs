...
meta_desc: "Documentation for the azure-nextgen.costmanagement.Export resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#exporttype">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Cost<wbr>Management.<wbr>Export<wbr>Type</a></span>
    </dt>
