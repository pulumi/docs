...
meta_desc: "Documentation for the azure-nextgen.apimanagement.Backend resource with examples, input properties, output properties, lookup functions, and supporting types."
---
