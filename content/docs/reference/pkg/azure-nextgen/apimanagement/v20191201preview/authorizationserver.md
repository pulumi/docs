...
title_tag: "Resource AuthorizationServer | Module apimanagement/v20191201preview | Package Azure NextGen"
meta_desc: "Explore the AuthorizationServer resource of the apimanagement/v20191201preview module, including examples, input properties, output properties, lookup functions, and supporting types. External OAuth authorization server settings."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var authorizationServer = new AzureNextGen.ApiManagement.V20191201Preview.AuthorizationServer("authorizationServer", new AzureNextGen.ApiManagement.V20191201Preview.AuthorizationServerArgs
        {
...
authorization_server = azure_nextgen.apimanagement.v20191201preview.AuthorizationServer("authorizationServer",
...
const authorizationServer = new azure_nextgen.apimanagement.v20191201preview.AuthorizationServer("authorizationServer", {
    authorizationEndpoint: "https://www.contoso.com/oauth2/auth",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/apimanagement/v20191201preview/#AuthorizationServerArgs">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/apimanagement/v20191201preview?tab=doc#AuthorizationServerArgs">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.ApiManagement.V20191201Preview.AuthorizationServerArgs.html">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#tokenbodyparameters_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Body<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tokenbodyparametercontract">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Api<wbr>Management.<wbr>V20191201Preview.<wbr>Inputs.<wbr>Token<wbr>Body<wbr>Parameter<wbr>Contract<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/apimanagement/v20191201preview?tab=doc#TokenBodyParameterContractArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.ApiManagement.V20191201Preview.Inputs.TokenBodyParameterContractArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/apimanagement/v20191201preview?tab=doc#TokenBodyParameterContractResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.ApiManagement.V20191201Preview.Outputs.TokenBodyParameterContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
