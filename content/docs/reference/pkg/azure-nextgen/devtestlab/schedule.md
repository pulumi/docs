...
```sh
$ pulumi import azure-nextgen:devtestlab:Schedule myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/schedules/{name} 
```
