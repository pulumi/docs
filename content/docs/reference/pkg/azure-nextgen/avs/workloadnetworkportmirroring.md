...
meta_desc: "Documentation for the azure-nextgen.avs.WorkloadNetworkPortMirroring resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language csharp %}}
<dl class="tabular">
    <dt>INGRESS_EGRESS_BIDIRECTIONAL</dt>
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Port<wbr>Mirroring<wbr>Direction<wbr>Enum_INGRESS_EGRESS_BIDIRECTIONAL</dt>
    <dd>INGRESS, EGRESS, BIDIRECTIONAL</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular">
    <dt>INGRES_S_EGRES_S_BIDIRECTIONAL</dt>
    <dd>INGRESS, EGRESS, BIDIRECTIONAL</dd>
</dl>
{{% /choosable %}}
## Import
