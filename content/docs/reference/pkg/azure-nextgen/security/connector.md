...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        {
            AuthenticationDetails = new AzureNextGen.Security.Inputs.AwAssumeRoleAuthenticationDetailsPropertiesArgs
            {
...
connector = azure_nextgen.security.Connector("connector",
    authentication_details=azure_nextgen.security.AwAssumeRoleAuthenticationDetailsPropertiesArgs(
...
class MyStack : Stack
{
    public MyStack()
    {
        var connector = new AzureNextGen.Security.Connector("connector", new AzureNextGen.Security.ConnectorArgs
        {
            AuthenticationDetails = new AzureNextGen.Security.Inputs.AwsCredsAuthenticationDetailsPropertiesArgs
            {
...
connector = azure_nextgen.security.Connector("connector",
    authentication_details=azure_nextgen.security.AwsCredsAuthenticationDetailsPropertiesArgs(
...
class MyStack : Stack
{
    public MyStack()
    {
        var connector = new AzureNextGen.Security.Connector("connector", new AzureNextGen.Security.ConnectorArgs
        {
            AuthenticationDetails = new AzureNextGen.Security.Inputs.GcpCredentialsDetailsPropertiesArgs
            {
...
connector = azure_nextgen.security.Connector("connector",
    authentication_details=azure_nextgen.security.GcpCredentialsDetailsPropertiesArgs(
