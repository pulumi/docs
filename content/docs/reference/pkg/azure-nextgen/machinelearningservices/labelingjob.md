...
<a href="#inferencingcomputebinding_csharp" style="color: inherit; text-decoration: inherit;">Inferencing<wbr>Compute<wbr>Binding</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computebinding">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Compute<wbr>Binding<wbr>Args</a></span>
    </dt>
...
<a href="#inferencingcomputebinding_csharp" style="color: inherit; text-decoration: inherit;">Inferencing<wbr>Compute<wbr>Binding</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computebindingresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Machine<wbr>Learning<wbr>Services.<wbr>Inputs.<wbr>Compute<wbr>Binding<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The compute designated for inferencing.{{% /md %}}</dd>
    <dt class="property-required"
            title="Required">
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Media<wbr>Type<wbr>Image</dt>
    <dd>Image</dd>
    <dt>Media<wbr>Type<wbr>Text</dt>
    <dd>Text</dd>
</dl>
{{% /choosable %}}
