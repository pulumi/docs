...
meta_desc: "Documentation for the azure-nextgen.consumption.Budget resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Budget<wbr>Operator<wbr>Type<wbr>In</dt>
    <dd>In</dd>
</dl>
{{% /choosable %}}
