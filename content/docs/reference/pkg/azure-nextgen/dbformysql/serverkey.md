...
meta_desc: "Documentation for the azure-nextgen.dbformysql.ServerKey resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#serverkeytype_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Key<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#serverkeytype">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>DBfor<wbr>My<wbr>SQL..<wbr>Server<wbr>Key<wbr>Type</a></span>
    </dt>
...
```sh
$ pulumi import azure-nextgen:dbformysql:ServerKey omeVault_someKey_01234567890123456789012345678901 /subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/testrg/providers/Microsoft.DBforMySQL/servers/testserver/keys/someVault_someKey_01234567890123456789012345678901 
```
