...
---
title: "GetJitRequest"
title_tag: "Function GetJitRequest | Module solutions/latest | Package Azure NextGen"
meta_desc: "Explore the GetJitRequest function of the solutions/latest module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getJitRequest<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/solutions/latest/#GetJitRequestArgs">GetJitRequestArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/solutions/latest/#GetJitRequestResult">GetJitRequestResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupJitRequest<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/solutions/latest?tab=doc#LookupJitRequestArgs">LookupJitRequestArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/solutions/latest?tab=doc#LookupJitRequestResult">LookupJitRequestResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetJitRequest </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Solutions/latest.GetJitRequestResult.html">GetJitRequestResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Solutions.Latest.GetJitRequestArgs.html">GetJitRequestArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#jitauthorizationpolicies_csharp" style="color: inherit; text-decoration: inherit;">Jit<wbr>Authorization<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitauthorizationpoliciesresponse">List&lt;Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Solutions.<wbr>Latest.<wbr>Outputs.<wbr>Jit<wbr>Authorization<wbr>Policies<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#jitschedulingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Jit<wbr>Scheduling<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitschedulingpolicyresponse">Pulumi.<wbr>Azure<wbr>Next<wbr>Gen.<wbr>Solutions.<wbr>Latest.<wbr>Outputs.<wbr>Jit<wbr>Scheduling<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#jit_authorization_policies_python" style="color: inherit; text-decoration: inherit;">jit_<wbr>authorization_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitauthorizationpoliciesresponse">List[Jit<wbr>Authorization<wbr>Policies<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The JIT authorization policies.{{% /md %}}</dd>
...
<a href="#jit_scheduling_policy_python" style="color: inherit; text-decoration: inherit;">jit_<wbr>scheduling_<wbr>policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitschedulingpolicyresponse">Dict[Jit<wbr>Scheduling<wbr>Policy<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The JIT request properties.{{% /md %}}</dd>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/types/output/#JitAuthorizationPoliciesResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/solutions/latest?tab=doc#JitAuthorizationPoliciesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Solutions.Latest.Outputs.JitAuthorizationPoliciesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azure-nextgen/types/output/#JitSchedulingPolicyResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azure-nextgen/sdk/go/azure-nextgen/solutions/latest?tab=doc#JitSchedulingPolicyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureNextGen/Pulumi.AzureNextGen.Solutions.Latest.Outputs.JitSchedulingPolicyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
