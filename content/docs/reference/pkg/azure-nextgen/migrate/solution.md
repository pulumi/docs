...
meta_desc: "Documentation for the azure-nextgen.migrate.Solution resource with examples, input properties, output properties, lookup functions, and supporting types."
---
