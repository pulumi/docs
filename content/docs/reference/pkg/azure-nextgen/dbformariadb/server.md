...
class MyStack : Stack
{
    public MyStack()
    {
        var server = new AzureNextGen.DBforMariaDB.Server("server", new AzureNextGen.DBforMariaDB.ServerArgs
        {
            ...
            Properties = new AzureNextGen.DBforMariaDB.Inputs.ServerPropertiesForRestoreArgs
            {
...
server = azure_nextgen.dbformariadb.Server("server",
    location="brazilsouth",
    properties=azure_nextgen.dbformariadb.ServerPropertiesForRestoreArgs(
...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        {
            Location = "westus",
            Properties = new AzureNextGen.DBforMariaDB.Inputs.ServerPropertiesForDefaultCreateArgs
            {
...
server = azure_nextgen.dbformariadb.Server("server",
    location="westus",
    properties=azure_nextgen.dbformariadb.ServerPropertiesForDefaultCreateArgs(
        administrator_login="cloudsa",
        administrator_login_password="<administratorLoginPassword>",
        create_mode="Default",
        ssl_enforcement="Enabled",
        storage_profile=azure_nextgen.dbformariadb.StorageProfileArgs(
...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        {
            Location = "westus",
            Properties = new AzureNextGen.DBforMariaDB.Inputs.ServerPropertiesForGeoRestoreArgs
            {
...
server = azure_nextgen.dbformariadb.Server("server",
    location="westus",
    properties=azure_nextgen.dbformariadb.ServerPropertiesForGeoRestoreArgs(
