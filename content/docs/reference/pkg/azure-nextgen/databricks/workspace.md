...
meta_desc: "Documentation for the azure-nextgen.databricks.Workspace resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Key<wbr>Source<wbr>Default</dt>
    <dd>Default</dd>
