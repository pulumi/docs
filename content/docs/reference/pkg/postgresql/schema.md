...
meta_desc: "Explore the Schema resource of the PostgreSQL package, including examples, input properties, output properties, lookup functions, and supporting types. The ``postgresql..Schema`` resource creates and manages [schema"
---
...
The Schema resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
