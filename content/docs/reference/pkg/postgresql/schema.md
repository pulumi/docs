...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_postgresql/#pulumi_postgresql.Schema">Schema</a></span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>database=None<span class="p">, </span>drop_cascade=None<span class="p">, </span>if_not_exists=None<span class="p">, </span>name=None<span class="p">, </span>owner=None<span class="p">, </span>policies=None<span class="p">, </span>__props__=None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
