...
---
title: "getEntry"
title_tag: "google-native.datacatalog/v1beta1.getEntry"
meta_desc: "Documentation for the google-native.datacatalog/v1beta1.getEntry function with examples, input properties, output properties, and supporting types."
---
...
<a href="#bigquerydateshardedspec_csharp" style="color: inherit; text-decoration: inherit;">Bigquery<wbr>Date<wbr>Sharded<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1bigquerydateshardedspecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Big<wbr>Query<wbr>Date<wbr>Sharded<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification for a group of BigQuery tables with name pattern `[prefix]YYYYMMDD`. Context: https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bigquerytablespec_csharp" style="color: inherit; text-decoration: inherit;">Bigquery<wbr>Table<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1bigquerytablespecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Big<wbr>Query<wbr>Table<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification that applies to a BigQuery table. This is only valid on entries of type `TABLE`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Entry description, which can consist of several sentences or paragraphs that describe entry contents. Default value is an empty string.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display information such as title and description. A short name to identify the entry, for example, "Analytics Data - Jan 2011". Default value is an empty string.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gcsfilesetspec_csharp" style="color: inherit; text-decoration: inherit;">Gcs<wbr>Fileset<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1gcsfilesetspecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Gcs<wbr>Fileset<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification that applies to a Cloud Storage fileset. This is only valid on entries of type FILESET.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#linkedresource_csharp" style="color: inherit; text-decoration: inherit;">Linked<wbr>Resource</a>
    ...
    <dd>{{% md %}}The resource this metadata entry refers to. For Google Cloud Platform resources, `linked_resource` is the [full name of the resource](https://cloud.google.com/apis/design/resource_names#full_resource_name). For example, the `linked_resource` for a table resource from BigQuery is: * //bigquery.googleapis.com/projects/projectId/datasets/datasetId/tables/tableId Output only when Entry is of type in the EntryType enum. For entries with user_specified_type, this field is optional and defaults to an empty string.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1schemaresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Schema<wbr>Response</a></span>
    </dt>
...
<a href="#sourcesystemtimestamps_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>System<wbr>Timestamps</a>
    ...
    <dd>{{% md %}}Timestamps about the underlying resource, not about this Data Catalog entry. Output only when Entry is of type in the EntryType enum. For entries with user_specified_type, this field is optional and defaults to an empty timestamp.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the entry. Only used for Entries with types in the EntryType enum.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bigquerydateshardedspec_go" style="color: inherit; text-decoration: inherit;">Bigquery<wbr>Date<wbr>Sharded<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1bigquerydateshardedspecresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Big<wbr>Query<wbr>Date<wbr>Sharded<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification for a group of BigQuery tables with name pattern `[prefix]YYYYMMDD`. Context: https://cloud.google.com/bigquery/docs/partitioned-tables#partitioning_versus_sharding.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bigquerytablespec_go" style="color: inherit; text-decoration: inherit;">Bigquery<wbr>Table<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1bigquerytablespecresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Big<wbr>Query<wbr>Table<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification that applies to a BigQuery table. This is only valid on entries of type `TABLE`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gcsfilesetspec_go" style="color: inherit; text-decoration: inherit;">Gcs<wbr>Fileset<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1gcsfilesetspecresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Gcs<wbr>Fileset<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specification that applies to a Cloud Storage fileset. This is only valid on entries of type FILESET.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schema_go" style="color: inherit; text-decoration: inherit;">Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1schemaresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Schema<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Schema of the entry. An entry might not have any schema attached to it.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tablespec_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1tablespecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Table<wbr>Spec<wbr>Response</a></span>
    </dt>
...
<a href="#viewspec_csharp" style="color: inherit; text-decoration: inherit;">View<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1viewspecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1View<wbr>Spec<wbr>Response</a></span>
    </dt>
...
<a href="#subcolumns_csharp" style="color: inherit; text-decoration: inherit;">Subcolumns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1columnschemaresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Column<wbr>Schema<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#gcstimestamps_csharp" style="color: inherit; text-decoration: inherit;">Gcs<wbr>Timestamps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1systemtimestampsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1System<wbr>Timestamps<wbr>Response</a></span>
    </dt>
...
<a href="#samplegcsfilespecs_csharp" style="color: inherit; text-decoration: inherit;">Sample<wbr>Gcs<wbr>File<wbr>Specs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1gcsfilespecresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Gcs<wbr>File<wbr>Spec<wbr>Response&gt;</a></span>
    </dt>
