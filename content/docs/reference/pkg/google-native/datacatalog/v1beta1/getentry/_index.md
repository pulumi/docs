...
<a href="#usagesignal_csharp" style="color: inherit; text-decoration: inherit;">Usage<wbr>Signal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1usagesignalresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Usage<wbr>Signal<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Statistics on the usage level of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#usagesignal_go" style="color: inherit; text-decoration: inherit;">Usage<wbr>Signal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1usagesignalresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Usage<wbr>Signal<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Statistics on the usage level of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#column_csharp" style="color: inherit; text-decoration: inherit;">Column</a>
    ...
    <dd>{{% md %}}Name of the column.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="description_csharp">
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of the column.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#subcolumns_python" style="color: inherit; text-decoration: inherit;">subcolumns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1columnschemaresponse">Sequence[Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Column<wbr>Schema<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Optional. Schema of sub-columns. A column can have zero or more sub-columns.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_python">
...
<a href="#filepath_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Path</a>
    ...
    <dd>{{% md %}}The full file path. Example: `gs://bucket_name/a/b.txt`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sample_gcs_file_specs_python" style="color: inherit; text-decoration: inherit;">sample_<wbr>gcs_<wbr>file_<wbr>specs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1gcsfilespecresponse">Sequence[Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Gcs<wbr>File<wbr>Spec<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Sample files contained in this fileset, not all files contained in this fileset are represented here.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#columns_csharp" style="color: inherit; text-decoration: inherit;">Columns</a>
    ...
    <dd>{{% md %}}Schema of columns. A maximum of 10,000 columns and sub-columns can be specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="googleclouddatacatalogv1beta1usagesignalresponse">Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Usage<wbr>Signal<wbr>Response</h4>
...
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
    ...
    <dd>{{% md %}}The timestamp of the end of the usage statistics duration.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#usagewithintimerange_csharp" style="color: inherit; text-decoration: inherit;">Usage<wbr>Within<wbr>Time<wbr>Range</a>
    ...
    <dd>{{% md %}}Usage statistics over each of the pre-defined time ranges, supported strings for time ranges are {"24H", "7D", "30D"}.{{% /md %}}</dd></dl>
{{% /choosable %}}
