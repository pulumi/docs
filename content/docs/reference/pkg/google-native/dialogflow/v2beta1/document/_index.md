...
<span class="k">def </span><span class="nx">Document</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">knowledge_types</span><span class="p">:</span> <span class="nx">Optional[Sequence[DocumentKnowledgeTypesItem]]</span> = None<span class="p">,</span>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the document. The name must be 1024 bytes or less; otherwise, the creation request fails.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#knowledgetypes_csharp" style="color: inherit; text-decoration: inherit;">Knowledge<wbr>Types</a>
    ...
    <dd>{{% md %}}The knowledge type of document content.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#mimetype_csharp" style="color: inherit; text-decoration: inherit;">Mime<wbr>Type</a>
    ...
    <dd>{{% md %}}The MIME type of this document.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#knowledge_types_python" style="color: inherit; text-decoration: inherit;">knowledge_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#documentknowledgetypesitem">Sequence[Document<wbr>Knowledge<wbr>Types<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}The knowledge type of document content.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlerpcstatusresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V2Beta1.<wbr>Inputs.<wbr>Google<wbr>Rpc<wbr>Status<wbr>Response</a></span>
    </dt>
