...
---
title: "getTestCase"
title_tag: "google-native.dialogflow/v3.getTestCase"
meta_desc: "Documentation for the google-native.dialogflow/v3.getTestCase function with examples, input properties, output properties, and supporting types."
---
...
## Using getTestCase {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getTestCase<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetTestCaseArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetTestCaseResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_test_case(</span><span class="nx">agent_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                  <span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                  <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                  <span class="nx">test_case_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetTestCaseResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupTestCase<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupTestCaseArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupTestCaseResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetTestCase </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetTestCaseResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetTestCaseArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="testcaseid_csharp">
<a href="#testcaseid_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>Case<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#project_go" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="testcaseid_go">
<a href="#testcaseid_go" style="color: inherit; text-decoration: inherit;">Test<wbr>Case<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#project_nodejs" style="color: inherit; text-decoration: inherit;">project</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="testcaseid_nodejs">
<a href="#testcaseid_nodejs" style="color: inherit; text-decoration: inherit;">test<wbr>Case<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#project_python" style="color: inherit; text-decoration: inherit;">project</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="test_case_id_python">
<a href="#test_case_id_python" style="color: inherit; text-decoration: inherit;">test_<wbr>case_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The human-readable name of the test case, unique within the agent. Limit of 200 characters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lasttestresult_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Test<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3testcaseresultresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Test<wbr>Case<wbr>Result<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The latest test result.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The unique identifier of the test case. TestCases.CreateTestCase will populate the name automatically. Otherwise use format: `projects//locations//agents/ /testCases/`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#notes_csharp" style="color: inherit; text-decoration: inherit;">Notes</a>
    ...
    <dd>{{% md %}}Additional freeform notes about the test case. Limit of 400 characters.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}Tags are short descriptions that users may apply to test cases for organizational and filtering purposes. Each tag should start with "#" and has a limit of 30 characters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#testcaseconversationturns_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>Case<wbr>Conversation<wbr>Turns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3conversationturnresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Conversation<wbr>Turn<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The conversation turns uttered when the test case was created, in chronological order. These include the canonical set of agent utterances that should occur when the agent is working properly.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="testconfig_csharp">
<a href="#testconfig_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3testconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Test<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#lasttestresult_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Test<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3testcaseresultresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Test<wbr>Case<wbr>Result<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The latest test result.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_go">
...
<a href="#testconfig_go" style="color: inherit; text-decoration: inherit;">Test<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3testconfigresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Test<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Config for the test case.{{% /md %}}</dd></dl>
{{% /choosable %}}
