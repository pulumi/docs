...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The human-readable name of the security settings, unique within the location.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. Resource name of the settings. Format: `projects//locations//securitySettings/`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#redactionscope_csharp" style="color: inherit; text-decoration: inherit;">Redaction<wbr>Scope</a>
    ...
    <dd>{{% md %}}Defines on what data we apply redaction. Note that we don't redact data to which we don't have access, e.g., Stackdriver logs.{{% /md %}}</dd><dt class="property-"
            title="">
