...
<span class="k">def </span><span class="nx">Agent</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">speech_to_text_settings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_dialogflow_v3.GoogleCloudDialogflowCxV3SpeechToTextSettingsArgs]]</span> = None<span class="p">,</span>
