...
<span class="k">def </span><span class="nx">Page</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">entry_fulfillment</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDialogflowCxV3FulfillmentArgs]</span> = None<span class="p">,</span>
         <span class="nx">event_handlers</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudDialogflowCxV3EventHandlerArgs]]</span> = None<span class="p">,</span>
         <span class="nx">flow_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
         <span class="nx">form</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDialogflowCxV3FormArgs]</span> = None<span class="p">,</span>
...
<a href="#event_handlers_python" style="color: inherit; text-decoration: inherit;">event_<wbr>handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3eventhandler">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Event<wbr>Handler<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Handlers associated with the page to handle events such as webhook errors, no match or no input.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="form_python">
