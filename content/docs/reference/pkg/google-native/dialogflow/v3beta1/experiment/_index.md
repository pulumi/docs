...
<span class="k">def </span><span class="nx">Experiment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">rollout_config</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDialogflowCxV3beta1RolloutConfigArgs]</span> = None<span class="p">,</span>
               <span class="nx">rollout_failure_reason</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
               <span class="nx">rollout_state</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDialogflowCxV3beta1RolloutStateArgs]</span> = None<span class="p">,</span>
...
<a href="#rolloutconfig_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The configuration for auto rollout. If set, there should be exactly two variants in the experiment (control variant being the default version of the flow), the traffic allocation for the non-control variant will gradually increase to 100% when conditions are met, and eventually replace the control variant to become the default version of the flow.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rolloutfailurereason_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Failure<wbr>Reason</a>
    ...
    <dd>{{% md %}}The reason why rollout has failed. Should only be set when state is ROLLOUT_FAILED.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rolloutstate_csharp">
<a href="#rolloutstate_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutstate">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>State<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}State of the auto rollout process.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rolloutconfig_go" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfig">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The configuration for auto rollout. If set, there should be exactly two variants in the experiment (control variant being the default version of the flow), the traffic allocation for the non-control variant will gradually increase to 100% when conditions are met, and eventually replace the control variant to become the default version of the flow.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rolloutstate_go" style="color: inherit; text-decoration: inherit;">Rollout<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutstate">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>State<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}State of the auto rollout process.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googleclouddialogflowcxv3beta1rolloutconfig">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config</h4>
...
<a href="#failurecondition_csharp" style="color: inherit; text-decoration: inherit;">Failure<wbr>Condition</a>
    ...
    <dd>{{% md %}}The conditions that are used to evaluate the failure of a rollout step. If not specified, no rollout steps will fail. E.g. "containment_rate < 10% OR average_turn_count < 3". See the [conditions reference](https://cloud.google.com/dialogflow/cx/docs/reference/condition).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rolloutcondition_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Condition</a>
    ...
    <dd>{{% md %}}The conditions that are used to evaluate the success of a rollout step. If not specified, all rollout steps will proceed to the next one unless failure conditions are met. E.g. "containment_rate > 60% AND callback_rate < 20%". See the [conditions reference](https://cloud.google.com/dialogflow/cx/docs/reference/condition).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rolloutsteps_csharp">
<a href="#rolloutsteps_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Steps</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstep">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step&gt;</a></span>
    </dt>
...
<a href="#rolloutsteps_go" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstep">[]Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step</a></span>
    </dt>
    <dd>{{% md %}}Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rollout_steps_python" style="color: inherit; text-decoration: inherit;">rollout_<wbr>steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstep">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step]</a></span>
    </dt>
    <dd>{{% md %}}Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="googleclouddialogflowcxv3beta1rolloutconfigresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Response</h4>
...
<a href="#rolloutsteps_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstepresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rolloutsteps_go" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstepresponse">[]Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rollout_steps_python" style="color: inherit; text-decoration: inherit;">rollout_<wbr>steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1rolloutconfigrolloutstepresponse">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Steps to roll out a flow version. Steps should be sorted by percentage in ascending order.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="googleclouddialogflowcxv3beta1rolloutconfigrolloutstep">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step</h4>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the rollout step;{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#minduration_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Duration</a>
    ...
    <dd>{{% md %}}The minimum time that this step should last. Should be longer than 1 hour. If not set, the default minimum duration for each step will be 1 hour.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googleclouddialogflowcxv3beta1rolloutconfigrolloutstepresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>Config<wbr>Rollout<wbr>Step<wbr>Response</h4>
...
<h4 id="googleclouddialogflowcxv3beta1rolloutstate">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>State</h4>
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}Start time of the current step.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="step_csharp">
<a href="#step_csharp" style="color: inherit; text-decoration: inherit;">Step</a>
    ...
    <dd>{{% md %}}Display name of the current auto rollout step.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googleclouddialogflowcxv3beta1rolloutstateresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Rollout<wbr>State<wbr>Response</h4>
