...
title_tag: "google-native.dialogflow/v3beta1.getEnvironment"
meta_desc: "Documentation for the google-native.dialogflow/v3beta1.getEnvironment function with examples, input properties, output properties, and supporting types."
---
...
<a href="#testcasesconfig_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>Cases<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmenttestcasesconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#versionconfigs_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmentversionconfigresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Version<wbr>Config<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#testcasesconfig_go" style="color: inherit; text-decoration: inherit;">Test<wbr>Cases<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmenttestcasesconfigresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The test cases config for continuous tests of this environment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#versionconfigs_go" style="color: inherit; text-decoration: inherit;">Version<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmentversionconfigresponse">[]Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Version<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#version_configs_python" style="color: inherit; text-decoration: inherit;">version_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmentversionconfigresponse">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Version<wbr>Config<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.{{% /md %}}</dd></dl>
{{% /choosable %}}
