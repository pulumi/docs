...
<a href="#notename_csharp" style="color: inherit; text-decoration: inherit;">Note<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. Immutable. The analysis note associated with this occurrence, in the form of `projects/[PROVIDER_ID]/notes/[NOTE_ID]`. This field can be used as a filter in list requests.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
    ...
    <dd>{{% md %}}Required. Immutable. The resource for which the occurrence applies.{{% /md %}}</dd><dt class="property-"
            title="">
