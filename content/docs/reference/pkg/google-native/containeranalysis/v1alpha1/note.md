...
<span class="k">def </span><span class="nx">Note</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">attestation_authority</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.AttestationAuthorityArgs]]</span> = None<span class="p">,</span>
         <span class="nx">base_image</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.BasisArgs]]</span> = None<span class="p">,</span>
         <span class="nx">build_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.BuildTypeArgs]]</span> = None<span class="p">,</span>
         <span class="nx">create_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
         <span class="nx">deployable</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.DeployableArgs]]</span> = None<span class="p">,</span>
         <span class="nx">discovery</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.DiscoveryArgs]]</span> = None<span class="p">,</span>
         ...
         <span class="nx">package</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.PackageArgs]]</span> = None<span class="p">,</span>
         <span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
         <span class="nx">related_url</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_containeranalysis_v1alpha1.RelatedUrlArgs]]]]</span> = None<span class="p">,</span>
         ...
         <span class="nx">upgrade</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.UpgradeNoteArgs]]</span> = None<span class="p">,</span>
         <span class="nx">vulnerability_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_containeranalysis_v1alpha1.VulnerabilityTypeArgs]]</span> = None<span class="p">)</span>
