...
---
title: "getInstance"
title_tag: "google-native.memcache/v1.getInstance"
meta_desc: "Documentation for the google-native.memcache/v1.getInstance function with examples, input properties, output properties, and supporting types."
---
...
<a href="#authorizednetwork_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Network</a>
    ...
    <dd>{{% md %}}The full name of the Google Compute Engine [network](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. If left unspecified, the `default` network will be used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#instancemessages_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancemessageresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Memcache.<wbr>V1.<wbr>Outputs.<wbr>Instance<wbr>Message<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#nodeconfig_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodeconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Memcache.<wbr>V1.<wbr>Outputs.<wbr>Node<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Required. Configuration for Memcached nodes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nodecount_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Count</a>
    ...
    <dd>{{% md %}}Required. Number of nodes in the Memcached instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="parameters_csharp">
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#memcacheparametersresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Memcache.<wbr>V1.<wbr>Outputs.<wbr>Memcache<wbr>Parameters<wbr>Response</a></span>
    </dt>
