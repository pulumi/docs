...
<a href="#instanceid_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the instance to create. Valid identifiers are of the form `a-z*[a-z0-9]` and must be between 2 and 64 characters in length.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#processingunits_csharp" style="color: inherit; text-decoration: inherit;">Processing<wbr>Units</a>
    ...
    <dd>{{% md %}}The number of processing units allocated to this instance. At most one of processing_units or node_count should be present in the message. This may be zero in API responses for instances that are not yet in state `READY`.{{% /md %}}</dd></dl>
{{% /choosable %}}
