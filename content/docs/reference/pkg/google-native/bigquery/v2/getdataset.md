...
<a href="#creationtime_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] The time when this dataset was created, in milliseconds since the epoch.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}[Output-only] A hash of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output-only] The resource type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastmodifiedtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] The date when this dataset or any of its tables was last modified, in milliseconds since the epoch.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#target_types_csharp" style="color: inherit; text-decoration: inherit;">Target_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessentrytarget_typesitemresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Dataset<wbr>Access<wbr>Entry<wbr>Target_<wbr>types<wbr>Item<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
