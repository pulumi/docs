...
---
title: "getTable"
title_tag: "google-native.bigquery/v2.getTable"
meta_desc: "Documentation for the google-native.bigquery/v2.getTable function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_table(</span><span class="nx">dataset_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">selected_fields</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#selectedfields_csharp" style="color: inherit; text-decoration: inherit;">Selected<wbr>Fields</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#selectedfields_go" style="color: inherit; text-decoration: inherit;">Selected<wbr>Fields</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#selectedfields_nodejs" style="color: inherit; text-decoration: inherit;">selected<wbr>Fields</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#selected_fields_python" style="color: inherit; text-decoration: inherit;">selected_<wbr>fields</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#clustering_csharp" style="color: inherit; text-decoration: inherit;">Clustering</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusteringresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Clustering<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Beta] Clustering specification for the table. Must be specified with partitioning, data in the table will be first partitioned and subsequently clustered.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#creationtime_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] The time when this table was created, in milliseconds since the epoch.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}[Optional] A user-friendly description of this table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Configuration</a>
    ...
    <dd>{{% md %}}Custom encryption configuration (e.g., Cloud KMS keys).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}[Output-only] A hash of the table metadata. Used to ensure there were no concurrent modifications to the resource when attempting an update. Not guaranteed to change when the table contents or the fields numRows, numBytes, numLongTermBytes or lastModifiedTime change.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#externaldataconfiguration_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Data<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#externaldataconfigurationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>External<wbr>Data<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] Describes the data format, location, and other properties of a table stored outside of BigQuery. By defining these properties, the data source can then be queried as if it were a standard BigQuery table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}[Optional] A descriptive name for this table.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output-only] The type of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastmodifiedtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] The time when this table was last modified, in milliseconds since the epoch.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}[Output-only] The geographic location where the table resides. This value is inherited from the dataset.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#materializedview_csharp" style="color: inherit; text-decoration: inherit;">Materialized<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#materializedviewdefinitionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Materialized<wbr>View<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] Materialized view definition.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="model_csharp">
<a href="#model_csharp" style="color: inherit; text-decoration: inherit;">Model</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modeldefinitionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Model<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Output-only, Beta] Present iff this table represents a ML model. Describes the training information for the model, and it is required to run 'PREDICT' queries.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#numbytes_csharp" style="color: inherit; text-decoration: inherit;">Num<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output-only] The size of this table in bytes, excluding any data in the streaming buffer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#numlongtermbytes_csharp" style="color: inherit; text-decoration: inherit;">Num<wbr>Long<wbr>Term<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output-only] The number of bytes in the table that are considered "long-term storage".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#numphysicalbytes_csharp" style="color: inherit; text-decoration: inherit;">Num<wbr>Physical<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output-only] [TrustedTester] The physical size of this table in bytes, excluding any data in the streaming buffer. This includes compression and storage used for time travel.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#numrows_csharp" style="color: inherit; text-decoration: inherit;">Num<wbr>Rows</a>
    ...
    <dd>{{% md %}}[Output-only] The number of rows of data in this table, excluding any data in the streaming buffer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rangepartitioning_csharp" style="color: inherit; text-decoration: inherit;">Range<wbr>Partitioning</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rangepartitioningresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Range<wbr>Partitioning<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[TrustedTester] Range partitioning specification for this table. Only one of timePartitioning and rangePartitioning should be specified.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#requirepartitionfilter_csharp" style="color: inherit; text-decoration: inherit;">Require<wbr>Partition<wbr>Filter</a>
    ...
    <dd>{{% md %}}[Optional] If set to true, queries over this table require a partition filter that can be used for partition elimination to be specified.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="schema_csharp">
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tableschemaresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Table<wbr>Schema<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] Describes the schema of this table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output-only] A URL that can be used to access this resource again.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#snapshotdefinition_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Definition</a>
    ...
    <dd>{{% md %}}[Output-only] Snapshot definition.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#streamingbuffer_csharp" style="color: inherit; text-decoration: inherit;">Streaming<wbr>Buffer</a>
    ...
    <dd>{{% md %}}[Output-only] Contains information regarding this table's streaming buffer, if one is present. This field will be absent if the table is not being streamed to or if there is no data in the streaming buffer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tablereference_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Reference</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tablereferenceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Table<wbr>Reference<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Required] Reference describing the ID of this table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#timepartitioning_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Partitioning</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timepartitioningresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>Time<wbr>Partitioning<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Time-based partitioning specification for this table. Only one of timePartitioning and rangePartitioning should be specified.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}[Output-only] Describes the table type. The following values are supported: TABLE: A normal BigQuery table. VIEW: A virtual table defined by a SQL query. SNAPSHOT: An immutable, read-only table that is a copy of another table. [TrustedTester] MATERIALIZED_VIEW: SQL query whose result is persisted. EXTERNAL: A table that references data stored in an external storage system, such as Google Cloud Storage. The default value is TABLE.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="view_csharp">
<a href="#view_csharp" style="color: inherit; text-decoration: inherit;">View</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#viewdefinitionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Outputs.<wbr>View<wbr>Definition<wbr>Response</a></span>
    </dt>
...
<a href="#externaldataconfiguration_go" style="color: inherit; text-decoration: inherit;">External<wbr>Data<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#externaldataconfigurationresponse">External<wbr>Data<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] Describes the data format, location, and other properties of a table stored outside of BigQuery. By defining these properties, the data source can then be queried as if it were a standard BigQuery table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#materializedview_go" style="color: inherit; text-decoration: inherit;">Materialized<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#materializedviewdefinitionresponse">Materialized<wbr>View<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] Materialized view definition.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="model_go">
<a href="#model_go" style="color: inherit; text-decoration: inherit;">Model</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modeldefinitionresponse">Model<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Output-only, Beta] Present iff this table represents a ML model. Describes the training information for the model, and it is required to run 'PREDICT' queries.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="numbytes_go">
...
<a href="#view_go" style="color: inherit; text-decoration: inherit;">View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#viewdefinitionresponse">View<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Optional] The view definition.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lastrefreshtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Refresh<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] [TrustedTester] The time when this materialized view was last modified, in milliseconds since the epoch.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#basetablereference_csharp" style="color: inherit; text-decoration: inherit;">Base<wbr>Table<wbr>Reference</a>
    ...
    <dd>{{% md %}}[Required] Reference describing the ID of the table that is snapshotted.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#snapshottime_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Time</a>
    ...
    <dd>{{% md %}}[Required] The time at which the base table was snapshot.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#estimatedbytes_csharp" style="color: inherit; text-decoration: inherit;">Estimated<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output-only] A lower-bound estimate of the number of bytes currently in the streaming buffer.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#estimatedrows_csharp" style="color: inherit; text-decoration: inherit;">Estimated<wbr>Rows</a>
    ...
    <dd>{{% md %}}[Output-only] A lower-bound estimate of the number of rows currently in the streaming buffer.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#oldestentrytime_csharp" style="color: inherit; text-decoration: inherit;">Oldest<wbr>Entry<wbr>Time</a>
    ...
    <dd>{{% md %}}[Output-only] Contains the timestamp of the oldest entry in the streaming buffer, in milliseconds since the epoch, if the streaming buffer is available.{{% /md %}}</dd></dl>
{{% /choosable %}}
