...
---
title: "Config"
title_tag: "google-native.gameservices/v1.Config"
meta_desc: "Documentation for the google-native.gameservices/v1.Config resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Config</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">fleet_configs</span><span class="p">:</span> <span class="nx">Optional[Sequence[FleetConfigArgs]]</span> = None<span class="p">,</span>
           ...
           <span class="nx">scaling_configs</span><span class="p">:</span> <span class="nx">Optional[Sequence[ScalingConfigArgs]]</span> = None<span class="p">)</span>
...
<a href="#fleetconfigs_csharp" style="color: inherit; text-decoration: inherit;">Fleet<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fleetconfig">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Game<wbr>Services.<wbr>V1.<wbr>Inputs.<wbr>Fleet<wbr>Config<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#scalingconfigs_csharp" style="color: inherit; text-decoration: inherit;">Scaling<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scalingconfig">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Game<wbr>Services.<wbr>V1.<wbr>Inputs.<wbr>Scaling<wbr>Config<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#fleet_configs_python" style="color: inherit; text-decoration: inherit;">fleet_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#fleetconfig">Sequence[Fleet<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}FleetConfig contains a list of Agones fleet specs. Only one FleetConfig is allowed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#scaling_configs_python" style="color: inherit; text-decoration: inherit;">scaling_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scalingconfig">Sequence[Scaling<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The autoscaling settings.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the Scaling Config{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="schedules_csharp">
<a href="#schedules_csharp" style="color: inherit; text-decoration: inherit;">Schedules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Game<wbr>Services.<wbr>V1.<wbr>Inputs.<wbr>Schedule&gt;</a></span>
    </dt>
...
<a href="#selectors_csharp" style="color: inherit; text-decoration: inherit;">Selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#labelselector">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Game<wbr>Services.<wbr>V1.<wbr>Inputs.<wbr>Label<wbr>Selector&gt;</a></span>
    </dt>
...
<a href="#schedules_python" style="color: inherit; text-decoration: inherit;">schedules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedule">Sequence[Schedule]</a></span>
    </dt>
    <dd>{{% md %}}The schedules to which this Scaling Config applies.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#selectors_python" style="color: inherit; text-decoration: inherit;">selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#labelselector">Sequence[Label<wbr>Selector]</a></span>
    </dt>
    <dd>{{% md %}}Labels used to identify the game server clusters to which this Agones scaling config applies. A game server cluster is subject to this Agones scaling config if its labels match any of the selector entries.{{% /md %}}</dd></dl>
{{% /choosable %}}
