...
---
title: "Database"
title_tag: "google-native.sqladmin/v1.Database"
meta_desc: "Documentation for the google-native.sqladmin/v1.Database resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#sqlserverdatabasedetails_csharp" style="color: inherit; text-decoration: inherit;">Sqlserver<wbr>Database<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqlserverdatabasedetails">Pulumi.<wbr>Google<wbr>Native.<wbr>SQLAdmin.<wbr>V1.<wbr>Inputs.<wbr>Sql<wbr>Server<wbr>Database<wbr>Details<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
