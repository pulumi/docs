...
<a href="#externalipv6prefix_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Ipv6Prefix</a>
    ...
    <dd>{{% md %}}[Output Only] The range of external IPv6 addresses that are owned by this subnetwork.{{% /md %}}</dd><dt class="property-"
            title="">
