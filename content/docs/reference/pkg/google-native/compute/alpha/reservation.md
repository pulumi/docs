...
<span class="k">def </span><span class="nx">Reservation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">share_settings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_compute_alpha.AllocationShareSettingsArgs]]</span> = None<span class="p">,</span>
                <span class="nx">specific_reservation</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_compute_alpha.AllocationSpecificSKUReservationArgs]]</span> = None<span class="p">,</span>
