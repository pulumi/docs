...
<a href="#endtimestamp_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Commitment end time in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#commitment for commitments.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] URL of the region where this commitment may be used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#starttimestamp_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Commitment start time in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] Status of the commitment with regards to eventual expiration (each commitment has an end date defined). One of the following values: NOT_YET_ACTIVE, ACTIVE, EXPIRED.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sharesettings_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationsharesettingsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Allocation<wbr>Share<wbr>Settings<wbr>Response</a></span>
    </dt>
