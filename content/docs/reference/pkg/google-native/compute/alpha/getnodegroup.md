...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] The type of the resource. Always compute#nodeGroup for node group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}[Output Only] The total number of nodes in the node group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#zone_csharp" style="color: inherit; text-decoration: inherit;">Zone</a>
    ...
    <dd>{{% md %}}[Output Only] The name of the zone where the node group resides, such as us-central1-a.{{% /md %}}</dd></dl>
{{% /choosable %}}
