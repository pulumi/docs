...
<a href="#bgp_peers_python" style="color: inherit; text-decoration: inherit;">bgp_<wbr>peers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeer">Sequence[Router<wbr>Bgp<wbr>Peer<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}BGP information that must be configured into the routing stack to establish BGP peering. This information must specify the peer ASN and either the interface name, IP address, or peer IP address. Please refer to RFC4273.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#advertisedgroups_csharp" style="color: inherit; text-decoration: inherit;">Advertised<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeeradvertisedgroupsitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Bgp<wbr>Peer<wbr>Advertised<wbr>Groups<wbr>Item&gt;</a></span>
    </dt>
...
<a href="#bfd_csharp" style="color: inherit; text-decoration: inherit;">Bfd</a>
    ...
    <dd>{{% md %}}BFD configuration for the BGP peering.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#minreceiveinterval_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Receive<wbr>Interval</a>
    ...
    <dd>{{% md %}}The minimum interval, in milliseconds, between BFD control packets received from the peer router. The actual value is negotiated between the two routers and is equal to the greater of this value and the transmit interval of the other router. If set, this value must be between 1000 and 30000. The default is 1000.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mintransmitinterval_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Transmit<wbr>Interval</a>
    ...
    <dd>{{% md %}}The minimum interval, in milliseconds, between BFD control packets transmitted to the peer router. The actual value is negotiated between the two routers and is equal to the greater of this value and the corresponding receive interval of the other router. If set, this value must be between 1000 and 30000. The default is 1000.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="mode_csharp">
...
<a href="#multiplier_csharp" style="color: inherit; text-decoration: inherit;">Multiplier</a>
    ...
    <dd>{{% md %}}The number of consecutive BFD packets that must be missed before BFD declares that a peer is unavailable. If set, the value must be a value between 5 and 16. The default is 5.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="packetmode_csharp">
<a href="#packetmode_csharp" style="color: inherit; text-decoration: inherit;">Packet<wbr>Mode</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeerbfdpacketmode">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Packet<wbr>Mode</a></span>
    </dt>
...
<a href="#sessioninitializationmode_csharp" style="color: inherit; text-decoration: inherit;">Session<wbr>Initialization<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeerbfdsessioninitializationmode">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}The BFD session initialization mode for this BGP peer. If set to ACTIVE, the Cloud Router will initiate the BFD session for this BGP peer. If set to PASSIVE, the Cloud Router will wait for the peer router to initiate the BFD session for this BGP peer. If set to DISABLED, BFD is disabled for this BGP peer. The default is PASSIVE.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mode_go" style="color: inherit; text-decoration: inherit;">Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeerbfdmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}The BFD session initialization mode for this BGP peer. If set to ACTIVE, the Cloud Router will initiate the BFD session for this BGP peer. If set to PASSIVE, the Cloud Router will wait for the peer router to initiate the BFD session for this BGP peer. If set to DISABLED, BFD is disabled for this BGP peer. The default is PASSIVE.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#packetmode_go" style="color: inherit; text-decoration: inherit;">Packet<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeerbfdpacketmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Packet<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}The BFD packet mode for this BGP peer. If set to CONTROL_AND_ECHO, BFD echo mode is enabled for this BGP peer. In this mode, if the peer router also has BFD echo mode enabled, BFD echo packets will be sent to the other router. If the peer router does not have BFD echo mode enabled, only control packets will be sent. If set to CONTROL_ONLY, BFD echo mode is disabled for this BGP peer. If this router and the peer router have a multihop connection, this should be set to CONTROL_ONLY as BFD echo mode is only supported on singlehop connections. The default is CONTROL_AND_ECHO.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sessioninitializationmode_go" style="color: inherit; text-decoration: inherit;">Session<wbr>Initialization<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routerbgppeerbfdsessioninitializationmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}The BFD session initialization mode for this BGP peer. If set to ACTIVE, the Cloud Router will initiate the BFD session for this BGP peer. If set to PASSIVE, the Cloud Router will wait for the peer router to initiate the BFD session for this BGP peer. If set to DISABLED, BFD is disabled for this BGP peer. The default is PASSIVE.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="routerbgppeerbfdmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Active</dt>
    <dd>ACTIVE</dd><dt>Disabled</dt>
    <dd>DISABLED</dd><dt>Passive</dt>
    <dd>PASSIVE</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Mode<wbr>Active</dt>
    <dd>ACTIVE</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Mode<wbr>Disabled</dt>
    <dd>DISABLED</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Mode<wbr>Passive</dt>
    <dd>PASSIVE</dd></dl>
{{% /choosable %}}
...
<h4 id="routerbgppeerbfdpacketmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Packet<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Control<wbr>And<wbr>Echo</dt>
    <dd>CONTROL_AND_ECHO</dd><dt>Control<wbr>Only</dt>
    <dd>CONTROL_ONLY</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Packet<wbr>Mode<wbr>Control<wbr>And<wbr>Echo</dt>
    <dd>CONTROL_AND_ECHO</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Packet<wbr>Mode<wbr>Control<wbr>Only</dt>
    <dd>CONTROL_ONLY</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>CONTROL_AND_ECHO</dt>
    <dd>CONTROL_AND_ECHO</dd><dt>CONTROL_ONLY</dt>
    <dd>CONTROL_ONLY</dd></dl>
{{% /choosable %}}
...
<h4 id="routerbgppeerbfdsessioninitializationmode">Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode<wbr>Active</dt>
    <dd>ACTIVE</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode<wbr>Disabled</dt>
    <dd>DISABLED</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Bfd<wbr>Session<wbr>Initialization<wbr>Mode<wbr>Passive</dt>
    <dd>PASSIVE</dd></dl>
{{% /choosable %}}
...
<h4 id="routerbgppeerenable">Router<wbr>Bgp<wbr>Peer<wbr>Enable</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Bgp<wbr>Peer<wbr>Enable<wbr>False</dt>
    <dd>FALSE</dd><dt>Router<wbr>Bgp<wbr>Peer<wbr>Enable<wbr>True</dt>
    <dd>TRUE</dd></dl>
{{% /choosable %}}
...
<a href="#logconfig_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatlogconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Router<wbr>Nat<wbr>Log<wbr>Config</a></span>
    </dt>
...
<a href="#natipallocateoption_csharp" style="color: inherit; text-decoration: inherit;">Nat<wbr>Ip<wbr>Allocate<wbr>Option</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatnatipallocateoption">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Nat<wbr>Nat<wbr>Ip<wbr>Allocate<wbr>Option</a></span>
    </dt>
    <dd>{{% md %}}Specify the NatIpAllocateOption, which can take one of the following values: - MANUAL_ONLY: Uses only Nat IP addresses provided by customers. When there are not enough specified Nat IPs, the Nat service fails for new VMs. - AUTO_ONLY: Nat IPs are allocated by Google Cloud Platform; customers can't specify any Nat IPs. When choosing AUTO_ONLY, then nat_ip should be empty. {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_csharp" style="color: inherit; text-decoration: inherit;">Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatrule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Router<wbr>Nat<wbr>Rule&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of rules associated with this NAT.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sourcesubnetworkiprangestonat_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Subnetwork<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatsourcesubnetworkiprangestonat">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Nat<wbr>Source<wbr>Subnetwork<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat</a></span>
    </dt>
...
<a href="#subnetworks_csharp" style="color: inherit; text-decoration: inherit;">Subnetworks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatsubnetworktonat">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat&gt;</a></span>
    </dt>
...
<a href="#tcptimewaittimeoutsec_csharp" style="color: inherit; text-decoration: inherit;">Tcp<wbr>Time<wbr>Wait<wbr>Timeout<wbr>Sec</a>
    ...
    <dd>{{% md %}}Timeout (in seconds) for TCP connections that are in TIME_WAIT state. Defaults to 120s if not set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_go" style="color: inherit; text-decoration: inherit;">Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatrule">[]Router<wbr>Nat<wbr>Rule</a></span>
    </dt>
    <dd>{{% md %}}A list of rules associated with this NAT.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_python" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatrule">Sequence[Router<wbr>Nat<wbr>Rule]</a></span>
    </dt>
    <dd>{{% md %}}A list of rules associated with this NAT.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subnetworks_python" style="color: inherit; text-decoration: inherit;">subnetworks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatsubnetworktonat">Sequence[Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat]</a></span>
    </dt>
    <dd>{{% md %}}A list of Subnetwork resources whose traffic should be translated by NAT Gateway. It is used only when LIST_OF_SUBNETWORKS is selected for the SubnetworkIpRangeToNatOption above.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#filter_csharp" style="color: inherit; text-decoration: inherit;">Filter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatlogconfigfilter">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Nat<wbr>Log<wbr>Config<wbr>Filter</a></span>
    </dt>
...
<dl class="tabular"><dt>All</dt>
    <dd>ALL{{% md %}}Export logs for all (successful and unsuccessful) connections.{{% /md %}}</dd><dt>Errors<wbr>Only</dt>
    <dd>ERRORS_ONLY{{% md %}}Export logs for connection failures only.{{% /md %}}</dd><dt>Translations<wbr>Only</dt>
    <dd>TRANSLATIONS_ONLY{{% md %}}Export logs for successful connections only.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Nat<wbr>Log<wbr>Config<wbr>Filter<wbr>All</dt>
    <dd>ALL{{% md %}}Export logs for all (successful and unsuccessful) connections.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Log<wbr>Config<wbr>Filter<wbr>Errors<wbr>Only</dt>
    <dd>ERRORS_ONLY{{% md %}}Export logs for connection failures only.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Log<wbr>Config<wbr>Filter<wbr>Translations<wbr>Only</dt>
    <dd>TRANSLATIONS_ONLY{{% md %}}Export logs for successful connections only.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>ALL</dt>
    <dd>ALL{{% md %}}Export logs for all (successful and unsuccessful) connections.{{% /md %}}</dd><dt>ERRORS_ONLY</dt>
    <dd>ERRORS_ONLY{{% md %}}Export logs for connection failures only.{{% /md %}}</dd><dt>TRANSLATIONS_ONLY</dt>
    <dd>TRANSLATIONS_ONLY{{% md %}}Export logs for successful connections only.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Auto<wbr>Only</dt>
    <dd>AUTO_ONLY{{% md %}}Nat IPs are allocated by GCP; customers can not specify any Nat IPs.{{% /md %}}</dd><dt>Manual<wbr>Only</dt>
    <dd>MANUAL_ONLY{{% md %}}Only use Nat IPs provided by customers. When specified Nat IPs are not enough then the Nat service fails for new VMs.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Router<wbr>Nat<wbr>Nat<wbr>Ip<wbr>Allocate<wbr>Option<wbr>Auto<wbr>Only</dt>
    <dd>AUTO_ONLY{{% md %}}Nat IPs are allocated by GCP; customers can not specify any Nat IPs.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Nat<wbr>Ip<wbr>Allocate<wbr>Option<wbr>Manual<wbr>Only</dt>
    <dd>MANUAL_ONLY{{% md %}}Only use Nat IPs provided by customers. When specified Nat IPs are not enough then the Nat service fails for new VMs.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>AUTO_ONLY</dt>
    <dd>AUTO_ONLY{{% md %}}Nat IPs are allocated by GCP; customers can not specify any Nat IPs.{{% /md %}}</dd><dt>MANUAL_ONLY</dt>
    <dd>MANUAL_ONLY{{% md %}}Only use Nat IPs provided by customers. When specified Nat IPs are not enough then the Nat service fails for new VMs.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="routernatrule">Router<wbr>Nat<wbr>Rule</h4>
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatruleaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Router<wbr>Nat<wbr>Rule<wbr>Action</a></span>
    </dt>
    <dd>{{% md %}}The action to be enforced for traffic that matches this rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
    ...
    <dd>{{% md %}}An optional description of this rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#action_go" style="color: inherit; text-decoration: inherit;">Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatruleaction">Router<wbr>Nat<wbr>Rule<wbr>Action</a></span>
    </dt>
    <dd>{{% md %}}The action to be enforced for traffic that matches this rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="description_go">
...
<h4 id="routernatruleaction">Router<wbr>Nat<wbr>Rule<wbr>Action</h4>
...
<a href="#sourcenatactiveips_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Nat<wbr>Active<wbr>Ips</a>
    ...
    <dd>{{% md %}}A list of URLs of the IP resources used for this NAT rule. These IP addresses must be valid static external IP addresses assigned to the project. This field is used for public NAT.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>All<wbr>Subnetworks<wbr>All<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_SUBNETWORKS_ALL_IP_RANGES{{% md %}}All the IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>All<wbr>Subnetworks<wbr>All<wbr>Primary<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES{{% md %}}All the primary IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>List<wbr>Of<wbr>Subnetworks</dt>
    <dd>LIST_OF_SUBNETWORKS{{% md %}}A list of Subnetworks are allowed to Nat (specified in the field subnetwork below){{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Router<wbr>Nat<wbr>Source<wbr>Subnetwork<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>All<wbr>Subnetworks<wbr>All<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_SUBNETWORKS_ALL_IP_RANGES{{% md %}}All the IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Source<wbr>Subnetwork<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>All<wbr>Subnetworks<wbr>All<wbr>Primary<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES{{% md %}}All the primary IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Source<wbr>Subnetwork<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>List<wbr>Of<wbr>Subnetworks</dt>
    <dd>LIST_OF_SUBNETWORKS{{% md %}}A list of Subnetworks are allowed to Nat (specified in the field subnetwork below){{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ALL_SUBNETWORKS_ALL_IP_RANGES</dt>
    <dd>ALL_SUBNETWORKS_ALL_IP_RANGES{{% md %}}All the IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES</dt>
    <dd>ALL_SUBNETWORKS_ALL_PRIMARY_IP_RANGES{{% md %}}All the primary IP ranges in every Subnetwork are allowed to Nat.{{% /md %}}</dd><dt>LIST_OF_SUBNETWORKS</dt>
    <dd>LIST_OF_SUBNETWORKS{{% md %}}A list of Subnetworks are allowed to Nat (specified in the field subnetwork below){{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#sourceiprangestonat_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatsubnetworktonatsourceiprangestonatitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat<wbr>Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>Item&gt;</a></span>
    </dt>
...
<a href="#source_ip_ranges_to_nat_python" style="color: inherit; text-decoration: inherit;">source_<wbr>ip_<wbr>ranges_<wbr>to_<wbr>nat</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routernatsubnetworktonatsourceiprangestonatitem">Sequence[Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat<wbr>Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}Specify the options for NAT ranges in the Subnetwork. All options of a single value are valid except NAT_IP_RANGE_OPTION_UNSPECIFIED. The only valid option with multiple values is: ["PRIMARY_IP_RANGE", "LIST_OF_SECONDARY_IP_RANGES"] Default: [ALL_IP_RANGES]{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>All<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_IP_RANGES{{% md %}}The primary and all the secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>List<wbr>Of<wbr>Secondary<wbr>Ip<wbr>Ranges</dt>
    <dd>LIST_OF_SECONDARY_IP_RANGES{{% md %}}A list of secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>Primary<wbr>Ip<wbr>Range</dt>
    <dd>PRIMARY_IP_RANGE{{% md %}}The primary range is allowed to Nat.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat<wbr>Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>Item<wbr>All<wbr>Ip<wbr>Ranges</dt>
    <dd>ALL_IP_RANGES{{% md %}}The primary and all the secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat<wbr>Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>Item<wbr>List<wbr>Of<wbr>Secondary<wbr>Ip<wbr>Ranges</dt>
    <dd>LIST_OF_SECONDARY_IP_RANGES{{% md %}}A list of secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>Router<wbr>Nat<wbr>Subnetwork<wbr>To<wbr>Nat<wbr>Source<wbr>Ip<wbr>Ranges<wbr>To<wbr>Nat<wbr>Item<wbr>Primary<wbr>Ip<wbr>Range</dt>
    <dd>PRIMARY_IP_RANGE{{% md %}}The primary range is allowed to Nat.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ALL_IP_RANGES</dt>
    <dd>ALL_IP_RANGES{{% md %}}The primary and all the secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>LIST_OF_SECONDARY_IP_RANGES</dt>
    <dd>LIST_OF_SECONDARY_IP_RANGES{{% md %}}A list of secondary ranges are allowed to Nat.{{% /md %}}</dd><dt>PRIMARY_IP_RANGE</dt>
    <dd>PRIMARY_IP_RANGE{{% md %}}The primary range is allowed to Nat.{{% /md %}}</dd></dl>
{{% /choosable %}}
