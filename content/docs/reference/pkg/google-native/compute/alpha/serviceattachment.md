...
<span class="k">def </span><span class="nx">ServiceAttachment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">connected_endpoints</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_compute_alpha.ServiceAttachmentConnectedEndpointArgs]]]]</span> = None<span class="p">,</span>
                      ...
                      <span class="nx">consumer_accept_lists</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_compute_alpha.ServiceAttachmentConsumerProjectLimitArgs]]]]</span> = None<span class="p">,</span>
                      <span class="nx">consumer_forwarding_rules</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_compute_alpha.ServiceAttachmentConsumerForwardingRuleArgs]]]]</span> = None<span class="p">,</span>
                      <span class="nx">consumer_reject_lists</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                      ...
                      <span class="nx">psc_service_attachment_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_compute_alpha.Uint128Args]]</span> = None<span class="p">,</span>
...
<a href="#connectedendpoints_csharp" style="color: inherit; text-decoration: inherit;">Connected<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconnectedendpoint">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Service<wbr>Attachment<wbr>Connected<wbr>Endpoint<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#consumerforwardingrules_csharp" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Forwarding<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconsumerforwardingrule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Service<wbr>Attachment<wbr>Consumer<wbr>Forwarding<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#pscserviceattachmentid_csharp" style="color: inherit; text-decoration: inherit;">Psc<wbr>Service<wbr>Attachment<wbr>Id</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#uint128">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Uint128Args</a></span>
    </dt>
...
<a href="#consumeracceptlists_go" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Accept<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconsumerprojectlimit">[]Service<wbr>Attachment<wbr>Consumer<wbr>Project<wbr>Limit</a></span>
    </dt>
    <dd>{{% md %}}Projects that are allowed to connect to this service attachment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#consumeracceptlists_nodejs" style="color: inherit; text-decoration: inherit;">consumer<wbr>Accept<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconsumerprojectlimit">pulumi.<wbr>Input<pulumi.<wbr>Input<Service<wbr>Attachment<wbr>Consumer<wbr>Project<wbr>Limit<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Projects that are allowed to connect to this service attachment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
