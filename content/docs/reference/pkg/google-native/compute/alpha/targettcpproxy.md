...
<span class="k">def </span><span class="nx">TargetTcpProxy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">proxy_header</span><span class="p">:</span> <span class="nx">Optional[_compute_alpha.TargetTcpProxyProxyHeader]</span> = None<span class="p">,</span>
...
<a href="#proxyheader_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Header</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#targettcpproxyproxyheader">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Target<wbr>Tcp<wbr>Proxy<wbr>Proxy<wbr>Header</a></span>
    </dt>
