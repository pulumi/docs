...
<dl class="tabular"><dt>Address<wbr>Address<wbr>Type<wbr>Dns<wbr>Forwarding</dt>
    <dd>DNS_FORWARDING{{% md %}}DNS resolver address in the subnetwork.{{% /md %}}</dd><dt>Address<wbr>Address<wbr>Type<wbr>External</dt>
...
<dl class="tabular"><dt>Address<wbr>Network<wbr>Tier<wbr>Fixed<wbr>Standard</dt>
    <dd>FIXED_STANDARD{{% md %}}Public internet quality with fixed bandwidth.{{% /md %}}</dd><dt>Address<wbr>Network<wbr>Tier<wbr>Premium</dt>
    <dd>PREMIUM{{% md %}}High quality, Google-grade network tier, support for all networking products.{{% /md %}}</dd><dt>Address<wbr>Network<wbr>Tier<wbr>Select</dt>
    <dd>SELECT{{% md %}}Price competitive network tier, support for all networking products.{{% /md %}}</dd><dt>Address<wbr>Network<wbr>Tier<wbr>Standard</dt>
    <dd>STANDARD{{% md %}}Public internet quality, only limited support for other networking products.{{% /md %}}</dd><dt>Address<wbr>Network<wbr>Tier<wbr>Standard<wbr>Overrides<wbr>Fixed<wbr>Standard</dt>
    <dd>STANDARD_OVERRIDES_FIXED_STANDARD{{% md %}}(Output only) Temporary tier for FIXED_STANDARD when fixed standard tier is expired or not configured.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Address<wbr>Purpose<wbr>Dns<wbr>Resolver</dt>
    ...
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}A private network IP address that can be used to configure Private Service Connect. This purpose can be specified only for GLOBAL addresses of Type INTERNAL{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Psc<wbr>Producer<wbr>Nat<wbr>Range</dt>
    <dd>PSC_PRODUCER_NAT_RANGE{{% md %}}Internal IP range provided by producers for PSC ILB.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Shared<wbr>Loadbalancer<wbr>Vip</dt>
