...
title_tag: "google-native.compute/alpha.getRegionInstanceGroupManager"
meta_desc: "Documentation for the google-native.compute/alpha.getRegionInstanceGroupManager function with examples, input properties, output properties, and supporting types."
---
...
## Using getRegionInstanceGroupManager {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getRegionInstanceGroupManager<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetRegionInstanceGroupManagerArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetRegionInstanceGroupManagerResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_region_instance_group_manager(</span><span class="nx">instance_group_manager</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRegionInstanceGroupManagerResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRegionInstanceGroupManager<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupRegionInstanceGroupManagerArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupRegionInstanceGroupManagerResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetRegionInstanceGroupManager </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetRegionInstanceGroupManagerResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetRegionInstanceGroupManagerArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## getRegionInstanceGroupManager Result {#result}
...
<a href="#autohealingpolicies_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Healing<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerautohealingpolicyresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Auto<wbr>Healing<wbr>Policy<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The autohealing policy for this managed instance group. You can specify only one value.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#baseinstancename_csharp" style="color: inherit; text-decoration: inherit;">Base<wbr>Instance<wbr>Name</a>
    ...
    <dd>{{% md %}}The base instance name to use for instances in this group. The value must be 1-58 characters long. Instances are named by appending a hyphen and a random four-character string to the base instance name. The base instance name must comply with RFC1035.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#creationtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] The creation timestamp for this managed instance group in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#currentactions_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanageractionssummaryresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Actions<wbr>Summary<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] The list of instance actions and the number of instances in this managed instance group that are scheduled for each of those actions.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#distributionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Distribution<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Distribution<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Policy specifying the intended distribution of managed instances across zones in a regional managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#failoveraction_csharp" style="color: inherit; text-decoration: inherit;">Failover<wbr>Action</a>
    ...
    <dd>{{% md %}}The action to perform in case of zone failure. Only one value is supported, NO_FAILOVER. The default is NO_FAILOVER.{{% /md %}}</dd><dt class="property-"
            title="">
...
To see the latest fingerprint, make a get() request to retrieve an InstanceGroupManager.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#instancegroup_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Group</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the Instance Group resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="instancelifecyclepolicy_csharp">
<a href="#instancelifecyclepolicy_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lifecycle<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Instance lifecycle policy for this Instance Group Manager.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] The resource type, which is always compute#instanceGroupManager for managed instance groups.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the managed instance group. The name must be 1-63 characters long, and comply with RFC1035.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#namedports_csharp" style="color: inherit; text-decoration: inherit;">Named<wbr>Ports</a>
    ...
    <dd>{{% md %}}Named ports configured for the Instance Groups complementary to this Instance Group Manager.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="region_csharp">
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
</span>
    ...
    <dd>{{% md %}}[Output Only] The URL of the region where the managed instance group resides (for regional resources).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output Only] The URL for this managed instance group. The server defines this URL.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflinkwithid_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link<wbr>With<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] Server-defined URL for this resource with the resource id.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceaccount_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account</a>
    ...
    <dd>{{% md %}}The service account to be used as credentials for all operations performed by the managed instance group on instances. The service accounts needs all permissions required to create and delete instances. By default, the service account {projectNumber}@cloudservices.gserviceaccount.com is used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#statefulpolicy_csharp" style="color: inherit; text-decoration: inherit;">Stateful<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statefulpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Stateful<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Stateful configuration for this Instanced Group Manager{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerstatusresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] The status of this managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetpools_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Pools</a>
    ...
    <dd>{{% md %}}The URLs for all TargetPool resources to which instances in the instanceGroup field are added. The target pools automatically apply to all of the instances in the managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetsize_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Size</a>
    ...
    <dd>{{% md %}}The target number of running instances for this managed instance group. You can reduce this number by using the instanceGroupManager deleteInstances or abandonInstances methods. Resizing the group also changes this number.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetstoppedsize_csharp">
<a href="#targetstoppedsize_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Stopped<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}The target number of stopped instances for this managed instance group. This number changes when you:  
- Stop instance using the stopInstances method or start instances using the startInstances method. 
- Manually change the targetStoppedSize using the update method.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetsuspendedsize_csharp">
<a href="#targetsuspendedsize_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Suspended<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}The target number of suspended instances for this managed instance group. This number changes when you:  
- Suspend instance using the suspendInstances method or resume instances using the resumeInstances method. 
- Manually change the targetSuspendedSize using the update method.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="updatepolicy_csharp">
<a href="#updatepolicy_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerupdatepolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Update<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The update policy for this managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="versions_csharp">
<a href="#versions_csharp" style="color: inherit; text-decoration: inherit;">Versions</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerversionresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Version<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the instance templates used by this managed instance group to create instances.

Each version is defined by an instanceTemplate and a name. Every version can appear at most once per instance group. This field overrides the top-level instanceTemplate field. Read more about the relationships between these fields. Exactly one version must leave the targetSize field unset. That version will be applied to all remaining instances. For more information, read about canary updates.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="zone_csharp">
...
<a href="#autohealingpolicies_go" style="color: inherit; text-decoration: inherit;">Auto<wbr>Healing<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerautohealingpolicyresponse">[]Instance<wbr>Group<wbr>Manager<wbr>Auto<wbr>Healing<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The autohealing policy for this managed instance group. You can specify only one value.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#distributionpolicy_go" style="color: inherit; text-decoration: inherit;">Distribution<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionpolicyresponse">Distribution<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Policy specifying the intended distribution of managed instances across zones in a regional managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#instancegroup_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Group</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the Instance Group resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="instancelifecyclepolicy_go">
<a href="#instancelifecyclepolicy_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lifecycle<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicyresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Instance lifecycle policy for this Instance Group Manager.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#statefulpolicy_go" style="color: inherit; text-decoration: inherit;">Stateful<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statefulpolicyresponse">Stateful<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Stateful configuration for this Instanced Group Manager{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="status_go">
...
<a href="#targetsize_go" style="color: inherit; text-decoration: inherit;">Target<wbr>Size</a>
    ...
    <dd>{{% md %}}The target number of running instances for this managed instance group. You can reduce this number by using the instanceGroupManager deleteInstances or abandonInstances methods. Resizing the group also changes this number.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetstoppedsize_go">
<a href="#targetstoppedsize_go" style="color: inherit; text-decoration: inherit;">Target<wbr>Stopped<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
- Manually change the targetStoppedSize using the update method.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetsuspendedsize_go">
<a href="#targetsuspendedsize_go" style="color: inherit; text-decoration: inherit;">Target<wbr>Suspended<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#updatepolicy_go" style="color: inherit; text-decoration: inherit;">Update<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerupdatepolicyresponse">Instance<wbr>Group<wbr>Manager<wbr>Update<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The update policy for this managed instance group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="versions_go">
<a href="#versions_go" style="color: inherit; text-decoration: inherit;">Versions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerversionresponse">[]Instance<wbr>Group<wbr>Manager<wbr>Version<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the instance templates used by this managed instance group to create instances.
...
<a href="#instancegroup_nodejs" style="color: inherit; text-decoration: inherit;">instance<wbr>Group</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the Instance Group resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="instancelifecyclepolicy_nodejs">
<a href="#instancelifecyclepolicy_nodejs" style="color: inherit; text-decoration: inherit;">instance<wbr>Lifecycle<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicyresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#targetsize_nodejs" style="color: inherit; text-decoration: inherit;">target<wbr>Size</a>
    ...
    <dd>{{% md %}}The target number of running instances for this managed instance group. You can reduce this number by using the instanceGroupManager deleteInstances or abandonInstances methods. Resizing the group also changes this number.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetstoppedsize_nodejs">
<a href="#targetstoppedsize_nodejs" style="color: inherit; text-decoration: inherit;">target<wbr>Stopped<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
- Manually change the targetStoppedSize using the update method.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="targetsuspendedsize_nodejs">
<a href="#targetsuspendedsize_nodejs" style="color: inherit; text-decoration: inherit;">target<wbr>Suspended<wbr>Size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a href="#instance_group_python" style="color: inherit; text-decoration: inherit;">instance_<wbr>group</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the Instance Group resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="instance_lifecycle_policy_python">
<a href="#instance_lifecycle_policy_python" style="color: inherit; text-decoration: inherit;">instance_<wbr>lifecycle_<wbr>policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicyresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#target_size_python" style="color: inherit; text-decoration: inherit;">target_<wbr>size</a>
    ...
    <dd>{{% md %}}The target number of running instances for this managed instance group. You can reduce this number by using the instanceGroupManager deleteInstances or abandonInstances methods. Resizing the group also changes this number.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="target_stopped_size_python">
<a href="#target_stopped_size_python" style="color: inherit; text-decoration: inherit;">target_<wbr>stopped_<wbr>size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
- Manually change the targetStoppedSize using the update method.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="target_suspended_size_python">
<a href="#target_suspended_size_python" style="color: inherit; text-decoration: inherit;">target_<wbr>suspended_<wbr>size</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#zones_csharp" style="color: inherit; text-decoration: inherit;">Zones</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionpolicyzoneconfigurationresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Distribution<wbr>Policy<wbr>Zone<wbr>Configuration<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#restarting_csharp" style="color: inherit; text-decoration: inherit;">Restarting</a>
    ...
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be restarted or are currently being restarted.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resuming_csharp">
<a href="#resuming_csharp" style="color: inherit; text-decoration: inherit;">Resuming</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starting_csharp">
<a href="#starting_csharp" style="color: inherit; text-decoration: inherit;">Starting</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be started or are currently being started.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stopping_csharp">
<a href="#stopping_csharp" style="color: inherit; text-decoration: inherit;">Stopping</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="suspending_csharp">
<a href="#suspending_csharp" style="color: inherit; text-decoration: inherit;">Suspending</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be suspended or are currently being suspended.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#restarting_go" style="color: inherit; text-decoration: inherit;">Restarting</a>
    ...
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be restarted or are currently being restarted.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resuming_go">
<a href="#resuming_go" style="color: inherit; text-decoration: inherit;">Resuming</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starting_go">
<a href="#starting_go" style="color: inherit; text-decoration: inherit;">Starting</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be started or are currently being started.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stopping_go">
<a href="#stopping_go" style="color: inherit; text-decoration: inherit;">Stopping</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="suspending_go">
<a href="#suspending_go" style="color: inherit; text-decoration: inherit;">Suspending</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#restarting_nodejs" style="color: inherit; text-decoration: inherit;">restarting</a>
    ...
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be restarted or are currently being restarted.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resuming_nodejs">
<a href="#resuming_nodejs" style="color: inherit; text-decoration: inherit;">resuming</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starting_nodejs">
<a href="#starting_nodejs" style="color: inherit; text-decoration: inherit;">starting</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be started or are currently being started.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stopping_nodejs">
<a href="#stopping_nodejs" style="color: inherit; text-decoration: inherit;">stopping</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="suspending_nodejs">
<a href="#suspending_nodejs" style="color: inherit; text-decoration: inherit;">suspending</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a href="#restarting_python" style="color: inherit; text-decoration: inherit;">restarting</a>
    ...
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be restarted or are currently being restarted.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resuming_python">
<a href="#resuming_python" style="color: inherit; text-decoration: inherit;">resuming</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starting_python">
<a href="#starting_python" style="color: inherit; text-decoration: inherit;">starting</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be started or are currently being started.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stopping_python">
<a href="#stopping_python" style="color: inherit; text-decoration: inherit;">stopping</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}[Output Only] The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="suspending_python">
<a href="#suspending_python" style="color: inherit; text-decoration: inherit;">suspending</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#maxunavailable_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Unavailable</a>
    ...
    <dd>{{% md %}}Maximum number of instances that can be unavailable when autohealing. When 'percent' is used, the value is rounded UP. The instance is considered available if all of the following conditions are satisfied: 1. Instance's status is RUNNING. 2. Instance's currentAction is NONE (in particular its liveness health check result was observed to be HEALTHY at least once as it passed VERIFYING). 3. There is no outgoing action on an instance triggered by IGM.
...
<h4 id="instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignalresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal<wbr>Response</h4>
...
<a href="#timeoutsec_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Sec</a>
    ...
    <dd>{{% md %}}The number of seconds to wait for a readiness signal during initialization before timing out.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="instancegroupmanagerinstancelifecyclepolicyresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Response</h4>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metadatabasedreadinesssignal_csharp">
<a href="#metadatabasedreadinesssignal_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Based<wbr>Readiness<wbr>Signal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignalresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The configuration for metadata based readiness signal sent by the instance during initialization when stopping / suspending an instance. The Instance Group Manager will wait for a signal that indicates successful initialization before stopping / suspending an instance.
...
If metadataBasedReadinessSignal.timeoutSec is unset, the Instance Group Manager will directly proceed to suspend / stop instances, skipping initialization on them.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metadatabasedreadinesssignal_go">
<a href="#metadatabasedreadinesssignal_go" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Based<wbr>Readiness<wbr>Signal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignalresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The configuration for metadata based readiness signal sent by the instance during initialization when stopping / suspending an instance. The Instance Group Manager will wait for a signal that indicates successful initialization before stopping / suspending an instance.
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metadatabasedreadinesssignal_nodejs">
<a href="#metadatabasedreadinesssignal_nodejs" style="color: inherit; text-decoration: inherit;">metadata<wbr>Based<wbr>Readiness<wbr>Signal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignalresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal<wbr>Response</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="metadata_based_readiness_signal_python">
<a href="#metadata_based_readiness_signal_python" style="color: inherit; text-decoration: inherit;">metadata_<wbr>based_<wbr>readiness_<wbr>signal</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignalresponse">Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal<wbr>Response</a></span>
    </dt>
...
<a href="#stateful_csharp" style="color: inherit; text-decoration: inherit;">Stateful</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerstatusstatefulresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Status<wbr>Stateful<wbr>Response</a></span>
    </dt>
...
<a href="#versiontarget_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerstatusversiontargetresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Status<wbr>Version<wbr>Target<wbr>Response</a></span>
    </dt>
...
<a href="#perinstanceconfigs_csharp" style="color: inherit; text-decoration: inherit;">Per<wbr>Instance<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerstatusstatefulperinstanceconfigsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Status<wbr>Stateful<wbr>Per<wbr>Instance<wbr>Configs<wbr>Response</a></span>
    </dt>
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
    ...
    <dd>{{% md %}}Disks created on the instances that will be preserved on instance delete, update, etc. This map is keyed with the device names of the disks.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#externalips_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>IPs</a>
    ...
    <dd>{{% md %}}External network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="internalips_csharp">
<a href="#internalips_csharp" style="color: inherit; text-decoration: inherit;">Internal<wbr>IPs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, string&gt;</span>
    </dt>
    <dd>{{% md %}}Internal network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#externalips_go" style="color: inherit; text-decoration: inherit;">External<wbr>IPs</a>
    ...
    <dd>{{% md %}}External network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="internalips_go">
<a href="#internalips_go" style="color: inherit; text-decoration: inherit;">Internal<wbr>IPs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">map[string]string</span>
    </dt>
...
<a href="#externalips_nodejs" style="color: inherit; text-decoration: inherit;">external<wbr>IPs</a>
    ...
    <dd>{{% md %}}External network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="internalips_nodejs">
<a href="#internalips_nodejs" style="color: inherit; text-decoration: inherit;">internal<wbr>IPs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">{[key: string]: string}</span>
    </dt>
...
<a href="#external_ips_python" style="color: inherit; text-decoration: inherit;">external_<wbr>ips</a>
    ...
    <dd>{{% md %}}External network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="internal_ips_python">
<a href="#internal_ips_python" style="color: inherit; text-decoration: inherit;">internal_<wbr>ips</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, str]</span>
    </dt>
...
<a href="#preservedstate_csharp" style="color: inherit; text-decoration: inherit;">Preserved<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statefulpolicypreservedstateresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Stateful<wbr>Policy<wbr>Preserved<wbr>State<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
