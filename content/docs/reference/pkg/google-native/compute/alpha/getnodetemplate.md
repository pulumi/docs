...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] The type of the resource. Always compute#nodeTemplate for node templates.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
This field is mutually exclusive with the node_type property; you can only define one or the other, but not both.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="region_csharp">
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
</span>
    ...
    <dd>{{% md %}}[Output Only] The name of the region where the node template resides, such as us-central1.{{% /md %}}</dd><dt class="property-"
            title="">
...
See Sole-tenant node options for more information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the node template. One of the following values: CREATING, READY, and DELETING.{{% /md %}}</dd><dt class="property-"
            title="">
