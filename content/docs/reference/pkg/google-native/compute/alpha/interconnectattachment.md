...
<a href="#privateinterconnectinfo_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Interconnect<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#interconnectattachmentprivateinfo">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Interconnect<wbr>Attachment<wbr>Private<wbr>Info<wbr>Args</a></span>
    </dt>
