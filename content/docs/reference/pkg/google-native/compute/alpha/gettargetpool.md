...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#targetPool for target pools.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] URL of the region where the target pool resides.{{% /md %}}</dd><dt class="property-"
            title="">
