...
title_tag: "google-native.compute/alpha.getMachineImage"
meta_desc: "Documentation for the google-native.compute/alpha.getMachineImage function with examples, input properties, output properties, and supporting types."
---
...
<a href="#creationtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] The creation timestamp for this machine image in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] The resource type, which is always compute#machineImage for machine image.{{% /md %}}</dd><dt class="property-"
            title="">
...
If you do not provide an encryption key when creating the machine image, then the machine image will be encrypted using an automatically generated key and you do not need to provide a key to use the machine image later.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output Only] The URL for this machine image. The server defines this URL.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcediskencryptionkeys_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk<wbr>Encryption<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourcediskencryptionkeyresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Source<wbr>Disk<wbr>Encryption<wbr>Key<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#sourceinstanceproperties_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Instance<wbr>Properties</a>
    ...
    <dd>{{% md %}}[Output Only] Properties of source instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the machine image. One of the following values: INVALID, CREATING, READY, DELETING, and UPLOADING.{{% /md %}}</dd><dt class="property-"
            title="">
