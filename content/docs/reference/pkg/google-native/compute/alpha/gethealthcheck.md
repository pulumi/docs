...
title_tag: "google-native.compute/alpha.getHealthCheck"
meta_desc: "Documentation for the google-native.compute/alpha.getHealthCheck function with examples, input properties, output properties, and supporting types."
---
...
<a href="#creationtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Creation timestamp in 3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] Region where the health check resides. Not applicable to global health checks.{{% /md %}}</dd><dt class="property-"
            title="">
