...
<span class="k">def </span><span class="nx">TargetPool</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">session_affinity</span><span class="p">:</span> <span class="nx">Optional[_compute_alpha.TargetPoolSessionAffinity]</span> = None<span class="p">)</span>
...
<a href="#sessionaffinity_csharp" style="color: inherit; text-decoration: inherit;">Session<wbr>Affinity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#targetpoolsessionaffinity">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Target<wbr>Pool<wbr>Session<wbr>Affinity</a></span>
    </dt>
