...
To see the latest fingerprint, make get() request to the security policy.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#parent_csharp" style="color: inherit; text-decoration: inherit;">Parent</a>
    ...
    <dd>{{% md %}}[Output Only] The parent of the security policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ruletuplecount_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Tuple<wbr>Count</a>
    ...
    <dd>{{% md %}}[Output Only] Total count of all security policy rule tuples. A security policy can not exceed a set number of tuples.{{% /md %}}</dd><dt class="property-"
            title="">
...
This field may only be specified when versioned_expr is set to FIREWALL.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
This field may only be specified when versioned_expr is set to FIREWALL.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
This field may only be specified when the versioned_expr is set to FIREWALL.{{% /md %}}</dd><dt class="property-required"
            title="Required">
