...
title_tag: "google-native.compute/alpha.InterconnectAttachment"
meta_desc: "Documentation for the google-native.compute/alpha.InterconnectAttachment resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">InterconnectAttachment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">bandwidth</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentBandwidth]</span> = None<span class="p">,</span>
                           <span class="nx">candidate_ipv6_subnets</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                           <span class="nx">candidate_subnets</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                           <span class="nx">cloud_router_ipv6_interface_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">customer_router_ipv6_interface_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">edge_availability_domain</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentEdgeAvailabilityDomain]</span> = None<span class="p">,</span>
                           <span class="nx">encryption</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentEncryption]</span> = None<span class="p">,</span>
                           ...
                           <span class="nx">partner_metadata</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentPartnerMetadataArgs]</span> = None<span class="p">,</span>
                           ...
                           <span class="nx">stack_type</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentStackType]</span> = None<span class="p">,</span>
                           <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[InterconnectAttachmentType]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewInterconnectAttachment</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">InterconnectAttachmentArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">InterconnectAttachment</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#bandwidth_csharp" style="color: inherit; text-decoration: inherit;">Bandwidth</a>
    ...
    <dd>{{% md %}}Provisioned bandwidth capacity for the interconnect attachment. For attachments of type DEDICATED, the user can set the bandwidth. For attachments of type PARTNER, the Google Partner that is operating the interconnect must set the bandwidth. Output only for PARTNER type, mutable for PARTNER_PROVIDER and DEDICATED, and can take one of the following values: - BPS_50M: 50 Mbit/s - BPS_100M: 100 Mbit/s - BPS_200M: 200 Mbit/s - BPS_300M: 300 Mbit/s - BPS_400M: 400 Mbit/s - BPS_500M: 500 Mbit/s - BPS_1G: 1 Gbit/s - BPS_2G: 2 Gbit/s - BPS_5G: 5 Gbit/s - BPS_10G: 10 Gbit/s - BPS_20G: 20 Gbit/s - BPS_50G: 50 Gbit/s {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="candidateipv6subnets_csharp">
<a href="#candidateipv6subnets_csharp" style="color: inherit; text-decoration: inherit;">Candidate<wbr>Ipv6Subnets</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;string&gt;</span>
    </dt>
    <dd>{{% md %}}Up to 16 candidate prefixes that control the allocation of cloudRouterIpv6Address and customerRouterIpv6Address for this attachment. Each prefix must be in the Global Unique Address (GUA) space. It is highly recommended that it be in a range owned by the requestor. A GUA in a range owned by Google will cause the request to fail. Google will select an available prefix from the supplied candidates or fail the request. If not supplied, a /125 from a Google-owned GUA block will be selected.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#candidatesubnets_csharp" style="color: inherit; text-decoration: inherit;">Candidate<wbr>Subnets</a>
    ...
    <dd>{{% md %}}Up to 16 candidate prefixes that can be used to restrict the allocation of cloudRouterIpAddress and customerRouterIpAddress for this attachment. All prefixes must be within link-local address space (169.254.0.0/16) and must be /29 or shorter (/28, /27, etc). Google will attempt to select an unused /29 from the supplied candidate prefix(es). The request will fail if all possible /29s are in use on Google's edge. If not supplied, Google will randomly select an unused /29 from all of link-local space.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudrouteripv6interfaceid_csharp">
<a href="#cloudrouteripv6interfaceid_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}If supplied, the interface id (index within the subnet) to be used for the cloud router address. The id must be in the range of 1 to 6. If a subnet mask is supplied, it must be /125, and the subnet should either be 0 or match the selected subnet.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="customerrouteripv6interfaceid_csharp">
<a href="#customerrouteripv6interfaceid_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}If supplied, the interface id (index within the subnet) to be used for the customer router address. The id must be in the range of 1 to 6. If a subnet mask is supplied, it must be /125, and the subnet should either be 0 or match the selected subnet.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#edgeavailabilitydomain_csharp" style="color: inherit; text-decoration: inherit;">Edge<wbr>Availability<wbr>Domain</a>
    ...
    <dd>{{% md %}}Desired availability domain for the attachment. Only available for type PARTNER, at creation time, and can take one of the following values: - AVAILABILITY_DOMAIN_ANY - AVAILABILITY_DOMAIN_1 - AVAILABILITY_DOMAIN_2 For improved reliability, customers should configure a pair of attachments, one per availability domain. The selected availability domain will be provided to the Partner via the pairing key, so that the provisioned circuit will lie in the specified domain. If not specified, the value will default to AVAILABILITY_DOMAIN_ANY.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#partnermetadata_csharp" style="color: inherit; text-decoration: inherit;">Partner<wbr>Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#interconnectattachmentpartnermetadata">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Interconnect<wbr>Attachment<wbr>Partner<wbr>Metadata<wbr>Args</a></span>
    </dt>
...
<a href="#stacktype_csharp" style="color: inherit; text-decoration: inherit;">Stack<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#interconnectattachmentstacktype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Interconnect<wbr>Attachment<wbr>Stack<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}The stack type for this interconnect attachment to identify whether the IPv6 feature is enabled or not. If not specified, IPV4_ONLY will be used. This field can be both set at interconnect attachments creation and update interconnect attachment operations.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of interconnect attachment this is, which can take one of the following values: - DEDICATED: an attachment to a Dedicated Interconnect. - PARTNER: an attachment to a Partner Interconnect, created by the customer. - PARTNER_PROVIDER: an attachment to a Partner Interconnect, created by the partner. {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#bandwidth_go" style="color: inherit; text-decoration: inherit;">Bandwidth</a>
    ...
    <dd>{{% md %}}Provisioned bandwidth capacity for the interconnect attachment. For attachments of type DEDICATED, the user can set the bandwidth. For attachments of type PARTNER, the Google Partner that is operating the interconnect must set the bandwidth. Output only for PARTNER type, mutable for PARTNER_PROVIDER and DEDICATED, and can take one of the following values: - BPS_50M: 50 Mbit/s - BPS_100M: 100 Mbit/s - BPS_200M: 200 Mbit/s - BPS_300M: 300 Mbit/s - BPS_400M: 400 Mbit/s - BPS_500M: 500 Mbit/s - BPS_1G: 1 Gbit/s - BPS_2G: 2 Gbit/s - BPS_5G: 5 Gbit/s - BPS_10G: 10 Gbit/s - BPS_20G: 20 Gbit/s - BPS_50G: 50 Gbit/s {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="candidateipv6subnets_go">
<a href="#candidateipv6subnets_go" style="color: inherit; text-decoration: inherit;">Candidate<wbr>Ipv6Subnets</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]string</span>
    </dt>
...
<a href="#candidatesubnets_go" style="color: inherit; text-decoration: inherit;">Candidate<wbr>Subnets</a>
    ...
    <dd>{{% md %}}Up to 16 candidate prefixes that can be used to restrict the allocation of cloudRouterIpAddress and customerRouterIpAddress for this attachment. All prefixes must be within link-local address space (169.254.0.0/16) and must be /29 or shorter (/28, /27, etc). Google will attempt to select an unused /29 from the supplied candidate prefix(es). The request will fail if all possible /29s are in use on Google's edge. If not supplied, Google will randomly select an unused /29 from all of link-local space.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudrouteripv6interfaceid_go">
<a href="#cloudrouteripv6interfaceid_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}If supplied, the interface id (index within the subnet) to be used for the cloud router address. The id must be in the range of 1 to 6. If a subnet mask is supplied, it must be /125, and the subnet should either be 0 or match the selected subnet.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="customerrouteripv6interfaceid_go">
<a href="#customerrouteripv6interfaceid_go" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#stacktype_go" style="color: inherit; text-decoration: inherit;">Stack<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#interconnectattachmentstacktype">Interconnect<wbr>Attachment<wbr>Stack<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}The stack type for this interconnect attachment to identify whether the IPv6 feature is enabled or not. If not specified, IPV4_ONLY will be used. This field can be both set at interconnect attachments creation and update interconnect attachment operations.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_go">
...
<a href="#bandwidth_nodejs" style="color: inherit; text-decoration: inherit;">bandwidth</a>
    ...
    <dd>{{% md %}}Provisioned bandwidth capacity for the interconnect attachment. For attachments of type DEDICATED, the user can set the bandwidth. For attachments of type PARTNER, the Google Partner that is operating the interconnect must set the bandwidth. Output only for PARTNER type, mutable for PARTNER_PROVIDER and DEDICATED, and can take one of the following values: - BPS_50M: 50 Mbit/s - BPS_100M: 100 Mbit/s - BPS_200M: 200 Mbit/s - BPS_300M: 300 Mbit/s - BPS_400M: 400 Mbit/s - BPS_500M: 500 Mbit/s - BPS_1G: 1 Gbit/s - BPS_2G: 2 Gbit/s - BPS_5G: 5 Gbit/s - BPS_10G: 10 Gbit/s - BPS_20G: 20 Gbit/s - BPS_50G: 50 Gbit/s {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="candidateipv6subnets_nodejs">
<a href="#candidateipv6subnets_nodejs" style="color: inherit; text-decoration: inherit;">candidate<wbr>Ipv6Subnets</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string[]</span>
    </dt>
...
<a href="#candidatesubnets_nodejs" style="color: inherit; text-decoration: inherit;">candidate<wbr>Subnets</a>
    ...
    <dd>{{% md %}}Up to 16 candidate prefixes that can be used to restrict the allocation of cloudRouterIpAddress and customerRouterIpAddress for this attachment. All prefixes must be within link-local address space (169.254.0.0/16) and must be /29 or shorter (/28, /27, etc). Google will attempt to select an unused /29 from the supplied candidate prefix(es). The request will fail if all possible /29s are in use on Google's edge. If not supplied, Google will randomly select an unused /29 from all of link-local space.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloudrouteripv6interfaceid_nodejs">
<a href="#cloudrouteripv6interfaceid_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}If supplied, the interface id (index within the subnet) to be used for the cloud router address. The id must be in the range of 1 to 6. If a subnet mask is supplied, it must be /125, and the subnet should either be 0 or match the selected subnet.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="customerrouteripv6interfaceid_nodejs">
<a href="#customerrouteripv6interfaceid_nodejs" style="color: inherit; text-decoration: inherit;">customer<wbr>Router<wbr>Ipv6Interface<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#bandwidth_python" style="color: inherit; text-decoration: inherit;">bandwidth</a>
    ...
    <dd>{{% md %}}Provisioned bandwidth capacity for the interconnect attachment. For attachments of type DEDICATED, the user can set the bandwidth. For attachments of type PARTNER, the Google Partner that is operating the interconnect must set the bandwidth. Output only for PARTNER type, mutable for PARTNER_PROVIDER and DEDICATED, and can take one of the following values: - BPS_50M: 50 Mbit/s - BPS_100M: 100 Mbit/s - BPS_200M: 200 Mbit/s - BPS_300M: 300 Mbit/s - BPS_400M: 400 Mbit/s - BPS_500M: 500 Mbit/s - BPS_1G: 1 Gbit/s - BPS_2G: 2 Gbit/s - BPS_5G: 5 Gbit/s - BPS_10G: 10 Gbit/s - BPS_20G: 20 Gbit/s - BPS_50G: 50 Gbit/s {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="candidate_ipv6_subnets_python">
<a href="#candidate_ipv6_subnets_python" style="color: inherit; text-decoration: inherit;">candidate_<wbr>ipv6_<wbr>subnets</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#candidate_subnets_python" style="color: inherit; text-decoration: inherit;">candidate_<wbr>subnets</a>
    ...
    <dd>{{% md %}}Up to 16 candidate prefixes that can be used to restrict the allocation of cloudRouterIpAddress and customerRouterIpAddress for this attachment. All prefixes must be within link-local address space (169.254.0.0/16) and must be /29 or shorter (/28, /27, etc). Google will attempt to select an unused /29 from the supplied candidate prefix(es). The request will fail if all possible /29s are in use on Google's edge. If not supplied, Google will randomly select an unused /29 from all of link-local space.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cloud_router_ipv6_interface_id_python">
<a href="#cloud_router_ipv6_interface_id_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>router_<wbr>ipv6_<wbr>interface_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}If supplied, the interface id (index within the subnet) to be used for the cloud router address. The id must be in the range of 1 to 6. If a subnet mask is supplied, it must be /125, and the subnet should either be 0 or match the selected subnet.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="customer_router_ipv6_interface_id_python">
<a href="#customer_router_ipv6_interface_id_python" style="color: inherit; text-decoration: inherit;">customer_<wbr>router_<wbr>ipv6_<wbr>interface_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#cloudrouteripaddress_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="cloudrouteripv6address_csharp">
<a href="#cloudrouteripv6address_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}IPv6 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customerrouteripaddress_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="customerrouteripv6address_csharp">
<a href="#customerrouteripv6address_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}IPv6 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privateinterconnectinfo_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Interconnect<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#interconnectattachmentprivateinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Interconnect<wbr>Attachment<wbr>Private<wbr>Info<wbr>Response</a></span>
    </dt>
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The current state of this attachment's functionality. Enum values ACTIVE and UNPROVISIONED are shared by DEDICATED/PRIVATE, PARTNER, and PARTNER_PROVIDER interconnect attachments, while enum values PENDING_PARTNER, PARTNER_REQUEST_RECEIVED, and PENDING_CUSTOMER are used for only PARTNER and PARTNER_PROVIDER interconnect attachments. This state can take one of the following values: - ACTIVE: The attachment has been turned up and is ready to use. - UNPROVISIONED: The attachment is not ready to use yet, because turnup is not complete. - PENDING_PARTNER: A newly-created PARTNER attachment that has not yet been configured on the Partner side. - PARTNER_REQUEST_RECEIVED: A PARTNER attachment is in the process of provisioning after a PARTNER_PROVIDER attachment was created that references it. - PENDING_CUSTOMER: A PARTNER or PARTNER_PROVIDER attachment that is waiting for a customer to activate it. - DEFUNCT: The attachment was deleted externally and is no longer functional. This could be because the associated Interconnect was removed, or because the other side of a Partner attachment was deleted. {{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cloudrouteripaddress_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="cloudrouteripv6address_go">
<a href="#cloudrouteripv6address_go" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#customerrouteripaddress_go" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="customerrouteripv6address_go">
<a href="#customerrouteripv6address_go" style="color: inherit; text-decoration: inherit;">Customer<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#cloudrouteripaddress_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="cloudrouteripv6address_nodejs">
<a href="#cloudrouteripv6address_nodejs" style="color: inherit; text-decoration: inherit;">cloud<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#customerrouteripaddress_nodejs" style="color: inherit; text-decoration: inherit;">customer<wbr>Router<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="customerrouteripv6address_nodejs">
<a href="#customerrouteripv6address_nodejs" style="color: inherit; text-decoration: inherit;">customer<wbr>Router<wbr>Ipv6Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#cloud_router_ip_address_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>router_<wbr>ip_<wbr>address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on Cloud Router Interface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="cloud_router_ipv6_address_python">
<a href="#cloud_router_ipv6_address_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>router_<wbr>ipv6_<wbr>address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#customer_router_ip_address_python" style="color: inherit; text-decoration: inherit;">customer_<wbr>router_<wbr>ip_<wbr>address</a>
    ...
    <dd>{{% md %}}IPv4 address + prefix length to be configured on the customer router subinterface for this interconnect attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="customer_router_ipv6_address_python">
<a href="#customer_router_ipv6_address_python" style="color: inherit; text-decoration: inherit;">customer_<wbr>router_<wbr>ipv6_<wbr>address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<dl class="tabular"><dt>Bps100m</dt>
    <dd>BPS_100M{{% md %}}100 Mbit/s{{% /md %}}</dd><dt>Bps10g</dt>
    <dd>BPS_10G{{% md %}}10 Gbit/s{{% /md %}}</dd><dt>Bps1g</dt>
    <dd>BPS_1G{{% md %}}1 Gbit/s{{% /md %}}</dd><dt>Bps200m</dt>
    <dd>BPS_200M{{% md %}}200 Mbit/s{{% /md %}}</dd><dt>Bps20g</dt>
    <dd>BPS_20G{{% md %}}20 Gbit/s{{% /md %}}</dd><dt>Bps2g</dt>
    <dd>BPS_2G{{% md %}}2 Gbit/s{{% /md %}}</dd><dt>Bps300m</dt>
    <dd>BPS_300M{{% md %}}300 Mbit/s{{% /md %}}</dd><dt>Bps400m</dt>
    <dd>BPS_400M{{% md %}}400 Mbit/s{{% /md %}}</dd><dt>Bps500m</dt>
    <dd>BPS_500M{{% md %}}500 Mbit/s{{% /md %}}</dd><dt>Bps50g</dt>
    <dd>BPS_50G{{% md %}}50 Gbit/s{{% /md %}}</dd><dt>Bps50m</dt>
    <dd>BPS_50M{{% md %}}50 Mbit/s{{% /md %}}</dd><dt>Bps5g</dt>
    <dd>BPS_5G{{% md %}}5 Gbit/s{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps100m</dt>
    <dd>BPS_100M{{% md %}}100 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps10g</dt>
    <dd>BPS_10G{{% md %}}10 Gbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps1g</dt>
    <dd>BPS_1G{{% md %}}1 Gbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps200m</dt>
    <dd>BPS_200M{{% md %}}200 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps20g</dt>
    <dd>BPS_20G{{% md %}}20 Gbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps2g</dt>
    <dd>BPS_2G{{% md %}}2 Gbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps300m</dt>
    <dd>BPS_300M{{% md %}}300 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps400m</dt>
    <dd>BPS_400M{{% md %}}400 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps500m</dt>
    <dd>BPS_500M{{% md %}}500 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps50g</dt>
    <dd>BPS_50G{{% md %}}50 Gbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps50m</dt>
    <dd>BPS_50M{{% md %}}50 Mbit/s{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Bandwidth<wbr>Bps5g</dt>
    <dd>BPS_5G{{% md %}}5 Gbit/s{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Ipsec</dt>
    <dd>IPSEC{{% md %}}The interconnect attachment will carry only encrypted traffic that is encrypted by an IPsec device such as HA VPN gateway; VMs cannot directly send traffic to or receive traffic from such an interconnect attachment. To use IPsec-encrypted Cloud Interconnect, the interconnect attachment must be created with this option.{{% /md %}}</dd><dt>None</dt>
    <dd>NONE{{% md %}}This is the default value, which means the Interconnect Attachment will carry unencrypted traffic. VMs will be able to send traffic to or receive traffic from such interconnect attachment.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Interconnect<wbr>Attachment<wbr>Encryption<wbr>Ipsec</dt>
    <dd>IPSEC{{% md %}}The interconnect attachment will carry only encrypted traffic that is encrypted by an IPsec device such as HA VPN gateway; VMs cannot directly send traffic to or receive traffic from such an interconnect attachment. To use IPsec-encrypted Cloud Interconnect, the interconnect attachment must be created with this option.{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Encryption<wbr>None</dt>
    <dd>NONE{{% md %}}This is the default value, which means the Interconnect Attachment will carry unencrypted traffic. VMs will be able to send traffic to or receive traffic from such interconnect attachment.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="interconnectattachmentstacktype">Interconnect<wbr>Attachment<wbr>Stack<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}The interconnect attachment can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}The interconnect attachment will only be assigned IPv4 addresses.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Interconnect<wbr>Attachment<wbr>Stack<wbr>Type<wbr>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}The interconnect attachment can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Stack<wbr>Type<wbr>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}The interconnect attachment will only be assigned IPv4 addresses.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>IPV4_IPV6</dt>
    <dd>IPV4_IPV6{{% md %}}The interconnect attachment can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>IPV4_ONLY</dt>
    <dd>IPV4_ONLY{{% md %}}The interconnect attachment will only be assigned IPv4 addresses.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Dedicated</dt>
    <dd>DEDICATED{{% md %}}Attachment to a dedicated interconnect.{{% /md %}}</dd><dt>Partner</dt>
    <dd>PARTNER{{% md %}}Attachment to a partner interconnect, created by the customer.{{% /md %}}</dd><dt>Partner<wbr>Provider</dt>
    <dd>PARTNER_PROVIDER{{% md %}}Attachment to a partner interconnect, created by the partner.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Interconnect<wbr>Attachment<wbr>Type<wbr>Dedicated</dt>
    <dd>DEDICATED{{% md %}}Attachment to a dedicated interconnect.{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Type<wbr>Partner</dt>
    <dd>PARTNER{{% md %}}Attachment to a partner interconnect, created by the customer.{{% /md %}}</dd><dt>Interconnect<wbr>Attachment<wbr>Type<wbr>Partner<wbr>Provider</dt>
    <dd>PARTNER_PROVIDER{{% md %}}Attachment to a partner interconnect, created by the partner.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>DEDICATED</dt>
    <dd>DEDICATED{{% md %}}Attachment to a dedicated interconnect.{{% /md %}}</dd><dt>PARTNER</dt>
    <dd>PARTNER{{% md %}}Attachment to a partner interconnect, created by the customer.{{% /md %}}</dd><dt>PARTNER_PROVIDER</dt>
    <dd>PARTNER_PROVIDER{{% md %}}Attachment to a partner interconnect, created by the partner.{{% /md %}}</dd></dl>
{{% /choosable %}}
