...
---
title: "getRegionHealthCheck"
title_tag: "google-native.compute/alpha.getRegionHealthCheck"
meta_desc: "Documentation for the google-native.compute/alpha.getRegionHealthCheck function with examples, input properties, output properties, and supporting types."
---
...
## Using getRegionHealthCheck {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getRegionHealthCheck<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetRegionHealthCheckArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetRegionHealthCheckResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_region_health_check(</span><span class="nx">health_check</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRegionHealthCheckResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRegionHealthCheck<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupRegionHealthCheckArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupRegionHealthCheckResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `LookupRegionHealthCheck` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetRegionHealthCheck </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetRegionHealthCheckResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetRegionHealthCheckArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## getRegionHealthCheck Result {#result}
...
<a href="#grpchealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Grpc<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#grpchealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>GRPCHealth<wbr>Check<wbr>Response</a></span>
    </dt>
...
<a href="#http2healthcheck_csharp" style="color: inherit; text-decoration: inherit;">Http2Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#http2healthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>HTTP2Health<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httphealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httphealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>HTTPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpshealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Https<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpshealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>HTTPSHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#logconfig_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#healthchecklogconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Health<wbr>Check<wbr>Log<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Configure logging on this health check.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and comply with RFC1035. For example, a name that is 1-63 characters long, matches the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?`, and otherwise complies with RFC1035. This regular expression describes a name where the first character is a lowercase letter, and all following characters are a dash, lowercase letter, or digit, except the last character, which isn't a dash.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="region_csharp">
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
</span>
...
<a href="#sslhealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sslhealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>SSLHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tcphealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Tcp<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tcphealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>TCPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Specifies the type of the healthCheck, either TCP, SSL, HTTP, HTTPS or HTTP2. If not specified, the default is TCP. Exactly one of the protocol-specific health check field must be specified, which must match type field.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#udphealthcheck_csharp" style="color: inherit; text-decoration: inherit;">Udp<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#udphealthcheckresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>UDPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#grpchealthcheck_go" style="color: inherit; text-decoration: inherit;">Grpc<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#grpchealthcheckresponse">GRPCHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#http2healthcheck_go" style="color: inherit; text-decoration: inherit;">Http2Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#http2healthcheckresponse">HTTP2Health<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httphealthcheck_go" style="color: inherit; text-decoration: inherit;">Http<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httphealthcheckresponse">HTTPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpshealthcheck_go" style="color: inherit; text-decoration: inherit;">Https<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpshealthcheckresponse">HTTPSHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_go">
...
<a href="#logconfig_go" style="color: inherit; text-decoration: inherit;">Log<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#healthchecklogconfigresponse">Health<wbr>Check<wbr>Log<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Configure logging on this health check.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_go">
...
<a href="#sslhealthcheck_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sslhealthcheckresponse">SSLHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tcphealthcheck_go" style="color: inherit; text-decoration: inherit;">Tcp<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tcphealthcheckresponse">TCPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#udphealthcheck_go" style="color: inherit; text-decoration: inherit;">Udp<wbr>Health<wbr>Check</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#udphealthcheckresponse">UDPHealth<wbr>Check<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#portspecification_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Specification</a>
    ...
    <dd>{{% md %}}Specifies how port is selected for health checking, can be one of following values: USE_FIXED_PORT: The port number in port is used for health checking. USE_NAMED_PORT: The portName is used for health checking. USE_SERVING_PORT: For NetworkEndpointGroup, the port specified for each network endpoint is used for health checking. For other backends, the port or named port specified in the Backend Service is used for health checking. If not specified, HTTP health check follows behavior specified in port and portName fields.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="proxyheader_csharp">
<a href="#proxyheader_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Header</a>
</span>
...
<a href="#portspecification_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Specification</a>
    ...
    <dd>{{% md %}}Specifies how port is selected for health checking, can be one of following values: USE_FIXED_PORT: The port number in port is used for health checking. USE_NAMED_PORT: The portName is used for health checking. USE_SERVING_PORT: For NetworkEndpointGroup, the port specified for each network endpoint is used for health checking. For other backends, the port or named port specified in the Backend Service is used for health checking. If not specified, HTTPS health check follows behavior specified in port and portName fields.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="proxyheader_csharp">
<a href="#proxyheader_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Header</a>
</span>
...
<h4 id="healthchecklogconfigresponse">Health<wbr>Check<wbr>Log<wbr>Config<wbr>Response</h4>
...
<a href="#portspecification_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Specification</a>
    ...
    <dd>{{% md %}}Specifies how port is selected for health checking, can be one of following values: USE_FIXED_PORT: The port number in port is used for health checking. USE_NAMED_PORT: The portName is used for health checking. USE_SERVING_PORT: For NetworkEndpointGroup, the port specified for each network endpoint is used for health checking. For other backends, the port or named port specified in the Backend Service is used for health checking. If not specified, SSL health check follows behavior specified in port and portName fields.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="proxyheader_csharp">
<a href="#proxyheader_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Header</a>
</span>
...
<a href="#portspecification_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Specification</a>
    ...
    <dd>{{% md %}}Specifies how port is selected for health checking, can be one of following values: USE_FIXED_PORT: The port number in port is used for health checking. USE_NAMED_PORT: The portName is used for health checking. USE_SERVING_PORT: For NetworkEndpointGroup, the port specified for each network endpoint is used for health checking. For other backends, the port or named port specified in the Backend Service is used for health checking. If not specified, TCP health check follows behavior specified in port and portName fields.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="proxyheader_csharp">
<a href="#proxyheader_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Header</a>
</span>
...
<h4 id="udphealthcheckresponse">UDPHealth<wbr>Check<wbr>Response</h4>
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The UDP port number for the health check request. Valid values are 1 through 65535.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="portname_csharp">
<a href="#portname_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Name</a>
</span>
...
<a href="#request_csharp" style="color: inherit; text-decoration: inherit;">Request</a>
    ...
    <dd>{{% md %}}Raw data of request to send in payload of UDP packet. It is an error if this is empty. The request data can only be ASCII.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="response_csharp">
<a href="#response_csharp" style="color: inherit; text-decoration: inherit;">Response</a>
</span>
    ...
    <dd>{{% md %}}The bytes to match against the beginning of the response data. It is an error if this is empty. The response data can only be ASCII.{{% /md %}}</dd></dl>
{{% /choosable %}}
