...
## Create a FutureReservation Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">FutureReservation</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">FutureReservationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">FutureReservation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">specific_sku_properties</span><span class="p">:</span> <span class="nx">Optional[FutureReservationSpecificSKUPropertiesArgs]</span> = None<span class="p">,</span>
                      <span class="nx">time_window</span><span class="p">:</span> <span class="nx">Optional[FutureReservationTimeWindowArgs]</span> = None<span class="p">,</span>
                      <span class="nx">zone</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">FutureReservation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[FutureReservationArgs]</a></span> = None<span class="p">,</span>
                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewFutureReservation</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">FutureReservationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">FutureReservation</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">FutureReservation</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">FutureReservationArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">FutureReservationArgs</a></span>
    </dt>
...
## FutureReservation Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Architecture and Concepts docs.

### Inputs

The FutureReservation resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}An optional description of this resource. Provide this property when you create the future reservation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#nameprefix_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Prefix</a>
    ...
    <dd>{{% md %}}Name prefix for the reservations to be created at the time of delivery. The name prefix must comply with RFC1035. Maximum allowed length for name prefix is 20. Automatically created reservations name format will be -date-####.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sharesettings_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sharesettings">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Share<wbr>Settings<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}List of Projects/Folders to share with.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#specificskuproperties_csharp" style="color: inherit; text-decoration: inherit;">Specific<wbr>Sku<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#futurereservationspecificskuproperties">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Future<wbr>Reservation<wbr>Specific<wbr>SKUProperties<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Future Reservation configuration to indicate instance properties and total count.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="timewindow_csharp">
<a href="#timewindow_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Window</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#futurereservationtimewindow">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Future<wbr>Reservation<wbr>Time<wbr>Window<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Time window for this Future Reservation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="zone_csharp">
...
<a href="#specificskuproperties_go" style="color: inherit; text-decoration: inherit;">Specific<wbr>Sku<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#futurereservationspecificskuproperties">Future<wbr>Reservation<wbr>Specific<wbr>SKUProperties<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Future Reservation configuration to indicate instance properties and total count.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timewindow_go" style="color: inherit; text-decoration: inherit;">Time<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#futurereservationtimewindow">Future<wbr>Reservation<wbr>Time<wbr>Window<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Time window for this Future Reservation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="zone_go">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the FutureReservation resource produces the following output properties:
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output only] Status of the Future Reservation{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="futurereservationspecificskuproperties">Future<wbr>Reservation<wbr>Specific<wbr>SKUProperties</h4>
...
<a href="#instanceproperties_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Properties</a>
    ...
    <dd>{{% md %}}Properties of the SKU instances being reserved.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="futurereservationtimewindow">Future<wbr>Reservation<wbr>Time<wbr>Window</h4>
...
<a href="#duration_csharp" style="color: inherit; text-decoration: inherit;">Duration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#duration">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Duration</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
