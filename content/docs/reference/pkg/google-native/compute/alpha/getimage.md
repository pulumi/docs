...
---
title: "getImage"
title_tag: "google-native.compute/alpha.getImage"
meta_desc: "Documentation for the google-native.compute/alpha.getImage function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getImage<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetImageArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetImageResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_image(</span><span class="nx">image</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetImageResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupImage<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupImageArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupImageResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetImage </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetImageResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetImageArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#archivesizebytes_csharp" style="color: inherit; text-decoration: inherit;">Archive<wbr>Size<wbr>Bytes</a>
    ...
    <dd>{{% md %}}Size of the image tar.gz archive stored in Google Cloud Storage (in bytes).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#deprecated_csharp" style="color: inherit; text-decoration: inherit;">Deprecated</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deprecationstatusresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Deprecation<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The deprecation status associated with this image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disksizegb_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>Gb</a>
    ...
    <dd>{{% md %}}Size of the image when restored onto a persistent disk (in GB).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#family_csharp" style="color: inherit; text-decoration: inherit;">Family</a>
    ...
    <dd>{{% md %}}The name of the image family to which this image belongs. You can create disks by specifying an image family instead of a specific image name. The image family always returns its latest image that is not deprecated. The name of the image family must comply with RFC1035.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#guestosfeatures_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Os<wbr>Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestosfeatureresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Guest<wbr>Os<wbr>Feature<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of features to enable on the guest operating system. Applicable only for bootable images. Read  Enabling guest operating system features to see a list of available options.{{% /md %}}</dd><dt class="property-"
            title="">
...
If you do not provide an encryption key when creating the image, then the disk will be encrypted using an automatically generated key and you do not need to provide a key to use the image later.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#image for images.{{% /md %}}</dd><dt class="property-"
            title="">
...
To see the latest fingerprint, make a get() request to retrieve an image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Labels to apply to this image. These can be later modified by the setLabels method.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#licensecodes_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Codes</a>
    ...
    <dd>{{% md %}}Integer license codes indicating which licenses are attached to this image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#licenses_csharp" style="color: inherit; text-decoration: inherit;">Licenses</a>
    ...
    <dd>{{% md %}}Any applicable license URI.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#rawdisk_csharp" style="color: inherit; text-decoration: inherit;">Raw<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagerawdiskresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Image<wbr>Raw<wbr>Disk<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The parameters of the raw disk image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rolloutoverride_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Override</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rolloutpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Rollout<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A rollout policy to apply to this image. When specified, the rollout policy overrides per-zone references to the image via the associated image family. The rollout policy restricts the zones where this image is accessible when using a zonal image family reference. When the rollout policy does not include the user specified zone, or if the zone is rolled out, this image is accessible.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#shieldedinstanceinitialstate_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Initial<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#initialstateconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Initial<wbr>State<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Set the secure boot keys of shielded instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
- zones/zone/disks/disk{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcediskid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] The ID value of the disk used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given disk name.{{% /md %}}</dd><dt class="property-"
            title="">
...
- The sourceDisk URL{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceimageencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Image<wbr>Encryption<wbr>Key</a>
    ...
    <dd>{{% md %}}The customer-supplied encryption key of the source image. Required if the source image is protected by a customer-supplied encryption key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceimageid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Image<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] The ID value of the image used to create this image. This value may be used to determine whether the image was taken from the current or a previous instance of a given image name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcesnapshotencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Snapshot<wbr>Encryption<wbr>Key</a>
    ...
    <dd>{{% md %}}The customer-supplied encryption key of the source snapshot. Required if the source snapshot is protected by a customer-supplied encryption key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcesnapshotid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Snapshot<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] The ID value of the snapshot used to create this image. This value may be used to determine whether the snapshot was taken from the current or a previous instance of a given snapshot name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcetype_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of the image used to create this disk. The default and only value is RAW{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the image. An image can be used to create other resources, such as instances, only after the image has been successfully created and the status is set to READY. Possible values are FAILED, PENDING, or READY.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#deprecated_go" style="color: inherit; text-decoration: inherit;">Deprecated</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deprecationstatusresponse">Deprecation<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The deprecation status associated with this image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rawdisk_go" style="color: inherit; text-decoration: inherit;">Raw<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagerawdiskresponse">Image<wbr>Raw<wbr>Disk<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The parameters of the raw disk image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#stateoverride_csharp" style="color: inherit; text-decoration: inherit;">State<wbr>Override</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rolloutpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Rollout<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#dbs_csharp" style="color: inherit; text-decoration: inherit;">Dbs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filecontentbufferresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>File<wbr>Content<wbr>Buffer<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#pk_csharp" style="color: inherit; text-decoration: inherit;">Pk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filecontentbufferresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>File<wbr>Content<wbr>Buffer<wbr>Response</a></span>
    </dt>
...
<a href="#locationrolloutpolicies_csharp" style="color: inherit; text-decoration: inherit;">Location<wbr>Rollout<wbr>Policies</a>
    ...
    <dd>{{% md %}}Location based rollout policies to apply to the resource.

Currently only zone names are supported and must be represented as valid URLs, like: zones/us-central1-a.

The value expects an RFC3339 timestamp on or after which the update is considered rolled out to the specified location.{{% /md %}}</dd></dl>
{{% /choosable %}}
