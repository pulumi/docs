...
When the load balancing scheme is INTERNAL and protocol is TCP/UDP, specify this field to allow packets addressed to any ports will be forwarded to the backends configured with this forwarding rule.{{% /md %}}</dd><dt class="property-"
            title="">
...
To see the latest fingerprint, make a get() request to retrieve a ForwardingRule.{{% /md %}}</dd><dt class="property-"
            title="">
...
For Private Service Connect forwarding rules that forward traffic to Google APIs, IP address must be provided.{{% /md %}}</dd><dt class="property-"
            title="">
...
- Network Load Balancing: The load balancing scheme is EXTERNAL, and one of TCP or UDP is valid.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#forwardingRule for Forwarding Rule resources.{{% /md %}}</dd><dt class="property-"
            title="">
...
For more information about forwarding rules, refer to Forwarding rule concepts.{{% /md %}}</dd><dt class="property-"
            title="">
...
metadataFilters only applies to Loadbalancers that have their loadBalancingScheme set to INTERNAL_SELF_MANAGED.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
For Private Service Connect forwarding rules that forward traffic to Google APIs, a network must be provided.{{% /md %}}</dd><dt class="property-"
            title="">
...
If this field is not specified, it is assumed to be PREMIUM. If IPAddress is specified, this value must be equal to the networkTier of the Address.{{% /md %}}</dd><dt class="property-"
            title="">
...
- TargetVpnGateway: 500, 4500{{% /md %}}</dd><dt class="property-"
            title="">
...
For more information, see [Port specifications](/load-balancing/docs/forwarding-rule-concepts#port_specifications).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#pscconnectionid_csharp" style="color: inherit; text-decoration: inherit;">Psc<wbr>Connection<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] The PSC connection id of the PSC Forwarding Rule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] URL of the region where the regional forwarding rule resides. This field is not applicable to global forwarding rules. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.{{% /md %}}</dd><dt class="property-"
            title="">
...
It is only supported for Internal TCP/UDP Load Balancing and Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt class="property-"
            title="">
...
This field is only used for internal load balancing.{{% /md %}}</dd><dt class="property-"
            title="">
...
If the network specified is in auto subnet mode, this field is optional. However, if the network is in custom subnet mode, a subnetwork must be specified.{{% /md %}}</dd><dt class="property-"
            title="">
