...
<span class="k">def </span><span class="nx">InstanceGroupManager</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                         ...
                         <span class="nx">instance_lifecycle_policy</span><span class="p">:</span> <span class="nx">Optional[InstanceGroupManagerInstanceLifecyclePolicyArgs]</span> = None<span class="p">,</span>
...
<a href="#failoveraction_csharp" style="color: inherit; text-decoration: inherit;">Failover<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerfailoveraction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action</a></span>
    </dt>
...
<a href="#targetstoppedsize_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Stopped<wbr>Size</a>
    ...
    <dd>{{% md %}}The target number of stopped instances for this managed instance group. This number changes when you: - Stop instance using the stopInstances method or start instances using the startInstances method. - Manually change the targetStoppedSize using the update method. {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#targetsuspendedsize_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Suspended<wbr>Size</a>
    ...
    <dd>{{% md %}}The target number of suspended instances for this managed instance group. This number changes when you: - Suspend instance using the suspendInstances method or resume instances using the resumeInstances method. - Manually change the targetSuspendedSize using the update method. {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#zones_csharp" style="color: inherit; text-decoration: inherit;">Zones</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#distributionpolicyzoneconfiguration">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Distribution<wbr>Policy<wbr>Zone<wbr>Configuration&gt;</a></span>
    </dt>
...
<a href="#resuming_csharp" style="color: inherit; text-decoration: inherit;">Resuming</a>
    ...
    <dd>{{% md %}}The number of instances in the managed instance group that are scheduled to be resumed or are currently being resumed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#starting_csharp" style="color: inherit; text-decoration: inherit;">Starting</a>
    ...
    <dd>{{% md %}}The number of instances in the managed instance group that are scheduled to be started or are currently being started.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#stopping_csharp" style="color: inherit; text-decoration: inherit;">Stopping</a>
    ...
    <dd>{{% md %}}The number of instances in the managed instance group that are scheduled to be stopped or are currently being stopped.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#suspending_csharp" style="color: inherit; text-decoration: inherit;">Suspending</a>
    ...
    <dd>{{% md %}}The number of instances in the managed instance group that are scheduled to be suspended or are currently being suspended.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#metadatabasedreadinesssignal_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Based<wbr>Readiness<wbr>Signal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupmanagerinstancelifecyclepolicymetadatabasedreadinesssignal">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Instance<wbr>Group<wbr>Manager<wbr>Instance<wbr>Lifecycle<wbr>Policy<wbr>Metadata<wbr>Based<wbr>Readiness<wbr>Signal</a></span>
    </dt>
...
<a href="#preservedstate_csharp" style="color: inherit; text-decoration: inherit;">Preserved<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statefulpolicypreservedstate">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Stateful<wbr>Policy<wbr>Preserved<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
