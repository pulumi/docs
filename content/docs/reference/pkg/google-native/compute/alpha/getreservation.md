...
title_tag: "google-native.compute/alpha.getReservation"
meta_desc: "Documentation for the google-native.compute/alpha.getReservation function with examples, input properties, output properties, and supporting types."
---
...
<a href="#commitment_csharp" style="color: inherit; text-decoration: inherit;">Commitment</a>
    ...
    <dd>{{% md %}}[Output Only] Full or partial URL to a parent commitment. This field displays for reservations that are tied to a commitment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#reservations for reservations.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#sharesettings_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationsharesettingsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Allocation<wbr>Share<wbr>Settings<wbr>Response</a></span>
    </dt>
...
<a href="#specificreservation_csharp" style="color: inherit; text-decoration: inherit;">Specific<wbr>Reservation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationspecificskureservationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Allocation<wbr>Specific<wbr>SKUReservation<wbr>Response</a></span>
    </dt>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the reservation.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="zone_csharp">
<a href="#zone_csharp" style="color: inherit; text-decoration: inherit;">Zone</a>
</span>
