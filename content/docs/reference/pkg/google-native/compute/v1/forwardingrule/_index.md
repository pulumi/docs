...
<a href="#pscconnectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Psc<wbr>Connection<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#forwardingrulepscconnectionstatus">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Forwarding<wbr>Rule<wbr>Psc<wbr>Connection<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
