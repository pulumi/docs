...
title_tag: "google-native.compute/v1.getGlobalNetworkEndpointGroup"
meta_desc: "Documentation for the google-native.compute/v1.getGlobalNetworkEndpointGroup function with examples, input properties, output properties, and supporting types."
---
...
<a href="#appengine_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Engine</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkendpointgroupappengineresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Endpoint<wbr>Group<wbr>App<wbr>Engine<wbr>Response</a></span>
    </dt>
...
<a href="#cloudfunction_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Function</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkendpointgroupcloudfunctionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Endpoint<wbr>Group<wbr>Cloud<wbr>Function<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#cloudrun_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Run</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkendpointgroupcloudrunresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Endpoint<wbr>Group<wbr>Cloud<wbr>Run<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Only valid when networkEndpointType is "SERVERLESS". Only one of cloudRun, appEngine or cloudFunction may be set.{{% /md %}}</dd><dt class="property-"
            title="">
