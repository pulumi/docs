...
---
title: "getFirewall"
title_tag: "google-native.compute/v1.getFirewall"
meta_desc: "Documentation for the google-native.compute/v1.getFirewall function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_firewall(</span><span class="nx">firewall</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#allowed_csharp" style="color: inherit; text-decoration: inherit;">Allowed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallalloweditemresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Firewall<wbr>Allowed<wbr>Item<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#denied_csharp" style="color: inherit; text-decoration: inherit;">Denied</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewalldenieditemresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Firewall<wbr>Denied<wbr>Item<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#destinationranges_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Ranges</a>
    ...
    <dd>{{% md %}}If destination ranges are specified, the firewall rule applies only to traffic that has destination IP address in these ranges. These ranges must be expressed in CIDR format. Only IPv4 is supported.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#direction_csharp" style="color: inherit; text-decoration: inherit;">Direction</a>
    ...
    <dd>{{% md %}}Direction of traffic to which this firewall applies, either `INGRESS` or `EGRESS`. The default is `INGRESS`. For `INGRESS` traffic, you cannot specify the destinationRanges field, and for `EGRESS` traffic, you cannot specify the sourceRanges or sourceTags fields.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disabled_csharp" style="color: inherit; text-decoration: inherit;">Disabled</a>
    ...
    <dd>{{% md %}}Denotes whether the firewall rule is disabled. When set to true, the firewall rule is not enforced and the network behaves as if it did not exist. If this is unspecified, the firewall rule will be enabled.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#firewall for firewall rules.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="logconfig_csharp">
<a href="#logconfig_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewalllogconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Firewall<wbr>Log<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}This field denotes the logging options for a particular firewall rule. If logging is enabled, logs will be exported to Cloud Logging.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#network_csharp" style="color: inherit; text-decoration: inherit;">Network</a>
    ...
    <dd>{{% md %}}URL of the network resource for this firewall rule. If not specified when creating a firewall rule, the default network is used:
...
- global/networks/default{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}Priority for this rule. This is an integer between `0` and `65535`, both inclusive. The default value is `1000`. Relative priorities determine which rule takes effect if multiple rules apply. Lower values indicate higher priority. For example, a rule with priority `0` has higher precedence than a rule with priority `1`. DENY rules take precedence over ALLOW rules if they have equal priority. Note that VPC networks have implied rules with a priority of `65535`. To avoid conflicts with the implied rules, use a priority number less than `65535`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetserviceaccounts_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Service<wbr>Accounts</a>
    ...
    <dd>{{% md %}}A list of service accounts indicating sets of instances located in the network that may make network connections as specified in allowed[]. targetServiceAccounts cannot be used at the same time as targetTags or sourceTags. If neither targetServiceAccounts nor targetTags are specified, the firewall rule applies to all instances on the specified network.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#allowed_go" style="color: inherit; text-decoration: inherit;">Allowed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallalloweditemresponse">[]Firewall<wbr>Allowed<wbr>Item<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The list of ALLOW rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a permitted connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#denied_go" style="color: inherit; text-decoration: inherit;">Denied</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewalldenieditemresponse">[]Firewall<wbr>Denied<wbr>Item<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#logconfig_go" style="color: inherit; text-decoration: inherit;">Log<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewalllogconfigresponse">Firewall<wbr>Log<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}This field denotes the logging options for a particular firewall rule. If logging is enabled, logs will be exported to Cloud Logging.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_go">
...
<a href="#ports_csharp" style="color: inherit; text-decoration: inherit;">Ports</a>
    ...
    <dd>{{% md %}}An optional list of ports to which this rule applies. This field is only applicable for the UDP or TCP protocol. Each entry must be either an integer or a range. If not specified, this rule applies to connections through any port.
