...
title_tag: "google-native.compute/v1.getReservation"
meta_desc: "Documentation for the google-native.compute/v1.getReservation function with examples, input properties, output properties, and supporting types."
---
...
<a href="#specificreservation_csharp" style="color: inherit; text-decoration: inherit;">Specific<wbr>Reservation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allocationspecificskureservationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Allocation<wbr>Specific<wbr>SKUReservation<wbr>Response</a></span>
    </dt>
