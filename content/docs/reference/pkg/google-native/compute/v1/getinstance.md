...
---
title: "getInstance"
title_tag: "google-native.compute/v1.getInstance"
meta_desc: "Documentation for the google-native.compute/v1.getInstance function with examples, input properties, output properties, and supporting types."
---
...
<a href="#advancedmachinefeatures_csharp" style="color: inherit; text-decoration: inherit;">Advanced<wbr>Machine<wbr>Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#advancedmachinefeaturesresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Advanced<wbr>Machine<wbr>Features<wbr>Response</a></span>
    </dt>
...
<a href="#confidentialinstanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Confidential<wbr>Instance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#confidentialinstanceconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Confidential<wbr>Instance<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#cpuplatform_csharp" style="color: inherit; text-decoration: inherit;">Cpu<wbr>Platform</a>
    ...
    <dd>{{% md %}}[Output Only] The CPU platform used by this instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Attached<wbr>Disk<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#displaydevice_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Device</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#displaydeviceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Display<wbr>Device<wbr>Response</a></span>
    </dt>
...
To see the latest fingerprint, make get() request to the instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#guestaccelerators_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Accelerators</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#acceleratorconfigresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Accelerator<wbr>Config<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#instance for instances.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#laststarttimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Start<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Last start timestamp in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#laststoptimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Stop<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Last stop timestamp in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastsuspendedtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Suspended<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] Last suspended timestamp in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
For a full list of restrictions, read the Specifications for custom machine types.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="metadata_csharp">
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Metadata<wbr>Response</a></span>
    </dt>
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfaceresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Interface<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#reservationaffinity_csharp" style="color: inherit; text-decoration: inherit;">Reservation<wbr>Affinity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reservationaffinityresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Reservation<wbr>Affinity<wbr>Response</a></span>
    </dt>
...
<a href="#scheduling_csharp" style="color: inherit; text-decoration: inherit;">Scheduling</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Scheduling<wbr>Response</a></span>
    </dt>
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output Only] Server-defined URL for this resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceaccounts_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Accounts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaccountresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Service<wbr>Account<wbr>Response&gt;</a></span>
    </dt>
...
Service accounts generate access tokens that can be accessed through the metadata server and used to authenticate applications on the instance. See Service Accounts for more information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#shieldedinstanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shieldedinstanceconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Shielded<wbr>Instance<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#shieldedinstanceintegritypolicy_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Integrity<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shieldedinstanceintegritypolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Shielded<wbr>Instance<wbr>Integrity<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#startrestricted_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Restricted</a>
    ...
    <dd>{{% md %}}[Output Only] Whether a VM has been restricted for start because Compute Engine has detected suspicious activity.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the instance. One of the following values: PROVISIONING, STAGING, RUNNING, STOPPING, SUSPENDING, SUSPENDED, REPAIRING, and TERMINATED. For more information about the status of the instance, see  Instance life cycle.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#statusmessage_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Message</a>
    ...
    <dd>{{% md %}}[Output Only] An optional, human-readable explanation of the status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Tags<wbr>Response</a></span>
    </dt>
...
<a href="#zone_csharp" style="color: inherit; text-decoration: inherit;">Zone</a>
    ...
    <dd>{{% md %}}[Output Only] URL of the zone where the instance resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.{{% /md %}}</dd></dl>
{{% /choosable %}}
