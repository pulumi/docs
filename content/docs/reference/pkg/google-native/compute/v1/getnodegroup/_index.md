...
---
title: "getNodeGroup"
title_tag: "google-native.compute/v1.getNodeGroup"
meta_desc: "Documentation for the google-native.compute/v1.getNodeGroup function with examples, input properties, output properties, and supporting types."
---
...
<a href="#autoscalingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Autoscaling<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupautoscalingpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Node<wbr>Group<wbr>Autoscaling<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#maintenancewindow_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodegroupmaintenancewindowresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Node<wbr>Group<wbr>Maintenance<wbr>Window<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
