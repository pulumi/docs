...
<span class="k">def </span><span class="nx">Instance</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">advanced_machine_features</span><span class="p">:</span> <span class="nx">Optional[AdvancedMachineFeaturesArgs]</span> = None<span class="p">,</span>
             <span class="nx">can_ip_forward</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
             <span class="nx">confidential_instance_config</span><span class="p">:</span> <span class="nx">Optional[ConfidentialInstanceConfigArgs]</span> = None<span class="p">,</span>
             ...
             <span class="nx">disks</span><span class="p">:</span> <span class="nx">Optional[Sequence[AttachedDiskArgs]]</span> = None<span class="p">,</span>
             <span class="nx">display_device</span><span class="p">:</span> <span class="nx">Optional[DisplayDeviceArgs]</span> = None<span class="p">,</span>
             <span class="nx">guest_accelerators</span><span class="p">:</span> <span class="nx">Optional[Sequence[AcceleratorConfigArgs]]</span> = None<span class="p">,</span>
             ...
             <span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[MetadataArgs]</span> = None<span class="p">,</span>
             ...
             <span class="nx">network_interfaces</span><span class="p">:</span> <span class="nx">Optional[Sequence[NetworkInterfaceArgs]]</span> = None<span class="p">,</span>
             <span class="nx">private_ipv6_google_access</span><span class="p">:</span> <span class="nx">Optional[InstancePrivateIpv6GoogleAccess]</span> = None<span class="p">,</span>
             ...
             <span class="nx">scheduling</span><span class="p">:</span> <span class="nx">Optional[SchedulingArgs]</span> = None<span class="p">,</span>
             <span class="nx">service_accounts</span><span class="p">:</span> <span class="nx">Optional[Sequence[ServiceAccountArgs]]</span> = None<span class="p">,</span>
             ...
             <span class="nx">shielded_instance_integrity_policy</span><span class="p">:</span> <span class="nx">Optional[ShieldedInstanceIntegrityPolicyArgs]</span> = None<span class="p">,</span>
             <span class="nx">source_instance_template</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[TagsArgs]</span> = None<span class="p">,</span>
...
<a href="#privateipv6googleaccess_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Ipv6Google<wbr>Access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instanceprivateipv6googleaccess">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Instance<wbr>Private<wbr>Ipv6Google<wbr>Access</a></span>
    </dt>
...
<a href="#serviceaccounts_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Accounts</a>
    ...
    <dd>{{% md %}}A list of service accounts, with their specified scopes, authorized for this instance. Only one service account per VM instance is supported. Service accounts generate access tokens that can be accessed through the metadata server and used to authenticate applications on the instance. See Service Accounts for more information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#disks_python" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddisk">Sequence[Attached<wbr>Disk<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Array of disks associated with this instance. Persistent disks must be created before you can assign them.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#service_accounts_python" style="color: inherit; text-decoration: inherit;">service_<wbr>accounts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaccount">Sequence[Service<wbr>Account<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A list of service accounts, with their specified scopes, authorized for this instance. Only one service account per VM instance is supported. Service accounts generate access tokens that can be accessed through the metadata server and used to authenticate applications on the instance. See Service Accounts for more information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networktier_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Tier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessconfignetworktier">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Access<wbr>Config<wbr>Network<wbr>Tier</a></span>
    </dt>
    <dd>{{% md %}}This signifies the networking tier used for configuring this access configuration and can only take the following values: PREMIUM, STANDARD. If an AccessConfig is specified without a valid external IP address, an ephemeral IP will be created with this networkTier. If an AccessConfig with a valid external IP address is specified, it must match that of the networkTier associated with the Address resource owning that IP.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessconfigtype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Access<wbr>Config<wbr>Type</a></span>
    </dt>
...
<dl class="tabular"><dt>Premium</dt>
    <dd>PREMIUM{{% md %}}High quality, Google-grade network tier, support for all networking products.{{% /md %}}</dd><dt>Standard</dt>
    <dd>STANDARD{{% md %}}Public internet quality, only limited support for other networking products.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Access<wbr>Config<wbr>Network<wbr>Tier<wbr>Premium</dt>
    <dd>PREMIUM{{% md %}}High quality, Google-grade network tier, support for all networking products.{{% /md %}}</dd><dt>Access<wbr>Config<wbr>Network<wbr>Tier<wbr>Standard</dt>
    <dd>STANDARD{{% md %}}Public internet quality, only limited support for other networking products.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#guestosfeatures_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Os<wbr>Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestosfeature">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Guest<wbr>Os<wbr>Feature&gt;</a></span>
    </dt>
...
<a href="#initializeparams_csharp" style="color: inherit; text-decoration: inherit;">Initialize<wbr>Params</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskinitializeparams">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Attached<wbr>Disk<wbr>Initialize<wbr>Params</a></span>
    </dt>
...
<a href="#interface_csharp" style="color: inherit; text-decoration: inherit;">Interface</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskinterface">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Attached<wbr>Disk<wbr>Interface</a></span>
    </dt>
...
<a href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskmode">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Attached<wbr>Disk<wbr>Mode</a></span>
    </dt>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddisktype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Attached<wbr>Disk<wbr>Type</a></span>
    </dt>
...
<a href="#guest_os_features_python" style="color: inherit; text-decoration: inherit;">guest_<wbr>os_<wbr>features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestosfeature">Sequence[Guest<wbr>Os<wbr>Feature]</a></span>
    </dt>
    <dd>{{% md %}}A list of features to enable on the guest operating system. Applicable only for bootable images. Read Enabling guest operating system features to see a list of available options.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#onupdateaction_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Update<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskinitializeparamsonupdateaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Attached<wbr>Disk<wbr>Initialize<wbr>Params<wbr>On<wbr>Update<wbr>Action</a></span>
    </dt>
...
<dl class="tabular"><dt>Recreate<wbr>Disk</dt>
    <dd>RECREATE_DISK{{% md %}}Always recreate the disk.{{% /md %}}</dd><dt>Recreate<wbr>Disk<wbr>If<wbr>Source<wbr>Changed</dt>
    <dd>RECREATE_DISK_IF_SOURCE_CHANGED{{% md %}}Recreate the disk if source (image, snapshot) of this disk is different from source of existing disk.{{% /md %}}</dd><dt>Use<wbr>Existing<wbr>Disk</dt>
    <dd>USE_EXISTING_DISK{{% md %}}Use the existing disk, this is the default behaviour.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Attached<wbr>Disk<wbr>Initialize<wbr>Params<wbr>On<wbr>Update<wbr>Action<wbr>Recreate<wbr>Disk</dt>
    <dd>RECREATE_DISK{{% md %}}Always recreate the disk.{{% /md %}}</dd><dt>Attached<wbr>Disk<wbr>Initialize<wbr>Params<wbr>On<wbr>Update<wbr>Action<wbr>Recreate<wbr>Disk<wbr>If<wbr>Source<wbr>Changed</dt>
    <dd>RECREATE_DISK_IF_SOURCE_CHANGED{{% md %}}Recreate the disk if source (image, snapshot) of this disk is different from source of existing disk.{{% /md %}}</dd><dt>Attached<wbr>Disk<wbr>Initialize<wbr>Params<wbr>On<wbr>Update<wbr>Action<wbr>Use<wbr>Existing<wbr>Disk</dt>
    <dd>USE_EXISTING_DISK{{% md %}}Use the existing disk, this is the default behaviour.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>RECREATE_DISK</dt>
    <dd>RECREATE_DISK{{% md %}}Always recreate the disk.{{% /md %}}</dd><dt>RECREATE_DISK_IF_SOURCE_CHANGED</dt>
    <dd>RECREATE_DISK_IF_SOURCE_CHANGED{{% md %}}Recreate the disk if source (image, snapshot) of this disk is different from source of existing disk.{{% /md %}}</dd><dt>USE_EXISTING_DISK</dt>
    <dd>USE_EXISTING_DISK{{% md %}}Use the existing disk, this is the default behaviour.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#sourceimageencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Image<wbr>Encryption<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customerencryptionkeyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Customer<wbr>Encryption<wbr>Key<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Attached<wbr>Disk<wbr>Interface<wbr>Nvme</dt>
...
<dl class="tabular"><dt>Read<wbr>Only</dt>
    <dd>READ_ONLY{{% md %}}Attaches this disk in read-only mode. Multiple virtual machines can use a disk in read-only mode at a time.{{% /md %}}</dd><dt>Read<wbr>Write</dt>
    <dd>READ_WRITE{{% md %}}*[Default]* Attaches this disk in read-write mode. Only one virtual machine at a time can be attached to a disk in read-write mode.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Attached<wbr>Disk<wbr>Mode<wbr>Read<wbr>Only</dt>
    <dd>READ_ONLY{{% md %}}Attaches this disk in read-only mode. Multiple virtual machines can use a disk in read-only mode at a time.{{% /md %}}</dd><dt>Attached<wbr>Disk<wbr>Mode<wbr>Read<wbr>Write</dt>
    <dd>READ_WRITE{{% md %}}*[Default]* Attaches this disk in read-write mode. Only one virtual machine at a time can be attached to a disk in read-write mode.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>READ_ONLY</dt>
    <dd>READ_ONLY{{% md %}}Attaches this disk in read-only mode. Multiple virtual machines can use a disk in read-only mode at a time.{{% /md %}}</dd><dt>READ_WRITE</dt>
    <dd>READ_WRITE{{% md %}}*[Default]* Attaches this disk in read-write mode. Only one virtual machine at a time can be attached to a disk in read-write mode.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#guestosfeatures_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Os<wbr>Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestosfeatureresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Guest<wbr>Os<wbr>Feature<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#initializeparams_csharp" style="color: inherit; text-decoration: inherit;">Initialize<wbr>Params</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddiskinitializeparamsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Attached<wbr>Disk<wbr>Initialize<wbr>Params<wbr>Response</a></span>
    </dt>
...
<a href="#shieldedinstanceinitialstate_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Initial<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#initialstateconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Initial<wbr>State<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#dbs_csharp" style="color: inherit; text-decoration: inherit;">Dbs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filecontentbufferresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>File<wbr>Content<wbr>Buffer<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#pk_csharp" style="color: inherit; text-decoration: inherit;">Pk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filecontentbufferresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>File<wbr>Content<wbr>Buffer<wbr>Response</a></span>
    </dt>
...
<dl class="tabular"><dt>Enable<wbr>Bidirectional<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Inherit<wbr>From<wbr>Subnetwork</dt>
    <dd>INHERIT_FROM_SUBNETWORK{{% md %}}Each network interface inherits PrivateIpv6GoogleAccess from its subnetwork.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Instance<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Bidirectional<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Instance<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Instance<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Inherit<wbr>From<wbr>Subnetwork</dt>
    <dd>INHERIT_FROM_SUBNETWORK{{% md %}}Each network interface inherits PrivateIpv6GoogleAccess from its subnetwork.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>INHERIT_FROM_SUBNETWORK</dt>
    <dd>INHERIT_FROM_SUBNETWORK{{% md %}}Each network interface inherits PrivateIpv6GoogleAccess from its subnetwork.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#items_csharp" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataitemsitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Metadata<wbr>Items<wbr>Item&gt;</a></span>
    </dt>
    <dd>{{% md %}}Array of key/value pairs. The total size of all keys and values must be less than 512 KB.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#items_python" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataitemsitem">Sequence[Metadata<wbr>Items<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}Array of key/value pairs. The total size of all keys and values must be less than 512 KB.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#items_csharp" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataitemsitemresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Metadata<wbr>Items<wbr>Item<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#accessconfigs_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessconfig">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Access<wbr>Config&gt;</a></span>
    </dt>
...
<a href="#aliasipranges_csharp" style="color: inherit; text-decoration: inherit;">Alias<wbr>Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aliasiprange">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Alias<wbr>Ip<wbr>Range&gt;</a></span>
    </dt>
...
<a href="#network_csharp" style="color: inherit; text-decoration: inherit;">Network</a>
    ...
    <dd>{{% md %}}URL of the network resource for this instance. When creating an instance, if neither the network nor the subnetwork is specified, the default network global/networks/default is used; if the network is not specified but the subnetwork is specified, the network is inferred. If you specify this property, you can specify the network as a full or partial URL. For example, the following are all valid URLs: - https://www.googleapis.com/compute/v1/projects/project/global/networks/ network - projects/project/global/networks/network - global/networks/default {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nictype_csharp" style="color: inherit; text-decoration: inherit;">Nic<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacenictype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Network<wbr>Interface<wbr>Nic<wbr>Type</a></span>
    </dt>
...
<a href="#stacktype_csharp" style="color: inherit; text-decoration: inherit;">Stack<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacestacktype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Network<wbr>Interface<wbr>Stack<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}The stack type for this network interface to identify whether the IPv6 feature is enabled or not. If not specified, IPV4_ONLY will be used. This field can be both set at instance creation and update network interface operations.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#access_configs_python" style="color: inherit; text-decoration: inherit;">access_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessconfig">Sequence[Access<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}An array of configurations for this interface. Currently, only one access config, ONE_TO_ONE_NAT, is supported. If there are no accessConfigs specified, then this instance will have no external internet access.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#alias_ip_ranges_python" style="color: inherit; text-decoration: inherit;">alias_<wbr>ip_<wbr>ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aliasiprange">Sequence[Alias<wbr>Ip<wbr>Range]</a></span>
    </dt>
    <dd>{{% md %}}An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>Gvnic</dt>
    <dd>GVNIC{{% md %}}GVNIC{{% /md %}}</dd><dt>Unspecified<wbr>Nic<wbr>Type</dt>
    <dd>UNSPECIFIED_NIC_TYPE{{% md %}}No type specified.{{% /md %}}</dd><dt>Virtio<wbr>Net</dt>
    <dd>VIRTIO_NET{{% md %}}VIRTIO{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Network<wbr>Interface<wbr>Nic<wbr>Type<wbr>Gvnic</dt>
    <dd>GVNIC{{% md %}}GVNIC{{% /md %}}</dd><dt>Network<wbr>Interface<wbr>Nic<wbr>Type<wbr>Unspecified<wbr>Nic<wbr>Type</dt>
    <dd>UNSPECIFIED_NIC_TYPE{{% md %}}No type specified.{{% /md %}}</dd><dt>Network<wbr>Interface<wbr>Nic<wbr>Type<wbr>Virtio<wbr>Net</dt>
    <dd>VIRTIO_NET{{% md %}}VIRTIO{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>GVNIC</dt>
    <dd>GVNIC{{% md %}}GVNIC{{% /md %}}</dd><dt>UNSPECIFIED_NIC_TYPE</dt>
...
<a href="#accessconfigs_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessconfigresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Access<wbr>Config<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#aliasipranges_csharp" style="color: inherit; text-decoration: inherit;">Alias<wbr>Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aliasiprangeresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Alias<wbr>Ip<wbr>Range<wbr>Response&gt;</a></span>
    </dt>
...
<dl class="tabular"><dt>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}The network interface can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}The network interface will be assigned IPv4 address.{{% /md %}}</dd><dt>Unspecified<wbr>Stack<wbr>Type</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Network<wbr>Interface<wbr>Stack<wbr>Type<wbr>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}The network interface can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Network<wbr>Interface<wbr>Stack<wbr>Type<wbr>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}The network interface will be assigned IPv4 address.{{% /md %}}</dd><dt>Network<wbr>Interface<wbr>Stack<wbr>Type<wbr>Unspecified<wbr>Stack<wbr>Type</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>IPV4_IPV6</dt>
    <dd>IPV4_IPV6{{% md %}}The network interface can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>IPV4_ONLY</dt>
    <dd>IPV4_ONLY{{% md %}}The network interface will be assigned IPv4 address.{{% /md %}}</dd><dt>UNSPECIFIED_STACK_TYPE</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}
...
<a href="#consumereservationtype_csharp" style="color: inherit; text-decoration: inherit;">Consume<wbr>Reservation<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reservationaffinityconsumereservationtype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Reservation<wbr>Affinity<wbr>Consume<wbr>Reservation<wbr>Type</a></span>
    </dt>
...
<dl class="tabular"><dt>Any<wbr>Reservation</dt>
    <dd>ANY_RESERVATION{{% md %}}Consume any allocation available.{{% /md %}}</dd><dt>No<wbr>Reservation</dt>
    <dd>NO_RESERVATION{{% md %}}Do not consume from any allocated capacity.{{% /md %}}</dd><dt>Specific<wbr>Reservation</dt>
    <dd>SPECIFIC_RESERVATION{{% md %}}Must consume from a specific reservation. Must specify key value fields for specifying the reservations.{{% /md %}}</dd><dt>Unspecified</dt>
...
<dl class="tabular"><dt>Reservation<wbr>Affinity<wbr>Consume<wbr>Reservation<wbr>Type<wbr>Any<wbr>Reservation</dt>
    <dd>ANY_RESERVATION{{% md %}}Consume any allocation available.{{% /md %}}</dd><dt>Reservation<wbr>Affinity<wbr>Consume<wbr>Reservation<wbr>Type<wbr>No<wbr>Reservation</dt>
    <dd>NO_RESERVATION{{% md %}}Do not consume from any allocated capacity.{{% /md %}}</dd><dt>Reservation<wbr>Affinity<wbr>Consume<wbr>Reservation<wbr>Type<wbr>Specific<wbr>Reservation</dt>
    <dd>SPECIFIC_RESERVATION{{% md %}}Must consume from a specific reservation. Must specify key value fields for specifying the reservations.{{% /md %}}</dd><dt>Reservation<wbr>Affinity<wbr>Consume<wbr>Reservation<wbr>Type<wbr>Unspecified</dt>
    <dd>UNSPECIFIED</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ANY_RESERVATION</dt>
    <dd>ANY_RESERVATION{{% md %}}Consume any allocation available.{{% /md %}}</dd><dt>NO_RESERVATION</dt>
    <dd>NO_RESERVATION{{% md %}}Do not consume from any allocated capacity.{{% /md %}}</dd><dt>SPECIFIC_RESERVATION</dt>
    <dd>SPECIFIC_RESERVATION{{% md %}}Must consume from a specific reservation. Must specify key value fields for specifying the reservations.{{% /md %}}</dd><dt>UNSPECIFIED</dt>
    <dd>UNSPECIFIED</dd></dl>
{{% /choosable %}}
...
<a href="#nodeaffinities_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Affinities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingnodeaffinity">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Scheduling<wbr>Node<wbr>Affinity&gt;</a></span>
    </dt>
...
<a href="#onhostmaintenance_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Host<wbr>Maintenance</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingonhostmaintenance">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Scheduling<wbr>On<wbr>Host<wbr>Maintenance</a></span>
    </dt>
...
<a href="#node_affinities_python" style="color: inherit; text-decoration: inherit;">node_<wbr>affinities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingnodeaffinity">Sequence[Scheduling<wbr>Node<wbr>Affinity]</a></span>
    </dt>
    <dd>{{% md %}}A set of node affinity and anti-affinity configurations. Refer to Configuring node affinity for more information. Overrides reservationAffinity.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#operator_csharp" style="color: inherit; text-decoration: inherit;">Operator</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingnodeaffinityoperator">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Scheduling<wbr>Node<wbr>Affinity<wbr>Operator</a></span>
    </dt>
...
<dl class="tabular"><dt>In</dt>
    <dd>IN{{% md %}}Requires Compute Engine to seek for matched nodes.{{% /md %}}</dd><dt>Not<wbr>In</dt>
    <dd>NOT_IN{{% md %}}Requires Compute Engine to avoid certain nodes.{{% /md %}}</dd><dt>Operator<wbr>Unspecified</dt>
    <dd>OPERATOR_UNSPECIFIED</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Scheduling<wbr>Node<wbr>Affinity<wbr>Operator<wbr>In</dt>
    <dd>IN{{% md %}}Requires Compute Engine to seek for matched nodes.{{% /md %}}</dd><dt>Scheduling<wbr>Node<wbr>Affinity<wbr>Operator<wbr>Not<wbr>In</dt>
    <dd>NOT_IN{{% md %}}Requires Compute Engine to avoid certain nodes.{{% /md %}}</dd><dt>Scheduling<wbr>Node<wbr>Affinity<wbr>Operator<wbr>Operator<wbr>Unspecified</dt>
    <dd>OPERATOR_UNSPECIFIED</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>IN_</dt>
    <dd>IN{{% md %}}Requires Compute Engine to seek for matched nodes.{{% /md %}}</dd><dt>NOT_IN</dt>
    <dd>NOT_IN{{% md %}}Requires Compute Engine to avoid certain nodes.{{% /md %}}</dd><dt>OPERATOR_UNSPECIFIED</dt>
    <dd>OPERATOR_UNSPECIFIED</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Migrate</dt>
    <dd>MIGRATE{{% md %}}*[Default]* Allows Compute Engine to automatically migrate instances out of the way of maintenance events.{{% /md %}}</dd><dt>Terminate</dt>
...
<dl class="tabular"><dt>Scheduling<wbr>On<wbr>Host<wbr>Maintenance<wbr>Migrate</dt>
    <dd>MIGRATE{{% md %}}*[Default]* Allows Compute Engine to automatically migrate instances out of the way of maintenance events.{{% /md %}}</dd><dt>Scheduling<wbr>On<wbr>Host<wbr>Maintenance<wbr>Terminate</dt>
    <dd>TERMINATE{{% md %}}Tells Compute Engine to terminate and (optionally) restart the instance away from the maintenance activity. If you would like your instance to be restarted, set the automaticRestart flag to true. Your instance may be restarted more than once, and it may be restarted outside the window of maintenance events.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodeaffinities_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Affinities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulingnodeaffinityresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Scheduling<wbr>Node<wbr>Affinity<wbr>Response&gt;</a></span>
    </dt>
