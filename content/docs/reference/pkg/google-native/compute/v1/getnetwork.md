...
---
title: "getNetwork"
title_tag: "google-native.compute/v1.getNetwork"
meta_desc: "Documentation for the google-native.compute/v1.getNetwork function with examples, input properties, output properties, and supporting types."
---
...
For custom mode VPC networks, you can add subnets using the subnetworks insert method.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gatewayipv4_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>IPv4</a>
    ...
    <dd>{{% md %}}[Output Only] The gateway address for default routing out of the network, selected by GCP.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#network for networks.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="mtu_csharp">
...
<a href="#peerings_csharp" style="color: inherit; text-decoration: inherit;">Peerings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkpeeringresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Peering<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] A list of network peerings for the resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="routingconfig_csharp">
<a href="#routingconfig_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkroutingconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Network<wbr>Routing<wbr>Config<wbr>Response</a></span>
    </dt>
