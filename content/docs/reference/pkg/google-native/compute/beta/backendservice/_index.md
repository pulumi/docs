...
<a href="#circuitbreakers_csharp" style="color: inherit; text-decoration: inherit;">Circuit<wbr>Breakers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#circuitbreakers">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Circuit<wbr>Breakers<wbr>Args</a></span>
    </dt>
...
<a href="#maxrateperendpoint_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Rate<wbr>Per<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}Defines a maximum target for requests per second (RPS). For usage guidelines, see Rate balancing mode and Utilization balancing mode. Not available if the backend's balancingMode is CONNECTION.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>Connection</dt>
    <dd>CONNECTION{{% md %}}Balance based on the number of simultaneous connections.{{% /md %}}</dd><dt>Rate</dt>
    <dd>RATE{{% md %}}Balance based on requests per second (RPS).{{% /md %}}</dd><dt>Utilization</dt>
    <dd>UTILIZATION{{% md %}}Balance based on the backend utilization.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Backend<wbr>Balancing<wbr>Mode<wbr>Connection</dt>
    <dd>CONNECTION{{% md %}}Balance based on the number of simultaneous connections.{{% /md %}}</dd><dt>Backend<wbr>Balancing<wbr>Mode<wbr>Rate</dt>
    <dd>RATE{{% md %}}Balance based on requests per second (RPS).{{% /md %}}</dd><dt>Backend<wbr>Balancing<wbr>Mode<wbr>Utilization</dt>
    <dd>UTILIZATION{{% md %}}Balance based on the backend utilization.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#bypasscacheonrequestheaders_csharp" style="color: inherit; text-decoration: inherit;">Bypass<wbr>Cache<wbr>On<wbr>Request<wbr>Headers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendservicecdnpolicybypasscacheonrequestheader">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Backend<wbr>Service<wbr>Cdn<wbr>Policy<wbr>Bypass<wbr>Cache<wbr>On<wbr>Request<wbr>Header&gt;</a></span>
    </dt>
...
<a href="#cachekeypolicy_csharp" style="color: inherit; text-decoration: inherit;">Cache<wbr>Key<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cachekeypolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Cache<wbr>Key<wbr>Policy</a></span>
    </dt>
...
<a href="#negativecachingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Negative<wbr>Caching<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendservicecdnpolicynegativecachingpolicy">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Backend<wbr>Service<wbr>Cdn<wbr>Policy<wbr>Negative<wbr>Caching<wbr>Policy&gt;</a></span>
    </dt>
...
<a href="#bypass_cache_on_request_headers_python" style="color: inherit; text-decoration: inherit;">bypass_<wbr>cache_<wbr>on_<wbr>request_<wbr>headers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendservicecdnpolicybypasscacheonrequestheader">Sequence[Backend<wbr>Service<wbr>Cdn<wbr>Policy<wbr>Bypass<wbr>Cache<wbr>On<wbr>Request<wbr>Header]</a></span>
    </dt>
    <dd>{{% md %}}Bypass the cache when the specified request headers are matched - e.g. Pragma or Authorization headers. Up to 5 headers can be specified. The cache is bypassed for all cdnPolicy.cacheMode settings.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="backendservicecompressionmode">Backend<wbr>Service<wbr>Compression<wbr>Mode</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Backend<wbr>Service<wbr>Compression<wbr>Mode<wbr>Automatic</dt>
    <dd>AUTOMATIC{{% md %}}Automatically uses the best compression based on the Accept-Encoding header sent by the client.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Compression<wbr>Mode<wbr>Disabled</dt>
    <dd>DISABLED{{% md %}}Disables compression. Existing compressed responses cached by Cloud CDN will not be served to clients.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#disableconnectiondrainonfailover_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Connection<wbr>Drain<wbr>On<wbr>Failover</a>
    ...
    <dd>{{% md %}}This can be set to true only if the protocol is TCP. The default is false.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#droptrafficifunhealthy_csharp" style="color: inherit; text-decoration: inherit;">Drop<wbr>Traffic<wbr>If<wbr>Unhealthy</a>
    ...
    <dd>{{% md %}}If set to true, connections to the load balancer are dropped when all primary and all backup backend VMs are unhealthy.If set to false, connections are distributed among all primary VMs when all primary and all backup backend VMs are unhealthy. For load balancers that have configurable failover: [Internal TCP/UDP Load Balancing](https://cloud.google.com/load-balancing/docs/internal/failover-overview) and [external TCP/UDP Load Balancing](/network/networklb-failover-overview). The default is false.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#oauth2clientsecret_csharp" style="color: inherit; text-decoration: inherit;">Oauth2Client<wbr>Secret</a>
    ...
    <dd>{{% md %}}OAuth2 client secret to use for the authentication flow. For security reasons, this value cannot be retrieved via the API. Instead, the SHA-256 hash of the value is returned in the oauth2ClientSecretSha256 field. @InputOnly{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>External</dt>
    <dd>EXTERNAL{{% md %}}Signifies that this will be used for external HTTP(S), SSL Proxy, TCP Proxy, or Network Load Balancing{{% /md %}}</dd><dt>External<wbr>Managed</dt>
    <dd>EXTERNAL_MANAGED{{% md %}}Signifies that this will be used for External Managed HTTP(S), SSL Proxy, or TCP Proxy Load Balancing.{{% /md %}}</dd><dt>Internal</dt>
    <dd>INTERNAL{{% md %}}Signifies that this will be used for Internal TCP/UDP Load Balancing.{{% /md %}}</dd><dt>Internal<wbr>Managed</dt>
    <dd>INTERNAL_MANAGED{{% md %}}Signifies that this will be used for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>Internal<wbr>Self<wbr>Managed</dt>
    <dd>INTERNAL_SELF_MANAGED{{% md %}}Signifies that this will be used by Traffic Director.{{% /md %}}</dd><dt>Invalid<wbr>Load<wbr>Balancing<wbr>Scheme</dt>
...
<dl class="tabular"><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>External</dt>
    <dd>EXTERNAL{{% md %}}Signifies that this will be used for external HTTP(S), SSL Proxy, TCP Proxy, or Network Load Balancing{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>External<wbr>Managed</dt>
    <dd>EXTERNAL_MANAGED{{% md %}}Signifies that this will be used for External Managed HTTP(S), SSL Proxy, or TCP Proxy Load Balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>Internal</dt>
    <dd>INTERNAL{{% md %}}Signifies that this will be used for Internal TCP/UDP Load Balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>Internal<wbr>Managed</dt>
    <dd>INTERNAL_MANAGED{{% md %}}Signifies that this will be used for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>Internal<wbr>Self<wbr>Managed</dt>
    <dd>INTERNAL_SELF_MANAGED{{% md %}}Signifies that this will be used by Traffic Director.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Load<wbr>Balancing<wbr>Scheme<wbr>Invalid<wbr>Load<wbr>Balancing<wbr>Scheme</dt>
    <dd>INVALID_LOAD_BALANCING_SCHEME</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>EXTERNAL</dt>
    <dd>EXTERNAL{{% md %}}Signifies that this will be used for external HTTP(S), SSL Proxy, TCP Proxy, or Network Load Balancing{{% /md %}}</dd><dt>EXTERNAL_MANAGED</dt>
    <dd>EXTERNAL_MANAGED{{% md %}}Signifies that this will be used for External Managed HTTP(S), SSL Proxy, or TCP Proxy Load Balancing.{{% /md %}}</dd><dt>INTERNAL</dt>
    <dd>INTERNAL{{% md %}}Signifies that this will be used for Internal TCP/UDP Load Balancing.{{% /md %}}</dd><dt>INTERNAL_MANAGED</dt>
    <dd>INTERNAL_MANAGED{{% md %}}Signifies that this will be used for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>INTERNAL_SELF_MANAGED</dt>
    <dd>INTERNAL_SELF_MANAGED{{% md %}}Signifies that this will be used by Traffic Director.{{% /md %}}</dd><dt>INVALID_LOAD_BALANCING_SCHEME</dt>
    <dd>INVALID_LOAD_BALANCING_SCHEME</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Invalid<wbr>Lb<wbr>Policy</dt>
    ...
    <dd>LEAST_REQUEST{{% md %}}An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests.{{% /md %}}</dd><dt>Maglev</dt>
    <dd>MAGLEV{{% md %}}This algorithm implements consistent hashing to backends. Maglev can be used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see https://ai.google/research/pubs/pub44824{{% /md %}}</dd><dt>Original<wbr>Destination</dt>
    <dd>ORIGINAL_DESTINATION{{% md %}}Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer.{{% /md %}}</dd><dt>Random</dt>
    <dd>RANDOM{{% md %}}The load balancer selects a random healthy host.{{% /md %}}</dd><dt>Ring<wbr>Hash</dt>
    <dd>RING_HASH{{% md %}}The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests.{{% /md %}}</dd><dt>Round<wbr>Robin</dt>
    <dd>ROUND_ROBIN{{% md %}}This is a simple policy in which each healthy backend is selected in round robin order. This is the default.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Invalid<wbr>Lb<wbr>Policy</dt>
    ...
    <dd>LEAST_REQUEST{{% md %}}An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Maglev</dt>
    <dd>MAGLEV{{% md %}}This algorithm implements consistent hashing to backends. Maglev can be used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see https://ai.google/research/pubs/pub44824{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Original<wbr>Destination</dt>
    <dd>ORIGINAL_DESTINATION{{% md %}}Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Random</dt>
    <dd>RANDOM{{% md %}}The load balancer selects a random healthy host.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Ring<wbr>Hash</dt>
    <dd>RING_HASH{{% md %}}The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Locality<wbr>Lb<wbr>Policy<wbr>Round<wbr>Robin</dt>
    <dd>ROUND_ROBIN{{% md %}}This is a simple policy in which each healthy backend is selected in round robin order. This is the default.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>INVALID_LB_POLICY</dt>
    ...
    <dd>LEAST_REQUEST{{% md %}}An O(1) algorithm which selects two random healthy hosts and picks the host which has fewer active requests.{{% /md %}}</dd><dt>MAGLEV</dt>
    <dd>MAGLEV{{% md %}}This algorithm implements consistent hashing to backends. Maglev can be used as a drop in replacement for the ring hash load balancer. Maglev is not as stable as ring hash but has faster table lookup build times and host selection times. For more information about Maglev, see https://ai.google/research/pubs/pub44824{{% /md %}}</dd><dt>ORIGINAL_DESTINATION</dt>
    <dd>ORIGINAL_DESTINATION{{% md %}}Backend host is selected based on the client connection metadata, i.e., connections are opened to the same address as the destination address of the incoming connection before the connection was redirected to the load balancer.{{% /md %}}</dd><dt>RANDOM</dt>
    <dd>RANDOM{{% md %}}The load balancer selects a random healthy host.{{% /md %}}</dd><dt>RING_HASH</dt>
    <dd>RING_HASH{{% md %}}The ring/modulo hash load balancer implements consistent hashing to backends. The algorithm has the property that the addition/removal of a host from a set of N hosts only affects 1/N of the requests.{{% /md %}}</dd><dt>ROUND_ROBIN</dt>
    <dd>ROUND_ROBIN{{% md %}}This is a simple policy in which each healthy backend is selected in round robin order. This is the default.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Grpc</dt>
    <dd>GRPC{{% md %}}gRPC (available for Traffic Director).{{% /md %}}</dd><dt>Http</dt>
    <dd>HTTP</dd><dt>Http2</dt>
    <dd>HTTP2{{% md %}}HTTP/2 with SSL.{{% /md %}}</dd><dt>Https</dt>
    <dd>HTTPS</dd><dt>Ssl</dt>
    <dd>SSL{{% md %}}TCP proxying with SSL.{{% /md %}}</dd><dt>Tcp</dt>
    <dd>TCP{{% md %}}TCP proxying or TCP pass-through.{{% /md %}}</dd><dt>Udp</dt>
    <dd>UDP{{% md %}}UDP.{{% /md %}}</dd><dt>Unspecified</dt>
    <dd>UNSPECIFIED{{% md %}}If a Backend Service has UNSPECIFIED as its protocol, it can be used with any L3/L4 Forwarding Rules.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Backend<wbr>Service<wbr>Protocol<wbr>Grpc</dt>
    <dd>GRPC{{% md %}}gRPC (available for Traffic Director).{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Http</dt>
    <dd>HTTP</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Http2</dt>
    <dd>HTTP2{{% md %}}HTTP/2 with SSL.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Https</dt>
    <dd>HTTPS</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Ssl</dt>
    <dd>SSL{{% md %}}TCP proxying with SSL.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Tcp</dt>
    <dd>TCP{{% md %}}TCP proxying or TCP pass-through.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Udp</dt>
    <dd>UDP{{% md %}}UDP.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Protocol<wbr>Unspecified</dt>
    <dd>UNSPECIFIED{{% md %}}If a Backend Service has UNSPECIFIED as its protocol, it can be used with any L3/L4 Forwarding Rules.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Client<wbr>Ip</dt>
    <dd>CLIENT_IP{{% md %}}2-tuple hash on packet's source and destination IP addresses. Connections from the same source IP address to the same destination IP address will be served by the same backend VM while that VM remains healthy.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Client<wbr>Ip<wbr>No<wbr>Destination</dt>
    <dd>CLIENT_IP_NO_DESTINATION{{% md %}}1-tuple hash only on packet's source IP address. Connections from the same source IP address will be served by the same backend VM while that VM remains healthy. This option can only be used for Internal TCP/UDP Load Balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Client<wbr>Ip<wbr>Port<wbr>Proto</dt>
    <dd>CLIENT_IP_PORT_PROTO{{% md %}}5-tuple hash on packet's source and destination IP addresses, IP protocol, and source and destination ports. Connections for the same IP protocol from the same source IP address and port to the same destination IP address and port will be served by the same backend VM while that VM remains healthy. This option cannot be used for HTTP(S) load balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Client<wbr>Ip<wbr>Proto</dt>
    <dd>CLIENT_IP_PROTO{{% md %}}3-tuple hash on packet's source and destination IP addresses, and IP protocol. Connections for the same IP protocol from the same source IP address to the same destination IP address will be served by the same backend VM while that VM remains healthy. This option cannot be used for HTTP(S) load balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Generated<wbr>Cookie</dt>
    <dd>GENERATED_COOKIE{{% md %}}Hash based on a cookie generated by the L7 loadbalancer. Only valid for HTTP(S) load balancing.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Header<wbr>Field</dt>
    <dd>HEADER_FIELD{{% md %}}The hash is based on a user specified header field.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>Http<wbr>Cookie</dt>
    <dd>HTTP_COOKIE{{% md %}}The hash is based on a user provided cookie.{{% /md %}}</dd><dt>Backend<wbr>Service<wbr>Session<wbr>Affinity<wbr>None</dt>
    <dd>NONE{{% md %}}No session affinity. Connections from the same client IP may go to any instance in the pool.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#includenamedcookies_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Named<wbr>Cookies</a>
    ...
    <dd>{{% md %}}Allows HTTP cookies (by name) to be used in the cache key. The name=value pair will be used in the cache key Cloud CDN generates.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maxconnections_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Connections</a>
    ...
    <dd>{{% md %}}Not supported when the backend service is referenced by a URL map that is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#httpcookie_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Cookie</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#consistenthashloadbalancersettingshttpcookie">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Consistent<wbr>Hash<wbr>Load<wbr>Balancer<wbr>Settings<wbr>Http<wbr>Cookie</a></span>
    </dt>
