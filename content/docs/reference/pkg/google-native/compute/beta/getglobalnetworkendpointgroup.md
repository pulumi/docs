...
title_tag: "google-native.compute/beta.getGlobalNetworkEndpointGroup"
meta_desc: "Documentation for the google-native.compute/beta.getGlobalNetworkEndpointGroup function with examples, input properties, output properties, and supporting types."
---
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#networkEndpointGroup for network endpoint group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the region where the network endpoint group is located.{{% /md %}}</dd><dt class="property-"
            title="">
