...
---
title: "UrlMap"
title_tag: "google-native.compute/beta.UrlMap"
meta_desc: "Documentation for the google-native.compute/beta.UrlMap resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#defaultrouteaction_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Route<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouteaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Action<wbr>Args</a></span>
    </dt>
...
<a href="#defaulturlredirect_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Url<wbr>Redirect</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpredirectaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Redirect<wbr>Action<wbr>Args</a></span>
    </dt>
...
<a href="#headeraction_csharp" style="color: inherit; text-decoration: inherit;">Header<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Action<wbr>Args</a></span>
    </dt>
...
<a href="#hostrules_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostrule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Host<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#pathmatchers_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Matchers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathmatcher">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Path<wbr>Matcher<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#tests_csharp" style="color: inherit; text-decoration: inherit;">Tests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaptest">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Url<wbr>Map<wbr>Test<wbr>Args&gt;</a></span>
    </dt>
...
<h4 id="httpfaultabort">Http<wbr>Fault<wbr>Abort</h4>
...
<h4 id="httpfaultdelay">Http<wbr>Fault<wbr>Delay</h4>
...
<h4 id="httpfaultinjection">Http<wbr>Fault<wbr>Injection</h4>
...
<a href="#abort_csharp" style="color: inherit; text-decoration: inherit;">Abort</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultabort">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Fault<wbr>Abort</a></span>
    </dt>
...
<a href="#delay_csharp" style="color: inherit; text-decoration: inherit;">Delay</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultdelay">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Fault<wbr>Delay</a></span>
    </dt>
...
<a href="#abort_go" style="color: inherit; text-decoration: inherit;">Abort</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultabort">Http<wbr>Fault<wbr>Abort</a></span>
    </dt>
    <dd>{{% md %}}The specification for how client requests are aborted as part of fault injection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="delay_go">
<a href="#delay_go" style="color: inherit; text-decoration: inherit;">Delay</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultdelay">Http<wbr>Fault<wbr>Delay</a></span>
    </dt>
    <dd>{{% md %}}The specification for how client requests are delayed as part of fault injection, before being sent to a backend service.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="httpfilterconfig">Http<wbr>Filter<wbr>Config</h4>
...
<h4 id="httpheaderaction">Http<wbr>Header<wbr>Action</h4>
...
<a href="#requestheaderstoadd_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Headers<wbr>To<wbr>Add</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderoption">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Option&gt;</a></span>
    </dt>
...
<a href="#requestheaderstoadd_go" style="color: inherit; text-decoration: inherit;">Request<wbr>Headers<wbr>To<wbr>Add</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderoption">[]Http<wbr>Header<wbr>Option</a></span>
    </dt>
    <dd>{{% md %}}Headers to add to a matching request prior to forwarding the request to the backendService.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#request_headers_to_add_python" style="color: inherit; text-decoration: inherit;">request_<wbr>headers_<wbr>to_<wbr>add</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderoption">Sequence[Http<wbr>Header<wbr>Option]</a></span>
    </dt>
    <dd>{{% md %}}Headers to add to a matching request prior to forwarding the request to the backendService.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#exactmatch_csharp" style="color: inherit; text-decoration: inherit;">Exact<wbr>Match</a>
    ...
    <dd>{{% md %}}The value should exactly match contents of exactMatch. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#invertmatch_csharp" style="color: inherit; text-decoration: inherit;">Invert<wbr>Match</a>
    ...
    <dd>{{% md %}}If set to false, the headerMatch is considered a match if the match criteria above are met. If set to true, the headerMatch is considered a match if the match criteria above are NOT met. The default setting is false.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#prefixmatch_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>Match</a>
    ...
    <dd>{{% md %}}The value of the header must start with the contents of prefixMatch. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#presentmatch_csharp" style="color: inherit; text-decoration: inherit;">Present<wbr>Match</a>
    ...
    <dd>{{% md %}}A header with the contents of headerName must exist. The match takes place whether or not the request's header has a value. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rangematch_csharp">
<a href="#rangematch_csharp" style="color: inherit; text-decoration: inherit;">Range<wbr>Match</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#int64rangematch">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Int64Range<wbr>Match</a></span>
    </dt>
    <dd>{{% md %}}The header value must be an integer and its value must be in the range specified in rangeMatch. If the header does not contain an integer, number or is empty, the match fails. For example for a range [-5, 0] - -3 will match. - 0 will not match. - 0.25 will not match. - -3someString will not match. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set. Note that rangeMatch is not supported for Loadbalancers that have their loadBalancingScheme set to EXTERNAL.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#regexmatch_csharp" style="color: inherit; text-decoration: inherit;">Regex<wbr>Match</a>
    ...
    <dd>{{% md %}}The value of the header must match the regular expression specified in regexMatch. For regular expression grammar, please see: github.com/google/re2/wiki/Syntax For matching against a port specified in the HTTP request, use a headerMatch with headerName set to PORT and a regular expression that satisfies the RFC2616 Host header's port specifier. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set. Note that regexMatch only applies to Loadbalancers that have their loadBalancingScheme set to INTERNAL_SELF_MANAGED.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rangematch_go" style="color: inherit; text-decoration: inherit;">Range<wbr>Match</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#int64rangematch">Int64Range<wbr>Match</a></span>
    </dt>
    <dd>{{% md %}}The header value must be an integer and its value must be in the range specified in rangeMatch. If the header does not contain an integer, number or is empty, the match fails. For example for a range [-5, 0] - -3 will match. - 0 will not match. - 0.25 will not match. - -3someString will not match. Only one of exactMatch, prefixMatch, suffixMatch, regexMatch, presentMatch or rangeMatch must be set. Note that rangeMatch is not supported for Loadbalancers that have their loadBalancingScheme set to EXTERNAL.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="httpheaderoption">Http<wbr>Header<wbr>Option</h4>
...
<h4 id="httpqueryparametermatch">Http<wbr>Query<wbr>Parameter<wbr>Match</h4>
...
<a href="#exactmatch_csharp" style="color: inherit; text-decoration: inherit;">Exact<wbr>Match</a>
    ...
    <dd>{{% md %}}The queryParameterMatch matches if the value of the parameter exactly matches the contents of exactMatch. Only one of presentMatch, exactMatch or regexMatch must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#presentmatch_csharp" style="color: inherit; text-decoration: inherit;">Present<wbr>Match</a>
    ...
    <dd>{{% md %}}Specifies that the queryParameterMatch matches if the request contains the query parameter, irrespective of whether the parameter has a value or not. Only one of presentMatch, exactMatch or regexMatch must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="regexmatch_csharp">
<a href="#regexmatch_csharp" style="color: inherit; text-decoration: inherit;">Regex<wbr>Match</a>
</span>
...
<h4 id="httpredirectaction">Http<wbr>Redirect<wbr>Action</h4>
...
<a href="#hostredirect_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Redirect</a>
    ...
    <dd>{{% md %}}The host that will be used in the redirect response instead of the one that was supplied in the request. The value must be between 1 and 255 characters.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pathredirect_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Redirect</a>
    ...
    <dd>{{% md %}}The path that will be used in the redirect response instead of the one that was supplied in the request. pathRedirect cannot be supplied together with prefixRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect. The value must be between 1 and 1024 characters.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>Found</dt>
    <dd>FOUND{{% md %}}Http Status Code 302 - Found.{{% /md %}}</dd><dt>Moved<wbr>Permanently<wbr>Default</dt>
    <dd>MOVED_PERMANENTLY_DEFAULT{{% md %}}Http Status Code 301 - Moved Permanently.{{% /md %}}</dd><dt>Permanent<wbr>Redirect</dt>
    <dd>PERMANENT_REDIRECT{{% md %}}Http Status Code 308 - Permanent Redirect maintaining HTTP method.{{% /md %}}</dd><dt>See<wbr>Other</dt>
    <dd>SEE_OTHER{{% md %}}Http Status Code 303 - See Other.{{% /md %}}</dd><dt>Temporary<wbr>Redirect</dt>
    <dd>TEMPORARY_REDIRECT{{% md %}}Http Status Code 307 - Temporary Redirect maintaining HTTP method.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Http<wbr>Redirect<wbr>Action<wbr>Redirect<wbr>Response<wbr>Code<wbr>Found</dt>
    <dd>FOUND{{% md %}}Http Status Code 302 - Found.{{% /md %}}</dd><dt>Http<wbr>Redirect<wbr>Action<wbr>Redirect<wbr>Response<wbr>Code<wbr>Moved<wbr>Permanently<wbr>Default</dt>
    <dd>MOVED_PERMANENTLY_DEFAULT{{% md %}}Http Status Code 301 - Moved Permanently.{{% /md %}}</dd><dt>Http<wbr>Redirect<wbr>Action<wbr>Redirect<wbr>Response<wbr>Code<wbr>Permanent<wbr>Redirect</dt>
    <dd>PERMANENT_REDIRECT{{% md %}}Http Status Code 308 - Permanent Redirect maintaining HTTP method.{{% /md %}}</dd><dt>Http<wbr>Redirect<wbr>Action<wbr>Redirect<wbr>Response<wbr>Code<wbr>See<wbr>Other</dt>
    <dd>SEE_OTHER{{% md %}}Http Status Code 303 - See Other.{{% /md %}}</dd><dt>Http<wbr>Redirect<wbr>Action<wbr>Redirect<wbr>Response<wbr>Code<wbr>Temporary<wbr>Redirect</dt>
    <dd>TEMPORARY_REDIRECT{{% md %}}Http Status Code 307 - Temporary Redirect maintaining HTTP method.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>FOUND</dt>
    <dd>FOUND{{% md %}}Http Status Code 302 - Found.{{% /md %}}</dd><dt>MOVED_PERMANENTLY_DEFAULT</dt>
    <dd>MOVED_PERMANENTLY_DEFAULT{{% md %}}Http Status Code 301 - Moved Permanently.{{% /md %}}</dd><dt>PERMANENT_REDIRECT</dt>
    <dd>PERMANENT_REDIRECT{{% md %}}Http Status Code 308 - Permanent Redirect maintaining HTTP method.{{% /md %}}</dd><dt>SEE_OTHER</dt>
    <dd>SEE_OTHER{{% md %}}Http Status Code 303 - See Other.{{% /md %}}</dd><dt>TEMPORARY_REDIRECT</dt>
    <dd>TEMPORARY_REDIRECT{{% md %}}Http Status Code 307 - Temporary Redirect maintaining HTTP method.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="httpretrypolicy">Http<wbr>Retry<wbr>Policy</h4>
...
<a href="#pertrytimeout_csharp" style="color: inherit; text-decoration: inherit;">Per<wbr>Try<wbr>Timeout</a>
    ...
    <dd>{{% md %}}Specifies a non-zero timeout per retry attempt. If not specified, will use the timeout set in HttpRouteAction. If timeout in HttpRouteAction is not set, will use the largest timeout among all backend services associated with the route.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="httprouteaction">Http<wbr>Route<wbr>Action</h4>
...
<a href="#corspolicy_csharp" style="color: inherit; text-decoration: inherit;">Cors<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#corspolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Cors<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}The specification for allowing client side cross-origin requests. Please see W3C Recommendation for Cross Origin Resource Sharing Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requestmirrorpolicy_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Mirror<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#requestmirrorpolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Request<wbr>Mirror<wbr>Policy</a></span>
    </dt>
...
<a href="#retrypolicy_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpretrypolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Retry<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}Specifies the retry policy associated with this route. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#urlrewrite_csharp" style="color: inherit; text-decoration: inherit;">Url<wbr>Rewrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlrewrite">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Url<wbr>Rewrite</a></span>
    </dt>
...
<a href="#weightedbackendservices_csharp" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Backend<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#weightedbackendservice">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Weighted<wbr>Backend<wbr>Service&gt;</a></span>
    </dt>
...
<a href="#faultinjectionpolicy_go" style="color: inherit; text-decoration: inherit;">Fault<wbr>Injection<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultinjection">Http<wbr>Fault<wbr>Injection</a></span>
    </dt>
    <dd>{{% md %}}The specification for fault injection introduced into traffic to test the resiliency of clients to backend service failure. As part of fault injection, when clients send requests to a backend service, delays can be introduced by Loadbalancer on a percentage of requests before sending those request to the backend service. Similarly requests from clients can be aborted by the Loadbalancer for a percentage of requests. For the requests impacted by fault injection, timeout and retry_policy will be ignored by clients that are configured with a fault_injection_policy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requestmirrorpolicy_go" style="color: inherit; text-decoration: inherit;">Request<wbr>Mirror<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#requestmirrorpolicy">Request<wbr>Mirror<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service. Loadbalancer does not wait for responses from the shadow service. Prior to sending traffic to the shadow service, the host / authority header is suffixed with -shadow. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#urlrewrite_go" style="color: inherit; text-decoration: inherit;">Url<wbr>Rewrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlrewrite">Url<wbr>Rewrite</a></span>
    </dt>
    <dd>{{% md %}}The spec to modify the URL of the request, prior to forwarding the request to the matched service. urlRewrite is the only action supported in UrlMaps for external HTTP(S) load balancers. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#weightedbackendservices_go" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Backend<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#weightedbackendservice">[]Weighted<wbr>Backend<wbr>Service</a></span>
    </dt>
    <dd>{{% md %}}A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one weightedBackendService with weight set to a non-zero number. Once a backendService is identified and before forwarding the request to the backend service, advanced routing actions such as URL rewrites and header transformations are applied depending on additional settings specified in this HttpRouteAction.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#weighted_backend_services_python" style="color: inherit; text-decoration: inherit;">weighted_<wbr>backend_<wbr>services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#weightedbackendservice">Sequence[Weighted<wbr>Backend<wbr>Service]</a></span>
    </dt>
    <dd>{{% md %}}A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one weightedBackendService with weight set to a non-zero number. Once a backendService is identified and before forwarding the request to the backend service, advanced routing actions such as URL rewrites and header transformations are applied depending on additional settings specified in this HttpRouteAction.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#corspolicy_csharp" style="color: inherit; text-decoration: inherit;">Cors<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#corspolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Cors<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#faultinjectionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Fault<wbr>Injection<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfaultinjectionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Fault<wbr>Injection<wbr>Response</a></span>
    </dt>
...
<a href="#requestmirrorpolicy_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Mirror<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#requestmirrorpolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Request<wbr>Mirror<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the policy on how requests intended for the route's backends are shadowed to a separate mirrored backend service. Loadbalancer does not wait for responses from the shadow service. Prior to sending traffic to the shadow service, the host / authority header is suffixed with -shadow. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="retrypolicy_csharp">
<a href="#retrypolicy_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpretrypolicyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Retry<wbr>Policy<wbr>Response</a></span>
    </dt>
...
<a href="#urlrewrite_csharp" style="color: inherit; text-decoration: inherit;">Url<wbr>Rewrite</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlrewriteresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Url<wbr>Rewrite<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The spec to modify the URL of the request, prior to forwarding the request to the matched service. urlRewrite is the only action supported in UrlMaps for external HTTP(S) load balancers. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="weightedbackendservices_csharp">
<a href="#weightedbackendservices_csharp" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Backend<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#weightedbackendserviceresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Weighted<wbr>Backend<wbr>Service<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of weighted backend services to send traffic to when a route match occurs. The weights determine the fraction of traffic that flows to their corresponding backend service. If all traffic needs to go to a single backend service, there must be one weightedBackendService with weight set to a non-zero number. Once a backendService is identified and before forwarding the request to the backend service, advanced routing actions such as URL rewrites and header transformations are applied depending on additional settings specified in this HttpRouteAction.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="httprouterule">Http<wbr>Route<wbr>Rule</h4>
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The short description conveying the intent of this routeRule. The description can have a maximum length of 1024 characters.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="headeraction_csharp">
<a href="#headeraction_csharp" style="color: inherit; text-decoration: inherit;">Header<wbr>Action</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Action</a></span>
    </dt>
...
<a href="#httpfilterconfigs_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Filter<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfilterconfig">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Filter<wbr>Config&gt;</a></span>
    </dt>
...
<a href="#matchrules_csharp" style="color: inherit; text-decoration: inherit;">Match<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouterulematch">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Rule<wbr>Match&gt;</a></span>
    </dt>
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}For routeRules within a given pathMatcher, priority determines the order in which load balancer will interpret routeRules. RouteRules are evaluated in order of priority, from the lowest to highest number. The priority of a rule decreases as its number increases (1, 2, 3, N+1). The first rule that matches the request is applied. You cannot configure two or more routeRules with the same priority. Priority for each rule must be set to a number between 0 and 2147483647 inclusive. Priority numbers can have gaps, which enable you to add or remove rules in the future without affecting the rest of the rules. For example, 1, 2, 3, 4, 5, 9, 12, 16 is a valid series of priority numbers to which you could add rules numbered from 6 to 8, 10 to 11, and 13 to 15 in the future without any impact on existing rules.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="routeaction_csharp">
<a href="#routeaction_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Action</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouteaction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Action</a></span>
    </dt>
    <dd>{{% md %}}In response to a matching matchRule, the load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If routeAction specifies any weightedBackendServices, service must not be set. Conversely if service is set, routeAction cannot contain any weightedBackendServices. Only one of urlRedirect, service or routeAction.weightedBackendService must be set. UrlMaps for external HTTP(S) load balancers support only the urlRewrite action within a routeRule's routeAction.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#httpfilterconfigs_go" style="color: inherit; text-decoration: inherit;">Http<wbr>Filter<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfilterconfig">[]Http<wbr>Filter<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}Outbound route specific configuration for networkservices.HttpFilter resources enabled by Traffic Director. httpFilterConfigs only applies for Loadbalancers with loadBalancingScheme set to INTERNAL_SELF_MANAGED. See ForwardingRule for more details. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#matchrules_go" style="color: inherit; text-decoration: inherit;">Match<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouterulematch">[]Http<wbr>Route<wbr>Rule<wbr>Match</a></span>
    </dt>
    <dd>{{% md %}}The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="priority_go">
...
<a href="#http_filter_configs_python" style="color: inherit; text-decoration: inherit;">http_<wbr>filter_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfilterconfig">Sequence[Http<wbr>Filter<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}Outbound route specific configuration for networkservices.HttpFilter resources enabled by Traffic Director. httpFilterConfigs only applies for Loadbalancers with loadBalancingScheme set to INTERNAL_SELF_MANAGED. See ForwardingRule for more details. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#match_rules_python" style="color: inherit; text-decoration: inherit;">match_<wbr>rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouterulematch">Sequence[Http<wbr>Route<wbr>Rule<wbr>Match]</a></span>
    </dt>
    <dd>{{% md %}}The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates within a given matchRule have AND semantics. All predicates within a matchRule must match for the request to match the rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="httprouterulematch">Http<wbr>Route<wbr>Rule<wbr>Match</h4>
...
<a href="#fullpathmatch_csharp" style="color: inherit; text-decoration: inherit;">Full<wbr>Path<wbr>Match</a>
    ...
    <dd>{{% md %}}For satisfying the matchRule condition, the path of the request must exactly match the value specified in fullPathMatch after removing any query parameters and anchor that may be part of the original URL. fullPathMatch must be between 1 and 1024 characters. Only one of prefixMatch, fullPathMatch or regexMatch must be specified.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="headermatches_csharp">
<a href="#headermatches_csharp" style="color: inherit; text-decoration: inherit;">Header<wbr>Matches</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheadermatch">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Match&gt;</a></span>
    </dt>
...
<a href="#ignorecase_csharp" style="color: inherit; text-decoration: inherit;">Ignore<wbr>Case</a>
    ...
    <dd>{{% md %}}Specifies that prefixMatch and fullPathMatch matches are case sensitive. The default value is false. ignoreCase must not be used with regexMatch. Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metadatafilters_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadatafilter">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Metadata<wbr>Filter&gt;</a></span>
    </dt>
...
<a href="#prefixmatch_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>Match</a>
    ...
    <dd>{{% md %}}For satisfying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /. The value must be between 1 and 1024 characters. Only one of prefixMatch, fullPathMatch or regexMatch must be specified.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#queryparametermatches_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>Parameter<wbr>Matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpqueryparametermatch">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Query<wbr>Parameter<wbr>Match&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request. Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="regexmatch_csharp">
<a href="#regexmatch_csharp" style="color: inherit; text-decoration: inherit;">Regex<wbr>Match</a>
</span>
...
<a href="#queryparametermatches_go" style="color: inherit; text-decoration: inherit;">Query<wbr>Parameter<wbr>Matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpqueryparametermatch">[]Http<wbr>Query<wbr>Parameter<wbr>Match</a></span>
    </dt>
    <dd>{{% md %}}Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request. Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="regexmatch_go">
...
<a href="#header_matches_python" style="color: inherit; text-decoration: inherit;">header_<wbr>matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheadermatch">Sequence[Http<wbr>Header<wbr>Match]</a></span>
    </dt>
    <dd>{{% md %}}Specifies a list of header match criteria, all of which must match corresponding headers in the request.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metadata_filters_python" style="color: inherit; text-decoration: inherit;">metadata_<wbr>filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadatafilter">Sequence[Metadata<wbr>Filter]</a></span>
    </dt>
    <dd>{{% md %}}Opaque filter criteria used by Loadbalancer to restrict routing configuration to a limited set of xDS compliant clients. In their xDS requests to Loadbalancer, xDS clients present node metadata. When there is a match, the relevant routing configuration is made available to those proxies. For each metadataFilter in this list, if its filterMatchCriteria is set to MATCH_ANY, at least one of the filterLabels must match the corresponding label provided in the metadata. If its filterMatchCriteria is set to MATCH_ALL, then all of its filterLabels must match with corresponding labels provided in the metadata. If multiple metadataFilters are specified, all of them need to be satisfied in order to be considered a match. metadataFilters specified here will be applied after those specified in ForwardingRule that refers to the UrlMap this HttpRouteRuleMatch belongs to. metadataFilters only applies to Loadbalancers that have their loadBalancingScheme set to INTERNAL_SELF_MANAGED. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="prefix_match_python">
...
<a href="#query_parameter_matches_python" style="color: inherit; text-decoration: inherit;">query_<wbr>parameter_<wbr>matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpqueryparametermatch">Sequence[Http<wbr>Query<wbr>Parameter<wbr>Match]</a></span>
    </dt>
    <dd>{{% md %}}Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request. Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="regex_match_python">
...
<a href="#headermatches_csharp" style="color: inherit; text-decoration: inherit;">Header<wbr>Matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheadermatchresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Match<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#metadatafilters_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadatafilterresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Metadata<wbr>Filter<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Opaque filter criteria used by Loadbalancer to restrict routing configuration to a limited set of xDS compliant clients. In their xDS requests to Loadbalancer, xDS clients present node metadata. When there is a match, the relevant routing configuration is made available to those proxies. For each metadataFilter in this list, if its filterMatchCriteria is set to MATCH_ANY, at least one of the filterLabels must match the corresponding label provided in the metadata. If its filterMatchCriteria is set to MATCH_ALL, then all of its filterLabels must match with corresponding labels provided in the metadata. If multiple metadataFilters are specified, all of them need to be satisfied in order to be considered a match. metadataFilters specified here will be applied after those specified in ForwardingRule that refers to the UrlMap this HttpRouteRuleMatch belongs to. metadataFilters only applies to Loadbalancers that have their loadBalancingScheme set to INTERNAL_SELF_MANAGED. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="prefixmatch_csharp">
...
<a href="#queryparametermatches_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>Parameter<wbr>Matches</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpqueryparametermatchresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Query<wbr>Parameter<wbr>Match<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#headeraction_csharp" style="color: inherit; text-decoration: inherit;">Header<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpheaderactionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Header<wbr>Action<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies changes to request and response headers that need to take effect for the selected backendService. The headerAction specified here are applied before the matching pathMatchers[].headerAction and after pathMatchers[].routeRules[].routeAction.weightedBackendService.backendServiceWeightAction[].headerAction Note that headerAction is not supported for Loadbalancers that have their loadBalancingScheme set to EXTERNAL. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="httpfilterconfigs_csharp">
<a href="#httpfilterconfigs_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Filter<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpfilterconfigresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Filter<wbr>Config<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Outbound route specific configuration for networkservices.HttpFilter resources enabled by Traffic Director. httpFilterConfigs only applies for Loadbalancers with loadBalancingScheme set to INTERNAL_SELF_MANAGED. See ForwardingRule for more details. Not supported when the URL map is bound to target gRPC proxy that has validateForProxyless field set to true.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="httpfiltermetadata_csharp">
...
<a href="#matchrules_csharp" style="color: inherit; text-decoration: inherit;">Match<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouterulematchresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Rule<wbr>Match<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#routeaction_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouteactionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Action<wbr>Response</a></span>
    </dt>
...
<a href="#urlredirect_csharp" style="color: inherit; text-decoration: inherit;">Url<wbr>Redirect</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpredirectactionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Redirect<wbr>Action<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}When this rule is matched, the request is redirected to a URL specified by urlRedirect. If urlRedirect is specified, service or routeAction must not be set. Not supported when the URL map is bound to target gRPC proxy.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="int64rangematch">Int64Range<wbr>Match</h4>
...
<a href="#filterlabels_csharp" style="color: inherit; text-decoration: inherit;">Filter<wbr>Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadatafilterlabelmatch">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Metadata<wbr>Filter<wbr>Label<wbr>Match&gt;</a></span>
    </dt>
...
<h4 id="pathmatcher">Path<wbr>Matcher</h4>
...
<a href="#defaultrouteaction_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Route<wbr>Action</a>
    ...
    <dd>{{% md %}}defaultRouteAction takes effect when none of the pathRules or routeRules match. The load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If defaultRouteAction specifies any weightedBackendServices, defaultService must not be set. Conversely if defaultService is set, defaultRouteAction cannot contain any weightedBackendServices. Only one of defaultRouteAction or defaultUrlRedirect must be set. UrlMaps for external HTTP(S) load balancers support only the urlRewrite action within a pathMatcher's defaultRouteAction.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="defaultservice_csharp">
<a href="#defaultservice_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Service</a>
</span>
...
<a href="#pathrules_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathrule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Path<wbr>Rule&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of path rules. Use this list instead of routeRules when routing based on simple path matching is all that's required. The order by which path rules are specified does not matter. Matches are always done on the longest-path-first basis. For example: a pathRule with a path /a/b/c/* will match before /a/b/* irrespective of the order in which those paths appear in this list. Within a given pathMatcher, only one of pathRules or routeRules must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="routerules_csharp">
<a href="#routerules_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouterule">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Rule&gt;</a></span>
    </dt>
...
<a href="#pathrules_go" style="color: inherit; text-decoration: inherit;">Path<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathrule">[]Path<wbr>Rule</a></span>
    </dt>
    <dd>{{% md %}}The list of path rules. Use this list instead of routeRules when routing based on simple path matching is all that's required. The order by which path rules are specified does not matter. Matches are always done on the longest-path-first basis. For example: a pathRule with a path /a/b/c/* will match before /a/b/* irrespective of the order in which those paths appear in this list. Within a given pathMatcher, only one of pathRules or routeRules must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#path_rules_python" style="color: inherit; text-decoration: inherit;">path_<wbr>rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathrule">Sequence[Path<wbr>Rule]</a></span>
    </dt>
    <dd>{{% md %}}The list of path rules. Use this list instead of routeRules when routing based on simple path matching is all that's required. The order by which path rules are specified does not matter. Matches are always done on the longest-path-first basis. For example: a pathRule with a path /a/b/c/* will match before /a/b/* irrespective of the order in which those paths appear in this list. Within a given pathMatcher, only one of pathRules or routeRules must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pathrules_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathruleresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Path<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#routerules_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httprouteruleresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Http<wbr>Route<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of HTTP route rules. Use this list instead of pathRules when advanced route matching and routing actions are desired. routeRules are evaluated in order of priority, from the lowest to highest number. Within a given pathMatcher, you can set only one of pathRules or routeRules.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="pathrule">Path<wbr>Rule</h4>
...
<a href="#routeaction_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Action</a>
    ...
    <dd>{{% md %}}In response to a matching path, the load balancer performs advanced routing actions like URL rewrites, header transformations, etc. prior to forwarding the request to the selected backend. If routeAction specifies any weightedBackendServices, service must not be set. Conversely if service is set, routeAction cannot contain any weightedBackendServices. Only one of routeAction or urlRedirect must be set. UrlMaps for external HTTP(S) load balancers support only the urlRewrite action within a pathRule's routeAction.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="service_csharp">
<a href="#service_csharp" style="color: inherit; text-decoration: inherit;">Service</a>
</span>
...
<h4 id="requestmirrorpolicy">Request<wbr>Mirror<wbr>Policy</h4>
...
<h4 id="urlmaptest">Url<wbr>Map<wbr>Test</h4>
...
<a href="#expectedredirectresponsecode_csharp" style="color: inherit; text-decoration: inherit;">Expected<wbr>Redirect<wbr>Response<wbr>Code</a>
    ...
    <dd>{{% md %}}For rules with urlRedirect, the test passes only if expectedRedirectResponseCode matches the HTTP status code in load balancer's redirect response. expectedRedirectResponseCode cannot be set when service is set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="headers_csharp">
<a href="#headers_csharp" style="color: inherit; text-decoration: inherit;">Headers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaptestheader">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Url<wbr>Map<wbr>Test<wbr>Header&gt;</a></span>
    </dt>
...
<a href="#headers_go" style="color: inherit; text-decoration: inherit;">Headers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaptestheader">[]Url<wbr>Map<wbr>Test<wbr>Header</a></span>
    </dt>
    <dd>{{% md %}}HTTP headers for this request. If headers contains a host header, then host must also match the header value.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="host_go">
...
<a href="#headers_python" style="color: inherit; text-decoration: inherit;">headers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaptestheader">Sequence[Url<wbr>Map<wbr>Test<wbr>Header]</a></span>
    </dt>
    <dd>{{% md %}}HTTP headers for this request. If headers contains a host header, then host must also match the header value.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="host_python">
...
<h4 id="urlmaptestheader">Url<wbr>Map<wbr>Test<wbr>Header</h4>
...
<a href="#headers_csharp" style="color: inherit; text-decoration: inherit;">Headers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaptestheaderresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Url<wbr>Map<wbr>Test<wbr>Header<wbr>Response&gt;</a></span>
    </dt>
...
<h4 id="urlrewrite">Url<wbr>Rewrite</h4>
...
<a href="#hostrewrite_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Rewrite</a>
    ...
    <dd>{{% md %}}Prior to forwarding the request to the selected service, the request's host header is replaced with contents of hostRewrite. The value must be between 1 and 255 characters.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="weightedbackendservice">Weighted<wbr>Backend<wbr>Service</h4>
