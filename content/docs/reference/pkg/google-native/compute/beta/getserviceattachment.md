...
title_tag: "google-native.compute/beta.getServiceAttachment"
meta_desc: "Documentation for the google-native.compute/beta.getServiceAttachment function with examples, input properties, output properties, and supporting types."
---
...
<a href="#connectedendpoints_csharp" style="color: inherit; text-decoration: inherit;">Connected<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconnectedendpointresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Outputs.<wbr>Service<wbr>Attachment<wbr>Connected<wbr>Endpoint<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] An array of connections for all the consumers connected to this service attachment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#consumerforwardingrules_csharp" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Forwarding<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconsumerforwardingruleresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Outputs.<wbr>Service<wbr>Attachment<wbr>Consumer<wbr>Forwarding<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] An array of forwarding rules for all the consumers connected to this service attachment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#serviceAttachment for service attachments.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#pscserviceattachmentid_csharp" style="color: inherit; text-decoration: inherit;">Psc<wbr>Service<wbr>Attachment<wbr>Id</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#uint128response">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Outputs.<wbr>Uint128Response</a></span>
    </dt>
    <dd>{{% md %}}[Output Only] An 128-bit global unique ID of the PSC service attachment.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="region_csharp">
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
</span>
    ...
    <dd>{{% md %}}[Output Only] URL of the region where the service attachment resides. This field applies only to the region resource. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.{{% /md %}}</dd><dt class="property-"
            title="">
