...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#resource_policies for resource policies.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#resourcestatus_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Status</a>
    ...
    <dd>{{% md %}}[Output Only] The system status of the resource policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output Only] Server-defined fully-qualified URL for this resource.{{% /md %}}</dd><dt class="property-"
            title="">
