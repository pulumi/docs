...
<a href="#creationtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}[Output Only] The creation timestamp for this instance group in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#fingerprint_csharp" style="color: inherit; text-decoration: inherit;">Fingerprint</a>
    ...
    <dd>{{% md %}}[Output Only] The fingerprint of the named ports. The system uses this fingerprint to detect conflicts when multiple users change the named ports concurrently.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] The resource type, which is always compute#instanceGroup for instance groups.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
Named ports apply to all instances in this instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#network_csharp" style="color: inherit; text-decoration: inherit;">Network</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the network to which all instances in the instance group belong. If your instance has multiple network interfaces, then the network and subnetwork fields only refer to the network and subnet used by your primary interface (nic0).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the region where the instance group is located (for regional resources).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}[Output Only] The URL for this instance group. The server generates this URL.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="size_csharp">
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}[Output Only] The total number of instances in the instance group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#subnetwork_csharp" style="color: inherit; text-decoration: inherit;">Subnetwork</a>
    ...
    <dd>{{% md %}}[Output Only] The URL of the subnetwork to which all instances in the instance group belong. If your instance has multiple network interfaces, then the network and subnetwork fields only refer to the network and subnet used by your primary interface (nic0).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="zone_csharp">
<a href="#zone_csharp" style="color: inherit; text-decoration: inherit;">Zone</a>
</span>
    ...
    <dd>{{% md %}}[Output Only] The URL of the zone where the instance group is located (for zonal resources).{{% /md %}}</dd></dl>
{{% /choosable %}}
