...
<span class="k">def </span><span class="nx">SslPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">warnings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_compute_beta.SslPolicyWarningsItemArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#warnings_csharp" style="color: inherit; text-decoration: inherit;">Warnings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sslpolicywarningsitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Ssl<wbr>Policy<wbr>Warnings<wbr>Item<wbr>Args&gt;</a></span>
    </dt>
