...
This field cannot be set to true at resource creation time.{{% /md %}}</dd><dt class="property-"
            title="">
...
To see the latest fingerprint, make a get() request to retrieve a Subnetwork.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gatewayaddress_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Address</a>
    ...
    <dd>{{% md %}}[Output Only] The gateway address for default routes to reach destination addresses outside this subnetwork.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ipv6cidrrange_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Cidr<wbr>Range</a>
    ...
    <dd>{{% md %}}[Output Only] The range of internal IPv6 addresses that are owned by this subnetwork.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#subnetwork for Subnetwork resources.{{% /md %}}</dd><dt class="property-"
            title="">
...
This field can be both set at resource creation time and updated using patch.{{% /md %}}</dd><dt class="property-"
            title="">
