...
<a href="#autocreated_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Created</a>
    ...
    <dd>{{% md %}}[Output Only] Set to true if snapshots are automatically created by applying resource policy on the target disk.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#downloadbytes_csharp" style="color: inherit; text-decoration: inherit;">Download<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output Only] Number of bytes downloaded to restore a snapshot to a disk.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}[Output Only] Type of the resource. Always compute#snapshot for Snapshot resources.{{% /md %}}</dd><dt class="property-"
            title="">
...
To see the latest fingerprint, make a get() request to retrieve a snapshot.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#licensecodes_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Codes</a>
    ...
    <dd>{{% md %}}[Output Only] Integer license codes indicating which licenses are attached to this snapshot.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#licenses_csharp" style="color: inherit; text-decoration: inherit;">Licenses</a>
    ...
    <dd>{{% md %}}[Output Only] A list of public visible licenses that apply to this snapshot. This can be because the original image had licenses attached (such as a Windows image).{{% /md %}}</dd><dt class="property-"
            title="">
...
If you do not provide an encryption key when creating the snapshot, then the snapshot will be encrypted using an automatically generated key and you do not need to provide a key to use the snapshot later.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcediskid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk<wbr>Id</a>
    ...
    <dd>{{% md %}}[Output Only] The ID value of the disk used to create this snapshot. This value may be used to determine whether the snapshot was taken from the current or a previous instance of a given disk name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}[Output Only] The status of the snapshot. This can be CREATING, DELETING, FAILED, READY, or UPLOADING.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storagebytes_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Bytes</a>
    ...
    <dd>{{% md %}}[Output Only] A size of the storage used by the snapshot. As snapshots share storage, this number is expected to change with snapshot creation/deletion.{{% /md %}}</dd><dt class="property-"
            title="">
