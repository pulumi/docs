...
<span class="k">def </span><span class="nx">Secret</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">replication</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_secretmanager_v1beta1.ReplicationArgs]]</span> = None<span class="p">,</span>
...
<a href="#automatic_csharp" style="color: inherit; text-decoration: inherit;">Automatic</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#automatic">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>Automatic<wbr>Args</a></span>
    </dt>
...
<a href="#usermanaged_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Managed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usermanaged">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>User<wbr>Managed<wbr>Args</a></span>
    </dt>
...
<a href="#automatic_csharp" style="color: inherit; text-decoration: inherit;">Automatic</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#automaticresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>Automatic<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#usermanaged_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Managed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usermanagedresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>User<wbr>Managed<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The Secret will only be replicated into the locations specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replica">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>Replica<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replicaresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>Replica<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Required. The list of Replicas for this Secret. Cannot be empty.{{% /md %}}</dd></dl>
{{% /choosable %}}
