...
<span class="k">def </span><span class="nx">Secret</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">rotation</span><span class="p">:</span> <span class="nx">Optional[RotationArgs]</span> = None<span class="p">,</span>
           <span class="nx">secret_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
           <span class="nx">topics</span><span class="p">:</span> <span class="nx">Optional[Sequence[TopicArgs]]</span> = None<span class="p">,</span>
...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}Optional. Etag of the currently stored Secret.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#topics_python" style="color: inherit; text-decoration: inherit;">topics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#topic">Sequence[Topic<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Optional. A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ttl_python">
...
<a href="#customermanagedencryption_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Managed<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customermanagedencryption">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Customer<wbr>Managed<wbr>Encryption</a></span>
    </dt>
...
<a href="#automatic_csharp" style="color: inherit; text-decoration: inherit;">Automatic</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#automatic">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Automatic</a></span>
    </dt>
...
<a href="#usermanaged_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Managed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usermanaged">Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>User<wbr>Managed</a></span>
    </dt>
...
<a href="#nextrotationtime_csharp" style="color: inherit; text-decoration: inherit;">Next<wbr>Rotation<wbr>Time</a>
    ...
    <dd>{{% md %}}Optional. Timestamp in UTC at which the Secret is scheduled to rotate. Cannot be set to less than 300s (5 min) in the future and at most 3153600000s (100 years). next_rotation_time MUST be set if rotation_period is set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replica">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Replica&gt;</a></span>
    </dt>
