...
<span class="k">def </span><span class="nx">Secret</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">replication</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_secretmanager_v1.ReplicationArgs]]</span> = None<span class="p">,</span>
           <span class="nx">rotation</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_secretmanager_v1.RotationArgs]]</span> = None<span class="p">,</span>
           <span class="nx">secrets_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
           <span class="nx">topics</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_secretmanager_v1.TopicArgs]]]]</span> = None<span class="p">,</span>
