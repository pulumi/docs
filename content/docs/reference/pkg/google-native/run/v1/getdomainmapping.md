...
title_tag: "google-native.run/v1.getDomainMapping"
meta_desc: "Documentation for the google-native.run/v1.getDomainMapping function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_domain_mapping(</span><span class="nx">domainmapping_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#domainmappingid_csharp" style="color: inherit; text-decoration: inherit;">Domainmapping<wbr>Id</a>
</span>
...
<a href="#domainmappingid_go" style="color: inherit; text-decoration: inherit;">Domainmapping<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#domainmappingid_nodejs" style="color: inherit; text-decoration: inherit;">domainmapping<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="domainmapping_id_python">
<a href="#domainmapping_id_python" style="color: inherit; text-decoration: inherit;">domainmapping_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#apiversion_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Version</a>
    ...
    <dd>{{% md %}}The API version for this call such as "domains.cloudrun.com/v1".{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}The kind of resource, in this case "DomainMapping".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
    ...
    <dd>{{% md %}}Metadata associated with this BuildTemplate.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="spec_csharp">
<a href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainmappingspecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Run.<wbr>V1.<wbr>Outputs.<wbr>Domain<wbr>Mapping<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The spec for this DomainMapping.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainmappingstatusresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Run.<wbr>V1.<wbr>Outputs.<wbr>Domain<wbr>Mapping<wbr>Status<wbr>Response</a></span>
    </dt>
...
<a href="#spec_go" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainmappingspecresponse">Domain<wbr>Mapping<wbr>Spec<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The spec for this DomainMapping.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="status_go">
<a href="#status_go" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainmappingstatusresponse">Domain<wbr>Mapping<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The current status of the DomainMapping.{{% /md %}}</dd></dl>
{{% /choosable %}}
