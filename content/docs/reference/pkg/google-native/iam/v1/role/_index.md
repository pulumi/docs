...
<span class="k">def </span><span class="nx">Role</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">stage</span><span class="p">:</span> <span class="nx">Optional[RoleStage]</span> = None<span class="p">,</span>
...
<a href="#stage_csharp" style="color: inherit; text-decoration: inherit;">Stage</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rolestage">Pulumi.<wbr>Google<wbr>Native.<wbr>IAM.<wbr>V1.<wbr>Role<wbr>Stage</a></span>
    </dt>
...
<a href="#stage_go" style="color: inherit; text-decoration: inherit;">Stage</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rolestage">Role<wbr>Stage</a></span>
    </dt>
    <dd>{{% md %}}The current launch stage of the role. If the `ALPHA` launch stage has been selected for a role, the `stage` field will not be included in the returned definition for the role.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="title_go">
...
<h4 id="rolestage">Role<wbr>Stage</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Role<wbr>Stage<wbr>Alpha</dt>
    <dd>ALPHA{{% md %}}The user has indicated this role is currently in an Alpha phase. If this launch stage is selected, the `stage` field will not be included when requesting the definition for a given role.{{% /md %}}</dd><dt>Role<wbr>Stage<wbr>Beta</dt>
    <dd>BETA{{% md %}}The user has indicated this role is currently in a Beta phase.{{% /md %}}</dd><dt>Role<wbr>Stage<wbr>Ga</dt>
    <dd>GA{{% md %}}The user has indicated this role is generally available.{{% /md %}}</dd><dt>Role<wbr>Stage<wbr>Deprecated</dt>
    <dd>DEPRECATED{{% md %}}The user has indicated this role is being deprecated.{{% /md %}}</dd><dt>Role<wbr>Stage<wbr>Disabled</dt>
    <dd>DISABLED{{% md %}}This role is disabled and will not contribute permissions to any members it is granted to in policies.{{% /md %}}</dd><dt>Role<wbr>Stage<wbr>Eap</dt>
    <dd>EAP{{% md %}}The user has indicated this role is currently in an EAP phase.{{% /md %}}</dd></dl>
{{% /choosable %}}
