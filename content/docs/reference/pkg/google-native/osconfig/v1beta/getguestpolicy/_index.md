...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Unique name of the resource in this project using one of the following forms: `projects/{project_number}/guestPolicies/{guest_policy_id}`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#package_repositories_python" style="color: inherit; text-decoration: inherit;">package_<wbr>repositories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#packagerepositoryresponse">Sequence[Package<wbr>Repository<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}A list of package repositories to configure on the VM instance. This is done before any other configs are applied so they can use these repos. Package repositories are only configured if the corresponding package manager(s) are available.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#recipes_python" style="color: inherit; text-decoration: inherit;">recipes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#softwarereciperesponse">Sequence[Software<wbr>Recipe<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}A list of Recipes to install on the VM instance.{{% /md %}}</dd><dt class="property-"
            title="">
