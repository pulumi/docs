...
## Using getGuestPolicy {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getGuestPolicy<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetGuestPolicyArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetGuestPolicyResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_guest_policy(</span><span class="nx">guest_policy_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetGuestPolicyResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupGuestPolicy<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupGuestPolicyArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupGuestPolicyResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetGuestPolicy </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetGuestPolicyResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetGuestPolicyArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#assignment_csharp" style="color: inherit; text-decoration: inherit;">Assignment</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#assignmentresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>OSConfig.<wbr>V1Beta.<wbr>Outputs.<wbr>Assignment<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Required. Specifies the VM instances that are assigned to this policy. This allows you to target sets or groups of VM instances by different parameters such as labels, names, OS, or zones. If left empty, all VM instances underneath this policy are targeted. At the same level in the resource hierarchy (that is within a project), the service prevents the creation of multiple policies that conflict with each other. For more information, see how the service [handles assignment conflicts](/compute/docs/os-config-management/create-guest-policy#handle-conflicts).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description of the guest policy. Length of the description is limited to 1024 characters.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}The etag for this guest policy. If this is provided on update, it must match the server's etag.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. Unique name of the resource in this project using one of the following forms: `projects/{project_number}/guestPolicies/{guest_policy_id}`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagerepositories_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Repositories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#packagerepositoryresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>OSConfig.<wbr>V1Beta.<wbr>Outputs.<wbr>Package<wbr>Repository<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of package repositories to configure on the VM instance. This is done before any other configs are applied so they can use these repos. Package repositories are only configured if the corresponding package manager(s) are available.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="packages_csharp">
<a href="#packages_csharp" style="color: inherit; text-decoration: inherit;">Packages</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#packageresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>OSConfig.<wbr>V1Beta.<wbr>Outputs.<wbr>Package<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The software packages to be managed by this policy.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="recipes_csharp">
<a href="#recipes_csharp" style="color: inherit; text-decoration: inherit;">Recipes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#softwarereciperesponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>OSConfig.<wbr>V1Beta.<wbr>Outputs.<wbr>Software<wbr>Recipe<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of Recipes to install on the VM instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagerepositories_go" style="color: inherit; text-decoration: inherit;">Package<wbr>Repositories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#packagerepositoryresponse">[]Package<wbr>Repository<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A list of package repositories to configure on the VM instance. This is done before any other configs are applied so they can use these repos. Package repositories are only configured if the corresponding package manager(s) are available.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="packages_go">
...
<a href="#recipes_go" style="color: inherit; text-decoration: inherit;">Recipes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#softwarereciperesponse">[]Software<wbr>Recipe<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A list of Recipes to install on the VM instance.{{% /md %}}</dd><dt class="property-"
            title="">
