...
<a href="#ancestor_csharp" style="color: inherit; text-decoration: inherit;">Ancestor</a>
    ...
    <dd>{{% md %}}Required. The index's ancestor mode. Must not be ANCESTOR_MODE_UNSPECIFIED.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="indexid_csharp">
<a href="#indexid_csharp" style="color: inherit; text-decoration: inherit;">Index<wbr>Id</a>
</span>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}Required. The entity kind to which this index applies.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="project_csharp">
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
</span>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}Required. An ordered sequence of property names and their index attributes.{{% /md %}}</dd><dt class="property-"
            title="">
