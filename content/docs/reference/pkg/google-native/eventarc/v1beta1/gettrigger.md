...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
    ...
    <dd>{{% md %}}Required. Destination specifies where the events should be sent to.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#matchingcriteria_csharp" style="color: inherit; text-decoration: inherit;">Matching<wbr>Criteria</a>
    ...
    <dd>{{% md %}}Required. null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#attribute_csharp" style="color: inherit; text-decoration: inherit;">Attribute</a>
    ...
    <dd>{{% md %}}Required. The name of a CloudEvents attribute. Currently, only a subset of attributes can be specified. All triggers MUST provide a matching criteria for the 'type' attribute.{{% /md %}}</dd><dt class="property-required"
            title="Required">
