...
<a href="#servicelevelindicator_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Level<wbr>Indicator</a>
    ...
    <dd>{{% md %}}The definition of good service, used to measure and calculate the quality of the Service's performance with respect to a single aspect of service quality.{{% /md %}}</dd><dt class="property-"
            title="">
