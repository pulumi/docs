...
<a href="#clustername_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The cluster name. Cluster names within a project must be unique. Names of deleted clusters can be reused.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
