...
<a href="#clustername_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The cluster name. Cluster names within a project must be unique. Names of deleted clusters can be reused.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
    ...
    <dd>{{% md %}}Required. The cluster config. Note that Dataproc may set default values, and values may change when clusters are updated.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}Required. The Google Cloud Platform project ID that the cluster belongs to.{{% /md %}}</dd><dt class="property-"
            title="">
