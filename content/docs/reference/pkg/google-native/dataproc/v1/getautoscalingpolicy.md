...
title_tag: "google-native.dataproc/v1.getAutoscalingPolicy"
meta_desc: "Documentation for the google-native.dataproc/v1.getAutoscalingPolicy function with examples, input properties, output properties, and supporting types."
---
...
<a href="#basicalgorithm_csharp" style="color: inherit; text-decoration: inherit;">Basic<wbr>Algorithm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#basicautoscalingalgorithmresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Basic<wbr>Autoscaling<wbr>Algorithm<wbr>Response</a></span>
    </dt>
...
<a href="#secondaryworkerconfig_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Worker<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancegroupautoscalingpolicyconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Instance<wbr>Group<wbr>Autoscaling<wbr>Policy<wbr>Config<wbr>Response</a></span>
    </dt>
