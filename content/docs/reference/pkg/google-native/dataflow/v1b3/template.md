...
<span class="k">def </span><span class="nx">Template</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">environment</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_dataflow_v1b3.RuntimeEnvironmentArgs]]</span> = None<span class="p">,</span>
             <span class="nx">gcs_path</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#environment_go" style="color: inherit; text-decoration: inherit;">Environment</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#runtimeenvironment">Runtime<wbr>Environment</a></span>
    </dt>
    <dd>{{% md %}}The runtime environment for the job.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="gcspath_go">
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#parametermetadataresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dataflow.<wbr>V1b3.<wbr>Inputs.<wbr>Parameter<wbr>Metadata<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#sdkinfo_csharp" style="color: inherit; text-decoration: inherit;">Sdk<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sdkinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataflow.<wbr>V1b3.<wbr>Inputs.<wbr>SDKInfo<wbr>Response<wbr>Args</a></span>
    </dt>
