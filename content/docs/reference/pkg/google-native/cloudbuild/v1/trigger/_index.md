...
<a href="#steps_python" style="color: inherit; text-decoration: inherit;">steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildstep">Sequence[Build<wbr>Step]</a></span>
    </dt>
    <dd>{{% md %}}The operations to be performed on the workspace.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pullrequest_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Request</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pullrequestfilter">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Pull<wbr>Request<wbr>Filter</a></span>
    </dt>
...
<a href="#push_csharp" style="color: inherit; text-decoration: inherit;">Push</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pushfilter">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Push<wbr>Filter</a></span>
    </dt>
...
<h4 id="webhookconfig">Webhook<wbr>Config</h4>
...
<a href="#secret_csharp" style="color: inherit; text-decoration: inherit;">Secret</a>
    ...
    <dd>{{% md %}}Resource name for the secret required as a URL parameter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhookconfigstate">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Webhook<wbr>Config<wbr>State</a></span>
    </dt>
...
<a href="#state_go" style="color: inherit; text-decoration: inherit;">State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhookconfigstate">Webhook<wbr>Config<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}Potential issues with the underlying Pub/Sub subscription configuration. Only populated on get requests.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="webhookconfigstate">Webhook<wbr>Config<wbr>State</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>State<wbr>Unspecified</dt>
    <dd>STATE_UNSPECIFIED{{% md %}}The webhook auth configuration not been checked.{{% /md %}}</dd><dt>Ok</dt>
    <dd>OK{{% md %}}The auth configuration is properly setup.{{% /md %}}</dd><dt>Secret<wbr>Deleted</dt>
    <dd>SECRET_DELETED{{% md %}}The secret provided in auth_method has been deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Webhook<wbr>Config<wbr>State<wbr>State<wbr>Unspecified</dt>
    <dd>STATE_UNSPECIFIED{{% md %}}The webhook auth configuration not been checked.{{% /md %}}</dd><dt>Webhook<wbr>Config<wbr>State<wbr>Ok</dt>
    <dd>OK{{% md %}}The auth configuration is properly setup.{{% /md %}}</dd><dt>Webhook<wbr>Config<wbr>State<wbr>Secret<wbr>Deleted</dt>
    <dd>SECRET_DELETED{{% md %}}The secret provided in auth_method has been deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>STATE_UNSPECIFIED</dt>
    <dd>STATE_UNSPECIFIED{{% md %}}The webhook auth configuration not been checked.{{% /md %}}</dd><dt>OK</dt>
    <dd>OK{{% md %}}The auth configuration is properly setup.{{% /md %}}</dd><dt>SECRET_DELETED</dt>
    <dd>SECRET_DELETED{{% md %}}The secret provided in auth_method has been deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}
