...
---
title: "getTrigger"
title_tag: "google-native.cloudbuild/v1.getTrigger"
meta_desc: "Documentation for the google-native.cloudbuild/v1.getTrigger function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_trigger(</span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#approvalconfig_csharp" style="color: inherit; text-decoration: inherit;">Approval<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#approvalconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Approval<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Configuration for manual approval to start a build invocation of this BuildTrigger.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#autodetect_csharp" style="color: inherit; text-decoration: inherit;">Autodetect</a>
    ...
    <dd>{{% md %}}Autodetect build configuration. The following precedence is used (case insensitive): 1. cloudbuild.yaml 2. cloudbuild.yml 3. cloudbuild.json 4. Dockerfile Currently only available for GitHub App Triggers.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="build_csharp">
<a href="#build_csharp" style="color: inherit; text-decoration: inherit;">Build</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Build<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Contents of the build template.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Human-readable description of this trigger.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disabled_csharp" style="color: inherit; text-decoration: inherit;">Disabled</a>
    ...
    <dd>{{% md %}}If true, the trigger will never automatically execute a build.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#filename_csharp" style="color: inherit; text-decoration: inherit;">Filename</a>
    ...
    <dd>{{% md %}}Path, from the source root, to the build configuration file (i.e. cloudbuild.yaml).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#filter_csharp" style="color: inherit; text-decoration: inherit;">Filter</a>
    ...
    <dd>{{% md %}}A Common Expression Language string.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gitfilesource_csharp" style="color: inherit; text-decoration: inherit;">Git<wbr>File<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitfilesourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Git<wbr>File<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The file source describing the local or remote Build template.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="github_csharp">
<a href="#github_csharp" style="color: inherit; text-decoration: inherit;">Github</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#githubeventsconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Git<wbr>Hub<wbr>Events<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}GitHubEventsConfig describes the configuration of a trigger that creates a build whenever a GitHub event is received. Mutually exclusive with `trigger_template`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}User-assigned name of the trigger. Must be unique within the project. Trigger names must meet the following requirements: + They must contain only alphanumeric characters and dashes. + They can be 1-64 characters long. + They must begin and end with an alphanumeric character.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="pubsubconfig_csharp">
<a href="#pubsubconfig_csharp" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Pubsub<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}PubsubConfig describes the configuration of a trigger that creates a build whenever a Pub/Sub message is published.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The `Trigger` name with format: `projects/{project}/locations/{location}/triggers/{trigger}`, where {trigger} is a unique identifier generated by the service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceaccount_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account</a>
    ...
    <dd>{{% md %}}The service account used for all user-controlled operations including UpdateBuildTrigger, RunBuildTrigger, CreateBuild, and CancelBuild. If no service account is set, then the standard Cloud Build service account ([PROJECT_NUM]@system.gserviceaccount.com) will be used instead. Format: `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT_ID_OR_EMAIL}`{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcetobuild_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>To<wbr>Build</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitreposourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Git<wbr>Repo<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The repo and ref of the repository from which to build. This field is used only for those triggers that do not respond to SCM events. Triggers that respond to such events build source at whatever commit caused the event. This field is currently only used by Webhook, Pub/Sub, Manual, and Cron triggers.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#substitutions_csharp" style="color: inherit; text-decoration: inherit;">Substitutions</a>
    ...
    <dd>{{% md %}}Substitutions for Build resource. The keys must match the following regular expression: `^_[A-Z0-9_]+$`.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}Tags for annotation of a `BuildTrigger`{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#triggertemplate_csharp" style="color: inherit; text-decoration: inherit;">Trigger<wbr>Template</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reposourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Repo<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Template describing the types of source changes to trigger a build. Branch and tag names in trigger templates are interpreted as regular expressions. Any branch or tag change that matches that regular expression will trigger a build. Mutually exclusive with `github`.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="webhookconfig_csharp">
<a href="#webhookconfig_csharp" style="color: inherit; text-decoration: inherit;">Webhook<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhookconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Webhook<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#gitfilesource_go" style="color: inherit; text-decoration: inherit;">Git<wbr>File<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitfilesourceresponse">Git<wbr>File<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The file source describing the local or remote Build template.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="github_go">
<a href="#github_go" style="color: inherit; text-decoration: inherit;">Github</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#githubeventsconfigresponse">Git<wbr>Hub<wbr>Events<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}GitHubEventsConfig describes the configuration of a trigger that creates a build whenever a GitHub event is received. Mutually exclusive with `trigger_template`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#pubsubconfig_go" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubconfigresponse">Pubsub<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}PubsubConfig describes the configuration of a trigger that creates a build whenever a Pub/Sub message is published.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcetobuild_go" style="color: inherit; text-decoration: inherit;">Source<wbr>To<wbr>Build</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gitreposourceresponse">Git<wbr>Repo<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The repo and ref of the repository from which to build. This field is used only for those triggers that do not respond to SCM events. Triggers that respond to such events build source at whatever commit caused the event. This field is currently only used by Webhook, Pub/Sub, Manual, and Cron triggers.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#webhookconfig_go" style="color: inherit; text-decoration: inherit;">Webhook<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhookconfigresponse">Webhook<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}WebhookConfig describes the configuration of a trigger that creates a build whenever a webhook is sent to a trigger's webhook URL.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#volumes_csharp" style="color: inherit; text-decoration: inherit;">Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumeresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Volume<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#artifacts_csharp" style="color: inherit; text-decoration: inherit;">Artifacts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#artifactsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Artifacts<wbr>Response</a></span>
    </dt>
...
<a href="#availablesecrets_csharp" style="color: inherit; text-decoration: inherit;">Available<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Secrets<wbr>Response</a></span>
    </dt>
...
<a href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildoptionsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Build<wbr>Options<wbr>Response</a></span>
    </dt>
...
<a href="#results_csharp" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resultsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Results<wbr>Response</a></span>
    </dt>
...
<a href="#secrets_csharp" style="color: inherit; text-decoration: inherit;">Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Secret<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Source<wbr>Response</a></span>
    </dt>
...
<a href="#sourceprovenance_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Provenance</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourceprovenanceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Source<wbr>Provenance<wbr>Response</a></span>
    </dt>
...
<a href="#steps_csharp" style="color: inherit; text-decoration: inherit;">Steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildstepresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Build<wbr>Step<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The operations to be performed on the workspace.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="substitutions_csharp">
<a href="#substitutions_csharp" style="color: inherit; text-decoration: inherit;">Substitutions</a>
</span>
...
<a href="#warnings_csharp" style="color: inherit; text-decoration: inherit;">Warnings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#warningresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Warning<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#artifacts_go" style="color: inherit; text-decoration: inherit;">Artifacts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#artifactsresponse">Artifacts<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Artifacts produced by the build that should be uploaded upon successful completion of all build steps.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#availablesecrets_go" style="color: inherit; text-decoration: inherit;">Available<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretsresponse">Secrets<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Secrets and secret environment variables.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#options_go" style="color: inherit; text-decoration: inherit;">Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildoptionsresponse">Build<wbr>Options<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Special options for this build.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="project_go">
...
<a href="#steps_go" style="color: inherit; text-decoration: inherit;">Steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildstepresponse">[]Build<wbr>Step<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The operations to be performed on the workspace.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="substitutions_go">
...
<a href="#steps_python" style="color: inherit; text-decoration: inherit;">steps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#buildstepresponse">Sequence[Build<wbr>Step<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The operations to be performed on the workspace.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="substitutions_python">
...
<h4 id="githubeventsconfigresponse">Git<wbr>Hub<wbr>Events<wbr>Config<wbr>Response</h4>
...
<a href="#pullrequest_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Request</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pullrequestfilterresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Pull<wbr>Request<wbr>Filter<wbr>Response</a></span>
    </dt>
...
<a href="#push_csharp" style="color: inherit; text-decoration: inherit;">Push</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pushfilterresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Push<wbr>Filter<wbr>Response</a></span>
    </dt>
...
<a href="#pullrequest_go" style="color: inherit; text-decoration: inherit;">Pull<wbr>Request</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pullrequestfilterresponse">Pull<wbr>Request<wbr>Filter<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}filter to match changes in pull requests.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="push_go">
...
<h4 id="pooloptionresponse">Pool<wbr>Option<wbr>Response</h4>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The `WorkerPool` resource to execute the build on. You must have `cloudbuild.workerpools.use` on the project hosting the WorkerPool. Format projects/{project}/locations/{location}/workerPools/{workerPoolId}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="pubsubconfigresponse">Pubsub<wbr>Config<wbr>Response</h4>
...
<a href="#serviceaccountemail_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account<wbr>Email</a>
    ...
    <dd>{{% md %}}Service account that will make the push request.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
</span>
    ...
    <dd>{{% md %}}Potential issues with the underlying Pub/Sub subscription configuration. Only populated on get requests.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#subscription_csharp" style="color: inherit; text-decoration: inherit;">Subscription</a>
    ...
    <dd>{{% md %}}Name of the subscription. Format is `projects/{project}/subscriptions/{subscription}`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<h4 id="pushfilterresponse">Push<wbr>Filter<wbr>Response</h4>
...
<a href="#images_csharp" style="color: inherit; text-decoration: inherit;">Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#builtimageresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Built<wbr>Image<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#images_python" style="color: inherit; text-decoration: inherit;">images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#builtimageresponse">Sequence[Built<wbr>Image<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Container images that were built as a part of the build.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#inline_csharp" style="color: inherit; text-decoration: inherit;">Inline</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inlinesecretresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Inline<wbr>Secret<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#secretmanager_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Manager</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretmanagersecretresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Secret<wbr>Manager<wbr>Secret<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#inline_python" style="color: inherit; text-decoration: inherit;">inline</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inlinesecretresponse">Sequence[Inline<wbr>Secret<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Secrets encrypted with KMS key and the associated secret environment variable.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#secret_manager_python" style="color: inherit; text-decoration: inherit;">secret_<wbr>manager</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretmanagersecretresponse">Sequence[Secret<wbr>Manager<wbr>Secret<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Secrets in Secret Manager and associated secret environment variable.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#resolvedreposource_csharp" style="color: inherit; text-decoration: inherit;">Resolved<wbr>Repo<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reposourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Repo<wbr>Source<wbr>Response</a></span>
    </dt>
...
<a href="#resolvedstoragesource_csharp" style="color: inherit; text-decoration: inherit;">Resolved<wbr>Storage<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storagesourceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Storage<wbr>Source<wbr>Response</a></span>
    </dt>
...
<a href="#resolvedstoragesourcemanifest_csharp" style="color: inherit; text-decoration: inherit;">Resolved<wbr>Storage<wbr>Source<wbr>Manifest</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storagesourcemanifestresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Inputs.<wbr>Storage<wbr>Source<wbr>Manifest<wbr>Response</a></span>
    </dt>
...
<a href="#storagesourcemanifest_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Source<wbr>Manifest</a>
    ...
    <dd>{{% md %}}If provided, get the source from this manifest in Google Cloud Storage. This feature is in Preview; see description [here](https://github.com/GoogleCloudPlatform/cloud-builders/tree/master/gcs-fetcher).{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="warningresponse">Warning<wbr>Response</h4>
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}The priority for this warning.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="text_csharp">
<a href="#text_csharp" style="color: inherit; text-decoration: inherit;">Text</a>
    ...
    <dd>{{% md %}}Explanation of the warning generated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="webhookconfigresponse">Webhook<wbr>Config<wbr>Response</h4>
...
<a href="#secret_csharp" style="color: inherit; text-decoration: inherit;">Secret</a>
    ...
    <dd>{{% md %}}Resource name for the secret required as a URL parameter.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
</span>
    ...
    <dd>{{% md %}}Potential issues with the underlying Pub/Sub subscription configuration. Only populated on get requests.{{% /md %}}</dd></dl>
{{% /choosable %}}
