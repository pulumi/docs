...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_trigger(</span><span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#pubsubconfig_csharp" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Config</a>
    ...
    <dd>{{% md %}}Optional. PubsubConfig describes the configuration of a trigger that creates a build whenever a Pub/Sub message is published.{{% /md %}}</dd><dt class="property-"
            title="">
