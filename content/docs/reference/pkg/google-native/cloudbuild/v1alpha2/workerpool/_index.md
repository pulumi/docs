...
---
title: "WorkerPool"
title_tag: "google-native.cloudbuild/v1alpha2.WorkerPool"
meta_desc: "Documentation for the google-native.cloudbuild/v1alpha2.WorkerPool resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}Immutable. The region where the `WorkerPool` runs. Only "us-central1" is currently supported. Note that `region` cannot be changed once the `WorkerPool` is created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#networkconfig_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Network<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#workerconfig_csharp" style="color: inherit; text-decoration: inherit;">Worker<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workerconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Worker<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#disksizegb_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>Gb</a>
    ...
    <dd>{{% md %}}Size of the disk attached to the worker, in GB. See https://cloud.google.com/compute/docs/disks/ If `0` is specified, Cloud Build will use a standard disk size.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
