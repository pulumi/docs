...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
    ...
    <dd>{{% md %}}Required. The resource name (URI) of the destination connection profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>{{% md %}}Required. The resource name (URI) of the source connection profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Required. The migration job type.{{% /md %}}</dd><dt class="property-"
            title="">
