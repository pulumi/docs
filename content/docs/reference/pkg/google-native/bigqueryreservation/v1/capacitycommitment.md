...
<span class="k">def </span><span class="nx">CapacityCommitment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">plan</span><span class="p">:</span> <span class="nx">Optional[_bigqueryreservation_v1.CapacityCommitmentPlan]</span> = None<span class="p">,</span>
                       <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       <span class="nx">renewal_plan</span><span class="p">:</span> <span class="nx">Optional[_bigqueryreservation_v1.CapacityCommitmentRenewalPlan]</span> = None<span class="p">,</span>
