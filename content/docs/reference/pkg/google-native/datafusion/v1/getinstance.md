...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}The resource labels for instance to use to annotate any related underlying resources such as GCE VMs. The character '=' is not allowed to be used within the labels.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Required. Instance type.{{% /md %}}</dd><dt class="property-"
            title="">
