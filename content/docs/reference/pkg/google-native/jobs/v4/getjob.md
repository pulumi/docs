...
---
title: "getJob"
title_tag: "google-native.jobs/v4.getJob"
meta_desc: "Documentation for the google-native.jobs/v4.getJob function with examples, input properties, output properties, and supporting types."
---
...
<a href="#applicationinfo_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Outputs.<wbr>Application<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Job application information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#company_csharp" style="color: inherit; text-decoration: inherit;">Company</a>
    ...
    <dd>{{% md %}}Required. The resource name of the company listing the job. The format is "projects/{project_id}/tenants/{tenant_id}/companies/{company_id}". For example, "projects/foo/tenants/bar/companies/baz".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#compensationinfo_csharp" style="color: inherit; text-decoration: inherit;">Compensation<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#compensationinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Outputs.<wbr>Compensation<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Job compensation information (a.k.a. "pay rate") i.e., the compensation that will paid to the employee.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#degreetypes_csharp" style="color: inherit; text-decoration: inherit;">Degree<wbr>Types</a>
    ...
    <dd>{{% md %}}The desired education degrees for the job, such as Bachelors, Masters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#department_csharp" style="color: inherit; text-decoration: inherit;">Department</a>
    ...
    <dd>{{% md %}}The department or functional area within the company with the open position. The maximum number of allowed characters is 255.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#employmenttypes_csharp" style="color: inherit; text-decoration: inherit;">Employment<wbr>Types</a>
    ...
    <dd>{{% md %}}The employment type(s) of a job, for example, full time or part time.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#incentives_csharp" style="color: inherit; text-decoration: inherit;">Incentives</a>
    ...
    <dd>{{% md %}}A description of bonus, commission, and other compensation incentives associated with the job not including salary or pay. The maximum number of allowed characters is 10,000.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobbenefits_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Benefits</a>
    ...
    <dd>{{% md %}}The benefits included with the job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobendtime_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>End<wbr>Time</a>
    ...
    <dd>{{% md %}}The end timestamp of the job. Typically this field is used for contracting engagements. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#joblevel_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Level</a>
    ...
    <dd>{{% md %}}The experience level associated with the job, such as "Entry Level".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobstarttime_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The start timestamp of the job in UTC time zone. Typically this field is used for contracting engagements. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#postingpublishtime_csharp" style="color: inherit; text-decoration: inherit;">Posting<wbr>Publish<wbr>Time</a>
    ...
    <dd>{{% md %}}The timestamp this job posting was most recently published. The default value is the time the request arrives at the server. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#processingoptions_csharp" style="color: inherit; text-decoration: inherit;">Processing<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#processingoptionsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Outputs.<wbr>Processing<wbr>Options<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Options for job processing.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#amount_csharp" style="color: inherit; text-decoration: inherit;">Amount</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#moneyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Inputs.<wbr>Money<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Compensation amount.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="description_csharp">
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
    ...
    <dd>{{% md %}}Compensation description. For example, could indicate equity terms or provide additional context to an estimated bonus.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expectedunitsperyear_csharp" style="color: inherit; text-decoration: inherit;">Expected<wbr>Units<wbr>Per<wbr>Year</a>
    ...
    <dd>{{% md %}}Expected number of units paid each year. If not specified, when Job.employment_types is FULLTIME, a default value is inferred based on unit. Default values: - HOURLY: 2080 - DAILY: 260 - WEEKLY: 52 - MONTHLY: 12 - ANNUAL: 1{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="range_csharp">
<a href="#range_csharp" style="color: inherit; text-decoration: inherit;">Range</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#compensationrangeresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Inputs.<wbr>Compensation<wbr>Range<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Compensation range.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Compensation type. Default is CompensationType.COMPENSATION_TYPE_UNSPECIFIED.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="unit_csharp">
<a href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
    ...
    <dd>{{% md %}}Frequency of the specified amount. Default is CompensationUnit.COMPENSATION_UNIT_UNSPECIFIED.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#annualizedbasecompensationrange_csharp" style="color: inherit; text-decoration: inherit;">Annualized<wbr>Base<wbr>Compensation<wbr>Range</a>
    ...
    <dd>{{% md %}}Annualized base compensation range. Computed as base compensation entry's CompensationEntry.amount times CompensationEntry.expected_units_per_year. See CompensationEntry for explanation on compensation annualization.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#annualizedtotalcompensationrange_csharp" style="color: inherit; text-decoration: inherit;">Annualized<wbr>Total<wbr>Compensation<wbr>Range</a>
    ...
    <dd>{{% md %}}Annualized total compensation range. Computed as all compensation entries' CompensationEntry.amount times CompensationEntry.expected_units_per_year. See CompensationEntry for explanation on compensation annualization.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="entries_csharp">
<a href="#entries_csharp" style="color: inherit; text-decoration: inherit;">Entries</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#compensationentryresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Inputs.<wbr>Compensation<wbr>Entry<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as **base compensation entry** for the job.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#maxcompensation_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Compensation</a>
    ...
    <dd>{{% md %}}The maximum amount of compensation. If left empty, the value is set to a maximal compensation value and the currency code is set to match the currency code of min_compensation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#mincompensation_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Compensation</a>
    ...
    <dd>{{% md %}}The minimum amount of compensation. If left empty, the value is set to zero and the currency code is set to match the currency code of max_compensation.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#locations_csharp" style="color: inherit; text-decoration: inherit;">Locations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#locationresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V4.<wbr>Inputs.<wbr>Location<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#disablestreetaddressresolution_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Street<wbr>Address<wbr>Resolution</a>
    ...
    <dd>{{% md %}}If set to `true`, the service does not attempt to resolve a more precise address for the job.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#htmlsanitization_csharp" style="color: inherit; text-decoration: inherit;">Html<wbr>Sanitization</a>
    ...
    <dd>{{% md %}}Option for job HTML content sanitization. Applied fields are: * description * applicationInfo.instruction * incentives * qualifications * responsibilities HTML tags in these fields may be stripped if sanitiazation isn't disabled. Defaults to HtmlSanitization.SIMPLE_FORMATTING_ONLY.{{% /md %}}</dd></dl>
{{% /choosable %}}
