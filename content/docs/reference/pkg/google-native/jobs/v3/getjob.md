...
<a href="#applicationinfo_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Info</a>
    ...
    <dd>{{% md %}}Required. At least one field within ApplicationInfo must be specified. Job application information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#companyname_csharp" style="color: inherit; text-decoration: inherit;">Company<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The resource name of the company listing the job, such as "projects/api-test-project/companies/foo".{{% /md %}}</dd><dt class="property-"
            title="">
