...
<span class="k">def </span><span class="nx">Job</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">app_engine_http_target</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudscheduler_v1.AppEngineHttpTargetArgs]]</span> = None<span class="p">,</span>
        ...
        <span class="nx">http_target</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudscheduler_v1.HttpTargetArgs]]</span> = None<span class="p">,</span>
        <span class="nx">jobs_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">last_attempt_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        ...
        <span class="nx">pubsub_target</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudscheduler_v1.PubsubTargetArgs]]</span> = None<span class="p">,</span>
        <span class="nx">retry_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudscheduler_v1.RetryConfigArgs]]</span> = None<span class="p">,</span>
        ...
        <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudscheduler_v1.StatusArgs]]</span> = None<span class="p">,</span>
        <span class="nx">time_zone</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">user_update_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span>
