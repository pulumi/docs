...
<a href="#codebucket_csharp" style="color: inherit; text-decoration: inherit;">Code<wbr>Bucket</a>
    ...
    <dd>{{% md %}}Google Cloud Storage bucket that can be used for storing files associated with this application. This bucket is associated with the application and can be used by the gcloud deployment commands.@OutputOnly{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#defaultbucket_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Bucket</a>
    ...
    <dd>{{% md %}}Google Cloud Storage bucket that can be used by this application to store content.@OutputOnly{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#defaulthostname_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Hostname</a>
    ...
    <dd>{{% md %}}Hostname used to reach this application, as resolved by App Engine.@OutputOnly{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Full path to the Application resource in the API. Example: apps/myapp.@OutputOnly{{% /md %}}</dd><dt class="property-"
            title="">
