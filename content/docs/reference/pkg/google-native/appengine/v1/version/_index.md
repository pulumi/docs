...
---
title: "Version"
title_tag: "google-native.appengine/v1.Version"
meta_desc: "Documentation for the google-native.appengine/v1.Version resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Version</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">api_config</span><span class="p">:</span> <span class="nx">Optional[ApiConfigHandlerArgs]</span> = None<span class="p">,</span>
            <span class="nx">app_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">automatic_scaling</span><span class="p">:</span> <span class="nx">Optional[AutomaticScalingArgs]</span> = None<span class="p">,</span>
            <span class="nx">basic_scaling</span><span class="p">:</span> <span class="nx">Optional[BasicScalingArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">endpoints_api_service</span><span class="p">:</span> <span class="nx">Optional[EndpointsApiServiceArgs]</span> = None<span class="p">,</span>
            <span class="nx">entrypoint</span><span class="p">:</span> <span class="nx">Optional[EntrypointArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">error_handlers</span><span class="p">:</span> <span class="nx">Optional[Sequence[ErrorHandlerArgs]]</span> = None<span class="p">,</span>
            <span class="nx">handlers</span><span class="p">:</span> <span class="nx">Optional[Sequence[UrlMapArgs]]</span> = None<span class="p">,</span>
            <span class="nx">health_check</span><span class="p">:</span> <span class="nx">Optional[HealthCheckArgs]</span> = None<span class="p">,</span>
            <span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">inbound_services</span><span class="p">:</span> <span class="nx">Optional[Sequence[VersionInboundServicesItem]]</span> = None<span class="p">,</span>
            <span class="nx">instance_class</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">libraries</span><span class="p">:</span> <span class="nx">Optional[Sequence[LibraryArgs]]</span> = None<span class="p">,</span>
            <span class="nx">liveness_check</span><span class="p">:</span> <span class="nx">Optional[LivenessCheckArgs]</span> = None<span class="p">,</span>
            <span class="nx">manual_scaling</span><span class="p">:</span> <span class="nx">Optional[ManualScalingArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">readiness_check</span><span class="p">:</span> <span class="nx">Optional[ReadinessCheckArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">serving_status</span><span class="p">:</span> <span class="nx">Optional[VersionServingStatus]</span> = None<span class="p">,</span>
            ...
            <span class="nx">vpc_access_connector</span><span class="p">:</span> <span class="nx">Optional[VpcAccessConnectorArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewVersion</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">VersionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Version</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#inboundservices_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#versioninboundservicesitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Version<wbr>Inbound<wbr>Services<wbr>Item&gt;</a></span>
    </dt>
...
<a href="#servingstatus_csharp" style="color: inherit; text-decoration: inherit;">Serving<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#versionservingstatus">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Version<wbr>Serving<wbr>Status</a></span>
    </dt>
...
<a href="#error_handlers_python" style="color: inherit; text-decoration: inherit;">error_<wbr>handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#errorhandler">Sequence[Error<wbr>Handler<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Custom static error pages. Limited to 10KB per page.Only returned in GET requests if view=FULL is set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#handlers_python" style="color: inherit; text-decoration: inherit;">handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmap">Sequence[Url<wbr>Map<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An ordered list of URL-matching patterns that should be applied to incoming requests. The first matching URL handles the request and other request handlers are not attempted.Only returned in GET requests if view=FULL is set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inbound_services_python" style="color: inherit; text-decoration: inherit;">inbound_<wbr>services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#versioninboundservicesitem">Sequence[Version<wbr>Inbound<wbr>Services<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}Before an application can receive email or XMPP messages, the application must be configured to enable the service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#libraries_python" style="color: inherit; text-decoration: inherit;">libraries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#library">Sequence[Library<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Configuration for third-party Python runtime libraries that are required by the application.Only returned in GET requests if view=FULL is set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#versionurl_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Url</a>
    ...
    <dd>{{% md %}}Serving URL for this version. Example: "https://myversion-dot-myservice-dot-myapp.appspot.com"{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#authfailaction_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Fail<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiconfighandlerauthfailaction">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Api<wbr>Config<wbr>Handler<wbr>Auth<wbr>Fail<wbr>Action</a></span>
    </dt>
...
<a href="#login_csharp" style="color: inherit; text-decoration: inherit;">Login</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiconfighandlerlogin">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Api<wbr>Config<wbr>Handler<wbr>Login</a></span>
    </dt>
...
<a href="#securitylevel_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Level</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiconfighandlersecuritylevel">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Api<wbr>Config<wbr>Handler<wbr>Security<wbr>Level</a></span>
    </dt>
...
<a href="#cpuutilization_csharp" style="color: inherit; text-decoration: inherit;">Cpu<wbr>Utilization</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cpuutilization">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Cpu<wbr>Utilization</a></span>
    </dt>
...
<a href="#diskutilization_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Utilization</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskutilization">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Disk<wbr>Utilization</a></span>
    </dt>
...
<a href="#networkutilization_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Utilization</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkutilization">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Network<wbr>Utilization</a></span>
    </dt>
...
<a href="#requestutilization_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Utilization</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#requestutilization">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Request<wbr>Utilization</a></span>
    </dt>
...
<a href="#standardschedulersettings_csharp" style="color: inherit; text-decoration: inherit;">Standard<wbr>Scheduler<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#standardschedulersettings">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Standard<wbr>Scheduler<wbr>Settings</a></span>
    </dt>
...
<a href="#cloudbuildoptions_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Build<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudbuildoptions">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Cloud<wbr>Build<wbr>Options</a></span>
    </dt>
...
<a href="#container_csharp" style="color: inherit; text-decoration: inherit;">Container</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerinfo">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Container<wbr>Info</a></span>
    </dt>
...
<a href="#zip_csharp" style="color: inherit; text-decoration: inherit;">Zip</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#zipinfo">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Zip<wbr>Info</a></span>
    </dt>
...
<a href="#rolloutstrategy_csharp" style="color: inherit; text-decoration: inherit;">Rollout<wbr>Strategy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointsapiservicerolloutstrategy">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Endpoints<wbr>Api<wbr>Service<wbr>Rollout<wbr>Strategy</a></span>
    </dt>
...
<a href="#errorcode_csharp" style="color: inherit; text-decoration: inherit;">Error<wbr>Code</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#errorhandlererrorcode">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Error<wbr>Handler<wbr>Error<wbr>Code</a></span>
    </dt>
...
<a href="#volumes_csharp" style="color: inherit; text-decoration: inherit;">Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volume">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Volume&gt;</a></span>
    </dt>
...
<a href="#apiendpoint_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiendpointhandler">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Api<wbr>Endpoint<wbr>Handler</a></span>
    </dt>
...
<a href="#authfailaction_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Fail<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmapauthfailaction">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Url<wbr>Map<wbr>Auth<wbr>Fail<wbr>Action</a></span>
    </dt>
    <dd>{{% md %}}Action to take when users access resources that require authentication. Defaults to redirect.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="login_csharp">
<a href="#login_csharp" style="color: inherit; text-decoration: inherit;">Login</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmaplogin">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Url<wbr>Map<wbr>Login</a></span>
    </dt>
...
<a href="#redirecthttpresponsecode_csharp" style="color: inherit; text-decoration: inherit;">Redirect<wbr>Http<wbr>Response<wbr>Code</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmapredirecthttpresponsecode">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Url<wbr>Map<wbr>Redirect<wbr>Http<wbr>Response<wbr>Code</a></span>
    </dt>
...
<a href="#script_csharp" style="color: inherit; text-decoration: inherit;">Script</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scripthandler">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Script<wbr>Handler</a></span>
    </dt>
...
<a href="#securitylevel_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Level</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#urlmapsecuritylevel">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Url<wbr>Map<wbr>Security<wbr>Level</a></span>
    </dt>
    <dd>{{% md %}}Security (HTTPS) enforcement for this URL.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#staticfiles_csharp" style="color: inherit; text-decoration: inherit;">Static<wbr>Files</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticfileshandler">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Inputs.<wbr>Static<wbr>Files<wbr>Handler</a></span>
    </dt>
...
<a href="#egresssetting_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>Setting</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpcaccessconnectoregresssetting">Pulumi.<wbr>Google<wbr>Native.<wbr>App<wbr>Engine.<wbr>V1.<wbr>Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting</a></span>
    </dt>
    <dd>{{% md %}}The egress setting for the connector, controlling what traffic is diverted through it.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#egresssetting_go" style="color: inherit; text-decoration: inherit;">Egress<wbr>Setting</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpcaccessconnectoregresssetting">Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting</a></span>
    </dt>
    <dd>{{% md %}}The egress setting for the connector, controlling what traffic is diverted through it.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_go">
...
<h4 id="vpcaccessconnectoregresssetting">Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Egress<wbr>Setting<wbr>Unspecified</dt>
    <dd>EGRESS_SETTING_UNSPECIFIED</dd><dt>All<wbr>Traffic</dt>
    <dd>ALL_TRAFFIC{{% md %}}Force the use of VPC Access for all egress traffic from the function.{{% /md %}}</dd><dt>Private<wbr>Ip<wbr>Ranges</dt>
    <dd>PRIVATE_IP_RANGES{{% md %}}Use the VPC Access Connector for private IP space from RFC1918.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting<wbr>Egress<wbr>Setting<wbr>Unspecified</dt>
    <dd>EGRESS_SETTING_UNSPECIFIED</dd><dt>Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting<wbr>All<wbr>Traffic</dt>
    <dd>ALL_TRAFFIC{{% md %}}Force the use of VPC Access for all egress traffic from the function.{{% /md %}}</dd><dt>Vpc<wbr>Access<wbr>Connector<wbr>Egress<wbr>Setting<wbr>Private<wbr>Ip<wbr>Ranges</dt>
    <dd>PRIVATE_IP_RANGES{{% md %}}Use the VPC Access Connector for private IP space from RFC1918.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>EGRESS_SETTING_UNSPECIFIED</dt>
    <dd>EGRESS_SETTING_UNSPECIFIED</dd><dt>ALL_TRAFFIC</dt>
    <dd>ALL_TRAFFIC{{% md %}}Force the use of VPC Access for all egress traffic from the function.{{% /md %}}</dd><dt>PRIVATE_IP_RANGES</dt>
    <dd>PRIVATE_IP_RANGES{{% md %}}Use the VPC Access Connector for private IP space from RFC1918.{{% /md %}}</dd></dl>
{{% /choosable %}}
