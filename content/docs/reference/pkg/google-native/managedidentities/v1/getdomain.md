...
---
title: "getDomain"
title_tag: "google-native.managedidentities/v1.getDomain"
meta_desc: "Documentation for the google-native.managedidentities/v1.getDomain function with examples, input properties, output properties, and supporting types."
---
...
<a href="#authorizednetworks_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Networks</a>
    ...
    <dd>{{% md %}}Optional. The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) the domain instance is connected to. Networks can be added using UpdateDomain. The domain is only available on networks listed in `authorized_networks`. If CIDR subnets overlap between networks, domain creation will fail.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. Resource labels that can contain user-provided metadata.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#locations_csharp" style="color: inherit; text-decoration: inherit;">Locations</a>
    ...
    <dd>{{% md %}}Required. Locations where domain needs to be provisioned. regions e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. The unique name of the domain using the form: `projects/{project_id}/locations/global/domains/{domain_name}`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#reservediprange_csharp" style="color: inherit; text-decoration: inherit;">Reserved<wbr>Ip<wbr>Range</a>
    ...
    <dd>{{% md %}}Required. The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger. Ranges must be unique and non-overlapping with existing subnets in [Domain].[authorized_networks].{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetdnsipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Dns<wbr>Ip<wbr>Addresses</a>
    ...
    <dd>{{% md %}}Required. The target DNS server IP addresses which can resolve the remote domain involved in the trust.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#targetdomainname_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. The fully qualified target domain name which will be in trust with the current domain.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#trustdirection_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Direction</a>
    ...
    <dd>{{% md %}}Required. The trust direction, which decides if the current domain is trusted, trusting, or both.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#trusthandshakesecret_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Handshake<wbr>Secret</a>
    ...
    <dd>{{% md %}}Required. The trust secret used for the handshake with the target domain. This will not be stored.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#trusttype_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Type</a>
    ...
    <dd>{{% md %}}Required. The type of trust represented by the trust resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="updatetime_csharp">
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
</span>
