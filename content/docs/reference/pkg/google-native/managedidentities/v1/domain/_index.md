...
---
title: "Domain"
title_tag: "google-native.managedidentities/v1.Domain"
meta_desc: "Documentation for the google-native.managedidentities/v1.Domain resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#authorizednetworks_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Networks</a>
    ...
    <dd>{{% md %}}Optional. The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) the domain instance is connected to. Networks can be added using UpdateDomain. The domain is only available on networks listed in `authorized_networks`. If CIDR subnets overlap between networks, domain creation will fail.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd>{{% md %}}The fully-qualified domain name of the exposed domain used by clients to connect to the service. Similar to what would be chosen for an Active Directory set up on an internal network.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#trusts_csharp" style="color: inherit; text-decoration: inherit;">Trusts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#trustresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Managedidentities.<wbr>V1.<wbr>Outputs.<wbr>Trust<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
    ...
    <dd>{{% md %}}The last update time.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#createtime_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Time</a>
    ...
    <dd>{{% md %}}The time the instance was created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="lasttrustheartbeattime_csharp">
<a href="#lasttrustheartbeattime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Trust<wbr>Heartbeat<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#selectiveauthentication_csharp" style="color: inherit; text-decoration: inherit;">Selective<wbr>Authentication</a>
    ...
    <dd>{{% md %}}Optional. The trust authentication type, which decides whether the trusted side has forest/domain wide access or selective access to an approved set of resources.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
</span>
    ...
    <dd>{{% md %}}The current state of the trust.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#statedescription_csharp" style="color: inherit; text-decoration: inherit;">State<wbr>Description</a>
    ...
    <dd>{{% md %}}Additional information about the current state of the trust, if available.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#targetdnsipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Dns<wbr>Ip<wbr>Addresses</a>
    ...
    <dd>{{% md %}}The target DNS server IP addresses which can resolve the remote domain involved in the trust.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#targetdomainname_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}The fully qualified target domain name which will be in trust with the current domain.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#trustdirection_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Direction</a>
    ...
    <dd>{{% md %}}The trust direction, which decides if the current domain is trusted, trusting, or both.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#trusthandshakesecret_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Handshake<wbr>Secret</a>
    ...
    <dd>{{% md %}}The trust secret used for the handshake with the target domain. This will not be stored.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#createtime_go" style="color: inherit; text-decoration: inherit;">Create<wbr>Time</a>
    ...
    <dd>{{% md %}}The time the instance was created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="lasttrustheartbeattime_go">
<a href="#lasttrustheartbeattime_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Trust<wbr>Heartbeat<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#createtime_nodejs" style="color: inherit; text-decoration: inherit;">create<wbr>Time</a>
    ...
    <dd>{{% md %}}The time the instance was created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="lasttrustheartbeattime_nodejs">
<a href="#lasttrustheartbeattime_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Trust<wbr>Heartbeat<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#create_time_python" style="color: inherit; text-decoration: inherit;">create_<wbr>time</a>
    ...
    <dd>{{% md %}}The time the instance was created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="last_trust_heartbeat_time_python">
<a href="#last_trust_heartbeat_time_python" style="color: inherit; text-decoration: inherit;">last_<wbr>trust_<wbr>heartbeat_<wbr>time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
