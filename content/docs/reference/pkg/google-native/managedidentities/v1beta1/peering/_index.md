...
---
title: "Peering"
title_tag: "google-native.managedidentities/v1beta1.Peering"
meta_desc: "Documentation for the google-native.managedidentities/v1beta1.Peering resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Peering</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">domain_resource</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#authorizednetwork_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Network</a>
    ...
    <dd>{{% md %}}The full names of the Google Compute Engine [networks](/compute/docs/networks-and-firewalls#networks) to which the instance is connected. Caller needs to make sure that CIDR subnets do not overlap between networks, else peering creation will fail.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#domainresource_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Resource</a>
    ...
    <dd>{{% md %}}Full domain resource path for the Managed AD Domain involved in peering. The resource path should be in the form: `projects/{project_id}/locations/global/domains/{domain_name}`{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. Resource labels to represent user provided metadata.{{% /md %}}</dd></dl>
{{% /choosable %}}
