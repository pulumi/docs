...
---
title: "getDomain"
title_tag: "google-native.managedidentities/v1beta1.getDomain"
meta_desc: "Documentation for the google-native.managedidentities/v1beta1.getDomain function with examples, input properties, output properties, and supporting types."
---
...
<a href="#locations_csharp" style="color: inherit; text-decoration: inherit;">Locations</a>
    ...
    <dd>{{% md %}}Locations where domain needs to be provisioned. regions e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The unique name of the domain using the form: `projects/{project_id}/locations/global/domains/{domain_name}`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#reservediprange_csharp" style="color: inherit; text-decoration: inherit;">Reserved<wbr>Ip<wbr>Range</a>
    ...
    <dd>{{% md %}}The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger. Ranges must be unique and non-overlapping with existing subnets in [Domain].[authorized_networks].{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trusts_csharp" style="color: inherit; text-decoration: inherit;">Trusts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#trustresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Managedidentities.<wbr>V1Beta1.<wbr>Outputs.<wbr>Trust<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#selectiveauthentication_csharp" style="color: inherit; text-decoration: inherit;">Selective<wbr>Authentication</a>
    ...
    <dd>{{% md %}}The trust authentication type, which decides whether the trusted side has forest/domain wide access or selective access to an approved set of resources.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
</span>
...
<a href="#trusthandshakesecret_csharp" style="color: inherit; text-decoration: inherit;">Trust<wbr>Handshake<wbr>Secret</a>
    ...
    <dd>{{% md %}}Input only. The trust secret used for the handshake with the target domain. It will not be stored.{{% /md %}}</dd><dt class="property-required"
            title="Required">
