...
<a href="#latestoperationname_csharp" style="color: inherit; text-decoration: inherit;">Latest<wbr>Operation<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the most recently started TransferOperation of this JobConfig. Present if and only if at least one TransferOperation has been created for this JobConfig.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#notificationconfig_csharp" style="color: inherit; text-decoration: inherit;">Notification<wbr>Config</a>
    ...
    <dd>{{% md %}}Notification configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
    ...
    <dd>{{% md %}}Specifies schedule for the transfer job. This is an optional field. When the field is not set, the job will never execute a transfer, unless you invoke RunTransferJob or update the job to have a non-empty schedule.{{% /md %}}</dd><dt class="property-"
            title="">
