...
<a href="#additionalgroupkeys_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Group<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#entitykeyresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Identity.<wbr>V1Beta1.<wbr>Outputs.<wbr>Entity<wbr>Key<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Additional entity key aliases for a Group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dynamicgroupmetadata_csharp" style="color: inherit; text-decoration: inherit;">Dynamic<wbr>Group<wbr>Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dynamicgroupmetadataresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Identity.<wbr>V1Beta1.<wbr>Outputs.<wbr>Dynamic<wbr>Group<wbr>Metadata<wbr>Response</a></span>
    </dt>
...
<a href="#groupkey_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Key</a>
    ...
    <dd>{{% md %}}Required. Immutable. The `EntityKey` of the `Group`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#parent_csharp" style="color: inherit; text-decoration: inherit;">Parent</a>
    ...
    <dd>{{% md %}}Required. Immutable. The resource name of the entity under which this `Group` resides in the Cloud Identity resource hierarchy. Must be of the form `identitysources/{identity_source_id}` for external- identity-mapped groups or `customers/{customer_id}` for Google Groups.{{% /md %}}</dd><dt class="property-"
            title="">
