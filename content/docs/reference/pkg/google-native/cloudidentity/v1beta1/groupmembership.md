...
<span class="k">def </span><span class="nx">GroupMembership</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">member_key</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudidentity_v1beta1.EntityKeyArgs]]</span> = None<span class="p">,</span>
                    <span class="nx">memberships_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                    <span class="nx">preferred_member_key</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudidentity_v1beta1.EntityKeyArgs]]</span> = None<span class="p">,</span>
                    <span class="nx">roles</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_cloudidentity_v1beta1.MembershipRoleArgs]]]]</span> = None<span class="p">)</span>
