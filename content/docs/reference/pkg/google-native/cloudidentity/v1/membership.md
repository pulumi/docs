...
<span class="k">def </span><span class="nx">Membership</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">preferred_member_key</span><span class="p">:</span> <span class="nx">Optional[_cloudidentity_v1.EntityKeyArgs]</span> = None<span class="p">,</span>
               <span class="nx">roles</span><span class="p">:</span> <span class="nx">Optional[Sequence[_cloudidentity_v1.MembershipRoleArgs]]</span> = None<span class="p">)</span>
...
<a href="#preferredmemberkey_csharp" style="color: inherit; text-decoration: inherit;">Preferred<wbr>Member<wbr>Key</a>
    ...
    <dd>{{% md %}}Required. Immutable. The `EntityKey` of the member.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#expirydetail_csharp" style="color: inherit; text-decoration: inherit;">Expiry<wbr>Detail</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expirydetail">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Identity.<wbr>V1.<wbr>Inputs.<wbr>Expiry<wbr>Detail<wbr>Args</a></span>
    </dt>
...
<a href="#expirydetail_csharp" style="color: inherit; text-decoration: inherit;">Expiry<wbr>Detail</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expirydetailresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Identity.<wbr>V1.<wbr>Inputs.<wbr>Expiry<wbr>Detail<wbr>Response<wbr>Args</a></span>
    </dt>
