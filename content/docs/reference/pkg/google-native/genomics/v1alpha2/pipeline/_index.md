...
---
title: "Pipeline"
title_tag: "google-native.genomics/v1alpha2.Pipeline"
meta_desc: "Documentation for the google-native.genomics/v1alpha2.Pipeline resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Pipeline</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">docker</span><span class="p">:</span> <span class="nx">Optional[DockerExecutorArgs]</span> = None<span class="p">,</span>
             <span class="nx">input_parameters</span><span class="p">:</span> <span class="nx">Optional[Sequence[PipelineParameterArgs]]</span> = None<span class="p">,</span>
             <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">output_parameters</span><span class="p">:</span> <span class="nx">Optional[Sequence[PipelineParameterArgs]]</span> = None<span class="p">,</span>
             ...
             <span class="nx">resources</span><span class="p">:</span> <span class="nx">Optional[PipelineResourcesArgs]</span> = None<span class="p">)</span>
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}The project in which to create the pipeline. The caller must have WRITE access.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resources_csharp">
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineresources">Pulumi.<wbr>Google<wbr>Native.<wbr>Genomics.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Pipeline<wbr>Resources<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies resource requirements for the pipeline run. Required fields: * minimumCpuCores * minimumRamGb{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#docker_csharp" style="color: inherit; text-decoration: inherit;">Docker</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dockerexecutor">Pulumi.<wbr>Google<wbr>Native.<wbr>Genomics.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Docker<wbr>Executor<wbr>Args</a></span>
    </dt>
...
<a href="#inputparameters_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineparameter">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Genomics.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Pipeline<wbr>Parameter<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}A user specified pipeline name that does not have to be unique. This name can be used for filtering Pipelines in ListPipelines.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pipelineid_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Id</a>
    ...
    <dd>{{% md %}}Unique pipeline id that is generated by the service when CreatePipeline is called. Cannot be specified in the Pipeline used in the CreatePipelineRequest, and will be populated in the response to CreatePipeline and all subsequent Get and List calls. Indicates that the service has registered this pipeline.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#input_parameters_python" style="color: inherit; text-decoration: inherit;">input_<wbr>parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineparameter">Sequence[Pipeline<wbr>Parameter<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Input parameters of the pipeline.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_python">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the disk that can be used in the pipeline parameters. Must be 1 - 63 characters. The name "boot" is reserved for system use.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the disk to create.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>{{% md %}}The full or partial URL of the persistent disk to attach. See https://cloud.google.com/compute/docs/reference/latest/instances#resource and https://cloud.google.com/compute/docs/disks/persistent-disks#snapshots for more details.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the disk to create.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cmd_csharp" style="color: inherit; text-decoration: inherit;">Cmd</a>
    ...
    <dd>{{% md %}}The command or newline delimited script to run. The command string will be executed within a bash shell. If the command exits with a non-zero exit code, output parameter de-localization will be skipped and the pipeline operation's `error` field will be populated. Maximum command string length is 16384.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#imagename_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Name</a>
    ...
    <dd>{{% md %}}Image name from either Docker Hub or Google Container Registry. Users that run pipelines must have READ access to the image.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="localcopy">Local<wbr>Copy</h4>
...
<a href="#disk_csharp" style="color: inherit; text-decoration: inherit;">Disk</a>
    ...
    <dd>{{% md %}}The name of the disk where this parameter is located. Can be the name of one of the disks specified in the Resources field, or "boot", which represents the Docker instance's boot disk and has a mount point of `/`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="path_csharp">
<a href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd>{{% md %}}The path within the user's docker container where this input should be localized to and from, relative to the specified disk's mount point. For example: file.txt,{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="pipelineparameter">Pipeline<wbr>Parameter</h4>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the parameter - the pipeline runner uses this string as the key to the input and output maps in RunPipeline.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#localcopy_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Copy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localcopy">Pulumi.<wbr>Google<wbr>Native.<wbr>Genomics.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Local<wbr>Copy</a></span>
    </dt>
    <dd>{{% md %}}If present, this parameter is marked for copying to and from the VM. `LocalCopy` indicates where on the VM the file should be. The value given to this parameter (either at runtime or using `defaultValue`) must be the remote path where the file should be.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#localcopy_go" style="color: inherit; text-decoration: inherit;">Local<wbr>Copy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localcopy">Local<wbr>Copy</a></span>
    </dt>
    <dd>{{% md %}}If present, this parameter is marked for copying to and from the VM. `LocalCopy` indicates where on the VM the file should be. The value given to this parameter (either at runtime or using `defaultValue`) must be the remote path where the file should be.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the parameter - the pipeline runner uses this string as the key to the input and output maps in RunPipeline.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="pipelineresources">Pipeline<wbr>Resources</h4>
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#disk">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Genomics.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Disk&gt;</a></span>
    </dt>
