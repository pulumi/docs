...
<span class="k">def </span><span class="nx">JobTemplate</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_transcoder_v1beta1.JobConfigArgs]]</span> = None<span class="p">,</span>
                <span class="nx">job_templates_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
