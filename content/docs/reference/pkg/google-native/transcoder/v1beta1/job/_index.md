...
---
title: "Job"
title_tag: "google-native.transcoder/v1beta1.Job"
meta_desc: "Documentation for the google-native.transcoder/v1beta1.Job resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The current state of the job.{{% /md %}}</dd></dl>
{{% /choosable %}}
