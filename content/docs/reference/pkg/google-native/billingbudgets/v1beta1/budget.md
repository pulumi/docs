...
<a href="#allupdatesrule_go" style="color: inherit; text-decoration: inherit;">All<wbr>Updates<wbr>Rule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudbillingbudgetsv1beta1allupdatesrule">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1All<wbr>Updates<wbr>Rule</a></span>
    </dt>
    <dd>{{% md %}}Optional. Rules to apply to notifications sent based on budget spend and thresholds.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="amount_go">
<a href="#amount_go" style="color: inherit; text-decoration: inherit;">Amount</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudbillingbudgetsv1beta1budgetamount">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Budget<wbr>Amount</a></span>
    </dt>
    <dd>{{% md %}}Required. Budgeted amount.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#thresholdrules_go" style="color: inherit; text-decoration: inherit;">Threshold<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudbillingbudgetsv1beta1thresholdrule">[]Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Threshold<wbr>Rule</a></span>
    </dt>
    <dd>{{% md %}}Optional. Rules that trigger alerts (notifications of thresholds being crossed) when spend exceeds the specified percentages of the budget.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="googlecloudbillingbudgetsv1beta1allupdatesruleresponse">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1All<wbr>Updates<wbr>Rule<wbr>Response</h4>
...
<h4 id="googlecloudbillingbudgetsv1beta1budgetamount">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Budget<wbr>Amount</h4>
...
<a href="#specifiedamount_csharp" style="color: inherit; text-decoration: inherit;">Specified<wbr>Amount</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypemoney">Pulumi.<wbr>Google<wbr>Native.<wbr>Billingbudgets.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Money<wbr>Args</a></span>
    </dt>
...
<h4 id="googlecloudbillingbudgetsv1beta1budgetamountresponse">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Budget<wbr>Amount<wbr>Response</h4>
...
<a href="#specifiedamount_csharp" style="color: inherit; text-decoration: inherit;">Specified<wbr>Amount</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypemoneyresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Billingbudgets.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Money<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}A specified amount to use as the budget. `currency_code` is optional. If specified when creating a budget, it must match the currency of the billing account. If specified when updating a budget, it must match the currency_code of the existing budget. The `currency_code` is provided on output.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="googlecloudbillingbudgetsv1beta1customperiod">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Custom<wbr>Period</h4>
...
<a href="#enddate_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypedate">Pulumi.<wbr>Google<wbr>Native.<wbr>Billingbudgets.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Date<wbr>Args</a></span>
    </dt>
...
<a href="#enddate_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypedateresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Billingbudgets.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Date<wbr>Response<wbr>Args</a></span>
    </dt>
...
<h4 id="googlecloudbillingbudgetsv1beta1thresholdrule">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Threshold<wbr>Rule</h4>
...
<h4 id="googlecloudbillingbudgetsv1beta1thresholdruleresponse">Google<wbr>Cloud<wbr>Billing<wbr>Budgets<wbr>V1beta1Threshold<wbr>Rule<wbr>Response</h4>
