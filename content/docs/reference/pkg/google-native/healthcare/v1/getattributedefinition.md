...
<a href="#allowedvalues_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Values</a>
    ...
    <dd>{{% md %}}Required. Possible values for the attribute. The number of allowed values must not exceed 100. An empty list is invalid. The list can only be expanded after creation.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#category_csharp" style="color: inherit; text-decoration: inherit;">Category</a>
    ...
    <dd>{{% md %}}Required. The category of the attribute. The value of this field cannot be changed after creation.{{% /md %}}</dd><dt class="property-"
            title="">
