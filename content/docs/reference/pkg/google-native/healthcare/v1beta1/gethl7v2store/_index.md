...
<a href="#notificationconfig_csharp" style="color: inherit; text-decoration: inherit;">Notification<wbr>Config</a>
    ...
    <dd>{{% md %}}The notification destination all messages (both Ingest & Create) are published on. Only the message name is sent as part of the notification. If this is unset, no notifications are sent. Supplied by the client.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#notificationconfigs_csharp" style="color: inherit; text-decoration: inherit;">Notification<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hl7v2notificationconfigresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Outputs.<wbr>Hl7V2Notification<wbr>Config<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#parserconfig_csharp" style="color: inherit; text-decoration: inherit;">Parser<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#parserconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Outputs.<wbr>Parser<wbr>Config<wbr>Response</a></span>
    </dt>
