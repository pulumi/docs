...
<a href="#policies_go" style="color: inherit; text-decoration: inherit;">Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudhealthcarev1beta1consentpolicy">[]Google<wbr>Cloud<wbr>Healthcare<wbr>V1beta1Consent<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}Optional. Represents a user's consent in terms of the resources that can be accessed and under what conditions.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_go">
...
<a href="#resourceattributes_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attributeresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Inputs.<wbr>Attribute<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}The resources that this policy applies to. A resource is a match if it matches all the attributes listed here. If empty, this policy applies to all User data mappings for the given user.{{% /md %}}</dd></dl>
{{% /choosable %}}
