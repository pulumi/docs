...
<span class="k">def </span><span class="nx">BucketObject</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">acl</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_storage_v1.ObjectAccessControlArgs]]]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">component_count</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">custom_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 <span class="nx">customer_encryption</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_storage_v1.ObjectCustomerEncryptionArgs]]</span> = None<span class="p">,</span>
                 <span class="nx">etag</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 <span class="nx">event_based_hold</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">md5_hash</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">owner</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_storage_v1.ObjectOwnerArgs]]</span> = None<span class="p">,</span>
                 <span class="nx">retention_expiration_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">temporary_hold</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                 <span class="nx">time_created</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 <span class="nx">time_deleted</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                 <span class="nx">time_storage_class_updated</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#customerencryption_nodejs" style="color: inherit; text-decoration: inherit;">customer<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectcustomerencryption">pulumi.<wbr>Input<Object<wbr>Customer<wbr>Encryption<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Metadata of customer-supplied encryption key, if the object is encrypted by such a key.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="etag_nodejs">
...
<a href="#owner_nodejs" style="color: inherit; text-decoration: inherit;">owner</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectowner">pulumi.<wbr>Input<Object<wbr>Owner<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The owner of the object. This will always be the uploader of the object.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
