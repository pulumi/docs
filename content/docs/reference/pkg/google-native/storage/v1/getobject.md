...
---
title: "getObject"
title_tag: "google-native.storage/v1.getObject"
meta_desc: "Documentation for the google-native.storage/v1.getObject function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getObject<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetObjectArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetObjectResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_object(</span><span class="nx">bucket</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
               ...
               <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetObjectResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetObject<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetObjectArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetObjectResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetObject </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetObjectResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetObjectArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#acl_csharp" style="color: inherit; text-decoration: inherit;">Acl</a>
    ...
    <dd>{{% md %}}Access controls on the object.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bucket_csharp">
<a href="#bucket_csharp" style="color: inherit; text-decoration: inherit;">Bucket</a>
</span>
    ...
    <dd>{{% md %}}The name of the bucket containing this object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#cachecontrol_csharp" style="color: inherit; text-decoration: inherit;">Cache<wbr>Control</a>
    ...
    <dd>{{% md %}}Cache-Control directive for the object data. If omitted, and the object is accessible to all anonymous users, the default will be public, max-age=3600.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#componentcount_csharp" style="color: inherit; text-decoration: inherit;">Component<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of underlying components that make up this object. Components are accumulated by compose operations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#contentdisposition_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Disposition</a>
    ...
    <dd>{{% md %}}Content-Disposition of the object data.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#contentencoding_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Encoding</a>
    ...
    <dd>{{% md %}}Content-Encoding of the object data.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#contentlanguage_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Language</a>
    ...
    <dd>{{% md %}}Content-Language of the object data.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#contenttype_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Type</a>
    ...
    <dd>{{% md %}}Content-Type of the object data. If an object is stored without a Content-Type, it is served as application/octet-stream.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#crc32c_csharp" style="color: inherit; text-decoration: inherit;">Crc32c</a>
    ...
    <dd>{{% md %}}CRC32c checksum, as described in RFC 4960, Appendix B; encoded using base64 in big-endian byte order. For more information about using the CRC32c checksum, see Hashes and ETags: Best Practices.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customtime_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Time</a>
    ...
    <dd>{{% md %}}A timestamp in RFC 3339 format specified by the user for an object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customerencryption_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectcustomerencryptionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage.<wbr>V1.<wbr>Outputs.<wbr>Object<wbr>Customer<wbr>Encryption<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Metadata of customer-supplied encryption key, if the object is encrypted by such a key.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}HTTP 1.1 Entity tag for the object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#generation_csharp" style="color: inherit; text-decoration: inherit;">Generation</a>
    ...
    <dd>{{% md %}}The content generation of this object. Used for object versioning.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}The kind of item this is. For objects, this is always storage#object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kmskeyname_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Name</a>
    ...
    <dd>{{% md %}}Not currently supported. Specifying the parameter causes the request to fail with status code 400 - Bad Request.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#md5hash_csharp" style="color: inherit; text-decoration: inherit;">Md5Hash</a>
    ...
    <dd>{{% md %}}MD5 hash of the data; encoded using base64. For more information about using the MD5 hash, see Hashes and ETags: Best Practices.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#medialink_csharp" style="color: inherit; text-decoration: inherit;">Media<wbr>Link</a>
    ...
    <dd>{{% md %}}Media download link.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
    ...
    <dd>{{% md %}}User-provided metadata, in key/value pairs.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#metageneration_csharp" style="color: inherit; text-decoration: inherit;">Metageneration</a>
    ...
    <dd>{{% md %}}The version of the metadata for this object at this generation. Used for preconditions and for detecting changes in metadata. A metageneration number is only meaningful in the context of a particular generation of a particular object.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the object. Required if not specified by URL parameter.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="owner_csharp">
<a href="#owner_csharp" style="color: inherit; text-decoration: inherit;">Owner</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectownerresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage.<wbr>V1.<wbr>Outputs.<wbr>Object<wbr>Owner<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The owner of the object. This will always be the uploader of the object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#retentionexpirationtime_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Expiration<wbr>Time</a>
    ...
    <dd>{{% md %}}A server-determined value that specifies the earliest time that the object's retention period expires. This value is in RFC 3339 format. Note 1: This field is not provided for objects with an active event-based hold, since retention expiration is unknown until the hold is removed. Note 2: This value can be provided even when temporary hold is set (so that the user can reason about policy without having to first unset the temporary hold).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}The link to this object.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="size_csharp">
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}Content-Length of the data in bytes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageclass_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Class</a>
    ...
    <dd>{{% md %}}Storage class of the object.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#timecreated_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Created</a>
    ...
    <dd>{{% md %}}The creation time of the object in RFC 3339 format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#timedeleted_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Deleted</a>
    ...
    <dd>{{% md %}}The deletion time of the object in RFC 3339 format. Will be returned if and only if this version of the object has been deleted.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#timestorageclassupdated_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Storage<wbr>Class<wbr>Updated</a>
    ...
    <dd>{{% md %}}The time at which the object's storage class was last changed. When the object is initially created, it will be set to timeCreated.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customerencryption_go" style="color: inherit; text-decoration: inherit;">Customer<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectcustomerencryptionresponse">Object<wbr>Customer<wbr>Encryption<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Metadata of customer-supplied encryption key, if the object is encrypted by such a key.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_go">
...
<a href="#owner_go" style="color: inherit; text-decoration: inherit;">Owner</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectownerresponse">Object<wbr>Owner<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The owner of the object. This will always be the uploader of the object.{{% /md %}}</dd><dt class="property-"
            title="">
