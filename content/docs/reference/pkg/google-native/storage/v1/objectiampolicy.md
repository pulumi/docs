...
<span class="k">def </span><span class="nx">ObjectIamPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">bindings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_storage_v1.ObjectIamPolicyBindingsItemArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#bindings_go" style="color: inherit; text-decoration: inherit;">Bindings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectiampolicybindingsitem">[]Object<wbr>Iam<wbr>Policy<wbr>Bindings<wbr>Item</a></span>
    </dt>
    <dd>{{% md %}}An association between a role, which comes with a set of permissions, and members who may assume that role.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="etag_go">
...
<a href="#bindings_nodejs" style="color: inherit; text-decoration: inherit;">bindings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectiampolicybindingsitem">pulumi.<wbr>Input<pulumi.<wbr>Input<Object<wbr>Iam<wbr>Policy<wbr>Bindings<wbr>Item<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An association between a role, which comes with a set of permissions, and members who may assume that role.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="etag_nodejs">
