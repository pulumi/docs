...
---
title: "getInstance"
title_tag: "google-native.redis/v1.getInstance"
meta_desc: "Documentation for the google-native.redis/v1.getInstance function with examples, input properties, output properties, and supporting types."
---
...
<a href="#alternativelocationid_csharp" style="color: inherit; text-decoration: inherit;">Alternative<wbr>Location<wbr>Id</a>
    ...
    <dd>{{% md %}}Optional. Only applicable to STANDARD_HA tier which protects the instance against zonal failures by provisioning it across two zones. If provided, it must be a different zone from the one provided in location_id.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#authenabled_csharp" style="color: inherit; text-decoration: inherit;">Auth<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Optional. Indicates whether OSS Redis AUTH is enabled for the instance. If set to "true" AUTH is enabled on the instance. Default value is "false" meaning AUTH is disabled.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#authorizednetwork_csharp" style="color: inherit; text-decoration: inherit;">Authorized<wbr>Network</a>
    ...
    <dd>{{% md %}}Optional. The full name of the Google Compute Engine [network](https://cloud.google.com/vpc/docs/vpc) to which the instance is connected. If left unspecified, the `default` network will be used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connectmode_csharp" style="color: inherit; text-decoration: inherit;">Connect<wbr>Mode</a>
    ...
    <dd>{{% md %}}Optional. The network connect mode of the Redis instance. If not provided, the connect mode defaults to DIRECT_PEERING.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}An arbitrary and optional user-provided name for the instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="host_csharp">
...
<a href="#memorysizegb_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Size<wbr>Gb</a>
    ...
    <dd>{{% md %}}Required. Redis memory size in GiB.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#redisversion_csharp" style="color: inherit; text-decoration: inherit;">Redis<wbr>Version</a>
    ...
    <dd>{{% md %}}Optional. The version of Redis software. If not provided, latest supported version will be used. Currently, the supported values are: * `REDIS_3_2` for Redis 3.2 compatibility * `REDIS_4_0` for Redis 4.0 compatibility (default) * `REDIS_5_0` for Redis 5.0 compatibility * `REDIS_6_X` for Redis 6.x compatibility{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#statusmessage_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Message</a>
    ...
    <dd>{{% md %}}Additional information about the current status of this instance, if available.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tier_csharp">
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}Required. The service tier of the instance.{{% /md %}}</dd><dt class="property-"
            title="">
