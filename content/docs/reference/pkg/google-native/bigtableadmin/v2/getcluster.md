...
<a href="#servenodes_csharp" style="color: inherit; text-decoration: inherit;">Serve<wbr>Nodes</a>
    ...
    <dd>{{% md %}}Required. The number of nodes allocated to this cluster. More nodes enable higher throughput and more consistent performance.{{% /md %}}</dd><dt class="property-"
            title="">
