...
<span class="k">def </span><span class="nx">InstanceTableIamPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">audit_configs</span><span class="p">:</span> <span class="nx">Optional[Sequence[_bigtableadmin_v2.AuditConfigArgs]]</span> = None<span class="p">,</span>
                           <span class="nx">bindings</span><span class="p">:</span> <span class="nx">Optional[Sequence[_bigtableadmin_v2.BindingArgs]]</span> = None<span class="p">,</span>
...
<a href="#logtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#auditlogconfiglogtype">Pulumi.<wbr>Google<wbr>Native.<wbr>Bigtable<wbr>Admin.<wbr>V2.<wbr>Audit<wbr>Log<wbr>Config<wbr>Log<wbr>Type</a></span>
    </dt>
