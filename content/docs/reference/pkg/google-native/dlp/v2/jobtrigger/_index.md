...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewJobTrigger</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">JobTriggerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">JobTrigger</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#manual_csharp" style="color: inherit; text-decoration: inherit;">Manual</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleprivacydlpv2manual">Pulumi.<wbr>Google<wbr>Native.<wbr>DLP.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Privacy<wbr>Dlp<wbr>V2Manual</a></span>
    </dt>
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleprivacydlpv2schedule">Pulumi.<wbr>Google<wbr>Native.<wbr>DLP.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Privacy<wbr>Dlp<wbr>V2Schedule</a></span>
    </dt>
...
<a href="#manual_csharp" style="color: inherit; text-decoration: inherit;">Manual</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleprivacydlpv2manualresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>DLP.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Privacy<wbr>Dlp<wbr>V2Manual<wbr>Response</a></span>
    </dt>
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleprivacydlpv2scheduleresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>DLP.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Privacy<wbr>Dlp<wbr>V2Schedule<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Create a job on a repeating basis based on the elapse of time.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="jobtriggerstatus">Job<wbr>Trigger<wbr>Status</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Status<wbr>Unspecified</dt>
    <dd>STATUS_UNSPECIFIED{{% md %}}Unused.{{% /md %}}</dd><dt>Healthy</dt>
    <dd>HEALTHY{{% md %}}Trigger is healthy.{{% /md %}}</dd><dt>Paused</dt>
    <dd>PAUSED{{% md %}}Trigger is temporarily paused.{{% /md %}}</dd><dt>Cancelled</dt>
    <dd>CANCELLED{{% md %}}Trigger is cancelled and can not be resumed.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Job<wbr>Trigger<wbr>Status<wbr>Status<wbr>Unspecified</dt>
    <dd>STATUS_UNSPECIFIED{{% md %}}Unused.{{% /md %}}</dd><dt>Job<wbr>Trigger<wbr>Status<wbr>Healthy</dt>
    <dd>HEALTHY{{% md %}}Trigger is healthy.{{% /md %}}</dd><dt>Job<wbr>Trigger<wbr>Status<wbr>Paused</dt>
    <dd>PAUSED{{% md %}}Trigger is temporarily paused.{{% /md %}}</dd><dt>Job<wbr>Trigger<wbr>Status<wbr>Cancelled</dt>
    <dd>CANCELLED{{% md %}}Trigger is cancelled and can not be resumed.{{% /md %}}</dd></dl>
{{% /choosable %}}
