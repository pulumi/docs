...
title_tag: "google-native.orgpolicy/v2.getOrganizationPolicy"
meta_desc: "Documentation for the google-native.orgpolicy/v2.getOrganizationPolicy function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_organization_policy(</span><span class="nx">organization_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
