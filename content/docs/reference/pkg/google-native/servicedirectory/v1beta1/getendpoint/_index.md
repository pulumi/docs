...
---
title: "getEndpoint"
title_tag: "google-native.servicedirectory/v1beta1.getEndpoint"
meta_desc: "Documentation for the google-native.servicedirectory/v1beta1.getEndpoint function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_endpoint(</span><span class="nx">endpoint_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#address_csharp" style="color: inherit; text-decoration: inherit;">Address</a>
    ...
    <dd>{{% md %}}Optional. An IPv4 or IPv6 address. Service Directory rejects bad addresses like: * `8.8.8` * `8.8.8.8:53` * `test:bad:address` * `[::1]` * `[::1]:8080` Limited to 45 characters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Immutable. The resource name for the endpoint in the format `projects/*/locations/*/namespaces/*/services/*/endpoints/*`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}Optional. Service Directory rejects values outside of `[0, 65535]`.{{% /md %}}</dd><dt class="property-"
            title="">
