...
---
title: "getJob"
title_tag: "google-native.ml/v1.getJob"
meta_desc: "Documentation for the google-native.ml/v1.getJob function with examples, input properties, output properties, and supporting types."
---
...
<a href="#jobid_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Id</a>
    ...
    <dd>{{% md %}}Required. The user-specified id of the job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. One or more labels that you can add, to organize your jobs. Each label is a key-value pair, where both the key and the value are arbitrary strings that you supply. For more information, see the documentation on using labels.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#predictioninput_csharp" style="color: inherit; text-decoration: inherit;">Prediction<wbr>Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__predictioninputresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Ml.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Ml<wbr>V1__Prediction<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Input parameters to create a prediction job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#predictionoutput_csharp" style="color: inherit; text-decoration: inherit;">Prediction<wbr>Output</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__predictionoutputresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Ml.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Ml<wbr>V1__Prediction<wbr>Output<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The current prediction job result.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The detailed state of a job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="traininginput_csharp">
<a href="#traininginput_csharp" style="color: inherit; text-decoration: inherit;">Training<wbr>Input</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__traininginputresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Ml.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Ml<wbr>V1__Training<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Input parameters to create a training job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trainingoutput_csharp" style="color: inherit; text-decoration: inherit;">Training<wbr>Output</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__trainingoutputresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Ml.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Ml<wbr>V1__Training<wbr>Output<wbr>Response</a></span>
    </dt>
...
<a href="#predictioninput_go" style="color: inherit; text-decoration: inherit;">Prediction<wbr>Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__predictioninputresponse">Google<wbr>Cloud<wbr>Ml<wbr>V1__Prediction<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Input parameters to create a prediction job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#predictionoutput_go" style="color: inherit; text-decoration: inherit;">Prediction<wbr>Output</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__predictionoutputresponse">Google<wbr>Cloud<wbr>Ml<wbr>V1__Prediction<wbr>Output<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The current prediction job result.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#traininginput_go" style="color: inherit; text-decoration: inherit;">Training<wbr>Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__traininginputresponse">Google<wbr>Cloud<wbr>Ml<wbr>V1__Training<wbr>Input<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Input parameters to create a training job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trainingoutput_go" style="color: inherit; text-decoration: inherit;">Training<wbr>Output</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudmlv1__trainingoutputresponse">Google<wbr>Cloud<wbr>Ml<wbr>V1__Training<wbr>Output<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The current training job result.{{% /md %}}</dd></dl>
{{% /choosable %}}
