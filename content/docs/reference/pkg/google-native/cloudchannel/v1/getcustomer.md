...
<a href="#domain_csharp" style="color: inherit; text-decoration: inherit;">Domain</a>
    ...
    <dd>{{% md %}}Required. Primary domain used by the customer. Domain of primary contact email is required to be same as the provided domain.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#orgdisplayname_csharp" style="color: inherit; text-decoration: inherit;">Org<wbr>Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. Name of the organization that the customer entity represents.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#orgpostaladdress_csharp" style="color: inherit; text-decoration: inherit;">Org<wbr>Postal<wbr>Address</a>
    ...
    <dd>{{% md %}}Required. Address of the organization of the customer entity. Region and zip codes are required to enforce US laws and embargoes. Valid address lines are required for all customers. Language code is discarded. Use the Customer-level language code to set the customer's language.{{% /md %}}</dd><dt class="property-"
            title="">
