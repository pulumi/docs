...
---
title: "Customer"
title_tag: "google-native.cloudchannel/v1.Customer"
...
## Create a Customer Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Customer</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CustomerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">Customer</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">org_postal_address</span><span class="p">:</span> <span class="nx">Optional[GoogleTypePostalAddressArgs]</span> = None<span class="p">,</span>
             <span class="nx">primary_contact_info</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudChannelV1ContactInfoArgs]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">Customer</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CustomerArgs</a></span><span class="p">,</span>
             <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewCustomer</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">CustomerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Customer</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Customer</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CustomerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">CustomerArgs</a></span>
    </dt>
...
## Customer Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Programming Model docs.

### Inputs

The Customer resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#domain_csharp" style="color: inherit; text-decoration: inherit;">Domain</a>
    ...
    <dd>{{% md %}}The customer's primary domain. Must match the primary contact email's domain.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#orgdisplayname_csharp" style="color: inherit; text-decoration: inherit;">Org<wbr>Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the organization that the customer entity represents.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#orgpostaladdress_csharp" style="color: inherit; text-decoration: inherit;">Org<wbr>Postal<wbr>Address</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypepostaladdress">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Postal<wbr>Address<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The organization address for the customer. To enforce US laws and embargoes, we require a region and zip code. You must provide valid addresses for every customer. To set the customer's language, use the Customer-level language code.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#alternateemail_csharp" style="color: inherit; text-decoration: inherit;">Alternate<wbr>Email</a>
    ...
    <dd>{{% md %}}Secondary contact email. You need to provide an alternate email to create different domains if a primary contact email already exists. Users will receive a notification with credentials when you create an admin.google.com account. Secondary emails are also recovery email addresses. Alternate emails are optional when you create Team customers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#primarycontactinfo_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Contact<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1contactinfo">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Contact<wbr>Info<wbr>Args</a></span>
    </dt>
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the Customer resource produces the following output properties:
...
<a href="#email_csharp" style="color: inherit; text-decoration: inherit;">Email</a>
    ...
    <dd>{{% md %}}The customer account's contact email. Required for entitlements that create admin.google.com accounts, and serves as the customer's username for those accounts. Use this email to invite Team customers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#firstname_csharp" style="color: inherit; text-decoration: inherit;">First<wbr>Name</a>
    ...
    <dd>{{% md %}}The customer account contact's first name. Optional for Team customers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastname_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Name</a>
    ...
    <dd>{{% md %}}The customer account contact's last name. Optional for Team customers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#phone_csharp" style="color: inherit; text-decoration: inherit;">Phone</a>
    ...
    <dd>{{% md %}}The customer account's contact phone number.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
