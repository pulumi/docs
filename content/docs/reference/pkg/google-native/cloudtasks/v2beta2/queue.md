...
<span class="k">def </span><span class="nx">Queue</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">app_engine_http_target</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudtasks_v2beta2.AppEngineHttpTargetArgs]]</span> = None<span class="p">,</span>
          ...
          <span class="nx">pull_target</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudtasks_v2beta2.PullTargetArgs]]</span> = None<span class="p">,</span>
          <span class="nx">purge_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">queues_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">rate_limits</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudtasks_v2beta2.RateLimitsArgs]]</span> = None<span class="p">,</span>
          <span class="nx">retry_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_cloudtasks_v2beta2.RetryConfigArgs]]</span> = None<span class="p">,</span>
          <span class="nx">state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">task_ttl</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">tombstone_ttl</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span>
