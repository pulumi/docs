...
<span class="k">def </span><span class="nx">Queue</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">app_engine_http_target</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.AppEngineHttpTargetArgs]</span> = None<span class="p">,</span>
          <span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">pull_target</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.PullTargetArgs]</span> = None<span class="p">,</span>
          <span class="nx">purge_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">rate_limits</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.RateLimitsArgs]</span> = None<span class="p">,</span>
          <span class="nx">retry_config</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.RetryConfigArgs]</span> = None<span class="p">,</span>
          <span class="nx">state</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.QueueState]</span> = None<span class="p">,</span>
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#queuestate">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Queue<wbr>State</a></span>
    </dt>
...
<dl class="tabular"><dt>State<wbr>Unspecified</dt>
    ...
    <dd>PAUSED{{% md %}}Tasks are paused by the user. If the queue is paused then Cloud Tasks will stop delivering tasks from it, but more tasks can still be added to it by the user. When a pull queue is paused, all LeaseTasks calls will return a FAILED_PRECONDITION.{{% /md %}}</dd><dt>Disabled</dt>
    <dd>DISABLED{{% md %}}The queue is disabled. A queue becomes `DISABLED` when [queue.yaml](https://cloud.google.com/appengine/docs/python/config/queueref) or [queue.xml](https://cloud.google.com/appengine/docs/standard/java/config/queueref) is uploaded which does not contain the queue. You cannot directly disable a queue. When a queue is disabled, tasks can still be added to a queue but the tasks are not dispatched and LeaseTasks calls return a `FAILED_PRECONDITION` error. To permanently delete this queue and all of its tasks, call DeleteQueue.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Queue<wbr>State<wbr>State<wbr>Unspecified</dt>
    ...
    <dd>PAUSED{{% md %}}Tasks are paused by the user. If the queue is paused then Cloud Tasks will stop delivering tasks from it, but more tasks can still be added to it by the user. When a pull queue is paused, all LeaseTasks calls will return a FAILED_PRECONDITION.{{% /md %}}</dd><dt>Queue<wbr>State<wbr>Disabled</dt>
    <dd>DISABLED{{% md %}}The queue is disabled. A queue becomes `DISABLED` when [queue.yaml](https://cloud.google.com/appengine/docs/python/config/queueref) or [queue.xml](https://cloud.google.com/appengine/docs/standard/java/config/queueref) is uploaded which does not contain the queue. You cannot directly disable a queue. When a queue is disabled, tasks can still be added to a queue but the tasks are not dispatched and LeaseTasks calls return a `FAILED_PRECONDITION` error. To permanently delete this queue and all of its tasks, call DeleteQueue.{{% /md %}}</dd></dl>
{{% /choosable %}}
