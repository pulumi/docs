...
<a href="#appenginehttptarget_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Engine<wbr>Http<wbr>Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appenginehttptargetresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Outputs.<wbr>App<wbr>Engine<wbr>Http<wbr>Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}App Engine HTTP target. An App Engine queue is a queue that has an AppEngineHttpTarget.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#pulltarget_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pulltargetresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Outputs.<wbr>Pull<wbr>Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Pull target. A pull queue is a queue that has a PullTarget.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ratelimits_csharp" style="color: inherit; text-decoration: inherit;">Rate<wbr>Limits</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ratelimitsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Outputs.<wbr>Rate<wbr>Limits<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Rate limits for task dispatches. rate_limits and retry_config are related because they both control task attempts however they control how tasks are attempted in different ways: * rate_limits controls the total rate of dispatches from a queue (i.e. all traffic dispatched from the queue, regardless of whether the dispatch is from a first attempt or a retry). * retry_config controls what happens to particular a task after its first attempt fails. That is, retry_config controls task retries (the second attempt, third attempt, etc).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="retryconfig_csharp">
<a href="#retryconfig_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#retryconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Outputs.<wbr>Retry<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#pulltarget_go" style="color: inherit; text-decoration: inherit;">Pull<wbr>Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pulltargetresponse">Pull<wbr>Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Pull target. A pull queue is a queue that has a PullTarget.{{% /md %}}</dd><dt class="property-"
            title="">
