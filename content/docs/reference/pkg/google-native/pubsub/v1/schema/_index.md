...
<span class="k">def </span><span class="nx">Schema</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[SchemaType]</span> = None<span class="p">)</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the schema. Format is `projects/{project}/schemas/{schema}`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
