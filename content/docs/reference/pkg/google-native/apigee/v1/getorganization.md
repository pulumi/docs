...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_organization(</span><span class="nx">organization_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupOrganization<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupOrganizationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupOrganizationResult</a></span>, error)</span></code></pre></div>
...
<a href="#addonsconfig_csharp" style="color: inherit; text-decoration: inherit;">Addons<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1addonsconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Apigee.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Apigee<wbr>V1Addons<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Addon configurations of the Apigee organization.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#analyticsregion_csharp" style="color: inherit; text-decoration: inherit;">Analytics<wbr>Region</a>
    ...
    <dd>{{% md %}}Required. Primary GCP region for analytics data storage. For valid values, see [Create an Apigee organization](https://cloud.google.com/apigee/docs/api-platform/get-started/create-org).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#attributes_csharp" style="color: inherit; text-decoration: inherit;">Attributes</a>
    ...
    <dd>{{% md %}}Not used by Apigee.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#billingtype_csharp" style="color: inherit; text-decoration: inherit;">Billing<wbr>Type</a>
    ...
    <dd>{{% md %}}Billing type of the Apigee organization. See [Apigee pricing](https://cloud.google.com/apigee/pricing).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description of the Apigee organization.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}Properties defined in the Apigee organization profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#runtimetype_csharp" style="color: inherit; text-decoration: inherit;">Runtime<wbr>Type</a>
    ...
    <dd>{{% md %}}Required. Runtime type of the Apigee organization based on the Apigee subscription purchased.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}State of the organization. Values other than ACTIVE means the resource is not ready to use.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#addonsconfig_go" style="color: inherit; text-decoration: inherit;">Addons<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1addonsconfigresponse">Google<wbr>Cloud<wbr>Apigee<wbr>V1Addons<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Addon configurations of the Apigee organization.{{% /md %}}</dd><dt class="property-"
            title="">
