...
<a href="#email_csharp" style="color: inherit; text-decoration: inherit;">Email</a>
    ...
    <dd>{{% md %}}Email address of the developer. This value is used to uniquely identify the developer in Apigee hybrid. Note that the email address has to be in lowercase only.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#firstname_csharp" style="color: inherit; text-decoration: inherit;">First<wbr>Name</a>
    ...
    <dd>{{% md %}}First name of the developer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastname_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Name</a>
    ...
    <dd>{{% md %}}Last name of the developer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}User name of the developer. Not used by Apigee hybrid.{{% /md %}}</dd></dl>
{{% /choosable %}}
