...
---
title: "getApp"
title_tag: "google-native.apigee/v1.getApp"
meta_desc: "Documentation for the google-native.apigee/v1.getApp function with examples, input properties, output properties, and supporting types."
---
...
<a href="#apiproducts_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Products</a>
    ...
    <dd>{{% md %}}List of API products associated with the developer app.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#appid_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of the developer app.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#attributes_csharp" style="color: inherit; text-decoration: inherit;">Attributes</a>
    ...
    <dd>{{% md %}}List of attributes for the developer app.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#callbackurl_csharp" style="color: inherit; text-decoration: inherit;">Callback<wbr>Url</a>
    ...
    <dd>{{% md %}}Callback URL used by OAuth 2.0 authorization servers to communicate authorization codes back to developer apps.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#developerid_csharp" style="color: inherit; text-decoration: inherit;">Developer<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of the developer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#keyexpiresin_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Expires<wbr>In</a>
    ...
    <dd>{{% md %}}Expiration time, in milliseconds, for the consumer key that is generated for the developer app. If not set or left to the default value of `-1`, the API key never expires. The expiration time can't be updated after it is set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastmodifiedat_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>At</a>
    ...
    <dd>{{% md %}}Time the developer app was modified in milliseconds since epoch.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the developer app.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#scopes_csharp" style="color: inherit; text-decoration: inherit;">Scopes</a>
    ...
    <dd>{{% md %}}Scopes to apply to the developer app. The specified scopes must already exist for the API product that you associate with the developer app.{{% /md %}}</dd><dt class="property-"
            title="">
