...
<span class="k">def </span><span class="nx">Datastore</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">datastore_config</span><span class="p">:</span> <span class="nx">Optional[_apigee_v1.GoogleCloudApigeeV1DatastoreConfigArgs]</span> = None<span class="p">,</span>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Required. Display name in UI{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#datastoreconfig_go" style="color: inherit; text-decoration: inherit;">Datastore<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1datastoreconfig">Google<wbr>Cloud<wbr>Apigee<wbr>V1Datastore<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}Datastore Configurations.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}Required. GCP project in which the datastore exists{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
