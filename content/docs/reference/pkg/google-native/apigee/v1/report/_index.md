...
---
title: "Report"
title_tag: "google-native.apigee/v1.Report"
meta_desc: "Documentation for the google-native.apigee/v1.Report resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Report</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">metrics</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudApigeeV1CustomReportMetricArgs]]</span> = None<span class="p">,</span>
           ...
           <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudApigeeV1ReportPropertyArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewReport</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ReportArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Report</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The Report resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#metrics_csharp" style="color: inherit; text-decoration: inherit;">Metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1customreportmetric">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Apigee.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Apigee<wbr>V1Custom<wbr>Report<wbr>Metric<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}This contains the list of metrics{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Unique identifier for the report T his is a legacy field used to encode custom report unique id{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1reportproperty">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Apigee.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Apigee<wbr>V1Report<wbr>Property<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#metrics_python" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1customreportmetric">Sequence[Google<wbr>Cloud<wbr>Apigee<wbr>V1Custom<wbr>Report<wbr>Metric<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}This contains the list of metrics{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1reportproperty">Sequence[Google<wbr>Cloud<wbr>Apigee<wbr>V1Report<wbr>Property<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}This field contains report properties such as ui metadata etc.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
