...
<span class="k">def </span><span class="nx">Product</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">audience</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudRetailV2AudienceArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">color_info</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudRetailV2ColorInfoArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">fulfillment_info</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudRetailV2FulfillmentInfoArgs]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">promotions</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudRetailV2PromotionArgs]]</span> = None<span class="p">,</span>
            <span class="nx">publish_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">rating</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudRetailV2RatingArgs]</span> = None<span class="p">,</span>
...
<a href="#audience_csharp" style="color: inherit; text-decoration: inherit;">Audience</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2audience">Pulumi.<wbr>Google<wbr>Native.<wbr>Retail.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Retail<wbr>V2Audience<wbr>Args</a></span>
    </dt>
...
<a href="#colorinfo_csharp" style="color: inherit; text-decoration: inherit;">Color<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2colorinfo">Pulumi.<wbr>Google<wbr>Native.<wbr>Retail.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Retail<wbr>V2Color<wbr>Info<wbr>Args</a></span>
    </dt>
...
<a href="#fulfillmentinfo_csharp" style="color: inherit; text-decoration: inherit;">Fulfillment<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2fulfillmentinfo">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Retail.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Retail<wbr>V2Fulfillment<wbr>Info<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#promotions_csharp" style="color: inherit; text-decoration: inherit;">Promotions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2promotion">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Retail.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Retail<wbr>V2Promotion<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#rating_csharp" style="color: inherit; text-decoration: inherit;">Rating</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2rating">Pulumi.<wbr>Google<wbr>Native.<wbr>Retail.<wbr>V2.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Retail<wbr>V2Rating<wbr>Args</a></span>
    </dt>
...
<a href="#audience_go" style="color: inherit; text-decoration: inherit;">Audience</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2audience">Google<wbr>Cloud<wbr>Retail<wbr>V2Audience<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The target group associated with a given audience (e.g. male, veterans, car owners, musicians, etc.) of the product.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#colorinfo_go" style="color: inherit; text-decoration: inherit;">Color<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2colorinfo">Google<wbr>Cloud<wbr>Retail<wbr>V2Color<wbr>Info<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The color of the product. Google Merchant Center property [color](https://support.google.com/merchants/answer/6324487). Schema.org property [Product.color](https://schema.org/color).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fulfillmentinfo_go" style="color: inherit; text-decoration: inherit;">Fulfillment<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2fulfillmentinfo">[]Google<wbr>Cloud<wbr>Retail<wbr>V2Fulfillment<wbr>Info<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Fulfillment information, such as the store IDs for in-store pickup or region IDs for different shipping methods. All the elements must have distinct FulfillmentInfo.type. Otherwise, an INVALID_ARGUMENT error is returned.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="gtin_go">
...
<a href="#promotions_go" style="color: inherit; text-decoration: inherit;">Promotions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2promotion">[]Google<wbr>Cloud<wbr>Retail<wbr>V2Promotion<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The promotions applied to the product. A maximum of 10 values are allowed per Product.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rating_go" style="color: inherit; text-decoration: inherit;">Rating</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2rating">Google<wbr>Cloud<wbr>Retail<wbr>V2Rating<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The rating of this product.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fulfillment_info_python" style="color: inherit; text-decoration: inherit;">fulfillment_<wbr>info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2fulfillmentinfo">Sequence[Google<wbr>Cloud<wbr>Retail<wbr>V2Fulfillment<wbr>Info<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Fulfillment information, such as the store IDs for in-store pickup or region IDs for different shipping methods. All the elements must have distinct FulfillmentInfo.type. Otherwise, an INVALID_ARGUMENT error is returned.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="gtin_python">
...
<a href="#promotions_python" style="color: inherit; text-decoration: inherit;">promotions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudretailv2promotion">Sequence[Google<wbr>Cloud<wbr>Retail<wbr>V2Promotion<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The promotions applied to the product. A maximum of 10 values are allowed per Product.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googlecloudretailv2audience">Google<wbr>Cloud<wbr>Retail<wbr>V2Audience</h4>
...
<h4 id="googlecloudretailv2colorinfo">Google<wbr>Cloud<wbr>Retail<wbr>V2Color<wbr>Info</h4>
...
<h4 id="googlecloudretailv2fulfillmentinfo">Google<wbr>Cloud<wbr>Retail<wbr>V2Fulfillment<wbr>Info</h4>
...
<h4 id="googlecloudretailv2promotion">Google<wbr>Cloud<wbr>Retail<wbr>V2Promotion</h4>
...
<h4 id="googlecloudretailv2rating">Google<wbr>Cloud<wbr>Retail<wbr>V2Rating</h4>
