...
title_tag: "google-native.notebooks/v1.getEnvironment"
meta_desc: "Documentation for the google-native.notebooks/v1.getEnvironment function with examples, input properties, output properties, and supporting types."
---
...
<a href="#containerimage_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Image</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerimageresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Container<wbr>Image<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Use a container image to start the notebook instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display name of this environment for the UI.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of this environment. Format: `projects/{project_id}/locations/{location}/environments/{environment_id}`{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#poststartupscript_csharp" style="color: inherit; text-decoration: inherit;">Post<wbr>Startup<wbr>Script</a>
    ...
    <dd>{{% md %}}Path to a Bash script that automatically runs after a notebook instance fully boots up. The path must be a URL or Cloud Storage path. Example: `"gs://path-to-file/file-name"`{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="vmimage_csharp">
<a href="#vmimage_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vmimageresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Vm<wbr>Image<wbr>Response</a></span>
    </dt>
...
<a href="#vmimage_go" style="color: inherit; text-decoration: inherit;">Vm<wbr>Image</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vmimageresponse">Vm<wbr>Image<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Use a Compute Engine VM image to start the notebook instance.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}The name of the Google Cloud project that this VM image belongs to. Format: `projects/{project_id}`{{% /md %}}</dd></dl>
{{% /choosable %}}
