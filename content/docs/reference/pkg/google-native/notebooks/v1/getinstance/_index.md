...
---
title: "getInstance"
title_tag: "google-native.notebooks/v1.getInstance"
meta_desc: "Documentation for the google-native.notebooks/v1.getInstance function with examples, input properties, output properties, and supporting types."
---
...
<a href="#acceleratorconfig_csharp" style="color: inherit; text-decoration: inherit;">Accelerator<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#acceleratorconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Accelerator<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has [enough vCPUs and memory to support the `machine_type` you have selected](/compute/docs/gpus/#gpus-list).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bootdisksizegb_csharp" style="color: inherit; text-decoration: inherit;">Boot<wbr>Disk<wbr>Size<wbr>Gb</a>
    ...
    <dd>{{% md %}}Input only. The size of the boot disk in GB attached to this instance, up to a maximum of 64000 GB (64 TB). The minimum recommended value is 100 GB. If not specified, this defaults to 100.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bootdisktype_csharp" style="color: inherit; text-decoration: inherit;">Boot<wbr>Disk<wbr>Type</a>
    ...
    <dd>{{% md %}}Input only. The type of the boot disk attached to this instance, defaults to standard persistent disk (`PD_STANDARD`).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customgpudriverpath_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Gpu<wbr>Driver<wbr>Path</a>
    ...
    <dd>{{% md %}}Specify a custom Cloud Storage path where the GPU driver is stored. If not specified, we'll automatically choose from official GPU drivers.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#datadisksizegb_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disk<wbr>Size<wbr>Gb</a>
    ...
    <dd>{{% md %}}Input only. The size of the data disk in GB attached to this instance, up to a maximum of 64000 GB (64 TB). You can choose the size of the data disk based on how big your notebooks and data are. If not specified, this defaults to 100.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#datadisktype_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disk<wbr>Type</a>
    ...
    <dd>{{% md %}}Input only. The type of the data disk attached to this instance, defaults to standard persistent disk (`PD_STANDARD`).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#diskencryption_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Encryption</a>
    ...
    <dd>{{% md %}}Input only. Disk encryption method used on the boot and data disks, defaults to GMEK.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#installgpudriver_csharp" style="color: inherit; text-decoration: inherit;">Install<wbr>Gpu<wbr>Driver</a>
    ...
    <dd>{{% md %}}Whether the end user authorizes Google Cloud to install GPU driver on this instance. If this field is empty or set to false, the GPU driver won't be installed. Only applicable to instances with GPUs.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#instanceowners_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Owners</a>
    ...
    <dd>{{% md %}}Input only. The owner of this instance after creation. Format: `alias@example.com` Currently supports one owner only. If not specified, all of the service account users of your VM instance's service account can use the instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#kmskey_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key</a>
    ...
    <dd>{{% md %}}Input only. The KMS key used to encrypt the disks, only applicable if disk_encryption is CMEK. Format: `projects/{project_id}/locations/{location}/keyRings/{key_ring_id}/cryptoKeys/{key_id}` Learn more about [using your own encryption keys](/kms/docs/quickstart).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#machinetype_csharp" style="color: inherit; text-decoration: inherit;">Machine<wbr>Type</a>
    ...
    <dd>{{% md %}}The [Compute Engine machine type](/compute/docs/machine-types) of this instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
    ...
    <dd>{{% md %}}Custom metadata to apply to this instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#network_csharp" style="color: inherit; text-decoration: inherit;">Network</a>
    ...
    <dd>{{% md %}}The name of the VPC that this instance is in. Format: `projects/{project_id}/global/networks/{network_id}`{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nictype_csharp" style="color: inherit; text-decoration: inherit;">Nic<wbr>Type</a>
    ...
    <dd>{{% md %}}Optional. The type of vNIC to be used on this interface. This may be gVNIC or VirtioNet.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#noproxyaccess_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Proxy<wbr>Access</a>
    ...
    <dd>{{% md %}}If true, the notebook instance will not register with the proxy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nopublicip_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Public<wbr>Ip</a>
    ...
    <dd>{{% md %}}If true, no public IP will be assigned to this instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#noremovedatadisk_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Remove<wbr>Data<wbr>Disk</a>
    ...
    <dd>{{% md %}}Input only. If true, the data disk will not be auto deleted when deleting the instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#poststartupscript_csharp" style="color: inherit; text-decoration: inherit;">Post<wbr>Startup<wbr>Script</a>
    ...
    <dd>{{% md %}}Path to a Bash script that automatically runs after a notebook instance fully boots up. The path must be a URL or Cloud Storage path (gs://path-to-file/file-name).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#reservationaffinity_csharp" style="color: inherit; text-decoration: inherit;">Reservation<wbr>Affinity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reservationaffinityresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Reservation<wbr>Affinity<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. The optional reservation affinity. Setting this field will apply the specified [Zonal Compute Reservation](https://cloud.google.com/compute/docs/instances/reserving-zonal-resources) to this notebook instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceaccount_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account</a>
    ...
    <dd>{{% md %}}The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must have the service account user permission to use the instance. If not specified, the [Compute Engine default service account](https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#shieldedinstanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shieldedinstanceconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Shielded<wbr>Instance<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Shielded VM configuration. [Images using supported Shielded VM features] (https://cloud.google.com/compute/docs/instances/modifying-shielded-vm).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#subnet_csharp" style="color: inherit; text-decoration: inherit;">Subnet</a>
    ...
    <dd>{{% md %}}The name of the subnet that this instance is in. Format: `projects/{project_id}/regions/{region}/subnetworks/{subnetwork_id}`{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}Optional. The Compute Engine tags to add to runtime (see [Tagging instances](https://cloud.google.com/compute/docs/label-or-tag-resources#tags)).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
    ...
    <dd>{{% md %}}Instance update time.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#upgradehistory_csharp" style="color: inherit; text-decoration: inherit;">Upgrade<wbr>History</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#upgradehistoryentryresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Notebooks.<wbr>V1.<wbr>Outputs.<wbr>Upgrade<wbr>History<wbr>Entry<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The upgrade history of this instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#upgradehistory_go" style="color: inherit; text-decoration: inherit;">Upgrade<wbr>History</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#upgradehistoryentryresponse">[]Upgrade<wbr>History<wbr>Entry<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The upgrade history of this instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="vmimage_go">
...
<a href="#upgrade_history_python" style="color: inherit; text-decoration: inherit;">upgrade_<wbr>history</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#upgradehistoryentryresponse">Sequence[Upgrade<wbr>History<wbr>Entry<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The upgrade history of this instance.{{% /md %}}</dd><dt class="property-"
            title="">
