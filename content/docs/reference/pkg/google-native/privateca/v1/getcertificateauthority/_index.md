...
title_tag: "google-native.privateca/v1.getCertificateAuthority"
meta_desc: "Documentation for the google-native.privateca/v1.getCertificateAuthority function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_certificate_authority(</span><span class="nx">ca_pool_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#keyspec_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyversionspecresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Outputs.<wbr>Key<wbr>Version<wbr>Spec<wbr>Response</a></span>
    </dt>
...
<a href="#lifetime_csharp" style="color: inherit; text-decoration: inherit;">Lifetime</a>
    ...
    <dd>{{% md %}}Immutable. The desired lifetime of the CA certificate. Used to create the "not_before_time" and "not_after_time" fields inside an X.509 certificate.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#subordinateconfig_csharp" style="color: inherit; text-decoration: inherit;">Subordinate<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subordinateconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Outputs.<wbr>Subordinate<wbr>Config<wbr>Response</a></span>
    </dt>
