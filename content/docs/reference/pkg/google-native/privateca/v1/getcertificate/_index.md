...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_certificate(</span><span class="nx">ca_pool_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#certificatetemplate_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Template</a>
    ...
    <dd>{{% md %}}Immutable. The resource name for a CertificateTemplate used to issue this certificate, in the format `projects/*/locations/*/certificateTemplates/*`. If this is specified, the caller must have the necessary permission to use this template. If this is omitted, no template will be used. This template must be in the same location as the Certificate.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="config_csharp">
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificateconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Outputs.<wbr>Certificate<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#subjectmode_csharp" style="color: inherit; text-decoration: inherit;">Subject<wbr>Mode</a>
    ...
    <dd>{{% md %}}Immutable. Specifies how the Certificate's identity fields are to be decided. If this is omitted, the `DEFAULT` subject mode will be used.{{% /md %}}</dd><dt class="property-"
            title="">
