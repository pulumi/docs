...
<a href="#keyspec_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyversionspec">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Inputs.<wbr>Key<wbr>Version<wbr>Spec<wbr>Args</a></span>
    </dt>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificateauthoritytype">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Certificate<wbr>Authority<wbr>Type</a></span>
    </dt>
...
<a href="#subordinateconfig_csharp" style="color: inherit; text-decoration: inherit;">Subordinate<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subordinateconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Inputs.<wbr>Subordinate<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#accessurls_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Urls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accessurlsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Outputs.<wbr>Access<wbr>Urls<wbr>Response</a></span>
    </dt>
...
<a href="#cacertificatedescriptions_csharp" style="color: inherit; text-decoration: inherit;">Ca<wbr>Certificate<wbr>Descriptions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatedescriptionresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Outputs.<wbr>Certificate<wbr>Description<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#deletetime_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which this CertificateAuthority was soft deleted, if it is in the DELETED state.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#expiretime_csharp" style="color: inherit; text-decoration: inherit;">Expire<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which this CertificateAuthority will be permanently purged, if it is in the DELETED state.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The resource name for this CertificateAuthority in the format `projects/*/locations/*/caPools/*/certificateAuthorities/*`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}The CaPool.Tier of the CaPool that includes this CertificateAuthority.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which this CertificateAuthority was last updated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cacertificateaccessurl_csharp" style="color: inherit; text-decoration: inherit;">Ca<wbr>Certificate<wbr>Access<wbr>Url</a>
    ...
    <dd>{{% md %}}The URL where this CertificateAuthority's CA certificate is published. This will only be set for CAs that have been activated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="crlaccessurls_csharp">
<a href="#crlaccessurls_csharp" style="color: inherit; text-decoration: inherit;">Crl<wbr>Access<wbr>Urls</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;string&gt;</span>
    </dt>
    <dd>{{% md %}}The URLs where this CertificateAuthority's CRLs are published. This will only be set for CAs that have been activated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cacertificateaccessurl_go" style="color: inherit; text-decoration: inherit;">Ca<wbr>Certificate<wbr>Access<wbr>Url</a>
    ...
    <dd>{{% md %}}The URL where this CertificateAuthority's CA certificate is published. This will only be set for CAs that have been activated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="crlaccessurls_go">
<a href="#crlaccessurls_go" style="color: inherit; text-decoration: inherit;">Crl<wbr>Access<wbr>Urls</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]string</span>
    </dt>
...
<a href="#cacertificateaccessurl_nodejs" style="color: inherit; text-decoration: inherit;">ca<wbr>Certificate<wbr>Access<wbr>Url</a>
    ...
    <dd>{{% md %}}The URL where this CertificateAuthority's CA certificate is published. This will only be set for CAs that have been activated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="crlaccessurls_nodejs">
<a href="#crlaccessurls_nodejs" style="color: inherit; text-decoration: inherit;">crl<wbr>Access<wbr>Urls</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string[]</span>
    </dt>
...
<a href="#ca_certificate_access_url_python" style="color: inherit; text-decoration: inherit;">ca_<wbr>certificate_<wbr>access_<wbr>url</a>
    ...
    <dd>{{% md %}}The URL where this CertificateAuthority's CA certificate is published. This will only be set for CAs that have been activated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="crl_access_urls_python">
<a href="#crl_access_urls_python" style="color: inherit; text-decoration: inherit;">crl_<wbr>access_<wbr>urls</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[str]</span>
    </dt>
...
<a href="#algorithm_csharp" style="color: inherit; text-decoration: inherit;">Algorithm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyversionspecalgorithm">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Key<wbr>Version<wbr>Spec<wbr>Algorithm</a></span>
    </dt>
    <dd>{{% md %}}The algorithm to use for creating a managed Cloud KMS key for a for a simplified experience. All managed keys will be have their ProtectionLevel as `HSM`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pemissuerchain_csharp" style="color: inherit; text-decoration: inherit;">Pem<wbr>Issuer<wbr>Chain</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subordinateconfigchain">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Inputs.<wbr>Subordinate<wbr>Config<wbr>Chain</a></span>
    </dt>
...
<a href="#pemissuerchain_csharp" style="color: inherit; text-decoration: inherit;">Pem<wbr>Issuer<wbr>Chain</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subordinateconfigchainresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1.<wbr>Inputs.<wbr>Subordinate<wbr>Config<wbr>Chain<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Contains the PEM certificate chain for the issuers of this CertificateAuthority, but not pem certificate for this CA itself.{{% /md %}}</dd></dl>
{{% /choosable %}}
