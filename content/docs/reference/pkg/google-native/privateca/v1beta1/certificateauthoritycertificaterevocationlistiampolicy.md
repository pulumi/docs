...
<span class="k">def </span><span class="nx">CertificateAuthorityCertificateRevocationListIamPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                                           ...
                                                           <span class="nx">audit_configs</span><span class="p">:</span> <span class="nx">Optional[Sequence[_privateca_v1beta1.AuditConfigArgs]]</span> = None<span class="p">,</span>
                                                           <span class="nx">bindings</span><span class="p">:</span> <span class="nx">Optional[Sequence[_privateca_v1beta1.BindingArgs]]</span> = None<span class="p">,</span>
                                                           <span class="nx">certificate_authority_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                                           <span class="nx">certificate_revocation_list_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#certificateauthorityid_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authority<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="certificaterevocationlistid_csharp">
<a href="#certificaterevocationlistid_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Revocation<wbr>List<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#certificateauthorityid_go" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authority<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="certificaterevocationlistid_go">
<a href="#certificaterevocationlistid_go" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Revocation<wbr>List<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#certificateauthorityid_nodejs" style="color: inherit; text-decoration: inherit;">certificate<wbr>Authority<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="certificaterevocationlistid_nodejs">
<a href="#certificaterevocationlistid_nodejs" style="color: inherit; text-decoration: inherit;">certificate<wbr>Revocation<wbr>List<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#certificate_authority_id_python" style="color: inherit; text-decoration: inherit;">certificate_<wbr>authority_<wbr>id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="certificate_revocation_list_id_python">
<a href="#certificate_revocation_list_id_python" style="color: inherit; text-decoration: inherit;">certificate_<wbr>revocation_<wbr>list_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#logtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#auditlogconfiglogtype">Pulumi.<wbr>Google<wbr>Native.<wbr>Privateca.<wbr>V1Beta1.<wbr>Audit<wbr>Log<wbr>Config<wbr>Log<wbr>Type</a></span>
    </dt>
