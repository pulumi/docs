...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
    ...
    <dd>{{% md %}}Required. Immutable. The config used to create a self-signed X.509 certificate or CSR.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#keyspec_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Spec</a>
    ...
    <dd>{{% md %}}Required. Immutable. Used when issuing certificates for this CertificateAuthority. If this CertificateAuthority is a self-signed CertificateAuthority, this key is also used to sign the self-signed CA certificate. Otherwise, it is used to sign a CSR.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lifetime_csharp" style="color: inherit; text-decoration: inherit;">Lifetime</a>
    ...
    <dd>{{% md %}}Required. The desired lifetime of the CA certificate. Used to create the "not_before_time" and "not_after_time" fields inside an X.509 certificate.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}Required. Immutable. The Tier of this CertificateAuthority.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Required. Immutable. The Type of this CertificateAuthority.{{% /md %}}</dd><dt class="property-"
            title="">
