...
---
title: "getDataset"
title_tag: "google-native.datalabeling/v1beta1.getDataset"
meta_desc: "Documentation for the google-native.datalabeling/v1beta1.getDataset function with examples, input properties, output properties, and supporting types."
---
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Optional. User-provided description of the annotation specification set. The description can be up to 10000 characters long.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the dataset. Maximum of 64 characters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastmigratetime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Migrate<wbr>Time</a>
    ...
    <dd>{{% md %}}Last time that the Dataset is migrated to AI Platform V2. If any of the AnnotatedDataset is migrated, the last_migration_time in Dataset is also updated.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
