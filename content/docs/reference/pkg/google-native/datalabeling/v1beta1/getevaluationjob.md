...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Required. Description of the job. The description can be up to 25,000 characters long.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#evaluationjobconfig_csharp" style="color: inherit; text-decoration: inherit;">Evaluation<wbr>Job<wbr>Config</a>
    ...
    <dd>{{% md %}}Required. Configuration details for the evaluation job.{{% /md %}}</dd><dt class="property-"
            title="">
