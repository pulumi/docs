...
<a href="#deleteservicestrategy_go" style="color: inherit; text-decoration: inherit;">Delete<wbr>Service<wbr>Strategy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deleteservicestrategy">Delete<wbr>Service<wbr>Strategy</a></span>
    </dt>
    <dd>{{% md %}}The strategy associated with a rollout to delete a `ManagedService`. Readonly.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#trafficpercentstrategy_go" style="color: inherit; text-decoration: inherit;">Traffic<wbr>Percent<wbr>Strategy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#trafficpercentstrategy">Traffic<wbr>Percent<wbr>Strategy</a></span>
    </dt>
    <dd>{{% md %}}Google Service Control selects service configurations based on traffic percentage.{{% /md %}}</dd></dl>
{{% /choosable %}}
