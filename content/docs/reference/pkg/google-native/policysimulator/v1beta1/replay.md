...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Replay</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_policysimulator_v1beta1.GoogleCloudPolicysimulatorV1beta1ReplayConfigArgs]]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">, </span><span class="nx">replays_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudpolicysimulatorv1beta1replayconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Policy<wbr>Simulator.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Policysimulator<wbr>V1beta1Replay<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#config_nodejs" style="color: inherit; text-decoration: inherit;">config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudpolicysimulatorv1beta1replayconfig">pulumi.<wbr>Input<Google<wbr>Cloud<wbr>Policysimulator<wbr>V1beta1Replay<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Required. The configuration used for the `Replay`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#newestdate_csharp" style="color: inherit; text-decoration: inherit;">Newest<wbr>Date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googletypedateresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Policy<wbr>Simulator.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Type<wbr>Date<wbr>Response<wbr>Args</a></span>
    </dt>
