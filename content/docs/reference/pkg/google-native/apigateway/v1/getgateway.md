...
<a href="#apiconfig_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Config</a>
    ...
    <dd>{{% md %}}Required. Resource name of the API Config for this Gateway. Format: projects/{project}/locations/global/apis/{api}/configs/{apiConfig}{{% /md %}}</dd><dt class="property-"
            title="">
