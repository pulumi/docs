...
<span class="k">def </span><span class="nx">GroupMembership</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">member_key</span><span class="p">:</span> <span class="nx">Optional[GroupMembershipMemberKeyArgs]</span> = None<span class="p">,</span>
                    <span class="nx">preferred_member_key</span><span class="p">:</span> <span class="nx">Optional[GroupMembershipPreferredMemberKeyArgs]</span> = None<span class="p">,</span>
                    <span class="nx">roles</span><span class="p">:</span> <span class="nx">Optional[Sequence[GroupMembershipRoleArgs]]</span> = None<span class="p">)</span>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">update_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> GroupMembership</code></pre></div>
{{% /choosable %}}
