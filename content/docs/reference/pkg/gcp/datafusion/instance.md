...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancenetworkconfig">Pulumi.<wbr>Gcp.<wbr>Data<wbr>Fusion.<wbr>Inputs.<wbr>Instance<wbr>Network<wbr>Config<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Network<wbr>Config</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancenetworkconfig">Pulumi.<wbr>Gcp.<wbr>Data<wbr>Fusion.<wbr>Outputs.<wbr>Instance<wbr>Network<wbr>Config?</a></span>
    </dt>
    <dd>{{% md %}}Network configuration options. These are required when a private Data Fusion instance is to be created.
{{% /md %}}</dd>
