...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ServiceIamBinding resource produces the following computed outputs.
