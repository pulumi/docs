...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the DicomStore resource produces the following computed outputs.
