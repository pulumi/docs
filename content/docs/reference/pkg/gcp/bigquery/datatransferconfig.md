...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the DataTransferConfig resource produces the following computed outputs.
