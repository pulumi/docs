...
meta_desc: "Explore the Dataset resource of the bigquery module, including examples, input properties, output properties, lookup functions, and supporting types. "
---
