...
## AttestorIamMember Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AttestorIamMember resource produces the following computed outputs.
