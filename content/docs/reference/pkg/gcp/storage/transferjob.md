...
<span class="k">def </span><span class="nx">TransferJob</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">schedule</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[TransferJobScheduleArgs]]</span> = None<span class="p">,</span>
                <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                <span class="nx">transfer_spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[TransferJobTransferSpecArgs]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewTransferJob</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">TransferJobArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">TransferJob</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#schedule_nodejs" style="color: inherit; text-decoration: inherit;">schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedule">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Schedule<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Schedule specification defining when the Transfer Job should be scheduled to start, end and what time to run. Structure documented below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#transferspec_nodejs" style="color: inherit; text-decoration: inherit;">transfer<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspec">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Transfer specification. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#schedule_python" style="color: inherit; text-decoration: inherit;">schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedule">Input[Transfer<wbr>Job<wbr>Schedule<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Schedule specification defining when the Transfer Job should be scheduled to start, end and what time to run. Structure documented below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#transfer_spec_python" style="color: inherit; text-decoration: inherit;">transfer_<wbr>spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspec">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Transfer specification. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">public static </span><span class="nf">get</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#ID">Input&lt;ID&gt;</a></span><span class="p">,</span> <span class="nx">state</span><span class="p">?:</span> <span class="nx">TransferJobState</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">): </span><span class="nx">TransferJob</span></code></pre></div>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">deletion_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">last_modification_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">schedule</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[TransferJobScheduleArgs]]</span> = None<span class="p">,</span>
        <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">transfer_spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[TransferJobTransferSpecArgs]]</span> = None<span class="p">) -&gt;</span> TransferJob</code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetTransferJob<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">TransferJobState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">TransferJob</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span><span class="nx">TransferJob</span><span class="nf"> Get</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.Input-1.html">Input&lt;string&gt;</a></span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">TransferJobState</span><span class="p">? </span><span class="nx">state<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#schedulestartdate_nodejs" style="color: inherit; text-decoration: inherit;">schedule<wbr>Start<wbr>Date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobscheduleschedulestartdate">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Schedule<wbr>Schedule<wbr>Start<wbr>Date<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The first day the recurring transfer is scheduled to run. If `schedule_start_date` is in the past, the transfer will run for the first time on the following day. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#scheduleenddate_nodejs" style="color: inherit; text-decoration: inherit;">schedule<wbr>End<wbr>Date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedulescheduleenddate">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Schedule<wbr>Schedule<wbr>End<wbr>Date<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The last day the recurring transfer will be run. If `schedule_end_date` is the same as `schedule_start_date`, the transfer will be executed only once. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#starttimeofday_nodejs" style="color: inherit; text-decoration: inherit;">start<wbr>Time<wbr>Of<wbr>Day</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedulestarttimeofday">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Schedule<wbr>Start<wbr>Time<wbr>Of<wbr>Day<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The time in UTC at which the transfer will be scheduled to start in a day. Transfers may start later than this time. If not specified, recurring and one-time transfers that are scheduled to run today will run immediately; recurring transfers that are scheduled to run on a future date will start at approximately midnight UTC on that date. Note that when configuring a transfer with the Cloud Platform Console, the transfer's start time in a day is specified in your local timezone. Structure documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#schedule_start_date_python" style="color: inherit; text-decoration: inherit;">schedule_<wbr>start_<wbr>date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobscheduleschedulestartdate">Input[Transfer<wbr>Job<wbr>Schedule<wbr>Schedule<wbr>Start<wbr>Date<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The first day the recurring transfer is scheduled to run. If `schedule_start_date` is in the past, the transfer will run for the first time on the following day. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#schedule_end_date_python" style="color: inherit; text-decoration: inherit;">schedule_<wbr>end_<wbr>date</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedulescheduleenddate">Input[Transfer<wbr>Job<wbr>Schedule<wbr>Schedule<wbr>End<wbr>Date<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The last day the recurring transfer will be run. If `schedule_end_date` is the same as `schedule_start_date`, the transfer will be executed only once. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#start_time_of_day_python" style="color: inherit; text-decoration: inherit;">start_<wbr>time_<wbr>of_<wbr>day</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobschedulestarttimeofday">Input[Transfer<wbr>Job<wbr>Schedule<wbr>Start<wbr>Time<wbr>Of<wbr>Day<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The time in UTC at which the transfer will be scheduled to start in a day. Transfers may start later than this time. If not specified, recurring and one-time transfers that are scheduled to run today will run immediately; recurring transfers that are scheduled to run on a future date will start at approximately midnight UTC on that date. Note that when configuring a transfer with the Cloud Platform Console, the transfer's start time in a day is specified in your local timezone. Structure documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#awss3datasource_nodejs" style="color: inherit; text-decoration: inherit;">aws<wbr>S3Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecawss3datasource">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Aws<wbr>S3Data<wbr>Source<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An AWS S3 data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gcsdatasink_nodejs" style="color: inherit; text-decoration: inherit;">gcs<wbr>Data<wbr>Sink</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecgcsdatasink">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Gcs<wbr>Data<wbr>Sink<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A Google Cloud Storage data sink. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gcsdatasource_nodejs" style="color: inherit; text-decoration: inherit;">gcs<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecgcsdatasource">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Gcs<wbr>Data<wbr>Source<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A Google Cloud Storage data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#httpdatasource_nodejs" style="color: inherit; text-decoration: inherit;">http<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspechttpdatasource">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Http<wbr>Data<wbr>Source<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An HTTP URL data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#objectconditions_nodejs" style="color: inherit; text-decoration: inherit;">object<wbr>Conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecobjectconditions">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Object<wbr>Conditions<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Only objects that satisfy these object conditions are included in the set of data source and data sink objects. Object conditions based on objects' `last_modification_time` do not exclude objects in a data sink. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transferoptions_nodejs" style="color: inherit; text-decoration: inherit;">transfer<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspectransferoptions">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Transfer<wbr>Options<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Characteristics of how to treat files from datasource and sink during job. If the option `delete_objects_unique_in_sink` is true, object conditions based on objects' `last_modification_time` are ignored and do not exclude objects in a data source or a data sink. Structure documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#aws_s3_data_source_python" style="color: inherit; text-decoration: inherit;">aws_<wbr>s3_<wbr>data_<wbr>source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecawss3datasource">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Aws<wbr>S3Data<wbr>Source<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An AWS S3 data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gcs_data_sink_python" style="color: inherit; text-decoration: inherit;">gcs_<wbr>data_<wbr>sink</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecgcsdatasink">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Gcs<wbr>Data<wbr>Sink<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A Google Cloud Storage data sink. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gcs_data_source_python" style="color: inherit; text-decoration: inherit;">gcs_<wbr>data_<wbr>source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecgcsdatasource">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Gcs<wbr>Data<wbr>Source<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A Google Cloud Storage data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#http_data_source_python" style="color: inherit; text-decoration: inherit;">http_<wbr>data_<wbr>source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspechttpdatasource">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Http<wbr>Data<wbr>Source<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An HTTP URL data source. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#object_conditions_python" style="color: inherit; text-decoration: inherit;">object_<wbr>conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecobjectconditions">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Object<wbr>Conditions<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Only objects that satisfy these object conditions are included in the set of data source and data sink objects. Object conditions based on objects' `last_modification_time` do not exclude objects in a data sink. Structure documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transfer_options_python" style="color: inherit; text-decoration: inherit;">transfer_<wbr>options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspectransferoptions">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Transfer<wbr>Options<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Characteristics of how to treat files from datasource and sink during job. If the option `delete_objects_unique_in_sink` is true, object conditions based on objects' `last_modification_time` are ignored and do not exclude objects in a data source or a data sink. Structure documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#awsaccesskey_nodejs" style="color: inherit; text-decoration: inherit;">aws<wbr>Access<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecawss3datasourceawsaccesskey">pulumi.<wbr>Input<Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Aws<wbr>S3Data<wbr>Source<wbr>Aws<wbr>Access<wbr>Key<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}AWS credentials block.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#aws_access_key_python" style="color: inherit; text-decoration: inherit;">aws_<wbr>access_<wbr>key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferjobtransferspecawss3datasourceawsaccesskey">Input[Transfer<wbr>Job<wbr>Transfer<wbr>Spec<wbr>Aws<wbr>S3Data<wbr>Source<wbr>Aws<wbr>Access<wbr>Key<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}AWS credentials block.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
