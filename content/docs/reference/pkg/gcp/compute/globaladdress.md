...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the GlobalAddress resource produces the following computed outputs.
