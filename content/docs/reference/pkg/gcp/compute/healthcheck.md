...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the HealthCheck resource produces the following computed outputs.
