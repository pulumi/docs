...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RouterPeer resource produces the following computed outputs.
