...
<span class="k">def </span><span class="nx">RegionPerInstanceConfig</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                            ...
                            <span class="nx">preserved_state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[RegionPerInstanceConfigPreservedStateArgs]]</span> = None<span class="p">,</span>
                            ...
                            <span class="nx">region_instance_group_manager</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRegionPerInstanceConfig</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RegionPerInstanceConfigArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RegionPerInstanceConfig</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#preservedstate_nodejs" style="color: inherit; text-decoration: inherit;">preserved<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regionperinstanceconfigpreservedstate">pulumi.<wbr>Input<Region<wbr>Per<wbr>Instance<wbr>Config<wbr>Preserved<wbr>State<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The preserved state for this instance.
Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
...
<a href="#preserved_state_python" style="color: inherit; text-decoration: inherit;">preserved_<wbr>state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regionperinstanceconfigpreservedstate">Input[Region<wbr>Per<wbr>Instance<wbr>Config<wbr>Preserved<wbr>State<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The preserved state for this instance.
Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">region_instance_group_manager</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">remove_instance_state_on_destroy</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">) -&gt;</span> RegionPerInstanceConfig</code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetRegionPerInstanceConfig<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">RegionPerInstanceConfigState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RegionPerInstanceConfig</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#disks_nodejs" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regionperinstanceconfigpreservedstatedisk">pulumi.<wbr>Input<pulumi.<wbr>Input<Region<wbr>Per<wbr>Instance<wbr>Config<wbr>Preserved<wbr>State<wbr>Disk<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Stateful disks for the instance.
Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
...
<a href="#disks_python" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regionperinstanceconfigpreservedstatedisk">Input[Region<wbr>Per<wbr>Instance<wbr>Config<wbr>Preserved<wbr>State<wbr>Disk<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Stateful disks for the instance.
Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
