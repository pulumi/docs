...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NetworkEndpointGroup resource produces the following computed outputs.
