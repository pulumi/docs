...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the FolderSink resource produces the following computed outputs.
