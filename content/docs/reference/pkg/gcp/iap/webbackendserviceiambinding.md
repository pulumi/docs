...
meta_desc: "Explore the WebBackendServiceIamBinding resource of the iap module, including examples, input properties, output properties, lookup functions, and supporting types. "
---
