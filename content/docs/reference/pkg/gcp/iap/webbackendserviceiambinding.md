...
## WebBackendServiceIamBinding Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the WebBackendServiceIamBinding resource produces the following computed outputs.
