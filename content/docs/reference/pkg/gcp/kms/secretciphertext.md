...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SecretCiphertext resource produces the following computed outputs.
