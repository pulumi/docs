...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">GCPolicy</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>column_family=None<span class="p">, </span>instance_name=None<span class="p">, </span>max_ages=None<span class="p">, </span>max_versions=None<span class="p">, </span>mode=None<span class="p">, </span>project=None<span class="p">, </span>table=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
