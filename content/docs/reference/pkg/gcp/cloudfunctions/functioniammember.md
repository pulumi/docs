...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.Cloudfunctions.FunctionIamMember.html">FunctionIamMember</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Gcp/Pulumi.Gcp.CloudFunctions.Inputs.FunctionIamMemberArgs.html">FunctionIamMemberArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span>Condition</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#functioniammembercondition">Pulumi.<wbr>Gcp.<wbr>Cloud<wbr>Functions.<wbr>Inputs.<wbr>Function<wbr>Iam<wbr>Member<wbr>Condition<wbr>Args?</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Condition</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#functioniammembercondition">Pulumi.<wbr>Gcp.<wbr>Cloud<wbr>Functions.<wbr>Outputs.<wbr>Function<wbr>Iam<wbr>Member<wbr>Condition?</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
