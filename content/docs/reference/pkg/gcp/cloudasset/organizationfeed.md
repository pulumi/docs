...
<span class="k">def </span><span class="nx">OrganizationFeed</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">asset_names</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                     <span class="nx">asset_types</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                     <span class="nx">billing_project</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">condition</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[OrganizationFeedConditionArgs]]</span> = None<span class="p">,</span>
                     <span class="nx">content_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">feed_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">feed_output_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[OrganizationFeedFeedOutputConfigArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewOrganizationFeed</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">OrganizationFeedArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">OrganizationFeed</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#feedoutputconfig_nodejs" style="color: inherit; text-decoration: inherit;">feed<wbr>Output<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedfeedoutputconfig">pulumi.<wbr>Input<Organization<wbr>Feed<wbr>Feed<wbr>Output<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Output configuration for asset feed destination.
Structure is documented below.
{{% /md %}}</dd><dt class="property-required"
...
<a href="#condition_nodejs" style="color: inherit; text-decoration: inherit;">condition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedcondition">pulumi.<wbr>Input<Organization<wbr>Feed<wbr>Condition<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A condition which determines whether an asset update should be published. If specified, an asset
will be returned only when the expression evaluates to true. When set, expression field
must be a valid CEL expression on a TemporalAsset with name temporal_asset. Example: a Feed with
...
<a href="#feed_output_config_python" style="color: inherit; text-decoration: inherit;">feed_<wbr>output_<wbr>config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedfeedoutputconfig">Input[Organization<wbr>Feed<wbr>Feed<wbr>Output<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Output configuration for asset feed destination.
Structure is documented below.
{{% /md %}}</dd><dt class="property-required"
...
<a href="#condition_python" style="color: inherit; text-decoration: inherit;">condition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedcondition">Input[Organization<wbr>Feed<wbr>Condition<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A condition which determines whether an asset update should be published. If specified, an asset
will be returned only when the expression evaluates to true. When set, expression field
must be a valid CEL expression on a TemporalAsset with name temporal_asset. Example: a Feed with
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">org_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> OrganizationFeed</code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetOrganizationFeed<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">OrganizationFeedState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v5/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">OrganizationFeed</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#pubsubdestination_nodejs" style="color: inherit; text-decoration: inherit;">pubsub<wbr>Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedfeedoutputconfigpubsubdestination">pulumi.<wbr>Input<Organization<wbr>Feed<wbr>Feed<wbr>Output<wbr>Config<wbr>Pubsub<wbr>Destination<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Destination on Cloud Pubsub.
Structure is documented below.
{{% /md %}}</dd></dl>
...
<a href="#pubsub_destination_python" style="color: inherit; text-decoration: inherit;">pubsub_<wbr>destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#organizationfeedfeedoutputconfigpubsubdestination">Input[Organization<wbr>Feed<wbr>Feed<wbr>Output<wbr>Config<wbr>Pubsub<wbr>Destination<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Destination on Cloud Pubsub.
Structure is documented below.
{{% /md %}}</dd></dl>
