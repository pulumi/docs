...
All [input](#inputs) properties are implicitly available as output properties. The TenantInboundSamlConfig resource does not produce any additional output properties.
