...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the GameServerConfig resource produces the following computed outputs.
