...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the GameServerDeploymentRollout resource produces the following computed outputs.
