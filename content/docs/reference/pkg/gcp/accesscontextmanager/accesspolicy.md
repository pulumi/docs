...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AccessPolicy resource produces the following computed outputs.
