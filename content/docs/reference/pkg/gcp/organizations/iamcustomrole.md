...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the IAMCustomRole resource produces the following computed outputs.
