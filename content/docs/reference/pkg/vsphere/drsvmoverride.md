...
All [input](#inputs) properties are implicitly available as output properties. The DrsVmOverride resource does not produce any additional output properties.
