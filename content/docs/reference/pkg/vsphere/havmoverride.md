...
meta_desc: "Explore the HaVmOverride resource of the vSphere package, including examples, input properties, output properties, lookup functions, and supporting types. The `vsphere..HaVmOverride` resource can be used to add an override for"
---
...
The HaVmOverride resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
