...
All [input](#inputs) properties are implicitly available as output properties. The VirtualMachineSnapshot resource does not produce any additional output properties.
