...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the VmfsDatastore resource produces the following computed outputs.
