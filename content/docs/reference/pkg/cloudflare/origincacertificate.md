...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the OriginCaCertificate resource produces the following computed outputs.
