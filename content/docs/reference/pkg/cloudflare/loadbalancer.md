...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">LoadBalancer</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>default_pool_ids=None<span class="p">, </span>description=None<span class="p">, </span>enabled=None<span class="p">, </span>fallback_pool_id=None<span class="p">, </span>name=None<span class="p">, </span>pop_pools=None<span class="p">, </span>proxied=None<span class="p">, </span>region_pools=None<span class="p">, </span>session_affinity=None<span class="p">, </span>steering_policy=None<span class="p">, </span>ttl=None<span class="p">, </span>zone_id=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
