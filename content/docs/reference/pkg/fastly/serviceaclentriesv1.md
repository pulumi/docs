...
All [input](#inputs) properties are implicitly available as output properties. The ServiceACLEntriesv1 resource does not produce any additional output properties.
