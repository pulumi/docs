...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ServiceACLEntriesv1</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>acl_id=None<span class="p">, </span>entries=None<span class="p">, </span>service_id=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
