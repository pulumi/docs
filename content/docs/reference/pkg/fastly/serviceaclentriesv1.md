...
<span class="k">def </span><span class="nx">ServiceACLEntriesv1</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                        ...
                        <span class="nx">entries</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ServiceACLEntriesv1EntryArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#entries_nodejs" style="color: inherit; text-decoration: inherit;">entries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaclentriesv1entry">pulumi<wbr>Input<pulumi<wbr>Input<Service<wbr>ACLEntriesv1Entry<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A Set ACL entries that are applied to the service. Defined below
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#entries_python" style="color: inherit; text-decoration: inherit;">entries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaclentriesv1entry">Input[Service<wbr>ACLEntriesv1Entry<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A Set ACL entries that are applied to the service. Defined below
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">acl_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">entries</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ServiceACLEntriesv1EntryArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">service_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> ServiceACLEntriesv1</code></pre></div>
{{% /choosable %}}
