...
title_tag: "alicloud.slb.getServerGroups"
meta_desc: "Documentation for the alicloud.slb.getServerGroups function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_server_groups(</span><span class="nx">ids</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
...
<a href="#servers_csharp" style="color: inherit; text-decoration: inherit;">Servers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getservergroupsslbservergroupserver">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Slb.<wbr>Inputs.<wbr>Get<wbr>Server<wbr>Groups<wbr>Slb<wbr>Server<wbr>Group<wbr>Server&gt;</a></span>
    </dt>
...
<a href="#servers_python" style="color: inherit; text-decoration: inherit;">servers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getservergroupsslbservergroupserver">Sequence[Get<wbr>Server<wbr>Groups<wbr>Slb<wbr>Server<wbr>Group<wbr>Server]</a></span>
    </dt>
    <dd>{{% md %}}ECS instances associated to the group. Each element contains the following attributes:
{{% /md %}}</dd></dl>
{{% /choosable %}}
