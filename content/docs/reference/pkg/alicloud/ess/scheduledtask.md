...
All [input](#inputs) properties are implicitly available as output properties. The ScheduledTask resource does not produce any additional output properties.
