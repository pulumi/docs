...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RouterInterface resource produces the following computed outputs.
