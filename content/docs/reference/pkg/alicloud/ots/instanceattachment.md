...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the InstanceAttachment resource produces the following computed outputs.
