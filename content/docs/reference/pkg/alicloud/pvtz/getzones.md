...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_zones(</span><span class="nx">enable_details</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
              ...
              <span class="nx">query_region_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">query_vpc_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#bindvpcs_csharp" style="color: inherit; text-decoration: inherit;">Bind<wbr>Vpcs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzoneszonebindvpc">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Pvtz.<wbr>Inputs.<wbr>Get<wbr>Zones<wbr>Zone<wbr>Bind<wbr>Vpc&gt;</a></span>
    </dt>
...
<a href="#bind_vpcs_python" style="color: inherit; text-decoration: inherit;">bind_<wbr>vpcs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzoneszonebindvpc">Sequence[Get<wbr>Zones<wbr>Zone<wbr>Bind<wbr>Vpc]</a></span>
    </dt>
    <dd>{{% md %}}List of the VPCs is bound to the Private Zone:
{{% /md %}}</dd><dt class="property-required"
            title="Required">
