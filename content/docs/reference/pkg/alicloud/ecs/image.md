...
<span class="k">def </span><span class="nx">Image</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">disk_device_mappings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ImageDiskDeviceMappingArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#diskdevicemappings_nodejs" style="color: inherit; text-decoration: inherit;">disk<wbr>Device<wbr>Mappings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagediskdevicemapping">pulumi.<wbr>Input<pulumi.<wbr>Input<Image<wbr>Disk<wbr>Device<wbr>Mapping<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Description of the system with disks and snapshots under the image.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#disk_device_mappings_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>device_<wbr>mappings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagediskdevicemapping">Input[Image<wbr>Disk<wbr>Device<wbr>Mapping<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Description of the system with disks and snapshots under the image.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">resource_group_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">snapshot_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Mapping[str, Any]]]</span> = None<span class="p">) -&gt;</span> Image</code></pre></div>
{{% /choosable %}}
