...
<a href="#diskdevicemappings_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Device<wbr>Mappings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancesinstancediskdevicemapping">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Ecs.<wbr>Inputs.<wbr>Get<wbr>Instances<wbr>Instance<wbr>Disk<wbr>Device<wbr>Mapping&gt;</a></span>
    </dt>
...
<a href="#disk_device_mappings_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>device_<wbr>mappings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancesinstancediskdevicemapping">Sequence[Get<wbr>Instances<wbr>Instance<wbr>Disk<wbr>Device<wbr>Mapping]</a></span>
    </dt>
    <dd>{{% md %}}Description of the attached disks.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
