...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;in_use&#39; has been deprecated from provider version 1.8.0.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#inuse_csharp" style="color: inherit; text-decoration: inherit;">In<wbr>Use</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;in_use&#39; has been deprecated from provider version 1.8.0.{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="ipaddresses_csharp">
<a href="#ipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Addresses</a>
</span>
