...
---
title: "getOssBackupPlans"
title_tag: "alicloud.hbr.getOssBackupPlans"
meta_desc: "Documentation for the alicloud.hbr.getOssBackupPlans function with examples, input properties, output properties, and supporting types."
---
...
## Using getOssBackupPlans {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getOssBackupPlans<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetOssBackupPlansArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetOssBackupPlansResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_oss_backup_plans(</span><span class="nx">bucket</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                         ...
                         <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetOssBackupPlansResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetOssBackupPlans<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetOssBackupPlansArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetOssBackupPlansResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetOssBackupPlans </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetOssBackupPlansResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetOssBackupPlansArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#ids_csharp" style="color: inherit; text-decoration: inherit;">Ids</a>
    ...
    <dd>{{% md %}}A list of OssBackupPlan IDs.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd>{{% md %}}A regex string to filter results by OssBackupPlan name.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
## getOssBackupPlans Result {#result}
...
<a href="#plans_csharp" style="color: inherit; text-decoration: inherit;">Plans</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getossbackupplansplan">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Hbr.<wbr>Outputs.<wbr>Get<wbr>Oss<wbr>Backup<wbr>Plans<wbr>Plan&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bucket_csharp">
...
<a href="#plans_go" style="color: inherit; text-decoration: inherit;">Plans</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getossbackupplansplan">[]Get<wbr>Oss<wbr>Backup<wbr>Plans<wbr>Plan</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bucket_go">
...
<a href="#plans_python" style="color: inherit; text-decoration: inherit;">plans</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getossbackupplansplan">Sequence[Get<wbr>Oss<wbr>Backup<wbr>Plans<wbr>Plan]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bucket_python">
...
<h4 id="getossbackupplansplan">Get<wbr>Oss<wbr>Backup<wbr>Plans<wbr>Plan</h4>
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ossbackupplanid_csharp">
<a href="#ossbackupplanid_csharp" style="color: inherit; text-decoration: inherit;">Oss<wbr>Backup<wbr>Plan<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#id_go" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ossbackupplanid_go">
<a href="#ossbackupplanid_go" style="color: inherit; text-decoration: inherit;">Oss<wbr>Backup<wbr>Plan<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#id_nodejs" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ossbackupplanid_nodejs">
<a href="#ossbackupplanid_nodejs" style="color: inherit; text-decoration: inherit;">oss<wbr>Backup<wbr>Plan<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#id_python" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="oss_backup_plan_id_python">
<a href="#oss_backup_plan_id_python" style="color: inherit; text-decoration: inherit;">oss_<wbr>backup_<wbr>plan_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
