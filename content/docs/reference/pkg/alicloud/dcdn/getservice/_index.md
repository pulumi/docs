...
---
title: "getService"
title_tag: "alicloud.dcdn.getService"
meta_desc: "Documentation for the alicloud.dcdn.getService function with examples, input properties, output properties, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var open = Output.Create(AliCloud.Dcdn.GetService.InvokeAsync(new AliCloud.Dcdn.GetServiceArgs
        {
            Enable = "On",
        }));
    }
