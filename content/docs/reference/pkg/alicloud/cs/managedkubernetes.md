...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ManagedKubernetes resource produces the following computed outputs.
