...
---
title: "getInstances"
title_tag: "alicloud.drds.getInstances"
meta_desc: "Documentation for the alicloud.drds.getInstances function with examples, input properties, output properties, and supporting types."
---
...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;name_regex&#39; is deprecated and will be removed in a future release. Please use &#39;description_regex&#39; instead.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;name_regex&#39; is deprecated and will be removed in a future release. Please use &#39;description_regex&#39; instead.{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="outputfile_csharp">
<a href="#outputfile_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>File</a>
</span>
