...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_clusters(</span><span class="nx">db_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#dbnodes_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclustersclusterdbnode">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Polar<wbr>DB.<wbr>Inputs.<wbr>Get<wbr>Clusters<wbr>Cluster<wbr>Db<wbr>Node&gt;</a></span>
    </dt>
...
<a href="#db_nodes_python" style="color: inherit; text-decoration: inherit;">db_<wbr>nodes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclustersclusterdbnode">Sequence[Get<wbr>Clusters<wbr>Cluster<wbr>Db<wbr>Node]</a></span>
    </dt>
    <dd>{{% md %}}The DBNodes of the PolarDB cluster.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
