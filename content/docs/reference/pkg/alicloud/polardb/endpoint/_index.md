...
meta_desc: "Documentation for the alicloud.polardb.Endpoint resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Endpoint</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">auto_add_new_nodes</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">db_cluster_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">endpoint_config</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, Any]]</span> = None<span class="p">,</span>
...
<a href="#sslconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}(Available in v1.121.0+) The SSL connection string.
...
<a href="#sslexpiretime_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Expire<wbr>Time</a>
    ...
    <dd>{{% md %}}(Available in v1.121.0+) The time when the SSL certificate expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#state_sslenabled_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Enabled</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_sslexpiretime_csharp">
<a href="#state_sslexpiretime_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Expire<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_sslcertificateurl_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Certificate<wbr>Url</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_sslconnectionstring_go">
<a href="#state_sslconnectionstring_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Connection<wbr>String</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_sslenabled_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Enabled</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_sslexpiretime_go">
<a href="#state_sslexpiretime_go" style="color: inherit; text-decoration: inherit;">Ssl<wbr>Expire<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_sslenabled_nodejs" style="color: inherit; text-decoration: inherit;">ssl<wbr>Enabled</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_sslexpiretime_nodejs">
<a href="#state_sslexpiretime_nodejs" style="color: inherit; text-decoration: inherit;">ssl<wbr>Expire<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_ssl_certificate_url_python" style="color: inherit; text-decoration: inherit;">ssl_<wbr>certificate_<wbr>url</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_ssl_connection_string_python">
<a href="#state_ssl_connection_string_python" style="color: inherit; text-decoration: inherit;">ssl_<wbr>connection_<wbr>string</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#state_ssl_enabled_python" style="color: inherit; text-decoration: inherit;">ssl_<wbr>enabled</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_ssl_expire_time_python">
<a href="#state_ssl_expire_time_python" style="color: inherit; text-decoration: inherit;">ssl_<wbr>expire_<wbr>time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
