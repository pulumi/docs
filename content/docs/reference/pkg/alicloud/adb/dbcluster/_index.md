...
---
title: "DBCluster"
title_tag: "alicloud.adb.DBCluster"
meta_desc: "Documentation for the alicloud.adb.DBCluster resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#dbclustercategory_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Category</a>
    ...
    <dd>{{% md %}}The db cluster category. Valid values: `Basic`, `Cluster`, `MixedStorage`.
...
<a href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
    ...
    <dd>{{% md %}}The mode of the cluster. Valid values: `reserver`, `flexible`.
...
<a href="#autorenewperiod_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Renew<wbr>Period</a>
    ...
    <dd>{{% md %}}Auto-renewal period of an cluster, in the unit of the month. It is valid when `payment_type` is `Subscription`. Valid values: `1`, `2`, `3`, `6`, `12`, `24`, `36`. Default to `1`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#computeresource_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Resource</a>
    ...
    <dd>{{% md %}}The specifications of computing resources in elastic mode. The increase of resources can speed up queries. AnalyticDB for MySQL automatically scales computing resources. For more information, see [ComputeResource](https://www.alibabacloud.com/help/en/doc-detail/144851.htm)
...
<a href="#dbclusterclass_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Class</a>
    ...
    <dd>{{% md %}}It duplicates with attribute db_node_class and is deprecated from 1.121.2.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}It duplicates with attribute db_node_class and is deprecated from 1.121.2.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#dbclusterversion_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Version</a>
    ...
    <dd>{{% md %}}The db cluster version. Value options: `3.0`, Default to `3.0`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dbnodeclass_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Node<wbr>Class</a>
    ...
    <dd>{{% md %}}The db node class. For more information, see [DBClusterClass](https://help.aliyun.com/document_detail/190519.html)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of DBCluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintaintime_csharp" style="color: inherit; text-decoration: inherit;">Maintain<wbr>Time</a>
    ...
    <dd>{{% md %}}The maintenance window of the cluster. Format: hh:mmZ-hh:mmZ.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#paytype_csharp" style="color: inherit; text-decoration: inherit;">Pay<wbr>Type</a>
    ...
    <dd>{{% md %}}Field `pay_type` has been deprecated. New field `payment_type` instead.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#paymenttype_csharp" style="color: inherit; text-decoration: inherit;">Payment<wbr>Type</a>
    ...
    <dd>{{% md %}}The payment type of the resource. Valid values are `PayAsYouGo` and `Subscription`. Default to `PayAsYouGo`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#connectionstring_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>String</a>
    ...
    <dd>{{% md %}}The endpoint of the cluster.
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, Any]]</span> = None<span class="p">,</span>
        <span class="nx">vswitch_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">zone_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> DBCluster</code></pre></div>
{{% /choosable %}}
