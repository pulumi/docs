...
All [input](#inputs) properties are implicitly available as output properties. The DdosBgpInstance resource does not produce any additional output properties.
