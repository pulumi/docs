...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_accounts(</span><span class="nx">enable_details</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
<a href="#payeraccountid_csharp" style="color: inherit; text-decoration: inherit;">Payer<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}(Available in v1.124.3+) Settlement account ID. If the value is empty, the current account will be used for settlement.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
