...
<a href="#capabilities_go" style="color: inherit; text-decoration: inherit;">Capabilities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumecapability">[]Volume<wbr>Capability</a></span>
    </dt>
    <dd>{{% md %}}Capabilities intended to be used in a job. At least one capability must be provided.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mountoptions_go" style="color: inherit; text-decoration: inherit;">Mount<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumemountoptions">Volume<wbr>Mount<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}Options for mounting 'block-device' volumes without a pre-formatted file system.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
