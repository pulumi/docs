...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AuthConfigOkta resource produces the following computed outputs.
