...
<p class="resource-deprecated">Deprecated: {{% md %}}rancher2.RoleTempalte has been deprecated in favor of rancher2.RoleTemplate{{% /md %}}</p>
...
<a href="#administrative_csharp" style="color: inherit; text-decoration: inherit;">Administrative</a>
    ...
    <dd>{{% md %}}Administrative role template
...
<a href="#defaultrole_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Role</a>
    ...
    <dd>{{% md %}}Default role template for new created cluster or project
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Role template policy description
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Role template policy name
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#roletemplateids_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Template<wbr>Ids</a>
    ...
    <dd>{{% md %}}Inherit role template IDs
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_csharp" style="color: inherit; text-decoration: inherit;">Rules</a>
    ...
    <dd>{{% md %}}Role template policy rules
{{% /md %}}</dd></dl>
{{% /choosable %}}
