...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RoleTempalte resource produces the following computed outputs.
