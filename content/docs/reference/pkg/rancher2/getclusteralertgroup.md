...
<a href="#recipients_python" style="color: inherit; text-decoration: inherit;">recipients</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getclusteralertgrouprecipient">Sequence[Get<wbr>Cluster<wbr>Alert<wbr>Group<wbr>Recipient]</a></span>
    </dt>
    <dd>{{% md %}}(Computed) The cluster alert group recipients (list)
{{% /md %}}</dd>
