...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AuthConfigPing resource produces the following computed outputs.
