...
All [input](#inputs) properties are implicitly available as output properties. The GroupAssignment resource does not produce any additional output properties.
