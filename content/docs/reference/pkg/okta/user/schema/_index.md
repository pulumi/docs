...
<span class="k">def </span><span class="nx">Schema</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">array_one_ofs</span><span class="p">:</span> <span class="nx">Optional[Sequence[SchemaArrayOneOfArgs]]</span> = None<span class="p">,</span>
           ...
           <span class="nx">master_override_priorities</span><span class="p">:</span> <span class="nx">Optional[Sequence[SchemaMasterOverridePriorityArgs]]</span> = None<span class="p">,</span>
           ...
           <span class="nx">one_ofs</span><span class="p">:</span> <span class="nx">Optional[Sequence[SchemaOneOfArgs]]</span> = None<span class="p">,</span>
...
<a href="#arrayoneofs_go" style="color: inherit; text-decoration: inherit;">Array<wbr>One<wbr>Ofs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schemaarrayoneof">[]Schema<wbr>Array<wbr>One<wbr>Of<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Display name and value an enum array can be set to.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#masteroverridepriorities_go" style="color: inherit; text-decoration: inherit;">Master<wbr>Override<wbr>Priorities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schemamasteroverridepriority">[]Schema<wbr>Master<wbr>Override<wbr>Priority<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Prioritized list of profile sources (required when `master` is `"OVERRIDE"`).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#oneofs_go" style="color: inherit; text-decoration: inherit;">One<wbr>Ofs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schemaoneof">[]Schema<wbr>One<wbr>Of<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Array of maps containing a mapping for display name to enum value.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">unique</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">user_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> Schema</code></pre></div>
{{% /choosable %}}
