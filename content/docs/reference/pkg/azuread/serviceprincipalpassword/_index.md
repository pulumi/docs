...
<a href="#startdate_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Date</a>
    ...
    <dd>{{% md %}}The start date from which the password is valid, formatted as an RFC3339 date string (e.g. `2018-01-01T01:02:03Z`).
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}The password for this service principal, which is generated by Azure Active Directory.
{{% /md %}}</dd></dl>
{{% /choosable %}}
