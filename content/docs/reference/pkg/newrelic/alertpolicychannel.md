...
All [input](#inputs) properties are implicitly available as output properties. The AlertPolicyChannel resource does not produce any additional output properties.
