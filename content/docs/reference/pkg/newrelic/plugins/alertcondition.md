...
meta_desc: "Explore the AlertCondition resource of the plugins module, including examples, input properties, output properties, lookup functions, and supporting types. Use this resource to create and manage plugins alert conditions in New Relic."
---
