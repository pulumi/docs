...
<span class="k">def </span><span class="nx">ListChart</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">color_scales</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ListChartColorScaleArgs]]]]</span> = None<span class="p">,</span>
              ...
              <span class="nx">hide_missing_values</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
              ...
              <span class="nx">legend_options_fields</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ListChartLegendOptionsFieldArgs]]]]</span> = None<span class="p">,</span>
              ...
              <span class="nx">viz_options</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ListChartVizOptionArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#colorscales_nodejs" style="color: inherit; text-decoration: inherit;">color<wbr>Scales</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartcolorscale">pulumi<wbr>Input<pulumi<wbr>Input<List<wbr>Chart<wbr>Color<wbr>Scale<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Single color range including both the color to display for that range and the borders of the range. Example: `[{ gt = 60, color = "blue" }, { lte = 60, color = "yellow" }]`. Look at this [link](https://docs.signalfx.com/en/latest/charts/chart-options-tab.html).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#legendoptionsfields_nodejs" style="color: inherit; text-decoration: inherit;">legend<wbr>Options<wbr>Fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartlegendoptionsfield">pulumi<wbr>Input<pulumi<wbr>Input<List<wbr>Chart<wbr>Legend<wbr>Options<wbr>Field<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of property names and enabled flags that should be displayed in the data table for the chart, in the order provided. This option cannot be used with `legend_fields_to_hide`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vizoptions_nodejs" style="color: inherit; text-decoration: inherit;">viz<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartvizoption">pulumi<wbr>Input<pulumi<wbr>Input<List<wbr>Chart<wbr>Viz<wbr>Option<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Plot-level customization options, associated with a publish statement.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#color_scales_python" style="color: inherit; text-decoration: inherit;">color_<wbr>scales</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartcolorscale">Input[List<wbr>Chart<wbr>Color<wbr>Scale<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Single color range including both the color to display for that range and the borders of the range. Example: `[{ gt = 60, color = "blue" }, { lte = 60, color = "yellow" }]`. Look at this [link](https://docs.signalfx.com/en/latest/charts/chart-options-tab.html).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#legend_options_fields_python" style="color: inherit; text-decoration: inherit;">legend_<wbr>options_<wbr>fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartlegendoptionsfield">Input[List<wbr>Chart<wbr>Legend<wbr>Options<wbr>Field<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}List of property names and enabled flags that should be displayed in the data table for the chart, in the order provided. This option cannot be used with `legend_fields_to_hide`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#viz_options_python" style="color: inherit; text-decoration: inherit;">viz_<wbr>options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listchartvizoption">Input[List<wbr>Chart<wbr>Viz<wbr>Option<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Plot-level customization options, associated with a publish statement.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">viz_options</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ListChartVizOptionArgs]]]]</span> = None<span class="p">) -&gt;</span> ListChart</code></pre></div>
{{% /choosable %}}
