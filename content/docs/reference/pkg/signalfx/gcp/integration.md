...
<span class="k">def </span><span class="nx">Integration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">project_service_keys</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[IntegrationProjectServiceKeyArgs]]]]</span> = None<span class="p">,</span>
                ...
                <span class="nx">whitelists</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">)</span>
...
<a href="#projectservicekeys_nodejs" style="color: inherit; text-decoration: inherit;">project<wbr>Service<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationprojectservicekey">pulumi.<wbr>Input<pulumi.<wbr>Input<Integration<wbr>Project<wbr>Service<wbr>Key<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}GCP projects to add.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#project_service_keys_python" style="color: inherit; text-decoration: inherit;">project_<wbr>service_<wbr>keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationprojectservicekey">Input[Integration<wbr>Project<wbr>Service<wbr>Key<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}GCP projects to add.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">project_service_keys</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[IntegrationProjectServiceKeyArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">services</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
        <span class="nx">whitelists</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">) -&gt;</span> Integration</code></pre></div>
{{% /choosable %}}
