...
---
title: "getApi"
title_tag: "azure.apimanagement.getApi"
meta_desc: "Documentation for the azure.apimanagement.getApi function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_api(</span><span class="nx">api_management_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#subscription_key_parameter_names_python" style="color: inherit; text-decoration: inherit;">subscription_<wbr>key_<wbr>parameter_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getapisubscriptionkeyparametername">Sequence[Get<wbr>Api<wbr>Subscription<wbr>Key<wbr>Parameter<wbr>Name]</a></span>
    </dt>
    <dd>{{% md %}}A `subscription_key_parameter_names` block as documented below.
{{% /md %}}</dd><dt class="property-"
            title="">
