...
<span class="k">def </span><span class="nx">Logger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">application_insights</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[LoggerApplicationInsightsArgs]]</span> = None<span class="p">,</span>
           <span class="nx">buffered</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
           <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
           <span class="nx">eventhub</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[LoggerEventhubArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewLogger</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">LoggerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Logger</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#applicationinsights_nodejs" style="color: inherit; text-decoration: inherit;">application<wbr>Insights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loggerapplicationinsights">pulumi.<wbr>Input<Logger<wbr>Application<wbr>Insights<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An `application_insights` block as documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#eventhub_nodejs" style="color: inherit; text-decoration: inherit;">eventhub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loggereventhub">pulumi.<wbr>Input<Logger<wbr>Eventhub<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An `eventhub` block as documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#application_insights_python" style="color: inherit; text-decoration: inherit;">application_<wbr>insights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loggerapplicationinsights">Input[Logger<wbr>Application<wbr>Insights<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An `application_insights` block as documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#eventhub_python" style="color: inherit; text-decoration: inherit;">eventhub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loggereventhub">Input[Logger<wbr>Eventhub<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An `eventhub` block as documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
