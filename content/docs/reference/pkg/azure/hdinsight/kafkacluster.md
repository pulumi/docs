...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the KafkaCluster resource produces the following computed outputs.
