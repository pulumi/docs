...
<a href="#installscriptactions_nodejs" style="color: inherit; text-decoration: inherit;">install<wbr>Script<wbr>Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hadoopclusterrolesedgenodeinstallscriptaction">Hadoop<wbr>Cluster<wbr>Roles<wbr>Edge<wbr>Node<wbr>Install<wbr>Script<wbr>Action<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}A `install_script_action` block as defined below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
