...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Remediation</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>location_filters=None<span class="p">, </span>name=None<span class="p">, </span>policy_assignment_id=None<span class="p">, </span>policy_definition_reference_id=None<span class="p">, </span>scope=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
The Remediation resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
