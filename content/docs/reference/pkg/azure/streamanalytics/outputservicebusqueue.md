...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Streamanalytics.OutputServiceBusQueue.html">OutputServiceBusQueue</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.StreamAnalytics.Inputs.OutputServiceBusQueueArgs.html">OutputServiceBusQueueArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outputservicebusqueueserialization">Pulumi.<wbr>Azure.<wbr>Stream<wbr>Analytics.<wbr>Inputs.<wbr>Output<wbr>Service<wbr>Bus<wbr>Queue<wbr>Serialization<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Serialization</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outputservicebusqueueserialization">Pulumi.<wbr>Azure.<wbr>Stream<wbr>Analytics.<wbr>Outputs.<wbr>Output<wbr>Service<wbr>Bus<wbr>Queue<wbr>Serialization</a></span>
    </dt>
    <dd>{{% md %}}A `serialization` block as defined below.
{{% /md %}}</dd>
