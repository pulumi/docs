...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#streaminputiothubserialization">Pulumi.<wbr>Azure.<wbr>Stream<wbr>Analytics.<wbr>Inputs.<wbr>Stream<wbr>Input<wbr>Iot<wbr>Hub<wbr>Serialization<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Serialization</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#streaminputiothubserialization">Pulumi.<wbr>Azure.<wbr>Stream<wbr>Analytics.<wbr>Outputs.<wbr>Stream<wbr>Input<wbr>Iot<wbr>Hub<wbr>Serialization</a></span>
    </dt>
    <dd>{{% md %}}A `serialization` block as defined below.
{{% /md %}}</dd>
