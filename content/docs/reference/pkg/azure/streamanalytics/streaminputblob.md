...
All [input](#inputs) properties are implicitly available as output properties. The StreamInputBlob resource does not produce any additional output properties.
