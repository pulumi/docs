...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_template_spec_version(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetTemplateSpecVersion<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetTemplateSpecVersionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetTemplateSpecVersionResult</a></span>, error)</span></code></pre></div>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of this Template Spec.
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Resource Group where the Template Spec exists.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}The Version Name of the Template Spec.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A mapping of tags assigned to the Template.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#templatebody_csharp" style="color: inherit; text-decoration: inherit;">Template<wbr>Body</a>
    ...
    <dd>{{% md %}}The ARM Template body of the Template Spec Version.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="version_csharp">
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
