...
All [input](#inputs) properties are implicitly available as output properties. The NetworkSecurityGroup resource does not produce any additional output properties.
