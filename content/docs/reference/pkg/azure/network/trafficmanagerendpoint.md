...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the TrafficManagerEndpoint resource produces the following computed outputs.
