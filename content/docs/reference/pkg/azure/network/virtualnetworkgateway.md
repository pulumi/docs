...
meta_desc: "Documentation for the azure.network.VirtualNetworkGateway resource with examples, input properties, output properties, lookup functions, and supporting types."
---
