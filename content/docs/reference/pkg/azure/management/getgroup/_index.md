...
---
title: "getGroup"
title_tag: "azure.management.getGroup"
meta_desc: "Documentation for the azure.management.getGroup function with examples, input properties, output properties, and supporting types."
---
...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Deprecated in favour of `name`{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a href="#groupid_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Deprecated in favour of `name`{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="id_csharp">
