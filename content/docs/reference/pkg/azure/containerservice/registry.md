...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Containerservice.Registry.html">Registry</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.ContainerService.Inputs.RegistryArgs.html">RegistryArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrynetworkruleset">Pulumi.<wbr>Azure.<wbr>Container<wbr>Service.<wbr>Inputs.<wbr>Registry<wbr>Network<wbr>Rule<wbr>Set<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Network<wbr>Rule<wbr>Set</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrynetworkruleset">Pulumi.<wbr>Azure.<wbr>Container<wbr>Service.<wbr>Outputs.<wbr>Registry<wbr>Network<wbr>Rule<wbr>Set</a></span>
    </dt>
    <dd>{{% md %}}A `network_rule_set` block as documented below.
{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrynetworkrulesetiprule">List&lt;Pulumi.<wbr>Azure.<wbr>Container<wbr>Service.<wbr>Inputs.<wbr>Registry<wbr>Network<wbr>Rule<wbr>Set<wbr>Ip<wbr>Rule<wbr>Args&gt;?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrynetworkrulesetvirtualnetwork">List&lt;Pulumi.<wbr>Azure.<wbr>Container<wbr>Service.<wbr>Inputs.<wbr>Registry<wbr>Network<wbr>Rule<wbr>Set<wbr>Virtual<wbr>Network<wbr>Args&gt;?</a></span>
    </dt>
