...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Siterecovery.ReplicatedVM.html">ReplicatedVM</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.SiteRecovery.Inputs.ReplicatedVMArgs.html">ReplicatedVMArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replicatedvmmanageddisk">List&lt;Pulumi.<wbr>Azure.<wbr>Site<wbr>Recovery.<wbr>Inputs.<wbr>Replicated<wbr>VMManaged<wbr>Disk<wbr>Args&gt;?</a></span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-"
        ...
        <span>Managed<wbr>Disks</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replicatedvmmanageddisk">List&lt;Pulumi.<wbr>Azure.<wbr>Site<wbr>Recovery.<wbr>Outputs.<wbr>Replicated<wbr>VMManaged<wbr>Disk&gt;?</a></span>
    </dt>
    <dd>{{% md %}}One or more `managed_disk` block.
{{% /md %}}</dd>
