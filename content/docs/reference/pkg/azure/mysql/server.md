...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverstorageprofile">Pulumi.<wbr>Azure.<wbr>My<wbr>Sql.<wbr>Inputs.<wbr>Server<wbr>Storage<wbr>Profile<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Storage<wbr>Profile</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverstorageprofile">Pulumi.<wbr>Azure.<wbr>My<wbr>Sql.<wbr>Outputs.<wbr>Server<wbr>Storage<wbr>Profile</a></span>
    </dt>
    <dd>{{% md %}}A `storage_profile` block as defined below.
{{% /md %}}</dd>
