...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetsqlservertableschemacolumn">List&lt;Pulumi.<wbr>Azure.<wbr>Data<wbr>Factory.<wbr>Inputs.<wbr>Dataset<wbr>Sql<wbr>Server<wbr>Table<wbr>Schema<wbr>Column<wbr>Args&gt;?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Schema<wbr>Columns</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetsqlservertableschemacolumn">List&lt;Pulumi.<wbr>Azure.<wbr>Data<wbr>Factory.<wbr>Outputs.<wbr>Dataset<wbr>Sql<wbr>Server<wbr>Table<wbr>Schema<wbr>Column&gt;?</a></span>
    </dt>
    <dd>{{% md %}}A `schema_column` block as defined below.
{{% /md %}}</dd>
