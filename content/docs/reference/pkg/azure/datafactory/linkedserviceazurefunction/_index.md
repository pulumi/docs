...
<span class="k">def </span><span class="nx">LinkedServiceAzureFunction</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">key_vault_key</span><span class="p">:</span> <span class="nx">Optional[LinkedServiceAzureFunctionKeyVaultKeyArgs]</span> = None<span class="p">,</span>
...
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>{{% md %}}The system key of the Azure Function. Exactly one of either `key` or `key_vault_key` is required
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#keyvaultkey_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Vault<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#linkedserviceazurefunctionkeyvaultkey">Linked<wbr>Service<wbr>Azure<wbr>Function<wbr>Key<wbr>Vault<wbr>Key<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}A `key_vault_key` block as defined below. Use this Argument to store the system key of the Azure Function in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. Exactly one of either `key` or `key_vault_key` is required.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<h4 id="linkedserviceazurefunctionkeyvaultkey">Linked<wbr>Service<wbr>Azure<wbr>Function<wbr>Key<wbr>Vault<wbr>Key</h4>
...
<a href="#secretname_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Name</a>
    ...
    <dd>{{% md %}}Specifies the secret name in Azure Key Vault that stores the system key of the Azure Function.
{{% /md %}}</dd></dl>
{{% /choosable %}}
