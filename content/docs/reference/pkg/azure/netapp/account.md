...
<span class="k">def </span><span class="nx">Account</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">active_directory</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[AccountActiveDirectoryArgs]]</span> = None<span class="p">,</span>
...
<a href="#activedirectory_nodejs" style="color: inherit; text-decoration: inherit;">active<wbr>Directory</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountactivedirectory">pulumi.<wbr>Input<Account<wbr>Active<wbr>Directory<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A `active_directory` block as defined below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#active_directory_python" style="color: inherit; text-decoration: inherit;">active_<wbr>directory</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountactivedirectory">Input[Account<wbr>Active<wbr>Directory<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A `active_directory` block as defined below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
