...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the EventHubNamespaceAuthorizationRule resource produces the following computed outputs.
