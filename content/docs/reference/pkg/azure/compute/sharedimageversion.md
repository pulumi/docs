...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">SharedImageVersion</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>exclude_from_latest=None<span class="p">, </span>gallery_name=None<span class="p">, </span>image_name=None<span class="p">, </span>location=None<span class="p">, </span>managed_image_id=None<span class="p">, </span>name=None<span class="p">, </span>resource_group_name=None<span class="p">, </span>tags=None<span class="p">, </span>target_regions=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
