...
<span class="k">def </span><span class="nx">Vault</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">identity</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[VaultIdentityArgs]]</span> = None<span class="p">,</span>
...
<a href="#identity_nodejs" style="color: inherit; text-decoration: inherit;">identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vaultidentity">pulumi.<wbr>Input<Vault<wbr>Identity<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An `identity` block as defined below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#identity_python" style="color: inherit; text-decoration: inherit;">identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vaultidentity">Input[Vault<wbr>Identity<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An `identity` block as defined below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
