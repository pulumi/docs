...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serveripv4firewallrule">List&lt;Pulumi.<wbr>Azure.<wbr>Analysis<wbr>Services.<wbr>Inputs.<wbr>Server<wbr>Ipv4Firewall<wbr>Rule<wbr>Args&gt;?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Ipv4Firewall<wbr>Rules</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serveripv4firewallrule">List&lt;Pulumi.<wbr>Azure.<wbr>Analysis<wbr>Services.<wbr>Outputs.<wbr>Server<wbr>Ipv4Firewall<wbr>Rule&gt;?</a></span>
    </dt>
    <dd>{{% md %}}One or more `ipv4_firewall_rule` block(s) as defined below.
{{% /md %}}</dd>
