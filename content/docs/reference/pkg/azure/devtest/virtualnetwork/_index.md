...
<span class="k">def </span><span class="nx">VirtualNetwork</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">subnet</span><span class="p">:</span> <span class="nx">Optional[VirtualNetworkSubnetArgs]</span> = None<span class="p">,</span>
...
<a href="#labname_csharp" style="color: inherit; text-decoration: inherit;">Lab<wbr>Name</a>
    ...
    <dd>{{% md %}}Specifies the name of the Dev Test Lab in which the Virtual Network should be created. Changing this forces a new resource to be created.
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}A description for the Virtual Network.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Specifies the name of the Dev Test Virtual Network. Changing this forces a new resource to be created.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#uniqueidentifier_csharp" style="color: inherit; text-decoration: inherit;">Unique<wbr>Identifier</a>
    ...
    <dd>{{% md %}}The unique immutable identifier of the Dev Test Virtual Network.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">subnet</span><span class="p">:</span> <span class="nx">Optional[VirtualNetworkSubnetArgs]</span> = None<span class="p">,</span>
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">,</span>
        <span class="nx">unique_identifier</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> VirtualNetwork</code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="useinvirtualmachinecreation_csharp">
<a href="#useinvirtualmachinecreation_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>In<wbr>Virtual<wbr>Machine<wbr>Creation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Can this subnet be used for creating Virtual Machines? Possible values are `Allow`, `Default` and `Deny`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="usepublicipaddress_csharp">
<a href="#usepublicipaddress_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Public<wbr>Ip<wbr>Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Can Virtual Machines in this Subnet use Public IP Addresses? Possible values are `Allow`, `Default` and `Deny`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="useinvirtualmachinecreation_go">
<a href="#useinvirtualmachinecreation_go" style="color: inherit; text-decoration: inherit;">Use<wbr>In<wbr>Virtual<wbr>Machine<wbr>Creation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="usepublicipaddress_go">
<a href="#usepublicipaddress_go" style="color: inherit; text-decoration: inherit;">Use<wbr>Public<wbr>Ip<wbr>Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="useinvirtualmachinecreation_nodejs">
<a href="#useinvirtualmachinecreation_nodejs" style="color: inherit; text-decoration: inherit;">use<wbr>In<wbr>Virtual<wbr>Machine<wbr>Creation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="usepublicipaddress_nodejs">
<a href="#usepublicipaddress_nodejs" style="color: inherit; text-decoration: inherit;">use<wbr>Public<wbr>Ip<wbr>Address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="use_in_virtual_machine_creation_python">
<a href="#use_in_virtual_machine_creation_python" style="color: inherit; text-decoration: inherit;">use_<wbr>in_<wbr>virtual_<wbr>machine_<wbr>creation</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="use_public_ip_address_python">
<a href="#use_public_ip_address_python" style="color: inherit; text-decoration: inherit;">use_<wbr>public_<wbr>ip_<wbr>address</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
