...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.Eventgrid.Domain.html">Domain</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Azure/Pulumi.Azure.EventGrid.Inputs.DomainArgs.html">DomainArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domaininputmappingdefaultvalues">Pulumi.<wbr>Azure.<wbr>Event<wbr>Grid.<wbr>Inputs.<wbr>Domain<wbr>Input<wbr>Mapping<wbr>Default<wbr>Values<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domaininputmappingfields">Pulumi.<wbr>Azure.<wbr>Event<wbr>Grid.<wbr>Inputs.<wbr>Domain<wbr>Input<wbr>Mapping<wbr>Fields<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Input<wbr>Mapping<wbr>Default<wbr>Values</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domaininputmappingdefaultvalues">Pulumi.<wbr>Azure.<wbr>Event<wbr>Grid.<wbr>Outputs.<wbr>Domain<wbr>Input<wbr>Mapping<wbr>Default<wbr>Values?</a></span>
    </dt>
    <dd>{{% md %}}A `input_mapping_default_values` block as defined below.
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Input<wbr>Mapping<wbr>Fields</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domaininputmappingfields">Pulumi.<wbr>Azure.<wbr>Event<wbr>Grid.<wbr>Outputs.<wbr>Domain<wbr>Input<wbr>Mapping<wbr>Fields?</a></span>
    </dt>
    <dd>{{% md %}}A `input_mapping_fields` block as defined below.
{{% /md %}}</dd>
