...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the DpsSharedAccessPolicy resource produces the following computed outputs.
