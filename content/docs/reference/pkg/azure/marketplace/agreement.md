...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Agreement</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>offer=None<span class="p">, </span>plan=None<span class="p">, </span>publisher=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
The Agreement resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
