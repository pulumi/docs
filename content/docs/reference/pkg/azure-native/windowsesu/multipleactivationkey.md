...
<span class="k">def </span><span class="nx">MultipleActivationKey</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">agreement_number</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          <span class="nx">installed_server_number</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
                          <span class="nx">is_eligible</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                          <span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          <span class="nx">multiple_activation_key_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          ...
                          <span class="nx">support_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, SupportType]]]</span> = None<span class="p">,</span>
...
<a href="#supporttype_nodejs" style="color: inherit; text-decoration: inherit;">support<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#supporttype">pulumi.<wbr>Input<Support<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Type of support{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_nodejs">
...
<a href="#support_type_python" style="color: inherit; text-decoration: inherit;">support_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#supporttype">Input[Support<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Type of support{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_python">
