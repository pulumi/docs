...
title_tag: "azure-native.keyvault.getPrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.keyvault.getPrivateEndpointConnection function with examples, input properties, output properties, and supporting types."
---
...
<a href="#privateendpointconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the private endpoint connection associated with the key vault.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the resource group that contains the key vault.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#vaultname_csharp" style="color: inherit; text-decoration: inherit;">Vault<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the key vault.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}Modified whenever there is a change in the state of private endpoint connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}Properties of the private endpoint object.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="privatelinkserviceconnectionstate_csharp">
<a href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstateresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Key<wbr>Vault.<wbr>Outputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Response</a></span>
    </dt>
