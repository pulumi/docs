...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_network(</span><span class="nx">network_resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#networkresourcename_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The identity of the network.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}Describes properties of a network resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
