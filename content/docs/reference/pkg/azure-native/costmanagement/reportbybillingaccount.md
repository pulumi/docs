...
class MyStack : Stack
{
    public MyStack()
    {
        var reportByBillingAccount = new AzureNative.CostManagement.ReportByBillingAccount("reportByBillingAccount", new AzureNative.CostManagement.ReportByBillingAccountArgs
        {
...
const reportByBillingAccount = new azure_native.costmanagement.ReportByBillingAccount("reportByBillingAccount", {
    billingAccountId: "123456",
    definition: {
        dataset: {
            aggregation: {
