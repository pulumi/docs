...
title_tag: "azure-native.costmanagement.getReportConfig"
meta_desc: "Documentation for the azure-native.costmanagement.getReportConfig function with examples, input properties, output properties, and supporting types."
---
...
<a href="#reportconfigname_csharp" style="color: inherit; text-decoration: inherit;">Report<wbr>Config<wbr>Name</a>
    ...
    <dd>{{% md %}}Report Config Name.{{% /md %}}</dd></dl>
{{% /choosable %}}
