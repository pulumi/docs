...
---
title: "ReportConfig"
title_tag: "azure-native.costmanagement.ReportConfig"
meta_desc: "Documentation for the azure-native.costmanagement.ReportConfig resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var reportConfig = new AzureNative.CostManagement.ReportConfig("reportConfig", new AzureNative.CostManagement.ReportConfigArgs
        {
            Definition = new AzureNative.CostManagement.Inputs.ReportConfigDefinitionArgs
            {
                Dataset = new AzureNative.CostManagement.Inputs.ReportConfigDatasetArgs
                {
                    Aggregation = 
                    {
                        { "costSum", new AzureNative.CostManagement.Inputs.ReportConfigAggregationArgs
                        {
                            Function = "Sum",
                            Name = "PreTaxCost",
                        } },
                    ...
                    Filter = new AzureNative.CostManagement.Inputs.ReportConfigFilterArgs
                    {
                        And = 
                        {
                            new AzureNative.CostManagement.Inputs.ReportConfigFilterArgs
                            {
                                Or = 
                                {
                                    ,
            ...
            DeliveryInfo = new AzureNative.CostManagement.Inputs.ReportConfigDeliveryInfoArgs
            {
                Destination = new AzureNative.CostManagement.Inputs.ReportConfigDeliveryDestinationArgs
                {
                    Container = "reports",
            ...
            Schedule = new AzureNative.CostManagement.Inputs.ReportConfigScheduleArgs
            {
                Recurrence = "Weekly",
                RecurrencePeriod = new AzureNative.CostManagement.Inputs.ReportConfigRecurrencePeriodArgs
                {
...
report_config = azure_native.costmanagement.ReportConfig("reportConfig",
    definition=azure_native.costmanagement.ReportConfigDefinitionArgs(
        dataset=azure_native.costmanagement.ReportConfigDatasetArgs(
            aggregation={
                "costSum": azure_native.costmanagement.ReportConfigAggregationArgs(
                    function="Sum",
                    name="PreTaxCost",
                ),
            },
            configuration=azure_native.costmanagement.ReportConfigDatasetConfigurationArgs(
                columns=[
                    "Date",
                    "MeterId",
                    "InstanceId",
            ...
            filter=azure_native.costmanagement.ReportConfigFilterArgs(
                and_=[
                    azure_native.costmanagement.ReportConfigFilterArgs(
                        or_=[
                            azure_native.costmanagement.ReportConfigFilterArgs(),
                            azure_native.costmanagement.ReportConfigFilterArgs(),
                        ],
            ...
            granularity="Daily",
            grouping=[
                azure_native.costmanagement.ReportConfigGroupingArgs(
                    name="SubscriptionName",
                ),
                azure_native.costmanagement.ReportConfigGroupingArgs(
                    name="Environment",
    ...
    delivery_info=azure_native.costmanagement.ReportConfigDeliveryInfoArgs(
        destination=azure_native.costmanagement.ReportConfigDeliveryDestinationArgs(
            container="reports",
    ...
    schedule=azure_native.costmanagement.ReportConfigScheduleArgs(
        recurrence="Weekly",
        recurrence_period=azure_native.costmanagement.ReportConfigRecurrencePeriodArgs(
            from_="2018-06-01T00:00:00Z",
            to="2018-10-31T00:00:00Z",
        ),
        status="Active",
    ))
...
const reportConfig = new azure_native.costmanagement.ReportConfig("reportConfig", {
    definition: {
        dataset: {
            aggregation: {
                costSum: {
...
<a href="#deliveryinfo_csharp" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Info</a>
    ...
    <dd>{{% md %}}Has delivery information for the report config.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
```sh
$ pulumi import azure-native:costmanagement:ReportConfig TestReportConfig subscriptions/{subscription-id}/providers/Microsoft.Consumption/reportconfigs/TestReportConfig 
```
