...
title_tag: "azure-native.costmanagement.ReportConfigByResourceGroupName"
meta_desc: "Documentation for the azure-native.costmanagement.ReportConfigByResourceGroupName resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var reportConfigByResourceGroupName = new AzureNative.CostManagement.ReportConfigByResourceGroupName("reportConfigByResourceGroupName", new AzureNative.CostManagement.ReportConfigByResourceGroupNameArgs
        {
...
report_config_by_resource_group_name = azure_native.costmanagement.ReportConfigByResourceGroupName("reportConfigByResourceGroupName",
    definition={
...
const reportConfigByResourceGroupName = new azure_native.costmanagement.ReportConfigByResourceGroupName("reportConfigByResourceGroupName", {
    definition: {
        dataset: {
            aggregation: {
                costSum: {
...
```sh
$ pulumi import azure-native:costmanagement:ReportConfigByResourceGroupName TestReportConfig subscriptions/{subscription-id}/providers/Microsoft.Consumption/reportconfigs/TestReportConfig 
```
