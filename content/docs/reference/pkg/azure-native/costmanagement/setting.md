...
<span class="k">def </span><span class="nx">Setting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">cache</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[SettingsPropertiesCacheArgs]]]]</span> = None<span class="p">,</span>
            ...
            <span class="nx">start_on</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span>
...
<a href="#cache_nodejs" style="color: inherit; text-decoration: inherit;">cache</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#settingspropertiescache">pulumi.<wbr>Input<pulumi.<wbr>Input<Settings<wbr>Properties<wbr>Cache<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Array of scopes with additional details used by Cost Management in the Azure portal.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#cache_python" style="color: inherit; text-decoration: inherit;">cache</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#settingspropertiescache">Input[Settings<wbr>Properties<wbr>Cache<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Array of scopes with additional details used by Cost Management in the Azure portal.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
