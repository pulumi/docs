...
class MyStack : Stack
{
    public MyStack()
    {
        var reportByDepartment = new AzureNative.CostManagement.ReportByDepartment("reportByDepartment", new AzureNative.CostManagement.ReportByDepartmentArgs
        {
...
const reportByDepartment = new azure_native.costmanagement.ReportByDepartment("reportByDepartment", {
    definition: {
        dataset: {
            aggregation: {
                costSum: {
...
<span class="k">def </span><span class="nx">ReportByDepartment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">department_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
