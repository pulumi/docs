...
class MyStack : Stack
{
    public MyStack()
    {
        var report = new AzureNative.CostManagement.Report("report", new AzureNative.CostManagement.ReportArgs
        {
...
const report = new azure_native.costmanagement.Report("report", {
    definition: {
        dataset: {
            aggregation: {
                costSum: {
...
```sh
$ pulumi import azure-native:costmanagement:Report TestReport subscriptions/{subscription-id}/providers/Microsoft.CostManagement/reports/TestReport 
```
