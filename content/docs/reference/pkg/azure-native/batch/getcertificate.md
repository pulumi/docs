...
title_tag: "azure-native.batch.getCertificate"
meta_desc: "Documentation for the azure-native.batch.getCertificate function with examples, input properties, output properties, and supporting types."
---
...
<a href="#certificatename_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Name</a>
    ...
    <dd>{{% md %}}The identifier for the certificate. This must be made up of algorithm and thumbprint separated by a dash, and must match the certificate data in the request. For example SHA1-a3d1c5.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#format_csharp" style="color: inherit; text-decoration: inherit;">Format</a>
    ...
    <dd>{{% md %}}The format of the certificate - either Pfx or Cer. If omitted, the default is Pfx.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#thumbprint_csharp" style="color: inherit; text-decoration: inherit;">Thumbprint</a>
    ...
    <dd>{{% md %}}This must match the thumbprint from the name.{{% /md %}}</dd><dt class="property-"
            title="">
