...
---
title: "Pool"
title_tag: "azure-native.batch.Pool"
meta_desc: "Documentation for the azure-native.batch.Pool resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Pool</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">application_licenses</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
         <span class="nx">application_packages</span><span class="p">:</span> <span class="nx">Optional[Sequence[ApplicationPackageReferenceArgs]]</span> = None<span class="p">,</span>
         <span class="nx">certificates</span><span class="p">:</span> <span class="nx">Optional[Sequence[CertificateReferenceArgs]]</span> = None<span class="p">,</span>
         ...
         <span class="nx">identity</span><span class="p">:</span> <span class="nx">Optional[BatchPoolIdentityArgs]</span> = None<span class="p">,</span>
         <span class="nx">inter_node_communication</span><span class="p">:</span> <span class="nx">Optional[InterNodeCommunicationState]</span> = None<span class="p">,</span>
         <span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[Sequence[MetadataItemArgs]]</span> = None<span class="p">,</span>
         <span class="nx">mount_configuration</span><span class="p">:</span> <span class="nx">Optional[Sequence[MountConfigurationArgs]]</span> = None<span class="p">,</span>
         ...
         <span class="nx">start_task</span><span class="p">:</span> <span class="nx">Optional[StartTaskArgs]</span> = None<span class="p">,</span>
         <span class="nx">task_scheduling_policy</span><span class="p">:</span> <span class="nx">Optional[TaskSchedulingPolicyArgs]</span> = None<span class="p">,</span>
         <span class="nx">task_slots_per_node</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
         <span class="nx">user_accounts</span><span class="p">:</span> <span class="nx">Optional[Sequence[UserAccountArgs]]</span> = None<span class="p">,</span>
...
<a href="#applicationlicenses_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Licenses</a>
    ...
    <dd>{{% md %}}The list of application licenses must be a subset of available Batch service application licenses. If a license is requested which is not supported, pool creation will fail.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#applicationpackages_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Packages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationpackagereference">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Application<wbr>Package<wbr>Reference<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#certificates_csharp" style="color: inherit; text-decoration: inherit;">Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatereference">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Certificate<wbr>Reference<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#deploymentconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Deployment<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deploymentconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Deployment<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name need not be unique and can contain any Unicode characters up to a maximum length of 1024.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="identity_csharp">
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchpoolidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Batch<wbr>Pool<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#internodecommunication_csharp" style="color: inherit; text-decoration: inherit;">Inter<wbr>Node<wbr>Communication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#internodecommunicationstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inter<wbr>Node<wbr>Communication<wbr>State</a></span>
    </dt>
...
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataitem">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Metadata<wbr>Item<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#mountconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Mount<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mountconfiguration">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Mount<wbr>Configuration<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#networkconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Network<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#poolname_csharp" style="color: inherit; text-decoration: inherit;">Pool<wbr>Name</a>
    ...
    <dd>{{% md %}}The pool name. This must be unique within the account.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="scalesettings_csharp">
<a href="#scalesettings_csharp" style="color: inherit; text-decoration: inherit;">Scale<wbr>Settings</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scalesettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Scale<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a href="#starttask_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Task</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#starttask">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Start<wbr>Task<wbr>Args</a></span>
    </dt>
...
<a href="#taskschedulingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Task<wbr>Scheduling<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#taskschedulingpolicy">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>Task<wbr>Scheduling<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#taskslotspernode_csharp" style="color: inherit; text-decoration: inherit;">Task<wbr>Slots<wbr>Per<wbr>Node</a>
    ...
    <dd>{{% md %}}The default value is 1. The maximum value is the smaller of 4 times the number of cores of the vmSize of the pool or 256.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="useraccounts_csharp">
<a href="#useraccounts_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Accounts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useraccount">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inputs.<wbr>User<wbr>Account<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#autoscalerun_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Scale<wbr>Run</a>
    ...
    <dd>{{% md %}}This property is set only if the pool automatically scales, i.e. autoScaleSettings are used.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}The ETag of the resource, used for concurrency statements.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#lastmodified_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified</a>
    ...
    <dd>{{% md %}}This is the last time at which the pool level data, such as the targetDedicatedNodes or autoScaleSettings, changed. It does not factor in node-level changes such as a compute node changing state.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#resizeoperationstatus_csharp" style="color: inherit; text-decoration: inherit;">Resize<wbr>Operation<wbr>Status</a>
    ...
    <dd>{{% md %}}Describes either the current operation (if the pool AllocationState is Resizing) or the previously completed operation (if the AllocationState is Steady).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}If this is omitted, and no default version is specified for this application, the request fails with the error code InvalidApplicationPackageReferences. If you are calling the REST API directly, the HTTP status code is 409.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#results_csharp" style="color: inherit; text-decoration: inherit;">Results</a>
    ...
    <dd>{{% md %}}Each variable value is returned in the form $variable=value, and variables are separated by semicolons.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#evaluationinterval_csharp" style="color: inherit; text-decoration: inherit;">Evaluation<wbr>Interval</a>
    ...
    <dd>{{% md %}}If omitted, the default value is 15 minutes (PT15M).{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="autouserscope">Auto<wbr>User<wbr>Scope</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Task</dt>
    <dd>Task{{% md %}}Specifies that the service should create a new user for the task.{{% /md %}}</dd><dt>Pool</dt>
    <dd>Pool{{% md %}}Specifies that the task runs as the common auto user account which is created on every node in a pool.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Auto<wbr>User<wbr>Scope<wbr>Task</dt>
    <dd>Task{{% md %}}Specifies that the service should create a new user for the task.{{% /md %}}</dd><dt>Auto<wbr>User<wbr>Scope<wbr>Pool</dt>
    <dd>Pool{{% md %}}Specifies that the task runs as the common auto user account which is created on every node in a pool.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#elevationlevel_csharp" style="color: inherit; text-decoration: inherit;">Elevation<wbr>Level</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elevationlevel">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Elevation<wbr>Level</a></span>
    </dt>
...
<a href="#scope_csharp" style="color: inherit; text-decoration: inherit;">Scope</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#autouserscope">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Auto<wbr>User<wbr>Scope</a></span>
    </dt>
...
<a href="#relativemountpath_csharp" style="color: inherit; text-decoration: inherit;">Relative<wbr>Mount<wbr>Path</a>
    ...
    <dd>{{% md %}}All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#accountkey_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Key</a>
    ...
    <dd>{{% md %}}This property is mutually exclusive with sasKey and one must be specified.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#blobfuseoptions_csharp" style="color: inherit; text-decoration: inherit;">Blobfuse<wbr>Options</a>
    ...
    <dd>{{% md %}}These are 'net use' options in Windows and 'mount' options in Linux.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#saskey_csharp" style="color: inherit; text-decoration: inherit;">Sas<wbr>Key</a>
    ...
    <dd>{{% md %}}This property is mutually exclusive with accountKey and one must be specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#azurefileurl_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>File<wbr>Url</a>
    ...
    <dd>{{% md %}}This is of the form 'https://{account}.file.core.windows.net/'.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="relativemountpath_csharp">
<a href="#relativemountpath_csharp" style="color: inherit; text-decoration: inherit;">Relative<wbr>Mount<wbr>Path</a>
</span>
...
<a href="#mountoptions_csharp" style="color: inherit; text-decoration: inherit;">Mount<wbr>Options</a>
    ...
    <dd>{{% md %}}These are 'net use' options in Windows and 'mount' options in Linux.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#poolidentitytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Pool<wbr>Identity<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}The type of identity used for the Batch Pool.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#relativemountpath_csharp" style="color: inherit; text-decoration: inherit;">Relative<wbr>Mount<wbr>Path</a>
    ...
    <dd>{{% md %}}All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<h4 id="cachingtype">Caching<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>None</dt>
    <dd>None{{% md %}}The caching mode for the disk is not enabled.{{% /md %}}</dd><dt>Read<wbr>Only</dt>
    <dd>ReadOnly{{% md %}}The caching mode for the disk is read only.{{% /md %}}</dd><dt>Read<wbr>Write</dt>
    <dd>ReadWrite{{% md %}}The caching mode for the disk is read and write.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Caching<wbr>Type<wbr>None</dt>
    <dd>None{{% md %}}The caching mode for the disk is not enabled.{{% /md %}}</dd><dt>Caching<wbr>Type<wbr>Read<wbr>Only</dt>
    <dd>ReadOnly{{% md %}}The caching mode for the disk is read only.{{% /md %}}</dd><dt>Caching<wbr>Type<wbr>Read<wbr>Write</dt>
    <dd>ReadWrite{{% md %}}The caching mode for the disk is read and write.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>NONE</dt>
    <dd>None{{% md %}}The caching mode for the disk is not enabled.{{% /md %}}</dd><dt>READ_ONLY</dt>
    <dd>ReadOnly{{% md %}}The caching mode for the disk is read only.{{% /md %}}</dd><dt>READ_WRITE</dt>
    <dd>ReadWrite{{% md %}}The caching mode for the disk is read and write.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#storelocation_csharp" style="color: inherit; text-decoration: inherit;">Store<wbr>Location</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatestorelocation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Certificate<wbr>Store<wbr>Location</a></span>
    </dt>
...
<a href="#storename_csharp" style="color: inherit; text-decoration: inherit;">Store<wbr>Name</a>
    ...
    <dd>{{% md %}}This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="visibility_csharp">
<a href="#visibility_csharp" style="color: inherit; text-decoration: inherit;">Visibility</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatevisibility">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Certificate<wbr>Visibility&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#visibility_go" style="color: inherit; text-decoration: inherit;">Visibility</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatevisibility">[]Certificate<wbr>Visibility</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#visibility_python" style="color: inherit; text-decoration: inherit;">visibility</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatevisibility">Sequence[Certificate<wbr>Visibility]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="certificatestorelocation">Certificate<wbr>Store<wbr>Location</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Current<wbr>User</dt>
    <dd>CurrentUser{{% md %}}Certificates should be installed to the CurrentUser certificate store.{{% /md %}}</dd><dt>Local<wbr>Machine</dt>
    <dd>LocalMachine{{% md %}}Certificates should be installed to the LocalMachine certificate store.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Certificate<wbr>Store<wbr>Location<wbr>Current<wbr>User</dt>
    <dd>CurrentUser{{% md %}}Certificates should be installed to the CurrentUser certificate store.{{% /md %}}</dd><dt>Certificate<wbr>Store<wbr>Location<wbr>Local<wbr>Machine</dt>
    <dd>LocalMachine{{% md %}}Certificates should be installed to the LocalMachine certificate store.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>CURRENT_USER</dt>
    <dd>CurrentUser{{% md %}}Certificates should be installed to the CurrentUser certificate store.{{% /md %}}</dd><dt>LOCAL_MACHINE</dt>
    <dd>LocalMachine{{% md %}}Certificates should be installed to the LocalMachine certificate store.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="certificatevisibility">Certificate<wbr>Visibility</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Start<wbr>Task</dt>
    <dd>StartTask{{% md %}}The certificate should be visible to the user account under which the start task is run. Note that if AutoUser Scope is Pool for both the StartTask and a Task, this certificate will be visible to the Task as well.{{% /md %}}</dd><dt>Task</dt>
    <dd>Task{{% md %}}The certificate should be visible to the user accounts under which job tasks are run.{{% /md %}}</dd><dt>Remote<wbr>User</dt>
    <dd>RemoteUser{{% md %}}The certificate should be visible to the user accounts under which users remotely access the node.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Certificate<wbr>Visibility<wbr>Start<wbr>Task</dt>
    <dd>StartTask{{% md %}}The certificate should be visible to the user account under which the start task is run. Note that if AutoUser Scope is Pool for both the StartTask and a Task, this certificate will be visible to the Task as well.{{% /md %}}</dd><dt>Certificate<wbr>Visibility<wbr>Task</dt>
    <dd>Task{{% md %}}The certificate should be visible to the user accounts under which job tasks are run.{{% /md %}}</dd><dt>Certificate<wbr>Visibility<wbr>Remote<wbr>User</dt>
    <dd>RemoteUser{{% md %}}The certificate should be visible to the user accounts under which users remotely access the node.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>START_TASK</dt>
    <dd>StartTask{{% md %}}The certificate should be visible to the user account under which the start task is run. Note that if AutoUser Scope is Pool for both the StartTask and a Task, this certificate will be visible to the Task as well.{{% /md %}}</dd><dt>TASK</dt>
    <dd>Task{{% md %}}The certificate should be visible to the user accounts under which job tasks are run.{{% /md %}}</dd><dt>REMOTE_USER</dt>
    <dd>RemoteUser{{% md %}}The certificate should be visible to the user accounts under which users remotely access the node.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#osversion_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Version</a>
    ...
    <dd>{{% md %}}The default value is * which specifies the latest operating system version for the specified OS family.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="computenodedeallocationoption">Compute<wbr>Node<wbr>Deallocation<wbr>Option</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Requeue</dt>
    <dd>Requeue{{% md %}}Terminate running task processes and requeue the tasks. The tasks will run again when a node is available. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>Terminate</dt>
    <dd>Terminate{{% md %}}Terminate running tasks. The tasks will be completed with failureInfo indicating that they were terminated, and will not run again. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>Task<wbr>Completion</dt>
    <dd>TaskCompletion{{% md %}}Allow currently running tasks to complete. Schedule no new tasks while waiting. Remove nodes when all tasks have completed.{{% /md %}}</dd><dt>Retained<wbr>Data</dt>
    <dd>RetainedData{{% md %}}Allow currently running tasks to complete, then wait for all task data retention periods to expire. Schedule no new tasks while waiting. Remove nodes when all task retention periods have expired.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Compute<wbr>Node<wbr>Deallocation<wbr>Option<wbr>Requeue</dt>
    <dd>Requeue{{% md %}}Terminate running task processes and requeue the tasks. The tasks will run again when a node is available. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>Compute<wbr>Node<wbr>Deallocation<wbr>Option<wbr>Terminate</dt>
    <dd>Terminate{{% md %}}Terminate running tasks. The tasks will be completed with failureInfo indicating that they were terminated, and will not run again. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>Compute<wbr>Node<wbr>Deallocation<wbr>Option<wbr>Task<wbr>Completion</dt>
    <dd>TaskCompletion{{% md %}}Allow currently running tasks to complete. Schedule no new tasks while waiting. Remove nodes when all tasks have completed.{{% /md %}}</dd><dt>Compute<wbr>Node<wbr>Deallocation<wbr>Option<wbr>Retained<wbr>Data</dt>
    <dd>RetainedData{{% md %}}Allow currently running tasks to complete, then wait for all task data retention periods to expire. Schedule no new tasks while waiting. Remove nodes when all task retention periods have expired.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>REQUEUE</dt>
    <dd>Requeue{{% md %}}Terminate running task processes and requeue the tasks. The tasks will run again when a node is available. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>TERMINATE</dt>
    <dd>Terminate{{% md %}}Terminate running tasks. The tasks will be completed with failureInfo indicating that they were terminated, and will not run again. Remove nodes as soon as tasks have been terminated.{{% /md %}}</dd><dt>TASK_COMPLETION</dt>
    <dd>TaskCompletion{{% md %}}Allow currently running tasks to complete. Schedule no new tasks while waiting. Remove nodes when all tasks have completed.{{% /md %}}</dd><dt>RETAINED_DATA</dt>
    <dd>RetainedData{{% md %}}Allow currently running tasks to complete, then wait for all task data retention periods to expire. Schedule no new tasks while waiting. Remove nodes when all task retention periods have expired.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="computenodefilltype">Compute<wbr>Node<wbr>Fill<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Spread</dt>
    <dd>Spread{{% md %}}Tasks should be assigned evenly across all nodes in the pool.{{% /md %}}</dd><dt>Pack</dt>
    <dd>Pack{{% md %}}As many tasks as possible (taskSlotsPerNode) should be assigned to each node in the pool before any tasks are assigned to the next node in the pool.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Compute<wbr>Node<wbr>Fill<wbr>Type<wbr>Spread</dt>
    <dd>Spread{{% md %}}Tasks should be assigned evenly across all nodes in the pool.{{% /md %}}</dd><dt>Compute<wbr>Node<wbr>Fill<wbr>Type<wbr>Pack</dt>
    <dd>Pack{{% md %}}As many tasks as possible (taskSlotsPerNode) should be assigned to each node in the pool before any tasks are assigned to the next node in the pool.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containertype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Container<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#containerimagenames_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Image<wbr>Names</a>
    ...
    <dd>{{% md %}}This is the full image reference, as would be specified to "docker pull". An image will be sourced from the default Docker registry unless the image is fully qualified with an alternative registry.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#type_go" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containertype">Container<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#registryserver_csharp" style="color: inherit; text-decoration: inherit;">Registry<wbr>Server</a>
    ...
    <dd>{{% md %}}If omitted, the default is "docker.io".{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Docker<wbr>Compatible</dt>
    <dd>DockerCompatible{{% md %}}A Docker compatible container technology will be used to launch the containers.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Container<wbr>Type<wbr>Docker<wbr>Compatible</dt>
    <dd>DockerCompatible{{% md %}}A Docker compatible container technology will be used to launch the containers.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>DOCKER_COMPATIBLE</dt>
    <dd>DockerCompatible{{% md %}}A Docker compatible container technology will be used to launch the containers.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="containerworkingdirectory">Container<wbr>Working<wbr>Directory</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Task<wbr>Working<wbr>Directory</dt>
    <dd>TaskWorkingDirectory{{% md %}}Use the standard Batch service task working directory, which will contain the Task resource files populated by Batch.{{% /md %}}</dd><dt>Container<wbr>Image<wbr>Default</dt>
    <dd>ContainerImageDefault{{% md %}}Using container image defined working directory. Beware that this directory will not contain the resource files downloaded by Batch.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Container<wbr>Working<wbr>Directory<wbr>Task<wbr>Working<wbr>Directory</dt>
    <dd>TaskWorkingDirectory{{% md %}}Use the standard Batch service task working directory, which will contain the Task resource files populated by Batch.{{% /md %}}</dd><dt>Container<wbr>Working<wbr>Directory<wbr>Container<wbr>Image<wbr>Default</dt>
    <dd>ContainerImageDefault{{% md %}}Using container image defined working directory. Beware that this directory will not contain the resource files downloaded by Batch.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>TASK_WORKING_DIRECTORY</dt>
    <dd>TaskWorkingDirectory{{% md %}}Use the standard Batch service task working directory, which will contain the Task resource files populated by Batch.{{% /md %}}</dd><dt>CONTAINER_IMAGE_DEFAULT</dt>
    <dd>ContainerImageDefault{{% md %}}Using container image defined working directory. Beware that this directory will not contain the resource files downloaded by Batch.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lun_csharp" style="color: inherit; text-decoration: inherit;">Lun</a>
    ...
    <dd>{{% md %}}The lun is used to uniquely identify each data disk. If attaching multiple disks, each should have a distinct lun. The value must be between 0 and 63, inclusive.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="caching_csharp">
<a href="#caching_csharp" style="color: inherit; text-decoration: inherit;">Caching</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cachingtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Caching<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}Values are:
 ...
 The default value for caching is none. For information about the caching options see: https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-azure-drives-disks-and-images/.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storageaccounttype_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageaccounttype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Storage<wbr>Account<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}If omitted, the default is "Standard_LRS". Values are:

 Standard_LRS - The data disk should use standard locally redundant storage.
 Premium_LRS - The data disk should use premium locally redundant storage.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targets_csharp" style="color: inherit; text-decoration: inherit;">Targets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptiontarget">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Disk<wbr>Encryption<wbr>Target&gt;</a></span>
    </dt>
    <dd>{{% md %}}On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targets_go" style="color: inherit; text-decoration: inherit;">Targets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptiontarget">[]Disk<wbr>Encryption<wbr>Target</a></span>
    </dt>
    <dd>{{% md %}}On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targets_python" style="color: inherit; text-decoration: inherit;">targets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptiontarget">Sequence[Disk<wbr>Encryption<wbr>Target]</a></span>
    </dt>
    <dd>{{% md %}}On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="diskencryptiontarget">Disk<wbr>Encryption<wbr>Target</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Os<wbr>Disk</dt>
    <dd>OsDisk{{% md %}}The OS Disk on the compute node is encrypted.{{% /md %}}</dd><dt>Temporary<wbr>Disk</dt>
    <dd>TemporaryDisk{{% md %}}The temporary disk on the compute node is encrypted. On Linux this encryption applies to other partitions (such as those on mounted data disks) when encryption occurs at boot time.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Disk<wbr>Encryption<wbr>Target<wbr>Os<wbr>Disk</dt>
    <dd>OsDisk{{% md %}}The OS Disk on the compute node is encrypted.{{% /md %}}</dd><dt>Disk<wbr>Encryption<wbr>Target<wbr>Temporary<wbr>Disk</dt>
    <dd>TemporaryDisk{{% md %}}The temporary disk on the compute node is encrypted. On Linux this encryption applies to other partitions (such as those on mounted data disks) when encryption occurs at boot time.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>OS_DISK</dt>
    <dd>OsDisk{{% md %}}The OS Disk on the compute node is encrypted.{{% /md %}}</dd><dt>TEMPORARY_DISK</dt>
    <dd>TemporaryDisk{{% md %}}The temporary disk on the compute node is encrypted. On Linux this encryption applies to other partitions (such as those on mounted data disks) when encryption occurs at boot time.{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="elevationlevel">Elevation<wbr>Level</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Non<wbr>Admin</dt>
    <dd>NonAdmin{{% md %}}The user is a standard user without elevated access.{{% /md %}}</dd><dt>Admin</dt>
    <dd>Admin{{% md %}}The user is a user with elevated access and operates with full Administrator permissions.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Elevation<wbr>Level<wbr>Non<wbr>Admin</dt>
    <dd>NonAdmin{{% md %}}The user is a standard user without elevated access.{{% /md %}}</dd><dt>Elevation<wbr>Level<wbr>Admin</dt>
    <dd>Admin{{% md %}}The user is a user with elevated access and operates with full Administrator permissions.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>NON_ADMIN</dt>
    <dd>NonAdmin{{% md %}}The user is a standard user without elevated access.{{% /md %}}</dd><dt>ADMIN</dt>
    <dd>Admin{{% md %}}The user is a user with elevated access and operates with full Administrator permissions.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodedeallocationoption_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Deallocation<wbr>Option</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computenodedeallocationoption">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Compute<wbr>Node<wbr>Deallocation<wbr>Option</a></span>
    </dt>
...
<a href="#resizetimeout_csharp" style="color: inherit; text-decoration: inherit;">Resize<wbr>Timeout</a>
    ...
    <dd>{{% md %}}The default value is 15 minutes. Timeout values use ISO 8601 format. For example, use PT10M for 10 minutes. The minimum value is 5 minutes. If you specify a value less than 5 minutes, the Batch service rejects the request with an error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#targetdedicatednodes_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Dedicated<wbr>Nodes</a>
    ...
    <dd>{{% md %}}At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#targetlowprioritynodes_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Low<wbr>Priority<wbr>Nodes</a>
    ...
    <dd>{{% md %}}At least one of targetDedicatedNodes, targetLowPriorityNodes must be set.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="ipaddressprovisioningtype">IPAddress<wbr>Provisioning<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Batch<wbr>Managed</dt>
    <dd>BatchManaged{{% md %}}A public IP will be created and managed by Batch. There may be multiple public IPs depending on the size of the Pool.{{% /md %}}</dd><dt>User<wbr>Managed</dt>
    <dd>UserManaged{{% md %}}Public IPs are provided by the user and will be used to provision the Compute Nodes.{{% /md %}}</dd><dt>No<wbr>Public<wbr>IPAddresses</dt>
    <dd>NoPublicIPAddresses{{% md %}}No public IP Address will be created for the Compute Nodes in the Pool.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>IPAddress<wbr>Provisioning<wbr>Type<wbr>Batch<wbr>Managed</dt>
    <dd>BatchManaged{{% md %}}A public IP will be created and managed by Batch. There may be multiple public IPs depending on the size of the Pool.{{% /md %}}</dd><dt>IPAddress<wbr>Provisioning<wbr>Type<wbr>User<wbr>Managed</dt>
    <dd>UserManaged{{% md %}}Public IPs are provided by the user and will be used to provision the Compute Nodes.{{% /md %}}</dd><dt>IPAddress<wbr>Provisioning<wbr>Type<wbr>No<wbr>Public<wbr>IPAddresses</dt>
    <dd>NoPublicIPAddresses{{% md %}}No public IP Address will be created for the Compute Nodes in the Pool.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>BATCH_MANAGED</dt>
    <dd>BatchManaged{{% md %}}A public IP will be created and managed by Batch. There may be multiple public IPs depending on the size of the Pool.{{% /md %}}</dd><dt>USER_MANAGED</dt>
    <dd>UserManaged{{% md %}}Public IPs are provided by the user and will be used to provision the Compute Nodes.{{% /md %}}</dd><dt>NO_PUBLIC_IP_ADDRESSES</dt>
    <dd>NoPublicIPAddresses{{% md %}}No public IP Address will be created for the Compute Nodes in the Pool.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#offer_csharp" style="color: inherit; text-decoration: inherit;">Offer</a>
    ...
    <dd>{{% md %}}For example, UbuntuServer or WindowsServer.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publisher_csharp" style="color: inherit; text-decoration: inherit;">Publisher</a>
    ...
    <dd>{{% md %}}For example, Canonical or MicrosoftWindowsServer.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}For example, 18.04-LTS or 2019-Datacenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="version_csharp">
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
</span>
    ...
    <dd>{{% md %}}A value of 'latest' can be specified to select the latest version of an image. If omitted, the default is 'latest'.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="inboundendpointprotocol">Inbound<wbr>Endpoint<wbr>Protocol</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>TCP</dt>
    <dd>TCP{{% md %}}Use TCP for the endpoint.{{% /md %}}</dd><dt>UDP</dt>
    <dd>UDP{{% md %}}Use UDP for the endpoint.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Inbound<wbr>Endpoint<wbr>Protocol<wbr>TCP</dt>
    <dd>TCP{{% md %}}Use TCP for the endpoint.{{% /md %}}</dd><dt>Inbound<wbr>Endpoint<wbr>Protocol<wbr>UDP</dt>
    <dd>UDP{{% md %}}Use UDP for the endpoint.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#backendport_csharp" style="color: inherit; text-decoration: inherit;">Backend<wbr>Port</a>
    ...
    <dd>{{% md %}}This must be unique within a Batch pool. Acceptable values are between 1 and 65535 except for 22, 3389, 29876 and 29877 as these are reserved. If any reserved values are provided the request fails with HTTP status code 400.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#frontendportrangeend_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>Port<wbr>Range<wbr>End</a>
    ...
    <dd>{{% md %}}Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved by the Batch service. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#frontendportrangestart_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>Port<wbr>Range<wbr>Start</a>
    ...
    <dd>{{% md %}}Acceptable values range between 1 and 65534 except ports from 50000 to 55000 which are reserved. All ranges within a pool must be distinct and cannot overlap. If any reserved or overlapping values are provided the request fails with HTTP status code 400.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inboundendpointprotocol">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Inbound<wbr>Endpoint<wbr>Protocol</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#protocol_go" style="color: inherit; text-decoration: inherit;">Protocol</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inboundendpointprotocol">Inbound<wbr>Endpoint<wbr>Protocol</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="internodecommunicationstate">Inter<wbr>Node<wbr>Communication<wbr>State</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Enabled</dt>
    <dd>Enabled{{% md %}}Enable network communication between virtual machines.{{% /md %}}</dd><dt>Disabled</dt>
    <dd>Disabled{{% md %}}Disable network communication between virtual machines.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Inter<wbr>Node<wbr>Communication<wbr>State<wbr>Enabled</dt>
    <dd>Enabled{{% md %}}Enable network communication between virtual machines.{{% /md %}}</dd><dt>Inter<wbr>Node<wbr>Communication<wbr>State<wbr>Disabled</dt>
    <dd>Disabled{{% md %}}Disable network communication between virtual machines.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#gid_csharp" style="color: inherit; text-decoration: inherit;">Gid</a>
    ...
    <dd>{{% md %}}The uid and gid properties must be specified together or not at all. If not specified the underlying operating system picks the gid.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#uid_csharp" style="color: inherit; text-decoration: inherit;">Uid</a>
    ...
    <dd>{{% md %}}The uid and gid properties must be specified together or not at all. If not specified the underlying operating system picks the uid.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="loginmode">Login<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Batch</dt>
    <dd>Batch{{% md %}}The LOGON32_LOGON_BATCH Win32 login mode. The batch login mode is recommended for long running parallel processes.{{% /md %}}</dd><dt>Interactive</dt>
    <dd>Interactive{{% md %}}The LOGON32_LOGON_INTERACTIVE Win32 login mode. Some applications require having permissions associated with the interactive login mode. If this is the case for an application used in your task, then this option is recommended.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Login<wbr>Mode<wbr>Batch</dt>
    <dd>Batch{{% md %}}The LOGON32_LOGON_BATCH Win32 login mode. The batch login mode is recommended for long running parallel processes.{{% /md %}}</dd><dt>Login<wbr>Mode<wbr>Interactive</dt>
    <dd>Interactive{{% md %}}The LOGON32_LOGON_INTERACTIVE Win32 login mode. Some applications require having permissions associated with the interactive login mode. If this is the case for an application used in your task, then this option is recommended.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#access_csharp" style="color: inherit; text-decoration: inherit;">Access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networksecuritygroupruleaccess">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Network<wbr>Security<wbr>Group<wbr>Rule<wbr>Access</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sourceaddressprefix_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Address<wbr>Prefix</a>
    ...
    <dd>{{% md %}}Valid values are a single IP address (i.e. 10.10.10.10), IP subnet (i.e. 192.168.1.0/24), default tag, or * (for all addresses).  If any other values are provided the request fails with HTTP status code 400.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sourceportranges_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Port<wbr>Ranges</a>
    ...
    <dd>{{% md %}}Valid values are '*' (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. 100-200). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be *.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#access_go" style="color: inherit; text-decoration: inherit;">Access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networksecuritygroupruleaccess">Network<wbr>Security<wbr>Group<wbr>Rule<wbr>Access</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="priority_go">
...
<h4 id="networksecuritygroupruleaccess">Network<wbr>Security<wbr>Group<wbr>Rule<wbr>Access</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Allow</dt>
    <dd>Allow{{% md %}}Allow access.{{% /md %}}</dd><dt>Deny</dt>
    <dd>Deny{{% md %}}Deny access.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Network<wbr>Security<wbr>Group<wbr>Rule<wbr>Access<wbr>Allow</dt>
    <dd>Allow{{% md %}}Allow access.{{% /md %}}</dd><dt>Network<wbr>Security<wbr>Group<wbr>Rule<wbr>Access<wbr>Deny</dt>
    <dd>Deny{{% md %}}Deny access.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodeplacementpolicytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Node<wbr>Placement<wbr>Policy<wbr>Type</a></span>
    </dt>
...
<dl class="tabular"><dt>Regional</dt>
    <dd>Regional{{% md %}}All nodes in the pool will be allocated in the same region.{{% /md %}}</dd><dt>Zonal</dt>
    <dd>Zonal{{% md %}}Nodes in the pool will be spread across different zones with best effort balancing.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Node<wbr>Placement<wbr>Policy<wbr>Type<wbr>Regional</dt>
    <dd>Regional{{% md %}}All nodes in the pool will be allocated in the same region.{{% /md %}}</dd><dt>Node<wbr>Placement<wbr>Policy<wbr>Type<wbr>Zonal</dt>
    <dd>Zonal{{% md %}}Nodes in the pool will be spread across different zones with best effort balancing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>User<wbr>Assigned</dt>
    <dd>UserAssigned{{% md %}}Batch pool has user assigned identities with it.{{% /md %}}</dd><dt>None</dt>
    <dd>None{{% md %}}Batch pool has no identity associated with it. Setting `None` in update pool will remove existing identities.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Pool<wbr>Identity<wbr>Type<wbr>User<wbr>Assigned</dt>
    <dd>UserAssigned{{% md %}}Batch pool has user assigned identities with it.{{% /md %}}</dd><dt>Pool<wbr>Identity<wbr>Type<wbr>None</dt>
    <dd>None{{% md %}}Batch pool has no identity associated with it. Setting `None` in update pool will remove existing identities.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ipaddressids_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address<wbr>Ids</a>
    ...
    <dd>{{% md %}}The number of IPs specified here limits the maximum size of the Pool - 100 dedicated nodes or 100 low-priority nodes can be allocated for each public IP. For example, a pool needing 250 dedicated VMs would need at least 3 public IPs specified. Each element of this collection is of the form: /subscriptions/{subscription}/resourceGroups/{group}/providers/Microsoft.Network/publicIPAddresses/{ip}.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="provision_csharp">
<a href="#provision_csharp" style="color: inherit; text-decoration: inherit;">Provision</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipaddressprovisioningtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>IPAddress<wbr>Provisioning<wbr>Type</a></span>
    </dt>
...
<a href="#nodedeallocationoption_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Deallocation<wbr>Option</a>
    ...
    <dd>{{% md %}}The default value is requeue.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="resizetimeout_csharp">
<a href="#resizetimeout_csharp" style="color: inherit; text-decoration: inherit;">Resize<wbr>Timeout</a>
</span>
    ...
    <dd>{{% md %}}The default value is 15 minutes. The minimum value is 5 minutes. If you specify a value less than 5 minutes, the Batch service returns an error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#autostoragecontainername_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Storage<wbr>Container<wbr>Name</a>
    ...
    <dd>{{% md %}}The autoStorageContainerName, storageContainerUrl and httpUrl properties are mutually exclusive and one of them must be specified.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#blobprefix_csharp" style="color: inherit; text-decoration: inherit;">Blob<wbr>Prefix</a>
    ...
    <dd>{{% md %}}The property is valid only when autoStorageContainerName or storageContainerUrl is used. This prefix can be a partial filename or a subdirectory. If a prefix is not specified, all the files in the container will be downloaded.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#filemode_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Mode</a>
    ...
    <dd>{{% md %}}This property applies only to files being downloaded to Linux compute nodes. It will be ignored if it is specified for a resourceFile which will be downloaded to a Windows node. If this property is not specified for a Linux node, then a default value of 0770 is applied to the file.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#filepath_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Path</a>
    ...
    <dd>{{% md %}}If the httpUrl property is specified, the filePath is required and describes the path which the file will be downloaded to, including the filename. Otherwise, if the autoStorageContainerName or storageContainerUrl property is specified, filePath is optional and is the directory to download the files to. In the case where filePath is used as a directory, any directory structure already associated with the input data will be retained in full and appended to the specified filePath directory. The specified relative path cannot break out of the task's working directory (for example by using '..').{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maxtaskretrycount_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Task<wbr>Retry<wbr>Count</a>
    ...
    <dd>{{% md %}}The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>Standard_LRS</dt>
    <dd>Standard_LRS{{% md %}}The data disk should use standard locally redundant storage.{{% /md %}}</dd><dt>Premium_LRS</dt>
    <dd>Premium_LRS{{% md %}}The data disk should use premium locally redundant storage.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Storage<wbr>Account<wbr>Type_Standard_LRS</dt>
    <dd>Standard_LRS{{% md %}}The data disk should use standard locally redundant storage.{{% /md %}}</dd><dt>Storage<wbr>Account<wbr>Type_Premium_LRS</dt>
    <dd>Premium_LRS{{% md %}}The data disk should use premium locally redundant storage.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#imagename_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Name</a>
    ...
    <dd>{{% md %}}This is the full image reference, as would be specified to "docker pull". If no tag is provided as part of the image name, the tag ":latest" is used as a default.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#containerrunoptions_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Run<wbr>Options</a>
    ...
    <dd>{{% md %}}These additional options are supplied as arguments to the "docker create" command, in addition to those controlled by the Batch Service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workingdirectory_csharp" style="color: inherit; text-decoration: inherit;">Working<wbr>Directory</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerworkingdirectory">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Container<wbr>Working<wbr>Directory</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodefilltype_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Fill<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computenodefilltype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Compute<wbr>Node<wbr>Fill<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nodefilltype_go" style="color: inherit; text-decoration: inherit;">Node<wbr>Fill<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computenodefilltype">Compute<wbr>Node<wbr>Fill<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}The userName and autoUser properties are mutually exclusive; you must specify one but not both.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#protectedsettings_csharp" style="color: inherit; text-decoration: inherit;">Protected<wbr>Settings</a>
    ...
    <dd>{{% md %}}The extension can contain either protectedSettings or protectedSettingsFromKeyVault or no protected settings at all. {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nodeagentskuid_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Agent<wbr>Sku<wbr>Id</a>
    ...
    <dd>{{% md %}}The Batch node agent is a program that runs on each node in the pool, and provides the command-and-control interface between the node and the Batch service. There are different implementations of the node agent, known as SKUs, for different operating systems. You must specify a node agent SKU which matches the selected image reference. To get the list of supported node agent SKUs along with their list of verified image references, see the 'List supported node agent SKUs' operation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enableautomaticupdates_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Automatic<wbr>Updates</a>
    ...
    <dd>{{% md %}}If omitted, the default value is true.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#loginmode_csharp" style="color: inherit; text-decoration: inherit;">Login<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loginmode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Batch.<wbr>Login<wbr>Mode</a></span>
    </dt>
