...
---
title: "Share"
title_tag: "azure-native.datashare.Share"
meta_desc: "Documentation for the azure-native.datashare.Share resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Share description.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sharekind_csharp">
<a href="#sharekind_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Kind</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#sharekind">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Share.<wbr>Share<wbr>Kind</a></span>
    </dt>
    <dd>{{% md %}}Share kind.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sharekind_go" style="color: inherit; text-decoration: inherit;">Share<wbr>Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#sharekind">Share<wbr>Kind</a></span>
    </dt>
    <dd>{{% md %}}Share kind.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#share_kind_python" style="color: inherit; text-decoration: inherit;">share_<wbr>kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#sharekind">Share<wbr>Kind</a></span>
    </dt>
    <dd>{{% md %}}Share kind.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>{{% md %}}Time at which the share was created.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Copy<wbr>Based</dt>
    <dd>CopyBased</dd><dt>In<wbr>Place</dt>
    <dd>InPlace</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Share<wbr>Kind<wbr>Copy<wbr>Based</dt>
    <dd>CopyBased</dd><dt>Share<wbr>Kind<wbr>In<wbr>Place</dt>
    <dd>InPlace</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>COPY_BASED</dt>
    <dd>CopyBased</dd><dt>IN_PLACE</dt>
    <dd>InPlace</dd></dl>
{{% /choosable %}}
