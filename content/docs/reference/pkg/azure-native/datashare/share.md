...
<span class="k">def </span><span class="nx">Share</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">share_kind</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, ShareKind]]]</span> = None<span class="p">,</span>
...
<a href="#sharekind_nodejs" style="color: inherit; text-decoration: inherit;">share<wbr>Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#sharekind">pulumi.<wbr>Input<Share<wbr>Kind></a></span>
    </dt>
    <dd>{{% md %}}Share kind.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#share_kind_python" style="color: inherit; text-decoration: inherit;">share_<wbr>kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#sharekind">Input[Share<wbr>Kind]</a></span>
    </dt>
    <dd>{{% md %}}Share kind.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
