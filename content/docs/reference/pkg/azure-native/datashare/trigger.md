...
<span class="k">def </span><span class="nx">Trigger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">kind</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, TriggerKind]]]</span> = None<span class="p">,</span>
...
<a href="#kind_nodejs" style="color: inherit; text-decoration: inherit;">kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#triggerkind">pulumi.<wbr>Input<Trigger<wbr>Kind></a></span>
    </dt>
    <dd>{{% md %}}Kind of synchronization on trigger.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#kind_python" style="color: inherit; text-decoration: inherit;">kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#triggerkind">Input[Trigger<wbr>Kind]</a></span>
    </dt>
    <dd>{{% md %}}Kind of synchronization on trigger.{{% /md %}}</dd><dt class="property-required"
            title="Required">
