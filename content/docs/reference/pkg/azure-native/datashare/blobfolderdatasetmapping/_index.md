...
## Create a BlobFolderDataSetMapping Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The BlobFolderDataSetMapping resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#prefix_csharp" style="color: inherit; text-decoration: inherit;">Prefix</a>
    ...
    <dd>{{% md %}}Prefix for blob folder{{% /md %}}</dd><dt class="property-required"
            title="Required">
