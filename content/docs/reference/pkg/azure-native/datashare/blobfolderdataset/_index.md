...
## Create a BlobFolderDataSet Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The BlobFolderDataSet resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
