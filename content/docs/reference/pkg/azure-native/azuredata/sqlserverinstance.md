...
title_tag: "azure-native.azuredata.SqlServerInstance"
meta_desc: "Documentation for the azure-native.azuredata.SqlServerInstance resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var sqlServerInstance = new AzureNative.AzureData.SqlServerInstance("sqlServerInstance", new AzureNative.AzureData.SqlServerInstanceArgs
        {
...
sql_server_instance = azure_native.azuredata.SqlServerInstance("sqlServerInstance",
...
const sqlServerInstance = new azure_native.azuredata.SqlServerInstance("sqlServerInstance", {
    containerResourceId: "Arc Machine Name",
    edition: "Developer",
    location: "northeurope",
    resourceGroupName: "testrg",
...
<a href="#edition_csharp" style="color: inherit; text-decoration: inherit;">Edition</a>
    ...
    <dd>{{% md %}}SQL Server edition.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The cloud connectivity status.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#vcore_csharp" style="color: inherit; text-decoration: inherit;">VCore</a>
    ...
    <dd>{{% md %}}The number of logical processors used by the SQL Server instance.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}SQL Server version.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#updatetime_csharp" style="color: inherit; text-decoration: inherit;">Update<wbr>Time</a>
    ...
    <dd>{{% md %}}The time when the resource was last updated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-native:azuredata:SqlServerInstance testsqlServerInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureData/SqlServerInstances/testsqlServerInstance 
```
