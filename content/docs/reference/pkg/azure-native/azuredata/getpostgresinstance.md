...
title_tag: "azure-native.azuredata.getPostgresInstance"
meta_desc: "Documentation for the azure-native.azuredata.getPostgresInstance function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getPostgresInstance<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetPostgresInstanceArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetPostgresInstanceResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#postgresinstancename_csharp" style="color: inherit; text-decoration: inherit;">Postgres<wbr>Instance<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of Postgres Instance{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#admin_csharp" style="color: inherit; text-decoration: inherit;">Admin</a>
    ...
    <dd>{{% md %}}The instance admin{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#datacontrollerid_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Controller<wbr>Id</a>
    ...
    <dd>{{% md %}}The data controller id{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#k8sraw_csharp" style="color: inherit; text-decoration: inherit;">K8s<wbr>Raw</a>
    ...
    <dd>{{% md %}}The raw kubernetes information{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastuploadeddate_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Uploaded<wbr>Date</a>
    ...
    <dd>{{% md %}}Last uploaded date from on premise cluster. Defaults to current date time{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
