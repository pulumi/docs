...
title_tag: "azure-native.azuredata.SqlManagedInstance"
meta_desc: "Documentation for the azure-native.azuredata.SqlManagedInstance resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var sqlManagedInstance = new AzureNative.AzureData.SqlManagedInstance("sqlManagedInstance", new AzureNative.AzureData.SqlManagedInstanceArgs
        {
            Admin = "Admin user",
...
sql_managed_instance = azure_native.azuredata.SqlManagedInstance("sqlManagedInstance",
    admin="Admin user",
...
const sqlManagedInstance = new azure_native.azuredata.SqlManagedInstance("sqlManagedInstance", {
    admin: "Admin user",
    endTime: "Instance end time",
    instanceEndpoint: "The on premise instance endpoint",
    location: "northeurope",
...
```sh
$ pulumi import azure-native:azuredata:SqlManagedInstance testsqlManagedInstance /subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.AzureData/sqlManagedInstances/testsqlManagedInstance 
```
