...
<a href="#alternateid_csharp" style="color: inherit; text-decoration: inherit;">Alternate<wbr>Id</a>
    ...
    <dd>{{% md %}}The alternate ID of the Asset.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#assetname_csharp" style="color: inherit; text-decoration: inherit;">Asset<wbr>Name</a>
    ...
    <dd>{{% md %}}The Asset name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#container_csharp" style="color: inherit; text-decoration: inherit;">Container</a>
    ...
    <dd>{{% md %}}The name of the asset blob container.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The Asset description.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
