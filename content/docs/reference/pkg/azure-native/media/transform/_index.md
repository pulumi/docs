...
---
title: "Transform"
title_tag: "azure-native.media.Transform"
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewTransform</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">TransformArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Transform</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#outputs_csharp" style="color: inherit; text-decoration: inherit;">Outputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transformoutput">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Transform<wbr>Output<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#created_csharp" style="color: inherit; text-decoration: inherit;">Created</a>
    ...
    <dd>{{% md %}}The UTC date and time when the Transform was created, in 'YYYY-MM-DDThh:mm:ssZ' format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#lastmodified_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified</a>
    ...
    <dd>{{% md %}}The UTC date and time when the Transform was last updated, in 'YYYY-MM-DDThh:mm:ssZ' format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#profile_csharp" style="color: inherit; text-decoration: inherit;">Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#aacaudioprofile">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Aac<wbr>Audio<wbr>Profile</a></span>
    </dt>
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Aac<wbr>Lc</dt>
    <dd>AacLc{{% md %}}Specifies that the output audio is to be encoded into AAC Low Complexity profile (AAC-LC).{{% /md %}}</dd><dt>He<wbr>Aac<wbr>V1</dt>
    <dd>HeAacV1{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v1 profile.{{% /md %}}</dd><dt>He<wbr>Aac<wbr>V2</dt>
    <dd>HeAacV2{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v2 profile.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Aac<wbr>Audio<wbr>Profile<wbr>Aac<wbr>Lc</dt>
    <dd>AacLc{{% md %}}Specifies that the output audio is to be encoded into AAC Low Complexity profile (AAC-LC).{{% /md %}}</dd><dt>Aac<wbr>Audio<wbr>Profile<wbr>He<wbr>Aac<wbr>V1</dt>
    <dd>HeAacV1{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v1 profile.{{% /md %}}</dd><dt>Aac<wbr>Audio<wbr>Profile<wbr>He<wbr>Aac<wbr>V2</dt>
    <dd>HeAacV2{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v2 profile.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>AAC_LC</dt>
    <dd>AacLc{{% md %}}Specifies that the output audio is to be encoded into AAC Low Complexity profile (AAC-LC).{{% /md %}}</dd><dt>HE_AAC_V1</dt>
    <dd>HeAacV1{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v1 profile.{{% /md %}}</dd><dt>HE_AAC_V2</dt>
    <dd>HeAacV2{{% md %}}Specifies that the output audio is to be encoded into HE-AAC v2 profile.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Source<wbr>Resolution</dt>
    <dd>SourceResolution</dd><dt>Standard<wbr>Definition</dt>
    <dd>StandardDefinition</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Analysis<wbr>Resolution<wbr>Source<wbr>Resolution</dt>
    <dd>SourceResolution</dd><dt>Analysis<wbr>Resolution<wbr>Standard<wbr>Definition</dt>
    <dd>StandardDefinition</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>SOURCE_RESOLUTION</dt>
    <dd>SourceResolution</dd><dt>STANDARD_DEFINITION</dt>
    <dd>StandardDefinition</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Standard</dt>
    <dd>Standard{{% md %}}Performs all operations included in the Basic mode, additionally performing language detection and speaker diarization.{{% /md %}}</dd><dt>Basic</dt>
    <dd>Basic{{% md %}}This mode performs speech-to-text transcription and generation of a VTT subtitle/caption file. The output of this mode includes an Insights JSON file including only the keywords, transcription,and timing information. Automatic language detection and speaker diarization are not included in this mode.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Audio<wbr>Analysis<wbr>Mode<wbr>Standard</dt>
    <dd>Standard{{% md %}}Performs all operations included in the Basic mode, additionally performing language detection and speaker diarization.{{% /md %}}</dd><dt>Audio<wbr>Analysis<wbr>Mode<wbr>Basic</dt>
    <dd>Basic{{% md %}}This mode performs speech-to-text transcription and generation of a VTT subtitle/caption file. The output of this mode includes an Insights JSON file including only the keywords, transcription,and timing information. Automatic language detection and speaker diarization are not included in this mode.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#audioanalysismode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Audio<wbr>Analysis<wbr>Mode</a></span>
    </dt>
...
<h4 id="blurtype">Blur<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Box</dt>
    <dd>Box{{% md %}}Box: debug filter, bounding box only{{% /md %}}</dd><dt>Low</dt>
    <dd>Low{{% md %}}Low: box-car blur filter{{% /md %}}</dd><dt>Med</dt>
    <dd>Med{{% md %}}Med: Gaussian blur filter{{% /md %}}</dd><dt>High</dt>
    <dd>High{{% md %}}High: Confuse blur filter{{% /md %}}</dd><dt>Black</dt>
    <dd>Black{{% md %}}Black: Black out filter{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Blur<wbr>Type<wbr>Box</dt>
    <dd>Box{{% md %}}Box: debug filter, bounding box only{{% /md %}}</dd><dt>Blur<wbr>Type<wbr>Low</dt>
    <dd>Low{{% md %}}Low: box-car blur filter{{% /md %}}</dd><dt>Blur<wbr>Type<wbr>Med</dt>
    <dd>Med{{% md %}}Med: Gaussian blur filter{{% /md %}}</dd><dt>Blur<wbr>Type<wbr>High</dt>
    <dd>High{{% md %}}High: Confuse blur filter{{% /md %}}</dd><dt>Blur<wbr>Type<wbr>Black</dt>
    <dd>Black{{% md %}}Black: Black out filter{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#presetname_csharp" style="color: inherit; text-decoration: inherit;">Preset<wbr>Name</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#encodernamedpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Encoder<wbr>Named<wbr>Preset</a></span>
    </dt>
...
<a href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#deinterlacemode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Deinterlace<wbr>Mode</a></span>
    </dt>
...
<a href="#parity_csharp" style="color: inherit; text-decoration: inherit;">Parity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#deinterlaceparity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Deinterlace<wbr>Parity</a></span>
    </dt>
...
<dl class="tabular"><dt>Off</dt>
    <dd>Off{{% md %}}Disables de-interlacing of the source video.{{% /md %}}</dd><dt>Auto<wbr>Pixel<wbr>Adaptive</dt>
    <dd>AutoPixelAdaptive{{% md %}}Apply automatic pixel adaptive de-interlacing on each frame in the input video.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Deinterlace<wbr>Mode<wbr>Off</dt>
    <dd>Off{{% md %}}Disables de-interlacing of the source video.{{% /md %}}</dd><dt>Deinterlace<wbr>Mode<wbr>Auto<wbr>Pixel<wbr>Adaptive</dt>
    <dd>AutoPixelAdaptive{{% md %}}Apply automatic pixel adaptive de-interlacing on each frame in the input video.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>OFF</dt>
    <dd>Off{{% md %}}Disables de-interlacing of the source video.{{% /md %}}</dd><dt>AUTO_PIXEL_ADAPTIVE</dt>
    <dd>AutoPixelAdaptive{{% md %}}Apply automatic pixel adaptive de-interlacing on each frame in the input video.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Auto</dt>
    <dd>Auto{{% md %}}Automatically detect the order of fields{{% /md %}}</dd><dt>Top<wbr>Field<wbr>First</dt>
    <dd>TopFieldFirst{{% md %}}Apply top field first processing of input video.{{% /md %}}</dd><dt>Bottom<wbr>Field<wbr>First</dt>
    <dd>BottomFieldFirst{{% md %}}Apply bottom field first processing of input video.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Deinterlace<wbr>Parity<wbr>Auto</dt>
    <dd>Auto{{% md %}}Automatically detect the order of fields{{% /md %}}</dd><dt>Deinterlace<wbr>Parity<wbr>Top<wbr>Field<wbr>First</dt>
    <dd>TopFieldFirst{{% md %}}Apply top field first processing of input video.{{% /md %}}</dd><dt>Deinterlace<wbr>Parity<wbr>Bottom<wbr>Field<wbr>First</dt>
    <dd>BottomFieldFirst{{% md %}}Apply bottom field first processing of input video.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>AUTO</dt>
    <dd>Auto{{% md %}}Automatically detect the order of fields{{% /md %}}</dd><dt>TOP_FIELD_FIRST</dt>
    <dd>TopFieldFirst{{% md %}}Apply top field first processing of input video.{{% /md %}}</dd><dt>BOTTOM_FIELD_FIRST</dt>
    <dd>BottomFieldFirst{{% md %}}Apply bottom field first processing of input video.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>H264Single<wbr>Bitrate<wbr>SD</dt>
    <dd>H264SingleBitrateSD{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 2200 kbps and a picture height of 480 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H264Single<wbr>Bitrate720p</dt>
    <dd>H264SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 4500 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H264Single<wbr>Bitrate1080p</dt>
    <dd>H264SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 6750 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Adaptive<wbr>Streaming</dt>
    <dd>AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.264 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>AACGood<wbr>Quality<wbr>Audio</dt>
    <dd>AACGoodQualityAudio{{% md %}}Produces a single MP4 file containing only stereo audio encoded at 192 kbps.{{% /md %}}</dd><dt>Content<wbr>Aware<wbr>Encoding<wbr>Experimental</dt>
    <dd>ContentAwareEncodingExperimental{{% md %}}Exposes an experimental preset for content-aware encoding. Given any input content, the service attempts to automatically determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. The underlying algorithms will continue to evolve over time. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>Content<wbr>Aware<wbr>Encoding</dt>
    <dd>ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>Copy<wbr>All<wbr>Bitrate<wbr>Non<wbr>Interleaved</dt>
    <dd>CopyAllBitrateNonInterleaved{{% md %}}Copy all video and audio streams from the input asset as non-interleaved video and audio output files. This preset can be used to clip an existing asset or convert a group of key frame (GOP) aligned MP4 files as an asset that can be streamed.{{% /md %}}</dd><dt>H264Multiple<wbr>Bitrate1080p</dt>
    <dd>H264MultipleBitrate1080p{{% md %}}Produces a set of 8 GOP-aligned MP4 files, ranging from 6000 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 1080p and goes down to 180p.{{% /md %}}</dd><dt>H264Multiple<wbr>Bitrate720p</dt>
    <dd>H264MultipleBitrate720p{{% md %}}Produces a set of 6 GOP-aligned MP4 files, ranging from 3400 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 720p and goes down to 180p.{{% /md %}}</dd><dt>H264Multiple<wbr>Bitrate<wbr>SD</dt>
    <dd>H264MultipleBitrateSD{{% md %}}Produces a set of 5 GOP-aligned MP4 files, ranging from 1900kbps to 400 kbps, and stereo AAC audio. Resolution starts at 480p and goes down to 240p.{{% /md %}}</dd><dt>H265Content<wbr>Aware<wbr>Encoding</dt>
    <dd>H265ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>H265Adaptive<wbr>Streaming</dt>
    <dd>H265AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.265 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>H265Single<wbr>Bitrate720p</dt>
    <dd>H265SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 1800 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H265Single<wbr>Bitrate1080p</dt>
    <dd>H265SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 3500 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H265Single<wbr>Bitrate4K</dt>
    <dd>H265SingleBitrate4K{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 9500 kbps and a picture height of 2160 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Single<wbr>Bitrate<wbr>SD</dt>
    <dd>H264SingleBitrateSD{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 2200 kbps and a picture height of 480 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Single<wbr>Bitrate720p</dt>
    <dd>H264SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 4500 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Single<wbr>Bitrate1080p</dt>
    <dd>H264SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 6750 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>Adaptive<wbr>Streaming</dt>
    <dd>AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.264 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>AACGood<wbr>Quality<wbr>Audio</dt>
    <dd>AACGoodQualityAudio{{% md %}}Produces a single MP4 file containing only stereo audio encoded at 192 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>Content<wbr>Aware<wbr>Encoding<wbr>Experimental</dt>
    <dd>ContentAwareEncodingExperimental{{% md %}}Exposes an experimental preset for content-aware encoding. Given any input content, the service attempts to automatically determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. The underlying algorithms will continue to evolve over time. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>Content<wbr>Aware<wbr>Encoding</dt>
    <dd>ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>Copy<wbr>All<wbr>Bitrate<wbr>Non<wbr>Interleaved</dt>
    <dd>CopyAllBitrateNonInterleaved{{% md %}}Copy all video and audio streams from the input asset as non-interleaved video and audio output files. This preset can be used to clip an existing asset or convert a group of key frame (GOP) aligned MP4 files as an asset that can be streamed.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Multiple<wbr>Bitrate1080p</dt>
    <dd>H264MultipleBitrate1080p{{% md %}}Produces a set of 8 GOP-aligned MP4 files, ranging from 6000 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 1080p and goes down to 180p.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Multiple<wbr>Bitrate720p</dt>
    <dd>H264MultipleBitrate720p{{% md %}}Produces a set of 6 GOP-aligned MP4 files, ranging from 3400 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 720p and goes down to 180p.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H264Multiple<wbr>Bitrate<wbr>SD</dt>
    <dd>H264MultipleBitrateSD{{% md %}}Produces a set of 5 GOP-aligned MP4 files, ranging from 1900kbps to 400 kbps, and stereo AAC audio. Resolution starts at 480p and goes down to 240p.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H265Content<wbr>Aware<wbr>Encoding</dt>
    <dd>H265ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H265Adaptive<wbr>Streaming</dt>
    <dd>H265AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.265 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H265Single<wbr>Bitrate720p</dt>
    <dd>H265SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 1800 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H265Single<wbr>Bitrate1080p</dt>
    <dd>H265SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 3500 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>Encoder<wbr>Named<wbr>Preset<wbr>H265Single<wbr>Bitrate4K</dt>
    <dd>H265SingleBitrate4K{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 9500 kbps and a picture height of 2160 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>H264_SINGLE_BITRATE_SD</dt>
    <dd>H264SingleBitrateSD{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 2200 kbps and a picture height of 480 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H264_SINGLE_BITRATE720P</dt>
    <dd>H264SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 4500 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H264_SINGLE_BITRATE1080P</dt>
    <dd>H264SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.264 codec at 6750 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>ADAPTIVE_STREAMING</dt>
    <dd>AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.264 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>AAC_GOOD_QUALITY_AUDIO</dt>
    <dd>AACGoodQualityAudio{{% md %}}Produces a single MP4 file containing only stereo audio encoded at 192 kbps.{{% /md %}}</dd><dt>CONTENT_AWARE_ENCODING_EXPERIMENTAL</dt>
    <dd>ContentAwareEncodingExperimental{{% md %}}Exposes an experimental preset for content-aware encoding. Given any input content, the service attempts to automatically determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. The underlying algorithms will continue to evolve over time. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>CONTENT_AWARE_ENCODING</dt>
    <dd>ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>COPY_ALL_BITRATE_NON_INTERLEAVED</dt>
    <dd>CopyAllBitrateNonInterleaved{{% md %}}Copy all video and audio streams from the input asset as non-interleaved video and audio output files. This preset can be used to clip an existing asset or convert a group of key frame (GOP) aligned MP4 files as an asset that can be streamed.{{% /md %}}</dd><dt>H264_MULTIPLE_BITRATE1080P</dt>
    <dd>H264MultipleBitrate1080p{{% md %}}Produces a set of 8 GOP-aligned MP4 files, ranging from 6000 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 1080p and goes down to 180p.{{% /md %}}</dd><dt>H264_MULTIPLE_BITRATE720P</dt>
    <dd>H264MultipleBitrate720p{{% md %}}Produces a set of 6 GOP-aligned MP4 files, ranging from 3400 kbps to 400 kbps, and stereo AAC audio. Resolution starts at 720p and goes down to 180p.{{% /md %}}</dd><dt>H264_MULTIPLE_BITRATE_SD</dt>
    <dd>H264MultipleBitrateSD{{% md %}}Produces a set of 5 GOP-aligned MP4 files, ranging from 1900kbps to 400 kbps, and stereo AAC audio. Resolution starts at 480p and goes down to 240p.{{% /md %}}</dd><dt>H265_CONTENT_AWARE_ENCODING</dt>
    <dd>H265ContentAwareEncoding{{% md %}}Produces a set of GOP-aligned MP4s by using content-aware encoding. Given any input content, the service performs an initial lightweight analysis of the input content, and uses the results to determine the optimal number of layers, appropriate bitrate and resolution settings for delivery by adaptive streaming. This preset is particularly effective for low and medium complexity videos, where the output files will be at lower bitrates but at a quality that still delivers a good experience to viewers. The output will contain MP4 files with video and audio interleaved.{{% /md %}}</dd><dt>H265_ADAPTIVE_STREAMING</dt>
    <dd>H265AdaptiveStreaming{{% md %}}Produces a set of GOP aligned MP4 files with H.265 video and stereo AAC audio. Auto-generates a bitrate ladder based on the input resolution, bitrate and frame rate. The auto-generated preset will never exceed the input resolution. For example, if the input is 720p, output will remain 720p at best.{{% /md %}}</dd><dt>H265_SINGLE_BITRATE720P</dt>
    <dd>H265SingleBitrate720p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 1800 kbps and a picture height of 720 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H265_SINGLE_BITRATE1080P</dt>
    <dd>H265SingleBitrate1080p{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 3500 kbps and a picture height of 1080 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd><dt>H265_SINGLE_BITRATE4_K</dt>
    <dd>H265SingleBitrate4K{{% md %}}Produces an MP4 file where the video is encoded with H.265 codec at 9500 kbps and a picture height of 2160 pixels, and the stereo audio is encoded with AAC-LC codec at 128 kbps.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Cabac</dt>
    <dd>Cabac{{% md %}}Context Adaptive Binary Arithmetic Coder (CABAC) entropy encoding.{{% /md %}}</dd><dt>Cavlc</dt>
    <dd>Cavlc{{% md %}}Context Adaptive Variable Length Coder (CAVLC) entropy encoding.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Entropy<wbr>Mode<wbr>Cabac</dt>
    <dd>Cabac{{% md %}}Context Adaptive Binary Arithmetic Coder (CABAC) entropy encoding.{{% /md %}}</dd><dt>Entropy<wbr>Mode<wbr>Cavlc</dt>
    <dd>Cavlc{{% md %}}Context Adaptive Variable Length Coder (CAVLC) entropy encoding.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#blurtype_csharp" style="color: inherit; text-decoration: inherit;">Blur<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#blurtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Blur<wbr>Type</a></span>
    </dt>
...
<a href="#mode_csharp" style="color: inherit; text-decoration: inherit;">Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#faceredactormode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Face<wbr>Redactor<wbr>Mode</a></span>
    </dt>
...
<a href="#resolution_csharp" style="color: inherit; text-decoration: inherit;">Resolution</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#analysisresolution">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Analysis<wbr>Resolution</a></span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="blurtype_go">
<a href="#blurtype_go" style="color: inherit; text-decoration: inherit;">Blur<wbr>Type</a>
</span>
        <span class="property-indicator"></span>
...
<h4 id="faceredactormode">Face<wbr>Redactor<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Analyze</dt>
    <dd>Analyze{{% md %}}Analyze mode detects faces and outputs a metadata file with the results. Allows editing of the metadata file before faces are blurred with Redact mode.{{% /md %}}</dd><dt>Redact</dt>
    <dd>Redact{{% md %}}Redact mode consumes the metadata file from Analyze mode and redacts the faces found.{{% /md %}}</dd><dt>Combined</dt>
    <dd>Combined{{% md %}}Combined mode does the Analyze and Redact steps in one pass when editing the analyzed faces is not desired.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Face<wbr>Redactor<wbr>Mode<wbr>Analyze</dt>
    <dd>Analyze{{% md %}}Analyze mode detects faces and outputs a metadata file with the results. Allows editing of the metadata file before faces are blurred with Redact mode.{{% /md %}}</dd><dt>Face<wbr>Redactor<wbr>Mode<wbr>Redact</dt>
    <dd>Redact{{% md %}}Redact mode consumes the metadata file from Analyze mode and redacts the faces found.{{% /md %}}</dd><dt>Face<wbr>Redactor<wbr>Mode<wbr>Combined</dt>
    <dd>Combined{{% md %}}Combined mode does the Analyze and Redact steps in one pass when editing the analyzed faces is not desired.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#crop_csharp" style="color: inherit; text-decoration: inherit;">Crop</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rectangle">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Rectangle</a></span>
    </dt>
...
<a href="#deinterlace_csharp" style="color: inherit; text-decoration: inherit;">Deinterlace</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deinterlace">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Deinterlace</a></span>
    </dt>
...
<a href="#overlays_csharp" style="color: inherit; text-decoration: inherit;">Overlays</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Union&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Audio<wbr>Overlay, Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Video<wbr>Overlay&gt;&gt;</span>
    </dt>
...
<a href="#rotation_csharp" style="color: inherit; text-decoration: inherit;">Rotation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#rotation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Rotation</a></span>
    </dt>
...
<a href="#overlays_python" style="color: inherit; text-decoration: inherit;">overlays</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[Union[Audio<wbr>Overlay, Video<wbr>Overlay]]</span>
    </dt>
    <dd>{{% md %}}The properties of overlays to be applied to the input video. These could be audio, image or video overlays.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Speed</dt>
    <dd>Speed{{% md %}}Tells the encoder to use settings that are optimized for faster encoding. Quality is sacrificed to decrease encoding time.{{% /md %}}</dd><dt>Balanced</dt>
    <dd>Balanced{{% md %}}Tells the encoder to use settings that achieve a balance between speed and quality.{{% /md %}}</dd><dt>Quality</dt>
    <dd>Quality{{% md %}}Tells the encoder to use settings that are optimized to produce higher quality output at the expense of slower overall encode time.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>H264Complexity<wbr>Speed</dt>
    <dd>Speed{{% md %}}Tells the encoder to use settings that are optimized for faster encoding. Quality is sacrificed to decrease encoding time.{{% /md %}}</dd><dt>H264Complexity<wbr>Balanced</dt>
    <dd>Balanced{{% md %}}Tells the encoder to use settings that achieve a balance between speed and quality.{{% /md %}}</dd><dt>H264Complexity<wbr>Quality</dt>
    <dd>Quality{{% md %}}Tells the encoder to use settings that are optimized to produce higher quality output at the expense of slower overall encode time.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#entropymode_csharp" style="color: inherit; text-decoration: inherit;">Entropy<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#entropymode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Entropy<wbr>Mode</a></span>
    </dt>
...
<a href="#profile_csharp" style="color: inherit; text-decoration: inherit;">Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#h264videoprofile">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>H264Video<wbr>Profile</a></span>
    </dt>
...
<a href="#complexity_csharp" style="color: inherit; text-decoration: inherit;">Complexity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#h264complexity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>H264Complexity</a></span>
    </dt>
...
<a href="#layers_csharp" style="color: inherit; text-decoration: inherit;">Layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#h264layer">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>H264Layer&gt;</a></span>
    </dt>
...
<a href="#syncmode_csharp" style="color: inherit; text-decoration: inherit;">Sync<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#videosyncmode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Video<wbr>Sync<wbr>Mode</a></span>
    </dt>
...
<a href="#layers_python" style="color: inherit; text-decoration: inherit;">layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#h264layer">Sequence[H264Layer]</a></span>
    </dt>
    <dd>{{% md %}}The collection of output H.264 layers to be produced by the encoder.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Auto</dt>
    <dd>Auto{{% md %}}Tells the encoder to automatically determine the appropriate H.264 profile.{{% /md %}}</dd><dt>Baseline</dt>
    <dd>Baseline{{% md %}}Baseline profile{{% /md %}}</dd><dt>Main</dt>
    <dd>Main{{% md %}}Main profile{{% /md %}}</dd><dt>High</dt>
    <dd>High{{% md %}}High profile.{{% /md %}}</dd><dt>High422</dt>
    <dd>High422{{% md %}}High 4:2:2 profile.{{% /md %}}</dd><dt>High444</dt>
    <dd>High444{{% md %}}High 4:4:4 predictive profile.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>H264Video<wbr>Profile<wbr>Auto</dt>
    <dd>Auto{{% md %}}Tells the encoder to automatically determine the appropriate H.264 profile.{{% /md %}}</dd><dt>H264Video<wbr>Profile<wbr>Baseline</dt>
    <dd>Baseline{{% md %}}Baseline profile{{% /md %}}</dd><dt>H264Video<wbr>Profile<wbr>Main</dt>
    <dd>Main{{% md %}}Main profile{{% /md %}}</dd><dt>H264Video<wbr>Profile<wbr>High</dt>
    <dd>High{{% md %}}High profile.{{% /md %}}</dd><dt>H264Video<wbr>Profile<wbr>High422</dt>
    <dd>High422{{% md %}}High 4:2:2 profile.{{% /md %}}</dd><dt>H264Video<wbr>Profile<wbr>High444</dt>
    <dd>High444{{% md %}}High 4:4:4 predictive profile.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="h265complexity">H265Complexity</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>H265Complexity<wbr>Speed</dt>
    <dd>Speed{{% md %}}Tells the encoder to use settings that are optimized for faster encoding. Quality is sacrificed to decrease encoding time.{{% /md %}}</dd><dt>H265Complexity<wbr>Balanced</dt>
    <dd>Balanced{{% md %}}Tells the encoder to use settings that achieve a balance between speed and quality.{{% /md %}}</dd><dt>H265Complexity<wbr>Quality</dt>
    <dd>Quality{{% md %}}Tells the encoder to use settings that are optimized to produce higher quality output at the expense of slower overall encode time.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#profile_csharp" style="color: inherit; text-decoration: inherit;">Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#h265videoprofile">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>H265Video<wbr>Profile</a></span>
    </dt>
...
<a href="#complexity_csharp" style="color: inherit; text-decoration: inherit;">Complexity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#h265complexity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>H265Complexity</a></span>
    </dt>
...
<a href="#layers_csharp" style="color: inherit; text-decoration: inherit;">Layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#h265layer">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>H265Layer&gt;</a></span>
    </dt>
...
<a href="#layers_python" style="color: inherit; text-decoration: inherit;">layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#h265layer">Sequence[H265Layer]</a></span>
    </dt>
    <dd>{{% md %}}The collection of output H.265 layers to be produced by the encoder.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="scene_change_detection_python">
...
<h4 id="h265videoprofile">H265Video<wbr>Profile</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Auto</dt>
    <dd>Auto{{% md %}}Tells the encoder to automatically determine the appropriate H.265 profile.{{% /md %}}</dd><dt>Main</dt>
    <dd>Main{{% md %}}Main profile (https://x265.readthedocs.io/en/default/cli.html?highlight=profile#profile-level-tier){{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>H265Video<wbr>Profile<wbr>Auto</dt>
    <dd>Auto{{% md %}}Tells the encoder to automatically determine the appropriate H.265 profile.{{% /md %}}</dd><dt>H265Video<wbr>Profile<wbr>Main</dt>
    <dd>Main{{% md %}}Main profile (https://x265.readthedocs.io/en/default/cli.html?highlight=profile#profile-level-tier){{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Audio<wbr>Insights<wbr>Only</dt>
    <dd>AudioInsightsOnly{{% md %}}Generate audio only insights. Ignore video even if present. Fails if no audio is present.{{% /md %}}</dd><dt>Video<wbr>Insights<wbr>Only</dt>
    <dd>VideoInsightsOnly{{% md %}}Generate video only insights. Ignore audio if present. Fails if no video is present.{{% /md %}}</dd><dt>All<wbr>Insights</dt>
    <dd>AllInsights{{% md %}}Generate both audio and video insights. Fails if either audio or video Insights fail.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Insights<wbr>Type<wbr>Audio<wbr>Insights<wbr>Only</dt>
    <dd>AudioInsightsOnly{{% md %}}Generate audio only insights. Ignore video even if present. Fails if no audio is present.{{% /md %}}</dd><dt>Insights<wbr>Type<wbr>Video<wbr>Insights<wbr>Only</dt>
    <dd>VideoInsightsOnly{{% md %}}Generate video only insights. Ignore audio if present. Fails if no video is present.{{% /md %}}</dd><dt>Insights<wbr>Type<wbr>All<wbr>Insights</dt>
    <dd>AllInsights{{% md %}}Generate both audio and video insights. Fails if either audio or video Insights fail.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>AUDIO_INSIGHTS_ONLY</dt>
    <dd>AudioInsightsOnly{{% md %}}Generate audio only insights. Ignore video even if present. Fails if no audio is present.{{% /md %}}</dd><dt>VIDEO_INSIGHTS_ONLY</dt>
    <dd>VideoInsightsOnly{{% md %}}Generate video only insights. Ignore audio if present. Fails if no video is present.{{% /md %}}</dd><dt>ALL_INSIGHTS</dt>
    <dd>AllInsights{{% md %}}Generate both audio and video insights. Fails if either audio or video Insights fail.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#layers_csharp" style="color: inherit; text-decoration: inherit;">Layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jpglayer">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Jpg<wbr>Layer&gt;</a></span>
    </dt>
...
<a href="#layers_python" style="color: inherit; text-decoration: inherit;">layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jpglayer">Sequence[Jpg<wbr>Layer]</a></span>
    </dt>
    <dd>{{% md %}}A collection of output JPEG image layers to be produced by the encoder.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="range_python">
...
<a href="#outputfiles_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>Files</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outputfile">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Output<wbr>File&gt;</a></span>
    </dt>
...
<a href="#output_files_python" style="color: inherit; text-decoration: inherit;">output_<wbr>files</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outputfile">Sequence[Output<wbr>File]</a></span>
    </dt>
    <dd>{{% md %}}The list of output files to produce.  Each entry in the list is a set of audio and video layer labels to be muxed together .{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Stop<wbr>Processing<wbr>Job</dt>
    <dd>StopProcessingJob{{% md %}}Tells the service that if this TransformOutput fails, then any other incomplete TransformOutputs can be stopped.{{% /md %}}</dd><dt>Continue<wbr>Job</dt>
    <dd>ContinueJob{{% md %}}Tells the service that if this TransformOutput fails, then allow any other TransformOutput to continue.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>On<wbr>Error<wbr>Type<wbr>Stop<wbr>Processing<wbr>Job</dt>
    <dd>StopProcessingJob{{% md %}}Tells the service that if this TransformOutput fails, then any other incomplete TransformOutputs can be stopped.{{% /md %}}</dd><dt>On<wbr>Error<wbr>Type<wbr>Continue<wbr>Job</dt>
    <dd>ContinueJob{{% md %}}Tells the service that if this TransformOutput fails, then allow any other TransformOutput to continue.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>STOP_PROCESSING_JOB</dt>
    <dd>StopProcessingJob{{% md %}}Tells the service that if this TransformOutput fails, then any other incomplete TransformOutputs can be stopped.{{% /md %}}</dd><dt>CONTINUE_JOB</dt>
    <dd>ContinueJob{{% md %}}Tells the service that if this TransformOutput fails, then allow any other TransformOutput to continue.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#layers_csharp" style="color: inherit; text-decoration: inherit;">Layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pnglayer">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Png<wbr>Layer&gt;</a></span>
    </dt>
...
<a href="#layers_python" style="color: inherit; text-decoration: inherit;">layers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pnglayer">Sequence[Png<wbr>Layer]</a></span>
    </dt>
    <dd>{{% md %}}A collection of output PNG image layers to be produced by the encoder.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="range_python">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Auto</dt>
    <dd>Auto{{% md %}}Automatically detect and rotate as needed.{{% /md %}}</dd><dt>None</dt>
    <dd>None{{% md %}}Do not rotate the video.  If the output format supports it, any metadata about rotation is kept intact.{{% /md %}}</dd><dt>Rotate0</dt>
    <dd>Rotate0{{% md %}}Do not rotate the video but remove any metadata about the rotation.{{% /md %}}</dd><dt>Rotate90</dt>
    <dd>Rotate90{{% md %}}Rotate 90 degrees clockwise.{{% /md %}}</dd><dt>Rotate180</dt>
    <dd>Rotate180{{% md %}}Rotate 180 degrees clockwise.{{% /md %}}</dd><dt>Rotate270</dt>
    <dd>Rotate270{{% md %}}Rotate 270 degrees clockwise.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Rotation<wbr>Auto</dt>
    <dd>Auto{{% md %}}Automatically detect and rotate as needed.{{% /md %}}</dd><dt>Rotation<wbr>None</dt>
    <dd>None{{% md %}}Do not rotate the video.  If the output format supports it, any metadata about rotation is kept intact.{{% /md %}}</dd><dt>Rotation<wbr>Rotate0</dt>
    <dd>Rotate0{{% md %}}Do not rotate the video but remove any metadata about the rotation.{{% /md %}}</dd><dt>Rotation<wbr>Rotate90</dt>
    <dd>Rotate90{{% md %}}Rotate 90 degrees clockwise.{{% /md %}}</dd><dt>Rotation<wbr>Rotate180</dt>
    <dd>Rotate180{{% md %}}Rotate 180 degrees clockwise.{{% /md %}}</dd><dt>Rotation<wbr>Rotate270</dt>
    <dd>Rotate270{{% md %}}Rotate 270 degrees clockwise.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#filters_csharp" style="color: inherit; text-decoration: inherit;">Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filters">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Filters</a></span>
    </dt>
...
<a href="#codecs_python" style="color: inherit; text-decoration: inherit;">codecs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[Union[Aac<wbr>Audio, Audio, Copy<wbr>Audio, Copy<wbr>Video, H264Video, H265Video, Image, Jpg<wbr>Image, Png<wbr>Image, Video]]</span>
    </dt>
    <dd>{{% md %}}The list of codecs to be used when encoding the input video.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#formats_python" style="color: inherit; text-decoration: inherit;">formats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[Union[Image<wbr>Format, Jpg<wbr>Format, Mp4Format, Multi<wbr>Bitrate<wbr>Format, Png<wbr>Format, Transport<wbr>Stream<wbr>Format]]</span>
    </dt>
    <dd>{{% md %}}The list of outputs to be produced by the encoder.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>None</dt>
    <dd>None{{% md %}}Strictly respect the output resolution without considering the pixel aspect ratio or display aspect ratio of the input video.{{% /md %}}</dd><dt>Auto<wbr>Size</dt>
    <dd>AutoSize{{% md %}}Override the output resolution, and change it to match the display aspect ratio of the input, without padding. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the value in the preset is overridden, and the output will be at 1280x720, which maintains the input aspect ratio of 16:9.{{% /md %}}</dd><dt>Auto<wbr>Fit</dt>
    <dd>AutoFit{{% md %}}Pad the output (with either letterbox or pillar box) to honor the output resolution, while ensuring that the active video region in the output has the same aspect ratio as the input. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the output will be at 1280x1280, which contains an inner rectangle of 1280x720 at aspect ratio of 16:9, and pillar box regions 280 pixels wide at the left and right.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Stretch<wbr>Mode<wbr>None</dt>
    <dd>None{{% md %}}Strictly respect the output resolution without considering the pixel aspect ratio or display aspect ratio of the input video.{{% /md %}}</dd><dt>Stretch<wbr>Mode<wbr>Auto<wbr>Size</dt>
    <dd>AutoSize{{% md %}}Override the output resolution, and change it to match the display aspect ratio of the input, without padding. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the value in the preset is overridden, and the output will be at 1280x720, which maintains the input aspect ratio of 16:9.{{% /md %}}</dd><dt>Stretch<wbr>Mode<wbr>Auto<wbr>Fit</dt>
    <dd>AutoFit{{% md %}}Pad the output (with either letterbox or pillar box) to honor the output resolution, while ensuring that the active video region in the output has the same aspect ratio as the input. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the output will be at 1280x1280, which contains an inner rectangle of 1280x720 at aspect ratio of 16:9, and pillar box regions 280 pixels wide at the left and right.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>NONE</dt>
    <dd>None{{% md %}}Strictly respect the output resolution without considering the pixel aspect ratio or display aspect ratio of the input video.{{% /md %}}</dd><dt>AUTO_SIZE</dt>
    <dd>AutoSize{{% md %}}Override the output resolution, and change it to match the display aspect ratio of the input, without padding. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the value in the preset is overridden, and the output will be at 1280x720, which maintains the input aspect ratio of 16:9.{{% /md %}}</dd><dt>AUTO_FIT</dt>
    <dd>AutoFit{{% md %}}Pad the output (with either letterbox or pillar box) to honor the output resolution, while ensuring that the active video region in the output has the same aspect ratio as the input. For example, if the input is 1920x1080 and the encoding preset asks for 1280x1280, then the output will be at 1280x1280, which contains an inner rectangle of 1280x720 at aspect ratio of 16:9, and pillar box regions 280 pixels wide at the left and right.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#preset_csharp" style="color: inherit; text-decoration: inherit;">Preset</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#audioanalyzerpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Audio<wbr>Analyzer<wbr>Preset</a> | <a href="#builtinstandardencoderpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Built<wbr>In<wbr>Standard<wbr>Encoder<wbr>Preset</a> | <a href="#facedetectorpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Face<wbr>Detector<wbr>Preset</a> | <a href="#standardencoderpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Standard<wbr>Encoder<wbr>Preset</a> | <a href="#videoanalyzerpreset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Video<wbr>Analyzer<wbr>Preset</a></span>
    </dt>
...
<a href="#onerror_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Error</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#onerrortype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>On<wbr>Error<wbr>Type</a></span>
    </dt>
...
<a href="#insightstoextract_csharp" style="color: inherit; text-decoration: inherit;">Insights<wbr>To<wbr>Extract</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#insightstype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Insights<wbr>Type</a></span>
    </dt>
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Auto</dt>
    <dd>Auto{{% md %}}This is the default method. Chooses between Cfr and Vfr depending on muxer capabilities. For output format MP4, the default mode is Cfr.{{% /md %}}</dd><dt>Passthrough</dt>
    <dd>Passthrough{{% md %}}The presentation timestamps on frames are passed through from the input file to the output file writer. Recommended when the input source has variable frame rate, and are attempting to produce multiple layers for adaptive streaming in the output which have aligned GOP boundaries. Note: if two or more frames in the input have duplicate timestamps, then the output will also have the same behavior{{% /md %}}</dd><dt>Cfr</dt>
    <dd>Cfr{{% md %}}Input frames will be repeated and/or dropped as needed to achieve exactly the requested constant frame rate. Recommended when the output frame rate is explicitly set at a specified value{{% /md %}}</dd><dt>Vfr</dt>
    <dd>Vfr{{% md %}}Similar to the Passthrough mode, but if the input has frames that have duplicate timestamps, then only one frame is passed through to the output, and others are dropped. Recommended when the number of output frames is expected to be equal to the number of input frames. For example, the output is used to calculate a quality metric like PSNR against the input{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Video<wbr>Sync<wbr>Mode<wbr>Auto</dt>
    <dd>Auto{{% md %}}This is the default method. Chooses between Cfr and Vfr depending on muxer capabilities. For output format MP4, the default mode is Cfr.{{% /md %}}</dd><dt>Video<wbr>Sync<wbr>Mode<wbr>Passthrough</dt>
    <dd>Passthrough{{% md %}}The presentation timestamps on frames are passed through from the input file to the output file writer. Recommended when the input source has variable frame rate, and are attempting to produce multiple layers for adaptive streaming in the output which have aligned GOP boundaries. Note: if two or more frames in the input have duplicate timestamps, then the output will also have the same behavior{{% /md %}}</dd><dt>Video<wbr>Sync<wbr>Mode<wbr>Cfr</dt>
    <dd>Cfr{{% md %}}Input frames will be repeated and/or dropped as needed to achieve exactly the requested constant frame rate. Recommended when the output frame rate is explicitly set at a specified value{{% /md %}}</dd><dt>Video<wbr>Sync<wbr>Mode<wbr>Vfr</dt>
    <dd>Vfr{{% md %}}Similar to the Passthrough mode, but if the input has frames that have duplicate timestamps, then only one frame is passed through to the output, and others are dropped. Recommended when the number of output frames is expected to be equal to the number of input frames. For example, the output is used to calculate a quality metric like PSNR against the input{{% /md %}}</dd></dl>
{{% /choosable %}}
