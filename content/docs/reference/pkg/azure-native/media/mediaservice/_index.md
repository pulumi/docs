...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewMediaService</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">MediaServiceArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">MediaService</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#encryption_csharp" style="color: inherit; text-decoration: inherit;">Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountencryption">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Account<wbr>Encryption<wbr>Args</a></span>
    </dt>
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mediaserviceidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Media<wbr>Service<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#storageaccounts_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Accounts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageaccount">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Inputs.<wbr>Storage<wbr>Account<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#mediaserviceid_csharp" style="color: inherit; text-decoration: inherit;">Media<wbr>Service<wbr>Id</a>
    ...
    <dd>{{% md %}}The Media Services account ID.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<dl class="tabular"><dt>System<wbr>Assigned</dt>
    <dd>SystemAssigned{{% md %}}A system-assigned managed identity.{{% /md %}}</dd><dt>None</dt>
    <dd>None{{% md %}}No managed identity.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Managed<wbr>Identity<wbr>Type<wbr>System<wbr>Assigned</dt>
    <dd>SystemAssigned{{% md %}}A system-assigned managed identity.{{% /md %}}</dd><dt>Managed<wbr>Identity<wbr>Type<wbr>None</dt>
    <dd>None{{% md %}}No managed identity.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#managedidentitytype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Media.<wbr>Managed<wbr>Identity<wbr>Type</a></span>
    </dt>
...
<dl class="tabular"><dt>Primary</dt>
    <dd>Primary{{% md %}}The primary storage account for the Media Services account.{{% /md %}}</dd><dt>Secondary</dt>
    <dd>Secondary{{% md %}}A secondary storage account for the Media Services account.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Storage<wbr>Account<wbr>Type<wbr>Primary</dt>
    <dd>Primary{{% md %}}The primary storage account for the Media Services account.{{% /md %}}</dd><dt>Storage<wbr>Account<wbr>Type<wbr>Secondary</dt>
    <dd>Secondary{{% md %}}A secondary storage account for the Media Services account.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>System</dt>
    <dd>System{{% md %}}System authentication.{{% /md %}}</dd><dt>Managed<wbr>Identity</dt>
    <dd>ManagedIdentity{{% md %}}Managed Identity authentication.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Storage<wbr>Authentication<wbr>System</dt>
    <dd>System{{% md %}}System authentication.{{% /md %}}</dd><dt>Storage<wbr>Authentication<wbr>Managed<wbr>Identity</dt>
    <dd>ManagedIdentity{{% md %}}Managed Identity authentication.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>SYSTEM</dt>
    <dd>System{{% md %}}System authentication.{{% /md %}}</dd><dt>MANAGED_IDENTITY</dt>
    <dd>ManagedIdentity{{% md %}}Managed Identity authentication.{{% /md %}}</dd></dl>
{{% /choosable %}}
