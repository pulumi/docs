...
<span class="k">def </span><span class="nx">SupportPlanType</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">plan_type_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#providername_csharp" style="color: inherit; text-decoration: inherit;">Provider<wbr>Name</a>
    ...
    <dd>{{% md %}}The support plan type. For now the only valid type is "canonical".{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#plantypename_csharp" style="color: inherit; text-decoration: inherit;">Plan<wbr>Type<wbr>Name</a>
    ...
    <dd>{{% md %}}The Canonical support plan type.{{% /md %}}</dd></dl>
{{% /choosable %}}
