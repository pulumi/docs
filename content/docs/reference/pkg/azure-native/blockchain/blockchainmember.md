...
title_tag: "azure-native.blockchain.BlockchainMember"
meta_desc: "Documentation for the azure-native.blockchain.BlockchainMember resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">BlockchainMember</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">blockchain_member_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">consortium</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">consortium_management_account_password</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">consortium_member_display_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">consortium_role</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">firewall_rules</span><span class="p">:</span> <span class="nx">Optional[Sequence[FirewallRuleArgs]]</span> = None<span class="p">,</span>
                     <span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">password</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">protocol</span><span class="p">:</span> <span class="nx">Optional[Union[str, BlockchainProtocol]]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">validator_nodes_sku</span><span class="p">:</span> <span class="nx">Optional[BlockchainMemberNodesSkuArgs]</span> = None<span class="p">)</span>
...
The BlockchainMember resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#firewallrules_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallrule">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Blockchain.<wbr>Inputs.<wbr>Firewall<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#blockchainprotocol">Pulumi.<wbr>Azure<wbr>Native.<wbr>Blockchain.<wbr>Blockchain<wbr>Protocol</a></span>
    </dt>
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Blockchain.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
...
<a href="#validatornodessku_csharp" style="color: inherit; text-decoration: inherit;">Validator<wbr>Nodes<wbr>Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#blockchainmembernodessku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Blockchain.<wbr>Inputs.<wbr>Blockchain<wbr>Member<wbr>Nodes<wbr>Sku<wbr>Args</a></span>
    </dt>
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}Gets the auth user name of the blockchain member.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="blockchainprotocol">Blockchain<wbr>Protocol</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Not<wbr>Specified</dt>
    <dd>NotSpecified</dd><dt>Parity</dt>
    <dd>Parity</dd><dt>Quorum</dt>
    <dd>Quorum</dd><dt>Corda</dt>
    <dd>Corda</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Blockchain<wbr>Protocol<wbr>Not<wbr>Specified</dt>
    <dd>NotSpecified</dd><dt>Blockchain<wbr>Protocol<wbr>Parity</dt>
    <dd>Parity</dd><dt>Blockchain<wbr>Protocol<wbr>Quorum</dt>
    <dd>Quorum</dd><dt>Blockchain<wbr>Protocol<wbr>Corda</dt>
    <dd>Corda</dd></dl>
{{% /choosable %}}
