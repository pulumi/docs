...
<span class="k">def </span><span class="nx">Group</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[GroupType]]</span> = None<span class="p">)</span>
...
<a href="#type_nodejs" style="color: inherit; text-decoration: inherit;">type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#grouptype">pulumi.<wbr>Input<Group<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Group type.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_python" style="color: inherit; text-decoration: inherit;">type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#grouptype">Input[Group<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Group type.{{% /md %}}</dd></dl>
{{% /choosable %}}
