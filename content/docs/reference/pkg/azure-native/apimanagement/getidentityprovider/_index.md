...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_identity_provider(</span><span class="nx">identity_provider_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          <span class="nx">service_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIdentityProviderResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIdentityProvider<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIdentityProviderArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIdentityProviderResult</a></span>, error)</span></code></pre></div>
...
<a href="#identityprovidername_csharp" style="color: inherit; text-decoration: inherit;">Identity<wbr>Provider<wbr>Name</a>
    ...
    <dd>{{% md %}}Identity Provider Type identifier.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
    ...
    <dd>{{% md %}}Client Id of the Application in the external Identity Provider. It is App ID for Facebook login, Client ID for Google login, App ID for Microsoft.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#allowedtenants_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Tenants</a>
    ...
    <dd>{{% md %}}List of Allowed Tenants when configuring Azure Active Directory login.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#authority_csharp" style="color: inherit; text-decoration: inherit;">Authority</a>
    ...
    <dd>{{% md %}}OpenID Connect discovery endpoint hostname for AAD or AAD B2C.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#passwordresetpolicyname_csharp" style="color: inherit; text-decoration: inherit;">Password<wbr>Reset<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}Password Reset Policy Name. Only applies to AAD B2C Identity Provider.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#profileeditingpolicyname_csharp" style="color: inherit; text-decoration: inherit;">Profile<wbr>Editing<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}Profile Editing Policy Name. Only applies to AAD B2C Identity Provider.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#signinpolicyname_csharp" style="color: inherit; text-decoration: inherit;">Signin<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}Signin Policy Name. Only applies to AAD B2C Identity Provider.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#signintenant_csharp" style="color: inherit; text-decoration: inherit;">Signin<wbr>Tenant</a>
    ...
    <dd>{{% md %}}The TenantId to use instead of Common when logging into Active Directory{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#signuppolicyname_csharp" style="color: inherit; text-decoration: inherit;">Signup<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}Signup Policy Name. Only applies to AAD B2C Identity Provider.{{% /md %}}</dd></dl>
{{% /choosable %}}
