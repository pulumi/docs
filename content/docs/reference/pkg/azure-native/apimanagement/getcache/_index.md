...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_cache(</span><span class="nx">cache_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#cacheid_csharp" style="color: inherit; text-decoration: inherit;">Cache<wbr>Id</a>
    ...
    <dd>{{% md %}}Identifier of the Cache entity. Cache identifier (should be either 'default' or valid Azure region identifier).{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#connectionstring_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Runtime connection string to cache{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Cache description{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}Original uri of entity in external system cache points to{{% /md %}}</dd></dl>
{{% /choosable %}}
