...
<dl class="tabular">
    <dt>Http</dt>
    <dd>http{{% md %}}The Backend is a RESTful service.{{% /md %}}</dd>
    <dt>Soap</dt>
    <dd>soap{{% md %}}The Backend is a SOAP service.{{% /md %}}</dd>
</dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular">
    <dt>Backend<wbr>Protocol<wbr>Http</dt>
    <dd>http{{% md %}}The Backend is a RESTful service.{{% /md %}}</dd>
    <dt>Backend<wbr>Protocol<wbr>Soap</dt>
    <dd>soap{{% md %}}The Backend is a SOAP service.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
