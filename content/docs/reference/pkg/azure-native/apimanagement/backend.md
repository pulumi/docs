...
<a href="#credentials_csharp" style="color: inherit; text-decoration: inherit;">Credentials</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendcredentialscontract">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Backend<wbr>Credentials<wbr>Contract<wbr>Args</a></span>
    </dt>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Backend<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<a href="#proxy_csharp" style="color: inherit; text-decoration: inherit;">Proxy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendproxycontract">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Backend<wbr>Proxy<wbr>Contract<wbr>Args</a></span>
    </dt>
...
<a href="#tls_csharp" style="color: inherit; text-decoration: inherit;">Tls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendtlsproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Backend<wbr>Tls<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<h4 id="backendprotocol">Backend<wbr>Protocol</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Http</dt>
    <dd>http{{% md %}}The Backend is a RESTful service.{{% /md %}}</dd><dt>Soap</dt>
    <dd>soap{{% md %}}The Backend is a SOAP service.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Backend<wbr>Protocol<wbr>Http</dt>
    <dd>http{{% md %}}The Backend is a RESTful service.{{% /md %}}</dd><dt>Backend<wbr>Protocol<wbr>Soap</dt>
    <dd>soap{{% md %}}The Backend is a SOAP service.{{% /md %}}</dd></dl>
{{% /choosable %}}
