...
<span class="k">def </span><span class="nx">Logger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">credentials</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]</span> = None<span class="p">,</span>
           <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
           <span class="nx">is_buffered</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
           <span class="nx">logger_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
           <span class="nx">logger_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, LoggerType]]]</span> = None<span class="p">,</span>
...
<a href="#loggertype_nodejs" style="color: inherit; text-decoration: inherit;">logger<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#loggertype">pulumi.<wbr>Input<Logger<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Logger type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#logger_type_python" style="color: inherit; text-decoration: inherit;">logger_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#loggertype">Input[Logger<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Logger type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
