...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_private_dns_zone_group(</span><span class="nx">private_dns_zone_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                               ...
                               <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetPrivateDnsZoneGroupResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupPrivateDnsZoneGroup<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupPrivateDnsZoneGroupArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupPrivateDnsZoneGroupResult</a></span>, error)</span></code></pre></div>
...
<a href="#privatednszonegroupname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Zone<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the private dns zone group.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the private dns zone group resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the resource that is unique within a resource group. This name can be used to access the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privatednszoneconfigs_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Zone<wbr>Configs</a>
    ...
    <dd>{{% md %}}A collection of private dns zone configurations of the private dns zone group.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#privatednszoneid_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Zone<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource id of the private dns zone.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the recordset.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="fqdn_csharp">
...
<a href="#ipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Addresses</a>
    ...
    <dd>{{% md %}}The private ip address of the private endpoint.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#recordsetname_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Set<wbr>Name</a>
    ...
    <dd>{{% md %}}Recordset name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#recordtype_csharp" style="color: inherit; text-decoration: inherit;">Record<wbr>Type</a>
    ...
    <dd>{{% md %}}Resource record type.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ttl_csharp">
<a href="#ttl_csharp" style="color: inherit; text-decoration: inherit;">Ttl</a>
    ...
    <dd>{{% md %}}Recordset time to live.{{% /md %}}</dd></dl>
{{% /choosable %}}
