...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupVirtualWan<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupVirtualWanArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupVirtualWanResult</a></span>, error)</span></code></pre></div>
...
<a href="#virtualwanname_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>WANName</a>
    ...
    <dd>{{% md %}}The name of the VirtualWAN being retrieved.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#vpnsites_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Sites</a>
    ...
    <dd>{{% md %}}List of VpnSites in the VirtualWAN.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#allowbranchtobranchtraffic_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Branch<wbr>To<wbr>Branch<wbr>Traffic</a>
    ...
    <dd>{{% md %}}True if branch to branch traffic is allowed.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#allowvnettovnettraffic_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Vnet<wbr>To<wbr>Vnet<wbr>Traffic</a>
    ...
    <dd>{{% md %}}True if Vnet to Vnet traffic is allowed.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disablevpnencryption_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Vpn<wbr>Encryption</a>
    ...
    <dd>{{% md %}}Vpn encryption to be disabled or not.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
