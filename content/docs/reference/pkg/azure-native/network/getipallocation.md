...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIpAllocation<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetIpAllocationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetIpAllocationResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_ip_allocation(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                      ...
                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIpAllocationResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIpAllocation<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIpAllocationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIpAllocationResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIpAllocation </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetIpAllocationResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetIpAllocationArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#ipallocationname_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Allocation<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the IpAllocation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#virtualnetwork_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network</a>
    ...
    <dd>{{% md %}}The VirtualNetwork that using the prefix of this IpAllocation resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#allocationtags_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Tags</a>
    ...
    <dd>{{% md %}}IpAllocation tags.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipamallocationid_csharp" style="color: inherit; text-decoration: inherit;">Ipam<wbr>Allocation<wbr>Id</a>
    ...
    <dd>{{% md %}}The IPAM allocation ID.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#prefix_csharp" style="color: inherit; text-decoration: inherit;">Prefix</a>
    ...
    <dd>{{% md %}}The address prefix for the IpAllocation.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#prefixlength_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>Length</a>
    ...
    <dd>{{% md %}}The address prefix length for the IpAllocation.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#prefixtype_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>Type</a>
    ...
    <dd>{{% md %}}The address prefix Type for the IpAllocation.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
