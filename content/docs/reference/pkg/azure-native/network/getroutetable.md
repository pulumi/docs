...
---
title: "getRouteTable"
title_tag: "azure-native.network.getRouteTable"
meta_desc: "Documentation for the azure-native.network.getRouteTable function with examples, input properties, output properties, and supporting types."
---
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the route table resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
    ...
    <dd>{{% md %}}The resource GUID property of the route table.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disablebgproutepropagation_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Bgp<wbr>Route<wbr>Propagation</a>
    ...
    <dd>{{% md %}}Whether to disable the routes learned by BGP on that route table. True means disable.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#routes_csharp" style="color: inherit; text-decoration: inherit;">Routes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routeresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Route<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Collection of routes contained within a route table.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
