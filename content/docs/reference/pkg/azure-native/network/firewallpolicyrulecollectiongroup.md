...
<span class="k">def </span><span class="nx">FirewallPolicyRuleCollectionGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                      ...
                                      <span class="nx">rule_collections</span><span class="p">:</span> <span class="nx">Optional[Sequence[Union[FirewallPolicyFilterRuleCollectionArgs, FirewallPolicyNatRuleCollectionArgs]]]</span> = None<span class="p">)</span>
...
<a href="#rulecollections_nodejs" style="color: inherit; text-decoration: inherit;">rule<wbr>Collections</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Firewall<wbr>Policy<wbr>Filter<wbr>Rule<wbr>Collection<wbr>Args | Firewall<wbr>Policy<wbr>Nat<wbr>Rule<wbr>Collection<wbr>Args[]</span>
    </dt>
    <dd>{{% md %}}Group of Firewall Policy rule collections.{{% /md %}}</dd></dl>
{{% /choosable %}}
