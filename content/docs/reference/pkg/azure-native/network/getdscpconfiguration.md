...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_dscp_configuration(</span><span class="nx">dscp_configuration_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetDscpConfigurationResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupDscpConfiguration<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupDscpConfigurationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupDscpConfigurationResult</a></span>, error)</span></code></pre></div>
...
<a href="#destinationipranges_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Ip<wbr>Ranges</a>
    ...
    <dd>{{% md %}}Destination IP ranges.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#destinationportranges_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Port<wbr>Ranges</a>
    ...
    <dd>{{% md %}}Destination port ranges.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#markings_csharp" style="color: inherit; text-decoration: inherit;">Markings</a>
    ...
    <dd>{{% md %}}List of markings to be used in the configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd>{{% md %}}RNM supported protocol types.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceipranges_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Ip<wbr>Ranges</a>
    ...
    <dd>{{% md %}}Source IP ranges.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceportranges_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Port<wbr>Ranges</a>
    ...
    <dd>{{% md %}}Sources port ranges.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
