...
class MyStack : Stack
{
    public MyStack()
    {
        var packetCapture = new AzureNative.Network.PacketCapture("packetCapture", new AzureNative.Network.PacketCaptureArgs
        {
...
<span class="k">def </span><span class="nx">PacketCapture</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">total_bytes_per_session</span><span class="p">:</span> <span class="nx">Optional[float]</span> = None<span class="p">)</span>
