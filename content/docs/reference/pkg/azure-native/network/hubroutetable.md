...
<span class="k">def </span><span class="nx">HubRouteTable</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">routes</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[HubRouteArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#routes_nodejs" style="color: inherit; text-decoration: inherit;">routes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hubroute">pulumi.<wbr>Input<pulumi.<wbr>Input<Hub<wbr>Route<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of all routes.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#routes_python" style="color: inherit; text-decoration: inherit;">routes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hubroute">Input[Hub<wbr>Route<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}List of all routes.{{% /md %}}</dd></dl>
{{% /choosable %}}
