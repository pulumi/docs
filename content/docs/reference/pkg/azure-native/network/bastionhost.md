...
<span class="k">def </span><span class="nx">BastionHost</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">bastion_host_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                ...
                <span class="nx">ip_configurations</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[BastionHostIPConfigurationArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#bastionhostname_csharp" style="color: inherit; text-decoration: inherit;">Bastion<wbr>Host<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Bastion Host.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd>{{% md %}}FQDN for the endpoint on which bastion host is accessible.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bastionhostipconfiguration">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Bastion<wbr>Host<wbr>IPConfiguration<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}IP configuration of the Bastion Host resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bastionhostipconfiguration">pulumi.<wbr>Input<pulumi.<wbr>Input<Bastion<wbr>Host<wbr>IPConfiguration<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}IP configuration of the Bastion Host resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ip_configurations_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bastionhostipconfiguration">Input[Bastion<wbr>Host<wbr>IPConfiguration<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}IP configuration of the Bastion Host resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subnet_csharp" style="color: inherit; text-decoration: inherit;">Subnet</a>
    ...
    <dd>{{% md %}}Reference of the subnet resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
