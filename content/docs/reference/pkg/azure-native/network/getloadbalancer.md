...
title_tag: "azure-native.network.getLoadBalancer"
meta_desc: "Documentation for the azure-native.network.getLoadBalancer function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_load_balancer(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the load balancer resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
    ...
    <dd>{{% md %}}The resource GUID property of the load balancer resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#backendaddresspools_csharp" style="color: inherit; text-decoration: inherit;">Backend<wbr>Address<wbr>Pools</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backendaddresspoolresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Backend<wbr>Address<wbr>Pool<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Collection of backend address pools used by a load balancer.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#frontendipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>IPConfigurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#frontendipconfigurationresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Frontend<wbr>IPConfiguration<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Object representing the frontend IPs to be used for the load balancer.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#inboundnatpools_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Nat<wbr>Pools</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inboundnatpoolresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Inbound<wbr>Nat<wbr>Pool<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#inboundnatrules_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Nat<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inboundnatruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Inbound<wbr>Nat<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#loadbalancingrules_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancing<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loadbalancingruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Load<wbr>Balancing<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Object collection representing the load balancing rules Gets the provisioning.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#outboundrules_csharp" style="color: inherit; text-decoration: inherit;">Outbound<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outboundruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Outbound<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The outbound rules.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="probes_csharp">
<a href="#probes_csharp" style="color: inherit; text-decoration: inherit;">Probes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#proberesponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Probe<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Collection of probe objects used in the load balancer.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loadbalancerskuresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Load<wbr>Balancer<wbr>Sku<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The load balancer SKU.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#outbound_rules_python" style="color: inherit; text-decoration: inherit;">outbound_<wbr>rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#outboundruleresponse">Sequence[Outbound<wbr>Rule<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The outbound rules.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#probes_python" style="color: inherit; text-decoration: inherit;">probes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#proberesponse">Sequence[Probe<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Collection of probe objects used in the load balancer.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_python">
...
<a href="#frontendportrangeend_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>Port<wbr>Range<wbr>End</a>
    ...
    <dd>{{% md %}}The last port number in the range of external ports that will be used to provide Inbound Nat to NICs associated with a load balancer. Acceptable values range between 1 and 65535.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#frontendportrangestart_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>Port<wbr>Range<wbr>Start</a>
    ...
    <dd>{{% md %}}The first port number in the range of external ports that will be used to provide Inbound Nat to NICs associated with a load balancer. Acceptable values range between 1 and 65534.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd>{{% md %}}The reference to the transport protocol used by the inbound NAT pool.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="provisioningstate_csharp">
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
</span>
    ...
    <dd>{{% md %}}The provisioning state of the inbound NAT pool resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the resource that is unique within the set of inbound NAT pools used by the load balancer. This name can be used to access the resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of a load balancer SKU.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tier_csharp">
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}Tier of a load balancer SKU.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#frontendport_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>Port</a>
    ...
    <dd>{{% md %}}The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values are between 0 and 65534. Note that value 0 enables "Any Port".{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="protocol_csharp">
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
</span>
    ...
    <dd>{{% md %}}The reference to the transport protocol used by the load balancing rule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="provisioningstate_csharp">
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
</span>
    ...
    <dd>{{% md %}}The provisioning state of the load balancing rule resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#backendaddresspool_csharp" style="color: inherit; text-decoration: inherit;">Backend<wbr>Address<wbr>Pool</a>
    ...
    <dd>{{% md %}}A reference to a pool of DIPs. Inbound traffic is randomly load balanced across IPs in the backend IPs.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="backendport_csharp">
<a href="#backendport_csharp" style="color: inherit; text-decoration: inherit;">Backend<wbr>Port</a>
</span>
    ...
    <dd>{{% md %}}The port used for internal connections on the endpoint. Acceptable values are between 0 and 65535. Note that value 0 enables "Any Port".{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#disableoutboundsnat_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Outbound<wbr>Snat</a>
    ...
    <dd>{{% md %}}Configures SNAT for the VMs in the backend pool to use the publicIP address specified in the frontend of the load balancing rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="enablefloatingip_csharp">
<a href="#enablefloatingip_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Floating<wbr>IP</a>
</span>
...
<a href="#loaddistribution_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Distribution</a>
    ...
    <dd>{{% md %}}The load distribution policy for this rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}The name of the resource that is unique within the set of load balancing rules used by the load balancer. This name can be used to access the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#probe_csharp" style="color: inherit; text-decoration: inherit;">Probe</a>
    ...
    <dd>{{% md %}}The reference to the load balancer probe used by the load balancing rule.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#backendaddresspool_csharp" style="color: inherit; text-decoration: inherit;">Backend<wbr>Address<wbr>Pool</a>
    ...
    <dd>{{% md %}}A reference to a pool of DIPs. Outbound traffic is randomly load balanced across IPs in the backend IPs.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="etag_csharp">
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
</span>
...
<a href="#frontendipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Frontend<wbr>IPConfigurations</a>
    ...
    <dd>{{% md %}}The Frontend IP addresses of the load balancer.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="protocol_csharp">
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
</span>
    ...
    <dd>{{% md %}}The protocol for the outbound rule in load balancer.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="provisioningstate_csharp">
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
</span>
    ...
    <dd>{{% md %}}The provisioning state of the outbound rule resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#allocatedoutboundports_csharp" style="color: inherit; text-decoration: inherit;">Allocated<wbr>Outbound<wbr>Ports</a>
    ...
    <dd>{{% md %}}The number of outbound ports to be used for NAT.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="enabletcpreset_csharp">
<a href="#enabletcpreset_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Tcp<wbr>Reset</a>
</span>
...
<a href="#idletimeoutinminutes_csharp" style="color: inherit; text-decoration: inherit;">Idle<wbr>Timeout<wbr>In<wbr>Minutes</a>
    ...
    <dd>{{% md %}}The timeout for the TCP idle connection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}The name of the resource that is unique within the set of outbound rules used by the load balancer. This name can be used to access the resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#loadbalancingrules_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancing<wbr>Rules</a>
    ...
    <dd>{{% md %}}The load balancer rules that use this probe.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="port_csharp">
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The port for communicating the probe. Possible values range from 1 to 65535, inclusive.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="protocol_csharp">
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
</span>
    ...
    <dd>{{% md %}}The protocol of the end point. If 'Tcp' is specified, a received ACK is required for the probe to be successful. If 'Http' or 'Https' is specified, a 200 OK response from the specifies URI is required for the probe to be successful.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="provisioningstate_csharp">
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
</span>
    ...
    <dd>{{% md %}}The provisioning state of the probe resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#intervalinseconds_csharp" style="color: inherit; text-decoration: inherit;">Interval<wbr>In<wbr>Seconds</a>
    ...
    <dd>{{% md %}}The interval, in seconds, for how frequently to probe the endpoint for health status. Typically, the interval is slightly less than half the allocated timeout period (in seconds) which allows two full probes before taking the instance out of rotation. The default value is 15, the minimum value is 5.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}The name of the resource that is unique within the set of probes used by the load balancer. This name can be used to access the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#numberofprobes_csharp" style="color: inherit; text-decoration: inherit;">Number<wbr>Of<wbr>Probes</a>
    ...
    <dd>{{% md %}}The number of probes where if no response, will result in stopping further traffic from being delivered to the endpoint. This values allows endpoints to be taken out of rotation faster or slower than the typical times used in Azure.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requestpath_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Path</a>
    ...
    <dd>{{% md %}}The URI used for requesting health status from the VM. Path is required if a protocol is set to http. Otherwise, it is not allowed. There is no default value.{{% /md %}}</dd></dl>
{{% /choosable %}}
