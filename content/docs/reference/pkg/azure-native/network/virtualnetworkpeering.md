...
<span class="k">def </span><span class="nx">VirtualNetworkPeering</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">peering_state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, VirtualNetworkPeeringState]]]</span> = None<span class="p">,</span>
                          ...
                          <span class="nx">remote_bgp_communities</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[VirtualNetworkBgpCommunitiesArgs]]</span> = None<span class="p">,</span>
                          <span class="nx">remote_virtual_network</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SubResourceArgs]]</span> = None<span class="p">,</span>
...
<a href="#peeringstate_nodejs" style="color: inherit; text-decoration: inherit;">peering<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#virtualnetworkpeeringstate">pulumi.<wbr>Input<Virtual<wbr>Network<wbr>Peering<wbr>State></a></span>
    </dt>
    <dd>{{% md %}}The status of the virtual network peering.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#remotebgpcommunities_nodejs" style="color: inherit; text-decoration: inherit;">remote<wbr>Bgp<wbr>Communities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkbgpcommunities">pulumi.<wbr>Input<Virtual<wbr>Network<wbr>Bgp<wbr>Communities<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The reference to the remote virtual network's Bgp Communities.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#peering_state_python" style="color: inherit; text-decoration: inherit;">peering_<wbr>state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#virtualnetworkpeeringstate">Input[Virtual<wbr>Network<wbr>Peering<wbr>State]</a></span>
    </dt>
    <dd>{{% md %}}The status of the virtual network peering.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#remote_bgp_communities_python" style="color: inherit; text-decoration: inherit;">remote_<wbr>bgp_<wbr>communities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkbgpcommunities">Input[Virtual<wbr>Network<wbr>Bgp<wbr>Communities<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The reference to the remote virtual network's Bgp Communities.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the virtual network peering resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
