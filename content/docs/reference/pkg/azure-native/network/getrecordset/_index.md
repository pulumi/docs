...
---
title: "getRecordSet"
title_tag: "azure-native.network.getRecordSet"
meta_desc: "Documentation for the azure-native.network.getRecordSet function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_record_set(</span><span class="nx">record_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                   ...
                   <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRecordSetResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRecordSet<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupRecordSetArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupRecordSetResult</a></span>, error)</span></code></pre></div>
...
<a href="#zonename_csharp" style="color: inherit; text-decoration: inherit;">Zone<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the DNS zone (without a terminating dot).{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The ID of the record set.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the record set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#caarecords_csharp" style="color: inherit; text-decoration: inherit;">Caa<wbr>Records</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#caarecordresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Caa<wbr>Record<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of CAA records in the record set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nsrecords_csharp" style="color: inherit; text-decoration: inherit;">Ns<wbr>Records</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nsrecordresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Ns<wbr>Record<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of NS records in the record set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetresource_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Resource</a>
    ...
    <dd>{{% md %}}A reference to an azure resource from where the dns resource value is taken.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="ttl_csharp">
