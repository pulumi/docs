...
<a href="#access_csharp" style="color: inherit; text-decoration: inherit;">Access</a>
    ...
    <dd>{{% md %}}Indicates the access allowed for this particular rule{{% /md %}}</dd>
    <dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}A description for this rule.{{% /md %}}</dd>
    <dt class="property-"
            title="">
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}The priority of the rule. The value can be between 1 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.{{% /md %}}</dd>
    <dt class="property-"
            title="">
