...
<a href="#virtualnetworkgatewayconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the virtual network gateway connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#connectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd>{{% md %}}Virtual Network Gateway connection status.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connectiontype_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Type</a>
    ...
    <dd>{{% md %}}Gateway connection type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#egressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>Bytes<wbr>Transferred</a>
    ...
    <dd>{{% md %}}The egress bytes transferred in this connection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#ingressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Bytes<wbr>Transferred</a>
    ...
    <dd>{{% md %}}The ingress bytes transferred in this connection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the virtual network gateway connection resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
    ...
    <dd>{{% md %}}The resource GUID property of the virtual network gateway connection resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tunnelconnectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Tunnel<wbr>Connection<wbr>Status</a>
    ...
    <dd>{{% md %}}Collection of all tunnels' connection health status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#virtualnetworkgateway1_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway1</a>
    ...
    <dd>{{% md %}}The reference to virtual network gateway resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#authorizationkey_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Key</a>
    ...
    <dd>{{% md %}}The authorizationKey.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connectionmode_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Mode</a>
    ...
    <dd>{{% md %}}The connection mode for this connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connectionprotocol_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Protocol</a>
    ...
    <dd>{{% md %}}Connection protocol used for this connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dpdtimeoutseconds_csharp" style="color: inherit; text-decoration: inherit;">Dpd<wbr>Timeout<wbr>Seconds</a>
    ...
    <dd>{{% md %}}The dead peer detection timeout of this connection in seconds.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enablebgp_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Bgp</a>
    ...
    <dd>{{% md %}}EnableBgp flag.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#expressroutegatewaybypass_csharp" style="color: inherit; text-decoration: inherit;">Express<wbr>Route<wbr>Gateway<wbr>Bypass</a>
    ...
    <dd>{{% md %}}Bypass ExpressRoute Gateway for data forwarding.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipsecpolicies_csharp" style="color: inherit; text-decoration: inherit;">Ipsec<wbr>Policies</a>
    ...
    <dd>{{% md %}}The IPSec Policies to be considered by this connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#localnetworkgateway2_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Network<wbr>Gateway2</a>
    ...
    <dd>{{% md %}}The reference to local network gateway resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#peer_csharp" style="color: inherit; text-decoration: inherit;">Peer</a>
    ...
    <dd>{{% md %}}The reference to peerings resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#routingweight_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Weight</a>
    ...
    <dd>{{% md %}}The routing weight.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sharedkey_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Key</a>
    ...
    <dd>{{% md %}}The IPSec shared key.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#trafficselectorpolicies_csharp" style="color: inherit; text-decoration: inherit;">Traffic<wbr>Selector<wbr>Policies</a>
    ...
    <dd>{{% md %}}The Traffic Selector Policies to be considered by this connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#uselocalazureipaddress_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Local<wbr>Azure<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}Use private local Azure IP for the connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#usepolicybasedtrafficselectors_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Policy<wbr>Based<wbr>Traffic<wbr>Selectors</a>
    ...
    <dd>{{% md %}}Enable policy-based traffic selectors.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#virtualnetworkgateway2_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway2</a>
    ...
    <dd>{{% md %}}The reference to virtual network gateway resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the local network gateway resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resourceguid_csharp">
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
</span>
    ...
    <dd>{{% md %}}The resource GUID property of the local network gateway resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#connectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd>{{% md %}}Virtual Network Gateway connection status.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="egressbytestransferred_csharp">
<a href="#egressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>Bytes<wbr>Transferred</a>
</span>
    ...
    <dd>{{% md %}}The Egress Bytes Transferred in this connection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ingressbytestransferred_csharp">
<a href="#ingressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Bytes<wbr>Transferred</a>
</span>
    ...
    <dd>{{% md %}}The Ingress Bytes Transferred in this connection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#lastconnectionestablishedutctime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Connection<wbr>Established<wbr>Utc<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which connection was established in Utc format.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#inbounddnsforwardingendpoint_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Dns<wbr>Forwarding<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}The IP address allocated by the gateway to which dns requests can be sent.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the virtual network gateway resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resourceguid_csharp">
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
</span>
    ...
    <dd>{{% md %}}The resource GUID property of the virtual network gateway resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
