...
---
title: "getProfile"
title_tag: "azure-native.network.getProfile"
meta_desc: "Documentation for the azure-native.network.getProfile function with examples, input properties, output properties, and supporting types."
---
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group containing the Traffic Manager profile.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dnsconfig_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dnsconfigresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Dns<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The DNS settings of the Traffic Manager profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="endpoints_csharp">
<a href="#endpoints_csharp" style="color: inherit; text-decoration: inherit;">Endpoints</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Endpoint<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The list of endpoints in the Traffic Manager profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#maxreturn_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Return</a>
    ...
    <dd>{{% md %}}Maximum number of endpoints to be returned for MultiValue routing type.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="monitorconfig_csharp">
<a href="#monitorconfig_csharp" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#monitorconfigresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Monitor<wbr>Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The endpoint monitoring settings of the Traffic Manager profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#profilestatus_csharp" style="color: inherit; text-decoration: inherit;">Profile<wbr>Status</a>
    ...
    <dd>{{% md %}}The status of the Traffic Manager profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#trafficroutingmethod_csharp" style="color: inherit; text-decoration: inherit;">Traffic<wbr>Routing<wbr>Method</a>
    ...
    <dd>{{% md %}}The traffic routing method of the Traffic Manager profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trafficviewenrollmentstatus_csharp" style="color: inherit; text-decoration: inherit;">Traffic<wbr>View<wbr>Enrollment<wbr>Status</a>
    ...
    <dd>{{% md %}}Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
