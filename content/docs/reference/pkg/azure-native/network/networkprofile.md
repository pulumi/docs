...
<a href="#ipconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipconfigurationprofile">IPConfiguration<wbr>Profile<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}A list of ip configurations of the container network interface configuration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_nodejs">
...
<a href="#ipconfigurations_nodejs" style="color: inherit; text-decoration: inherit;">ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containernetworkinterfaceipconfigurationresponse">Container<wbr>Network<wbr>Interface<wbr>Ip<wbr>Configuration<wbr>Response<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}Reference to the ip configuration on this container nic.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="provisioningstate_nodejs">
