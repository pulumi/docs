...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_virtual_network_gateway(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#activeactive_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Active</a>
    ...
    <dd>{{% md %}}ActiveActive flag.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bgpsettings_csharp" style="color: inherit; text-decoration: inherit;">Bgp<wbr>Settings</a>
    ...
    <dd>{{% md %}}Virtual network gateway's BGP speaker settings.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customroutes_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Routes</a>
    ...
    <dd>{{% md %}}The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enablebgp_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Bgp</a>
    ...
    <dd>{{% md %}}Whether BGP is enabled for this virtual network gateway or not.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enablednsforwarding_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Dns<wbr>Forwarding</a>
    ...
    <dd>{{% md %}}Whether dns forwarding is enabled or not.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enableprivateipaddress_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Private<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}Whether private IP needs to be enabled on this gateway for connections or not.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gatewaydefaultsite_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Default<wbr>Site</a>
    ...
    <dd>{{% md %}}The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gatewaytype_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of this virtual network gateway.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
    ...
    <dd>{{% md %}}IP configurations for virtual network gateway.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#vnetextendedlocationresourceid_csharp" style="color: inherit; text-decoration: inherit;">VNet<wbr>Extended<wbr>Location<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}MAS FIJI customer vnet resource id. VirtualNetworkGateway of type local gateway is associated with the customer vnet.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#virtualnetworkextendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Extended<wbr>Location</a>
    ...
    <dd>{{% md %}}The extended location of type local virtual network gateway.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpnclientconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Client<wbr>Configuration</a>
    ...
    <dd>{{% md %}}The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpngatewaygeneration_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Gateway<wbr>Generation</a>
    ...
    <dd>{{% md %}}The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.{{% /md %}}</dd><dt class="property-"
            title="">
