...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Expands referenced express route bgp peering resources.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rules_csharp" style="color: inherit; text-decoration: inherit;">Rules</a>
    ...
    <dd>{{% md %}}Collection of RouteFilterRules contained within a route filter.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
