...
<a href="#alias_csharp" style="color: inherit; text-decoration: inherit;">Alias</a>
    ...
    <dd>{{% md %}}The alias of the private link service.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
    ...
    <dd>{{% md %}}An array of references to the network interfaces created for this private link service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privateendpointconnections_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connections</a>
    ...
    <dd>{{% md %}}An array of list about connections to the private endpoint.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the private link service resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#autoapproval_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Approval</a>
    ...
    <dd>{{% md %}}The auto-approval list of the private link service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enableproxyprotocol_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Proxy<wbr>Protocol</a>
    ...
    <dd>{{% md %}}Whether the private link service is enabled for proxy protocol or not.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#fqdns_csharp" style="color: inherit; text-decoration: inherit;">Fqdns</a>
    ...
    <dd>{{% md %}}The list of Fqdn.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
    ...
    <dd>{{% md %}}An array of private link service IP configurations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loadbalancerfrontendipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancer<wbr>Frontend<wbr>Ip<wbr>Configurations</a>
    ...
    <dd>{{% md %}}An array of references to the load balancer IP configurations.{{% /md %}}</dd><dt class="property-"
            title="">
