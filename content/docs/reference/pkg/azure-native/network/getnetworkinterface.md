...
title_tag: "azure-native.network.getNetworkInterface"
meta_desc: "Documentation for the azure-native.network.getNetworkInterface function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getNetworkInterface<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetNetworkInterfaceArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetNetworkInterfaceResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_network_interface(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                          ...
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetNetworkInterfaceResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupNetworkInterface<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupNetworkInterfaceArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupNetworkInterfaceResult</a></span>, error)</span></code></pre></div>
...
<a href="#networkinterfacename_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the network interface.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dscpconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Dscp<wbr>Configuration</a>
    ...
    <dd>{{% md %}}A reference to the dscp configuration to which the network interface is linked.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#hostedworkloads_csharp" style="color: inherit; text-decoration: inherit;">Hosted<wbr>Workloads</a>
    ...
    <dd>{{% md %}}A list of references to linked BareMetal resources.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#macaddress_csharp" style="color: inherit; text-decoration: inherit;">Mac<wbr>Address</a>
    ...
    <dd>{{% md %}}The MAC address of the network interface.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#primary_csharp" style="color: inherit; text-decoration: inherit;">Primary</a>
    ...
    <dd>{{% md %}}Whether this is a primary network interface on a virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}A reference to the private endpoint to which the network interface is linked.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the network interface resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceguid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Guid</a>
    ...
    <dd>{{% md %}}The resource GUID property of the network interface resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tapconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Tap<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacetapconfigurationresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Network<wbr>Interface<wbr>Tap<wbr>Configuration<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of TapConfigurations of the network interface.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#virtualmachine_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine</a>
    ...
    <dd>{{% md %}}The reference to a virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="dnssettings_csharp">
<a href="#dnssettings_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Settings</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacednssettingsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Network<wbr>Interface<wbr>Dns<wbr>Settings<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The DNS settings in network interface.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enableacceleratednetworking_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Accelerated<wbr>Networking</a>
    ...
    <dd>{{% md %}}If the network interface is accelerated networking enabled.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enableipforwarding_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>IPForwarding</a>
    ...
    <dd>{{% md %}}Indicates whether IP forwarding is enabled on this network interface.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
    ...
    <dd>{{% md %}}The extended location of the network interface.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
    ...
    <dd>{{% md %}}A list of IPConfigurations of the network interface.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networksecuritygroup_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Security<wbr>Group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networksecuritygroupresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Network<wbr>Security<wbr>Group<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The reference to the NetworkSecurityGroup resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
