...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupNetworkInterface<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupNetworkInterfaceArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupNetworkInterfaceResult</a></span>, error)</span></code></pre></div>
...
<a href="#migrationphase_csharp" style="color: inherit; text-decoration: inherit;">Migration<wbr>Phase</a>
    ...
    <dd>{{% md %}}Migration phase of Network Interface resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nictype_csharp" style="color: inherit; text-decoration: inherit;">Nic<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of Network Interface resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privatelinkservice_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Privatelinkservice of the network interface resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
