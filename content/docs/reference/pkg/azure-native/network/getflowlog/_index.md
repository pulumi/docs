...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getFlowLog<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetFlowLogArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetFlowLogResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_flow_log(</span><span class="nx">flow_log_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetFlowLogResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupFlowLog<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupFlowLogArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupFlowLogResult</a></span>, error)</span></code></pre></div>
...
<a href="#flowlogname_csharp" style="color: inherit; text-decoration: inherit;">Flow<wbr>Log<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the flow log resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the flow log.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of the storage account which is used to store the flow log.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetresourceguid_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Resource<wbr>Guid</a>
    ...
    <dd>{{% md %}}Guid of network security group to which flow log will be applied.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetresourceid_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of network security group to which flow log will be applied.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}Flag to enable/disable flow logging.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#flowanalyticsconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Flow<wbr>Analytics<wbr>Configuration</a>
    ...
    <dd>{{% md %}}Parameters that define the configuration of traffic analytics.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#format_csharp" style="color: inherit; text-decoration: inherit;">Format</a>
    ...
    <dd>{{% md %}}Parameters that define the flow log format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#retentionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Policy</a>
    ...
    <dd>{{% md %}}Parameters that define the retention policy for flow log.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
