...
title_tag: "azure-native.network.VirtualNetwork"
meta_desc: "Documentation for the azure-native.network.VirtualNetwork resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">VirtualNetwork</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">bgp_communities</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[VirtualNetworkBgpCommunitiesArgs]]</span> = None<span class="p">,</span>
                   <span class="nx">ddos_protection_plan</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SubResourceArgs]]</span> = None<span class="p">,</span>
                   <span class="nx">dhcp_options</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[DhcpOptionsArgs]]</span> = None<span class="p">,</span>
                   <span class="nx">enable_ddos_protection</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                   <span class="nx">enable_vm_protection</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
                   ...
                   <span class="nx">subnets</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[SubnetArgs]]]]</span> = None<span class="p">,</span>
                   ...
                   <span class="nx">virtual_network_peerings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[VirtualNetworkPeeringArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#addressspace_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Space</a>
    ...
    <dd>{{% md %}}The AddressSpace that contains an array of IP address ranges that can be used by subnets.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#bgpcommunities_csharp" style="color: inherit; text-decoration: inherit;">Bgp<wbr>Communities</a>
    ...
    <dd>{{% md %}}Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ddosprotectionplan_csharp" style="color: inherit; text-decoration: inherit;">Ddos<wbr>Protection<wbr>Plan</a>
    ...
    <dd>{{% md %}}The DDoS protection plan associated with the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="dhcpoptions_csharp">
<a href="#dhcpoptions_csharp" style="color: inherit; text-decoration: inherit;">Dhcp<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dhcpoptions">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Dhcp<wbr>Options<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enableddosprotection_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Ddos<wbr>Protection</a>
    ...
    <dd>{{% md %}}Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enablevmprotection_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Vm<wbr>Protection</a>
    ...
    <dd>{{% md %}}Indicates if VM protection is enabled for all the subnets in the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
    ...
    <dd>{{% md %}}The extended location of the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
...
<a href="#ipallocations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Allocations</a>
    ...
    <dd>{{% md %}}Array of IpAllocation which reference this VNET.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subnets_csharp" style="color: inherit; text-decoration: inherit;">Subnets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subnet">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Subnet<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of subnets in a Virtual Network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#virtualnetworkpeerings_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Peerings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkpeering">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Virtual<wbr>Network<wbr>Peering<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#dhcpoptions_nodejs" style="color: inherit; text-decoration: inherit;">dhcp<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dhcpoptions">pulumi.<wbr>Input<Dhcp<wbr>Options<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#virtualnetworkpeerings_nodejs" style="color: inherit; text-decoration: inherit;">virtual<wbr>Network<wbr>Peerings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkpeering">pulumi.<wbr>Input<pulumi.<wbr>Input<Virtual<wbr>Network<wbr>Peering<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A list of peerings in a Virtual Network.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dhcp_options_python" style="color: inherit; text-decoration: inherit;">dhcp_<wbr>options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dhcpoptions">Input[Dhcp<wbr>Options<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#virtual_network_peerings_python" style="color: inherit; text-decoration: inherit;">virtual_<wbr>network_<wbr>peerings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkpeering">Input[Virtual<wbr>Network<wbr>Peering<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A list of peerings in a Virtual Network.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#remotebgpcommunities_nodejs" style="color: inherit; text-decoration: inherit;">remote<wbr>Bgp<wbr>Communities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkbgpcommunitiesresponse">pulumi.<wbr>Input<Virtual<wbr>Network<wbr>Bgp<wbr>Communities<wbr>Response<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The reference to the remote virtual network's Bgp Communities.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="remotevirtualnetwork_nodejs">
...
<a href="#remote_bgp_communities_python" style="color: inherit; text-decoration: inherit;">remote_<wbr>bgp_<wbr>communities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkbgpcommunitiesresponse">Input[Virtual<wbr>Network<wbr>Bgp<wbr>Communities<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The reference to the remote virtual network's Bgp Communities.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="remote_virtual_network_python">
