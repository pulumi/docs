...
<a href="#interfaceendpointname_csharp" style="color: inherit; text-decoration: inherit;">Interface<wbr>Endpoint<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the interface endpoint.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#endpointservice_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Service</a>
    ...
    <dd>{{% md %}}A reference to the service being brought into the virtual network.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd>{{% md %}}A first-party service's FQDN that is mapped to the private IP allocated via this interface endpoint.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
