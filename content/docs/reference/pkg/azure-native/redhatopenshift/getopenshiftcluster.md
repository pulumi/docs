...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_open_shift_cluster(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetOpenShiftClusterResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupOpenShiftCluster<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupOpenShiftClusterArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupOpenShiftClusterResult</a></span>, error)</span></code></pre></div>
...
<a href="#apiserverprofile_csharp" style="color: inherit; text-decoration: inherit;">Apiserver<wbr>Profile</a>
    ...
    <dd>{{% md %}}The cluster API server profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clusterprofile_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Profile</a>
    ...
    <dd>{{% md %}}The cluster profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#consoleprofile_csharp" style="color: inherit; text-decoration: inherit;">Console<wbr>Profile</a>
    ...
    <dd>{{% md %}}The console profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ingressprofiles_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Profiles</a>
    ...
    <dd>{{% md %}}The cluster ingress profiles.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#masterprofile_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Profile</a>
    ...
    <dd>{{% md %}}The cluster master profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networkprofile_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Profile</a>
    ...
    <dd>{{% md %}}The cluster network profile.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The cluster provisioning state (immutable).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceprincipalprofile_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Principal<wbr>Profile</a>
    ...
    <dd>{{% md %}}The cluster service principal profile.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
