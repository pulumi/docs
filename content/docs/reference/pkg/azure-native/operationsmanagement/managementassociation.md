...
<span class="k">def </span><span class="nx">ManagementAssociation</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">management_association_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ManagementAssociationPropertiesArgs]]</span> = None<span class="p">,</span>
...
<a href="#resourcetype_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Type</a>
    ...
    <dd>{{% md %}}Resource type for the parent resource{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#managementassociationname_csharp" style="color: inherit; text-decoration: inherit;">Management<wbr>Association<wbr>Name</a>
    ...
    <dd>{{% md %}}User ManagementAssociation Name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#properties_nodejs" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managementassociationproperties">pulumi.<wbr>Input<Management<wbr>Association<wbr>Properties<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Properties for ManagementAssociation object supported by the OperationsManagement resource provider.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managementassociationproperties">Input[Management<wbr>Association<wbr>Properties<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Properties for ManagementAssociation object supported by the OperationsManagement resource provider.{{% /md %}}</dd></dl>
{{% /choosable %}}
