...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Connection<wbr>Status<wbr>Pending</dt>
    <dd>Pending</dd>
    <dt>Connection<wbr>Status<wbr>Approved</dt>
    <dd>Approved</dd>
    <dt>Connection<wbr>Status<wbr>Rejected</dt>
    <dd>Rejected</dd>
    <dt>Connection<wbr>Status<wbr>Disconnected</dt>
    <dd>Disconnected</dd>
</dl>
{{% /choosable %}}
