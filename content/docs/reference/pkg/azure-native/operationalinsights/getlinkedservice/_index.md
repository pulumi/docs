...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_linked_service(</span><span class="nx">linked_service_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#linkedservicename_csharp" style="color: inherit; text-decoration: inherit;">Linked<wbr>Service<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the linked service.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the linked service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourceid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource id of the resource that will be linked to the workspace. This should be used for linking resources which require read access{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
