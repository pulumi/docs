...
<span class="k">def </span><span class="nx">MachineGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">group_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, MachineGroupType]]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">machines</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[MachineReferenceWithHintsArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#grouptype_nodejs" style="color: inherit; text-decoration: inherit;">group<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#machinegrouptype">pulumi.<wbr>Input<Machine<wbr>Group<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Type of the machine group{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#machines_nodejs" style="color: inherit; text-decoration: inherit;">machines</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#machinereferencewithhints">pulumi.<wbr>Input<pulumi.<wbr>Input<Machine<wbr>Reference<wbr>With<wbr>Hints<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}References of the machines in this group. The hints within each reference do not represent the current value of the corresponding fields. They are a snapshot created during the last time the machine group was updated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#group_type_python" style="color: inherit; text-decoration: inherit;">group_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#machinegrouptype">Input[Machine<wbr>Group<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Type of the machine group{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#machines_python" style="color: inherit; text-decoration: inherit;">machines</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#machinereferencewithhints">Input[Machine<wbr>Reference<wbr>With<wbr>Hints<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}References of the machines in this group. The hints within each reference do not represent the current value of the corresponding fields. They are a snapshot created during the last time the machine group was updated.{{% /md %}}</dd></dl>
{{% /choosable %}}
