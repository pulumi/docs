...
<span class="k">def </span><span class="nx">ADCCatalog</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">users</span><span class="p">:</span> <span class="nx">Optional[Sequence[PrincipalsArgs]]</span> = None<span class="p">)</span>
...
The ADCCatalog resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#admins_csharp" style="color: inherit; text-decoration: inherit;">Admins</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#principals">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>Inputs.<wbr>Principals<wbr>Args&gt;</a></span>
    </dt>
