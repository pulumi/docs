...
<a href="#accesspolicyname_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Time Series Insights access policy associated with the specified environment.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}An description of the access policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#principalobjectid_csharp" style="color: inherit; text-decoration: inherit;">Principal<wbr>Object<wbr>Id</a>
    ...
    <dd>{{% md %}}The objectId of the principal in Azure Active Directory.{{% /md %}}</dd><dt class="property-"
            title="">
