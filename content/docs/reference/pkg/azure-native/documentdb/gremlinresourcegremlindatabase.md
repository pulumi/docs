...
class MyStack : Stack
{
    public MyStack()
    {
        var gremlinResourceGremlinDatabase = new AzureNative.DocumentDB.GremlinResourceGremlinDatabase("gremlinResourceGremlinDatabase", new AzureNative.DocumentDB.GremlinResourceGremlinDatabaseArgs
        {
            AccountName = "ddb1",
...
<span class="k">def </span><span class="nx">GremlinResourceGremlinDatabase</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   ...
                                   <span class="nx">resource</span><span class="p">:</span> <span class="nx">Optional[GremlinDatabaseResourceArgs]</span> = None<span class="p">,</span>
...
The GremlinResourceGremlinDatabase resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gremlindatabaseresource">Pulumi.<wbr>Azure<wbr>Native.<wbr>Document<wbr>DB.<wbr>Inputs.<wbr>Gremlin<wbr>Database<wbr>Resource<wbr>Args</a></span>
    </dt>
