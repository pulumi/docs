...
<span class="k">def </span><span class="nx">MongoDBResourceMongoDBDatabase</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   ...
                                   <span class="nx">resource</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[MongoDBDatabaseResourceArgs]]</span> = None<span class="p">,</span>
...
<a href="#resource_nodejs" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mongodbdatabaseresource">pulumi.<wbr>Input<Mongo<wbr>DBDatabase<wbr>Resource<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The standard JSON format of a MongoDB database{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resource_python" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mongodbdatabaseresource">Input[Mongo<wbr>DBDatabase<wbr>Resource<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The standard JSON format of a MongoDB database{{% /md %}}</dd><dt class="property-required"
            title="Required">
