...
<span class="k">def </span><span class="nx">SqlResourceSqlDatabase</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">resource</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SqlDatabaseResourceArgs]]</span> = None<span class="p">,</span>
...
<a href="#resource_nodejs" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqldatabaseresource">pulumi.<wbr>Input<Sql<wbr>Database<wbr>Resource<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The standard JSON format of a SQL database{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resource_python" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqldatabaseresource">Input[Sql<wbr>Database<wbr>Resource<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The standard JSON format of a SQL database{{% /md %}}</dd><dt class="property-required"
            title="Required">
