...
title_tag: "azure-native.documentdb.DatabaseAccountSqlContainer"
meta_desc: "Documentation for the azure-native.documentdb.DatabaseAccountSqlContainer resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var databaseAccountSqlContainer = new AzureNative.DocumentDB.DatabaseAccountSqlContainer("databaseAccountSqlContainer", new AzureNative.DocumentDB.DatabaseAccountSqlContainerArgs
        {
            AccountName = "ddb1",
...
database_account_sql_container = azure_native.documentdb.DatabaseAccountSqlContainer("databaseAccountSqlContainer",
    account_name="ddb1",
...
const databaseAccountSqlContainer = new azure_native.documentdb.DatabaseAccountSqlContainer("databaseAccountSqlContainer", {
    accountName: "ddb1",
    containerName: "containerName",
    databaseName: "databaseName",
    options: {},
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqlcontainerresource">Pulumi.<wbr>Azure<wbr>Native.<wbr>Document<wbr>DB.<wbr>Inputs.<wbr>Sql<wbr>Container<wbr>Resource<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The standard JSON format of a container{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#containername_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Name</a>
    ...
    <dd>{{% md %}}Cosmos DB container name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#conflictresolutionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Conflict<wbr>Resolution<wbr>Policy</a>
    ...
    <dd>{{% md %}}The conflict resolution policy for the container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#indexingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Indexing<wbr>Policy</a>
    ...
    <dd>{{% md %}}The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the container{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Name of the Cosmos DB SQL container{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
```sh
$ pulumi import azure-native:documentdb:DatabaseAccountSqlContainer containerName containerName 
```
