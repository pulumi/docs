...
title_tag: "azure-native.documentdb.DatabaseAccountCassandraTable"
meta_desc: "Documentation for the azure-native.documentdb.DatabaseAccountCassandraTable resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var databaseAccountCassandraTable = new AzureNative.DocumentDB.DatabaseAccountCassandraTable("databaseAccountCassandraTable", new AzureNative.DocumentDB.DatabaseAccountCassandraTableArgs
        {
            AccountName = "ddb1",
...
database_account_cassandra_table = azure_native.documentdb.DatabaseAccountCassandraTable("databaseAccountCassandraTable",
    account_name="ddb1",
...
const databaseAccountCassandraTable = new azure_native.documentdb.DatabaseAccountCassandraTable("databaseAccountCassandraTable", {
    accountName: "ddb1",
    keyspaceName: "tableName",
    options: {},
    resource: {
...
<a href="#defaultttl_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Ttl</a>
    ...
    <dd>{{% md %}}Time to live of the Cosmos DB Cassandra table{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandraschemaresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Document<wbr>DB.<wbr>Outputs.<wbr>Cassandra<wbr>Schema<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Schema of the Cosmos DB Cassandra table{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
```sh
$ pulumi import azure-native:documentdb:DatabaseAccountCassandraTable tableName tableName 
```
