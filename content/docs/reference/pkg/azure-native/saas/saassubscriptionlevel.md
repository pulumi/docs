...
<span class="k">def </span><span class="nx">SaasSubscriptionLevel</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SaasCreationPropertiesArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSaasSubscriptionLevel</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SaasSubscriptionLevelArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SaasSubscriptionLevel</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The SaasSubscriptionLevel resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}Resource location. Only value allowed for SaaS is 'global'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a href="#properties_nodejs" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#saascreationproperties">pulumi.<wbr>Input<Saas<wbr>Creation<wbr>Properties<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Properties of the SaaS resource that are relevant for creation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#saascreationproperties">Input[Saas<wbr>Creation<wbr>Properties<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Properties of the SaaS resource that are relevant for creation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#paymentchanneltype_nodejs" style="color: inherit; text-decoration: inherit;">payment<wbr>Channel<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#paymentchanneltype">pulumi.<wbr>Input<Payment<wbr>Channel<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}The Payment channel for the SaasSubscription.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#payment_channel_type_python" style="color: inherit; text-decoration: inherit;">payment_<wbr>channel_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#paymentchanneltype">Input[Payment<wbr>Channel<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}The Payment channel for the SaasSubscription.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#term_nodejs" style="color: inherit; text-decoration: inherit;">term</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#saaspropertiesresponseterm">pulumi.<wbr>Input<Saas<wbr>Properties<wbr>Response<wbr>Term<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The current Term object.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="termid_nodejs">
...
<a href="#term_python" style="color: inherit; text-decoration: inherit;">term</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#saaspropertiesresponseterm">Input[Saas<wbr>Properties<wbr>Response<wbr>Term<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The current Term object.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="term_id_python">
