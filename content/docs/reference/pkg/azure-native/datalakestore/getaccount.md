...
<a href="#defaultgroup_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Group</a>
    ...
    <dd>{{% md %}}The default owner group for all new folders and files created in the Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionconfig_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Config</a>
    ...
    <dd>{{% md %}}The Key Vault encryption configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionstate_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>State</a>
    ...
    <dd>{{% md %}}The current state of encryption for this Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#firewallrules_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>Rules</a>
    ...
    <dd>{{% md %}}The list of firewall rules associated with this Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#firewallstate_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>State</a>
    ...
    <dd>{{% md %}}The current state of the IP address firewall for this Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}The Key Vault encryption identity, if any.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#newtier_csharp" style="color: inherit; text-decoration: inherit;">New<wbr>Tier</a>
    ...
    <dd>{{% md %}}The commitment tier to use for next month.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trustedidproviderstate_csharp" style="color: inherit; text-decoration: inherit;">Trusted<wbr>Id<wbr>Provider<wbr>State</a>
    ...
    <dd>{{% md %}}The current state of the trusted identity provider feature for this Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#trustedidproviders_csharp" style="color: inherit; text-decoration: inherit;">Trusted<wbr>Id<wbr>Providers</a>
    ...
    <dd>{{% md %}}The list of trusted identity providers associated with this Data Lake Store account.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
