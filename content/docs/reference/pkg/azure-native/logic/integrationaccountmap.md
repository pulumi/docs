...
<span class="k">def </span><span class="nx">IntegrationAccountMap</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">map_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, MapType]]]</span> = None<span class="p">,</span>
                          <span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[Any]</span> = None<span class="p">,</span>
                          <span class="nx">parameters_schema</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[IntegrationAccountMapPropertiesParametersSchemaArgs]]</span> = None<span class="p">,</span>
...
<a href="#maptype_nodejs" style="color: inherit; text-decoration: inherit;">map<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#maptype">pulumi.<wbr>Input<Map<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}The map type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#parametersschema_nodejs" style="color: inherit; text-decoration: inherit;">parameters<wbr>Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationaccountmappropertiesparametersschema">pulumi.<wbr>Input<Integration<wbr>Account<wbr>Map<wbr>Properties<wbr>Parameters<wbr>Schema<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The parameters schema of integration account map.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_nodejs">
...
<a href="#map_type_python" style="color: inherit; text-decoration: inherit;">map_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#maptype">Input[Map<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}The map type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#parameters_schema_python" style="color: inherit; text-decoration: inherit;">parameters_<wbr>schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationaccountmappropertiesparametersschema">Input[Integration<wbr>Account<wbr>Map<wbr>Properties<wbr>Parameters<wbr>Schema<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The parameters schema of integration account map.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_python">
