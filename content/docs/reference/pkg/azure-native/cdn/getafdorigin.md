...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getAFDOrigin<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetAFDOriginArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetAFDOriginResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupAFDOrigin<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAFDOriginArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupAFDOriginResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAFDOrigin </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetAFDOriginResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetAFDOriginArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#originname_csharp" style="color: inherit; text-decoration: inherit;">Origin<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the origin which is unique within the profile.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>{{% md %}}The address of the origin. Domain names, IPv4 addresses, and IPv6 addresses are supported.This should be unique across all origins in an endpoint.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#azureorigin_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Origin</a>
    ...
    <dd>{{% md %}}Resource reference to the Azure origin resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enabledstate_csharp" style="color: inherit; text-decoration: inherit;">Enabled<wbr>State</a>
    ...
    <dd>{{% md %}}Whether to enable health probes to be made against backends defined under backendPools. Health probes can only be disabled if there is a single enabled backend in single enabled backend pool.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpport_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Port</a>
    ...
    <dd>{{% md %}}The value of the HTTP port. Must be between 1 and 65535.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpsport_csharp" style="color: inherit; text-decoration: inherit;">Https<wbr>Port</a>
    ...
    <dd>{{% md %}}The value of the HTTPS port. Must be between 1 and 65535.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#originhostheader_csharp" style="color: inherit; text-decoration: inherit;">Origin<wbr>Host<wbr>Header</a>
    ...
    <dd>{{% md %}}The host header value sent to the origin with each request. If you leave this blank, the request hostname determines this value. Azure CDN origins, such as Web Apps, Blob Storage, and Cloud Services require this host header value to match the origin hostname by default. This overrides the host header defined at Endpoint{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}Priority of origin in given origin group for load balancing. Higher priorities will not be used for load balancing if any lower priority origin is healthy.Must be between 1 and 5{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sharedprivatelinkresource_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Private<wbr>Link<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sharedprivatelinkresourcepropertiesresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Cdn.<wbr>Outputs.<wbr>Shared<wbr>Private<wbr>Link<wbr>Resource<wbr>Properties<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The properties of the private link resource for private origin.{{% /md %}}</dd><dt class="property-"
            title="">
