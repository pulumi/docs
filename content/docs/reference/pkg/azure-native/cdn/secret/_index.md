...
<span class="k">def </span><span class="nx">Secret</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">parameters</span><span class="p">:</span> <span class="nx">Optional[Union[CustomerCertificateParametersArgs, ManagedCertificateParametersArgs, UrlSigningKeyParametersArgs]]</span> = None<span class="p">,</span>
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customercertificateparameters">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cdn.<wbr>Inputs.<wbr>Customer<wbr>Certificate<wbr>Parameters<wbr>Args</a> | <a href="#managedcertificateparameters">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cdn.<wbr>Inputs.<wbr>Managed<wbr>Certificate<wbr>Parameters<wbr>Args</a> | <a href="#urlsigningkeyparameters">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cdn.<wbr>Inputs.<wbr>Url<wbr>Signing<wbr>Key<wbr>Parameters<wbr>Args</a></span>
    </dt>
...
<a href="#secretname_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the Secret under the profile.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="customercertificateparameters">Customer<wbr>Certificate<wbr>Parameters</h4>
...
<a href="#certificateauthority_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authority</a>
    ...
    <dd>{{% md %}}Certificate issuing authority.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#secretversion_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Version</a>
    ...
    <dd>{{% md %}}Version of the secret to be used{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subjectalternativenames_csharp" style="color: inherit; text-decoration: inherit;">Subject<wbr>Alternative<wbr>Names</a>
    ...
    <dd>{{% md %}}The list of SANs.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#uselatestversion_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Latest<wbr>Version</a>
    ...
    <dd>{{% md %}}Whether to use the latest version for the certificate{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="managedcertificateparameters">Managed<wbr>Certificate<wbr>Parameters</h4>
...
<h4 id="urlsigningkeyparameters">Url<wbr>Signing<wbr>Key<wbr>Parameters</h4>
...
<a href="#secretversion_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Version</a>
    ...
    <dd>{{% md %}}Version of the secret to be used{{% /md %}}</dd></dl>
{{% /choosable %}}
