...
## Create a VirtualMachineTemplate Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The VirtualMachineTemplate resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the inventory Item ID for the virtual machine template.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
template.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#vcenterid_csharp" style="color: inherit; text-decoration: inherit;">VCenter<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the ARM Id of the vCenter resource in which this template resides.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
