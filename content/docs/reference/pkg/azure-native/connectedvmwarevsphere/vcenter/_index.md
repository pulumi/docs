...
## Create a VCenter Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The VCenter resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd>{{% md %}}Gets or sets the FQDN/IPAddress of the vCenter.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#credentials_csharp" style="color: inherit; text-decoration: inherit;">Credentials</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vicredential">Pulumi.<wbr>Azure<wbr>Native.<wbr>Connected<wbr>VMwarev<wbr>Sphere.<wbr>Inputs.<wbr>VICredential<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Username / Password Credentials to connect to vcenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}Gets or sets the port of the vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}Gets or sets the version of the vCenter.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="vicredential">VICredential</h4>
...
<a href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd>{{% md %}}Gets or sets the password to connect with the vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
