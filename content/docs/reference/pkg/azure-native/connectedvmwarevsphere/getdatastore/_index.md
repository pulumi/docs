...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_datastore(</span><span class="nx">datastore_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#datastorename_csharp" style="color: inherit; text-decoration: inherit;">Datastore<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the datastore.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#moname_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Name</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter Managed Object name for the datastore.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the inventory Item ID for the datastore.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#morefid_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Ref<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter MoRef (Managed Object Reference) ID for the datastore.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#vcenterid_csharp" style="color: inherit; text-decoration: inherit;">VCenter<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the ARM Id of the vCenter resource in which this datastore resides.{{% /md %}}</dd></dl>
{{% /choosable %}}
