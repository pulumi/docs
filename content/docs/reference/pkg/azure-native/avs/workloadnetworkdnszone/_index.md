...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWorkloadNetworkDnsZone</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">WorkloadNetworkDnsZoneArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WorkloadNetworkDnsZone</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display name of the DNS Zone.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnsserverips_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Server<wbr>Ips</a>
    ...
    <dd>{{% md %}}DNS Server IP array of the DNS Zone.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnsservices_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Services</a>
    ...
    <dd>{{% md %}}Number of DNS Services using the DNS zone.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnszoneid_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Zone<wbr>Id</a>
    ...
    <dd>{{% md %}}NSX DNS Zone identifier. Generally the same as the DNS Zone's display name{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#domain_csharp" style="color: inherit; text-decoration: inherit;">Domain</a>
    ...
    <dd>{{% md %}}Domain names of the DNS Zone.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
