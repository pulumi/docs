...
class MyStack : Stack
{
    public MyStack()
    {
        var cluster = new AzureNative.AVS.Cluster("cluster", new AzureNative.AVS.ClusterArgs
        {
...
<span class="k">def </span><span class="nx">Cluster</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">cluster_size</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>Native.<wbr>AVS.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The cluster SKU{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clustername_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the cluster in the private cloud{{% /md %}}</dd></dl>
{{% /choosable %}}
