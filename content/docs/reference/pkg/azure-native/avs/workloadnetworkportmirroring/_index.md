...
title_tag: "azure-native.avs.WorkloadNetworkPortMirroring"
meta_desc: "Documentation for the azure-native.avs.WorkloadNetworkPortMirroring resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">WorkloadNetworkPortMirroring</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 ...
                                 <span class="nx">direction</span><span class="p">:</span> <span class="nx">Optional[Union[str, PortMirroringDirectionEnum]]</span> = None<span class="p">,</span>
                                 <span class="nx">display_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                 <span class="nx">port_mirroring_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">WorkloadNetworkPortMirroring</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WorkloadNetworkPortMirroringArgs</a></span><span class="p">,</span>
                                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewWorkloadNetworkPortMirroring</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">WorkloadNetworkPortMirroringArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">WorkloadNetworkPortMirroring</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
    ...
    <dd>{{% md %}}Destination VM Group.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="direction_csharp">
<a href="#direction_csharp" style="color: inherit; text-decoration: inherit;">Direction</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#portmirroringdirectionenum">Pulumi.<wbr>Azure<wbr>Native.<wbr>AVS.<wbr>Port<wbr>Mirroring<wbr>Direction<wbr>Enum</a></span>
    </dt>
    <dd>{{% md %}}Direction of port mirroring profile.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display name of the port mirroring profile.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#portmirroringid_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Mirroring<wbr>Id</a>
    ...
    <dd>{{% md %}}NSX Port Mirroring identifier. Generally the same as the Port Mirroring display name{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>{{% md %}}Source VM Group.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#direction_go" style="color: inherit; text-decoration: inherit;">Direction</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#portmirroringdirectionenum">Port<wbr>Mirroring<wbr>Direction<wbr>Enum</a></span>
    </dt>
    <dd>{{% md %}}Direction of port mirroring profile.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#direction_python" style="color: inherit; text-decoration: inherit;">direction</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#portmirroringdirectionenum">Port<wbr>Mirroring<wbr>Direction<wbr>Enum</a></span>
    </dt>
    <dd>{{% md %}}Direction of port mirroring profile.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Port Mirroring Status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<h4 id="portmirroringdirectionenum">Port<wbr>Mirroring<wbr>Direction<wbr>Enum</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>INGRESS_EGRESS_BIDIRECTIONAL</dt>
    <dd>INGRESS, EGRESS, BIDIRECTIONAL</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Port<wbr>Mirroring<wbr>Direction<wbr>Enum_INGRESS_EGRESS_BIDIRECTIONAL</dt>
    <dd>INGRESS, EGRESS, BIDIRECTIONAL</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>INGRES_S_EGRES_S_BIDIRECTIONAL</dt>
    <dd>INGRESS, EGRESS, BIDIRECTIONAL</dd></dl>
{{% /choosable %}}
## Import
