...
## Create a ScriptExecution Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewScriptExecution</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ScriptExecutionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ScriptExecution</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The ScriptExecution resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#timeout_csharp" style="color: inherit; text-decoration: inherit;">Timeout</a>
    ...
    <dd>{{% md %}}Time limit for execution{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#failurereason_csharp" style="color: inherit; text-decoration: inherit;">Failure<wbr>Reason</a>
    ...
    <dd>{{% md %}}Error message if the script was able to run, but if the script itself had errors or powershell threw an exception{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#namedoutputs_csharp" style="color: inherit; text-decoration: inherit;">Named<wbr>Outputs</a>
    ...
    <dd>{{% md %}}User-defined dictionary.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#output_csharp" style="color: inherit; text-decoration: inherit;">Output</a>
    ...
    <dd>{{% md %}}Standard output stream from the powershell execution{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#retention_csharp" style="color: inherit; text-decoration: inherit;">Retention</a>
    ...
    <dd>{{% md %}}Time to live for the resource. If not provided, will be available for 60 days{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#scriptcmdletid_csharp" style="color: inherit; text-decoration: inherit;">Script<wbr>Cmdlet<wbr>Id</a>
    ...
    <dd>{{% md %}}A reference to the script cmdlet resource if user is running a AVS script{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#warnings_csharp" style="color: inherit; text-decoration: inherit;">Warnings</a>
    ...
    <dd>{{% md %}}Standard warning out stream from the powershell execution{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="pscredentialexecutionparameter">PSCredential<wbr>Execution<wbr>Parameter</h4>
...
<h4 id="scriptsecurestringexecutionparameter">Script<wbr>Secure<wbr>String<wbr>Execution<wbr>Parameter</h4>
...
<h4 id="scriptstringexecutionparameter">Script<wbr>String<wbr>Execution<wbr>Parameter</h4>
