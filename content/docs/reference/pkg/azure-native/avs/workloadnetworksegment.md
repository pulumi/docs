...
<span class="k">def </span><span class="nx">WorkloadNetworkSegment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">subnet</span><span class="p">:</span> <span class="nx">Optional[WorkloadNetworkSegmentSubnetArgs]</span> = None<span class="p">)</span>
...
The WorkloadNetworkSegment resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#subnet_csharp" style="color: inherit; text-decoration: inherit;">Subnet</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workloadnetworksegmentsubnet">Pulumi.<wbr>Azure<wbr>Native.<wbr>AVS.<wbr>Inputs.<wbr>Workload<wbr>Network<wbr>Segment<wbr>Subnet<wbr>Args</a></span>
    </dt>
...
<a href="#portvif_csharp" style="color: inherit; text-decoration: inherit;">Port<wbr>Vif</a>
    ...
    <dd>{{% md %}}Port Vif which segment is associated with.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Segment status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
