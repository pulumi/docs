...
title_tag: "azure-native.edgeorder.OrderCollectionByName"
meta_desc: "Documentation for the azure-native.edgeorder.OrderCollectionByName resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var orderCollectionByName = new AzureNative.EdgeOrder.OrderCollectionByName("orderCollectionByName", new AzureNative.EdgeOrder.OrderCollectionByNameArgs
        {
            Location = "westus",
...
order_collection_by_name = azure_native.edgeorder.OrderCollectionByName("orderCollectionByName",
    location="westus",
...
const orderCollectionByName = new azure_native.edgeorder.OrderCollectionByName("orderCollectionByName", {
    location: "westus",
    orderCollectionName: "TestOrderCollectionName1",
    orderIds: [
        "/subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourcegroups/TestRG/providers/Microsoft.EdgeOrder/Orders/TestOrderName1",
...
<a href="#orderids_csharp" style="color: inherit; text-decoration: inherit;">Order<wbr>Ids</a>
    ...
    <dd>{{% md %}}List of order ARM Ids which are part of an order collection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#ordercollectionname_csharp" style="color: inherit; text-decoration: inherit;">Order<wbr>Collection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the order collection{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
```sh
$ pulumi import azure-native:edgeorder:OrderCollectionByName TestOrderCollectionName1 /subscriptions/fa68082f-8ff7-4a25-95c7-ce9da541242f/resourceGroups/TestRG/providers/Microsoft.EdgeOrder/orderCollections/TestOrderCollectionName1 
```
