...
<span class="k">def </span><span class="nx">OperationByProviderRegistration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                    ...
                                    <span class="nx">contents</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[OperationsDefinitionArgs]]]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewOperationByProviderRegistration</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">OperationByProviderRegistrationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">OperationByProviderRegistration</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#contents_nodejs" style="color: inherit; text-decoration: inherit;">contents</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operationsdefinition">pulumi.<wbr>Input<pulumi.<wbr>Input<Operations<wbr>Definition<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#contents_python" style="color: inherit; text-decoration: inherit;">contents</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operationsdefinition">Input[Operations<wbr>Definition<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#display_nodejs" style="color: inherit; text-decoration: inherit;">display</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operationsdefinitiondisplay">pulumi.<wbr>Input<Operations<wbr>Definition<wbr>Display<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Display information of the operation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_nodejs">
...
<a href="#display_python" style="color: inherit; text-decoration: inherit;">display</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operationsdefinitiondisplay">Input[Operations<wbr>Definition<wbr>Display<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Display information of the operation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_python">
