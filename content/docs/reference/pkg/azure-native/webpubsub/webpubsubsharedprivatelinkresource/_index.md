...
## Create a WebPubSubSharedPrivateLinkResource Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The WebPubSubSharedPrivateLinkResource resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
