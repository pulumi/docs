...
<span class="k">def </span><span class="nx">Account</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">sku</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[AccountSkuArgs]]</span> = None<span class="p">,</span>
...
<a href="#sku_nodejs" style="color: inherit; text-decoration: inherit;">sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountsku">pulumi.<wbr>Input<Account<wbr>Sku<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Gets or sets the Sku.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_nodejs">
...
<a href="#sku_python" style="color: inherit; text-decoration: inherit;">sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountsku">Input[Account<wbr>Sku<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Gets or sets the Sku.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_python">
...
<a href="#lastmodifiedat_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>At</a>
    ...
    <dd>{{% md %}}The timestamp of the last modification the resource (UTC).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
