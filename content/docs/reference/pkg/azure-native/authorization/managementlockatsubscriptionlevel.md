...
```sh
$ pulumi import azure-native:authorization:ManagementLockAtSubscriptionLevel myresource1 /subscriptions/{subscriptionId}/providers/Microsoft.Authorization/locks/{lockName} 
```
