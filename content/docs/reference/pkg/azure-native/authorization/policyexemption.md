...
<span class="k">def </span><span class="nx">PolicyExemption</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">exemption_category</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, ExemptionCategory]]]</span> = None<span class="p">,</span>
                    ...
                    <span class="nx">policy_definition_reference_ids</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                    <span class="nx">policy_exemption_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#exemptioncategory_nodejs" style="color: inherit; text-decoration: inherit;">exemption<wbr>Category</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#exemptioncategory">pulumi.<wbr>Input<Exemption<wbr>Category></a></span>
    </dt>
    <dd>{{% md %}}The policy exemption category. Possible values are Waiver and Mitigated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#exemption_category_python" style="color: inherit; text-decoration: inherit;">exemption_<wbr>category</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#exemptioncategory">Input[Exemption<wbr>Category]</a></span>
    </dt>
    <dd>{{% md %}}The policy exemption category. Possible values are Waiver and Mitigated.{{% /md %}}</dd><dt class="property-required"
            title="Required">
