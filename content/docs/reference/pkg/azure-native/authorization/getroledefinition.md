...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_role_definition(</span><span class="nx">role_definition_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#roledefinitionid_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Definition<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the role definition.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#scope_csharp" style="color: inherit; text-decoration: inherit;">Scope</a>
    ...
    <dd>{{% md %}}The scope of the role definition.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The role definition type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#assignablescopes_csharp" style="color: inherit; text-decoration: inherit;">Assignable<wbr>Scopes</a>
    ...
    <dd>{{% md %}}Role definition assignable scopes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The role definition description.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#permissions_csharp" style="color: inherit; text-decoration: inherit;">Permissions</a>
    ...
    <dd>{{% md %}}Role definition permissions.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rolename_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Name</a>
    ...
    <dd>{{% md %}}The role name.{{% /md %}}</dd><dt class="property-"
            title="">
