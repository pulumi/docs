...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}Location of the Guest Usages resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The initial domain name of the AAD tenant.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the Guest Usages resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
