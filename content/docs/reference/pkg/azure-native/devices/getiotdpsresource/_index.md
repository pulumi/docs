...
title_tag: "azure-native.devices.getIotDpsResource"
meta_desc: "Documentation for the azure-native.devices.getIotDpsResource function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_iot_dps_resource(</span><span class="nx">provisioning_service_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                         <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                         <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIotDpsResourceResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIotDpsResource<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIotDpsResourceArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIotDpsResourceResult</a></span>, error)</span></code></pre></div>
...
<a href="#provisioningservicename_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>Service<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the provisioning service to retrieve.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iotdpspropertiesdescriptionresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Devices.<wbr>Outputs.<wbr>Iot<wbr>Dps<wbr>Properties<wbr>Description<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Service specific properties for a provisioning service{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iotdpsskuinforesponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Devices.<wbr>Outputs.<wbr>Iot<wbr>Dps<wbr>Sku<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Sku info for a provisioning Service.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#deviceprovisioninghostname_csharp" style="color: inherit; text-decoration: inherit;">Device<wbr>Provisioning<wbr>Host<wbr>Name</a>
    ...
    <dd>{{% md %}}Device endpoint for this provisioning service.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#idscope_csharp" style="color: inherit; text-decoration: inherit;">Id<wbr>Scope</a>
    ...
    <dd>{{% md %}}Unique identifier of this provisioning service.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#serviceoperationshostname_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Operations<wbr>Host<wbr>Name</a>
    ...
    <dd>{{% md %}}Service endpoint for provisioning service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allocationpolicy_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Policy</a>
    ...
    <dd>{{% md %}}Allocation policy to be used by this provisioning service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The ARM provisioning state of the provisioning service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}Current state of the provisioning service.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}Pricing tier name of the provisioning service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#capacity_csharp" style="color: inherit; text-decoration: inherit;">Capacity</a>
    ...
    <dd>{{% md %}}The number of units to provision{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#connectionstring_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Connection string of the IoT hub.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="location_csharp">
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
</span>
    ...
    <dd>{{% md %}}ARM region of the IoT hub.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}Host name of the IoT hub.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allocationweight_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Weight</a>
    ...
    <dd>{{% md %}}weight to apply for a given iot h.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#applyallocationpolicy_csharp" style="color: inherit; text-decoration: inherit;">Apply<wbr>Allocation<wbr>Policy</a>
    ...
    <dd>{{% md %}}flag for applying allocationPolicy or not for a given iot hub.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rights_csharp" style="color: inherit; text-decoration: inherit;">Rights</a>
    ...
    <dd>{{% md %}}Rights that this key has.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#primarykey_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Key</a>
    ...
    <dd>{{% md %}}Primary SAS key value.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#secondarykey_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Key</a>
    ...
    <dd>{{% md %}}Secondary SAS key value.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="targetipfilterruleresponse">Target<wbr>Ip<wbr>Filter<wbr>Rule<wbr>Response</h4>
