...
<span class="k">def </span><span class="nx">NamespaceAuthorizationRule</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">rights</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[Union[str, AccessRights]]]]]</span> = None<span class="p">)</span>
...
<a href="#rights_nodejs" style="color: inherit; text-decoration: inherit;">rights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<pulumi.<wbr>Input<string | Access<wbr>Rights>[]></span>
    </dt>
    <dd>{{% md %}}The rights associated with the rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rights_python" style="color: inherit; text-decoration: inherit;">rights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Input[Union[str, Access<wbr>Rights]]]]</span>
    </dt>
    <dd>{{% md %}}The rights associated with the rule.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
