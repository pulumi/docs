...
<a href="#clustername_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Event Hubs Cluster.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#updatedat_csharp" style="color: inherit; text-decoration: inherit;">Updated<wbr>At</a>
    ...
    <dd>{{% md %}}The UTC time when the Event Hubs Cluster was last updated.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}Properties of the cluster SKU.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
