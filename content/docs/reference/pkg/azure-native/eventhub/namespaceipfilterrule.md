...
<span class="k">def </span><span class="nx">NamespaceIpFilterRule</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">action</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, IPAction]]]</span> = None<span class="p">,</span>
                          <span class="nx">filter_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          <span class="nx">ip_filter_rule_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                          <span class="nx">ip_mask</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#action_nodejs" style="color: inherit; text-decoration: inherit;">action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#ipaction">pulumi.<wbr>Input<IPAction></a></span>
    </dt>
    <dd>{{% md %}}The IP Filter Action{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#action_python" style="color: inherit; text-decoration: inherit;">action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#ipaction">Input[IPAction]</a></span>
    </dt>
    <dd>{{% md %}}The IP Filter Action{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
