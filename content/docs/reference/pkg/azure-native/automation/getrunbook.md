...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_runbook(</span><span class="nx">automation_account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                ...
                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRunbookResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRunbook<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupRunbookArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupRunbookResult</a></span>, error)</span></code></pre></div>
...
<a href="#runbookname_csharp" style="color: inherit; text-decoration: inherit;">Runbook<wbr>Name</a>
    ...
    <dd>{{% md %}}The runbook name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#draft_csharp" style="color: inherit; text-decoration: inherit;">Draft</a>
    ...
    <dd>{{% md %}}Gets or sets the draft runbook properties.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#logactivitytrace_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Activity<wbr>Trace</a>
    ...
    <dd>{{% md %}}Gets or sets the option to log activity trace of the runbook.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#logprogress_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Progress</a>
    ...
    <dd>{{% md %}}Gets or sets progress log option.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#logverbose_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Verbose</a>
    ...
    <dd>{{% md %}}Gets or sets verbose log option.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publishcontentlink_csharp" style="color: inherit; text-decoration: inherit;">Publish<wbr>Content<wbr>Link</a>
    ...
    <dd>{{% md %}}Gets or sets the published runbook content link.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#runbooktype_csharp" style="color: inherit; text-decoration: inherit;">Runbook<wbr>Type</a>
    ...
    <dd>{{% md %}}Gets or sets the type of the runbook.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}Gets or sets the state of the runbook.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
