...
<span class="k">def </span><span class="nx">Connection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">field_definition_values</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">,</span>
...
<a href="#connectiontype_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectiontypeassociationproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>Automation.<wbr>Inputs.<wbr>Connection<wbr>Type<wbr>Association<wbr>Property<wbr>Args</a></span>
    </dt>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets or sets the name of the connection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#connectionname_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The parameters supplied to the create or update connection operation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Gets or sets the description of the connection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fielddefinitionvalues_csharp" style="color: inherit; text-decoration: inherit;">Field<wbr>Definition<wbr>Values</a>
    ...
    <dd>{{% md %}}Gets or sets the field definition properties of the connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
