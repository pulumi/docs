...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_schedule(</span><span class="nx">automation_account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#schedulename_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Name</a>
    ...
    <dd>{{% md %}}The schedule name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#advancedschedule_csharp" style="color: inherit; text-decoration: inherit;">Advanced<wbr>Schedule</a>
    ...
    <dd>{{% md %}}Gets or sets the advanced schedule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#expirytime_csharp" style="color: inherit; text-decoration: inherit;">Expiry<wbr>Time</a>
    ...
    <dd>{{% md %}}Gets or sets the end time of the schedule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#frequency_csharp" style="color: inherit; text-decoration: inherit;">Frequency</a>
    ...
    <dd>{{% md %}}Gets or sets the frequency of the schedule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#interval_csharp" style="color: inherit; text-decoration: inherit;">Interval</a>
    ...
    <dd>{{% md %}}Gets or sets the interval of the schedule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nextrunoffsetminutes_csharp" style="color: inherit; text-decoration: inherit;">Next<wbr>Run<wbr>Offset<wbr>Minutes</a>
    ...
    <dd>{{% md %}}Gets or sets the next run time's offset in minutes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}Gets or sets the start time of the schedule.{{% /md %}}</dd><dt class="property-"
            title="">
