...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets or sets the name of the credential.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd>{{% md %}}Gets or sets the password of the credential.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}Gets or sets the user name of the credential.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#credentialname_csharp" style="color: inherit; text-decoration: inherit;">Credential<wbr>Name</a>
    ...
    <dd>{{% md %}}The parameters supplied to the create or update credential operation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Gets or sets the description of the credential.{{% /md %}}</dd></dl>
{{% /choosable %}}
