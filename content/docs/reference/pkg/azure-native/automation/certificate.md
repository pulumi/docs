...
<span class="k">def </span><span class="nx">Certificate</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">base64_value</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                ...
                <span class="nx">is_exportable</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<a href="#base64value_csharp" style="color: inherit; text-decoration: inherit;">Base64Value</a>
    ...
    <dd>{{% md %}}Gets or sets the base64 encoded value of the certificate.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets or sets the name of the certificate.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#certificatename_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Name</a>
    ...
    <dd>{{% md %}}The parameters supplied to the create or update certificate operation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Gets or sets the description of the certificate.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#isexportable_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Exportable</a>
    ...
    <dd>{{% md %}}Gets or sets the is exportable flag of the certificate.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#thumbprint_csharp" style="color: inherit; text-decoration: inherit;">Thumbprint</a>
    ...
    <dd>{{% md %}}Gets or sets the thumbprint of the certificate.{{% /md %}}</dd></dl>
{{% /choosable %}}
