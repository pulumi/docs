...
---
title: "StorageDomain"
title_tag: "azure-native.storsimple.StorageDomain"
meta_desc: "Documentation for the azure-native.storsimple.StorageDomain resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var storageDomain = new AzureNative.StorSimple.StorageDomain("storageDomain", new AzureNative.StorSimple.StorageDomainArgs
        {
...
storage_domain = azure_native.storsimple.StorageDomain("storageDomain",
...
const storageDomain = new azure_native.storsimple.StorageDomain("storageDomain", {
    encryptionStatus: "Disabled",
    managerName: "hAzureSDKOperations",
    resourceGroupName: "ResourceGroupForSDKTest",
...
<a href="#encryptionstatus_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Stor<wbr>Simple.<wbr>Encryption<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}The encryption status "Enabled | Disabled".{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#storageaccountcredentialids_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Credential<wbr>Ids</a>
    ...
    <dd>{{% md %}}The storage account credentials.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#encryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Key</a>
    ...
    <dd>{{% md %}}The encryption key used to encrypt the data. This is a user secret.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
```sh
$ pulumi import azure-native:storsimple:StorageDomain sd-fs-HSDK-4XY4FI2IVG /subscriptions/9eb689cd-7243-43b4-b6f6-5c65cb296641/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/hAzureSDKOperations/storageDomains/sd-fs-HSDK-4XY4FI2IVG 
```
