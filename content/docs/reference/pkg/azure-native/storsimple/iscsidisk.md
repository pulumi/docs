...
---
title: "IscsiDisk"
title_tag: "azure-native.storsimple.IscsiDisk"
meta_desc: "Documentation for the azure-native.storsimple.IscsiDisk resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var iscsiDisk = new AzureNative.StorSimple.IscsiDisk("iscsiDisk", new AzureNative.StorSimple.IscsiDiskArgs
        {
...
iscsi_disk = azure_native.storsimple.IscsiDisk("iscsiDisk",
...
const iscsiDisk = new azure_native.storsimple.IscsiDisk("iscsiDisk", {
    accessControlRecords: [],
    dataPolicy: "Tiered",
    description: "Demo IscsiDisk for SDK Test Tiered",
    deviceName: "HSDK-0NZI14MDTF",
...
<a href="#accesscontrolrecords_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Control<wbr>Records</a>
    ...
    <dd>{{% md %}}The access control records.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#diskstatus_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Stor<wbr>Simple.<wbr>Disk<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}The disk status.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#monitoringstatus_csharp" style="color: inherit; text-decoration: inherit;">Monitoring<wbr>Status</a>
    ...
    <dd>{{% md %}}The monitoring.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisionedcapacityinbytes_csharp" style="color: inherit; text-decoration: inherit;">Provisioned<wbr>Capacity<wbr>In<wbr>Bytes</a>
    ...
    <dd>{{% md %}}The provisioned capacity in bytes.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
{{% choosable language go %}}
<dl class="tabular"><dt>Disk<wbr>Status<wbr>Online</dt>
    <dd>Online</dd><dt>Disk<wbr>Status<wbr>Offline</dt>
    <dd>Offline</dd></dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-native:storsimple:IscsiDisk Auto-TestIscsiDisk1 /subscriptions/9eb689cd-7243-43b4-b6f6-5c65cb296641/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/hAzureSDKOperations/devices/HSDK-0NZI14MDTF/iscsiServers/HSDK-0NZI14MDTF/disks/Auto-TestIscsiDisk1 
```
