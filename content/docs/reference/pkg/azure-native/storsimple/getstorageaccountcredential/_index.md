...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_storage_account_credential(</span><span class="nx">manager_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#storageaccountcredentialname_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Credential<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of storage account credential to be fetched.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#endpoint_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Point</a>
    ...
    <dd>{{% md %}}The storage endpoint{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#volumescount_csharp" style="color: inherit; text-decoration: inherit;">Volumes<wbr>Count</a>
    ...
    <dd>{{% md %}}The count of volumes using this storage account credential.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#accesskey_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Key</a>
    ...
    <dd>{{% md %}}The details of the storage account password.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
