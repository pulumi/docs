...
---
title: "FileServer"
title_tag: "azure-native.storsimple.FileServer"
meta_desc: "Documentation for the azure-native.storsimple.FileServer resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var fileServer = new AzureNative.StorSimple.FileServer("fileServer", new AzureNative.StorSimple.FileServerArgs
        {
...
file_server = azure_native.storsimple.FileServer("fileServer",
...
const fileServer = new azure_native.storsimple.FileServer("fileServer", {
    backupScheduleGroupId: "/subscriptions/9eb689cd-7243-43b4-b6f6-5c65cb296641/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/hAzureSDKOperations/devices/hsdk-4xy4fi2ivg/backupScheduleGroups/BackupSchGroupForSDKTest",
    description: "Demo FileServer for SDK Test",
    deviceName: "HSDK-4XY4FI2IVG",
    domainName: "fareast.corp.microsoft.com",
...
<a href="#domainname_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}Domain of the file server{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the file server{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fileservername_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Server<wbr>Name</a>
    ...
    <dd>{{% md %}}The file server name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-native:storsimple:FileServer HSDK-4XY4FI2IVG /subscriptions/9eb689cd-7243-43b4-b6f6-5c65cb296641/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/hAzureSDKOperations/devices/hsdk-4xy4fi2ivg/fileServers/HSDK-4XY4FI2IVG 
```
