...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getVolumeContainer<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetVolumeContainerArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetVolumeContainerResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_volume_container(</span><span class="nx">device_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                         ...
                         <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetVolumeContainerResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupVolumeContainer<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupVolumeContainerArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupVolumeContainerResult</a></span>, error)</span></code></pre></div>
...
<a href="#volumecontainername_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Container<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the volume container.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#encryptionstatus_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Status</a>
    ...
    <dd>{{% md %}}The flag to denote whether encryption is enabled or not.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ownershipstatus_csharp" style="color: inherit; text-decoration: inherit;">Owner<wbr>Ship<wbr>Status</a>
    ...
    <dd>{{% md %}}The owner ship status of the volume container. Only when the status is "NotOwned", the delete operation on the volume container is permitted.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageaccountcredentialid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Credential<wbr>Id</a>
    ...
    <dd>{{% md %}}The path ID of storage account associated with the volume container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#totalcloudstorageusageinbytes_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Cloud<wbr>Storage<wbr>Usage<wbr>In<wbr>Bytes</a>
    ...
    <dd>{{% md %}}The total cloud storage for the volume container.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#volumecount_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of volumes in the volume Container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bandwidthrateinmbps_csharp" style="color: inherit; text-decoration: inherit;">Band<wbr>Width<wbr>Rate<wbr>In<wbr>Mbps</a>
    ...
    <dd>{{% md %}}The bandwidth-rate set on the volume container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bandwidthsettingid_csharp" style="color: inherit; text-decoration: inherit;">Bandwidth<wbr>Setting<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the bandwidth setting associated with the volume container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Key</a>
    ...
    <dd>{{% md %}}The key used to encrypt data in the volume container. It is required when property 'EncryptionStatus' is "Enabled".{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#encryptioncertthumbprint_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Cert<wbr>Thumbprint</a>
    ...
    <dd>{{% md %}}Thumbprint certificate that was used to encrypt "Value". If the value in unencrypted, it will be null.{{% /md %}}</dd></dl>
{{% /choosable %}}
