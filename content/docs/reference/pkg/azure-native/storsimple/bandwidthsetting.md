...
<span class="k">def </span><span class="nx">BandwidthSetting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">bandwidth_setting_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">schedules</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[BandwidthScheduleArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#schedules_nodejs" style="color: inherit; text-decoration: inherit;">schedules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bandwidthschedule">pulumi.<wbr>Input<pulumi.<wbr>Input<Bandwidth<wbr>Schedule<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The schedules.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#schedules_python" style="color: inherit; text-decoration: inherit;">schedules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bandwidthschedule">Input[Bandwidth<wbr>Schedule<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The schedules.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#start_nodejs" style="color: inherit; text-decoration: inherit;">start</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#time">pulumi.<wbr>Input<Time<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The start time of the schedule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stop_nodejs">
...
<a href="#start_python" style="color: inherit; text-decoration: inherit;">start</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#time">Input[Time<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The start time of the schedule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stop_python">
...
<a href="#start_nodejs" style="color: inherit; text-decoration: inherit;">start</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timeresponse">pulumi.<wbr>Input<Time<wbr>Response<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The start time of the schedule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stop_nodejs">
...
<a href="#start_python" style="color: inherit; text-decoration: inherit;">start</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timeresponse">Input[Time<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The start time of the schedule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stop_python">
