...
---
title: "ChapSetting"
title_tag: "azure-native.storsimple.ChapSetting"
meta_desc: "Documentation for the azure-native.storsimple.ChapSetting resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var chapSetting = new AzureNative.StorSimple.ChapSetting("chapSetting", new AzureNative.StorSimple.ChapSettingArgs
        {
            ChapUserName = "ChapSettingForSDK",
            DeviceName = "HSDK-WSJQERQW3F",
            ManagerName = "hAzureSDKOperations",
            Password = new AzureNative.StorSimple.Inputs.AsymmetricEncryptedSecretArgs
            {
...
chap_setting = azure_native.storsimple.ChapSetting("chapSetting",
    chap_user_name="ChapSettingForSDK",
    device_name="HSDK-WSJQERQW3F",
    manager_name="hAzureSDKOperations",
    password=azure_native.storsimple.AsymmetricEncryptedSecretArgs(
...
const chapSetting = new azure_native.storsimple.ChapSetting("chapSetting", {
    chapUserName: "ChapSettingForSDK",
    deviceName: "HSDK-WSJQERQW3F",
    managerName: "hAzureSDKOperations",
    password: {
...
<a href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd>{{% md %}}The chap password.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#chapusername_csharp" style="color: inherit; text-decoration: inherit;">Chap<wbr>User<wbr>Name</a>
    ...
    <dd>{{% md %}}The chap user name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
```sh
$ pulumi import azure-native:storsimple:ChapSetting ChapSettingForSDK /subscriptions/9eb689cd-7243-43b4-b6f6-5c65cb296641/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/hAzureSDKOperations/devices/HSDK-WSJQERQW3F/chapSettings/ChapSettingForSDK 
```
