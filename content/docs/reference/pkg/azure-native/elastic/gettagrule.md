...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group to which the Elastic resource belongs.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#rulesetname_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Set<wbr>Name</a>
    ...
    <dd>{{% md %}}Tag Rule Set resource name{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}Properties of the monitoring tag rules.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd>{{% md %}}Valid actions for a filtering tag.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#filteringtags_csharp" style="color: inherit; text-decoration: inherit;">Filtering<wbr>Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#filteringtagresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Elastic.<wbr>Inputs.<wbr>Filtering<wbr>Tag<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#logrules_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#logrulesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Elastic.<wbr>Inputs.<wbr>Log<wbr>Rules<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Rules for sending logs.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}Provisioning state of the monitoring tag rules.{{% /md %}}</dd></dl>
{{% /choosable %}}
