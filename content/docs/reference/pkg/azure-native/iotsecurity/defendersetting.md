...
<span class="k">def </span><span class="nx">DefenderSetting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">device_quota</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
                    <span class="nx">onboarding_kind</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, OnboardingKind]]]</span> = None<span class="p">,</span>
                    <span class="nx">sentinel_workspace_resource_ids</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">)</span>
...
<a href="#onboardingkind_nodejs" style="color: inherit; text-decoration: inherit;">onboarding<wbr>Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#onboardingkind">pulumi.<wbr>Input<Onboarding<wbr>Kind></a></span>
    </dt>
    <dd>{{% md %}}The kind of onboarding for the subscription{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#onboarding_kind_python" style="color: inherit; text-decoration: inherit;">onboarding_<wbr>kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#onboardingkind">Input[Onboarding<wbr>Kind]</a></span>
    </dt>
    <dd>{{% md %}}The kind of onboarding for the subscription{{% /md %}}</dd><dt class="property-required"
            title="Required">
