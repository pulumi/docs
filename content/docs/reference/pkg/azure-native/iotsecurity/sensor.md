...
<span class="k">def </span><span class="nx">Sensor</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">sensor_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
           <span class="nx">sensor_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, SensorType]]]</span> = None<span class="p">,</span>
           <span class="nx">ti_automatic_updates</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<a href="#sensortype_nodejs" style="color: inherit; text-decoration: inherit;">sensor<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#sensortype">pulumi.<wbr>Input<Sensor<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Type of sensor{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sensor_type_python" style="color: inherit; text-decoration: inherit;">sensor_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#sensortype">Input[Sensor<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Type of sensor{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
