...
title_tag: "azure-native.dbformysql.getConfiguration"
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_configuration(</span><span class="nx">configuration_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#configurationname_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the server configuration.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>{{% md %}}Source of the configuration.{{% /md %}}</dd><dt class="property-"
            title="">
