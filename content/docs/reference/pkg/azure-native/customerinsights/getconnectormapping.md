...
<a href="#mappingname_csharp" style="color: inherit; text-decoration: inherit;">Mapping<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the connector mapping.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#connectorname_csharp" style="color: inherit; text-decoration: inherit;">Connector<wbr>Name</a>
    ...
    <dd>{{% md %}}The connector name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#entitytype_csharp" style="color: inherit; text-decoration: inherit;">Entity<wbr>Type</a>
    ...
    <dd>{{% md %}}Defines which entity type the file should map to.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#mappingproperties_csharp" style="color: inherit; text-decoration: inherit;">Mapping<wbr>Properties</a>
    ...
    <dd>{{% md %}}The properties of the mapping.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the connector mapping.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display name for the connector mapping.{{% /md %}}</dd></dl>
{{% /choosable %}}
