...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Maintenance<wbr>Scope<wbr>All</dt>
    <dd>All</dd>
    <dt>Maintenance<wbr>Scope<wbr>Host</dt>
    <dd>Host</dd>
    <dt>Maintenance<wbr>Scope<wbr>Resource</dt>
    <dd>Resource</dd>
    <dt>Maintenance<wbr>Scope<wbr>In<wbr>Resource</dt>
    <dd>InResource</dd>
</dl>
{{% /choosable %}}
