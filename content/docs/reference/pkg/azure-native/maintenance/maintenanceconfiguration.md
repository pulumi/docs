...
<span class="k">def </span><span class="nx">MaintenanceConfiguration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">extension_properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]</span> = None<span class="p">,</span>
                             <span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                             <span class="nx">maintenance_scope</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, MaintenanceScope]]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewMaintenanceConfiguration</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">MaintenanceConfigurationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">MaintenanceConfiguration</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The MaintenanceConfiguration resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#extensionproperties_csharp" style="color: inherit; text-decoration: inherit;">Extension<wbr>Properties</a>
    ...
    <dd>{{% md %}}Gets or sets extensionProperties of the maintenanceConfiguration. This is for future use only and would be a set of key value pairs for additional information e.g. whether to follow SDP etc.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}Gets or sets location of the resource{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancescope_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Scope</a>
    ...
    <dd>{{% md %}}Gets or sets maintenanceScope of the configuration. It represent the impact area of the maintenance{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd>{{% md %}}Gets or sets namespace of the resource e.g. Microsoft.Maintenance or Microsoft.Sql{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}Resource Identifier{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#maintenancescope_nodejs" style="color: inherit; text-decoration: inherit;">maintenance<wbr>Scope</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#maintenancescope">pulumi.<wbr>Input<Maintenance<wbr>Scope></a></span>
    </dt>
    <dd>{{% md %}}Gets or sets maintenanceScope of the configuration. It represent the impact area of the maintenance{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenance_scope_python" style="color: inherit; text-decoration: inherit;">maintenance_<wbr>scope</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#maintenancescope">Input[Maintenance<wbr>Scope]</a></span>
    </dt>
    <dd>{{% md %}}Gets or sets maintenanceScope of the configuration. It represent the impact area of the maintenance{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="maintenancescope">Maintenance<wbr>Scope</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>All</dt>
    <dd>All</dd><dt>Host</dt>
    <dd>Host</dd><dt>Resource</dt>
    <dd>Resource</dd><dt>In<wbr>Resource</dt>
    <dd>InResource</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Maintenance<wbr>Scope<wbr>All</dt>
    <dd>All</dd><dt>Maintenance<wbr>Scope<wbr>Host</dt>
    <dd>Host</dd><dt>Maintenance<wbr>Scope<wbr>Resource</dt>
    <dd>Resource</dd><dt>Maintenance<wbr>Scope<wbr>In<wbr>Resource</dt>
    <dd>InResource</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ALL</dt>
    <dd>All</dd><dt>HOST</dt>
    <dd>Host</dd><dt>RESOURCE</dt>
    <dd>Resource</dd><dt>IN_RESOURCE</dt>
    <dd>InResource</dd></dl>
{{% /choosable %}}
## Import
