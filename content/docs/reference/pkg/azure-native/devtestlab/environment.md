...
<span class="k">def </span><span class="nx">Environment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">arm_template_display_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                <span class="nx">deployment_properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[EnvironmentDeploymentPropertiesArgs]]</span> = None<span class="p">,</span>
...
<a href="#deploymentproperties_nodejs" style="color: inherit; text-decoration: inherit;">deployment<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentdeploymentproperties">pulumi.<wbr>Input<Environment<wbr>Deployment<wbr>Properties<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The deployment properties of the environment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#deployment_properties_python" style="color: inherit; text-decoration: inherit;">deployment_<wbr>properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentdeploymentproperties">Input[Environment<wbr>Deployment<wbr>Properties<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The deployment properties of the environment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#parameters_nodejs" style="color: inherit; text-decoration: inherit;">parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#armtemplateparameterproperties">pulumi.<wbr>Input<pulumi.<wbr>Input<Arm<wbr>Template<wbr>Parameter<wbr>Properties<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The parameters of the Azure Resource Manager template.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#parameters_python" style="color: inherit; text-decoration: inherit;">parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#armtemplateparameterproperties">Input[Arm<wbr>Template<wbr>Parameter<wbr>Properties<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The parameters of the Azure Resource Manager template.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#parameters_nodejs" style="color: inherit; text-decoration: inherit;">parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#armtemplateparameterpropertiesresponse">pulumi.<wbr>Input<pulumi.<wbr>Input<Arm<wbr>Template<wbr>Parameter<wbr>Properties<wbr>Response<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The parameters of the Azure Resource Manager template.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#parameters_python" style="color: inherit; text-decoration: inherit;">parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#armtemplateparameterpropertiesresponse">Input[Arm<wbr>Template<wbr>Parameter<wbr>Properties<wbr>Response<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The parameters of the Azure Resource Manager template.{{% /md %}}</dd></dl>
{{% /choosable %}}
## Import
