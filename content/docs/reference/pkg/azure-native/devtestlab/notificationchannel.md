...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Notification<wbr>Channel<wbr>Event<wbr>Type<wbr>Auto<wbr>Shutdown</dt>
    <dd>AutoShutdown</dd>
    <dt>Notification<wbr>Channel<wbr>Event<wbr>Type<wbr>Cost</dt>
    <dd>Cost</dd>
</dl>
{{% /choosable %}}
