...
<span class="k">def </span><span class="nx">Formula</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">vm</span><span class="p">:</span> <span class="nx">Optional[FormulaPropertiesFromVmArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewFormula</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">FormulaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Formula</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the formula.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#formulacontent_csharp" style="color: inherit; text-decoration: inherit;">Formula<wbr>Content</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#labvirtualmachinecreationparameter">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Lab<wbr>Virtual<wbr>Machine<wbr>Creation<wbr>Parameter<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The content of the formula.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the formula.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
    ...
    <dd>{{% md %}}The OS type of the formula.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#vm_csharp" style="color: inherit; text-decoration: inherit;">Vm</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#formulapropertiesfromvm">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Formula<wbr>Properties<wbr>From<wbr>Vm<wbr>Args</a></span>
    </dt>
