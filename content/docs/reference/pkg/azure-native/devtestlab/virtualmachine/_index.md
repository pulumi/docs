...
<a href="#artifacts_csharp" style="color: inherit; text-decoration: inherit;">Artifacts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#artifactinstallproperties">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Artifact<wbr>Install<wbr>Properties<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#datadiskparameters_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disk<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datadiskproperties">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Data<wbr>Disk<wbr>Properties<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#galleryimagereference_csharp" style="color: inherit; text-decoration: inherit;">Gallery<wbr>Image<wbr>Reference</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#galleryimagereference">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Gallery<wbr>Image<wbr>Reference<wbr>Args</a></span>
    </dt>
...
<a href="#networkinterface_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfaceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Network<wbr>Interface<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<a href="#scheduleparameters_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulecreationparameter">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>Inputs.<wbr>Schedule<wbr>Creation<wbr>Parameter<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#artifactdeploymentstatus_csharp" style="color: inherit; text-decoration: inherit;">Artifact<wbr>Deployment<wbr>Status</a>
    ...
    <dd>{{% md %}}The artifact deployment status for the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#computeid_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource identifier (Microsoft.Compute) of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#computevm_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Vm</a>
    ...
    <dd>{{% md %}}The compute virtual machine properties.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#createdbyuser_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By<wbr>User</a>
    ...
    <dd>{{% md %}}The email address of creator of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#createdbyuserid_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By<wbr>User<wbr>Id</a>
    ...
    <dd>{{% md %}}The object identifier of the creator of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="fqdn_csharp">
<a href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd>{{% md %}}The fully-qualified domain name of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#lastknownpowerstate_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Known<wbr>Power<wbr>State</a>
    ...
    <dd>{{% md %}}Last known compute power state captured in DTL{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
    ...
    <dd>{{% md %}}The OS type of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disksizegib_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>Gi<wbr>B</a>
    ...
    <dd>{{% md %}}Gets data disk size in GiB.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets data disk name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#code_csharp" style="color: inherit; text-decoration: inherit;">Code</a>
    ...
    <dd>{{% md %}}Gets the status Code.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#displaystatus_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Status</a>
    ...
    <dd>{{% md %}}Gets the short localizable label for the status.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#message_csharp" style="color: inherit; text-decoration: inherit;">Message</a>
    ...
    <dd>{{% md %}}Gets the message associated with the status.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#datadiskids_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disk<wbr>Ids</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;string&gt;</span>
    </dt>
    <dd>{{% md %}}Gets data disks blob uri for the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkinterfaceid_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets the network interface ID of the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#osdiskid_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Disk<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets OS disk blob uri for the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ostype_csharp">
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
</span>
    ...
    <dd>{{% md %}}Gets the OS type of the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vmsize_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Size</a>
    ...
    <dd>{{% md %}}Gets the size of the virtual machine.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#datadiskids_go" style="color: inherit; text-decoration: inherit;">Data<wbr>Disk<wbr>Ids</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]string</span>
    </dt>
...
<a href="#datadiskids_nodejs" style="color: inherit; text-decoration: inherit;">data<wbr>Disk<wbr>Ids</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string[]</span>
    </dt>
...
<a href="#data_disk_ids_python" style="color: inherit; text-decoration: inherit;">data_<wbr>disk_<wbr>ids</a>
</span>
        <span class="property-indicator"></span>
...
<h4 id="hostcachingoptions">Host<wbr>Caching<wbr>Options</h4>
