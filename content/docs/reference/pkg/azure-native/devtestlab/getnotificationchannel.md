...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupNotificationChannel<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupNotificationChannelArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupNotificationChannelResult</a></span>, error)</span></code></pre></div>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the notification channel.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($select=webHookUrl)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description of notification.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#emailrecipient_csharp" style="color: inherit; text-decoration: inherit;">Email<wbr>Recipient</a>
    ...
    <dd>{{% md %}}The email recipient to send notifications to (can be a list of semi-colon separated email addresses).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#events_csharp" style="color: inherit; text-decoration: inherit;">Events</a>
    ...
    <dd>{{% md %}}The list of event for which this notification is enabled.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#notificationlocale_csharp" style="color: inherit; text-decoration: inherit;">Notification<wbr>Locale</a>
    ...
    <dd>{{% md %}}The locale to use when sending a notification (fallback for unsupported languages is EN).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
