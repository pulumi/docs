...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_application(</span><span class="nx">application_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#applicationname_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the application within the specified application group{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#commandlinesetting_csharp" style="color: inherit; text-decoration: inherit;">Command<wbr>Line<wbr>Setting</a>
    ...
    <dd>{{% md %}}Specifies whether this published application can be launched with command line arguments provided by the client, command line arguments specified at publish time, or no command line arguments at all.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#objectid_csharp" style="color: inherit; text-decoration: inherit;">Object<wbr>Id</a>
    ...
    <dd>{{% md %}}ObjectId of Application. (internal use){{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#applicationtype_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Type</a>
    ...
    <dd>{{% md %}}Resource Type of Application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#commandlinearguments_csharp" style="color: inherit; text-decoration: inherit;">Command<wbr>Line<wbr>Arguments</a>
    ...
    <dd>{{% md %}}Command Line Arguments for Application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description of Application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#filepath_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Path</a>
    ...
    <dd>{{% md %}}Specifies a path for the executable file for the application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}Friendly name of Application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#iconindex_csharp" style="color: inherit; text-decoration: inherit;">Icon<wbr>Index</a>
    ...
    <dd>{{% md %}}Index of the icon.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#iconpath_csharp" style="color: inherit; text-decoration: inherit;">Icon<wbr>Path</a>
    ...
    <dd>{{% md %}}Path to icon.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#msixpackageapplicationid_csharp" style="color: inherit; text-decoration: inherit;">Msix<wbr>Package<wbr>Application<wbr>Id</a>
    ...
    <dd>{{% md %}}Specifies the package application Id for MSIX applications{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#msixpackagefamilyname_csharp" style="color: inherit; text-decoration: inherit;">Msix<wbr>Package<wbr>Family<wbr>Name</a>
    ...
    <dd>{{% md %}}Specifies the package family name for MSIX applications{{% /md %}}</dd><dt class="property-"
            title="">
