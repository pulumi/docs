...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getMSIXPackage<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetMSIXPackageArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetMSIXPackageResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupMSIXPackage<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupMSIXPackageArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupMSIXPackageResult</a></span>, error)</span></code></pre></div>
...
<a href="#msixpackagefullname_csharp" style="color: inherit; text-decoration: inherit;">Msix<wbr>Package<wbr>Full<wbr>Name</a>
    ...
    <dd>{{% md %}}The version specific package full name of the MSIX package within specified hostpool{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}User friendly Name to be displayed in the portal. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#imagepath_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Path</a>
    ...
    <dd>{{% md %}}VHD/CIM image path on Network Share.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#isactive_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Active</a>
    ...
    <dd>{{% md %}}Make this version of the package the active one across the hostpool. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#isregularregistration_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Regular<wbr>Registration</a>
    ...
    <dd>{{% md %}}Specifies how to register Package in feed.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastupdated_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Updated</a>
    ...
    <dd>{{% md %}}Date Package was last updated, found in the appxmanifest.xml. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packageapplications_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Applications</a>
    ...
    <dd>{{% md %}}List of package applications. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagedependencies_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Dependencies</a>
    ...
    <dd>{{% md %}}List of package dependencies. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagefamilyname_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Family<wbr>Name</a>
    ...
    <dd>{{% md %}}Package Family Name from appxmanifest.xml. Contains Package Name and Publisher name. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagename_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Name</a>
    ...
    <dd>{{% md %}}Package Name from appxmanifest.xml. {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#packagerelativepath_csharp" style="color: inherit; text-decoration: inherit;">Package<wbr>Relative<wbr>Path</a>
    ...
    <dd>{{% md %}}Relative Path to the package inside the image. {{% /md %}}</dd><dt class="property-"
            title="">
