...
<span class="k">def </span><span class="nx">DelegatedSubnetServiceDetails</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  ...
                                  <span class="nx">subnet_details</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SubnetDetailsArgs]]</span> = None<span class="p">,</span>
...
<a href="#subnetdetails_nodejs" style="color: inherit; text-decoration: inherit;">subnet<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subnetdetails">pulumi.<wbr>Input<Subnet<wbr>Details<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}subnet details{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_nodejs">
...
<a href="#subnet_details_python" style="color: inherit; text-decoration: inherit;">subnet_<wbr>details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subnetdetails">Input[Subnet<wbr>Details<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}subnet details{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_python">
