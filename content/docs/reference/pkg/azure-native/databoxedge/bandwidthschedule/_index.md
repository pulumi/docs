...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewBandwidthSchedule</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">BandwidthScheduleArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">BandwidthSchedule</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#rateinmbps_csharp" style="color: inherit; text-decoration: inherit;">Rate<wbr>In<wbr>Mbps</a>
    ...
    <dd>{{% md %}}The bandwidth rate in Mbps.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#start_csharp" style="color: inherit; text-decoration: inherit;">Start</a>
    ...
    <dd>{{% md %}}The start time of the schedule in UTC.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="stop_csharp">
<a href="#stop_csharp" style="color: inherit; text-decoration: inherit;">Stop</a>
    ...
    <dd>{{% md %}}The stop time of the schedule in UTC.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The bandwidth schedule name which needs to be added/updated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
    ...
    <dd>{{% md %}}Bandwidth object related to ASE resource{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
