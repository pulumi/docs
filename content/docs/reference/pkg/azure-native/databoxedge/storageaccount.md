...
<span class="k">def </span><span class="nx">StorageAccount</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">storage_account_credential_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                   ...
                   <span class="nx">storage_account_status</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, StorageAccountStatus]]]</span> = None<span class="p">)</span>
...
<a href="#storageaccountstatus_nodejs" style="color: inherit; text-decoration: inherit;">storage<wbr>Account<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#storageaccountstatus">pulumi.<wbr>Input<Storage<wbr>Account<wbr>Status></a></span>
    </dt>
    <dd>{{% md %}}Current status of the storage account{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#storage_account_status_python" style="color: inherit; text-decoration: inherit;">storage_<wbr>account_<wbr>status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#storageaccountstatus">Input[Storage<wbr>Account<wbr>Status]</a></span>
    </dt>
    <dd>{{% md %}}Current status of the storage account{{% /md %}}</dd></dl>
{{% /choosable %}}
