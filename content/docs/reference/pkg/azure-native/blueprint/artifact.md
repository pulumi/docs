...
<p class="resource-deprecated">Deprecated: {{% md %}}Please use one of the variants: PolicyAssignmentArtifact, RoleAssignmentArtifact, TemplateArtifact.{{% /md %}}</p>
...
<span class="k">def </span><span class="nx">Artifact</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">kind</span><span class="p">:</span> <span class="nx">Optional[Union[str, ArtifactKind]]</span> = None<span class="p">,</span>
