...
---
title: "BuildTask"
title_tag: "azure-native.containerregistry.BuildTask"
meta_desc: "Documentation for the azure-native.containerregistry.BuildTask resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var buildTask = new AzureNative.ContainerRegistry.BuildTask("buildTask", new AzureNative.ContainerRegistry.BuildTaskArgs
        {
            Alias = "myalias",
            ...
            SourceRepository = new AzureNative.ContainerRegistry.Inputs.SourceRepositoryPropertiesArgs
            {
                IsCommitTriggerEnabled = true,
                RepositoryUrl = "https://github.com/Azure/azure-rest-api-specs",
                SourceControlAuthProperties = new AzureNative.ContainerRegistry.Inputs.SourceControlAuthInfoArgs
                {
                    Scope = "repo",
                    Token = "xxxxxx",
                    TokenType = "OAuth",
...
build_task = azure_native.containerregistry.BuildTask("buildTask",
    alias="myalias",
    ...
    source_repository=azure_native.containerregistry.SourceRepositoryPropertiesArgs(
        is_commit_trigger_enabled=True,
        repository_url="https://github.com/Azure/azure-rest-api-specs",
        source_control_auth_properties=azure_native.containerregistry.SourceControlAuthInfoArgs(
            scope="repo",
            token="xxxxxx",
            token_type="OAuth",
        ),
...
const buildTask = new azure_native.containerregistry.BuildTask("buildTask", {
    alias: "myalias",
    buildTaskName: "myBuildTask",
    location: "eastus",
    platform: {},
...
```sh
$ pulumi import azure-native:containerregistry:BuildTask myBuildTask /subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/myResourceGroup/providers/Microsoft.ContainerRegistry/registries/myRegistry/buildTasks/myBuildTask 
```
