...
title_tag: "azure-native.cache.RedisEnterprise"
meta_desc: "Documentation for the azure-native.cache.RedisEnterprise resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">RedisEnterprise</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">sku</span><span class="p">:</span> <span class="nx">Optional[EnterpriseSkuArgs]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRedisEnterprise</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RedisEnterpriseArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RedisEnterprise</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#enterprisesku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cache.<wbr>Inputs.<wbr>Enterprise<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The SKU to create, which affects price, performance, and features.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clustername_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the RedisEnterprise cluster.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#minimumtlsversion_csharp" style="color: inherit; text-decoration: inherit;">Minimum<wbr>Tls<wbr>Version</a>
    ...
    <dd>{{% md %}}The minimum TLS version for the cluster to support, e.g. '1.2'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#sku_go" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#enterprisesku">Enterprise<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The SKU to create, which affects price, performance, and features.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="enterprisesku">Enterprise<wbr>Sku</h4>
