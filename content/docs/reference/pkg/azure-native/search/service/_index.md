...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group within the current subscription. You can obtain this value from the Azure Resource Manager API or the portal.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#identity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Search.<wbr>Inputs.<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#networkruleset_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Rule<wbr>Set</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkruleset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Search.<wbr>Inputs.<wbr>Network<wbr>Rule<wbr>Set<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Network specific rules that determine how the Azure Cognitive Search service may be reached.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#partitioncount_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of partitions in the search service; if specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publicnetworkaccess_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access</a>
    ...
    <dd>{{% md %}}This value can be set to 'enabled' to avoid breaking changes on existing customer resources and templates. If set to 'disabled', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#replicacount_csharp" style="color: inherit; text-decoration: inherit;">Replica<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of replicas in the search service. If specified, it must be a value between 1 and 12 inclusive for standard SKUs or between 1 and 3 inclusive for basic SKU.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#searchservicename_csharp" style="color: inherit; text-decoration: inherit;">Search<wbr>Service<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Azure Cognitive Search service to create or update. Search service names must only contain lowercase letters, digits or dashes, cannot use dash as the first two or last one characters, cannot contain consecutive dashes, and must be between 2 and 60 characters in length. Search service names must be globally unique since they are part of the service URI (https://<name>.search.windows.net). You cannot change the service name after the service is created.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Search.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The SKU of the Search Service, which determines price tier and capacity limits. This property is required when creating a new Search Service.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#privateendpointconnections_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connections</a>
    ...
    <dd>{{% md %}}The list of private endpoint connections to the Azure Cognitive Search service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The state of the last provisioning operation performed on the search service. Provisioning is an intermediate state that occurs while service capacity is being established. After capacity is set up, provisioningState changes to either 'succeeded' or 'failed'. Client applications can poll provisioning status (the recommended polling interval is from 30 seconds to one minute) by using the Get Search Service operation to see when an operation is completed. If you are using the free service, this value tends to come back as 'succeeded' directly in the call to Create search service. This is because the free service uses capacity that is already set up.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sharedprivatelinkresources_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Private<wbr>Link<wbr>Resources</a>
    ...
    <dd>{{% md %}}The list of shared private link resources managed by the Azure Cognitive Search service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#statusdetails_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Details</a>
    ...
    <dd>{{% md %}}The details of the search service status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<h4 id="hostingmode">Hosting<wbr>Mode</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>@Default</dt>
    <dd>default</dd><dt>High<wbr>Density</dt>
    <dd>highDensity</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Hosting<wbr>Mode<wbr>Default</dt>
    <dd>default</dd><dt>Hosting<wbr>Mode<wbr>High<wbr>Density</dt>
    <dd>highDensity</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>DEFAULT</dt>
    <dd>default</dd><dt>HIGH_DENSITY</dt>
    <dd>highDensity</dd></dl>
{{% /choosable %}}
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}Value corresponding to a single IPv4 address (eg., 123.1.2.3) or an IP range in CIDR format (eg., 123.1.2.3/24) to be allowed.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#iprules_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Rules</a>
    ...
    <dd>{{% md %}}A list of IP restriction rules that defines the inbound network(s) with allowing access to the search service endpoint. At the meantime, all other public IP networks are blocked by the firewall. These restriction rules are applied only when the 'publicNetworkAccess' of the search service is 'enabled'; otherwise, traffic over public interface is not allowed even with any public IP rules, and private endpoint connections would be the exclusive access method.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The resource id of the private endpoint resource from Microsoft.Network provider.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#actionsrequired_csharp" style="color: inherit; text-decoration: inherit;">Actions<wbr>Required</a>
    ...
    <dd>{{% md %}}A description of any extra actions that may be required.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description for the private link service connection state.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
</span>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Free</dt>
    ...
    <dd>standard</dd><dt>Standard2</dt>
    <dd>standard2</dd><dt>Standard3</dt>
    <dd>standard3</dd><dt>Storage_<wbr>optimized_<wbr>l1</dt>
    <dd>storage_optimized_l1</dd><dt>Storage_<wbr>optimized_<wbr>l2</dt>
    <dd>storage_optimized_l2</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Sku<wbr>Name<wbr>Free</dt>
    ...
    <dd>standard</dd><dt>Sku<wbr>Name<wbr>Standard2</dt>
    <dd>standard2</dd><dt>Sku<wbr>Name<wbr>Standard3</dt>
    <dd>standard3</dd><dt>Sku<wbr>Name_Storage_<wbr>optimized_<wbr>l1</dt>
    <dd>storage_optimized_l1</dd><dt>Sku<wbr>Name_Storage_<wbr>optimized_<wbr>l2</dt>
    <dd>storage_optimized_l2</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>FREE</dt>
    ...
    <dd>standard</dd><dt>STANDARD2</dt>
    <dd>standard2</dd><dt>STANDARD3</dt>
    <dd>standard3</dd><dt>STORAGE_OPTIMIZED_L1</dt>
    <dd>storage_optimized_l1</dd><dt>STORAGE_OPTIMIZED_L2</dt>
    <dd>storage_optimized_l2</dd></dl>
{{% /choosable %}}
