...
<span class="k">def </span><span class="nx">Certificate</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[CertificatePropertiesArgs]]</span> = None<span class="p">,</span>
...
<a href="#properties_nodejs" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificateproperties">pulumi.<wbr>Input<Certificate<wbr>Properties<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Properties of the certificate resource payload.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificateproperties">Input[Certificate<wbr>Properties<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Properties of the certificate resource payload.{{% /md %}}</dd></dl>
{{% /choosable %}}
