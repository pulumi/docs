...
<a href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of the team account which contains this workspace.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#creationdate_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Date</a>
    ...
    <dd>{{% md %}}The creation date of the machine learning workspace in ISO8601 format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The current deployment state of team account workspace resource. The provisioningState is to indicate states for resource provisioning.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#workspaceid_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of this workspace.{{% /md %}}</dd><dt class="property-"
            title="">
