...
<a href="#accountname_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the machine learning team account.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group to which the machine learning team account belongs.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id associated with this team account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#creationdate_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Date</a>
    ...
    <dd>{{% md %}}The creation date of the machine learning team account in ISO8601 format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#discoveryuri_csharp" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Uri</a>
    ...
    <dd>{{% md %}}The uri for this machine learning team account.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#keyvaultid_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Vault<wbr>Id</a>
    ...
    <dd>{{% md %}}The fully qualified arm id of the user key vault.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The current deployment state of team account resource. The provisioningState is to indicate states for resource provisioning.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageaccount_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageaccountpropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning<wbr>Experimentation.<wbr>Outputs.<wbr>Storage<wbr>Account<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The properties of the storage account for the machine learning team account.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#vsoaccountid_csharp" style="color: inherit; text-decoration: inherit;">Vso<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The fully qualified arm id of the vso account to be used for this team account.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}The friendly name for this workspace. This will be the workspace name in the arm id when the workspace object gets created{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#seats_csharp" style="color: inherit; text-decoration: inherit;">Seats</a>
    ...
    <dd>{{% md %}}The no of users/seats who can access this team account. This property defines the charge on the team account.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#accesskey_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Key</a>
    ...
    <dd>{{% md %}}The access key to the storage account.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#storageaccountid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The fully qualified arm Id of the storage account.{{% /md %}}</dd></dl>
{{% /choosable %}}
