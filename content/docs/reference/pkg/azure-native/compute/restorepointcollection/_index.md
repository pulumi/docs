...
## Create a RestorePointCollection Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRestorePointCollection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RestorePointCollectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RestorePointCollection</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The RestorePointCollection resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#restorepointcollectionname_csharp" style="color: inherit; text-decoration: inherit;">Restore<wbr>Point<wbr>Collection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the restore point collection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="source_csharp">
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#restorepointcollectionsourceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Restore<wbr>Point<wbr>Collection<wbr>Source<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the restore point collection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="restorepointcollectionid_csharp">
<a href="#restorepointcollectionid_csharp" style="color: inherit; text-decoration: inherit;">Restore<wbr>Point<wbr>Collection<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}The unique id of the restore point collection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="restorepoints_csharp">
<a href="#restorepoints_csharp" style="color: inherit; text-decoration: inherit;">Restore<wbr>Points</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>{{% md %}}A list containing all restore points created under this restore point collection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#restorepointcollectionid_go" style="color: inherit; text-decoration: inherit;">Restore<wbr>Point<wbr>Collection<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#restorepoints_go" style="color: inherit; text-decoration: inherit;">Restore<wbr>Points</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#restorepointcollectionid_nodejs" style="color: inherit; text-decoration: inherit;">restore<wbr>Point<wbr>Collection<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#restorepoints_nodejs" style="color: inherit; text-decoration: inherit;">restore<wbr>Points</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#restorepointresponse">Restore<wbr>Point<wbr>Response[]</a></span>
    </dt>
...
<a href="#restore_point_collection_id_python" style="color: inherit; text-decoration: inherit;">restore_<wbr>point_<wbr>collection_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#restore_points_python" style="color: inherit; text-decoration: inherit;">restore_<wbr>points</a>
</span>
        <span class="property-indicator"></span>
...
<h4 id="restorepointcollectionsourceproperties">Restore<wbr>Point<wbr>Collection<wbr>Source<wbr>Properties</h4>
...
<h4 id="restorepointcollectionsourcepropertiesresponse">Restore<wbr>Point<wbr>Collection<wbr>Source<wbr>Properties<wbr>Response</h4>
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}Location of the source resource used to create this restore point collection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#consistencymode_csharp" style="color: inherit; text-decoration: inherit;">Consistency<wbr>Mode</a>
    ...
    <dd>{{% md %}}Gets the consistency mode for the restore point. Please refer to https://aka.ms/RestorePoints for more details.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}Gets the provisioning state of the restore point.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#certificateurl_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Url</a>
    ...
    <dd>{{% md %}}This is the URL of a certificate that has been uploaded to Key Vault as a secret. For adding a secret to the Key Vault, see [Add a key or secret to the key vault](https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add). In this case, your certificate needs to be It is the Base64 encoding of the following JSON Object which is encoded in UTF-8: <br><br> {<br>  "data":"<Base64-encoded-certificate>",<br>  "dataType":"pfx",<br>  "password":"<pfx-file-password>"<br>}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
