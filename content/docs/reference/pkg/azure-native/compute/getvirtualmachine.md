...
title_tag: "azure-native.compute.getVirtualMachine"
meta_desc: "Documentation for the azure-native.compute.getVirtualMachine function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_virtual_machine(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}The expand expression to apply on the operation. 'InstanceView' retrieves a snapshot of the runtime properties of the virtual machine that is managed by the platform and can change outside of control plane operations. 'UserData' retrieves the UserData property as part of the VM model view that was provided by the user during the VM Create/Update operation.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineinstanceviewresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Virtual<wbr>Machine<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine instance view.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensionresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine child extension resources.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#vmid_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Id</a>
    ...
    <dd>{{% md %}}Specifies the VM unique ID which is a 128-bits identifier that is encoded and stored in all Azure IaaS VMs SMBIOS and can be read using platform BIOS commands.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#additionalcapabilities_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Capabilities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#additionalcapabilitiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Additional<wbr>Capabilities<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies additional capabilities enabled or disabled on the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#availabilityset_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Set</a>
    ...
    <dd>{{% md %}}Specifies information about the availability set that the virtual machine should be assigned to. Virtual machines specified in the same availability set are allocated to different nodes to maximize availability. For more information about availability sets, see [Availability sets overview](https://docs.microsoft.com/azure/virtual-machines/availability-set-overview). <br><br> For more information on Azure planned maintenance, see [Maintenance and updates for Virtual Machines in Azure](https://docs.microsoft.com/azure/virtual-machines/maintenance-and-updates) <br><br> Currently, a VM can only be added to availability set at creation time. The availability set to which the VM is being added should be under the same resource group as the availability set resource. An existing VM cannot be added to an availability set. <br><br>This property cannot exist along with a non-null properties.virtualMachineScaleSet reference.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#billingprofile_csharp" style="color: inherit; text-decoration: inherit;">Billing<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#billingprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Billing<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the billing related details of a Azure Spot virtual machine. <br><br>Minimum api-version: 2019-03-01.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#diagnosticsprofile_csharp" style="color: inherit; text-decoration: inherit;">Diagnostics<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diagnosticsprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Diagnostics<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the boot diagnostic settings state. <br><br>Minimum api-version: 2015-06-15.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#evictionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Eviction<wbr>Policy</a>
    ...
    <dd>{{% md %}}Specifies the eviction policy for the Azure Spot virtual machine and Azure Spot scale set. <br><br>For Azure Spot virtual machines, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2019-03-01. <br><br>For Azure Spot scale sets, both 'Deallocate' and 'Delete' are supported and the minimum api-version is 2017-10-30-preview.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#extensionstimebudget_csharp" style="color: inherit; text-decoration: inherit;">Extensions<wbr>Time<wbr>Budget</a>
    ...
    <dd>{{% md %}}Specifies the time alloted for all extensions to start. The time duration should be between 15 minutes and 120 minutes (inclusive) and should be specified in ISO 8601 format. The default value is 90 minutes (PT1H30M). <br><br> Minimum api-version: 2020-06-01{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#hardwareprofile_csharp" style="color: inherit; text-decoration: inherit;">Hardware<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hardwareprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Hardware<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the hardware settings for the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="host_csharp">
<a href="#host_csharp" style="color: inherit; text-decoration: inherit;">Host</a>
    ...
    <dd>{{% md %}}Specifies information about the dedicated host that the virtual machine resides in. <br><br>Minimum api-version: 2018-10-01.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#hostgroup_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Group</a>
    ...
    <dd>{{% md %}}Specifies information about the dedicated host group that the virtual machine resides in. <br><br>Minimum api-version: 2020-06-01. <br><br>NOTE: User cannot specify both host and hostGroup properties.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="identity_csharp">
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineidentityresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Virtual<wbr>Machine<wbr>Identity<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The identity of the virtual machine, if configured.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networkprofile_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Network<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the network interfaces of the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="osprofile_csharp">
<a href="#osprofile_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Profile</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#osprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>OSProfile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the operating system settings used while creating the virtual machine. Some of the settings cannot be changed once VM is provisioned.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="plan_csharp">
<a href="#plan_csharp" style="color: inherit; text-decoration: inherit;">Plan</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#planresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Plan<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies information about the marketplace image used to create the virtual machine. This element is only used for marketplace images. Before you can use a marketplace image from an API, you must enable the image for programmatic use.  In the Azure portal, find the marketplace image that you want to use and then click **Want to deploy programmatically, Get Started ->**. Enter any required information and then click **Save**.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#platformfaultdomain_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Fault<wbr>Domain</a>
    ...
    <dd>{{% md %}}Specifies the scale set logical fault domain into which the Virtual Machine will be created. By default, the Virtual Machine will by automatically assigned to a fault domain that best maintains balance across available fault domains.<br><li>This is applicable only if the 'virtualMachineScaleSet' property of this Virtual Machine is set.<li>The Virtual Machine Scale Set that is referenced, must have 'platformFaultDomainCount' &gt; 1.<li>This property cannot be updated once the Virtual Machine is created.<li>Fault domain assignment can be viewed in the Virtual Machine Instance View.<br><br>Minimum api‐version: 2020‐12‐01{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#priority_csharp" style="color: inherit; text-decoration: inherit;">Priority</a>
    ...
    <dd>{{% md %}}Specifies the priority for the virtual machine. <br><br>Minimum api-version: 2019-03-01{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#proximityplacementgroup_csharp" style="color: inherit; text-decoration: inherit;">Proximity<wbr>Placement<wbr>Group</a>
    ...
    <dd>{{% md %}}Specifies information about the proximity placement group that the virtual machine should be assigned to. <br><br>Minimum api-version: 2018-04-01.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#scheduledeventsprofile_csharp" style="color: inherit; text-decoration: inherit;">Scheduled<wbr>Events<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduledeventsprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Scheduled<wbr>Events<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies Scheduled Event related configurations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#securityprofile_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#securityprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Security<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the Security related profile settings for the virtual machine.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageprofile_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Outputs.<wbr>Storage<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the storage settings for the virtual machine disks.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#userdata_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Data</a>
    ...
    <dd>{{% md %}}UserData for the VM, which must be base-64 encoded. Customer should not pass any secrets in here. <br><br>Minimum api-version: 2021-03-01{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#virtualmachinescaleset_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine<wbr>Scale<wbr>Set</a>
    ...
    <dd>{{% md %}}Specifies information about the virtual machine scale set that the virtual machine should be assigned to. Virtual machines specified in the same virtual machine scale set are allocated to different nodes to maximize availability. Currently, a VM can only be added to virtual machine scale set at creation time. An existing VM cannot be added to a virtual machine scale set. <br><br>This property cannot exist along with a non-null properties.availabilitySet reference. <br><br>Minimum api‐version: 2019‐03‐01{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#zones_csharp" style="color: inherit; text-decoration: inherit;">Zones</a>
    ...
    <dd>{{% md %}}The virtual machine zones.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
    ...
    <dd>{{% md %}}The target of the particular error.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#details_csharp" style="color: inherit; text-decoration: inherit;">Details</a>
    ...
    <dd>{{% md %}}The Api error details{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#innererror_csharp" style="color: inherit; text-decoration: inherit;">Innererror</a>
    ...
    <dd>{{% md %}}The Api inner error{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="message_csharp">
<a href="#message_csharp" style="color: inherit; text-decoration: inherit;">Message</a>
</span>
...
<a href="#assessmentactivityid_csharp" style="color: inherit; text-decoration: inherit;">Assessment<wbr>Activity<wbr>Id</a>
    ...
    <dd>{{% md %}}The activity ID of the operation that produced this result. It is used to correlate across CRP and extension logs.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#criticalandsecuritypatchcount_csharp" style="color: inherit; text-decoration: inherit;">Critical<wbr>And<wbr>Security<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of critical or security patches that have been detected as available and not yet installed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="error_csharp">
<a href="#error_csharp" style="color: inherit; text-decoration: inherit;">Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apierrorresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Api<wbr>Error<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The errors that were encountered during execution of the operation. The details array contains the list of them.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#lastmodifiedtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>Time</a>
    ...
    <dd>{{% md %}}The UTC timestamp when the operation began.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#otherpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Other<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of all available patches excluding critical and security.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#rebootpending_csharp" style="color: inherit; text-decoration: inherit;">Reboot<wbr>Pending</a>
    ...
    <dd>{{% md %}}The overall reboot status of the VM. It will be true when partially installed patches require a reboot to complete installation but the reboot has not yet occurred.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The overall success or failure status of the operation. It remains "InProgress" until the operation completes. At that point it will become "Unknown", "Failed", "Succeeded", or "CompletedWithWarnings."{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#consolescreenshotbloburi_csharp" style="color: inherit; text-decoration: inherit;">Console<wbr>Screenshot<wbr>Blob<wbr>Uri</a>
    ...
    <dd>{{% md %}}The console screenshot blob URI. <br><br>NOTE: This will **not** be set if boot diagnostics is currently enabled with managed storage.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#serialconsolelogbloburi_csharp" style="color: inherit; text-decoration: inherit;">Serial<wbr>Console<wbr>Log<wbr>Blob<wbr>Uri</a>
    ...
    <dd>{{% md %}}The serial console log blob Uri. <br><br>NOTE: This will **not** be set if boot diagnostics is currently enabled with managed storage.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
</span>
    ...
    <dd>{{% md %}}The boot diagnostics status information for the VM. <br><br> NOTE: It will be set only if there are errors encountered in enabling boot diagnostics.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#createoption_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Option</a>
    ...
    <dd>{{% md %}}Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#diskiopsreadwrite_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>IOPSRead<wbr>Write</a>
    ...
    <dd>{{% md %}}Specifies the Read-Write IOPS for the managed disk when StorageAccountType is UltraSSD_LRS. Returned only for VirtualMachine ScaleSet VM disks. Can be updated only via updates to the VirtualMachine Scale Set.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#diskmbpsreadwrite_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>MBps<wbr>Read<wbr>Write</a>
    ...
    <dd>{{% md %}}Specifies the bandwidth in MB per second for the managed disk when StorageAccountType is UltraSSD_LRS. Returned only for VirtualMachine ScaleSet VM disks. Can be updated only via updates to the VirtualMachine Scale Set.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="lun_csharp">
...
<a href="#caching_csharp" style="color: inherit; text-decoration: inherit;">Caching</a>
    ...
    <dd>{{% md %}}Specifies the caching requirements. <br><br> Possible values are: <br><br> **None** <br><br> **ReadOnly** <br><br> **ReadWrite** <br><br> Default: **None for Standard storage. ReadOnly for Premium storage**{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#deleteoption_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Option</a>
    ...
    <dd>{{% md %}}Specifies whether data disk should be deleted or detached upon VM deletion.<br><br> Possible values: <br><br> **Delete** If this value is used, the data disk is deleted when VM is deleted.<br><br> **Detach** If this value is used, the data disk is retained after VM is deleted.<br><br> The default value is set to **detach**{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#disksizegb_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>GB</a>
    ...
    <dd>{{% md %}}Specifies the size of an empty data disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image. <br><br> This value cannot be larger than 1023 GB{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
    ...
    <dd>{{% md %}}The source user image virtual hard disk. The virtual hard disk will be copied before being attached to the virtual machine. If SourceImage is provided, the destination virtual hard drive must not exist.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tobedetached_csharp" style="color: inherit; text-decoration: inherit;">To<wbr>Be<wbr>Detached</a>
    ...
    <dd>{{% md %}}Specifies whether the data disk is in process of detachment from the VirtualMachine/VirtualMachineScaleset{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="vhd_csharp">
<a href="#vhd_csharp" style="color: inherit; text-decoration: inherit;">Vhd</a>
    ...
    <dd>{{% md %}}The virtual hard disk.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#writeacceleratorenabled_csharp" style="color: inherit; text-decoration: inherit;">Write<wbr>Accelerator<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Specifies whether writeAccelerator should be enabled or disabled on the disk.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#option_csharp" style="color: inherit; text-decoration: inherit;">Option</a>
    ...
    <dd>{{% md %}}Specifies the ephemeral disk settings for operating system disk.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#encryptionsettings_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptionsettingsresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Disk<wbr>Encryption<wbr>Settings<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the encryption settings for the OS Disk. <br><br> Minimum api-version: 2015-06-15{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#encryption_settings_python" style="color: inherit; text-decoration: inherit;">encryption_<wbr>settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptionsettingsresponse">Sequence[Disk<wbr>Encryption<wbr>Settings<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Specifies the encryption settings for the OS Disk. <br><br> Minimum api-version: 2015-06-15{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_python">
...
<a href="#exactversion_csharp" style="color: inherit; text-decoration: inherit;">Exact<wbr>Version</a>
    ...
    <dd>{{% md %}}Specifies in decimal numbers, the version of platform image or marketplace image used to create the virtual machine. This readonly field differs from 'version', only if the value specified in 'version' field is 'latest'.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#offer_csharp" style="color: inherit; text-decoration: inherit;">Offer</a>
    ...
    <dd>{{% md %}}Specifies the offer of the platform image or marketplace image used to create the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#errordetail_csharp" style="color: inherit; text-decoration: inherit;">Errordetail</a>
    ...
    <dd>{{% md %}}The internal error message or exception dump.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#exceptiontype_csharp" style="color: inherit; text-decoration: inherit;">Exceptiontype</a>
    ...
    <dd>{{% md %}}The exception type.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#excludedpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Excluded<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of all available patches but excluded explicitly by a customer-specified exclusion list match.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#failedpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Failed<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The count of patches that failed installation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#installedpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Installed<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The count of patches that successfully installed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="lastmodifiedtime_csharp">
<a href="#lastmodifiedtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>Time</a>
</span>
...
<a href="#maintenancewindowexceeded_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window<wbr>Exceeded</a>
    ...
    <dd>{{% md %}}Describes whether the operation ran out of time before it completed all its intended actions{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#notselectedpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>Selected<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of all available patches but not going to be installed because it didn't match a classification or inclusion list entry.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#pendingpatchcount_csharp" style="color: inherit; text-decoration: inherit;">Pending<wbr>Patch<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of all available patches expected to be installed over the course of the patch installation operation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starttime_csharp">
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
</span>
...
<a href="#iscustomerinitiatedmaintenanceallowed_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Customer<wbr>Initiated<wbr>Maintenance<wbr>Allowed</a>
    ...
    <dd>{{% md %}}True, if customer is allowed to perform Maintenance.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastoperationmessage_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Operation<wbr>Message</a>
    ...
    <dd>{{% md %}}Message returned for the last Maintenance Operation.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastoperationresultcode_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Operation<wbr>Result<wbr>Code</a>
    ...
    <dd>{{% md %}}The Last Maintenance Operation Result Code.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancewindowendtime_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window<wbr>End<wbr>Time</a>
    ...
    <dd>{{% md %}}End Time for the Maintenance Window.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancewindowstarttime_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window<wbr>Start<wbr>Time</a>
    ...
    <dd>{{% md %}}Start Time for the Maintenance Window.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#premaintenancewindowendtime_csharp" style="color: inherit; text-decoration: inherit;">Pre<wbr>Maintenance<wbr>Window<wbr>End<wbr>Time</a>
    ...
    <dd>{{% md %}}End Time for the Pre Maintenance Window.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#premaintenancewindowstarttime_csharp" style="color: inherit; text-decoration: inherit;">Pre<wbr>Maintenance<wbr>Window<wbr>Start<wbr>Time</a>
    ...
    <dd>{{% md %}}Start Time for the Pre Maintenance Window.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#deleteoption_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Option</a>
    ...
    <dd>{{% md %}}Specify what happens to the network interface when the VM is deleted{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#primary_csharp" style="color: inherit; text-decoration: inherit;">Primary</a>
    ...
    <dd>{{% md %}}Specifies the primary network interface in case the virtual machine has more than 1 network interface.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="networkapiversion_csharp">
<a href="#networkapiversion_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Api<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}specifies the Microsoft.Network API version used when creating networking resources in the Network Interface Configurations{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkinterfaceconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceconfigurationresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Configuration<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the networking configurations that will be used to create the virtual machine networking resources.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacereferenceresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Network<wbr>Interface<wbr>Reference<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the list of resource Ids for the network interfaces associated with the virtual machine.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="networkapiversion_go">
<a href="#networkapiversion_go" style="color: inherit; text-decoration: inherit;">Network<wbr>Api<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#networkinterfaceconfigurations_go" style="color: inherit; text-decoration: inherit;">Network<wbr>Interface<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceconfigurationresponse">[]Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the networking configurations that will be used to create the virtual machine networking resources.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="networkapiversion_nodejs">
<a href="#networkapiversion_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Api<wbr>Version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="network_api_version_python">
<a href="#network_api_version_python" style="color: inherit; text-decoration: inherit;">network_<wbr>api_<wbr>version</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#network_interface_configurations_python" style="color: inherit; text-decoration: inherit;">network_<wbr>interface_<wbr>configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceconfigurationresponse">Sequence[Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Configuration<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Specifies the networking configurations that will be used to create the virtual machine networking resources.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_interfaces_python" style="color: inherit; text-decoration: inherit;">network_<wbr>interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacereferenceresponse">Sequence[Network<wbr>Interface<wbr>Reference<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Specifies the list of resource Ids for the network interfaces associated with the virtual machine.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#createoption_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Option</a>
    ...
    <dd>{{% md %}}Specifies how the virtual machine should be created.<br><br> Possible values are:<br><br> **Attach** \u2013 This value is used when you are using a specialized disk to create the virtual machine.<br><br> **FromImage** \u2013 This value is used when you are using an image to create the virtual machine. If you are using a platform image, you also use the imageReference element described above. If you are using a marketplace image, you  also use the plan element previously described.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="caching_csharp">
<a href="#caching_csharp" style="color: inherit; text-decoration: inherit;">Caching</a>
</span>
...
<a href="#deleteoption_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Option</a>
    ...
    <dd>{{% md %}}Specifies whether OS Disk should be deleted or detached upon VM deletion. <br><br> Possible values: <br><br> **Delete** If this value is used, the OS disk is deleted when VM is deleted.<br><br> **Detach** If this value is used, the os disk is retained after VM is deleted. <br><br> The default value is set to **detach**. For an ephemeral OS Disk, the default value is set to **Delete**. User cannot change the delete option for ephemeral OS Disk.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#diffdisksettings_csharp" style="color: inherit; text-decoration: inherit;">Diff<wbr>Disk<wbr>Settings</a>
    ...
    <dd>{{% md %}}Specifies the ephemeral Disk Settings for the operating system disk used by the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="disksizegb_csharp">
<a href="#disksizegb_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>GB</a>
</span>
...
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
    ...
    <dd>{{% md %}}This property allows you to specify the type of the OS that is included in the disk if creating a VM from user-image or a specialized VHD. <br><br> Possible values are: <br><br> **Windows** <br><br> **Linux**{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="vhd_csharp">
<a href="#vhd_csharp" style="color: inherit; text-decoration: inherit;">Vhd</a>
</span>
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}Specify public IP sku tier{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#datadisks_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datadiskresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Data<wbr>Disk<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#osdisk_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#osdiskresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>OSDisk<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/managed-disks-overview).{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#enable_csharp" style="color: inherit; text-decoration: inherit;">Enable</a>
    ...
    <dd>{{% md %}}Specifies whether the Terminate Scheduled event is enabled or disabled.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#notbeforetimeout_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>Before<wbr>Timeout</a>
    ...
    <dd>{{% md %}}Configurable length of time a Virtual Machine being deleted will have to potentially approve the Terminate Scheduled Event before the event is auto approved (timed out). The configuration must be specified in ISO 8601 format, the default value is 5 minutes (PT5M){{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#extensionhandlers_csharp" style="color: inherit; text-decoration: inherit;">Extension<wbr>Handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensionhandlerinstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Handler<wbr>Instance<wbr>View<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine extension handler instance view.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="statuses_csharp">
<a href="#statuses_csharp" style="color: inherit; text-decoration: inherit;">Statuses</a>
</span>
...
<a href="#vmagentversion_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Agent<wbr>Version</a>
    ...
    <dd>{{% md %}}The VM Agent full version.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#extension_handlers_python" style="color: inherit; text-decoration: inherit;">extension_<wbr>handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensionhandlerinstanceviewresponse">Sequence[Virtual<wbr>Machine<wbr>Extension<wbr>Handler<wbr>Instance<wbr>View<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine extension handler instance view.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="statuses_python">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The extension handler status.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensioninstanceviewresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The health status information for the VM.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#principalid_csharp" style="color: inherit; text-decoration: inherit;">Principal<wbr>Id</a>
    ...
    <dd>{{% md %}}The principal id of virtual machine identity. This property will only be provided for a system assigned identity.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#tenantid_csharp" style="color: inherit; text-decoration: inherit;">Tenant<wbr>Id</a>
    ...
    <dd>{{% md %}}The tenant id associated with the virtual machine. This property will only be provided for a system assigned identity.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
    ...
    <dd>{{% md %}}The type of identity used for the virtual machine. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user assigned identities. The type 'None' will remove any identities from the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="userassignedidentities_csharp">
<a href="#userassignedidentities_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Assigned<wbr>Identities</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Identity<wbr>Response<wbr>User<wbr>Assigned<wbr>Identities&gt;</span>
    </dt>
    <dd>{{% md %}}The list of user identities associated with the Virtual Machine. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#user_assigned_identities_python" style="color: inherit; text-decoration: inherit;">user_<wbr>assigned_<wbr>identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, Virtual<wbr>Machine<wbr>Identity<wbr>Response<wbr>User<wbr>Assigned<wbr>Identities]</span>
    </dt>
    <dd>{{% md %}}The list of user identities associated with the Virtual Machine. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#assignedhost_csharp" style="color: inherit; text-decoration: inherit;">Assigned<wbr>Host</a>
    ...
    <dd>{{% md %}}Resource id of the dedicated host, on which the virtual machine is allocated through automatic placement, when the virtual machine is associated with a dedicated host group that has automatic placement enabled. <br><br>Minimum api-version: 2020-06-01.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="vmhealth_csharp">
<a href="#vmhealth_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Health</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinehealthstatusresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Health<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The health status for the VM.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="bootdiagnostics_csharp">
<a href="#bootdiagnostics_csharp" style="color: inherit; text-decoration: inherit;">Boot<wbr>Diagnostics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bootdiagnosticsinstanceviewresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Boot<wbr>Diagnostics<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="computername_csharp">
<a href="#computername_csharp" style="color: inherit; text-decoration: inherit;">Computer<wbr>Name</a>
</span>
    ...
    <dd>{{% md %}}The computer name assigned to the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="disks_csharp">
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskinstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Disk<wbr>Instance<wbr>View<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine disk information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="extensions_csharp">
<a href="#extensions_csharp" style="color: inherit; text-decoration: inherit;">Extensions</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensioninstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Instance<wbr>View<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The extensions information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#hypervgeneration_csharp" style="color: inherit; text-decoration: inherit;">Hyper<wbr>VGeneration</a>
    ...
    <dd>{{% md %}}Specifies the HyperVGeneration Type associated with a resource{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenanceredeploystatus_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Redeploy<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maintenanceredeploystatusresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Maintenance<wbr>Redeploy<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The Maintenance Operation status on the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#osname_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Name</a>
    ...
    <dd>{{% md %}}The Operating System running on the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#osversion_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Version</a>
    ...
    <dd>{{% md %}}The version of Operating System running on the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="patchstatus_csharp">
<a href="#patchstatus_csharp" style="color: inherit; text-decoration: inherit;">Patch<wbr>Status</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinepatchstatusresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Patch<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Preview Feature] The status of virtual machine patch operations.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="platformfaultdomain_csharp">
<a href="#platformfaultdomain_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Fault<wbr>Domain</a>
</span>
    ...
    <dd>{{% md %}}Specifies the fault domain of the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#platformupdatedomain_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Update<wbr>Domain</a>
    ...
    <dd>{{% md %}}Specifies the update domain of the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rdpthumbprint_csharp" style="color: inherit; text-decoration: inherit;">Rdp<wbr>Thumb<wbr>Print</a>
    ...
    <dd>{{% md %}}The Remote desktop certificate thumbprint.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="statuses_csharp">
<a href="#statuses_csharp" style="color: inherit; text-decoration: inherit;">Statuses</a>
</span>
...
<a href="#vmagent_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Agent</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineagentinstanceviewresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Agent<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The VM Agent running on the virtual machine.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#disks_python" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskinstanceviewresponse">Sequence[Disk<wbr>Instance<wbr>View<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The virtual machine disk information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#extensions_python" style="color: inherit; text-decoration: inherit;">extensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensioninstanceviewresponse">Sequence[Virtual<wbr>Machine<wbr>Extension<wbr>Instance<wbr>View<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The extensions information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="virtualmachineiptagresponse">Virtual<wbr>Machine<wbr>Ip<wbr>Tag<wbr>Response</h4>
...
<a href="#iptagtype_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Tag<wbr>Type</a>
    ...
    <dd>{{% md %}}IP tag type. Example: FirstPartyUsage.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tag_csharp">
<a href="#tag_csharp" style="color: inherit; text-decoration: inherit;">Tag</a>
    ...
    <dd>{{% md %}}IP tag associated with the public IP. Example: SQL, Storage etc.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="virtualmachinenetworkinterfaceconfigurationresponse">Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Configuration<wbr>Response</h4>
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceipconfigurationresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>IPConfiguration<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The network interface configuration name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="deleteoption_csharp">
<a href="#deleteoption_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Option</a>
</span>
...
<a href="#dnssettings_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfacednssettingsconfigurationresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</a></span>
    </dt>
...
<a href="#enableacceleratednetworking_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Accelerated<wbr>Networking</a>
    ...
    <dd>{{% md %}}Specifies whether the network interface is accelerated networking-enabled.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enablefpga_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Fpga</a>
    ...
    <dd>{{% md %}}Specifies whether the network interface is FPGA networking-enabled.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enableipforwarding_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>IPForwarding</a>
    ...
    <dd>{{% md %}}Whether IP forwarding enabled on this NIC.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipconfigurations_go" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceipconfigurationresponse">[]Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>IPConfiguration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the IP configurations of the network interface.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_go">
...
<a href="#dnssettings_go" style="color: inherit; text-decoration: inherit;">Dns<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfacednssettingsconfigurationresponse">Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The dns settings to be applied on the network interfaces.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ip_configurations_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinenetworkinterfaceipconfigurationresponse">Sequence[Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>IPConfiguration<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Specifies the IP configurations of the network interface.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_python">
...
<h4 id="virtualmachinenetworkinterfacednssettingsconfigurationresponse">Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</h4>
...
<a href="#dnsservers_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Servers</a>
    ...
    <dd>{{% md %}}List of DNS servers IP addresses{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="virtualmachinenetworkinterfaceipconfigurationresponse">Virtual<wbr>Machine<wbr>Network<wbr>Interface<wbr>IPConfiguration<wbr>Response</h4>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The IP configuration name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#applicationgatewaybackendaddresspools_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Gateway<wbr>Backend<wbr>Address<wbr>Pools</a>
    ...
    <dd>{{% md %}}Specifies an array of references to backend address pools of application gateways. A virtual machine can reference backend address pools of multiple application gateways. Multiple virtual machines cannot use the same application gateway.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#loadbalancerbackendaddresspools_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancer<wbr>Backend<wbr>Address<wbr>Pools</a>
    ...
    <dd>{{% md %}}Specifies an array of references to backend address pools of load balancers. A virtual machine can reference backend address pools of one public and one internal load balancer. [Multiple virtual machines cannot use the same basic sku load balancer].{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="primary_csharp">
<a href="#primary_csharp" style="color: inherit; text-decoration: inherit;">Primary</a>
</span>
    ...
    <dd>{{% md %}}Specifies the primary network interface in case the virtual machine has more than 1 network interface.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privateipaddressversion_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>IPAddress<wbr>Version</a>
    ...
    <dd>{{% md %}}Available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4.  Possible values are: 'IPv4' and 'IPv6'.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publicipaddressconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>IPAddress<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinepublicipaddressconfigurationresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Configuration<wbr>Response</a></span>
    </dt>
...
<a href="#publicipaddressconfiguration_go" style="color: inherit; text-decoration: inherit;">Public<wbr>IPAddress<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinepublicipaddressconfigurationresponse">Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The publicIPAddressConfiguration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="subnet_go">
...
<a href="#configurationstatuses_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Statuses</a>
    ...
    <dd>{{% md %}}The enablement status of the specified patchMode{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#availablepatchsummary_csharp" style="color: inherit; text-decoration: inherit;">Available<wbr>Patch<wbr>Summary</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#availablepatchsummaryresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Available<wbr>Patch<wbr>Summary<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The available patch summary of the latest assessment operation for the virtual machine.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastpatchinstallationsummary_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Patch<wbr>Installation<wbr>Summary</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#lastpatchinstallationsummaryresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Last<wbr>Patch<wbr>Installation<wbr>Summary<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The installation summary of the latest installation operation for the virtual machine.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="virtualmachinepublicipaddressconfigurationresponse">Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Configuration<wbr>Response</h4>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The publicIP address configuration name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="deleteoption_csharp">
<a href="#deleteoption_csharp" style="color: inherit; text-decoration: inherit;">Delete<wbr>Option</a>
</span>
    ...
    <dd>{{% md %}}Specify what happens to the public IP address when the VM is deleted{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="dnssettings_csharp">
<a href="#dnssettings_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Settings</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinepublicipaddressdnssettingsconfigurationresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</a></span>
    </dt>
...
<a href="#iptags_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineiptagresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Ip<wbr>Tag<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#publicipaddressversion_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>IPAddress<wbr>Version</a>
    ...
    <dd>{{% md %}}Available from Api-Version 2019-07-01 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6. Default is taken as IPv4. Possible values are: 'IPv4' and 'IPv6'.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publicipallocationmethod_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>IPAllocation<wbr>Method</a>
    ...
    <dd>{{% md %}}Specify the public IP allocation type{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publicipprefix_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>IPPrefix</a>
    ...
    <dd>{{% md %}}The PublicIPPrefix from which to allocate publicIP addresses.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#publicipaddressskuresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Compute.<wbr>Inputs.<wbr>Public<wbr>IPAddress<wbr>Sku<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Describes the public IP Sku{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dnssettings_go" style="color: inherit; text-decoration: inherit;">Dns<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinepublicipaddressdnssettingsconfigurationresponse">Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The dns settings to be applied on the publicIP addresses .{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#iptags_go" style="color: inherit; text-decoration: inherit;">Ip<wbr>Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineiptagresponse">[]Virtual<wbr>Machine<wbr>Ip<wbr>Tag<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The list of IP tags associated with the public IP address.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ip_tags_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineiptagresponse">Sequence[Virtual<wbr>Machine<wbr>Ip<wbr>Tag<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The list of IP tags associated with the public IP address.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="virtualmachinepublicipaddressdnssettingsconfigurationresponse">Virtual<wbr>Machine<wbr>Public<wbr>IPAddress<wbr>Dns<wbr>Settings<wbr>Configuration<wbr>Response</h4>
...
<a href="#domainnamelabel_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Name<wbr>Label</a>
    ...
    <dd>{{% md %}}The Domain name label prefix of the PublicIPAddress resources that will be created. The generated name label is the concatenation of the domain name label and vm network profile unique ID.{{% /md %}}</dd></dl>
{{% /choosable %}}
