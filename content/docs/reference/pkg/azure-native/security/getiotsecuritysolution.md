...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIotSecuritySolution<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetIotSecuritySolutionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetIotSecuritySolutionResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_iot_security_solution(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                              <span class="nx">solution_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIotSecuritySolutionResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIotSecuritySolution<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIotSecuritySolutionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIotSecuritySolutionResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIotSecuritySolution </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetIotSecuritySolutionResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetIotSecuritySolutionArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#solutionname_csharp" style="color: inherit; text-decoration: inherit;">Solution<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the IoT Security solution.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Resource display name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#iothubs_csharp" style="color: inherit; text-decoration: inherit;">Iot<wbr>Hubs</a>
    ...
    <dd>{{% md %}}IoT Hub resource IDs{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#additionalworkspaces_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Workspaces</a>
    ...
    <dd>{{% md %}}List of additional workspaces{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disableddatasources_csharp" style="color: inherit; text-decoration: inherit;">Disabled<wbr>Data<wbr>Sources</a>
    ...
    <dd>{{% md %}}Disabled data sources. Disabling these data sources compromises the system.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#export_csharp" style="color: inherit; text-decoration: inherit;">Export</a>
    ...
    <dd>{{% md %}}List of additional options for exporting to workspace data.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#recommendationsconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Recommendations<wbr>Configuration</a>
    ...
    <dd>{{% md %}}List of the configuration status for each recommendation type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Status of the IoT Security solution.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#unmaskediploggingstatus_csharp" style="color: inherit; text-decoration: inherit;">Unmasked<wbr>Ip<wbr>Logging<wbr>Status</a>
    ...
    <dd>{{% md %}}Unmasked IP address logging status{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#userdefinedresources_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Defined<wbr>Resources</a>
    ...
    <dd>{{% md %}}Properties of the IoT Security solution's user defined resources.{{% /md %}}</dd><dt class="property-"
            title="">
