...
<dl class="tabular">
    ...
    <dd>NotSpecified</dd>
    <dt>Auto<wbr>Approve</dt>
    <dd>AutoApprove</dd>
    <dt>Manual<wbr>Approve</dt>
    <dd>ManualApprove</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Jit<wbr>Approval<wbr>Mode<wbr>Not<wbr>Specified</dt>
    <dd>NotSpecified</dd>
    <dt>Jit<wbr>Approval<wbr>Mode<wbr>Auto<wbr>Approve</dt>
    <dd>AutoApprove</dd>
    <dt>Jit<wbr>Approval<wbr>Mode<wbr>Manual<wbr>Approve</dt>
    <dd>ManualApprove</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Jit<wbr>Approver<wbr>Type<wbr>User</dt>
    <dd>user</dd>
    <dt>Jit<wbr>Approver<wbr>Type<wbr>Group</dt>
    <dd>group</dd>
</dl>
{{% /choosable %}}
