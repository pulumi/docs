...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the hybrid machine.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#clientpublickey_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Public<wbr>Key</a>
    ...
    <dd>{{% md %}}Public Key that the client provides to be used during initial resource onboarding{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="identity_csharp">
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#machineresponseidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Hybrid<wbr>Compute.<wbr>Outputs.<wbr>Machine<wbr>Response<wbr>Identity</a></span>
    </dt>
...
<a href="#locationdata_csharp" style="color: inherit; text-decoration: inherit;">Location<wbr>Data</a>
    ...
    <dd>{{% md %}}Metadata pertaining to the geographic location of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#osprofile_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Profile</a>
    ...
    <dd>{{% md %}}Specifies the operating system settings for the hybrid machine.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
