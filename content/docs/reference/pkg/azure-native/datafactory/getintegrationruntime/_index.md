...
<a href="#referencename_csharp" style="color: inherit; text-decoration: inherit;">Reference<wbr>Name</a>
    ...
    <dd>{{% md %}}Reference credential name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
    ...
    <dd>{{% md %}}Credential reference type.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#credential_csharp" style="color: inherit; text-decoration: inherit;">Credential</a>
    ...
    <dd>{{% md %}}The credential reference containing authentication information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
