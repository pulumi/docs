...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_managed_cluster(</span><span class="nx">cluster_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#adminusername_csharp" style="color: inherit; text-decoration: inherit;">Admin<wbr>User<wbr>Name</a>
    ...
    <dd>{{% md %}}vm admin user name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clustercertificatethumbprint_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Certificate<wbr>Thumbprint</a>
    ...
    <dd>{{% md %}}The cluster certificate thumbprint used node to node communication.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clusterstate_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>State</a>
    ...
    <dd>{{% md %}}The current state of the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dnsname_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Name</a>
    ...
    <dd>{{% md %}}The cluster dns name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd>{{% md %}}the cluster Fully qualified domain name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the managed cluster resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#addonfeatures_csharp" style="color: inherit; text-decoration: inherit;">Addon<wbr>Features</a>
    ...
    <dd>{{% md %}}client certificates for the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#adminpassword_csharp" style="color: inherit; text-decoration: inherit;">Admin<wbr>Password</a>
    ...
    <dd>{{% md %}}vm admin user password.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#azureactivedirectory_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Active<wbr>Directory</a>
    ...
    <dd>{{% md %}}Azure active directory.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clientconnectionport_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Connection<wbr>Port</a>
    ...
    <dd>{{% md %}}The port used for client connections to the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpgatewayconnectionport_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Gateway<wbr>Connection<wbr>Port</a>
    ...
    <dd>{{% md %}}The port used for http connections to the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loadbalancingrules_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancing<wbr>Rules</a>
    ...
    <dd>{{% md %}}Describes load balancing rules.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}The sku of the managed cluster{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
