...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getReplicationvCenter<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetReplicationvCenterArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetReplicationvCenterResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_replicationv_center(</span><span class="nx">fabric_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            ...
                            <span class="nx">v_center_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetReplicationvCenterResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupReplicationvCenter<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupReplicationvCenterArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupReplicationvCenterResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetReplicationvCenter </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetReplicationvCenterResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetReplicationvCenterArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
    ...
    <dd>{{% md %}}VCenter related data.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#discoverystatus_csharp" style="color: inherit; text-decoration: inherit;">Discovery<wbr>Status</a>
    ...
    <dd>{{% md %}}The VCenter discovery status.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fabricarmresourcename_csharp" style="color: inherit; text-decoration: inherit;">Fabric<wbr>Arm<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The ARM resource name of the fabric containing this VCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}Friendly name of the vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#infrastructureid_csharp" style="color: inherit; text-decoration: inherit;">Infrastructure<wbr>Id</a>
    ...
    <dd>{{% md %}}The infrastructure Id of vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#internalid_csharp" style="color: inherit; text-decoration: inherit;">Internal<wbr>Id</a>
    ...
    <dd>{{% md %}}VCenter internal ID.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipaddress_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}The IP address of the vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastheartbeat_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Heartbeat</a>
    ...
    <dd>{{% md %}}The time when the last heartbeat was received by vCenter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="port_csharp">
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The port number for discovery.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#runasaccountid_csharp" style="color: inherit; text-decoration: inherit;">Run<wbr>As<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The account Id which has privileges to discover the vCenter.{{% /md %}}</dd></dl>
{{% /choosable %}}
