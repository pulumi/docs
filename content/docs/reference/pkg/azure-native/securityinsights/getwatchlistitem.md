...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getWatchlistItem<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWatchlistItemArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetWatchlistItemResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_watchlist_item(</span><span class="nx">operational_insights_resource_provider</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">watchlist_alias</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">watchlist_item_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">workspace_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetWatchlistItemResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupWatchlistItem<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupWatchlistItemArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupWatchlistItemResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWatchlistItem </span><span class="p">{</span><span class="k">
...
<a href="#watchlistitemid_csharp" style="color: inherit; text-decoration: inherit;">Watchlist<wbr>Item<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Watchlist Item Id (GUID){{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#watchlistitemid_go" style="color: inherit; text-decoration: inherit;">Watchlist<wbr>Item<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#itemskeyvalue_csharp" style="color: inherit; text-decoration: inherit;">Items<wbr>Key<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">object</span>
    </dt>
    <dd>{{% md %}}key-value pairs for a watchlist item{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#created_csharp" style="color: inherit; text-decoration: inherit;">Created</a>
    ...
    <dd>{{% md %}}The time the watchlist item was created{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#entitymapping_csharp" style="color: inherit; text-decoration: inherit;">Entity<wbr>Mapping</a>
    ...
    <dd>{{% md %}}key-value pairs for a watchlist item entity mapping{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#isdeleted_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Deleted</a>
    ...
    <dd>{{% md %}}A flag that indicates if the watchlist item is deleted or not{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#tenantid_csharp" style="color: inherit; text-decoration: inherit;">Tenant<wbr>Id</a>
    ...
    <dd>{{% md %}}The tenantId to which the watchlist item belongs to{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#updated_csharp" style="color: inherit; text-decoration: inherit;">Updated</a>
    ...
    <dd>{{% md %}}The last time the watchlist item was updated{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#watchlistitemid_csharp" style="color: inherit; text-decoration: inherit;">Watchlist<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}The id (a Guid) of the watchlist item{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#itemskeyvalue_go" style="color: inherit; text-decoration: inherit;">Items<wbr>Key<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#itemskeyvalue_nodejs" style="color: inherit; text-decoration: inherit;">items<wbr>Key<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#items_key_value_python" style="color: inherit; text-decoration: inherit;">items_<wbr>key_<wbr>value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Any</span>
    </dt>
...
<a href="#entity_mapping_python" style="color: inherit; text-decoration: inherit;">entity_<wbr>mapping</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Any</span>
    </dt>
