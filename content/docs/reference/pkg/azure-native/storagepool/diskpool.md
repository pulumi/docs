...
<a href="#additionalcapabilities_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Capabilities</a>
    ...
    <dd>{{% md %}}List of additional capabilities for a Disk pool.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Disk<wbr>Pool<wbr>Tier<wbr>Basic</dt>
    <dd>Basic</dd>
    <dt>Disk<wbr>Pool<wbr>Tier<wbr>Standard</dt>
    <dd>Standard</dd>
    <dt>Disk<wbr>Pool<wbr>Tier<wbr>Premium</dt>
    <dd>Premium</dd>
</dl>
{{% /choosable %}}
