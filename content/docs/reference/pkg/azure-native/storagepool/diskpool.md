...
## Create a DiskPool Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">DiskPool</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">additional_capabilities</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">, </span><span class="nx">availability_zones</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">, </span><span class="nx">disk_pool_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">disks</span><span class="p">:</span> <span class="nx">Optional[Sequence[DiskArgs]]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">subnet_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">tier</span><span class="p">:</span> <span class="nx">Optional[Union[str, DiskPoolTier]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#availabilityzones_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zones</a>
    ...
    <dd>{{% md %}}Logical zone for Disk pool resource; example: ["1"].{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
    ...
    <dd>{{% md %}}Azure Resource ID of a Subnet for the Disk pool.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="tier_csharp">
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#diskpooltier">Pulumi.<wbr>Azure<wbr>Native.<wbr>Storage<wbr>Pool.<wbr>Disk<wbr>Pool<wbr>Tier</a></span>
    </dt>
    <dd>{{% md %}}Determines the SKU of VM deployed for Disk pool{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#additionalcapabilities_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Capabilities</a>
    ...
    <dd>{{% md %}}List of additional capabilities for a Disk pool.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#diskpoolname_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Pool<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Disk pool.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="disks_csharp">
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#disk">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Storage<wbr>Pool.<wbr>Inputs.<wbr>Disk<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#tier_go" style="color: inherit; text-decoration: inherit;">Tier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#diskpooltier">Disk<wbr>Pool<wbr>Tier</a></span>
    </dt>
    <dd>{{% md %}}Determines the SKU of VM deployed for Disk pool{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tier_python" style="color: inherit; text-decoration: inherit;">tier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#diskpooltier">Disk<wbr>Pool<wbr>Tier</a></span>
    </dt>
    <dd>{{% md %}}Determines the SKU of VM deployed for Disk pool{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Operational status of the Disk pool.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
    ...
    <dd>{{% md %}}Resource metadata required by ARM RPC{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Unique Azure Resource ID of the Managed Disk.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="diskpooltier">Disk<wbr>Pool<wbr>Tier</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Disk<wbr>Pool<wbr>Tier<wbr>Basic</dt>
    <dd>Basic</dd><dt>Disk<wbr>Pool<wbr>Tier<wbr>Standard</dt>
    <dd>Standard</dd><dt>Disk<wbr>Pool<wbr>Tier<wbr>Premium</dt>
    <dd>Premium</dd></dl>
{{% /choosable %}}
...
<a href="#createdby_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By</a>
    ...
    <dd>{{% md %}}A string identifier for the identity that created the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#createdbytype_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of identity that created the resource: user, application, managedIdentity.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastmodifiedby_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>By</a>
    ...
    <dd>{{% md %}}A string identifier for the identity that last modified the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
