...
<span class="k">def </span><span class="nx">ClusterPrincipalAssignment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">role</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, ClusterPrincipalRole]]]</span> = None<span class="p">,</span>
...
<a href="#role_nodejs" style="color: inherit; text-decoration: inherit;">role</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#clusterprincipalrole">pulumi.<wbr>Input<Cluster<wbr>Principal<wbr>Role></a></span>
    </dt>
    <dd>{{% md %}}Cluster principal role.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#role_python" style="color: inherit; text-decoration: inherit;">role</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#clusterprincipalrole">Input[Cluster<wbr>Principal<wbr>Role]</a></span>
    </dt>
    <dd>{{% md %}}Cluster principal role.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
