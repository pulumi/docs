...
<span class="k">def </span><span class="nx">WorkspaceConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                        ...
                        <span class="nx">value_format</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, ValueFormat]]]</span> = None<span class="p">,</span>
...
<a href="#valueformat_nodejs" style="color: inherit; text-decoration: inherit;">value<wbr>Format</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#valueformat">pulumi.<wbr>Input<Value<wbr>Format></a></span>
    </dt>
    <dd>{{% md %}}format for the workspace connection value{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#value_format_python" style="color: inherit; text-decoration: inherit;">value_<wbr>format</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#valueformat">Input[Value<wbr>Format]</a></span>
    </dt>
    <dd>{{% md %}}format for the workspace connection value{{% /md %}}</dd></dl>
{{% /choosable %}}
