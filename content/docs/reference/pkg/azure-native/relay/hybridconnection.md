...
<span class="k">def </span><span class="nx">HybridConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">hybrid_connection_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">namespace_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">requires_client_authorization</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewHybridConnection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">HybridConnectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">HybridConnection</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#hybridconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Hybrid<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The hybrid connection name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requiresclientauthorization_csharp" style="color: inherit; text-decoration: inherit;">Requires<wbr>Client<wbr>Authorization</a>
    ...
    <dd>{{% md %}}Returns true if client authorization is needed for this hybrid connection; otherwise, false.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#usermetadata_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Metadata</a>
    ...
    <dd>{{% md %}}The usermetadata is a placeholder to store user-defined string data for the hybrid connection endpoint. For example, it can be used to store descriptive data, such as a list of teams and their contact information. Also, user-defined configuration settings can be stored.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>{{% md %}}The time the hybrid connection was created.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#listenercount_csharp" style="color: inherit; text-decoration: inherit;">Listener<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of listeners for this hybrid connection. Note that min : 1 and max:25 are supported.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
