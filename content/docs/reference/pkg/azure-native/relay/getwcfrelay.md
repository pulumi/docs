...
---
title: "getWCFRelay"
title_tag: "azure-native.relay.getWCFRelay"
meta_desc: "Documentation for the azure-native.relay.getWCFRelay function with examples, input properties, output properties, and supporting types."
---
...
## Using getWCFRelay {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getWCFRelay<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWCFRelayArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetWCFRelayResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_wcf_relay(</span><span class="nx">namespace_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">relay_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetWCFRelayResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupWCFRelay<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupWCFRelayArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupWCFRelayResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWCFRelay </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetWCFRelayResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetWCFRelayArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#relayname_csharp" style="color: inherit; text-decoration: inherit;">Relay<wbr>Name</a>
    ...
    <dd>{{% md %}}The relay name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#relaytype_csharp" style="color: inherit; text-decoration: inherit;">Relay<wbr>Type</a>
    ...
    <dd>{{% md %}}WCF relay type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#requiresclientauthorization_csharp" style="color: inherit; text-decoration: inherit;">Requires<wbr>Client<wbr>Authorization</a>
    ...
    <dd>{{% md %}}Returns true if client authorization is needed for this relay; otherwise, false.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#requirestransportsecurity_csharp" style="color: inherit; text-decoration: inherit;">Requires<wbr>Transport<wbr>Security</a>
    ...
    <dd>{{% md %}}Returns true if transport security is needed for this relay; otherwise, false.{{% /md %}}</dd><dt class="property-"
            title="">
