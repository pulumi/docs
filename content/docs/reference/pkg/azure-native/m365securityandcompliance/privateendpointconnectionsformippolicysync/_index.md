...
class MyStack : Stack
{
    public MyStack()
    {
        var privateEndpointConnectionsForMIPPolicySync = new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsForMIPPolicySync("privateEndpointConnectionsForMIPPolicySync", new AzureNative.M365SecurityAndCompliance.PrivateEndpointConnectionsForMIPPolicySyncArgs
        {
