...
<a href="#appid_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Id</a>
    ...
    <dd>{{% md %}}The App ID of the app used for login.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#configfilepath_csharp" style="color: inherit; text-decoration: inherit;">Config<wbr>File<wbr>Path</a>
    ...
    <dd>{{% md %}}The path of the config file containing auth settings if they come from a file.
...
The setting in this value can control the behavior of certain features in the Authentication / Authorization module.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}<code>false</code> if the Azure Active Directory provider should not be enabled despite the set registration; otherwise, <code>true</code>.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
a user logs in. Each parameter must be in the form "key=value".{{% /md %}}</dd></dl>
{{% /choosable %}}
...
More information on OpenID Connect Discovery: http://openid.net/specs/openid-connect-discovery-1_0.html{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#allowedaudiences_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Audiences</a>
    ...
    <dd>{{% md %}}The list of audiences that can make successful authentication/authorization requests.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sasurlsettingname_csharp" style="color: inherit; text-decoration: inherit;">Sas<wbr>Url<wbr>Setting<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the app setting containing the SAS URL of the blob storage containing the tokens.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#timetoexpiration_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>To<wbr>Expiration</a>
    ...
    <dd>{{% md %}}The time after the request is made when the session cookie should expire.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}<code>false</code> if the Facebook provider should not be enabled despite the set registration; otherwise, <code>true</code>.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#customhostheadername_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Host<wbr>Header<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the header containing the host of the request.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requireauthentication_csharp" style="color: inherit; text-decoration: inherit;">Require<wbr>Authentication</a>
    ...
    <dd>{{% md %}}<code>true</code> if the authentication flow is required any request is made; otherwise, <code>false</code>.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requirehttps_csharp" style="color: inherit; text-decoration: inherit;">Require<wbr>Https</a>
    ...
    <dd>{{% md %}}<code>false</code> if the authentication/authorization responses not having the HTTPS scheme are permissible; otherwise, <code>true</code>.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedclientapplications_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Client<wbr>Applications</a>
    ...
    <dd>{{% md %}}The list of the allowed client applications.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#preserveurlfragmentsforlogins_csharp" style="color: inherit; text-decoration: inherit;">Preserve<wbr>Url<wbr>Fragments<wbr>For<wbr>Logins</a>
    ...
    <dd>{{% md %}}<code>true</code> if the fragments from the request are preserved after the login request is made; otherwise, <code>false</code>.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="routes_csharp">
<a href="#routes_csharp" style="color: inherit; text-decoration: inherit;">Routes</a>
</span>
...
<a href="#logoutendpoint_csharp" style="color: inherit; text-decoration: inherit;">Logout<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}The endpoint at which a logout request should be made.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#scopes_csharp" style="color: inherit; text-decoration: inherit;">Scopes</a>
    ...
    <dd>{{% md %}}A list of the scopes that should be requested while authenticating.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nonceexpirationinterval_csharp" style="color: inherit; text-decoration: inherit;">Nonce<wbr>Expiration<wbr>Interval</a>
    ...
    <dd>{{% md %}}The time after the request is made when the nonce should expire.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#validatenonce_csharp" style="color: inherit; text-decoration: inherit;">Validate<wbr>Nonce</a>
    ...
    <dd>{{% md %}}<code>false</code> if the nonce should not be validated while completing the login flow; otherwise, <code>true</code>.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#authorizationendpoint_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}The endpoint to be used to make an authorization request.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#certificationuri_csharp" style="color: inherit; text-decoration: inherit;">Certification<wbr>Uri</a>
    ...
    <dd>{{% md %}}The endpoint that provides the keys necessary to validate the token.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tokenendpoint_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}The endpoint to be used to request a token.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#wellknownopenidconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Well<wbr>Known<wbr>Open<wbr>Id<wbr>Configuration</a>
    ...
    <dd>{{% md %}}The endpoint that contains all the configuration endpoints for the provider.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#nameclaimtype_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Claim<wbr>Type</a>
    ...
    <dd>{{% md %}}The name of the claim that contains the users name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="scopes_csharp">
<a href="#scopes_csharp" style="color: inherit; text-decoration: inherit;">Scopes</a>
</span>
...
call the token refresh API. The default is 72 hours.{{% /md %}}</dd></dl>
{{% /choosable %}}
