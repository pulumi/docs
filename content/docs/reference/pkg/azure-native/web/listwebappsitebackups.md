...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listWebAppSiteBackups<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">ListWebAppSiteBackupsArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">ListWebAppSiteBackupsResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>ListWebAppSiteBackups<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">ListWebAppSiteBackupsArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">ListWebAppSiteBackupsResult</a></span>, error)</span></code></pre></div>
...
<a href="#backupid_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Id</a>
    ...
    <dd>{{% md %}}Id of the backup.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#blobname_csharp" style="color: inherit; text-decoration: inherit;">Blob<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the blob which contains data for this backup.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#correlationid_csharp" style="color: inherit; text-decoration: inherit;">Correlation<wbr>Id</a>
    ...
    <dd>{{% md %}}Unique correlation identifier. Please use this along with the timestamp while communicating with Azure support.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#created_csharp" style="color: inherit; text-decoration: inherit;">Created</a>
    ...
    <dd>{{% md %}}Timestamp of the backup creation.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="databases_csharp">
<a href="#databases_csharp" style="color: inherit; text-decoration: inherit;">Databases</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#databasebackupsettingresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Database<wbr>Backup<wbr>Setting<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of databases included in the backup.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#finishedtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Finished<wbr>Time<wbr>Stamp</a>
    ...
    <dd>{{% md %}}Timestamp when this backup finished.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
...
<a href="#lastrestoretimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Restore<wbr>Time<wbr>Stamp</a>
    ...
    <dd>{{% md %}}Timestamp of a last restore operation which used this backup.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="log_csharp">
<a href="#log_csharp" style="color: inherit; text-decoration: inherit;">Log</a>
    ...
    <dd>{{% md %}}Details regarding this backup. Might contain an error message.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#scheduled_csharp" style="color: inherit; text-decoration: inherit;">Scheduled</a>
    ...
    <dd>{{% md %}}True if this backup has been created due to a schedule being triggered.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sizeinbytes_csharp" style="color: inherit; text-decoration: inherit;">Size<wbr>In<wbr>Bytes</a>
    ...
    <dd>{{% md %}}Size of the backup in bytes.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Backup status.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#storageaccounturl_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Url</a>
    ...
    <dd>{{% md %}}SAS URL for the storage account container which contains this backup.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#websitesizeinbytes_csharp" style="color: inherit; text-decoration: inherit;">Website<wbr>Size<wbr>In<wbr>Bytes</a>
    ...
    <dd>{{% md %}}Size of the original web app which has been backed up.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
