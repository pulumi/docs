...
---
title: "WebApp"
title_tag: "azure-native.web.WebApp"
meta_desc: "Documentation for the azure-native.web.WebApp resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Unique name of the app to create or update. To create or update a deployment slot, use the {slot} parameter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
