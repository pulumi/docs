...
title_tag: "azure-native.web.ManagedHostingEnvironment"
meta_desc: "Documentation for the azure-native.web.ManagedHostingEnvironment resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
```sh
$ pulumi import azure-native:web:ManagedHostingEnvironment myresource1 /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/managedHostingEnvironments/{name} 
```
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">ManagedHostingEnvironment</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ManagedHostingEnvironmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewManagedHostingEnvironment</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ManagedHostingEnvironmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ManagedHostingEnvironment</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">ManagedHostingEnvironment</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="#inputs">ManagedHostingEnvironmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>
      The unique name of the resource.
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">ManagedHostingEnvironmentArgs</a></span>
    </dt>
    <dd>
...
The ManagedHostingEnvironment resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostingenvironmentstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Hosting<wbr>Environment<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}Current status of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedmultisizes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Multi<wbr>Sizes</a>
    ...
    <dd>{{% md %}}List of comma separated strings describing which VM sizes are allowed for front-ends{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedworkersizes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Worker<wbr>Sizes</a>
    ...
    <dd>{{% md %}}List of comma separated strings describing which VM sizes are allowed for workers{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#apimanagementaccountid_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Management<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}Api Management Account associated with this Hosting Environment{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clustersettings_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Settings</a>
    ...
    <dd>{{% md %}}Custom settings for changing the behavior of the hosting environment{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#databaseedition_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Edition</a>
    ...
    <dd>{{% md %}}Edition of the metadata database for the hostingEnvironment (App Service Environment) e.g. "Standard"{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#databaseserviceobjective_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Service<wbr>Objective</a>
    ...
    <dd>{{% md %}}Service objective of the metadata database for the hostingEnvironment (App Service Environment) e.g. "S0"{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnssuffix_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Suffix</a>
    ...
    <dd>{{% md %}}DNS suffix of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#environmentcapacities_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Capacities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#stampcapacity">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Stamp<wbr>Capacity<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Current total, used, and available worker capacities{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#environmentishealthy_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Is<wbr>Healthy</a>
    ...
    <dd>{{% md %}}True/false indicating whether the hostingEnvironment (App Service Environment) is healthy{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#environmentstatus_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Status</a>
    ...
    <dd>{{% md %}}Detailed message about with results of the last check of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
...
<a href="#internalloadbalancingmode_csharp" style="color: inherit; text-decoration: inherit;">Internal<wbr>Load<wbr>Balancing<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#internalloadbalancingmode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Internal<wbr>Load<wbr>Balancing<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}Specifies which endpoints to serve internally in the hostingEnvironment's (App Service Environment) VNET{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipssladdresscount_csharp" style="color: inherit; text-decoration: inherit;">Ipssl<wbr>Address<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of IP SSL addresses reserved for this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#lastaction_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Action</a>
    ...
    <dd>{{% md %}}Last deployment action on this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastactionresult_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Action<wbr>Result</a>
    ...
    <dd>{{% md %}}Result of the last deployment action on this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maximumnumberofmachines_csharp" style="color: inherit; text-decoration: inherit;">Maximum<wbr>Number<wbr>Of<wbr>Machines</a>
    ...
    <dd>{{% md %}}Maximum number of VMs in this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#multirolecount_csharp" style="color: inherit; text-decoration: inherit;">Multi<wbr>Role<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of front-end instances{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkaccesscontrollist_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Access<wbr>Control<wbr>List</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkaccesscontrolentry">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Network<wbr>Access<wbr>Control<wbr>Entry<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Access control list for controlling traffic to the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="provisioningstate_csharp">
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#provisioningstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Provisioning<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}Provisioning state of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcegroup_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group</a>
    ...
    <dd>{{% md %}}Resource group of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subscriptionid_csharp" style="color: inherit; text-decoration: inherit;">Subscription<wbr>Id</a>
    ...
    <dd>{{% md %}}Subscription of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#suspended_csharp" style="color: inherit; text-decoration: inherit;">Suspended</a>
    ...
    <dd>{{% md %}}True/false indicating whether the hostingEnvironment is suspended. The environment can be suspended e.g. when the management endpoint is no longer available
            (most likely because NSG blocked the incoming traffic){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#upgradedomains_csharp" style="color: inherit; text-decoration: inherit;">Upgrade<wbr>Domains</a>
    ...
    <dd>{{% md %}}Number of upgrade domains of this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="vipmappings_csharp">
<a href="#vipmappings_csharp" style="color: inherit; text-decoration: inherit;">Vip<wbr>Mappings</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualipmapping">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Virtual<wbr>IPMapping<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Description of IP SSL mapping for this hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#virtualnetwork_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network</a>
    ...
    <dd>{{% md %}}Description of the hostingEnvironment's (App Service Environment) virtual network{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vnetname_csharp" style="color: inherit; text-decoration: inherit;">Vnet<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the hostingEnvironment's (App Service Environment) virtual network{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vnetresourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Vnet<wbr>Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Resource group of the hostingEnvironment's (App Service Environment) virtual network{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vnetsubnetname_csharp" style="color: inherit; text-decoration: inherit;">Vnet<wbr>Subnet<wbr>Name</a>
    ...
    <dd>{{% md %}}Subnet of the hostingEnvironment's (App Service Environment) virtual network{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="workerpools_csharp">
<a href="#workerpools_csharp" style="color: inherit; text-decoration: inherit;">Worker<wbr>Pools</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workerpool">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Worker<wbr>Pool<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Description of worker pools with worker size ids, VM sizes, and number of workers in each pool{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#status_go" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostingenvironmentstatus">Hosting<wbr>Environment<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}Current status of the hostingEnvironment (App Service Environment){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#internalloadbalancingmode_go" style="color: inherit; text-decoration: inherit;">Internal<wbr>Load<wbr>Balancing<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#internalloadbalancingmode">Internal<wbr>Load<wbr>Balancing<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}Specifies which endpoints to serve internally in the hostingEnvironment's (App Service Environment) VNET{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% choosable language go %}}
<dl class="tabular"><dt>Access<wbr>Control<wbr>Entry<wbr>Action<wbr>Permit</dt>
    <dd>Permit</dd><dt>Access<wbr>Control<wbr>Entry<wbr>Action<wbr>Deny</dt>
    <dd>Deny</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Shared</dt>
    <dd>Shared</dd><dt>Dedicated</dt>
    <dd>Dedicated</dd><dt>Dynamic</dt>
    <dd>Dynamic</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Compute<wbr>Mode<wbr>Options<wbr>Shared</dt>
    <dd>Shared</dd><dt>Compute<wbr>Mode<wbr>Options<wbr>Dedicated</dt>
    <dd>Dedicated</dd><dt>Compute<wbr>Mode<wbr>Options<wbr>Dynamic</dt>
    <dd>Dynamic</dd></dl>
{{% /choosable %}}
...
<h4 id="hostingenvironmentstatus">Hosting<wbr>Environment<wbr>Status</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Preparing</dt>
    <dd>Preparing</dd><dt>Ready</dt>
    <dd>Ready</dd><dt>Scaling</dt>
    <dd>Scaling</dd><dt>Deleting</dt>
    <dd>Deleting</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Hosting<wbr>Environment<wbr>Status<wbr>Preparing</dt>
    <dd>Preparing</dd><dt>Hosting<wbr>Environment<wbr>Status<wbr>Ready</dt>
    <dd>Ready</dd><dt>Hosting<wbr>Environment<wbr>Status<wbr>Scaling</dt>
    <dd>Scaling</dd><dt>Hosting<wbr>Environment<wbr>Status<wbr>Deleting</dt>
    <dd>Deleting</dd></dl>
{{% /choosable %}}
...
<h4 id="internalloadbalancingmode">Internal<wbr>Load<wbr>Balancing<wbr>Mode</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Internal<wbr>Load<wbr>Balancing<wbr>Mode<wbr>None</dt>
    <dd>None</dd><dt>Internal<wbr>Load<wbr>Balancing<wbr>Mode<wbr>Web</dt>
    <dd>Web</dd><dt>Internal<wbr>Load<wbr>Balancing<wbr>Mode<wbr>Publishing</dt>
    <dd>Publishing</dd></dl>
{{% /choosable %}}
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accesscontrolentryaction">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Access<wbr>Control<wbr>Entry<wbr>Action</a></span>
    </dt>
...
<dl class="tabular"><dt>Succeeded</dt>
    ...
    <dd>Canceled</dd><dt>In<wbr>Progress</dt>
    <dd>InProgress</dd><dt>Deleting</dt>
    <dd>Deleting</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Provisioning<wbr>State<wbr>Succeeded</dt>
    ...
    <dd>Canceled</dd><dt>Provisioning<wbr>State<wbr>In<wbr>Progress</dt>
    <dd>InProgress</dd><dt>Provisioning<wbr>State<wbr>Deleting</dt>
    <dd>Deleting</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>SUCCEEDED</dt>
    <dd>Succeeded</dd><dt>FAILED</dt>
    <dd>Failed</dd><dt>CANCELED</dt>
    <dd>Canceled</dd><dt>IN_PROGRESS</dt>
    <dd>InProgress</dd><dt>DELETING</dt>
    <dd>Deleting</dd></dl>
{{% /choosable %}}
...
<a href="#computemode_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#computemodeoptions">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Compute<wbr>Mode<wbr>Options</a></span>
    </dt>
...
<a href="#workersize_csharp" style="color: inherit; text-decoration: inherit;">Worker<wbr>Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workersizeoptions">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Worker<wbr>Size<wbr>Options</a></span>
    </dt>
...
<a href="#workersize_go" style="color: inherit; text-decoration: inherit;">Worker<wbr>Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workersizeoptions">Worker<wbr>Size<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}Size of the machines{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#skudescription">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Sku<wbr>Description<wbr>Args</a></span>
    </dt>
...
<h4 id="workersizeoptions">Worker<wbr>Size<wbr>Options</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Default</dt>
    <dd>Default</dd><dt>Small</dt>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Worker<wbr>Size<wbr>Options<wbr>Default</dt>
    <dd>Default</dd><dt>Worker<wbr>Size<wbr>Options<wbr>Small</dt>
    <dd>Small</dd><dt>Worker<wbr>Size<wbr>Options<wbr>Medium</dt>
    <dd>Medium</dd><dt>Worker<wbr>Size<wbr>Options<wbr>Large</dt>
    <dd>Large</dd></dl>
{{% /choosable %}}
