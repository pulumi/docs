...
<span class="k">def </span><span class="nx">WebAppSiteExtension</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
...
<span class="k">def </span><span class="nx">WebAppSiteExtension</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                        <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">WebAppSiteExtensionArgs</a></span><span class="p">,</span>
...
<a href="#siteextensionid_csharp" style="color: inherit; text-decoration: inherit;">Site<wbr>Extension<wbr>Id</a>
    ...
    <dd>{{% md %}}Site extension name.{{% /md %}}</dd></dl>
{{% /choosable %}}
