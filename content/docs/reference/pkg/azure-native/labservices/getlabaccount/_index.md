...
---
title: "getLabAccount"
title_tag: "azure-native.labservices.getLabAccount"
meta_desc: "Documentation for the azure-native.labservices.getLabAccount function with examples, input properties, output properties, and supporting types."
---
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($expand=sizeConfiguration)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#enabledregionselection_csharp" style="color: inherit; text-decoration: inherit;">Enabled<wbr>Region<wbr>Selection</a>
    ...
    <dd>{{% md %}}Represents if region selection is enabled{{% /md %}}</dd><dt class="property-"
            title="">
