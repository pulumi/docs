...
class MyStack : Stack
{
    public MyStack()
    {
        var domain = new AzureNative.EventGrid.Domain("domain", new AzureNative.EventGrid.DomainArgs
        {
...
<a href="#inboundiprules_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Ip<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inboundiprule">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Event<wbr>Grid.<wbr>Inputs.<wbr>Inbound<wbr>Ip<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#inputschema_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Schema</a>
    ...
    <dd>{{% md %}}This determines the format that Event Grid should expect for incoming events published to the domain.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inputschemamapping_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Schema<wbr>Mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jsoninputschemamapping">Pulumi.<wbr>Azure<wbr>Native.<wbr>Event<wbr>Grid.<wbr>Inputs.<wbr>Json<wbr>Input<wbr>Schema<wbr>Mapping<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Information about the InputSchemaMapping which specified the info about mapping event payload.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.DomainProperties.InboundIpRules" />{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
