...
class MyStack : Stack
{
    public MyStack()
    {
        var partnerTopicEventSubscription = new AzureNative.EventGrid.PartnerTopicEventSubscription("partnerTopicEventSubscription", new AzureNative.EventGrid.PartnerTopicEventSubscriptionArgs
        {
            Destination = 
            {
