...
title_tag: "azure-native.eventgrid.getDomainTopic"
meta_desc: "Documentation for the azure-native.eventgrid.getDomainTopic function with examples, input properties, output properties, and supporting types."
---
...
<a href="#domaintopicname_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Topic<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the topic.{{% /md %}}</dd><dt class="property-required"
            title="Required">
