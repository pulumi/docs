...
<span class="k">def </span><span class="nx">DiagnosticSetting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">logs</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[LogSettingsArgs]]]]</span> = None<span class="p">,</span>
                      <span class="nx">metrics</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[MetricSettingsArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#loganalyticsdestinationtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Analytics<wbr>Destination<wbr>Type</a>
    ...
    <dd>{{% md %}}A string indicating whether the export to Log Analytics should use the default destination type, i.e. AzureDiagnostics, or use a destination type constructed as follows: <normalized service identity>_<normalized category name>. Possible values are: Dedicated and null (null is default.){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="logs_csharp">
<a href="#logs_csharp" style="color: inherit; text-decoration: inherit;">Logs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#logsettings">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Inputs.<wbr>Log<wbr>Settings<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#metrics_csharp" style="color: inherit; text-decoration: inherit;">Metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricsettings">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Inputs.<wbr>Metric<wbr>Settings<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#logs_nodejs" style="color: inherit; text-decoration: inherit;">logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#logsettings">pulumi.<wbr>Input<pulumi.<wbr>Input<Log<wbr>Settings<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The list of logs settings.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metrics_nodejs" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricsettings">pulumi.<wbr>Input<pulumi.<wbr>Input<Metric<wbr>Settings<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The list of metric settings.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_nodejs">
...
<a href="#logs_python" style="color: inherit; text-decoration: inherit;">logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#logsettings">Input[Log<wbr>Settings<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The list of logs settings.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metrics_python" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricsettings">Input[Metric<wbr>Settings<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The list of metric settings.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_python">
