...
class MyStack : Stack
{
    public MyStack()
    {
        var workbook = new AzureNative.Insights.Workbook("workbook", new AzureNative.Insights.WorkbookArgs
        {
            ...
            Identity = new AzureNative.Insights.Inputs.ManagedIdentityArgs
            {
                Type = "UserAssigned",
            },
            Kind = "shared",
...
workbook = azure_native.insights.Workbook("workbook",
    ...
    etag="\"4a00f78d-0000-0700-0000-5f8f616c1000\"",
    id="/subscriptions/00000000-0000-0000-0000-00000000/resourcegroups/MyGroup/providers/Microsoft.Insights/workbooks/e378d137-1243-4256-b5c4-ad2a937cae79",
    identity=azure_native.insights.ManagedIdentityArgs(
        type="UserAssigned",
    ),
    kind="shared",
    location="westus",
...
<a href="#userassignedidentities_nodejs" style="color: inherit; text-decoration: inherit;">user<wbr>Assigned<wbr>Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userassignedidentitiesresponse">pulumi.<wbr>Input<User<wbr>Assigned<wbr>Identities<wbr>Response<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Customer Managed Identity{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#user_assigned_identities_python" style="color: inherit; text-decoration: inherit;">user_<wbr>assigned_<wbr>identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userassignedidentitiesresponse">Input[User<wbr>Assigned<wbr>Identities<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Customer Managed Identity{{% /md %}}</dd></dl>
{{% /choosable %}}
