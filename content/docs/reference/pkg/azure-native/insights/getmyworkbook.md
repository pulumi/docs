...
---
title: "getMyWorkbook"
title_tag: "azure-native.insights.getMyWorkbook"
meta_desc: "Documentation for the azure-native.insights.getMyWorkbook function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getMyWorkbook<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetMyWorkbookArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetMyWorkbookResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_my_workbook(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetMyWorkbookResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupMyWorkbook<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupMyWorkbookArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupMyWorkbookResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetMyWorkbook </span><span class="p">{</span><span class="k">
...
<a href="#category_csharp" style="color: inherit; text-decoration: inherit;">Category</a>
    ...
    <dd>{{% md %}}Workbook category, as defined by the user at creation time.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The user-defined name of the private workbook.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serializeddata_csharp" style="color: inherit; text-decoration: inherit;">Serialized<wbr>Data</a>
    ...
    <dd>{{% md %}}Configuration of this particular private workbook. Configuration data is a string containing valid JSON{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#userid_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Id</a>
    ...
    <dd>{{% md %}}Unique user id of the specific user that owns this private workbook.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#myworkbookmanagedidentityresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Outputs.<wbr>My<wbr>Workbook<wbr>Managed<wbr>Identity<wbr>Response</a></span>
    </dt>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}The kind of workbook. Choices are user and shared.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Id</a>
    ...
    <dd>{{% md %}}Optional resourceId for a source resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageuri_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Uri</a>
    ...
    <dd>{{% md %}}BYOS Storage Account URI{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#userassignedidentities_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Assigned<wbr>Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#myworkbookuserassignedidentitiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Inputs.<wbr>My<wbr>Workbook<wbr>User<wbr>Assigned<wbr>Identities<wbr>Response</a></span>
    </dt>
