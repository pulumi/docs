...
title_tag: "azure-native.insights.PrivateLinkScope"
meta_desc: "Documentation for the azure-native.insights.PrivateLinkScope resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var privateLinkScope = new AzureNative.Insights.PrivateLinkScope("privateLinkScope", new AzureNative.Insights.PrivateLinkScopeArgs
        {
            Location = "Global",
