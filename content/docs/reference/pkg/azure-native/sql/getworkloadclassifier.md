...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getWorkloadClassifier<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWorkloadClassifierArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetWorkloadClassifierResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_workload_classifier(</span><span class="nx">database_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            ...
                            <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetWorkloadClassifierResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupWorkloadClassifier<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupWorkloadClassifierArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupWorkloadClassifierResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWorkloadClassifier </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetWorkloadClassifierResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetWorkloadClassifierArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#workloadclassifiername_csharp" style="color: inherit; text-decoration: inherit;">Workload<wbr>Classifier<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the workload classifier.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#workloadgroupname_csharp" style="color: inherit; text-decoration: inherit;">Workload<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the workload group from which to receive the classifier from.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#membername_csharp" style="color: inherit; text-decoration: inherit;">Member<wbr>Name</a>
    ...
    <dd>{{% md %}}The workload classifier member name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#context_csharp" style="color: inherit; text-decoration: inherit;">Context</a>
    ...
    <dd>{{% md %}}The workload classifier context.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#endtime_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Time</a>
    ...
    <dd>{{% md %}}The workload classifier end time for classification.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#importance_csharp" style="color: inherit; text-decoration: inherit;">Importance</a>
    ...
    <dd>{{% md %}}The workload classifier importance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#label_csharp" style="color: inherit; text-decoration: inherit;">Label</a>
    ...
    <dd>{{% md %}}The workload classifier label.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The workload classifier start time for classification.{{% /md %}}</dd></dl>
{{% /choosable %}}
