...
<a href="#administratorloginpassword_csharp" style="color: inherit; text-decoration: inherit;">Administrator<wbr>Login<wbr>Password</a>
    ...
    <dd>{{% md %}}The administrator login password (required for managed instance creation).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dnszonepartner_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Zone<wbr>Partner</a>
    ...
    <dd>{{% md %}}The resource id of another managed instance whose DNS zone this managed instance will share after creation.{{% /md %}}</dd><dt class="property-"
            title="">
...
Restore: Creates an instance by restoring a set of backups to specific point in time. RestorePointInTime and SourceManagedInstanceId must be specified.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcemanagedinstanceid_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Managed<wbr>Instance<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource identifier of the source managed instance associated with create operation of this instance.{{% /md %}}</dd><dt class="property-"
            title="">
