...
<span class="k">def </span><span class="nx">ServerTrustGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">group_members</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ServerInfoArgs]]]]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">server_trust_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                     <span class="nx">trust_scopes</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">)</span>
...
<a href="#groupmembers_nodejs" style="color: inherit; text-decoration: inherit;">group<wbr>Members</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverinfo">pulumi.<wbr>Input<pulumi.<wbr>Input<Server<wbr>Info<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Group members information for the server trust group.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#group_members_python" style="color: inherit; text-decoration: inherit;">group_<wbr>members</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverinfo">Input[Server<wbr>Info<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Group members information for the server trust group.{{% /md %}}</dd><dt class="property-required"
            title="Required">
