...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_elastic_pool(</span><span class="nx">elastic_pool_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetElasticPoolResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupElasticPool<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupElasticPoolArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupElasticPoolResult</a></span>, error)</span></code></pre></div>
...
<a href="#elasticpoolname_csharp" style="color: inherit; text-decoration: inherit;">Elastic<wbr>Pool<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the elastic pool.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#licensetype_csharp" style="color: inherit; text-decoration: inherit;">License<wbr>Type</a>
    ...
    <dd>{{% md %}}The license type to apply for this elastic pool.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#maintenanceconfigurationid_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Configuration<wbr>Id</a>
    ...
    <dd>{{% md %}}Maintenance configuration id assigned to the elastic pool. This configuration defines the period when the maintenance updates will will occur.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#maxsizebytes_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Size<wbr>Bytes</a>
    ...
    <dd>{{% md %}}The storage limit for the database elastic pool in bytes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#perdatabasesettings_csharp" style="color: inherit; text-decoration: inherit;">Per<wbr>Database<wbr>Settings</a>
    ...
    <dd>{{% md %}}The per database settings for the elastic pool.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
