...
<span class="k">def </span><span class="nx">GeoBackupPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[GeoBackupPolicyState]]</span> = None<span class="p">)</span>
...
<a href="#state_nodejs" style="color: inherit; text-decoration: inherit;">state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geobackuppolicystate">pulumi.<wbr>Input<Geo<wbr>Backup<wbr>Policy<wbr>State></a></span>
    </dt>
    <dd>{{% md %}}The state of the geo backup policy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_python" style="color: inherit; text-decoration: inherit;">state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geobackuppolicystate">Input[Geo<wbr>Backup<wbr>Policy<wbr>State]</a></span>
    </dt>
    <dd>{{% md %}}The state of the geo backup policy.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
