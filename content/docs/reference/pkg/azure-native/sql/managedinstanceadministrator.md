...
<span class="k">def </span><span class="nx">ManagedInstanceAdministrator</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                 ...
                                 <span class="nx">administrator_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                 <span class="nx">administrator_type</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, ManagedInstanceAdministratorType]]]</span> = None<span class="p">,</span>
...
<a href="#administratortype_nodejs" style="color: inherit; text-decoration: inherit;">administrator<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#managedinstanceadministratortype">pulumi.<wbr>Input<Managed<wbr>Instance<wbr>Administrator<wbr>Type></a></span>
    </dt>
    <dd>{{% md %}}Type of the managed instance administrator.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#administrator_type_python" style="color: inherit; text-decoration: inherit;">administrator_<wbr>type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#managedinstanceadministratortype">Input[Managed<wbr>Instance<wbr>Administrator<wbr>Type]</a></span>
    </dt>
    <dd>{{% md %}}Type of the managed instance administrator.{{% /md %}}</dd><dt class="property-required"
            title="Required">
