...
{{% choosable language go %}}
<dl class="tabular">
    <dt>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Status<wbr>Approved</dt>
    <dd>Approved</dd>
    <dt>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Status<wbr>Pending</dt>
    <dd>Pending</dd>
    <dt>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Status<wbr>Rejected</dt>
    <dd>Rejected</dd>
    <dt>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Status<wbr>Disconnected</dt>
    <dd>Disconnected</dd>
</dl>
{{% /choosable %}}
