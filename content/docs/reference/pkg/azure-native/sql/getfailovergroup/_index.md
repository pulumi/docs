...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_failover_group(</span><span class="nx">failover_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       ...
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetFailoverGroupResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupFailoverGroup<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupFailoverGroupArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupFailoverGroupResult</a></span>, error)</span></code></pre></div>
...
<a href="#servername_csharp" style="color: inherit; text-decoration: inherit;">Server<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the server containing the failover group.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#partnerservers_csharp" style="color: inherit; text-decoration: inherit;">Partner<wbr>Servers</a>
    ...
    <dd>{{% md %}}List of partner server information for the failover group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#databases_csharp" style="color: inherit; text-decoration: inherit;">Databases</a>
    ...
    <dd>{{% md %}}List of databases in the failover group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#readonlyendpoint_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Only<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}Read-only endpoint of the failover group instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
