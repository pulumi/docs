...
title_tag: "azure-native.sql.getSensitivityLabel"
...
## Using getSensitivityLabel {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getSensitivityLabel<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetSensitivityLabelArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetSensitivityLabelResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_sensitivity_label(</span><span class="nx">column_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">database_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">schema_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">sensitivity_label_source</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">server_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">table_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetSensitivityLabelResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupSensitivityLabel<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx">LookupSensitivityLabelArgs</span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupSensitivityLabelResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetSensitivityLabel </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetSensitivityLabelResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetSensitivityLabelArgs</span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#sensitivitylabelsource_csharp" style="color: inherit; text-decoration: inherit;">Sensitivity<wbr>Label<wbr>Source</a>
    ...
    <dd>{{% md %}}The source of the sensitivity label.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#tablename_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the table.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
## getSensitivityLabel Result {#result}
...
<a href="#columnname_csharp" style="color: inherit; text-decoration: inherit;">Column<wbr>Name</a>
    ...
    <dd>{{% md %}}The column name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#managedby_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>By</a>
    ...
    <dd>{{% md %}}Resource that manages the sensitivity label.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#schemaname_csharp" style="color: inherit; text-decoration: inherit;">Schema<wbr>Name</a>
    ...
    <dd>{{% md %}}The schema name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tablename_csharp">
<a href="#tablename_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Name</a>
</span>
    ...
    <dd>{{% md %}}The table name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#informationtype_csharp" style="color: inherit; text-decoration: inherit;">Information<wbr>Type</a>
    ...
    <dd>{{% md %}}The information type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#informationtypeid_csharp" style="color: inherit; text-decoration: inherit;">Information<wbr>Type<wbr>Id</a>
    ...
    <dd>{{% md %}}The information type ID.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labelid_csharp" style="color: inherit; text-decoration: inherit;">Label<wbr>Id</a>
    ...
    <dd>{{% md %}}The label ID.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labelname_csharp" style="color: inherit; text-decoration: inherit;">Label<wbr>Name</a>
    ...
    <dd>{{% md %}}The label name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="rank_csharp">
