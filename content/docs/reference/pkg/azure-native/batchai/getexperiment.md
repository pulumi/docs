...
---
title: "getExperiment"
title_tag: "azure-native.batchai.getExperiment"
meta_desc: "Documentation for the azure-native.batchai.getExperiment function with examples, input properties, output properties, and supporting types."
---
...
<a href="#creationtime_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Time</a>
    ...
    <dd>{{% md %}}Time when the Experiment was created.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioned state of the experiment{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstatetransitiontime_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State<wbr>Transition<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which the experiment entered its current provisioning state.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
