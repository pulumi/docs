...
---
title: "getWorkspace"
title_tag: "azure-native.batchai.getWorkspace"
meta_desc: "Documentation for the azure-native.batchai.getWorkspace function with examples, input properties, output properties, and supporting types."
---
...
<a href="#creationtime_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Time</a>
    ...
    <dd>{{% md %}}Time when the Workspace was created.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioned state of the Workspace{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstatetransitiontime_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State<wbr>Transition<wbr>Time</a>
    ...
    <dd>{{% md %}}The time at which the workspace entered its current provisioning state.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
