...
<span class="k">def </span><span class="nx">ArtifactSource</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">artifact_root</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                   <span class="nx">artifact_source_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                   <span class="nx">authentication</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[SasAuthenticationArgs]]</span> = None<span class="p">,</span>
...
<a href="#authentication_csharp" style="color: inherit; text-decoration: inherit;">Authentication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sasauthentication">Pulumi.<wbr>Azure<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>Inputs.<wbr>Sas<wbr>Authentication<wbr>Args</a></span>
    </dt>
...
<a href="#sourcetype_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of artifact source used.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#authentication_nodejs" style="color: inherit; text-decoration: inherit;">authentication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sasauthentication">pulumi.<wbr>Input<Sas<wbr>Authentication<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The authentication method to use to access the artifact source.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#authentication_python" style="color: inherit; text-decoration: inherit;">authentication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sasauthentication">Input[Sas<wbr>Authentication<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The authentication method to use to access the artifact source.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sasuri_csharp" style="color: inherit; text-decoration: inherit;">Sas<wbr>Uri</a>
    ...
    <dd>{{% md %}}The SAS URI to the Azure Storage blob container. Any offset from the root of the container to where the artifacts are located can be defined in the artifactRoot.{{% /md %}}</dd></dl>
{{% /choosable %}}
