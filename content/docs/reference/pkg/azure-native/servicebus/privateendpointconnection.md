...
<span class="k">def </span><span class="nx">PrivateEndpointConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                              ...
                              <span class="nx">provisioning_state</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Union[str, EndPointProvisioningState]]]</span> = None<span class="p">,</span>
...
<a href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpoint">Pulumi.<wbr>Azure<wbr>Native.<wbr>Service<wbr>Bus.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Args</a></span>
    </dt>
...
<a href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Service<wbr>Bus.<wbr>Inputs.<wbr>Connection<wbr>State<wbr>Args</a></span>
    </dt>
...
<a href="#provisioningstate_nodejs" style="color: inherit; text-decoration: inherit;">provisioning<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#endpointprovisioningstate">pulumi.<wbr>Input<End<wbr>Point<wbr>Provisioning<wbr>State></a></span>
    </dt>
    <dd>{{% md %}}Provisioning state of the Private Endpoint Connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioning_state_python" style="color: inherit; text-decoration: inherit;">provisioning_<wbr>state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#endpointprovisioningstate">Input[End<wbr>Point<wbr>Provisioning<wbr>State]</a></span>
    </dt>
    <dd>{{% md %}}Provisioning state of the Private Endpoint Connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#status_nodejs" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#privatelinkconnectionstatus">pulumi.<wbr>Input<Private<wbr>Link<wbr>Connection<wbr>Status></a></span>
    </dt>
    <dd>{{% md %}}Status of the connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#status_python" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#privatelinkconnectionstatus">Input[Private<wbr>Link<wbr>Connection<wbr>Status]</a></span>
    </dt>
    <dd>{{% md %}}Status of the connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="endpointprovisioningstate">End<wbr>Point<wbr>Provisioning<wbr>State</h4>
...
<h4 id="privatelinkconnectionstatus">Private<wbr>Link<wbr>Connection<wbr>Status</h4>
