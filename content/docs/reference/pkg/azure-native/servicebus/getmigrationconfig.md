...
<a href="#configname_csharp" style="color: inherit; text-decoration: inherit;">Config<wbr>Name</a>
    ...
    <dd>{{% md %}}The configuration name. Should always be "$default".{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#postmigrationname_csharp" style="color: inherit; text-decoration: inherit;">Post<wbr>Migration<wbr>Name</a>
    ...
    <dd>{{% md %}}Name to access Standard Namespace after migration{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetnamespace_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Namespace</a>
    ...
    <dd>{{% md %}}Existing premium Namespace ARM Id name which has no entities, will be used for migration{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
