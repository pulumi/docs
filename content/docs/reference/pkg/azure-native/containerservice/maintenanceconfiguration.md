...
<span class="k">def </span><span class="nx">MaintenanceConfiguration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">not_allowed_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[TimeSpanArgs]]]]</span> = None<span class="p">,</span>
                             ...
                             <span class="nx">time_in_week</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[TimeInWeekArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#notallowedtime_nodejs" style="color: inherit; text-decoration: inherit;">not<wbr>Allowed<wbr>Time</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timespan">pulumi.<wbr>Input<pulumi.<wbr>Input<Time<wbr>Span<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Time slots on which upgrade is not allowed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timeinweek_nodejs" style="color: inherit; text-decoration: inherit;">time<wbr>In<wbr>Week</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timeinweek">pulumi.<wbr>Input<pulumi.<wbr>Input<Time<wbr>In<wbr>Week<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Weekday time slots allowed to upgrade.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#not_allowed_time_python" style="color: inherit; text-decoration: inherit;">not_<wbr>allowed_<wbr>time</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timespan">Input[Time<wbr>Span<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Time slots on which upgrade is not allowed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#time_in_week_python" style="color: inherit; text-decoration: inherit;">time_<wbr>in_<wbr>week</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timeinweek">Input[Time<wbr>In<wbr>Week<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Weekday time slots allowed to upgrade.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#day_nodejs" style="color: inherit; text-decoration: inherit;">day</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<string> | <a href="#weekday">pulumi.<wbr>Input<Week<wbr>Day></a></span>
    </dt>
    <dd>{{% md %}}A day in a week.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#day_python" style="color: inherit; text-decoration: inherit;">day</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input[str] | <a href="#weekday">Input[Week<wbr>Day]</a></span>
    </dt>
    <dd>{{% md %}}A day in a week.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
