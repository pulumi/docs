...
---
title: "getService"
title_tag: "azure-native.datamigration.getService"
meta_desc: "Documentation for the azure-native.datamigration.getService function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_service(</span><span class="nx">group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#servicename_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the service{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The resource's provisioning state{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#virtualsubnetid_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Subnet<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the Microsoft.Network/virtualNetworks/subnets resource to which the service should be joined{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}HTTP strong entity tag value. Ignored if submitted{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}The resource kind. Only 'vm' (the default) is supported.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publickey_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Key</a>
    ...
    <dd>{{% md %}}The public key of the service, used to encrypt secrets sent to the service{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceskuresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Migration.<wbr>Outputs.<wbr>Service<wbr>Sku<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Service SKU{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#capacity_csharp" style="color: inherit; text-decoration: inherit;">Capacity</a>
    ...
    <dd>{{% md %}}The capacity of the SKU, if it supports scaling{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#family_csharp" style="color: inherit; text-decoration: inherit;">Family</a>
    ...
    <dd>{{% md %}}The SKU family, used when the service has multiple performance classes within a tier, such as 'A', 'D', etc. for virtual machines{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}The unique name of the SKU, such as 'P3'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="size_csharp">
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}The size of the SKU, used when the name alone does not denote a service size or when a SKU has multiple performance classes within a family, e.g. 'A1' for virtual machines{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tier_csharp">
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}The tier of the SKU, such as 'Free', 'Basic', 'Standard', or 'Premium'{{% /md %}}</dd></dl>
{{% /choosable %}}
