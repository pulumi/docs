...
## Create a AzurePowerShellScript Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">AzurePowerShellScript</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">AzurePowerShellScriptArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">AzurePowerShellScript</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">az_power_shell_version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">AzurePowerShellScript</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">AzurePowerShellScriptArgs</a></span><span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAzurePowerShellScript</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">AzurePowerShellScriptArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AzurePowerShellScript</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">AzurePowerShellScript</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AzurePowerShellScriptArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">AzurePowerShellScriptArgs</a></span>
    </dt>
...
## AzurePowerShellScript Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Programming Model docs.

### Inputs

The AzurePowerShellScript resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#azpowershellversion_csharp" style="color: inherit; text-decoration: inherit;">Az<wbr>Power<wbr>Shell<wbr>Version</a>
    ...
    <dd>{{% md %}}Azure PowerShell module version to be used.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#retentioninterval_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Interval</a>
    ...
    <dd>{{% md %}}Interval for which the service retains the script resource after it reaches a terminal state. Resource will be deleted when this duration expires. Duration is based on ISO 8601 pattern (for example P1D means one day).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#arguments_csharp" style="color: inherit; text-decoration: inherit;">Arguments</a>
    ...
    <dd>{{% md %}}Command line arguments to pass to the script. Arguments are separated by spaces. ex: -Name blue* -Location 'West US 2' {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#cleanuppreference_csharp" style="color: inherit; text-decoration: inherit;">Cleanup<wbr>Preference</a>
    ...
    <dd>{{% md %}}The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#containersettings_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Resources.<wbr>Inputs.<wbr>Container<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#environmentvariables_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Variables</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentvariable">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Resources.<wbr>Inputs.<wbr>Environment<wbr>Variable<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#forceupdatetag_csharp" style="color: inherit; text-decoration: inherit;">Force<wbr>Update<wbr>Tag</a>
    ...
    <dd>{{% md %}}Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="identity_csharp">
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managedserviceidentity">Pulumi.<wbr>Azure<wbr>Native.<wbr>Resources.<wbr>Inputs.<wbr>Managed<wbr>Service<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}The location of the ACI and the storage account for the deployment script.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#primaryscripturi_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Script<wbr>Uri</a>
    ...
    <dd>{{% md %}}Uri for the script. This is the entry point for the external script.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#scriptcontent_csharp" style="color: inherit; text-decoration: inherit;">Script<wbr>Content</a>
    ...
    <dd>{{% md %}}Script body.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#scriptname_csharp" style="color: inherit; text-decoration: inherit;">Script<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the deployment script.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storageaccountsettings_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageaccountconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Resources.<wbr>Inputs.<wbr>Storage<wbr>Account<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#supportingscripturis_csharp" style="color: inherit; text-decoration: inherit;">Supporting<wbr>Script<wbr>Uris</a>
    ...
    <dd>{{% md %}}Supporting files for the external script.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AzurePowerShellScript resource produces the following output properties:
...
<h4 id="cleanupoptions">Cleanup<wbr>Options</h4>
...
<h4 id="storageaccountconfiguration">Storage<wbr>Account<wbr>Configuration</h4>
