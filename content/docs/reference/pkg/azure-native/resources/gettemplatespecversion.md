...
<a href="#templatespecname_csharp" style="color: inherit; text-decoration: inherit;">Template<wbr>Spec<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the Template Spec.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#templatespecversion_csharp" style="color: inherit; text-decoration: inherit;">Template<wbr>Spec<wbr>Version</a>
    ...
    <dd>{{% md %}}The version of the Template Spec.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}The location of the Template Spec Version. It must match the location of the parent Template Spec.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
