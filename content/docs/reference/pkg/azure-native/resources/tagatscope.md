...
<span class="k">def </span><span class="nx">TagAtScope</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[TagsArgs]]</span> = None<span class="p">,</span>
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tags">Input[Tags<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The set of tags.{{% /md %}}</dd><dt class="property-required"
            title="Required">
