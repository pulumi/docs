...
<span class="k">def </span><span class="nx">TemplateSpecVersion</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                        ...
                        <span class="nx">linked_templates</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[LinkedTemplateArtifactArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#linkedtemplates_nodejs" style="color: inherit; text-decoration: inherit;">linked<wbr>Templates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#linkedtemplateartifact">pulumi.<wbr>Input<pulumi.<wbr>Input<Linked<wbr>Template<wbr>Artifact<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An array of linked template artifacts.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#linked_templates_python" style="color: inherit; text-decoration: inherit;">linked_<wbr>templates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#linkedtemplateartifact">Input[Linked<wbr>Template<wbr>Artifact<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An array of linked template artifacts.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
