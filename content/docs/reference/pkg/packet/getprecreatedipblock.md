...
<div class="note note-info" role="alert">
    <p><i class="fas fa-info-circle pr-2"></i>
        The Packet provider has been deprecated. The replacement function is Equinix Metal <a href="/docs/reference/pkg/equinix-metal/getprecreatedipblock/">GetPrecreatedIpBlock</a>.
    </p>
</div>
