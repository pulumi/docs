...
<a href="#master_go" style="color: inherit; text-decoration: inherit;">Master</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermaster">Kubernetes<wbr>Cluster<wbr>Master</a></span>
    </dt>
    <dd>{{% md %}}Kubernetes master configuration options. The structure is documented below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#kmsprovider_go" style="color: inherit; text-decoration: inherit;">Kms<wbr>Provider</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclusterkmsprovider">Kubernetes<wbr>Cluster<wbr>Kms<wbr>Provider</a></span>
    </dt>
    <dd>{{% md %}}cluster KMS provider parameters.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancepolicy_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermastermaintenancepolicy">Kubernetes<wbr>Cluster<wbr>Master<wbr>Maintenance<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#regional_csharp" style="color: inherit; text-decoration: inherit;">Regional</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterregional">Kubernetes<wbr>Cluster<wbr>Master<wbr>Regional<wbr>Args</a></span>
    </dt>
...
<a href="#versioninfo_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterversioninfo">Kubernetes<wbr>Cluster<wbr>Master<wbr>Version<wbr>Info<wbr>Args</a></span>
    </dt>
...
<a href="#zonal_csharp" style="color: inherit; text-decoration: inherit;">Zonal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterzonal">Kubernetes<wbr>Cluster<wbr>Master<wbr>Zonal<wbr>Args</a></span>
    </dt>
...
<a href="#maintenancewindows_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermastermaintenancepolicymaintenancewindow">List&lt;Kubernetes<wbr>Cluster<wbr>Master<wbr>Maintenance<wbr>Policy<wbr>Maintenance<wbr>Window<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#maintenancewindows_nodejs" style="color: inherit; text-decoration: inherit;">maintenance<wbr>Windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermastermaintenancepolicymaintenancewindow">Kubernetes<wbr>Cluster<wbr>Master<wbr>Maintenance<wbr>Policy<wbr>Maintenance<wbr>Window<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}(Optional) (Computed) This structure specifies maintenance window, when update for master is allowed. When omitted, it defaults to any time.
To specify time of day interval, for all days, one element should be provided, with two fields set, `start_time` and `duration`.
Please see `zonal_cluster_resource_name` config example.
...
<a href="#maintenance_windows_python" style="color: inherit; text-decoration: inherit;">maintenance_<wbr>windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermastermaintenancepolicymaintenancewindow">Sequence[Kubernetes<wbr>Cluster<wbr>Master<wbr>Maintenance<wbr>Policy<wbr>Maintenance<wbr>Window<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}(Optional) (Computed) This structure specifies maintenance window, when update for master is allowed. When omitted, it defaults to any time.
To specify time of day interval, for all days, one element should be provided, with two fields set, `start_time` and `duration`.
Please see `zonal_cluster_resource_name` config example.
...
<a href="#locations_csharp" style="color: inherit; text-decoration: inherit;">Locations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterregionallocation">List&lt;Kubernetes<wbr>Cluster<wbr>Master<wbr>Regional<wbr>Location<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#locations_nodejs" style="color: inherit; text-decoration: inherit;">locations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterregionallocation">Kubernetes<wbr>Cluster<wbr>Master<wbr>Regional<wbr>Location<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}Array of locations, where master instances will be allocated. The structure is documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#locations_python" style="color: inherit; text-decoration: inherit;">locations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesclustermasterregionallocation">Sequence[Kubernetes<wbr>Cluster<wbr>Master<wbr>Regional<wbr>Location<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Array of locations, where master instances will be allocated. The structure is documented below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
