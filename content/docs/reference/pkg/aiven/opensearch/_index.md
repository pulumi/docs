...
## Create a OpenSearch Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<span class="k">def </span><span class="nx">OpenSearch</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">opensearch</span><span class="p">:</span> <span class="nx">Optional[OpenSearchOpensearchArgs]</span> = None<span class="p">,</span>
...
The OpenSearch resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#cloudname_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Name</a>
    ...
    <dd>{{% md %}}defines where the cloud provider and region where the service is hosted in. This can be
...
<a href="#maintenancewindowdow_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window<wbr>Dow</a>
    ...
    <dd>{{% md %}}day of week when maintenance operations should be performed. On monday, tuesday,
wednesday, etc.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancewindowtime_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window<wbr>Time</a>
    ...
    <dd>{{% md %}}time of day when maintenance operations should be performed. UTC time in HH:mm:
ss format.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#opensearch_csharp" style="color: inherit; text-decoration: inherit;">Opensearch</a>
    ...
    <dd>{{% md %}}Allow clients to connect to opensearch from the public internet for service nodes
...
<a href="#opensearchuserconfig_csharp" style="color: inherit; text-decoration: inherit;">Opensearch<wbr>User<wbr>Config</a>
    ...
    <dd>{{% md %}}defines Opensearch specific additional configuration options. The following
...
<a href="#plan_csharp" style="color: inherit; text-decoration: inherit;">Plan</a>
    ...
    <dd>{{% md %}}defines what kind of computing resources are allocated for the service. It can be changed after
...
<a href="#projectvpcid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Vpc<wbr>Id</a>
    ...
    <dd>{{% md %}}optionally specifies the VPC the service should run in. If the value is not set the
...
<a href="#terminationprotection_csharp" style="color: inherit; text-decoration: inherit;">Termination<wbr>Protection</a>
    ...
    <dd>{{% md %}}prevents the service from being deleted. It is recommended to set this to `true`
...
## Look up an Existing OpenSearch Resource {#look-up}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_opensearch_csharp">
<a href="#state_opensearch_csharp" style="color: inherit; text-decoration: inherit;">Opensearch</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearch">Open<wbr>Search<wbr>Opensearch<wbr>Args</a></span>
    </dt>
...
<a href="#state_opensearchuserconfig_csharp" style="color: inherit; text-decoration: inherit;">Opensearch<wbr>User<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearchuserconfig">Open<wbr>Search<wbr>Opensearch<wbr>User<wbr>Config<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_opensearch_go">
<a href="#state_opensearch_go" style="color: inherit; text-decoration: inherit;">Opensearch</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearch">Open<wbr>Search<wbr>Opensearch<wbr>Args</a></span>
    </dt>
...
<a href="#state_opensearchuserconfig_go" style="color: inherit; text-decoration: inherit;">Opensearch<wbr>User<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearchuserconfig">Open<wbr>Search<wbr>Opensearch<wbr>User<wbr>Config<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_opensearch_nodejs">
<a href="#state_opensearch_nodejs" style="color: inherit; text-decoration: inherit;">opensearch</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearch">Open<wbr>Search<wbr>Opensearch<wbr>Args</a></span>
    </dt>
...
<a href="#state_opensearchuserconfig_nodejs" style="color: inherit; text-decoration: inherit;">opensearch<wbr>User<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearchuserconfig">Open<wbr>Search<wbr>Opensearch<wbr>User<wbr>Config<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_opensearch_python">
<a href="#state_opensearch_python" style="color: inherit; text-decoration: inherit;">opensearch</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearch">Open<wbr>Search<wbr>Opensearch<wbr>Args</a></span>
    </dt>
...
<a href="#state_opensearch_user_config_python" style="color: inherit; text-decoration: inherit;">opensearch_<wbr>user_<wbr>config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#opensearchopensearchuserconfig">Open<wbr>Search<wbr>Opensearch<wbr>User<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#disablereplicationfactoradjustment_csharp" style="color: inherit; text-decoration: inherit;">Disable<wbr>Replication<wbr>Factor<wbr>Adjustment</a>
    ...
    <dd>{{% md %}}Disable automatic replication factor adjustment for
...
<a href="#opensearchdashboards_csharp" style="color: inherit; text-decoration: inherit;">Opensearch<wbr>Dashboards</a>
    ...
    <dd>{{% md %}}Allow clients to connect to opensearch_dashboards from the public
...
<a href="#projecttoforkfrom_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>To<wbr>Fork<wbr>From</a>
    ...
    <dd>{{% md %}}Name of another project to fork a service from. This has effect only when a
...
<a href="#servicetoforkfrom_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>To<wbr>Fork<wbr>From</a>
    ...
    <dd>{{% md %}}Name of another service to fork from. This has effect only when a new service
is being created.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pattern_csharp" style="color: inherit; text-decoration: inherit;">Pattern</a>
    ...
    <dd>{{% md %}}Must consist of alpha-numeric characters, dashes, underscores, dots and glob
characters (* and ?)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mappingnestedobjectslimit_csharp" style="color: inherit; text-decoration: inherit;">Mapping<wbr>Nested<wbr>Objects<wbr>Limit</a>
    ...
    <dd>{{% md %}}The maximum number of nested JSON objects that a single document
...
<a href="#actionautocreateindexenabled_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>Auto<wbr>Create<wbr>Index<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Explicitly allow or block automatic creation of indices.
Defaults to true
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#httpmaxcontentlength_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Max<wbr>Content<wbr>Length</a>
    ...
    <dd>{{% md %}}Maximum content length for HTTP requests to the Opensearch HTTP API, in
bytes.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#indicesfielddatacachesize_csharp" style="color: inherit; text-decoration: inherit;">Indices<wbr>Fielddata<wbr>Cache<wbr>Size</a>
    ...
    <dd>{{% md %}}Relative amount. Maximum amount of heap memory used for field data
...
<a href="#indicesmemoryindexbuffersize_csharp" style="color: inherit; text-decoration: inherit;">Indices<wbr>Memory<wbr>Index<wbr>Buffer<wbr>Size</a>
    ...
    <dd>{{% md %}}Percentage value. Default is 10%. Total amount of heap used
...
<a href="#indicesqueriescachesize_csharp" style="color: inherit; text-decoration: inherit;">Indices<wbr>Queries<wbr>Cache<wbr>Size</a>
    ...
    <dd>{{% md %}}Percentage value. Default is 10%. Maximum amount of heap used for
...
<a href="#indicesqueryboolmaxclausecount_csharp" style="color: inherit; text-decoration: inherit;">Indices<wbr>Query<wbr>Bool<wbr>Max<wbr>Clause<wbr>Count</a>
    ...
    <dd>{{% md %}}Maximum number of clauses Lucene BooleanQuery can have. The
...
<a href="#reindexremotewhitelists_csharp" style="color: inherit; text-decoration: inherit;">Reindex<wbr>Remote<wbr>Whitelists</a>
    ...
    <dd>{{% md %}}Whitelisted addresses for reindexing. Changing this value will cause
...
<a href="#searchmaxbuckets_csharp" style="color: inherit; text-decoration: inherit;">Search<wbr>Max<wbr>Buckets</a>
    ...
    <dd>{{% md %}}Maximum number of aggregation buckets allowed in a single response.
...
<a href="#threadpoolforcemergesize_csharp" style="color: inherit; text-decoration: inherit;">Thread<wbr>Pool<wbr>Force<wbr>Merge<wbr>Size</a>
    ...
    <dd>{{% md %}}Size for the thread pool. See documentation for exact details. Do
...
<a href="#threadpoolsearchthrottledqueuesize_csharp" style="color: inherit; text-decoration: inherit;">Thread<wbr>Pool<wbr>Search<wbr>Throttled<wbr>Queue<wbr>Size</a>
    ...
    <dd>{{% md %}}Size for the thread pool queue. See documentation for
exact details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threadpoolsearchthrottledsize_csharp" style="color: inherit; text-decoration: inherit;">Thread<wbr>Pool<wbr>Search<wbr>Throttled<wbr>Size</a>
    ...
    <dd>{{% md %}}Size for the thread pool. See documentation for exact
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}Enable or disable opensearch_dashboards.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maxoldspacesize_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Old<wbr>Space<wbr>Size</a>
    ...
    <dd>{{% md %}}Limits the maximum amount of memory (in MiB) the Opensearch dashboards
...
<a href="#opensearchrequesttimeout_csharp" style="color: inherit; text-decoration: inherit;">Opensearch<wbr>Request<wbr>Timeout</a>
    ...
    <dd>{{% md %}}Timeout in milliseconds for requests made by opensearch_dashboards
towards Opensearch.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#prometheus_csharp" style="color: inherit; text-decoration: inherit;">Prometheus</a>
    ...
    <dd>{{% md %}}Allow clients to connect to prometheus from the public internet for service nodes
that are in a project VPC or another type of private network.
{{% /md %}}</dd></dl>
{{% /choosable %}}
