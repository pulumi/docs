...
<span class="k">def </span><span class="nx">M3Aggregator</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">m3aggregator</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[M3AggregatorM3aggregatorArgs]]</span> = None<span class="p">,</span>
                 <span class="nx">m3aggregator_user_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[M3AggregatorM3aggregatorUserConfigArgs]]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">service_integrations</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[M3AggregatorServiceIntegrationArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#m3aggregator_nodejs" style="color: inherit; text-decoration: inherit;">m3aggregator</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorm3aggregator">pulumi<wbr>Input<M3Aggregator<wbr>M3aggregator<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}M3 Aggregator specific server provided values.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#m3aggregatoruserconfig_nodejs" style="color: inherit; text-decoration: inherit;">m3aggregator<wbr>User<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorm3aggregatoruserconfig">pulumi<wbr>Input<M3Aggregator<wbr>M3aggregator<wbr>User<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}defines M3 Aggregator specific additional configuration options. 
The following configuration options available:
{{% /md %}}</dd><dt class="property-optional"
...
<a href="#serviceintegrations_nodejs" style="color: inherit; text-decoration: inherit;">service<wbr>Integrations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorserviceintegration">pulumi<wbr>Input<pulumi<wbr>Input<M3Aggregator<wbr>Service<wbr>Integration<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Service integrations to specify when creating a service. Not applied after initial service creation
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#m3aggregator_python" style="color: inherit; text-decoration: inherit;">m3aggregator</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorm3aggregator">Input[M3Aggregator<wbr>M3aggregator<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}M3 Aggregator specific server provided values.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#m3aggregator_user_config_python" style="color: inherit; text-decoration: inherit;">m3aggregator_<wbr>user_<wbr>config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorm3aggregatoruserconfig">Input[M3Aggregator<wbr>M3aggregator<wbr>User<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}defines M3 Aggregator specific additional configuration options. 
The following configuration options available:
{{% /md %}}</dd><dt class="property-optional"
...
<a href="#service_integrations_python" style="color: inherit; text-decoration: inherit;">service_<wbr>integrations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorserviceintegration">Input[M3Aggregator<wbr>Service<wbr>Integration<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Service integrations to specify when creating a service. Not applied after initial service creation
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
        <span class="nx">cloud_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">components</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[M3AggregatorComponentArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">m3aggregator</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[M3AggregatorM3aggregatorArgs]]</span> = None<span class="p">,</span>
        <span class="nx">m3aggregator_user_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[M3AggregatorM3aggregatorUserConfigArgs]]</span> = None<span class="p">,</span>
        <span class="nx">maintenance_window_dow</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">maintenance_window_time</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        ...
        <span class="nx">termination_protection</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">) -&gt;</span> M3Aggregator</code></pre></div>
{{% /choosable %}}
...
<a href="#state_components_nodejs" style="color: inherit; text-decoration: inherit;">components</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorcomponent">pulumi<wbr>Input<pulumi<wbr>Input<M3Aggregator<wbr>Component<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Service component information objects
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_components_python" style="color: inherit; text-decoration: inherit;">components</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#m3aggregatorcomponent">Input[M3Aggregator<wbr>Component<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Service component information objects
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
