...
meta_desc: "Explore the KafkaMirrorMaker resource of the Aiven package, including examples, input properties, output properties, lookup functions, and supporting types. ## # Kafka Mirror Maker Resource"
---
...
<a href="#kafkamirrormakeruserconfig_csharp" style="color: inherit; text-decoration: inherit;">Kafka<wbr>Mirrormaker<wbr>User<wbr>Config</a>
    ...
    <dd>{{% md %}}defines Kafka Mirror Maker 2 specific additional configuration options. 
...
<a href="#servicehost_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Host</a>
    ...
    <dd>{{% md %}}Kafka Mirror Maker 2 hostname.
{{% /md %}}</dd>
...
<a href="#servicepassword_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Password</a>
    ...
    <dd>{{% md %}}Password used for connecting to the Kafka Mirror Maker 2 service, if applicable.
{{% /md %}}</dd>
...
<a href="#serviceport_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Port</a>
    ...
    <dd>{{% md %}}Kafka Mirror Maker 2 port.
{{% /md %}}</dd>
...
<a href="#serviceuri_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Uri</a>
    ...
    <dd>{{% md %}}URI for connecting to the Kafka Mirror Maker 2 service.
{{% /md %}}</dd>
...
<a href="#serviceusername_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Username</a>
    ...
    <dd>{{% md %}}Username used for connecting to the Kafka Mirror Maker 2 service, if applicable.
{{% /md %}}</dd>
