...
meta_desc: "Explore the GetKafkaMirrorMaker function of the Aiven package, including examples, input properties, output properties, and supporting types. ## # Kafka Mirror Maker Data Source"
---
...
<a href="#kafkamirrormaker_csharp" style="color: inherit; text-decoration: inherit;">Kafka<wbr>Mirrormaker</a>
    ...
    <dd>{{% md %}}Kafka Mirror Maker 2 specific server provided values.
{{% /md %}}</dd>
