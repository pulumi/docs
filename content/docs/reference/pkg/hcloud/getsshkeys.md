...
---
title: "getSshKeys"
title_tag: "hcloud.getSshKeys"
meta_desc: "Documentation for the hcloud.getSshKeys function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_ssh_keys(</span><span class="nx">with_selector</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
