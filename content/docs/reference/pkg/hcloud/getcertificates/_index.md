...
title_tag: "hcloud.getCertificates"
meta_desc: "Documentation for the hcloud.getCertificates function with examples, input properties, output properties, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_certificates(</span><span class="nx">with_selector</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#certificates_csharp" style="color: inherit; text-decoration: inherit;">Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getcertificatescertificate">List&lt;Pulumi.<wbr>HCloud.<wbr>Outputs.<wbr>Get<wbr>Certificates<wbr>Certificate&gt;</a></span>
    </dt>
    <dd>{{% md %}}(list) List of all matching certificates. See `data.hcloud_certificate` for schema.
