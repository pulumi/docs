...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">UserAttributeMapper</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>always_read_value_from_ldap=None<span class="p">, </span>is_mandatory_in_ldap=None<span class="p">, </span>ldap_attribute=None<span class="p">, </span>ldap_user_federation_id=None<span class="p">, </span>name=None<span class="p">, </span>read_only=None<span class="p">, </span>realm_id=None<span class="p">, </span>user_model_attribute=None<span class="p">, </span>__props__=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
The UserAttributeMapper resource accepts the following [input]({{< prelref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
