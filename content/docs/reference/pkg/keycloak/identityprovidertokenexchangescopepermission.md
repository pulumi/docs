...
{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">static </span><span class="nf">get</span><span class="p">(resource_name, id, opts=None, </span>authorization_idp_resource_id=None<span class="p">, </span>authorization_resource_server_id=None<span class="p">, </span>authorization_token_exchange_scope_permission_id=None<span class="p">, </span>clients=None<span class="p">, </span>policy_id=None<span class="p">, </span>policy_type=None<span class="p">, </span>provider_alias=None<span class="p">, </span>realm_id=None<span class="p">, __props__=None)</span></code></pre></div>
{{% /choosable %}}
