...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SubnetPool resource produces the following computed outputs.
