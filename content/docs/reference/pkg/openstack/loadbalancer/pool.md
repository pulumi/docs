...
<span class="k">def </span><span class="nx">Pool</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">persistence</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PoolPersistenceArgs]]</span> = None<span class="p">,</span>
...
<a href="#persistence_nodejs" style="color: inherit; text-decoration: inherit;">persistence</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#poolpersistence">pulumi.<wbr>Input<Pool<wbr>Persistence<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Omit this field to prevent session persistence.  Indicates
whether connections in the same session will be processed by the same Pool
member or not. Changing this creates a new pool.
...
<a href="#persistence_python" style="color: inherit; text-decoration: inherit;">persistence</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#poolpersistence">Input[Pool<wbr>Persistence<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Omit this field to prevent session persistence.  Indicates
whether connections in the same session will be processed by the same Pool
member or not. Changing this creates a new pool.
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">protocol</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">tenant_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> Pool</code></pre></div>
{{% /choosable %}}
