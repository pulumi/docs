...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ShareAccess resource produces the following computed outputs.
