...
All [input](#inputs) properties are implicitly available as output properties. The InterfaceAttach resource does not produce any additional output properties.
