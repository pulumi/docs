...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the VolumeAttach resource produces the following computed outputs.
