...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ImageAccessAccept resource produces the following computed outputs.
