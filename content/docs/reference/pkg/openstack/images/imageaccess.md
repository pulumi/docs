...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ImageAccess resource produces the following computed outputs.
