...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ContainerObject resource produces the following computed outputs.
