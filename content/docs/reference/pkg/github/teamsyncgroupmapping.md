...
<span class="k">def </span><span class="nx">TeamSyncGroupMapping</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                         ...
                         <span class="nx">groups</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[TeamSyncGroupMappingGroupArgs]]]]</span> = None<span class="p">,</span>
                         <span class="nx">team_slug</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span>
...
<a href="#groups_nodejs" style="color: inherit; text-decoration: inherit;">groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#teamsyncgroupmappinggroup">pulumi<wbr>Input<pulumi<wbr>Input<Team<wbr>Sync<wbr>Group<wbr>Mapping<wbr>Group<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An Array of GitHub Identity Provider Groups (or empty []).  Each `group` block consists of the fields documented below.
___
{{% /md %}}</dd></dl>
...
<a href="#groups_python" style="color: inherit; text-decoration: inherit;">groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#teamsyncgroupmappinggroup">Input[Team<wbr>Sync<wbr>Group<wbr>Mapping<wbr>Group<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An Array of GitHub Identity Provider Groups (or empty []).  Each `group` block consists of the fields documented below.
___
{{% /md %}}</dd></dl>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">groups</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[TeamSyncGroupMappingGroupArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">team_slug</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> TeamSyncGroupMapping</code></pre></div>
{{% /choosable %}}
