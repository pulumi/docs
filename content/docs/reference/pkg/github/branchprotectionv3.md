...
title_tag: "github.BranchProtectionV3"
meta_desc: "Documentation for the github.BranchProtectionV3 resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">BranchProtectionV3</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       ...
                       <span class="nx">required_pull_request_reviews</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RequiredPullRequestReviewsArgs]</span> = None<span class="p">,</span>
                       <span class="nx">required_status_checks</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RequiredStatusChecksArgs]</span> = None<span class="p">,</span>
                       <span class="nx">restrictions</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RestrictionsArgs]</span> = None<span class="p">)</span>
...
The BranchProtectionV3 resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">required_pull_request_reviews</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RequiredPullRequestReviewsArgs]</span> = None<span class="p">,</span>
        <span class="nx">required_status_checks</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RequiredStatusChecksArgs]</span> = None<span class="p">,</span>
        <span class="nx">restrictions</span><span class="p">:</span> <span class="nx">Optional[BranchProtectionV3RestrictionsArgs]</span> = None<span class="p">) -&gt;</span> BranchProtectionV3</code></pre></div>
{{% /choosable %}}
