...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NodeBalancerNode resource produces the following computed outputs.
