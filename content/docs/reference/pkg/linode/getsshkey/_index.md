...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_ssh_key(</span><span class="nx">label</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#label_csharp" style="color: inherit; text-decoration: inherit;">Label</a>
    ...
    <dd>{{% md %}}The label of the SSH Key to select.
{{% /md %}}</dd></dl>
{{% /choosable %}}
