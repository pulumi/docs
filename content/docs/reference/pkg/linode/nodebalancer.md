...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NodeBalancer resource produces the following computed outputs.
