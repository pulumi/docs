...
---
title: "Registry"
title_tag: "aws-native.glue.Registry"
meta_desc: "Documentation for the aws-native.glue.Registry resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<span class="k">def </span><span class="nx">Registry</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Sequence[RegistryTagArgs]]</span> = None<span class="p">)</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the registry to be created of max length of 255, and may only contain letters, numbers, hyphen, underscore, dollar sign, or hash mark.  No whitespace.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}A description of the registry. If description is not provided, there will not be any default value for this.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrytag">List&lt;Pulumi.<wbr>Aws<wbr>Native.<wbr>Glue.<wbr>Inputs.<wbr>Registry<wbr>Tag<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of tags to tag the Registry{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tags_go" style="color: inherit; text-decoration: inherit;">Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrytag">[]Registry<wbr>Tag<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}List of tags to tag the Registry{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tags_python" style="color: inherit; text-decoration: inherit;">tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrytag">Sequence[Registry<wbr>Tag<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of tags to tag the Registry{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>{{% md %}}Amazon Resource Name for the created Registry.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<h4 id="registrytag">Registry<wbr>Tag</h4>
