...
---
title: "Table"
title_tag: "aws-native.timestream.Table"
meta_desc: "Documentation for the aws-native.timestream.Table resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#databasename_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Name</a>
    ...
    <dd>{{% md %}}The name for the database which the table to be created belongs to.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tablename_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Name</a>
    ...
    <dd>{{% md %}}The name for the table. If you don't specify a name, AWS CloudFormation generates a unique physical ID and uses that ID for the table name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tabletag">List&lt;Pulumi.<wbr>Aws<wbr>Native.<wbr>Timestream.<wbr>Inputs.<wbr>Table<wbr>Tag<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The table name exposed as a read-only attribute.{{% /md %}}</dd></dl>
{{% /choosable %}}
