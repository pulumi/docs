...
title_tag: "gcp-native.binaryauthorization/v1.PolicyIamPolicy"
meta_desc: "Documentation for the gcp-native.binaryauthorization/v1.PolicyIamPolicy resource with examples, input properties, output properties, lookup functions, and supporting types."
---
