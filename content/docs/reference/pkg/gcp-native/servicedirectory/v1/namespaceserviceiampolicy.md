...
title_tag: "gcp-native.servicedirectory/v1.NamespaceServiceIamPolicy"
meta_desc: "Documentation for the gcp-native.servicedirectory/v1.NamespaceServiceIamPolicy resource with examples, input properties, output properties, lookup functions, and supporting types."
---
