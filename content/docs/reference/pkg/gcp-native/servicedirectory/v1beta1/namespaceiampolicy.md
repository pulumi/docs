...
title_tag: "gcp-native.servicedirectory/v1beta1.NamespaceIamPolicy"
meta_desc: "Documentation for the gcp-native.servicedirectory/v1beta1.NamespaceIamPolicy resource with examples, input properties, output properties, lookup functions, and supporting types."
---
