...
title_tag: "gcp-native.accesscontextmanager/v1.AccessPolicyServicePerimeter"
meta_desc: "Documentation for the gcp-native.accesscontextmanager/v1.AccessPolicyServicePerimeter resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">AccessPolicyServicePerimeter</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">access_policies_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">perimeter_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">service_perimeters_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_accesscontextmanager_v1.ServicePerimeterConfigArgs]</span> = None<span class="p">, </span><span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[_accesscontextmanager_v1.ServicePerimeterConfigArgs]</span> = None<span class="p">, </span><span class="nx">title</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">use_explicit_dry_run_spec</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceperimeterconfig">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Service<wbr>Perimeter<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#methodselectors_csharp" style="color: inherit; text-decoration: inherit;">Method<wbr>Selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#methodselector">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Method<wbr>Selector<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#method_selectors_python" style="color: inherit; text-decoration: inherit;">method_<wbr>selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#methodselector">Method<wbr>Selector<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}API methods or permissions to allow. Method or permission must belong to the service specified by `service_name` field. A single MethodSelector entry with `*` specified for the `method` field will allow all methods AND permissions for the service specified in `service_name`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#methodselectors_csharp" style="color: inherit; text-decoration: inherit;">Method<wbr>Selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#methodselectorresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Method<wbr>Selector<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#method_selectors_python" style="color: inherit; text-decoration: inherit;">method_<wbr>selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#methodselectorresponse">Method<wbr>Selector<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}API methods or permissions to allow. Method or permission must belong to the service specified by `service_name` field. A single MethodSelector entry with `*` specified for the `method` field will allow all methods AND permissions for the service specified in `service_name`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="service_name_python">
...
<a href="#egressfrom_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>From</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressfrom">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>From<wbr>Args</a></span>
    </dt>
...
<a href="#egressto_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressto">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>To<wbr>Args</a></span>
    </dt>
...
<a href="#egress_from_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>from</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressfrom">Egress<wbr>From<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines conditions on the source of a request causing this EgressPolicy to apply.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#egress_to_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressto">Egress<wbr>To<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and destination resources that cause this EgressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#egressfrom_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>From</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressfromresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>From<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#egressto_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresstoresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>To<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and destination resources that cause this EgressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#egress_from_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>from</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egressfromresponse">Egress<wbr>From<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines conditions on the source of a request causing this EgressPolicy to apply.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="egress_to_python">
<a href="#egress_to_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresstoresponse">Egress<wbr>To<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and destination resources that cause this EgressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#operations_csharp" style="color: inherit; text-decoration: inherit;">Operations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apioperation">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Api<wbr>Operation<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of ApiOperations that this egress rule applies to. A request matches if it contains an operation/service in this list.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
    ...
    <dd>{{% md %}}A list of resources, currently only projects in the form `projects/`, that match this to stanza. A request matches if it contains a resource in this list. If `*` is specified for resources, then this EgressTo rule will authorize access to all resources outside the perimeter.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#operations_python" style="color: inherit; text-decoration: inherit;">operations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apioperation">Api<wbr>Operation<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A list of ApiOperations that this egress rule applies to. A request matches if it contains an operation/service in this list.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#operations_csharp" style="color: inherit; text-decoration: inherit;">Operations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apioperationresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Api<wbr>Operation<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of ApiOperations that this egress rule applies to. A request matches if it contains an operation/service in this list.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resources_csharp">
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
</span>
...
<a href="#sources_csharp" style="color: inherit; text-decoration: inherit;">Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresssource">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>Source<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#sources_csharp" style="color: inherit; text-decoration: inherit;">Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresssourceresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>Source<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Sources that this IngressPolicy authorizes access from.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#sources_python" style="color: inherit; text-decoration: inherit;">sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresssourceresponse">Ingress<wbr>Source<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Sources that this IngressPolicy authorizes access from.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ingressfrom_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>From</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressfrom">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>From<wbr>Args</a></span>
    </dt>
...
<a href="#ingressto_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressto">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>To<wbr>Args</a></span>
    </dt>
...
<a href="#ingress_from_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>from</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressfrom">Ingress<wbr>From<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the source of a request causing this IngressPolicy to apply.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ingress_to_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressto">Ingress<wbr>To<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and request destination that cause this IngressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ingressfrom_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>From</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressfromresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>From<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#ingressto_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>To</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresstoresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>To<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and request destination that cause this IngressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ingress_from_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>from</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressfromresponse">Ingress<wbr>From<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the source of a request causing this IngressPolicy to apply.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ingress_to_python">
<a href="#ingress_to_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>to</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresstoresponse">Ingress<wbr>To<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Defines the conditions on the ApiOperation and request destination that cause this IngressPolicy to apply.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#accesslevel_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Level</a>
    ...
    <dd>{{% md %}}An AccessLevel resource name that allow resources within the ServicePerimeters to be accessed from the internet. AccessLevels listed must be in the same policy as this ServicePerimeter. Referencing a nonexistent AccessLevel will cause an error. If no AccessLevel names are listed, resources within the perimeter can only be accessed via Google Cloud calls with request origins within the perimeter. Example: `accessPolicies/MY_POLICY/accessLevels/MY_LEVEL`. If `*` is specified, then all IngressSources will be allowed.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resource_csharp">
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
</span>
...
<a href="#operations_csharp" style="color: inherit; text-decoration: inherit;">Operations</a>
    ...
    <dd>{{% md %}}A list of ApiOperations the sources specified in corresponding IngressFrom are allowed to perform in this ServicePerimeter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="resources_csharp">
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
</span>
    ...
    <dd>{{% md %}}A list of resources, currently only projects in the form `projects/`, protected by this ServicePerimeter that are allowed to be accessed by sources defined in the corresponding IngressFrom. A request matches if it contains a resource in this list. If `*` is specified for resources, then this IngressTo rule will authorize access to all resources inside the perimeter, provided that the request also matches the `operations` field.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#operations_csharp" style="color: inherit; text-decoration: inherit;">Operations</a>
    ...
    <dd>{{% md %}}A list of ApiOperations the sources specified in corresponding IngressFrom are allowed to perform in this ServicePerimeter.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resources_csharp">
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
</span>
...
<a href="#egresspolicies_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresspolicy">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>Policy<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#ingresspolicies_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresspolicy">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>Policy<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#vpcaccessibleservices_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Accessible<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpcaccessibleservices">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Vpc<wbr>Accessible<wbr>Services<wbr>Args</a></span>
    </dt>
...
<a href="#egress_policies_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresspolicy">Egress<wbr>Policy<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of EgressPolicies to apply to the perimeter. A perimeter may have multiple EgressPolicies, each of which is evaluated separately. Access is granted if any EgressPolicy grants it. Must be empty for a perimeter bridge.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ingress_policies_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresspolicy">Ingress<wbr>Policy<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of IngressPolicies to apply to the perimeter. A perimeter may have multiple IngressPolicies, each of which is evaluated separately. Access is granted if any Ingress Policy grants it. Must be empty for a perimeter bridge.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="resources_python">
...
<a href="#egresspolicies_csharp" style="color: inherit; text-decoration: inherit;">Egress<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresspolicyresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Egress<wbr>Policy<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#ingresspolicies_csharp" style="color: inherit; text-decoration: inherit;">Ingress<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresspolicyresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Ingress<wbr>Policy<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#vpcaccessibleservices_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Accessible<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpcaccessibleservicesresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Access<wbr>Context<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Vpc<wbr>Accessible<wbr>Services<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Configuration for APIs allowed within Perimeter.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#egress_policies_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#egresspolicyresponse">Egress<wbr>Policy<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of EgressPolicies to apply to the perimeter. A perimeter may have multiple EgressPolicies, each of which is evaluated separately. Access is granted if any EgressPolicy grants it. Must be empty for a perimeter bridge.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="ingress_policies_python">
<a href="#ingress_policies_python" style="color: inherit; text-decoration: inherit;">ingress_<wbr>policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingresspolicyresponse">Ingress<wbr>Policy<wbr>Response<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of IngressPolicies to apply to the perimeter. A perimeter may have multiple IngressPolicies, each of which is evaluated separately. Access is granted if any Ingress Policy grants it. Must be empty for a perimeter bridge.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resources_python">
