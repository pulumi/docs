...
title_tag: "gcp-native.bigqueryreservation/v1.CapacityCommitment"
meta_desc: "Documentation for the gcp-native.bigqueryreservation/v1.CapacityCommitment resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#failurestatus_csharp" style="color: inherit; text-decoration: inherit;">Failure<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statusresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Big<wbr>Query<wbr>Reservation.<wbr>V1.<wbr>Outputs.<wbr>Status<wbr>Response</a></span>
    </dt>
