...
title_tag: "gcp-native.compute/v1.GlobalNetworkEndpointGroup"
meta_desc: "Documentation for the gcp-native.compute/v1.GlobalNetworkEndpointGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
---
