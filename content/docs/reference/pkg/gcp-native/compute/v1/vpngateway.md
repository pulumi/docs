...
---
title: "VpnGateway"
title_tag: "gcp-native.compute/v1.VpnGateway"
meta_desc: "Documentation for the gcp-native.compute/v1.VpnGateway resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#vpninterfaces_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpngatewayvpngatewayinterface">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Inputs.<wbr>Vpn<wbr>Gateway<wbr>Vpn<wbr>Gateway<wbr>Interface<wbr>Args&gt;</a></span>
    </dt>
