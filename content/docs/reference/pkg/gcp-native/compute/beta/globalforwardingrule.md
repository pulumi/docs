...
title_tag: "gcp-native.compute/beta.GlobalForwardingRule"
meta_desc: "Documentation for the gcp-native.compute/beta.GlobalForwardingRule resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#servicedirectoryregistrations_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Directory<wbr>Registrations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#forwardingruleservicedirectoryregistration">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Forwarding<wbr>Rule<wbr>Service<wbr>Directory<wbr>Registration<wbr>Args&gt;</a></span>
    </dt>
