...
title_tag: "gcp-native.compute/beta.RegionInstanceGroupManager"
meta_desc: "Documentation for the gcp-native.compute/beta.RegionInstanceGroupManager resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
The RegionInstanceGroupManager resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
