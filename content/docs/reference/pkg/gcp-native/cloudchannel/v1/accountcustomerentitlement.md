...
---
title: "AccountCustomerEntitlement"
title_tag: "gcp-native.cloudchannel/v1.AccountCustomerEntitlement"
meta_desc: "Documentation for the gcp-native.cloudchannel/v1.AccountCustomerEntitlement resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
## Create a AccountCustomerEntitlement Resource {#create}
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">AccountCustomerEntitlement</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">accounts_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">association_info</span><span class="p">:</span> <span class="nx">Optional[_cloudchannel_v1.GoogleCloudChannelV1AssociationInfoArgs]</span> = None<span class="p">, </span><span class="nx">commitment_settings</span><span class="p">:</span> <span class="nx">Optional[_cloudchannel_v1.GoogleCloudChannelV1CommitmentSettingsArgs]</span> = None<span class="p">, </span><span class="nx">customers_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">entitlements_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">offer</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">parameters</span><span class="p">:</span> <span class="nx">Optional[Sequence[_cloudchannel_v1.GoogleCloudChannelV1ParameterArgs]]</span> = None<span class="p">, </span><span class="nx">purchase_order_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">request_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
## AccountCustomerEntitlement Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Programming Model docs.

### Inputs

The AccountCustomerEntitlement resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#customersid_csharp" style="color: inherit; text-decoration: inherit;">Customers<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="entitlementsid_csharp">
<a href="#entitlementsid_csharp" style="color: inherit; text-decoration: inherit;">Entitlements<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#associationinfo_csharp" style="color: inherit; text-decoration: inherit;">Association<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1associationinfo">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Association<wbr>Info<wbr>Args</a></span>
    </dt>
...
<a href="#commitmentsettings_csharp" style="color: inherit; text-decoration: inherit;">Commitment<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1commitmentsettings">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Commitment<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1parameter">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Parameter<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#customersid_go" style="color: inherit; text-decoration: inherit;">Customers<wbr>Id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="entitlementsid_go">
<a href="#entitlementsid_go" style="color: inherit; text-decoration: inherit;">Entitlements<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#associationinfo_go" style="color: inherit; text-decoration: inherit;">Association<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1associationinfo">Google<wbr>Cloud<wbr>Channel<wbr>V1Association<wbr>Info</a></span>
    </dt>
    <dd>{{% md %}}Association information to other entitlements.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#commitmentsettings_go" style="color: inherit; text-decoration: inherit;">Commitment<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1commitmentsettings">Google<wbr>Cloud<wbr>Channel<wbr>V1Commitment<wbr>Settings</a></span>
    </dt>
    <dd>{{% md %}}Commitment settings for a commitment-based Offer. Required for commitment based offers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="offer_go">
...
<a href="#parameters_go" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1parameter">[]Google<wbr>Cloud<wbr>Channel<wbr>V1Parameter</a></span>
    </dt>
    <dd>{{% md %}}Extended entitlement parameters. When creating an entitlement, valid parameters' names and values are defined in the offer's parameter definitions.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#customers_id_python" style="color: inherit; text-decoration: inherit;">customers_<wbr>id</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="entitlements_id_python">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the AccountCustomerEntitlement resource produces the following output properties:
...
<a href="#provisionedservice_csharp" style="color: inherit; text-decoration: inherit;">Provisioned<wbr>Service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1provisionedserviceresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Provisioned<wbr>Service<wbr>Response</a></span>
    </dt>
...
<a href="#trialsettings_csharp" style="color: inherit; text-decoration: inherit;">Trial<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1trialsettingsresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Trial<wbr>Settings<wbr>Response</a></span>
    </dt>
...
<a href="#renewalsettings_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1renewalsettings">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Renewal<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a href="#renewalsettings_csharp" style="color: inherit; text-decoration: inherit;">Renewal<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1renewalsettingsresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Renewal<wbr>Settings<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1value">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Value<wbr>Args</a></span>
    </dt>
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1valueresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Value<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Value of the parameter.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#paymentcycle_csharp" style="color: inherit; text-decoration: inherit;">Payment<wbr>Cycle</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1period">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Period<wbr>Args</a></span>
    </dt>
...
<a href="#paymentcycle_csharp" style="color: inherit; text-decoration: inherit;">Payment<wbr>Cycle</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudchannelv1periodresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Channel.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Channel<wbr>V1Period<wbr>Response<wbr>Args</a></span>
    </dt>
