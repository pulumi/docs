...
---
title: "Service"
title_tag: "gcp-native.metastore/v1alpha.Service"
meta_desc: "Documentation for the gcp-native.metastore/v1alpha.Service resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Service</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">hive_metastore_config</span><span class="p">:</span> <span class="nx">Optional[_metastore_v1alpha.HiveMetastoreConfigArgs]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">maintenance_window</span><span class="p">:</span> <span class="nx">Optional[_metastore_v1alpha.MaintenanceWindowArgs]</span> = None<span class="p">, </span><span class="nx">metadata_integration</span><span class="p">:</span> <span class="nx">Optional[_metastore_v1alpha.MetadataIntegrationArgs]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">network</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">port</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">release_channel</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">services_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">tier</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#hivemetastoreconfig_csharp" style="color: inherit; text-decoration: inherit;">Hive<wbr>Metastore<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hivemetastoreconfig">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Hive<wbr>Metastore<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#maintenancewindow_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maintenancewindow">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Maintenance<wbr>Window<wbr>Args</a></span>
    </dt>
...
<a href="#metadataintegration_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Integration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadataintegration">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Metadata<wbr>Integration<wbr>Args</a></span>
    </dt>
...
<a href="#metadatamanagementactivity_csharp" style="color: inherit; text-decoration: inherit;">Metadata<wbr>Management<wbr>Activity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadatamanagementactivityresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Outputs.<wbr>Metadata<wbr>Management<wbr>Activity<wbr>Response</a></span>
    </dt>
...
<a href="#kerberosconfig_csharp" style="color: inherit; text-decoration: inherit;">Kerberos<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kerberosconfig">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Kerberos<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#keytab_csharp" style="color: inherit; text-decoration: inherit;">Keytab</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secret">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Secret<wbr>Args</a></span>
    </dt>
...
<a href="#datacatalogconfig_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Catalog<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datacatalogconfig">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Inputs.<wbr>Data<wbr>Catalog<wbr>Config<wbr>Args</a></span>
    </dt>
