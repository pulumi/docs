...
---
title: "Deployment"
title_tag: "gcp-native.deploymentmanager/v2beta.Deployment"
meta_desc: "Documentation for the gcp-native.deploymentmanager/v2beta.Deployment resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Deployment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">deployment</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">fingerprint</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">insert_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Sequence[_deploymentmanager_v2beta.DeploymentLabelEntryArgs]]</span> = None<span class="p">, </span><span class="nx">manifest</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">operation</span><span class="p">:</span> <span class="nx">Optional[_deploymentmanager_v2beta.OperationArgs]</span> = None<span class="p">, </span><span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">self_link</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">target</span><span class="p">:</span> <span class="nx">Optional[_deploymentmanager_v2beta.TargetConfigurationArgs]</span> = None<span class="p">, </span><span class="nx">update</span><span class="p">:</span> <span class="nx">Optional[_deploymentmanager_v2beta.DeploymentUpdateArgs]</span> = None<span class="p">, </span><span class="nx">update_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deploymentlabelentry">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Deployment<wbr>Label<wbr>Entry<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#operation_csharp" style="color: inherit; text-decoration: inherit;">Operation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operation">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Operation<wbr>Args</a></span>
    </dt>
...
<a href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#targetconfiguration">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Target<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#update_csharp" style="color: inherit; text-decoration: inherit;">Update</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deploymentupdate">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Deployment<wbr>Update<wbr>Args</a></span>
    </dt>
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deploymentupdatelabelentry">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Deployment<wbr>Update<wbr>Label<wbr>Entry<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Map of One Platform labels; provided by the client when the resource is created or updated. Specifically: Label keys must be between 1 and 63 characters long and must conform to the following regular expression: `[a-z]([-a-z0-9]*[a-z0-9])?` Label values must be between 0 and 63 characters long and must conform to the regular expression `([a-z]([-a-z0-9]*[a-z0-9])?)?`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="manifest_csharp">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deploymentupdatelabelentryresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Deployment<wbr>Update<wbr>Label<wbr>Entry<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configfile">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Config<wbr>File<wbr>Args</a></span>
    </dt>
...
<a href="#imports_csharp" style="color: inherit; text-decoration: inherit;">Imports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importfile">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Import<wbr>File<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configfileresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Config<wbr>File<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#imports_csharp" style="color: inherit; text-decoration: inherit;">Imports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#importfileresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Deployment<wbr>Manager.<wbr>V2Beta.<wbr>Inputs.<wbr>Import<wbr>File<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies any files to import for this configuration. This can be used to import templates or other files. For example, you might import a text file in order to use the file in a template.{{% /md %}}</dd></dl>
{{% /choosable %}}
