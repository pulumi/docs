...
---
title: "Secret"
title_tag: "gcp-native.secretmanager/v1.Secret"
meta_desc: "Documentation for the gcp-native.secretmanager/v1.Secret resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Secret</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">expire_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">replication</span><span class="p">:</span> <span class="nx">Optional[_secretmanager_v1.ReplicationArgs]</span> = None<span class="p">, </span><span class="nx">rotation</span><span class="p">:</span> <span class="nx">Optional[_secretmanager_v1.RotationArgs]</span> = None<span class="p">, </span><span class="nx">secrets_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">topics</span><span class="p">:</span> <span class="nx">Optional[Sequence[_secretmanager_v1.TopicArgs]]</span> = None<span class="p">, </span><span class="nx">ttl</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#replication_csharp" style="color: inherit; text-decoration: inherit;">Replication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replication">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Replication<wbr>Args</a></span>
    </dt>
...
<a href="#rotation_csharp" style="color: inherit; text-decoration: inherit;">Rotation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rotation">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Rotation<wbr>Args</a></span>
    </dt>
...
<a href="#topics_csharp" style="color: inherit; text-decoration: inherit;">Topics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#topic">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Topic<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#customermanagedencryption_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Managed<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customermanagedencryption">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Customer<wbr>Managed<wbr>Encryption<wbr>Args</a></span>
    </dt>
...
<a href="#customermanagedencryption_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Managed<wbr>Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customermanagedencryptionresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Customer<wbr>Managed<wbr>Encryption<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Optional. The customer-managed encryption configuration of the Secret. If no configuration is provided, Google-managed default encryption is used. Updates to the Secret encryption configuration only apply to SecretVersions added afterwards. They do not apply retroactively to existing SecretVersions.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#automatic_csharp" style="color: inherit; text-decoration: inherit;">Automatic</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#automatic">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Automatic<wbr>Args</a></span>
    </dt>
...
<a href="#usermanaged_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Managed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usermanaged">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>User<wbr>Managed<wbr>Args</a></span>
    </dt>
...
<a href="#automatic_csharp" style="color: inherit; text-decoration: inherit;">Automatic</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#automaticresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Automatic<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#usermanaged_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Managed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usermanagedresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>User<wbr>Managed<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The Secret will only be replicated into the locations specified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replica">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Replica<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#replicaresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Secret<wbr>Manager.<wbr>V1.<wbr>Inputs.<wbr>Replica<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Required. The list of Replicas for this Secret. Cannot be empty.{{% /md %}}</dd></dl>
{{% /choosable %}}
