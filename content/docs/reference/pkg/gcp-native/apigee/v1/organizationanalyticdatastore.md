...
title_tag: "gcp-native.apigee/v1.OrganizationAnalyticDatastore"
meta_desc: "Documentation for the gcp-native.apigee/v1.OrganizationAnalyticDatastore resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">OrganizationAnalyticDatastore</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">datastore_config</span><span class="p">:</span> <span class="nx">Optional[_apigee_v1.GoogleCloudApigeeV1DatastoreConfigArgs]</span> = None<span class="p">, </span><span class="nx">datastores_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">display_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">organizations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">target_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#datastoreconfig_csharp" style="color: inherit; text-decoration: inherit;">Datastore<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlecloudapigeev1datastoreconfig">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Apigee.<wbr>V1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Apigee<wbr>V1Datastore<wbr>Config<wbr>Args</a></span>
    </dt>
