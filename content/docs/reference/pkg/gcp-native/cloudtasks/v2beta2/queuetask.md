...
---
title: "QueueTask"
title_tag: "gcp-native.cloudtasks/v2beta2.QueueTask"
meta_desc: "Documentation for the gcp-native.cloudtasks/v2beta2.QueueTask resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">QueueTask</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">app_engine_http_request</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.AppEngineHttpRequestArgs]</span> = None<span class="p">, </span><span class="nx">create_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">pull_message</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.PullMessageArgs]</span> = None<span class="p">, </span><span class="nx">queues_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">response_view</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">schedule_time</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[_cloudtasks_v2beta2.TaskStatusArgs]</span> = None<span class="p">, </span><span class="nx">tasks_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">view</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#appenginehttprequest_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Engine<wbr>Http<wbr>Request</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appenginehttprequest">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>App<wbr>Engine<wbr>Http<wbr>Request<wbr>Args</a></span>
    </dt>
...
<a href="#pullmessage_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Message</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pullmessage">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Pull<wbr>Message<wbr>Args</a></span>
    </dt>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#taskstatus">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Task<wbr>Status<wbr>Args</a></span>
    </dt>
...
<a href="#responsestatus_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#status">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Status<wbr>Args</a></span>
    </dt>
...
<a href="#responsestatus_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#statusresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Status<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#firstattemptstatus_csharp" style="color: inherit; text-decoration: inherit;">First<wbr>Attempt<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attemptstatus">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Attempt<wbr>Status<wbr>Args</a></span>
    </dt>
...
<a href="#firstattemptstatus_csharp" style="color: inherit; text-decoration: inherit;">First<wbr>Attempt<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attemptstatusresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Cloud<wbr>Tasks.<wbr>V2Beta2.<wbr>Inputs.<wbr>Attempt<wbr>Status<wbr>Response<wbr>Args</a></span>
    </dt>
