...
title_tag: "gcp-native.dialogflow/v3.AgentFlowVersion"
meta_desc: "Documentation for the gcp-native.dialogflow/v3.AgentFlowVersion resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#nlusettings_csharp" style="color: inherit; text-decoration: inherit;">Nlu<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3nlusettingsresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Nlu<wbr>Settings<wbr>Response</a></span>
    </dt>
