...
---
title: "Agent"
title_tag: "gcp-native.dialogflow/v3.Agent"
meta_desc: "Documentation for the gcp-native.dialogflow/v3.Agent resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<a href="#speechtotextsettings_csharp" style="color: inherit; text-decoration: inherit;">Speech<wbr>To<wbr>Text<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3speechtotextsettings">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Speech<wbr>To<wbr>Text<wbr>Settings<wbr>Args</a></span>
    </dt>
