...
---
title: "Membership"
title_tag: "gcp-native.gkehub/v1alpha2.Membership"
meta_desc: "Documentation for the gcp-native.gkehub/v1alpha2.Membership resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Membership</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">authority</span><span class="p">:</span> <span class="nx">Optional[_gkehub_v1alpha2.AuthorityArgs]</span> = None<span class="p">, </span><span class="nx">endpoint</span><span class="p">:</span> <span class="nx">Optional[_gkehub_v1alpha2.MembershipEndpointArgs]</span> = None<span class="p">, </span><span class="nx">external_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">infrastructure_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">memberships_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#authority_csharp" style="color: inherit; text-decoration: inherit;">Authority</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authority">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Authority<wbr>Args</a></span>
    </dt>
...
<a href="#endpoint_csharp" style="color: inherit; text-decoration: inherit;">Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#membershipendpoint">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Membership<wbr>Endpoint<wbr>Args</a></span>
    </dt>
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#membershipstateresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Outputs.<wbr>Membership<wbr>State<wbr>Response</a></span>
    </dt>
...
<a href="#resourceoptions_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceoptions">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Resource<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#connectresources_csharp" style="color: inherit; text-decoration: inherit;">Connect<wbr>Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcemanifestresponse">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Resource<wbr>Manifest<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#resourceoptions_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceoptionsresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Resource<wbr>Options<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Optional. Options for Kubernetes resource generation.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#gkecluster_csharp" style="color: inherit; text-decoration: inherit;">Gke<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gkecluster">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Gke<wbr>Cluster<wbr>Args</a></span>
    </dt>
...
<a href="#kubernetesresource_csharp" style="color: inherit; text-decoration: inherit;">Kubernetes<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesresource">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Kubernetes<wbr>Resource<wbr>Args</a></span>
    </dt>
...
<a href="#gkecluster_csharp" style="color: inherit; text-decoration: inherit;">Gke<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gkeclusterresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Gke<wbr>Cluster<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#kubernetesmetadata_csharp" style="color: inherit; text-decoration: inherit;">Kubernetes<wbr>Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesmetadataresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Kubernetes<wbr>Metadata<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#kubernetesresource_csharp" style="color: inherit; text-decoration: inherit;">Kubernetes<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesresourceresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>GKEHub.<wbr>V1Alpha2.<wbr>Inputs.<wbr>Kubernetes<wbr>Resource<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.{{% /md %}}</dd></dl>
{{% /choosable %}}
