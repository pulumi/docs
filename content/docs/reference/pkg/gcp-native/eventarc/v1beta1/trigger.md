...
---
title: "Trigger"
title_tag: "gcp-native.eventarc/v1beta1.Trigger"
meta_desc: "Documentation for the gcp-native.eventarc/v1beta1.Trigger resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Trigger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">destination</span><span class="p">:</span> <span class="nx">Optional[_eventarc_v1beta1.DestinationArgs]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">matching_criteria</span><span class="p">:</span> <span class="nx">Optional[Sequence[_eventarc_v1beta1.MatchingCriteriaArgs]]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">service_account</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">triggers_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#destination">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Inputs.<wbr>Destination<wbr>Args</a></span>
    </dt>
...
<a href="#matchingcriteria_csharp" style="color: inherit; text-decoration: inherit;">Matching<wbr>Criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#matchingcriteria">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Inputs.<wbr>Matching<wbr>Criteria<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Required. null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#matchingcriteria_go" style="color: inherit; text-decoration: inherit;">Matching<wbr>Criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#matchingcriteria">[]Matching<wbr>Criteria</a></span>
    </dt>
    <dd>{{% md %}}Required. null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_go">
...
<a href="#transport_csharp" style="color: inherit; text-decoration: inherit;">Transport</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transportresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Outputs.<wbr>Transport<wbr>Response</a></span>
    </dt>
...
<a href="#cloudrunservice_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Run<wbr>Service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunservice">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Inputs.<wbr>Cloud<wbr>Run<wbr>Service<wbr>Args</a></span>
    </dt>
...
<a href="#cloud_run_service_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>run_<wbr>service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunservice">Cloud<wbr>Run<wbr>Service<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project as the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cloudrunservice_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Run<wbr>Service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunserviceresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Inputs.<wbr>Cloud<wbr>Run<wbr>Service<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project as the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cloud_run_service_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>run_<wbr>service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunserviceresponse">Cloud<wbr>Run<wbr>Service<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project as the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#attribute_csharp" style="color: inherit; text-decoration: inherit;">Attribute</a>
    ...
    <dd>{{% md %}}Required. The name of a CloudEvents attribute. Currently, only a subset of attributes can be specified. All triggers MUST provide a matching criteria for the 'type' attribute.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pubsub_csharp" style="color: inherit; text-decoration: inherit;">Pubsub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Inputs.<wbr>Pubsub<wbr>Response<wbr>Args</a></span>
    </dt>
