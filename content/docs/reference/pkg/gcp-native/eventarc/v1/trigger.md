...
---
title: "Trigger"
title_tag: "gcp-native.eventarc/v1.Trigger"
meta_desc: "Documentation for the gcp-native.eventarc/v1.Trigger resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">Trigger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">destination</span><span class="p">:</span> <span class="nx">Optional[_eventarc_v1.DestinationArgs]</span> = None<span class="p">, </span><span class="nx">event_filters</span><span class="p">:</span> <span class="nx">Optional[Sequence[_eventarc_v1.EventFilterArgs]]</span> = None<span class="p">, </span><span class="nx">labels</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">service_account</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">transport</span><span class="p">:</span> <span class="nx">Optional[_eventarc_v1.TransportArgs]</span> = None<span class="p">, </span><span class="nx">triggers_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#destination">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Destination<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Required. Destination specifies where the events should be sent to.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="eventfilters_csharp">
<a href="#eventfilters_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Filters</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventfilter">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Event<wbr>Filter<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Required. null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Required. The resource name of the trigger. Must be unique within the location on the project and must be in `projects/{project}/locations/{location}/triggers/{trigger}` format.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transport_csharp" style="color: inherit; text-decoration: inherit;">Transport</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transport">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Transport<wbr>Args</a></span>
    </dt>
...
<a href="#eventfilters_go" style="color: inherit; text-decoration: inherit;">Event<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventfilter">[]Event<wbr>Filter</a></span>
    </dt>
    <dd>{{% md %}}Required. null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="labels_go">
...
<a href="#transport_go" style="color: inherit; text-decoration: inherit;">Transport</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transport">Transport</a></span>
    </dt>
    <dd>{{% md %}}Optional. In order to deliver messages, Eventarc may use other GCP products as transport intermediary. This field contains a reference to that transport intermediary. This information can be used for debugging purposes.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd>{{% md %}}Optional. The relative path on the Cloud Run service the events should be sent to. The value must conform to the definition of URI path segment (section 3.3 of RFC2396). Examples: "/route", "route", "route/subroute".{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}Required. The region the Cloud Run service is deployed in.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#service_csharp" style="color: inherit; text-decoration: inherit;">Service</a>
    ...
    <dd>{{% md %}}Required. The name of the Cloud Run service being addressed. See https://cloud.google.com/run/docs/reference/rest/v1/namespaces.services. Only services located in the same project of the trigger object can be addressed.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}Required. The region the Cloud Run service is deployed in.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="service_csharp">
<a href="#service_csharp" style="color: inherit; text-decoration: inherit;">Service</a>
</span>
...
<a href="#cloudrun_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Run</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrun">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Cloud<wbr>Run<wbr>Args</a></span>
    </dt>
...
<a href="#cloud_run_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>run</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrun">Cloud<wbr>Run<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project of the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cloudrun_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>Run</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Cloud<wbr>Run<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project of the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cloud_run_python" style="color: inherit; text-decoration: inherit;">cloud_<wbr>run</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudrunresponse">Cloud<wbr>Run<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cloud Run fully-managed service that receives the events. The service should be running in the same project of the trigger.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#attribute_csharp" style="color: inherit; text-decoration: inherit;">Attribute</a>
    ...
    <dd>{{% md %}}Required. The name of a CloudEvents attribute. Currently, only a subset of attributes are supported for filtering. All triggers MUST provide a filter for the 'type' attribute.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}Required. The value for the attribute.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#attribute_csharp" style="color: inherit; text-decoration: inherit;">Attribute</a>
    ...
    <dd>{{% md %}}Required. The name of a CloudEvents attribute. Currently, only a subset of attributes are supported for filtering. All triggers MUST provide a filter for the 'type' attribute.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="value_csharp">
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
</span>
...
<a href="#pubsub_csharp" style="color: inherit; text-decoration: inherit;">Pubsub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsub">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Pubsub<wbr>Args</a></span>
    </dt>
...
<a href="#pubsub_python" style="color: inherit; text-decoration: inherit;">pubsub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsub">Pubsub<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The Pub/Sub topic and subscription used by Eventarc as delivery intermediary.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#pubsub_csharp" style="color: inherit; text-decoration: inherit;">Pubsub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Inputs.<wbr>Pubsub<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The Pub/Sub topic and subscription used by Eventarc as delivery intermediary.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#pubsub_python" style="color: inherit; text-decoration: inherit;">pubsub</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubresponse">Pubsub<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The Pub/Sub topic and subscription used by Eventarc as delivery intermediary.{{% /md %}}</dd></dl>
{{% /choosable %}}
