...
title_tag: "gcp-native.healthcare/v1beta1.DatasetConsentStoreConsentArtifact"
meta_desc: "Documentation for the gcp-native.healthcare/v1beta1.DatasetConsentStoreConsentArtifact resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx">DatasetConsentStoreConsentArtifact</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">consent_artifacts_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">consent_content_screenshots</span><span class="p">:</span> <span class="nx">Optional[Sequence[_healthcare_v1beta1.ImageArgs]]</span> = None<span class="p">, </span><span class="nx">consent_content_version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">consent_stores_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">datasets_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">guardian_signature</span><span class="p">:</span> <span class="nx">Optional[_healthcare_v1beta1.SignatureArgs]</span> = None<span class="p">, </span><span class="nx">locations_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">projects_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">user_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">user_signature</span><span class="p">:</span> <span class="nx">Optional[_healthcare_v1beta1.SignatureArgs]</span> = None<span class="p">, </span><span class="nx">witness_signature</span><span class="p">:</span> <span class="nx">Optional[_healthcare_v1beta1.SignatureArgs]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#consentcontentscreenshots_csharp" style="color: inherit; text-decoration: inherit;">Consent<wbr>Content<wbr>Screenshots</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">List&lt;Pulumi.<wbr>Gcp<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Inputs.<wbr>Image<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#guardiansignature_csharp" style="color: inherit; text-decoration: inherit;">Guardian<wbr>Signature</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#signature">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Inputs.<wbr>Signature<wbr>Args</a></span>
    </dt>
...
<a href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Inputs.<wbr>Image<wbr>Args</a></span>
    </dt>
...
<a href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imageresponse">Pulumi.<wbr>Gcp<wbr>Native.<wbr>Healthcare.<wbr>V1Beta1.<wbr>Inputs.<wbr>Image<wbr>Response<wbr>Args</a></span>
    </dt>
