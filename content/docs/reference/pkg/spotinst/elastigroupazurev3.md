...
<a href="#customs_nodejs" style="color: inherit; text-decoration: inherit;">customs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elastigroupazurev3imagecustom">Elastigroup<wbr>Azure<wbr>V3Image<wbr>Custom<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#marketplaces_nodejs" style="color: inherit; text-decoration: inherit;">marketplaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elastigroupazurev3imagemarketplace">Elastigroup<wbr>Azure<wbr>V3Image<wbr>Marketplace<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#networkinterfaces_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elastigroupazurev3networknetworkinterface">Elastigroup<wbr>Azure<wbr>V3Network<wbr>Network<wbr>Interface<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resourcegroupname_nodejs">
