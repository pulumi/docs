...
<a href="#namedports_nodejs" style="color: inherit; text-decoration: inherit;">named<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#oceanimportbackendservicenamedport">Ocean<wbr>Import<wbr>Backend<wbr>Service<wbr>Named<wbr>Port<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tasks_nodejs" style="color: inherit; text-decoration: inherit;">tasks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#oceanimportscheduledtasktask">Ocean<wbr>Import<wbr>Scheduled<wbr>Task<wbr>Task<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}The scheduling tasks for the cluster.
{{% /md %}}</dd></dl>
{{% /choosable %}}
