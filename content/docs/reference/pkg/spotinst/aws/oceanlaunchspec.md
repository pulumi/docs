...
<span class="k">def </span><span class="nx">OceanLaunchSpec</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">resource_limits</span><span class="p">:</span> <span class="nx">Optional[Sequence[OceanLaunchSpecResourceLimitArgs]]</span> = None<span class="p">,</span>
...
<a href="#oceanid_csharp" style="color: inherit; text-decoration: inherit;">Ocean<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the Ocean cluster.
...
<a href="#autoscaleheadrooms_csharp" style="color: inherit; text-decoration: inherit;">Autoscale<wbr>Headrooms</a>
    ...
    <dd>{{% md %}}Set custom headroom per Virtual Node Group. Provide a list of headrooms object.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#elasticippools_csharp" style="color: inherit; text-decoration: inherit;">Elastic<wbr>Ip<wbr>Pools</a>
    ...
    <dd>{{% md %}}Assign an Elastic IP to the instances spun by the Virtual Node Group. Can be null.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#instancetypes_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Types</a>
    ...
    <dd>{{% md %}}A list of instance types allowed to be provisioned for pods pending under the specified launch specification. The list overrides the list defined for the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the Virtual Node Group.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#restrictscaledown_csharp" style="color: inherit; text-decoration: inherit;">Restrict<wbr>Scale<wbr>Down</a>
    ...
    <dd>{{% md %}}Boolean. When set to `True`, nodes will be treated as if all pods running have the restrict-scale-down label. Therefore, Ocean will not scale nodes down unless empty.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#elasticippools_nodejs" style="color: inherit; text-decoration: inherit;">elastic<wbr>Ip<wbr>Pools</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#oceanlaunchspecelasticippool">Ocean<wbr>Launch<wbr>Spec<wbr>Elastic<wbr>Ip<wbr>Pool<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}Assign an Elastic IP to the instances spun by the Virtual Node Group. Can be null.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcelimits_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Limits</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#oceanlaunchspecresourcelimit">Ocean<wbr>Launch<wbr>Spec<wbr>Resource<wbr>Limit<wbr>Args[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tagselector_csharp" style="color: inherit; text-decoration: inherit;">Tag<wbr>Selector</a>
    ...
    <dd>{{% md %}}A key-value pair, which defines an Elastic IP from the customer pool. Can be null.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tagkey_csharp" style="color: inherit; text-decoration: inherit;">Tag<wbr>Key</a>
    ...
    <dd>{{% md %}}Elastic IP tag key. The Virtual Node Group will consider all Elastic IPs tagged with this tag as a part of the Elastic IP pool to use.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#spotpercentage_csharp" style="color: inherit; text-decoration: inherit;">Spot<wbr>Percentage</a>
    ...
    <dd>{{% md %}}When set, Ocean will proactively try to maintain as close as possible to the percentage of Spot instances out of all the Virtual Node Group instances.
{{% /md %}}</dd></dl>
{{% /choosable %}}
