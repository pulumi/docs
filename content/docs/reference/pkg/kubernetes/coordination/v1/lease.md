...
---
title: "Lease"
title_tag: "Resource Lease | Module coordination.k8s.io/v1 | Package Kubernetes"
meta_desc: "Explore the Lease resource of the coordination.k8s.io/v1 module, including examples, input properties, output properties, lookup functions, and supporting types. Lease defines a lease concept."
---
