...
<span class="k">def </span><span class="nx">Event</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">deprecated_count</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
          <span class="nx">deprecated_first_timestamp</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">deprecated_last_timestamp</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">deprecated_source</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.EventSourceArgs]]</span> = None<span class="p">,</span>
          ...
          <span class="nx">regarding</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.ObjectReferenceArgs]]</span> = None<span class="p">,</span>
          <span class="nx">related</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.ObjectReferenceArgs]]</span> = None<span class="p">,</span>
          <span class="nx">reporting_controller</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">reporting_instance</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">series</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_events_k8s_io_v1.EventSeriesArgs]]</span> = None<span class="p">,</span>
...
<a href="#deprecatedsource_nodejs" style="color: inherit; text-decoration: inherit;">deprecated<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventsource">pulumi.<wbr>Input<core.v1.<wbr>Event<wbr>Source<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}deprecatedSource is the deprecated field assuring backward compatibility with core.v1 Event type.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#series_nodejs" style="color: inherit; text-decoration: inherit;">series</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventseries">pulumi.<wbr>Input<Event<wbr>Series<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}series is data about the Event series this event represents or nil if it's a singleton Event.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_nodejs">
