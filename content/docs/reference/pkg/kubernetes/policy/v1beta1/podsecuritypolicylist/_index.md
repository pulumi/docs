...
<span class="k">def </span><span class="nx">PodSecurityPolicyList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                          <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[PodSecurityPolicyArgs]]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">PodSecurityPolicyList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">PodSecurityPolicyListArgs</a></span><span class="p">,</span>
                          <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPodSecurityPolicyList</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">PodSecurityPolicyListArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PodSecurityPolicyList</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsecuritypolicy">[]Pod<wbr>Security<wbr>Policy<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}items is a list of schema objects.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="metadata_go">
...
<a href="#items_python" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsecuritypolicy">Sequence[Pod<wbr>Security<wbr>Policy<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}items is a list of schema objects.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedflexvolumes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Flex<wbr>Volumes</a>
    ...
    <dd>{{% md %}}allowedFlexVolumes is an allowlist of Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedhostpaths_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Host<wbr>Paths</a>
    ...
    <dd>{{% md %}}allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedprocmounttypes_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Proc<wbr>Mount<wbr>Types</a>
    ...
    <dd>{{% md %}}AllowedProcMountTypes is an allowlist of allowed ProcMountTypes. Empty or nil indicates that only the DefaultProcMountType may be used. This requires the ProcMountType feature flag to be enabled.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
Examples: e.g. "foo/*" allows "foo/bar", "foo/baz", etc. e.g. "foo.*" allows "foo.bar", "foo.baz", etc.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
Examples: e.g. "foo/*" forbids "foo/bar", "foo/baz", etc. e.g. "foo.*" forbids "foo.bar", "foo.baz", etc.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#volumes_csharp" style="color: inherit; text-decoration: inherit;">Volumes</a>
    ...
    <dd>{{% md %}}volumes is an allowlist of volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use '*'.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#allowedruntimeclassnames_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Runtime<wbr>Class<wbr>Names</a>
    ...
    <dd>{{% md %}}allowedRuntimeClassNames is an allowlist of RuntimeClass names that may be specified on a pod. A value of "*" means that any RuntimeClass name is allowed, and must be the only item in the list. An empty list requires the RuntimeClassName field to be unset.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
