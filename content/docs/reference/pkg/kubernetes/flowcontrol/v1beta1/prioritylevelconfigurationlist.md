...
<span class="k">def </span><span class="nx">PriorityLevelConfigurationList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   ...
                                   <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_flowcontrol_apiserver_k8s_io_v1beta1.PriorityLevelConfigurationArgs]]</span> = None<span class="p">,</span>
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfiguration">[]Priority<wbr>Level<wbr>Configuration<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}`items` is a list of request-priorities.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="metadata_go">
