...
## PriorityLevelConfigurationList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The PriorityLevelConfigurationList resource does not produce any additional output properties.
