...
<span class="k">def </span><span class="nx">VolumeAttachmentList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                         ...
                         <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_storage_k8s_io_v1alpha1.VolumeAttachmentArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumeattachment">pulumi.<wbr>Input<pulumi.<wbr>Input<Volume<wbr>Attachment<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Items is the list of VolumeAttachments{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#status_nodejs" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumeattachmentstatus">pulumi.<wbr>Input<Volume<wbr>Attachment<wbr>Status<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.{{% /md %}}</dd></dl>
{{% /choosable %}}
