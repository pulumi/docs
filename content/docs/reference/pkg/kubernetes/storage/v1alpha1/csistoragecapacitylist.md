...
<span class="k">def </span><span class="nx">CSIStorageCapacityList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_storage_k8s_io_v1alpha1.CSIStorageCapacityArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#csistoragecapacity">pulumi.<wbr>Input<pulumi.<wbr>Input<CSIStorage<wbr>Capacity<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Items is the list of CSIStorageCapacity objects.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
