...
<span class="k">def </span><span class="nx">CSIDriverList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_storage_k8s_io_v1.CSIDriverArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#csidriver">pulumi.<wbr>Input<pulumi.<wbr>Input<CSIDriver<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}items is the list of CSIDriver{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
