...
---
title: "CSINodeList"
title_tag: "Resource CSINodeList | Module storage.k8s.io/v1beta1 | Package Kubernetes"
meta_desc: "Explore the CSINodeList resource of the storage.k8s.io/v1beta1 module, including examples, input properties, output properties, lookup functions, and supporting types. CSINodeList is a collection of CSINode objects."
---
...
The CSINodeList resource accepts the following [input]({{< relref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
