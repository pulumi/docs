...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the CertificateSigningRequest resource produces the following computed outputs.
