...
<span class="k">def </span><span class="nx">CertificateSigningRequestList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  ...
                                  <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_certificates_k8s_io_v1beta1.CertificateSigningRequestArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatesigningrequest">pulumi.<wbr>Input<pulumi.<wbr>Input<Certificate<wbr>Signing<wbr>Request<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#status_nodejs" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatesigningrequeststatus">pulumi.<wbr>Input<Certificate<wbr>Signing<wbr>Request<wbr>Status<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Derived information about the request.{{% /md %}}</dd></dl>
{{% /choosable %}}
