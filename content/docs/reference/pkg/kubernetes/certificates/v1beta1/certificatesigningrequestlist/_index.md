...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">CertificateSigningRequestList</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CertificateSigningRequestList</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">CertificateSigningRequestList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                                  <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_certificates_k8s_io.v1beta1.CertificateSigningRequestArgs]]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">CertificateSigningRequestList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                  <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">CertificateSigningRequestListArgs</a></span><span class="p">,</span>
                                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewCertificateSigningRequestList</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">CertificateSigningRequestListArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">CertificateSigningRequestList</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">CertificateSigningRequestList</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">CertificateSigningRequestListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">CertificateSigningRequestList</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">CertificateSigningRequestListArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatesigningrequest">[]Certificate<wbr>Signing<wbr>Request<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="metadata_go">
...
<a href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd>{{% md %}}The certificate request itself and any additional information.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Derived information about the request.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lastupdatetime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Update<wbr>Time</a>
    ...
    <dd>{{% md %}}timestamp for the last update to this condition{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#message_csharp" style="color: inherit; text-decoration: inherit;">Message</a>
    ...
    <dd>{{% md %}}human readable message with details about the request state{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reason_csharp" style="color: inherit; text-decoration: inherit;">Reason</a>
    ...
    <dd>{{% md %}}brief reason for the request state{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
</span>
    ...
    <dd>{{% md %}}Status of the condition, one of True, False, Unknown. Approved, Denied, and Failed conditions may not be "False" or "Unknown". Defaults to "True". If unset, should be treated as "True".{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#request_csharp" style="color: inherit; text-decoration: inherit;">Request</a>
    ...
    <dd>{{% md %}}Base64-encoded PKCS#10 CSR data{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#extra_csharp" style="color: inherit; text-decoration: inherit;">Extra</a>
    ...
    <dd>{{% md %}}Extra information about the requesting user. See user.Info interface for details.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#groups_csharp" style="color: inherit; text-decoration: inherit;">Groups</a>
    ...
    <dd>{{% md %}}Group information about the requesting user. See user.Info interface for details.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
Distribution of trust for signers happens out of band. You can select on this field using `spec.signerName`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="uid_csharp">
<a href="#uid_csharp" style="color: inherit; text-decoration: inherit;">Uid</a>
    ...
    <dd>{{% md %}}UID information about the requesting user. See user.Info interface for details.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">Username</a>
    ...
    <dd>{{% md %}}Information about the requesting user. See user.Info interface for details.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#certificate_csharp" style="color: inherit; text-decoration: inherit;">Certificate</a>
    ...
    <dd>{{% md %}}If request was approved, the controller will place the issued certificate here.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
    ...
    <dd>{{% md %}}Conditions applied to the request, such as approval or denial.{{% /md %}}</dd></dl>
{{% /choosable %}}
