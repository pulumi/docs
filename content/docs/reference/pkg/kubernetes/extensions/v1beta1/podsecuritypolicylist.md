...
## PodSecurityPolicyList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The PodSecurityPolicyList resource does not produce any additional output properties.
