...
<span class="k">def </span><span class="nx">PriorityClassList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_scheduling_k8s_io_v1beta1.PriorityClassArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#priorityclass">pulumi.<wbr>Input<pulumi.<wbr>Input<Priority<wbr>Class<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}items is the list of PriorityClasses{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
