...
<span class="k">def </span><span class="nx">EndpointSliceList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_discovery_k8s_io_v1beta1.EndpointSliceArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointslice">pulumi.<wbr>Input<pulumi.<wbr>Input<Endpoint<wbr>Slice<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of endpoint slices{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
