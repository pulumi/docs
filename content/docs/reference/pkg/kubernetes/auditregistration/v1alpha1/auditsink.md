...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">AuditSink</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">AuditSink</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">AuditSink</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_auditregistration_k8s_io_v1alpha1.AuditSinkSpecArgs]]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">AuditSink</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[AuditSinkArgs]</a></span> = None<span class="p">,</span>
              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAuditSink</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">AuditSinkArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">AuditSink</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">AuditSink</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AuditSinkArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>
      The unique name of the resource.
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">AuditSink</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties"><dt
    ...
    <dd>
      The unique name of the resource.
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">AuditSinkArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd><dt
...
<a href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd>{{% md %}}Spec defines the audit configuration spec{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#auditsinkspec">pulumi.<wbr>Input<Audit<wbr>Sink<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Spec defines the audit configuration spec{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
    ...
    <dd>{{% md %}}Policy defines the policy for selecting which events should be sent to the webhook required{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#webhook_csharp" style="color: inherit; text-decoration: inherit;">Webhook</a>
    ...
    <dd>{{% md %}}Webhook to send events required{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#policy_nodejs" style="color: inherit; text-decoration: inherit;">policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policy">pulumi.<wbr>Input<Policy<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Policy defines the policy for selecting which events should be sent to the webhook required{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#webhook_nodejs" style="color: inherit; text-decoration: inherit;">webhook</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhook">pulumi.<wbr>Input<Webhook<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Webhook to send events required{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#level_csharp" style="color: inherit; text-decoration: inherit;">Level</a>
    ...
    <dd>{{% md %}}The Level that all requests are recorded at. available options: None, Metadata, Request, RequestResponse required{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#stages_csharp" style="color: inherit; text-decoration: inherit;">Stages</a>
    ...
    <dd>{{% md %}}Stages is a list of stages for which events are created.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#clientconfig_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Config</a>
    ...
    <dd>{{% md %}}ClientConfig holds the connection parameters for the webhook required{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#throttle_csharp" style="color: inherit; text-decoration: inherit;">Throttle</a>
    ...
    <dd>{{% md %}}Throttle holds the options for throttling the webhook{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#throttle_nodejs" style="color: inherit; text-decoration: inherit;">throttle</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webhookthrottleconfig">pulumi.<wbr>Input<Webhook<wbr>Throttle<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Throttle holds the options for throttling the webhook{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#burst_csharp" style="color: inherit; text-decoration: inherit;">Burst</a>
    ...
    <dd>{{% md %}}ThrottleBurst is the maximum number of events sent at the same moment default 15 QPS{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="qps_csharp">
<a href="#qps_csharp" style="color: inherit; text-decoration: inherit;">Qps</a>
    ...
    <dd>{{% md %}}ThrottleQPS maximum number of batches per second default 10 QPS{{% /md %}}</dd></dl>
{{% /choosable %}}
