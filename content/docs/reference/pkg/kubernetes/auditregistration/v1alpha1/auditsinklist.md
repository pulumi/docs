...
## AuditSinkList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The AuditSinkList resource does not produce any additional output properties.
