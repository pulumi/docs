...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/batch/v1beta1?tab=doc#JobTemplateSpecOutput">output</a> API doc for this type.
{{% /choosable %}}
