...
All [input](#inputs) properties are implicitly available as output properties. The JobList resource does not produce any additional output properties.
