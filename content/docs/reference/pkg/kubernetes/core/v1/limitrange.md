...
<span class="k">def </span><span class="nx">LimitRange</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.LimitRangeSpecArgs]]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">LimitRange</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[LimitRangeArgs]</a></span> = None<span class="p">,</span>
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#limitrangespec">pulumi.<wbr>Input<Limit<wbr>Range<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#limits_nodejs" style="color: inherit; text-decoration: inherit;">limits</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#limitrangeitem">pulumi.<wbr>Input<pulumi.<wbr>Input<Limit<wbr>Range<wbr>Item<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Limits is the list of LimitRangeItem objects that are enforced.{{% /md %}}</dd></dl>
{{% /choosable %}}
