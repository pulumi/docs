...
<span class="k">def </span><span class="nx">EndpointsList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_core_v1.EndpointsArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpoints">pulumi.<wbr>Input<pulumi.<wbr>Input<Endpoints<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of endpoints.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
