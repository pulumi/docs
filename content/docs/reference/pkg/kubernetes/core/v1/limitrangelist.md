...
## LimitRangeList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The LimitRangeList resource does not produce any additional output properties.
