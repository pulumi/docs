...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">Endpoints</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">Endpoints</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
<span class="k">def </span><span class="nx">Endpoints</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">subsets</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_core_v1.EndpointSubsetArgs]]]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEndpoints</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">EndpointsArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Endpoints</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">Endpoints</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EndpointsArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>
      The unique name of the resource.
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">Endpoints</a></span>
    </dt>
    <dd>
...
<a href="#subsets_csharp" style="color: inherit; text-decoration: inherit;">Subsets</a>
    ...
    <dd>{{% md %}}The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#subsets_nodejs" style="color: inherit; text-decoration: inherit;">subsets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointsubset">pulumi.<wbr>Input<pulumi.<wbr>Input<Endpoint<wbr>Subset<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to the IPs they share. A single address with multiple ports, some of which are ready and some of which are not (because they come from different containers) will result in the address being displayed in different subsets for the different ports. No address will appear in both Addresses and NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ip_csharp" style="color: inherit; text-decoration: inherit;">Ip</a>
    ...
    <dd>{{% md %}}The IP of this endpoint. May not be loopback (127.0.0.0/8), link-local (169.254.0.0/16), or link-local multicast ((224.0.0.0/24). IPv6 is also accepted but not fully supported on all platforms. Also, certain kubernetes components, like kube-proxy, are not IPv6 ready.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Hostname</a>
    ...
    <dd>{{% md %}}The Hostname of this endpoint{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nodename_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Name</a>
    ...
    <dd>{{% md %}}Optional: Node hosting this endpoint. This can be used to determine endpoints local to a node.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#targetref_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Ref</a>
    ...
    <dd>{{% md %}}Reference to object providing the endpoint.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targetref_nodejs" style="color: inherit; text-decoration: inherit;">target<wbr>Ref</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectreference">pulumi.<wbr>Input<Object<wbr>Reference<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Reference to object providing the endpoint.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The port number of the endpoint.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#appprotocol_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Protocol</a>
    ...
    <dd>{{% md %}}The application protocol for this port. This field follows standard Kubernetes label syntax. Un-prefixed names are reserved for IANA standard service names (as per RFC-6335 and http://www.iana.org/assignments/service-names). Non-standard protocols should use prefixed names such as mycompany.com/my-custom-protocol. This is a beta field that is guarded by the ServiceAppProtocol feature gate and enabled by default.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of this port.  This must match the 'name' field in the corresponding ServicePort. Must be a DNS_LABEL. Optional only if one port is defined.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#addresses_csharp" style="color: inherit; text-decoration: inherit;">Addresses</a>
    ...
    <dd>{{% md %}}IP addresses which offer the related ports that are marked as ready. These endpoints should be considered safe for load balancers and clients to utilize.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#notreadyaddresses_csharp" style="color: inherit; text-decoration: inherit;">Not<wbr>Ready<wbr>Addresses</a>
    ...
    <dd>{{% md %}}IP addresses which offer the related ports but are not currently marked as ready because they have not yet finished starting, have recently failed a readiness check, or have recently failed a liveness check.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ports_csharp" style="color: inherit; text-decoration: inherit;">Ports</a>
    ...
    <dd>{{% md %}}Port numbers available on the related IP addresses.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#addresses_nodejs" style="color: inherit; text-decoration: inherit;">addresses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointaddress">pulumi.<wbr>Input<pulumi.<wbr>Input<Endpoint<wbr>Address<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}IP addresses which offer the related ports that are marked as ready. These endpoints should be considered safe for load balancers and clients to utilize.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ports_nodejs" style="color: inherit; text-decoration: inherit;">ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointport">pulumi.<wbr>Input<pulumi.<wbr>Input<Endpoint<wbr>Port<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Port numbers available on the related IP addresses.{{% /md %}}</dd></dl>
{{% /choosable %}}
