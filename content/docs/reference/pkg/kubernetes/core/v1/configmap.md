...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_kubernetes/core/v1/#ConfigMap">ConfigMap</a></span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>binary_data=None<span class="p">, </span>data=None<span class="p">, </span>immutable=None<span class="p">, </span>metadata=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
