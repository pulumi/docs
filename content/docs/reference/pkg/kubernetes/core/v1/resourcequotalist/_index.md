...
<span class="k">def </span><span class="nx">ResourceQuotaList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[ResourceQuotaArgs]]</span> = None<span class="p">,</span>
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcequota">[]Resource<wbr>Quota<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="metadata_go">
...
<a href="#items_python" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcequota">Sequence[Resource<wbr>Quota<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#match_expressions_python" style="color: inherit; text-decoration: inherit;">match_<wbr>expressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scopedresourceselectorrequirement">Sequence[Scoped<wbr>Resource<wbr>Selector<wbr>Requirement]</a></span>
    </dt>
    <dd>{{% md %}}A list of scope selector requirements by scope of the resources.{{% /md %}}</dd></dl>
{{% /choosable %}}
