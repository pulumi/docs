...
## ServiceAccountList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The ServiceAccountList resource does not produce any additional output properties.
