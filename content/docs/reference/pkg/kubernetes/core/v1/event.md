...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/core/v1/#Event">Event</a></span><span class="p">(</span><span class="nx">name</span>: <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span>: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/core/v1/#Event">Event</a></span><span class="p">, </span><span class="nx">opts</span>?: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Event</span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>action=None<span class="p">, </span>count=None<span class="p">, </span>event_time=None<span class="p">, </span>first_timestamp=None<span class="p">, </span>involved_object=None<span class="p">, </span>last_timestamp=None<span class="p">, </span>message=None<span class="p">, </span>metadata=None<span class="p">, </span>reason=None<span class="p">, </span>related=None<span class="p">, </span>reporting_component=None<span class="p">, </span>reporting_instance=None<span class="p">, </span>series=None<span class="p">, </span>source=None<span class="p">, </span>type=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/core/v1/#Event">Event</a></span>
    </dt>
    <dd>
