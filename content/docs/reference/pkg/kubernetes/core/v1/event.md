...
<span class="k">def </span><span class="nx">Event</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">first_timestamp</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          <span class="nx">involved_object</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.ObjectReferenceArgs]]</span> = None<span class="p">,</span>
          <span class="nx">last_timestamp</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          ...
          <span class="nx">reporting_component</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
          ...
          <span class="nx">series</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.EventSeriesArgs]]</span> = None<span class="p">,</span>
          <span class="nx">source</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_core_v1.EventSourceArgs]]</span> = None<span class="p">,</span>
...
<a href="#involvedobject_csharp" style="color: inherit; text-decoration: inherit;">Involved<wbr>Object</a>
    ...
    <dd>{{% md %}}The object that this event is about.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd>{{% md %}}What action was taken/failed regarding to the Regarding object.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#count_csharp" style="color: inherit; text-decoration: inherit;">Count</a>
    ...
    <dd>{{% md %}}The number of times this event has occurred.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#eventtime_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Time</a>
    ...
    <dd>{{% md %}}Time when this Event was first observed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#firsttimestamp_csharp" style="color: inherit; text-decoration: inherit;">First<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}The time at which the event was first recorded. (Time of server receipt is in TypeMeta.){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lasttimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}The time at which the most recent occurrence of this event was recorded.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reason_csharp" style="color: inherit; text-decoration: inherit;">Reason</a>
    ...
    <dd>{{% md %}}This should be a short, machine understandable string that gives the reason for the transition into the object's current status.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#related_csharp" style="color: inherit; text-decoration: inherit;">Related</a>
    ...
    <dd>{{% md %}}Optional secondary object for more complex actions.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reportingcomponent_csharp" style="color: inherit; text-decoration: inherit;">Reporting<wbr>Component</a>
    ...
    <dd>{{% md %}}Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reportinginstance_csharp" style="color: inherit; text-decoration: inherit;">Reporting<wbr>Instance</a>
    ...
    <dd>{{% md %}}ID of the controller instance, e.g. `kubelet-xyzf`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#series_csharp" style="color: inherit; text-decoration: inherit;">Series</a>
    ...
    <dd>{{% md %}}Data about the Event series this event represents or nil if it's a singleton Event.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
    ...
    <dd>{{% md %}}The component reporting this event. Should be a short machine understandable string.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of this event (Normal, Warning), new types could be added in the future{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#source_nodejs" style="color: inherit; text-decoration: inherit;">source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventsource">pulumi.<wbr>Input<Event<wbr>Source<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The component reporting this event. Should be a short machine understandable string.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_nodejs">
...
<a href="#count_csharp" style="color: inherit; text-decoration: inherit;">Count</a>
    ...
    <dd>{{% md %}}Number of occurrences in this series up to the last heartbeat time{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastobservedtime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Observed<wbr>Time</a>
    ...
    <dd>{{% md %}}Time of the last occurrence observed{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}State of this Series: Ongoing or Finished Deprecated. Planned removal for 1.18{{% /md %}}</dd></dl>
{{% /choosable %}}
