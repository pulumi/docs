...
<span class="k">def </span><span class="nx">ClusterRole</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">aggregation_rule</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_rbac_authorization_k8s_io_v1beta1.AggregationRuleArgs]]</span> = None<span class="p">,</span>
                ...
                <span class="nx">rules</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_rbac_authorization_k8s_io_v1beta1.PolicyRuleArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#aggregationrule_nodejs" style="color: inherit; text-decoration: inherit;">aggregation<wbr>Rule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aggregationrule">pulumi.<wbr>Input<Aggregation<wbr>Rule<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_nodejs" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policyrule">pulumi.<wbr>Input<pulumi.<wbr>Input<Policy<wbr>Rule<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Rules holds all the PolicyRules for this ClusterRole{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#clusterroleselectors_nodejs" style="color: inherit; text-decoration: inherit;">cluster<wbr>Role<wbr>Selectors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#labelselector">pulumi.<wbr>Input<pulumi.<wbr>Input<meta.v1.<wbr>Label<wbr>Selector<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added{{% /md %}}</dd></dl>
{{% /choosable %}}
