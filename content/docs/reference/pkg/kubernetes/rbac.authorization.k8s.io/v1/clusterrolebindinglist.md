...
## Create a ClusterRoleBindingList Resource

{{< chooser language "javascript,typescript,python,go,csharp" / >}}

{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/rbac.authorization.k8s.io/v1/#ClusterRoleBindingList">ClusterRoleBindingList</a></span><span class="p">(</span><span class="nx">name</span>: <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span>: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/rbac.authorization.k8s.io/v1/#ClusterRoleBindingListArgs">ClusterRoleBindingListArgs</a></span><span class="p">, </span><span class="nx">opts</span>?: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">pulumi.CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ClusterRoleBindingList</span><span class="p">(resource_name, opts=None, </span>api_version=None<span class="p">, </span>items=None<span class="p">, </span>kind=None<span class="p">, </span>metadata=None<span class="p">, __props__=None);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>NewClusterRoleBindingList<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">name</span> <span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac.authorization.k8s.io/v1?tab=doc#ClusterRoleBindingListArgs">ClusterRoleBindingListArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">pulumi.ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac.authorization.k8s.io/v1?tab=doc#ClusterRoleBindingList">ClusterRoleBindingList</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Rbac.Authorization.K8s.Io/V1.ClusterRoleBindingList.html">ClusterRoleBindingList</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Rbac.authorization.k8s.io/v1.Inputs.ClusterRoleBindingListArgs.html">ClusterRoleBindingListArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterrolebinding">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Rbac.authorization.k8s.io/v1.<wbr>Inputs.<wbr>Cluster<wbr>Role<wbr>Binding<wbr>Args&gt;</a></span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
        ...
        <span>items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterrolebinding">List[Cluster<wbr>Role<wbr>Binding]</a></span>
    </dt>
    <dd>{{% md %}}Items is a list of ClusterRoleBindings{{% /md %}}</dd>
...
## ClusterRoleBindingList Output Properties
...
<dl class="resources-properties">
    ...
    <dt class="property-"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterrolebinding">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Rbac.authorization.k8s.io/v1.<wbr>Outputs.<wbr>Cluster<wbr>Role<wbr>Binding&gt;?</a></span>
    </dt>
    <dd>{{% md %}}Items is a list of ClusterRoleBindings{{% /md %}}</dd>
...
<h4>Cluster<wbr>Role<wbr>Binding</h4>
{{% choosable language nodejs %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#ClusterRoleBindingTypeArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#ClusterRoleBindingTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#roleref">Pulumi.<wbr>Kubernetes.<wbr>Rbac.authorization.k8s.io/v1.<wbr>Inputs.<wbr>Role<wbr>Ref<wbr>Args?</a></span>
    </dt>
    ...
    <dt class="property-optional"
        ...
        <span>Subjects</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subject">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Rbac.authorization.k8s.io/v1.<wbr>Inputs.<wbr>Subject<wbr>Args&gt;?</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#RoleRefArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#RoleRefOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#SubjectArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/rbac/v1?tab=doc#SubjectOutput">output</a> API doc for this type.
{{% /choosable %}}
