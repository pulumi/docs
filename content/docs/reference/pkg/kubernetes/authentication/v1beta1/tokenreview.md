...
## TokenReview Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the TokenReview resource produces the following computed outputs.
