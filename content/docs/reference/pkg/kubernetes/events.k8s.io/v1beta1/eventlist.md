...
## Create a EventList Resource

{{< chooser language "javascript,typescript,python,go,csharp" / >}}

{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/events.k8s.io/v1beta1/#EventList">EventList</a></span><span class="p">(</span><span class="nx">name</span>: <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span>: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/events.k8s.io/v1beta1/#EventListArgs">EventListArgs</a></span><span class="p">, </span><span class="nx">opts</span>?: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">pulumi.CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">EventList</span><span class="p">(resource_name, opts=None, </span>api_version=None<span class="p">, </span>items=None<span class="p">, </span>kind=None<span class="p">, </span>metadata=None<span class="p">, __props__=None);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>NewEventList<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">name</span> <span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/events.k8s.io/v1beta1?tab=doc#EventListArgs">EventListArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">pulumi.ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/events.k8s.io/v1beta1?tab=doc#EventList">EventList</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Events.K8s.Io/V1beta1.EventList.html">EventList</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Events.k8s.io/v1beta1.Inputs.EventListArgs.html">EventListArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#event">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Events.k8s.io/v1beta1.<wbr>Inputs.<wbr>Event<wbr>Args&gt;</a></span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#event">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Events.k8s.io/v1beta1.<wbr>Outputs.<wbr>Event&gt;?</a></span>
    </dt>
    <dd>{{% md %}}Items is a list of schema objects.{{% /md %}}</dd>
...
<h4>Event</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#Event">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/events/v1beta1?tab=doc#EventTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Deprecated<wbr>Count</span>
        <span class="property-indicator"></span>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Deprecated<wbr>First<wbr>Timestamp</span>
        <span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
    <dd>{{% md %}}Deprecated field assuring backward compatibility with core.v1 Event type{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Deprecated<wbr>Last<wbr>Timestamp</span>
        <span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
    <dd>{{% md %}}Deprecated field assuring backward compatibility with core.v1 Event type{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Deprecated<wbr>Source</span>
        <span class="property-indicator"></span>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Reporting<wbr>Controller</span>
        <span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Reporting<wbr>Instance</span>
        <span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
    ...
    <dt class="property-optional"
        ...
        <span>Series</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventseries">Pulumi.<wbr>Kubernetes.<wbr>Events.k8s.io/v1beta1.<wbr>Inputs.<wbr>Event<wbr>Series<wbr>Args?</a></span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">
        <span>deprecated_<wbr>count</span>
        <span class="property-indicator"></span>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>deprecated_<wbr>first_<wbr>timestamp</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}Deprecated field assuring backward compatibility with core.v1 Event type{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>deprecated_<wbr>last_<wbr>timestamp</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}Deprecated field assuring backward compatibility with core.v1 Event type{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>deprecated_<wbr>source</span>
        <span class="property-indicator"></span>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>reporting_<wbr>controller</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`.{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>reporting_<wbr>instance</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
    <dd>{{% md %}}ID of the controller instance, e.g. `kubelet-xyzf`.{{% /md %}}</dd>
...
<h4>Event<wbr>Series</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#EventSeries">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/events/v1beta1?tab=doc#EventSeriesOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Last<wbr>Observed<wbr>Time</span>
        <span class="property-indicator"></span>
        <span class="property-type">string?</span>
    </dt>
...
<h4>Event<wbr>Source</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#EventSource">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/core/v1?tab=doc#EventSourceOutput">output</a> API doc for this type.
{{% /choosable %}}
