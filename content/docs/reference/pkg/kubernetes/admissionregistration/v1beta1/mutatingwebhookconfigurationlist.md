...
<span class="k">def </span><span class="nx">MutatingWebhookConfigurationList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                     ...
                                     <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_admissionregistration_k8s_io_v1beta1.MutatingWebhookConfigurationArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhookconfiguration">pulumi.<wbr>Input<pulumi.<wbr>Input<Mutating<wbr>Webhook<wbr>Configuration<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of MutatingWebhookConfiguration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rules_nodejs" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulewithoperations">pulumi.<wbr>Input<pulumi.<wbr>Input<Rule<wbr>With<wbr>Operations<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Rules describes what operations on what resources/subresources the webhook cares about. The webhook cares about an operation if it matches _any_ Rule. However, in order to prevent ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks from putting the cluster in a state which cannot be recovered from without completely disabling the plugin, ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks are never called on admission requests for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#webhooks_nodejs" style="color: inherit; text-decoration: inherit;">webhooks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhook">pulumi.<wbr>Input<pulumi.<wbr>Input<Mutating<wbr>Webhook<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Webhooks is a list of webhooks and the affected resources and operations.{{% /md %}}</dd></dl>
{{% /choosable %}}
