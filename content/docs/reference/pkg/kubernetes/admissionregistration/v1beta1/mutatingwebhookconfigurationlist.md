...
## MutatingWebhookConfigurationList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The MutatingWebhookConfigurationList resource does not produce any additional output properties.
