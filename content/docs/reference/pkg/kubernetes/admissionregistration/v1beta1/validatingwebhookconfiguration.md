...
title_tag: "Resource ValidatingWebhookConfiguration | Module admissionregistration.k8s.io/v1beta1 | Package Kubernetes"
meta_desc: "Explore the ValidatingWebhookConfiguration resource of the admissionregistration.k8s.io/v1beta1 module, including examples, input properties, output properties, lookup functions, and supporting types. ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it. Deprecated in v1.16, planned for removal in v1.19. Use admissionregistration.k8s.io/v1 ValidatingWebhookConfiguration instead."
---
...
The ValidatingWebhookConfiguration resource accepts the following [input]({{< relref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
