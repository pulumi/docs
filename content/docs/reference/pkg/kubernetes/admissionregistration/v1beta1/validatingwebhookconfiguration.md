...
<span class="k">def </span><span class="nx">ValidatingWebhookConfiguration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   ...
                                   <span class="nx">webhooks</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_admissionregistration_k8s_io_v1beta1.ValidatingWebhookArgs]]]]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">ValidatingWebhookConfiguration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                   <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[ValidatingWebhookConfigurationArgs]</a></span> = None<span class="p">,</span>
...
<a href="#webhooks_nodejs" style="color: inherit; text-decoration: inherit;">webhooks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#validatingwebhook">pulumi.<wbr>Input<pulumi.<wbr>Input<Validating<wbr>Webhook<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Webhooks is a list of webhooks and the affected resources and operations.{{% /md %}}</dd></dl>
{{% /choosable %}}
