...
<span class="k">def </span><span class="nx">ValidatingWebhookConfigurationList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                       ...
                                       <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_admissionregistration_k8s_io_v1.ValidatingWebhookConfigurationArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#validatingwebhookconfiguration">pulumi.<wbr>Input<pulumi.<wbr>Input<Validating<wbr>Webhook<wbr>Configuration<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}List of ValidatingWebhookConfiguration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
