...
<dl class="resources-properties">
    ...
    <dt class="property-"
        ...
        <span>Webhooks</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhook">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Admissionregistration.k8s.io/v1.<wbr>Outputs.<wbr>Mutating<wbr>Webhook&gt;?</a></span>
    </dt>
    <dd>{{% md %}}Webhooks is a list of webhooks and the affected resources and operations.{{% /md %}}</dd>
