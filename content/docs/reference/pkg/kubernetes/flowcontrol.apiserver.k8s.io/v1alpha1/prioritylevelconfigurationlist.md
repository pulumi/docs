...
## Create a PriorityLevelConfigurationList Resource

{{< chooser language "javascript,typescript,python,go,csharp" / >}}

{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/flowcontrol.apiserver.k8s.io/v1alpha1/#PriorityLevelConfigurationList">PriorityLevelConfigurationList</a></span><span class="p">(</span><span class="nx">name</span>: <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span>: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/flowcontrol.apiserver.k8s.io/v1alpha1/#PriorityLevelConfigurationListArgs">PriorityLevelConfigurationListArgs</a></span><span class="p">, </span><span class="nx">opts</span>?: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">pulumi.CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">PriorityLevelConfigurationList</span><span class="p">(resource_name, opts=None, </span>api_version=None<span class="p">, </span>items=None<span class="p">, </span>kind=None<span class="p">, </span>metadata=None<span class="p">, __props__=None);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>NewPriorityLevelConfigurationList<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">name</span> <span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol.apiserver.k8s.io/v1alpha1?tab=doc#PriorityLevelConfigurationListArgs">PriorityLevelConfigurationListArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">pulumi.ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol.apiserver.k8s.io/v1alpha1?tab=doc#PriorityLevelConfigurationList">PriorityLevelConfigurationList</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Flowcontrol.Apiserver.K8s.Io/V1alpha1.PriorityLevelConfigurationList.html">PriorityLevelConfigurationList</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Flowcontrol.apiserver.k8s.io/v1alpha1.Inputs.PriorityLevelConfigurationListArgs.html">PriorityLevelConfigurationListArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfiguration">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Priority<wbr>Level<wbr>Configuration<wbr>Args&gt;</a></span>
    </dt>
...
## PriorityLevelConfigurationList Output Properties
...
<dl class="resources-properties">
    ...
    <dt class="property-"
        ...
        <span>Items</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfiguration">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Outputs.<wbr>Priority<wbr>Level<wbr>Configuration&gt;?</a></span>
    </dt>
    <dd>{{% md %}}`items` is a list of request-priorities.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#LimitResponseArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#LimitResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span>Queuing</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#queuingconfiguration">Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Queuing<wbr>Configuration<wbr>Args?</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#LimitedPriorityLevelConfigurationArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#LimitedPriorityLevelConfigurationOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Assured<wbr>Concurrency<wbr>Shares</span>
        <span class="property-indicator"></span>
...
bigger numbers of ACS mean more reserved concurrent requests (at the expense of every other PL). This field has a default value of 30.{{% /md %}}</dd>
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Limit<wbr>Response</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#limitresponse">Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Limit<wbr>Response<wbr>Args?</a></span>
    </dt>
...
<h4>Priority<wbr>Level<wbr>Configuration</h4>
{{% choosable language nodejs %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationTypeArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span>Spec</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationspec">Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Priority<wbr>Level<wbr>Configuration<wbr>Spec<wbr>Args?</a></span>
    </dt>
    ...
    <dt class="property-optional"
        ...
        <span>Status</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationstatus">Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Priority<wbr>Level<wbr>Configuration<wbr>Status<wbr>Args?</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationConditionArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationConditionOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationSpecArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationSpecOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span>Limited</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#limitedprioritylevelconfiguration">Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Limited<wbr>Priority<wbr>Level<wbr>Configuration<wbr>Args?</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationStatusArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#PriorityLevelConfigurationStatusOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationcondition">List&lt;Pulumi.<wbr>Kubernetes.<wbr>Flowcontrol.apiserver.k8s.io/v1alpha1.<wbr>Inputs.<wbr>Priority<wbr>Level<wbr>Configuration<wbr>Condition<wbr>Args&gt;?</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#QueuingConfigurationArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/flowcontrol/v1alpha1?tab=doc#QueuingConfigurationOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
            title="Optional">
        <span>Queue<wbr>Length<wbr>Limit</span>
        <span class="property-indicator"></span>
        <span class="property-type">int?</span>
    </dt>
