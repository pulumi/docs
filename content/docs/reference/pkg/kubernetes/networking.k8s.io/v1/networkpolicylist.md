...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/networking/v1?tab=doc#NetworkPolicyTypeArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/networking/v1?tab=doc#NetworkPolicyTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
