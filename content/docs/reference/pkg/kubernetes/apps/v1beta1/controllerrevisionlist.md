...
<span class="k">def </span><span class="nx">ControllerRevisionList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                           ...
                           <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_apps_v1beta1.ControllerRevisionArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#controllerrevision">pulumi.<wbr>Input<pulumi.<wbr>Input<Controller<wbr>Revision<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Items is the list of ControllerRevisions{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
