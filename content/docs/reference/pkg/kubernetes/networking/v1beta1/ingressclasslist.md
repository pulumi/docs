...
<span class="k">def </span><span class="nx">IngressClassList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                     ...
                     <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_networking_k8s_io_v1beta1.IngressClassArgs]]]]</span> = None<span class="p">,</span>
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressclass">pulumi.<wbr>Input<pulumi.<wbr>Input<Ingress<wbr>Class<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Items is the list of IngressClasses.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressclassspec">pulumi.<wbr>Input<Ingress<wbr>Class<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#parameters_nodejs" style="color: inherit; text-decoration: inherit;">parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressclassparametersreference">pulumi.<wbr>Input<Ingress<wbr>Class<wbr>Parameters<wbr>Reference<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters.{{% /md %}}</dd></dl>
{{% /choosable %}}
