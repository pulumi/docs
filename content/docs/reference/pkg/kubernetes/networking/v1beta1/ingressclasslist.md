...
## IngressClassList Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The IngressClassList resource does not produce any additional output properties.
