...
<span class="k">def </span><span class="nx">Ingress</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_networking_k8s_io_v1.IngressSpecArgs]]</span> = None<span class="p">)</span>
...
Implementations are required to support all path types.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#service_nodejs" style="color: inherit; text-decoration: inherit;">service</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ingressservicebackend">pulumi.<wbr>Input<Ingress<wbr>Service<wbr>Backend<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Service references a Service as a Backend. This is a mutually exclusive setting with "Resource".{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name is the referenced service. The service must exist in the same namespace as the Ingress object.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="port_csharp">
...
<a href="#port_nodejs" style="color: inherit; text-decoration: inherit;">port</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicebackendport">pulumi.<wbr>Input<Service<wbr>Backend<wbr>Port<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Port of the referenced service. A port name or port number is required for a IngressServiceBackend.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#secretname_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Name</a>
    ...
    <dd>{{% md %}}SecretName is the name of the secret used to terminate TLS traffic on port 443. Field is left optional to allow TLS routing based on SNI hostname alone. If the SNI host in a listener conflicts with the "Host" header field used by an IngressRule, the SNI host is used for termination and value of the Host header is used for routing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name is the name of the port on the Service. This is a mutually exclusive setting with "Number".{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#number_csharp" style="color: inherit; text-decoration: inherit;">Number</a>
    ...
    <dd>{{% md %}}Number is the numerical port number (e.g. 80) on the Service. This is a mutually exclusive setting with "Name".{{% /md %}}</dd></dl>
{{% /choosable %}}
