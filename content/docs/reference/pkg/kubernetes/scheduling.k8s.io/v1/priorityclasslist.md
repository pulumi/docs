...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/go/kubernetes/scheduling/v1?tab=doc#PriorityClassTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
