...
## Create a CustomResource Resource
...
## CustomResource Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. The CustomResource resource does not produce any additional output properties.
