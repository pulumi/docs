...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">CustomResource</span><span class="p">(resource_name, </span>api_version<span class="p">, </span>kind<span class="p">, </span>metadata=None<span class="p">, </span>opts=None<span class="p">);</span></code></pre></div>
{{% /choosable %}}
