...
## SelfSubjectRulesReview Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SelfSubjectRulesReview resource produces the following computed outputs.
