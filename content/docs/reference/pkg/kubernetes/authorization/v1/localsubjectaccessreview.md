...
## LocalSubjectAccessReview Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the LocalSubjectAccessReview resource produces the following computed outputs.
