...
<span class="k">def </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_authorization_k8s_io_v1.SubjectAccessReviewSpecArgs]]</span> = None<span class="p">)</span>
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subjectaccessreviewspec">pulumi.<wbr>Input<Subject<wbr>Access<wbr>Review<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nonresourceattributes_nodejs" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">pulumi.<wbr>Input<Non<wbr>Resource<wbr>Attributes<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}NonResourceAttributes describes information for a non-resource access request{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceattributes_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Attributes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">pulumi.<wbr>Input<Resource<wbr>Attributes<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}ResourceAuthorizationAttributes describes information for a resource access request{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="uid_nodejs">
