...
<span class="k">def </span><span class="nx">SelfSubjectAccessReview</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                            ...
                            <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[_authorization_k8s_io_v1beta1.SelfSubjectAccessReviewSpecArgs]]</span> = None<span class="p">)</span>
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#selfsubjectaccessreviewspec">pulumi.<wbr>Input<Self<wbr>Subject<wbr>Access<wbr>Review<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Spec holds information about the request being evaluated.  user and groups must be empty{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
