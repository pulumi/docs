...
## SelfSubjectAccessReview Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SelfSubjectAccessReview resource produces the following computed outputs.
