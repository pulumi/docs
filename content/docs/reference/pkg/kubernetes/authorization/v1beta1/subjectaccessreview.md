...
## SubjectAccessReview Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the SubjectAccessReview resource produces the following computed outputs.
