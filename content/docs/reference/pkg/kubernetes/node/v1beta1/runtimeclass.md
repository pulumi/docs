...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RuntimeClass</span><span class="p">(resource_name, opts=None, </span>handler=None<span class="p">, </span>metadata=None<span class="p">, </span>overhead=None<span class="p">, </span>scheduling=None<span class="p">, __props__=None);</span></code></pre></div>
{{% /choosable %}}
