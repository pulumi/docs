...
<span class="k">def </span><span class="nx">RuntimeClass</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">overhead</span><span class="p">:</span> <span class="nx">Optional[_node_k8s_io.v1.OverheadArgs]</span> = None<span class="p">,</span>
                 <span class="nx">scheduling</span><span class="p">:</span> <span class="nx">Optional[_node_k8s_io.v1.SchedulingArgs]</span> = None<span class="p">)</span>
...
This field is in beta starting v1.18 and is only honored by servers that enable the PodOverhead feature.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
