...
<h3 class="pdoc-module-header" id="apiEndpoint" data-link-title="apiEndpoint">
    <a href="https://github.com/pulumi/pulumi-digitalocean/blob/9858e0100a19105d18af1001b178e5f04ae82534/sdk/nodejs/config/vars.ts#L12">
...
<h3 class="pdoc-module-header" id="spacesAccessId" data-link-title="spacesAccessId">
    <a href="https://github.com/pulumi/pulumi-digitalocean/blob/9858e0100a19105d18af1001b178e5f04ae82534/sdk/nodejs/config/vars.ts#L16">
...
<h3 class="pdoc-module-header" id="spacesEndpoint" data-link-title="spacesEndpoint">
    <a href="https://github.com/pulumi/pulumi-digitalocean/blob/9858e0100a19105d18af1001b178e5f04ae82534/sdk/nodejs/config/vars.ts#L20">
        let <strong>spacesEndpoint</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> spacesEndpoint: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span> | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.get(&#34;spacesEndpoint&#34;)</span>;</code></pre>

The URL to use for the DigitalOcean Spaces API.

<h3 class="pdoc-module-header" id="spacesSecretKey" data-link-title="spacesSecretKey">
    <a href="https://github.com/pulumi/pulumi-digitalocean/blob/9858e0100a19105d18af1001b178e5f04ae82534/sdk/nodejs/config/vars.ts#L24">
...
<h3 class="pdoc-module-header" id="token" data-link-title="token">
    <a href="https://github.com/pulumi/pulumi-digitalocean/blob/9858e0100a19105d18af1001b178e5f04ae82534/sdk/nodejs/config/vars.ts#L28">
