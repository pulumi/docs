...
<h3 class="pdoc-module-header" id="run" data-link-title="run">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L150">
...
<h3 class="pdoc-module-header" id="RunOpts" data-link-title="RunOpts">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L140">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L143">property <b>argv</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L144">property <b>programStarted</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L145">property <b>reportLoggedError</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L146">property <b>runInStack</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/cmd/run-policy-pack/run.ts#L147">property <b>typeScript</b></a>
</h4>
