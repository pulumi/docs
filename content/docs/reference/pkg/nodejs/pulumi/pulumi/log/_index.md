...
<h3 class="pdoc-module-header" id="debug" data-link-title="debug">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/log/index.ts#L35">
...
<h3 class="pdoc-module-header" id="error" data-link-title="error">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/log/index.ts#L76">
...
<h3 class="pdoc-module-header" id="hasErrors" data-link-title="hasErrors">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/log/index.ts#L28">
...
<h3 class="pdoc-module-header" id="info" data-link-title="info">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/log/index.ts#L48">
...
<h3 class="pdoc-module-header" id="warn" data-link-title="warn">
    <a href="https://github.com/pulumi/pulumi/blob/{{< param git_sha >}}/sdk/nodejs/log/index.ts#L62">
