...
<a href="{{< pkg-url pkg="aws" path="worklink/fleet.ts" >}}">worklink/fleet.ts</a> <a href="{{< pkg-url pkg="aws" path="worklink/websiteCertificateAuthorityAssociation.ts" >}}">worklink/websiteCertificateAuthorityAssociation.ts</a> 
</div>
</div>
</div>
