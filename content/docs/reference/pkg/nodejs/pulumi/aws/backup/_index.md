...
<a href="{{< pkg-url pkg="aws" path="backup/plan.ts" >}}">backup/plan.ts</a> <a href="{{< pkg-url pkg="aws" path="backup/selection.ts" >}}">backup/selection.ts</a> <a href="{{< pkg-url pkg="aws" path="backup/vault.ts" >}}">backup/vault.ts</a> 
</div>
</div>
</div>
