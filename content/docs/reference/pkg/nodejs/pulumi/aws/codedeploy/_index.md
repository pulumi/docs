...
<a href="{{< pkg-url pkg="aws" path="codedeploy/application.ts" >}}">codedeploy/application.ts</a> <a href="{{< pkg-url pkg="aws" path="codedeploy/deploymentConfig.ts" >}}">codedeploy/deploymentConfig.ts</a> <a href="{{< pkg-url pkg="aws" path="codedeploy/deploymentGroup.ts" >}}">codedeploy/deploymentGroup.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="aws" path="codedeploy/application.ts#L134" >}}">interface <b>ApplicationArgs</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="aws" path="codedeploy/application.ts#L119" >}}">interface <b>ApplicationState</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
