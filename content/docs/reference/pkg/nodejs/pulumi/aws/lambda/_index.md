...
<a href="{{< pkg-url pkg="aws" path="lambda/alias.ts" >}}">lambda/alias.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/eventSourceMapping.ts" >}}">lambda/eventSourceMapping.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/function.ts" >}}">lambda/function.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/getFunction.ts" >}}">lambda/getFunction.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/getInvocation.ts" >}}">lambda/getInvocation.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/getLayerVersion.ts" >}}">lambda/getLayerVersion.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/lambdaMixins.ts" >}}">lambda/lambdaMixins.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/layerVersion.ts" >}}">lambda/layerVersion.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/permission.ts" >}}">lambda/permission.ts</a> <a href="{{< pkg-url pkg="aws" path="lambda/runtimes.ts" >}}">lambda/runtimes.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="aws" path="lambda/lambdaMixins.ts#L29" >}}">interface <b>Context</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
