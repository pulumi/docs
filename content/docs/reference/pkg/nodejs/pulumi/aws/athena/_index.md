...
<a href="{{< pkg-url pkg="aws" path="athena/database.ts" >}}">athena/database.ts</a> <a href="{{< pkg-url pkg="aws" path="athena/namedQuery.ts" >}}">athena/namedQuery.ts</a> <a href="{{< pkg-url pkg="aws" path="athena/workgroup.ts" >}}">athena/workgroup.ts</a> 
</div>
</div>
</div>
