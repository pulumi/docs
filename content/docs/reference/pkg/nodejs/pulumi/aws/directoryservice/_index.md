...
<a href="{{< pkg-url pkg="aws" path="directoryservice/conditionalForwader.ts" >}}">directoryservice/conditionalForwader.ts</a> <a href="{{< pkg-url pkg="aws" path="directoryservice/directory.ts" >}}">directoryservice/directory.ts</a> <a href="{{< pkg-url pkg="aws" path="directoryservice/logService.ts" >}}">directoryservice/logService.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="aws" path="directoryservice/conditionalForwader.ts#L130" >}}">interface <b>ConditionalForwaderArgs</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="aws" path="directoryservice/conditionalForwader.ts#L112" >}}">interface <b>ConditionalForwaderState</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
