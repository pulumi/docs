...
<h3 class="pdoc-module-header" id="GetReportDefinitionArgs" data-link-title="GetReportDefinitionArgs">
    <a href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L47">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L51">property <b>reportName</b></a>
</h4>
...
<h3 class="pdoc-module-header" id="GetReportDefinitionResult" data-link-title="GetReportDefinitionResult">
    <a href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L57">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L61">property <b>additionalArtifacts</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L65">property <b>additionalSchemaElements</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L69">property <b>compression</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L73">property <b>format</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L94">property <b>id</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L74">property <b>reportName</b></a>
</h4>

<pre class="highlight"><code><span class='kd'></span>reportName: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>;</code></pre>
<h4 class="pdoc-member-header" id="GetReportDefinitionResult-s3Bucket">
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L78">property <b>s3Bucket</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L82">property <b>s3Prefix</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L86">property <b>s3Region</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-aws/blob/{{< param git_sha >}}/sdk/nodejs/cur/getReportDefinition.ts#L90">property <b>timeUnit</b></a>
</h4>
