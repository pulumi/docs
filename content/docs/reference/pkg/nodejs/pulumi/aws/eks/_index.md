...
<a href="{{< pkg-url pkg="aws" path="eks/cluster.ts" >}}">eks/cluster.ts</a> <a href="{{< pkg-url pkg="aws" path="eks/getCluster.ts" >}}">eks/getCluster.ts</a> <a href="{{< pkg-url pkg="aws" path="eks/getClusterAuth.ts" >}}">eks/getClusterAuth.ts</a> 
</div>
</div>
</div>
