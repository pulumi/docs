...
<a href="{{< pkg-url pkg="gcp" path="sql/database.ts" >}}">sql/database.ts</a> <a href="{{< pkg-url pkg="gcp" path="sql/databaseInstance.ts" >}}">sql/databaseInstance.ts</a> <a href="{{< pkg-url pkg="gcp" path="sql/sslCert.ts" >}}">sql/sslCert.ts</a> <a href="{{< pkg-url pkg="gcp" path="sql/user.ts" >}}">sql/user.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="gcp" path="sql/database.ts#L182" >}}">interface <b>DatabaseArgs</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="gcp" path="sql/database.ts#L143" >}}">interface <b>DatabaseState</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
