...
<h3 class="pdoc-module-header" id="addAddressToEnv" data-link-title="addAddressToEnv">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L13">
...
<h3 class="pdoc-module-header" id="address" data-link-title="address">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L17">
...
<h3 class="pdoc-module-header" id="authLogins" data-link-title="authLogins">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L21">
        let <strong>authLogins</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> authLogins: <a href='/docs/reference/pkg/nodejs/pulumi/vault/types/output/#AuthLogins'>AuthLogins</a>[] | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;outputs.config.AuthLogins[]&gt;(&#34;authLogins&#34;)</span>;</code></pre>

Login to vault with an existing auth method using auth/<mount>/login

<h3 class="pdoc-module-header" id="caCertDir" data-link-title="caCertDir">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L25">
...
<h3 class="pdoc-module-header" id="caCertFile" data-link-title="caCertFile">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L29">
...
<h3 class="pdoc-module-header" id="clientAuths" data-link-title="clientAuths">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L33">
        let <strong>clientAuths</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> clientAuths: <a href='/docs/reference/pkg/nodejs/pulumi/vault/types/output/#ClientAuths'>ClientAuths</a>[] | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;outputs.config.ClientAuths[]&gt;(&#34;clientAuths&#34;)</span>;</code></pre>

Client authentication credentials.

<h3 class="pdoc-module-header" id="headers" data-link-title="headers">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L37">
        let <strong>headers</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> headers: <a href='/docs/reference/pkg/nodejs/pulumi/vault/types/output/#Headers'>Headers</a>[] | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;outputs.config.Headers[]&gt;(&#34;headers&#34;)</span>;</code></pre>

The headers to send with each Vault request.

<h3 class="pdoc-module-header" id="maxLeaseTtlSeconds" data-link-title="maxLeaseTtlSeconds">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L41">
        let <strong>maxLeaseTtlSeconds</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> maxLeaseTtlSeconds: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number'>number</a></span> | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;number&gt;(&#34;maxLeaseTtlSeconds&#34;) || (&lt;any&gt;utilities.getEnvNumber(&#34;TERRAFORM_VAULT_MAX_TTL&#34;) || 1200)</span>;</code></pre>

Maximum TTL for secret leases requested by this provider

<h3 class="pdoc-module-header" id="maxRetries" data-link-title="maxRetries">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L45">
        let <strong>maxRetries</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> maxRetries: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number'>number</a></span> | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;number&gt;(&#34;maxRetries&#34;) || (&lt;any&gt;utilities.getEnvNumber(&#34;VAULT_MAX_RETRIES&#34;) || 2)</span>;</code></pre>

Maximum number of retries when a 5xx error code is encountered.

<h3 class="pdoc-module-header" id="namespace" data-link-title="namespace">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L49">
...
<h3 class="pdoc-module-header" id="skipTlsVerify" data-link-title="skipTlsVerify">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L53">
        let <strong>skipTlsVerify</strong>
    </a>
</h3>

<pre class="highlight"><code><span class='kd'>let</span> skipTlsVerify: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean'>boolean</a></span> | <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined'>undefined</a></span> = <span class='s2'> __config.getObject&lt;boolean&gt;(&#34;skipTlsVerify&#34;) || &lt;any&gt;utilities.getEnvBoolean(&#34;VAULT_SKIP_VERIFY&#34;)</span>;</code></pre>

Set this to true only if the target Vault server is an insecure development instance.

<h3 class="pdoc-module-header" id="token" data-link-title="token">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L57">
...
<h3 class="pdoc-module-header" id="tokenName" data-link-title="tokenName">
    <a href="https://github.com/pulumi/pulumi-vault/blob/ebbace55ace6f59a082f504fcae2277b394db92f/sdk/nodejs/config/vars.ts#L61">
