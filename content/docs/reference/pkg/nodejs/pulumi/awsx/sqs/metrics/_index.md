---
title: Module sqs/metrics
---

<!-- WARNING: this page was generated by a tool. Do not edit it by hand. -->
<!-- To change it, please see https://github.com/pulumi/docs/tree/master/tools/tscdocgen. -->

<a href="../../">@pulumi/awsx</a> &gt; <a href="../">sqs</a> &gt; metrics
...
<ul>
<li><a href="#approximateAgeOfOldestMessage">function approximateAgeOfOldestMessage</a></li>
<li><a href="#approximateNumberOfMessagesDelayed">function approximateNumberOfMessagesDelayed</a></li>
<li><a href="#approximateNumberOfMessagesNotVisible">function approximateNumberOfMessagesNotVisible</a></li>
<li><a href="#approximateNumberOfMessagesVisible">function approximateNumberOfMessagesVisible</a></li>
<li><a href="#metric">function metric</a></li>
<li><a href="#numberOfEmptyReceives">function numberOfEmptyReceives</a></li>
<li><a href="#numberOfMessagesDeleted">function numberOfMessagesDeleted</a></li>
<li><a href="#numberOfMessagesReceived">function numberOfMessagesReceived</a></li>
<li><a href="#numberOfMessagesSent">function numberOfMessagesSent</a></li>
<li><a href="#sentMessageSize">function sentMessageSize</a></li>
<li><a href="#SqsMetricChange">interface SqsMetricChange</a></li>
<li><a href="#SqsMetricName">type SqsMetricName</a></li>
</ul>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L78" >}}">function <b>approximateAgeOfOldestMessage</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L92" >}}">function <b>approximateNumberOfMessagesDelayed</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L106" >}}">function <b>approximateNumberOfMessagesNotVisible</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L118" >}}">function <b>approximateNumberOfMessagesVisible</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L54" >}}">function <b>metric</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L130" >}}">function <b>numberOfEmptyReceives</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L155" >}}">function <b>numberOfMessagesDeleted</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L162" >}}">function <b>numberOfMessagesReceived</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L174" >}}">function <b>numberOfMessagesSent</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L186" >}}">function <b>sentMessageSize</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L27" >}}">interface <b>SqsMetricChange</b></a>
</h2>
<div class="pdoc-module-contents">
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="sqs/metrics.ts#L21" >}}">type <b>SqsMetricName</b></a>
</h2>
<div class="pdoc-module-contents">
