---
title: Module efs/metrics
---

<!-- WARNING: this page was generated by a tool. Do not edit it by hand. -->
<!-- To change it, please see https://github.com/pulumi/docs/tree/master/tools/tscdocgen. -->

<a href="../../">@pulumi/awsx</a> &gt; <a href="../">efs</a> &gt; metrics
...
<ul>
<li><a href="#burstCreditBalance">function burstCreditBalance</a></li>
<li><a href="#clientConnections">function clientConnections</a></li>
<li><a href="#dataReadIOBytes">function dataReadIOBytes</a></li>
<li><a href="#dataWriteIOBytes">function dataWriteIOBytes</a></li>
<li><a href="#metadataIOBytes">function metadataIOBytes</a></li>
<li><a href="#metric">function metric</a></li>
<li><a href="#percentIOLimit">function percentIOLimit</a></li>
<li><a href="#permittedThroughput">function permittedThroughput</a></li>
<li><a href="#totalIOBytes">function totalIOBytes</a></li>
<li><a href="#EfsMetricChange">interface EfsMetricChange</a></li>
<li><a href="#EfsMetricName">type EfsMetricName</a></li>
</ul>

<a href="{{< pkg-url pkg="awsx" path="efs/metrics.ts" >}}">efs/metrics.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L79" >}}">function <b>burstCreditBalance</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L94" >}}">function <b>clientConnections</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L113" >}}">function <b>dataReadIOBytes</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L132" >}}">function <b>dataWriteIOBytes</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L151" >}}">function <b>metadataIOBytes</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L51" >}}">function <b>metric</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L165" >}}">function <b>percentIOLimit</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L185" >}}">function <b>permittedThroughput</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L209" >}}">function <b>totalIOBytes</b></a>
</h2>
<div class="pdoc-module-contents">
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L26" >}}">interface <b>EfsMetricChange</b></a>
</h2>
<div class="pdoc-module-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L30" >}}">property <b>fileSystem</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="efs/metrics.ts#L21" >}}">type <b>EfsMetricName</b></a>
</h2>
<div class="pdoc-module-contents">
