...
<a class="pdoc-member-name" href="{{< pkg-url pkg="awsx" path="lambda/metrics.ts#L20" >}}">module <b>metrics</b></a>
</h2>
<div class="pdoc-module-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="awsx" path="lambda/metrics.ts#L25" >}}">interface <b>LambdaMetricChange</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}
{{% /md %}}
