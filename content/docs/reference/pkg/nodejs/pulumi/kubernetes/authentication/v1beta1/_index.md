...
<a class="pdoc-member-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L13" >}}">class <b>TokenReview</b></a>
</h2>
<div class="pdoc-module-contents">
...
<pre class="highlight"><span class='kd'></span><span class='kd'>new</span> TokenReview(name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>, args?: <a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/input/authentication/v1beta1/#TokenReview'>inputs.authentication.v1beta1.TokenReview</a>, opts?: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions'>pulumi.CustomResourceOptions</a>)</pre>
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L20" >}}">property <b>apiVersion</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L28" >}}">property <b>kind</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L31" >}}">property <b>metadata</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L36" >}}">property <b>spec</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>spec: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/authentication/v1beta1/#TokenReviewSpec'>outputs.authentication.v1beta1.TokenReviewSpec</a>&gt;;</pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="authentication/v1beta1/TokenReview.ts#L41" >}}">property <b>status</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>status: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/authentication/v1beta1/#TokenReviewStatus'>outputs.authentication.v1beta1.TokenReviewStatus</a>&gt;;</pre>
{{% md %}}
