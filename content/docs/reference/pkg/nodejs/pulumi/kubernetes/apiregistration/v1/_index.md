...
<a href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts" >}}">apiregistration/v1/APIService.ts</a> <a href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts" >}}">apiregistration/v1/APIServiceList.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L12" >}}">class <b>APIService</b></a>
</h2>
<div class="pdoc-module-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L71" >}}"> <b>constructor</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}

<pre class="highlight"><span class='kd'></span><span class='kd'>new</span> APIService(name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>, args?: <a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/input/apiregistration/v1/#APIService'>inputs.apiregistration.v1.APIService</a>, opts?: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions'>pulumi.CustomResourceOptions</a>)</pre>
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L54" >}}">method <b>get</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L65" >}}">method <b>isInstance</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L19" >}}">property <b>apiVersion</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L27" >}}">property <b>kind</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L30" >}}">property <b>metadata</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L35" >}}">property <b>spec</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>spec: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/apiregistration/v1/#APIServiceSpec'>outputs.apiregistration.v1.APIServiceSpec</a>&gt;;</pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIService.ts#L40" >}}">property <b>status</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>status: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/apiregistration/v1/#APIServiceStatus'>outputs.apiregistration.v1.APIServiceStatus</a>&gt;;</pre>
{{% md %}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L12" >}}">class <b>APIServiceList</b></a>
</h2>
<div class="pdoc-module-contents">
<pre class="highlight"><span class='kd'>extends</span> <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResource'>CustomResource</a></pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L64" >}}"> <b>constructor</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}

<pre class="highlight"><span class='kd'></span><span class='kd'>new</span> APIServiceList(name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>, args?: <a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/input/apiregistration/v1/#APIServiceList'>inputs.apiregistration.v1.APIServiceList</a>, opts?: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions'>pulumi.CustomResourceOptions</a>)</pre>
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L47" >}}">method <b>get</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L58" >}}">method <b>isInstance</b></a>
</h3>
<div class="pdoc-member-contents">
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L19" >}}">property <b>apiVersion</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>apiVersion: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<span class='s2'>"apiregistration.k8s.io/v1"</span>&gt;;</pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L22" >}}">property <b>items</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>items: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/apiregistration/v1/#APIService'>outputs.apiregistration.v1.APIService</a>[]&gt;;</pre>
{{% md %}}
{{% /md %}}
</div>
<h3 class="pdoc-member-header" id="APIServiceList-kind">
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L30" >}}">property <b>kind</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="apiregistration/v1/APIServiceList.ts#L33" >}}">property <b>metadata</b></a>
</h3>
<div class="pdoc-member-contents">
