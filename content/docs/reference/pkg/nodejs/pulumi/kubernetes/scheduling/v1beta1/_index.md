...
<a class="pdoc-member-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L14" >}}">class <b>PriorityClass</b></a>
</h2>
<div class="pdoc-module-contents">
...
<pre class="highlight"><span class='kd'></span><span class='kd'>new</span> PriorityClass(name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>, args?: <a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/input/scheduling/v1beta1/#PriorityClass'>inputs.scheduling.v1beta1.PriorityClass</a>, opts?: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions'>pulumi.CustomResourceOptions</a>)</pre>
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L21" >}}">property <b>apiVersion</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L27" >}}">property <b>description</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L36" >}}">property <b>globalDefault</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L44" >}}">property <b>kind</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L50" >}}">property <b>metadata</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L57" >}}">property <b>preemptionPolicy</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClass.ts#L63" >}}">property <b>value</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClassList.ts#L12" >}}">class <b>PriorityClassList</b></a>
</h2>
<div class="pdoc-module-contents">
<pre class="highlight"><span class='kd'>extends</span> <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResource'>CustomResource</a></pre>
{{% md %}}
...
<pre class="highlight"><span class='kd'></span><span class='kd'>new</span> PriorityClassList(name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>, args?: <a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/input/scheduling/v1beta1/#PriorityClassList'>inputs.scheduling.v1beta1.PriorityClassList</a>, opts?: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions'>pulumi.CustomResourceOptions</a>)</pre>
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClassList.ts#L19" >}}">property <b>apiVersion</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>apiVersion: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<span class='s2'>"scheduling.k8s.io/v1beta1"</span>&gt;;</pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClassList.ts#L24" >}}">property <b>items</b></a>
</h3>
<div class="pdoc-member-contents">
<pre class="highlight"><span class='kd'>public </span>items: <a href='/docs/reference/pkg/nodejs/pulumi/pulumi/#Output'>pulumi.Output</a>&lt;<a href='/docs/reference/pkg/nodejs/pulumi/@pulumi/kubernetes/types/output/scheduling/v1beta1/#PriorityClass'>outputs.scheduling.v1beta1.PriorityClass</a>[]&gt;;</pre>
{{% md %}}
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClassList.ts#L32" >}}">property <b>kind</b></a>
</h3>
<div class="pdoc-member-contents">
...
<a class="pdoc-child-name" href="{{< pkg-url pkg="kubernetes" path="scheduling/v1beta1/PriorityClassList.ts#L38" >}}">property <b>metadata</b></a>
</h3>
<div class="pdoc-member-contents">
