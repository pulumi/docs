...
<a href="{{< pkg-url pkg="newrelic" path="config/vars.ts" >}}">config/vars.ts</a> 
</div>
</div>
</div>
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="newrelic" path="config/vars.ts#L9" >}}">let <b>apiKey</b></a>
</h2>
<div class="pdoc-module-contents">
{{< md-disable >}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="newrelic" path="config/vars.ts#L10" >}}">let <b>apiUrl</b></a>
</h2>
<div class="pdoc-module-contents">
{{< md-disable >}}
...
<a class="pdoc-member-name" href="{{< pkg-url pkg="newrelic" path="config/vars.ts#L11" >}}">let <b>infraApiUrl</b></a>
</h2>
<div class="pdoc-module-contents">
{{< md-disable >}}
