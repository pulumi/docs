...
<h3 class="pdoc-module-header" id="anonymous" data-link-title="anonymous">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L13">
...
<h3 class="pdoc-module-header" id="baseUrl" data-link-title="baseUrl">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L17">
...
<h3 class="pdoc-module-header" id="individual" data-link-title="individual">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L21">
...
<h3 class="pdoc-module-header" id="insecure" data-link-title="insecure">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L25">
...
<h3 class="pdoc-module-header" id="organization" data-link-title="organization">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L29">
...
<h3 class="pdoc-module-header" id="token" data-link-title="token">
    <a href="https://github.com/pulumi/pulumi-github/blob/{{< param git_sha >}}/sdk/nodejs/config/vars.ts#L33">
