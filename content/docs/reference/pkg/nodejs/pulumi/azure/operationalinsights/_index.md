...
<a href="{{< pkg-url pkg="azure" path="operationalinsights/analyticsSolution.ts" >}}">operationalinsights/analyticsSolution.ts</a> <a href="{{< pkg-url pkg="azure" path="operationalinsights/analyticsWorkspace.ts" >}}">operationalinsights/analyticsWorkspace.ts</a> <a href="{{< pkg-url pkg="azure" path="operationalinsights/analyticsWorkspaceLinkedService.ts" >}}">operationalinsights/analyticsWorkspaceLinkedService.ts</a> <a href="{{< pkg-url pkg="azure" path="operationalinsights/getAnalyticsWorkspace.ts" >}}">operationalinsights/getAnalyticsWorkspace.ts</a> 
</div>
</div>
</div>
