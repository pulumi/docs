...
<h3 class="pdoc-module-header" id="getBuiltinRoleDefinition" data-link-title="getBuiltinRoleDefinition">
    <a href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L16">
...
<h3 class="pdoc-module-header" id="GetBuiltinRoleDefinitionArgs" data-link-title="GetBuiltinRoleDefinitionArgs">
    <a href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L34">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L38">property <b>name</b></a>
</h4>
...
<h3 class="pdoc-module-header" id="GetBuiltinRoleDefinitionResult" data-link-title="GetBuiltinRoleDefinitionResult">
    <a href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L44">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L48">property <b>assignableScopes</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L52">property <b>description</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L65">property <b>id</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L53">property <b>name</b></a>
</h4>

<pre class="highlight"><code><span class='kd'></span>name: <span class='kd'><a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String'>string</a></span>;</code></pre>
<h4 class="pdoc-member-header" id="GetBuiltinRoleDefinitionResult-permissions">
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L57">property <b>permissions</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-azure/blob/{{< param git_sha >}}/sdk/nodejs/authorization/getBuiltinRoleDefinition.ts#L61">property <b>type</b></a>
</h4>
