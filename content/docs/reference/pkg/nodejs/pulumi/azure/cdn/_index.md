...
<a href="{{< pkg-url pkg="azure" path="cdn/endpoint.ts" >}}">cdn/endpoint.ts</a> <a href="{{< pkg-url pkg="azure" path="cdn/getProfile.ts" >}}">cdn/getProfile.ts</a> <a href="{{< pkg-url pkg="azure" path="cdn/profile.ts" >}}">cdn/profile.ts</a> 
</div>
</div>
</div>
