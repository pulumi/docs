...
git_sha: "ec4be43cce40cb1042d71163c17391f91e46f32f"
---
...
<h3 class="pdoc-module-header" id="PolicyResource" data-link-title="PolicyResource">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L223">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L242">property <b>name</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L232">property <b>props</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L227">property <b>type</b></a>
</h4>
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L237">property <b>urn</b></a>
</h4>
...
<h3 class="pdoc-module-header" id="ReportViolation" data-link-title="ReportViolation">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L252">
...
<h3 class="pdoc-module-header" id="StackValidation" data-link-title="StackValidation">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L208">
...
<h3 class="pdoc-module-header" id="StackValidationArgs" data-link-title="StackValidationArgs">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L213">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L217">property <b>resources</b></a>
</h4>
...
<h3 class="pdoc-module-header" id="StackValidationPolicy" data-link-title="StackValidationPolicy">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L193">
...
<a class="pdoc-child-name" href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L197">property <b>validateStack</b></a>
</h4>
...
<h3 class="pdoc-module-header" id="validateTypedResource" data-link-title="validateTypedResource">
    <a href="https://github.com/pulumi/pulumi-policy/blob/{{< param git_sha >}}/sdk/nodejs/policy/policy.ts#L171">
