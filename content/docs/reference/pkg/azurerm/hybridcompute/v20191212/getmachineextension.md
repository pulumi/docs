...
title_tag: "Function GetMachineExtension | Module hybridcompute/v20191212 | Package azurerm"
meta_desc: "Explore the GetMachineExtension function of the hybridcompute/v20191212 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetMachineExtension </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Hybridcompute/v20191212.GetMachineExtensionResult.html">GetMachineExtensionResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.HybridCompute.V20191212.GetMachineExtensionArgs.html">GetMachineExtensionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#machineextensionpropertiesresponseinstanceview">Pulumi.<wbr>Azure<wbr>RM.<wbr>Hybrid<wbr>Compute.<wbr>V20191212.<wbr>Outputs.<wbr>Machine<wbr>Extension<wbr>Properties<wbr>Response<wbr>Instance<wbr>View</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hybridcompute/v20191212?tab=doc#MachineExtensionPropertiesResponseInstanceView">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
