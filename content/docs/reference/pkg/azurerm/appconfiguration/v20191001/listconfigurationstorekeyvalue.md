...
title_tag: "Function ListConfigurationStoreKeyValue | Module appconfiguration/v20191001 | Package azurerm"
meta_desc: "Explore the ListConfigurationStoreKeyValue function of the appconfiguration/v20191001 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListConfigurationStoreKeyValue </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Appconfiguration/v20191001.ListConfigurationStoreKeyValueResult.html">ListConfigurationStoreKeyValueResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.AppConfiguration.V20191001.ListConfigurationStoreKeyValueArgs.html">ListConfigurationStoreKeyValueArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
