...
---
title: "GetBuildTask"
title_tag: "Function GetBuildTask | Module containerregistry/v20180201preview | Package Azure RM"
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getBuildTask<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/containerregistry/v20180201preview/#GetBuildTaskArgs">GetBuildTaskArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/containerregistry/v20180201preview/#GetBuildTaskResult">GetBuildTaskResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetBuildTask </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Containerregistry/v20180201preview.GetBuildTaskResult.html">GetBuildTaskResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ContainerRegistry.V20180201Preview.GetBuildTaskArgs.html">GetBuildTaskArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#platform_csharp" style="color: inherit; text-decoration: inherit;">Platform</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#platformpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Container<wbr>Registry.<wbr>V20180201Preview.<wbr>Outputs.<wbr>Platform<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a href="#sourcerepository_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Repository</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourcerepositorypropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Container<wbr>Registry.<wbr>V20180201Preview.<wbr>Outputs.<wbr>Source<wbr>Repository<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerregistry/v20180201preview?tab=doc#PlatformPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/containerregistry/v20180201preview?tab=doc#SourceRepositoryPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
