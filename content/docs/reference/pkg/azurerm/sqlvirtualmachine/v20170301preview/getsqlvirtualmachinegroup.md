...
<a href="#wsfcdomainprofile_csharp" style="color: inherit; text-decoration: inherit;">Wsfc<wbr>Domain<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#wsfcdomainprofileresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql<wbr>Virtual<wbr>Machine.<wbr>V20170301Preview.<wbr>Outputs.<wbr>Wsfc<wbr>Domain<wbr>Profile<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sqlvirtualmachine/v20170301preview?tab=doc#WsfcDomainProfileResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
