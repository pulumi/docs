...
title_tag: "Function GetAvailabilityGroupListener | Module sqlvirtualmachine/preview | Package azurerm"
meta_desc: "Explore the GetAvailabilityGroupListener function of the sqlvirtualmachine/preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAvailabilityGroupListener </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Sqlvirtualmachine/preview.GetAvailabilityGroupListenerResult.html">GetAvailabilityGroupListenerResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.SqlVirtualMachine.Preview.GetAvailabilityGroupListenerArgs.html">GetAvailabilityGroupListenerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#loadbalancerconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Load<wbr>Balancer<wbr>Configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loadbalancerconfigurationresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql<wbr>Virtual<wbr>Machine.<wbr>Preview.<wbr>Outputs.<wbr>Load<wbr>Balancer<wbr>Configuration<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sqlvirtualmachine/preview?tab=doc#LoadBalancerConfigurationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.SqlVirtualMachine.Preview.Outputs.LoadBalancerConfigurationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#privateipaddress_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Ip<wbr>Address</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateipaddressresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql<wbr>Virtual<wbr>Machine.<wbr>Preview.<wbr>Inputs.<wbr>Private<wbr>IPAddress<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sqlvirtualmachine/preview?tab=doc#PrivateIPAddressResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.SqlVirtualMachine.Preview.Outputs.PrivateIPAddressResponse.html">output</a> API doc for this type.
{{% /choosable %}}
