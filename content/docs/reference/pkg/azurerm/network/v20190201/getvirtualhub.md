...
---
title: "GetVirtualHub"
title_tag: "Function GetVirtualHub | Module network/v20190201 | Package azurerm"
meta_desc: "Explore the GetVirtualHub function of the network/v20190201 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#routetable_csharp" style="color: inherit; text-decoration: inherit;">Route<wbr>Table</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualhubroutetableresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190201.<wbr>Outputs.<wbr>Virtual<wbr>Hub<wbr>Route<wbr>Table<wbr>Response</a></span>
    </dt>
...
<a href="#virtualnetworkconnections_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Connections</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hubvirtualnetworkconnectionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190201.<wbr>Outputs.<wbr>Hub<wbr>Virtual<wbr>Network<wbr>Connection<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20190201?tab=doc#HubVirtualNetworkConnectionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20190201?tab=doc#VirtualHubRouteResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20190201?tab=doc#VirtualHubRouteTableResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
