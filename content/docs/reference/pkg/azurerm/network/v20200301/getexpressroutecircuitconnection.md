...
title_tag: "Function GetExpressRouteCircuitConnection | Module network/v20200301 | Package azurerm"
meta_desc: "Explore the GetExpressRouteCircuitConnection function of the network/v20200301 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#ipv6circuitconnectionconfig_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Circuit<wbr>Connection<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6circuitconnectionconfigresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200301.<wbr>Outputs.<wbr>Ipv6Circuit<wbr>Connection<wbr>Config<wbr>Response</a></span>
    </dt>
