...
title_tag: "Function GetVirtualNetworkPeering | Module network/v20181201 | Package azurerm"
meta_desc: "Explore the GetVirtualNetworkPeering function of the network/v20181201 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#remoteaddressspace_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Address<wbr>Space</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressspaceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20181201.<wbr>Outputs.<wbr>Address<wbr>Space<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20181201?tab=doc#AddressSpaceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
