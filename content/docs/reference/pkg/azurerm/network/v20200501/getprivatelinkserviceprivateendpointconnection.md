...
title_tag: "Function GetPrivateLinkServicePrivateEndpointConnection | Module network/v20200501 | Package azurerm"
meta_desc: "Explore the GetPrivateLinkServicePrivateEndpointConnection function of the network/v20200501 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetPrivateLinkServicePrivateEndpointConnection </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network/v20200501.GetPrivateLinkServicePrivateEndpointConnectionResult.html">GetPrivateLinkServicePrivateEndpointConnectionResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20200501.GetPrivateLinkServicePrivateEndpointConnectionArgs.html">GetPrivateLinkServicePrivateEndpointConnectionArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
