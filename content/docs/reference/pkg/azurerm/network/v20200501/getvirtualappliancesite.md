...
title_tag: "Function GetVirtualApplianceSite | Module network/v20200501 | Package azurerm"
meta_desc: "Explore the GetVirtualApplianceSite function of the network/v20200501 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetVirtualApplianceSite </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network/v20200501.GetVirtualApplianceSiteResult.html">GetVirtualApplianceSiteResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20200501.GetVirtualApplianceSiteArgs.html">GetVirtualApplianceSiteArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#o365policy_csharp" style="color: inherit; text-decoration: inherit;">O365Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#office365policypropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200501.<wbr>Outputs.<wbr>Office365Policy<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200501?tab=doc#BreakOutCategoryPoliciesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20200501.Outputs.BreakOutCategoryPoliciesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200501?tab=doc#Office365PolicyPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20200501.Outputs.Office365PolicyPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#breakoutcategories_csharp" style="color: inherit; text-decoration: inherit;">Break<wbr>Out<wbr>Categories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#breakoutcategorypoliciesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200501.<wbr>Inputs.<wbr>Break<wbr>Out<wbr>Category<wbr>Policies<wbr>Response<wbr>Args</a></span>
    </dt>
