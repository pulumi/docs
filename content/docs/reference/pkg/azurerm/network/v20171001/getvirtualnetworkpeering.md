...
title_tag: "Function GetVirtualNetworkPeering | Module network/v20171001 | Package azurerm"
meta_desc: "Explore the GetVirtualNetworkPeering function of the network/v20171001 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#remoteaddressspace_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Address<wbr>Space</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressspaceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20171001.<wbr>Outputs.<wbr>Address<wbr>Space<wbr>Response</a></span>
    </dt>
...
<a href="#remotevirtualnetwork_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Virtual<wbr>Network</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subresourceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20171001.<wbr>Outputs.<wbr>Sub<wbr>Resource<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20171001?tab=doc#AddressSpaceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20171001.Outputs.AddressSpaceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20171001?tab=doc#SubResourceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20171001.Outputs.SubResourceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
