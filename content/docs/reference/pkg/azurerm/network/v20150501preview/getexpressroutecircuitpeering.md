...
title_tag: "Function GetExpressRouteCircuitPeering | Module network/v20150501preview | Package azurerm"
meta_desc: "Explore the GetExpressRouteCircuitPeering function of the network/v20150501preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#microsoftpeeringconfig_csharp" style="color: inherit; text-decoration: inherit;">Microsoft<wbr>Peering<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expressroutecircuitpeeringconfigresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20150501Preview.<wbr>Outputs.<wbr>Express<wbr>Route<wbr>Circuit<wbr>Peering<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#stats_csharp" style="color: inherit; text-decoration: inherit;">Stats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expressroutecircuitstatsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20150501Preview.<wbr>Outputs.<wbr>Express<wbr>Route<wbr>Circuit<wbr>Stats<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20150501preview?tab=doc#ExpressRouteCircuitPeeringConfigResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20150501Preview.Outputs.ExpressRouteCircuitPeeringConfigResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20150501preview?tab=doc#ExpressRouteCircuitStatsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20150501Preview.Outputs.ExpressRouteCircuitStatsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
