...
title_tag: "Function GetExpressRouteCrossConnectionPeering | Module network/v20190801 | Package azurerm"
meta_desc: "Explore the GetExpressRouteCrossConnectionPeering function of the network/v20190801 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetExpressRouteCrossConnectionPeering </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network/v20190801.GetExpressRouteCrossConnectionPeeringResult.html">GetExpressRouteCrossConnectionPeeringResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20190801.GetExpressRouteCrossConnectionPeeringArgs.html">GetExpressRouteCrossConnectionPeeringArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#ipv6peeringconfig_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Peering<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipv6expressroutecircuitpeeringconfigresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190801.<wbr>Outputs.<wbr>Ipv6Express<wbr>Route<wbr>Circuit<wbr>Peering<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#microsoftpeeringconfig_csharp" style="color: inherit; text-decoration: inherit;">Microsoft<wbr>Peering<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expressroutecircuitpeeringconfigresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190801.<wbr>Outputs.<wbr>Express<wbr>Route<wbr>Circuit<wbr>Peering<wbr>Config<wbr>Response</a></span>
    </dt>
