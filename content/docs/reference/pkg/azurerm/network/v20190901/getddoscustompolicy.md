...
title_tag: "Function GetDdosCustomPolicy | Module network/v20190901 | Package azurerm"
meta_desc: "Explore the GetDdosCustomPolicy function of the network/v20190901 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#protocolcustomsettings_csharp" style="color: inherit; text-decoration: inherit;">Protocol<wbr>Custom<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#protocolcustomsettingsformatresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190901.<wbr>Outputs.<wbr>Protocol<wbr>Custom<wbr>Settings<wbr>Format<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20190901?tab=doc#ProtocolCustomSettingsFormatResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20190901.Outputs.ProtocolCustomSettingsFormatResponse.html">output</a> API doc for this type.
{{% /choosable %}}
