...
title_tag: "Function GetSecurityRule | Module network/v20190601 | Package azurerm"
meta_desc: "Explore the GetSecurityRule function of the network/v20190601 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#destinationapplicationsecuritygroups_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Application<wbr>Security<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationsecuritygroupresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20190601.<wbr>Outputs.<wbr>Application<wbr>Security<wbr>Group<wbr>Response&gt;</a></span>
    </dt>
