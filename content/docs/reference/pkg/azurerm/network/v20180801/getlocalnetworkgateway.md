...
title_tag: "Function GetLocalNetworkGateway | Module network/v20180801 | Package azurerm"
meta_desc: "Explore the GetLocalNetworkGateway function of the network/v20180801 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#bgpsettings_csharp" style="color: inherit; text-decoration: inherit;">Bgp<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bgpsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20180801.<wbr>Outputs.<wbr>Bgp<wbr>Settings<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20180801?tab=doc#BgpSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
