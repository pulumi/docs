...
---
title: "GetVpnSite"
title_tag: "Function GetVpnSite | Module network/v20180801 | Package azurerm"
meta_desc: "Explore the GetVpnSite function of the network/v20180801 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#deviceproperties_csharp" style="color: inherit; text-decoration: inherit;">Device<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#devicepropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20180801.<wbr>Outputs.<wbr>Device<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20180801?tab=doc#DevicePropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
