...
title_tag: "Function GetDdosCustomPolicy | Module network/latest | Package Azure RM"
meta_desc: "Explore the GetDdosCustomPolicy function of the network/latest module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#protocolcustomsettings_csharp" style="color: inherit; text-decoration: inherit;">Protocol<wbr>Custom<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#protocolcustomsettingsformatresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>Latest.<wbr>Outputs.<wbr>Protocol<wbr>Custom<wbr>Settings<wbr>Format<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/latest?tab=doc#ProtocolCustomSettingsFormatResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
