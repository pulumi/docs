...
title_tag: "Function GetInterfaceEndpoint | Module network/latest | Package Azure RM"
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/latest?tab=doc#EndpointServiceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
