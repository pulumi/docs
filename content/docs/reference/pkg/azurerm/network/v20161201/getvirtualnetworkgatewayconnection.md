...
title_tag: "Function GetVirtualNetworkGatewayConnection | Module network/v20161201 | Package azurerm"
meta_desc: "Explore the GetVirtualNetworkGatewayConnection function of the network/v20161201 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#virtualnetworkgateway1_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway1</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkgatewayresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20161201.<wbr>Outputs.<wbr>Virtual<wbr>Network<wbr>Gateway<wbr>Response</a></span>
    </dt>
...
<a href="#localnetworkgateway2_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Network<wbr>Gateway2</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localnetworkgatewayresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20161201.<wbr>Outputs.<wbr>Local<wbr>Network<wbr>Gateway<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A common class for general resource information{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20161201?tab=doc#LocalNetworkGatewayResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20161201?tab=doc#TunnelConnectionHealthResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20161201?tab=doc#VirtualNetworkGatewayResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
