...
title_tag: "Function GetDscpConfiguration | Module network/v20200601 | Package azurerm"
meta_desc: "Explore the GetDscpConfiguration function of the network/v20200601 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetDscpConfiguration </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network/v20200601.GetDscpConfigurationResult.html">GetDscpConfigurationResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Network.V20200601.GetDscpConfigurationArgs.html">GetDscpConfigurationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#destinationipranges_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#qosiprangeresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200601.<wbr>Outputs.<wbr>Qos<wbr>Ip<wbr>Range<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#destinationportranges_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Port<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#qosportrangeresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200601.<wbr>Outputs.<wbr>Qos<wbr>Port<wbr>Range<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#QosIpRangeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#QosPortRangeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
