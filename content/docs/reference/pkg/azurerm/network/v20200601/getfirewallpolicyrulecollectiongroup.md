...
title_tag: "Function GetFirewallPolicyRuleCollectionGroup | Module network/v20200601 | Package azurerm"
meta_desc: "Explore the GetFirewallPolicyRuleCollectionGroup function of the network/v20200601 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#rulecollections_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Collections</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Union&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200601.<wbr>Outputs.<wbr>Firewall<wbr>Policy<wbr>Filter<wbr>Rule<wbr>Collection<wbr>Response, Pulumi.<wbr>Azure<wbr>RM.<wbr>Network.<wbr>V20200601.<wbr>Outputs.<wbr>Firewall<wbr>Policy<wbr>Nat<wbr>Rule<wbr>Collection<wbr>Response&gt;&gt;</span>
    </dt>
...
<a href="#rule_collections_python" style="color: inherit; text-decoration: inherit;">rule_<wbr>collections</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azurerm:Network/V20200601:Firewall<wbr>Policy<wbr>Filter<wbr>Rule<wbr>Collection<wbr>Response, Azurerm:Network/V20200601:Firewall<wbr>Policy<wbr>Nat<wbr>Rule<wbr>Collection<wbr>Response, Default=>]</span>
    </dt>
    <dd>{{% md %}}Group of Firewall Policy rule collections.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#ApplicationRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#FirewallPolicyFilterRuleCollectionActionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#FirewallPolicyFilterRuleCollectionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#FirewallPolicyNatRuleCollectionActionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#FirewallPolicyNatRuleCollectionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#FirewallPolicyRuleApplicationProtocolResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#NatRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/network/v20200601?tab=doc#NetworkRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
