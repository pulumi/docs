...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listConnectedClusterUserCredentials<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/kubernetes/v20200101preview/#ListConnectedClusterUserCredentialsArgs">ListConnectedClusterUserCredentialsArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/kubernetes/v20200101preview/#ListConnectedClusterUserCredentialsResult">ListConnectedClusterUserCredentialsResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>ListConnectedClusterUserCredentials<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kubernetes/v20200101preview?tab=doc#ListConnectedClusterUserCredentialsArgs">ListConnectedClusterUserCredentialsArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kubernetes/v20200101preview?tab=doc#ListConnectedClusterUserCredentialsResult">ListConnectedClusterUserCredentialsResult</a></span>, error)</span></code></pre></div>
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authenticationdetailsvalue">Pulumi.<wbr>Azure<wbr>RM.<wbr>Kubernetes.<wbr>V20200101Preview.<wbr>Inputs.<wbr>Authentication<wbr>Details<wbr>Value<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#kubeconfigs_csharp" style="color: inherit; text-decoration: inherit;">Kubeconfigs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#credentialresultresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Kubernetes.<wbr>V20200101Preview.<wbr>Outputs.<wbr>Credential<wbr>Result<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/input/#AuthenticationCertificateDetails">input</a>   API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kubernetes/v20200101preview?tab=doc#AuthenticationCertificateDetailsArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kubernetes.V20200101Preview.Inputs.AuthenticationCertificateDetailsArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/input/#AuthenticationDetailsValue">input</a>   API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kubernetes/v20200101preview?tab=doc#AuthenticationDetailsValueArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kubernetes.V20200101Preview.Inputs.AuthenticationDetailsValueArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#clientcertificate_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Certificate</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authenticationcertificatedetails">Pulumi.<wbr>Azure<wbr>RM.<wbr>Kubernetes.<wbr>V20200101Preview.<wbr>Inputs.<wbr>Authentication<wbr>Certificate<wbr>Details<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kubernetes/v20200101preview?tab=doc#CredentialResultResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kubernetes.V20200101Preview.Outputs.CredentialResultResponse.html">output</a> API doc for this type.
{{% /choosable %}}
