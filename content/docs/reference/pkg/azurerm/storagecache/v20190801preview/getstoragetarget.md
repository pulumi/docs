...
title_tag: "Function GetStorageTarget | Module storagecache/v20190801preview | Package azurerm"
meta_desc: "Explore the GetStorageTarget function of the storagecache/v20190801preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetStorageTarget </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storagecache/v20190801preview.GetStorageTargetResult.html">GetStorageTargetResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageCache.V20190801Preview.GetStorageTargetArgs.html">GetStorageTargetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#storagetargetname_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Target<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of storage target.{{% /md %}}</dd>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}A fully qualified URL.{{% /md %}}</dd>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type for the storage target; Microsoft.StorageCache/Cache/StorageTarget{{% /md %}}</dd>
...
<a href="#clfs_csharp" style="color: inherit; text-decoration: inherit;">Clfs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clfstargetresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Cache.<wbr>V20190801Preview.<wbr>Outputs.<wbr>Clfs<wbr>Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties when clfs target.{{% /md %}}</dd>
...
<a href="#junctions_csharp" style="color: inherit; text-decoration: inherit;">Junctions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#namespacejunctionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Cache.<wbr>V20190801Preview.<wbr>Outputs.<wbr>Namespace<wbr>Junction<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of cache namespace to target namespace associations.{{% /md %}}</dd>
...
<a href="#nfs3_csharp" style="color: inherit; text-decoration: inherit;">Nfs3</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nfs3targetresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Cache.<wbr>V20190801Preview.<wbr>Outputs.<wbr>Nfs3Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties when nfs3 target.{{% /md %}}</dd>
...
<a href="#targettype_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Type</a>
    ...
    <dd>{{% md %}}Type for storage target.{{% /md %}}</dd>
...
<a href="#unknown_csharp" style="color: inherit; text-decoration: inherit;">Unknown</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#unknowntargetresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Cache.<wbr>V20190801Preview.<wbr>Outputs.<wbr>Unknown<wbr>Target<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties when unknown target.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagecache/v20190801preview?tab=doc#ClfsTargetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageCache.V20190801Preview.Outputs.ClfsTargetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
    ...
    <dd>{{% md %}}URL of storage container.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagecache/v20190801preview?tab=doc#NamespaceJunctionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageCache.V20190801Preview.Outputs.NamespaceJunctionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagecache/v20190801preview?tab=doc#Nfs3TargetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageCache.V20190801Preview.Outputs.Nfs3TargetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
    ...
    <dd>{{% md %}}IP or name of an NFS Storage Target host, ie: 10.0.44.44{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagecache/v20190801preview?tab=doc#UnknownTargetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageCache.V20190801Preview.Outputs.UnknownTargetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#unknownmap_csharp" style="color: inherit; text-decoration: inherit;">Unknown<wbr>Map</a>
    ...
    <dd>{{% md %}}Dictionary of string->string pairs containing information about the StorageTarget.{{% /md %}}</dd>
