...
title_tag: "Function GetAppServiceEnvironment | Module web/v20200601 | Package azurerm"
meta_desc: "Explore the GetAppServiceEnvironment function of the web/v20200601 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getAppServiceEnvironment<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/web/v20200601/#GetAppServiceEnvironmentArgs">GetAppServiceEnvironmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/web/v20200601/#GetAppServiceEnvironmentResult">GetAppServiceEnvironmentResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAppServiceEnvironment </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web/v20200601.GetAppServiceEnvironmentResult.html">GetAppServiceEnvironmentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.V20200601.GetAppServiceEnvironmentArgs.html">GetAppServiceEnvironmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#virtualnetwork_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkprofileresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>V20200601.<wbr>Outputs.<wbr>Virtual<wbr>Network<wbr>Profile<wbr>Response</a></span>
    </dt>
...
<a href="#workerpools_csharp" style="color: inherit; text-decoration: inherit;">Worker<wbr>Pools</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workerpoolresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>V20200601.<wbr>Outputs.<wbr>Worker<wbr>Pool<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#clustersettings_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#namevaluepairresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>V20200601.<wbr>Outputs.<wbr>Name<wbr>Value<wbr>Pair<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#networkaccesscontrollist_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Access<wbr>Control<wbr>List</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkaccesscontrolentryresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>V20200601.<wbr>Outputs.<wbr>Network<wbr>Access<wbr>Control<wbr>Entry<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20200601?tab=doc#NetworkAccessControlEntryResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20200601?tab=doc#StampCapacityResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20200601?tab=doc#VirtualIPMappingResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20200601?tab=doc#VirtualNetworkProfileResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20200601?tab=doc#WorkerPoolResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
