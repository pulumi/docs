...
title_tag: "Function ListWebAppBackupStatusSecrets | Module web/latest | Package Azure RM"
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListWebAppBackupStatusSecrets </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web/latest.ListWebAppBackupStatusSecretsResult.html">ListWebAppBackupStatusSecretsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.Latest.ListWebAppBackupStatusSecretsArgs.html">ListWebAppBackupStatusSecretsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#backupschedule_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#backupschedule">Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>Latest.<wbr>Inputs.<wbr>Backup<wbr>Schedule<wbr>Args</a></span>
    </dt>
...
<a href="#databases_csharp" style="color: inherit; text-decoration: inherit;">Databases</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#databasebackupsetting">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Web.<wbr>Latest.<wbr>Inputs.<wbr>Database<wbr>Backup<wbr>Setting<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/latest?tab=doc#BackupScheduleArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.Latest.Inputs.BackupScheduleArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/latest?tab=doc#DatabaseBackupSettingArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.Latest.Inputs.DatabaseBackupSettingArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
