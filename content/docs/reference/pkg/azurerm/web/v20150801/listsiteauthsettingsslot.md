...
---
title: "ListSiteAuthSettingsSlot"
title_tag: "Function ListSiteAuthSettingsSlot | Module web/v20150801 | Package azurerm"
meta_desc: "Explore the ListSiteAuthSettingsSlot function of the web/v20150801 module, including examples, input properties, output properties, and supporting types. "
---
...
## Using ListSiteAuthSettingsSlot {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listSiteAuthSettingsSlot<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/web/v20150801/#ListSiteAuthSettingsSlotArgs">ListSiteAuthSettingsSlotArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/web/v20150801/#ListSiteAuthSettingsSlotResult">ListSiteAuthSettingsSlotResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>list_site_auth_settings_slot(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">slot</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> ListSiteAuthSettingsSlotResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>ListSiteAuthSettingsSlot<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20150801?tab=doc#ListSiteAuthSettingsSlotArgs">ListSiteAuthSettingsSlotArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/web/v20150801?tab=doc#ListSiteAuthSettingsSlotResult">ListSiteAuthSettingsSlotResult</a></span>, error)</span></code></pre></div>

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListSiteAuthSettingsSlot </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web/v20150801.ListSiteAuthSettingsSlotResult.html">ListSiteAuthSettingsSlotResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.V20150801.ListSiteAuthSettingsSlotArgs.html">ListSiteAuthSettingsSlotArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## ListSiteAuthSettingsSlot Result {#result}
...
<a href="#additionalloginparams_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Login<wbr>Params</a>
    ...
    <dd>{{% md %}}Gets or sets a list of login parameters to send to the OpenID Connect authorization endpoint when
...
<a href="#allowedaudiences_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Audiences</a>
    ...
    <dd>{{% md %}}Gets or sets a list of allowed audience values to consider when validating JWTs issued by 
...
<a href="#allowedexternalredirecturls_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>External<wbr>Redirect<wbr>Urls</a>
    ...
    <dd>{{% md %}}Gets or sets a collection of external URLs that can be redirected to as part of logging in
...
<a href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the Client ID of this relying party application, known as the client_id.
...
<a href="#clientsecret_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Secret</a>
    ...
    <dd>{{% md %}}Gets or sets the Client Secret of this relying party application (in Azure Active Directory, this is also referred to as the Key).
...
<a href="#defaultprovider_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Provider</a>
    ...
    <dd>{{% md %}}Gets or sets the default authentication provider to use when multiple providers are configured.
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}Gets or sets a value indicating whether the Authentication / Authorization feature is enabled for the current app.{{% /md %}}</dd>
...
<a href="#facebookappid_csharp" style="color: inherit; text-decoration: inherit;">Facebook<wbr>App<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the App ID of the Facebook app used for login.
...
<a href="#facebookappsecret_csharp" style="color: inherit; text-decoration: inherit;">Facebook<wbr>App<wbr>Secret</a>
    ...
    <dd>{{% md %}}Gets or sets the App Secret of the Facebook app used for Facebook Login.
            This setting is required for enabling Facebook Login.
            Facebook Login documentation: https://developers.facebook.com/docs/facebook-login{{% /md %}}</dd>
...
<a href="#facebookoauthscopes_csharp" style="color: inherit; text-decoration: inherit;">Facebook<wbr>OAuth<wbr>Scopes</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 2.0 scopes that will be requested as part of Facebook Login authentication.
...
<a href="#googleclientid_csharp" style="color: inherit; text-decoration: inherit;">Google<wbr>Client<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the OpenID Connect Client ID for the Google web application.
...
<a href="#googleclientsecret_csharp" style="color: inherit; text-decoration: inherit;">Google<wbr>Client<wbr>Secret</a>
    ...
    <dd>{{% md %}}Gets or sets the client secret associated with the Google web application.
            This setting is required for enabling Google Sign-In.
            Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/{{% /md %}}</dd>
...
<a href="#googleoauthscopes_csharp" style="color: inherit; text-decoration: inherit;">Google<wbr>OAuth<wbr>Scopes</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 2.0 scopes that will be requested as part of Google Sign-In authentication.
            This setting is optional. If not specified, "openid", "profile", and "email" are used as default scopes.
            Google Sign-In documentation: https://developers.google.com/identity/sign-in/web/{{% /md %}}</dd>

    <dt class="property-"
            title="">
        <span id="httpapiprefixpath_csharp">
<a href="#httpapiprefixpath_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Api<wbr>Prefix<wbr>Path</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}Gets or sets the relative path prefix used by platform HTTP APIs.
            Changing this value is not recommended except for compatibility reasons.{{% /md %}}</dd>
...
<a href="#issuer_csharp" style="color: inherit; text-decoration: inherit;">Issuer</a>
    ...
    <dd>{{% md %}}Gets or sets the OpenID Connect Issuer URI that represents the entity which issues access tokens for this application.
...
<a href="#microsoftaccountclientid_csharp" style="color: inherit; text-decoration: inherit;">Microsoft<wbr>Account<wbr>Client<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 2.0 client ID that was created for the app used for authentication.
...
<a href="#microsoftaccountclientsecret_csharp" style="color: inherit; text-decoration: inherit;">Microsoft<wbr>Account<wbr>Client<wbr>Secret</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 2.0 client secret that was created for the app used for authentication.
            This setting is required for enabling Microsoft Account authentication.
            Microsoft Account OAuth documentation: https://dev.onedrive.com/auth/msa_oauth.htm{{% /md %}}</dd>
...
<a href="#microsoftaccountoauthscopes_csharp" style="color: inherit; text-decoration: inherit;">Microsoft<wbr>Account<wbr>OAuth<wbr>Scopes</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 2.0 scopes that will be requested as part of Microsoft Account authentication.
...
<a href="#tokenrefreshextensionhours_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Refresh<wbr>Extension<wbr>Hours</a>
    ...
    <dd>{{% md %}}Gets or sets the number of hours after session token expiration that a session token can be used to
...
<a href="#tokenstoreenabled_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Store<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Gets or sets a value indicating whether to durably store platform-specific security tokens
            obtained during login flows. This capability is disabled by default.{{% /md %}}</dd>
...
<a href="#twitterconsumerkey_csharp" style="color: inherit; text-decoration: inherit;">Twitter<wbr>Consumer<wbr>Key</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 1.0a consumer key of the Twitter application used for sign-in.
...
<a href="#twitterconsumersecret_csharp" style="color: inherit; text-decoration: inherit;">Twitter<wbr>Consumer<wbr>Secret</a>
    ...
    <dd>{{% md %}}Gets or sets the OAuth 1.0a consumer secret of the Twitter application used for sign-in.
            This setting is required for enabling Twitter Sign-In.
            Twitter Sign-In documentation: https://dev.twitter.com/web/sign-in{{% /md %}}</dd>
...
<a href="#unauthenticatedclientaction_csharp" style="color: inherit; text-decoration: inherit;">Unauthenticated<wbr>Client<wbr>Action</a>
    ...
    <dd>{{% md %}}Gets or sets the action to take when an unauthenticated client attempts to access the app.{{% /md %}}</dd>
...
<a href="#googleoauthscopes_go" style="color: inherit; text-decoration: inherit;">Google<wbr>OAuth<wbr>Scopes</a>
    ...
    <dt class="property-"
            title="">
        <span id="httpapiprefixpath_go">
<a href="#httpapiprefixpath_go" style="color: inherit; text-decoration: inherit;">Http<wbr>Api<wbr>Prefix<wbr>Path</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#googleoauthscopes_nodejs" style="color: inherit; text-decoration: inherit;">google<wbr>OAuth<wbr>Scopes</a>
    ...
    <dt class="property-"
            title="">
        <span id="httpapiprefixpath_nodejs">
<a href="#httpapiprefixpath_nodejs" style="color: inherit; text-decoration: inherit;">http<wbr>Api<wbr>Prefix<wbr>Path</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#google_o_auth_scopes_python" style="color: inherit; text-decoration: inherit;">google_<wbr>o_<wbr>auth_<wbr>scopes</a>
    ...
    <dt class="property-"
            title="">
        <span id="http_api_prefix_path_python">
<a href="#http_api_prefix_path_python" style="color: inherit; text-decoration: inherit;">http_<wbr>api_<wbr>prefix_<wbr>path</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
