...
title_tag: "Function GetWebAppInstanceFunctionSlot | Module web/v20190801 | Package azurerm"
meta_desc: "Explore the GetWebAppInstanceFunctionSlot function of the web/v20190801 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWebAppInstanceFunctionSlot </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web/v20190801.GetWebAppInstanceFunctionSlotResult.html">GetWebAppInstanceFunctionSlotResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Web.V20190801.GetWebAppInstanceFunctionSlotArgs.html">GetWebAppInstanceFunctionSlotArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
