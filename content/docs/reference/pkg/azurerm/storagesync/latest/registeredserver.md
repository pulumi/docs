...
title_tag: "Resource RegisteredServer | Module storagesync/latest | Package Azure RM"
...
class MyStack : Stack
{
    public MyStack()
    {
        var registeredServer = new AzureRM.StorageSync.Latest.RegisteredServer("registeredServer", new AzureRM.StorageSync.Latest.RegisteredServerArgs
        {
...
registered_server = azurerm.storagesync.latest.RegisteredServer("registeredServer",
