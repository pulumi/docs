...
title_tag: "Function GetServerEndpoint | Module storagesync/v20181001 | Package azurerm"
meta_desc: "Explore the GetServerEndpoint function of the storagesync/v20181001 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#syncstatus_csharp" style="color: inherit; text-decoration: inherit;">Sync<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverendpointhealthresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Sync.<wbr>V20181001.<wbr>Outputs.<wbr>Server<wbr>Endpoint<wbr>Health<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Server Endpoint properties.{{% /md %}}</dd>
...
<a href="#syncstatus_go" style="color: inherit; text-decoration: inherit;">Sync<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverendpointhealthresponse">Server<wbr>Endpoint<wbr>Health<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Server Endpoint properties.{{% /md %}}</dd>
...
<a href="#sync_status_python" style="color: inherit; text-decoration: inherit;">sync_<wbr>status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverendpointhealthresponse">Dict[Server<wbr>Endpoint<wbr>Health<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Server Endpoint properties.{{% /md %}}</dd>
...
<h4 id="serverendpointhealthresponse">Server<wbr>Endpoint<wbr>Health<wbr>Response</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#ServerEndpointHealthResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagesync/v20181001?tab=doc#ServerEndpointHealthResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageSync.V20181001.Outputs.ServerEndpointHealthResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#combinedhealth_csharp" style="color: inherit; text-decoration: inherit;">Combined<wbr>Health</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="currentprogress_csharp">
<a href="#currentprogress_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Progress</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#syncprogressstatusresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Sync.<wbr>V20181001.<wbr>Inputs.<wbr>Sync<wbr>Progress<wbr>Status<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Current progress{{% /md %}}</dd>
...
<a href="#downloadstatus_csharp" style="color: inherit; text-decoration: inherit;">Download<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#syncsessionstatusresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage<wbr>Sync.<wbr>V20181001.<wbr>Inputs.<wbr>Sync<wbr>Session<wbr>Status<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#combinedhealth_go" style="color: inherit; text-decoration: inherit;">Combined<wbr>Health</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="currentprogress_go">
<a href="#currentprogress_go" style="color: inherit; text-decoration: inherit;">Current<wbr>Progress</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#syncprogressstatusresponse">Sync<wbr>Progress<wbr>Status<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Current progress{{% /md %}}</dd>
...
<a href="#combinedhealth_nodejs" style="color: inherit; text-decoration: inherit;">combined<wbr>Health</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="currentprogress_nodejs">
<a href="#currentprogress_nodejs" style="color: inherit; text-decoration: inherit;">current<wbr>Progress</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#syncprogressstatusresponse">Sync<wbr>Progress<wbr>Status<wbr>Response</a></span>
    </dt>
...
<a href="#combined_health_python" style="color: inherit; text-decoration: inherit;">combined_<wbr>health</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="current_progress_python">
<a href="#current_progress_python" style="color: inherit; text-decoration: inherit;">current_<wbr>progress</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#syncprogressstatusresponse">Dict[Sync<wbr>Progress<wbr>Status<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Current progress{{% /md %}}</dd>
...
<h4 id="syncprogressstatusresponse">Sync<wbr>Progress<wbr>Status<wbr>Response</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#SyncProgressStatusResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagesync/v20181001?tab=doc#SyncProgressStatusResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageSync.V20181001.Outputs.SyncProgressStatusResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#peritemerrorcount_csharp" style="color: inherit; text-decoration: inherit;">Per<wbr>Item<wbr>Error<wbr>Count</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="progresstimestamp_csharp">
<a href="#progresstimestamp_csharp" style="color: inherit; text-decoration: inherit;">Progress<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}Progress timestamp{{% /md %}}</dd>
...
<a href="#peritemerrorcount_go" style="color: inherit; text-decoration: inherit;">Per<wbr>Item<wbr>Error<wbr>Count</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="progresstimestamp_go">
<a href="#progresstimestamp_go" style="color: inherit; text-decoration: inherit;">Progress<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#peritemerrorcount_nodejs" style="color: inherit; text-decoration: inherit;">per<wbr>Item<wbr>Error<wbr>Count</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="progresstimestamp_nodejs">
<a href="#progresstimestamp_nodejs" style="color: inherit; text-decoration: inherit;">progress<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#per_item_error_count_python" style="color: inherit; text-decoration: inherit;">per_<wbr>item_<wbr>error_<wbr>count</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="progress_timestamp_python">
<a href="#progress_timestamp_python" style="color: inherit; text-decoration: inherit;">progress_<wbr>timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storagesync/v20181001?tab=doc#SyncSessionStatusResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorageSync.V20181001.Outputs.SyncSessionStatusResponse.html">output</a> API doc for this type.
{{% /choosable %}}
