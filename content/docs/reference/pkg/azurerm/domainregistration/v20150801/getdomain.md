...
---
title: "GetDomain"
title_tag: "Function GetDomain | Module domainregistration/v20150801 | Package azurerm"
meta_desc: "Explore the GetDomain function of the domainregistration/v20150801 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#autorenew_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Renew</a>
    ...
    <dd>{{% md %}}If true then domain will renewed automatically{{% /md %}}</dd>
...
<a href="#consent_csharp" style="color: inherit; text-decoration: inherit;">Consent</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainpurchaseconsentresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Domain<wbr>Registration.<wbr>V20150801.<wbr>Outputs.<wbr>Domain<wbr>Purchase<wbr>Consent<wbr>Response</a></span>
    </dt>
...
<a href="#contactadmin_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Admin</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contactresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Domain<wbr>Registration.<wbr>V20150801.<wbr>Outputs.<wbr>Contact<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Admin contact information{{% /md %}}</dd>
...
<a href="#contactbilling_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Billing</a>
    ...
    <dd>{{% md %}}Billing contact information{{% /md %}}</dd>
...
<a href="#contactregistrant_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Registrant</a>
    ...
    <dd>{{% md %}}Registrant contact information{{% /md %}}</dd>
...
<a href="#contacttech_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Tech</a>
    ...
    <dd>{{% md %}}Technical contact information{{% /md %}}</dd>
...
<a href="#managedhostnames_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Host<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hostnameresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Domain<wbr>Registration.<wbr>V20150801.<wbr>Outputs.<wbr>Host<wbr>Name<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#privacy_csharp" style="color: inherit; text-decoration: inherit;">Privacy</a>
    ...
    <dd>{{% md %}}If true then domain privacy is enabled for this domain{{% /md %}}</dd>
...
<a href="#readyfordnsrecordmanagement_csharp" style="color: inherit; text-decoration: inherit;">Ready<wbr>For<wbr>Dns<wbr>Record<wbr>Management</a>
    ...
    <dd>{{% md %}}If true then Azure can assign this domain to Web Apps. This value will be true if domain registration status is active and it is hosted on name servers Azure has programmatic access to{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/domainregistration/v20150801?tab=doc#AddressResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DomainRegistration.V20150801.Outputs.AddressResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/domainregistration/v20150801?tab=doc#ContactResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DomainRegistration.V20150801.Outputs.ContactResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#addressmailing_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Mailing</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Domain<wbr>Registration.<wbr>V20150801.<wbr>Inputs.<wbr>Address<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/domainregistration/v20150801?tab=doc#DomainPurchaseConsentResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DomainRegistration.V20150801.Outputs.DomainPurchaseConsentResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#agreementkeys_csharp" style="color: inherit; text-decoration: inherit;">Agreement<wbr>Keys</a>
    ...
    <dd>{{% md %}}List of applicable legal agreement keys. This list can be retrieved using ListLegalAgreements Api under TopLevelDomain resource{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/domainregistration/v20150801?tab=doc#HostNameResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DomainRegistration.V20150801.Outputs.HostNameResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#azureresourcename_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the Azure resource the hostname is assigned to. If it is assigned to a traffic manager then it will be the traffic manager name otherwise it will be the website name{{% /md %}}</dd>
...
<a href="#sitenames_csharp" style="color: inherit; text-decoration: inherit;">Site<wbr>Names</a>
    ...
    <dd>{{% md %}}List of sites the hostname is assigned to. This list will have more than one site only if the hostname is pointing to a Traffic Manager{{% /md %}}</dd>
