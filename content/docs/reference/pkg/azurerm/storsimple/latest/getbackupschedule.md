...
title_tag: "Function GetBackupSchedule | Module storsimple/latest | Package Azure RM"
...
<a href="#schedulerecurrence_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Recurrence</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulerecurrenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>Latest.<wbr>Outputs.<wbr>Schedule<wbr>Recurrence<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/latest?tab=doc#ScheduleRecurrenceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
