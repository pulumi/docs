...
title_tag: "Function ListDeviceFailoverSets | Module storsimple/latest | Package Azure RM"
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/latest?tab=doc#FailoverSetEligibilityResultResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.Latest.Outputs.FailoverSetEligibilityResultResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/latest?tab=doc#FailoverSetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.Latest.Outputs.FailoverSetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#eligibilityresult_csharp" style="color: inherit; text-decoration: inherit;">Eligibility<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#failoverseteligibilityresultresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>Latest.<wbr>Inputs.<wbr>Failover<wbr>Set<wbr>Eligibility<wbr>Result<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#volumecontainers_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Containers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumecontainerfailovermetadataresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>Latest.<wbr>Inputs.<wbr>Volume<wbr>Container<wbr>Failover<wbr>Metadata<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/latest?tab=doc#VolumeContainerFailoverMetadataResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.Latest.Outputs.VolumeContainerFailoverMetadataResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#volumes_csharp" style="color: inherit; text-decoration: inherit;">Volumes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#volumefailovermetadataresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>Latest.<wbr>Inputs.<wbr>Volume<wbr>Failover<wbr>Metadata<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/latest?tab=doc#VolumeFailoverMetadataResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.Latest.Outputs.VolumeFailoverMetadataResponse.html">output</a> API doc for this type.
{{% /choosable %}}
