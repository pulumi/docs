...
title_tag: "Function ListDeviceFailoverTars | Module storsimple/v20170601 | Package azurerm"
meta_desc: "Explore the ListDeviceFailoverTars function of the storsimple/v20170601 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListDeviceFailoverTars </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storsimple/v20170601.ListDeviceFailoverTarsResult.html">ListDeviceFailoverTarsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.V20170601.ListDeviceFailoverTarsArgs.html">ListDeviceFailoverTarsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#failovertargetresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>V20170601.<wbr>Outputs.<wbr>Failover<wbr>Target<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/v20170601?tab=doc#FailoverTargetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.V20170601.Outputs.FailoverTargetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#eligibilityresult_csharp" style="color: inherit; text-decoration: inherit;">Eligibility<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#targeteligibilityresultresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>V20170601.<wbr>Inputs.<wbr>Target<wbr>Eligibility<wbr>Result<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/v20170601?tab=doc#TargetEligibilityErrorMessageResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.V20170601.Outputs.TargetEligibilityErrorMessageResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storsimple/v20170601?tab=doc#TargetEligibilityResultResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.StorSimple.V20170601.Outputs.TargetEligibilityResultResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#messages_csharp" style="color: inherit; text-decoration: inherit;">Messages</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#targeteligibilityerrormessageresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Stor<wbr>Simple.<wbr>V20170601.<wbr>Inputs.<wbr>Target<wbr>Eligibility<wbr>Error<wbr>Message<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
