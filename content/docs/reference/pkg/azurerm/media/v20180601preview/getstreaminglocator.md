...
title_tag: "Function GetStreamingLocator | Module media/v20180601preview | Package azurerm"
meta_desc: "Explore the GetStreamingLocator function of the media/v20180601preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#contentkeys_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#streaminglocatorcontentkeyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180601Preview.<wbr>Outputs.<wbr>Streaming<wbr>Locator<wbr>Content<wbr>Key<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180601preview?tab=doc#StreamingLocatorContentKeyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
