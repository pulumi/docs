...
---
title: "GetLiveEvent"
title_tag: "Function GetLiveEvent | Module media/v20190501preview | Package azurerm"
meta_desc: "Explore the GetLiveEvent function of the media/v20190501preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getLiveEvent<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/media/v20190501preview/#GetLiveEventArgs">GetLiveEventArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/media/v20190501preview/#GetLiveEventResult">GetLiveEventResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#input_csharp" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventinputresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Outputs.<wbr>Live<wbr>Event<wbr>Input<wbr>Response</a></span>
    </dt>
...
<a href="#crosssiteaccesspolicies_csharp" style="color: inherit; text-decoration: inherit;">Cross<wbr>Site<wbr>Access<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crosssiteaccesspoliciesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Outputs.<wbr>Cross<wbr>Site<wbr>Access<wbr>Policies<wbr>Response</a></span>
    </dt>
...
<a href="#encoding_csharp" style="color: inherit; text-decoration: inherit;">Encoding</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventencodingresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Outputs.<wbr>Live<wbr>Event<wbr>Encoding<wbr>Response</a></span>
    </dt>
...
<a href="#preview_csharp" style="color: inherit; text-decoration: inherit;">Preview</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventpreviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Outputs.<wbr>Live<wbr>Event<wbr>Preview<wbr>Response</a></span>
    </dt>
...
<a href="#streamoptions_csharp" style="color: inherit; text-decoration: inherit;">Stream<wbr>Options</a>
    ...
    <dd>{{% md %}}The options to use for the LiveEvent.  This value is specified at creation time and cannot be updated.{{% /md %}}</dd>
...
<a href="#transcriptions_csharp" style="color: inherit; text-decoration: inherit;">Transcriptions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventtranscriptionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Outputs.<wbr>Live<wbr>Event<wbr>Transcription<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The Live Event transcription.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#CrossSiteAccessPoliciesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.CrossSiteAccessPoliciesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#IPAccessControlResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.IPAccessControlResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#allow_csharp" style="color: inherit; text-decoration: inherit;">Allow</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprangeresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>IPRange<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#IPRangeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.IPRangeResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventEncodingResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventEncodingResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#encodingtype_csharp" style="color: inherit; text-decoration: inherit;">Encoding<wbr>Type</a>
    ...
    <dd>{{% md %}}The encoding type for Live Event.  This value is specified at creation time and cannot be updated.{{% /md %}}</dd>
...
<a href="#presetname_csharp" style="color: inherit; text-decoration: inherit;">Preset<wbr>Name</a>
    ...
    <dd>{{% md %}}The encoding preset name.  This value is specified at creation time and cannot be updated.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventEndpointResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventEndpointResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventInputAccessControlResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventInputAccessControlResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#ip_csharp" style="color: inherit; text-decoration: inherit;">Ip</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipaccesscontrolresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>IPAccess<wbr>Control<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventInputResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventInputResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#accesscontrol_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Control</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventinputaccesscontrolresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>Live<wbr>Event<wbr>Input<wbr>Access<wbr>Control<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#accesstoken_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Token</a>
    ...
    <dd>{{% md %}}A unique identifier for a stream.  This can be specified at creation time but cannot be updated.  If omitted, the service will generate a unique value.{{% /md %}}</dd>
...
<a href="#endpoints_csharp" style="color: inherit; text-decoration: inherit;">Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventendpointresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>Live<wbr>Event<wbr>Endpoint<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#LiveEventInputTrackSelectionResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventInputTrackSelectionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventInputTrackSelectionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#operation_csharp" style="color: inherit; text-decoration: inherit;">Operation</a>
    ...
    <dd>{{% md %}}Comparing operation.{{% /md %}}</dd>
...
<a href="#property_csharp" style="color: inherit; text-decoration: inherit;">Property</a>
    ...
    <dd>{{% md %}}Property name to select.{{% /md %}}</dd>
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}Property value to select.{{% /md %}}</dd>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#LiveEventOutputTranscriptionTrackResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventOutputTranscriptionTrackResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventOutputTranscriptionTrackResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#trackname_csharp" style="color: inherit; text-decoration: inherit;">Track<wbr>Name</a>
    ...
    <dd>{{% md %}}The output track name.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventPreviewAccessControlResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventPreviewAccessControlResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventPreviewResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventPreviewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#accesscontrol_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Control</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventpreviewaccesscontrolresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>Live<wbr>Event<wbr>Preview<wbr>Access<wbr>Control<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#LiveEventTranscriptionResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20190501preview?tab=doc#LiveEventTranscriptionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20190501Preview.Outputs.LiveEventTranscriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#inputtrackselection_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Track<wbr>Selection</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventinputtrackselectionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>Live<wbr>Event<wbr>Input<wbr>Track<wbr>Selection<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Provides a mechanism to select the audio track in the input live feed, to which speech-to-text transcription is applied.{{% /md %}}</dd>
...
<a href="#language_csharp" style="color: inherit; text-decoration: inherit;">Language</a>
    ...
    <dd>{{% md %}}Specifies the language (locale) used for speech-to-text transcription � it should match the spoken language in the audio track. The value should be in BCP-47 format of 'language tag-region' (e.g: 'en-US'). The list of supported languages are 'en-US' and 'en-GB'.{{% /md %}}</dd>
...
<a href="#outputtranscriptiontrack_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>Transcription<wbr>Track</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#liveeventoutputtranscriptiontrackresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20190501Preview.<wbr>Inputs.<wbr>Live<wbr>Event<wbr>Output<wbr>Transcription<wbr>Track<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Describes a transcription track in the output of a Live Event, generated using speech-to-text transcription.{{% /md %}}</dd>
