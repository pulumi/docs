...
---
title: "Job"
title_tag: "Resource Job | Module media/v20180330preview | Package azurerm"
meta_desc: "Explore the Job resource of the media/v20180330preview module, including examples, input properties, output properties, lookup functions, and supporting types. A Job resource type. The progress and state can be obtained by polling a Job or subscribing to events using EventGrid."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/media/v20180330preview/#Job">Job</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/media/v20180330preview/#JobArgs">JobArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_azurerm/media/v20180330preview/#pulumi_azurerm.media/v20180330preview.Job">Job</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">input</span><span class="p">:</span> <span class="nx">Optional[Dict[JobInputClip] | Dict[JobInputs]]</span> = None<span class="p">, </span><span class="nx">job_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">outputs</span><span class="p">:</span> <span class="nx">Optional[List[JobOutputAsset]]</span> = None<span class="p">, </span><span class="nx">priority</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">transform_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#Job">NewJob</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobArgs">JobArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#Job">Job</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Job.html">Job</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.JobArgs.html">JobArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/media/v20180330preview/#JobArgs">JobArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobArgs">JobArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.JobArgs.html">JobArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#input_csharp" style="color: inherit; text-decoration: inherit;">Input</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Union&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Input<wbr>Clip<wbr>Args, Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Inputs<wbr>Args&gt;</span>
    </dt>
...
<a href="#outputs_csharp" style="color: inherit; text-decoration: inherit;">Outputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#joboutputasset">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Output<wbr>Asset<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobErrorDetailResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Outputs.JobErrorDetailResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobErrorResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Outputs.JobErrorResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#details_csharp" style="color: inherit; text-decoration: inherit;">Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#joberrordetailresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Error<wbr>Detail<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobInputClipArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Inputs.JobInputClipArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#files_csharp" style="color: inherit; text-decoration: inherit;">Files</a>
    ...
    <dd>{{% md %}}List of files. Required for JobInputHttp.{{% /md %}}</dd>
...
<a href="#label_csharp" style="color: inherit; text-decoration: inherit;">Label</a>
    ...
    <dd>{{% md %}}A label that is assigned to a JobInput, that is used to satisfy a reference used in the Transform. For example, a Transform can be authored so as to take an image file with the label 'xyz' and apply it as an overlay onto the input video before it is encoded. When submitting a Job, exactly one of the JobInputs should be the image file, and it should have the label 'xyz'.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobInputClipResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Outputs.JobInputClipResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobInputsArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Inputs.JobInputsArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Union&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Input<wbr>Clip<wbr>Args, Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Inputs<wbr>Args&gt;&gt;</span>
    </dt>
...
<a href="#inputs_python" style="color: inherit; text-decoration: inherit;">inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azurerm:Media/V20180330preview:Job<wbr>Input<wbr>Clip, Azurerm:Media/V20180330preview:Job<wbr>Inputs, Default=>]</span>
    </dt>
    <dd>{{% md %}}List of inputs to a Job.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobInputsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Outputs.JobInputsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Union&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Input<wbr>Clip<wbr>Response<wbr>Args, Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Inputs<wbr>Response<wbr>Args&gt;&gt;</span>
    </dt>
    <dd>{{% md %}}List of inputs to a Job.{{% /md %}}</dd>
...
<a href="#inputs_python" style="color: inherit; text-decoration: inherit;">inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">List[Union<Azurerm:Media/V20180330preview:Job<wbr>Input<wbr>Clip<wbr>Response, Azurerm:Media/V20180330preview:Job<wbr>Inputs<wbr>Response, Default=>]</span>
    </dt>
    <dd>{{% md %}}List of inputs to a Job.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobOutputAssetArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Inputs.JobOutputAssetArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/media/v20180330preview?tab=doc#JobOutputAssetResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Media.V20180330Preview.Outputs.JobOutputAssetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#error_csharp" style="color: inherit; text-decoration: inherit;">Error</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#joberrorresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Media.<wbr>V20180330Preview.<wbr>Inputs.<wbr>Job<wbr>Error<wbr>Response<wbr>Args</a></span>
    </dt>
