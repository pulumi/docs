...
title_tag: "Resource RelationshipLink | Module customerinsights/v20170426 | Package azurerm"
meta_desc: "Explore the RelationshipLink resource of the customerinsights/v20170426 module, including examples, input properties, output properties, lookup functions, and supporting types. The relationship link resource format."
---
...
relationship_link = azurerm.customerinsights.v20170426.RelationshipLink("relationshipLink",
    description={
        "en-us": "Link Description",
    },
    display_name={
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/customerinsights/v20170426/#RelationshipLinkArgs">RelationshipLinkArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/customerinsights/v20170426?tab=doc#RelationshipLinkArgs">RelationshipLinkArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.CustomerInsights.V20170426.RelationshipLinkArgs.html">RelationshipLinkArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#profilepropertyreferences_csharp" style="color: inherit; text-decoration: inherit;">Profile<wbr>Property<wbr>References</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#participantprofilepropertyreference">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Customer<wbr>Insights.<wbr>V20170426.<wbr>Inputs.<wbr>Participant<wbr>Profile<wbr>Property<wbr>Reference<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#mappings_csharp" style="color: inherit; text-decoration: inherit;">Mappings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#relationshiplinkfieldmapping">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Customer<wbr>Insights.<wbr>V20170426.<wbr>Inputs.<wbr>Relationship<wbr>Link<wbr>Field<wbr>Mapping<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/input/#ParticipantProfilePropertyReference">input</a>   API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/customerinsights/v20170426?tab=doc#ParticipantProfilePropertyReferenceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.CustomerInsights.V20170426.Inputs.ParticipantProfilePropertyReferenceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/customerinsights/v20170426?tab=doc#ParticipantProfilePropertyReferenceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/customerinsights/v20170426?tab=doc#RelationshipLinkFieldMappingArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.CustomerInsights.V20170426.Inputs.RelationshipLinkFieldMappingArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/customerinsights/v20170426?tab=doc#RelationshipLinkFieldMappingResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
