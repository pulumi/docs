...
title_tag: "Function GetCassandraResourceCassandraKeyspace | Module documentdb/latest | Package Azure RM"
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getCassandraResourceCassandraKeyspace<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/documentdb/latest/#GetCassandraResourceCassandraKeyspaceArgs">GetCassandraResourceCassandraKeyspaceArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/documentdb/latest/#GetCassandraResourceCassandraKeyspaceResult">GetCassandraResourceCassandraKeyspaceResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandrakeyspacegetpropertiesresponseoptions">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>Latest.<wbr>Outputs.<wbr>Cassandra<wbr>Keyspace<wbr>Get<wbr>Properties<wbr>Response<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandrakeyspacegetpropertiesresponseresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>Latest.<wbr>Outputs.<wbr>Cassandra<wbr>Keyspace<wbr>Get<wbr>Properties<wbr>Response<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/latest?tab=doc#CassandraKeyspaceGetPropertiesResponseOptions">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.Latest.Outputs.CassandraKeyspaceGetPropertiesResponseOptions.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/latest?tab=doc#CassandraKeyspaceGetPropertiesResponseResource">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.Latest.Outputs.CassandraKeyspaceGetPropertiesResponseResource.html">output</a> API doc for this type.
{{% /choosable %}}
