...
title_tag: "Function GetMongoDBResourceMongoDBCollection | Module documentdb/v20200301 | Package azurerm"
meta_desc: "Explore the GetMongoDBResourceMongoDBCollection function of the documentdb/v20200301 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mongodbcollectiongetpropertiesresponseoptions">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20200301.<wbr>Outputs.<wbr>Mongo<wbr>DBCollection<wbr>Get<wbr>Properties<wbr>Response<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mongodbcollectiongetpropertiesresponseresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20200301.<wbr>Outputs.<wbr>Mongo<wbr>DBCollection<wbr>Get<wbr>Properties<wbr>Response<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200301?tab=doc#MongoDBCollectionGetPropertiesResponseOptions">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200301?tab=doc#MongoDBCollectionGetPropertiesResponseResource">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200301?tab=doc#MongoIndexKeysResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200301?tab=doc#MongoIndexOptionsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200301?tab=doc#MongoIndexResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
