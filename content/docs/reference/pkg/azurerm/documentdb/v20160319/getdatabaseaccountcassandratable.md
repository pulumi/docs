...
title_tag: "Function GetDatabaseAccountCassandraTable | Module documentdb/v20160319 | Package azurerm"
meta_desc: "Explore the GetDatabaseAccountCassandraTable function of the documentdb/v20160319 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetDatabaseAccountCassandraTable </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Documentdb/v20160319.GetDatabaseAccountCassandraTableResult.html">GetDatabaseAccountCassandraTableResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20160319.GetDatabaseAccountCassandraTableArgs.html">GetDatabaseAccountCassandraTableArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandraschemaresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20160319.<wbr>Outputs.<wbr>Cassandra<wbr>Schema<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20160319?tab=doc#CassandraPartitionKeyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20160319.Outputs.CassandraPartitionKeyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20160319?tab=doc#CassandraSchemaResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20160319.Outputs.CassandraSchemaResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#clusterkeys_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterkeyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20160319.<wbr>Inputs.<wbr>Cluster<wbr>Key<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#columns_csharp" style="color: inherit; text-decoration: inherit;">Columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#columnresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20160319.<wbr>Inputs.<wbr>Column<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#partitionkeys_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandrapartitionkeyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20160319.<wbr>Inputs.<wbr>Cassandra<wbr>Partition<wbr>Key<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20160319?tab=doc#ClusterKeyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20160319.Outputs.ClusterKeyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20160319?tab=doc#ColumnResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20160319.Outputs.ColumnResponse.html">output</a> API doc for this type.
{{% /choosable %}}
