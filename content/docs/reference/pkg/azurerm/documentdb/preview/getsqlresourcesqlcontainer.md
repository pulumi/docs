...
title_tag: "Function GetSqlResourceSqlContainer | Module documentdb/preview | Package azurerm"
meta_desc: "Explore the GetSqlResourceSqlContainer function of the documentdb/preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupSqlResourceSqlContainer<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/preview?tab=doc#LookupSqlResourceSqlContainerArgs">LookupSqlResourceSqlContainerArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/preview?tab=doc#LookupSqlResourceSqlContainerResult">LookupSqlResourceSqlContainerResult</a></span>, error)</span></code></pre></div>
...
<a href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqlcontainergetpropertiesresponseoptions">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>Preview.<wbr>Outputs.<wbr>Sql<wbr>Container<wbr>Get<wbr>Properties<wbr>Response<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqlcontainergetpropertiesresponseresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>Preview.<wbr>Outputs.<wbr>Sql<wbr>Container<wbr>Get<wbr>Properties<wbr>Response<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/preview?tab=doc#SqlContainerGetPropertiesResponseOptions">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/preview?tab=doc#SqlContainerGetPropertiesResponseResource">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
