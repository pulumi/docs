...
title_tag: "Function GetCassandraResourceCassandraTable | Module documentdb/v20191212 | Package azurerm"
meta_desc: "Explore the GetCassandraResourceCassandraTable function of the documentdb/v20191212 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandratablegetpropertiesresponseresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20191212.<wbr>Outputs.<wbr>Cassandra<wbr>Table<wbr>Get<wbr>Properties<wbr>Response<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20191212?tab=doc#CassandraPartitionKeyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20191212.Outputs.CassandraPartitionKeyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20191212?tab=doc#CassandraSchemaResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20191212.Outputs.CassandraSchemaResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#clusterkeys_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterkeyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20191212.<wbr>Inputs.<wbr>Cluster<wbr>Key<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#columns_csharp" style="color: inherit; text-decoration: inherit;">Columns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#columnresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20191212.<wbr>Inputs.<wbr>Column<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#partitionkeys_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandrapartitionkeyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20191212.<wbr>Inputs.<wbr>Cassandra<wbr>Partition<wbr>Key<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20191212?tab=doc#CassandraTableGetPropertiesResponseResource">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20191212.Outputs.CassandraTableGetPropertiesResponseResource.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cassandraschemaresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20191212.<wbr>Inputs.<wbr>Cassandra<wbr>Schema<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20191212?tab=doc#ClusterKeyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20191212.Outputs.ClusterKeyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20191212?tab=doc#ColumnResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20191212.Outputs.ColumnResponse.html">output</a> API doc for this type.
{{% /choosable %}}
