...
title_tag: "Resource MongoDBResourceMongoDBDatabase | Module documentdb/v20200601preview | Package Azure RM"
...
class MyStack : Stack
{
    public MyStack()
    {
        var mongoDBResourceMongoDBDatabase = new AzureRM.DocumentDB.V20200601Preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", new AzureRM.DocumentDB.V20200601Preview.MongoDBResourceMongoDBDatabaseArgs
        {
            AccountName = "ddb1",
            DatabaseName = "databaseName",
            Location = "West US",
            Options = ,
            Resource = new AzureRM.DocumentDB.V20200601Preview.Inputs.MongoDBDatabaseResourceArgs
            {
                Id = "databaseName",
            },
...
const mongoDBResourceMongoDBDatabase = new azurerm.documentdb.v20200601preview.MongoDBResourceMongoDBDatabase("mongoDBResourceMongoDBDatabase", {
    accountName: "ddb1",
    databaseName: "databaseName",
    location: "West US",
    options: {},
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/documentdb/v20200601preview/#MongoDBResourceMongoDBDatabaseArgs">MongoDBResourceMongoDBDatabaseArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#MongoDBResourceMongoDBDatabaseArgs">MongoDBResourceMongoDBDatabaseArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.MongoDBResourceMongoDBDatabaseArgs.html">MongoDBResourceMongoDBDatabaseArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mongodbdatabaseresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20200601Preview.<wbr>Inputs.<wbr>Mongo<wbr>DBDatabase<wbr>Resource<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#MongoDBDatabaseGetPropertiesResponseOptionsOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Outputs.MongoDBDatabaseGetPropertiesResponseOptions.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#MongoDBDatabaseGetPropertiesResponseResourceOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Outputs.MongoDBDatabaseGetPropertiesResponseResource.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#MongoDBDatabaseResourceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Inputs.MongoDBDatabaseResourceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
