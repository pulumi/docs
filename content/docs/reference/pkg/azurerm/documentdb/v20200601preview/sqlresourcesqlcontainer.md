...
title_tag: "Resource SqlResourceSqlContainer | Module documentdb/v20200601preview | Package Azure RM"
meta_desc: "Explore the SqlResourceSqlContainer resource of the documentdb/v20200601preview module, including examples, input properties, output properties, lookup functions, and supporting types. An Azure Cosmos DB container."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var sqlResourceSqlContainer = new AzureRM.DocumentDB.V20200601Preview.SqlResourceSqlContainer("sqlResourceSqlContainer", new AzureRM.DocumentDB.V20200601Preview.SqlResourceSqlContainerArgs
        {
            AccountName = "ddb1",
            ...
            Location = "West US",
            Options = ,
            Resource = new AzureRM.DocumentDB.V20200601Preview.Inputs.SqlContainerResourceArgs
            {
...
sql_resource_sql_container = azurerm.documentdb.v20200601preview.SqlResourceSqlContainer("sqlResourceSqlContainer",
    account_name="ddb1",
...
const sqlResourceSqlContainer = new azurerm.documentdb.v20200601preview.SqlResourceSqlContainer("sqlResourceSqlContainer", {
    accountName: "ddb1",
    containerName: "containerName",
    databaseName: "databaseName",
    location: "West US",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/documentdb/v20200601preview/#SqlResourceSqlContainerArgs">SqlResourceSqlContainerArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#SqlResourceSqlContainerArgs">SqlResourceSqlContainerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.SqlResourceSqlContainerArgs.html">SqlResourceSqlContainerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sqlcontainerresource">Pulumi.<wbr>Azure<wbr>RM.<wbr>Document<wbr>DB.<wbr>V20200601Preview.<wbr>Inputs.<wbr>Sql<wbr>Container<wbr>Resource<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#SqlContainerGetPropertiesResponseOptionsOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Outputs.SqlContainerGetPropertiesResponseOptions.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#SqlContainerGetPropertiesResponseResourceOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Outputs.SqlContainerGetPropertiesResponseResource.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/documentdb/v20200601preview?tab=doc#SqlContainerResourceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DocumentDB.V20200601Preview.Inputs.SqlContainerResourceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
