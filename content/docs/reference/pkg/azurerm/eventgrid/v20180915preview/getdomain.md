...
---
title: "GetDomain"
title_tag: "Function GetDomain | Module eventgrid/v20180915preview | Package azurerm"
meta_desc: "Explore the GetDomain function of the eventgrid/v20180915preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#inputschemamapping_csharp" style="color: inherit; text-decoration: inherit;">Input<wbr>Schema<wbr>Mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jsoninputschemamappingresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Event<wbr>Grid.<wbr>V20180915Preview.<wbr>Outputs.<wbr>Json<wbr>Input<wbr>Schema<wbr>Mapping<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/eventgrid/v20180915preview?tab=doc#JsonFieldResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/eventgrid/v20180915preview?tab=doc#JsonFieldWithDefaultResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/eventgrid/v20180915preview?tab=doc#JsonInputSchemaMappingResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
