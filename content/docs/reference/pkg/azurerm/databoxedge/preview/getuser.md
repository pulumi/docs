...
---
title: "GetUser"
title_tag: "Function GetUser | Module databoxedge/preview | Package azurerm"
meta_desc: "Explore the GetUser function of the databoxedge/preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#shareaccessrights_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Access<wbr>Rights</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shareaccessrightresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Data<wbr>Box<wbr>Edge.<wbr>Preview.<wbr>Outputs.<wbr>Share<wbr>Access<wbr>Right<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#encryptedpassword_csharp" style="color: inherit; text-decoration: inherit;">Encrypted<wbr>Password</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#asymmetricencryptedsecretresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Data<wbr>Box<wbr>Edge.<wbr>Preview.<wbr>Outputs.<wbr>Asymmetric<wbr>Encrypted<wbr>Secret<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/databoxedge/preview?tab=doc#AsymmetricEncryptedSecretResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DataBoxEdge.Preview.Outputs.AsymmetricEncryptedSecretResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/databoxedge/preview?tab=doc#ShareAccessRightResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DataBoxEdge.Preview.Outputs.ShareAccessRightResponse.html">output</a> API doc for this type.
{{% /choosable %}}
