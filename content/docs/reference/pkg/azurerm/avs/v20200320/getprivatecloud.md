...
title_tag: "Function GetPrivateCloud | Module avs/v20200320 | Package azurerm"
meta_desc: "Explore the GetPrivateCloud function of the avs/v20200320 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetPrivateCloud </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Avs/v20200320.GetPrivateCloudResult.html">GetPrivateCloudResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.AVS.V20200320.GetPrivateCloudArgs.html">GetPrivateCloudArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#managementcluster_csharp" style="color: inherit; text-decoration: inherit;">Management<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managementclusterresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>AVS.<wbr>V20200320.<wbr>Outputs.<wbr>Management<wbr>Cluster<wbr>Response</a></span>
    </dt>
...
<a href="#identitysources_csharp" style="color: inherit; text-decoration: inherit;">Identity<wbr>Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#identitysourceresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>AVS.<wbr>V20200320.<wbr>Outputs.<wbr>Identity<wbr>Source<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/avs/v20200320?tab=doc#CircuitResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/avs/v20200320?tab=doc#EndpointsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/avs/v20200320?tab=doc#IdentitySourceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/avs/v20200320?tab=doc#ManagementClusterResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
