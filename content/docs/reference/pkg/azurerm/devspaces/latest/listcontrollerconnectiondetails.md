...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListControllerConnectionDetails </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devspaces/latest.ListControllerConnectionDetailsResult.html">ListControllerConnectionDetailsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DevSpaces.Latest.ListControllerConnectionDetailsArgs.html">ListControllerConnectionDetailsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#connectiondetailslist_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Details<wbr>List</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#controllerconnectiondetailsresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Dev<wbr>Spaces.<wbr>Latest.<wbr>Outputs.<wbr>Controller<wbr>Connection<wbr>Details<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devspaces/latest?tab=doc#ControllerConnectionDetailsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DevSpaces.Latest.Outputs.ControllerConnectionDetailsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#orchestratorspecificconnectiondetails_csharp" style="color: inherit; text-decoration: inherit;">Orchestrator<wbr>Specific<wbr>Connection<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesconnectiondetailsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Dev<wbr>Spaces.<wbr>Latest.<wbr>Inputs.<wbr>Kubernetes<wbr>Connection<wbr>Details<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devspaces/latest?tab=doc#KubernetesConnectionDetailsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DevSpaces.Latest.Outputs.KubernetesConnectionDetailsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
