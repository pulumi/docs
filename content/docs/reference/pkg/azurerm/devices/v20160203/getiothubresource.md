...
title_tag: "Function GetIotHubResource | Module devices/v20160203 | Package azurerm"
meta_desc: "Explore the GetIotHubResource function of the devices/v20160203 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIotHubResource<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/devices/v20160203/#GetIotHubResourceArgs">GetIotHubResourceArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/devices/v20160203/#GetIotHubResourceResult">GetIotHubResourceResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_iot_hub_resource(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIotHubResourceResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIotHubResource<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#LookupIotHubResourceArgs">LookupIotHubResourceArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#LookupIotHubResourceResult">LookupIotHubResourceResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIotHubResource </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices/v20160203.GetIotHubResourceResult.html">GetIotHubResourceResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.GetIotHubResourceArgs.html">GetIotHubResourceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iothubpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Outputs.<wbr>Iot<wbr>Hub<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The properties of an IoT hub.{{% /md %}}</dd>

    <dt class="property-"
            title="">
        <span id="resourcegroup_csharp">
<a href="#resourcegroup_csharp" style="color: inherit; text-decoration: inherit;">Resourcegroup</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}The name of the resource group that contains the IoT hub. A resource group name uniquely identifies the resource group within the subscription.{{% /md %}}</dd>
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iothubskuinforesponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Outputs.<wbr>Iot<wbr>Hub<wbr>Sku<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Information about the SKU of the IoT hub.{{% /md %}}</dd>

    <dt class="property-"
            title="">
        <span id="subscriptionid_csharp">
<a href="#subscriptionid_csharp" style="color: inherit; text-decoration: inherit;">Subscriptionid</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}The subscription identifier.{{% /md %}}</dd>
...
<a href="#resourcegroup_go" style="color: inherit; text-decoration: inherit;">Resourcegroup</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#subscriptionid_go" style="color: inherit; text-decoration: inherit;">Subscriptionid</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#resourcegroup_nodejs" style="color: inherit; text-decoration: inherit;">resourcegroup</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#subscriptionid_nodejs" style="color: inherit; text-decoration: inherit;">subscriptionid</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iothubpropertiesresponse">Dict[Iot<wbr>Hub<wbr>Properties<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The properties of an IoT hub.{{% /md %}}</dd>
...
<a href="#resourcegroup_python" style="color: inherit; text-decoration: inherit;">resourcegroup</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
...
<a href="#sku_python" style="color: inherit; text-decoration: inherit;">sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iothubskuinforesponse">Dict[Iot<wbr>Hub<wbr>Sku<wbr>Info<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Information about the SKU of the IoT hub.{{% /md %}}</dd>
...
<a href="#subscriptionid_python" style="color: inherit; text-decoration: inherit;">subscriptionid</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#CloudToDevicePropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.CloudToDevicePropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#feedback_csharp" style="color: inherit; text-decoration: inherit;">Feedback</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#feedbackpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Feedback<wbr>Properties<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#EventHubPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.EventHubPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#FeedbackPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.FeedbackPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#IotHubPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.IotHubPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#authorizationpolicies_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sharedaccesssignatureauthorizationruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Shared<wbr>Access<wbr>Signature<wbr>Authorization<wbr>Rule<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#cloudtodevice_csharp" style="color: inherit; text-decoration: inherit;">Cloud<wbr>To<wbr>Device</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cloudtodevicepropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Cloud<wbr>To<wbr>Device<wbr>Properties<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#eventhubendpoints_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Hub<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Event<wbr>Hub<wbr>Properties<wbr>Response<wbr>Args&gt;</span>
    </dt>
...
<a href="#ipfilterrules_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Filter<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipfilterruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Ip<wbr>Filter<wbr>Rule<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#messagingendpoints_csharp" style="color: inherit; text-decoration: inherit;">Messaging<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Messaging<wbr>Endpoint<wbr>Properties<wbr>Response<wbr>Args&gt;</span>
    </dt>
...
<a href="#operationsmonitoringproperties_csharp" style="color: inherit; text-decoration: inherit;">Operations<wbr>Monitoring<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#operationsmonitoringpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Operations<wbr>Monitoring<wbr>Properties<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The operations monitoring properties for the IoT hub. The possible keys to the dictionary are Connections, DeviceTelemetry, C2DCommands, DeviceIdentityOperations, FileUploadOperations.{{% /md %}}</dd>
...
<a href="#storageendpoints_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Devices.<wbr>V20160203.<wbr>Inputs.<wbr>Storage<wbr>Endpoint<wbr>Properties<wbr>Response<wbr>Args&gt;</span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#IotHubSkuInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.IotHubSkuInfoResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#IpFilterRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.IpFilterRuleResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#MessagingEndpointPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.MessagingEndpointPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#lockdurationasiso8601_csharp" style="color: inherit; text-decoration: inherit;">Lock<wbr>Duration<wbr>As<wbr>Iso8601</a>
    ...
    <dd>{{% md %}}The lock duration. See: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-file-upload.{{% /md %}}</dd>
...
<a href="#maxdeliverycount_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Delivery<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of times the IoT hub attempts to deliver a message. See: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-file-upload.{{% /md %}}</dd>
...
<a href="#ttlasiso8601_csharp" style="color: inherit; text-decoration: inherit;">Ttl<wbr>As<wbr>Iso8601</a>
    ...
    <dd>{{% md %}}The period of time for which a message is available to consume before it is expired by the IoT hub. See: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-file-upload.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#OperationsMonitoringPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.OperationsMonitoringPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#SharedAccessSignatureAuthorizationRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.SharedAccessSignatureAuthorizationRuleResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devices/v20160203?tab=doc#StorageEndpointPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devices.V20160203.Outputs.StorageEndpointPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
