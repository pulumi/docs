...
---
title: "Project"
title_tag: "Resource Project | Module migrate/v20180202 | Package azurerm"
meta_desc: "Explore the Project resource of the migrate/v20180202 module, including examples, input properties, output properties, lookup functions, and supporting types. Azure Migrate Project."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/migrate/v20180202/#Project">Project</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/migrate/v20180202/#ProjectArgs">ProjectArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_azurerm/migrate/v20180202/#pulumi_azurerm.migrate/v20180202.Project">Project</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">customer_workspace_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">customer_workspace_location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">e_tag</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">project_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">provisioning_state</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Dict[str, Any]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/migrate/v20180202?tab=doc#Project">NewProject</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/migrate/v20180202?tab=doc#ProjectArgs">ProjectArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/migrate/v20180202?tab=doc#Project">Project</a></span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/migrate/v20180202/#ProjectArgs">ProjectArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/migrate/v20180202?tab=doc#ProjectArgs">ProjectArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Migrate.V20180202.ProjectArgs.html">ProjectArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#customerworkspacelocation_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Workspace<wbr>Location</a>
    ...
    <dd>{{% md %}}Location of the Service Map workspace created by user.{{% /md %}}</dd>
...
<a href="#lastassessmenttimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Assessment<wbr>Timestamp</a>
    ...
    <dt class="property-"
            title="">
        <span id="lastdiscoverysessionid_csharp">
<a href="#lastdiscoverysessionid_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Discovery<wbr>Session<wbr>Id</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}Session id of the last discovery.{{% /md %}}</dd>

    <dt class="property-"
            title="">
        <span id="lastdiscoverytimestamp_csharp">
<a href="#lastdiscoverytimestamp_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Discovery<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}Time when this project was created. Date-Time represented in ISO-8601 format. This value will be null until discovery is complete.{{% /md %}}</dd>
...
<a href="#lastassessmenttimestamp_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Assessment<wbr>Timestamp</a>
    ...
    <dt class="property-"
            title="">
        <span id="lastdiscoverysessionid_go">
<a href="#lastdiscoverysessionid_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Discovery<wbr>Session<wbr>Id</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
    ...
    <dt class="property-"
            title="">
        <span id="lastdiscoverytimestamp_go">
<a href="#lastdiscoverytimestamp_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Discovery<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#lastassessmenttimestamp_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Assessment<wbr>Timestamp</a>
    ...
    <dt class="property-"
            title="">
        <span id="lastdiscoverysessionid_nodejs">
<a href="#lastdiscoverysessionid_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Discovery<wbr>Session<wbr>Id</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
    ...
    <dt class="property-"
            title="">
        <span id="lastdiscoverytimestamp_nodejs">
<a href="#lastdiscoverytimestamp_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Discovery<wbr>Timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#last_assessment_timestamp_python" style="color: inherit; text-decoration: inherit;">last_<wbr>assessment_<wbr>timestamp</a>
    ...
    <dt class="property-"
            title="">
        <span id="last_discovery_session_id_python">
<a href="#last_discovery_session_id_python" style="color: inherit; text-decoration: inherit;">last_<wbr>discovery_<wbr>session_<wbr>id</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
    ...
    <dt class="property-"
            title="">
        <span id="last_discovery_timestamp_python">
<a href="#last_discovery_timestamp_python" style="color: inherit; text-decoration: inherit;">last_<wbr>discovery_<wbr>timestamp</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
