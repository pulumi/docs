...
---
title: "User"
title_tag: "Resource User | Module apimanagement/v20191201preview | Package Azure RM"
...
class MyStack : Stack
{
    public MyStack()
    {
        var user = new AzureRM.ApiManagement.V20191201Preview.User("user", new AzureRM.ApiManagement.V20191201Preview.UserArgs
        {
            Confirmation = "signup",
...
user = azurerm.apimanagement.v20191201preview.User("user",
    confirmation="signup",
    email="foobar@outlook.com",
    first_name="foo",
    last_name="bar",
...
const user = new azurerm.apimanagement.v20191201preview.User("user", {
    confirmation: "signup",
    email: "foobar@outlook.com",
    firstName: "foo",
    lastName: "bar",
