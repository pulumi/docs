...
title_tag: "Resource ApiTagDescription | Module apimanagement/v20191201preview | Package Azure RM"
meta_desc: "Explore the ApiTagDescription resource of the apimanagement/v20191201preview module, including examples, input properties, output properties, lookup functions, and supporting types. Contract details."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var apiTagDescription = new AzureRM.ApiManagement.V20191201Preview.ApiTagDescription("apiTagDescription", new AzureRM.ApiManagement.V20191201Preview.ApiTagDescriptionArgs
        {
...
const apiTagDescription = new azurerm.apimanagement.v20191201preview.ApiTagDescription("apiTagDescription", {
    apiId: "5931a75ae4bbd512a88c680b",
    description: "Some description that will be displayed for operation's tag if the tag is assigned to operation of the API",
    externalDocsDescription: "Description of the external docs resource",
    externalDocsUrl: "http://some.url/additionaldoc",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/apimanagement/v20191201preview/#ApiTagDescriptionArgs">ApiTagDescriptionArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201preview?tab=doc#ApiTagDescriptionArgs">ApiTagDescriptionArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201Preview.ApiTagDescriptionArgs.html">ApiTagDescriptionArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
