...
---
title: "GetApi"
title_tag: "Function GetApi | Module apimanagement/v20170301 | Package azurerm"
meta_desc: "Explore the GetApi function of the apimanagement/v20170301 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getApi<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/apimanagement/v20170301/#GetApiArgs">GetApiArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/apimanagement/v20170301/#GetApiResult">GetApiResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#apiversionset_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Version<wbr>Set</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiversionsetcontractresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20170301.<wbr>Outputs.<wbr>Api<wbr>Version<wbr>Set<wbr>Contract<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Api Version Set Contract details.{{% /md %}}</dd>
...
<a href="#authenticationsettings_csharp" style="color: inherit; text-decoration: inherit;">Authentication<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authenticationsettingscontractresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20170301.<wbr>Outputs.<wbr>Authentication<wbr>Settings<wbr>Contract<wbr>Response</a></span>
    </dt>
...
<a href="#serviceurl_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Url</a>
    ...
    <dd>{{% md %}}Absolute URL of the backend service implementing this API.{{% /md %}}</dd>
...
<a href="#subscriptionkeyparameternames_csharp" style="color: inherit; text-decoration: inherit;">Subscription<wbr>Key<wbr>Parameter<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subscriptionkeyparameternamescontractresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20170301.<wbr>Outputs.<wbr>Subscription<wbr>Key<wbr>Parameter<wbr>Names<wbr>Contract<wbr>Response</a></span>
    </dt>
...
<a href="#apiversionset_go" style="color: inherit; text-decoration: inherit;">Api<wbr>Version<wbr>Set</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiversionsetcontractresponse">Api<wbr>Version<wbr>Set<wbr>Contract<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Api Version Set Contract details.{{% /md %}}</dd>
...
<a href="#api_version_set_python" style="color: inherit; text-decoration: inherit;">api_<wbr>version_<wbr>set</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiversionsetcontractresponse">Dict[Api<wbr>Version<wbr>Set<wbr>Contract<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Api Version Set Contract details.{{% /md %}}</dd>
...
<h4 id="apiversionsetcontractresponse">Api<wbr>Version<wbr>Set<wbr>Contract<wbr>Response</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#ApiVersionSetContractResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20170301?tab=doc#ApiVersionSetContractResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20170301.Outputs.ApiVersionSetContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20170301?tab=doc#AuthenticationSettingsContractResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20170301.Outputs.AuthenticationSettingsContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#oauth2_csharp" style="color: inherit; text-decoration: inherit;">OAuth2</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#oauth2authenticationsettingscontractresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20170301.<wbr>Inputs.<wbr>OAuth2Authentication<wbr>Settings<wbr>Contract<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20170301?tab=doc#OAuth2AuthenticationSettingsContractResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20170301.Outputs.OAuth2AuthenticationSettingsContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20170301?tab=doc#SubscriptionKeyParameterNamesContractResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20170301.Outputs.SubscriptionKeyParameterNamesContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
