...
title_tag: "Resource AuthorizationServer | Module apimanagement/v20191201 | Package azurerm"
meta_desc: "Explore the AuthorizationServer resource of the apimanagement/v20191201 module, including examples, input properties, output properties, lookup functions, and supporting types. External OAuth authorization server settings."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var authorizationServer = new AzureRM.ApiManagement.V20191201.AuthorizationServer("authorizationServer", new AzureRM.ApiManagement.V20191201.AuthorizationServerArgs
        {
...
authorization_server = azurerm.apimanagement.v20191201.AuthorizationServer("authorizationServer",
...
const authorizationServer = new azurerm.apimanagement.v20191201.AuthorizationServer("authorizationServer", {
    authorizationEndpoint: "https://www.contoso.com/oauth2/auth",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/apimanagement/v20191201/#AuthorizationServerArgs">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#AuthorizationServerArgs">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.AuthorizationServerArgs.html">AuthorizationServerArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#tokenbodyparameters_csharp" style="color: inherit; text-decoration: inherit;">Token<wbr>Body<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tokenbodyparametercontract">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20191201.<wbr>Inputs.<wbr>Token<wbr>Body<wbr>Parameter<wbr>Contract<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#TokenBodyParameterContractArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Inputs.TokenBodyParameterContractArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#TokenBodyParameterContractResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Outputs.TokenBodyParameterContractResponse.html">output</a> API doc for this type.
{{% /choosable %}}
