...
---
title: "Cache"
title_tag: "Resource Cache | Module apimanagement/v20191201 | Package azurerm"
meta_desc: "Explore the Cache resource of the apimanagement/v20191201 module, including examples, input properties, output properties, lookup functions, and supporting types. Cache details."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var cache = new AzureRM.ApiManagement.V20191201.Cache("cache", new AzureRM.ApiManagement.V20191201.CacheArgs
        {
            CacheId = "westindia",
...
cache = azurerm.apimanagement.v20191201.Cache("cache",
    cache_id="westindia",
...
const cache = new azurerm.apimanagement.v20191201.Cache("cache", {
    cacheId: "westindia",
    connectionString: "contoso5.redis.cache.windows.net,ssl=true,password=...",
    description: "Redis cache instances in West India",
    resourceGroupName: "rg1",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/apimanagement/v20191201/#CacheArgs">CacheArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#CacheArgs">CacheArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.CacheArgs.html">CacheArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
