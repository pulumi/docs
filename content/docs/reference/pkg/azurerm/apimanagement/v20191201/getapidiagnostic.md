...
title_tag: "Function GetApiDiagnostic | Module apimanagement/v20191201 | Package azurerm"
meta_desc: "Explore the GetApiDiagnostic function of the apimanagement/v20191201 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetApiDiagnostic </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Apimanagement/v20191201.GetApiDiagnosticResult.html">GetApiDiagnosticResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.GetApiDiagnosticArgs.html">GetApiDiagnosticArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#backend_csharp" style="color: inherit; text-decoration: inherit;">Backend</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelinediagnosticsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20191201.<wbr>Outputs.<wbr>Pipeline<wbr>Diagnostic<wbr>Settings<wbr>Response</a></span>
    </dt>
...
<a href="#sampling_csharp" style="color: inherit; text-decoration: inherit;">Sampling</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#samplingsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20191201.<wbr>Outputs.<wbr>Sampling<wbr>Settings<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#BodyDiagnosticSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Outputs.BodyDiagnosticSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#HttpMessageDiagnosticResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Outputs.HttpMessageDiagnosticResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#body_csharp" style="color: inherit; text-decoration: inherit;">Body</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bodydiagnosticsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20191201.<wbr>Inputs.<wbr>Body<wbr>Diagnostic<wbr>Settings<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#PipelineDiagnosticSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Outputs.PipelineDiagnosticSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#request_csharp" style="color: inherit; text-decoration: inherit;">Request</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpmessagediagnosticresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Api<wbr>Management.<wbr>V20191201.<wbr>Inputs.<wbr>Http<wbr>Message<wbr>Diagnostic<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/apimanagement/v20191201?tab=doc#SamplingSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ApiManagement.V20191201.Outputs.SamplingSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
