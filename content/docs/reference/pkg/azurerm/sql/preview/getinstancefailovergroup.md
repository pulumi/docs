...
title_tag: "Function GetInstanceFailoverGroup | Module sql/preview | Package azurerm"
meta_desc: "Explore the GetInstanceFailoverGroup function of the sql/preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getInstanceFailoverGroup<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/sql/preview/#GetInstanceFailoverGroupArgs">GetInstanceFailoverGroupArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/sql/preview/#GetInstanceFailoverGroupResult">GetInstanceFailoverGroupResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetInstanceFailoverGroup </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Sql/preview.GetInstanceFailoverGroupResult.html">GetInstanceFailoverGroupResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Sql.Preview.GetInstanceFailoverGroupArgs.html">GetInstanceFailoverGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#managedinstancepairs_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Instance<wbr>Pairs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#managedinstancepairinforesponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql.<wbr>Preview.<wbr>Outputs.<wbr>Managed<wbr>Instance<wbr>Pair<wbr>Info<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#partnerregions_csharp" style="color: inherit; text-decoration: inherit;">Partner<wbr>Regions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#partnerregioninforesponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql.<wbr>Preview.<wbr>Outputs.<wbr>Partner<wbr>Region<wbr>Info<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#readwriteendpoint_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Write<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancefailovergroupreadwriteendpointresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql.<wbr>Preview.<wbr>Outputs.<wbr>Instance<wbr>Failover<wbr>Group<wbr>Read<wbr>Write<wbr>Endpoint<wbr>Response</a></span>
    </dt>
...
<a href="#readonlyendpoint_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Only<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancefailovergroupreadonlyendpointresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql.<wbr>Preview.<wbr>Outputs.<wbr>Instance<wbr>Failover<wbr>Group<wbr>Read<wbr>Only<wbr>Endpoint<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sql/preview?tab=doc#InstanceFailoverGroupReadOnlyEndpointResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sql/preview?tab=doc#InstanceFailoverGroupReadWriteEndpointResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sql/preview?tab=doc#ManagedInstancePairInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sql/preview?tab=doc#PartnerRegionInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
