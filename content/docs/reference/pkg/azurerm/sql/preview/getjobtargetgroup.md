...
title_tag: "Function GetJobTargetGroup | Module sql/preview | Package azurerm"
meta_desc: "Explore the GetJobTargetGroup function of the sql/preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#members_csharp" style="color: inherit; text-decoration: inherit;">Members</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobtargetresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Sql.<wbr>Preview.<wbr>Outputs.<wbr>Job<wbr>Target<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/sql/preview?tab=doc#JobTargetResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
