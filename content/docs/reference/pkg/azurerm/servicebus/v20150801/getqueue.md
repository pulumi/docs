...
---
title: "GetQueue"
title_tag: "Function GetQueue | Module servicebus/v20150801 | Package azurerm"
meta_desc: "Explore the GetQueue function of the servicebus/v20150801 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getQueue<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/servicebus/v20150801/#GetQueueArgs">GetQueueArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/servicebus/v20150801/#GetQueueResult">GetQueueResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#autodeleteonidle_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Delete<wbr>On<wbr>Idle</a>
    ...
    <dd>{{% md %}}the TimeSpan idle interval after which the queue is automatically deleted. The minimum duration is 5 minutes.{{% /md %}}</dd>
...
<a href="#defaultmessagetimetolive_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Message<wbr>Time<wbr>To<wbr>Live</a>
    ...
    <dd>{{% md %}}The default message time to live value. This is the duration after which the message expires, starting from when the message is sent to Service Bus. This is the default value used when TimeToLive is not set on a message itself.{{% /md %}}</dd>
...
<a href="#duplicatedetectionhistorytimewindow_csharp" style="color: inherit; text-decoration: inherit;">Duplicate<wbr>Detection<wbr>History<wbr>Time<wbr>Window</a>
    ...
    <dd>{{% md %}}TimeSpan structure that defines the duration of the duplicate detection history. The default value is 10 minutes.{{% /md %}}</dd>
...
<a href="#enablebatchedoperations_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Batched<wbr>Operations</a>
    ...
    <dd>{{% md %}}A value that indicates whether server-side batched operations are enabled.{{% /md %}}</dd>
...
<a href="#entityavailabilitystatus_csharp" style="color: inherit; text-decoration: inherit;">Entity<wbr>Availability<wbr>Status</a>
    ...
    <dd>{{% md %}}Entity availability status for the queue.{{% /md %}}</dd>

    <dt class="property-"
            title="">
        <span id="isanonymousaccessible_csharp">
<a href="#isanonymousaccessible_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Anonymous<wbr>Accessible</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">bool</a></span>
    </dt>
    <dd>{{% md %}}A value that indicates whether the message is accessible anonymously.{{% /md %}}</dd>
...
<a href="#lockduration_csharp" style="color: inherit; text-decoration: inherit;">Lock<wbr>Duration</a>
    ...
    <dd>{{% md %}}The duration of a peek-lock; that is, the amount of time that the message is locked for other receivers. The maximum value for LockDuration is 5 minutes; the default value is 1 minute.{{% /md %}}</dd>
...
<a href="#maxdeliverycount_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Delivery<wbr>Count</a>
    ...
    <dd>{{% md %}}The maximum delivery count. A message is automatically deadlettered after this number of deliveries.{{% /md %}}</dd>
...
<a href="#maxsizeinmegabytes_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Size<wbr>In<wbr>Megabytes</a>
    ...
    <dd>{{% md %}}The maximum size of the queue in megabytes, which is the size of memory allocated for the queue.{{% /md %}}</dd>
...
<a href="#supportordering_csharp" style="color: inherit; text-decoration: inherit;">Support<wbr>Ordering</a>
    ...
    <dd>{{% md %}}A value that indicates whether the queue supports ordering.{{% /md %}}</dd>
...
<a href="#entityavailabilitystatus_go" style="color: inherit; text-decoration: inherit;">Entity<wbr>Availability<wbr>Status</a>
    ...
    <dt class="property-"
            title="">
        <span id="isanonymousaccessible_go">
<a href="#isanonymousaccessible_go" style="color: inherit; text-decoration: inherit;">Is<wbr>Anonymous<wbr>Accessible</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#boolean">bool</a></span>
    </dt>
...
<a href="#entityavailabilitystatus_nodejs" style="color: inherit; text-decoration: inherit;">entity<wbr>Availability<wbr>Status</a>
    ...
    <dt class="property-"
            title="">
        <span id="isanonymousaccessible_nodejs">
<a href="#isanonymousaccessible_nodejs" style="color: inherit; text-decoration: inherit;">is<wbr>Anonymous<wbr>Accessible</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/boolean">boolean</a></span>
    </dt>
...
<a href="#entity_availability_status_python" style="color: inherit; text-decoration: inherit;">entity_<wbr>availability_<wbr>status</a>
    ...
    <dt class="property-"
            title="">
        <span id="is_anonymous_accessible_python">
<a href="#is_anonymous_accessible_python" style="color: inherit; text-decoration: inherit;">is_<wbr>anonymous_<wbr>accessible</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">bool</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicebus/v20150801?tab=doc#MessageCountDetailsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
