...
---
title: "GetFileServer"
title_tag: "Function GetFileServer | Module batchai/v20170901preview | Package azurerm"
meta_desc: "Explore the GetFileServer function of the batchai/v20170901preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getFileServer<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/batchai/v20170901preview/#GetFileServerArgs">GetFileServerArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/batchai/v20170901preview/#GetFileServerResult">GetFileServerResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_file_server(</span><span class="nx">file_server_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetFileServerResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupFileServer<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#LookupFileServerArgs">LookupFileServerArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#LookupFileServerResult">LookupFileServerResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetFileServer </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Batchai/v20170901preview.GetFileServerResult.html">GetFileServerResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.BatchAI.V20170901Preview.GetFileServerArgs.html">GetFileServerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#mountsettings_csharp" style="color: inherit; text-decoration: inherit;">Mount<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mountsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Batch<wbr>AI.<wbr>V20170901Preview.<wbr>Outputs.<wbr>Mount<wbr>Settings<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Details of the File Server.{{% /md %}}</dd>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}Possible values: creating - The File Server is getting created. updating - The File Server creation has been accepted and it is getting updated. deleting - The user has requested that the File Server be deleted, and it is in the process of being deleted. failed - The File Server creation has failed with the specified errorCode. Details about the error code are specified in the message field. succeeded - The File Server creation has succeeded.{{% /md %}}</dd>
...
<a href="#datadisks_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datadisksresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Batch<wbr>AI.<wbr>V20170901Preview.<wbr>Outputs.<wbr>Data<wbr>Disks<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Settings for the data disk which would be created for the File Server.{{% /md %}}</dd>
...
<a href="#sshconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Ssh<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sshconfigurationresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Batch<wbr>AI.<wbr>V20170901Preview.<wbr>Outputs.<wbr>Ssh<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}SSH configuration settings for the VM{{% /md %}}</dd>
...
<a href="#vmsize_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Size</a>
    ...
    <dd>{{% md %}}For information about available VM sizes for File Server from the Virtual Machines Marketplace, see Sizes for Virtual Machines (Linux).{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#DataDisksResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.BatchAI.V20170901Preview.Outputs.DataDisksResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#MountSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.BatchAI.V20170901Preview.Outputs.MountSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#fileserverpublicip_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Server<wbr>Public<wbr>IP</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="fileservertype_csharp">
<a href="#fileservertype_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Server<wbr>Type</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
...
<a href="#fileserverpublicip_go" style="color: inherit; text-decoration: inherit;">File<wbr>Server<wbr>Public<wbr>IP</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="fileservertype_go">
<a href="#fileservertype_go" style="color: inherit; text-decoration: inherit;">File<wbr>Server<wbr>Type</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#fileserverpublicip_nodejs" style="color: inherit; text-decoration: inherit;">file<wbr>Server<wbr>Public<wbr>IP</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="fileservertype_nodejs">
<a href="#fileservertype_nodejs" style="color: inherit; text-decoration: inherit;">file<wbr>Server<wbr>Type</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#file_server_public_ip_python" style="color: inherit; text-decoration: inherit;">file_<wbr>server_<wbr>public_<wbr>ip</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="file_server_type_python">
<a href="#file_server_type_python" style="color: inherit; text-decoration: inherit;">file_<wbr>server_<wbr>type</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#SshConfigurationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.BatchAI.V20170901Preview.Outputs.SshConfigurationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#useraccountsettings_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Account<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#useraccountsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Batch<wbr>AI.<wbr>V20170901Preview.<wbr>Inputs.<wbr>User<wbr>Account<wbr>Settings<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#publicipstoallow_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>IPs<wbr>To<wbr>Allow</a>
    ...
    <dd>{{% md %}}Default value is '*' can be used to match all source IPs. Maximum number of publicIPs that can be specified are 400.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/batchai/v20170901preview?tab=doc#UserAccountSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
