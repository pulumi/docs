...
---
title: "Map"
title_tag: "Resource Map | Module logic/v20160601 | Package azurerm"
meta_desc: "Explore the Map resource of the logic/v20160601 module, including examples, input properties, output properties, lookup functions, and supporting types. The integration account map."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20160601/#MapArgs">MapArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#MapArgs">MapArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.MapArgs.html">MapArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
The Map resource accepts the following [input]({{< relref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
...
<a href="#parametersschema_csharp" style="color: inherit; text-decoration: inherit;">Parameters<wbr>Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationaccountmappropertiesparametersschema">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Inputs.<wbr>Integration<wbr>Account<wbr>Map<wbr>Properties<wbr>Parameters<wbr>Schema<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#IntegrationAccountMapPropertiesParametersSchemaArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Inputs.IntegrationAccountMapPropertiesParametersSchemaArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#IntegrationAccountMapPropertiesResponseParametersSchemaOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
