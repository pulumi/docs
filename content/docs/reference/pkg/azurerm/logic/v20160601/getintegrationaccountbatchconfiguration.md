...
title_tag: "Function GetIntegrationAccountBatchConfiguration | Module logic/v20160601 | Package azurerm"
meta_desc: "Explore the GetIntegrationAccountBatchConfiguration function of the logic/v20160601 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIntegrationAccountBatchConfiguration<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20160601/#GetIntegrationAccountBatchConfigurationArgs">GetIntegrationAccountBatchConfigurationArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20160601/#GetIntegrationAccountBatchConfigurationResult">GetIntegrationAccountBatchConfigurationResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIntegrationAccountBatchConfiguration<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#LookupIntegrationAccountBatchConfigurationArgs">LookupIntegrationAccountBatchConfigurationArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#LookupIntegrationAccountBatchConfigurationResult">LookupIntegrationAccountBatchConfigurationResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIntegrationAccountBatchConfiguration </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic/v20160601.GetIntegrationAccountBatchConfigurationResult.html">GetIntegrationAccountBatchConfigurationResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.GetIntegrationAccountBatchConfigurationArgs.html">GetIntegrationAccountBatchConfigurationArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchconfigurationpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Outputs.<wbr>Batch<wbr>Configuration<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchconfigurationpropertiesresponse">Dict[Batch<wbr>Configuration<wbr>Properties<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The batch configuration properties.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#BatchConfigurationPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Outputs.BatchConfigurationPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#releasecriteria_csharp" style="color: inherit; text-decoration: inherit;">Release<wbr>Criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#batchreleasecriteriaresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Inputs.<wbr>Batch<wbr>Release<wbr>Criteria<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#BatchReleaseCriteriaResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Outputs.BatchReleaseCriteriaResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#recurrence_csharp" style="color: inherit; text-decoration: inherit;">Recurrence</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workflowtriggerrecurrenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Inputs.<wbr>Workflow<wbr>Trigger<wbr>Recurrence<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#RecurrenceScheduleOccurrenceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Outputs.RecurrenceScheduleOccurrenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#RecurrenceScheduleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Outputs.RecurrenceScheduleResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#monthlyoccurrences_csharp" style="color: inherit; text-decoration: inherit;">Monthly<wbr>Occurrences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#recurrencescheduleoccurrenceresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Inputs.<wbr>Recurrence<wbr>Schedule<wbr>Occurrence<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20160601?tab=doc#WorkflowTriggerRecurrenceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20160601.Outputs.WorkflowTriggerRecurrenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#recurrencescheduleresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20160601.<wbr>Inputs.<wbr>Recurrence<wbr>Schedule<wbr>Response<wbr>Args</a></span>
    </dt>
