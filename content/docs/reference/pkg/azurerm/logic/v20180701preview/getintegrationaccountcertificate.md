...
title_tag: "Function GetIntegrationAccountCertificate | Module logic/v20180701preview | Package azurerm"
meta_desc: "Explore the GetIntegrationAccountCertificate function of the logic/v20180701preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultkeyreferenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Outputs.<wbr>Key<wbr>Vault<wbr>Key<wbr>Reference<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#KeyVaultKeyReferenceResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.KeyVaultKeyReferenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#keyvault_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Vault</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultkeyreferenceresponsekeyvault">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Key<wbr>Reference<wbr>Response<wbr>Key<wbr>Vault<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#KeyVaultKeyReferenceResponseKeyVault">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.KeyVaultKeyReferenceResponseKeyVault.html">output</a> API doc for this type.
{{% /choosable %}}
