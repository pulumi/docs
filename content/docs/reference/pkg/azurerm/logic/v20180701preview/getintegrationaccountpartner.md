...
title_tag: "Function GetIntegrationAccountPartner | Module logic/v20180701preview | Package azurerm"
meta_desc: "Explore the GetIntegrationAccountPartner function of the logic/v20180701preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIntegrationAccountPartner<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20180701preview/#GetIntegrationAccountPartnerArgs">GetIntegrationAccountPartnerArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20180701preview/#GetIntegrationAccountPartnerResult">GetIntegrationAccountPartnerResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIntegrationAccountPartner<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#LookupIntegrationAccountPartnerArgs">LookupIntegrationAccountPartnerArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#LookupIntegrationAccountPartnerResult">LookupIntegrationAccountPartnerResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIntegrationAccountPartner </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic/v20180701preview.GetIntegrationAccountPartnerResult.html">GetIntegrationAccountPartnerResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.GetIntegrationAccountPartnerArgs.html">GetIntegrationAccountPartnerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#content_csharp" style="color: inherit; text-decoration: inherit;">Content</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#partnercontentresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Outputs.<wbr>Partner<wbr>Content<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#B2BPartnerContentResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.B2BPartnerContentResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#businessidentities_csharp" style="color: inherit; text-decoration: inherit;">Business<wbr>Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#businessidentityresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>Business<wbr>Identity<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#BusinessIdentityResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.BusinessIdentityResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#PartnerContentResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.PartnerContentResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#b2b_csharp" style="color: inherit; text-decoration: inherit;">B2b</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#b2bpartnercontentresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>B2BPartner<wbr>Content<wbr>Response<wbr>Args</a></span>
    </dt>
