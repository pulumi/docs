...
title_tag: "Function ListIntegrationAccountAgreementContentCallbackUrl | Module logic/v20180701preview | Package azurerm"
meta_desc: "Explore the ListIntegrationAccountAgreementContentCallbackUrl function of the logic/v20180701preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listIntegrationAccountAgreementContentCallbackUrl<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20180701preview/#ListIntegrationAccountAgreementContentCallbackUrlArgs">ListIntegrationAccountAgreementContentCallbackUrlArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/logic/v20180701preview/#ListIntegrationAccountAgreementContentCallbackUrlResult">ListIntegrationAccountAgreementContentCallbackUrlResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListIntegrationAccountAgreementContentCallbackUrl </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic/v20180701preview.ListIntegrationAccountAgreementContentCallbackUrlResult.html">ListIntegrationAccountAgreementContentCallbackUrlResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.ListIntegrationAccountAgreementContentCallbackUrlArgs.html">ListIntegrationAccountAgreementContentCallbackUrlArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#queries_csharp" style="color: inherit; text-decoration: inherit;">Queries</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workflowtriggerlistcallbackurlqueriesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Outputs.<wbr>Workflow<wbr>Trigger<wbr>List<wbr>Callback<wbr>Url<wbr>Queries<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#WorkflowTriggerListCallbackUrlQueriesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.WorkflowTriggerListCallbackUrlQueriesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
