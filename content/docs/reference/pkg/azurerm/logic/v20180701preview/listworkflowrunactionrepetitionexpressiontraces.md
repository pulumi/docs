...
---
title: "ListWorkflowRunActionRepetitionExpressionTraces"
title_tag: "Function ListWorkflowRunActionRepetitionExpressionTraces | Module logic/v20180701preview | Package azurerm"
meta_desc: "Explore the ListWorkflowRunActionRepetitionExpressionTraces function of the logic/v20180701preview module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#actionname_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>Name</a>
    ...
    <dt class="property-required"
            title="Required">
        <span id="repetitionname_csharp">
<a href="#repetitionname_csharp" style="color: inherit; text-decoration: inherit;">Repetition<wbr>Name</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span>
    </dt>
    <dd>{{% md %}}The workflow repetition.{{% /md %}}</dd>
...
<a href="#actionname_go" style="color: inherit; text-decoration: inherit;">Action<wbr>Name</a>
    ...
    <dt class="property-required"
            title="Required">
        <span id="repetitionname_go">
<a href="#repetitionname_go" style="color: inherit; text-decoration: inherit;">Repetition<wbr>Name</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://golang.org/pkg/builtin/#string">string</a></span>
    </dt>
...
<a href="#actionname_nodejs" style="color: inherit; text-decoration: inherit;">action<wbr>Name</a>
    ...
    <dt class="property-required"
            title="Required">
        <span id="repetitionname_nodejs">
<a href="#repetitionname_nodejs" style="color: inherit; text-decoration: inherit;">repetition<wbr>Name</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span>
    </dt>
...
<a href="#action_name_python" style="color: inherit; text-decoration: inherit;">action_<wbr>name</a>
    ...
    <dt class="property-required"
            title="Required">
        <span id="repetition_name_python">
<a href="#repetition_name_python" style="color: inherit; text-decoration: inherit;">repetition_<wbr>name</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.python.org/3/library/stdtypes.html">str</a></span>
    </dt>
...
## ListWorkflowRunActionRepetitionExpressionTraces Result {#result}
...
<a href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expressionrootresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Outputs.<wbr>Expression<wbr>Root<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#AzureResourceErrorInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.AzureResourceErrorInfoResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#details_csharp" style="color: inherit; text-decoration: inherit;">Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#azureresourceerrorinforesponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>Azure<wbr>Resource<wbr>Error<wbr>Info<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#ExpressionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.ExpressionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#error_csharp" style="color: inherit; text-decoration: inherit;">Error</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#azureresourceerrorinforesponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>Azure<wbr>Resource<wbr>Error<wbr>Info<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#subexpressions_csharp" style="color: inherit; text-decoration: inherit;">Subexpressions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#expressionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20180701Preview.<wbr>Inputs.<wbr>Expression<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20180701preview?tab=doc#ExpressionRootResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Logic.V20180701Preview.Outputs.ExpressionRootResponse.html">output</a> API doc for this type.
{{% /choosable %}}
