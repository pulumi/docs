...
title_tag: "Function GetIntegrationAccountMap | Module logic/v20190501 | Package azurerm"
meta_desc: "Explore the GetIntegrationAccountMap function of the logic/v20190501 module, including examples, input properties, output properties, and supporting types. "
---
...
<a href="#parametersschema_csharp" style="color: inherit; text-decoration: inherit;">Parameters<wbr>Schema</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#integrationaccountmappropertiesresponseparametersschema">Pulumi.<wbr>Azure<wbr>RM.<wbr>Logic.<wbr>V20190501.<wbr>Outputs.<wbr>Integration<wbr>Account<wbr>Map<wbr>Properties<wbr>Response<wbr>Parameters<wbr>Schema</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/logic/v20190501?tab=doc#IntegrationAccountMapPropertiesResponseParametersSchema">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
