...
title_tag: "Resource RegistrationDefinition | Module managedservices/v20190901 | Package azurerm"
meta_desc: "Explore the RegistrationDefinition resource of the managedservices/v20190901 module, including examples, input properties, output properties, lookup functions, and supporting types. Registration definition."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/managedservices/v20190901/#RegistrationDefinitionArgs">RegistrationDefinitionArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#RegistrationDefinitionArgs">RegistrationDefinitionArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20190901.RegistrationDefinitionArgs.html">RegistrationDefinitionArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#plan_csharp" style="color: inherit; text-decoration: inherit;">Plan</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#plan">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20190901.<wbr>Inputs.<wbr>Plan<wbr>Args</a></span>
    </dt>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationdefinitionproperties">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20190901.<wbr>Inputs.<wbr>Registration<wbr>Definition<wbr>Properties<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#AuthorizationArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20190901.Inputs.AuthorizationArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#AuthorizationResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#PlanArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20190901.Inputs.PlanArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#PlanResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#RegistrationDefinitionPropertiesArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20190901.Inputs.RegistrationDefinitionPropertiesArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#authorizations_csharp" style="color: inherit; text-decoration: inherit;">Authorizations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authorization">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20190901.<wbr>Inputs.<wbr>Authorization<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20190901?tab=doc#RegistrationDefinitionPropertiesResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
