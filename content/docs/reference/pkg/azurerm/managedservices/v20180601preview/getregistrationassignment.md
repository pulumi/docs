...
title_tag: "Function GetRegistrationAssignment | Module managedservices/v20180601preview | Package azurerm"
meta_desc: "Explore the GetRegistrationAssignment function of the managedservices/v20180601preview module, including examples, input properties, output properties, and supporting types. "
---
...
## Using GetRegistrationAssignment {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getRegistrationAssignment<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/managedservices/v20180601preview/#GetRegistrationAssignmentArgs">GetRegistrationAssignmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/managedservices/v20180601preview/#GetRegistrationAssignmentResult">GetRegistrationAssignmentResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRegistrationAssignment<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#LookupRegistrationAssignmentArgs">LookupRegistrationAssignmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#LookupRegistrationAssignmentResult">LookupRegistrationAssignmentResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetRegistrationAssignment </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Managedservices/v20180601preview.GetRegistrationAssignmentResult.html">GetRegistrationAssignmentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.GetRegistrationAssignmentArgs.html">GetRegistrationAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#scope_csharp" style="color: inherit; text-decoration: inherit;">Scope</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="expandregistrationdefinition_csharp">
<a href="#expandregistrationdefinition_csharp" style="color: inherit; text-decoration: inherit;">Expand<wbr>Registration<wbr>Definition</a>
</span> 
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">bool</a></span>
    </dt>
    <dd>{{% md %}}Tells whether to return registration definition details also along with registration assignment details.{{% /md %}}</dd>
...
<a href="#scope_go" style="color: inherit; text-decoration: inherit;">Scope</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="expandregistrationdefinition_go">
<a href="#expandregistrationdefinition_go" style="color: inherit; text-decoration: inherit;">Expand<wbr>Registration<wbr>Definition</a>
</span> 
        <span class="property-indicator"></span>
...
<a href="#scope_nodejs" style="color: inherit; text-decoration: inherit;">scope</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="expandregistrationdefinition_nodejs">
<a href="#expandregistrationdefinition_nodejs" style="color: inherit; text-decoration: inherit;">expand<wbr>Registration<wbr>Definition</a>
</span> 
        <span class="property-indicator"></span>
...
<a href="#scope_python" style="color: inherit; text-decoration: inherit;">scope</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="expand_registration_definition_python">
<a href="#expand_registration_definition_python" style="color: inherit; text-decoration: inherit;">expand_<wbr>registration_<wbr>definition</a>
</span> 
        <span class="property-indicator"></span>
...
## GetRegistrationAssignment Result {#result}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationassignmentpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20180601Preview.<wbr>Outputs.<wbr>Registration<wbr>Assignment<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a href="#properties_go" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationassignmentpropertiesresponse">Registration<wbr>Assignment<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties of a registration assignment.{{% /md %}}</dd>
...
<a href="#properties_python" style="color: inherit; text-decoration: inherit;">properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationassignmentpropertiesresponse">Dict[Registration<wbr>Assignment<wbr>Properties<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Properties of a registration assignment.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#AuthorizationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.Outputs.AuthorizationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#PlanResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.Outputs.PlanResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#RegistrationAssignmentPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.Outputs.RegistrationAssignmentPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#registrationdefinition_csharp" style="color: inherit; text-decoration: inherit;">Registration<wbr>Definition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationassignmentpropertiesresponseregistrationdefinition">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20180601Preview.<wbr>Inputs.<wbr>Registration<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Registration<wbr>Definition<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#RegistrationAssignmentPropertiesResponseProperties">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.Outputs.RegistrationAssignmentPropertiesResponseProperties.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#authorizations_csharp" style="color: inherit; text-decoration: inherit;">Authorizations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authorizationresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20180601Preview.<wbr>Inputs.<wbr>Authorization<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/managedservices/v20180601preview?tab=doc#RegistrationAssignmentPropertiesResponseRegistrationDefinition">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ManagedServices.V20180601Preview.Outputs.RegistrationAssignmentPropertiesResponseRegistrationDefinition.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#plan_csharp" style="color: inherit; text-decoration: inherit;">Plan</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#planresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20180601Preview.<wbr>Inputs.<wbr>Plan<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#registrationassignmentpropertiesresponseproperties">Pulumi.<wbr>Azure<wbr>RM.<wbr>Managed<wbr>Services.<wbr>V20180601Preview.<wbr>Inputs.<wbr>Registration<wbr>Assignment<wbr>Properties<wbr>Response<wbr>Properties<wbr>Args</a></span>
    </dt>
