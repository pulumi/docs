...
title_tag: "Resource VirtualMachineScaleSetVM | Module compute/v20200601 | Package azurerm"
meta_desc: "Explore the VirtualMachineScaleSetVM resource of the compute/v20200601 module, including examples, input properties, output properties, lookup functions, and supporting types. Describes a virtual machine scale set virtual machine."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20200601/#VirtualMachineScaleSetVMArgs">VirtualMachineScaleSetVMArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMArgs">VirtualMachineScaleSetVMArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.VirtualMachineScaleSetVMArgs.html">VirtualMachineScaleSetVMArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#networkprofileconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Profile<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinescalesetvmnetworkprofileconfiguration">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200601.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Scale<wbr>Set<wbr>VMNetwork<wbr>Profile<wbr>Configuration<wbr>Args</a></span>
    </dt>
...
<a href="#protectionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Protection<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinescalesetvmprotectionpolicy">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200601.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Scale<wbr>Set<wbr>VMProtection<wbr>Policy<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMNetworkProfileConfigurationArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.Inputs.VirtualMachineScaleSetVMNetworkProfileConfigurationArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMNetworkProfileConfigurationResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMProtectionPolicyArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.Inputs.VirtualMachineScaleSetVMProtectionPolicyArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#VirtualMachineScaleSetVMProtectionPolicyResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
