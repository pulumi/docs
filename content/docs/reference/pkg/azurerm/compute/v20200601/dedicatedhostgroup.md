...
title_tag: "Resource DedicatedHostGroup | Module compute/v20200601 | Package azurerm"
meta_desc: "Explore the DedicatedHostGroup resource of the compute/v20200601 module, including examples, input properties, output properties, lookup functions, and supporting types. Specifies information about the dedicated host group that the dedicated hosts should be assigned to. &lt;br&gt;&lt;br&gt; Currently, a dedicated host can only be added to a dedicated host group at creation time. An existing dedicated host cannot be added to another dedicated host group."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20200601/#DedicatedHostGroupArgs">DedicatedHostGroupArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#DedicatedHostGroupArgs">DedicatedHostGroupArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.DedicatedHostGroupArgs.html">DedicatedHostGroupArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedhostgroupinstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200601.<wbr>Outputs.<wbr>Dedicated<wbr>Host<wbr>Group<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#DedicatedHostGroupInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.Outputs.DedicatedHostGroupInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#hosts_csharp" style="color: inherit; text-decoration: inherit;">Hosts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedhostinstanceviewwithnameresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200601.<wbr>Inputs.<wbr>Dedicated<wbr>Host<wbr>Instance<wbr>View<wbr>With<wbr>Name<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200601?tab=doc#DedicatedHostInstanceViewWithNameResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200601.Outputs.DedicatedHostInstanceViewWithNameResponse.html">output</a> API doc for this type.
{{% /choosable %}}
