...
title_tag: "Function GetGalleryImage | Module compute/v20200930 | Package azurerm"
meta_desc: "Explore the GetGalleryImage function of the compute/v20200930 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getGalleryImage<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20200930/#GetGalleryImageArgs">GetGalleryImageArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20200930/#GetGalleryImageResult">GetGalleryImageResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#identifier_csharp" style="color: inherit; text-decoration: inherit;">Identifier</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#galleryimageidentifierresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Outputs.<wbr>Gallery<wbr>Image<wbr>Identifier<wbr>Response</a></span>
    </dt>
...
<a href="#disallowed_csharp" style="color: inherit; text-decoration: inherit;">Disallowed</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#disallowedresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Outputs.<wbr>Disallowed<wbr>Response</a></span>
    </dt>
...
<a href="#features_csharp" style="color: inherit; text-decoration: inherit;">Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#galleryimagefeatureresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Outputs.<wbr>Gallery<wbr>Image<wbr>Feature<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#purchaseplan_csharp" style="color: inherit; text-decoration: inherit;">Purchase<wbr>Plan</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagepurchaseplanresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Outputs.<wbr>Image<wbr>Purchase<wbr>Plan<wbr>Response</a></span>
    </dt>
...
<a href="#recommended_csharp" style="color: inherit; text-decoration: inherit;">Recommended</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#recommendedmachineconfigurationresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Outputs.<wbr>Recommended<wbr>Machine<wbr>Configuration<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#DisallowedResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.DisallowedResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#GalleryImageFeatureResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.GalleryImageFeatureResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#GalleryImageIdentifierResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.GalleryImageIdentifierResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#ImagePurchasePlanResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.ImagePurchasePlanResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#RecommendedMachineConfigurationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.RecommendedMachineConfigurationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#memory_csharp" style="color: inherit; text-decoration: inherit;">Memory</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcerangeresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200930.<wbr>Inputs.<wbr>Resource<wbr>Range<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200930?tab=doc#ResourceRangeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200930.Outputs.ResourceRangeResponse.html">output</a> API doc for this type.
{{% /choosable %}}
