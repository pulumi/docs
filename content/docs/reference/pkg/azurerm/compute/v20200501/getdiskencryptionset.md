...
title_tag: "Function GetDiskEncryptionSet | Module compute/v20200501 | Package azurerm"
meta_desc: "Explore the GetDiskEncryptionSet function of the compute/v20200501 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetDiskEncryptionSet </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute/v20200501.GetDiskEncryptionSetResult.html">GetDiskEncryptionSetResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20200501.GetDiskEncryptionSetArgs.html">GetDiskEncryptionSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#activekey_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultandkeyreferenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200501.<wbr>Outputs.<wbr>Key<wbr>Vault<wbr>And<wbr>Key<wbr>Reference<wbr>Response</a></span>
    </dt>
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionsetidentityresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20200501.<wbr>Outputs.<wbr>Encryption<wbr>Set<wbr>Identity<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20200501?tab=doc#EncryptionSetIdentityResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
