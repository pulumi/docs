...
title_tag: "Function GetDedicatedHost | Module compute/v20190701 | Package azurerm"
meta_desc: "Explore the GetDedicatedHost function of the compute/v20190701 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getDedicatedHost<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20190701/#GetDedicatedHostArgs">GetDedicatedHostArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20190701/#GetDedicatedHostResult">GetDedicatedHostResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetDedicatedHost </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute/v20190701.GetDedicatedHostResult.html">GetDedicatedHostResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.GetDedicatedHostArgs.html">GetDedicatedHostArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedhostinstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Outputs.<wbr>Dedicated<wbr>Host<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
...
<a href="#virtualmachines_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machines</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subresourcereadonlyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Outputs.<wbr>Sub<wbr>Resource<wbr>Read<wbr>Only<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#DedicatedHostAllocatableVMResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DedicatedHostAllocatableVMResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DedicatedHostAllocatableVMResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#DedicatedHostAvailableCapacityResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DedicatedHostAvailableCapacityResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DedicatedHostAvailableCapacityResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#allocatablevms_csharp" style="color: inherit; text-decoration: inherit;">Allocatable<wbr>VMs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedhostallocatablevmresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Dedicated<wbr>Host<wbr>Allocatable<wbr>VMResponse<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#DedicatedHostInstanceViewResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DedicatedHostInstanceViewResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DedicatedHostInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#availablecapacity_csharp" style="color: inherit; text-decoration: inherit;">Available<wbr>Capacity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dedicatedhostavailablecapacityresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Dedicated<wbr>Host<wbr>Available<wbr>Capacity<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#statuses_csharp" style="color: inherit; text-decoration: inherit;">Statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instanceviewstatusresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Instance<wbr>View<wbr>Status<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#InstanceViewStatusResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#SubResourceReadOnlyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.SubResourceReadOnlyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
