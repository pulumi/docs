...
title_tag: "Resource VirtualMachine | Module compute/v20190701 | Package azurerm"
meta_desc: "Explore the VirtualMachine resource of the compute/v20190701 module, including examples, input properties, output properties, lookup functions, and supporting types. Describes a Virtual Machine."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20190701/#VirtualMachine">VirtualMachine</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20190701/#VirtualMachineArgs">VirtualMachineArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_azurerm/compute/v20190701/#pulumi_azurerm.compute/v20190701.VirtualMachine">VirtualMachine</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">additional_capabilities</span><span class="p">:</span> <span class="nx">Optional[Dict[AdditionalCapabilities]]</span> = None<span class="p">, </span><span class="nx">availability_set</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">billing_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[BillingProfile]]</span> = None<span class="p">, </span><span class="nx">diagnostics_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[DiagnosticsProfile]]</span> = None<span class="p">, </span><span class="nx">eviction_policy</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">hardware_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[HardwareProfile]]</span> = None<span class="p">, </span><span class="nx">host</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">identity</span><span class="p">:</span> <span class="nx">Optional[Dict[VirtualMachineIdentity]]</span> = None<span class="p">, </span><span class="nx">license_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">network_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[NetworkProfile]]</span> = None<span class="p">, </span><span class="nx">os_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[OSProfile]]</span> = None<span class="p">, </span><span class="nx">plan</span><span class="p">:</span> <span class="nx">Optional[Dict[Plan]]</span> = None<span class="p">, </span><span class="nx">priority</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">proximity_placement_group</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">storage_profile</span><span class="p">:</span> <span class="nx">Optional[Dict[StorageProfile]]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Dict[str, str]]</span> = None<span class="p">, </span><span class="nx">virtual_machine_scale_set</span><span class="p">:</span> <span class="nx">Optional[Dict[SubResource]]</span> = None<span class="p">, </span><span class="nx">vm_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">zones</span><span class="p">:</span> <span class="nx">Optional[List[str]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachine">NewVirtualMachine</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineArgs">VirtualMachineArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachine">VirtualMachine</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.VirtualMachine.html">VirtualMachine</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.VirtualMachineArgs.html">VirtualMachineArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20190701/#VirtualMachineArgs">VirtualMachineArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineArgs">VirtualMachineArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.VirtualMachineArgs.html">VirtualMachineArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#hardwareprofile_csharp" style="color: inherit; text-decoration: inherit;">Hardware<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hardwareprofile">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Hardware<wbr>Profile<wbr>Args</a></span>
    </dt>
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineidentity">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#networkprofile_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkprofile">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Network<wbr>Profile<wbr>Args</a></span>
    </dt>
...
<a href="#osprofile_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#osprofile">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>OSProfile<wbr>Args</a></span>
    </dt>
...
<a href="#storageprofile_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageprofile">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Storage<wbr>Profile<wbr>Args</a></span>
    </dt>
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineinstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Outputs.<wbr>Virtual<wbr>Machine<wbr>Instance<wbr>View<wbr>Response</a></span>
    </dt>
...
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Outputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#BootDiagnosticsInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.BootDiagnosticsInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DataDiskArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.DataDiskArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#manageddisk_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#manageddiskparameters">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Managed<wbr>Disk<wbr>Parameters<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DataDiskResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DataDiskResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#manageddisk_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#manageddiskparametersresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Managed<wbr>Disk<wbr>Parameters<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The managed disk parameters.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DiskEncryptionSettingsArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.DiskEncryptionSettingsArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#diskencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Encryption<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultsecretreference">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Secret<wbr>Reference<wbr>Args</a></span>
    </dt>
...
<a href="#keyencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Encryption<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultkeyreference">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Key<wbr>Reference<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DiskEncryptionSettingsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DiskEncryptionSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#diskencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Encryption<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultsecretreferenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Secret<wbr>Reference<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies the location of the disk encryption key, which is a Key Vault Secret.{{% /md %}}</dd>
...
<a href="#keyencryptionkey_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Encryption<wbr>Key</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultkeyreferenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Key<wbr>Reference<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies the location of the key encryption key in Key Vault.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#DiskInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.DiskInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#encryptionsettings_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptionsettingsresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Disk<wbr>Encryption<wbr>Settings<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#HardwareProfileArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.HardwareProfileArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#HardwareProfileResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.HardwareProfileResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#KeyVaultKeyReferenceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.KeyVaultKeyReferenceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#KeyVaultKeyReferenceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.KeyVaultKeyReferenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#KeyVaultSecretReferenceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.KeyVaultSecretReferenceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#KeyVaultSecretReferenceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.KeyVaultSecretReferenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#MaintenanceRedeployStatusResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.MaintenanceRedeployStatusResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#ManagedDiskParametersArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.ManagedDiskParametersArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#ManagedDiskParametersResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.ManagedDiskParametersResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#NetworkInterfaceReferenceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.NetworkInterfaceReferenceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#NetworkInterfaceReferenceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.NetworkInterfaceReferenceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#NetworkProfileArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.NetworkProfileArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacereference">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Network<wbr>Interface<wbr>Reference<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#NetworkProfileResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.NetworkProfileResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterfacereferenceresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Network<wbr>Interface<wbr>Reference<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the list of resource Ids for the network interfaces associated with the virtual machine.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#OSDiskArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.OSDiskArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#encryptionsettings_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptionsettings">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Disk<wbr>Encryption<wbr>Settings<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies the encryption settings for the OS Disk. <br><br> Minimum api-version: 2015-06-15{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#OSDiskResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.OSDiskResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#encryptionsettings_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskencryptionsettingsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Disk<wbr>Encryption<wbr>Settings<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies the encryption settings for the OS Disk. <br><br> Minimum api-version: 2015-06-15{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#OSProfileArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.OSProfileArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#requireguestprovisionsignal_csharp" style="color: inherit; text-decoration: inherit;">Require<wbr>Guest<wbr>Provision<wbr>Signal</a>
    ...
    <dd>{{% md %}}Specifies whether the guest provision signal is required to infer provision success of the virtual machine.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#OSProfileResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.OSProfileResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#StorageProfileArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.StorageProfileArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#datadisks_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datadisk">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Data<wbr>Disk<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#osdisk_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#osdisk">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>OSDisk<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#StorageProfileResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.StorageProfileResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#datadisks_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datadiskresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Data<wbr>Disk<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Specifies the parameters that are used to add a data disk to a virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).{{% /md %}}</dd>
...
<a href="#osdisk_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#osdiskresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>OSDisk<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Specifies information about the operating system disk used by the virtual machine. <br><br> For more information about disks, see [About disks and VHDs for Azure virtual machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineAgentInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineAgentInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#extensionhandlers_csharp" style="color: inherit; text-decoration: inherit;">Extension<wbr>Handlers</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensionhandlerinstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Handler<wbr>Instance<wbr>View<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineExtensionHandlerInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineExtensionHandlerInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineExtensionInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineExtensionInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineExtensionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineExtensionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensioninstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Instance<wbr>View<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineIdentityArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Inputs.VirtualMachineIdentityArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineIdentityResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineIdentityResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#userassignedidentities_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Assigned<wbr>Identities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Identity<wbr>Response<wbr>User<wbr>Assigned<wbr>Identities<wbr>Args&gt;</span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineIdentityResponseUserAssignedIdentitiesOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineIdentityResponseUserAssignedIdentities.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20190701?tab=doc#VirtualMachineInstanceViewResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20190701.Outputs.VirtualMachineInstanceViewResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#bootdiagnostics_csharp" style="color: inherit; text-decoration: inherit;">Boot<wbr>Diagnostics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bootdiagnosticsinstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Boot<wbr>Diagnostics<wbr>Instance<wbr>View<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Boot Diagnostics is a debugging feature which allows you to view Console Output and Screenshot to diagnose VM status. <br><br> You can easily view the output of your console log. <br><br> Azure also enables you to see a screenshot of the VM from the hypervisor.{{% /md %}}</dd>
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskinstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Disk<wbr>Instance<wbr>View<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#extensions_csharp" style="color: inherit; text-decoration: inherit;">Extensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineextensioninstanceviewresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Extension<wbr>Instance<wbr>View<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#maintenanceredeploystatus_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Redeploy<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maintenanceredeploystatusresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Maintenance<wbr>Redeploy<wbr>Status<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#vmagent_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Agent</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachineagentinstanceviewresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20190701.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Agent<wbr>Instance<wbr>View<wbr>Response<wbr>Args</a></span>
    </dt>
