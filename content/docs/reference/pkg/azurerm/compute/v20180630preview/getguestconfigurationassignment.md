...
title_tag: "Function GetGuestConfigurationAssignment | Module compute/v20180630preview | Package azurerm"
meta_desc: "Explore the GetGuestConfigurationAssignment function of the compute/v20180630preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getGuestConfigurationAssignment<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20180630preview/#GetGuestConfigurationAssignmentArgs">GetGuestConfigurationAssignmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/compute/v20180630preview/#GetGuestConfigurationAssignmentResult">GetGuestConfigurationAssignmentResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupGuestConfigurationAssignment<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#LookupGuestConfigurationAssignmentArgs">LookupGuestConfigurationAssignmentArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#LookupGuestConfigurationAssignmentResult">LookupGuestConfigurationAssignmentResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetGuestConfigurationAssignment </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute/v20180630preview.GetGuestConfigurationAssignmentResult.html">GetGuestConfigurationAssignmentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20180630Preview.GetGuestConfigurationAssignmentArgs.html">GetGuestConfigurationAssignmentArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestconfigurationassignmentpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20180630Preview.<wbr>Outputs.<wbr>Guest<wbr>Configuration<wbr>Assignment<wbr>Properties<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#ConfigurationParameterResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20180630Preview.Outputs.ConfigurationParameterResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#ConfigurationSettingResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20180630Preview.Outputs.ConfigurationSettingResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#GuestConfigurationAssignmentPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20180630Preview.Outputs.GuestConfigurationAssignmentPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#compliancestatus_csharp" style="color: inherit; text-decoration: inherit;">Compliance<wbr>Status</a>
    ...
    <dd>{{% md %}}A value indicating compliance status of the virtual machine for the assigned guest configuration.{{% /md %}}</dd>
...
<a href="#guestconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#guestconfigurationnavigationresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20180630Preview.<wbr>Inputs.<wbr>Guest<wbr>Configuration<wbr>Navigation<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/compute/v20180630preview?tab=doc#GuestConfigurationNavigationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Compute.V20180630Preview.Outputs.GuestConfigurationNavigationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#configurationparameter_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Parameter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationparameterresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20180630Preview.<wbr>Inputs.<wbr>Configuration<wbr>Parameter<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#configurationsetting_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Setting</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#configurationsettingresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Compute.<wbr>V20180630Preview.<wbr>Inputs.<wbr>Configuration<wbr>Setting<wbr>Response<wbr>Args</a></span>
    </dt>
