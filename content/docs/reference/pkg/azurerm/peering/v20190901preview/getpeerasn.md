...
---
title: "GetPeerAsn"
title_tag: "Function GetPeerAsn | Module peering/v20190901preview | Package azurerm"
meta_desc: "Explore the GetPeerAsn function of the peering/v20190901preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getPeerAsn<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/peering/v20190901preview/#GetPeerAsnArgs">GetPeerAsnArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/peering/v20190901preview/#GetPeerAsnResult">GetPeerAsnResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupPeerAsn<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/peering/v20190901preview?tab=doc#LookupPeerAsnArgs">LookupPeerAsnArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/peering/v20190901preview?tab=doc#LookupPeerAsnResult">LookupPeerAsnResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetPeerAsn </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Peering/v20190901preview.GetPeerAsnResult.html">GetPeerAsnResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Peering.V20190901Preview.GetPeerAsnArgs.html">GetPeerAsnArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#peercontactinfo_csharp" style="color: inherit; text-decoration: inherit;">Peer<wbr>Contact<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contactinforesponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Peering.<wbr>V20190901Preview.<wbr>Outputs.<wbr>Contact<wbr>Info<wbr>Response</a></span>
    </dt>
...
<a href="#peercontactinfo_go" style="color: inherit; text-decoration: inherit;">Peer<wbr>Contact<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contactinforesponse">Contact<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The contact information of the peer.{{% /md %}}</dd>
...
<a href="#peer_contact_info_python" style="color: inherit; text-decoration: inherit;">peer_<wbr>contact_<wbr>info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contactinforesponse">Dict[Contact<wbr>Info<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The contact information of the peer.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/peering/v20190901preview?tab=doc#ContactInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Peering.V20190901Preview.Outputs.ContactInfoResponse.html">output</a> API doc for this type.
{{% /choosable %}}
