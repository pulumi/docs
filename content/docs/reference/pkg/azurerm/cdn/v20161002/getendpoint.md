...
---
title: "GetEndpoint"
title_tag: "Function GetEndpoint | Module cdn/v20161002 | Package azurerm"
meta_desc: "Explore the GetEndpoint function of the cdn/v20161002 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEndpoint </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn/v20161002.GetEndpointResult.html">GetEndpointResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn.V20161002.GetEndpointArgs.html">GetEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#origins_csharp" style="color: inherit; text-decoration: inherit;">Origins</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deepcreatedoriginresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20161002.<wbr>Outputs.<wbr>Deep<wbr>Created<wbr>Origin<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#geofilters_csharp" style="color: inherit; text-decoration: inherit;">Geo<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geofilterresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20161002.<wbr>Outputs.<wbr>Geo<wbr>Filter<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of rules defining user geo access within a CDN endpoint. Each geo filter defines an access rule to a specified path or content, e.g. block APAC for path /pictures/{{% /md %}}</dd>
...
<a href="#optimizationtype_csharp" style="color: inherit; text-decoration: inherit;">Optimization<wbr>Type</a>
    ...
    <dd>{{% md %}}Customer can specify what scenario they want this CDN endpoint to optimize, e.g. Download, Media services. With this information we can apply scenario driven optimization.{{% /md %}}</dd>
...
<a href="#originhostheader_csharp" style="color: inherit; text-decoration: inherit;">Origin<wbr>Host<wbr>Header</a>
    ...
    <dd>{{% md %}}The host header CDN sends along with content requests to origin. The default value is the host name of the origin.{{% /md %}}</dd>
...
<a href="#originpath_csharp" style="color: inherit; text-decoration: inherit;">Origin<wbr>Path</a>
    ...
    <dd>{{% md %}}The path used when CDN sends request to origin.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20161002?tab=doc#DeepCreatedOriginResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn.V20161002.Outputs.DeepCreatedOriginResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>{{% md %}}The address of the origin. It can be a domain names, IPv4 address, or IPv6 address.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20161002?tab=doc#GeoFilterResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn.V20161002.Outputs.GeoFilterResponse.html">output</a> API doc for this type.
{{% /choosable %}}
