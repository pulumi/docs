...
---
title: "GetEndpoint"
title_tag: "Function GetEndpoint | Module cdn/v20171012 | Package azurerm"
meta_desc: "Explore the GetEndpoint function of the cdn/v20171012 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEndpoint </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn/v20171012.GetEndpointResult.html">GetEndpointResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn.V20171012.GetEndpointArgs.html">GetEndpointArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#origins_csharp" style="color: inherit; text-decoration: inherit;">Origins</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deepcreatedoriginresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20171012.<wbr>Outputs.<wbr>Deep<wbr>Created<wbr>Origin<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#deliverypolicy_csharp" style="color: inherit; text-decoration: inherit;">Delivery<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointpropertiesupdateparametersresponsedeliverypolicy">Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20171012.<wbr>Outputs.<wbr>Endpoint<wbr>Properties<wbr>Update<wbr>Parameters<wbr>Response<wbr>Delivery<wbr>Policy</a></span>
    </dt>
...
<a href="#geofilters_csharp" style="color: inherit; text-decoration: inherit;">Geo<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geofilterresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20171012.<wbr>Outputs.<wbr>Geo<wbr>Filter<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#CacheExpirationActionParametersResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#DeepCreatedOriginResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#DeliveryRuleCacheExpirationActionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#DeliveryRuleResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#DeliveryRuleUrlFileExtensionConditionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#DeliveryRuleUrlPathConditionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#EndpointPropertiesUpdateParametersResponseDeliveryPolicy">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#GeoFilterResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#UrlFileExtensionConditionParametersResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/cdn/v20171012?tab=doc#UrlPathConditionParametersResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
