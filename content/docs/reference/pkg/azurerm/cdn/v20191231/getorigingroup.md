...
title_tag: "Function GetOriginGroup | Module cdn/v20191231 | Package azurerm"
meta_desc: "Explore the GetOriginGroup function of the cdn/v20191231 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetOriginGroup </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn/v20191231.GetOriginGroupResult.html">GetOriginGroupResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Cdn.V20191231.GetOriginGroupArgs.html">GetOriginGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#origins_csharp" style="color: inherit; text-decoration: inherit;">Origins</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcereferenceresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20191231.<wbr>Outputs.<wbr>Resource<wbr>Reference<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#healthprobesettings_csharp" style="color: inherit; text-decoration: inherit;">Health<wbr>Probe<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#healthprobeparametersresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20191231.<wbr>Outputs.<wbr>Health<wbr>Probe<wbr>Parameters<wbr>Response</a></span>
    </dt>
...
<a href="#responsebasedoriginerrordetectionsettings_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Based<wbr>Origin<wbr>Error<wbr>Detection<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#responsebasedoriginerrordetectionparametersresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Cdn.<wbr>V20191231.<wbr>Outputs.<wbr>Response<wbr>Based<wbr>Origin<wbr>Error<wbr>Detection<wbr>Parameters<wbr>Response</a></span>
    </dt>
