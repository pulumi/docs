...
title_tag: "Function GetReferenceDataSet | Module timeseriesinsights/v20200515 | Package azurerm"
meta_desc: "Explore the GetReferenceDataSet function of the timeseriesinsights/v20200515 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getReferenceDataSet<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/timeseriesinsights/v20200515/#GetReferenceDataSetArgs">GetReferenceDataSetArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/timeseriesinsights/v20200515/#GetReferenceDataSetResult">GetReferenceDataSetResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetReferenceDataSet </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Timeseriesinsights/v20200515.GetReferenceDataSetResult.html">GetReferenceDataSetResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.TimeSeriesInsights.V20200515.GetReferenceDataSetArgs.html">GetReferenceDataSetArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#keyproperties_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#referencedatasetkeypropertyresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Time<wbr>Series<wbr>Insights.<wbr>V20200515.<wbr>Outputs.<wbr>Reference<wbr>Data<wbr>Set<wbr>Key<wbr>Property<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/timeseriesinsights/v20200515?tab=doc#ReferenceDataSetKeyPropertyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
