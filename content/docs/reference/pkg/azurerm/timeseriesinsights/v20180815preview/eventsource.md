...
---
title: "EventSource"
title_tag: "Resource EventSource | Module timeseriesinsights/v20180815preview | Package azurerm"
meta_desc: "Explore the EventSource resource of the timeseriesinsights/v20180815preview module, including examples, input properties, output properties, lookup functions, and supporting types. An environment receives data from one or more event sources. Each event source has associated connection info that allows the Time Series Insights ingress pipeline to connect to and pull data from the event source"
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/timeseriesinsights/v20180815preview/#EventSourceArgs">EventSourceArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/timeseriesinsights/v20180815preview?tab=doc#EventSourceArgs">EventSourceArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.TimeSeriesInsights.V20180815Preview.EventSourceArgs.html">EventSourceArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#localtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Timestamp</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localtimestamp">Pulumi.<wbr>Azure<wbr>RM.<wbr>Time<wbr>Series<wbr>Insights.<wbr>V20180815Preview.<wbr>Inputs.<wbr>Local<wbr>Timestamp<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/timeseriesinsights/v20180815preview?tab=doc#LocalTimestampArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.TimeSeriesInsights.V20180815Preview.Inputs.LocalTimestampArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#timezoneoffset_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Zone<wbr>Offset</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localtimestamptimezoneoffset">Pulumi.<wbr>Azure<wbr>RM.<wbr>Time<wbr>Series<wbr>Insights.<wbr>V20180815Preview.<wbr>Inputs.<wbr>Local<wbr>Timestamp<wbr>Time<wbr>Zone<wbr>Offset<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/timeseriesinsights/v20180815preview?tab=doc#LocalTimestampTimeZoneOffsetArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.TimeSeriesInsights.V20180815Preview.Inputs.LocalTimestampTimeZoneOffsetArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
