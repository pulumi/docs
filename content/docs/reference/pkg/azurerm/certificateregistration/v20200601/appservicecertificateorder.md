...
title_tag: "Resource AppServiceCertificateOrder | Module certificateregistration/v20200601 | Package azurerm"
meta_desc: "Explore the AppServiceCertificateOrder resource of the certificateregistration/v20200601 module, including examples, input properties, output properties, lookup functions, and supporting types. SSL certificate purchase order."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/certificateregistration/v20200601/#AppServiceCertificateOrderArgs">AppServiceCertificateOrderArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/certificateregistration/v20200601?tab=doc#AppServiceCertificateOrderArgs">AppServiceCertificateOrderArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.CertificateRegistration.V20200601.AppServiceCertificateOrderArgs.html">AppServiceCertificateOrderArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#certificates_csharp" style="color: inherit; text-decoration: inherit;">Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Certificate<wbr>Registration.<wbr>V20200601.<wbr>Inputs.<wbr>App<wbr>Service<wbr>Certificate<wbr>Args&gt;</span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/certificateregistration/v20200601?tab=doc#AppServiceCertificateArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.CertificateRegistration.V20200601.Inputs.AppServiceCertificateArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/certificateregistration/v20200601?tab=doc#AppServiceCertificateResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/certificateregistration/v20200601?tab=doc#CertificateDetailsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
