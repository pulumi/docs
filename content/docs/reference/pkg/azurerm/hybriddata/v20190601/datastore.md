...
---
title: "DataStore"
title_tag: "Resource DataStore | Module hybriddata/v20190601 | Package azurerm"
meta_desc: "Explore the DataStore resource of the hybriddata/v20190601 module, including examples, input properties, output properties, lookup functions, and supporting types. Data store."
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var dataStore = new AzureRM.HybridData.V20190601.DataStore("dataStore", new AzureRM.HybridData.V20190601.DataStoreArgs
        {
            CustomerSecrets = 
            {
                new AzureRM.HybridData.V20190601.Inputs.CustomerSecretArgs
                {
                    Algorithm = "RSA1_5",
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/hybriddata/v20190601/#DataStoreArgs">DataStoreArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hybriddata/v20190601?tab=doc#DataStoreArgs">DataStoreArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.HybridData.V20190601.DataStoreArgs.html">DataStoreArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#customersecrets_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Secrets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customersecret">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Hybrid<wbr>Data.<wbr>V20190601.<wbr>Inputs.<wbr>Customer<wbr>Secret<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hybriddata/v20190601?tab=doc#CustomerSecretArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.HybridData.V20190601.Inputs.CustomerSecretArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/hybriddata/v20190601?tab=doc#CustomerSecretResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.HybridData.V20190601.Outputs.CustomerSecretResponse.html">output</a> API doc for this type.
{{% /choosable %}}
