...
title_tag: "Resource NamespaceAuthorizationRule | Module eventhub/v20170401 | Package azurerm"
meta_desc: "Explore the NamespaceAuthorizationRule resource of the eventhub/v20170401 module, including examples, input properties, output properties, lookup functions, and supporting types. Single item in a List or Get AuthorizationRule operation"
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var namespaceAuthorizationRule = new AzureRM.EventHub.V20170401.NamespaceAuthorizationRule("namespaceAuthorizationRule", new AzureRM.EventHub.V20170401.NamespaceAuthorizationRuleArgs
        {
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/eventhub/v20170401/#NamespaceAuthorizationRuleArgs">NamespaceAuthorizationRuleArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/eventhub/v20170401?tab=doc#NamespaceAuthorizationRuleArgs">NamespaceAuthorizationRuleArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.EventHub.V20170401.NamespaceAuthorizationRuleArgs.html">NamespaceAuthorizationRuleArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
