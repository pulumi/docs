...
---
title: "GetEventHub"
title_tag: "Function GetEventHub | Module eventhub/v20150801 | Package azurerm"
meta_desc: "Explore the GetEventHub function of the eventhub/v20150801 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEventHub </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Eventhub/v20150801.GetEventHubResult.html">GetEventHubResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.EventHub.V20150801.GetEventHubArgs.html">GetEventHubArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#messageretentionindays_csharp" style="color: inherit; text-decoration: inherit;">Message<wbr>Retention<wbr>In<wbr>Days</a>
    ...
    <dd>{{% md %}}Number of days to retain the events for this Event Hub.{{% /md %}}</dd>
...
<a href="#partitioncount_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of partitions created for the Event Hub.{{% /md %}}</dd>
