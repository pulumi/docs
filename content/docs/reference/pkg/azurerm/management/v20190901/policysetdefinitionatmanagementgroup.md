...
title_tag: "Resource PolicySetDefinitionAtManagementGroup | Module management/v20190901 | Package azurerm"
meta_desc: "Explore the PolicySetDefinitionAtManagementGroup resource of the management/v20190901 module, including examples, input properties, output properties, lookup functions, and supporting types. The policy set definition."
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/management/v20190901/#PolicySetDefinitionAtManagementGroupArgs">PolicySetDefinitionAtManagementGroupArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#PolicySetDefinitionAtManagementGroupArgs">PolicySetDefinitionAtManagementGroupArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Management.V20190901.PolicySetDefinitionAtManagementGroupArgs.html">PolicySetDefinitionAtManagementGroupArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#policydefinitions_csharp" style="color: inherit; text-decoration: inherit;">Policy<wbr>Definitions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policydefinitionreference">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Management.<wbr>V20190901.<wbr>Inputs.<wbr>Policy<wbr>Definition<wbr>Reference<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#policydefinitiongroups_csharp" style="color: inherit; text-decoration: inherit;">Policy<wbr>Definition<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policydefinitiongroup">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Management.<wbr>V20190901.<wbr>Inputs.<wbr>Policy<wbr>Definition<wbr>Group<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#ParameterValuesValueArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Management.V20190901.Inputs.ParameterValuesValueArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#ParameterValuesValueResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#PolicyDefinitionGroupArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Management.V20190901.Inputs.PolicyDefinitionGroupArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#PolicyDefinitionGroupResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#PolicyDefinitionReferenceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Management.V20190901.Inputs.PolicyDefinitionReferenceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, Pulumi.<wbr>Azure<wbr>RM.<wbr>Management.<wbr>V20190901.<wbr>Inputs.<wbr>Parameter<wbr>Values<wbr>Value<wbr>Args&gt;</span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/management/v20190901?tab=doc#PolicyDefinitionReferenceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
