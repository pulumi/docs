...
class MyStack : Stack
{
    public MyStack()
    {
        var policyAssignment = new AzureRM.Authorization.Latest.PolicyAssignment("policyAssignment", new AzureRM.Authorization.Latest.PolicyAssignmentArgs
        {
...
class MyStack : Stack
{
    public MyStack()
    {
        var policyAssignment = new AzureRM.Authorization.Latest.PolicyAssignment("policyAssignment", new AzureRM.Authorization.Latest.PolicyAssignmentArgs
        {
            ...
            Identity = new AzureRM.Authorization.Latest.Inputs.IdentityArgs
            {
                Type = "SystemAssigned",
            },
            Location = "eastus",
