...
title_tag: "Function GetStorageAccount | Module storage/v20150501preview | Package azurerm"
meta_desc: "Explore the GetStorageAccount function of the storage/v20150501preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupStorageAccount<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20150501preview?tab=doc#LookupStorageAccountArgs">LookupStorageAccountArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20150501preview?tab=doc#LookupStorageAccountResult">LookupStorageAccountResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetStorageAccount </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage/v20150501preview.GetStorageAccountResult.html">GetStorageAccountResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20150501Preview.GetStorageAccountArgs.html">GetStorageAccountArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#accounttype_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Type</a>
    ...
    <dd>{{% md %}}Gets the type of the storage account.{{% /md %}}</dd>
...
<a href="#customdomain_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Domain</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdomainresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20150501Preview.<wbr>Outputs.<wbr>Custom<wbr>Domain<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Gets the user assigned custom domain assigned to this storage account.{{% /md %}}</dd>
...
<a href="#lastgeofailovertime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Geo<wbr>Failover<wbr>Time</a>
    ...
    <dd>{{% md %}}Gets the timestamp of the most recent instance of a failover to the secondary location. Only the most recent timestamp is retained. This element is not returned if there has never been a failover instance. Only available if the accountType is StandardGRS or StandardRAGRS.{{% /md %}}</dd>
...
<a href="#primaryendpoints_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20150501Preview.<wbr>Outputs.<wbr>Endpoints<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Gets the URLs that are used to perform a retrieval of a public blob, queue or table object.Note that StandardZRS and PremiumLRS accounts only return the blob endpoint.{{% /md %}}</dd>
...
<a href="#primarylocation_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Location</a>
    ...
    <dd>{{% md %}}Gets the location of the primary for the storage account.{{% /md %}}</dd>
...
<a href="#secondaryendpoints_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Endpoints</a>
    ...
    <dd>{{% md %}}Gets the URLs that are used to perform a retrieval of a public blob, queue or table object from the secondary location of the storage account. Only available if the accountType is StandardRAGRS.{{% /md %}}</dd>
...
<a href="#secondarylocation_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Location</a>
    ...
    <dd>{{% md %}}Gets the location of the geo replicated secondary for the storage account. Only available if the accountType is StandardGRS or StandardRAGRS.{{% /md %}}</dd>
...
<a href="#statusofsecondary_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Of<wbr>Secondary</a>
    ...
    <dd>{{% md %}}Gets the status indicating whether the secondary location of the storage account is available or unavailable. Only available if the accountType is StandardGRS or StandardRAGRS.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20150501preview?tab=doc#CustomDomainResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20150501Preview.Outputs.CustomDomainResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets or sets the custom domain name. Name is the CNAME source.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20150501preview?tab=doc#EndpointsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20150501Preview.Outputs.EndpointsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
