...
title_tag: "Resource StorageAccount | Module storage/v20190401 | Package azurerm"
meta_desc: "Explore the StorageAccount resource of the storage/v20190401 module, including examples, input properties, output properties, lookup functions, and supporting types. The storage account."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/storage/v20190401/#StorageAccount">StorageAccount</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/storage/v20190401/#StorageAccountArgs">StorageAccountArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_azurerm/storage/v20190401/#pulumi_azurerm.storage/v20190401.StorageAccount">StorageAccount</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">access_tier</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">allow_blob_public_access</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">azure_files_identity_based_authentication</span><span class="p">:</span> <span class="nx">Optional[Dict[AzureFilesIdentityBasedAuthentication]]</span> = None<span class="p">, </span><span class="nx">custom_domain</span><span class="p">:</span> <span class="nx">Optional[Dict[CustomDomain]]</span> = None<span class="p">, </span><span class="nx">enable_https_traffic_only</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">encryption</span><span class="p">:</span> <span class="nx">Optional[Dict[Encryption]]</span> = None<span class="p">, </span><span class="nx">identity</span><span class="p">:</span> <span class="nx">Optional[Dict[Identity]]</span> = None<span class="p">, </span><span class="nx">is_hns_enabled</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">, </span><span class="nx">kind</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">large_file_shares_state</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">minimum_tls_version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">network_rule_set</span><span class="p">:</span> <span class="nx">Optional[Dict[NetworkRuleSet]]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">sku</span><span class="p">:</span> <span class="nx">Optional[Dict[Sku]]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Dict[str, str]]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#StorageAccount">NewStorageAccount</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#StorageAccountArgs">StorageAccountArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#StorageAccount">StorageAccount</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.StorageAccount.html">StorageAccount</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.StorageAccountArgs.html">StorageAccountArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/storage/v20190401/#StorageAccountArgs">StorageAccountArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#StorageAccountArgs">StorageAccountArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.StorageAccountArgs.html">StorageAccountArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
...
<a href="#azurefilesidentitybasedauthentication_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Files<wbr>Identity<wbr>Based<wbr>Authentication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#azurefilesidentitybasedauthentication">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Azure<wbr>Files<wbr>Identity<wbr>Based<wbr>Authentication<wbr>Args</a></span>
    </dt>
...
<a href="#customdomain_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Domain</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customdomain">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Custom<wbr>Domain<wbr>Args</a></span>
    </dt>
...
<a href="#encryption_csharp" style="color: inherit; text-decoration: inherit;">Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryption">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Encryption<wbr>Args</a></span>
    </dt>
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#identity">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#networkruleset_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Rule<wbr>Set</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkruleset">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Network<wbr>Rule<wbr>Set<wbr>Args</a></span>
    </dt>
...
<a href="#georeplicationstats_csharp" style="color: inherit; text-decoration: inherit;">Geo<wbr>Replication<wbr>Stats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#georeplicationstatsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Outputs.<wbr>Geo<wbr>Replication<wbr>Stats<wbr>Response</a></span>
    </dt>
...
<a href="#primaryendpoints_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Endpoints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointsresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Outputs.<wbr>Endpoints<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#ActiveDirectoryPropertiesArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.ActiveDirectoryPropertiesArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#ActiveDirectoryPropertiesResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.ActiveDirectoryPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#AzureFilesIdentityBasedAuthenticationArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.AzureFilesIdentityBasedAuthenticationArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#activedirectoryproperties_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Directory<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activedirectoryproperties">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Active<wbr>Directory<wbr>Properties<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#AzureFilesIdentityBasedAuthenticationResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.AzureFilesIdentityBasedAuthenticationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#activedirectoryproperties_csharp" style="color: inherit; text-decoration: inherit;">Active<wbr>Directory<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activedirectorypropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Active<wbr>Directory<wbr>Properties<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Required if choose AD.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#CustomDomainArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.CustomDomainArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#CustomDomainResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.CustomDomainResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.EncryptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#keyvaultproperties_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Vault<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultproperties">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<a href="#services_csharp" style="color: inherit; text-decoration: inherit;">Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionservices">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Encryption<wbr>Services<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.EncryptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#keyvaultproperties_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Vault<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#keyvaultpropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Key<wbr>Vault<wbr>Properties<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Properties provided by key vault.{{% /md %}}</dd>
...
<a href="#services_csharp" style="color: inherit; text-decoration: inherit;">Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionservicesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Encryption<wbr>Services<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}List of services which support encryption.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionServiceArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.EncryptionServiceArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionServiceResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.EncryptionServiceResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionServicesArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.EncryptionServicesArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#blob_csharp" style="color: inherit; text-decoration: inherit;">Blob</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionservice">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Encryption<wbr>Service<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EncryptionServicesResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.EncryptionServicesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#queue_csharp" style="color: inherit; text-decoration: inherit;">Queue</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryptionserviceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Encryption<wbr>Service<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#EndpointsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.EndpointsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#GeoReplicationStatsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.GeoReplicationStatsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#IPRuleArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.IPRuleArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#IPRuleResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.IPRuleResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#IdentityArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.IdentityArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#IdentityResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.IdentityResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#KeyVaultPropertiesArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.KeyVaultPropertiesArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#KeyVaultPropertiesResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.KeyVaultPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#NetworkRuleSetArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.NetworkRuleSetArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#iprules_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#iprule">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>IPRule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#virtualnetworkrules_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkrule">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Virtual<wbr>Network<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#NetworkRuleSetResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.NetworkRuleSetResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#iprules_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>IPRule<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Sets the IP ACL rules{{% /md %}}</dd>
...
<a href="#virtualnetworkrules_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkruleresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Virtual<wbr>Network<wbr>Rule<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Sets the virtual network rules{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#RestrictionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.RestrictionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#RestrictionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.RestrictionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#SKUCapabilityResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.SKUCapabilityResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#SkuArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.SkuArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#restrictions_csharp" style="color: inherit; text-decoration: inherit;">Restrictions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#restriction">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Restriction<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#SkuResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.SkuResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#capabilities_csharp" style="color: inherit; text-decoration: inherit;">Capabilities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#skucapabilityresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>SKUCapability<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#restrictions_csharp" style="color: inherit; text-decoration: inherit;">Restrictions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#restrictionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Storage.<wbr>V20190401.<wbr>Inputs.<wbr>Restriction<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}The restrictions because of which SKU cannot be used. This is empty if there are no restrictions.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#VirtualNetworkRuleArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Inputs.VirtualNetworkRuleArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/storage/v20190401?tab=doc#VirtualNetworkRuleResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Storage.V20190401.Outputs.VirtualNetworkRuleResponse.html">output</a> API doc for this type.
{{% /choosable %}}
