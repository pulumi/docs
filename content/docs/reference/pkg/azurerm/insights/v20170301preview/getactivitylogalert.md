...
title_tag: "Function GetActivityLogAlert | Module insights/v20170301preview | Package azurerm"
meta_desc: "Explore the GetActivityLogAlert function of the insights/v20170301preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getActivityLogAlert<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/insights/v20170301preview/#GetActivityLogAlertArgs">GetActivityLogAlertArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/insights/v20170301preview/#GetActivityLogAlertResult">GetActivityLogAlertResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetActivityLogAlert </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights/v20170301preview.GetActivityLogAlertResult.html">GetActivityLogAlertResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights.V20170301Preview.GetActivityLogAlertArgs.html">GetActivityLogAlertArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#actions_csharp" style="color: inherit; text-decoration: inherit;">Actions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activitylogalertactionlistresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Insights.<wbr>V20170301Preview.<wbr>Outputs.<wbr>Activity<wbr>Log<wbr>Alert<wbr>Action<wbr>List<wbr>Response</a></span>
    </dt>
...
<a href="#condition_csharp" style="color: inherit; text-decoration: inherit;">Condition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activitylogalertallofconditionresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Insights.<wbr>V20170301Preview.<wbr>Outputs.<wbr>Activity<wbr>Log<wbr>Alert<wbr>All<wbr>Of<wbr>Condition<wbr>Response</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20170301preview?tab=doc#ActivityLogAlertActionGroupResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights.V20170301Preview.Outputs.ActivityLogAlertActionGroupResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20170301preview?tab=doc#ActivityLogAlertActionListResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights.V20170301Preview.Outputs.ActivityLogAlertActionListResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#actiongroups_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activitylogalertactiongroupresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Insights.<wbr>V20170301Preview.<wbr>Inputs.<wbr>Activity<wbr>Log<wbr>Alert<wbr>Action<wbr>Group<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20170301preview?tab=doc#ActivityLogAlertAllOfConditionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights.V20170301Preview.Outputs.ActivityLogAlertAllOfConditionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#allof_csharp" style="color: inherit; text-decoration: inherit;">All<wbr>Of</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#activitylogalertleafconditionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Insights.<wbr>V20170301Preview.<wbr>Inputs.<wbr>Activity<wbr>Log<wbr>Alert<wbr>Leaf<wbr>Condition<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/insights/v20170301preview?tab=doc#ActivityLogAlertLeafConditionResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Insights.V20170301Preview.Outputs.ActivityLogAlertLeafConditionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
