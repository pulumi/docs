...
title_tag: "Function GetDiagnosticSetting | Module aadiam/latest | Package Azure RM"
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/aadiam/latest?tab=doc#LogSettingsResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Aadiam.Latest.Outputs.LogSettingsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#retentionpolicy_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#retentionpolicyresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Aadiam.<wbr>Latest.<wbr>Inputs.<wbr>Retention<wbr>Policy<wbr>Response<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/aadiam/latest?tab=doc#RetentionPolicyResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Aadiam.Latest.Outputs.RetentionPolicyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
