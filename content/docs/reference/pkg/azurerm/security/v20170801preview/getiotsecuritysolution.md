...
title_tag: "Function GetIotSecuritySolution | Module security/v20170801preview | Package azurerm"
meta_desc: "Explore the GetIotSecuritySolution function of the security/v20170801preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getIotSecuritySolution<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/security/v20170801preview/#GetIotSecuritySolutionArgs">GetIotSecuritySolutionArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/security/v20170801preview/#GetIotSecuritySolutionResult">GetIotSecuritySolutionResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIotSecuritySolution<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20170801preview?tab=doc#LookupIotSecuritySolutionArgs">LookupIotSecuritySolutionArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20170801preview?tab=doc#LookupIotSecuritySolutionResult">LookupIotSecuritySolutionResult</a></span>, error)</span></code></pre></div>
...
<a href="#solutionname_csharp" style="color: inherit; text-decoration: inherit;">Solution<wbr>Name</a>
    ...
    <dd>{{% md %}}The solution manager name{{% /md %}}</dd>
...
<a href="#export_csharp" style="color: inherit; text-decoration: inherit;">Export</a>
    ...
    <dd>{{% md %}}List of additional export to workspace data options{{% /md %}}</dd>
...
<a href="#recommendationsconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Recommendations<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#recommendationconfigurationpropertiesresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20170801Preview.<wbr>Outputs.<wbr>Recommendation<wbr>Configuration<wbr>Properties<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of recommendation configuration{{% /md %}}</dd>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Security solution status{{% /md %}}</dd>
...
<a href="#userdefinedresources_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Defined<wbr>Resources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userdefinedresourcespropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20170801Preview.<wbr>Outputs.<wbr>User<wbr>Defined<wbr>Resources<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties of the solution's user defined resources.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20170801preview?tab=doc#RecommendationConfigurationPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20170801Preview.Outputs.RecommendationConfigurationPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#recommendationtype_csharp" style="color: inherit; text-decoration: inherit;">Recommendation<wbr>Type</a>
    ...
    <dd>{{% md %}}The recommendation type.{{% /md %}}</dd>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Recommendation status. The recommendation is not generated when the status is disabled{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20170801preview?tab=doc#UserDefinedResourcesPropertiesResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20170801Preview.Outputs.UserDefinedResourcesPropertiesResponse.html">output</a> API doc for this type.
{{% /choosable %}}
