...
title_tag: "Function GetAdaptiveApplicationControl | Module security/v20150601preview | Package azurerm"
meta_desc: "Explore the GetAdaptiveApplicationControl function of the security/v20150601preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getAdaptiveApplicationControl<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/security/v20150601preview/#GetAdaptiveApplicationControlArgs">GetAdaptiveApplicationControlArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/security/v20150601preview/#GetAdaptiveApplicationControlResult">GetAdaptiveApplicationControlResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupAdaptiveApplicationControl<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#LookupAdaptiveApplicationControlArgs">LookupAdaptiveApplicationControlArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#LookupAdaptiveApplicationControlResult">LookupAdaptiveApplicationControlResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAdaptiveApplicationControl </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security/v20150601preview.GetAdaptiveApplicationControlResult.html">GetAdaptiveApplicationControlResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.GetAdaptiveApplicationControlArgs.html">GetAdaptiveApplicationControlArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#groupname_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of an application control VM/server group{{% /md %}}</dd>
...
<a href="#configurationstatus_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Status</a>
    ...
    <dd>{{% md %}}The configuration status of the VM/server group or machine or rule on the machine{{% /md %}}</dd>
...
<a href="#enforcementmode_csharp" style="color: inherit; text-decoration: inherit;">Enforcement<wbr>Mode</a>
    ...
    <dd>{{% md %}}The application control policy enforcement/protection mode of the VM/server group{{% /md %}}</dd>
...
<a href="#issues_csharp" style="color: inherit; text-decoration: inherit;">Issues</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appwhitelistingissuesummaryresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Outputs.<wbr>App<wbr>Whitelisting<wbr>Issue<wbr>Summary<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#pathrecommendations_csharp" style="color: inherit; text-decoration: inherit;">Path<wbr>Recommendations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pathrecommendationresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Outputs.<wbr>Path<wbr>Recommendation<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#protectionmode_csharp" style="color: inherit; text-decoration: inherit;">Protection<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#protectionmoderesponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Outputs.<wbr>Protection<wbr>Mode<wbr>Response</a></span>
    </dt>
...
<a href="#recommendationstatus_csharp" style="color: inherit; text-decoration: inherit;">Recommendation<wbr>Status</a>
    ...
    <dd>{{% md %}}The recommendation status of the VM/server group or VM/server{{% /md %}}</dd>
...
<a href="#sourcesystem_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>System</a>
    ...
    <dd>{{% md %}}The source type of the VM/server group{{% /md %}}</dd>
...
<a href="#vmrecommendations_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Recommendations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vmrecommendationresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Outputs.<wbr>Vm<wbr>Recommendation<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#issues_go" style="color: inherit; text-decoration: inherit;">Issues</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appwhitelistingissuesummaryresponse">[]App<wbr>Whitelisting<wbr>Issue<wbr>Summary<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#issues_python" style="color: inherit; text-decoration: inherit;">issues</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appwhitelistingissuesummaryresponse">List[App<wbr>Whitelisting<wbr>Issue<wbr>Summary<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<h4 id="appwhitelistingissuesummaryresponse">App<wbr>Whitelisting<wbr>Issue<wbr>Summary<wbr>Response</h4>
{{% choosable language nodejs %}}
> See the   <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/output/#AppWhitelistingIssueSummaryResponse">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#AppWhitelistingIssueSummaryResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.AppWhitelistingIssueSummaryResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#issue_csharp" style="color: inherit; text-decoration: inherit;">Issue</a>
    ...
    <dd>{{% md %}}An alert that VMs/servers within a group can have{{% /md %}}</dd>
...
<a href="#numberofvms_csharp" style="color: inherit; text-decoration: inherit;">Number<wbr>Of<wbr>Vms</a>
    ...
    <dd>{{% md %}}The number of machines in the VM/server group that have this alert{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#PathRecommendationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.PathRecommendationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd>{{% md %}}The recommendation action of the VM/server or rule{{% /md %}}</dd>
...
<a href="#common_csharp" style="color: inherit; text-decoration: inherit;">Common</a>
    ...
    <dd>{{% md %}}Whether the path is commonly run on the machine{{% /md %}}</dd>
...
<a href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd>{{% md %}}The full path to whitelist{{% /md %}}</dd>
...
<a href="#publisherinfo_csharp" style="color: inherit; text-decoration: inherit;">Publisher<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#publisherinforesponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Inputs.<wbr>Publisher<wbr>Info<wbr>Response<wbr>Args</a></span>
    </dt>
...
<a href="#usernames_csharp" style="color: inherit; text-decoration: inherit;">Usernames</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userrecommendationresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Security.<wbr>V20150601Preview.<wbr>Inputs.<wbr>User<wbr>Recommendation<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#ProtectionModeResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.ProtectionModeResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#PublisherInfoResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.PublisherInfoResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#UserRecommendationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.UserRecommendationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/security/v20150601preview?tab=doc#VmRecommendationResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Security.V20150601Preview.Outputs.VmRecommendationResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#enforcementsupport_csharp" style="color: inherit; text-decoration: inherit;">Enforcement<wbr>Support</a>
    ...
    <dd>{{% md %}}The VM/server supportability of Enforce feature{{% /md %}}</dd>
...
<a href="#resourceid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The full azure resource id of the machine{{% /md %}}</dd>
