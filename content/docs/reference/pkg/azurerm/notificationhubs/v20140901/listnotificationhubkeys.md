...
title_tag: "Function ListNotificationHubKeys | Module notificationhubs/v20140901 | Package azurerm"
meta_desc: "Explore the ListNotificationHubKeys function of the notificationhubs/v20140901 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>listNotificationHubKeys<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/notificationhubs/v20140901/#ListNotificationHubKeysArgs">ListNotificationHubKeysArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/notificationhubs/v20140901/#ListNotificationHubKeysResult">ListNotificationHubKeysResult</a></span>></span></code></pre></div>
{{% /choosable %}}
...
<a href="#primaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Gets or sets the primaryConnectionString of the created Namespace AuthorizationRule.{{% /md %}}</dd>
...
<a href="#secondaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Gets or sets the secondaryConnectionString of the created Namespace AuthorizationRule{{% /md %}}</dd>
