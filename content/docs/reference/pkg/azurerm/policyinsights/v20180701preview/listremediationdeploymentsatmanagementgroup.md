...
title_tag: "Function ListRemediationDeploymentsAtManagementGroup | Module policyinsights/v20180701preview | Package azurerm"
meta_desc: "Explore the ListRemediationDeploymentsAtManagementGroup function of the policyinsights/v20180701preview module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListRemediationDeploymentsAtManagementGroup </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Policyinsights/v20180701preview.ListRemediationDeploymentsAtManagementGroupResult.html">ListRemediationDeploymentsAtManagementGroupResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.PolicyInsights.V20180701Preview.ListRemediationDeploymentsAtManagementGroupArgs.html">ListRemediationDeploymentsAtManagementGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
