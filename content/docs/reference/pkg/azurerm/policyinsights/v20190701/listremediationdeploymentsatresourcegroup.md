...
title_tag: "Function ListRemediationDeploymentsAtResourceGroup | Module policyinsights/v20190701 | Package azurerm"
meta_desc: "Explore the ListRemediationDeploymentsAtResourceGroup function of the policyinsights/v20190701 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListRemediationDeploymentsAtResourceGroup </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Policyinsights/v20190701.ListRemediationDeploymentsAtResourceGroupResult.html">ListRemediationDeploymentsAtResourceGroupResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.PolicyInsights.V20190701.ListRemediationDeploymentsAtResourceGroupArgs.html">ListRemediationDeploymentsAtResourceGroupArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
