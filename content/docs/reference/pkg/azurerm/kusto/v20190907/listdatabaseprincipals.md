...
title_tag: "Function ListDatabasePrincipals | Module kusto/v20190907 | Package azurerm"
meta_desc: "Explore the ListDatabasePrincipals function of the kusto/v20190907 module, including examples, input properties, output properties, and supporting types. "
---
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListDatabasePrincipals </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kusto/v20190907.ListDatabasePrincipalsResult.html">ListDatabasePrincipalsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kusto.V20190907.ListDatabasePrincipalsArgs.html">ListDatabasePrincipalsArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#databaseprincipalresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Kusto.<wbr>V20190907.<wbr>Outputs.<wbr>Database<wbr>Principal<wbr>Response&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/kusto/v20190907?tab=doc#DatabasePrincipalResponse">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Kusto.V20190907.Outputs.DatabasePrincipalResponse.html">output</a> API doc for this type.
{{% /choosable %}}
