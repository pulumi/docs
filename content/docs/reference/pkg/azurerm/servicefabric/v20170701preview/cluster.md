...
---
title: "Cluster"
title_tag: "Resource Cluster | Module servicefabric/v20170701preview | Package azurerm"
meta_desc: "Explore the Cluster resource of the servicefabric/v20170701preview module, including examples, input properties, output properties, lookup functions, and supporting types. The cluster resource"
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/servicefabric/v20170701preview/#Cluster">Cluster</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/servicefabric/v20170701preview/#ClusterArgs">ClusterArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_azurerm/servicefabric/v20170701preview/#pulumi_azurerm.servicefabric/v20170701preview.Cluster">Cluster</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">add_on_features</span><span class="p">:</span> <span class="nx">Optional[List[str]]</span> = None<span class="p">, </span><span class="nx">available_cluster_versions</span><span class="p">:</span> <span class="nx">Optional[List[ClusterVersionDetails]]</span> = None<span class="p">, </span><span class="nx">azure_active_directory</span><span class="p">:</span> <span class="nx">Optional[Dict[AzureActiveDirectory]]</span> = None<span class="p">, </span><span class="nx">certificate</span><span class="p">:</span> <span class="nx">Optional[Dict[CertificateDescription]]</span> = None<span class="p">, </span><span class="nx">client_certificate_common_names</span><span class="p">:</span> <span class="nx">Optional[List[ClientCertificateCommonName]]</span> = None<span class="p">, </span><span class="nx">client_certificate_thumbprints</span><span class="p">:</span> <span class="nx">Optional[List[ClientCertificateThumbprint]]</span> = None<span class="p">, </span><span class="nx">cluster_code_version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">cluster_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">cluster_state</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">diagnostics_storage_account_config</span><span class="p">:</span> <span class="nx">Optional[Dict[DiagnosticsStorageAccountConfig]]</span> = None<span class="p">, </span><span class="nx">fabric_settings</span><span class="p">:</span> <span class="nx">Optional[List[SettingsSectionDescription]]</span> = None<span class="p">, </span><span class="nx">location</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">management_endpoint</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">node_types</span><span class="p">:</span> <span class="nx">Optional[List[NodeTypeDescription]]</span> = None<span class="p">, </span><span class="nx">reliability_level</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">reverse_proxy_certificate</span><span class="p">:</span> <span class="nx">Optional[Dict[CertificateDescription]]</span> = None<span class="p">, </span><span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Dict[str, str]]</span> = None<span class="p">, </span><span class="nx">upgrade_description</span><span class="p">:</span> <span class="nx">Optional[Dict[ClusterUpgradePolicy]]</span> = None<span class="p">, </span><span class="nx">upgrade_mode</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">vm_image</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#Cluster">NewCluster</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx"><a href="https://golang.org/pkg/builtin/#string">string</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterArgs">ClusterArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#Cluster">Cluster</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Cluster.html">Cluster</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.ClusterArgs.html">ClusterArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/servicefabric/v20170701preview/#ClusterArgs">ClusterArgs</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterArgs">ClusterArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.ClusterArgs.html">ClusterArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<a href="#nodetypes_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodetypedescription">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Node<wbr>Type<wbr>Description<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#availableclusterversions_csharp" style="color: inherit; text-decoration: inherit;">Available<wbr>Cluster<wbr>Versions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterversiondetails">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Version<wbr>Details<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#azureactivedirectory_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Active<wbr>Directory</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#azureactivedirectory">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Azure<wbr>Active<wbr>Directory<wbr>Args</a></span>
    </dt>
...
<a href="#certificate_csharp" style="color: inherit; text-decoration: inherit;">Certificate</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#certificatedescription">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Certificate<wbr>Description<wbr>Args</a></span>
    </dt>
...
<a href="#clientcertificatecommonnames_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Certificate<wbr>Common<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clientcertificatecommonname">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Client<wbr>Certificate<wbr>Common<wbr>Name<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#clientcertificatethumbprints_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Certificate<wbr>Thumbprints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clientcertificatethumbprint">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Client<wbr>Certificate<wbr>Thumbprint<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#diagnosticsstorageaccountconfig_csharp" style="color: inherit; text-decoration: inherit;">Diagnostics<wbr>Storage<wbr>Account<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diagnosticsstorageaccountconfig">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Diagnostics<wbr>Storage<wbr>Account<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#fabricsettings_csharp" style="color: inherit; text-decoration: inherit;">Fabric<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#settingssectiondescription">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Settings<wbr>Section<wbr>Description<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#upgradedescription_csharp" style="color: inherit; text-decoration: inherit;">Upgrade<wbr>Description</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterupgradepolicy">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Upgrade<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#availableclusterversions_go" style="color: inherit; text-decoration: inherit;">Available<wbr>Cluster<wbr>Versions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterversiondetails">[]Cluster<wbr>Version<wbr>Details</a></span>
    </dt>
    <dd>{{% md %}}The Service Fabric runtime versions available for this cluster.{{% /md %}}</dd>
...
<a href="#available_cluster_versions_python" style="color: inherit; text-decoration: inherit;">available_<wbr>cluster_<wbr>versions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterversiondetails">List[Cluster<wbr>Version<wbr>Details]</a></span>
    </dt>
    <dd>{{% md %}}The Service Fabric runtime versions available for this cluster.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#AzureActiveDirectoryArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.AzureActiveDirectoryArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#AzureActiveDirectoryResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.AzureActiveDirectoryResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#CertificateDescriptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.CertificateDescriptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#CertificateDescriptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.CertificateDescriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClientCertificateCommonNameArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClientCertificateCommonNameArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClientCertificateCommonNameResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClientCertificateCommonNameResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClientCertificateThumbprintArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClientCertificateThumbprintArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClientCertificateThumbprintResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClientCertificateThumbprintResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterHealthPolicyArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClusterHealthPolicyArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterHealthPolicyResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClusterHealthPolicyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterUpgradeDeltaHealthPolicyArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClusterUpgradeDeltaHealthPolicyArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#maxpercentdeltaunhealthyapplications_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Percent<wbr>Delta<wbr>Unhealthy<wbr>Applications</a>
    ...
    <dd>{{% md %}}The maximum allowed percentage of applications health degradation allowed during cluster upgrades. The delta is measured between the state of the applications at the beginning of upgrade and the state of the applications at the time of the health evaluation. The check is performed after every upgrade domain upgrade completion to make sure the global state of the cluster is within tolerated limits. System services are not included in this.{{% /md %}}</dd>
...
<a href="#maxpercentdeltaunhealthynodes_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Percent<wbr>Delta<wbr>Unhealthy<wbr>Nodes</a>
    ...
    <dd>{{% md %}}The maximum allowed percentage of nodes health degradation allowed during cluster upgrades. The delta is measured between the state of the nodes at the beginning of upgrade and the state of the nodes at the time of the health evaluation. The check is performed after every upgrade domain upgrade completion to make sure the global state of the cluster is within tolerated limits.{{% /md %}}</dd>
...
<a href="#maxpercentupgradedomaindeltaunhealthynodes_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Percent<wbr>Upgrade<wbr>Domain<wbr>Delta<wbr>Unhealthy<wbr>Nodes</a>
    ...
    <dd>{{% md %}}The maximum allowed percentage of upgrade domain nodes health degradation allowed during cluster upgrades. The delta is measured between the state of the upgrade domain nodes at the beginning of upgrade and the state of the upgrade domain nodes at the time of the health evaluation. The check is performed after every upgrade domain upgrade completion for all completed upgrade domains to make sure the state of the upgrade domains is within tolerated limits. {{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterUpgradeDeltaHealthPolicyResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClusterUpgradeDeltaHealthPolicyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterUpgradePolicyArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClusterUpgradePolicyArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#healthpolicy_csharp" style="color: inherit; text-decoration: inherit;">Health<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterhealthpolicy">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Health<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#deltahealthpolicy_csharp" style="color: inherit; text-decoration: inherit;">Delta<wbr>Health<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterupgradedeltahealthpolicy">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Upgrade<wbr>Delta<wbr>Health<wbr>Policy<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The delta health policy used when upgrading the cluster.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterUpgradePolicyResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClusterUpgradePolicyResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#healthpolicy_csharp" style="color: inherit; text-decoration: inherit;">Health<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterhealthpolicyresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Health<wbr>Policy<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The cluster health policy used when upgrading the cluster.{{% /md %}}</dd>
...
<a href="#deltahealthpolicy_csharp" style="color: inherit; text-decoration: inherit;">Delta<wbr>Health<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterupgradedeltahealthpolicyresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Cluster<wbr>Upgrade<wbr>Delta<wbr>Health<wbr>Policy<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The delta health policy used when upgrading the cluster.{{% /md %}}</dd>
...
<h4 id="clusterversiondetails">Cluster<wbr>Version<wbr>Details</h4>
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/azurerm/types/input/#ClusterVersionDetails">input</a>   API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterVersionDetailsArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.ClusterVersionDetailsArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#ClusterVersionDetailsResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.ClusterVersionDetailsResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#DiagnosticsStorageAccountConfigArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.DiagnosticsStorageAccountConfigArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#DiagnosticsStorageAccountConfigResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.DiagnosticsStorageAccountConfigResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#EndpointRangeDescriptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.EndpointRangeDescriptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#EndpointRangeDescriptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.EndpointRangeDescriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#NodeTypeDescriptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.NodeTypeDescriptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#applicationports_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointrangedescription">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Endpoint<wbr>Range<wbr>Description<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#NodeTypeDescriptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.NodeTypeDescriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#applicationports_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#endpointrangedescriptionresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Endpoint<wbr>Range<wbr>Description<wbr>Response<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The range of ports from which cluster assigned port to Service Fabric applications.{{% /md %}}</dd>
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#SettingsParameterDescriptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.SettingsParameterDescriptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#SettingsParameterDescriptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.SettingsParameterDescriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#SettingsSectionDescriptionArgs">input</a>   API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Inputs.SettingsSectionDescriptionArgs.html">input</a>   API doc for this type.
{{% /choosable %}}
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#settingsparameterdescription">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Settings<wbr>Parameter<wbr>Description<wbr>Args&gt;</a></span>
    </dt>
...
{{% choosable language go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/servicefabric/v20170701preview?tab=doc#SettingsSectionDescriptionResponseOutput">output</a> API doc for this type.
{{% /choosable %}}
{{% choosable language csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.ServiceFabric.V20170701Preview.Outputs.SettingsSectionDescriptionResponse.html">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#settingsparameterdescriptionresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Service<wbr>Fabric.<wbr>V20170701Preview.<wbr>Inputs.<wbr>Settings<wbr>Parameter<wbr>Description<wbr>Response<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}The collection of parameters in the section.{{% /md %}}</dd>
