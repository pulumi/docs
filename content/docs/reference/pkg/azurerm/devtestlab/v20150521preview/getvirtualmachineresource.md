...
---
title: "GetVirtualMachineResource"
title_tag: "Function GetVirtualMachineResource | Module devtestlab/v20150521preview | Package azurerm"
meta_desc: "Explore the GetVirtualMachineResource function of the devtestlab/v20150521preview module, including examples, input properties, output properties, and supporting types. "
---
...
## Using GetVirtualMachineResource {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getVirtualMachineResource<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/devtestlab/v20150521preview/#GetVirtualMachineResourceArgs">GetVirtualMachineResourceArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/azurerm/devtestlab/v20150521preview/#GetVirtualMachineResourceResult">GetVirtualMachineResourceResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_virtual_machine_resource(</span><span class="nx">lab_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetVirtualMachineResourceResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupVirtualMachineResource<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devtestlab/v20150521preview?tab=doc#LookupVirtualMachineResourceArgs">LookupVirtualMachineResourceArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-azurerm/sdk/go/azurerm/devtestlab/v20150521preview?tab=doc#LookupVirtualMachineResourceResult">LookupVirtualMachineResourceResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `LookupVirtualMachineResource` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetVirtualMachineResource </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.Devtestlab/v20150521preview.GetVirtualMachineResourceResult.html">GetVirtualMachineResourceResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.AzureRM/Pulumi.AzureRM.DevTestLab.V20150521Preview.GetVirtualMachineResourceArgs.html">GetVirtualMachineResourceArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## GetVirtualMachineResource Result {#result}
...
<a href="#artifactdeploymentstatus_csharp" style="color: inherit; text-decoration: inherit;">Artifact<wbr>Deployment<wbr>Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#artifactdeploymentstatuspropertiesresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>V20150521Preview.<wbr>Outputs.<wbr>Artifact<wbr>Deployment<wbr>Status<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a href="#artifacts_csharp" style="color: inherit; text-decoration: inherit;">Artifacts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#artifactinstallpropertiesresponse">List&lt;Pulumi.<wbr>Azure<wbr>RM.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>V20150521Preview.<wbr>Outputs.<wbr>Artifact<wbr>Install<wbr>Properties<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#galleryimagereference_csharp" style="color: inherit; text-decoration: inherit;">Gallery<wbr>Image<wbr>Reference</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#galleryimagereferenceresponse">Pulumi.<wbr>Azure<wbr>RM.<wbr>Dev<wbr>Test<wbr>Lab.<wbr>V20150521Preview.<wbr>Outputs.<wbr>Gallery<wbr>Image<wbr>Reference<wbr>Response</a></span>
    </dt>
