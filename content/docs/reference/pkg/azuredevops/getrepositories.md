...
title_tag: "azuredevops.getRepositories"
meta_desc: "Documentation for the azuredevops.getRepositories function with examples, input properties, output properties, and supporting types."
---
