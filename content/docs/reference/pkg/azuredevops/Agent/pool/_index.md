...
---
title: "Pool"
title_tag: "azuredevops.Agent.Pool"
meta_desc: "Documentation for the azuredevops.Agent.Pool resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<p class="resource-deprecated">Deprecated: {{% md %}}azuredevops.agent.Pool has been deprecated in favor of azuredevops.Pool{{% /md %}}</p>
