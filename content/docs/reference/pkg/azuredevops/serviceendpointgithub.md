...
<span class="k">def </span><span class="nx">ServiceEndpointGitHub</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                          ...
                          <span class="nx">auth_oauth</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ServiceEndpointGitHubAuthOauthArgs]]</span> = None<span class="p">,</span>
                          <span class="nx">auth_personal</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ServiceEndpointGitHubAuthPersonalArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewServiceEndpointGitHub</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ServiceEndpointGitHubArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServiceEndpointGitHub</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#authoauth_nodejs" style="color: inherit; text-decoration: inherit;">auth<wbr>Oauth</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceendpointgithubauthoauth">pulumi<wbr>Input<Service<wbr>Endpoint<wbr>Git<wbr>Hub<wbr>Auth<wbr>Oauth<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An `auth_oauth` block as documented below. Allows connecting using an Oauth token.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#authpersonal_nodejs" style="color: inherit; text-decoration: inherit;">auth<wbr>Personal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceendpointgithubauthpersonal">pulumi<wbr>Input<Service<wbr>Endpoint<wbr>Git<wbr>Hub<wbr>Auth<wbr>Personal<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An `auth_personal` block as documented below. Allows connecting using a personal access token.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#auth_oauth_python" style="color: inherit; text-decoration: inherit;">auth_<wbr>oauth</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceendpointgithubauthoauth">Input[Service<wbr>Endpoint<wbr>Git<wbr>Hub<wbr>Auth<wbr>Oauth<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An `auth_oauth` block as documented below. Allows connecting using an Oauth token.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#auth_personal_python" style="color: inherit; text-decoration: inherit;">auth_<wbr>personal</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceendpointgithubauthpersonal">Input[Service<wbr>Endpoint<wbr>Git<wbr>Hub<wbr>Auth<wbr>Personal<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An `auth_personal` block as documented below. Allows connecting using a personal access token.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">project_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">service_endpoint_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> ServiceEndpointGitHub</code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetServiceEndpointGitHub<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">ServiceEndpointGitHubState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServiceEndpointGitHub</span>, error)</span></code></pre></div>
{{% /choosable %}}
