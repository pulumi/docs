...
:param pulumi.Input[List[pulumi.Input[pulumi.InputType[‘CloudProviderSnapshotBackupPolicyPolicyArgs’]]]] policies: Contains a document for each backup policy item in the desired updated backup policy.</p>
