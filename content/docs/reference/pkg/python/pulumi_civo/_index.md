...
<li><p><strong>num_target_nodes</strong> (<em>pulumi.Input</em><em>[</em><em>float</em><em>]</em>) – The number of instances to create (The default at the time of writing is 3).</p></li>
