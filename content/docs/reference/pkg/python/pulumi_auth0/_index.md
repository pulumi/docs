...
<li><p><strong>idle_session_lifetime</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – Integer. Number of hours during which a session can be inactive before the user must log in again.</p></li>
...
<li><p><strong>session_lifetime</strong> (<em>pulumi.Input</em><em>[</em><em>int</em><em>]</em>) – Integer. Number of hours during which a session will stay valid.</p></li>
