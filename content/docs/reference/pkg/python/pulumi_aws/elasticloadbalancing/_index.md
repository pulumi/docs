...
<dd><p>Attaches an EC2 instance to an Elastic Load Balancer (ELB). For attaching resources with Application Load Balancer (ALB) or Network Load Balancer (NLB), see the <code class="docutils literal notranslate"><span class="pre">lb.TargetGroupAttachment</span></code> resource.</p>
<blockquote>
...
<code class="docutils literal notranslate"><span class="pre">Application/Network</span> <span class="pre">Load</span> <span class="pre">Balancers</span></code>.</p>
<blockquote>
...
See <code class="docutils literal notranslate"><span class="pre">LB</span></code> Data Source if you are looking for “v2”
