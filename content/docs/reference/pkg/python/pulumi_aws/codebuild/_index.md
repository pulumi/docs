...
<dd><p>Provides a CodeBuild Project resource. See also the <code class="docutils literal notranslate"><span class="pre">codebuild.Webhook</span></code> resource, which manages the webhook to the source (e.g. the “rebuild every time a code change is pushed” option in the CodeBuild web console).</p>
