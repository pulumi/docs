...
<p>To create a cross-account association, create an <code class="docutils literal notranslate"><span class="pre">directconnect.GatewayAssociationProposal</span></code> resource
...
<dd><p>Manages a Direct Connect Gateway Association Proposal, typically for enabling cross-account associations. For single account associations, see the <code class="docutils literal notranslate"><span class="pre">directconnect.GatewayAssociation</span></code> resource.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">pulumi</span>
<span class="kn">import</span> <span class="nn">pulumi_aws</span> <span class="k">as</span> <span class="nn">aws</span>
...
<dd><p>Provides a Direct Connect LAG. Connections can be added to the LAG via the <code class="docutils literal notranslate"><span class="pre">directconnect.Connection</span></code> and <code class="docutils literal notranslate"><span class="pre">directconnect.ConnectionAssociation</span></code> resources.</p>
<blockquote>
