...
<em class="property">class </em><code class="descclassname">pulumi_kubernetes.batch.v2alpha1.</code><code class="descname">CronJobList</code><span class="sig-paren">(</span><em>resource_name</em>, <em>opts=None</em>, <em>items=None</em>, <em>metadata=None</em>, <em>__name__=None</em>, <em>__opts__=None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_kubernetes.batch.v2alpha1.CronJobList" title="Permalink to this definition">¶</a></dt>
