...
<code class="sig-prename descclassname">pulumi_kubernetes.yaml.</code><code class="sig-name descname">deepcopy</code><span class="sig-paren">(</span><em class="sig-param">x</em>, <em class="sig-param">memo=None</em>, <em class="sig-param">_nil=[]</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_kubernetes.yaml.deepcopy" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">pulumi_kubernetes.yaml.</code><code class="sig-name descname">ConfigFile</code><span class="sig-paren">(</span><em class="sig-param">name: str</em>, <em class="sig-param">file_id: str</em>, <em class="sig-param">opts: Optional[pulumi.resource.ResourceOptions] = None</em>, <em class="sig-param">transformations: Optional[List[Callable]] = None</em>, <em class="sig-param">resource_prefix: Optional[str] = None</em><span class="sig-paren">)</span><a class="headerlink" href="#pulumi_kubernetes.yaml.ConfigFile" title="Permalink to this definition">¶</a></dt>
...
<li><p><strong>opts</strong> (<em>Optional</em><em>[</em><a class="reference internal" href="../../pulumi/#pulumi.ResourceOptions" title="pulumi.ResourceOptions"><em>ResourceOptions</em></a><em>]</em>) – A bag of optional settings that control a resource’s behavior.</p></li>
<li><p><strong>transformations</strong> (<em>Optional</em><em>[</em><em>List</em><em>[</em><em>Callable</em><em>]</em><em>]</em>) – A set of transformations to apply to Kubernetes
resource definitions before registering with engine.</p></li>
...
<li><p><strong>name</strong> – The name of this resource.</p></li>
