...
:param pulumi.Input[dict] labels: Labels with user-defined metadata.</p>
<blockquote>
<div><p>This field may contain up to 64 entries. Label keys and values may be no
...
:param str resource_name: The name of the resource.
:param pulumi.ResourceOptions opts: Options for the resource.
:param pulumi.Input[str] location: The name of the location this repository is located in.</p>
<blockquote>
<div><p>Used to find the parent resource to bind the IAM policy to</p>
</div></blockquote>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
