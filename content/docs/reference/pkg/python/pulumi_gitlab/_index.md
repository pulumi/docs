...
<li><p><strong>with_custom*attributes</strong> (<em>bool</em>) – <p>Include custom attributes in response <a href="#id20"><span class="problematic" id="id21">*</span></a>(admins only)_.</p>
</p></li>
