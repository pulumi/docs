...
:param pulumi.Input[int] xss_score_threshold: XSS attack threshold.</p>
<dl class="py method">
...
:param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType[‘Servicev1BackendArgs’]]]] backends: A set of Backends to service requests from your Domains.</p>
<blockquote>
