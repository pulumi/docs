...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RouteTableAssociation resource produces the following computed outputs.
