...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RouteTable</span><span class="p">(resource_name, id, opts=None, </span>tags=None<span class="p">, </span>transit_gateway_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, default_<wbr>association_<wbr>route_<wbr>table=None, default_<wbr>propagation_<wbr>route_<wbr>table=None, tags=None, transit_<wbr>gateway_<wbr>id=None)
```

```go
func GetRouteTable(ctx *pulumi.Context, name string, id pulumi.IDInput, state *RouteTableState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
