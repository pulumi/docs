...
<span class="k">def </span><span class="nx">GlobalTable</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">replicas</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]]</span> = None<span class="p">)</span>
...
<a href="#replicas_nodejs" style="color: inherit; text-decoration: inherit;">replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#globaltablereplica">pulumi.<wbr>Input<pulumi.<wbr>Input<Global<wbr>Table<wbr>Replica<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Underlying DynamoDB Table. At least 1 replica must be defined. See below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#replicas_python" style="color: inherit; text-decoration: inherit;">replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#globaltablereplica">Input[Global<wbr>Table<wbr>Replica<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Underlying DynamoDB Table. At least 1 replica must be defined. See below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">replicas</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[GlobalTableReplicaArgs]]]]</span> = None<span class="p">) -&gt;</span> GlobalTable</code></pre></div>
{{% /choosable %}}
