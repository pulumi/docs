...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduledactionscalabletargetaction">Pulumi.<wbr>Aws.<wbr>App<wbr>Auto<wbr>Scaling.<wbr>Inputs.<wbr>Scheduled<wbr>Action<wbr>Scalable<wbr>Target<wbr>Action<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Scalable<wbr>Target<wbr>Action</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduledactionscalabletargetaction">Pulumi.<wbr>Aws.<wbr>App<wbr>Auto<wbr>Scaling.<wbr>Outputs.<wbr>Scheduled<wbr>Action<wbr>Scalable<wbr>Target<wbr>Action?</a></span>
    </dt>
    <dd>{{% md %}}The new minimum and maximum capacity. You can set both values or just one. See below
{{% /md %}}</dd>
