...
```python
def get(resource_name, id, opts=None, arn=None, container_<wbr>definitions=None, cpu=None, execution_<wbr>role_<wbr>arn=None, family=None, ipc_<wbr>mode=None, memory=None, network_<wbr>mode=None, pid_<wbr>mode=None, placement_<wbr>constraints=None, proxy_<wbr>configuration=None, requires_<wbr>compatibilities=None, revision=None, tags=None, task_<wbr>role_<wbr>arn=None, volumes=None)
```

```go
func GetTaskDefinition(ctx *pulumi.Context, name string, id pulumi.IDInput, state *TaskDefinitionState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
