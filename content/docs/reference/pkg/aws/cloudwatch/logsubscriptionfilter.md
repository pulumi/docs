...
The method used to distribute log data to the destination. By default log data is grouped by log stream, but the grouping can be set to random for a more even distribution. This property is only applicable when the destination is an Amazon Kinesis stream. Valid values are &#34;Random&#34; and &#34;ByLogStream&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">filter_<wbr>pattern</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the destination to deliver matching log events to. Kinesis stream or Lambda function ARN.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The method used to distribute log data to the destination. By default log data is grouped by log stream, but the grouping can be set to random for a more even distribution. This property is only applicable when the destination is an Amazon Kinesis stream. Valid values are &#34;Random&#34; and &#34;ByLogStream&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A valid CloudWatch Logs filter pattern for subscribing to a filtered stream of log events.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the log group to associate the subscription filter with
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of an IAM role that grants Amazon CloudWatch Logs permissions to deliver ingested log events to the destination. If you use Lambda as a destination, you should skip this argument and use `aws.lambda.Permission` resource for granting access from CloudWatch logs to the destination Lambda function. 
 {{% /md %}}
