...
```python
def get(resource_name, id, opts=None, arn=None, batch_<wbr>target=None, ecs_<wbr>target=None, input=None, input_<wbr>path=None, input_<wbr>transformer=None, kinesis_<wbr>target=None, role_<wbr>arn=None, rule=None, run_<wbr>command_<wbr>targets=None, sqs_<wbr>target=None, target_<wbr>id=None)
```

```go
func GetEventTarget(ctx *pulumi.Context, name string, id pulumi.IDInput, state *EventTargetState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
