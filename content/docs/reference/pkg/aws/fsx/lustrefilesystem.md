...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the LustreFileSystem resource produces the following computed outputs.
