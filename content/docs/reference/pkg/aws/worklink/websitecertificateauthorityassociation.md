...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">WebsiteCertificateAuthorityAssociation</span><span class="p">(resource_name, id, opts=None, </span>certificate=None<span class="p">, </span>display_name=None<span class="p">, </span>fleet_arn=None<span class="p">, __props__=None);</span></code></pre></div>
...
The certificate name to display.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">fleet_<wbr>arn</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The root certificate of the Certificate Authority.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The certificate name to display.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the fleet.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A unique identifier for the Certificate Authority.
 {{% /md %}}
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">website_<wbr>ca_<wbr>id</td>
            <td class="align-top">
...
```python
def get(resource_name, id, opts=None, certificate=None, display_<wbr>name=None, fleet_<wbr>arn=None, website_<wbr>ca_<wbr>id=None)
```

```go
func GetWebsiteCertificateAuthorityAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *WebsiteCertificateAuthorityAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
