...
Description of the license configuration.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">license_<wbr>count</td>
            <td class="align-top">
...
Number of licenses managed by the license configuration.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">license_<wbr>count_<wbr>hard_<wbr>limit</td>
            <td class="align-top">
...
Sets the number of available licenses as a hard limit.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">license_<wbr>counting_<wbr>type</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Description of the license configuration.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Number of licenses managed by the license configuration.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Sets the number of available licenses as a hard limit.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Dimension to use to track license inventory. Specify either `vCPU`, `Instance`, `Core` or `Socket`.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the license configuration.
 {{% /md %}}
