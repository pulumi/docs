...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">MaintenanceWindowTask</span><span class="p">(resource_name, id, opts=None, </span>description=None<span class="p">, </span>logging_info=None<span class="p">, </span>max_concurrency=None<span class="p">, </span>max_errors=None<span class="p">, </span>name=None<span class="p">, </span>priority=None<span class="p">, </span>service_role_arn=None<span class="p">, </span>targets=None<span class="p">, </span>task_arn=None<span class="p">, </span>task_invocation_parameters=None<span class="p">, </span>task_parameters=None<span class="p">, </span>task_type=None<span class="p">, </span>window_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, description=None, logging_<wbr>info=None, max_<wbr>concurrency=None, max_<wbr>errors=None, name=None, priority=None, service_<wbr>role_<wbr>arn=None, targets=None, task_<wbr>arn=None, task_<wbr>invocation_<wbr>parameters=None, task_<wbr>parameters=None, task_<wbr>type=None, window_<wbr>id=None)
```

```go
func GetMaintenanceWindowTask(ctx *pulumi.Context, name string, id pulumi.IDInput, state *MaintenanceWindowTaskState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
