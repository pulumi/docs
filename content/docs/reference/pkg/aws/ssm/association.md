...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Association</span><span class="p">(resource_name, id, opts=None, </span>association_name=None<span class="p">, </span>automation_target_parameter_name=None<span class="p">, </span>compliance_severity=None<span class="p">, </span>document_version=None<span class="p">, </span>instance_id=None<span class="p">, </span>max_concurrency=None<span class="p">, </span>max_errors=None<span class="p">, </span>name=None<span class="p">, </span>output_location=None<span class="p">, </span>parameters=None<span class="p">, </span>schedule_expression=None<span class="p">, </span>targets=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, association_<wbr>id=None, association_<wbr>name=None, automation_<wbr>target_<wbr>parameter_<wbr>name=None, compliance_<wbr>severity=None, document_<wbr>version=None, instance_<wbr>id=None, max_<wbr>concurrency=None, max_<wbr>errors=None, name=None, output_<wbr>location=None, parameters=None, schedule_<wbr>expression=None, targets=None)
```
