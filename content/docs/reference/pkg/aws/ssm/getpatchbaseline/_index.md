...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_patch_baseline(</span><span class="nx">default_baseline</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                       ...
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetPatchBaselineResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupPatchBaseline<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupPatchBaselineArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupPatchBaselineResult</a></span>, error)</span></code></pre></div>
...
<a href="#defaultbaseline_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Baseline</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#defaultbaseline_go" style="color: inherit; text-decoration: inherit;">Default<wbr>Baseline</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a href="#defaultbaseline_nodejs" style="color: inherit; text-decoration: inherit;">default<wbr>Baseline</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#default_baseline_python" style="color: inherit; text-decoration: inherit;">default_<wbr>baseline</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
