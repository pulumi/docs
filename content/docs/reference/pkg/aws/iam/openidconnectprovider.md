...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the OpenIdConnectProvider resource produces the following computed outputs.
