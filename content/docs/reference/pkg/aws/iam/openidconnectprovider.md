...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">OpenIdConnectProvider</span><span class="p">(resource_name, id, opts=None, </span>client_id_lists=None<span class="p">, </span>thumbprint_lists=None<span class="p">, </span>url=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, arn=None, client_<wbr>id_<wbr>lists=None, thumbprint_<wbr>lists=None, url=None)
```

```go
func GetOpenIdConnectProvider(ctx *pulumi.Context, name string, id pulumi.IDInput, state *OpenIdConnectProviderState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
