...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">AccessKey</span><span class="p">(resource_name, id, opts=None, </span>pgp_key=None<span class="p">, </span>status=None<span class="p">, </span>user=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, encrypted_<wbr>secret=None, key_<wbr>fingerprint=None, pgp_<wbr>key=None, secret=None, ses_<wbr>smtp_<wbr>password=None, ses_<wbr>smtp_<wbr>password_<wbr>v4=None, status=None, user=None)
```

```go
func GetAccessKey(ctx *pulumi.Context, name string, id pulumi.IDInput, state *AccessKeyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
