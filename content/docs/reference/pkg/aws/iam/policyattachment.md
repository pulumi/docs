...
<a href="#groups_nodejs" style="color: inherit; text-decoration: inherit;">groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<pulumi.<wbr>Input<string | Group>[]></span>
    </dt>
    <dd>{{% md %}}The group(s) the policy should be applied to
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#roles_nodejs" style="color: inherit; text-decoration: inherit;">roles</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<pulumi.<wbr>Input<string | Role>[]></span>
    </dt>
    <dd>{{% md %}}The role(s) the policy should be applied to
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#users_nodejs" style="color: inherit; text-decoration: inherit;">users</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<pulumi.<wbr>Input<string | User>[]></span>
    </dt>
    <dd>{{% md %}}The user(s) the policy should be applied to
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">policy_arn</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">roles</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">,</span>
        <span class="nx">users</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]</span> = None<span class="p">) -&gt;</span> PolicyAttachment</code></pre></div>
{{% /choosable %}}
