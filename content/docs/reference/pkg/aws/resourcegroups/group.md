...
<span class="k">def </span><span class="nx">Group</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">resource_query</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[GroupResourceQueryArgs]]</span> = None<span class="p">,</span>
...
<a href="#resourcequery_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Query</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#groupresourcequery">pulumi.<wbr>Input<Group<wbr>Resource<wbr>Query<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A `resource_query` block. Resource queries are documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_query_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>query</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#groupresourcequery">Input[Group<wbr>Resource<wbr>Query<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A `resource_query` block. Resource queries are documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
