...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#groupresourcequery">Pulumi.<wbr>Aws.<wbr>Resource<wbr>Groups.<wbr>Inputs.<wbr>Group<wbr>Resource<wbr>Query<wbr>Args</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Resource<wbr>Query</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#groupresourcequery">Pulumi.<wbr>Aws.<wbr>Resource<wbr>Groups.<wbr>Outputs.<wbr>Group<wbr>Resource<wbr>Query</a></span>
    </dt>
    <dd>{{% md %}}A `resource_query` block. Resource queries are documented below.
{{% /md %}}</dd>
