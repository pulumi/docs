...
title_tag: "aws.elb.getHostedZoneId"
meta_desc: "Documentation for the aws.elb.getHostedZoneId function with examples, input properties, output properties, and supporting types."
---
