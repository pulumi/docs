...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ClusterSnapshot resource produces the following computed outputs.
