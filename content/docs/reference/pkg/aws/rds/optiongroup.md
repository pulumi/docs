...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the OptionGroup resource produces the following computed outputs.
