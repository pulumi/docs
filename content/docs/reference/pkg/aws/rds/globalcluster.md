...
<span class="k">def </span><span class="nx">GlobalCluster</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">source_db_cluster_identifier</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">force_destroy</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
        <span class="nx">global_cluster_identifier</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">global_cluster_members</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[GlobalClusterGlobalClusterMemberArgs]]]]</span> = None<span class="p">,</span>
        <span class="nx">global_cluster_resource_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">source_db_cluster_identifier</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">storage_encrypted</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">) -&gt;</span> GlobalCluster</code></pre></div>
{{% /choosable %}}
...
<a href="#state_globalclustermembers_nodejs" style="color: inherit; text-decoration: inherit;">global<wbr>Cluster<wbr>Members</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#globalclusterglobalclustermember">pulumi.<wbr>Input<pulumi.<wbr>Input<Global<wbr>Cluster<wbr>Global<wbr>Cluster<wbr>Member<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Set of objects containing Global Cluster members.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_global_cluster_members_python" style="color: inherit; text-decoration: inherit;">global_<wbr>cluster_<wbr>members</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#globalclusterglobalclustermember">Input[Global<wbr>Cluster<wbr>Global<wbr>Cluster<wbr>Member<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Set of objects containing Global Cluster members.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
