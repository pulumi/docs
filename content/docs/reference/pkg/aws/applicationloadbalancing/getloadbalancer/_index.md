...
title_tag: "aws.applicationloadbalancing.getLoadBalancer"
meta_desc: "Documentation for the aws.applicationloadbalancing.getLoadBalancer function with examples, input properties, output properties, and supporting types."
---
...
<p class="resource-deprecated">Deprecated: {{% md %}}aws.applicationloadbalancing.getLoadBalancer has been deprecated in favor of aws.alb.getLoadBalancer{{% /md %}}</p>
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_load_balancer(</span><span class="nx">arn</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
