...
<span class="k">def </span><span class="nx">Account</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">cloudwatch_role_arn</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">)</span>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
        <span class="nx">cloudwatch_role_arn</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">throttle_settings</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[AccountThrottleSettingsArgs]]</span> = None<span class="p">) -&gt;</span> Account</code></pre></div>
{{% /choosable %}}
...
<a href="#state_throttlesettings_nodejs" style="color: inherit; text-decoration: inherit;">throttle<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountthrottlesettings">pulumi.<wbr>Input<Account<wbr>Throttle<wbr>Settings<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Account-Level throttle settings. See exported fields below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#state_throttle_settings_python" style="color: inherit; text-decoration: inherit;">throttle_<wbr>settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountthrottlesettings">Input[Account<wbr>Throttle<wbr>Settings<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Account-Level throttle settings. See exported fields below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
