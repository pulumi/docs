...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Resource</span><span class="p">(resource_name, id, opts=None, </span>parent_id=None<span class="p">, </span>path_part=None<span class="p">, </span>rest_api=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, parent_<wbr>id=None, path=None, path_<wbr>part=None, rest_<wbr>api=None)
```

```go
func GetResource(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResourceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
