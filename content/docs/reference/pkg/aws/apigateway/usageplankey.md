...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">UsagePlanKey</span><span class="p">(resource_name, id, opts=None, </span>key_id=None<span class="p">, </span>key_type=None<span class="p">, </span>usage_plan_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
The type of the API key resource. Currently, the valid key type is API_KEY.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">usage_<wbr>plan_<wbr>id</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The identifier of the API key resource.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The type of the API key resource. Currently, the valid key type is API_KEY.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of a usage plan key.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Id of the usage plan resource representing to associate the key to.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The value of a usage plan key.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, key_<wbr>id=None, key_<wbr>type=None, name=None, usage_<wbr>plan_<wbr>id=None, value=None)
```

```go
func GetUsagePlanKey(ctx *pulumi.Context, name string, id pulumi.IDInput, state *UsagePlanKeyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
