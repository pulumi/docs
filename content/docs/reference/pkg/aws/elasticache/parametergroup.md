...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elasticache.ParameterGroup.html">ParameterGroup</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.ElastiCache.Inputs.ParameterGroupArgs.html">ParameterGroupArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#parametergroupparameter">List&lt;Pulumi.<wbr>Aws.<wbr>Elasti<wbr>Cache.<wbr>Inputs.<wbr>Parameter<wbr>Group<wbr>Parameter<wbr>Args&gt;?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Parameters</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#parametergroupparameter">List&lt;Pulumi.<wbr>Aws.<wbr>Elasti<wbr>Cache.<wbr>Outputs.<wbr>Parameter<wbr>Group<wbr>Parameter&gt;?</a></span>
    </dt>
    <dd>{{% md %}}A list of ElastiCache parameters to apply.
{{% /md %}}</dd>
