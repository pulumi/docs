...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">DelegationSet</span><span class="p">(resource_name, id, opts=None, </span>reference_name=None<span class="p">, __props__=None);</span></code></pre></div>
