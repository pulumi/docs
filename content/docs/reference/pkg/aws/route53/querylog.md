...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">QueryLog</span><span class="p">(resource_name, id, opts=None, </span>cloudwatch_log_group_arn=None<span class="p">, </span>zone_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} CloudWatch log group ARN to send query logs.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Route53 hosted zone ID to enable query logs.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, cloudwatch_<wbr>log_<wbr>group_<wbr>arn=None, zone_<wbr>id=None)
```

```go
func GetQueryLog(ctx *pulumi.Context, name string, id pulumi.IDInput, state *QueryLogState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
