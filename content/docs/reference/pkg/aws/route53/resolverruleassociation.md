...
Creates a ResolverRuleAssociation resource with the given unique name, arguments, and options.
...
A name for the association that you&#39;re creating between a resolver rule and a VPC.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Resolver<wbr>Rule<wbr>Id</td>
            <td class="align-top">
...
A name for the association that you&#39;re creating between a resolver rule and a VPC.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">resolver_<wbr>rule_<wbr>id</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A name for the association that you&#39;re creating between a resolver rule and a VPC.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the resolver rule that you want to associate with the VPC.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the VPC that you want to associate the resolver rule with.
 {{% /md %}}
