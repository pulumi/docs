...
<span class="k">def </span><span class="nx">InfrastructureConfiguration</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                ...
                                <span class="nx">instance_profile_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                ...
                                <span class="nx">logging</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[InfrastructureConfigurationLoggingArgs]]</span> = None<span class="p">,</span>
                                ...
                                <span class="nx">terminate_instance_on_failure</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">)</span>
...
<a href="#logging_nodejs" style="color: inherit; text-decoration: inherit;">logging</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#infrastructureconfigurationlogging">pulumi.<wbr>Input<Infrastructure<wbr>Configuration<wbr>Logging<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Configuration block with logging settings. Detailed below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#logging_python" style="color: inherit; text-decoration: inherit;">logging</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#infrastructureconfigurationlogging">Input[Infrastructure<wbr>Configuration<wbr>Logging<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Configuration block with logging settings. Detailed below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">subnet_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]</span> = None<span class="p">,</span>
        <span class="nx">terminate_instance_on_failure</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">) -&gt;</span> InfrastructureConfiguration</code></pre></div>
{{% /choosable %}}
...
<a href="#s3logs_nodejs" style="color: inherit; text-decoration: inherit;">s3Logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#infrastructureconfigurationloggings3logs">pulumi.<wbr>Input<Infrastructure<wbr>Configuration<wbr>Logging<wbr>S3Logs<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Configuration block with S3 logging settings. Detailed below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#s3_logs_python" style="color: inherit; text-decoration: inherit;">s3_<wbr>logs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#infrastructureconfigurationloggings3logs">Input[Infrastructure<wbr>Configuration<wbr>Logging<wbr>S3Logs<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Configuration block with S3 logging settings. Detailed below.
{{% /md %}}</dd></dl>
{{% /choosable %}}
