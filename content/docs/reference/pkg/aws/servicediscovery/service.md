...
<span class="k">def </span><span class="nx">Service</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">dns_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ServiceDnsConfigArgs]]</span> = None<span class="p">,</span>
            <span class="nx">health_check_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ServiceHealthCheckConfigArgs]]</span> = None<span class="p">,</span>
            <span class="nx">health_check_custom_config</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[ServiceHealthCheckCustomConfigArgs]]</span> = None<span class="p">,</span>
...
<a href="#dnsconfig_nodejs" style="color: inherit; text-decoration: inherit;">dns<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicednsconfig">pulumi.<wbr>Input<Service<wbr>Dns<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains information about the resource record sets that you want Amazon Route 53 to create when you register an instance.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#healthcheckconfig_nodejs" style="color: inherit; text-decoration: inherit;">health<wbr>Check<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicehealthcheckconfig">pulumi.<wbr>Input<Service<wbr>Health<wbr>Check<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains settings for an optional health check. Only for Public DNS namespaces.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#healthcheckcustomconfig_nodejs" style="color: inherit; text-decoration: inherit;">health<wbr>Check<wbr>Custom<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicehealthcheckcustomconfig">pulumi.<wbr>Input<Service<wbr>Health<wbr>Check<wbr>Custom<wbr>Config<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains settings for ECS managed health checks.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dns_config_python" style="color: inherit; text-decoration: inherit;">dns_<wbr>config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicednsconfig">Input[Service<wbr>Dns<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains information about the resource record sets that you want Amazon Route 53 to create when you register an instance.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#health_check_config_python" style="color: inherit; text-decoration: inherit;">health_<wbr>check_<wbr>config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicehealthcheckconfig">Input[Service<wbr>Health<wbr>Check<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains settings for an optional health check. Only for Public DNS namespaces.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#health_check_custom_config_python" style="color: inherit; text-decoration: inherit;">health_<wbr>check_<wbr>custom_<wbr>config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicehealthcheckcustomconfig">Input[Service<wbr>Health<wbr>Check<wbr>Custom<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A complex type that contains settings for ECS managed health checks.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnsrecords_nodejs" style="color: inherit; text-decoration: inherit;">dns<wbr>Records</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicednsconfigdnsrecord">pulumi.<wbr>Input<pulumi.<wbr>Input<Service<wbr>Dns<wbr>Config<wbr>Dns<wbr>Record<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An array that contains one DnsRecord object for each resource record set.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dns_records_python" style="color: inherit; text-decoration: inherit;">dns_<wbr>records</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicednsconfigdnsrecord">Input[Service<wbr>Dns<wbr>Config<wbr>Dns<wbr>Record<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An array that contains one DnsRecord object for each resource record set.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
