...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the PublicDnsNamespace resource produces the following computed outputs.
