...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#queuereservationplansettings">Pulumi.<wbr>Aws.<wbr>Media<wbr>Convert.<wbr>Inputs.<wbr>Queue<wbr>Reservation<wbr>Plan<wbr>Settings<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Reservation<wbr>Plan<wbr>Settings</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#queuereservationplansettings">Pulumi.<wbr>Aws.<wbr>Media<wbr>Convert.<wbr>Outputs.<wbr>Queue<wbr>Reservation<wbr>Plan<wbr>Settings</a></span>
    </dt>
    <dd>{{% md %}}A detail pricing plan of the  reserved queue. See below.
{{% /md %}}</dd>
