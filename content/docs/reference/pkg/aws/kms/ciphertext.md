...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the Ciphertext resource produces the following computed outputs.
