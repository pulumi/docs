...
<a href="#meshname_csharp" style="color: inherit; text-decoration: inherit;">Mesh<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the service mesh in which to create the gateway route.
{{% /md %}}</dd>
...
<a href="#virtualgatewayname_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Gateway<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the [virtual gateway](https://www.terraform.io/docs/providers/aws/r/appmesh_virtual_gateway.html) to associate the gateway route with.
{{% /md %}}</dd>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name to use for the gateway route.
{{% /md %}}</dd>
...
<a href="#virtualservicename_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Service<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the virtual service that traffic is routed to.
{{% /md %}}</dd>
