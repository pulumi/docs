...
<span class="k">def </span><span class="nx">Mesh</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[MeshSpecArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewMesh</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">MeshArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Mesh</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#meshspec">pulumi.<wbr>Input<Mesh<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The service mesh specification to apply.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#spec_python" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#meshspec">Input[Mesh<wbr>Spec<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The service mesh specification to apply.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#egressfilter_nodejs" style="color: inherit; text-decoration: inherit;">egress<wbr>Filter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#meshspecegressfilter">pulumi.<wbr>Input<Mesh<wbr>Spec<wbr>Egress<wbr>Filter<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The egress filter rules for the service mesh.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#egress_filter_python" style="color: inherit; text-decoration: inherit;">egress_<wbr>filter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#meshspecegressfilter">Input[Mesh<wbr>Spec<wbr>Egress<wbr>Filter<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The egress filter rules for the service mesh.
{{% /md %}}</dd></dl>
{{% /choosable %}}
