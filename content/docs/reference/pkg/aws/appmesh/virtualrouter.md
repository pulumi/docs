...
<span class="k">def </span><span class="nx">VirtualRouter</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[VirtualRouterSpecArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewVirtualRouter</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">VirtualRouterArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v4/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">VirtualRouter</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#spec_nodejs" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspec">pulumi.<wbr>Input<Virtual<wbr>Router<wbr>Spec<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The virtual router specification to apply.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#spec_python" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspec">Input[Virtual<wbr>Router<wbr>Spec<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The virtual router specification to apply.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#listener_nodejs" style="color: inherit; text-decoration: inherit;">listener</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspeclistener">pulumi.<wbr>Input<Virtual<wbr>Router<wbr>Spec<wbr>Listener<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The listeners that the virtual router is expected to receive inbound traffic from.
Currently only one listener is supported per virtual router.
{{% /md %}}</dd></dl>
...
<a href="#listener_python" style="color: inherit; text-decoration: inherit;">listener</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspeclistener">Input[Virtual<wbr>Router<wbr>Spec<wbr>Listener<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The listeners that the virtual router is expected to receive inbound traffic from.
Currently only one listener is supported per virtual router.
{{% /md %}}</dd></dl>
...
<a href="#portmapping_nodejs" style="color: inherit; text-decoration: inherit;">port<wbr>Mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspeclistenerportmapping">pulumi.<wbr>Input<Virtual<wbr>Router<wbr>Spec<wbr>Listener<wbr>Port<wbr>Mapping<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}The port mapping information for the listener.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#port_mapping_python" style="color: inherit; text-decoration: inherit;">port_<wbr>mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualrouterspeclistenerportmapping">Input[Virtual<wbr>Router<wbr>Spec<wbr>Listener<wbr>Port<wbr>Mapping<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The port mapping information for the listener.
{{% /md %}}</dd></dl>
{{% /choosable %}}
