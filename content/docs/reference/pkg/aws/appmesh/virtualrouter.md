...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the VirtualRouter resource produces the following computed outputs.
