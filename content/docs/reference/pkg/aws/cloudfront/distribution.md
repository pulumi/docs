...
```python
def get(resource_name, id, opts=None, active_<wbr>trusted_<wbr>signers=None, aliases=None, arn=None, caller_<wbr>reference=None, comment=None, custom_<wbr>error_<wbr>responses=None, default_<wbr>cache_<wbr>behavior=None, default_<wbr>root_<wbr>object=None, domain_<wbr>name=None, enabled=None, etag=None, hosted_<wbr>zone_<wbr>id=None, http_<wbr>version=None, in_<wbr>progress_<wbr>validation_<wbr>batches=None, is_<wbr>ipv6_<wbr>enabled=None, last_<wbr>modified_<wbr>time=None, logging_<wbr>config=None, ordered_<wbr>cache_<wbr>behaviors=None, origin_<wbr>groups=None, origins=None, price_<wbr>class=None, restrictions=None, retain_<wbr>on_<wbr>delete=None, status=None, tags=None, viewer_<wbr>certificate=None, wait_<wbr>for_<wbr>deployment=None, web_<wbr>acl_<wbr>id=None)
```

```go
func GetDistribution(ctx *pulumi.Context, name string, id pulumi.IDInput, state *DistributionState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
