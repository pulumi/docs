...
An optional comment about the public key.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">encoded_<wbr>key</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Internal value used by CloudFront to allow future updates to the public key configuration.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} An optional comment about the public key.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The encoded public key that you want to add to CloudFront to use with features like field-level encryption.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The current version of the public key. For example: `E2QWRUHAPOMQZL`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name for the public key. By default generated by this provider.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name for the public key. Conflicts with `name`.
 {{% /md %}}
