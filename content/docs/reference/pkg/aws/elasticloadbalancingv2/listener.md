...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elasticloadbalancingv2.Listener.html">Listener</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.ElasticLoadBalancingV2.Inputs.ListenerArgs.html">ListenerArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultaction">List&lt;Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Inputs.<wbr>Listener<wbr>Default<wbr>Action<wbr>Args&gt;</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Default<wbr>Actions</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultaction">List&lt;Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Outputs.<wbr>Listener<wbr>Default<wbr>Action&gt;</a></span>
    </dt>
    <dd>{{% md %}}An Action block. Action blocks are documented below.
{{% /md %}}</dd>
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultactionauthenticatecognito">Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Inputs.<wbr>Listener<wbr>Default<wbr>Action<wbr>Authenticate<wbr>Cognito<wbr>Args?</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultactionauthenticateoidc">Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Inputs.<wbr>Listener<wbr>Default<wbr>Action<wbr>Authenticate<wbr>Oidc<wbr>Args?</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultactionfixedresponse">Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Inputs.<wbr>Listener<wbr>Default<wbr>Action<wbr>Fixed<wbr>Response<wbr>Args?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span>Redirect</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#listenerdefaultactionredirect">Pulumi.<wbr>Aws.<wbr>Elastic<wbr>Load<wbr>Balancing<wbr>V2.<wbr>Inputs.<wbr>Listener<wbr>Default<wbr>Action<wbr>Redirect<wbr>Args?</a></span>
    </dt>
