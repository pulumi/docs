...
All [input](#inputs) properties are implicitly available as output properties. The BucketNotification resource does not produce any additional output properties.
