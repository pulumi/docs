...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">AccountPublicAccessBlock</span><span class="p">(resource_name, id, opts=None, </span>account_id=None<span class="p">, </span>block_public_acls=None<span class="p">, </span>block_public_policy=None<span class="p">, </span>ignore_public_acls=None<span class="p">, </span>restrict_public_buckets=None<span class="p">, __props__=None);</span></code></pre></div>
