 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventorydestination">Inventory<wbr>Destination<wbr>Args</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventoryfilter">Inventory<wbr>Filter<wbr>Args?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventoryschedule">Inventory<wbr>Schedule<wbr>Args</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventorydestinationbucket">Inventory<wbr>Destination<wbr>Bucket<wbr>Args</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
The S3 bucket configuration where inventory results are published (documented below).
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventorydestinationbucketencryption">Inventory<wbr>Destination<wbr>Bucket<wbr>Encryption<wbr>Args?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventorydestinationbucketencryptionssekms">Inventory<wbr>Destination<wbr>Bucket<wbr>Encryption<wbr>Sse<wbr>Kms<wbr>Args?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#inventorydestinationbucketencryptionsses3">Inventory<wbr>Destination<wbr>Bucket<wbr>Encryption<wbr>Sse<wbr>S3Args?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
