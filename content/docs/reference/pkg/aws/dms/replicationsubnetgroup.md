...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">replication_<wbr>subnet_<wbr>group_<wbr>description</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The description for the subnet group.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name for the replication subnet group. This value is stored as a lowercase string.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A list of the EC2 subnet IDs for the subnet group.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the VPC the subnet group is in.
 {{% /md %}}
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">replication_<wbr>subnet_<wbr>group_<wbr>arn</td>
            <td class="align-top">
