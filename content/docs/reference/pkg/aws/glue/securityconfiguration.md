...
All [input](#inputs) properties are implicitly available as output properties. The SecurityConfiguration resource does not produce any additional output properties.
