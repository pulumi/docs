...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The description of the snapshot schedule.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Whether to destroy all associated clusters with this snapshot schedule on deletion. Must be enabled and applied before attempting deletion.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, definitions=None, description=None, force_<wbr>destroy=None, identifier=None, identifier_<wbr>prefix=None, tags=None)
```

```go
func GetSnapshotSchedule(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SnapshotScheduleState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
