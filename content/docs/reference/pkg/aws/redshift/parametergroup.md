...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of parameter group
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The description of the Redshift parameter group. Defaults to &#34;Managed by Pulumi&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The family of the Redshift parameter group.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the Redshift parameter.
 {{% /md %}}
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Redshift.ParameterGroupParameterArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Redshift.ParameterGroupParameter.html">output</a> API doc for this type.
{{% /lang %}}
