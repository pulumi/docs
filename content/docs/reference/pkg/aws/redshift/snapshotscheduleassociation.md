...
title_tag: "Resource SnapshotScheduleAssociation | Module redshift | Package AWS"
meta_desc: "Explore the SnapshotScheduleAssociation resource of the redshift module, including examples, input properties, output properties, lookup functions, and supporting types. {{% examples %}}"
---
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/v2/go/aws/redshift?tab=doc#SnapshotScheduleAssociationArgs">SnapshotScheduleAssociationArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
The SnapshotScheduleAssociation resource accepts the following [input]({{< relref "/docs/intro/concepts/programming-model#outputs" >}}) properties:
