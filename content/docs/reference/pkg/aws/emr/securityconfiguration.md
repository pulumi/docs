...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A JSON formatted Security Configuration
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Date the Security Configuration was created
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the EMR Security Configuration. By default generated by this provider.
 {{% /md %}}
