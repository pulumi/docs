...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the GatewayAssociationProposal resource produces the following computed outputs.
