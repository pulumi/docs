...
<a href="#connectionsbandwidth_csharp" style="color: inherit; text-decoration: inherit;">Connections<wbr>Bandwidth</a>
    ...
    <dd>{{% md %}}The bandwidth of the individual physical connections bundled by the LAG. Valid values: 50Mbps, 100Mbps, 200Mbps, 300Mbps, 400Mbps, 500Mbps, 1Gbps, 2Gbps, 5Gbps, 10Gbps and 100Gbps. Case sensitive.
...
<a href="#connectionid_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of an existing dedicated connection to migrate to the LAG.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#providername_csharp" style="color: inherit; text-decoration: inherit;">Provider<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the service provider associated with the LAG.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#owneraccountid_csharp" style="color: inherit; text-decoration: inherit;">Owner<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the AWS account that owns the LAG.
{{% /md %}}</dd></dl>
{{% /choosable %}}
