...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the TransitVirtualInterface resource produces the following computed outputs.
