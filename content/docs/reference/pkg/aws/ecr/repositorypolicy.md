...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_aws/ecr/#pulumi_aws.ecr.RepositoryPolicy">RepositoryPolicy</a></span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>policy=None<span class="p">, </span>repository=None<span class="p">, </span>__props__=None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
