...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the RepositoryPolicy resource produces the following computed outputs.
