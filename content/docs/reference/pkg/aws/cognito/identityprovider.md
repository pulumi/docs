...
All [input](#inputs) properties are implicitly available as output properties. The IdentityProvider resource does not produce any additional output properties.
