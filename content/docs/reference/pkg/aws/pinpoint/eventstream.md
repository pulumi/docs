...
The application ID.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">destination_<wbr>stream_<wbr>arn</td>
            <td class="align-top">
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Amazon Resource Name (ARN) of the Amazon Kinesis stream or Firehose delivery stream to which you want to publish events.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The IAM role that authorizes Amazon Pinpoint to publish events to the stream in your account.
 {{% /md %}}
