...
<a href="#arn_csharp" style="color: inherit; text-decoration: inherit;">Arn</a>
    ...
    <dd>{{% md %}}The Amazon Resource Name of the Neptune event notification subscription.
...
<a href="#customerawsid_csharp" style="color: inherit; text-decoration: inherit;">Customer<wbr>Aws<wbr>Id</a>
    ...
    <dd>{{% md %}}The AWS customer account associated with the Neptune event notification subscription.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
