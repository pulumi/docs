...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the ClusterInstance resource produces the following computed outputs.
