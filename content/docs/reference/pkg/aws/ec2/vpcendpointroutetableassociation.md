...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">VpcEndpointRouteTableAssociation</span><span class="p">(resource_name, id, opts=None, </span>route_table_id=None<span class="p">, </span>vpc_endpoint_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Identifier of the EC2 Route Table to be associated with the VPC Endpoint.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Identifier of the VPC Endpoint with which the EC2 Route Table will be associated.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, route_<wbr>table_<wbr>id=None, vpc_<wbr>endpoint_<wbr>id=None)
```

```go
func GetVpcEndpointRouteTableAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *VpcEndpointRouteTableAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
