...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupNatGateway<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/ec2?tab=doc#GetNatGatewayArgs">GetNatGatewayArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#InvokeOption">pulumi.InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/ec2?tab=doc#LookupNatGatewayResult">LookupNatGatewayResult</a></span>, error)</span></code></pre></div>


<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Ec2.GetNatGatewayResult.html">Pulumi.Aws.Ec2.GetNatGatewayResult</a></span>> <span class="p">GetNatGateway(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Ec2.GetNatGatewayArgs.html">GetNatGatewayArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/InvokeOptions.html">InvokeOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getnatgatewayfilter">List&lt;Pulumi.<wbr>Aws.<wbr>Ec2.<wbr>Get<wbr>Nat<wbr>Gateway<wbr>Filter<wbr>Args&gt;?</a></code>
            </td>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Id of the EIP allocated to the selected Nat Gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getnatgatewayfilter">List&lt;Pulumi.<wbr>Aws.<wbr>Ec2.<wbr>Get<wbr>Nat<wbr>Gateway<wbr>Filter&gt;?</a></code>
            </td>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Id of the ENI allocated to the selected Nat Gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The private Ip address of the selected Nat Gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The public Ip (EIP) address of the selected Nat Gateway.
 {{% /md %}}
