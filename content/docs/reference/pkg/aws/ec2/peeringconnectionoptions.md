...
<span class="k">def </span><span class="nx">PeeringConnectionOptions</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">accepter</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PeeringConnectionOptionsAccepterArgs]]</span> = None<span class="p">,</span>
                             <span class="nx">requester</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PeeringConnectionOptionsRequesterArgs]]</span> = None<span class="p">,</span>
...
<a href="#accepter_nodejs" style="color: inherit; text-decoration: inherit;">accepter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#peeringconnectionoptionsaccepter">pulumi.<wbr>Input<Peering<wbr>Connection<wbr>Options<wbr>Accepter<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}An optional configuration block that allows for [VPC Peering Connection]
(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options to be set for the VPC that accepts
the peering connection (a maximum of one).
...
<a href="#requester_nodejs" style="color: inherit; text-decoration: inherit;">requester</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#peeringconnectionoptionsrequester">pulumi.<wbr>Input<Peering<wbr>Connection<wbr>Options<wbr>Requester<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A optional configuration block that allows for [VPC Peering Connection]
(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options to be set for the VPC that requests
the peering connection (a maximum of one).
...
<a href="#accepter_python" style="color: inherit; text-decoration: inherit;">accepter</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#peeringconnectionoptionsaccepter">Input[Peering<wbr>Connection<wbr>Options<wbr>Accepter<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}An optional configuration block that allows for [VPC Peering Connection]
(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options to be set for the VPC that accepts
the peering connection (a maximum of one).
...
<a href="#requester_python" style="color: inherit; text-decoration: inherit;">requester</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#peeringconnectionoptionsrequester">Input[Peering<wbr>Connection<wbr>Options<wbr>Requester<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A optional configuration block that allows for [VPC Peering Connection]
(https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options to be set for the VPC that requests
the peering connection (a maximum of one).
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">accepter</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PeeringConnectionOptionsAccepterArgs]]</span> = None<span class="p">,</span>
        <span class="nx">requester</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[PeeringConnectionOptionsRequesterArgs]]</span> = None<span class="p">,</span>
        <span class="nx">vpc_peering_connection_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> PeeringConnectionOptions</code></pre></div>
{{% /choosable %}}
