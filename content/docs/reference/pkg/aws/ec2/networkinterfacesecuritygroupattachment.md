...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">NetworkInterfaceSecurityGroupAttachment</span><span class="p">(resource_name, id, opts=None, </span>network_interface_id=None<span class="p">, </span>security_group_id=None<span class="p">, __props__=None);</span></code></pre></div>
