...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">AmiCopy</span><span class="p">(resource_name, id, opts=None, </span>description=None<span class="p">, </span>ebs_block_devices=None<span class="p">, </span>encrypted=None<span class="p">, </span>ephemeral_block_devices=None<span class="p">, </span>kms_key_id=None<span class="p">, </span>name=None<span class="p">, </span>source_ami_id=None<span class="p">, </span>source_ami_region=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, architecture=None, description=None, ebs_<wbr>block_<wbr>devices=None, ena_<wbr>support=None, encrypted=None, ephemeral_<wbr>block_<wbr>devices=None, image_<wbr>location=None, kernel_<wbr>id=None, kms_<wbr>key_<wbr>id=None, manage_<wbr>ebs_<wbr>snapshots=None, name=None, ramdisk_<wbr>id=None, root_<wbr>device_<wbr>name=None, root_<wbr>snapshot_<wbr>id=None, source_<wbr>ami_<wbr>id=None, source_<wbr>ami_<wbr>region=None, sriov_<wbr>net_<wbr>support=None, tags=None, virtualization_<wbr>type=None)
```

```go
func GetAmiCopy(ctx *pulumi.Context, name string, id pulumi.IDInput, state *AmiCopyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
