...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_nat_gateway(</span><span class="nx">filters</span><span class="p">:</span> <span class="nx">Optional[Sequence[GetNatGatewayFilter]]</span> = None<span class="p">,</span>
...
<a href="#filters_python" style="color: inherit; text-decoration: inherit;">filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getnatgatewayfilter">Sequence[Get<wbr>Nat<wbr>Gateway<wbr>Filter]</a></span>
    </dt>
    <dd>{{% md %}}Custom filter block as described below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
