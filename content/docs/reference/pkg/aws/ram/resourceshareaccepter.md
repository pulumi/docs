...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ResourceShareAccepter</span><span class="p">(resource_name, id, opts=None, </span>share_arn=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">share_<wbr>arn</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the resource share invitation.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The account ID of the receiver account which accepts the invitation.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The account ID of the sender account which submits the invitation.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the resource share.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the resource share as displayed in the console.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the resource share.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The status of the resource share (ACTIVE, PENDING, FAILED, DELETING, DELETED).
 {{% /md %}}
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">invitation_<wbr>arn</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">receiver_<wbr>account_<wbr>id</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">sender_<wbr>account_<wbr>id</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">share_<wbr>id</td>
            <td class="align-top">
...
```python
def get(resource_name, id, opts=None, invitation_<wbr>arn=None, receiver_<wbr>account_<wbr>id=None, resources=None, sender_<wbr>account_<wbr>id=None, share_<wbr>arn=None, share_<wbr>id=None, share_<wbr>name=None, status=None)
```

```go
func GetResourceShareAccepter(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResourceShareAccepterState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
