...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the EndpointConfiguration resource produces the following computed outputs.
