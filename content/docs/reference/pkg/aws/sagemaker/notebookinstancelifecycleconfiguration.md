...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the NotebookInstanceLifecycleConfiguration resource produces the following computed outputs.
