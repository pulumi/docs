...
{{% /md %}}</dd>
    ...
    <dt class="property-required"
        ...
        <span>Triggers</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#triggertrigger">List&lt;Pulumi.<wbr>Aws.<wbr>Code<wbr>Commit.<wbr>Inputs.<wbr>Trigger<wbr>Trigger<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Triggers</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#triggertrigger">List&lt;Pulumi.<wbr>Aws.<wbr>Code<wbr>Commit.<wbr>Outputs.<wbr>Trigger<wbr>Trigger&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
