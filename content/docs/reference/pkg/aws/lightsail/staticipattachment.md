...
The name of the Lightsail instance to attach the IP to
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">static_<wbr>ip_<wbr>name</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the Lightsail instance to attach the IP to
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the allocated static IP
 {{% /md %}}
