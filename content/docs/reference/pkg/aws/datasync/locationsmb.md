...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the LocationSmb resource produces the following computed outputs.
