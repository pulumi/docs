...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the EfsLocation resource produces the following computed outputs.
