...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Agent</span><span class="p">(resource_name, id, opts=None, </span>activation_key=None<span class="p">, </span>ip_address=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
