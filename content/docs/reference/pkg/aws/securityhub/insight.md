...
<span class="k">def </span><span class="nx">Insight</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">filters</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[InsightFiltersArgs]]</span> = None<span class="p">,</span>
            <span class="nx">group_by_attribute</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#filters_nodejs" style="color: inherit; text-decoration: inherit;">filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilters">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block including one or more (up to 10 distinct) attributes used to filter the findings included in the insight. The insight only includes findings that match criteria defined in the filters. See filters below for more details.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#filters_python" style="color: inherit; text-decoration: inherit;">filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilters">Input[Insight<wbr>Filters<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block including one or more (up to 10 distinct) attributes used to filter the findings included in the insight. The insight only includes findings that match criteria defined in the filters. See filters below for more details.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">filters</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[InsightFiltersArgs]]</span> = None<span class="p">,</span>
        <span class="nx">group_by_attribute</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> Insight</code></pre></div>
{{% /choosable %}}
...
<a href="#awsaccountids_nodejs" style="color: inherit; text-decoration: inherit;">aws<wbr>Account<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersawsaccountid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Aws<wbr>Account<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}AWS account ID that a finding is generated in. See String_Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#companynames_nodejs" style="color: inherit; text-decoration: inherit;">company<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscompanyname">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Company<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the findings provider (company) that owns the solution (product) that generates findings. See String_Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#compliancestatuses_nodejs" style="color: inherit; text-decoration: inherit;">compliance<wbr>Statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscompliancestatus">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Compliance<wbr>Status<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Exclusive to findings that are generated as the result of a check run against a specific rule in a supported standard, such as CIS AWS Foundations. Contains security standard-related finding details. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#confidences_nodejs" style="color: inherit; text-decoration: inherit;">confidences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersconfidence">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Confidence<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A finding's confidence. Confidence is defined as the likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. Confidence is scored on a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent confidence. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#createdats_nodejs" style="color: inherit; text-decoration: inherit;">created<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscreatedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Created<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider captured the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#criticalities_nodejs" style="color: inherit; text-decoration: inherit;">criticalities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscriticality">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Criticality<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The level of importance assigned to the resources associated with the finding. A score of 0 means that the underlying resources have no criticality, and a score of 100 is reserved for the most critical resources. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#descriptions_nodejs" style="color: inherit; text-decoration: inherit;">descriptions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersdescription">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Description<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A finding's description. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldsconfidences_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Confidences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsconfidence">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Confidence<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the finding confidence. Confidence is defined as the likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. Confidence is scored on a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent confidence. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldscriticalities_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Criticalities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldscriticality">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Criticality<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the level of importance assigned to the resources associated with the findings. A score of 0 means that the underlying resources have no criticality, and a score of 100 is reserved for the most critical resources. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldsrelatedfindingsids_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsrelatedfindingsid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The finding identifier of a related finding that is identified by the finding provider. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldsrelatedfindingsproductarns_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Product<wbr>Arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsrelatedfindingsproductarn">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Product<wbr>Arn<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The ARN of the solution that generated a related finding that is identified by the finding provider. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldsseveritylabels_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsseveritylabel">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Label<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the severity label. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldsseverityoriginals_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Originals</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsseverityoriginal">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Original<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The finding provider's original value for the severity. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#findingproviderfieldstypes_nodejs" style="color: inherit; text-decoration: inherit;">finding<wbr>Provider<wbr>Fields<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldstype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}One or more finding types that the finding provider assigned to the finding. Uses the format of `namespace/category/classifier` that classify a finding. Valid namespace values include: `Software and Configuration Checks`, `TTPs`, `Effects`, `Unusual Behaviors`, and `Sensitive Data Identifications`. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#firstobservedats_nodejs" style="color: inherit; text-decoration: inherit;">first<wbr>Observed<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfirstobservedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>First<wbr>Observed<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider first observed the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#generatorids_nodejs" style="color: inherit; text-decoration: inherit;">generator<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersgeneratorid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Generator<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The identifier for the solution-specific component (a discrete unit of logic) that generated a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ids_nodejs" style="color: inherit; text-decoration: inherit;">ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The security findings provider-specific identifier for a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#keywords_nodejs" style="color: inherit; text-decoration: inherit;">keywords</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterskeyword">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Keyword<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A keyword for a finding. See Keyword Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lastobservedats_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Observed<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterslastobservedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Last<wbr>Observed<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider most recently observed the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malwarenames_nodejs" style="color: inherit; text-decoration: inherit;">malware<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarename">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Malware<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malwarepaths_nodejs" style="color: inherit; text-decoration: inherit;">malware<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarepath">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Malware<wbr>Path<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The filesystem path of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malwarestates_nodejs" style="color: inherit; text-decoration: inherit;">malware<wbr>States</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarestate">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Malware<wbr>State<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The state of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malwaretypes_nodejs" style="color: inherit; text-decoration: inherit;">malware<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwaretype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Malware<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The type of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkdestinationdomains_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Destination<wbr>Domains</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationdomain">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Domain<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The destination domain of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkdestinationipv4s_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Destination<wbr>Ipv4s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationipv4">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Ipv4Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The destination IPv4 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkdestinationipv6s_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Destination<wbr>Ipv6s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationipv6">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Ipv6Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The destination IPv6 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkdestinationports_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Destination<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationport">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Port<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The destination port of network-related information about a finding. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkdirections_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Directions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdirection">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Direction<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Indicates the direction of network traffic associated with a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkprotocols_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Protocols</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkprotocol">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Protocol<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The protocol of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksourcedomains_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Source<wbr>Domains</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourcedomain">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Domain<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source domain of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksourceipv4s_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Source<wbr>Ipv4s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceipv4">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Ipv4Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source IPv4 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksourceipv6s_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Source<wbr>Ipv6s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceipv6">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Ipv6Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source IPv6 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksourcemacs_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Source<wbr>Macs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourcemac">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Mac<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source media access control (MAC) address of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksourceports_nodejs" style="color: inherit; text-decoration: inherit;">network<wbr>Source<wbr>Ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceport">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Port<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source port of network-related information about a finding. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#notetexts_nodejs" style="color: inherit; text-decoration: inherit;">note<wbr>Texts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnotetext">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Note<wbr>Text<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The text of a note. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#noteupdatedats_nodejs" style="color: inherit; text-decoration: inherit;">note<wbr>Updated<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The timestamp of when the note was updated. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#noteupdatedbies_nodejs" style="color: inherit; text-decoration: inherit;">note<wbr>Updated<wbr>Bies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedby">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>By<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The principal that created a note. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processlaunchedats_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Launched<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesslaunchedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Launched<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The date/time that the process was launched. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processnames_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessname">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the process. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processparentpids_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Parent<wbr>Pids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessparentpid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Parent<wbr>Pid<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The parent process ID. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processpaths_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesspath">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Path<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The path to the process executable. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processpids_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Pids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesspid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Pid<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The process ID. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#processterminatedats_nodejs" style="color: inherit; text-decoration: inherit;">process<wbr>Terminated<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessterminatedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Terminated<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The date/time that the process was terminated. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#productarns_nodejs" style="color: inherit; text-decoration: inherit;">product<wbr>Arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductarn">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Product<wbr>Arn<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The ARN generated by Security Hub that uniquely identifies a third-party company (security findings provider) after this provider's product (solution that generates findings) is registered with Security Hub. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#productfields_nodejs" style="color: inherit; text-decoration: inherit;">product<wbr>Fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductfield">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Product<wbr>Field<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A data type where security-findings providers can include additional solution-specific details that aren't part of the defined `AwsSecurityFinding` format. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#productnames_nodejs" style="color: inherit; text-decoration: inherit;">product<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductname">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Product<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the solution (product) that generates findings. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#recommendationtexts_nodejs" style="color: inherit; text-decoration: inherit;">recommendation<wbr>Texts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrecommendationtext">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Recommendation<wbr>Text<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The recommendation of what to do about the issue described in a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#recordstates_nodejs" style="color: inherit; text-decoration: inherit;">record<wbr>States</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrecordstate">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Record<wbr>State<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The updated record state for the finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#relatedfindingsids_nodejs" style="color: inherit; text-decoration: inherit;">related<wbr>Findings<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrelatedfindingsid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Related<wbr>Findings<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The solution-generated identifier for a related finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#relatedfindingsproductarns_nodejs" style="color: inherit; text-decoration: inherit;">related<wbr>Findings<wbr>Product<wbr>Arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrelatedfindingsproductarn">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Related<wbr>Findings<wbr>Product<wbr>Arn<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The ARN of the solution that generated a related finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instanceiaminstanceprofilearns_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Iam<wbr>Instance<wbr>Profile<wbr>Arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceiaminstanceprofilearn">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Iam<wbr>Instance<wbr>Profile<wbr>Arn<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The IAM profile ARN of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instanceimageids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Image<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceimageid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Image<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The Amazon Machine Image (AMI) ID of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instanceipv4addresses_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv4Addresses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceipv4address">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv4Address<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The IPv4 addresses associated with the instance. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instanceipv6addresses_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv6Addresses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceipv6address">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv6Address<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The IPv6 addresses associated with the instance. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instancekeynames_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Key<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancekeyname">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Key<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The key name associated with the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instancelaunchedats_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Launched<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancelaunchedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Launched<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The date and time the instance was launched. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instancesubnetids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Subnet<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancesubnetid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Subnet<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The identifier of the subnet that the instance was launched in. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instancetypes_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancetype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The instance type of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsec2instancevpcids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Ec2Instance<wbr>Vpc<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancevpcid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Vpc<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The identifier of the VPC that the instance was launched in. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsiamaccesskeycreatedats_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Created<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeycreatedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Created<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The creation date/time of the IAM access key related to a finding. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsiamaccesskeystatuses_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeystatus">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Status<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The status of the IAM access key related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawsiamaccesskeyusernames_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>User<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeyusername">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>User<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The user associated with the IAM access key related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawss3bucketownerids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawss3bucketownerid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The canonical user ID of the owner of the S3 bucket. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceawss3bucketownernames_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawss3bucketownername">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The display name of the owner of the S3 bucket. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcecontainerimageids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Container<wbr>Image<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerimageid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Image<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The identifier of the image related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcecontainerimagenames_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Container<wbr>Image<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerimagename">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Image<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the image related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcecontainerlaunchedats_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Container<wbr>Launched<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerlaunchedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Launched<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The date/time that the container was started. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcecontainernames_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Container<wbr>Names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainername">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Name<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The name of the container related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcedetailsothers_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Details<wbr>Others</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcedetailsother">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Details<wbr>Other<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The details of a resource that doesn't have a specific subfield for the resource type defined. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceids_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceid">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Id<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The canonical identifier for the given resource type. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcepartitions_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Partitions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcepartition">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Partition<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The canonical AWS partition name that the Region is assigned to. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceregions_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Regions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceregion">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Region<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The canonical AWS external Region name where this resource is located. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcetags_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcetag">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Tag<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A list of AWS tags associated with a resource at the time the finding was processed. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcetypes_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcetype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}Specifies the type of the resource that details are provided for. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#severitylabels_nodejs" style="color: inherit; text-decoration: inherit;">severity<wbr>Labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersseveritylabel">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Severity<wbr>Label<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The label of a finding's severity. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sourceurls_nodejs" style="color: inherit; text-decoration: inherit;">source<wbr>Urls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterssourceurl">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Source<wbr>Url<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A URL that links to a page about the current finding in the security-findings provider's solution. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatorcategories_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Categories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorcategory">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Category<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The category of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatorlastobservedats_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Last<wbr>Observed<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorlastobservedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Last<wbr>Observed<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The date/time of the last observation of a threat intelligence indicator. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatorsourceurls_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Source<wbr>Urls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorsourceurl">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Source<wbr>Url<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The URL for more details from the source of the threat intelligence. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatorsources_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorsource">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Source<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The source of the threat intelligence. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatortypes_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatortype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The type of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threatintelindicatorvalues_nodejs" style="color: inherit; text-decoration: inherit;">threat<wbr>Intel<wbr>Indicator<wbr>Values</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorvalue">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Value<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The value of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#titles_nodejs" style="color: inherit; text-decoration: inherit;">titles</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterstitle">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Title<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A finding's title. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#types_nodejs" style="color: inherit; text-decoration: inherit;">types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterstype">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Type<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A finding type in the format of `namespace/category/classifier` that classifies a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#updatedats_nodejs" style="color: inherit; text-decoration: inherit;">updated<wbr>Ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersupdatedat">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Updated<wbr>At<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider last updated the finding record. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#userdefinedvalues_nodejs" style="color: inherit; text-decoration: inherit;">user<wbr>Defined<wbr>Values</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersuserdefinedvalue">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>User<wbr>Defined<wbr>Value<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}A list of name/value string pairs associated with the finding. These are custom, user-defined fields added to a finding. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#verificationstates_nodejs" style="color: inherit; text-decoration: inherit;">verification<wbr>States</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersverificationstate">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Verification<wbr>State<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The veracity of a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workflowstatuses_nodejs" style="color: inherit; text-decoration: inherit;">workflow<wbr>Statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersworkflowstatus">pulumi.<wbr>Input<pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Workflow<wbr>Status<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The status of the investigation into a finding. See Workflow Status Filter below for more details.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#aws_account_ids_python" style="color: inherit; text-decoration: inherit;">aws_<wbr>account_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersawsaccountid">Input[Insight<wbr>Filters<wbr>Aws<wbr>Account<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}AWS account ID that a finding is generated in. See String_Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#company_names_python" style="color: inherit; text-decoration: inherit;">company_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscompanyname">Input[Insight<wbr>Filters<wbr>Company<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the findings provider (company) that owns the solution (product) that generates findings. See String_Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#compliance_statuses_python" style="color: inherit; text-decoration: inherit;">compliance_<wbr>statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscompliancestatus">Input[Insight<wbr>Filters<wbr>Compliance<wbr>Status<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Exclusive to findings that are generated as the result of a check run against a specific rule in a supported standard, such as CIS AWS Foundations. Contains security standard-related finding details. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#confidences_python" style="color: inherit; text-decoration: inherit;">confidences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersconfidence">Input[Insight<wbr>Filters<wbr>Confidence<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A finding's confidence. Confidence is defined as the likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. Confidence is scored on a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent confidence. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#created_ats_python" style="color: inherit; text-decoration: inherit;">created_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscreatedat">Input[Insight<wbr>Filters<wbr>Created<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider captured the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#criticalities_python" style="color: inherit; text-decoration: inherit;">criticalities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscriticality">Input[Insight<wbr>Filters<wbr>Criticality<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The level of importance assigned to the resources associated with the finding. A score of 0 means that the underlying resources have no criticality, and a score of 100 is reserved for the most critical resources. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#descriptions_python" style="color: inherit; text-decoration: inherit;">descriptions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersdescription">Input[Insight<wbr>Filters<wbr>Description<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A finding's description. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_confidences_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>confidences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsconfidence">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Confidence<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the finding confidence. Confidence is defined as the likelihood that a finding accurately identifies the behavior or issue that it was intended to identify. Confidence is scored on a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent confidence. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_criticalities_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>criticalities</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldscriticality">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Criticality<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the level of importance assigned to the resources associated with the findings. A score of 0 means that the underlying resources have no criticality, and a score of 100 is reserved for the most critical resources. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_related_findings_ids_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>related_<wbr>findings_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsrelatedfindingsid">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The finding identifier of a related finding that is identified by the finding provider. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_related_findings_product_arns_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>related_<wbr>findings_<wbr>product_<wbr>arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsrelatedfindingsproductarn">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Related<wbr>Findings<wbr>Product<wbr>Arn<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The ARN of the solution that generated a related finding that is identified by the finding provider. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_severity_labels_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>severity_<wbr>labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsseveritylabel">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Label<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The finding provider value for the severity label. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_severity_originals_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>severity_<wbr>originals</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldsseverityoriginal">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Severity<wbr>Original<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The finding provider's original value for the severity. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#finding_provider_fields_types_python" style="color: inherit; text-decoration: inherit;">finding_<wbr>provider_<wbr>fields_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfindingproviderfieldstype">Input[Insight<wbr>Filters<wbr>Finding<wbr>Provider<wbr>Fields<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}One or more finding types that the finding provider assigned to the finding. Uses the format of `namespace/category/classifier` that classify a finding. Valid namespace values include: `Software and Configuration Checks`, `TTPs`, `Effects`, `Unusual Behaviors`, and `Sensitive Data Identifications`. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#first_observed_ats_python" style="color: inherit; text-decoration: inherit;">first_<wbr>observed_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfirstobservedat">Input[Insight<wbr>Filters<wbr>First<wbr>Observed<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider first observed the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#generator_ids_python" style="color: inherit; text-decoration: inherit;">generator_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersgeneratorid">Input[Insight<wbr>Filters<wbr>Generator<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The identifier for the solution-specific component (a discrete unit of logic) that generated a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ids_python" style="color: inherit; text-decoration: inherit;">ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersid">Input[Insight<wbr>Filters<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The security findings provider-specific identifier for a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#keywords_python" style="color: inherit; text-decoration: inherit;">keywords</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterskeyword">Input[Insight<wbr>Filters<wbr>Keyword<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A keyword for a finding. See Keyword Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#last_observed_ats_python" style="color: inherit; text-decoration: inherit;">last_<wbr>observed_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterslastobservedat">Input[Insight<wbr>Filters<wbr>Last<wbr>Observed<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider most recently observed the potential security issue that a finding captured. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malware_names_python" style="color: inherit; text-decoration: inherit;">malware_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarename">Input[Insight<wbr>Filters<wbr>Malware<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malware_paths_python" style="color: inherit; text-decoration: inherit;">malware_<wbr>paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarepath">Input[Insight<wbr>Filters<wbr>Malware<wbr>Path<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The filesystem path of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malware_states_python" style="color: inherit; text-decoration: inherit;">malware_<wbr>states</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwarestate">Input[Insight<wbr>Filters<wbr>Malware<wbr>State<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The state of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#malware_types_python" style="color: inherit; text-decoration: inherit;">malware_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersmalwaretype">Input[Insight<wbr>Filters<wbr>Malware<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The type of the malware that was observed. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_destination_domains_python" style="color: inherit; text-decoration: inherit;">network_<wbr>destination_<wbr>domains</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationdomain">Input[Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Domain<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The destination domain of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_destination_ipv4s_python" style="color: inherit; text-decoration: inherit;">network_<wbr>destination_<wbr>ipv4s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationipv4">Input[Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Ipv4Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The destination IPv4 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_destination_ipv6s_python" style="color: inherit; text-decoration: inherit;">network_<wbr>destination_<wbr>ipv6s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationipv6">Input[Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Ipv6Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The destination IPv6 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_destination_ports_python" style="color: inherit; text-decoration: inherit;">network_<wbr>destination_<wbr>ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdestinationport">Input[Insight<wbr>Filters<wbr>Network<wbr>Destination<wbr>Port<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The destination port of network-related information about a finding. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_directions_python" style="color: inherit; text-decoration: inherit;">network_<wbr>directions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkdirection">Input[Insight<wbr>Filters<wbr>Network<wbr>Direction<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Indicates the direction of network traffic associated with a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_protocols_python" style="color: inherit; text-decoration: inherit;">network_<wbr>protocols</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworkprotocol">Input[Insight<wbr>Filters<wbr>Network<wbr>Protocol<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The protocol of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_source_domains_python" style="color: inherit; text-decoration: inherit;">network_<wbr>source_<wbr>domains</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourcedomain">Input[Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Domain<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source domain of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_source_ipv4s_python" style="color: inherit; text-decoration: inherit;">network_<wbr>source_<wbr>ipv4s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceipv4">Input[Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Ipv4Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source IPv4 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_source_ipv6s_python" style="color: inherit; text-decoration: inherit;">network_<wbr>source_<wbr>ipv6s</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceipv6">Input[Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Ipv6Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source IPv6 address of network-related information about a finding. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_source_macs_python" style="color: inherit; text-decoration: inherit;">network_<wbr>source_<wbr>macs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourcemac">Input[Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Mac<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source media access control (MAC) address of network-related information about a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#network_source_ports_python" style="color: inherit; text-decoration: inherit;">network_<wbr>source_<wbr>ports</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnetworksourceport">Input[Insight<wbr>Filters<wbr>Network<wbr>Source<wbr>Port<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source port of network-related information about a finding. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#note_texts_python" style="color: inherit; text-decoration: inherit;">note_<wbr>texts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnotetext">Input[Insight<wbr>Filters<wbr>Note<wbr>Text<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The text of a note. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#note_updated_ats_python" style="color: inherit; text-decoration: inherit;">note_<wbr>updated_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedat">Input[Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The timestamp of when the note was updated. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#note_updated_bies_python" style="color: inherit; text-decoration: inherit;">note_<wbr>updated_<wbr>bies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedby">Input[Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>By<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The principal that created a note. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_launched_ats_python" style="color: inherit; text-decoration: inherit;">process_<wbr>launched_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesslaunchedat">Input[Insight<wbr>Filters<wbr>Process<wbr>Launched<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The date/time that the process was launched. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_names_python" style="color: inherit; text-decoration: inherit;">process_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessname">Input[Insight<wbr>Filters<wbr>Process<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the process. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_parent_pids_python" style="color: inherit; text-decoration: inherit;">process_<wbr>parent_<wbr>pids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessparentpid">Input[Insight<wbr>Filters<wbr>Process<wbr>Parent<wbr>Pid<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The parent process ID. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_paths_python" style="color: inherit; text-decoration: inherit;">process_<wbr>paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesspath">Input[Insight<wbr>Filters<wbr>Process<wbr>Path<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The path to the process executable. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_pids_python" style="color: inherit; text-decoration: inherit;">process_<wbr>pids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesspid">Input[Insight<wbr>Filters<wbr>Process<wbr>Pid<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The process ID. See Number Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#process_terminated_ats_python" style="color: inherit; text-decoration: inherit;">process_<wbr>terminated_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessterminatedat">Input[Insight<wbr>Filters<wbr>Process<wbr>Terminated<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The date/time that the process was terminated. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#product_arns_python" style="color: inherit; text-decoration: inherit;">product_<wbr>arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductarn">Input[Insight<wbr>Filters<wbr>Product<wbr>Arn<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The ARN generated by Security Hub that uniquely identifies a third-party company (security findings provider) after this provider's product (solution that generates findings) is registered with Security Hub. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#product_fields_python" style="color: inherit; text-decoration: inherit;">product_<wbr>fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductfield">Input[Insight<wbr>Filters<wbr>Product<wbr>Field<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A data type where security-findings providers can include additional solution-specific details that aren't part of the defined `AwsSecurityFinding` format. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#product_names_python" style="color: inherit; text-decoration: inherit;">product_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersproductname">Input[Insight<wbr>Filters<wbr>Product<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the solution (product) that generates findings. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#recommendation_texts_python" style="color: inherit; text-decoration: inherit;">recommendation_<wbr>texts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrecommendationtext">Input[Insight<wbr>Filters<wbr>Recommendation<wbr>Text<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The recommendation of what to do about the issue described in a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#record_states_python" style="color: inherit; text-decoration: inherit;">record_<wbr>states</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrecordstate">Input[Insight<wbr>Filters<wbr>Record<wbr>State<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The updated record state for the finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#related_findings_ids_python" style="color: inherit; text-decoration: inherit;">related_<wbr>findings_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrelatedfindingsid">Input[Insight<wbr>Filters<wbr>Related<wbr>Findings<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The solution-generated identifier for a related finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#related_findings_product_arns_python" style="color: inherit; text-decoration: inherit;">related_<wbr>findings_<wbr>product_<wbr>arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersrelatedfindingsproductarn">Input[Insight<wbr>Filters<wbr>Related<wbr>Findings<wbr>Product<wbr>Arn<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The ARN of the solution that generated a related finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_iam_instance_profile_arns_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>iam_<wbr>instance_<wbr>profile_<wbr>arns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceiaminstanceprofilearn">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Iam<wbr>Instance<wbr>Profile<wbr>Arn<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The IAM profile ARN of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_image_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>image_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceimageid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Image<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The Amazon Machine Image (AMI) ID of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_ipv4_addresses_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>ipv4_<wbr>addresses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceipv4address">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv4Address<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The IPv4 addresses associated with the instance. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_ipv6_addresses_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>ipv6_<wbr>addresses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instanceipv6address">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Ipv6Address<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The IPv6 addresses associated with the instance. See Ip Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_key_names_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>key_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancekeyname">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Key<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The key name associated with the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_launched_ats_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>launched_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancelaunchedat">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Launched<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The date and time the instance was launched. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_subnet_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>subnet_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancesubnetid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Subnet<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The identifier of the subnet that the instance was launched in. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_types_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancetype">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The instance type of the instance. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_ec2_instance_vpc_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>ec2_<wbr>instance_<wbr>vpc_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancevpcid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Vpc<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The identifier of the VPC that the instance was launched in. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_iam_access_key_created_ats_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>iam_<wbr>access_<wbr>key_<wbr>created_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeycreatedat">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Created<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The creation date/time of the IAM access key related to a finding. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_iam_access_key_statuses_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>iam_<wbr>access_<wbr>key_<wbr>statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeystatus">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Status<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The status of the IAM access key related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_iam_access_key_user_names_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>iam_<wbr>access_<wbr>key_<wbr>user_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeyusername">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>User<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The user associated with the IAM access key related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_s3_bucket_owner_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>s3_<wbr>bucket_<wbr>owner_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawss3bucketownerid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The canonical user ID of the owner of the S3 bucket. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_aws_s3_bucket_owner_names_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>aws_<wbr>s3_<wbr>bucket_<wbr>owner_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawss3bucketownername">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>S3Bucket<wbr>Owner<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The display name of the owner of the S3 bucket. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_container_image_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>container_<wbr>image_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerimageid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Image<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The identifier of the image related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_container_image_names_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>container_<wbr>image_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerimagename">Input[Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Image<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the image related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_container_launched_ats_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>container_<wbr>launched_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerlaunchedat">Input[Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Launched<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The date/time that the container was started. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_container_names_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>container_<wbr>names</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainername">Input[Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Name<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The name of the container related to a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_details_others_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>details_<wbr>others</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcedetailsother">Input[Insight<wbr>Filters<wbr>Resource<wbr>Details<wbr>Other<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The details of a resource that doesn't have a specific subfield for the resource type defined. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_ids_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>ids</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceid">Input[Insight<wbr>Filters<wbr>Resource<wbr>Id<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The canonical identifier for the given resource type. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_partitions_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>partitions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcepartition">Input[Insight<wbr>Filters<wbr>Resource<wbr>Partition<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The canonical AWS partition name that the Region is assigned to. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_regions_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>regions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceregion">Input[Insight<wbr>Filters<wbr>Resource<wbr>Region<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The canonical AWS external Region name where this resource is located. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_tags_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcetag">Input[Insight<wbr>Filters<wbr>Resource<wbr>Tag<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A list of AWS tags associated with a resource at the time the finding was processed. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resource_types_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcetype">Input[Insight<wbr>Filters<wbr>Resource<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}Specifies the type of the resource that details are provided for. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#severity_labels_python" style="color: inherit; text-decoration: inherit;">severity_<wbr>labels</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersseveritylabel">Input[Insight<wbr>Filters<wbr>Severity<wbr>Label<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The label of a finding's severity. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#source_urls_python" style="color: inherit; text-decoration: inherit;">source_<wbr>urls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterssourceurl">Input[Insight<wbr>Filters<wbr>Source<wbr>Url<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A URL that links to a page about the current finding in the security-findings provider's solution. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_categories_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>categories</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorcategory">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Category<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The category of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_last_observed_ats_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>last_<wbr>observed_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorlastobservedat">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Last<wbr>Observed<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The date/time of the last observation of a threat intelligence indicator. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_source_urls_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>source_<wbr>urls</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorsourceurl">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Source<wbr>Url<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The URL for more details from the source of the threat intelligence. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_sources_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>sources</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorsource">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Source<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The source of the threat intelligence. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_types_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatortype">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The type of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#threat_intel_indicator_values_python" style="color: inherit; text-decoration: inherit;">threat_<wbr>intel_<wbr>indicator_<wbr>values</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorvalue">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Value<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The value of a threat intelligence indicator. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#titles_python" style="color: inherit; text-decoration: inherit;">titles</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterstitle">Input[Insight<wbr>Filters<wbr>Title<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A finding's title. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#types_python" style="color: inherit; text-decoration: inherit;">types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterstype">Input[Insight<wbr>Filters<wbr>Type<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A finding type in the format of `namespace/category/classifier` that classifies a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#updated_ats_python" style="color: inherit; text-decoration: inherit;">updated_<wbr>ats</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersupdatedat">Input[Insight<wbr>Filters<wbr>Updated<wbr>At<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}An ISO8601-formatted timestamp that indicates when the security-findings provider last updated the finding record. See Date Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#user_defined_values_python" style="color: inherit; text-decoration: inherit;">user_<wbr>defined_<wbr>values</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersuserdefinedvalue">Input[Insight<wbr>Filters<wbr>User<wbr>Defined<wbr>Value<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}A list of name/value string pairs associated with the finding. These are custom, user-defined fields added to a finding. See Map Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#verification_states_python" style="color: inherit; text-decoration: inherit;">verification_<wbr>states</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersverificationstate">Input[Insight<wbr>Filters<wbr>Verification<wbr>State<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The veracity of a finding. See String Filter below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workflow_statuses_python" style="color: inherit; text-decoration: inherit;">workflow_<wbr>statuses</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersworkflowstatus">Input[Insight<wbr>Filters<wbr>Workflow<wbr>Status<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The status of the investigation into a finding. See Workflow Status Filter below for more details.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscreatedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Created<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterscreatedatdaterange">Input[Insight<wbr>Filters<wbr>Created<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfirstobservedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>First<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersfirstobservedatdaterange">Input[Insight<wbr>Filters<wbr>First<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterslastobservedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Last<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfilterslastobservedatdaterange">Input[Insight<wbr>Filters<wbr>Last<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersnoteupdatedatdaterange">Input[Insight<wbr>Filters<wbr>Note<wbr>Updated<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesslaunchedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocesslaunchedatdaterange">Input[Insight<wbr>Filters<wbr>Process<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessterminatedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Process<wbr>Terminated<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersprocessterminatedatdaterange">Input[Insight<wbr>Filters<wbr>Process<wbr>Terminated<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancelaunchedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsec2instancelaunchedatdaterange">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Ec2Instance<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeycreatedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Created<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourceawsiamaccesskeycreatedatdaterange">Input[Insight<wbr>Filters<wbr>Resource<wbr>Aws<wbr>Iam<wbr>Access<wbr>Key<wbr>Created<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerlaunchedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersresourcecontainerlaunchedatdaterange">Input[Insight<wbr>Filters<wbr>Resource<wbr>Container<wbr>Launched<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorlastobservedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Last<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersthreatintelindicatorlastobservedatdaterange">Input[Insight<wbr>Filters<wbr>Threat<wbr>Intel<wbr>Indicator<wbr>Last<wbr>Observed<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#daterange_nodejs" style="color: inherit; text-decoration: inherit;">date<wbr>Range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersupdatedatdaterange">pulumi.<wbr>Input<Insight<wbr>Filters<wbr>Updated<wbr>At<wbr>Date<wbr>Range<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#date_range_python" style="color: inherit; text-decoration: inherit;">date_<wbr>range</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#insightfiltersupdatedatdaterange">Input[Insight<wbr>Filters<wbr>Updated<wbr>At<wbr>Date<wbr>Range<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A configuration block of the date range for the date filter. See date_range below for more details.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
