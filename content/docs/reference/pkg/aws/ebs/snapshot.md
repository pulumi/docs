...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Snapshot</span><span class="p">(resource_name, id, opts=None, </span>description=None<span class="p">, </span>tags=None<span class="p">, </span>volume_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A mapping of tags to assign to the snapshot
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Volume ID of which to make a snapshot.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, data_<wbr>encryption_<wbr>key_<wbr>id=None, description=None, encrypted=None, kms_<wbr>key_<wbr>id=None, owner_<wbr>alias=None, owner_<wbr>id=None, tags=None, volume_<wbr>id=None, volume_<wbr>size=None)
```

```go
func GetSnapshot(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SnapshotState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
