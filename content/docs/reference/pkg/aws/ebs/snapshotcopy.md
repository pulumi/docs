...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">SnapshotCopy</span><span class="p">(resource_name, id, opts=None, </span>description=None<span class="p">, </span>encrypted=None<span class="p">, </span>kms_key_id=None<span class="p">, </span>source_region=None<span class="p">, </span>source_snapshot_id=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, data_<wbr>encryption_<wbr>key_<wbr>id=None, description=None, encrypted=None, kms_<wbr>key_<wbr>id=None, owner_<wbr>alias=None, owner_<wbr>id=None, source_<wbr>region=None, source_<wbr>snapshot_<wbr>id=None, tags=None, volume_<wbr>id=None, volume_<wbr>size=None)
```

```go
func GetSnapshotCopy(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SnapshotCopyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
