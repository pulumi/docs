...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Organization</span><span class="p">(resource_name, id, opts=None, </span>aws_service_access_principals=None<span class="p">, </span>enabled_policy_types=None<span class="p">, </span>feature_set=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, accounts=None, arn=None, aws_<wbr>service_<wbr>access_<wbr>principals=None, enabled_<wbr>policy_<wbr>types=None, feature_<wbr>set=None, master_<wbr>account_<wbr>arn=None, master_<wbr>account_<wbr>email=None, master_<wbr>account_<wbr>id=None, non_<wbr>master_<wbr>accounts=None, roots=None)
```

```go
func GetOrganization(ctx *pulumi.Context, name string, id pulumi.IDInput, state *OrganizationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
