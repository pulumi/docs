...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">OrganizationalUnit</span><span class="p">(resource_name, id, opts=None, </span>name=None<span class="p">, </span>parent_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} ARN of the organizational unit
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name for the organizational unit
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} ID of the parent organizational unit, which may be the root
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, accounts=None, arn=None, name=None, parent_<wbr>id=None)
```

```go
func GetOrganizationalUnit(ctx *pulumi.Context, name string, id pulumi.IDInput, state *OrganizationalUnitState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
