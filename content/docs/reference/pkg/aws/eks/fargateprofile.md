...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">FargateProfile</span><span class="p">(resource_name, id, opts=None, </span>cluster_name=None<span class="p">, </span>fargate_profile_name=None<span class="p">, </span>pod_execution_role_arn=None<span class="p">, </span>selectors=None<span class="p">, </span>subnet_ids=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
Name of the EKS Cluster.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">fargate_<wbr>profile_<wbr>name</td>
            <td class="align-top">
...
Name of the EKS Fargate Profile.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">pod_<wbr>execution_<wbr>role_<wbr>arn</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the EKS Fargate Profile.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the EKS Fargate Profile.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the IAM Role that provides permissions for the EKS Fargate Profile.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Status of the EKS Fargate Profile.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, cluster_<wbr>name=None, fargate_<wbr>profile_<wbr>name=None, pod_<wbr>execution_<wbr>role_<wbr>arn=None, selectors=None, status=None, subnet_<wbr>ids=None, tags=None)
```

```go
func GetFargateProfile(ctx *pulumi.Context, name string, id pulumi.IDInput, state *FargateProfileState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
