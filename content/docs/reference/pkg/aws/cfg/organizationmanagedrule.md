...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the OrganizationManagedRule resource produces the following computed outputs.
