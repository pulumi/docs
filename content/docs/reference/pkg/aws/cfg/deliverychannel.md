...
<span class="k">def </span><span class="nx">DeliveryChannel</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">snapshot_delivery_properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[DeliveryChannelSnapshotDeliveryPropertiesArgs]]</span> = None<span class="p">,</span>
...
<a href="#snapshotdeliveryproperties_nodejs" style="color: inherit; text-decoration: inherit;">snapshot<wbr>Delivery<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deliverychannelsnapshotdeliveryproperties">pulumi.<wbr>Input<Delivery<wbr>Channel<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}Options for how AWS Config delivers configuration snapshots. See below
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#snapshot_delivery_properties_python" style="color: inherit; text-decoration: inherit;">snapshot_<wbr>delivery_<wbr>properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deliverychannelsnapshotdeliveryproperties">Input[Delivery<wbr>Channel<wbr>Snapshot<wbr>Delivery<wbr>Properties<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Options for how AWS Config delivers configuration snapshots. See below
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">s3_key_prefix</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
        <span class="nx">snapshot_delivery_properties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[DeliveryChannelSnapshotDeliveryPropertiesArgs]]</span> = None<span class="p">,</span>
        <span class="nx">sns_topic_arn</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">) -&gt;</span> DeliveryChannel</code></pre></div>
{{% /choosable %}}
