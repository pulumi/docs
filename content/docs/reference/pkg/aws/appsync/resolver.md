...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Resolver</span><span class="p">(resource_name, id, opts=None, </span>api_id=None<span class="p">, </span>data_source=None<span class="p">, </span>field=None<span class="p">, </span>kind=None<span class="p">, </span>pipeline_config=None<span class="p">, </span>request_template=None<span class="p">, </span>response_template=None<span class="p">, </span>type=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, api_<wbr>id=None, arn=None, data_<wbr>source=None, field=None, kind=None, pipeline_<wbr>config=None, request_<wbr>template=None, response_<wbr>template=None, type=None)
```

```go
func GetResolver(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResolverState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
