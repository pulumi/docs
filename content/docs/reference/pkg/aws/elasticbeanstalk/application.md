...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Application</span><span class="p">(resource_name, id, opts=None, </span>appversion_lifecycle=None<span class="p">, </span>description=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Short description of the application
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the application, must be unique within your account
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, appversion_<wbr>lifecycle=None, arn=None, description=None, name=None, tags=None)
```
