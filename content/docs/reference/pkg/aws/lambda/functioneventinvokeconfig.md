...
<h4>Function<wbr>Event<wbr>Invoke<wbr>Config<wbr>Destination<wbr>Config</h4>
{{% choosable language nodejs %}}
...
<h4>Function<wbr>Event<wbr>Invoke<wbr>Config<wbr>Destination<wbr>Config<wbr>On<wbr>Failure</h4>
{{% choosable language nodejs %}}
...
<h4>Function<wbr>Event<wbr>Invoke<wbr>Config<wbr>Destination<wbr>Config<wbr>On<wbr>Success</h4>
{{% choosable language nodejs %}}
