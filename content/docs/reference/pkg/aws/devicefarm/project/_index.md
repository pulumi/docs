...
<a href="#defaultjobtimeoutminutes_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Job<wbr>Timeout<wbr>Minutes</a>
    ...
    <dd>{{% md %}}Sets the execution timeout value (in minutes) for a project. All test runs in this project use the specified execution timeout value unless overridden when scheduling a run.
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_defaultjobtimeoutminutes_csharp">
<a href="#state_defaultjobtimeoutminutes_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Job<wbr>Timeout<wbr>Minutes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_defaultjobtimeoutminutes_go">
<a href="#state_defaultjobtimeoutminutes_go" style="color: inherit; text-decoration: inherit;">Default<wbr>Job<wbr>Timeout<wbr>Minutes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_defaultjobtimeoutminutes_nodejs">
<a href="#state_defaultjobtimeoutminutes_nodejs" style="color: inherit; text-decoration: inherit;">default<wbr>Job<wbr>Timeout<wbr>Minutes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_default_job_timeout_minutes_python">
<a href="#state_default_job_timeout_minutes_python" style="color: inherit; text-decoration: inherit;">default_<wbr>job_<wbr>timeout_<wbr>minutes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
