...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">NotificationRule</span><span class="p">(resource_name, id, opts=None, </span>detail_type=None<span class="p">, </span>event_type_ids=None<span class="p">, </span>name=None<span class="p">, </span>resource=None<span class="p">, </span>status=None<span class="p">, </span>tags=None<span class="p">, </span>targets=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">detail_<wbr>type</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The codestar notification rule ARN.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The level of detail to include in the notifications for this resource. Possible values are `BASIC` and `FULL`.
 {{% /md %}}
...
For list of allowed events see [here](https://docs.aws.amazon.com/codestar-notifications/latest/userguide/concepts.html#concepts-api).
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of notification rule.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the resource to associate with the notification rule.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The status of the notification rule. Possible values are `ENABLED` and `DISABLED`, default is `ENABLED`.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, detail_<wbr>type=None, event_<wbr>type_<wbr>ids=None, name=None, resource=None, status=None, tags=None, targets=None)
```

```go
func GetNotificationRule(ctx *pulumi.Context, name string, id pulumi.IDInput, state *NotificationRuleState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
