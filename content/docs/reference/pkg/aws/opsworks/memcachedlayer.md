...
## MemcachedLayer Resource Properties
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the MemcachedLayer resource produces the following computed outputs.
