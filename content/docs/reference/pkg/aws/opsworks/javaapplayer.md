...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the JavaAppLayer resource produces the following computed outputs.
