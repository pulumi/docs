...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the StaticWebLayer resource produces the following computed outputs.
