...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticweblayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Ops<wbr>Works.<wbr>Inputs.<wbr>Static<wbr>Web<wbr>Layer<wbr>Ebs<wbr>Volume<wbr>Args&gt;?</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span>Ebs<wbr>Volumes</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#staticweblayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Ops<wbr>Works.<wbr>Outputs.<wbr>Static<wbr>Web<wbr>Layer<wbr>Ebs<wbr>Volume&gt;?</a></span>
    </dt>
    <dd>{{% md %}}`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
{{% /md %}}</dd>
...
<h4>Static<wbr>Web<wbr>Layer<wbr>Ebs<wbr>Volume</h4>
{{% choosable language nodejs %}}
