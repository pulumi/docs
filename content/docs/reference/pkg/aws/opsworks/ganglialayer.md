...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the GangliaLayer resource produces the following computed outputs.
