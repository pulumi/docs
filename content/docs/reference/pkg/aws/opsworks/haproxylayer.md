 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">[]Haproxy<wbr>Layer<wbr>Ebs<wbr>Volume</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer&#39;s instances.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">List[Haproxy<wbr>Layer<wbr>Ebs<wbr>Volume]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer&#39;s instances.
