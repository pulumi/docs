...
Creates a HaproxyLayer resource with the given unique name, arguments, and options.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Opsworks.<wbr>Haproxy<wbr>Layer<wbr>Ebs<wbr>Volume<wbr>Args&gt;?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
...
Name of an Elastic Load Balancer to attach to this layer
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Healthcheck<wbr>Method</td>
            <td class="align-top">
...
HTTP method to use for instance healthchecks. Defaults to &#34;OPTIONS&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Healthcheck<wbr>Url</td>
            <td class="align-top">
...
The id of the stack the layer will belong to.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Stats<wbr>Enabled</td>
            <td class="align-top">
...
Whether to enable HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Stats<wbr>Password</td>
            <td class="align-top">
...
The password to use for HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Stats<wbr>Url</td>
            <td class="align-top">
...
The HAProxy stats URL. Defaults to &#34;/haproxy?stats&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Stats<wbr>User</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">[]opsworks.<wbr>Haproxy<wbr>Layer<wbr>Ebs<wbr>Volume</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer&#39;s instances.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">list[haproxy_<wbr>layer_<wbr>ebs_<wbr>volume]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer&#39;s instances.
...
Name of an Elastic Load Balancer to attach to this layer
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">healthcheck_<wbr>method</td>
            <td class="align-top">
...
HTTP method to use for instance healthchecks. Defaults to &#34;OPTIONS&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">healthcheck_<wbr>url</td>
            <td class="align-top">
...
The id of the stack the layer will belong to.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">stats_<wbr>enabled</td>
            <td class="align-top">
...
Whether to enable HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">stats_<wbr>password</td>
            <td class="align-top">
...
The password to use for HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">stats_<wbr>url</td>
            <td class="align-top">
...
The HAProxy stats URL. Defaults to &#34;/haproxy?stats&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">stats_<wbr>user</td>
            <td class="align-top">
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#haproxylayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Opsworks.<wbr>Haproxy<wbr>Layer<wbr>Ebs<wbr>Volume&gt;?</a></code>
            </td>
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} HTTP method to use for instance healthchecks. Defaults to &#34;OPTIONS&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} URL path to use for instance healthchecks. Defaults to &#34;/&#34;.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Whether to enable HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The password to use for HAProxy stats.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The HAProxy stats URL. Defaults to &#34;/haproxy?stats&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The username for HAProxy stats. Defaults to &#34;opsworks&#34;.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, auto_<wbr>assign_<wbr>elastic_<wbr>ips=None, auto_<wbr>assign_<wbr>public_<wbr>ips=None, auto_<wbr>healing=None, custom_<wbr>configure_<wbr>recipes=None, custom_<wbr>deploy_<wbr>recipes=None, custom_<wbr>instance_<wbr>profile_<wbr>arn=None, custom_<wbr>json=None, custom_<wbr>security_<wbr>group_<wbr>ids=None, custom_<wbr>setup_<wbr>recipes=None, custom_<wbr>shutdown_<wbr>recipes=None, custom_<wbr>undeploy_<wbr>recipes=None, drain_<wbr>elb_<wbr>on_<wbr>shutdown=None, ebs_<wbr>volumes=None, elastic_<wbr>load_<wbr>balancer=None, healthcheck_<wbr>method=None, healthcheck_<wbr>url=None, install_<wbr>updates_<wbr>on_<wbr>boot=None, instance_<wbr>shutdown_<wbr>timeout=None, name=None, stack_<wbr>id=None, stats_<wbr>enabled=None, stats_<wbr>password=None, stats_<wbr>url=None, stats_<wbr>user=None, system_<wbr>packages=None, use_<wbr>ebs_<wbr>optimized_<wbr>instances=None)
```

```go
func GetHaproxyLayer(ctx *pulumi.Context, name string, id pulumi.IDInput, state *HaproxyLayerState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
...
{{% lang csharp %}}
> See the <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Opsworks.HaproxyLayerEbsVolumeArgs.html">input</a> and <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Opsworks.HaproxyLayerEbsVolume.html">output</a> API doc for this type.
{{% /lang %}}
