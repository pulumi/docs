...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Permission</span><span class="p">(resource_name, id, opts=None, </span>allow_ssh=None<span class="p">, </span>allow_sudo=None<span class="p">, </span>level=None<span class="p">, </span>stack_id=None<span class="p">, </span>user_arn=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, allow_<wbr>ssh=None, allow_<wbr>sudo=None, level=None, stack_<wbr>id=None, user_<wbr>arn=None)
```
