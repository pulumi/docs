...
```python
def get(resource_name, id, opts=None, agent_<wbr>version=None, arn=None, berkshelf_<wbr>version=None, color=None, configuration_<wbr>manager_<wbr>name=None, configuration_<wbr>manager_<wbr>version=None, custom_<wbr>cookbooks_<wbr>sources=None, custom_<wbr>json=None, default_<wbr>availability_<wbr>zone=None, default_<wbr>instance_<wbr>profile_<wbr>arn=None, default_<wbr>os=None, default_<wbr>root_<wbr>device_<wbr>type=None, default_<wbr>ssh_<wbr>key_<wbr>name=None, default_<wbr>subnet_<wbr>id=None, hostname_<wbr>theme=None, manage_<wbr>berkshelf=None, name=None, region=None, service_<wbr>role_<wbr>arn=None, stack_<wbr>endpoint=None, tags=None, use_<wbr>custom_<wbr>cookbooks=None, use_<wbr>opsworks_<wbr>security_<wbr>groups=None, vpc_<wbr>id=None)
```
