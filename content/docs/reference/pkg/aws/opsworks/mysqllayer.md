...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the MysqlLayer resource produces the following computed outputs.
