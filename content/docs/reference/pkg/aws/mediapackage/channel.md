...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Mediapackage.Channel.html">Channel</a></span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span> <span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.MediaPackage.Inputs.ChannelArgs.html">ChannelArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">Pulumi.CustomResourceOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd>
    ...
    <dt class="property-"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#channelhlsingest">List&lt;Pulumi.<wbr>Aws.<wbr>Media<wbr>Package.<wbr>Outputs.<wbr>Channel<wbr>Hls<wbr>Ingest&gt;</a></span>
    </dt>
...
{{% /md %}}</dd>
    ...
    <dt class="property-optional"
        ...
        <span>Hls<wbr>Ingests</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#channelhlsingest">List&lt;Pulumi.<wbr>Aws.<wbr>Media<wbr>Package.<wbr>Inputs.<wbr>Channel<wbr>Hls<wbr>Ingest<wbr>Args&gt;?</a></span>
    </dt>
    <dd>{{% md %}}A single item list of HLS ingest information
{{% /md %}}</dd>
...
<dl class="resources-properties">
    ...
    <dt class="property-optional"
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#channelhlsingestingestendpoint">List&lt;Pulumi.<wbr>Aws.<wbr>Media<wbr>Package.<wbr>Inputs.<wbr>Channel<wbr>Hls<wbr>Ingest<wbr>Ingest<wbr>Endpoint<wbr>Args&gt;?</a></span>
    </dt>
