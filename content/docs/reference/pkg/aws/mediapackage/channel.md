...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Channel</span><span class="p">(resource_name, id, opts=None, </span>channel_id=None<span class="p">, </span>description=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
