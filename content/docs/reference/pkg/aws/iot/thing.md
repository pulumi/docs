...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Thing</span><span class="p">(resource_name, id, opts=None, </span>attributes=None<span class="p">, </span>name=None<span class="p">, </span>thing_type_name=None<span class="p">, __props__=None);</span></code></pre></div>
...
The name of the thing.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">thing_<wbr>type_<wbr>name</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the thing.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The default client ID.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the thing.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The thing type name.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The current version of the thing record in the registry.
 {{% /md %}}
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">default_<wbr>client_<wbr>id</td>
            <td class="align-top">
...
```python
def get(resource_name, id, opts=None, arn=None, attributes=None, default_<wbr>client_<wbr>id=None, name=None, thing_<wbr>type_<wbr>name=None, version=None)
```

```go
func GetThing(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ThingState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
