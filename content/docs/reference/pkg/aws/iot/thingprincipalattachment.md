...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ThingPrincipalAttachment</span><span class="p">(resource_name, id, opts=None, </span>principal=None<span class="p">, </span>thing=None<span class="p">, __props__=None);</span></code></pre></div>
