...
<span class="k">def </span><span class="nx">ServiceDependency</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">dependencies</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[ServiceDependencyDependencyArgs]]]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewServiceDependency</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ServiceDependencyArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServiceDependency</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#dependencies_nodejs" style="color: inherit; text-decoration: inherit;">dependencies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependency">pulumi<wbr>Input<pulumi<wbr>Input<Service<wbr>Dependency<wbr>Dependency<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The relationship between the `supporting_service` and `dependent_service`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dependencies_python" style="color: inherit; text-decoration: inherit;">dependencies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependency">Input[Service<wbr>Dependency<wbr>Dependency<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The relationship between the `supporting_service` and `dependent_service`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dependentservices_nodejs" style="color: inherit; text-decoration: inherit;">dependent<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependencydependentservice">pulumi<wbr>Input<pulumi<wbr>Input<Service<wbr>Dependency<wbr>Dependency<wbr>Dependent<wbr>Service<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The service that id dependent on the supporting service.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#supportingservices_nodejs" style="color: inherit; text-decoration: inherit;">supporting<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependencysupportingservice">pulumi<wbr>Input<pulumi<wbr>Input<Service<wbr>Dependency<wbr>Dependency<wbr>Supporting<wbr>Service<wbr>Args>[]></a></span>
    </dt>
    <dd>{{% md %}}The service that supports  the  dependent service.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dependent_services_python" style="color: inherit; text-decoration: inherit;">dependent_<wbr>services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependencydependentservice">Input[Service<wbr>Dependency<wbr>Dependency<wbr>Dependent<wbr>Service<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The service that id dependent on the supporting service.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#supporting_services_python" style="color: inherit; text-decoration: inherit;">supporting_<wbr>services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#servicedependencydependencysupportingservice">Input[Service<wbr>Dependency<wbr>Dependency<wbr>Supporting<wbr>Service<wbr>Args]]]</a></span>
    </dt>
    <dd>{{% md %}}The service that supports  the  dependent service.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
