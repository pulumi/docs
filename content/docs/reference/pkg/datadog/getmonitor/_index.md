...
<a href="#monitorthresholdwindows_csharp" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Threshold<wbr>Windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthresholdwindow">List&lt;Get<wbr>Monitor<wbr>Monitor<wbr>Threshold<wbr>Window&gt;</a></span>
    </dt>
...
<a href="#monitorthresholds_csharp" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Thresholds</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthreshold">List&lt;Get<wbr>Monitor<wbr>Monitor<wbr>Threshold&gt;</a></span>
    </dt>
...
<a href="#monitorthresholdwindows_go" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Threshold<wbr>Windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthresholdwindow">[]Get<wbr>Monitor<wbr>Monitor<wbr>Threshold<wbr>Window</a></span>
    </dt>
    <dd>{{% md %}}Mapping containing `recovery_window` and `trigger_window` values, e.g. `last_15m`. This is only used by anomaly monitors.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#monitorthresholds_go" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Thresholds</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthreshold">[]Get<wbr>Monitor<wbr>Monitor<wbr>Threshold</a></span>
    </dt>
    <dd>{{% md %}}Alert thresholds of the monitor.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#monitor_threshold_windows_python" style="color: inherit; text-decoration: inherit;">monitor_<wbr>threshold_<wbr>windows</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthresholdwindow">Sequence[Get<wbr>Monitor<wbr>Monitor<wbr>Threshold<wbr>Window]</a></span>
    </dt>
    <dd>{{% md %}}Mapping containing `recovery_window` and `trigger_window` values, e.g. `last_15m`. This is only used by anomaly monitors.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#monitor_thresholds_python" style="color: inherit; text-decoration: inherit;">monitor_<wbr>thresholds</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmonitormonitorthreshold">Sequence[Get<wbr>Monitor<wbr>Monitor<wbr>Threshold]</a></span>
    </dt>
    <dd>{{% md %}}Alert thresholds of the monitor.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<h4 id="getmonitormonitorthreshold">Get<wbr>Monitor<wbr>Monitor<wbr>Threshold</h4>
...
<h4 id="getmonitormonitorthresholdwindow">Get<wbr>Monitor<wbr>Monitor<wbr>Threshold<wbr>Window</h4>
