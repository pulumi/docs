...
<span class="k">def </span><span class="nx">ProfileHttp</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">accept_xff</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">app_service</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">basic_auth_realm</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                ...
                <span class="nx">encrypt_cookie_secret</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">encrypt_cookies</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                <span class="nx">fallback_host</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">fallback_status_codes</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                <span class="nx">head_erase</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">head_insert</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">insert_xforwarded_for</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">lws_separator</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">lws_width</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
                <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">oneconnect_transformations</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">proxy_type</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">redirect_rewrite</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">request_chunking</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">response_chunking</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">response_headers_permitteds</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                <span class="nx">server_agent_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">tm_partition</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">via_host_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">via_request</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">via_response</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                <span class="nx">xff_alternative_names</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">)</span>
...
The ProfileHttp resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Specifies the name of the http profile,name of Profile should be full path. Full path is the combination of the `partition + profile name`,For example `/Common/test-http-profile`.
...
<a href="#acceptxff_csharp" style="color: inherit; text-decoration: inherit;">Accept<wbr>Xff</a>
    ...
    <dd>{{% md %}}Enables or disables trusting the client IP address, and statistics from the client IP address, based on the request's XFF (X-forwarded-for) headers, if they exist.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Specifies user-defined description.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#encryptcookiesecret_csharp" style="color: inherit; text-decoration: inherit;">Encrypt<wbr>Cookie<wbr>Secret</a>
    ...
    <dd>{{% md %}}Type a passphrase for cookie encryption.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#encryptcookies_csharp" style="color: inherit; text-decoration: inherit;">Encrypt<wbr>Cookies</a>
    ...
    <dd>{{% md %}}Type the cookie names for the system to encrypt.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fallbackstatuscodes_csharp" style="color: inherit; text-decoration: inherit;">Fallback<wbr>Status<wbr>Codes</a>
    ...
    <dd>{{% md %}}Specifies one or more three-digit status codes that can be returned by an HTTP server,that should trigger a redirection to the fallback host.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#headerase_csharp" style="color: inherit; text-decoration: inherit;">Head<wbr>Erase</a>
    ...
    <dd>{{% md %}}Specifies the header string that you want to erase from an HTTP request. Default is `none`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#headinsert_csharp" style="color: inherit; text-decoration: inherit;">Head<wbr>Insert</a>
    ...
    <dd>{{% md %}}Specifies a quoted header string that you want to insert into an HTTP request.Default is `none`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#insertxforwardedfor_csharp" style="color: inherit; text-decoration: inherit;">Insert<wbr>Xforwarded<wbr>For</a>
    ...
    <dd>{{% md %}}Specifies, when enabled, that the system inserts an X-Forwarded-For header in an HTTP request with the client IP address, to use with connection pooling. The default is `Disabled`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lwsseparator_csharp" style="color: inherit; text-decoration: inherit;">Lws<wbr>Separator</a>
    ...
    <dd>{{% md %}}Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you
specify in the LWS Maximum Columns setting.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="lwswidth_csharp">
<a href="#lwswidth_csharp" style="color: inherit; text-decoration: inherit;">Lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you specify in the LWS Maximum Columns setting.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#proxytype_csharp" style="color: inherit; text-decoration: inherit;">Proxy<wbr>Type</a>
    ...
    <dd>{{% md %}}Specifies the proxy mode for this profile: reverse, explicit, or transparent. The default is `reverse`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#redirectrewrite_csharp" style="color: inherit; text-decoration: inherit;">Redirect<wbr>Rewrite</a>
    ...
    <dd>{{% md %}}Specifies whether the system rewrites the URIs that are part of HTTP redirect (3XX) responses. The default is `none`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#requestchunking_csharp" style="color: inherit; text-decoration: inherit;">Request<wbr>Chunking</a>
    ...
    <dd>{{% md %}}Specifies how the system handles HTTP content that is chunked by a client. The default is `preserve`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#responsechunking_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Chunking</a>
    ...
    <dd>{{% md %}}Specifies how the system handles HTTP content that is chunked by a server. The default is `selective`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#responseheaderspermitteds_csharp" style="color: inherit; text-decoration: inherit;">Response<wbr>Headers<wbr>Permitteds</a>
    ...
    <dd>{{% md %}}Specifies headers that the BIG-IP system allows in an HTTP response.If you are specifying more than one header, separate the headers with a blank space.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="lwswidth_go">
<a href="#lwswidth_go" style="color: inherit; text-decoration: inherit;">Lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="lwswidth_nodejs">
<a href="#lwswidth_nodejs" style="color: inherit; text-decoration: inherit;">lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="lws_width_python">
<a href="#lws_width_python" style="color: inherit; text-decoration: inherit;">lws_<wbr>width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">via_request</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">via_response</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">xff_alternative_names</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">) -&gt;</span> ProfileHttp</code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_lwswidth_csharp">
<a href="#state_lwswidth_csharp" style="color: inherit; text-decoration: inherit;">Lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_lwswidth_go">
<a href="#state_lwswidth_go" style="color: inherit; text-decoration: inherit;">Lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_lwswidth_nodejs">
<a href="#state_lwswidth_nodejs" style="color: inherit; text-decoration: inherit;">lws<wbr>Width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_lws_width_python">
<a href="#state_lws_width_python" style="color: inherit; text-decoration: inherit;">lws_<wbr>width</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
