...
All [input](#inputs) properties are implicitly available as output properties. The ProfileFastL4 resource does not produce any additional output properties.
