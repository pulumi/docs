...
<span class="k">def </span><span class="nx">Monitor</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">adaptive</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">adaptive_limit</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
            ...
            <span class="nx">ip_dscp</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
            <span class="nx">manual_resume</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            ...
            <span class="nx">receive</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">receive_disable</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">reverse</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">send</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">time_until_up</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
            ...
            <span class="nx">up_interval</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Specifies the Name of the LTM Monitor.Name of Monitor should be full path,full path is the combination of the `partition + monitor name`,For ex:`/Common/test-ltm-monitor`.
...
<a href="#parent_csharp" style="color: inherit; text-decoration: inherit;">Parent</a>
    ...
    <dd>{{% md %}}Parent monitor for the system to use for setting initial values for the new monitor.
...
<a href="#adaptive_csharp" style="color: inherit; text-decoration: inherit;">Adaptive</a>
    ...
    <dd>{{% md %}}Specifies whether adaptive response time monitoring is enabled for this monitor. The default is `disabled`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#adaptivelimit_csharp" style="color: inherit; text-decoration: inherit;">Adaptive<wbr>Limit</a>
    ...
    <dd>{{% md %}}Specifies the absolute number of milliseconds that may not be exceeded by a monitor probe, regardless of Allowed Divergence.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#interval_csharp" style="color: inherit; text-decoration: inherit;">Interval</a>
    ...
    <dd>{{% md %}}Specifies, in seconds, the frequency at which the system issues the monitor check when either the resource is down or the status of the resource is unknown. The default is `5`
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipdscp_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Dscp</a>
    ...
    <dd>{{% md %}}Displays the differentiated services code point (DSCP).The default is `0 (zero)`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#manualresume_csharp" style="color: inherit; text-decoration: inherit;">Manual<wbr>Resume</a>
    ...
    <dd>{{% md %}}Specifies whether the system automatically changes the status of a resource to Enabled at the next successful monitor check.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="mode_csharp">
...
<a href="#receive_csharp" style="color: inherit; text-decoration: inherit;">Receive</a>
    ...
    <dd>{{% md %}}Specifies the regular expression representing the text string that the monitor looks for in the returned resource.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#receivedisable_csharp" style="color: inherit; text-decoration: inherit;">Receive<wbr>Disable</a>
    ...
    <dd>{{% md %}}The system marks the node or pool member disabled when its response matches Receive Disable String but not Receive String.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#send_csharp" style="color: inherit; text-decoration: inherit;">Send</a>
    ...
    <dd>{{% md %}}Specifies the text string that the monitor sends to the target object.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timeuntilup_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Until<wbr>Up</a>
    ...
    <dd>{{% md %}}Specifies the number of seconds to wait after a resource first responds correctly to the monitor before setting the resource to up.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timeout_csharp" style="color: inherit; text-decoration: inherit;">Timeout</a>
    ...
    <dd>{{% md %}}Specifies the number of seconds the target has in which to respond to the monitor request. The default is `16` seconds
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transparent_csharp" style="color: inherit; text-decoration: inherit;">Transparent</a>
    ...
    <dd>{{% md %}}Specifies whether the monitor operates in transparent mode.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="upinterval_csharp">
<a href="#upinterval_csharp" style="color: inherit; text-decoration: inherit;">Up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}Specifies the interval for the system to use to perform the health check when a resource is up. The default is `0(Disabled)`
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="upinterval_go">
<a href="#upinterval_go" style="color: inherit; text-decoration: inherit;">Up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="upinterval_nodejs">
<a href="#upinterval_nodejs" style="color: inherit; text-decoration: inherit;">up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="up_interval_python">
<a href="#up_interval_python" style="color: inherit; text-decoration: inherit;">up_<wbr>interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">transparent</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">up_interval</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">username</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> Monitor</code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_upinterval_csharp">
<a href="#state_upinterval_csharp" style="color: inherit; text-decoration: inherit;">Up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_upinterval_go">
<a href="#state_upinterval_go" style="color: inherit; text-decoration: inherit;">Up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_upinterval_nodejs">
<a href="#state_upinterval_nodejs" style="color: inherit; text-decoration: inherit;">up<wbr>Interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_up_interval_python">
<a href="#state_up_interval_python" style="color: inherit; text-decoration: inherit;">up_<wbr>interval</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
