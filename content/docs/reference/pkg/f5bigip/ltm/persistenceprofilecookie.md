...
All [input](#inputs) properties are implicitly available as output properties. The PersistenceProfileCookie resource does not produce any additional output properties.
