...
meta_desc: "Explore the BigIqAs3 resource of the f5 BIG-IP package, including examples, input properties, output properties, lookup functions, and supporting types. `f5bigip.BigIqAs3` provides details about bigiq as3 resource"
---
...
<a href="#bigiqaddress_csharp" style="color: inherit; text-decoration: inherit;">Bigiq<wbr>Address</a>
    ...
    <dd>{{% md %}}Address of the BIG-IQ to which your targer BIG-IP is attached
{{% /md %}}</dd>
...
<a href="#bigiqpassword_csharp" style="color: inherit; text-decoration: inherit;">Bigiq<wbr>Password</a>
    ...
    <dd>{{% md %}}Password of the BIG-IQ to which your targer BIG-IP is attached
{{% /md %}}</dd>
