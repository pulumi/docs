...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_civo/#pulumi_civo.Instance">Instance</a></span><span class="p">(resource_name, </span>opts=None<span class="p">, </span>firewall_id=None<span class="p">, </span>hostname=None<span class="p">, </span>initial_user=None<span class="p">, </span>network_id=None<span class="p">, </span>notes=None<span class="p">, </span>public_ip_requiered=None<span class="p">, </span>reverse_dns=None<span class="p">, </span>script=None<span class="p">, </span>size=None<span class="p">, </span>sshkey_id=None<span class="p">, </span>tags=None<span class="p">, </span>template=None<span class="p">, </span>__props__=None<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">static </span><span class="nf">get</span><span class="p">(resource_name, id, opts=None, </span>cpu_cores=None<span class="p">, </span>created_at=None<span class="p">, </span>disk_gb=None<span class="p">, </span>firewall_id=None<span class="p">, </span>hostname=None<span class="p">, </span>initial_password=None<span class="p">, </span>initial_user=None<span class="p">, </span>network_id=None<span class="p">, </span>notes=None<span class="p">, </span>private_ip=None<span class="p">, </span>pseudo_ip=None<span class="p">, </span>public_ip=None<span class="p">, </span>public_ip_requiered=None<span class="p">, </span>ram_mb=None<span class="p">, </span>reverse_dns=None<span class="p">, </span>script=None<span class="p">, </span>size=None<span class="p">, </span>sshkey_id=None<span class="p">, </span>status=None<span class="p">, </span>tags=None<span class="p">, </span>template=None<span class="p">, __props__=None)</span></code></pre></div>
{{% /choosable %}}
...
{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Civo/Pulumi.Civo.Instance.html">Instance</a></span><span class="nf"> Get</span><span class="p">(</span><span class="nx"><a href="https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types">string</a></span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.Input.html">Input&lt;string&gt;</a></span><span class="p"> </span><span class="nx">id<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Civo/Pulumi.Civo..InstanceState.html">InstanceState</a></span><span class="p">? </span><span class="nx">state<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
