...
```python
def EventSubscription(resource_name, id, opts=None, enabled=None, event_<wbr>categories=None, name=None, name_<wbr>prefix=None, sns_<wbr>topic_<wbr>arn=None, source_<wbr>ids=None, source_<wbr>type=None, tags=None, __props__=None)
```
