...
```python
def GraphQLApi(resource_name, id, opts=None, additional_<wbr>authentication_<wbr>providers=None, authentication_<wbr>type=None, log_<wbr>config=None, name=None, openid_<wbr>connect_<wbr>config=None, schema=None, tags=None, user_<wbr>pool_<wbr>config=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, additional_<wbr>authentication_<wbr>providers=None, arn=None, authentication_<wbr>type=None, log_<wbr>config=None, name=None, openid_<wbr>connect_<wbr>config=None, schema=None, tags=None, uris=None, user_<wbr>pool_<wbr>config=None)
```

```go
func GetGraphQLApi(ctx *pulumi.Context, name string, id pulumi.IDInput, state *GraphQLApiState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
