...
```python
def Resolver(resource_name, id, opts=None, api_<wbr>id=None, data_<wbr>source=None, field=None, kind=None, pipeline_<wbr>config=None, request_<wbr>template=None, response_<wbr>template=None, type=None, __props__=None)
```
