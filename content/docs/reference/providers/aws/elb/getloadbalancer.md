...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getLoadBalancer<span class="p">(</span><span class="nx">args</span>: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/aws/elb/#GetLoadBalancerArgs">GetLoadBalancerArgs</a></span><span class="p">, </span><span class="nx">opts</span>?: <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/pulumi/#InvokeOptions">pulumi.InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/aws/elb/#GetLoadBalancerResult">GetLoadBalancerResult</a></span>></span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupLoadBalancer<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elb?tab=doc#GetLoadBalancerArgs">GetLoadBalancerArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#InvokeOption">pulumi.InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elb?tab=doc#LookupLoadBalancerResult">LookupLoadBalancerResult</a></span>, error)</span></code></pre></div>


<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elb.GetLoadBalancerResult.html">Pulumi.Aws.Elb.GetLoadBalancerResult</a></span>> <span class="p">GetLoadBalancer(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elb.GetLoadBalancerArgs.html">GetLoadBalancerArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/InvokeOptions.html">InvokeOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getloadbalanceraccesslogs">Pulumi.<wbr>Aws.<wbr>Elb.<wbr>Get<wbr>Load<wbr>Balancer<wbr>Access<wbr>Logs</a></code>
            </td>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getloadbalancerhealthcheck">Pulumi.<wbr>Aws.<wbr>Elb.<wbr>Get<wbr>Load<wbr>Balancer<wbr>Health<wbr>Check</a></code>
            </td>
            <td class="align-top">{{% md %}}  {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getloadbalancerlistener">List&lt;Pulumi.<wbr>Aws.<wbr>Elb.<wbr>Get<wbr>Load<wbr>Balancer<wbr>Listener&gt;</a></code>
            </td>
            <td class="align-top">{{% md %}}  {{% /md %}}
...
{{% lang go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elb?tab=doc#GetLoadBalancerAccessLogs">output</a> API doc for this type.
{{% /lang %}}

{{% lang csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elb.GetLoadBalancerAccessLogs.html">output</a> API doc for this type.
{{% /lang %}}
...
{{% lang go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elb?tab=doc#GetLoadBalancerHealthCheck">output</a> API doc for this type.
{{% /lang %}}

{{% lang csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elb.GetLoadBalancerHealthCheck.html">output</a> API doc for this type.
{{% /lang %}}
...
{{% lang go %}}
> See the   <a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elb?tab=doc#GetLoadBalancerListener">output</a> API doc for this type.
{{% /lang %}}

{{% lang csharp %}}
> See the   <a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elb.GetLoadBalancerListener.html">output</a> API doc for this type.
{{% /lang %}}
