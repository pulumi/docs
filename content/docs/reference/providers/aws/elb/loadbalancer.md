...
```python
def LoadBalancer(resource_name, id, opts=None, access_<wbr>logs=None, availability_<wbr>zones=None, connection_<wbr>draining=None, connection_<wbr>draining_<wbr>timeout=None, cross_<wbr>zone_<wbr>load_<wbr>balancing=None, health_<wbr>check=None, idle_<wbr>timeout=None, instances=None, internal=None, listeners=None, name=None, name_<wbr>prefix=None, security_<wbr>groups=None, source_<wbr>security_<wbr>group=None, subnets=None, tags=None, __props__=None)
```
