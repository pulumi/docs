...
```python
def LoadBalancerPolicy(resource_name, id, opts=None, load_<wbr>balancer_<wbr>name=None, policy_<wbr>attributes=None, policy_<wbr>name=None, policy_<wbr>type_<wbr>name=None, __props__=None)
```
