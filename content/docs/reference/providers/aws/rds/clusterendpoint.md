...
```python
def ClusterEndpoint(resource_name, id, opts=None, cluster_<wbr>endpoint_<wbr>identifier=None, cluster_<wbr>identifier=None, custom_<wbr>endpoint_<wbr>type=None, excluded_<wbr>members=None, static_<wbr>members=None, tags=None, __props__=None)
```
