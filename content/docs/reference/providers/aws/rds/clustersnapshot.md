...
```python
def ClusterSnapshot(resource_name, id, opts=None, db_<wbr>cluster_<wbr>identifier=None, db_<wbr>cluster_<wbr>snapshot_<wbr>identifier=None, tags=None, __props__=None)
```
