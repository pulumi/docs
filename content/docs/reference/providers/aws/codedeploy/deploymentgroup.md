...
```python
def DeploymentGroup(resource_name, id, opts=None, alarm_<wbr>configuration=None, app_<wbr>name=None, auto_<wbr>rollback_<wbr>configuration=None, autoscaling_<wbr>groups=None, blue_<wbr>green_<wbr>deployment_<wbr>config=None, deployment_<wbr>config_<wbr>name=None, deployment_<wbr>group_<wbr>name=None, deployment_<wbr>style=None, ec2_<wbr>tag_<wbr>filters=None, ec2_<wbr>tag_<wbr>sets=None, ecs_<wbr>service=None, load_<wbr>balancer_<wbr>info=None, on_<wbr>premises_<wbr>instance_<wbr>tag_<wbr>filters=None, service_<wbr>role_<wbr>arn=None, trigger_<wbr>configurations=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, alarm_<wbr>configuration=None, app_<wbr>name=None, auto_<wbr>rollback_<wbr>configuration=None, autoscaling_<wbr>groups=None, blue_<wbr>green_<wbr>deployment_<wbr>config=None, deployment_<wbr>config_<wbr>name=None, deployment_<wbr>group_<wbr>name=None, deployment_<wbr>style=None, ec2_<wbr>tag_<wbr>filters=None, ec2_<wbr>tag_<wbr>sets=None, ecs_<wbr>service=None, load_<wbr>balancer_<wbr>info=None, on_<wbr>premises_<wbr>instance_<wbr>tag_<wbr>filters=None, service_<wbr>role_<wbr>arn=None, trigger_<wbr>configurations=None)
```

```go
func GetDeploymentGroup(ctx *pulumi.Context, name string, id pulumi.IDInput, state *DeploymentGroupState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
