...
```python
def DeploymentConfig(resource_name, id, opts=None, compute_<wbr>platform=None, deployment_<wbr>config_<wbr>name=None, minimum_<wbr>healthy_<wbr>hosts=None, traffic_<wbr>routing_<wbr>config=None, __props__=None)
```
