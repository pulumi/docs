...
```python
def Classifier(resource_name, id, opts=None, csv_<wbr>classifier=None, grok_<wbr>classifier=None, json_<wbr>classifier=None, name=None, xml_<wbr>classifier=None, __props__=None)
```
