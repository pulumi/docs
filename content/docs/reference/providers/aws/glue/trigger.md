...
```python
def Trigger(resource_name, id, opts=None, actions=None, description=None, enabled=None, name=None, predicate=None, schedule=None, tags=None, type=None, workflow_<wbr>name=None, __props__=None)
```
