...
```python
def Connection(resource_name, id, opts=None, catalog_<wbr>id=None, connection_<wbr>properties=None, connection_<wbr>type=None, description=None, match_<wbr>criterias=None, name=None, physical_<wbr>connection_<wbr>requirements=None, __props__=None)
```
