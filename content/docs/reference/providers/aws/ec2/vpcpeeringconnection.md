...
```python
def VpcPeeringConnection(resource_name, id, opts=None, accepter=None, auto_<wbr>accept=None, peer_<wbr>owner_<wbr>id=None, peer_<wbr>region=None, peer_<wbr>vpc_<wbr>id=None, requester=None, tags=None, vpc_<wbr>id=None, __props__=None)
```
