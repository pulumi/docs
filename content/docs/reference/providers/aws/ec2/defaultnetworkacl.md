...
```python
def DefaultNetworkAcl(resource_name, id, opts=None, default_<wbr>network_<wbr>acl_<wbr>id=None, egress=None, ingress=None, subnet_<wbr>ids=None, tags=None, __props__=None)
```
