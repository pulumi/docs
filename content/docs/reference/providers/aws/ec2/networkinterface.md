...
```python
def NetworkInterface(resource_name, id, opts=None, attachments=None, description=None, private_<wbr>ip=None, private_<wbr>ips=None, private_<wbr>ips_<wbr>count=None, security_<wbr>groups=None, source_<wbr>dest_<wbr>check=None, subnet_<wbr>id=None, tags=None, __props__=None)
```
