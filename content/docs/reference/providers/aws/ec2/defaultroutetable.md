...
```python
def DefaultRouteTable(resource_name, id, opts=None, default_<wbr>route_<wbr>table_<wbr>id=None, propagating_<wbr>vgws=None, routes=None, tags=None, __props__=None)
```
