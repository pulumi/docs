...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">DefaultRouteTable</span><span class="p">(resource_name, id, opts=None, </span>default_route_table_id=None<span class="p">, </span>propagating_vgws=None<span class="p">, </span>routes=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, default_<wbr>route_<wbr>table_<wbr>id=None, owner_<wbr>id=None, propagating_<wbr>vgws=None, routes=None, tags=None, vpc_<wbr>id=None)
```

```go
func GetDefaultRouteTable(ctx *pulumi.Context, name string, id pulumi.IDInput, state *DefaultRouteTableState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
