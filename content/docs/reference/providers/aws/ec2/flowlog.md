...
```python
def FlowLog(resource_name, id, opts=None, eni_<wbr>id=None, iam_<wbr>role_<wbr>arn=None, log_<wbr>destination=None, log_<wbr>destination_<wbr>type=None, log_<wbr>format=None, log_<wbr>group_<wbr>name=None, subnet_<wbr>id=None, traffic_<wbr>type=None, vpc_<wbr>id=None, __props__=None)
```
