...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ProxyProtocolPolicy</span><span class="p">(resource_name, id, opts=None, </span>instance_ports=None<span class="p">, </span>load_balancer=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, instance_<wbr>ports=None, load_<wbr>balancer=None)
```

```go
func GetProxyProtocolPolicy(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ProxyProtocolPolicyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
