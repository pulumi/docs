...
```python
def Eip(resource_name, id, opts=None, associate_<wbr>with_<wbr>private_<wbr>ip=None, instance=None, network_<wbr>interface=None, public_<wbr>ipv4_<wbr>pool=None, tags=None, vpc=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, allocation_<wbr>id=None, associate_<wbr>with_<wbr>private_<wbr>ip=None, association_<wbr>id=None, domain=None, instance=None, network_<wbr>interface=None, private_<wbr>dns=None, private_<wbr>ip=None, public_<wbr>dns=None, public_<wbr>ip=None, public_<wbr>ipv4_<wbr>pool=None, tags=None, vpc=None)
```

```go
func GetEip(ctx *pulumi.Context, name string, id pulumi.IDInput, state *EipState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
