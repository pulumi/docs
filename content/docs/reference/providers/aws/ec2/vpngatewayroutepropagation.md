...
```python
def VpnGatewayRoutePropagation(resource_name, id, opts=None, route_<wbr>table_<wbr>id=None, vpn_<wbr>gateway_<wbr>id=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The id of the `aws.ec2.RouteTable` to propagate routes into.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The id of the `aws.ec2.VpnGateway` to propagate routes from.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, route_<wbr>table_<wbr>id=None, vpn_<wbr>gateway_<wbr>id=None)
```

```go
func GetVpnGatewayRoutePropagation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *VpnGatewayRoutePropagationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
