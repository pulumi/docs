...
```python
def Fleet(resource_name, id, opts=None, excess_<wbr>capacity_<wbr>termination_<wbr>policy=None, launch_<wbr>template_<wbr>config=None, on_<wbr>demand_<wbr>options=None, replace_<wbr>unhealthy_<wbr>instances=None, spot_<wbr>options=None, tags=None, target_<wbr>capacity_<wbr>specification=None, terminate_<wbr>instances=None, terminate_<wbr>instances_<wbr>with_<wbr>expiration=None, type=None, __props__=None)
```
