...
```python
def CapacityReservation(resource_name, id, opts=None, availability_<wbr>zone=None, ebs_<wbr>optimized=None, end_<wbr>date=None, end_<wbr>date_<wbr>type=None, ephemeral_<wbr>storage=None, instance_<wbr>count=None, instance_<wbr>match_<wbr>criteria=None, instance_<wbr>platform=None, instance_<wbr>type=None, tags=None, tenancy=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, availability_<wbr>zone=None, ebs_<wbr>optimized=None, end_<wbr>date=None, end_<wbr>date_<wbr>type=None, ephemeral_<wbr>storage=None, instance_<wbr>count=None, instance_<wbr>match_<wbr>criteria=None, instance_<wbr>platform=None, instance_<wbr>type=None, tags=None, tenancy=None)
```

```go
func GetCapacityReservation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *CapacityReservationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
