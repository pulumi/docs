...
```python
def AmiCopy(resource_name, id, opts=None, description=None, ebs_<wbr>block_<wbr>devices=None, encrypted=None, ephemeral_<wbr>block_<wbr>devices=None, kms_<wbr>key_<wbr>id=None, name=None, source_<wbr>ami_<wbr>id=None, source_<wbr>ami_<wbr>region=None, tags=None, __props__=None)
```
