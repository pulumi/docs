...
```python
def SecurityGroupRule(resource_name, id, opts=None, cidr_<wbr>blocks=None, description=None, from_<wbr>port=None, ipv6_<wbr>cidr_<wbr>blocks=None, prefix_<wbr>list_<wbr>ids=None, protocol=None, security_<wbr>group_<wbr>id=None, self=None, source_<wbr>security_<wbr>group_<wbr>id=None, to_<wbr>port=None, type=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, cidr_<wbr>blocks=None, description=None, from_<wbr>port=None, ipv6_<wbr>cidr_<wbr>blocks=None, prefix_<wbr>list_<wbr>ids=None, protocol=None, security_<wbr>group_<wbr>id=None, self=None, source_<wbr>security_<wbr>group_<wbr>id=None, to_<wbr>port=None, type=None)
```

```go
func GetSecurityGroupRule(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SecurityGroupRuleState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
