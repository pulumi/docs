...
```python
def VolumeAttachment(resource_name, id, opts=None, device_<wbr>name=None, force_<wbr>detach=None, instance_<wbr>id=None, skip_<wbr>destroy=None, volume_<wbr>id=None, __props__=None)
```
