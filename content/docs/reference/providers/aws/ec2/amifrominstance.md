...
```python
def AmiFromInstance(resource_name, id, opts=None, description=None, ebs_<wbr>block_<wbr>devices=None, ephemeral_<wbr>block_<wbr>devices=None, name=None, snapshot_<wbr>without_<wbr>reboot=None, source_<wbr>instance_<wbr>id=None, tags=None, __props__=None)
```
