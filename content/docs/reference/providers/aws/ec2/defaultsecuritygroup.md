...
```python
def DefaultSecurityGroup(resource_name, id, opts=None, egress=None, ingress=None, revoke_<wbr>rules_<wbr>on_<wbr>delete=None, tags=None, vpc_<wbr>id=None, __props__=None)
```
