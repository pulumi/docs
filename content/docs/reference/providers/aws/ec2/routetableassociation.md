...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RouteTableAssociation</span><span class="p">(resource_name, id, opts=None, </span>gateway_id=None<span class="p">, </span>route_table_id=None<span class="p">, </span>subnet_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The gateway ID to create an association. Conflicts with `subnet_id`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the routing table to associate with.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The subnet ID to create an association. Conflicts with `gateway_id`.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, gateway_<wbr>id=None, route_<wbr>table_<wbr>id=None, subnet_<wbr>id=None)
```
