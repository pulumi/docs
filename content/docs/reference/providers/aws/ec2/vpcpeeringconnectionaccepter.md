...
```python
def VpcPeeringConnectionAccepter(resource_name, id, opts=None, accepter=None, auto_<wbr>accept=None, requester=None, tags=None, vpc_<wbr>peering_<wbr>connection_<wbr>id=None, __props__=None)
```
