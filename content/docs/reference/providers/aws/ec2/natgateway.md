...
```python
def NatGateway(resource_name, id, opts=None, allocation_<wbr>id=None, subnet_<wbr>id=None, tags=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Allocation ID of the Elastic IP address for the gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ENI ID of the network interface created by the NAT gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The private IP address of the NAT Gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The public IP address of the NAT Gateway.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Subnet ID of the subnet in which to place the gateway.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, allocation_<wbr>id=None, network_<wbr>interface_<wbr>id=None, private_<wbr>ip=None, public_<wbr>ip=None, subnet_<wbr>id=None, tags=None)
```

```go
func GetNatGateway(ctx *pulumi.Context, name string, id pulumi.IDInput, state *NatGatewayState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
