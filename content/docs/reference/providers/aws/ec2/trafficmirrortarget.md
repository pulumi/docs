...
```python
def TrafficMirrorTarget(resource_name, id, opts=None, description=None, network_<wbr>interface_<wbr>id=None, network_<wbr>load_<wbr>balancer_<wbr>arn=None, __props__=None)
```
