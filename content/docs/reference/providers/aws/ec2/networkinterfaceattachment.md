...
```python
def NetworkInterfaceAttachment(resource_name, id, opts=None, device_<wbr>index=None, instance_<wbr>id=None, network_<wbr>interface_<wbr>id=None, __props__=None)
```
