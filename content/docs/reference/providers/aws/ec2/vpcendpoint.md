...
```python
def VpcEndpoint(resource_name, id, opts=None, auto_<wbr>accept=None, policy=None, private_<wbr>dns_<wbr>enabled=None, route_<wbr>table_<wbr>ids=None, security_<wbr>group_<wbr>ids=None, service_<wbr>name=None, subnet_<wbr>ids=None, tags=None, vpc_<wbr>endpoint_<wbr>type=None, vpc_<wbr>id=None, __props__=None)
```
