...
```python
def EipAssociation(resource_name, id, opts=None, allocation_<wbr>id=None, allow_<wbr>reassociation=None, instance_<wbr>id=None, network_<wbr>interface_<wbr>id=None, private_<wbr>ip_<wbr>address=None, public_<wbr>ip=None, __props__=None)
```
