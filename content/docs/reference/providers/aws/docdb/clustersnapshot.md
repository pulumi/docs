...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ClusterSnapshot</span><span class="p">(resource_name, id, opts=None, </span>db_cluster_identifier=None<span class="p">, </span>db_cluster_snapshot_identifier=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The DocDB Cluster Identifier from which to take the snapshot.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Amazon Resource Name (ARN) for the DocDB Cluster Snapshot.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Version of the database engine for this DocDB cluster snapshot.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} If storage_encrypted is true, the AWS KMS key identifier for the encrypted DocDB cluster snapshot.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Port that the DocDB cluster was listening on at the time of the snapshot.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The status of this DocDB Cluster Snapshot.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Specifies whether the DocDB cluster snapshot is encrypted.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The VPC ID associated with the DocDB cluster snapshot.
 {{% /md %}}
