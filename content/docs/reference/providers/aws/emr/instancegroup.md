...
```python
def InstanceGroup(resource_name, id, opts=None, autoscaling_<wbr>policy=None, bid_<wbr>price=None, cluster_<wbr>id=None, configurations_<wbr>json=None, ebs_<wbr>configs=None, ebs_<wbr>optimized=None, instance_<wbr>count=None, instance_<wbr>type=None, name=None, __props__=None)
```
