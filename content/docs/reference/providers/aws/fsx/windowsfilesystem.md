...
```python
def WindowsFileSystem(resource_name, id, opts=None, active_<wbr>directory_<wbr>id=None, automatic_<wbr>backup_<wbr>retention_<wbr>days=None, copy_<wbr>tags_<wbr>to_<wbr>backups=None, daily_<wbr>automatic_<wbr>backup_<wbr>start_<wbr>time=None, kms_<wbr>key_<wbr>id=None, security_<wbr>group_<wbr>ids=None, self_<wbr>managed_<wbr>active_<wbr>directory=None, skip_<wbr>final_<wbr>backup=None, storage_<wbr>capacity=None, subnet_<wbr>ids=None, tags=None, throughput_<wbr>capacity=None, weekly_<wbr>maintenance_<wbr>start_<wbr>time=None, __props__=None)
```
