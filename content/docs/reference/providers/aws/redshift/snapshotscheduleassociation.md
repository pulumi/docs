...
```python
def SnapshotScheduleAssociation(resource_name, id, opts=None, cluster_<wbr>identifier=None, schedule_<wbr>identifier=None, __props__=None)
```
...
Creates a SnapshotScheduleAssociation resource with the given unique name, arguments, and options.
...
The cluster identifier.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">Schedule<wbr>Identifier</td>
            <td class="align-top">
...
The cluster identifier.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">schedule_<wbr>identifier</td>
            <td class="align-top">
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The snapshot schedule identifier.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, cluster_<wbr>identifier=None, schedule_<wbr>identifier=None)
```

```go
func GetSnapshotScheduleAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SnapshotScheduleAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
