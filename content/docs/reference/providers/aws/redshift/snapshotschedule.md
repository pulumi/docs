...
```python
def SnapshotSchedule(resource_name, id, opts=None, definitions=None, description=None, force_<wbr>destroy=None, identifier=None, identifier_<wbr>prefix=None, tags=None, __props__=None)
```
