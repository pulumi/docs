...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ServiceQuota</span><span class="p">(resource_name, id, opts=None, </span>quota_code=None<span class="p">, </span>service_code=None<span class="p">, </span>value=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, adjustable=None, arn=None, default_<wbr>value=None, quota_<wbr>code=None, quota_<wbr>name=None, request_<wbr>id=None, request_<wbr>status=None, service_<wbr>code=None, service_<wbr>name=None, value=None)
```

```go
func GetServiceQuota(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ServiceQuotaState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
