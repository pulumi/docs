...
```python
def CertificateAuthority(resource_name, id, opts=None, certificate_<wbr>authority_<wbr>configuration=None, enabled=None, permanent_<wbr>deletion_<wbr>time_<wbr>in_<wbr>days=None, revocation_<wbr>configuration=None, tags=None, type=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, certificate=None, certificate_<wbr>authority_<wbr>configuration=None, certificate_<wbr>chain=None, certificate_<wbr>signing_<wbr>request=None, enabled=None, not_<wbr>after=None, not_<wbr>before=None, permanent_<wbr>deletion_<wbr>time_<wbr>in_<wbr>days=None, revocation_<wbr>configuration=None, serial=None, status=None, tags=None, type=None)
```

```go
func GetCertificateAuthority(ctx *pulumi.Context, name string, id pulumi.IDInput, state *CertificateAuthorityState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
