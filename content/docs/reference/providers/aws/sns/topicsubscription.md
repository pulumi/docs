...
```python
def TopicSubscription(resource_name, id, opts=None, confirmation_<wbr>timeout_<wbr>in_<wbr>minutes=None, delivery_<wbr>policy=None, endpoint=None, endpoint_<wbr>auto_<wbr>confirms=None, filter_<wbr>policy=None, protocol=None, raw_<wbr>message_<wbr>delivery=None, topic=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, confirmation_<wbr>timeout_<wbr>in_<wbr>minutes=None, delivery_<wbr>policy=None, endpoint=None, endpoint_<wbr>auto_<wbr>confirms=None, filter_<wbr>policy=None, protocol=None, raw_<wbr>message_<wbr>delivery=None, topic=None)
```

```go
func GetTopicSubscription(ctx *pulumi.Context, name string, id pulumi.IDInput, state *TopicSubscriptionState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
