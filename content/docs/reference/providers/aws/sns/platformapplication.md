...
```python
def PlatformApplication(resource_name, id, opts=None, event_<wbr>delivery_<wbr>failure_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>created_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>deleted_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>updated_<wbr>topic_<wbr>arn=None, failure_<wbr>feedback_<wbr>role_<wbr>arn=None, name=None, platform=None, platform_<wbr>credential=None, platform_<wbr>principal=None, success_<wbr>feedback_<wbr>role_<wbr>arn=None, success_<wbr>feedback_<wbr>sample_<wbr>rate=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, event_<wbr>delivery_<wbr>failure_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>created_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>deleted_<wbr>topic_<wbr>arn=None, event_<wbr>endpoint_<wbr>updated_<wbr>topic_<wbr>arn=None, failure_<wbr>feedback_<wbr>role_<wbr>arn=None, name=None, platform=None, platform_<wbr>credential=None, platform_<wbr>principal=None, success_<wbr>feedback_<wbr>role_<wbr>arn=None, success_<wbr>feedback_<wbr>sample_<wbr>rate=None)
```

```go
func GetPlatformApplication(ctx *pulumi.Context, name string, id pulumi.IDInput, state *PlatformApplicationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
