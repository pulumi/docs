...
```python
def LifecyclePolicy(resource_name, id, opts=None, description=None, execution_<wbr>role_<wbr>arn=None, policy_<wbr>details=None, state=None, tags=None, __props__=None)
```
