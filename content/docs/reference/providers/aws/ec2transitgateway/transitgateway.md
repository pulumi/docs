...
```python
def TransitGateway(resource_name, id, opts=None, amazon_<wbr>side_<wbr>asn=None, auto_<wbr>accept_<wbr>shared_<wbr>attachments=None, default_<wbr>route_<wbr>table_<wbr>association=None, default_<wbr>route_<wbr>table_<wbr>propagation=None, description=None, dns_<wbr>support=None, tags=None, vpn_<wbr>ecmp_<wbr>support=None, __props__=None)
```
