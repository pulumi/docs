...
```python
def RouteTablePropagation(resource_name, id, opts=None, transit_<wbr>gateway_<wbr>attachment_<wbr>id=None, transit_<wbr>gateway_<wbr>route_<wbr>table_<wbr>id=None, __props__=None)
```
