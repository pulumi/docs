...
```python
def VpcAttachment(resource_name, id, opts=None, dns_<wbr>support=None, ipv6_<wbr>support=None, subnet_<wbr>ids=None, tags=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>association=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>propagation=None, transit_<wbr>gateway_<wbr>id=None, vpc_<wbr>id=None, __props__=None)
```
