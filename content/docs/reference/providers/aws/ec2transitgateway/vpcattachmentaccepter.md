...
```python
def VpcAttachmentAccepter(resource_name, id, opts=None, tags=None, transit_<wbr>gateway_<wbr>attachment_<wbr>id=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>association=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>propagation=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, dns_<wbr>support=None, ipv6_<wbr>support=None, subnet_<wbr>ids=None, tags=None, transit_<wbr>gateway_<wbr>attachment_<wbr>id=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>association=None, transit_<wbr>gateway_<wbr>default_<wbr>route_<wbr>table_<wbr>propagation=None, transit_<wbr>gateway_<wbr>id=None, vpc_<wbr>id=None, vpc_<wbr>owner_<wbr>id=None)
```

```go
func GetVpcAttachmentAccepter(ctx *pulumi.Context, name string, id pulumi.IDInput, state *VpcAttachmentAccepterState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
