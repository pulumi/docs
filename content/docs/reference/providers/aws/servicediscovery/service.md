...
```python
def Service(resource_name, id, opts=None, description=None, dns_<wbr>config=None, health_<wbr>check_<wbr>config=None, health_<wbr>check_<wbr>custom_<wbr>config=None, name=None, namespace_<wbr>id=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, description=None, dns_<wbr>config=None, health_<wbr>check_<wbr>config=None, health_<wbr>check_<wbr>custom_<wbr>config=None, name=None, namespace_<wbr>id=None)
```

```go
func GetService(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ServiceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
