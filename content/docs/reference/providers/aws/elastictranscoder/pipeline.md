...
```python
def get(resource_name, id, opts=None, arn=None, aws_<wbr>kms_<wbr>key_<wbr>arn=None, content_<wbr>config=None, content_<wbr>config_<wbr>permissions=None, input_<wbr>bucket=None, name=None, notifications=None, output_<wbr>bucket=None, role=None, thumbnail_<wbr>config=None, thumbnail_<wbr>config_<wbr>permissions=None)
```
