...
```python
def Preset(resource_name, id, opts=None, audio=None, audio_<wbr>codec_<wbr>options=None, container=None, description=None, name=None, thumbnails=None, type=None, video=None, video_<wbr>codec_<wbr>options=None, video_<wbr>watermarks=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, audio=None, audio_<wbr>codec_<wbr>options=None, container=None, description=None, name=None, thumbnails=None, type=None, video=None, video_<wbr>codec_<wbr>options=None, video_<wbr>watermarks=None)
```

```go
func GetPreset(ctx *pulumi.Context, name string, id pulumi.IDInput, state *PresetState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
