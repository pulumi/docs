...
```python
def Policy(resource_name, id, opts=None, name=None, policy_<wbr>type=None, resource_<wbr>id=None, scalable_<wbr>dimension=None, service_<wbr>namespace=None, step_<wbr>scaling_<wbr>policy_<wbr>configuration=None, target_<wbr>tracking_<wbr>scaling_<wbr>policy_<wbr>configuration=None, __props__=None)
```
