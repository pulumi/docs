...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ServiceLinkedRole</span><span class="p">(resource_name, id, opts=None, </span>aws_service_name=None<span class="p">, </span>custom_suffix=None<span class="p">, </span>description=None<span class="p">, __props__=None);</span></code></pre></div>
