...
```python
def UserLoginProfile(resource_name, id, opts=None, password_<wbr>length=None, password_<wbr>reset_<wbr>required=None, pgp_<wbr>key=None, user=None, __props__=None)
```
