...
```python
def AccountPasswordPolicy(resource_name, id, opts=None, allow_<wbr>users_<wbr>to_<wbr>change_<wbr>password=None, hard_<wbr>expiry=None, max_<wbr>password_<wbr>age=None, minimum_<wbr>password_<wbr>length=None, password_<wbr>reuse_<wbr>prevention=None, require_<wbr>lowercase_<wbr>characters=None, require_<wbr>numbers=None, require_<wbr>symbols=None, require_<wbr>uppercase_<wbr>characters=None, __props__=None)
```
