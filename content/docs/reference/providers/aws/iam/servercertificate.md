...
```python
def ServerCertificate(resource_name, id, opts=None, arn=None, certificate_<wbr>body=None, certificate_<wbr>chain=None, name=None, name_<wbr>prefix=None, path=None, private_<wbr>key=None, __props__=None)
```
