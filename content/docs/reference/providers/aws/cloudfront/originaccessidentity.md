...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">OriginAccessIdentity</span><span class="p">(resource_name, id, opts=None, </span>comment=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, caller_<wbr>reference=None, cloudfront_<wbr>access_<wbr>identity_<wbr>path=None, comment=None, etag=None, iam_<wbr>arn=None, s3_<wbr>canonical_<wbr>user_<wbr>id=None)
```

```go
func GetOriginAccessIdentity(ctx *pulumi.Context, name string, id pulumi.IDInput, state *OriginAccessIdentityState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
