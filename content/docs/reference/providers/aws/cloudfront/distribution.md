...
```python
def Distribution(resource_name, id, opts=None, aliases=None, comment=None, custom_<wbr>error_<wbr>responses=None, default_<wbr>cache_<wbr>behavior=None, default_<wbr>root_<wbr>object=None, enabled=None, http_<wbr>version=None, is_<wbr>ipv6_<wbr>enabled=None, logging_<wbr>config=None, ordered_<wbr>cache_<wbr>behaviors=None, origin_<wbr>groups=None, origins=None, price_<wbr>class=None, restrictions=None, retain_<wbr>on_<wbr>delete=None, tags=None, viewer_<wbr>certificate=None, wait_<wbr>for_<wbr>deployment=None, web_<wbr>acl_<wbr>id=None, __props__=None)
```
