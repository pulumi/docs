...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">PublicKey</span><span class="p">(resource_name, id, opts=None, </span>comment=None<span class="p">, </span>encoded_key=None<span class="p">, </span>name=None<span class="p">, </span>name_prefix=None<span class="p">, __props__=None);</span></code></pre></div>
