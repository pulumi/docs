...
```python
def AnalyticsApplication(resource_name, id, opts=None, cloudwatch_<wbr>logging_<wbr>options=None, code=None, description=None, inputs=None, name=None, outputs=None, reference_<wbr>data_<wbr>sources=None, tags=None, __props__=None)
```
