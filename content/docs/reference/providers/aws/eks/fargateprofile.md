...
```python
def FargateProfile(resource_name, id, opts=None, cluster_<wbr>name=None, fargate_<wbr>profile_<wbr>name=None, pod_<wbr>execution_<wbr>role_<wbr>arn=None, selectors=None, subnet_<wbr>ids=None, tags=None, __props__=None)
```
