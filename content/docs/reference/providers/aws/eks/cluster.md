...
```python
def Cluster(resource_name, id, opts=None, enabled_<wbr>cluster_<wbr>log_<wbr>types=None, encryption_<wbr>config=None, name=None, role_<wbr>arn=None, tags=None, version=None, vpc_<wbr>config=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, certificate_<wbr>authority=None, created_<wbr>at=None, enabled_<wbr>cluster_<wbr>log_<wbr>types=None, encryption_<wbr>config=None, endpoint=None, identities=None, name=None, platform_<wbr>version=None, role_<wbr>arn=None, status=None, tags=None, version=None, vpc_<wbr>config=None)
```
