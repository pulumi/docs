...
```python
def TargetGroupAttachment(resource_name, id, opts=None, availability_<wbr>zone=None, port=None, target_<wbr>group_<wbr>arn=None, target_<wbr>id=None, __props__=None)
```
