...
```python
def LoadBalancer(resource_name, id, opts=None, access_<wbr>logs=None, enable_<wbr>cross_<wbr>zone_<wbr>load_<wbr>balancing=None, enable_<wbr>deletion_<wbr>protection=None, enable_<wbr>http2=None, idle_<wbr>timeout=None, internal=None, ip_<wbr>address_<wbr>type=None, load_<wbr>balancer_<wbr>type=None, name=None, name_<wbr>prefix=None, security_<wbr>groups=None, subnet_<wbr>mappings=None, subnets=None, tags=None, __props__=None)
```
