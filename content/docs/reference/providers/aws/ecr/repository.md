...
```python
def Repository(resource_name, id, opts=None, image_<wbr>scanning_<wbr>configuration=None, image_<wbr>tag_<wbr>mutability=None, name=None, tags=None, __props__=None)
```
