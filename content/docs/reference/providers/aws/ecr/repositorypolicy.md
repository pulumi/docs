...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RepositoryPolicy</span><span class="p">(resource_name, id, opts=None, </span>policy=None<span class="p">, </span>repository=None<span class="p">, __props__=None);</span></code></pre></div>
...
```go
func GetRepositoryPolicy(ctx *pulumi.Context, name string, id pulumi.IDInput, state *RepositoryPolicyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
