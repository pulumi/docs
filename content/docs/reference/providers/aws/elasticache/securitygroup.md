...
```python
def SecurityGroup(resource_name, id, opts=None, description=None, name=None, security_<wbr>group_<wbr>names=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} description for the cache security group. Defaults to &#34;Managed by Pulumi&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name for the cache security group. This value is stored as a lowercase string.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, description=None, name=None, security_<wbr>group_<wbr>names=None)
```

```go
func GetSecurityGroup(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SecurityGroupState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
