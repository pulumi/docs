...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupCluster<span class="p">(</span><span class="nx">ctx</span> *<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#Context">pulumi.Context</a></span><span class="p">, </span><span class="nx">args</span> <span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elasticache?tab=doc#GetClusterArgs">GetClusterArgs</a></span><span class="p">, </span><span class="nx">opts</span> ...<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/go/pulumi?tab=doc#InvokeOption">pulumi.InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-aws/sdk/go/aws/elasticache?tab=doc#LookupClusterResult">LookupClusterResult</a></span>, error)</span></code></pre></div>


<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span>Task&lt;<span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elasticache.GetClusterResult.html">Pulumi.Aws.Elasticache.GetClusterResult</a></span>> <span class="p">GetCluster(</span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Aws/Pulumi.Aws.Elasticache.GetClusterArgs.html">GetClusterArgs</a></span> <span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/InvokeOptions.html">InvokeOptions</a></span>? <span class="nx">opts = null<span class="p">)</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Availability Zone for the cache cluster.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#getclustercachenode">List&lt;Pulumi.<wbr>Aws.<wbr>Elasticache.<wbr>Get<wbr>Cluster<wbr>Cache<wbr>Node&gt;</a></code>
            </td>
...
Referenceable e.g. as `${data.aws_elasticache_cluster.bar.cache_nodes.0.address}`
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the cache engine.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Version number of the cache engine.
 {{% /md %}}
...
SNS topic that ElastiCache notifications get sent to.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The number of cache nodes that the cache cluster has.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the parameter group associated with this cache cluster.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The port number on which each of the cache nodes will
accept connections.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The replication group to which this cache cluster belongs.
 {{% /md %}}
...
begin taking a daily snapshot of the cache cluster.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the subnet group associated to the cache cluster.
 {{% /md %}}
