...
```python
def ConfigurationAggregator(resource_name, id, opts=None, account_<wbr>aggregation_<wbr>source=None, name=None, organization_<wbr>aggregation_<wbr>source=None, tags=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, account_<wbr>aggregation_<wbr>source=None, arn=None, name=None, organization_<wbr>aggregation_<wbr>source=None, tags=None)
```

```go
func GetConfigurationAggregator(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ConfigurationAggregatorState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
