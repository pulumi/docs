...
```python
def OrganizationManagedRule(resource_name, id, opts=None, description=None, excluded_<wbr>accounts=None, input_<wbr>parameters=None, maximum_<wbr>execution_<wbr>frequency=None, name=None, resource_<wbr>id_<wbr>scope=None, resource_<wbr>types_<wbr>scopes=None, rule_<wbr>identifier=None, tag_<wbr>key_<wbr>scope=None, tag_<wbr>value_<wbr>scope=None, __props__=None)
```
