...
```python
def DeliveryChannel(resource_name, id, opts=None, name=None, s3_<wbr>bucket_<wbr>name=None, s3_<wbr>key_<wbr>prefix=None, snapshot_<wbr>delivery_<wbr>properties=None, sns_<wbr>topic_<wbr>arn=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, name=None, s3_<wbr>bucket_<wbr>name=None, s3_<wbr>key_<wbr>prefix=None, snapshot_<wbr>delivery_<wbr>properties=None, sns_<wbr>topic_<wbr>arn=None)
```

```go
func GetDeliveryChannel(ctx *pulumi.Context, name string, id pulumi.IDInput, state *DeliveryChannelState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
