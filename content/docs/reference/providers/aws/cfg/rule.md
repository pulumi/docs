...
```python
def Rule(resource_name, id, opts=None, description=None, input_<wbr>parameters=None, maximum_<wbr>execution_<wbr>frequency=None, name=None, scope=None, source=None, tags=None, __props__=None)
```
