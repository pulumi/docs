...
```python
def EnvironmentEC2(resource_name, id, opts=None, automatic_<wbr>stop_<wbr>time_<wbr>minutes=None, description=None, instance_<wbr>type=None, name=None, owner_<wbr>arn=None, subnet_<wbr>id=None, __props__=None)
```
