...
```python
def IdentityProvider(resource_name, id, opts=None, attribute_<wbr>mapping=None, idp_<wbr>identifiers=None, provider_<wbr>details=None, provider_<wbr>name=None, provider_<wbr>type=None, user_<wbr>pool_<wbr>id=None, __props__=None)
```
...
The provider name
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">provider_<wbr>type</td>
            <td class="align-top">
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The provider name
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The provider type.  [See AWS API for valid values](https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_CreateIdentityProvider.html#CognitoUserPools-CreateIdentityProvider-request-ProviderType)
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, attribute_<wbr>mapping=None, idp_<wbr>identifiers=None, provider_<wbr>details=None, provider_<wbr>name=None, provider_<wbr>type=None, user_<wbr>pool_<wbr>id=None)
```

```go
func GetIdentityProvider(ctx *pulumi.Context, name string, id pulumi.IDInput, state *IdentityProviderState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
