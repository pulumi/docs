...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">UserPoolDomain</span><span class="p">(resource_name, id, opts=None, </span>certificate_arn=None<span class="p">, </span>domain=None<span class="p">, </span>user_pool_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, aws_<wbr>account_<wbr>id=None, certificate_<wbr>arn=None, cloudfront_<wbr>distribution_<wbr>arn=None, domain=None, s3_<wbr>bucket=None, user_<wbr>pool_<wbr>id=None, version=None)
```

```go
func GetUserPoolDomain(ctx *pulumi.Context, name string, id pulumi.IDInput, state *UserPoolDomainState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
