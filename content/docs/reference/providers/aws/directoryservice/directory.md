...
```python
def Directory(resource_name, id, opts=None, alias=None, connect_<wbr>settings=None, description=None, edition=None, enable_<wbr>sso=None, name=None, password=None, short_<wbr>name=None, size=None, tags=None, type=None, vpc_<wbr>settings=None, __props__=None)
```
