...
```python
def Server(resource_name, id, opts=None, endpoint_<wbr>details=None, endpoint_<wbr>type=None, force_<wbr>destroy=None, host_<wbr>key=None, identity_<wbr>provider_<wbr>type=None, invocation_<wbr>role=None, logging_<wbr>role=None, tags=None, url=None, __props__=None)
```
