...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">NetworkAssociation</span><span class="p">(resource_name, id, opts=None, </span>client_vpn_endpoint_id=None<span class="p">, </span>subnet_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, client_<wbr>vpn_<wbr>endpoint_<wbr>id=None, security_<wbr>groups=None, status=None, subnet_<wbr>id=None, vpc_<wbr>id=None)
```

```go
func GetNetworkAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *NetworkAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
