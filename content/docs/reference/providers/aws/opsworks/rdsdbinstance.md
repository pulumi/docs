...
```python
def RdsDbInstance(resource_name, id, opts=None, db_<wbr>password=None, db_<wbr>user=None, rds_<wbr>db_<wbr>instance_<wbr>arn=None, stack_<wbr>id=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, db_<wbr>password=None, db_<wbr>user=None, rds_<wbr>db_<wbr>instance_<wbr>arn=None, stack_<wbr>id=None)
```

```go
func GetRdsDbInstance(ctx *pulumi.Context, name string, id pulumi.IDInput, state *RdsDbInstanceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
