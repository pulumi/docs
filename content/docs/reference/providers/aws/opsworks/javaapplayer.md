...
```python
def JavaAppLayer(resource_name, id, opts=None, app_<wbr>server=None, app_<wbr>server_<wbr>version=None, auto_<wbr>assign_<wbr>elastic_<wbr>ips=None, auto_<wbr>assign_<wbr>public_<wbr>ips=None, auto_<wbr>healing=None, custom_<wbr>configure_<wbr>recipes=None, custom_<wbr>deploy_<wbr>recipes=None, custom_<wbr>instance_<wbr>profile_<wbr>arn=None, custom_<wbr>json=None, custom_<wbr>security_<wbr>group_<wbr>ids=None, custom_<wbr>setup_<wbr>recipes=None, custom_<wbr>shutdown_<wbr>recipes=None, custom_<wbr>undeploy_<wbr>recipes=None, drain_<wbr>elb_<wbr>on_<wbr>shutdown=None, ebs_<wbr>volumes=None, elastic_<wbr>load_<wbr>balancer=None, install_<wbr>updates_<wbr>on_<wbr>boot=None, instance_<wbr>shutdown_<wbr>timeout=None, jvm_<wbr>options=None, jvm_<wbr>type=None, jvm_<wbr>version=None, name=None, stack_<wbr>id=None, system_<wbr>packages=None, use_<wbr>ebs_<wbr>optimized_<wbr>instances=None, __props__=None)
```
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#javaapplayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Opsworks.<wbr>Java<wbr>App<wbr>Layer<wbr>Ebs<wbr>Volume<wbr>Args&gt;?</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#javaapplayerebsvolume">[]opsworks.<wbr>Java<wbr>App<wbr>Layer<wbr>Ebs<wbr>Volume</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Optional)
`ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer&#39;s instances.
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">app_<wbr>server</td>
            <td class="align-top">
...
Keyword for the application container to use. Defaults to &#34;tomcat&#34;.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">app_<wbr>server_<wbr>version</td>
            <td class="align-top">
...
The time, in seconds, that OpsWorks will wait for Chef to complete after triggering the Shutdown event.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">jvm_<wbr>options</td>
            <td class="align-top">
...
Options to set for the JVM.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">jvm_<wbr>type</td>
            <td class="align-top">
...
Keyword for the type of JVM to use. Defaults to `openjdk`.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">jvm_<wbr>version</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Keyword for the application container to use. Defaults to &#34;tomcat&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Version of the selected application container to use. Defaults to &#34;7&#34;.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#javaapplayerebsvolume">List&lt;Pulumi.<wbr>Aws.<wbr>Opsworks.<wbr>Java<wbr>App<wbr>Layer<wbr>Ebs<wbr>Volume&gt;?</a></code>
            </td>
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Options to set for the JVM.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Keyword for the type of JVM to use. Defaults to `openjdk`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Version of JVM to use. Defaults to &#34;7&#34;.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, app_<wbr>server=None, app_<wbr>server_<wbr>version=None, auto_<wbr>assign_<wbr>elastic_<wbr>ips=None, auto_<wbr>assign_<wbr>public_<wbr>ips=None, auto_<wbr>healing=None, custom_<wbr>configure_<wbr>recipes=None, custom_<wbr>deploy_<wbr>recipes=None, custom_<wbr>instance_<wbr>profile_<wbr>arn=None, custom_<wbr>json=None, custom_<wbr>security_<wbr>group_<wbr>ids=None, custom_<wbr>setup_<wbr>recipes=None, custom_<wbr>shutdown_<wbr>recipes=None, custom_<wbr>undeploy_<wbr>recipes=None, drain_<wbr>elb_<wbr>on_<wbr>shutdown=None, ebs_<wbr>volumes=None, elastic_<wbr>load_<wbr>balancer=None, install_<wbr>updates_<wbr>on_<wbr>boot=None, instance_<wbr>shutdown_<wbr>timeout=None, jvm_<wbr>options=None, jvm_<wbr>type=None, jvm_<wbr>version=None, name=None, stack_<wbr>id=None, system_<wbr>packages=None, use_<wbr>ebs_<wbr>optimized_<wbr>instances=None)
```

```go
func GetJavaAppLayer(ctx *pulumi.Context, name string, id pulumi.IDInput, state *JavaAppLayerState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
