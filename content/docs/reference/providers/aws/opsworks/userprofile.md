...
```python
def UserProfile(resource_name, id, opts=None, allow_<wbr>self_<wbr>management=None, ssh_<wbr>public_<wbr>key=None, ssh_<wbr>username=None, user_<wbr>arn=None, __props__=None)
```
