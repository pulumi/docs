...
```python
def Grant(resource_name, id, opts=None, constraints=None, grant_<wbr>creation_<wbr>tokens=None, grantee_<wbr>principal=None, key_<wbr>id=None, name=None, operations=None, retire_<wbr>on_<wbr>delete=None, retiring_<wbr>principal=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, constraints=None, grant_<wbr>creation_<wbr>tokens=None, grant_<wbr>id=None, grant_<wbr>token=None, grantee_<wbr>principal=None, key_<wbr>id=None, name=None, operations=None, retire_<wbr>on_<wbr>delete=None, retiring_<wbr>principal=None)
```

```go
func GetGrant(ctx *pulumi.Context, name string, id pulumi.IDInput, state *GrantState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
