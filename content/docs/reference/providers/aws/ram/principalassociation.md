...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">PrincipalAssociation</span><span class="p">(resource_name, id, opts=None, </span>principal=None<span class="p">, </span>resource_share_arn=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, principal=None, resource_<wbr>share_<wbr>arn=None)
```

```go
func GetPrincipalAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *PrincipalAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
