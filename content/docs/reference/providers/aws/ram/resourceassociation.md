...
```python
def ResourceAssociation(resource_name, id, opts=None, resource_<wbr>arn=None, resource_<wbr>share_<wbr>arn=None, __props__=None)
```
...
Amazon Resource Name (ARN) of the resource to associate with the RAM Resource Share.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">resource_<wbr>share_<wbr>arn</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the resource to associate with the RAM Resource Share.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the RAM Resource Share.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, resource_<wbr>arn=None, resource_<wbr>share_<wbr>arn=None)
```

```go
func GetResourceAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResourceAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
