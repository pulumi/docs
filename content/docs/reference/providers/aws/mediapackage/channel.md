...
```python
def Channel(resource_name, id, opts=None, channel_<wbr>id=None, description=None, tags=None, __props__=None)
```
...
Creates a Channel resource with the given unique name, arguments, and options.
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">Channel<wbr>Id</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">channel_<wbr>id</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the channel
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A unique identifier describing the channel
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} A description of the channel
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, channel_<wbr>id=None, description=None, hls_<wbr>ingests=None, tags=None)
```

```go
func GetChannel(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ChannelState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
