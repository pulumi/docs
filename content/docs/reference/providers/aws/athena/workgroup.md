...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Workgroup</span><span class="p">(resource_name, id, opts=None, </span>configuration=None<span class="p">, </span>description=None<span class="p">, </span>name=None<span class="p">, </span>state=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the workgroup
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Description of the workgroup.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the workgroup.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} State of the workgroup. Valid values are `DISABLED` or `ENABLED`. Defaults to `ENABLED`.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, configuration=None, description=None, name=None, state=None, tags=None)
```

```go
func GetWorkgroup(ctx *pulumi.Context, name string, id pulumi.IDInput, state *WorkgroupState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">bytes_<wbr>scanned_<wbr>cutoff_<wbr>per_<wbr>query</td>
            <td class="align-top">
...
Integer for the upper data usage limit (cutoff) for the amount of bytes a single query in a workgroup is allowed to scan. Must be at least `10485760`.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">enforce_<wbr>workgroup_<wbr>configuration</td>
            <td class="align-top">
...
Boolean whether the settings for the workgroup override client-side settings. For more information, see [Workgroup Settings Override Client-Side Settings](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html). Defaults to `true`.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">publish_<wbr>cloudwatch_<wbr>metrics_<wbr>enabled</td>
            <td class="align-top">
