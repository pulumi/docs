...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Hsm</span><span class="p">(resource_name, id, opts=None, </span>availability_zone=None<span class="p">, </span>cluster_id=None<span class="p">, </span>ip_address=None<span class="p">, </span>subnet_id=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The IDs of AZ in which HSM module will be located. Do not use together with subnet_id.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of Cloud HSM v2 cluster to which HSM will be added.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The id of the ENI interface allocated for HSM module.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The id of the HSM module.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The state of the HSM module.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The IP address of HSM module. Must be within the CIDR of selected subnet.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of subnet in which HSM module will be located.
 {{% /md %}}
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">hsm_<wbr>eni_<wbr>id</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">hsm_<wbr>id</td>
            <td class="align-top">
 ...
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">hsm_<wbr>state</td>
            <td class="align-top">
...
```python
def get(resource_name, id, opts=None, availability_<wbr>zone=None, cluster_<wbr>id=None, hsm_<wbr>eni_<wbr>id=None, hsm_<wbr>id=None, hsm_<wbr>state=None, ip_<wbr>address=None, subnet_<wbr>id=None)
```

```go
func GetHsm(ctx *pulumi.Context, name string, id pulumi.IDInput, state *HsmState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
