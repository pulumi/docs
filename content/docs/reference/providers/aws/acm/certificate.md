...
```python
def Certificate(resource_name, id, opts=None, certificate_<wbr>authority_<wbr>arn=None, certificate_<wbr>body=None, certificate_<wbr>chain=None, domain_<wbr>name=None, options=None, private_<wbr>key=None, subject_<wbr>alternative_<wbr>names=None, tags=None, validation_<wbr>method=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, certificate_<wbr>authority_<wbr>arn=None, certificate_<wbr>body=None, certificate_<wbr>chain=None, domain_<wbr>name=None, domain_<wbr>validation_<wbr>options=None, options=None, private_<wbr>key=None, subject_<wbr>alternative_<wbr>names=None, tags=None, validation_<wbr>emails=None, validation_<wbr>method=None)
```
