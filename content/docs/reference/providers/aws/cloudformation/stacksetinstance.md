...
```python
def StackSetInstance(resource_name, id, opts=None, account_<wbr>id=None, parameter_<wbr>overrides=None, region=None, retain_<wbr>stack=None, stack_<wbr>set_<wbr>name=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, account_<wbr>id=None, parameter_<wbr>overrides=None, region=None, retain_<wbr>stack=None, stack_<wbr>id=None, stack_<wbr>set_<wbr>name=None)
```

```go
func GetStackSetInstance(ctx *pulumi.Context, name string, id pulumi.IDInput, state *StackSetInstanceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
