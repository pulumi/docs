...
```python
def Stack(resource_name, id, opts=None, capabilities=None, disable_<wbr>rollback=None, iam_<wbr>role_<wbr>arn=None, name=None, notification_<wbr>arns=None, on_<wbr>failure=None, parameters=None, policy_<wbr>body=None, policy_<wbr>url=None, tags=None, template_<wbr>body=None, template_<wbr>url=None, timeout_<wbr>in_<wbr>minutes=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, capabilities=None, disable_<wbr>rollback=None, iam_<wbr>role_<wbr>arn=None, name=None, notification_<wbr>arns=None, on_<wbr>failure=None, outputs=None, parameters=None, policy_<wbr>body=None, policy_<wbr>url=None, tags=None, template_<wbr>body=None, template_<wbr>url=None, timeout_<wbr>in_<wbr>minutes=None)
```

```go
func GetStack(ctx *pulumi.Context, name string, id pulumi.IDInput, state *StackState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
