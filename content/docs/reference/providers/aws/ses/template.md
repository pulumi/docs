...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Template</span><span class="p">(resource_name, id, opts=None, </span>html=None<span class="p">, </span>name=None<span class="p">, </span>subject=None<span class="p">, </span>text=None<span class="p">, __props__=None);</span></code></pre></div>
