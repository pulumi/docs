...
```python
def IdentityNotificationTopic(resource_name, id, opts=None, identity=None, include_<wbr>original_<wbr>headers=None, notification_<wbr>type=None, topic_<wbr>arn=None, __props__=None)
```
