...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">CapacityProvider</span><span class="p">(resource_name, id, opts=None, </span>auto_scaling_group_provider=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Amazon Resource Name (ARN) that identifies the capacity provider.
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the capacity provider.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, auto_<wbr>scaling_<wbr>group_<wbr>provider=None, name=None, tags=None)
```

```go
func GetCapacityProvider(ctx *pulumi.Context, name string, id pulumi.IDInput, state *CapacityProviderState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
