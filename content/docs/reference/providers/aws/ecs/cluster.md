...
```python
def Cluster(resource_name, id, opts=None, capacity_<wbr>providers=None, default_<wbr>capacity_<wbr>provider_<wbr>strategies=None, name=None, settings=None, tags=None, __props__=None)
```
