...
```python
def S3BucketAssociation(resource_name, id, opts=None, bucket_<wbr>name=None, classification_<wbr>type=None, member_<wbr>account_<wbr>id=None, prefix=None, __props__=None)
```
