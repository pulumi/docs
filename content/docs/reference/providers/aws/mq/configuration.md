...
```python
def Configuration(resource_name, id, opts=None, data=None, description=None, engine_<wbr>type=None, engine_<wbr>version=None, name=None, tags=None, __props__=None)
```
