...
```python
def NotificationRule(resource_name, id, opts=None, detail_<wbr>type=None, event_<wbr>type_<wbr>ids=None, name=None, resource=None, status=None, tags=None, targets=None, __props__=None)
```
