...
```python
def ThingPrincipalAttachment(resource_name, id, opts=None, principal=None, thing=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The AWS IoT Certificate ARN or Amazon Cognito Identity ID.
 {{% /md %}}
...
```go
func GetThingPrincipalAttachment(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ThingPrincipalAttachmentState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
