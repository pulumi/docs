...
```python
def TopicRule(resource_name, id, opts=None, cloudwatch_<wbr>alarm=None, cloudwatch_<wbr>metric=None, description=None, dynamodb=None, elasticsearch=None, enabled=None, firehose=None, kinesis=None, lambda_=None, name=None, republish=None, s3=None, sns=None, sql=None, sql_<wbr>version=None, sqs=None, __props__=None)
```
