...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RoleAlias</span><span class="p">(resource_name, id, opts=None, </span>alias=None<span class="p">, </span>credential_duration=None<span class="p">, </span>role_arn=None<span class="p">, __props__=None);</span></code></pre></div>
