...
```python
def BgpPeer(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, customer_<wbr>address=None, virtual_<wbr>interface_<wbr>id=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, aws_<wbr>device=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, bgp_<wbr>peer_<wbr>id=None, bgp_<wbr>status=None, customer_<wbr>address=None, virtual_<wbr>interface_<wbr>id=None)
```

```go
func GetBgpPeer(ctx *pulumi.Context, name string, id pulumi.IDInput, state *BgpPeerState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
