...
```python
def HostedPublicVirtualInterface(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, name=None, owner_<wbr>account_<wbr>id=None, route_<wbr>filter_<wbr>prefixes=None, vlan=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, amazon_<wbr>side_<wbr>asn=None, arn=None, aws_<wbr>device=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, name=None, owner_<wbr>account_<wbr>id=None, route_<wbr>filter_<wbr>prefixes=None, vlan=None)
```

```go
func GetHostedPublicVirtualInterface(ctx *pulumi.Context, name string, id pulumi.IDInput, state *HostedPublicVirtualInterfaceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
