...
```python
def PrivateVirtualInterface(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, dx_<wbr>gateway_<wbr>id=None, mtu=None, name=None, tags=None, vlan=None, vpn_<wbr>gateway_<wbr>id=None, __props__=None)
```
...
The MTU of a virtual private interface can be either `1500` or `9001` (jumbo frames). Default is `1500`.
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ID of the virtual private gateway to which to connect the virtual interface.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, amazon_<wbr>side_<wbr>asn=None, arn=None, aws_<wbr>device=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, dx_<wbr>gateway_<wbr>id=None, jumbo_<wbr>frame_<wbr>capable=None, mtu=None, name=None, tags=None, vlan=None, vpn_<wbr>gateway_<wbr>id=None)
```

```go
func GetPrivateVirtualInterface(ctx *pulumi.Context, name string, id pulumi.IDInput, state *PrivateVirtualInterfaceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
