...
```python
def GatewayAssociation(resource_name, id, opts=None, allowed_<wbr>prefixes=None, associated_<wbr>gateway_<wbr>id=None, associated_<wbr>gateway_<wbr>owner_<wbr>account_<wbr>id=None, dx_<wbr>gateway_<wbr>id=None, proposal_<wbr>id=None, vpn_<wbr>gateway_<wbr>id=None, __props__=None)
```
