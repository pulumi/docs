...
```python
def HostedTransitVirtualInterface(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, mtu=None, name=None, owner_<wbr>account_<wbr>id=None, vlan=None, __props__=None)
```
