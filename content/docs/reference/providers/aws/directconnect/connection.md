...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Connection</span><span class="p">(resource_name, id, opts=None, </span>bandwidth=None<span class="p">, </span>location=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the connection.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Direct Connect endpoint on which the physical connection terminates.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The bandwidth of the connection. Available values: 1Gbps, 10Gbps. Case sensitive.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Indicates whether the connection supports a secondary BGP peer in the same address family (IPv4/IPv6).
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Boolean value representing if jumbo frames have been enabled for this connection.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The AWS Direct Connect location where the connection is located. See [DescribeLocations](https://docs.aws.amazon.com/directconnect/latest/APIReference/API_DescribeLocations.html) for the list of AWS Direct Connect locations. Use `locationCode`.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, aws_<wbr>device=None, bandwidth=None, has_<wbr>logical_<wbr>redundancy=None, jumbo_<wbr>frame_<wbr>capable=None, location=None, name=None, tags=None)
```

```go
func GetConnection(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ConnectionState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
