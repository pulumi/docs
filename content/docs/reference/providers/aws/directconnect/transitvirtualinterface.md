...
```python
def TransitVirtualInterface(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, dx_<wbr>gateway_<wbr>id=None, mtu=None, name=None, tags=None, vlan=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, address_<wbr>family=None, amazon_<wbr>address=None, amazon_<wbr>side_<wbr>asn=None, arn=None, aws_<wbr>device=None, bgp_<wbr>asn=None, bgp_<wbr>auth_<wbr>key=None, connection_<wbr>id=None, customer_<wbr>address=None, dx_<wbr>gateway_<wbr>id=None, jumbo_<wbr>frame_<wbr>capable=None, mtu=None, name=None, tags=None, vlan=None)
```

```go
func GetTransitVirtualInterface(ctx *pulumi.Context, name string, id pulumi.IDInput, state *TransitVirtualInterfaceState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
