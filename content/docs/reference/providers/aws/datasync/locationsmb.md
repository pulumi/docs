...
```python
def LocationSmb(resource_name, id, opts=None, agent_<wbr>arns=None, domain=None, mount_<wbr>options=None, password=None, server_<wbr>hostname=None, subdirectory=None, tags=None, user=None, __props__=None)
```
