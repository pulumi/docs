...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">NfsLocation</span><span class="p">(resource_name, id, opts=None, </span>on_prem_config=None<span class="p">, </span>server_hostname=None<span class="p">, </span>subdirectory=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, arn=None, on_<wbr>prem_<wbr>config=None, server_<wbr>hostname=None, subdirectory=None, tags=None, uri=None)
```

```go
func GetNfsLocation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *NfsLocationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
