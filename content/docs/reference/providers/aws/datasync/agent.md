...
```python
def Agent(resource_name, id, opts=None, activation_<wbr>key=None, ip_<wbr>address=None, name=None, tags=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} DataSync Agent activation key during resource creation. Conflicts with `ip_address`. If an `ip_address` is provided instead, the provider will retrieve the `activation_key` as part of the resource creation.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of the DataSync Agent.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} DataSync Agent IP address to retrieve activation key during resource creation. Conflicts with `activation_key`. DataSync Agent must be accessible on port 80 from where the provider is running.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the DataSync Agent.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Key-value pairs of resource tags to assign to the DataSync Agent.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, activation_<wbr>key=None, arn=None, ip_<wbr>address=None, name=None, tags=None)
```

```go
func GetAgent(ctx *pulumi.Context, name string, id pulumi.IDInput, state *AgentState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
