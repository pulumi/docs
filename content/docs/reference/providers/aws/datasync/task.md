...
```python
def Task(resource_name, id, opts=None, cloudwatch_<wbr>log_<wbr>group_<wbr>arn=None, destination_<wbr>location_<wbr>arn=None, name=None, options=None, source_<wbr>location_<wbr>arn=None, tags=None, __props__=None)
```
