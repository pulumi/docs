...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Task</span><span class="p">(resource_name, id, opts=None, </span>cloudwatch_log_group_arn=None<span class="p">, </span>destination_location_arn=None<span class="p">, </span>name=None<span class="p">, </span>options=None<span class="p">, </span>source_location_arn=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, arn=None, cloudwatch_<wbr>log_<wbr>group_<wbr>arn=None, destination_<wbr>location_<wbr>arn=None, name=None, options=None, source_<wbr>location_<wbr>arn=None, tags=None)
```

```go
func GetTask(ctx *pulumi.Context, name string, id pulumi.IDInput, state *TaskState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
