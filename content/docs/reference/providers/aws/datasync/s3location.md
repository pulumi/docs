...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">S3Location</span><span class="p">(resource_name, id, opts=None, </span>s3_bucket_arn=None<span class="p">, </span>s3_config=None<span class="p">, </span>subdirectory=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, arn=None, s3_<wbr>bucket_<wbr>arn=None, s3_<wbr>config=None, subdirectory=None, tags=None, uri=None)
```

```go
func GetS3Location(ctx *pulumi.Context, name string, id pulumi.IDInput, state *S3LocationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            <td class="align-top">bucket_<wbr>access_<wbr>role_<wbr>arn</td>
            <td class="align-top">
