...
```python
def Environment(resource_name, id, opts=None, application=None, cname_<wbr>prefix=None, description=None, name=None, platform_<wbr>arn=None, poll_<wbr>interval=None, settings=None, solution_<wbr>stack_<wbr>name=None, tags=None, template_<wbr>name=None, tier=None, version=None, wait_<wbr>for_<wbr>ready_<wbr>timeout=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, all_<wbr>settings=None, application=None, arn=None, autoscaling_<wbr>groups=None, cname=None, cname_<wbr>prefix=None, description=None, endpoint_<wbr>url=None, instances=None, launch_<wbr>configurations=None, load_<wbr>balancers=None, name=None, platform_<wbr>arn=None, poll_<wbr>interval=None, queues=None, settings=None, solution_<wbr>stack_<wbr>name=None, tags=None, template_<wbr>name=None, tier=None, triggers=None, version=None, wait_<wbr>for_<wbr>ready_<wbr>timeout=None)
```

```go
func GetEnvironment(ctx *pulumi.Context, name string, id pulumi.IDInput, state *EnvironmentState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
