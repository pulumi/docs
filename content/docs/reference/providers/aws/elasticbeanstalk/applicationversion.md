...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ApplicationVersion</span><span class="p">(resource_name, id, opts=None, </span>application=None<span class="p">, </span>bucket=None<span class="p">, </span>description=None<span class="p">, </span>force_delete=None<span class="p">, </span>key=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
