...
```python
def ConfigurationTemplate(resource_name, id, opts=None, application=None, description=None, environment_<wbr>id=None, name=None, settings=None, solution_<wbr>stack_<wbr>name=None, __props__=None)
```
