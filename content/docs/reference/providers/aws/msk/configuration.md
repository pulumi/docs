...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Configuration</span><span class="p">(resource_name, id, opts=None, </span>description=None<span class="p">, </span>kafka_versions=None<span class="p">, </span>name=None<span class="p">, </span>server_properties=None<span class="p">, __props__=None);</span></code></pre></div>
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name of the configuration.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Contents of the server.properties file. Supported properties are documented in the [MSK Developer Guide](https://docs.aws.amazon.com/msk/latest/developerguide/msk-configuration-properties.html).
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, description=None, kafka_<wbr>versions=None, latest_<wbr>revision=None, name=None, server_<wbr>properties=None)
```

```go
func GetConfiguration(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ConfigurationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
