...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">LifecycleHook</span><span class="p">(resource_name, id, opts=None, </span>autoscaling_group_name=None<span class="p">, </span>default_result=None<span class="p">, </span>heartbeat_timeout=None<span class="p">, </span>lifecycle_transition=None<span class="p">, </span>name=None<span class="p">, </span>notification_metadata=None<span class="p">, </span>notification_target_arn=None<span class="p">, </span>role_arn=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, autoscaling_<wbr>group_<wbr>name=None, default_<wbr>result=None, heartbeat_<wbr>timeout=None, lifecycle_<wbr>transition=None, name=None, notification_<wbr>metadata=None, notification_<wbr>target_<wbr>arn=None, role_<wbr>arn=None)
```

```go
func GetLifecycleHook(ctx *pulumi.Context, name string, id pulumi.IDInput, state *LifecycleHookState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
