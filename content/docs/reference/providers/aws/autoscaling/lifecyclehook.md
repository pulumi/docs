...
```python
def LifecycleHook(resource_name, id, opts=None, autoscaling_<wbr>group_<wbr>name=None, default_<wbr>result=None, heartbeat_<wbr>timeout=None, lifecycle_<wbr>transition=None, name=None, notification_<wbr>metadata=None, notification_<wbr>target_<wbr>arn=None, role_<wbr>arn=None, __props__=None)
```
