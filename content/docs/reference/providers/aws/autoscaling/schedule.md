...
```python
def Schedule(resource_name, id, opts=None, autoscaling_<wbr>group_<wbr>name=None, desired_<wbr>capacity=None, end_<wbr>time=None, max_<wbr>size=None, min_<wbr>size=None, recurrence=None, scheduled_<wbr>action_<wbr>name=None, start_<wbr>time=None, __props__=None)
```
