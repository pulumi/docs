...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Directory</span><span class="p">(resource_name, id, opts=None, </span>directory_id=None<span class="p">, </span>self_service_permissions=None<span class="p">, </span>subnet_ids=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, directory_<wbr>id=None, self_<wbr>service_<wbr>permissions=None, subnet_<wbr>ids=None, tags=None)
```

```go
func GetDirectory(ctx *pulumi.Context, name string, id pulumi.IDInput, state *DirectoryState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
