...
```python
def Zone(resource_name, id, opts=None, comment=None, delegation_<wbr>set_<wbr>id=None, force_<wbr>destroy=None, name=None, tags=None, vpcs=None, __props__=None)
```
