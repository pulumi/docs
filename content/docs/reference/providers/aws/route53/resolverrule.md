...
```python
def ResolverRule(resource_name, id, opts=None, domain_<wbr>name=None, name=None, resolver_<wbr>endpoint_<wbr>id=None, rule_<wbr>type=None, tags=None, target_<wbr>ips=None, __props__=None)
```
