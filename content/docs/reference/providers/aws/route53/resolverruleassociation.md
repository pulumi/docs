...
```python
def ResolverRuleAssociation(resource_name, id, opts=None, name=None, resolver_<wbr>rule_<wbr>id=None, vpc_<wbr>id=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, name=None, resolver_<wbr>rule_<wbr>id=None, vpc_<wbr>id=None)
```

```go
func GetResolverRuleAssociation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResolverRuleAssociationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
