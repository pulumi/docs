...
```python
def Member(resource_name, id, opts=None, account_<wbr>id=None, detector_<wbr>id=None, disable_<wbr>email_<wbr>notification=None, email=None, invitation_<wbr>message=None, invite=None, __props__=None)
```
