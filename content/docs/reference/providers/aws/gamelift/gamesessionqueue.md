...
```python
def GameSessionQueue(resource_name, id, opts=None, destinations=None, name=None, player_<wbr>latency_<wbr>policies=None, tags=None, timeout_<wbr>in_<wbr>seconds=None, __props__=None)
```
