...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Listener</span><span class="p">(resource_name, id, opts=None, </span>accelerator_arn=None<span class="p">, </span>client_affinity=None<span class="p">, </span>port_ranges=None<span class="p">, </span>protocol=None<span class="p">, __props__=None);</span></code></pre></div>
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#listenerportrange">list[listener_<wbr>port_<wbr>range]</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
The list of port ranges for the connections from clients to the accelerator. Fields documented below.
...
```python
def get(resource_name, id, opts=None, accelerator_<wbr>arn=None, client_<wbr>affinity=None, port_<wbr>ranges=None, protocol=None)
```
