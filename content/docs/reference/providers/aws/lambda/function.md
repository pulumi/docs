...
```python
def Function(resource_name, id, opts=None, code=None, dead_<wbr>letter_<wbr>config=None, description=None, environment=None, handler=None, kms_<wbr>key_<wbr>arn=None, layers=None, memory_<wbr>size=None, name=None, publish=None, reserved_<wbr>concurrent_<wbr>executions=None, role=None, runtime=None, s3_<wbr>bucket=None, s3_<wbr>key=None, s3_<wbr>object_<wbr>version=None, source_<wbr>code_<wbr>hash=None, tags=None, timeout=None, tracing_<wbr>config=None, vpc_<wbr>config=None, __props__=None)
```
