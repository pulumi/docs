...
```python
def LayerVersion(resource_name, id, opts=None, code=None, compatible_<wbr>runtimes=None, description=None, layer_<wbr>name=None, license_<wbr>info=None, s3_<wbr>bucket=None, s3_<wbr>key=None, s3_<wbr>object_<wbr>version=None, source_<wbr>code_<wbr>hash=None, __props__=None)
```
