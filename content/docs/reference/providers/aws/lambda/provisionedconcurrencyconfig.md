...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">ProvisionedConcurrencyConfig</span><span class="p">(resource_name, id, opts=None, </span>function_name=None<span class="p">, </span>provisioned_concurrent_executions=None<span class="p">, </span>qualifier=None<span class="p">, __props__=None);</span></code></pre></div>
...
Name or Amazon Resource Name (ARN) of the Lambda Function.
 {{% /md %}}
        ...
        <tr>
            <td class="align-top">provisioned_<wbr>concurrent_<wbr>executions</td>
            <td class="align-top">
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Name or Amazon Resource Name (ARN) of the Lambda Function.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amount of capacity to allocate. Must be greater than or equal to `1`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Lambda Function version or Lambda Alias name.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, function_<wbr>name=None, provisioned_<wbr>concurrent_<wbr>executions=None, qualifier=None)
```

```go
func GetProvisionedConcurrencyConfig(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ProvisionedConcurrencyConfigState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
