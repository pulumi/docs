...
```python
def ProvisionedConcurrencyConfig(resource_name, id, opts=None, function_<wbr>name=None, provisioned_<wbr>concurrent_<wbr>executions=None, qualifier=None, __props__=None)
```
