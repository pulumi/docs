...
```python
def Alias(resource_name, id, opts=None, description=None, function_<wbr>name=None, function_<wbr>version=None, name=None, routing_<wbr>config=None, __props__=None)
```
