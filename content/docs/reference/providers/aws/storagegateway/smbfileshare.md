...
```python
def SmbFileShare(resource_name, id, opts=None, authentication=None, default_<wbr>storage_<wbr>class=None, gateway_<wbr>arn=None, guess_<wbr>mime_<wbr>type_<wbr>enabled=None, invalid_<wbr>user_<wbr>lists=None, kms_<wbr>encrypted=None, kms_<wbr>key_<wbr>arn=None, location_<wbr>arn=None, object_<wbr>acl=None, read_<wbr>only=None, requester_<wbr>pays=None, role_<wbr>arn=None, tags=None, valid_<wbr>user_<wbr>lists=None, __props__=None)
```
