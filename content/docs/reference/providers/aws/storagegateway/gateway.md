...
```python
def Gateway(resource_name, id, opts=None, activation_<wbr>key=None, cloudwatch_<wbr>log_<wbr>group_<wbr>arn=None, gateway_<wbr>ip_<wbr>address=None, gateway_<wbr>name=None, gateway_<wbr>timezone=None, gateway_<wbr>type=None, medium_<wbr>changer_<wbr>type=None, smb_<wbr>active_<wbr>directory_<wbr>settings=None, smb_<wbr>guest_<wbr>password=None, tags=None, tape_<wbr>drive_<wbr>type=None, __props__=None)
```
