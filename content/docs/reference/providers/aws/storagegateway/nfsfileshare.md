...
```python
def NfsFileShare(resource_name, id, opts=None, client_<wbr>lists=None, default_<wbr>storage_<wbr>class=None, gateway_<wbr>arn=None, guess_<wbr>mime_<wbr>type_<wbr>enabled=None, kms_<wbr>encrypted=None, kms_<wbr>key_<wbr>arn=None, location_<wbr>arn=None, nfs_<wbr>file_<wbr>share_<wbr>defaults=None, object_<wbr>acl=None, read_<wbr>only=None, requester_<wbr>pays=None, role_<wbr>arn=None, squash=None, tags=None, __props__=None)
```
