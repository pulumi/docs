...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">NfsFileShare</span><span class="p">(resource_name, id, opts=None, </span>client_lists=None<span class="p">, </span>default_storage_class=None<span class="p">, </span>gateway_arn=None<span class="p">, </span>guess_mime_type_enabled=None<span class="p">, </span>kms_encrypted=None<span class="p">, </span>kms_key_arn=None<span class="p">, </span>location_arn=None<span class="p">, </span>nfs_file_share_defaults=None<span class="p">, </span>object_acl=None<span class="p">, </span>read_only=None<span class="p">, </span>requester_pays=None<span class="p">, </span>role_arn=None<span class="p">, </span>squash=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, arn=None, client_<wbr>lists=None, default_<wbr>storage_<wbr>class=None, fileshare_<wbr>id=None, gateway_<wbr>arn=None, guess_<wbr>mime_<wbr>type_<wbr>enabled=None, kms_<wbr>encrypted=None, kms_<wbr>key_<wbr>arn=None, location_<wbr>arn=None, nfs_<wbr>file_<wbr>share_<wbr>defaults=None, object_<wbr>acl=None, read_<wbr>only=None, requester_<wbr>pays=None, role_<wbr>arn=None, squash=None, tags=None)
```

```go
func GetNfsFileShare(ctx *pulumi.Context, name string, id pulumi.IDInput, state *NfsFileShareState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
