...
```python
def BucketPublicAccessBlock(resource_name, id, opts=None, block_<wbr>public_<wbr>acls=None, block_<wbr>public_<wbr>policy=None, bucket=None, ignore_<wbr>public_<wbr>acls=None, restrict_<wbr>public_<wbr>buckets=None, __props__=None)
```
