...
```python
def WebAcl(resource_name, id, opts=None, default_<wbr>action=None, logging_<wbr>configuration=None, metric_<wbr>name=None, name=None, rules=None, tags=None, __props__=None)
```
