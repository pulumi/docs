...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">VaultLock</span><span class="p">(resource_name, id, opts=None, </span>complete_lock=None<span class="p">, </span>ignore_deletion_error=None<span class="p">, </span>policy=None<span class="p">, </span>vault_name=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, complete_<wbr>lock=None, ignore_<wbr>deletion_<wbr>error=None, policy=None, vault_<wbr>name=None)
```

```go
func GetVaultLock(ctx *pulumi.Context, name string, id pulumi.IDInput, state *VaultLockState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
