...
```python
def Model(resource_name, id, opts=None, containers=None, enable_<wbr>network_<wbr>isolation=None, execution_<wbr>role_<wbr>arn=None, name=None, primary_<wbr>container=None, tags=None, vpc_<wbr>config=None, __props__=None)
```
