...
```python
def EndpointConfiguration(resource_name, id, opts=None, kms_<wbr>key_<wbr>arn=None, name=None, production_<wbr>variants=None, tags=None, __props__=None)
```
...
Creates a EndpointConfiguration resource with the given unique name, arguments, and options.
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The Amazon Resource Name (ARN) assigned by AWS to this endpoint configuration.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Amazon Resource Name (ARN) of a AWS Key Management Service key that Amazon SageMaker uses to encrypt data on the storage volume attached to the ML compute instance that hosts the endpoint.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the endpoint configuration. If omitted, this provider will assign a random, unique name.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, kms_<wbr>key_<wbr>arn=None, name=None, production_<wbr>variants=None, tags=None)
```

```go
func GetEndpointConfiguration(ctx *pulumi.Context, name string, id pulumi.IDInput, state *EndpointConfigurationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
