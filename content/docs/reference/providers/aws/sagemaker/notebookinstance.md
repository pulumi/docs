...
```python
def NotebookInstance(resource_name, id, opts=None, direct_<wbr>internet_<wbr>access=None, instance_<wbr>type=None, kms_<wbr>key_<wbr>id=None, lifecycle_<wbr>config_<wbr>name=None, name=None, role_<wbr>arn=None, security_<wbr>groups=None, subnet_<wbr>id=None, tags=None, __props__=None)
```
