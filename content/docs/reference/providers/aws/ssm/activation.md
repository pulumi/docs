...
```python
def Activation(resource_name, id, opts=None, description=None, expiration_<wbr>date=None, iam_<wbr>role=None, name=None, registration_<wbr>limit=None, tags=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, activation_<wbr>code=None, description=None, expiration_<wbr>date=None, expired=None, iam_<wbr>role=None, name=None, registration_<wbr>count=None, registration_<wbr>limit=None, tags=None)
```

```go
func GetActivation(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ActivationState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
