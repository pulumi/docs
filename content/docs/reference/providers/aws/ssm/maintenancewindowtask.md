...
```python
def MaintenanceWindowTask(resource_name, id, opts=None, description=None, logging_<wbr>info=None, max_<wbr>concurrency=None, max_<wbr>errors=None, name=None, priority=None, service_<wbr>role_<wbr>arn=None, targets=None, task_<wbr>arn=None, task_<wbr>invocation_<wbr>parameters=None, task_<wbr>parameters=None, task_<wbr>type=None, window_<wbr>id=None, __props__=None)
```
