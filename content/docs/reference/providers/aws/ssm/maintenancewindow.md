...
```python
def MaintenanceWindow(resource_name, id, opts=None, allow_<wbr>unassociated_<wbr>targets=None, cutoff=None, description=None, duration=None, enabled=None, end_<wbr>date=None, name=None, schedule=None, schedule_<wbr>timezone=None, start_<wbr>date=None, tags=None, __props__=None)
```
