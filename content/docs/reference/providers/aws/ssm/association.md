...
```python
def Association(resource_name, id, opts=None, association_<wbr>name=None, automation_<wbr>target_<wbr>parameter_<wbr>name=None, compliance_<wbr>severity=None, document_<wbr>version=None, instance_<wbr>id=None, max_<wbr>concurrency=None, max_<wbr>errors=None, name=None, output_<wbr>location=None, parameters=None, schedule_<wbr>expression=None, targets=None, __props__=None)
```
