...
```python
def Parameter(resource_name, id, opts=None, allowed_<wbr>pattern=None, arn=None, description=None, key_<wbr>id=None, name=None, overwrite=None, tags=None, tier=None, type=None, value=None, __props__=None)
```
