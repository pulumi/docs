...
```python
def PatchBaseline(resource_name, id, opts=None, approval_<wbr>rules=None, approved_<wbr>patches=None, approved_<wbr>patches_<wbr>compliance_<wbr>level=None, description=None, global_<wbr>filters=None, name=None, operating_<wbr>system=None, rejected_<wbr>patches=None, tags=None, __props__=None)
```
