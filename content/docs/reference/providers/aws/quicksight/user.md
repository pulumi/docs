...
```python
def User(resource_name, id, opts=None, aws_<wbr>account_<wbr>id=None, email=None, iam_<wbr>arn=None, identity_<wbr>type=None, namespace=None, session_<wbr>name=None, user_<wbr>name=None, user_<wbr>role=None, __props__=None)
```
