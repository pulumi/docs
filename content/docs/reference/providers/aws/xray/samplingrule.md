...
```python
def SamplingRule(resource_name, id, opts=None, attributes=None, fixed_<wbr>rate=None, host=None, http_<wbr>method=None, priority=None, reservoir_<wbr>size=None, resource_<wbr>arn=None, rule_<wbr>name=None, service_<wbr>name=None, service_<wbr>type=None, url_<wbr>path=None, version=None, __props__=None)
```
