...
```python
def ApnsSandboxChannel(resource_name, id, opts=None, application_<wbr>id=None, bundle_<wbr>id=None, certificate=None, default_<wbr>authentication_<wbr>method=None, enabled=None, private_<wbr>key=None, team_<wbr>id=None, token_<wbr>key=None, token_<wbr>key_<wbr>id=None, __props__=None)
```
