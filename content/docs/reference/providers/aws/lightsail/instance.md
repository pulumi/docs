...
```python
def Instance(resource_name, id, opts=None, availability_<wbr>zone=None, blueprint_<wbr>id=None, bundle_<wbr>id=None, key_<wbr>pair_<wbr>name=None, name=None, tags=None, user_<wbr>data=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, availability_<wbr>zone=None, blueprint_<wbr>id=None, bundle_<wbr>id=None, cpu_<wbr>count=None, created_<wbr>at=None, ipv6_<wbr>address=None, is_<wbr>static_<wbr>ip=None, key_<wbr>pair_<wbr>name=None, name=None, private_<wbr>ip_<wbr>address=None, public_<wbr>ip_<wbr>address=None, ram_<wbr>size=None, tags=None, user_<wbr>data=None, username=None)
```
