...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">StaticIpAttachment</span><span class="p">(resource_name, id, opts=None, </span>instance_name=None<span class="p">, </span>static_ip_name=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, instance_<wbr>name=None, ip_<wbr>address=None, static_<wbr>ip_<wbr>name=None)
```

```go
func GetStaticIpAttachment(ctx *pulumi.Context, name string, id pulumi.IDInput, state *StaticIpAttachmentState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
