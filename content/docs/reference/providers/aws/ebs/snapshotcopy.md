...
```python
def SnapshotCopy(resource_name, id, opts=None, description=None, encrypted=None, kms_<wbr>key_<wbr>id=None, source_<wbr>region=None, source_<wbr>snapshot_<wbr>id=None, tags=None, __props__=None)
```
