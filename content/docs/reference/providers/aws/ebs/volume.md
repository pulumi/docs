...
```python
def Volume(resource_name, id, opts=None, availability_<wbr>zone=None, encrypted=None, iops=None, kms_<wbr>key_<wbr>id=None, size=None, snapshot_<wbr>id=None, tags=None, type=None, __props__=None)
```
