...
```python
def get(resource_name, id, opts=None, arn=None, availability_<wbr>zone=None, encrypted=None, iops=None, kms_<wbr>key_<wbr>id=None, size=None, snapshot_<wbr>id=None, tags=None, type=None)
```

```go
func GetVolume(ctx *pulumi.Context, name string, id pulumi.IDInput, state *VolumeState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
