...
```python
def Endpoint(resource_name, id, opts=None, certificate_<wbr>arn=None, database_<wbr>name=None, endpoint_<wbr>id=None, endpoint_<wbr>type=None, engine_<wbr>name=None, extra_<wbr>connection_<wbr>attributes=None, kms_<wbr>key_<wbr>arn=None, mongodb_<wbr>settings=None, password=None, port=None, s3_<wbr>settings=None, server_<wbr>name=None, service_<wbr>access_<wbr>role=None, ssl_<wbr>mode=None, tags=None, username=None, __props__=None)
```
