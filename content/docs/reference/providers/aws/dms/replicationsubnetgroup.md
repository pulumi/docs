...
```python
def ReplicationSubnetGroup(resource_name, id, opts=None, replication_<wbr>subnet_<wbr>group_<wbr>description=None, replication_<wbr>subnet_<wbr>group_<wbr>id=None, subnet_<wbr>ids=None, tags=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, replication_<wbr>subnet_<wbr>group_<wbr>arn=None, replication_<wbr>subnet_<wbr>group_<wbr>description=None, replication_<wbr>subnet_<wbr>group_<wbr>id=None, subnet_<wbr>ids=None, tags=None, vpc_<wbr>id=None)
```

```go
func GetReplicationSubnetGroup(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ReplicationSubnetGroupState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
