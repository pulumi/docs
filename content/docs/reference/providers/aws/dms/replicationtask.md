...
```python
def ReplicationTask(resource_name, id, opts=None, cdc_<wbr>start_<wbr>time=None, migration_<wbr>type=None, replication_<wbr>instance_<wbr>arn=None, replication_<wbr>task_<wbr>id=None, replication_<wbr>task_<wbr>settings=None, source_<wbr>endpoint_<wbr>arn=None, table_<wbr>mappings=None, tags=None, target_<wbr>endpoint_<wbr>arn=None, __props__=None)
```
