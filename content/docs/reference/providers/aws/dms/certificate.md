...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Certificate</span><span class="p">(resource_name, id, opts=None, </span>certificate_id=None<span class="p">, </span>certificate_pem=None<span class="p">, </span>certificate_wallet=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, certificate_<wbr>arn=None, certificate_<wbr>id=None, certificate_<wbr>pem=None, certificate_<wbr>wallet=None)
```
