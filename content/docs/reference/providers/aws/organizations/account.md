...
```python
def Account(resource_name, id, opts=None, email=None, iam_<wbr>user_<wbr>access_<wbr>to_<wbr>billing=None, name=None, parent_<wbr>id=None, role_<wbr>name=None, tags=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, email=None, iam_<wbr>user_<wbr>access_<wbr>to_<wbr>billing=None, joined_<wbr>method=None, joined_<wbr>timestamp=None, name=None, parent_<wbr>id=None, role_<wbr>name=None, status=None, tags=None)
```
