...
```python
def Organization(resource_name, id, opts=None, aws_<wbr>service_<wbr>access_<wbr>principals=None, enabled_<wbr>policy_<wbr>types=None, feature_<wbr>set=None, __props__=None)
```
