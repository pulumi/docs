...
```python
def ListenerPolicy(resource_name, id, opts=None, load_<wbr>balancer_<wbr>name=None, load_<wbr>balancer_<wbr>port=None, policy_<wbr>names=None, __props__=None)
```
