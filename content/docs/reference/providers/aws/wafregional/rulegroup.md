...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RuleGroup</span><span class="p">(resource_name, id, opts=None, </span>activated_rules=None<span class="p">, </span>metric_name=None<span class="p">, </span>name=None<span class="p">, </span>tags=None<span class="p">, __props__=None);</span></code></pre></div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#rulegroupactivatedrule">List&lt;Pulumi.<wbr>Aws.<wbr>Wafregional.<wbr>Rule<wbr>Group<wbr>Activated<wbr>Rule<wbr>Args&gt;?</a></code>
            </td>
...
<table class="ml-6">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#rulegroupactivatedrule">List&lt;Pulumi.<wbr>Aws.<wbr>Wafregional.<wbr>Rule<wbr>Group<wbr>Activated<wbr>Rule&gt;?</a></code>
            </td>
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The ARN of the WAF Regional Rule Group.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, activated_<wbr>rules=None, arn=None, metric_<wbr>name=None, name=None, tags=None)
```

```go
func GetRuleGroup(ctx *pulumi.Context, name string, id pulumi.IDInput, state *RuleGroupState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="align-top">
                ...
                <code><a href="#rulegroupactivatedruleaction">Pulumi.<wbr>Aws.<wbr>Wafregional.<wbr>Rule<wbr>Group<wbr>Activated<wbr>Rule<wbr>Action<wbr>Args</a></code>
            </td>
            <td class="align-top">{{% md %}} 
 (Required)
