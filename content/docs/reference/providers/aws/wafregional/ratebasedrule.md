...
```python
def RateBasedRule(resource_name, id, opts=None, metric_<wbr>name=None, name=None, predicates=None, rate_<wbr>key=None, rate_<wbr>limit=None, tags=None, __props__=None)
```
