...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Selection</span><span class="p">(resource_name, id, opts=None, </span>iam_role_arn=None<span class="p">, </span>name=None<span class="p">, </span>plan_id=None<span class="p">, </span>resources=None<span class="p">, </span>selection_tags=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, iam_<wbr>role_<wbr>arn=None, name=None, plan_<wbr>id=None, resources=None, selection_<wbr>tags=None)
```

```go
func GetSelection(ctx *pulumi.Context, name string, id pulumi.IDInput, state *SelectionState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
