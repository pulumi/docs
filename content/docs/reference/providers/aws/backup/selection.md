...
```python
def Selection(resource_name, id, opts=None, iam_<wbr>role_<wbr>arn=None, name=None, plan_<wbr>id=None, resources=None, selection_<wbr>tags=None, __props__=None)
```
