...
```python
def Budget(resource_name, id, opts=None, account_<wbr>id=None, budget_<wbr>type=None, cost_<wbr>filters=None, cost_<wbr>types=None, limit_<wbr>amount=None, limit_<wbr>unit=None, name=None, name_<wbr>prefix=None, notifications=None, time_<wbr>period_<wbr>end=None, time_<wbr>period_<wbr>start=None, time_<wbr>unit=None, __props__=None)
```
