...
```python
def Queue(resource_name, id, opts=None, description=None, name=None, pricing_<wbr>plan=None, reservation_<wbr>plan_<wbr>settings=None, status=None, tags=None, __props__=None)
```
