...
```python
def JobDefinition(resource_name, id, opts=None, container_<wbr>properties=None, name=None, parameters=None, retry_<wbr>strategy=None, timeout=None, type=None, __props__=None)
```
