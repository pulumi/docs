...
```python
def JobQueue(resource_name, id, opts=None, compute_<wbr>environments=None, name=None, priority=None, state=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, arn=None, compute_<wbr>environments=None, name=None, priority=None, state=None)
```

```go
func GetJobQueue(ctx *pulumi.Context, name string, id pulumi.IDInput, state *JobQueueState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
