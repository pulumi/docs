...
```python
def ComputeEnvironment(resource_name, id, opts=None, compute_<wbr>environment_<wbr>name=None, compute_<wbr>environment_<wbr>name_<wbr>prefix=None, compute_<wbr>resources=None, service_<wbr>role=None, state=None, type=None, __props__=None)
```
