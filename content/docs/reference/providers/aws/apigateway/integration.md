...
```python
def Integration(resource_name, id, opts=None, cache_<wbr>key_<wbr>parameters=None, cache_<wbr>namespace=None, connection_<wbr>id=None, connection_<wbr>type=None, content_<wbr>handling=None, credentials=None, http_<wbr>method=None, integration_<wbr>http_<wbr>method=None, passthrough_<wbr>behavior=None, request_<wbr>parameters=None, request_<wbr>templates=None, resource_<wbr>id=None, rest_<wbr>api=None, timeout_<wbr>milliseconds=None, type=None, uri=None, __props__=None)
```
