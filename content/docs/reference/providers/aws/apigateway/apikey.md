...
```python
def ApiKey(resource_name, id, opts=None, description=None, enabled=None, name=None, tags=None, value=None, __props__=None)
```
...
<table class="ml-6">
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The creation date of the API key
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The API key description. Defaults to &#34;Managed by Pulumi&#34;.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} Specifies whether the API key can be used by callers. Defaults to `true`.
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The last update date of the API key
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The name of the API key
 {{% /md %}}
 ...
 {{% /md %}}
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}} The value of the API key. If not specified, it will be automatically generated by AWS on creation.
 {{% /md %}}
...
```python
def get(resource_name, id, opts=None, arn=None, created_<wbr>date=None, description=None, enabled=None, last_<wbr>updated_<wbr>date=None, name=None, tags=None, value=None)
```

```go
func GetApiKey(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ApiKeyState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
