...
```python
def Response(resource_name, id, opts=None, response_<wbr>parameters=None, response_<wbr>templates=None, response_<wbr>type=None, rest_<wbr>api_<wbr>id=None, status_<wbr>code=None, __props__=None)
```
