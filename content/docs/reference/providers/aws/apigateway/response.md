...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">Response</span><span class="p">(resource_name, id, opts=None, </span>response_parameters=None<span class="p">, </span>response_templates=None<span class="p">, </span>response_type=None<span class="p">, </span>rest_api_id=None<span class="p">, </span>status_code=None<span class="p">, __props__=None);</span></code></pre></div>
...
```python
def get(resource_name, id, opts=None, response_<wbr>parameters=None, response_<wbr>templates=None, response_<wbr>type=None, rest_<wbr>api_<wbr>id=None, status_<wbr>code=None)
```

```go
func GetResponse(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ResponseState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
