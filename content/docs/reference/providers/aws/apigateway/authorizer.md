...
```python
def Authorizer(resource_name, id, opts=None, authorizer_<wbr>credentials=None, authorizer_<wbr>result_<wbr>ttl_<wbr>in_<wbr>seconds=None, authorizer_<wbr>uri=None, identity_<wbr>source=None, identity_<wbr>validation_<wbr>expression=None, name=None, provider_<wbr>arns=None, rest_<wbr>api=None, type=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, authorizer_<wbr>credentials=None, authorizer_<wbr>result_<wbr>ttl_<wbr>in_<wbr>seconds=None, authorizer_<wbr>uri=None, identity_<wbr>source=None, identity_<wbr>validation_<wbr>expression=None, name=None, provider_<wbr>arns=None, rest_<wbr>api=None, type=None)
```

```go
func GetAuthorizer(ctx *pulumi.Context, name string, id pulumi.IDInput, state *AuthorizerState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
