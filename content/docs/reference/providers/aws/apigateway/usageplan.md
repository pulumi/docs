...
```python
def UsagePlan(resource_name, id, opts=None, api_<wbr>stages=None, description=None, name=None, product_<wbr>code=None, quota_<wbr>settings=None, tags=None, throttle_<wbr>settings=None, __props__=None)
```
