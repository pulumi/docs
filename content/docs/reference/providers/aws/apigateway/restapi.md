...
```python
def RestApi(resource_name, id, opts=None, api_<wbr>key_<wbr>source=None, binary_<wbr>media_<wbr>types=None, body=None, description=None, endpoint_<wbr>configuration=None, minimum_<wbr>compression_<wbr>size=None, name=None, policy=None, tags=None, __props__=None)
```
