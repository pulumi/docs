...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nf">RequestValidator</span><span class="p">(resource_name, id, opts=None, </span>name=None<span class="p">, </span>rest_api=None<span class="p">, </span>validate_request_body=None<span class="p">, </span>validate_request_parameters=None<span class="p">, __props__=None);</span></code></pre></div>
