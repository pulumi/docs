...
```python
def LogMetricFilter(resource_name, id, opts=None, log_<wbr>group_<wbr>name=None, metric_<wbr>transformation=None, name=None, pattern=None, __props__=None)
```
...
```python
def get(resource_name, id, opts=None, log_<wbr>group_<wbr>name=None, metric_<wbr>transformation=None, name=None, pattern=None)
```

```go
func GetLogMetricFilter(ctx *pulumi.Context, name string, id pulumi.IDInput, state *LogMetricFilterState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
