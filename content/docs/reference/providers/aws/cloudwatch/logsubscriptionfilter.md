...
```python
def LogSubscriptionFilter(resource_name, id, opts=None, destination_<wbr>arn=None, distribution=None, filter_<wbr>pattern=None, log_<wbr>group=None, name=None, role_<wbr>arn=None, __props__=None)
```
