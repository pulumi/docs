...
```python
def EventRule(resource_name, id, opts=None, description=None, event_<wbr>pattern=None, is_<wbr>enabled=None, name=None, name_<wbr>prefix=None, role_<wbr>arn=None, schedule_<wbr>expression=None, tags=None, __props__=None)
```
