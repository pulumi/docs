...
```python
def LicenseConfiguration(resource_name, id, opts=None, description=None, license_<wbr>count=None, license_<wbr>count_<wbr>hard_<wbr>limit=None, license_<wbr>counting_<wbr>type=None, license_<wbr>rules=None, name=None, tags=None, __props__=None)
```
