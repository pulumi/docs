...
```python
def get(resource_name, id, opts=None, arn=None, artifacts=None, badge_<wbr>enabled=None, badge_<wbr>url=None, build_<wbr>timeout=None, cache=None, description=None, encryption_<wbr>key=None, environment=None, logs_<wbr>config=None, name=None, queued_<wbr>timeout=None, secondary_<wbr>artifacts=None, secondary_<wbr>sources=None, service_<wbr>role=None, source=None, source_<wbr>version=None, tags=None, vpc_<wbr>config=None)
```

```go
func GetProject(ctx *pulumi.Context, name string, id pulumi.IDInput, state *ProjectState, opts ...pulumi.ResourceOption) (*Bucket, error)
```
