...
```python
def __init__(__self__, resource_name, opts=None, policy=None, target=None, __props__=None)
```
...
<table class="ml-6">
    ...
    <tbody>
        <tr>
            ...
            <td class="align-top"><code>Union&lt;<wbr>string, <wbr>Policy<wbr>&gt;</code></td>
...
<table class="ml-6">
    ...
    <tbody>
        <tr>
            ...
            <td class="align-top"><code>Union&lt;<wbr>string, <wbr>Policy<wbr>&gt;</code></td>
            <td class="align-top">{{% md %}}
(Optional) The name of the policy to attach.
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>ARN</code></td>
            <td class="align-top">{{% md %}}
(Optional) The identity to which the policy is attached.
