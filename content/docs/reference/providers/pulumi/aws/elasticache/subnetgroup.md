...
(Optional) Description for the cache subnet group. Defaults to "Managed by Pulumi".
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) Name for the cache subnet group. Elasticache converts this name to lowercase.
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>Array&lt;<wbr>string<wbr>&gt;</code></td>
            <td class="align-top">{{% md %}}
(Optional) List of VPC Subnet IDs for the cache subnet group
