...
```python
def __init__(__self__, resource_name, opts=None, configuration=None, name=None, name_prefix=None, __props__=None)
```
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) The name of the EMR Security Configuration. By default generated by this provider.
...
<table class="ml-6">
    ...
    <tbody>
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) A JSON formatted Security Configuration
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) Date the Security Configuration was created
