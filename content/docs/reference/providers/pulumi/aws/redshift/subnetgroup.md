...
```python
def __init__(__self__, resource_name, opts=None, description=None, name=None, subnet_ids=None, tags=None, __props__=None)
```
...
(Optional) The description of the Redshift Subnet group. Defaults to "Managed by Pulumi".
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) The name of the Redshift Subnet group.
...
<table class="ml-6">
    ...
    <tbody>
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) Amazon Resource Name (ARN) of the Redshift Subnet group name
