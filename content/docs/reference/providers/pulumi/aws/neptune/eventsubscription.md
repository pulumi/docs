...
```python
def __init__(__self__, resource_name, opts=None, enabled=None, event_categories=None, name=None, name_prefix=None, sns_topic_arn=None, source_ids=None, source_type=None, tags=None, __props__=None)
```
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top">{{% md %}}
(Optional) The name of the Neptune event subscription. By default generated by this provider.
