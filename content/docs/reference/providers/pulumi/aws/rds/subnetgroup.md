...
```python
def __init__(__self__, resource_name, opts=None, description=None, name=None, name_prefix=None, subnet_ids=None, tags=None, __props__=None)
```
...
(Optional) The description of the DB subnet group. Defaults to "Managed by Pulumi".
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) The name of the DB subnet group. If omitted, this provider will assign a random, unique name.
...
<table class="ml-6">
    ...
    <tbody>
        <tr>
            ...
            <td class="align-top"><code>string</code></td>
            <td class="align-top">{{% md %}}
(Optional) The ARN of the db subnet group.
...
{{% /md %}}</td>
        ...
        <tr>
            ...
            <td class="align-top"><code>Array&lt;<wbr>string<wbr>&gt;</code></td>
            <td class="align-top">{{% md %}}
(Optional) A list of VPC subnet IDs.
