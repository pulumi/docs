...
![User Attributes & Claims Panel](/images/reference/service/saml-aad/attributes-and-claims-panel.png)

1. Then, click on the **Edit** icon next to **Name identifier value**.

![User Attributes & Claims](/images/reference/service/saml-aad/attributes-and-claims.png)

1. In the **Manage User Claims** panel, expand the **Choose name identifier format** and select **Email address**.

![Manage Name Identifier Format](/images/reference/service/saml-aad/name-identifier-format.png)
