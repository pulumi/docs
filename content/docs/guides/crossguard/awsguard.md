...
For more information on Pulumi's Policy as Code solution, visit our [docs]({{< prelref "/docs/get-started/crossguard" >}}).
...
Once you've validated the behavior of the AWSGuard policies you've configured in your Policy Pack, an organization administrator can publish the Policy Pack to the Pulumi Console to be enforced across your organization. To learn more see [Enforcing a Policy Pack Across an Organization]({{< prelref "/docs/get-started/crossguard/enforcing-a-policy-pack" >}}).

Now that you've seen how to configure and use AWSGuard policies, you may want to write your own policies. See the [Getting Started tutorial]({{< prelref "/docs/get-started/crossguard" >}}) to get started.
