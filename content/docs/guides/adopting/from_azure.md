...
func main() {
    pulumi.Run(func(ctx *pulumi.Context) error {
        ...
        blob, err := storage.NewBlob(ctx, "myBlob", &storage.BlobArgs{
            ResourceGroupName: pulumi.String("myrg"),
            AccountName: pulumi.String(storageAccountName),
            ContainerName: cont.Name,
            BlobName: pulumi.String("zip"),
...
using TemplateDeployment = Pulumi.AzureNextGen.Resources.Deployment;
...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        // Create a blob for our own deployment.
        var blob = new Blob("myBlob", new BlobArgs
        {
            ResourceGroupName = "myrg",
            AccountName = storageAccountName,
            BlobName = "zip",
...
const storagecreatedbyarm = new azure_nextgen.storage.StorageAccount("storagecreatedbyarm", {
...
storagecreatedbyarm = azure_nextgen.storage.StorageAccount("storagecreatedbyarm",
...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        var storagecreatedbyarm = new AzureNextGen.Storage.StorageAccount("storagecreatedbyarm", new AzureNextGen.Storage.StorageAccountArgs
        {
            AccountName = "storagecreatedbyarm",
            Kind = "StorageV2",
            Location = "westeurope",
