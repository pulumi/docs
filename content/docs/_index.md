...
<div class="card-table" style="background: #fafafa; margin: 64px 0 0 0; border-top: 1px solid #eee">
    <div class="mdl-card mdl-shadow--2dp get-started-card">
        <a href="{{< relref "/docs/quickstart/aws" >}}"><img src="/images/docs/quickstart/aws-purple.png" style="width: 250px"></a>
        <a href="{{< relref "/docs/quickstart/azure" >}}"><img src="/images/docs/quickstart/azure-purple.png" style="width: 250px"></a>
        <a href="{{< relref "/docs/quickstart/gcp" >}}"><img src="/images/docs/quickstart/gcp-purple.png" style="width: 250px"></a>
        <a href="{{< relref "/docs/quickstart/kubernetes" >}}"><img src="/images/docs/quickstart/k8s-purple.png" style="width: 250px"></a>
    </div>
</div>
...
<div class="card-table" style="background: #fafafa; border-top: 1px solid #eee; border-bottom: 1px solid #eee; margin-bottom: 64px">
    <div class="mdl-card mdl-shadow--2dp get-started-card">
        <a href="{{< relref "/docs/quickstart/aws/tutorial-service.md" >}}">
          <img src="/images/docs/icon-feature-containers.svg"
    ...
    <div class="mdl-card mdl-shadow--2dp get-started-card">
        <a href="{{< relref "/docs/quickstart/aws/tutorial-rest-api.md" >}}">
          <img src="/images/docs/icon-feature-serverless.svg"
              style="margin-bottom: 30px" width="125">
        </a>
        <div class="mdl-card__title">
            <h2 class="mdl-card__title-text no-anchor">
    ...
    <div class="mdl-card mdl-shadow--2dp get-started-card">
        <a href="{{< relref "/docs/quickstart/aws/tutorial-ec2-webserver.md" >}}">
          <img src="/images/docs/icon-feature-data.svg"
              style="margin-bottom: 30px" width="125">
        </a>
        <div class="mdl-card__title">
            <h2 class="mdl-card__title-text no-anchor">
    ...
    <div class="mdl-card mdl-shadow--2dp get-started-card">
        <a href="{{< relref "/docs/quickstart/kubernetes" >}}">
          <img src="/images/docs/icon-feature-kubernetes.svg"
              style="margin-bottom: 30px" width="125">
        </a>
        <div class="mdl-card__title">
            <h2 class="mdl-card__title-text no-anchor">
