...
To learn more about adopting Pulumi, please refer to the [AWS CloudFormation]({{< relref "/docs/guides/adopting/from_aws" >}}) or [Azure Resource Manager (ARM)]({{< relref "/docs/guides/adopting/from_azure" >}}) migration guides.  For ARM, the [arm2pulumi]({{ relref "https://www.pulumi.com/arm2pulumi" }}) tool can also help you directly convert your templates to Pulumi code.
