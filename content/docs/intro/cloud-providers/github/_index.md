...
repo, _ := github.NewRepository(ctx, "demo-repo", &github.RepositoryArgs{
...
class Program
{
    static Task Main() =>
        Deployment.Run(() => {
            var repo = new Repository("demo-repo", new RepositoryArgs
            {
                Description = "Generated from automated test",
                Private = true,
            });
...
* Python: [`pulumi-github`](https://pypi.org/project/pulumi-gitlab/)
