...
See the [full API documentation]({{< prelref "/docs/reference/pkg/kafka" >}}) for complete details of the available Kafka provider APIs.

## Setup

The Kafka provider supports several options for providing access to Kafka credentials.  See the [Kafka setup page]({{< prelref "setup" >}}) for details.
