...
Get an in-depth intro to Pulumi, and learn how it enables you to program the cloud.

<div class="md:flex flex-row mt-6 mb-6">
    <div class="w-1/2 border-solid border-t-2 border-gray-200">
        <h3 class="no-anchor pt-4"><a href="{{< relref "concepts" >}}"><i class="fas fa-book pr-2"></i>Architecture & Concepts</a></h3>
        <p>Learn about the Pulumi architecture and core concepts.</p>
    </div>
    <div class="w-1/2 border-solid ml-4 border-t-2 border-gray-200">
        <h3 class="no-anchor pt-4"><a href="{{< relref "console" >}}"><i class="far fa-window-maximize pr-2"></i>Pulumi Console</a></h3>
        <p>Learn about the features and benefits of using the Pulumi Console to manage your deployment state and enable faster collaboration.</p>
    </div>
</div>
<div class="md:flex flex-row mt-6 mb-6">
    <div class="w-1/2 border-solid border-t-2 border-gray-200">
