...
defining a `WebServer` class, we can hide many details (see [here](https://github.com/pulumi/examples/blob/master/azure-go-webserver-component/webserver.go) for its definition).
