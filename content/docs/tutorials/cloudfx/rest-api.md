...
<!-- LINKS -->
[@pulumi/cloud]: {{< prelref "./" >}}
[cloud.API]: {{< prelref "/docs/reference/pkg/nodejs/pulumi/cloud-aws#API" >}}
[cloud.Table]: {{< prelref "/docs/reference/pkg/nodejs/pulumi/cloud-aws#Table" >}}
<!-- END LINKS -->
