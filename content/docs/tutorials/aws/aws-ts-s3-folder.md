...
<p class="mb-4 flex">
    ...
    <a href="https://app.pulumi.com/new?template=https://github.com/pulumi/examples/tree/master/aws-ts-s3-folder" target="_blank">
...
1.  Open the site URL in a browser to see both the rendered HTML and the favicon:
    ...
    ***.s3-website-us-west-2.amazonaws.com
    ...
    ![Hello S3 example](https://raw.githubusercontent.com/pulumi/examples/master/aws-ts-s3-folder/images/part2-website.png)
