...
1. Replace the contents of `index.ts` with the following:
    ...
    - **Cloud infrastructure**. S3 bucket for videos and still frames. We define a [stack output property]({{< prelref "/docs/intro/concepts/stack#outputs" >}}) `bucketName`, to easily retrieve this value after the project has been deployed.
