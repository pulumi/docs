...
1. After 10-15 minutes, your cluster will be ready, and the kubeconfig JSON you'll use to connect to the cluster will
   be available as an output.
    ...
    > See the [Pulumi Programming Model](https://github.com/pulumi/examples/blob/master/aws-ts-eks-hello-world/../../reference/programming-model.md#autonaming) for more info.
    >
    > ```
