...
2. [Connect Pulumi to a Kubernetes Cluster]({{< prelref "/docs/intro/cloud-providers/kubernetes/setup" >}})
...
3. (Optional) By default, our frontend Service will be of type `ClusterIP`. This will work on Minikube, but for most
    ...
    The above code uses [configuration]({{< prelref "/docs/intro/concepts/config" >}}) to make this parameterizable.
