...
2. [components](https://github.com/pulumi/examples/blob/master/kubernetes-cs-guestbook/components) demonstrates benefits of using a familiar language, namely eliminating boilerplate through
