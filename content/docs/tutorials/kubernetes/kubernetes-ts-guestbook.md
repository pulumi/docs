...
2. [components](https://github.com/pulumi/examples/blob/master/kubernetes-ts-guestbook/components) demonstrates benefits of using a familiar language, namely eliminating boilerplate through
