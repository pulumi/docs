...
Many of our customers are building their own developer portals on top of [Pulumi Automation API](https://www.pulumi.com/docs/iac/concepts/automation-api/) and [Pulumi Deployments](https://www.pulumi.com/docs/deployments/concepts/), but we also wanted to offer options for teams that cannot (or do not want to) build a custom solution. The suite of tools for building internal developer portals include:
...
**Combination with Other Features**: The new template experience seamlessly integrates with your existing Pulumi workflows, providing a unified experience across your infrastructure management. Increase your developer productivity by using this suite of features in combination with [Pulumi ESC](/docs/esc/). Attach an Environment to your template to have it come with configuration and secret values. Once the templates are deployed they will show in the Pulumi Cloud console use [Policies](/docs/discovery-governance/policy/) over it, set up [Review Stacks](/docs/deployments/concepts/review-stacks/) on the new stack to get ephemeral environments tied to PRs, find the resources that were deployed with [Resource Search](/docs/discovery-governance/discovery/search/), and all the other Pulumi Cloud features.
