...
[get started with Crosswalk for AWS]({{< ref "/docs/intro/cloud-providers/aws/crosswalk" >}}) today!
...
[wire up to our own domain]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/api-gateway#configuring-api-gateway-custom-domains-and-ssl-using-route53-and-acm" >}}),
[add authorization]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/api-gateway#controlling-and-managing-access-to-apis" >}}),
[provision a database]({{< ref "/docs/reference/pkg/nodejs/pulumi/aws/dynamodb#Table" >}}),
or [chain together a more complex event-driven application]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/lambda#available-aws-services-with-event-sources" >}}).
...
of code, we can [add autoscaling]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs#creating-an-auto-scaling-group-for-ecs-cluster-instances" >}}),
[customize our ECS cluster]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs#explicitly-creating-ecs-clusters-for-ec2-or-fargate" >}}),
or [wire through advanced container configuration]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs#ecs-tasks-containers-and-services" >}})
...
evolve your VPC structure - [defining custom CIDR blocks]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/vpc#configuring-cidr-blocks-for-a-vpc" >}}),
[customizing Internet and NAT Gateways]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/vpc#configuring-internet-and-nat-gateways-for-subnets-in-a-vpc" >}})
or [additional additional private subnets]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/vpc#configuring-subnets-for-a-vpc" >}}).
...
platform features, like [customized node groups]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/eks#configuring-your-eks-cluster-s-worker-nodes-and-node-groups" >}}),
[private networking]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/eks#configuring-your-eks-cluster-s-networking" >}}),
and even [deploying Kubernetes YAML and Helm charts]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/eks#deploying-existing-kubernetes-yaml-config-to-your-eks-cluster" >}})
to our cluster.
...
[get logs for our functions and containers]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/cloudwatch#configuring-cloudwatch-logging" >}}),
[create alarms when we cross critical thresholds]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/cloudwatch#creating-cloudwatch-alarms" >}}),
and [create rich dashboard layouts]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/cloudwatch#defining-cloudwatch-dashboards-in-code" >}})
