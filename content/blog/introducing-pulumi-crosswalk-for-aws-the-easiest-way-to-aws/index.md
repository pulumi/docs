...
[Pulumi Crosswalk for AWS]({{< prelref "/crosswalk/aws" >}}) is a
...
[get started with Crosswalk for AWS]({{< prelref "/docs/guides/crosswalk/aws" >}}) today!
...
[wire up to our own domain]({{< prelref "/docs/guides/crosswalk/aws/api-gateway#configuring-api-gateway-custom-domains-and-ssl-using-route53-and-acm" >}}),
[add authorization]({{< prelref "/docs/guides/crosswalk/aws/api-gateway#controlling-and-managing-access-to-apis" >}}),
[provision a database]({{< prelref "/docs/reference/pkg/aws/dynamodb/table" >}}),
or [chain together a more complex event-driven application]({{< prelref "/docs/guides/crosswalk/aws/lambda#available-aws-services-with-event-sources" >}}).
...
of code, we can [add autoscaling]({{< prelref "/docs/guides/crosswalk/aws/ecs#creating-an-auto-scaling-group-for-ecs-cluster-instances" >}}),
[customize our ECS cluster]({{< prelref "/docs/guides/crosswalk/aws/ecs#explicitly-creating-ecs-clusters-for-ec2-or-fargate" >}}),
or [wire through advanced container configuration]({{< prelref "/docs/guides/crosswalk/aws/ecs#ecs-tasks-containers-and-services" >}})
...
evolve your VPC structure - [defining custom CIDR blocks]({{< prelref "/docs/guides/crosswalk/aws/vpc#configuring-cidr-blocks-for-a-vpc" >}}),
[customizing Internet and NAT Gateways]({{< prelref "/docs/guides/crosswalk/aws/vpc#configuring-internet-and-nat-gateways-for-subnets-in-a-vpc" >}})
or [additional additional private subnets]({{< prelref "/docs/guides/crosswalk/aws/vpc#configuring-subnets-for-a-vpc" >}}).
...
platform features, like [customized node groups]({{< prelref "/docs/guides/crosswalk/aws/eks#configuring-your-eks-cluster-s-worker-nodes-and-node-groups" >}}),
[private networking]({{< prelref "/docs/guides/crosswalk/aws/eks#configuring-your-eks-cluster-s-networking" >}}),
and even [deploying Kubernetes YAML and Helm charts]({{< prelref "/docs/guides/crosswalk/aws/eks#deploying-existing-kubernetes-yaml-config-to-your-eks-cluster" >}})
to our cluster.
...
[get logs for our functions and containers]({{< prelref "/docs/guides/crosswalk/aws/cloudwatch#configuring-cloudwatch-logging" >}}),
[create alarms when we cross critical thresholds]({{< prelref "/docs/guides/crosswalk/aws/cloudwatch#creating-cloudwatch-alarms" >}}),
and [create rich dashboard layouts]({{< prelref "/docs/guides/crosswalk/aws/cloudwatch#defining-cloudwatch-dashboards-in-code" >}})
...
Crosswalk for AWS is free and open source, and you can [get started today]({{< prelref "/crosswalk/aws" >}}).

For more on Crosswalk for AWS see:

- [Pulumi Crosswalk for AWS documentation]({{< prelref "/crosswalk/aws" >}})
- [Get Started with Docker on AWS Fargate using Pulumi]({{< prelref "get-started-with-docker-on-aws-fargate-using-pulumi" >}})
- [Easy Serverless Apps and Infrastructure -- Real Events, Real Code]({{< prelref "easy-serverless-apps-and-infrastructure-real-events-real-code" >}})
- [Easily Create and Manage AWS EKS Kubernetes Clusters with Pulumi]({{< prelref "easily-create-and-manage-aws-eks-kubernetes-clusters-with-pulumi" >}})
- [Serving a Static Website on AWS with Pulumi]({{< prelref "serving-a-static-website-on-aws-with-pulumi" >}})
- [IoT as Code with MapBox and Pulumi]({{< prelref "mapbox-iot-as-code-with-pulumi-crosswalk-for-aws" >}})
