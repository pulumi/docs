...
For the purposes of testing, we are now going to create a specific [AWS Provider resource](/docs/concepts/resources/providers/) that we can pass the IAM Role details to assume.
