...
We will use "strict" enums when we are sure that the enum will include all legal values, such as when a provider is auto-generated from a cloud provider specification (like our [Azure-Native](/blog/full-coverage-of-azure-resources-with-azure-native/) or [Kubernetes](/registry/packages/kubernetes/#pulumi-kubernetes-provider) providers).
