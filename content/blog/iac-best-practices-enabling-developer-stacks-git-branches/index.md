...
* No more resource-naming collisions. Because Pulumi names cloud resources [uniquely by default](/docs/iac/concepts/resources/names/#autonaming), no two stacks will ever produce cloud resources with the same names.
...
![An image showing the main branch deploying with test and prod stacks and feature branches deploying with developer stacks](/blog/iac-best-practices-enabling-developer-stacks-git-branches/dev-stacks-git-branches-workflow.jpg)
