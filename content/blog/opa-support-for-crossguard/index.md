...
date: 2020-08-14
meta_desc: "The Pulumi CrossGuard policy-as-code framework now supports Open Policy Agent (OPA) Rego language in addition to TypeScript and Python."
authors:
    - luke-hoban
tags:
    - policy-as-code
...
Pulumi [CrossGuard](https://www.pulumi.com/docs/discovery-governance/policy/) is a policy-as-code framework for enforcing policy across Pulumi infrastructure deployments on any cloud or in Kubernetes. CrossGuard can be used to enforce policy for compliance, security, best practices or cost control.
...
![Policy Configuration](/blog/opa-support-for-crossguard/console-default-policy.png)
...
![Policy Enforcement](/blog/opa-support-for-crossguard/console-policy-enforcement.png)
...
![VSCode for OPA and Pulumi](/blog/opa-support-for-crossguard/vscode-rego.png)
