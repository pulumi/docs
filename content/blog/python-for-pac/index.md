...
In the case of this Kubernetes policy example, the policy does not allow deploying a load balancer, which would open the kubernetes cluster to the public Internet.
