...
To follow along, create a new Pulumi project with the [Get Started with Google Cloud](/docs/iac/get-started/gcp/) guide.
...
[AWS Fargate](https://aws.amazon.com/fargate/) deploys container images. It requires an ECS cluster to run on and imposes more configuration burden on the user, including networking, load balancing, auto-scaling, and service discovery. Pulumi Crosswalk for AWS [can help](/docs/iac/clouds/aws/guides/ecs/) with these tasks.
