...
* __Fully Managed__: Pulumi ESC is offered both as a fully managed and a self-hosted service in Pulumi Cloud. The pulumi/esc project is [open source](https://github.com/pulumi/esc/), and contains the evaluation engine for environments, the Pulumi CLI, and in the future, the extensible plugins for source and target integrations.
