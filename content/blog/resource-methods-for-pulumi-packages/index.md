...
Let's walk through an example. We'll author a `Message` component that accepts a message as input. The component then provides a `getMessage` method that accepts a recipient name and returns the message customized for the recipient. To get started authoring a component package, refer to the [package](/docs/iac/guides/building-extending/providers/debugging-providers/) documentation.

### Schema

We'll start with declaring the method and component in the [Pulumi schema](/docs/iac/guides/building-extending/packages/schema/). First, define the function representing the method:
...
👉 [Author your first Pulumi Package](/docs/iac/guides/building-extending/providers/debugging-providers/)
