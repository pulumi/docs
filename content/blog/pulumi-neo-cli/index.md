...
`pulumi neo` is part of a broader launch on agentic infrastructure — see [the release overview](/releases/agentic-infrastructure-era/) for everything that shipped and [the announcement post](/blog/the-agentic-infrastructure-era/) for the bigger picture. See the [`pulumi neo` command reference](/docs/iac/cli/commands/pulumi_neo/) and the [Pulumi Neo docs](/docs/ai/) for details. [10 things you can do with Neo](/blog/10-things-you-can-do-with-neo/) is a good starting point for tasks to try. The [Pulumi Community Slack](https://pulumi.com/slack/) is the place for questions and feedback.
