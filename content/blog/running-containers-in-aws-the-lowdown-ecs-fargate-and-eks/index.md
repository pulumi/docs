...
[create a cluster and configure the EC2 launch and autoscaling configurations]({{< prelref "/docs/guides/crosswalk/aws/ecs#creating-an-auto-scaling-group-for-ecs-cluster-instances" >}}),
...
including [Azure (AKS)]({{< prelref "/docs/tutorials/kubernetes/aks" >}}),
[Google Cloud (GKE)]({{< prelref "/docs/tutorials/kubernetes/gke" >}}),
and [Digital Ocean]({{< prelref "/docs/reference/pkg/nodejs/pulumi/digitalocean#KubernetesCluster" >}}),
...
more about Pulumi's support for Kubernetes, [go here]({{< prelref "pulumi-a-better-way-to-kubernetes" >}}).

## Private ECR Container Registries

In all of these cases, [Amazon Elastic Container Registry (ECR)]({{< prelref "/docs/guides/crosswalk/aws/ecr" >}})
lets you publish
...
Pulumi, but there are [many benefits to Pulumi's infrastructure as code]({{< prelref "/why-pulumi" >}}).

In short, to get your containers up on AWS, in an easy yet
production-ready way, [get started for free with Pulumi for AWS today]({{< prelref "/docs/get-started/aws" >}})!

After getting started, here are some additional resources to go deeper
on specific topics:

- [Getting Started with ECS]({{< prelref "/docs/guides/crosswalk/aws/ecs" >}})
- [Getting Started with EKS]({{< prelref "/docs/guides/crosswalk/aws/eks" >}})
- [Getting Started with ECR]({{< prelref "/docs/guides/crosswalk/aws/ecr" >}})
    - [Using ECR from ECS Fargate or EC2]({{< prelref "/docs/guides/crosswalk/aws/ecs#building-and-publishing-docker-images-automatically" >}})
    - [Using ECR from EKS]({{< prelref "/docs/guides/crosswalk/aws/eks#using-an-ecr-container-image-from-an-eks-kubernetes-deployment" >}})
    - [Building and Publishing Docker Images to a Private Amazon ECR Repository]({{< prelref "building-and-publishing-docker-images-to-a-private-amazon-ecr-repository" >}})
