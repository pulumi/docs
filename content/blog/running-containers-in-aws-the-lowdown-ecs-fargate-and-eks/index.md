...
[create a cluster and configure the EC2 launch and autoscaling configurations]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs#creating-an-auto-scaling-group-for-ecs-cluster-instances" >}}),
...
In all of these cases, [Amazon Elastic Container Registry (ECR)]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecr" >}})
lets you publish
...
-   [Getting Started with ECS]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs" >}})
-   [Getting Started with EKS]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/eks" >}})
-   [Getting Started with ECR]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecr" >}})
    -   [Using ECR from ECS Fargate or EC2]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/ecs#building-and-publishing-docker-images-automatically" >}})
    -   [Using ECR from EKS]({{< ref "/docs/intro/cloud-providers/aws/crosswalk/eks#using-an-ecr-container-image-from-an-eks-kubernetes-deployment" >}})
