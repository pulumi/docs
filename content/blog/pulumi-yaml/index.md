...
The Pulumi YAML language support is open source at [https://github.com/pulumi/pulumi-yaml](https://github.com/pulumi/pulumi-yaml), and YAML examples are available for all packages and cloud providers in the [Pulumi Registry](/registry/). You can get started with Pulumi YAML today: [install the Pulumi CLI](/docs/install/), then follow the [Pulumi Getting Started](/docs/get-started/) guide and the [Pulumi YAML language docs](/docs/iac/languages-sdks/yaml/).  We can’t wait to see what you build!
