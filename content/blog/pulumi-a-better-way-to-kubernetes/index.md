...
[Did my deployment succeed]({{< prelref "how-do-kubernetes-deployments-work-an-adversarial-perspective" >}})?
...
[Kubernetes made easy]({{< prelref "/topics/kubernetes" >}})!
<!--more-->
...
[serverless app]({{< prelref "simple-serverless-programming-with-google-cloud-functions-and-pulumi" >}})
code. Rather than gluing together yet another set of tools, you can
[create managed Kubernetes clusters]({{< prelref "program-kubernetes-with-11-cloud-native-pulumi-pearls" >}})
with [GKE](https://github.com/pulumi/examples/tree/master/gcp-ts-gke),
[EKS]({{< prelref "easily-create-and-manage-aws-eks-kubernetes-clusters-with-pulumi" >}}) or
[AKS]({{< prelref "create-aks-clusters-with-monitoring-and-logging-with-pulumi-azure-open-source-sdks" >}})
...
[abstraction]({{< prelref "pulumi-and-docker-development-to-production" >}}),
conditionals, looping, library support,
[packaging]({{< prelref "creating-and-reusing-cloud-components-using-package-managers" >}}),
[testing]({{< prelref "testing-your-infrastructure-as-code-with-pulumi" >}}),
debugging, and more! From the obvious
([use variables to manage resource metadata]({{< prelref "program-kubernetes-with-11-cloud-native-pulumi-pearls" >}})),
to the more esoteric
([gate a canary deployment with Prometheus]({{< prelref "program-kubernetes-with-11-cloud-native-pulumi-pearls" >}}),
...
you to import [Helm charts]({{< prelref "using-helm-and-pulumi-to-define-cloud-native-infrastructure-as-code" >}})
and [YAML manifests]({{< prelref "program-kubernetes-with-11-cloud-native-pulumi-pearls" >}})
...
know-how to
[make your deployments more reproducible]({{< prelref "simple-reproducible-kubernetes-deployments" >}})
and maintainable.
...
Since Pulumi can [manage cloud resources as well as k8s resources]({{< prelref "pulumi-heart-google-cloud-platform" >}})
...
[message queue]({{< prelref "pulumi-and-epsagon-define-deploy-and-monitor-serverless-applications" >}})
...
[Why is my app not working]({{< prelref "how-do-kubernetes-deployments-work-an-adversarial-perspective" >}})?
...
Kubernetes provider includes [sophisticated logic]({{< prelref "improving-kubernetes-management-with-pulumis-await-logic" >}})
to [check resource readiness]({{< prelref "program-kubernetes-with-11-cloud-native-pulumi-pearls" >}}),
...
[get the information you need]({{< prelref "unified-logs-with-pulumi-logs" >}}) to
...
Pulumi's [state reconciliation model]({{< prelref "/docs/intro/concepts/how-pulumi-works" >}}) is a
[natural fit for CI/CD systems]({{< prelref "/docs/guides/continuous-delivery" >}}): review changes with a
preview, and then proceed with confidence once an update succeeds. This
is great for GitOps and [ChatOps]({{< prelref "getting-to-chatops-with-pulumi-webhooks" >}})
workflows. You don't have to be an expert on the inner workings of
Kubernetes to be productive with Pulumi.

Since you can [manage a full infrastructure stack]({{< prelref "using-helm-and-pulumi-to-define-cloud-native-infrastructure-as-code" >}})
with Pulumi, you can
[create infrastructure on demand]{{< prelref "data-science-on-demand-spinning-up-a-wallaroo-cluster-is-easy-with-pulumi" >}})
