...
You may access a [resource's options](/docs/iac/concepts/resources/#options) via the `ResourceValidationArgs` parameter. In the below example, we enforce that all DynamoDB tables be `protected` to prevent data loss.
...
* [Getting Started with CrossGuard](/docs/discovery-governance/policy/get-started/)
