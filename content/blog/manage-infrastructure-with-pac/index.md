...
2. [Running a Policy Pack locally](/docs/discovery-governance/policy/policy-packs/authoring/#running-policies-locally) to speed up development and testing of policies. Validate infrastructure before deployment.
...
4. [Apply a Policy Pack](/docs/discovery-governance/policy/policy-groups/) across an organization to validate all the infrastructure deployed
