...
To add the `disable-default-providers` configuration setting to your stack configuration file using the Pulumi CLI or the Automation API SDK, please see the [Resource providers](/docs/iac/concepts/providers/#disabling-default-providers) page.
