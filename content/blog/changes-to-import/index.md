...
Our import system depends on the ability for a [resource provider](/docs/iac/concepts/providers/) to be able to read the existing state of a resource and report back to Pulumi the current value of it's inputs and outputs.
