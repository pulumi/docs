---
title: "Announcing Next Generation Pulumi Azure Provider with 100% API Coverage and Same-Day Feature Support"
date: 2020-09-21
draft: true
meta_desc: "Next Generation Pulumi Azure provider with full coverage of Azure Resource Manager API is now available in beta."
...
We are excited to announce the beta release of a next generation Microsoft Azure provider for Pulumi. We designed the new provider to expose the entire API surface of Azure to developers and operators, now and forever.
...
Azure Resource Manager API is structured around Resource Providers&mdash;high-level groups like "storage", "compute", or "web". We map Resource Providers to top-level modules or namespaces in Pulumi SDKs.
