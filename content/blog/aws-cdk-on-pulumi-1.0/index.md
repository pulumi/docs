...
- [Detect and manage drift](/docs/deployments/concepts/drift/) with Pulumi deployments
- Track and store user actions and change history with [Audit Logs](/docs/administration/concepts/audit-logs/)
