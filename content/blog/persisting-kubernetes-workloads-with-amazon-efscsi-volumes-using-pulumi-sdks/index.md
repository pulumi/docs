...
[Install Pulumi CLI]({{< prelref "/docs/get-started" >}}) and set up your [AWS credentials]({{< prelref "/docs/get-started/aws" >}}). Initialize a new [Pulumi project]({{< prelref "/docs/intro/concepts/project" >}}) from available templates. We use `aws-typescript` template here to install all library dependencies.
