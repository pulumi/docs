...
Finally, for more detailed information on all of the DigitalOcean resources supported, please consult the reference material for your language of choice: [TypeScript]({{< relref "/docs/reference/pkg/nodejs/pulumi/digitalocean" >}}), [Python]({{< relref "/docs/reference/pkg/python/pulumi_digitalocean" >}}), or [JavaScript]({{< relref "/docs/reference/pkg/nodejs/pulumi/digitalocean" >}}) documentation.
