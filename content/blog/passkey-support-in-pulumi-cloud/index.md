...
![Pulumi Cloud Account Settings page showing the Passkeys section, with a "Register a passkey" button and an enrolled passkey named "Pulumipus's iPhone".](/blog/passkey-support-in-pulumi-cloud/account-settings-passkeys.png)
