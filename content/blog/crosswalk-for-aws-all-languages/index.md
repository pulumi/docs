...
Crosswalk for AWS is available to users in all Pulumi languages, [TypeScript](/docs/languages-sdks/javascript), [Python](/docs/languages-sdks/python), [.NET](/docs/languages-sdks/dotnet), [Go](/docs/languages-sdks/go), [Java](/docs/languages-sdks/java) and [YAML](/docs/languages-sdks/yaml). The AWSx package now joins the existing API Gateway and EKS packages in the Pulumi Registry, available in all Pulumi languages.
