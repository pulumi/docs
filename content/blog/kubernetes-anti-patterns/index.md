...
Pulumi's policy as code solution, Crossguard, lets you create a policy that checks if there are naked Pods. Learn more about [Crossguard](/docs/iac/packages-and-automation/crossguard/).
...
[Crosswalk for Kubernetes](/docs/iac/clouds/kubernetes/guides/)
[Crossguard - Policy as Code](/docs/iac/packages-and-automation/crossguard/)
