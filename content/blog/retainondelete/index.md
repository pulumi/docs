...
We [now support](https://github.com/pulumi/pulumi/releases/tag/v3.25.0) a new resource option [retain on delete](/docs/iac/concepts/resources/options/retainondelete/) that allows you to specify this case to the engine.
...
Using a combination of [import](/docs/iac/guides/migration/import/) and `RetainOnDelete` you can bring a resource under management and then relinquish it back to the external owner.
...
Read more about retain on delete in our [docs](/docs/iac/concepts/resources/options/retainondelete/). Let us know how you get on with this new feature at our community [Slack](https://slack.pulumi.com/)!
