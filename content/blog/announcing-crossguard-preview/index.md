...
> [!INFO]
> This blog post discusses CrossGuard in "preview" status. CrossGuard is now fully released and integrated into Pulumi. For current information about Pulumi's policy as code capabilities, please refer to the [latest CrossGuard documentation](/docs/discovery-governance/policy/).
...
* [Policy as Code Getting Started tutorial](/docs/discovery-governance/policy/get-started/)
