...
([GitHub App for CI/CD integration](/docs/integrations/version-control/github-app/)).
...
Pulumi already works with [your favorite CI/CD systems](/docs/iac/operations/continuous-delivery/)
...
it and configure it with your CI system, please [read the documentation](/docs/integrations/version-control/github-app/).
