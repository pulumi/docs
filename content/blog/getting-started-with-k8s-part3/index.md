...
We can abstract objects, such as Deployments and Services, into components to create our resources. [ComponentResource](/docs/reference/pkg/nodejs/pulumi/pulumi/classes/ComponentResource.html) is a Pulumi construct or resource that can aggregate other resources into a combined resource. Let’s take a look at how we implement the [Guestbook with components](https://github.com/pulumi/examples/tree/master/kubernetes-ts-guestbook/components).
