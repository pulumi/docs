...
We can use [Pulumi Crosswalk for AWS](/docs/iac/clouds/aws/guides/) to build the Docker image and publish it to a new ECR repository with just three lines of code.
