...
By following these steps, which can also be found in [our webhooks documentation](/docs/deployments/concepts/webhooks/), in a few clicks you will have a Microsoft Teams incoming webhook URL which you can use to set up a webhook in [Pulumi Cloud](https://app.pulumi.com/signin), as shown in the GIF below.
