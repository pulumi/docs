...
Languages and verifiability already provide strong foundations, however, there are still clear areas we need to improve, beginning with making the full suite of infrastructure automation, security, and governance tools more accessible to agents. That's what today is all about. To deep dive on details of the launches, check out [the release overview](/releases/agentic-infrastructure-era/) and the companion blog posts released today.
