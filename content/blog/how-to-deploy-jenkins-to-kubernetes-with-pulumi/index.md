...
Follow the steps in
[Pulumi Installation and Setup]({{< prelref "/docs/get-started/install" >}}) and
[Configuring Pulumi Kubernetes]({{< prelref "/docs/get-started/kubernetes" >}})
...
- Read the docs on [Kubernetes]({{< prelref "/docs/reference/pkg/kubernetes" >}})
- See the tutorial on [building components]({{< prelref "/docs/tutorials/aws/s3-folder-component" >}})
