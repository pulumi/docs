...
1. __Data delivery is regularly delayed__: COPY commands that used to take minutes are taking over an hour when the cluster is under load. Dependent cron jobs over the data need to be updated to handle delays.
