...
Most organizations end up needing both: somewhere to run their ML workloads, and something to keep the rest of the cloud sane. For the full definition, including the control-plane layer that provisions and governs both categories, see [what is AI infrastructure](/what-is/what-is-ai-infrastructure/).
