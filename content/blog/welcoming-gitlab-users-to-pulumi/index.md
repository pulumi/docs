...
Pulumi can be run in [many CI/CD environments](/docs/iac/operations/continuous-delivery/). Pulumi can be easily
integrated in your [CI pipeline on GitLab](/docs/iac/operations/continuous-delivery/gitlab-ci/), too.
