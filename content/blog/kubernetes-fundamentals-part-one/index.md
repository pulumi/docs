...
First, you need [Pulumi installed](/docs/install/). Then, you need to [configure Kubernetes for Pulumi](/registry/packages/kubernetes/installation-configuration/). From here, we can deploy to Kubernetes without touching a shred of YAML directly.
