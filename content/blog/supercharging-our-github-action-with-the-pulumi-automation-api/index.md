...
- Already use the v1 Pulumi GitHub Action? Migrate to the new one with our [migration guide](/docs/iac/operations/continuous-delivery/github-actions/#migrating-from-github-action-v1).
- New to Pulumi and GitHub Actions? Use our [getting started guide](/docs/iac/operations/continuous-delivery/github-actions/) to set up your first Pulumi workflow.
