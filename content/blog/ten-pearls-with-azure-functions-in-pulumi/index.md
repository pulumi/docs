...
For a streamlined Pulumi walkthrough, including language runtime installation and cloud configuration, see the  [Azure Quickstart](/docs/iac/get-started/azure/), check more examples at [Pulumi Azure GitHub](https://github.com/pulumi/pulumi-azure/tree/master/examples), and join the [Pulumi Community Slack](https://slack.pulumi.com/).
