...
| cdk8s | TypeScript, Python, Java, Go | No (workload only) | One-shot synth to YAML | Core stable, long-running 2.x line; `cdk8s+` construct libraries stable per-Kubernetes-version | Code-first manifest generation feeding existing GitOps |
