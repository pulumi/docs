...
[Pulumi CLI]({{< prelref "/docs/reference/cli" >}}). After
[installing the CLI]({{< prelref "/docs/get-started/install" >}}), I jump into an empty
...
[stacks]({{< prelref "/docs/intro/concepts/stack" >}})--- isolated,
...
[a way to configure]({{< prelref "/docs/intro/concepts/config" >}}) the program's
...
- [Getting Started with Pulumi]({{< prelref "/docs/get-started" >}})
- [Setup Pulumi to work with Azure]({{< prelref "/docs/get-started/azure" >}})
- [Walkthroughs and Examples]({{< prelref "/docs/get-started/azure" >}})
