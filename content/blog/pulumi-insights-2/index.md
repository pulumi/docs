...
Today we are outlining our vision for Pulumi Insights 2.0, and the features that are part of Insights 2.0 will be released over the coming weeks and months. [Get started with Pulumi Insights 2.0](/docs/insights/discovery/get-started/).
...
[Get started with Pulumi Insights 2.0](/docs/insights/discovery/get-started/).
