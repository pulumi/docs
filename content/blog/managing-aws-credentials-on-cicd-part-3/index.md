...
see [this blog post from BishopFox](https://bishopfox.com/blog/privilege-escalation-in-aws).
...
When you create a new stack using [pulumi stack init](/docs/iac/cli/commands/pulumi_stack_new/), you can optionally
