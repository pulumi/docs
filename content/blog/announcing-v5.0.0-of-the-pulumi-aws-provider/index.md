...
Yes! As part of this major version, we have taken advantage of using [aliases](/docs/iac/concepts/resources/options/aliases/) in Pulumi to be able to allow users to
