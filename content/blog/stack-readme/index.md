...
Starting today, users can create [Stack READMEs](/docs/iac/concepts/stacks/#stack-readme) in the [Pulumi Service](https://app.pulumi.com/signin) that dynamically update based on [Stack Outputs](https://www.pulumi.com/learn/building-with-pulumi/stack-outputs).
