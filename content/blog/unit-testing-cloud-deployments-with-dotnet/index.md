...
Under normal circumstances, the Pulumi engine would use the logical name to produce the physical name of the resource group automatically (see [resource names](/docs/iac/concepts/resources/#names) for details). However, my mocks don't do that.
