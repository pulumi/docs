...
Check out the [documentation](/docs/discovery-governance/policy/policy-packs/authoring/#remediating-policy-violations) to get started adding remediation policies to your policy-as-code configuration today.
