...
![The new Pulumi ESC onboarding experience provides a stylish look](/blog/esc-new-onboarding/esc-onboarding-1.png)
...
![The new Onboarding experience offers a Login Provider Setup for the most popular cloud providers](/blog/esc-new-onboarding/esc-onboarding-2.png)
...
![You can setup OIDC Providers via multiple options such as giving pulumi permissions through SSO or via executing a program on your local cli.](/blog/esc-new-onboarding/esc-onboarding-3.png)
...
![To setup AWS via SSO you need to provide the SSO start URL and SSO region](/blog/esc-new-onboarding/esc-onboarding-4.png)

![AWS will prompt you for permissions to pulumi to create the necessary resources](/blog/esc-new-onboarding/esc-onboarding-5.png)
...
![A new environment will be created under the project and name you specify](/blog/esc-new-onboarding/esc-onboarding-6.png)
