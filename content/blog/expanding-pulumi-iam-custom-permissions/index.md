...
With custom roles, you can define granular permissions using [fine-grained scopes](/docs/administration/concepts/rbac/scopes/). However, applying those roles still requires selecting individual stacks, environments, or accounts one by one. For organizations managing a large number of Pulumi entities, this means either granting overly broad access or spending significant time on manual configuration. Tag-based access control solves this problem.
...
Custom roles can now be assigned directly to [teams](/docs/administration/concepts/rbac/teams/) within your Pulumi organization. When an engineer joins a team, whether manually or via [SCIM provisioning](/docs/administration/guides/scim/), they automatically inherit the permissions defined in the team's assigned roles.
...
Custom roles can also be assigned directly to individual organization members. This is useful for users whose responsibilities span multiple teams or require permissions beyond the existing org-level `Admin`, `Member`, and `Billing Manager` [roles](/docs/administration/concepts/rbac/roles/).
...
Explore the [IAM documentation](/docs/administration/concepts/rbac/) to get started, and share your feedback in our [GitHub repository](https://github.com/pulumi/pulumi-cloud-requests/issues).

## Learn more

- [RBAC overview](/docs/administration/concepts/rbac/)
- [Roles](/docs/administration/concepts/rbac/roles/)
- [Permission sets](/docs/administration/concepts/rbac/permission-sets/)
- [Teams](/docs/administration/concepts/rbac/teams/)
