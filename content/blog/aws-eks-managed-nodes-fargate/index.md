  ...
  <div class="flex">
    ...
    <div>
      <p class="font-bold mt-1 mb-0">
        Looking for information on how to deploy an EKS cluster? Checkout our <a href="https://www.pulumi.com/docs/guides/crosswalk/aws/eks/">AWS Elastic Kubernetes Service</a> documentation.
    </p>
    </div>
  </div>
</div>
