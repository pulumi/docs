...
To accomplish the task of provisioning all the required resources, the team wrote a [Pulumi Component](/docs/concepts/resources/components/) to encapsulate all the complexity and provide a simple interface for provisioning and updating the service. Unfortunately, this was before we had developed [Pulumi Packages](/docs/iac/packages-and-automation/pulumi-packages/) and the Component was only available within the program itself.
