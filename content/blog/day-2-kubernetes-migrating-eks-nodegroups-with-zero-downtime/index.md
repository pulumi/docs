...
infrastructure and Kubernetes through code, [get started today]({{< prelref "/docs/get-started" >}}). Pulumi is open source and free to
use.
...
[eks-nodegroup-tutorial]: {{< prelref "/docs/tutorials/kubernetes/eks-migrate-nodegroups" >}}
[crosswalk-aws]: {{< prelref "/docs/guides/crosswalk/aws" >}}.
[tutorial-ha-refs]: {{< prelref "/docs/tutorials/kubernetes/eks-migrate-nodegroups#kubernetes-workloads-high-availability-ha-rolling-updates" >}}
