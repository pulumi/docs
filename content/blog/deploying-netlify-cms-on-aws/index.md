...
![Custom Neltify Config File](/blog/deploying-netlify-cms-on-aws/custom-config-file.png)
...
![Template's CMS config](/blog/deploying-netlify-cms-on-aws/template-cms-config1.jpg)
![Template's CMS config](/blog/deploying-netlify-cms-on-aws/template-cms-config2.jpg)
...
![Change Repo Name](/blog/deploying-netlify-cms-on-aws/change-repo-name.jpg)

### File Structure

Simplifying the file and deleting unneeded parameters produces this:

![File Structure](/blog/deploying-netlify-cms-on-aws/file-structure.jpg)
...
![Github Secrets Settings](/blog/deploying-netlify-cms-on-aws/github-secrets.jpg)

`PULUMI_STACK` is the Pulumi stack name that we are using.
`PULUMI_ACCESS_TOKEN` is required for the automatic process and can be generated by selecting "New Access Token" in the [Pulumi Service](https://app.pulumi.com/signin) settings.

![Pulumi Tokens](/blog/deploying-netlify-cms-on-aws/pulumi-token.jpg)
