...
To install Pulumi for AWS, go to [Before You Begin](/docs/iac/get-started/aws/). There are instructions for macOS, Windows and Linux. You need to have an AWS account.
