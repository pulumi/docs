...
* **Phase 1: Granular Access Tokens & Custom Roles (Available Today)**
    * Define custom, reusable **Permissions** with [fine-grained scopes](/docs/administration/concepts/rbac/scopes/) (e.g., `stack:delete` only).
...
* Follow instructions for [creating a custom role](/docs/administration/concepts/rbac/roles/#creating-custom-roles).
