...
If you want to dive straight in, [browse to the documentation](/docs/integrations/clouds/kubernetes/). Below is the backstory and why we’re so excited about this release.
...
To get started, check out the [documentation](/docs/integrations/clouds/kubernetes/), or [get started with the open source SDK now](/docs/iac/get-started/kubernetes/).
