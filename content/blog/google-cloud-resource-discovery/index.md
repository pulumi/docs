...
This makes [Pulumi Insights](/docs/discovery-governance/discovery/get-started/) an essential tool not just for monitoring, but also for cloud governance, compliance, and modernization.

## Getting Started

Get started today by [creating a Google Cloud Insights Account](/docs/discovery-governance/discovery/accounts/#google-cloud) and start uncovering your hidden resources.
