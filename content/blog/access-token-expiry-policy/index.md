...
social:
    ...
    bluesky: |
        ...
        Pulumi Cloud now enforces them for you: org admins can cap the max expiry of personal, organization, and team access tokens used against their organization, checked on every request.
---
