...
[Pulumi SDK]({{< prelref "/docs/get-started/install" >}}). The SDK includes
...
[check out the docs here]({{< prelref "/docs/intro/cloud-providers/aws/setup" >}})
to set things up.
...
[Additional management features]({{< prelref "/product" >}}), including
...
also available for Azure AKS, [Google GKE]({{< prelref "/docs/tutorials/kubernetes/gke" >}}),
and custom clusters (including Minikube), using the same workflow and approach.

For more information:

- [Get started with Pulumi and Kubernetes]({{< prelref "/docs/get-started/kubernetes" >}})
- [Get started with Pulumi and AWS]({{< prelref "/docs/get-started/aws" >}})
