...
Pulumi works with both Kubernetes and cloud providers (AWS, Azure, GCP, and more). You can create and manage infrastructure that builds both a Kubernetes cluster, and deploy applications and services into the cluster. Using Pulumi's programming model, we have access to all these various cloud technologies.
