...
This is a throwaway post used to exercise the `claude-social-review.yml` workflow's edit-in-place behavior. It will be deleted before the workflow PR is merged.
