...
---
title: "getRouteTable"
title_tag: "azure.network.getRouteTable"
meta_desc: "Documentation for the azure.network.getRouteTable function with examples, input properties, output properties, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_route_table(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
