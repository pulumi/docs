...
<span class="k">def </span><span class="nx">Topic</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">identity</span><span class="p">:</span> <span class="nx">Optional[TopicIdentityArgs]</span> = None<span class="p">,</span>
          <span class="nx">inbound_ip_rules</span><span class="p">:</span> <span class="nx">Optional[Sequence[TopicInboundIpRuleArgs]]</span> = None<span class="p">,</span>
          <span class="nx">input_mapping_default_values</span><span class="p">:</span> <span class="nx">Optional[TopicInputMappingDefaultValuesArgs]</span> = None<span class="p">,</span>
          <span class="nx">input_mapping_fields</span><span class="p">:</span> <span class="nx">Optional[TopicInputMappingFieldsArgs]</span> = None<span class="p">,</span>
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#topicidentity">Topic<wbr>Identity<wbr>Args</a></span>
    </dt>
...
<a href="#inboundiprules_csharp" style="color: inherit; text-decoration: inherit;">Inbound<wbr>Ip<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#topicinboundiprule">List&lt;Topic<wbr>Inbound<wbr>Ip<wbr>Rule<wbr>Args&gt;</a></span>
    </dt>
...
<a href="#inbound_ip_rules_python" style="color: inherit; text-decoration: inherit;">inbound_<wbr>ip_<wbr>rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#topicinboundiprule">Sequence[Topic<wbr>Inbound<wbr>Ip<wbr>Rule<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}One or more `inbound_ip_rule` blocks as defined below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Mapping[str, str]]</span> = None<span class="p">) -&gt;</span> Topic</code></pre></div>
{{% /choosable %}}
...
<h4 id="topicidentity">Topic<wbr>Identity</h4>
...
<h4 id="topicinboundiprule">Topic<wbr>Inbound<wbr>Ip<wbr>Rule</h4>
