...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The identity type of the Batch Account. Possible values are `SystemAssigned` and `UserAssigned`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#identityids_csharp" style="color: inherit; text-decoration: inherit;">Identity<wbr>Ids</a>
    ...
    <dd>{{% md %}}Specifies a list of user assigned identity ids. Required if `type` is `UserAssigned`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#principalid_csharp" style="color: inherit; text-decoration: inherit;">Principal<wbr>Id</a>
    ...
    <dd>{{% md %}}The Principal ID for the Service Principal associated with the system assigned identity of this Batch Account.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tenantid_csharp" style="color: inherit; text-decoration: inherit;">Tenant<wbr>Id</a>
    ...
    <dd>{{% md %}}The Tenant ID for the Service Principal associated with the system assigned identity of this Batch Account.
{{% /md %}}</dd></dl>
{{% /choosable %}}
