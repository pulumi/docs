...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_policy_set_definition(</span><span class="nx">display_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#policygroupnames_csharp" style="color: inherit; text-decoration: inherit;">Policy<wbr>Group<wbr>Names</a>
    ...
    <dd>{{% md %}}The list of names of the policy definition groups that this policy definition reference belongs to.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
