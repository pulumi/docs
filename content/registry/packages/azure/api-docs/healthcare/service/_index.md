...
---
title: "Service"
title_tag: "azure.healthcare.Service"
meta_desc: "Documentation for the azure.healthcare.Service resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<a href="#publicnetworkaccessenabled_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Whether public network access is enabled or disabled for this service instance.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
