...
title_tag: "azure.compute.getDedicatedHost"
meta_desc: "Documentation for the azure.compute.getDedicatedHost function with examples, input properties, output properties, and supporting types."
layout: api
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_dedicated_host(</span><span class="nx">dedicated_host_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="dedicatedhostgroupname_csharp">
<a href="#dedicatedhostgroupname_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Host<wbr>Group<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Specifies the name of the Dedicated Host Group the Dedicated Host is located in.
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Specifies the name of the Dedicated Host.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Specifies the name of the resource group the Dedicated Host is located in.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="dedicatedhostgroupname_go">
<a href="#dedicatedhostgroupname_go" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Host<wbr>Group<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="dedicatedhostgroupname_nodejs">
<a href="#dedicatedhostgroupname_nodejs" style="color: inherit; text-decoration: inherit;">dedicated<wbr>Host<wbr>Group<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="dedicated_host_group_name_python">
<a href="#dedicated_host_group_name_python" style="color: inherit; text-decoration: inherit;">dedicated_<wbr>host_<wbr>group_<wbr>name</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}The location where the Dedicated Host exists.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A mapping of tags assigned to the Dedicated Host.
{{% /md %}}</dd></dl>
{{% /choosable %}}
