...
title_tag: "aws-s3-replicated-bucket.ReplicatedBucket"
meta_desc: "Documentation for the aws-s3-replicated-bucket.ReplicatedBucket resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
## Create a ReplicatedBucket Resource {#create}
...
The ReplicatedBucket resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#destinationregion_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Region</a>
    ...
    <dd>{{% md %}}Region to which data should be replicated.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#destinationbucket_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Pulumi.<wbr>Aws.<wbr>S3.<wbr>Bucket</span>
    </dt>
    <dd>{{% md %}}Bucket to which data should be replicated.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The provider-assigned unique ID for this managed resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sourcebucket_csharp">
<a href="#sourcebucket_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Pulumi.<wbr>Aws.<wbr>S3.<wbr>Bucket</span>
    </dt>
    <dd>{{% md %}}Bucket to which objects are written.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#destinationbucket_go" style="color: inherit; text-decoration: inherit;">Destination<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#id_go" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The provider-assigned unique ID for this managed resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sourcebucket_go">
<a href="#sourcebucket_go" style="color: inherit; text-decoration: inherit;">Source<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Bucket</span>
    </dt>
...
<a href="#destinationbucket_nodejs" style="color: inherit; text-decoration: inherit;">destination<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#id_nodejs" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>{{% md %}}The provider-assigned unique ID for this managed resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sourcebucket_nodejs">
<a href="#sourcebucket_nodejs" style="color: inherit; text-decoration: inherit;">source<wbr>Bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">pulumi<wbr>Awss3Bucket</span>
    </dt>
...
<a href="#destination_bucket_python" style="color: inherit; text-decoration: inherit;">destination_<wbr>bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Bucket</span>
    </dt>
...
<a href="#id_python" style="color: inherit; text-decoration: inherit;">id</a>
    ...
    <dd>{{% md %}}The provider-assigned unique ID for this managed resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="source_bucket_python">
<a href="#source_bucket_python" style="color: inherit; text-decoration: inherit;">source_<wbr>bucket</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Bucket</span>
    </dt>
