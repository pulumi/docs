...
<span class="k">def </span><span class="nx">KafkaConnect</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">kafka_connect</span><span class="p">:</span> <span class="nx">Optional[KafkaConnectKafkaConnectArgs]</span> = None<span class="p">,</span>
...
<a href="#consumermaxpollrecords_csharp" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Max<wbr>Poll<wbr>Records</a>
    ...
    <dd>{{% md %}}The maximum number of records returned by a single poll.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
