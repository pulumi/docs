...
><span class="k">def </span>get_functions<span class="p">(</span><span class="nx">database</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_functions_output<span class="p">(</span><span class="nx">database</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#schema_csharp" style="color: inherit; text-decoration: inherit;">Schema</a>
    ...
    <dd>{{% md %}}The schema from which to return the functions from.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#functions_csharp" style="color: inherit; text-decoration: inherit;">Functions</a>
    ...
    <dd>{{% md %}}The functions in the schema
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
