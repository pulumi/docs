...
---
title: "Instance"
title_tag: "gcp.compute.Instance"
meta_desc: "Documentation for the gcp.compute.Instance resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Instance</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">confidential_instance_config</span><span class="p">:</span> <span class="nx">Optional[InstanceConfidentialInstanceConfigArgs]</span> = None<span class="p">,</span>
             ...
             <span class="nx">guest_accelerators</span><span class="p">:</span> <span class="nx">Optional[Sequence[InstanceGuestAcceleratorArgs]]</span> = None<span class="p">,</span>
             ...
             <span class="nx">scheduling</span><span class="p">:</span> <span class="nx">Optional[InstanceSchedulingArgs]</span> = None<span class="p">,</span>
             <span class="nx">scratch_disks</span><span class="p">:</span> <span class="nx">Optional[Sequence[InstanceScratchDiskArgs]]</span> = None<span class="p">,</span>
             <span class="nx">service_account</span><span class="p">:</span> <span class="nx">Optional[InstanceServiceAccountArgs]</span> = None<span class="p">,</span>
...
<a href="#attached_disks_python" style="color: inherit; text-decoration: inherit;">attached_<wbr>disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instanceattacheddisk">Sequence[Instance<wbr>Attached<wbr>Disk<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Additional disks to attach to the instance. Can be repeated multiple times for multiple disks. Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#guest_accelerators_python" style="color: inherit; text-decoration: inherit;">guest_<wbr>accelerators</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instanceguestaccelerator">Sequence[Instance<wbr>Guest<wbr>Accelerator<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of the type and count of accelerator cards attached to the instance. Structure documented below.
**Note:** GPU accelerators can only be used with `on_host_maintenance` option set to TERMINATE.
{{% /md %}}</dd><dt class="property-optional"
...
<a href="#scratch_disks_python" style="color: inherit; text-decoration: inherit;">scratch_<wbr>disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancescratchdisk">Sequence[Instance<wbr>Scratch<wbr>Disk<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Scratch disks to attach to the instance. This can be
specified multiple times for multiple scratch disks. Structure is documented below.
{{% /md %}}</dd><dt class="property-optional"
...
<h4 id="instanceconfidentialinstanceconfig">Instance<wbr>Confidential<wbr>Instance<wbr>Config</h4>
...
<a href="#ipv6accessconfigs_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Access<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancenetworkinterfaceipv6accessconfig">List&lt;Instance<wbr>Network<wbr>Interface<wbr>Ipv6Access<wbr>Config&gt;</a></span>
    </dt>
...
<a href="#ipv6accesstype_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Access<wbr>Type</a>
    ...
    <dd>{{% md %}}One of EXTERNAL, INTERNAL to indicate whether the IP can be accessed from the Internet.
...
<a href="#ipv6accessconfigs_go" style="color: inherit; text-decoration: inherit;">Ipv6Access<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancenetworkinterfaceipv6accessconfig">[]Instance<wbr>Network<wbr>Interface<wbr>Ipv6Access<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}An array of IPv6 access configurations for this interface.
Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig
specified, then this instance will have no external IPv6 Internet access. Structure documented below.
...
<a href="#ipv6_access_configs_python" style="color: inherit; text-decoration: inherit;">ipv6_<wbr>access_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#instancenetworkinterfaceipv6accessconfig">Sequence[Instance<wbr>Network<wbr>Interface<wbr>Ipv6Access<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}An array of IPv6 access configurations for this interface.
Currently, only one IPv6 access config, DIRECT_IPV6, is supported. If there is no ipv6AccessConfig
specified, then this instance will have no external IPv6 Internet access. Structure documented below.
...
<a href="#publicptrdomainname_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Ptr<wbr>Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}The domain name to be used when creating DNSv6
...
<h4 id="instancenetworkinterfaceipv6accessconfig">Instance<wbr>Network<wbr>Interface<wbr>Ipv6Access<wbr>Config</h4>
