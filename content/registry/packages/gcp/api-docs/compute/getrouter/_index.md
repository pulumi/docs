...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_router(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#bgps_python" style="color: inherit; text-decoration: inherit;">bgps</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getrouterbgp">Sequence[Get<wbr>Router<wbr>Bgp]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#advertised_ip_ranges_python" style="color: inherit; text-decoration: inherit;">advertised_<wbr>ip_<wbr>ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getrouterbgpadvertisediprange">Sequence[Get<wbr>Router<wbr>Bgp<wbr>Advertised<wbr>Ip<wbr>Range]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="asn_python">
