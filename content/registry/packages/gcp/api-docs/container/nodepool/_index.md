...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">upgrade_settings</span><span class="p">:</span> <span class="nx">Optional[NodePoolUpgradeSettingsArgs]</span> = None<span class="p">,</span>
        <span class="nx">version</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> NodePool</code></pre></div>
{{% /choosable %}}
...
<a href="#guest_accelerators_python" style="color: inherit; text-decoration: inherit;">guest_<wbr>accelerators</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodepoolnodeconfigguestaccelerator">Sequence[Node<wbr>Pool<wbr>Node<wbr>Config<wbr>Guest<wbr>Accelerator]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#taints_python" style="color: inherit; text-decoration: inherit;">taints</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodepoolnodeconfigtaint">Sequence[Node<wbr>Pool<wbr>Node<wbr>Config<wbr>Taint]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nodemetadata_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Metadata</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Deprecated in favor of mode.{{% /md %}}</p></dd></dl>
{{% /choosable %}}
