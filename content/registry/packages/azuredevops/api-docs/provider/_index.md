...
---
title: "Provider"
title_tag: "azuredevops.Provider"
meta_desc: "Documentation for the azuredevops.Provider resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/azuredevops/azuredevops/"
layout: api
---
...
<span class="k">def </span><span class="nx">Provider</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">org_service_url</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#orgserviceurl_csharp" style="color: inherit; text-decoration: inherit;">Org<wbr>Service<wbr>Url</a>
 ...
 It can also be sourced from the following environment variable: `AZDO_ORG_SERVICE_URL`{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
