...
<a href="#cidrs_csharp" style="color: inherit; text-decoration: inherit;">Cidrs</a>
    ...
    <dd>{{% md %}}The CIDR notation of the other end to affect, or a valid network CIDR (e.g. 0.0.0.0/0 to open for everyone or 1.2.3.4/32
...
<a href="#direction_csharp" style="color: inherit; text-decoration: inherit;">Direction</a>
    ...
    <dd>{{% md %}}Will this rule affect ingress traffic (only `ingress` is supported now)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#endport_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Port</a>
    ...
    <dd>{{% md %}}The end of the port range (this is optional, by default it will only apply to the single port listed in start_port)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#label_csharp" style="color: inherit; text-decoration: inherit;">Label</a>
    ...
    <dd>{{% md %}}A string that will be the displayed name/reference for this rule
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#protocol_csharp" style="color: inherit; text-decoration: inherit;">Protocol</a>
    ...
    <dd>{{% md %}}The protocol choice from `tcp`, `udp` or `icmp` (the default if unspecified is `tcp`)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#startport_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Port</a>
    ...
    <dd>{{% md %}}The start of the port range to configure for this rule (or the single port if required)
{{% /md %}}</dd></dl>
{{% /choosable %}}
