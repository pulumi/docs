...
<a href="#ttl_csharp" style="color: inherit; text-decoration: inherit;">Ttl</a>
    ...
    <dd>{{% md %}}How long caching DNS servers should cache this record for, in seconds (the minimum is 600 and the default if unspecified
is 600)
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The choice of RR type from a, cname, mx or txt
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The portion before the domain name (e.g. www) or an @ for the apex/root domain (you cannot use an A record with an
amex/root domain)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The account ID of this resource
...
<a href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>{{% md %}}Timestamp when this resource was created
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#updatedat_csharp" style="color: inherit; text-decoration: inherit;">Updated<wbr>At</a>
    ...
    <dd>{{% md %}}Timestamp when this resource was updated
{{% /md %}}</dd></dl>
{{% /choosable %}}
