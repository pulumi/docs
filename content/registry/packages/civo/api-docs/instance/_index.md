...
<span class="k">def </span><span class="nx">Instance</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
             ...
             <span class="nx">disk_image</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             ...
             <span class="nx">initial_user</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             ...
             <span class="nx">public_ip_required</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             <span class="nx">reverse_dns</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
             ...
             <span class="nx">sshkey_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="diskimage_csharp">
<a href="#diskimage_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}The ID for the disk image to use to build the instance
...
<a href="#firewallid_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the firewall to use, from the current list. If left blank or not sent, the default firewall will be used (open
to all)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Hostname</a>
    ...
    <dd>{{% md %}}A fully qualified domain name that should be set as the instance's hostname
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#initialuser_csharp" style="color: inherit; text-decoration: inherit;">Initial<wbr>User</a>
    ...
    <dd>{{% md %}}The name of the initial user created on the server (optional; this will default to the template's default_username and
fallback to civo)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publiciprequired_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Ip<wbr>Required</a>
    ...
    <dd>{{% md %}}This should be either 'none' or 'create' (default: 'create')
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}The region for the instance, if not declare we use the region in declared in the provider
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reversedns_csharp" style="color: inherit; text-decoration: inherit;">Reverse<wbr>Dns</a>
    ...
    <dd>{{% md %}}A fully qualified domain name that should be used as the instance's IP's reverse DNS (optional, uses the hostname if
unspecified)
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#script_csharp" style="color: inherit; text-decoration: inherit;">Script</a>
    ...
    <dd>{{% md %}}The contents of a script that will be uploaded to /usr/local/bin/civo-user-init-script on your instance,
...
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}The name of the size, from the current list, e.g. g3.xsmall
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sshkeyid_csharp" style="color: inherit; text-decoration: inherit;">Sshkey<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of an already uploaded SSH public key to use for login to the default user (optional; if one isn't provided a
...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}&#34;template&#34; attribute is deprecated. Moving forward, please use &#34;disk_image&#34; attribute.{{% /md %}}</p></dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="diskimage_go">
<a href="#diskimage_go" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="diskimage_nodejs">
<a href="#diskimage_nodejs" style="color: inherit; text-decoration: inherit;">disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="disk_image_python">
<a href="#disk_image_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>{{% md %}}Timestamp when the instance was created
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#initialpassword_csharp" style="color: inherit; text-decoration: inherit;">Initial<wbr>Password</a>
    ...
    <dd>{{% md %}}Initial password for login
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privateip_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Ip</a>
    ...
    <dd>{{% md %}}Instance's private IP address
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publicip_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Ip</a>
    ...
    <dd>{{% md %}}Instance's public IP address
{{% /md %}}</dd><dt class="property-"
            title="">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
        <span class="nx">cpu_cores</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">created_at</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">disk_gb</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">disk_image</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">firewall_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">hostname</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        ...
        <span class="nx">public_ip_required</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">ram_mb</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">reverse_dns</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">script</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">size</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        ...
        <span class="nx">tags</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
        <span class="nx">template</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> Instance</code></pre></div>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_diskimage_csharp">
<a href="#state_diskimage_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_diskimage_go">
<a href="#state_diskimage_go" style="color: inherit; text-decoration: inherit;">Disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_diskimage_nodejs">
<a href="#state_diskimage_nodejs" style="color: inherit; text-decoration: inherit;">disk<wbr>Image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_disk_image_python">
<a href="#state_disk_image_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>image</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
