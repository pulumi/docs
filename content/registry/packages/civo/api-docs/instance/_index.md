...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Hostname</a>
    ...
    <dd>{{% md %}}The Instance hostname, if is not declare the provider will generate one for you
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publiciprequired_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Ip<wbr>Required</a>
    ...
    <dd>{{% md %}}This should be either `create`, `none` or `move_ip_from:intances_id`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}The name of the size, from the current list, e.g. g3.k3s.small (required).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">pseudo_ip</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
