...
<a href="#licensemanager_csharp" style="color: inherit; text-decoration: inherit;">Licensemanager</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS License Manager{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#lightsail_csharp" style="color: inherit; text-decoration: inherit;">Lightsail</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Lightsail{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Location{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#macie_csharp" style="color: inherit; text-decoration: inherit;">Macie</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Macie{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#macie2_csharp" style="color: inherit; text-decoration: inherit;">Macie2</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Macie V2{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#managedblockchain_csharp" style="color: inherit; text-decoration: inherit;">Managedblockchain</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Managed Blockchain{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#marketplacecatalog_csharp" style="color: inherit; text-decoration: inherit;">Marketplacecatalog</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Marketplace Catalog{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mediaconnect_csharp" style="color: inherit; text-decoration: inherit;">Mediaconnect</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS MediaConnect{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mediaconvert_csharp" style="color: inherit; text-decoration: inherit;">Mediaconvert</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS MediaConvert{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#medialive_csharp" style="color: inherit; text-decoration: inherit;">Medialive</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS MediaLive{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mediapackage_csharp" style="color: inherit; text-decoration: inherit;">Mediapackage</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS MediaPackage{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mediastore_csharp" style="color: inherit; text-decoration: inherit;">Mediastore</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Elemental MediaStore container{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mediastoredata_csharp" style="color: inherit; text-decoration: inherit;">Mediastoredata</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Elemental MediaStore asset{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#memorydb_csharp" style="color: inherit; text-decoration: inherit;">Memorydb</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS MemoryDB for Redis{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="mq_csharp">
<a href="#mq_csharp" style="color: inherit; text-decoration: inherit;">Mq</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon MQ{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="mwaa_csharp">
<a href="#mwaa_csharp" style="color: inherit; text-decoration: inherit;">Mwaa</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Managed Workflows for Apache Airflow{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#neptune_csharp" style="color: inherit; text-decoration: inherit;">Neptune</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Neptune{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkfirewall_csharp" style="color: inherit; text-decoration: inherit;">Networkfirewall</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Network Firewall{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#networkmanager_csharp" style="color: inherit; text-decoration: inherit;">Networkmanager</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Network Manager{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#opsworks_csharp" style="color: inherit; text-decoration: inherit;">Opsworks</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS OpsWorks{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#organizations_csharp" style="color: inherit; text-decoration: inherit;">Organizations</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Organizations{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#outposts_csharp" style="color: inherit; text-decoration: inherit;">Outposts</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Outposts{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#personalize_csharp" style="color: inherit; text-decoration: inherit;">Personalize</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Personalize{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pinpoint_csharp" style="color: inherit; text-decoration: inherit;">Pinpoint</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Pinpoint{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pricing_csharp" style="color: inherit; text-decoration: inherit;">Pricing</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Web Services Price List Service{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="qldb_csharp">
<a href="#qldb_csharp" style="color: inherit; text-decoration: inherit;">Qldb</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon QLDB{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#quicksight_csharp" style="color: inherit; text-decoration: inherit;">Quicksight</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon QuickSight{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ram_csharp">
<a href="#ram_csharp" style="color: inherit; text-decoration: inherit;">Ram</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Resource Access Manager{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rds_csharp">
<a href="#rds_csharp" style="color: inherit; text-decoration: inherit;">Rds</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Relational Database Service{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#redshift_csharp" style="color: inherit; text-decoration: inherit;">Redshift</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Redshift{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcegroups_csharp" style="color: inherit; text-decoration: inherit;">Resourcegroups</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Resource Groups{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcegroupstaggingapi_csharp" style="color: inherit; text-decoration: inherit;">Resourcegroupstaggingapi</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Resource Groups Tagging API{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#route53_csharp" style="color: inherit; text-decoration: inherit;">Route53</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Route 53{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#route53domains_csharp" style="color: inherit; text-decoration: inherit;">Route53domains</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Route 53 Domains{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#route53recoverycontrolconfig_csharp" style="color: inherit; text-decoration: inherit;">Route53recoverycontrolconfig</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Route 53 Recovery Control{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#route53recoveryreadiness_csharp" style="color: inherit; text-decoration: inherit;">Route53recoveryreadiness</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Route 53 Recovery Readiness{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#route53resolver_csharp" style="color: inherit; text-decoration: inherit;">Route53resolver</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Route 53 Resolver{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="s3_csharp">
<a href="#s3_csharp" style="color: inherit; text-decoration: inherit;">S3</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Storage Service (S3){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#s3control_csharp" style="color: inherit; text-decoration: inherit;">S3control</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Storage Service (S3) Control{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#s3outposts_csharp" style="color: inherit; text-decoration: inherit;">S3outposts</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon S3 on Outposts{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sagemaker_csharp" style="color: inherit; text-decoration: inherit;">Sagemaker</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS SageMaker{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#schemas_csharp" style="color: inherit; text-decoration: inherit;">Schemas</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon EventBridge Schema Registry{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sdb_csharp">
<a href="#sdb_csharp" style="color: inherit; text-decoration: inherit;">Sdb</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon SimpleDB{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#secretsmanager_csharp" style="color: inherit; text-decoration: inherit;">Secretsmanager</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Secrets Manager{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#securityhub_csharp" style="color: inherit; text-decoration: inherit;">Securityhub</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Security Hub{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#serverlessrepo_csharp" style="color: inherit; text-decoration: inherit;">Serverlessrepo</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Serverless Application Repository{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#servicecatalog_csharp" style="color: inherit; text-decoration: inherit;">Servicecatalog</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Service Catalog{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#servicediscovery_csharp" style="color: inherit; text-decoration: inherit;">Servicediscovery</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Cloud Map{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#servicequotas_csharp" style="color: inherit; text-decoration: inherit;">Servicequotas</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Service Quotas{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ses_csharp">
<a href="#ses_csharp" style="color: inherit; text-decoration: inherit;">Ses</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Email Service (SES){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#shield_csharp" style="color: inherit; text-decoration: inherit;">Shield</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Shield Advanced API{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#signer_csharp" style="color: inherit; text-decoration: inherit;">Signer</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Signer{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sns_csharp">
<a href="#sns_csharp" style="color: inherit; text-decoration: inherit;">Sns</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Notification Service (SNS){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sqs_csharp">
<a href="#sqs_csharp" style="color: inherit; text-decoration: inherit;">Sqs</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Queue Service (SQS){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ssm_csharp">
<a href="#ssm_csharp" style="color: inherit; text-decoration: inherit;">Ssm</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Systems Manager{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ssoadmin_csharp" style="color: inherit; text-decoration: inherit;">Ssoadmin</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Single Sign On (SSO){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#stepfunctions_csharp" style="color: inherit; text-decoration: inherit;">Stepfunctions</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Step Functions{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storagegateway_csharp" style="color: inherit; text-decoration: inherit;">Storagegateway</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Storage Gateway{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="sts_csharp">
<a href="#sts_csharp" style="color: inherit; text-decoration: inherit;">Sts</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Security Token Service (STS){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="swf_csharp">
<a href="#swf_csharp" style="color: inherit; text-decoration: inherit;">Swf</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Simple Workflow Service (SWF){{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#synthetics_csharp" style="color: inherit; text-decoration: inherit;">Synthetics</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon CloudWatch Synthetics{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timestreamwrite_csharp" style="color: inherit; text-decoration: inherit;">Timestreamwrite</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon Timestream{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transfer_csharp" style="color: inherit; text-decoration: inherit;">Transfer</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS Transfer Family{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="waf_csharp">
<a href="#waf_csharp" style="color: inherit; text-decoration: inherit;">Waf</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS WAF Classic{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#wafregional_csharp" style="color: inherit; text-decoration: inherit;">Wafregional</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS WAF Regional Classic{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#wafv2_csharp" style="color: inherit; text-decoration: inherit;">Wafv2</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS WAF V2{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#worklink_csharp" style="color: inherit; text-decoration: inherit;">Worklink</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon WorkLink{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workmail_csharp" style="color: inherit; text-decoration: inherit;">Workmail</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon WorkMail{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workspaces_csharp" style="color: inherit; text-decoration: inherit;">Workspaces</a>
    ...
    <dd>{{% md %}}Override the default endpoint for Amazon WorkSpaces{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="xray_csharp">
<a href="#xray_csharp" style="color: inherit; text-decoration: inherit;">Xray</a>
    ...
    <dd>{{% md %}}Override the default endpoint for AWS X-Ray{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#keyprefixes_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Prefixes</a>
    ...
    <dd>{{% md %}}List of exact resource tag keys to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning the tag in any `tags` attributes and displaying any configuration difference for the tag value. If any resource configuration still has this tag key configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="keys_csharp">
<a href="#keys_csharp" style="color: inherit; text-decoration: inherit;">Keys</a>
    ...
    <dd>{{% md %}}List of resource tag key prefixes to ignore across all resources handled by this provider. This configuration prevents Pulumi from returning any tag key matching the prefixes in any `tags` attributes and displaying any configuration difference for those tag values. If any resource configuration still has a tag matching one of the prefixes configured in the `tags` argument, it will display a perpetual difference until the tag is removed from the argument or `ignoreChanges` is also used.{{% /md %}}</dd></dl>
{{% /choosable %}}
