...
---
title: "User"
title_tag: "aws-native.elasticache.User"
meta_desc: "Documentation for the aws-native.elasticache.User resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/aws-native/User/"
layout: api
---
...
<span class="k">def </span><span class="nx">User</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">engine</span><span class="p">:</span> <span class="nx">Optional[UserEngine]</span> = None<span class="p">,</span>
...
<a href="#engine_csharp" style="color: inherit; text-decoration: inherit;">Engine</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userengine">Pulumi.<wbr>Aws<wbr>Native.<wbr>Elasti<wbr>Cache.<wbr>User<wbr>Engine</a></span>
    </dt>
...
<a href="#accessstring_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>String</a>
    ...
    <dd>{{% md %}}Access permissions string used for this user account.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#nopasswordrequired_csharp" style="color: inherit; text-decoration: inherit;">No<wbr>Password<wbr>Required</a>
    ...
    <dd>{{% md %}}Indicates a password is not required for this user account.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#engine_go" style="color: inherit; text-decoration: inherit;">Engine</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#userengine">User<wbr>Engine</a></span>
    </dt>
    <dd>{{% md %}}Must be redis.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="userid_go">
...
<h4 id="userengine">User<wbr>Engine</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>User<wbr>Engine<wbr>Redis</dt>
    <dd>redis</dd></dl>
{{% /choosable %}}
