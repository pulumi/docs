...
<a href="#policy_csharp" style="color: inherit; text-decoration: inherit;">Policy</a>
    ...
    <dd>{{% md %}}The access point policy associated with this access point.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd>{{% md %}}Virtual Private Cloud (VPC) Id from which AccessPoint will allow requests.{{% /md %}}</dd></dl>
{{% /choosable %}}
