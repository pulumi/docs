...
---
title: "KeySigningKey"
title_tag: "aws-native.route53.KeySigningKey"
meta_desc: "Documentation for the aws-native.route53.KeySigningKey resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/aws-native/KeySigningKey/"
layout: api
---
...
<span class="k">def </span><span class="nx">KeySigningKey</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                  ...
                  <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[KeySigningKeyStatus]</span> = None<span class="p">)</span>
...
<a href="#hostedzoneid_csharp" style="color: inherit; text-decoration: inherit;">Hosted<wbr>Zone<wbr>Id</a>
    ...
    <dd>{{% md %}}The unique string (ID) used to identify a hosted zone.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<h4 id="keysigningkeystatus">Key<wbr>Signing<wbr>Key<wbr>Status</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Key<wbr>Signing<wbr>Key<wbr>Status<wbr>Active</dt>
    <dd>ACTIVE</dd><dt>Key<wbr>Signing<wbr>Key<wbr>Status<wbr>Inactive</dt>
    <dd>INACTIVE</dd></dl>
{{% /choosable %}}
