...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="documentationversionvalue_csharp">
<a href="#documentationversionvalue_csharp" style="color: inherit; text-decoration: inherit;">Documentation<wbr>Version<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}The version identifier of the API documentation snapshot.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#restapiid_csharp" style="color: inherit; text-decoration: inherit;">Rest<wbr>Api<wbr>Id</a>
    ...
    <dd>{{% md %}}The identifier of the API.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the API documentation snapshot.{{% /md %}}</dd></dl>
{{% /choosable %}}
