...
aliases:
    - "/docs/reference/pkg/aws-native/ModelQualityJobDefinition/"
...
<span class="k">def </span><span class="nx">ModelQualityJobDefinition</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                              <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">ModelQualityJobDefinitionArgs</a></span><span class="p">,</span>
...
<a href="#modelqualityjobinput_csharp" style="color: inherit; text-decoration: inherit;">Model<wbr>Quality<wbr>Job<wbr>Input</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#modelqualitybaselineconfig_nodejs" style="color: inherit; text-decoration: inherit;">model<wbr>Quality<wbr>Baseline<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionmodelqualitybaselineconfig">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Model<wbr>Quality<wbr>Baseline<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#model_quality_job_input_python" style="color: inherit; text-decoration: inherit;">model_<wbr>quality_<wbr>job_<wbr>input</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionmodelqualityjobinput">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Model<wbr>Quality<wbr>Job<wbr>Input<wbr>Args</a></span>
    </dt>
...
<a href="#clusterconfig_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionclusterconfig">Pulumi.<wbr>Aws<wbr>Native.<wbr>Sage<wbr>Maker.<wbr>Inputs.<wbr>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Cluster<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#clusterconfig_go" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionclusterconfig">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Cluster<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="modelqualityjobdefinitionnetworkconfig">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Network<wbr>Config</h4>
...
<a href="#vpcconfig_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionvpcconfig">Pulumi.<wbr>Aws<wbr>Native.<wbr>Sage<wbr>Maker.<wbr>Inputs.<wbr>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Vpc<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#vpcconfig_go" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitionvpcconfig">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Vpc<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="modelqualityjobdefinitionproblemtype">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Problem<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Binary<wbr>Classification</dt>
    <dd>BinaryClassification</dd><dt>Multiclass<wbr>Classification</dt>
    <dd>MulticlassClassification</dd><dt>Regression</dt>
    <dd>Regression</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Problem<wbr>Type<wbr>Binary<wbr>Classification</dt>
    <dd>BinaryClassification</dd><dt>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Problem<wbr>Type<wbr>Multiclass<wbr>Classification</dt>
    <dd>MulticlassClassification</dd><dt>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Problem<wbr>Type<wbr>Regression</dt>
    <dd>Regression</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>BINARY_CLASSIFICATION</dt>
    <dd>BinaryClassification</dd><dt>MULTICLASS_CLASSIFICATION</dt>
    <dd>MulticlassClassification</dd><dt>REGRESSION</dt>
    <dd>Regression</dd></dl>
{{% /choosable %}}

<h4 id="modelqualityjobdefinitions3output">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output</h4>
...
<a href="#s3uploadmode_csharp" style="color: inherit; text-decoration: inherit;">S3Upload<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitions3outputs3uploadmode">Pulumi.<wbr>Aws<wbr>Native.<wbr>Sage<wbr>Maker.<wbr>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output<wbr>S3Upload<wbr>Mode</a></span>
    </dt>
...
<a href="#s3uploadmode_go" style="color: inherit; text-decoration: inherit;">S3Upload<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#modelqualityjobdefinitions3outputs3uploadmode">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output<wbr>S3Upload<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}Whether to upload the results of the monitoring job continuously or after the job completes.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="modelqualityjobdefinitions3outputs3uploadmode">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output<wbr>S3Upload<wbr>Mode</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output<wbr>S3Upload<wbr>Mode<wbr>Continuous</dt>
    <dd>Continuous</dd><dt>Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>S3Output<wbr>S3Upload<wbr>Mode<wbr>End<wbr>Of<wbr>Job</dt>
    <dd>EndOfJob</dd></dl>
{{% /choosable %}}
...
<h4 id="modelqualityjobdefinitionstoppingcondition">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Stopping<wbr>Condition</h4>
...
<h4 id="modelqualityjobdefinitiontag">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Tag</h4>
...
<h4 id="modelqualityjobdefinitionvpcconfig">Model<wbr>Quality<wbr>Job<wbr>Definition<wbr>Vpc<wbr>Config</h4>
