...
---
title: "Service"
title_tag: "google-native.servicedirectory/v1beta1.Service"
meta_desc: "Documentation for the google-native.servicedirectory/v1beta1.Service resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Immutable. The resource name for the service in the format `projects/*/locations/*/namespaces/*/services/*`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
