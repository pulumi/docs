...
<span class="k">def </span><span class="nx">Feed</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">condition</span><span class="p">:</span> <span class="nx">Optional[ExprArgs]</span> = None<span class="p">,</span>
         <span class="nx">content_type</span><span class="p">:</span> <span class="nx">Optional[FeedContentType]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewFeed</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">FeedArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Feed</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#feedid_csharp" style="color: inherit; text-decoration: inherit;">Feed<wbr>Id</a>
    ...
    <dd>{{% md %}}This is the client-assigned asset feed identifier and it needs to be unique under a specific parent project/folder/organization.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#feedoutputconfig_csharp" style="color: inherit; text-decoration: inherit;">Feed<wbr>Output<wbr>Config</a>
    ...
    <dd>{{% md %}}Feed output configuration defining where the asset updates are published to.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
...
<a href="#pubsubdestination_csharp" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubdestination">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Asset.<wbr>V1.<wbr>Inputs.<wbr>Pubsub<wbr>Destination</a></span>
    </dt>
