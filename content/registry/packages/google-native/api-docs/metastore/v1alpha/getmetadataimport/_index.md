...
title_tag: "google-native.metastore/v1alpha.getMetadataImport"
meta_desc: "Documentation for the google-native.metastore/v1alpha.getMetadataImport function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
...
<a href="#databasedump_csharp" style="color: inherit; text-decoration: inherit;">Database<wbr>Dump</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#databasedumpresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Metastore.<wbr>V1Alpha.<wbr>Outputs.<wbr>Database<wbr>Dump<wbr>Response</a></span>
    </dt>
