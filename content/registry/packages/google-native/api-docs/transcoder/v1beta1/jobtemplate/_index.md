...
aliases:
    - "/docs/reference/pkg/google-native/JobTemplate/"
...
<a href="#bitratebps_csharp" style="color: inherit; text-decoration: inherit;">Bitrate<wbr>Bps</a>
    ...
    <dd>{{% md %}}Audio bitrate in bits per second. Must be between 1 and 10,000,000.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mapping_csharp" style="color: inherit; text-decoration: inherit;">Mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#audioatom">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Audio<wbr>Atom&gt;</a></span>
    </dt>
...
<a href="#mapping_python" style="color: inherit; text-decoration: inherit;">mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#audioatom">Sequence[Audio<wbr>Atom]</a></span>
    </dt>
    <dd>{{% md %}}The mapping for the `Job.edit_list` atoms with audio `EditAtom.inputs`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#audiostream_csharp" style="color: inherit; text-decoration: inherit;">Audio<wbr>Stream</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#audiostream">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Audio<wbr>Stream</a></span>
    </dt>
...
<a href="#textstream_csharp" style="color: inherit; text-decoration: inherit;">Text<wbr>Stream</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textstream">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Text<wbr>Stream</a></span>
    </dt>
...
<a href="#videostream_csharp" style="color: inherit; text-decoration: inherit;">Video<wbr>Stream</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#videostream">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Video<wbr>Stream</a></span>
    </dt>
...
<a href="#iv_csharp" style="color: inherit; text-decoration: inherit;">Iv</a>
    ...
    <dd>{{% md %}}128 bit Initialization Vector (IV) represented as lowercase hexadecimal digits.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="key_csharp">
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
</span>
    ...
    <dd>{{% md %}}128 bit encryption key represented as lowercase hexadecimal digits.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="aes128_csharp">
<a href="#aes128_csharp" style="color: inherit; text-decoration: inherit;">Aes128</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aes128encryption">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Aes128Encryption</a></span>
    </dt>
...
<a href="#mpegcenc_csharp" style="color: inherit; text-decoration: inherit;">Mpeg<wbr>Cenc</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mpegcommonencryption">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Mpeg<wbr>Common<wbr>Encryption</a></span>
    </dt>
...
<a href="#sampleaes_csharp" style="color: inherit; text-decoration: inherit;">Sample<wbr>Aes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sampleaesencryption">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Sample<wbr>Aes<wbr>Encryption</a></span>
    </dt>
...
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>{{% md %}}128 bit encryption key represented as lowercase hexadecimal digits.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="mpegcenc_csharp">
<a href="#mpegcenc_csharp" style="color: inherit; text-decoration: inherit;">Mpeg<wbr>Cenc</a>
</span>
...
<a href="#uri_csharp" style="color: inherit; text-decoration: inherit;">Uri</a>
    ...
    <dd>{{% md %}}URI of the JPEG image in Cloud Storage. For example, `gs://bucket/inputs/image.jpeg`. JPEG is the only supported image type.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#alpha_csharp" style="color: inherit; text-decoration: inherit;">Alpha</a>
    ...
    <dd>{{% md %}}Target image opacity. Valid values are from `1.0` (solid, default) to `0.0` (transparent), exclusive. Set this to a value greater than `0.0`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resolution_csharp" style="color: inherit; text-decoration: inherit;">Resolution</a>
    ...
    <dd>{{% md %}}Normalized image resolution, based on output video resolution. Valid values: `0.0`–`1.0`. To respect the original image aspect ratio, set either `x` or `y` to `0.0`. To use the original image resolution, set both `x` and `y` to `0.0`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#alpha_csharp" style="color: inherit; text-decoration: inherit;">Alpha</a>
    ...
    <dd>{{% md %}}Target image opacity. Valid values are from `1.0` (solid, default) to `0.0` (transparent), exclusive. Set this to a value greater than `0.0`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resolution_csharp">
<a href="#resolution_csharp" style="color: inherit; text-decoration: inherit;">Resolution</a>
</span>
...
<a href="#uri_csharp" style="color: inherit; text-decoration: inherit;">Uri</a>
    ...
    <dd>{{% md %}}URI of the JPEG image in Cloud Storage. For example, `gs://bucket/inputs/image.jpeg`. JPEG is the only supported image type.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#preprocessingconfig_csharp" style="color: inherit; text-decoration: inherit;">Preprocessing<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#preprocessingconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Preprocessing<wbr>Config</a></span>
    </dt>
...
<a href="#adbreaks_csharp" style="color: inherit; text-decoration: inherit;">Ad<wbr>Breaks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#adbreak">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Ad<wbr>Break&gt;</a></span>
    </dt>
...
<a href="#editlist_csharp" style="color: inherit; text-decoration: inherit;">Edit<wbr>List</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#editatom">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Edit<wbr>Atom&gt;</a></span>
    </dt>
...
<a href="#elementarystreams_csharp" style="color: inherit; text-decoration: inherit;">Elementary<wbr>Streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elementarystream">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Elementary<wbr>Stream&gt;</a></span>
    </dt>
...
<a href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#input">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Input&gt;</a></span>
    </dt>
...
<a href="#manifests_csharp" style="color: inherit; text-decoration: inherit;">Manifests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#manifest">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Manifest&gt;</a></span>
    </dt>
...
<a href="#muxstreams_csharp" style="color: inherit; text-decoration: inherit;">Mux<wbr>Streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#muxstream">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Mux<wbr>Stream&gt;</a></span>
    </dt>
...
<a href="#output_csharp" style="color: inherit; text-decoration: inherit;">Output</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#output">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Output</a></span>
    </dt>
...
<a href="#overlays_csharp" style="color: inherit; text-decoration: inherit;">Overlays</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#overlay">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Overlay&gt;</a></span>
    </dt>
...
<a href="#pubsubdestination_csharp" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pubsubdestination">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Pubsub<wbr>Destination</a></span>
    </dt>
...
<a href="#spritesheets_csharp" style="color: inherit; text-decoration: inherit;">Sprite<wbr>Sheets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#spritesheet">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Sprite<wbr>Sheet&gt;</a></span>
    </dt>
...
<a href="#ad_breaks_python" style="color: inherit; text-decoration: inherit;">ad_<wbr>breaks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#adbreak">Sequence[Ad<wbr>Break]</a></span>
    </dt>
    <dd>{{% md %}}List of ad breaks. Specifies where to insert ad break tags in the output manifests.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#edit_list_python" style="color: inherit; text-decoration: inherit;">edit_<wbr>list</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#editatom">Sequence[Edit<wbr>Atom]</a></span>
    </dt>
    <dd>{{% md %}}List of `Edit atom`s. Defines the ultimate timeline of the resulting file or manifest.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#elementary_streams_python" style="color: inherit; text-decoration: inherit;">elementary_<wbr>streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elementarystream">Sequence[Elementary<wbr>Stream]</a></span>
    </dt>
    <dd>{{% md %}}List of elementary streams.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="inputs_python">
<a href="#inputs_python" style="color: inherit; text-decoration: inherit;">inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#input">Sequence[Input]</a></span>
    </dt>
    <dd>{{% md %}}List of input assets stored in Cloud Storage.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mux_streams_python" style="color: inherit; text-decoration: inherit;">mux_<wbr>streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#muxstream">Sequence[Mux<wbr>Stream]</a></span>
    </dt>
    <dd>{{% md %}}List of multiplexing settings for output streams.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#overlays_python" style="color: inherit; text-decoration: inherit;">overlays</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#overlay">Sequence[Overlay]</a></span>
    </dt>
    <dd>{{% md %}}List of overlays on the output video, in descending Z-order.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sprite_sheets_python" style="color: inherit; text-decoration: inherit;">sprite_<wbr>sheets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#spritesheet">Sequence[Sprite<wbr>Sheet]</a></span>
    </dt>
    <dd>{{% md %}}List of output sprite sheets.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ad_breaks_python" style="color: inherit; text-decoration: inherit;">ad_<wbr>breaks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#adbreakresponse">Sequence[Ad<wbr>Break<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of ad breaks. Specifies where to insert ad break tags in the output manifests.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="edit_list_python">
<a href="#edit_list_python" style="color: inherit; text-decoration: inherit;">edit_<wbr>list</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#editatomresponse">Sequence[Edit<wbr>Atom<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of `Edit atom`s. Defines the ultimate timeline of the resulting file or manifest.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="elementary_streams_python">
<a href="#elementary_streams_python" style="color: inherit; text-decoration: inherit;">elementary_<wbr>streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#elementarystreamresponse">Sequence[Elementary<wbr>Stream<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of elementary streams.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="inputs_python">
...
<a href="#manifests_python" style="color: inherit; text-decoration: inherit;">manifests</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#manifestresponse">Sequence[Manifest<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of output manifests.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="mux_streams_python">
<a href="#mux_streams_python" style="color: inherit; text-decoration: inherit;">mux_<wbr>streams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#muxstreamresponse">Sequence[Mux<wbr>Stream<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of multiplexing settings for output streams.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="output_python">
...
<a href="#overlays_python" style="color: inherit; text-decoration: inherit;">overlays</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#overlayresponse">Sequence[Overlay<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of overlays on the output video, in descending Z-order.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="pubsub_destination_python">
...
<a href="#sprite_sheets_python" style="color: inherit; text-decoration: inherit;">sprite_<wbr>sheets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#spritesheetresponse">Sequence[Sprite<wbr>Sheet<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of output sprite sheets.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#muxstreams_csharp" style="color: inherit; text-decoration: inherit;">Mux<wbr>Streams</a>
    ...
    <dd>{{% md %}}List of user given `MuxStream.key`s that should appear in this manifest. When `Manifest.type` is `HLS`, a media manifest with name `MuxStream.key` and `.m3u8` extension is generated for each element of the `Manifest.mux_streams`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of the manifest, can be "HLS" or "DASH".{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#filename_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the generated file. The default is `"manifest"` with the extension suffix corresponding to the `Manifest.type`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of the manifest, can be "HLS" or "DASH".{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#keyid_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Id</a>
    ...
    <dd>{{% md %}}128 bit Key ID represented as lowercase hexadecimal digits for use with common encryption.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#scheme_csharp" style="color: inherit; text-decoration: inherit;">Scheme</a>
    ...
    <dd>{{% md %}}Specify the encryption scheme. Supported encryption schemes: - 'cenc' - 'cbcs'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#encryption_csharp" style="color: inherit; text-decoration: inherit;">Encryption</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#encryption">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Encryption</a></span>
    </dt>
...
<a href="#segmentsettings_csharp" style="color: inherit; text-decoration: inherit;">Segment<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#segmentsettings">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Segment<wbr>Settings</a></span>
    </dt>
...
<a href="#animations_csharp" style="color: inherit; text-decoration: inherit;">Animations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#animation">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Animation&gt;</a></span>
    </dt>
...
<a href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#image">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Image</a></span>
    </dt>
...
<a href="#animations_python" style="color: inherit; text-decoration: inherit;">animations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#animation">Sequence[Animation]</a></span>
    </dt>
    <dd>{{% md %}}List of Animations. The list should be chronological, without any time overlap.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#animations_python" style="color: inherit; text-decoration: inherit;">animations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#animationresponse">Sequence[Animation<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of Animations. The list should be chronological, without any time overlap.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="image_python">
...
<a href="#audio_csharp" style="color: inherit; text-decoration: inherit;">Audio</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#audio">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Audio</a></span>
    </dt>
...
<a href="#color_csharp" style="color: inherit; text-decoration: inherit;">Color</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#color">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Color</a></span>
    </dt>
...
<a href="#crop_csharp" style="color: inherit; text-decoration: inherit;">Crop</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crop">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Crop</a></span>
    </dt>
...
<a href="#deblock_csharp" style="color: inherit; text-decoration: inherit;">Deblock</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deblock">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Deblock</a></span>
    </dt>
...
<a href="#denoise_csharp" style="color: inherit; text-decoration: inherit;">Denoise</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#denoise">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Denoise</a></span>
    </dt>
...
<a href="#pad_csharp" style="color: inherit; text-decoration: inherit;">Pad</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pad">Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Pad</a></span>
    </dt>
...
<a href="#individualsegments_csharp" style="color: inherit; text-decoration: inherit;">Individual<wbr>Segments</a>
    ...
    <dd>{{% md %}}Create an individual segment file. The default is `false`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#individualsegments_csharp" style="color: inherit; text-decoration: inherit;">Individual<wbr>Segments</a>
    ...
    <dd>{{% md %}}Create an individual segment file. The default is `false`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="segmentduration_csharp">
<a href="#segmentduration_csharp" style="color: inherit; text-decoration: inherit;">Segment<wbr>Duration</a>
</span>
...
<a href="#fileprefix_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Prefix</a>
    ...
    <dd>{{% md %}}File name prefix for the generated sprite sheets. Each sprite sheet has an incremental 10-digit zero-padded suffix starting from 0 before the extension, such as `"sprite_sheet0000000123.jpeg"`.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#spriteheightpixels_csharp" style="color: inherit; text-decoration: inherit;">Sprite<wbr>Height<wbr>Pixels</a>
    ...
    <dd>{{% md %}}The height of sprite in pixels. Must be an even integer. To preserve the source aspect ratio, set the SpriteSheet.sprite_height_pixels field or the SpriteSheet.sprite_width_pixels field, but not both (the API will automatically calculate the missing field).{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#spritewidthpixels_csharp" style="color: inherit; text-decoration: inherit;">Sprite<wbr>Width<wbr>Pixels</a>
    ...
    <dd>{{% md %}}The width of sprite in pixels. Must be an even integer. To preserve the source aspect ratio, set the SpriteSheet.sprite_width_pixels field or the SpriteSheet.sprite_height_pixels field, but not both (the API will automatically calculate the missing field).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#spritewidthpixels_csharp" style="color: inherit; text-decoration: inherit;">Sprite<wbr>Width<wbr>Pixels</a>
    ...
    <dd>{{% md %}}The width of sprite in pixels. Must be an even integer. To preserve the source aspect ratio, set the SpriteSheet.sprite_width_pixels field or the SpriteSheet.sprite_height_pixels field, but not both (the API will automatically calculate the missing field).{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="starttimeoffset_csharp">
<a href="#starttimeoffset_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time<wbr>Offset</a>
</span>
...
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>{{% md %}}The `EditAtom.key` that references atom with text inputs in the `Job.edit_list`.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="inputs_csharp">
<a href="#inputs_csharp" style="color: inherit; text-decoration: inherit;">Inputs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textinput">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Text<wbr>Input&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of `Job.inputs` that should be embedded in this atom. Only one input is supported.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#inputs_python" style="color: inherit; text-decoration: inherit;">inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textinput">Sequence[Text<wbr>Input]</a></span>
    </dt>
    <dd>{{% md %}}List of `Job.inputs` that should be embedded in this atom. Only one input is supported.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#key_csharp" style="color: inherit; text-decoration: inherit;">Key</a>
    ...
    <dd>{{% md %}}The `EditAtom.key` that references atom with text inputs in the `Job.edit_list`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#inputs_python" style="color: inherit; text-decoration: inherit;">inputs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textinputresponse">Sequence[Text<wbr>Input<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of `Job.inputs` that should be embedded in this atom. Only one input is supported.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="key_python">
...
<a href="#languagecode_csharp" style="color: inherit; text-decoration: inherit;">Language<wbr>Code</a>
    ...
    <dd>{{% md %}}The BCP-47 language code, such as `"en-US"` or `"sr-Latn"`. For more information, see https://www.unicode.org/reports/tr35/#Unicode_locale_identifier.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="codec_csharp">
<a href="#codec_csharp" style="color: inherit; text-decoration: inherit;">Codec</a>
</span>
...
<a href="#mapping_csharp" style="color: inherit; text-decoration: inherit;">Mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textatom">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Transcoder.<wbr>V1Beta1.<wbr>Inputs.<wbr>Text<wbr>Atom&gt;</a></span>
    </dt>
...
<a href="#mapping_python" style="color: inherit; text-decoration: inherit;">mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textatom">Sequence[Text<wbr>Atom]</a></span>
    </dt>
    <dd>{{% md %}}The mapping for the `Job.edit_list` atoms with text `EditAtom.inputs`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#languagecode_csharp" style="color: inherit; text-decoration: inherit;">Language<wbr>Code</a>
    ...
    <dd>{{% md %}}The BCP-47 language code, such as `"en-US"` or `"sr-Latn"`. For more information, see https://www.unicode.org/reports/tr35/#Unicode_locale_identifier.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="mapping_csharp">
<a href="#mapping_csharp" style="color: inherit; text-decoration: inherit;">Mapping</a>
</span>
...
<a href="#mapping_python" style="color: inherit; text-decoration: inherit;">mapping</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#textatomresponse">Sequence[Text<wbr>Atom<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The mapping for the `Job.edit_list` atoms with text `EditAtom.inputs`.{{% /md %}}</dd></dl>
{{% /choosable %}}
