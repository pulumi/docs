...
---
title: "getScanConfig"
title_tag: "google-native.websecurityscanner/v1.getScanConfig"
meta_desc: "Documentation for the google-native.websecurityscanner/v1.getScanConfig function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#authentication_csharp" style="color: inherit; text-decoration: inherit;">Authentication</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authenticationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Web<wbr>Security<wbr>Scanner.<wbr>V1.<wbr>Outputs.<wbr>Authentication<wbr>Response</a></span>
    </dt>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The user provided display name of the ScanConfig.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduleresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Web<wbr>Security<wbr>Scanner.<wbr>V1.<wbr>Outputs.<wbr>Schedule<wbr>Response</a></span>
    </dt>
...
<a href="#startingurls_csharp" style="color: inherit; text-decoration: inherit;">Starting<wbr>Urls</a>
    ...
    <dd>{{% md %}}The starting URLs from which the scanner finds site pages.{{% /md %}}</dd><dt class="property-"
            title="">
