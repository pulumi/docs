...
<dl class="tabular"><dt>State<wbr>Unspecified</dt>
    ...
    <dd>UPDATE_FAILED{{% md %}}The job state resulting from a failed CloudScheduler.UpdateJob operation. To recover a job from this state, retry CloudScheduler.UpdateJob until a successful response is received.{{% /md %}}</dd><dt>Initializing</dt>
    <dd>INITIALIZING{{% md %}}The schedule resource is being created.{{% /md %}}</dd><dt>Deleting</dt>
    <dd>DELETING{{% md %}}The schedule resource is being deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Schedule<wbr>State<wbr>State<wbr>Unspecified</dt>
    ...
    <dd>UPDATE_FAILED{{% md %}}The job state resulting from a failed CloudScheduler.UpdateJob operation. To recover a job from this state, retry CloudScheduler.UpdateJob until a successful response is received.{{% /md %}}</dd><dt>Schedule<wbr>State<wbr>Initializing</dt>
    <dd>INITIALIZING{{% md %}}The schedule resource is being created.{{% /md %}}</dd><dt>Schedule<wbr>State<wbr>Deleting</dt>
    <dd>DELETING{{% md %}}The schedule resource is being deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}
