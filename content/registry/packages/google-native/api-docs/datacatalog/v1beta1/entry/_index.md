...
<span class="k">def </span><span class="nx">Entry</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">bigquery_date_sharded_spec</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDatacatalogV1beta1BigQueryDateShardedSpecArgs]</span> = None<span class="p">,</span>
          <span class="nx">bigquery_table_spec</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDatacatalogV1beta1BigQueryTableSpecArgs]</span> = None<span class="p">,</span>
          ...
          <span class="nx">gcs_fileset_spec</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDatacatalogV1beta1GcsFilesetSpecArgs]</span> = None<span class="p">,</span>
          ...
          <span class="nx">schema</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDatacatalogV1beta1SchemaArgs]</span> = None<span class="p">,</span>
...
<a href="#usagesignal_csharp" style="color: inherit; text-decoration: inherit;">Usage<wbr>Signal</a>
    ...
    <dd>{{% md %}}Statistics on the usage level of the resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tablespec_csharp" style="color: inherit; text-decoration: inherit;">Table<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1tablespec">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Table<wbr>Spec</a></span>
    </dt>
...
<a href="#viewspec_csharp" style="color: inherit; text-decoration: inherit;">View<wbr>Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1viewspec">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1View<wbr>Spec</a></span>
    </dt>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of the column.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
...
<a href="#subcolumns_csharp" style="color: inherit; text-decoration: inherit;">Subcolumns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1columnschema">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Catalog.<wbr>V1Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Column<wbr>Schema&gt;</a></span>
    </dt>
    <dd>{{% md %}}Optional. Schema of sub-columns. A column can have zero or more sub-columns.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#subcolumns_python" style="color: inherit; text-decoration: inherit;">subcolumns</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddatacatalogv1beta1columnschema">Sequence[Google<wbr>Cloud<wbr>Datacatalog<wbr>V1beta1Column<wbr>Schema]</a></span>
    </dt>
    <dd>{{% md %}}Optional. Schema of sub-columns. A column can have zero or more sub-columns.{{% /md %}}</dd></dl>
{{% /choosable %}}
