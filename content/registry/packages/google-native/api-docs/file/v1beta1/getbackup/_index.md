...
---
title: "getBackup"
title_tag: "google-native.file/v1beta1.getBackup"
meta_desc: "Documentation for the google-native.file/v1beta1.getBackup function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}A description of the backup with 2048 characters or less. Requests with longer descriptions will be rejected.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcefileshare_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>File<wbr>Share</a>
    ...
    <dd>{{% md %}}Name of the file share in the source Cloud Filestore instance that the backup is created from.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceinstance_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Instance</a>
    ...
    <dd>{{% md %}}The resource name of the source Cloud Filestore instance, in the format projects/{project_id}/locations/{location_id}/instances/{instance_id}, used to create this backup.{{% /md %}}</dd><dt class="property-"
            title="">
