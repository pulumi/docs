...
---
title: "getJob"
title_tag: "google-native.jobs/v3.getJob"
meta_desc: "Documentation for the google-native.jobs/v3.getJob function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
...
<a href="#applicationinfo_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V3.<wbr>Outputs.<wbr>Application<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}At least one field within ApplicationInfo must be specified. Job application information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#companyname_csharp" style="color: inherit; text-decoration: inherit;">Company<wbr>Name</a>
    ...
    <dd>{{% md %}}The resource name of the company listing the job, such as "projects/api-test-project/companies/foo".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#compensationinfo_csharp" style="color: inherit; text-decoration: inherit;">Compensation<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#compensationinforesponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V3.<wbr>Outputs.<wbr>Compensation<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job compensation information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customattributes_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Attributes</a>
    ...
    <dd>{{% md %}}Optional. A map of fields to hold both filterable and non-filterable custom job attributes that are not covered by the provided structured fields. The keys of the map are strings up to 64 bytes and must match the pattern: a-zA-Z*. For example, key0LikeThis or KEY_1_LIKE_THIS. At most 100 filterable and at most 100 unfilterable keys are supported. For filterable `string_values`, across all keys at most 200 values are allowed, with each string no more than 255 characters. For unfilterable `string_values`, the maximum total size of `string_values` across all keys is 50KB.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#degreetypes_csharp" style="color: inherit; text-decoration: inherit;">Degree<wbr>Types</a>
    ...
    <dd>{{% md %}}Optional. The desired education degrees for the job, such as Bachelors, Masters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#department_csharp" style="color: inherit; text-decoration: inherit;">Department</a>
    ...
    <dd>{{% md %}}Optional. The department or functional area within the company with the open position. The maximum number of allowed characters is 255.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#employmenttypes_csharp" style="color: inherit; text-decoration: inherit;">Employment<wbr>Types</a>
    ...
    <dd>{{% md %}}Optional. The employment type(s) of a job, for example, full time or part time.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#incentives_csharp" style="color: inherit; text-decoration: inherit;">Incentives</a>
    ...
    <dd>{{% md %}}Optional. A description of bonus, commission, and other compensation incentives associated with the job not including salary or pay. The maximum number of allowed characters is 10,000.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobbenefits_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Benefits</a>
    ...
    <dd>{{% md %}}Optional. The benefits included with the job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobendtime_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>End<wbr>Time</a>
    ...
    <dd>{{% md %}}Optional. The end timestamp of the job. Typically this field is used for contracting engagements. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#joblevel_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Level</a>
    ...
    <dd>{{% md %}}Optional. The experience level associated with the job, such as "Entry Level".{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jobstarttime_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Start<wbr>Time</a>
    ...
    <dd>{{% md %}}Optional. The start timestamp of the job in UTC time zone. Typically this field is used for contracting engagements. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#postingpublishtime_csharp" style="color: inherit; text-decoration: inherit;">Posting<wbr>Publish<wbr>Time</a>
    ...
    <dd>{{% md %}}Optional. The timestamp this job posting was most recently published. The default value is the time the request arrives at the server. Invalid timestamps are ignored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#postingupdatetime_csharp" style="color: inherit; text-decoration: inherit;">Posting<wbr>Update<wbr>Time</a>
    ...
    <dd>{{% md %}}The timestamp when this job posting was last updated.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#processingoptions_csharp" style="color: inherit; text-decoration: inherit;">Processing<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#processingoptionsresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Jobs.<wbr>V3.<wbr>Outputs.<wbr>Processing<wbr>Options<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Options for job processing.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#promotionvalue_csharp" style="color: inherit; text-decoration: inherit;">Promotion<wbr>Value</a>
    ...
    <dd>{{% md %}}Optional. A promotion value of the job, as determined by the client. The value determines the sort order of the jobs returned when searching for jobs using the featured jobs search call, with higher promotional values being returned first and ties being resolved by relevance sort. Only the jobs with a promotionValue >0 are returned in a FEATURED_JOB_SEARCH. Default value is 0, and negative values are treated as 0.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#qualifications_csharp" style="color: inherit; text-decoration: inherit;">Qualifications</a>
    ...
    <dd>{{% md %}}Optional. A description of the qualifications required to perform the job. The use of this field is recommended as an alternative to using the more general description field. This field accepts and sanitizes HTML input, and also accepts bold, italic, ordered list, and unordered list markup tags. The maximum number of allowed characters is 10,000.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#title_csharp" style="color: inherit; text-decoration: inherit;">Title</a>
    ...
    <dd>{{% md %}}The title of the job, such as "Software Engineer" The maximum number of allowed characters is 500.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#applicationinfo_go" style="color: inherit; text-decoration: inherit;">Application<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applicationinforesponse">Application<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}At least one field within ApplicationInfo must be specified. Job application information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#compensationinfo_go" style="color: inherit; text-decoration: inherit;">Compensation<wbr>Info</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#compensationinforesponse">Compensation<wbr>Info<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job compensation information.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#processingoptions_go" style="color: inherit; text-decoration: inherit;">Processing<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#processingoptionsresponse">Processing<wbr>Options<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Options for job processing.{{% /md %}}</dd><dt class="property-"
            title="">
