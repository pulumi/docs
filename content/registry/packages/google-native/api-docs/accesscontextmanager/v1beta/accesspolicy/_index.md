...
---
title: "AccessPolicy"
title_tag: "google-native.accesscontextmanager/v1beta.AccessPolicy"
meta_desc: "Documentation for the google-native.accesscontextmanager/v1beta.AccessPolicy resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<a href="#parent_csharp" style="color: inherit; text-decoration: inherit;">Parent</a>
    ...
    <dd>{{% md %}}The parent of this `AccessPolicy` in the Cloud Resource Hierarchy. Currently immutable once created. Format: `organizations/{organization_id}`{{% /md %}}</dd><dt class="property-required"
            title="Required">
