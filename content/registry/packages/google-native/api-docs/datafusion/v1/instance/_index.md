...
<a href="#cryptokeyconfig_csharp" style="color: inherit; text-decoration: inherit;">Crypto<wbr>Key<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#cryptokeyconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Data<wbr>Fusion.<wbr>V1.<wbr>Inputs.<wbr>Crypto<wbr>Key<wbr>Config<wbr>Args</a></span>
    </dt>
...
<dl class="tabular"><dt>Accelerator<wbr>Type<wbr>Unspecified</dt>
    ...
    <dd>HEALTHCARE{{% md %}}Cloud Healthcare accelerator for CDF. This accelerator is to enable Cloud Healthcare specific CDF plugins developed by Healthcare team.{{% /md %}}</dd><dt>Ccai<wbr>Insights</dt>
    <dd>CCAI_INSIGHTS{{% md %}}Contact Center AI Insights This accelerator is used to enable import and export pipelines custom built to streamline CCAI Insights processing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Accelerator<wbr>Accelerator<wbr>Type<wbr>Accelerator<wbr>Type<wbr>Unspecified</dt>
    ...
    <dd>HEALTHCARE{{% md %}}Cloud Healthcare accelerator for CDF. This accelerator is to enable Cloud Healthcare specific CDF plugins developed by Healthcare team.{{% /md %}}</dd><dt>Accelerator<wbr>Accelerator<wbr>Type<wbr>Ccai<wbr>Insights</dt>
    <dd>CCAI_INSIGHTS{{% md %}}Contact Center AI Insights This accelerator is used to enable import and export pipelines custom built to streamline CCAI Insights processing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ACCELERATOR_TYPE_UNSPECIFIED</dt>
    <dd>ACCELERATOR_TYPE_UNSPECIFIED{{% md %}}Default value, if unspecified.{{% /md %}}</dd><dt>CDC</dt>
    <dd>CDC{{% md %}}Change Data Capture accelerator for CDF.{{% /md %}}</dd><dt>HEALTHCARE</dt>
    <dd>HEALTHCARE{{% md %}}Cloud Healthcare accelerator for CDF. This accelerator is to enable Cloud Healthcare specific CDF plugins developed by Healthcare team.{{% /md %}}</dd><dt>CCAI_INSIGHTS</dt>
    <dd>CCAI_INSIGHTS{{% md %}}Contact Center AI Insights This accelerator is used to enable import and export pipelines custom built to streamline CCAI Insights processing.{{% /md %}}</dd></dl>
{{% /choosable %}}
