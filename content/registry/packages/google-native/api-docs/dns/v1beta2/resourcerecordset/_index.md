...
<span class="k">def </span><span class="nx">ResourceRecordSet</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                      ...
                      <span class="nx">routing_policy</span><span class="p">:</span> <span class="nx">Optional[RRSetRoutingPolicyArgs]</span> = None<span class="p">,</span>
...
<a href="#routingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rrsetroutingpolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>DNS.<wbr>V1Beta2.<wbr>Inputs.<wbr>RRSet<wbr>Routing<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#routingpolicy_go" style="color: inherit; text-decoration: inherit;">Routing<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rrsetroutingpolicy">RRSet<wbr>Routing<wbr>Policy<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Configures dynamic query responses based on geo location of querying user or a weighted round robin based routing policy. A ResourceRecordSet should only have either rrdata (static) or routing_policy (dynamic). An error is returned otherwise.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rrdatas_go">
