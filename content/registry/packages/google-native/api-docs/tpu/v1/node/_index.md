...
<span class="k">def </span><span class="nx">Node</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">health</span><span class="p">:</span> <span class="nx">Optional[NodeHealth]</span> = None<span class="p">,</span>
         ...
         <span class="nx">scheduling_config</span><span class="p">:</span> <span class="nx">Optional[SchedulingConfigArgs]</span> = None<span class="p">,</span>
...
<a href="#acceleratortype_csharp" style="color: inherit; text-decoration: inherit;">Accelerator<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of hardware accelerators associated with this node.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#tensorflowversion_csharp" style="color: inherit; text-decoration: inherit;">Tensorflow<wbr>Version</a>
    ...
    <dd>{{% md %}}The version of Tensorflow running in the Node.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
