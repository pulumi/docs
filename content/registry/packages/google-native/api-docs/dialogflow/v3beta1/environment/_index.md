...
---
title: "Environment"
title_tag: "google-native.dialogflow/v3beta1.Environment"
meta_desc: "Documentation for the google-native.dialogflow/v3beta1.Environment resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Environment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">test_cases_config</span><span class="p">:</span> <span class="nx">Optional[GoogleCloudDialogflowCxV3beta1EnvironmentTestCasesConfigArgs]</span> = None<span class="p">,</span>
                <span class="nx">version_configs</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfigArgs]]</span> = None<span class="p">)</span>
...
<a href="#testcasesconfig_csharp" style="color: inherit; text-decoration: inherit;">Test<wbr>Cases<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmenttestcasesconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3Beta1.<wbr>Inputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The test cases config for continuous tests of this environment.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#testcasesconfig_go" style="color: inherit; text-decoration: inherit;">Test<wbr>Cases<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmenttestcasesconfig">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The test cases config for continuous tests of this environment.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#version_configs_python" style="color: inherit; text-decoration: inherit;">version_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3beta1environmentversionconfig">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Version<wbr>Config<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}A list of configurations for flow versions. You should include version configs for all flows that are reachable from `Start Flow` in the agent. Otherwise, an error will be returned.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googleclouddialogflowcxv3beta1environmenttestcasesconfig">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config</h4>
...
<a href="#enablecontinuousrun_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Continuous<wbr>Run</a>
    ...
    <dd>{{% md %}}Whether to run test cases in TestCasesConfig.test_cases periodically. Default false. If set to ture, run once a day.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enablepredeploymentrun_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Predeployment<wbr>Run</a>
    ...
    <dd>{{% md %}}Whether to run test cases in TestCasesConfig.test_cases before deploying a flow version to the environment. Default false.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="googleclouddialogflowcxv3beta1environmenttestcasesconfigresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3beta1Environment<wbr>Test<wbr>Cases<wbr>Config<wbr>Response</h4>
