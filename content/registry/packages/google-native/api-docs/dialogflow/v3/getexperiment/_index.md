...
---
title: "getExperiment"
title_tag: "google-native.dialogflow/v3.getExperiment"
meta_desc: "Documentation for the google-native.dialogflow/v3.getExperiment function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
<a href="#definition_csharp" style="color: inherit; text-decoration: inherit;">Definition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3experimentdefinitionresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Experiment<wbr>Definition<wbr>Response</a></span>
    </dt>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The human-readable name of the experiment (unique in an environment). Limit of 64 characters.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The current state of the experiment. Transition triggered by Experiments.StartExperiment: DRAFT->RUNNING. Transition triggered by Experiments.CancelExperiment: DRAFT->DONE or RUNNING->DONE.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#variantshistory_csharp" style="color: inherit; text-decoration: inherit;">Variants<wbr>History</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3variantshistoryresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Dialogflow.<wbr>V3.<wbr>Outputs.<wbr>Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Variants<wbr>History<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#definition_go" style="color: inherit; text-decoration: inherit;">Definition</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3experimentdefinitionresponse">Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Experiment<wbr>Definition<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The definition of the experiment.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#variantshistory_go" style="color: inherit; text-decoration: inherit;">Variants<wbr>History</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3variantshistoryresponse">[]Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Variants<wbr>History<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The history of updates to the experiment variants.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#variants_history_python" style="color: inherit; text-decoration: inherit;">variants_<wbr>history</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googleclouddialogflowcxv3variantshistoryresponse">Sequence[Google<wbr>Cloud<wbr>Dialogflow<wbr>Cx<wbr>V3Variants<wbr>History<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}The history of updates to the experiment variants.{{% /md %}}</dd></dl>
{{% /choosable %}}
