...
title_tag: "google-native.healthcare/v1.AttributeDefinition"
meta_desc: "Documentation for the google-native.healthcare/v1.AttributeDefinition resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
---
...
<a href="#category_csharp" style="color: inherit; text-decoration: inherit;">Category</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attributedefinitioncategory">Pulumi.<wbr>Google<wbr>Native.<wbr>Healthcare.<wbr>V1.<wbr>Attribute<wbr>Definition<wbr>Category</a></span>
    </dt>
