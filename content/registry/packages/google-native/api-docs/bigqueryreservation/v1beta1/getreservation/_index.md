...
title_tag: "google-native.bigqueryreservation/v1beta1.getReservation"
meta_desc: "Documentation for the google-native.bigqueryreservation/v1beta1.getReservation function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#ignoreidleslots_csharp" style="color: inherit; text-decoration: inherit;">Ignore<wbr>Idle<wbr>Slots</a>
    ...
    <dd>{{% md %}}If false, any query or pipeline job using this reservation will use idle slots from other reservations within the same admin project. If true, a query or pipeline job using this reservation will execute with the slot capacity specified in the slot_capacity field at most.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The resource name of the reservation, e.g., `projects/*/locations/*/reservations/team1-prod`.{{% /md %}}</dd><dt class="property-"
            title="">
