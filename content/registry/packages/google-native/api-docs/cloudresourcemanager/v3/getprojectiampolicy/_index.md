...
title_tag: "google-native.cloudresourcemanager/v3.getProjectIamPolicy"
meta_desc: "Documentation for the google-native.cloudresourcemanager/v3.getProjectIamPolicy function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_project_iam_policy(</span><span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
