...
---
title: "Project"
title_tag: "google-native.cloudresourcemanager/v1beta1.Project"
meta_desc: "Documentation for the google-native.cloudresourcemanager/v1beta1.Project resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<span class="k">def </span><span class="nx">Project</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">lifecycle_state</span><span class="p">:</span> <span class="nx">Optional[ProjectLifecycleState]</span> = None<span class="p">,</span>
            <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">parent</span><span class="p">:</span> <span class="nx">Optional[ResourceIdArgs]</span> = None<span class="p">,</span>
            ...
            <span class="nx">use_legacy_stack</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span>
...
<a href="#parent_csharp" style="color: inherit; text-decoration: inherit;">Parent</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceid">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Resource<wbr>Manager.<wbr>V1Beta1.<wbr>Inputs.<wbr>Resource<wbr>Id<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}An optional reference to a parent Resource. Supported parent types include "organization" and "folder". Once set, the parent cannot be cleared. The `parent` can be set on creation or using the `UpdateProject` method; the end user must have the `resourcemanager.projects.create` permission on the parent. Read-write.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#projectnumber_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Number</a>
    ...
    <dd>{{% md %}}The number uniquely identifying the project. Example: `415104041262` Read-only.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="uselegacystack_csharp">
<a href="#uselegacystack_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Legacy<wbr>Stack</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#projectnumber_go" style="color: inherit; text-decoration: inherit;">Project<wbr>Number</a>
    ...
    <dd>{{% md %}}The number uniquely identifying the project. Example: `415104041262` Read-only.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="uselegacystack_go">
<a href="#uselegacystack_go" style="color: inherit; text-decoration: inherit;">Use<wbr>Legacy<wbr>Stack</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#projectnumber_nodejs" style="color: inherit; text-decoration: inherit;">project<wbr>Number</a>
    ...
    <dd>{{% md %}}The number uniquely identifying the project. Example: `415104041262` Read-only.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="uselegacystack_nodejs">
<a href="#uselegacystack_nodejs" style="color: inherit; text-decoration: inherit;">use<wbr>Legacy<wbr>Stack</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#project_number_python" style="color: inherit; text-decoration: inherit;">project_<wbr>number</a>
    ...
    <dd>{{% md %}}The number uniquely identifying the project. Example: `415104041262` Read-only.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="use_legacy_stack_python">
<a href="#use_legacy_stack_python" style="color: inherit; text-decoration: inherit;">use_<wbr>legacy_<wbr>stack</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Required field for the type-specific id. This should correspond to the id used in the type-specific API's.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Required field representing the resource type this id is for. At present, the valid types are "project", "folder", and "organization".{{% /md %}}</dd></dl>
{{% /choosable %}}
