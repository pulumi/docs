...
---
title: "getImage"
title_tag: "google-native.compute/v1.getImage"
meta_desc: "Documentation for the google-native.compute/v1.getImage function with examples, input properties, output properties, and supporting types."
layout: api
---
...
<a href="#deprecated_csharp" style="color: inherit; text-decoration: inherit;">Deprecated</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#deprecationstatusresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Deprecation<wbr>Status<wbr>Response</a></span>
    </dt>
...
<a href="#rawdisk_csharp" style="color: inherit; text-decoration: inherit;">Raw<wbr>Disk</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#imagerawdiskresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Image<wbr>Raw<wbr>Disk<wbr>Response</a></span>
    </dt>
...
<a href="#shieldedinstanceinitialstate_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Initial<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#initialstateconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Initial<wbr>State<wbr>Config<wbr>Response</a></span>
    </dt>
...
<a href="#sourceimage_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Image</a>
    ...
    <dd>{{% md %}}URL of the source image used to create this image. In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcesnapshot_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Snapshot</a>
    ...
    <dd>{{% md %}}URL of the source snapshot used to create this image. In order to create an image, you must provide the full or partial URL of one of the following: - The rawDisk.source URL - The sourceDisk URL - The sourceImage URL - The sourceSnapshot URL {{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The status of the image. An image can be used to create other resources, such as instances, only after the image has been successfully created and the status is set to READY. Possible values are FAILED, PENDING, or READY.{{% /md %}}</dd><dt class="property-"
            title="">
