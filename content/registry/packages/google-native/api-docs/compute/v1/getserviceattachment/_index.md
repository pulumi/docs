...
title_tag: "google-native.compute/v1.getServiceAttachment"
meta_desc: "Documentation for the google-native.compute/v1.getServiceAttachment function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#consumeracceptlists_csharp" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Accept<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceattachmentconsumerprojectlimitresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>V1.<wbr>Outputs.<wbr>Service<wbr>Attachment<wbr>Consumer<wbr>Project<wbr>Limit<wbr>Response&gt;</a></span>
    </dt>
