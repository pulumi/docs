...
---
title: "getMachineImage"
title_tag: "google-native.compute/beta.getMachineImage"
meta_desc: "Documentation for the google-native.compute/beta.getMachineImage function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
## Using getMachineImage {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getMachineImage<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetMachineImageArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetMachineImageResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_machine_image(</span><span class="nx">machine_image</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                      <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetMachineImageResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupMachineImage<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupMachineImageArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupMachineImageResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `LookupMachineImage` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetMachineImage </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetMachineImageResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetMachineImageArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#creationtimestamp_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Timestamp</a>
    ...
    <dd>{{% md %}}The creation timestamp for this machine image in RFC3339 text format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#guestflush_csharp" style="color: inherit; text-decoration: inherit;">Guest<wbr>Flush</a>
    ...
    <dd>{{% md %}}[Input Only] Whether to attempt an application consistent machine image by informing the OS to prepare for the snapshot process. Currently only supported on Windows instances using the Volume Shadow Copy Service (VSS).{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}The resource type, which is always compute#machineImage for machine image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}The URL for this machine image. The server defines this URL.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcediskencryptionkeys_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk<wbr>Encryption<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourcediskencryptionkeyresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Outputs.<wbr>Source<wbr>Disk<wbr>Encryption<wbr>Key<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}[Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceinstanceproperties_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Instance<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourceinstancepropertiesresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Outputs.<wbr>Source<wbr>Instance<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties of source instance.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The status of the machine image. One of the following values: INVALID, CREATING, READY, DELETING, and UPLOADING.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storagelocations_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Locations</a>
    ...
    <dd>{{% md %}}The regional or multi-regional Cloud Storage bucket location where the machine image is stored.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#totalstoragebytes_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Storage<wbr>Bytes</a>
    ...
    <dd>{{% md %}}Total size of the storage used by the machine image.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#sourcediskencryptionkeys_go" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk<wbr>Encryption<wbr>Keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourcediskencryptionkeyresponse">[]Source<wbr>Disk<wbr>Encryption<wbr>Key<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}[Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourceinstanceproperties_go" style="color: inherit; text-decoration: inherit;">Source<wbr>Instance<wbr>Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourceinstancepropertiesresponse">Source<wbr>Instance<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Properties of source instance.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="status_go">
...
<a href="#source_disk_encryption_keys_python" style="color: inherit; text-decoration: inherit;">source_<wbr>disk_<wbr>encryption_<wbr>keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourcediskencryptionkeyresponse">Sequence[Source<wbr>Disk<wbr>Encryption<wbr>Key<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}[Input Only] The customer-supplied encryption key of the disks attached to the source instance. Required if the source disk is protected by a customer-supplied encryption key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disktype_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Type</a>
    ...
    <dd>{{% md %}}URL of the disk type resource. For example: projects/project /zones/zone/diskTypes/pd-standard or pd-ssd{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#storagebytes_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Bytes</a>
    ...
    <dd>{{% md %}}A size of the storage used by the disk's snapshot by this machine image.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#storagebytesstatus_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Bytes<wbr>Status</a>
    ...
    <dd>{{% md %}}An indicator whether storageBytes is in a stable state or it is being adjusted as a result of shared storage reallocation. This status can either be UPDATING, meaning the size of the snapshot is being updated, or UP_TO_DATE, meaning the size of the snapshot is up-to-date.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#sourcedisk_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Disk</a>
    ...
    <dd>{{% md %}}URL of the disk attached to the source instance. This can be a full or valid partial URL. For example, the following are valid values: - https://www.googleapis.com/compute/v1/projects/project/zones/zone /disks/disk - projects/project/zones/zone/disks/disk - zones/zone/disks/disk {{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#savedattacheddiskresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Saved<wbr>Attached<wbr>Disk<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#disks_python" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#savedattacheddiskresponse">Sequence[Saved<wbr>Attached<wbr>Disk<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}An array of disks that are associated with the instances that are created from this machine image.{{% /md %}}</dd><dt class="property-required"
            title="Required">
