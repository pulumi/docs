...
title_tag: "google-native.compute/beta.RegionInstanceGroupManager"
meta_desc: "Documentation for the google-native.compute/beta.RegionInstanceGroupManager resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/google-native/RegionInstanceGroupManager/"
...
<span class="k">def </span><span class="nx">RegionInstanceGroupManager</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">failover_action</span><span class="p">:</span> <span class="nx">Optional[RegionInstanceGroupManagerFailoverAction]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRegionInstanceGroupManager</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">RegionInstanceGroupManagerArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RegionInstanceGroupManager</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#failoveraction_csharp" style="color: inherit; text-decoration: inherit;">Failover<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regioninstancegroupmanagerfailoveraction">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Region<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action</a></span>
    </dt>
...
<a href="#failoveraction_go" style="color: inherit; text-decoration: inherit;">Failover<wbr>Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#regioninstancegroupmanagerfailoveraction">Region<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action</a></span>
    </dt>
    <dd>{{% md %}}The action to perform in case of zone failure. Only one value is supported, NO_FAILOVER. The default is NO_FAILOVER.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="regioninstancegroupmanagerfailoveraction">Region<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Region<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action<wbr>No<wbr>Failover</dt>
    <dd>NO_FAILOVER</dd><dt>Region<wbr>Instance<wbr>Group<wbr>Manager<wbr>Failover<wbr>Action<wbr>Unknown</dt>
    <dd>UNKNOWN</dd></dl>
{{% /choosable %}}
