...
aliases:
    - "/docs/reference/pkg/google-native/InstanceTemplate/"
...
<a href="#selflink_csharp" style="color: inherit; text-decoration: inherit;">Self<wbr>Link</a>
    ...
    <dd>{{% md %}}The URL for this instance template. The server defines this URL.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Attach<wbr>Read<wbr>Only</dt>
    <dd>ATTACH_READ_ONLY{{% md %}}Attach the existing disk in read-only mode. The request will fail if the disk was attached in read-write mode on the source instance. Applicable to: read-only disks.{{% /md %}}</dd><dt>Blank</dt>
    <dd>BLANK{{% md %}}Create a blank disk. The disk will be created unformatted. Applicable to: additional read-write disks, local SSDs.{{% /md %}}</dd><dt>Custom<wbr>Image</dt>
    <dd>CUSTOM_IMAGE{{% md %}}Use the custom image specified in the custom_image field. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>Default</dt>
    <dd>DEFAULT{{% md %}}Use the default instantiation option for the corresponding type of disk. For boot disk and any other R/W disks, new custom images will be created from each disk. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.{{% /md %}}</dd><dt>Do<wbr>Not<wbr>Include</dt>
    <dd>DO_NOT_INCLUDE{{% md %}}Do not include the disk in the instance template. Applicable to: additional read-write disks, local SSDs, read-only disks.{{% /md %}}</dd><dt>Source<wbr>Image</dt>
    <dd>SOURCE_IMAGE{{% md %}}Use the same source image used for creation of the source instance's corresponding disk. The request will fail if the source VM's disk was created from a snapshot. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>Source<wbr>Image<wbr>Family</dt>
    <dd>SOURCE_IMAGE_FAMILY{{% md %}}Use the same source image family used for creation of the source instance's corresponding disk. The request will fail if the source image of the source disk does not belong to any image family. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Attach<wbr>Read<wbr>Only</dt>
    <dd>ATTACH_READ_ONLY{{% md %}}Attach the existing disk in read-only mode. The request will fail if the disk was attached in read-write mode on the source instance. Applicable to: read-only disks.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Blank</dt>
    <dd>BLANK{{% md %}}Create a blank disk. The disk will be created unformatted. Applicable to: additional read-write disks, local SSDs.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Custom<wbr>Image</dt>
    <dd>CUSTOM_IMAGE{{% md %}}Use the custom image specified in the custom_image field. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Default</dt>
    <dd>DEFAULT{{% md %}}Use the default instantiation option for the corresponding type of disk. For boot disk and any other R/W disks, new custom images will be created from each disk. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Do<wbr>Not<wbr>Include</dt>
    <dd>DO_NOT_INCLUDE{{% md %}}Do not include the disk in the instance template. Applicable to: additional read-write disks, local SSDs, read-only disks.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Source<wbr>Image</dt>
    <dd>SOURCE_IMAGE{{% md %}}Use the same source image used for creation of the source instance's corresponding disk. The request will fail if the source VM's disk was created from a snapshot. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>Disk<wbr>Instantiation<wbr>Config<wbr>Instantiate<wbr>From<wbr>Source<wbr>Image<wbr>Family</dt>
    <dd>SOURCE_IMAGE_FAMILY{{% md %}}Use the same source image family used for creation of the source instance's corresponding disk. The request will fail if the source image of the source disk does not belong to any image family. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>ATTACH_READ_ONLY</dt>
    <dd>ATTACH_READ_ONLY{{% md %}}Attach the existing disk in read-only mode. The request will fail if the disk was attached in read-write mode on the source instance. Applicable to: read-only disks.{{% /md %}}</dd><dt>BLANK</dt>
    <dd>BLANK{{% md %}}Create a blank disk. The disk will be created unformatted. Applicable to: additional read-write disks, local SSDs.{{% /md %}}</dd><dt>CUSTOM_IMAGE</dt>
    <dd>CUSTOM_IMAGE{{% md %}}Use the custom image specified in the custom_image field. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>DEFAULT</dt>
    <dd>DEFAULT{{% md %}}Use the default instantiation option for the corresponding type of disk. For boot disk and any other R/W disks, new custom images will be created from each disk. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.{{% /md %}}</dd><dt>DO_NOT_INCLUDE</dt>
    <dd>DO_NOT_INCLUDE{{% md %}}Do not include the disk in the instance template. Applicable to: additional read-write disks, local SSDs, read-only disks.{{% /md %}}</dd><dt>SOURCE_IMAGE</dt>
    <dd>SOURCE_IMAGE{{% md %}}Use the same source image used for creation of the source instance's corresponding disk. The request will fail if the source VM's disk was created from a snapshot. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd><dt>SOURCE_IMAGE_FAMILY</dt>
    <dd>SOURCE_IMAGE_FAMILY{{% md %}}Use the same source image family used for creation of the source instance's corresponding disk. The request will fail if the source image of the source disk does not belong to any image family. Applicable to: boot disk, additional read-write disks.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#advancedmachinefeatures_csharp" style="color: inherit; text-decoration: inherit;">Advanced<wbr>Machine<wbr>Features</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#advancedmachinefeatures">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Advanced<wbr>Machine<wbr>Features</a></span>
    </dt>
...
<a href="#confidentialinstanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Confidential<wbr>Instance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#confidentialinstanceconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Confidential<wbr>Instance<wbr>Config</a></span>
    </dt>
...
<a href="#disks_csharp" style="color: inherit; text-decoration: inherit;">Disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddisk">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Attached<wbr>Disk&gt;</a></span>
    </dt>
...
<a href="#displaydevice_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Device</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#displaydevice">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Display<wbr>Device</a></span>
    </dt>
...
<a href="#metadata_csharp" style="color: inherit; text-decoration: inherit;">Metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metadata">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Metadata</a></span>
    </dt>
...
<a href="#networkinterfaces_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkinterface">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Network<wbr>Interface&gt;</a></span>
    </dt>
...
<a href="#networkperformanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Performance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkperformanceconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Network<wbr>Performance<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reservationaffinity_csharp" style="color: inherit; text-decoration: inherit;">Reservation<wbr>Affinity</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#reservationaffinity">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Reservation<wbr>Affinity</a></span>
    </dt>
...
<a href="#scheduling_csharp" style="color: inherit; text-decoration: inherit;">Scheduling</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduling">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Scheduling</a></span>
    </dt>
...
<a href="#serviceaccounts_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Accounts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaccount">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Service<wbr>Account&gt;</a></span>
    </dt>
...
<a href="#shieldedinstanceconfig_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Instance<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shieldedinstanceconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Shielded<wbr>Instance<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#shieldedvmconfig_csharp" style="color: inherit; text-decoration: inherit;">Shielded<wbr>Vm<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#shieldedvmconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Shielded<wbr>Vm<wbr>Config</a></span>
    </dt>
...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tags">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Tags</a></span>
    </dt>
...
<a href="#disks_python" style="color: inherit; text-decoration: inherit;">disks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#attacheddisk">Sequence[Attached<wbr>Disk]</a></span>
    </dt>
    <dd>{{% md %}}An array of disks that are associated with the instances that are created from these properties.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#service_accounts_python" style="color: inherit; text-decoration: inherit;">service_<wbr>accounts</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaccount">Sequence[Service<wbr>Account]</a></span>
    </dt>
    <dd>{{% md %}}A list of service accounts with specified scopes. Access tokens for these service accounts are available to the instances that are created from these properties. Use metadata queries to obtain the access tokens for these instances.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<dl class="tabular"><dt>Instance<wbr>Properties<wbr>Post<wbr>Key<wbr>Revocation<wbr>Action<wbr>Type<wbr>Noop</dt>
    <dd>NOOP{{% md %}}Indicates user chose no operation.{{% /md %}}</dd><dt>Instance<wbr>Properties<wbr>Post<wbr>Key<wbr>Revocation<wbr>Action<wbr>Type<wbr>Post<wbr>Key<wbr>Revocation<wbr>Action<wbr>Type<wbr>Unspecified</dt>
    <dd>POST_KEY_REVOCATION_ACTION_TYPE_UNSPECIFIED{{% md %}}Default value. This value is unused.{{% /md %}}</dd><dt>Instance<wbr>Properties<wbr>Post<wbr>Key<wbr>Revocation<wbr>Action<wbr>Type<wbr>Shutdown</dt>
    <dd>SHUTDOWN{{% md %}}Indicates user chose to opt for VM shutdown on key revocation.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Instance<wbr>Properties<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Bidirectional<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Instance<wbr>Properties<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services. If specified, the subnetwork who is attached to the instance's default network interface will be assigned an internal IPv6 prefix if it doesn't have before.{{% /md %}}</dd><dt>Instance<wbr>Properties<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Inherit<wbr>From<wbr>Subnetwork</dt>
    <dd>INHERIT_FROM_SUBNETWORK{{% md %}}Each network interface inherits PrivateIpv6GoogleAccess from its subnetwork.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#diskconfigs_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskinstantiationconfig">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Inputs.<wbr>Disk<wbr>Instantiation<wbr>Config&gt;</a></span>
    </dt>
...
<a href="#disk_configs_python" style="color: inherit; text-decoration: inherit;">disk_<wbr>configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#diskinstantiationconfig">Sequence[Disk<wbr>Instantiation<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}Attached disks configuration. If not provided, defaults are applied: For boot disk and any other R/W disks, new custom images will be created from each disk. For read-only disks, they will be attached in read-only mode. Local SSD disks will be created as blank volumes.{{% /md %}}</dd></dl>
{{% /choosable %}}
