...
---
title: "Address"
title_tag: "google-native.compute/beta.Address"
meta_desc: "Documentation for the google-native.compute/beta.Address resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/google-native/Address/"
...
<span class="k">def </span><span class="nx">Address</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">address_type</span><span class="p">:</span> <span class="nx">Optional[AddressAddressType]</span> = None<span class="p">,</span>
            <span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">ip_version</span><span class="p">:</span> <span class="nx">Optional[AddressIpVersion]</span> = None<span class="p">,</span>
            ...
            <span class="nx">network_tier</span><span class="p">:</span> <span class="nx">Optional[AddressNetworkTier]</span> = None<span class="p">,</span>
            ...
            <span class="nx">purpose</span><span class="p">:</span> <span class="nx">Optional[AddressPurpose]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAddress</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">AddressArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Address</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The Address resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#addresstype_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressaddresstype">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Address<wbr>Address<wbr>Type</a></span>
    </dt>
...
<a href="#ipversion_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Version</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressipversion">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Address<wbr>Ip<wbr>Version</a></span>
    </dt>
...
<a href="#network_csharp" style="color: inherit; text-decoration: inherit;">Network</a>
    ...
    <dd>{{% md %}}The URL of the network in which to reserve the address. This field can only be used with INTERNAL type with the VPC_PEERING purpose.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="networktier_csharp">
<a href="#networktier_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Tier</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#addressnetworktier">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Beta.<wbr>Address<wbr>Network<wbr>Tier</a></span>
    </dt>
    <dd>{{% md %}}This signifies the networking tier used for configuring this address and can only take the following values: PREMIUM or STANDARD. Global forwarding rules can only be Premium Tier. Regional forwarding rules can be either Premium or Standard Tier. Standard Tier addresses applied to regional forwarding rules can be used with any external load balancer. Regional forwarding rules in Premium Tier can only be used with a network load balancer. If this field is not specified, it is assumed to be PREMIUM.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#prefixlength_csharp" style="color: inherit; text-decoration: inherit;">Prefix<wbr>Length</a>
    ...
    <dd>{{% md %}}The prefix length if the resource represents an IP range.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subnetwork_csharp" style="color: inherit; text-decoration: inherit;">Subnetwork</a>
    ...
    <dd>{{% md %}}The URL of the subnetwork in which to reserve the address. If an IP address is specified, it must be within the subnetwork's IP range. This field can only be used with INTERNAL type with a GCE_ENDPOINT or DNS_RESOLVER purpose.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#labelfingerprint_csharp" style="color: inherit; text-decoration: inherit;">Label<wbr>Fingerprint</a>
    ...
    <dd>{{% md %}}A fingerprint for the labels being applied to this Address, which is essentially a hash of the labels set used for optimistic locking. The fingerprint is initially generated by Compute Engine and changes after every request to modify or update labels. You must always provide an up-to-date fingerprint hash in order to update or change labels, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve an Address.{{% /md %}}</dd><dt class="property-"
            title="">
...
<dl class="tabular"><dt>External</dt>
    <dd>EXTERNAL{{% md %}}A publicly visible external IP address.{{% /md %}}</dd><dt>Internal</dt>
    <dd>INTERNAL{{% md %}}A private network IP address, for use with an Instance or Internal Load Balancer forwarding rule.{{% /md %}}</dd><dt>Unspecified<wbr>Type</dt>
    <dd>UNSPECIFIED_TYPE</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Address<wbr>Address<wbr>Type<wbr>External</dt>
    <dd>EXTERNAL{{% md %}}A publicly visible external IP address.{{% /md %}}</dd><dt>Address<wbr>Address<wbr>Type<wbr>Internal</dt>
    <dd>INTERNAL{{% md %}}A private network IP address, for use with an Instance or Internal Load Balancer forwarding rule.{{% /md %}}</dd><dt>Address<wbr>Address<wbr>Type<wbr>Unspecified<wbr>Type</dt>
    <dd>UNSPECIFIED_TYPE</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>EXTERNAL</dt>
    <dd>EXTERNAL{{% md %}}A publicly visible external IP address.{{% /md %}}</dd><dt>INTERNAL</dt>
    <dd>INTERNAL{{% md %}}A private network IP address, for use with an Instance or Internal Load Balancer forwarding rule.{{% /md %}}</dd><dt>UNSPECIFIED_TYPE</dt>
    <dd>UNSPECIFIED_TYPE</dd></dl>
{{% /choosable %}}
...
{{% choosable language go %}}
<dl class="tabular"><dt>Address<wbr>Network<wbr>Tier<wbr>Premium</dt>
    <dd>PREMIUM{{% md %}}High quality, Google-grade network tier, support for all networking products.{{% /md %}}</dd><dt>Address<wbr>Network<wbr>Tier<wbr>Standard</dt>
    <dd>STANDARD{{% md %}}Public internet quality, only limited support for other networking products.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Dns<wbr>Resolver</dt>
    <dd>DNS_RESOLVER{{% md %}}DNS resolver address in the subnetwork.{{% /md %}}</dd><dt>Gce<wbr>Endpoint</dt>
    <dd>GCE_ENDPOINT{{% md %}}VM internal/alias IP, Internal LB service IP, etc.{{% /md %}}</dd><dt>Ipsec<wbr>Interconnect</dt>
    <dd>IPSEC_INTERCONNECT{{% md %}}A regional internal IP address range reserved for the VLAN attachment that is used in IPsec-encrypted Cloud Interconnect. This regional internal IP address range must not overlap with any IP address range of subnet/route in the VPC network and its peering networks. After the VLAN attachment is created with the reserved IP address range, when creating a new VPN gateway, its interface IP address is allocated from the associated VLAN attachment’s IP address range.{{% /md %}}</dd><dt>Nat<wbr>Auto</dt>
    <dd>NAT_AUTO{{% md %}}External IP automatically reserved for Cloud NAT.{{% /md %}}</dd><dt>Private<wbr>Service<wbr>Connect</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}A private network IP address that can be used to configure Private Service Connect. This purpose can be specified only for GLOBAL addresses of Type INTERNAL{{% /md %}}</dd><dt>Shared<wbr>Loadbalancer<wbr>Vip</dt>
    <dd>SHARED_LOADBALANCER_VIP{{% md %}}A private network IP address that can be shared by multiple Internal Load Balancer forwarding rules.{{% /md %}}</dd><dt>Vpc<wbr>Peering</dt>
    <dd>VPC_PEERING{{% md %}}IP range for peer networks.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Address<wbr>Purpose<wbr>Dns<wbr>Resolver</dt>
    <dd>DNS_RESOLVER{{% md %}}DNS resolver address in the subnetwork.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Gce<wbr>Endpoint</dt>
    <dd>GCE_ENDPOINT{{% md %}}VM internal/alias IP, Internal LB service IP, etc.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Ipsec<wbr>Interconnect</dt>
    <dd>IPSEC_INTERCONNECT{{% md %}}A regional internal IP address range reserved for the VLAN attachment that is used in IPsec-encrypted Cloud Interconnect. This regional internal IP address range must not overlap with any IP address range of subnet/route in the VPC network and its peering networks. After the VLAN attachment is created with the reserved IP address range, when creating a new VPN gateway, its interface IP address is allocated from the associated VLAN attachment’s IP address range.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Nat<wbr>Auto</dt>
    <dd>NAT_AUTO{{% md %}}External IP automatically reserved for Cloud NAT.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Private<wbr>Service<wbr>Connect</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}A private network IP address that can be used to configure Private Service Connect. This purpose can be specified only for GLOBAL addresses of Type INTERNAL{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Shared<wbr>Loadbalancer<wbr>Vip</dt>
    <dd>SHARED_LOADBALANCER_VIP{{% md %}}A private network IP address that can be shared by multiple Internal Load Balancer forwarding rules.{{% /md %}}</dd><dt>Address<wbr>Purpose<wbr>Vpc<wbr>Peering</dt>
    <dd>VPC_PEERING{{% md %}}IP range for peer networks.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>DNS_RESOLVER</dt>
    <dd>DNS_RESOLVER{{% md %}}DNS resolver address in the subnetwork.{{% /md %}}</dd><dt>GCE_ENDPOINT</dt>
    <dd>GCE_ENDPOINT{{% md %}}VM internal/alias IP, Internal LB service IP, etc.{{% /md %}}</dd><dt>IPSEC_INTERCONNECT</dt>
    <dd>IPSEC_INTERCONNECT{{% md %}}A regional internal IP address range reserved for the VLAN attachment that is used in IPsec-encrypted Cloud Interconnect. This regional internal IP address range must not overlap with any IP address range of subnet/route in the VPC network and its peering networks. After the VLAN attachment is created with the reserved IP address range, when creating a new VPN gateway, its interface IP address is allocated from the associated VLAN attachment’s IP address range.{{% /md %}}</dd><dt>NAT_AUTO</dt>
    <dd>NAT_AUTO{{% md %}}External IP automatically reserved for Cloud NAT.{{% /md %}}</dd><dt>PRIVATE_SERVICE_CONNECT</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}A private network IP address that can be used to configure Private Service Connect. This purpose can be specified only for GLOBAL addresses of Type INTERNAL{{% /md %}}</dd><dt>SHARED_LOADBALANCER_VIP</dt>
    <dd>SHARED_LOADBALANCER_VIP{{% md %}}A private network IP address that can be shared by multiple Internal Load Balancer forwarding rules.{{% /md %}}</dd><dt>VPC_PEERING</dt>
    <dd>VPC_PEERING{{% md %}}IP range for peer networks.{{% /md %}}</dd></dl>
{{% /choosable %}}
