...
---
title: "Disk"
title_tag: "google-native.compute/alpha.Disk"
meta_desc: "Documentation for the google-native.compute/alpha.Disk resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/google-native/Disk/"
...
<span class="k">def </span><span class="nx">Disk</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
         ...
         <span class="nx">interface</span><span class="p">:</span> <span class="nx">Optional[DiskInterface]</span> = None<span class="p">,</span>
...
<a href="#userlicenses_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Licenses</a>
    ...
    <dd>{{% md %}}A list of publicly visible user-licenses. Unlike regular licenses, user provided licenses can be modified after the disk is created. This includes a list of URLs to the license resource. For example, to provide a debian license: https://www.googleapis.com/compute/v1/projects/debian-cloud/global/licenses/debian-9-stretch {{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="zone_csharp">
...
<a href="#users_csharp" style="color: inherit; text-decoration: inherit;">Users</a>
    ...
    <dd>{{% md %}}Links to the users of the disk (attached instances) in form: projects/project/zones/zone/instances/instance{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#source_image_id_python" style="color: inherit; text-decoration: inherit;">source_<wbr>image_<wbr>id</a>
    ...
    <dd>{{% md %}}The ID value of the image used to create this disk. This value identifies the exact image that was used to create this persistent disk. For example, if you created the persistent disk from an image that was later deleted and recreated under the same name, the source image ID would identify the exact version of the image that was used.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="source_instant_snapshot_id_python">
<a href="#source_instant_snapshot_id_python" style="color: inherit; text-decoration: inherit;">source_<wbr>instant_<wbr>snapshot_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
