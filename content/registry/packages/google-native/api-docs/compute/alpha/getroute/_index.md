...
<a href="#aspaths_csharp" style="color: inherit; text-decoration: inherit;">As<wbr>Paths</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routeaspathresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Route<wbr>As<wbr>Path<wbr>Response&gt;</a></span>
    </dt>
