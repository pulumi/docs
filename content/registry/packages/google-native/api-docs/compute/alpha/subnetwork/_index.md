...
<h4 id="subnetworkaggregationinterval">Subnetwork<wbr>Aggregation<wbr>Interval</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval10Min</dt>
    <dd>INTERVAL_10_MIN</dd><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval15Min</dt>
    <dd>INTERVAL_15_MIN</dd><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval1Min</dt>
    <dd>INTERVAL_1_MIN</dd><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval30Sec</dt>
    <dd>INTERVAL_30_SEC</dd><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval5Min</dt>
    <dd>INTERVAL_5_MIN</dd><dt>Subnetwork<wbr>Aggregation<wbr>Interval<wbr>Interval5Sec</dt>
    <dd>INTERVAL_5_SEC</dd></dl>
{{% /choosable %}}
...
<h4 id="subnetworkipv6accesstype">Subnetwork<wbr>Ipv6Access<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>External</dt>
    <dd>EXTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are accesible via the Internet, as well as the VPC network.{{% /md %}}</dd><dt>Internal</dt>
    <dd>INTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are only accessible over the VPC network.{{% /md %}}</dd><dt>Unspecified<wbr>Ipv6Access<wbr>Type</dt>
...
<dl class="tabular"><dt>Subnetwork<wbr>Ipv6Access<wbr>Type<wbr>External</dt>
    <dd>EXTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are accesible via the Internet, as well as the VPC network.{{% /md %}}</dd><dt>Subnetwork<wbr>Ipv6Access<wbr>Type<wbr>Internal</dt>
    <dd>INTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are only accessible over the VPC network.{{% /md %}}</dd><dt>Subnetwork<wbr>Ipv6Access<wbr>Type<wbr>Unspecified<wbr>Ipv6Access<wbr>Type</dt>
    <dd>UNSPECIFIED_IPV6_ACCESS_TYPE{{% md %}}IPv6 access type not set. Means this subnet hasn't been turned on IPv6 yet.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>EXTERNAL</dt>
    <dd>EXTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are accesible via the Internet, as well as the VPC network.{{% /md %}}</dd><dt>INTERNAL</dt>
    <dd>INTERNAL{{% md %}}VMs on this subnet will be assigned IPv6 addresses that are only accessible over the VPC network.{{% /md %}}</dd><dt>UNSPECIFIED_IPV6_ACCESS_TYPE</dt>
    <dd>UNSPECIFIED_IPV6_ACCESS_TYPE{{% md %}}IPv6 access type not set. Means this subnet hasn't been turned on IPv6 yet.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="subnetworkmetadata">Subnetwork<wbr>Metadata</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Metadata<wbr>Exclude<wbr>All<wbr>Metadata</dt>
    <dd>EXCLUDE_ALL_METADATA</dd><dt>Subnetwork<wbr>Metadata<wbr>Include<wbr>All<wbr>Metadata</dt>
    <dd>INCLUDE_ALL_METADATA</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Disable<wbr>Google<wbr>Access</dt>
    <dd>DISABLE_GOOGLE_ACCESS{{% md %}}Disable private IPv6 access to/from Google services.{{% /md %}}</dd><dt>Enable<wbr>Bidirectional<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services.{{% /md %}}</dd><dt>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services.{{% /md %}}</dd><dt>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google<wbr>For<wbr>Service<wbr>Accounts</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE_FOR_SERVICE_ACCOUNTS{{% md %}}Deprecated in favor of enable PrivateIpv6GoogleAccess on instance directly. Outbound private IPv6 access is enabled per VM based on Service Accounts. This applies only to VMs with primary service accounts as listed in private_ipv6_google_access_service_account.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Disable<wbr>Google<wbr>Access</dt>
    <dd>DISABLE_GOOGLE_ACCESS{{% md %}}Disable private IPv6 access to/from Google services.{{% /md %}}</dd><dt>Subnetwork<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Bidirectional<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services.{{% /md %}}</dd><dt>Subnetwork<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services.{{% /md %}}</dd><dt>Subnetwork<wbr>Private<wbr>Ipv6Google<wbr>Access<wbr>Enable<wbr>Outbound<wbr>Vm<wbr>Access<wbr>To<wbr>Google<wbr>For<wbr>Service<wbr>Accounts</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE_FOR_SERVICE_ACCOUNTS{{% md %}}Deprecated in favor of enable PrivateIpv6GoogleAccess on instance directly. Outbound private IPv6 access is enabled per VM based on Service Accounts. This applies only to VMs with primary service accounts as listed in private_ipv6_google_access_service_account.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>DISABLE_GOOGLE_ACCESS</dt>
    <dd>DISABLE_GOOGLE_ACCESS{{% md %}}Disable private IPv6 access to/from Google services.{{% /md %}}</dd><dt>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE</dt>
    <dd>ENABLE_BIDIRECTIONAL_ACCESS_TO_GOOGLE{{% md %}}Bidirectional private IPv6 access to/from Google services.{{% /md %}}</dd><dt>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE{{% md %}}Outbound private IPv6 access from VMs in this subnet to Google services.{{% /md %}}</dd><dt>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE_FOR_SERVICE_ACCOUNTS</dt>
    <dd>ENABLE_OUTBOUND_VM_ACCESS_TO_GOOGLE_FOR_SERVICE_ACCOUNTS{{% md %}}Deprecated in favor of enable PrivateIpv6GoogleAccess on instance directly. Outbound private IPv6 access is enabled per VM based on Service Accounts. This applies only to VMs with primary service accounts as listed in private_ipv6_google_access_service_account.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Aggregate</dt>
    <dd>AGGREGATE{{% md %}}Subnetwork used to aggregate multiple private subnetworks.{{% /md %}}</dd><dt>Cloud<wbr>Extension</dt>
    <dd>CLOUD_EXTENSION{{% md %}}Subnetworks created for Cloud Extension Machines.{{% /md %}}</dd><dt>Internal<wbr>Https<wbr>Load<wbr>Balancer</dt>
    <dd>INTERNAL_HTTPS_LOAD_BALANCER{{% md %}}Subnet reserved for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>Private</dt>
    <dd>PRIVATE{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>Private<wbr>Rfc1918</dt>
    <dd>PRIVATE_RFC_1918{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>Private<wbr>Service<wbr>Connect</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}Subnetworks created for Private Service Connect in the producer network.{{% /md %}}</dd><dt>Regional<wbr>Managed<wbr>Proxy</dt>
    <dd>REGIONAL_MANAGED_PROXY{{% md %}}Subnetwork used for Regional Internal/External HTTP(S) Load Balancing.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Purpose<wbr>Aggregate</dt>
    <dd>AGGREGATE{{% md %}}Subnetwork used to aggregate multiple private subnetworks.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Cloud<wbr>Extension</dt>
    <dd>CLOUD_EXTENSION{{% md %}}Subnetworks created for Cloud Extension Machines.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Internal<wbr>Https<wbr>Load<wbr>Balancer</dt>
    <dd>INTERNAL_HTTPS_LOAD_BALANCER{{% md %}}Subnet reserved for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Private</dt>
    <dd>PRIVATE{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Private<wbr>Rfc1918</dt>
    <dd>PRIVATE_RFC_1918{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Private<wbr>Service<wbr>Connect</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}Subnetworks created for Private Service Connect in the producer network.{{% /md %}}</dd><dt>Subnetwork<wbr>Purpose<wbr>Regional<wbr>Managed<wbr>Proxy</dt>
    <dd>REGIONAL_MANAGED_PROXY{{% md %}}Subnetwork used for Regional Internal/External HTTP(S) Load Balancing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>AGGREGATE</dt>
    <dd>AGGREGATE{{% md %}}Subnetwork used to aggregate multiple private subnetworks.{{% /md %}}</dd><dt>CLOUD_EXTENSION</dt>
    <dd>CLOUD_EXTENSION{{% md %}}Subnetworks created for Cloud Extension Machines.{{% /md %}}</dd><dt>INTERNAL_HTTPS_LOAD_BALANCER</dt>
    <dd>INTERNAL_HTTPS_LOAD_BALANCER{{% md %}}Subnet reserved for Internal HTTP(S) Load Balancing.{{% /md %}}</dd><dt>PRIVATE</dt>
    <dd>PRIVATE{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>PRIVATE_RFC1918</dt>
    <dd>PRIVATE_RFC_1918{{% md %}}Regular user created or automatically created subnet.{{% /md %}}</dd><dt>PRIVATE_SERVICE_CONNECT</dt>
    <dd>PRIVATE_SERVICE_CONNECT{{% md %}}Subnetworks created for Private Service Connect in the producer network.{{% /md %}}</dd><dt>REGIONAL_MANAGED_PROXY</dt>
    <dd>REGIONAL_MANAGED_PROXY{{% md %}}Subnetwork used for Regional Internal/External HTTP(S) Load Balancing.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>Active</dt>
    <dd>ACTIVE{{% md %}}The ACTIVE subnet that is currently used.{{% /md %}}</dd><dt>Backup</dt>
    <dd>BACKUP{{% md %}}The BACKUP subnet that could be promoted to ACTIVE.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Role<wbr>Active</dt>
    <dd>ACTIVE{{% md %}}The ACTIVE subnet that is currently used.{{% /md %}}</dd><dt>Subnetwork<wbr>Role<wbr>Backup</dt>
    <dd>BACKUP{{% md %}}The BACKUP subnet that could be promoted to ACTIVE.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#rangename_csharp" style="color: inherit; text-decoration: inherit;">Range<wbr>Name</a>
    ...
    <dd>{{% md %}}The name associated with this subnetwork secondary range, used when adding an alias IP range to a VM instance. The name must be 1-63 characters long, and comply with RFC1035. The name must be unique within the subnetwork.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="reservedinternalrange_csharp">
<a href="#reservedinternalrange_csharp" style="color: inherit; text-decoration: inherit;">Reserved<wbr>Internal<wbr>Range</a>
</span>
...
<h4 id="subnetworkstacktype">Subnetwork<wbr>Stack<wbr>Type</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}New VMs in this subnet can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}New VMs in this subnet will only be assigned IPv4 addresses.{{% /md %}}</dd><dt>Unspecified<wbr>Stack<wbr>Type</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Subnetwork<wbr>Stack<wbr>Type<wbr>Ipv4Ipv6</dt>
    <dd>IPV4_IPV6{{% md %}}New VMs in this subnet can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>Subnetwork<wbr>Stack<wbr>Type<wbr>Ipv4Only</dt>
    <dd>IPV4_ONLY{{% md %}}New VMs in this subnet will only be assigned IPv4 addresses.{{% /md %}}</dd><dt>Subnetwork<wbr>Stack<wbr>Type<wbr>Unspecified<wbr>Stack<wbr>Type</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>IPV4_IPV6</dt>
    <dd>IPV4_IPV6{{% md %}}New VMs in this subnet can have both IPv4 and IPv6 addresses.{{% /md %}}</dd><dt>IPV4_ONLY</dt>
    <dd>IPV4_ONLY{{% md %}}New VMs in this subnet will only be assigned IPv4 addresses.{{% /md %}}</dd><dt>UNSPECIFIED_STACK_TYPE</dt>
    <dd>UNSPECIFIED_STACK_TYPE</dd></dl>
{{% /choosable %}}
