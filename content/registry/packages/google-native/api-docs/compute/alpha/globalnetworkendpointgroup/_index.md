...
<span class="k">def </span><span class="nx">GlobalNetworkEndpointGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                               ...
                               <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[GlobalNetworkEndpointGroupType]</span> = None<span class="p">)</span>
...
<dl class="tabular"><dt>Global<wbr>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Gce<wbr>Vm<wbr>Ip</dt>
    ...
    <dd>GCE_VM_IP_PORT{{% md %}}The network endpoint is represented by IP address and port pair.{{% /md %}}</dd><dt>Global<wbr>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Gce<wbr>Vm<wbr>Primary<wbr>Ip</dt>
    <dd>GCE_VM_PRIMARY_IP{{% md %}}The network endpoint is the primary IP address on any network interface of a VM in Compute Engine.{{% /md %}}</dd><dt>Global<wbr>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Internet<wbr>Fqdn<wbr>Port</dt>
