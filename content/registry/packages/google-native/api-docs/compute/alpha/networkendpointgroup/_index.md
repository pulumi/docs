...
<span class="k">def </span><span class="nx">NetworkEndpointGroup</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                         ...
                         <span class="nx">type</span><span class="p">:</span> <span class="nx">Optional[NetworkEndpointGroupType]</span> = None<span class="p">,</span>
...
<dl class="tabular"><dt>Gce<wbr>Vm<wbr>Ip</dt>
    ...
    <dd>GCE_VM_IP_PORT{{% md %}}The network endpoint is represented by IP address and port pair.{{% /md %}}</dd><dt>Gce<wbr>Vm<wbr>Primary<wbr>Ip</dt>
    <dd>GCE_VM_PRIMARY_IP{{% md %}}The network endpoint is the primary IP address on any network interface of a VM in Compute Engine.{{% /md %}}</dd><dt>Internet<wbr>Fqdn<wbr>Port</dt>
...
<dl class="tabular"><dt>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Gce<wbr>Vm<wbr>Ip</dt>
    ...
    <dd>GCE_VM_IP_PORT{{% md %}}The network endpoint is represented by IP address and port pair.{{% /md %}}</dd><dt>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Gce<wbr>Vm<wbr>Primary<wbr>Ip</dt>
    <dd>GCE_VM_PRIMARY_IP{{% md %}}The network endpoint is the primary IP address on any network interface of a VM in Compute Engine.{{% /md %}}</dd><dt>Network<wbr>Endpoint<wbr>Group<wbr>Network<wbr>Endpoint<wbr>Type<wbr>Internet<wbr>Fqdn<wbr>Port</dt>
...
<dl class="tabular"><dt>GCE_VM_IP</dt>
    ...
    <dd>GCE_VM_IP_PORT{{% md %}}The network endpoint is represented by IP address and port pair.{{% /md %}}</dd><dt>GCE_VM_PRIMARY_IP</dt>
    <dd>GCE_VM_PRIMARY_IP{{% md %}}The network endpoint is the primary IP address on any network interface of a VM in Compute Engine.{{% /md %}}</dd><dt>INTERNET_FQDN_PORT</dt>
...
<dl class="tabular"><dt>Load<wbr>Balancing</dt>
    <dd>LOAD_BALANCING{{% md %}}The network endpoint group is a backend of a load balancer.{{% /md %}}</dd></dl>
{{% /choosable %}}
