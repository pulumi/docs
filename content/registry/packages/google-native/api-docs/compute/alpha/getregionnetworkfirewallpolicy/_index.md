...
---
title: "getRegionNetworkFirewallPolicy"
...
## Using getRegionNetworkFirewallPolicy {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getRegionNetworkFirewallPolicy<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetRegionNetworkFirewallPolicyArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetRegionNetworkFirewallPolicyResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_region_network_firewall_policy(</span><span class="nx">firewall_policy</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                       <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                       <span class="nx">region</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRegionNetworkFirewallPolicyResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupRegionNetworkFirewallPolicy<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupRegionNetworkFirewallPolicyArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupRegionNetworkFirewallPolicyResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `LookupRegionNetworkFirewallPolicy` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetRegionNetworkFirewallPolicy </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetRegionNetworkFirewallPolicyResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetRegionNetworkFirewallPolicyArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## getRegionNetworkFirewallPolicy Result {#result}
...
<a href="#associations_csharp" style="color: inherit; text-decoration: inherit;">Associations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyassociationresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Firewall<wbr>Policy<wbr>Association<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of associations that belong to this firewall policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#region_csharp" style="color: inherit; text-decoration: inherit;">Region</a>
    ...
    <dd>{{% md %}}URL of the region where the regional firewall policy resides. This field is not applicable to global firewall policies. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rules_csharp" style="color: inherit; text-decoration: inherit;">Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyruleresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Outputs.<wbr>Firewall<wbr>Policy<wbr>Rule<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#associations_go" style="color: inherit; text-decoration: inherit;">Associations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyassociationresponse">[]Firewall<wbr>Policy<wbr>Association<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A list of associations that belong to this firewall policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rules_go" style="color: inherit; text-decoration: inherit;">Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyruleresponse">[]Firewall<wbr>Policy<wbr>Rule<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="selflink_go">
...
<a href="#associations_python" style="color: inherit; text-decoration: inherit;">associations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyassociationresponse">Sequence[Firewall<wbr>Policy<wbr>Association<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}A list of associations that belong to this firewall policy.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#rules_python" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyruleresponse">Sequence[Firewall<wbr>Policy<wbr>Rule<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}A list of rules that belong to this policy. There must always be a default rule (rule with priority 2147483647 and match "*"). If no rules are provided when creating a firewall policy, a default rule with action "allow" will be added.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#layer4configs_csharp" style="color: inherit; text-decoration: inherit;">Layer4Configs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyrulematcherlayer4configresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Firewall<wbr>Policy<wbr>Rule<wbr>Matcher<wbr>Layer4Config<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#srcsecuretags_csharp" style="color: inherit; text-decoration: inherit;">Src<wbr>Secure<wbr>Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyrulesecuretagresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Firewall<wbr>Policy<wbr>Rule<wbr>Secure<wbr>Tag<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#src_secure_tags_python" style="color: inherit; text-decoration: inherit;">src_<wbr>secure_<wbr>tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyrulesecuretagresponse">Sequence[Firewall<wbr>Policy<wbr>Rule<wbr>Secure<wbr>Tag<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}List of secure tag values, which should be matched at the source of the traffic. For INGRESS rule, if all the srcSecureTag are INEFFECTIVE, and there is no srcIpRange, this rule will be ignored. Maximum number of source tag values allowed is 256.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#match_csharp" style="color: inherit; text-decoration: inherit;">Match</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#firewallpolicyrulematcherresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Compute.<wbr>Alpha.<wbr>Inputs.<wbr>Firewall<wbr>Policy<wbr>Rule<wbr>Matcher<wbr>Response</a></span>
    </dt>
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}State of the secure tag, either `EFFECTIVE` or `INEFFECTIVE`. A secure tag is `INEFFECTIVE` when it is deleted or its network is deleted.{{% /md %}}</dd></dl>
{{% /choosable %}}
