...
title_tag: "google-native.compute/alpha.HttpsHealthCheck"
meta_desc: "Documentation for the google-native.compute/alpha.HttpsHealthCheck resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/google-native/HttpsHealthCheck/"
...
<a href="#host_csharp" style="color: inherit; text-decoration: inherit;">Host</a>
    ...
    <dd>{{% md %}}The value of the host header in the HTTPS health check request. If left empty (default value), the public IP on behalf of which this health check is performed will be used.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The TCP port number for the HTTPS health check request. The default value is 443.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timeoutsec_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Sec</a>
    ...
    <dd>{{% md %}}How long (in seconds) to wait before claiming failure. The default value is 5 seconds. It is invalid for timeoutSec to have a greater value than checkIntervalSec.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
