...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
    ...
    <dd>{{% md %}}Optional. The cluster config for a cluster of Compute Engine Instances. Note that Dataproc may set default values, and values may change when clusters are updated.{{% /md %}}</dd><dt class="property-"
            title="">
