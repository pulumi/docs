...
---
title: "getJob"
title_tag: "google-native.dataproc/v1.getJob"
meta_desc: "Documentation for the google-native.dataproc/v1.getJob function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
<a href="#hadoopjob_csharp" style="color: inherit; text-decoration: inherit;">Hadoop<wbr>Job</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hadoopjobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Hadoop<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a Hadoop job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="hivejob_csharp">
<a href="#hivejob_csharp" style="color: inherit; text-decoration: inherit;">Hive<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#hivejobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Hive<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a Hive job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. The labels to associate with this job. Label keys must contain 1 to 63 characters, and must conform to RFC 1035 (https://www.ietf.org/rfc/rfc1035.txt). Label values may be empty, but, if present, must contain 1 to 63 characters, and must conform to RFC 1035 (https://www.ietf.org/rfc/rfc1035.txt). No more than 32 labels can be associated with a job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="pigjob_csharp">
<a href="#pigjob_csharp" style="color: inherit; text-decoration: inherit;">Pig<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pigjobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Pig<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a Pig job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="placement_csharp">
<a href="#placement_csharp" style="color: inherit; text-decoration: inherit;">Placement</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobplacementresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Job<wbr>Placement<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Job information, including how, when, and where to run the job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="prestojob_csharp">
<a href="#prestojob_csharp" style="color: inherit; text-decoration: inherit;">Presto<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prestojobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Presto<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a Presto job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="pysparkjob_csharp">
<a href="#pysparkjob_csharp" style="color: inherit; text-decoration: inherit;">Pyspark<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pysparkjobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Py<wbr>Spark<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a PySpark job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="reference_csharp">
<a href="#reference_csharp" style="color: inherit; text-decoration: inherit;">Reference</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobreferenceresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Job<wbr>Reference<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. The fully qualified reference to the job, which can be used to obtain the equivalent REST path of the job resource. If this property is not specified when a job is created, the server generates a job_id.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="scheduling_csharp">
<a href="#scheduling_csharp" style="color: inherit; text-decoration: inherit;">Scheduling</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobschedulingresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Job<wbr>Scheduling<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job scheduling configuration.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sparkjob_csharp">
<a href="#sparkjob_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sparkjobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Spark<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a Spark job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sparkrjob_csharp">
<a href="#sparkrjob_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>RJob</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sparkrjobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Spark<wbr>RJob<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a SparkR job.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sparksqljob_csharp">
<a href="#sparksqljob_csharp" style="color: inherit; text-decoration: inherit;">Spark<wbr>Sql<wbr>Job</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sparksqljobresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Dataproc.<wbr>V1.<wbr>Outputs.<wbr>Spark<wbr>Sql<wbr>Job<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Job is a SparkSql job.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#placement_go" style="color: inherit; text-decoration: inherit;">Placement</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jobplacementresponse">Job<wbr>Placement<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Job information, including how, when, and where to run the job.{{% /md %}}</dd><dt class="property-"
            title="">
