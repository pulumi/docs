...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewTransferJob</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">TransferJobArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">TransferJob</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#loggingconfig_csharp" style="color: inherit; text-decoration: inherit;">Logging<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#loggingconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Logging<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#notificationconfig_csharp" style="color: inherit; text-decoration: inherit;">Notification<wbr>Config</a>
    ...
    <dd>{{% md %}}Notification configuration. This is not supported for transfers involving PosixFilesystem.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pubsubtopic_csharp" style="color: inherit; text-decoration: inherit;">Pubsub<wbr>Topic</a>
    ...
    <dd>{{% md %}}The `Topic.name` of the Pub/Sub topic to which to publish notifications. Must be of the format: `projects/{project}/topics/{topic}`. Not matching this format results in an INVALID_ARGUMENT error.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#eventtypes_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Types</a>
    ...
    <dd>{{% md %}}Event types for which a notification is desired. If empty, send notifications for all event types.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#event_types_python" style="color: inherit; text-decoration: inherit;">event_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#notificationconfigeventtypesitem">Sequence[Notification<wbr>Config<wbr>Event<wbr>Types<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}Event types for which a notification is desired. If empty, send notifications for all event types.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lastmodifiedbefore_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>Before</a>
    ...
    <dd>{{% md %}}If specified, only objects with a "last modification time" before this timestamp and objects that don't have a "last modification time" are transferred.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="posixfilesystem">Posix<wbr>Filesystem</h4>
...
<a href="#endtimeofday_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Time<wbr>Of<wbr>Day</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#timeofday">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Time<wbr>Of<wbr>Day</a></span>
    </dt>
...
<dl class="tabular"><dt>Status<wbr>Unspecified</dt>
    ...
    <dd>ENABLED{{% md %}}New transfers are performed based on the schedule.{{% /md %}}</dd><dt>Disabled</dt>
    <dd>DISABLED{{% md %}}New transfers are not scheduled.{{% /md %}}</dd><dt>Deleted</dt>
...
<dl class="tabular"><dt>Transfer<wbr>Job<wbr>Status<wbr>Status<wbr>Unspecified</dt>
    ...
    <dd>ENABLED{{% md %}}New transfers are performed based on the schedule.{{% /md %}}</dd><dt>Transfer<wbr>Job<wbr>Status<wbr>Disabled</dt>
    <dd>DISABLED{{% md %}}New transfers are not scheduled.{{% /md %}}</dd><dt>Transfer<wbr>Job<wbr>Status<wbr>Deleted</dt>
    <dd>DELETED{{% md %}}This is a soft delete state. After a transfer job is set to this state, the job and all the transfer executions are subject to garbage collection. Transfer jobs become eligible for garbage collection 30 days after their status is set to `DELETED`.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#awss3datasource_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>S3Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#awss3data">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Aws<wbr>S3Data</a></span>
    </dt>
...
<a href="#azureblobstoragedatasource_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Blob<wbr>Storage<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#azureblobstoragedata">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Azure<wbr>Blob<wbr>Storage<wbr>Data</a></span>
    </dt>
...
<a href="#gcsdatasink_csharp" style="color: inherit; text-decoration: inherit;">Gcs<wbr>Data<wbr>Sink</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gcsdata">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Gcs<wbr>Data</a></span>
    </dt>
...
<a href="#httpdatasource_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#httpdata">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Http<wbr>Data</a></span>
    </dt>
...
<a href="#objectconditions_csharp" style="color: inherit; text-decoration: inherit;">Object<wbr>Conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectconditions">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Object<wbr>Conditions</a></span>
    </dt>
...
<a href="#posixdatasource_csharp" style="color: inherit; text-decoration: inherit;">Posix<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#posixfilesystem">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Posix<wbr>Filesystem</a></span>
    </dt>
    <dd>{{% md %}}A POSIX Filesystem data source.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#transferoptions_csharp" style="color: inherit; text-decoration: inherit;">Transfer<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transferoptions">Pulumi.<wbr>Google<wbr>Native.<wbr>Storage<wbr>Transfer.<wbr>V1.<wbr>Inputs.<wbr>Transfer<wbr>Options</a></span>
    </dt>
...
<a href="#posixdatasource_go" style="color: inherit; text-decoration: inherit;">Posix<wbr>Data<wbr>Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#posixfilesystem">Posix<wbr>Filesystem</a></span>
    </dt>
    <dd>{{% md %}}A POSIX Filesystem data source.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
