...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}A user specified pipeline name that does not have to be unique. This name can be used for filtering Pipelines in ListPipelines.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#project_csharp" style="color: inherit; text-decoration: inherit;">Project</a>
    ...
    <dd>{{% md %}}The project in which to create the pipeline. The caller must have WRITE access.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
    ...
    <dd>{{% md %}}Specifies resource requirements for the pipeline run. Required fields: * minimumCpuCores * minimumRamGb{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#input_parameters_python" style="color: inherit; text-decoration: inherit;">input_<wbr>parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pipelineparameterresponse">Sequence[Pipeline<wbr>Parameter<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Input parameters of the pipeline.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_python">
