...
---
title: "getTrigger"
title_tag: "google-native.eventarc/v1.getTrigger"
meta_desc: "Documentation for the google-native.eventarc/v1.getTrigger function with examples, input properties, output properties, and supporting types."
layout: api
---
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#destinationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Outputs.<wbr>Destination<wbr>Response</a></span>
    </dt>
...
<a href="#eventfilters_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventfilterresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Outputs.<wbr>Event<wbr>Filter<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The resource name of the trigger. Must be unique within the location on the project and must be in `projects/{project}/locations/{location}/triggers/{trigger}` format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#transport_csharp" style="color: inherit; text-decoration: inherit;">Transport</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#transportresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Eventarc.<wbr>V1.<wbr>Outputs.<wbr>Transport<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. In order to deliver messages, Eventarc may use other GCP products as transport intermediary. This field contains a reference to that transport intermediary. This information can be used for debugging purposes.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="uid_csharp">
...
<a href="#eventfilters_go" style="color: inherit; text-decoration: inherit;">Event<wbr>Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventfilterresponse">[]Event<wbr>Filter<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="labels_go">
...
<a href="#event_filters_python" style="color: inherit; text-decoration: inherit;">event_<wbr>filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#eventfilterresponse">Sequence[Event<wbr>Filter<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}null The list of filters that applies to event attributes. Only events that match all the provided filters will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
