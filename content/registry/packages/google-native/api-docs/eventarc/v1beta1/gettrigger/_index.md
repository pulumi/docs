...
---
title: "getTrigger"
title_tag: "google-native.eventarc/v1beta1.getTrigger"
meta_desc: "Documentation for the google-native.eventarc/v1beta1.getTrigger function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#destinationresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Outputs.<wbr>Destination<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Destination specifies where the events should be sent to.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. User labels attached to the triggers that can be used to group resources.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#matchingcriteria_csharp" style="color: inherit; text-decoration: inherit;">Matching<wbr>Criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#matchingcriteriaresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Eventarc.<wbr>V1Beta1.<wbr>Outputs.<wbr>Matching<wbr>Criteria<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The resource name of the trigger. Must be unique within the location on the project and must in `projects/{project}/locations/{location}/triggers/{trigger}` format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#matchingcriteria_go" style="color: inherit; text-decoration: inherit;">Matching<wbr>Criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#matchingcriteriaresponse">[]Matching<wbr>Criteria<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_go">
...
<a href="#matching_criteria_python" style="color: inherit; text-decoration: inherit;">matching_<wbr>criteria</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#matchingcriteriaresponse">Sequence[Matching<wbr>Criteria<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}null The criteria by which events are filtered. Only events that match with this criteria will be sent to the destination.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_python">
