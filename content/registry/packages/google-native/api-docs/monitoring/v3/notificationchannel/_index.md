...
aliases:
    - "/docs/reference/pkg/google-native/NotificationChannel/"
...
<span class="k">def </span><span class="nx">NotificationChannel</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                        ...
                        <span class="nx">mutation_records</span><span class="p">:</span> <span class="nx">Optional[Sequence[MutationRecordArgs]]</span> = None<span class="p">,</span>
                        ...
                        <span class="nx">verification_status</span><span class="p">:</span> <span class="nx">Optional[NotificationChannelVerificationStatus]</span> = None<span class="p">)</span>
...
<a href="#mutation_records_python" style="color: inherit; text-decoration: inherit;">mutation_<wbr>records</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutationrecord">Sequence[Mutation<wbr>Record<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Records of the modification of this channel.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_python">
