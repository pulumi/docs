...
<span class="k">def </span><span class="nx">Dataset</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">access</span><span class="p">:</span> <span class="nx">Optional[Sequence[DatasetAccessItemArgs]]</span> = None<span class="p">,</span>
            <span class="nx">dataset_reference</span><span class="p">:</span> <span class="nx">Optional[DatasetReferenceArgs]</span> = None<span class="p">,</span>
            <span class="nx">default_encryption_configuration</span><span class="p">:</span> <span class="nx">Optional[EncryptionConfigurationArgs]</span> = None<span class="p">,</span>
            <span class="nx">default_partition_expiration_ms</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#access_python" style="color: inherit; text-decoration: inherit;">access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessitem">Sequence[Dataset<wbr>Access<wbr>Item<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}[Optional] An array of objects that define dataset access for one or more entities. You can set this property when inserting or updating a dataset in order to control who is allowed to access the data. If unspecified at dataset creation time, BigQuery adds default dataset access for the following entities: access.specialGroup: projectReaders; access.role: READER; access.specialGroup: projectWriters; access.role: WRITER; access.specialGroup: projectOwners; access.role: OWNER; access.userByEmail: [dataset creator email]; access.role: OWNER;{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dataset_csharp" style="color: inherit; text-decoration: inherit;">Dataset</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetreference">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Dataset<wbr>Reference</a></span>
    </dt>
...
<a href="#targettypes_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessentrytargettypesitem">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Dataset<wbr>Access<wbr>Entry<wbr>Target<wbr>Types<wbr>Item&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targettypes_go" style="color: inherit; text-decoration: inherit;">Target<wbr>Types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessentrytargettypesitem">[]Dataset<wbr>Access<wbr>Entry<wbr>Target<wbr>Types<wbr>Item</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#target_types_python" style="color: inherit; text-decoration: inherit;">target_<wbr>types</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessentrytargettypesitem">Sequence[Dataset<wbr>Access<wbr>Entry<wbr>Target<wbr>Types<wbr>Item]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="datasetaccessentrytargettypesitem">Dataset<wbr>Access<wbr>Entry<wbr>Target<wbr>Types<wbr>Item</h4>
...
<a href="#dataset_csharp" style="color: inherit; text-decoration: inherit;">Dataset</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#datasetaccessentry">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Dataset<wbr>Access<wbr>Entry</a></span>
    </dt>
...
<a href="#routine_csharp" style="color: inherit; text-decoration: inherit;">Routine</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#routinereference">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Routine<wbr>Reference</a></span>
    </dt>
...
<a href="#view_csharp" style="color: inherit; text-decoration: inherit;">View</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tablereference">Pulumi.<wbr>Google<wbr>Native.<wbr>Big<wbr>Query.<wbr>V2.<wbr>Inputs.<wbr>Table<wbr>Reference</a></span>
    </dt>
