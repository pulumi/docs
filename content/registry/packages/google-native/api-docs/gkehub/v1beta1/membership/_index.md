...
<span class="k">def </span><span class="nx">Membership</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">authority</span><span class="p">:</span> <span class="nx">Optional[AuthorityArgs]</span> = None<span class="p">,</span>
               ...
               <span class="nx">infrastructure_type</span><span class="p">:</span> <span class="nx">Optional[MembershipInfrastructureType]</span> = None<span class="p">,</span>
...
<a href="#authority_csharp" style="color: inherit; text-decoration: inherit;">Authority</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#authority">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Authority<wbr>Args</a></span>
    </dt>
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Optional. Description of this membership, limited to 63 characters. Must match the regex: `a-zA-Z0-9*`{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="endpoint_csharp">
<a href="#endpoint_csharp" style="color: inherit; text-decoration: inherit;">Endpoint</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#membershipendpoint">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Membership<wbr>Endpoint<wbr>Args</a></span>
    </dt>
...
<a href="#infrastructuretype_csharp" style="color: inherit; text-decoration: inherit;">Infrastructure<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#membershipinfrastructuretype">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Membership<wbr>Infrastructure<wbr>Type</a></span>
    </dt>
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}Optional. GCP labels for this membership.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="kubernetesresource">Kubernetes<wbr>Resource</h4>
...
<a href="#membershipcrmanifest_csharp" style="color: inherit; text-decoration: inherit;">Membership<wbr>Cr<wbr>Manifest</a>
    ...
    <dd>{{% md %}}Input only. The YAML representation of the Membership CR. This field is ignored for GKE clusters where Hub can read the CR directly. Callers should provide the CR that is currently present in the cluster during CreateMembership or UpdateMembership, or leave this field empty if none exists. The CR manifest is used to validate the cluster has not been registered with another Membership.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourceoptions_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceoptions">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Resource<wbr>Options</a></span>
    </dt>
...
<a href="#resourceoptions_go" style="color: inherit; text-decoration: inherit;">Resource<wbr>Options</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceoptions">Resource<wbr>Options</a></span>
    </dt>
    <dd>{{% md %}}Optional. Options for Kubernetes resource generation.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#gkecluster_csharp" style="color: inherit; text-decoration: inherit;">Gke<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#gkecluster">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Gke<wbr>Cluster</a></span>
    </dt>
...
<a href="#kubernetesresource_csharp" style="color: inherit; text-decoration: inherit;">Kubernetes<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesresource">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Kubernetes<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#multicloudcluster_csharp" style="color: inherit; text-decoration: inherit;">Multi<wbr>Cloud<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#multicloudcluster">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Multi<wbr>Cloud<wbr>Cluster</a></span>
    </dt>
...
<a href="#onpremcluster_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Prem<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#onpremcluster">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>On<wbr>Prem<wbr>Cluster</a></span>
    </dt>
...
<a href="#kubernetesresource_go" style="color: inherit; text-decoration: inherit;">Kubernetes<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#kubernetesresource">Kubernetes<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. The in-cluster Kubernetes Resources that should be applied for a correctly registered cluster, in the steady state. These resources: * Ensure that the cluster is exclusively registered to one and only one Hub Membership. * Propagate Workload Pool Information available in the Membership Authority field. * Ensure proper initial configuration of default Hub Features.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#multicloudcluster_csharp" style="color: inherit; text-decoration: inherit;">Multi<wbr>Cloud<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#multicloudclusterresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>Multi<wbr>Cloud<wbr>Cluster<wbr>Response</a></span>
    </dt>
...
<a href="#onpremcluster_csharp" style="color: inherit; text-decoration: inherit;">On<wbr>Prem<wbr>Cluster</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#onpremclusterresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>GKEHub.<wbr>V1Beta1.<wbr>Inputs.<wbr>On<wbr>Prem<wbr>Cluster<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. Specific information for a GKE On-Prem cluster.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="resourceoptions">Resource<wbr>Options</h4>
