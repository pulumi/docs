...
<a href="#posixgroups_csharp" style="color: inherit; text-decoration: inherit;">Posix<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#posixgroupresponse">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Identity.<wbr>V1Beta1.<wbr>Outputs.<wbr>Posix<wbr>Group<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Optional. The POSIX groups associated with the `Group`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#posixgroups_go" style="color: inherit; text-decoration: inherit;">Posix<wbr>Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#posixgroupresponse">[]Posix<wbr>Group<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Optional. The POSIX groups associated with the `Group`.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#additional_group_keys_python" style="color: inherit; text-decoration: inherit;">additional_<wbr>group_<wbr>keys</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#entitykeyresponse">Sequence[Entity<wbr>Key<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Additional entity key aliases for a Group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#posix_groups_python" style="color: inherit; text-decoration: inherit;">posix_<wbr>groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#posixgroupresponse">Sequence[Posix<wbr>Group<wbr>Response]</a></span>
    </dt>
    <dd>{{% md %}}Optional. The POSIX groups associated with the `Group`.{{% /md %}}</dd><dt class="property-"
            title="">
