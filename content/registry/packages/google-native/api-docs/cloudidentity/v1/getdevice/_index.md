...
---
title: "getDevice"
title_tag: "google-native.cloudidentity/v1.getDevice"
meta_desc: "Documentation for the google-native.cloudidentity/v1.getDevice function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_device(</span><span class="nx">customer</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
