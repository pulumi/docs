...
---
title: "Environment"
title_tag: "google-native.composer/v1beta1.Environment"
...
<a href="#config_csharp" style="color: inherit; text-decoration: inherit;">Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Environment<wbr>Config<wbr>Args</a></span>
    </dt>
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentstate">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Environment<wbr>State</a></span>
    </dt>
...
<a href="#environmentsize_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentconfigenvironmentsize">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Environment<wbr>Config<wbr>Environment<wbr>Size</a></span>
    </dt>
    <dd>{{% md %}}Optional. The size of the Cloud Composer environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maintenancewindow_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Window</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#maintenancewindow">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Maintenance<wbr>Window</a></span>
    </dt>
    <dd>{{% md %}}Optional. The maintenance window is the period when Cloud Composer components may undergo maintenance. It is defined so that maintenance is not executed during peak hours or critical time periods. The system will not be under maintenance for every occurrence of this window, but when maintenance is planned, it will be scheduled during the window. The maintenance window period must encompass at least 12 hours per week. This may be split into multiple chunks, each with a size of at least 4 hours. If this value is omitted, Cloud Composer components may be subject to maintenance at any time.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="nodeconfig_csharp">
<a href="#nodeconfig_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Config</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nodeconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Node<wbr>Config</a></span>
    </dt>
...
<a href="#privateenvironmentconfig_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Environment<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateenvironmentconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Private<wbr>Environment<wbr>Config</a></span>
    </dt>
...
<a href="#softwareconfig_csharp" style="color: inherit; text-decoration: inherit;">Software<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#softwareconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Software<wbr>Config</a></span>
    </dt>
...
<a href="#workloadsconfig_csharp" style="color: inherit; text-decoration: inherit;">Workloads<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workloadsconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Workloads<wbr>Config</a></span>
    </dt>
...
<a href="#environmentsize_go" style="color: inherit; text-decoration: inherit;">Environment<wbr>Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentconfigenvironmentsize">Environment<wbr>Config<wbr>Environment<wbr>Size</a></span>
    </dt>
    <dd>{{% md %}}Optional. The size of the Cloud Composer environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workloadsconfig_go" style="color: inherit; text-decoration: inherit;">Workloads<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workloadsconfig">Workloads<wbr>Config</a></span>
    </dt>
    <dd>{{% md %}}Optional. The workloads configuration settings for the GKE cluster associated with the Cloud Composer environment. The GKE cluster runs Airflow scheduler, web server and workers workloads. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="environmentconfigenvironmentsize">Environment<wbr>Config<wbr>Environment<wbr>Size</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Environment<wbr>Size<wbr>Unspecified</dt>
    <dd>ENVIRONMENT_SIZE_UNSPECIFIED{{% md %}}The size of the environment is unspecified.{{% /md %}}</dd><dt>Environment<wbr>Size<wbr>Small</dt>
    <dd>ENVIRONMENT_SIZE_SMALL{{% md %}}The environment size is small.{{% /md %}}</dd><dt>Environment<wbr>Size<wbr>Medium</dt>
    <dd>ENVIRONMENT_SIZE_MEDIUM{{% md %}}The environment size is medium.{{% /md %}}</dd><dt>Environment<wbr>Size<wbr>Large</dt>
    <dd>ENVIRONMENT_SIZE_LARGE{{% md %}}The environment size is large.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Environment<wbr>Config<wbr>Environment<wbr>Size<wbr>Environment<wbr>Size<wbr>Unspecified</dt>
    <dd>ENVIRONMENT_SIZE_UNSPECIFIED{{% md %}}The size of the environment is unspecified.{{% /md %}}</dd><dt>Environment<wbr>Config<wbr>Environment<wbr>Size<wbr>Environment<wbr>Size<wbr>Small</dt>
    <dd>ENVIRONMENT_SIZE_SMALL{{% md %}}The environment size is small.{{% /md %}}</dd><dt>Environment<wbr>Config<wbr>Environment<wbr>Size<wbr>Environment<wbr>Size<wbr>Medium</dt>
    <dd>ENVIRONMENT_SIZE_MEDIUM{{% md %}}The environment size is medium.{{% /md %}}</dd><dt>Environment<wbr>Config<wbr>Environment<wbr>Size<wbr>Environment<wbr>Size<wbr>Large</dt>
    <dd>ENVIRONMENT_SIZE_LARGE{{% md %}}The environment size is large.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>ENVIRONMENT_SIZE_UNSPECIFIED</dt>
    <dd>ENVIRONMENT_SIZE_UNSPECIFIED{{% md %}}The size of the environment is unspecified.{{% /md %}}</dd><dt>ENVIRONMENT_SIZE_SMALL</dt>
    <dd>ENVIRONMENT_SIZE_SMALL{{% md %}}The environment size is small.{{% /md %}}</dd><dt>ENVIRONMENT_SIZE_MEDIUM</dt>
    <dd>ENVIRONMENT_SIZE_MEDIUM{{% md %}}The environment size is medium.{{% /md %}}</dd><dt>ENVIRONMENT_SIZE_LARGE</dt>
    <dd>ENVIRONMENT_SIZE_LARGE{{% md %}}The environment size is large.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ipallocationpolicy_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Allocation<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#ipallocationpolicy">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>IPAllocation<wbr>Policy</a></span>
    </dt>
    <dd>{{% md %}}Optional. The IPAllocationPolicy fields for the GKE cluster.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="location_csharp">
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
</span>
...
<a href="#privateclusterconfig_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Cluster<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateclusterconfig">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Private<wbr>Cluster<wbr>Config</a></span>
    </dt>
...
<a href="#count_csharp" style="color: inherit; text-decoration: inherit;">Count</a>
    ...
    <dd>{{% md %}}Optional. The number of schedulers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="cpu_csharp">
<a href="#cpu_csharp" style="color: inherit; text-decoration: inherit;">Cpu</a>
    ...
    <dd>{{% md %}}Optional. CPU request and limit for a single Airflow scheduler replica.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#memorygb_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Gb</a>
    ...
    <dd>{{% md %}}Optional. Memory (GB) request and limit for a single Airflow scheduler replica.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowedipranges_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Ip<wbr>Ranges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#allowediprange">List&lt;Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Allowed<wbr>Ip<wbr>Range&gt;</a></span>
    </dt>
...
<h4 id="webserverresource">Web<wbr>Server<wbr>Resource</h4>
...
<a href="#cpu_csharp" style="color: inherit; text-decoration: inherit;">Cpu</a>
    ...
    <dd>{{% md %}}Optional. CPU request and limit for Airflow web server.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="memorygb_csharp">
<a href="#memorygb_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Gb</a>
</span>
    ...
    <dd>{{% md %}}Optional. Memory (GB) request and limit for Airflow web server.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="storagegb_csharp">
<a href="#storagegb_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Gb</a>
</span>
...
<h4 id="workerresource">Worker<wbr>Resource</h4>
...
<a href="#cpu_csharp" style="color: inherit; text-decoration: inherit;">Cpu</a>
    ...
    <dd>{{% md %}}Optional. CPU request and limit for a single Airflow worker replica.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maxcount_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Count</a>
    ...
    <dd>{{% md %}}Optional. Maximum number of workers for autoscaling.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="memorygb_csharp">
<a href="#memorygb_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Gb</a>
</span>
    ...
    <dd>{{% md %}}Optional. Memory (GB) request and limit for a single Airflow worker replica.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mincount_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Count</a>
    ...
    <dd>{{% md %}}Optional. Minimum number of workers for autoscaling.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="storagegb_csharp">
<a href="#storagegb_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Gb</a>
</span>
...
<h4 id="workloadsconfig">Workloads<wbr>Config</h4>
...
<a href="#scheduler_csharp" style="color: inherit; text-decoration: inherit;">Scheduler</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulerresource">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Scheduler<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. Resources used by Airflow schedulers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="webserver_csharp">
<a href="#webserver_csharp" style="color: inherit; text-decoration: inherit;">Web<wbr>Server</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webserverresource">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Web<wbr>Server<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. Resources used by Airflow web server.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="worker_csharp">
<a href="#worker_csharp" style="color: inherit; text-decoration: inherit;">Worker</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workerresource">Pulumi.<wbr>Google<wbr>Native.<wbr>Composer.<wbr>V1Beta1.<wbr>Inputs.<wbr>Worker<wbr>Resource</a></span>
    </dt>
...
<a href="#scheduler_go" style="color: inherit; text-decoration: inherit;">Scheduler</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#schedulerresource">Scheduler<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. Resources used by Airflow schedulers.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#webserver_go" style="color: inherit; text-decoration: inherit;">Web<wbr>Server</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#webserverresource">Web<wbr>Server<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. Resources used by Airflow web server.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="worker_go">
<a href="#worker_go" style="color: inherit; text-decoration: inherit;">Worker</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#workerresource">Worker<wbr>Resource</a></span>
    </dt>
    <dd>{{% md %}}Optional. Resources used by Airflow workers.{{% /md %}}</dd></dl>
{{% /choosable %}}
