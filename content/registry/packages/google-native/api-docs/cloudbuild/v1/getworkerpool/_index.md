...
---
title: "getWorkerPool"
title_tag: "google-native.cloudbuild/v1.getWorkerPool"
meta_desc: "Documentation for the google-native.cloudbuild/v1.getWorkerPool function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
...
<a href="#annotations_csharp" style="color: inherit; text-decoration: inherit;">Annotations</a>
    ...
    <dd>{{% md %}}User specified annotations. See https://google.aip.dev/128#annotations for more details such as format and size limitations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}A user-specified, human-readable name for the `WorkerPool`. If provided, this value must be 1-63 characters.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#privatepoolv1config_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Pool<wbr>V1Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatepoolv1configresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Cloud<wbr>Build.<wbr>V1.<wbr>Outputs.<wbr>Private<wbr>Pool<wbr>V1Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Private Pool using a v1 configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privatepoolv1config_go" style="color: inherit; text-decoration: inherit;">Private<wbr>Pool<wbr>V1Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatepoolv1configresponse">Private<wbr>Pool<wbr>V1Config<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Private Pool using a v1 configuration.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="state_go">
