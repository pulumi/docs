...
title_tag: "google-native.pubsub/v1beta2.getSubscription"
meta_desc: "Documentation for the google-native.pubsub/v1beta2.getSubscription function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
...
<a href="#pushconfig_csharp" style="color: inherit; text-decoration: inherit;">Push<wbr>Config</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#pushconfigresponse">Pulumi.<wbr>Google<wbr>Native.<wbr>Pubsub.<wbr>V1Beta2.<wbr>Outputs.<wbr>Push<wbr>Config<wbr>Response</a></span>
    </dt>
