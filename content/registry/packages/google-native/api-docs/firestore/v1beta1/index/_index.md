...
<span class="k">def </span><span class="nx">Index</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">fields</span><span class="p">:</span> <span class="nx">Optional[Sequence[GoogleFirestoreAdminV1beta1IndexFieldArgs]]</span> = None<span class="p">,</span>
          <span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">project</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
          <span class="nx">state</span><span class="p">:</span> <span class="nx">Optional[IndexState]</span> = None<span class="p">)</span>
...
<a href="#fields_python" style="color: inherit; text-decoration: inherit;">fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#googlefirestoreadminv1beta1indexfield">Sequence[Google<wbr>Firestore<wbr>Admin<wbr>V1beta1Index<wbr>Field<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}The fields to index.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_python">
