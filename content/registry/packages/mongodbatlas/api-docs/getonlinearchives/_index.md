...
## Using getOnlineArchives {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getOnlineArchives<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetOnlineArchivesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetOnlineArchivesResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_online_archives(</span><span class="nx">cluster_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                        <span class="nx">project_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetOnlineArchivesResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetOnlineArchives<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetOnlineArchivesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetOnlineArchivesResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `GetOnlineArchives` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetOnlineArchives </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetOnlineArchivesResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetOnlineArchivesArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## getOnlineArchives Result {#result}
...
<a href="#results_csharp" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresult">List&lt;Get<wbr>Online<wbr>Archives<wbr>Result&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#results_go" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresult">[]Get<wbr>Online<wbr>Archives<wbr>Result</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#results_python" style="color: inherit; text-decoration: inherit;">results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresult">Sequence[Get<wbr>Online<wbr>Archives<wbr>Result]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<h4 id="getonlinearchivesresult">Get<wbr>Online<wbr>Archives<wbr>Result</h4>
...
<a href="#criterias_csharp" style="color: inherit; text-decoration: inherit;">Criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultcriteria">List&lt;Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Criteria&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#partitionfields_csharp" style="color: inherit; text-decoration: inherit;">Partition<wbr>Fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultpartitionfield">List&lt;Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Partition<wbr>Field&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#criterias_go" style="color: inherit; text-decoration: inherit;">Criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultcriteria">[]Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Criteria</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="dbname_go">
...
<a href="#partitionfields_go" style="color: inherit; text-decoration: inherit;">Partition<wbr>Fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultpartitionfield">[]Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Partition<wbr>Field</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="paused_go">
...
<a href="#criterias_python" style="color: inherit; text-decoration: inherit;">criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultcriteria">Sequence[Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Criteria]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#partition_fields_python" style="color: inherit; text-decoration: inherit;">partition_<wbr>fields</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getonlinearchivesresultpartitionfield">Sequence[Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Partition<wbr>Field]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<h4 id="getonlinearchivesresultcriteria">Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Criteria</h4>
...
<h4 id="getonlinearchivesresultpartitionfield">Get<wbr>Online<wbr>Archives<wbr>Result<wbr>Partition<wbr>Field</h4>
