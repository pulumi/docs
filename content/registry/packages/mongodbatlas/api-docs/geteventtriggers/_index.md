...
---
title: "getEventTriggers"
title_tag: "mongodbatlas.getEventTriggers"
meta_desc: "Documentation for the mongodbatlas.getEventTriggers function with examples, input properties, output properties, and supporting types."
layout: api
---
...
## Using getEventTriggers {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getEventTriggers<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetEventTriggersArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetEventTriggersResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_event_triggers(</span><span class="nx">app_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       <span class="nx">project_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetEventTriggersResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetEventTriggers<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetEventTriggersArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetEventTriggersResult</a></span>, error)</span></code></pre></div>

> Note: This function is named `GetEventTriggers` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEventTriggers </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetEventTriggersResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetEventTriggersArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
    ...
    <dd>{{% md %}}The unique ID for the project to get all event triggers.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
## getEventTriggers Result {#result}
...
<a href="#results_csharp" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresult">List&lt;Get<wbr>Event<wbr>Triggers<wbr>Result&gt;</a></span>
    </dt>
    <dd>{{% md %}}A list where each represents a Event Trigger.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#results_go" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresult">[]Get<wbr>Event<wbr>Triggers<wbr>Result</a></span>
    </dt>
    <dd>{{% md %}}A list where each represents a Event Trigger.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#results_python" style="color: inherit; text-decoration: inherit;">results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresult">Sequence[Get<wbr>Event<wbr>Triggers<wbr>Result]</a></span>
    </dt>
    <dd>{{% md %}}A list where each represents a Event Trigger.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="geteventtriggersresult">Get<wbr>Event<wbr>Triggers<wbr>Result</h4>
...
<a href="#eventprocessors_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Processors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessor">List&lt;Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor&gt;</a></span>
    </dt>
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}The type of the trigger. Possible Values: `DATABASE`, `AUTHENTICATION`
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#eventprocessors_go" style="color: inherit; text-decoration: inherit;">Event<wbr>Processors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessor">[]Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor</a></span>
    </dt>
    <dd>{{% md %}}An object where each field name is an event processor ID and each value is an object that configures its corresponding event processor.
* `event_processors.0.aws_eventbridge.config_account_id` - AWS Account ID.
* `event_processors.0.aws_eventbridge.config_region` - Region of AWS Account.
...
<a href="#event_processors_python" style="color: inherit; text-decoration: inherit;">event_<wbr>processors</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessor">Sequence[Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor]</a></span>
    </dt>
    <dd>{{% md %}}An object where each field name is an event processor ID and each value is an object that configures its corresponding event processor.
* `event_processors.0.aws_eventbridge.config_account_id` - AWS Account ID.
* `event_processors.0.aws_eventbridge.config_region` - Region of AWS Account.
...
<h4 id="geteventtriggersresulteventprocessor">Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor</h4>
...
<a href="#awseventbridges_csharp" style="color: inherit; text-decoration: inherit;">Aws<wbr>Eventbridges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessorawseventbridge">List&lt;Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor<wbr>Aws<wbr>Eventbridge&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#awseventbridges_go" style="color: inherit; text-decoration: inherit;">Aws<wbr>Eventbridges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessorawseventbridge">[]Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor<wbr>Aws<wbr>Eventbridge</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#aws_eventbridges_python" style="color: inherit; text-decoration: inherit;">aws_<wbr>eventbridges</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#geteventtriggersresulteventprocessorawseventbridge">Sequence[Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor<wbr>Aws<wbr>Eventbridge]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="geteventtriggersresulteventprocessorawseventbridge">Get<wbr>Event<wbr>Triggers<wbr>Result<wbr>Event<wbr>Processor<wbr>Aws<wbr>Eventbridge</h4>
