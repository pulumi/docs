...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_projects(</span><span class="nx">items_per_page</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
...
<a href="#teams_python" style="color: inherit; text-decoration: inherit;">teams</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectsresultteam">Sequence[Get<wbr>Projects<wbr>Result<wbr>Team]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
