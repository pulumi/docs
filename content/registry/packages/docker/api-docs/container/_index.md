...
aliases:
    - "/docs/reference/pkg/docker/Container/"
layout: api
---
...
<a href="#image_csharp" style="color: inherit; text-decoration: inherit;">Image</a>
    ...
    <dd>{{% md %}}The ID of the image to back this container. The easiest way to get this value is to use the `docker_image` resource as
...
<a href="#attach_csharp" style="color: inherit; text-decoration: inherit;">Attach</a>
    ...
    <dd>{{% md %}}If `true` attach to the container after its creation and waits the end of its execution. Defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#capabilities_csharp" style="color: inherit; text-decoration: inherit;">Capabilities</a>
    ...
    <dd>{{% md %}}Add or drop certrain linux capabilities.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#command_csharp" style="color: inherit; text-decoration: inherit;">Command</a>
    ...
    <dd>{{% md %}}The command to use to start the container. For example, to run `/usr/bin/myprogram -f baz.conf` set the command to be
...
<a href="#destroygraceseconds_csharp" style="color: inherit; text-decoration: inherit;">Destroy<wbr>Grace<wbr>Seconds</a>
    ...
    <dd>{{% md %}}If defined will attempt to stop the container before destroying. Container will be destroyed after `n` seconds or on
successful stop.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#devices_csharp" style="color: inherit; text-decoration: inherit;">Devices</a>
    ...
    <dd>{{% md %}}Bind devices to the container.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="dns_csharp">
...
<a href="#dnsopts_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Opts</a>
    ...
    <dd>{{% md %}}DNS options used by the DNS provider(s), see `resolv.conf` documentation for valid list of options.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dnssearches_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Searches</a>
    ...
    <dd>{{% md %}}DNS search domains that are used when bare unqualified hostnames are used inside of the container.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#entrypoints_csharp" style="color: inherit; text-decoration: inherit;">Entrypoints</a>
    ...
    <dd>{{% md %}}The command to use as the Entrypoint for the container. The Entrypoint allows you to configure a container to run as an
...
<a href="#envs_csharp" style="color: inherit; text-decoration: inherit;">Envs</a>
    ...
    <dd>{{% md %}}Environment variables to set in the form of `KEY=VALUE`, e.g. `DEBUG=0`
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#groupadds_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Adds</a>
    ...
    <dd>{{% md %}}Additional groups for the container user
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#healthcheck_csharp" style="color: inherit; text-decoration: inherit;">Healthcheck</a>
    ...
    <dd>{{% md %}}A test to perform to check that the container is healthy
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#hosts_csharp" style="color: inherit; text-decoration: inherit;">Hosts</a>
    ...
    <dd>{{% md %}}Additional hosts to add to the container.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="init_csharp">
<a href="#init_csharp" style="color: inherit; text-decoration: inherit;">Init</a>
    ...
    <dd>{{% md %}}Configured whether an init process should be injected for this container. If unset this will default to the `dockerd`
defaults.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipcmode_csharp" style="color: inherit; text-decoration: inherit;">Ipc<wbr>Mode</a>
    ...
    <dd>{{% md %}}IPC sharing mode for the container. Possible values are: `none`, `private`, `shareable`, `container:<name|id>` or
`host`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#links_csharp" style="color: inherit; text-decoration: inherit;">Links</a>
    ...
    <dd>{{% md %}}Set of links for link based connectivity between containers that are running on the same host.
...
<a href="#logdriver_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Driver</a>
    ...
    <dd>{{% md %}}The logging driver to use for the container. Defaults to `json-file`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#logopts_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Opts</a>
    ...
    <dd>{{% md %}}Key/value pairs to use as options for the logging driver.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="logs_csharp">
<a href="#logs_csharp" style="color: inherit; text-decoration: inherit;">Logs</a>
    ...
    <dd>{{% md %}}Save the container logs (`attach` must be enabled). Defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#maxretrycount_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Retry<wbr>Count</a>
    ...
    <dd>{{% md %}}The maximum amount of times to an attempt a restart when `restart` is set to 'on-failure'.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#memoryswap_csharp" style="color: inherit; text-decoration: inherit;">Memory<wbr>Swap</a>
    ...
    <dd>{{% md %}}The total memory limit (memory + swap) for the container in MBs. This setting may compute to `-1` after `terraform
...
<a href="#mounts_csharp" style="color: inherit; text-decoration: inherit;">Mounts</a>
    ...
    <dd>{{% md %}}Specification for mounts to be added to containers created as part of the service.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#mustrun_csharp" style="color: inherit; text-decoration: inherit;">Must<wbr>Run</a>
    ...
    <dd>{{% md %}}If `true`, then the Docker container will be kept running. If `false`, then as long as the container exists, Terraform
...
<a href="#networkaliases_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Aliases</a>
    ...
    <dd>{{% md %}}Set an alias for the container in all specified networks
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use networks_advanced instead. Will be removed in v3.0.0{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#networks_csharp" style="color: inherit; text-decoration: inherit;">Networks</a>
    ...
    <dd>{{% md %}}ID of the networks in which the container is.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use networks_advanced instead. Will be removed in v3.0.0{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#networksadvanced_csharp" style="color: inherit; text-decoration: inherit;">Networks<wbr>Advanced</a>
    ...
    <dd>{{% md %}}The networks the container is attached to
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#pidmode_csharp" style="color: inherit; text-decoration: inherit;">Pid<wbr>Mode</a>
    ...
    <dd>{{% md %}}he PID (Process) Namespace mode for the container. Either `container:<name|id>` or `host`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ports_csharp" style="color: inherit; text-decoration: inherit;">Ports</a>
    ...
    <dd>{{% md %}}Publish a container's port(s) to the host.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privileged_csharp" style="color: inherit; text-decoration: inherit;">Privileged</a>
    ...
    <dd>{{% md %}}If `true`, the container runs in privileged mode.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#readonly_csharp" style="color: inherit; text-decoration: inherit;">Read<wbr>Only</a>
    ...
    <dd>{{% md %}}If `true`, the container will be started as readonly. Defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#removevolumes_csharp" style="color: inherit; text-decoration: inherit;">Remove<wbr>Volumes</a>
    ...
    <dd>{{% md %}}If `true`, it will remove anonymous volumes associated with the container. Defaults to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#restart_csharp" style="color: inherit; text-decoration: inherit;">Restart</a>
    ...
    <dd>{{% md %}}The restart policy for the container. Must be one of 'no', 'on-failure', 'always', 'unless-stopped'. Defaults to `no`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rm_csharp">
<a href="#rm_csharp" style="color: inherit; text-decoration: inherit;">Rm</a>
    ...
    <dd>{{% md %}}If `true`, then the container will be automatically removed after his execution. Terraform won't check this container
...
<a href="#securityopts_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Opts</a>
    ...
    <dd>{{% md %}}List of string values to customize labels for MLS systems, such as SELinux. See
...
<a href="#start_csharp" style="color: inherit; text-decoration: inherit;">Start</a>
    ...
    <dd>{{% md %}}If `true`, then the Docker container will be started after creation. If `false`, then the container is only created.
Defaults to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#stdinopen_csharp" style="color: inherit; text-decoration: inherit;">Stdin<wbr>Open</a>
    ...
    <dd>{{% md %}}If `true`, keep STDIN open even if not attached (`docker run -i`). Defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="storageopts_csharp">
<a href="#storageopts_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, object&gt;</span>
    </dt>
    <dd>{{% md %}}Key/value pairs for the storage driver options, e.g. `size`: `120G`
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#tty_csharp" style="color: inherit; text-decoration: inherit;">Tty</a>
    ...
    <dd>{{% md %}}If `true`, allocate a pseudo-tty (`docker run -t`). Defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#uploads_csharp" style="color: inherit; text-decoration: inherit;">Uploads</a>
    ...
    <dd>{{% md %}}Specifies files to upload to the container before starting it. Only one of `content` or `content_base64` can be set and
...
<a href="#user_csharp" style="color: inherit; text-decoration: inherit;">User</a>
    ...
    <dd>{{% md %}}User used for run the first process. Format is `user` or `user:group` which user and group can be passed literraly or by
name.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#volumes_csharp" style="color: inherit; text-decoration: inherit;">Volumes</a>
    ...
    <dd>{{% md %}}Spec for mounting volumes in the container.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storageopts_go" style="color: inherit; text-decoration: inherit;">Storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">map[string]interface{}</span>
    </dt>
...
<a href="#storageopts_nodejs" style="color: inherit; text-decoration: inherit;">storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">{[key: string]: any}</span>
    </dt>
...
<a href="#storage_opts_python" style="color: inherit; text-decoration: inherit;">storage_<wbr>opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, Any]</span>
    </dt>
...
<a href="#gateway_csharp" style="color: inherit; text-decoration: inherit;">Gateway</a>
    ...
    <dd>{{% md %}}The network gateway of the container.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The network gateway of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP address of the container&#39;s first network it.{{% /md %}}</p></dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a href="#ipprefixlength_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Prefix<wbr>Length</a>
    ...
    <dd>{{% md %}}The IP prefix length of the container.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP prefix length of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-"
            title="">
...
<a href="#networkdatas_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Datas</a>
    ...
    <dd>{{% md %}}The data of the networks the container is connected to.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#state_gateway_csharp" style="color: inherit; text-decoration: inherit;">Gateway</a>
    ...
    <dd>{{% md %}}The network gateway of the container.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The network gateway of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_ipaddress_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}The IP address of the container.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP address of the container&#39;s first network it.{{% /md %}}</p></dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
...
<a href="#state_ipprefixlength_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Prefix<wbr>Length</a>
    ...
    <dd>{{% md %}}The IP prefix length of the container.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP prefix length of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_storageopts_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Dictionary&lt;string, object&gt;</span>
    </dt>
...
<a href="#state_storageopts_go" style="color: inherit; text-decoration: inherit;">Storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">map[string]interface{}</span>
    </dt>
...
<a href="#state_storageopts_nodejs" style="color: inherit; text-decoration: inherit;">storage<wbr>Opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">{[key: string]: any}</span>
    </dt>
...
<a href="#state_storage_opts_python" style="color: inherit; text-decoration: inherit;">storage_<wbr>opts</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Mapping[str, Any]</span>
    </dt>
...
<a href="#gateway_csharp" style="color: inherit; text-decoration: inherit;">Gateway</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The network gateway of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#ipaddress_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP address of the container&#39;s first network it.{{% /md %}}</p></dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
        <span id="ipprefixlength_csharp">
<a href="#ipprefixlength_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Prefix<wbr>Length</a>
</span>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use `network_data` instead. The IP prefix length of the container as read from its NetworkSettings.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
