...
<a href="#build_csharp" style="color: inherit; text-decoration: inherit;">Build</a>
    ...
    <dd>{{% md %}}Configuration to build an image. Please see [docker build command
...
<a href="#forceremove_csharp" style="color: inherit; text-decoration: inherit;">Force<wbr>Remove</a>
    ...
    <dd>{{% md %}}If true, then the image is removed forcibly when the resource is destroyed.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#keeplocally_csharp" style="color: inherit; text-decoration: inherit;">Keep<wbr>Locally</a>
    ...
    <dd>{{% md %}}If true, then the Docker image won't be deleted on destroy operation. If this is false, it will delete the image from
...
<a href="#pulltrigger_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Trigger</a>
    ...
    <dd>{{% md %}}A value which cause an image pull when changed
...
<a href="#pulltriggers_csharp" style="color: inherit; text-decoration: inherit;">Pull<wbr>Triggers</a>
    ...
    <dd>{{% md %}}List of values which cause an image pull when changed. This is used to store the image digest from the registry when
...
<a href="#latest_csharp" style="color: inherit; text-decoration: inherit;">Latest</a>
    ...
    <dd>{{% md %}}The ID of the image in the form of `sha256:<hash>` image digest. Do not confuse it with the default `latest` tag.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use repo_digest instead{{% /md %}}</p></dd><dt class="property- property-deprecated"
            title=", Deprecated">
...
<a href="#output_csharp" style="color: inherit; text-decoration: inherit;">Output</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Is unused and will be removed.{{% /md %}}</p></dd><dt class="property-"
            title="">
...
<a href="#repodigest_csharp" style="color: inherit; text-decoration: inherit;">Repo<wbr>Digest</a>
    ...
    <dd>{{% md %}}The image sha256 digest in the form of `repo[:tag]@sha256:<hash>`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">pull_trigger</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">pull_triggers</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
        <span class="nx">repo_digest</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">) -&gt;</span> RemoteImage</code></pre></div>
{{% /choosable %}}
...
<a href="#state_latest_csharp" style="color: inherit; text-decoration: inherit;">Latest</a>
    ...
    <dd>{{% md %}}The ID of the image in the form of `sha256:<hash>` image digest. Do not confuse it with the default `latest` tag.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use repo_digest instead{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a href="#state_output_csharp" style="color: inherit; text-decoration: inherit;">Output</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Is unused and will be removed.{{% /md %}}</p></dd><dt class="property-optional property-deprecated"
            title="Optional, Deprecated">
...
<a href="#state_repodigest_csharp" style="color: inherit; text-decoration: inherit;">Repo<wbr>Digest</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_repodigest_go" style="color: inherit; text-decoration: inherit;">Repo<wbr>Digest</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_repodigest_nodejs" style="color: inherit; text-decoration: inherit;">repo<wbr>Digest</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_repo_digest_python" style="color: inherit; text-decoration: inherit;">repo_<wbr>digest</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
