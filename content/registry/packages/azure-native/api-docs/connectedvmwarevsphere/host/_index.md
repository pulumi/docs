...
---
title: "Host"
title_tag: "azure-native.connectedvmwarevsphere.Host"
meta_desc: "Documentation for the azure-native.connectedvmwarevsphere.Host resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
class MyStack : Stack
{
    public MyStack()
    {
        var host = new AzureNative.ConnectedVMwarevSphere.Host("host", new AzureNative.ConnectedVMwarevSphere.HostArgs
        {
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the host.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the inventory Item ID for the host.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#morefid_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Ref<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter MoRef (Managed Object Reference) ID for the host.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#vcenterid_csharp" style="color: inherit; text-decoration: inherit;">VCenter<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the ARM Id of the vCenter resource in which this host resides.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#moname_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Name</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter Managed Object name for the host.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
```sh
$ pulumi import azure-native:connectedvmwarevsphere:Host ContosoAgent /subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.ConnectedVMwarevSphere/Hosts/ContosoAgent 
```
