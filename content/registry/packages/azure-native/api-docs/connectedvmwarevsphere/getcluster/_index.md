...
---
title: "getCluster"
title_tag: "azure-native.connectedvmwarevsphere.getCluster"
meta_desc: "Documentation for the azure-native.connectedvmwarevsphere.getCluster function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the inventory Item ID for the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#morefid_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Ref<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter MoRef (Managed Object Reference) ID for the cluster.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
