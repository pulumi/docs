...
<a href="#datastorename_csharp" style="color: inherit; text-decoration: inherit;">Datastore<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the datastore.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#inventoryitemid_csharp" style="color: inherit; text-decoration: inherit;">Inventory<wbr>Item<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the inventory Item ID for the datastore.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#morefid_csharp" style="color: inherit; text-decoration: inherit;">Mo<wbr>Ref<wbr>Id</a>
    ...
    <dd>{{% md %}}Gets or sets the vCenter MoRef (Managed Object Reference) ID for the datastore.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
