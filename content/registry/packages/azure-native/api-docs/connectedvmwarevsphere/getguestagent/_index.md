...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getGuestAgent<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetGuestAgentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetGuestAgentResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_guest_agent(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    ...
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetGuestAgentResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupGuestAgent<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupGuestAgentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupGuestAgentResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetGuestAgent </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetGuestAgentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetGuestAgentArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the GuestAgent.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Gets or sets the guest agent status.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#credentials_csharp" style="color: inherit; text-decoration: inherit;">Credentials</a>
    ...
    <dd>{{% md %}}Username / Password Credentials to provision guest agent.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#httpproxyconfig_csharp" style="color: inherit; text-decoration: inherit;">Http<wbr>Proxy<wbr>Config</a>
    ...
    <dd>{{% md %}}HTTP Proxy configuration for the VM.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningaction_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>Action</a>
    ...
    <dd>{{% md %}}Gets or sets the guest agent provisioning action.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">Username</a>
    ...
    <dd>{{% md %}}Gets or sets username to connect with the guest.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#httpsproxy_csharp" style="color: inherit; text-decoration: inherit;">Https<wbr>Proxy</a>
    ...
    <dd>{{% md %}}Gets or sets httpsProxy url.{{% /md %}}</dd></dl>
{{% /choosable %}}
