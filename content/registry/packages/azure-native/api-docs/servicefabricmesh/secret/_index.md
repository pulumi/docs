...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretresourceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Service<wbr>Fabric<wbr>Mesh.<wbr>Inputs.<wbr>Secret<wbr>Resource<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Describes the properties of a secret resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
