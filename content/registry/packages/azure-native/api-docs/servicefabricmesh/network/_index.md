...
---
title: "Network"
title_tag: "azure-native.servicefabricmesh.Network"
meta_desc: "Documentation for the azure-native.servicefabricmesh.Network resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/azure-native/Network/"
...
<span class="k">def </span><span class="nx">Network</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">network_resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
            <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[NetworkResourcePropertiesArgs]</span> = None<span class="p">,</span>
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#networkresourceproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Service<wbr>Fabric<wbr>Mesh.<wbr>Inputs.<wbr>Network<wbr>Resource<wbr>Properties<wbr>Args</a></span>
    </dt>
...
<a href="#networkresourcename_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The identity of the network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}User readable description of the network.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Status of the network.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#statusdetails_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Details</a>
    ...
    <dd>{{% md %}}Gives additional information about the current status of the network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="description_csharp">
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
</span>
