...
---
title: "getSecret"
title_tag: "azure-native.servicefabricmesh.getSecret"
meta_desc: "Documentation for the azure-native.servicefabricmesh.getSecret function with examples, input properties, output properties, and supporting types."
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_secret(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#secretresourcename_csharp" style="color: inherit; text-decoration: inherit;">Secret<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the secret resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Fully qualified identifier for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#secretresourcepropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Service<wbr>Fabric<wbr>Mesh.<wbr>Outputs.<wbr>Secret<wbr>Resource<wbr>Properties<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Describes the properties of a secret resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}State of the resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Status of the resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#statusdetails_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Details</a>
    ...
    <dd>{{% md %}}Gives additional information about the current status of the secret.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#contenttype_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of the content stored in the secret value. The value of this property is opaque to Service Fabric. Once set, the value of this property cannot be changed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}User readable description of the secret.{{% /md %}}</dd></dl>
{{% /choosable %}}
