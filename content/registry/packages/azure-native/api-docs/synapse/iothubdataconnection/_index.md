...
<a href="#sharedaccesspolicyname_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Access<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the share access policy{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dataformat_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Format</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#iothubdataformat">Pulumi.<wbr>Azure<wbr>Native.<wbr>Synapse.<wbr>Iot<wbr>Hub<wbr>Data<wbr>Format</a></span>
    </dt>
