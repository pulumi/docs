...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_asset(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              ...
              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetAssetResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupAsset<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAssetArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupAssetResult</a></span>, error)</span></code></pre></div>
...
<a href="#assetid_csharp" style="color: inherit; text-decoration: inherit;">Asset<wbr>Id</a>
    ...
    <dd>{{% md %}}The Asset ID.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#created_csharp" style="color: inherit; text-decoration: inherit;">Created</a>
    ...
    <dd>{{% md %}}The creation date of the Asset.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#lastmodified_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified</a>
    ...
    <dd>{{% md %}}The last modified date of the Asset.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#storageencryptionformat_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Encryption<wbr>Format</a>
    ...
    <dd>{{% md %}}The Asset encryption format. One of None or MediaStorageEncryption.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#alternateid_csharp" style="color: inherit; text-decoration: inherit;">Alternate<wbr>Id</a>
    ...
    <dd>{{% md %}}The alternate ID of the Asset.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#container_csharp" style="color: inherit; text-decoration: inherit;">Container</a>
    ...
    <dd>{{% md %}}The name of the asset blob container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The Asset description.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageaccountname_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the storage account.{{% /md %}}</dd></dl>
{{% /choosable %}}
