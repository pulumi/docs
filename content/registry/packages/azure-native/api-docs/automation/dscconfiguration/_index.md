...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewDscConfiguration</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">DscConfigurationArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">DscConfiguration</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The DscConfiguration resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#contentsource">Pulumi.<wbr>Azure<wbr>Native.<wbr>Automation.<wbr>Inputs.<wbr>Content<wbr>Source<wbr>Args</a></span>
    </dt>
...
<a href="#configurationname_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Name</a>
    ...
    <dd>{{% md %}}The create or update parameters for configuration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Gets or sets the description of the configuration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#logprogress_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Progress</a>
    ...
    <dd>{{% md %}}Gets or sets progress log option.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#logverbose_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Verbose</a>
    ...
    <dd>{{% md %}}Gets or sets verbose log option.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
...
<a href="#jobcount_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Count</a>
    ...
    <dd>{{% md %}}Gets or sets the job count of the configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#nodeconfigurationcount_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Configuration<wbr>Count</a>
    ...
    <dd>{{% md %}}Gets the number of compiled node configurations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}Gets or sets the provisioning state of the configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}Gets or sets the state of the configuration.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="contentsourcetype">Content<wbr>Source<wbr>Type</h4>
...
<a href="#defaultvalue_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Value</a>
    ...
    <dd>{{% md %}}Gets or sets the default value of parameter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ismandatory_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Mandatory</a>
    ...
    <dd>{{% md %}}Gets or sets a Boolean value to indicate whether the parameter is mandatory or not.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#position_csharp" style="color: inherit; text-decoration: inherit;">Position</a>
    ...
    <dd>{{% md %}}Get or sets the position of the parameter.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
    ...
    <dd>{{% md %}}Gets or sets the type of the parameter.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#is_mandatory_python" style="color: inherit; text-decoration: inherit;">is_<wbr>mandatory</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
