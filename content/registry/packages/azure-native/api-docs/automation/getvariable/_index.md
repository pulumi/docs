...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_variable(</span><span class="nx">automation_account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#variablename_csharp" style="color: inherit; text-decoration: inherit;">Variable<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of variable.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#isencrypted_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Encrypted</a>
    ...
    <dd>{{% md %}}Gets or sets the encrypted flag of the variable.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}Gets or sets the value of the variable.{{% /md %}}</dd></dl>
{{% /choosable %}}
