...
aliases:
    - "/docs/reference/pkg/azure-native/ConnectionType/"
layout: api
---
...
The ConnectionType resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
