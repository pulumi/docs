...
aliases:
    - "/docs/reference/pkg/azure-native/JobSchedule/"
...
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduleassociationproperty">Pulumi.<wbr>Azure<wbr>Native.<wbr>Automation.<wbr>Inputs.<wbr>Schedule<wbr>Association<wbr>Property<wbr>Args</a></span>
    </dt>
...
<a href="#jobscheduleid_csharp" style="color: inherit; text-decoration: inherit;">Job<wbr>Schedule<wbr>Id</a>
    ...
    <dd>{{% md %}}The job schedule name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#parameters_csharp" style="color: inherit; text-decoration: inherit;">Parameters</a>
    ...
    <dd>{{% md %}}Gets or sets a list of job properties.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#runon_csharp" style="color: inherit; text-decoration: inherit;">Run<wbr>On</a>
    ...
    <dd>{{% md %}}Gets or sets the hybrid worker group that the scheduled job should run on.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets the name of the variable.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Gets or sets the name of the Schedule.{{% /md %}}</dd></dl>
{{% /choosable %}}
