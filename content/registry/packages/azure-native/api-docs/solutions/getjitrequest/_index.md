...
><span class="k">function </span>getJitRequest<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetJitRequestArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetJitRequestResult</a></span>></span
><span class="k">
function </span>getJitRequestOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetJitRequestOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetJitRequestResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_jit_request<span class="p">(</span><span class="nx">jit_request_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetJitRequestResult</span
><span class="k">
def </span>get_jit_request_output<span class="p">(</span><span class="nx">jit_request_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                    <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetJitRequestResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>LookupJitRequest<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupJitRequestArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupJitRequestResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetJitRequest </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetJitRequestResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetJitRequestArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetJitRequestResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetJitRequestInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#jitrequestname_csharp" style="color: inherit; text-decoration: inherit;">Jit<wbr>Request<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the JIT request.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#applicationresourceid_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The parent application id.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jitauthorizationpolicies_csharp" style="color: inherit; text-decoration: inherit;">Jit<wbr>Authorization<wbr>Policies</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitauthorizationpoliciesresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Solutions.<wbr>Outputs.<wbr>Jit<wbr>Authorization<wbr>Policies<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}The JIT authorization policies.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#jitschedulingpolicy_csharp" style="color: inherit; text-decoration: inherit;">Jit<wbr>Scheduling<wbr>Policy</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#jitschedulingpolicyresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Solutions.<wbr>Outputs.<wbr>Jit<wbr>Scheduling<wbr>Policy<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The JIT request properties.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#updatedby_csharp" style="color: inherit; text-decoration: inherit;">Updated<wbr>By</a>
    ...
    <dd>{{% md %}}The client entity that last updated the JIT request.{{% /md %}}</dd><dt class="property-"
            title="">
