...
<a href="#accountname_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Azure Video Analyzer for Media account.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#accountname_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Name</a>
    ...
    <dd>{{% md %}}The account's name{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}Managed service identity (system assigned and/or user assigned identities){{% /md %}}</dd><dt class="property-"
            title="">
        <span id="mediaservices_csharp">
<a href="#mediaservices_csharp" style="color: inherit; text-decoration: inherit;">Media<wbr>Services</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mediaservicesforputrequestresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Video<wbr>Indexer.<wbr>Outputs.<wbr>Media<wbr>Services<wbr>For<wbr>Put<wbr>Request<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The media services details{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#mediaservices_go" style="color: inherit; text-decoration: inherit;">Media<wbr>Services</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mediaservicesforputrequestresponse">Media<wbr>Services<wbr>For<wbr>Put<wbr>Request<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The media services details{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_go">
