...
title_tag: "azure-native.machinelearning.getCommitmentPlan"
meta_desc: "Documentation for the azure-native.machinelearning.getCommitmentPlan function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_commitment_plan<span class="p">(</span><span class="nx">commitment_plan_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_commitment_plan_output<span class="p">(</span><span class="nx">commitment_plan_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#commitmentplanname_csharp" style="color: inherit; text-decoration: inherit;">Commitment<wbr>Plan<wbr>Name</a>
    ...
    <dd>{{% md %}}The Azure ML commitment plan name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">Etag</a>
    ...
    <dd>{{% md %}}An entity tag used to enforce optimistic concurrency.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceskuresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Machine<wbr>Learning.<wbr>Outputs.<wbr>Resource<wbr>Sku<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The commitment plan SKU.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
