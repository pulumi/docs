...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_express_route_circuit(</span><span class="nx">circuit_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#circuitname_csharp" style="color: inherit; text-decoration: inherit;">Circuit<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of express route circuit.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#allowclassicoperations_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Classic<wbr>Operations</a>
    ...
    <dd>{{% md %}}Allow classic operations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#authorizations_csharp" style="color: inherit; text-decoration: inherit;">Authorizations</a>
    ...
    <dd>{{% md %}}The list of authorizations.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#bandwidthingbps_csharp" style="color: inherit; text-decoration: inherit;">Bandwidth<wbr>In<wbr>Gbps</a>
    ...
    <dd>{{% md %}}The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#circuitprovisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Circuit<wbr>Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The CircuitProvisioningState state of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#expressrouteport_csharp" style="color: inherit; text-decoration: inherit;">Express<wbr>Route<wbr>Port</a>
    ...
    <dd>{{% md %}}The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#globalreachenabled_csharp" style="color: inherit; text-decoration: inherit;">Global<wbr>Reach<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Flag denoting global reach status.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#peerings_csharp" style="color: inherit; text-decoration: inherit;">Peerings</a>
    ...
    <dd>{{% md %}}The list of peerings.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#servicekey_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Key</a>
    ...
    <dd>{{% md %}}The ServiceKey.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceprovidernotes_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Provider<wbr>Notes</a>
    ...
    <dd>{{% md %}}The ServiceProviderNotes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceproviderproperties_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Provider<wbr>Properties</a>
    ...
    <dd>{{% md %}}The ServiceProviderProperties.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#serviceproviderprovisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Provider<wbr>Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The ServiceProviderProvisioningState state of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
