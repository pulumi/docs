...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_azure_firewall(</span><span class="nx">azure_firewall_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetAzureFirewallResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupAzureFirewall<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupAzureFirewallArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupAzureFirewallResult</a></span>, error)</span></code></pre></div>
...
<a href="#azurefirewallname_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Firewall<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Azure Firewall.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#ipgroups_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Groups</a>
    ...
    <dd>{{% md %}}IpGroups associated with AzureFirewall.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the Azure firewall resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#additionalproperties_csharp" style="color: inherit; text-decoration: inherit;">Additional<wbr>Properties</a>
    ...
    <dd>{{% md %}}The additional properties used to further config this azure firewall.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#applicationrulecollections_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Rule<wbr>Collections</a>
    ...
    <dd>{{% md %}}Collection of application rule collections used by Azure Firewall.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#firewallpolicy_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>Policy</a>
    ...
    <dd>{{% md %}}The firewallPolicy associated with this azure firewall.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#hubipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Hub<wbr>IPAddresses</a>
    ...
    <dd>{{% md %}}IP addresses associated with AzureFirewall.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ipconfigurations_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Configurations</a>
    ...
    <dd>{{% md %}}IP configuration of the Azure Firewall resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#managementipconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Management<wbr>Ip<wbr>Configuration</a>
    ...
    <dd>{{% md %}}IP configuration of the Azure Firewall used for management traffic.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#natrulecollections_csharp" style="color: inherit; text-decoration: inherit;">Nat<wbr>Rule<wbr>Collections</a>
    ...
    <dd>{{% md %}}Collection of NAT rule collections used by Azure Firewall.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networkrulecollections_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Rule<wbr>Collections</a>
    ...
    <dd>{{% md %}}Collection of network rule collections used by Azure Firewall.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}The Azure Firewall Resource SKU.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#virtualhub_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Hub</a>
    ...
    <dd>{{% md %}}The virtualHub to which the firewall belongs.{{% /md %}}</dd><dt class="property-"
            title="">
