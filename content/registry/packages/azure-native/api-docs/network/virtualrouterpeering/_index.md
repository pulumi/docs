...
The VirtualRouterPeering resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#virtualroutername_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Router<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Virtual Router.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the virtual router peering that is unique within a virtual router.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#peerip_csharp" style="color: inherit; text-decoration: inherit;">Peer<wbr>Ip</a>
    ...
    <dd>{{% md %}}Peer IP.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#peeringname_csharp" style="color: inherit; text-decoration: inherit;">Peering<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Virtual Router Peering.{{% /md %}}</dd></dl>
{{% /choosable %}}
