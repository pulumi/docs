...
title_tag: "azure-native.network.VirtualNetworkGatewayConnection"
meta_desc: "Documentation for the azure-native.network.VirtualNetworkGatewayConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/azure-native/VirtualNetworkGatewayConnection/"
...
<a href="#connectiontype_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Type</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#virtualnetworkgatewayconnectiontype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}Gateway connection type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#virtualnetworkgateway1_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway1</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkgateway">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Virtual<wbr>Network<wbr>Gateway<wbr>Args</a></span>
    </dt>
...
<a href="#authorizationkey_csharp" style="color: inherit; text-decoration: inherit;">Authorization<wbr>Key</a>
    ...
    <dd>{{% md %}}The authorizationKey.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#connectionmode_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Mode</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#virtualnetworkgatewayconnectionmode">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Mode</a></span>
    </dt>
    <dd>{{% md %}}The connection mode for this connection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dpdtimeoutseconds_csharp" style="color: inherit; text-decoration: inherit;">Dpd<wbr>Timeout<wbr>Seconds</a>
    ...
    <dd>{{% md %}}The dead peer detection timeout of this connection in seconds.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#expressroutegatewaybypass_csharp" style="color: inherit; text-decoration: inherit;">Express<wbr>Route<wbr>Gateway<wbr>Bypass</a>
    ...
    <dd>{{% md %}}Bypass ExpressRoute Gateway for data forwarding.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
...
<a href="#localnetworkgateway2_csharp" style="color: inherit; text-decoration: inherit;">Local<wbr>Network<wbr>Gateway2</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localnetworkgateway">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Inputs.<wbr>Local<wbr>Network<wbr>Gateway<wbr>Args</a></span>
    </dt>
...
<a href="#routingweight_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Weight</a>
    ...
    <dd>{{% md %}}The routing weight.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sharedkey_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Key</a>
    ...
    <dd>{{% md %}}The IPSec shared key.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#uselocalazureipaddress_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Local<wbr>Azure<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}Use private local Azure IP for the connection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#virtualnetworkgateway1_go" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Network<wbr>Gateway1</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkgateway">Virtual<wbr>Network<wbr>Gateway<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The reference to virtual network gateway resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#localnetworkgateway2_go" style="color: inherit; text-decoration: inherit;">Local<wbr>Network<wbr>Gateway2</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#localnetworkgateway">Local<wbr>Network<wbr>Gateway<wbr>Type<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The reference to local network gateway resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="location_go">
...
<a href="#ip_configurations_python" style="color: inherit; text-decoration: inherit;">ip_<wbr>configurations</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualnetworkgatewayipconfiguration">Sequence[Virtual<wbr>Network<wbr>Gateway<wbr>IPConfiguration]</a></span>
    </dt>
    <dd>{{% md %}}IP configurations for virtual network gateway.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="location_python">
...
{{% choosable language go %}}
<dl class="tabular"><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Mode<wbr>Default</dt>
    <dd>Default</dd><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Mode<wbr>Responder<wbr>Only</dt>
    <dd>ResponderOnly</dd><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Mode<wbr>Initiator<wbr>Only</dt>
    <dd>InitiatorOnly</dd></dl>
{{% /choosable %}}
...
<dl class="tabular"><dt>IPsec</dt>
    <dd>IPsec</dd><dt>Vnet2Vnet</dt>
    <dd>Vnet2Vnet</dd><dt>Express<wbr>Route</dt>
    <dd>ExpressRoute</dd><dt>VPNClient</dt>
    <dd>VPNClient</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Type<wbr>IPsec</dt>
    <dd>IPsec</dd><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Type<wbr>Vnet2Vnet</dt>
    <dd>Vnet2Vnet</dd><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Type<wbr>Express<wbr>Route</dt>
    <dd>ExpressRoute</dd><dt>Virtual<wbr>Network<wbr>Gateway<wbr>Connection<wbr>Type<wbr>VPNClient</dt>
    <dd>VPNClient</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>IPSEC</dt>
    <dd>IPsec</dd><dt>VNET2_VNET</dt>
    <dd>Vnet2Vnet</dd><dt>EXPRESS_ROUTE</dt>
    <dd>ExpressRoute</dd><dt>VPN_CLIENT</dt>
    <dd>VPNClient</dd></dl>
{{% /choosable %}}
