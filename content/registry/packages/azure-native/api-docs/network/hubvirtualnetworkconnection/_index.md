...
aliases:
    - "/docs/reference/pkg/azure-native/HubVirtualNetworkConnection/"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewHubVirtualNetworkConnection</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">HubVirtualNetworkConnectionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">HubVirtualNetworkConnection</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The resource group name of the HubVirtualNetworkConnection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#allowhubtoremotevnettransit_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Hub<wbr>To<wbr>Remote<wbr>Vnet<wbr>Transit</a>
    ...
    <dd>{{% md %}}Deprecated: VirtualHub to RemoteVnet transit to enabled or not.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allowremotevnettousehubvnetgateways_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Remote<wbr>Vnet<wbr>To<wbr>Use<wbr>Hub<wbr>Vnet<wbr>Gateways</a>
    ...
    <dd>{{% md %}}Deprecated: Allow RemoteVnet to use Virtual Hub's gateways.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#connectionname_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the HubVirtualNetworkConnection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#remotevirtualnetwork_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Virtual<wbr>Network</a>
    ...
    <dd>{{% md %}}Reference to the remote virtual network.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the hub virtual network connection resource.{{% /md %}}</dd></dl>
{{% /choosable %}}
