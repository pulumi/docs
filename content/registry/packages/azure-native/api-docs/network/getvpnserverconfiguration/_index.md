...
title_tag: "azure-native.network.getVpnServerConfiguration"
meta_desc: "Documentation for the azure-native.network.getVpnServerConfiguration function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">function </span>getVpnServerConfiguration<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetVpnServerConfigurationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetVpnServerConfigurationResult</a></span>></span
><span class="k">
function </span>getVpnServerConfigurationOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetVpnServerConfigurationOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetVpnServerConfigurationResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_vpn_server_configuration<span class="p">(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetVpnServerConfigurationResult</span
><span class="k">
def </span>get_vpn_server_configuration_output<span class="p">(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetVpnServerConfigurationResult]</span
></code></pre></div>
{{% /choosable %}}
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetVpnServerConfiguration </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetVpnServerConfigurationResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetVpnServerConfigurationArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetVpnServerConfigurationResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetVpnServerConfigurationInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The resource group name of the VpnServerConfiguration.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#vpnserverconfigurationname_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Server<wbr>Configuration<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the VpnServerConfiguration being retrieved.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#p2svpngateways_csharp" style="color: inherit; text-decoration: inherit;">P2SVpn<wbr>Gateways</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#p2svpngatewayresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>P2SVpn<wbr>Gateway<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of references to P2SVpnGateways.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the VpnServerConfiguration resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#aadauthenticationparameters_csharp" style="color: inherit; text-decoration: inherit;">Aad<wbr>Authentication<wbr>Parameters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#aadauthenticationparametersresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Aad<wbr>Authentication<wbr>Parameters<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The set of aad vpn authentication parameters.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#radiusclientrootcertificates_csharp" style="color: inherit; text-decoration: inherit;">Radius<wbr>Client<wbr>Root<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpnserverconfigradiusclientrootcertificateresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Vpn<wbr>Server<wbr>Config<wbr>Radius<wbr>Client<wbr>Root<wbr>Certificate<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Radius client root certificate of VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#radiusserveraddress_csharp" style="color: inherit; text-decoration: inherit;">Radius<wbr>Server<wbr>Address</a>
    ...
    <dd>{{% md %}}The radius server address property of the VpnServerConfiguration resource for point to site client connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#radiusserverrootcertificates_csharp" style="color: inherit; text-decoration: inherit;">Radius<wbr>Server<wbr>Root<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpnserverconfigradiusserverrootcertificateresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Vpn<wbr>Server<wbr>Config<wbr>Radius<wbr>Server<wbr>Root<wbr>Certificate<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Radius Server root certificate of VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#radiusserversecret_csharp" style="color: inherit; text-decoration: inherit;">Radius<wbr>Server<wbr>Secret</a>
    ...
    <dd>{{% md %}}The radius secret property of the VpnServerConfiguration resource for point to site client connection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="radiusservers_csharp">
<a href="#radiusservers_csharp" style="color: inherit; text-decoration: inherit;">Radius<wbr>Servers</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#radiusserverresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Radius<wbr>Server<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}Multiple Radius Server configuration for VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#vpnauthenticationtypes_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Authentication<wbr>Types</a>
    ...
    <dd>{{% md %}}VPN authentication types for the VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpnclientipsecpolicies_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Client<wbr>Ipsec<wbr>Policies</a>
    ...
    <dd>{{% md %}}VpnClientIpsecPolicies for VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpnclientrevokedcertificates_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Client<wbr>Revoked<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpnserverconfigvpnclientrevokedcertificateresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Vpn<wbr>Server<wbr>Config<wbr>Vpn<wbr>Client<wbr>Revoked<wbr>Certificate<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}VPN client revoked certificate of VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpnclientrootcertificates_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Client<wbr>Root<wbr>Certificates</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vpnserverconfigvpnclientrootcertificateresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Network.<wbr>Outputs.<wbr>Vpn<wbr>Server<wbr>Config<wbr>Vpn<wbr>Client<wbr>Root<wbr>Certificate<wbr>Response&gt;</a></span>
    </dt>
    <dd>{{% md %}}VPN client root certificate of VpnServerConfiguration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#vpnprotocols_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Protocols</a>
    ...
    <dd>{{% md %}}VPN protocols for the VpnServerConfiguration.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#aadaudience_csharp" style="color: inherit; text-decoration: inherit;">Aad<wbr>Audience</a>
    ...
    <dd>{{% md %}}AAD Vpn authentication parameter AAD audience.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#aadissuer_csharp" style="color: inherit; text-decoration: inherit;">Aad<wbr>Issuer</a>
    ...
    <dd>{{% md %}}AAD Vpn authentication parameter AAD issuer.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#aadtenant_csharp" style="color: inherit; text-decoration: inherit;">Aad<wbr>Tenant</a>
    ...
    <dd>{{% md %}}AAD Vpn authentication parameter AAD tenant.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the P2SConnectionConfiguration resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enableinternetsecurity_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Internet<wbr>Security</a>
    ...
    <dd>{{% md %}}Flag indicating whether the enable internet security flag is turned on for the P2S Connections or not.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the P2S VPN gateway resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
</span>
...
<a href="#customdnsservers_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Dns<wbr>Servers</a>
    ...
    <dd>{{% md %}}List of all customer specified DNS servers IP addresses.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
...
<a href="#isroutingpreferenceinternet_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Routing<wbr>Preference<wbr>Internet</a>
    ...
    <dd>{{% md %}}Enable Routing Preference property for the Public IP Interface of the P2SVpnGateway.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vpngatewayscaleunit_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Gateway<wbr>Scale<wbr>Unit</a>
    ...
    <dd>{{% md %}}The scale unit for this p2s vpn gateway.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#totalegressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Egress<wbr>Bytes<wbr>Transferred</a>
    ...
    <dd>{{% md %}}Total of the Egress Bytes Transferred in this connection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#totalingressbytestransferred_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Ingress<wbr>Bytes<wbr>Transferred</a>
    ...
    <dd>{{% md %}}Total of the Ingress Bytes Transferred in this P2S Vpn connection.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#allocatedipaddresses_csharp" style="color: inherit; text-decoration: inherit;">Allocated<wbr>Ip<wbr>Addresses</a>
    ...
    <dd>{{% md %}}List of allocated ip addresses to the connected p2s vpn clients.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vpnclientconnectionscount_csharp" style="color: inherit; text-decoration: inherit;">Vpn<wbr>Client<wbr>Connections<wbr>Count</a>
    ...
    <dd>{{% md %}}The total of p2s vpn clients connected at this time to this P2SVpnGateway.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The certificate name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publiccertdata_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Cert<wbr>Data</a>
    ...
    <dd>{{% md %}}The certificate public data.{{% /md %}}</dd></dl>
{{% /choosable %}}
