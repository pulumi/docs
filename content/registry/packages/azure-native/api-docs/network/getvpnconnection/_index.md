...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_vpn_connection(</span><span class="nx">connection_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                       ...
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetVpnConnectionResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupVpnConnection<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupVpnConnectionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupVpnConnectionResult</a></span>, error)</span></code></pre></div>
...
<a href="#connectionname_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the vpn connection.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the VPN connection resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#connectionbandwidth_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Bandwidth</a>
    ...
    <dd>{{% md %}}Expected bandwidth in MBPS.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dpdtimeoutseconds_csharp" style="color: inherit; text-decoration: inherit;">Dpd<wbr>Timeout<wbr>Seconds</a>
    ...
    <dd>{{% md %}}DPD timeout in seconds for vpn connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enableinternetsecurity_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Internet<wbr>Security</a>
    ...
    <dd>{{% md %}}Enable internet security.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#remotevpnsite_csharp" style="color: inherit; text-decoration: inherit;">Remote<wbr>Vpn<wbr>Site</a>
    ...
    <dd>{{% md %}}Id of the connected vpn site.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#routingconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Configuration</a>
    ...
    <dd>{{% md %}}The Routing Configuration indicating the associated and propagated route tables on this connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#routingweight_csharp" style="color: inherit; text-decoration: inherit;">Routing<wbr>Weight</a>
    ...
    <dd>{{% md %}}Routing weight for vpn connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sharedkey_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Key</a>
    ...
    <dd>{{% md %}}SharedKey for the vpn connection.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#uselocalazureipaddress_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Local<wbr>Azure<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}Use local azure ip to initiate connection.{{% /md %}}</dd><dt class="property-"
            title="">
