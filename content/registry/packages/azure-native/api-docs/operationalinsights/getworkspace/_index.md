...
<a href="#etag_csharp" style="color: inherit; text-decoration: inherit;">ETag</a>
    ...
    <dd>{{% md %}}The ETag of the workspace.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#features_csharp" style="color: inherit; text-decoration: inherit;">Features</a>
    ...
    <dd>{{% md %}}Workspace features.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#forcecmkforquery_csharp" style="color: inherit; text-decoration: inherit;">Force<wbr>Cmk<wbr>For<wbr>Query</a>
    ...
    <dd>{{% md %}}Indicates whether customer managed storage is mandatory for query management.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the workspace.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publicnetworkaccessforingestion_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access<wbr>For<wbr>Ingestion</a>
    ...
    <dd>{{% md %}}The network access type for accessing Log Analytics ingestion.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publicnetworkaccessforquery_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access<wbr>For<wbr>Query</a>
    ...
    <dd>{{% md %}}The network access type for accessing Log Analytics query.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#retentionindays_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>In<wbr>Days</a>
    ...
    <dd>{{% md %}}The workspace data retention in days. Allowed values are per pricing plan. See pricing tiers documentation for details.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
...
<a href="#workspacecapping_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Capping</a>
    ...
    <dd>{{% md %}}The daily volume cap for ingestion.{{% /md %}}</dd></dl>
{{% /choosable %}}
