...
><span class="k">function </span>getWebAppHostNameBindingSlot<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWebAppHostNameBindingSlotArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetWebAppHostNameBindingSlotResult</a></span>></span
><span class="k">
function </span>getWebAppHostNameBindingSlotOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWebAppHostNameBindingSlotOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetWebAppHostNameBindingSlotResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_web_app_host_name_binding_slot<span class="p">(</span><span class="nx">host_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                       ...
                                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetWebAppHostNameBindingSlotResult</span
><span class="k">
def </span>get_web_app_host_name_binding_slot_output<span class="p">(</span><span class="nx">host_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                       ...
                                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetWebAppHostNameBindingSlotResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>LookupWebAppHostNameBindingSlot<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupWebAppHostNameBindingSlotArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupWebAppHostNameBindingSlotResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWebAppHostNameBindingSlot </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetWebAppHostNameBindingSlotResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetWebAppHostNameBindingSlotArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetWebAppHostNameBindingSlotResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetWebAppHostNameBindingSlotInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>{{% md %}}Hostname in the hostname binding.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
...
<a href="#slot_csharp" style="color: inherit; text-decoration: inherit;">Slot</a>
    ...
    <dd>{{% md %}}Name of the deployment slot. If a slot is not specified, the API the named binding for the production slot.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#virtualip_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>IP</a>
    ...
    <dd>{{% md %}}Virtual IP address assigned to the hostname if IP based SSL is enabled.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#customhostnamednsrecordtype_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Host<wbr>Name<wbr>Dns<wbr>Record<wbr>Type</a>
    ...
    <dd>{{% md %}}Custom DNS record type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#domainid_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Id</a>
    ...
    <dd>{{% md %}}Fully qualified ARM domain resource URI.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#hostnametype_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name<wbr>Type</a>
    ...
    <dd>{{% md %}}Hostname type.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="kind_csharp">
...
<a href="#sitename_csharp" style="color: inherit; text-decoration: inherit;">Site<wbr>Name</a>
    ...
    <dd>{{% md %}}App Service app name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sslstate_csharp" style="color: inherit; text-decoration: inherit;">Ssl<wbr>State</a>
    ...
    <dd>{{% md %}}SSL type{{% /md %}}</dd><dt class="property-"
            title="">
