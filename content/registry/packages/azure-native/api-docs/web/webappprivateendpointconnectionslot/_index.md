...
## Create a WebAppPrivateEndpointConnectionSlot Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The WebAppPrivateEndpointConnectionSlot resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
