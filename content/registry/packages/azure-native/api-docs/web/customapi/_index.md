...
The CustomApi resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#apiname_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Name</a>
    ...
    <dd>{{% md %}}API name{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="etag_csharp">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#customapipropertiesdefinition">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Custom<wbr>Api<wbr>Properties<wbr>Definition<wbr>Args</a></span>
    </dt>
...
<a href="#clientid_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Id</a>
    ...
    <dd>{{% md %}}Resource provider client id{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clientsecret_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Secret</a>
    ...
    <dd>{{% md %}}Client Secret needed for OAuth{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#identityprovider_csharp" style="color: inherit; text-decoration: inherit;">Identity<wbr>Provider</a>
    ...
    <dd>{{% md %}}Identity provider{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="properties_csharp">
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
</span>
    ...
    <dd>{{% md %}}Read only properties for this oauth setting.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#options_csharp" style="color: inherit; text-decoration: inherit;">Options</a>
    ...
    <dd>{{% md %}}Options available to this parameter{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#uidefinition_csharp" style="color: inherit; text-decoration: inherit;">Ui<wbr>Definition</a>
    ...
    <dd>{{% md %}}UI definitions per culture as caller can specify the culture{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}Value of the setting{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ui_definition_python" style="color: inherit; text-decoration: inherit;">ui_<wbr>definition</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Any</span>
    </dt>
...
<h4 id="connectionparametertype">Connection<wbr>Parameter<wbr>Type</h4>
...
<a href="#capabilities_csharp" style="color: inherit; text-decoration: inherit;">Capabilities</a>
    ...
    <dd>{{% md %}}The custom API capabilities{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#runtimeurls_csharp" style="color: inherit; text-decoration: inherit;">Runtime<wbr>Urls</a>
    ...
    <dd>{{% md %}}Runtime URLs{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
