...
aliases:
    - "/docs/reference/pkg/azure-native/KubeEnvironment/"
...
## Create a KubeEnvironment Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The KubeEnvironment resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#applogsconfiguration_csharp" style="color: inherit; text-decoration: inherit;">App<wbr>Logs<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#applogsconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>App<wbr>Logs<wbr>Configuration<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cluster configuration which enables the log daemon to export
app logs to a destination. Currently only "log-analytics" is
supported{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#arcconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Arc<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#arcconfiguration">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Arc<wbr>Configuration<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Cluster configuration which determines the ARC cluster
components types. Eg: Choosing between BuildService kind,
FrontEnd Service ArtifactsStorageType etc.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="extendedlocation_csharp">
<a href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#extendedlocation">Pulumi.<wbr>Azure<wbr>Native.<wbr>Web.<wbr>Inputs.<wbr>Extended<wbr>Location<wbr>Args</a></span>
    </dt>
...
<a href="#internalloadbalancerenabled_csharp" style="color: inherit; text-decoration: inherit;">Internal<wbr>Load<wbr>Balancer<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Only visible within Vnet/Subnet{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="kind_csharp">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the Kubernetes Environment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#staticip_csharp" style="color: inherit; text-decoration: inherit;">Static<wbr>Ip</a>
    ...
    <dd>{{% md %}}Static IP of the KubeEnvironment{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<h4 id="applogsconfiguration">App<wbr>Logs<wbr>Configuration</h4>
...
<h4 id="arcconfiguration">Arc<wbr>Configuration</h4>
...
<h4 id="frontendconfiguration">Front<wbr>End<wbr>Configuration</h4>
...
<h4 id="frontendservicetype">Front<wbr>End<wbr>Service<wbr>Type</h4>
...
<h4 id="loganalyticsconfiguration">Log<wbr>Analytics<wbr>Configuration</h4>
