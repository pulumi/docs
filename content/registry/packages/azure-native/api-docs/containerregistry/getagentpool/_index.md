...
<a href="#count_csharp" style="color: inherit; text-decoration: inherit;">Count</a>
    ...
    <dd>{{% md %}}The count of agent machine{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="os_csharp">
<a href="#os_csharp" style="color: inherit; text-decoration: inherit;">Os</a>
    ...
    <dd>{{% md %}}The OS of agent machine{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
...
<a href="#tier_csharp" style="color: inherit; text-decoration: inherit;">Tier</a>
    ...
    <dd>{{% md %}}The Tier of agent machine{{% /md %}}</dd><dt class="property-"
            title="">
