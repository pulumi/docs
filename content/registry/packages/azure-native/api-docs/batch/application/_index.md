...
---
title: "Application"
title_tag: "azure-native.batch.Application"
meta_desc: "Documentation for the azure-native.batch.Application resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/azure-native/Application/"
...
<a href="#allowupdates_csharp" style="color: inherit; text-decoration: inherit;">Allow<wbr>Updates</a>
    ...
    <dd>{{% md %}}A value indicating whether packages within the application may be overwritten using the same version string.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#applicationname_csharp" style="color: inherit; text-decoration: inherit;">Application<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the application. This must be unique within the account.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#defaultversion_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Version</a>
    ...
    <dd>{{% md %}}The package to use if a client requests the application but does not specify a version. This property can only be set to the name of an existing package.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
