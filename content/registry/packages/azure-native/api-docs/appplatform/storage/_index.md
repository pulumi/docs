...
## Create a Storage Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The Storage resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#storageaccount">Pulumi.<wbr>Azure<wbr>Native.<wbr>App<wbr>Platform.<wbr>Inputs.<wbr>Storage<wbr>Account<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Properties of the storage resource payload.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#accountkey_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Key</a>
    ...
    <dd>{{% md %}}The account key of the Azure Storage Account.{{% /md %}}</dd><dt class="property-required"
            title="Required">
