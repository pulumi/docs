...
---
title: "Project"
title_tag: "azure-native.machinelearningexperimentation.Project"
meta_desc: "Documentation for the azure-native.machinelearningexperimentation.Project resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Project</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">gitrepo</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}The friendly name for this project.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#workspacename_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the machine learning team account workspace.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of this project.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gitrepo_csharp" style="color: inherit; text-decoration: inherit;">Gitrepo</a>
    ...
    <dd>{{% md %}}The reference to git repo for this project.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#projectname_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the machine learning project under a team account workspace.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#workspaceid_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of the workspace which contains this project.{{% /md %}}</dd></dl>
{{% /choosable %}}
