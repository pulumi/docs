...
---
title: "getProject"
title_tag: "azure-native.machinelearningexperimentation.getProject"
meta_desc: "Documentation for the azure-native.machinelearningexperimentation.getProject function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_project<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_project_output<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#projectname_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the machine learning project under a team account workspace.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#workspacename_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the machine learning team account workspace.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#accountid_csharp" style="color: inherit; text-decoration: inherit;">Account<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of the team account which contains this project.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#creationdate_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Date</a>
    ...
    <dd>{{% md %}}The creation date of the project in ISO8601 format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}The friendly name for this project.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of this project.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The current deployment state of project resource. The provisioningState is to indicate states for resource provisioning.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#workspaceid_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of the workspace which contains this project.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of this project.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#gitrepo_csharp" style="color: inherit; text-decoration: inherit;">Gitrepo</a>
    ...
    <dd>{{% md %}}The reference to git repo for this project.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
