...
---
title: "Workspace"
title_tag: "azure-native.machinelearningexperimentation.Workspace"
meta_desc: "Documentation for the azure-native.machinelearningexperimentation.Workspace resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<a href="#friendlyname_csharp" style="color: inherit; text-decoration: inherit;">Friendly<wbr>Name</a>
    ...
    <dd>{{% md %}}The friendly name for this workspace. This will be the workspace name in the arm id when the workspace object gets created{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group to which the machine learning team account belongs.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#workspaceid_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Id</a>
    ...
    <dd>{{% md %}}The immutable id of this workspace.{{% /md %}}</dd></dl>
{{% /choosable %}}
