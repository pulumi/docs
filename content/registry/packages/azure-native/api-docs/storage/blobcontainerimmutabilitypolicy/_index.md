...
aliases:
    - "/docs/reference/pkg/azure-native/BlobContainerImmutabilityPolicy/"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewBlobContainerImmutabilityPolicy</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">BlobContainerImmutabilityPolicyArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">BlobContainerImmutabilityPolicy</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#immutabilityperiodsincecreationindays_csharp" style="color: inherit; text-decoration: inherit;">Immutability<wbr>Period<wbr>Since<wbr>Creation<wbr>In<wbr>Days</a>
    ...
    <dd>{{% md %}}The immutability period for the blobs in the container since the policy creation, in days.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#immutabilitypolicyname_csharp" style="color: inherit; text-decoration: inherit;">Immutability<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the blob container immutabilityPolicy within the specified storage account. ImmutabilityPolicy Name must be 'default'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The ImmutabilityPolicy state of a blob container, possible values include: Locked and Unlocked.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
