...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_integration_account_schema(</span><span class="nx">integration_account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                   ...
                                   <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIntegrationAccountSchemaResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIntegrationAccountSchema<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIntegrationAccountSchemaArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIntegrationAccountSchemaResult</a></span>, error)</span></code></pre></div>
...
<a href="#schemaname_csharp" style="color: inherit; text-decoration: inherit;">Schema<wbr>Name</a>
    ...
    <dd>{{% md %}}The integration account schema name.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#schematype_csharp" style="color: inherit; text-decoration: inherit;">Schema<wbr>Type</a>
    ...
    <dd>{{% md %}}The schema type.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#content_csharp" style="color: inherit; text-decoration: inherit;">Content</a>
    ...
    <dd>{{% md %}}The content.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#contenttype_csharp" style="color: inherit; text-decoration: inherit;">Content<wbr>Type</a>
    ...
    <dd>{{% md %}}The content type.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#documentname_csharp" style="color: inherit; text-decoration: inherit;">Document<wbr>Name</a>
    ...
    <dd>{{% md %}}The document name.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#filename_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Name</a>
    ...
    <dd>{{% md %}}The file name.{{% /md %}}</dd><dt class="property-"
            title="">
