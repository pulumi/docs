...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_multiple_activation_key(</span><span class="nx">multiple_activation_key_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetMultipleActivationKeyResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupMultipleActivationKey<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupMultipleActivationKeyArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupMultipleActivationKeyResult</a></span>, error)</span></code></pre></div>
...
<a href="#multipleactivationkeyname_csharp" style="color: inherit; text-decoration: inherit;">Multiple<wbr>Activation<wbr>Key<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the MAK key.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#agreementnumber_csharp" style="color: inherit; text-decoration: inherit;">Agreement<wbr>Number</a>
    ...
    <dd>{{% md %}}Agreement number under which the key is requested.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#installedservernumber_csharp" style="color: inherit; text-decoration: inherit;">Installed<wbr>Server<wbr>Number</a>
    ...
    <dd>{{% md %}}Number of activations/servers using the MAK key.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#iseligible_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Eligible</a>
    ...
    <dd>{{% md %}}<code> true </code> if user has eligible on-premises Windows physical or virtual machines, and that the requested key will only be used in their organization; <code> false </code> otherwise.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of OS for which the key is requested.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#supporttype_csharp" style="color: inherit; text-decoration: inherit;">Support<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of support{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
