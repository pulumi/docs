...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_vendor(</span><span class="nx">vendor_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupVendor<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupVendorArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupVendorResult</a></span>, error)</span></code></pre></div>
...
<a href="#vendorname_csharp" style="color: inherit; text-decoration: inherit;">Vendor<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the vendor.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the vendor resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="skus_csharp">
<a href="#skus_csharp" style="color: inherit; text-decoration: inherit;">Skus</a>
    ...
    <dd>{{% md %}}A list of IDs of the vendor skus offered by the vendor.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
