...
class MyStack : Stack
{
    public MyStack()
    {
        var bot = new AzureNative.HealthBot.Bot("bot", new AzureNative.HealthBot.BotArgs
        {
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Health<wbr>Bot.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}SKU of the HealthBot.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
