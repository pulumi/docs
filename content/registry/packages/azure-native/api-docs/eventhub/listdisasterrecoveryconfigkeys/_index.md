...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>list_disaster_recovery_config_keys(</span><span class="nx">alias</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                       ...
                                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> ListDisasterRecoveryConfigKeysResult</code></pre></div>
{{% /choosable %}}
...
<a href="#aliasprimaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Alias<wbr>Primary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Primary connection string of the alias if GEO DR is enabled{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#aliassecondaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Alias<wbr>Secondary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Secondary  connection string of the alias if GEO DR is enabled{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#keyname_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Name</a>
    ...
    <dd>{{% md %}}A string that describes the AuthorizationRule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#primaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Primary connection string of the created namespace AuthorizationRule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#secondaryconnectionstring_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Connection<wbr>String</a>
    ...
    <dd>{{% md %}}Secondary connection string of the created namespace AuthorizationRule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#secondarykey_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Key</a>
    ...
    <dd>{{% md %}}A base64-encoded 256-bit primary key for signing and validating the SAS token.{{% /md %}}</dd></dl>
{{% /choosable %}}
