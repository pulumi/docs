...
title_tag: "azure-native.powerbi.getPrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.powerbi.getPrivateEndpointConnection function with examples, input properties, output properties, and supporting types."
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_private_endpoint_connection(</span><span class="nx">azure_resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#azureresourcename_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Azure resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Specifies the id of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>BI.<wbr>Outputs.<wbr>Private<wbr>Endpoint<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the private endpoint.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="privatelinkserviceconnectionstate_csharp">
<a href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#connectionstateresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Power<wbr>BI.<wbr>Outputs.<wbr>Connection<wbr>State<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Specifies the connection state.{{% /md %}}</dd><dt class="property-"
            title="">
