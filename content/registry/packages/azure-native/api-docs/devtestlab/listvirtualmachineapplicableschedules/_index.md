...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the virtual machine.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#labvmsshutdown_csharp" style="color: inherit; text-decoration: inherit;">Lab<wbr>Vms<wbr>Shutdown</a>
    ...
    <dd>{{% md %}}The auto-shutdown schedule, if one has been set at the lab or lab resource level.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labvmsstartup_csharp" style="color: inherit; text-decoration: inherit;">Lab<wbr>Vms<wbr>Startup</a>
    ...
    <dd>{{% md %}}The auto-startup schedule, if one has been set at the lab or lab resource level.{{% /md %}}</dd><dt class="property-"
            title="">
