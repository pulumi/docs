...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($expand=externalSubnets)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#allowedsubnets_csharp" style="color: inherit; text-decoration: inherit;">Allowed<wbr>Subnets</a>
    ...
    <dd>{{% md %}}The allowed subnets of the virtual network.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the virtual network.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#externalproviderresourceid_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Provider<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The Microsoft.Network resource identifier of the virtual network.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#subnetoverrides_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Overrides</a>
    ...
    <dd>{{% md %}}The subnet overrides of the virtual network.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
