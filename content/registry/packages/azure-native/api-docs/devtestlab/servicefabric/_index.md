...
aliases:
    - "/docs/reference/pkg/azure-native/ServiceFabric/"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewServiceFabric</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ServiceFabricArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ServiceFabric</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The ServiceFabric resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#environmentid_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource id of the environment under which the service fabric resource is present{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#externalservicefabricid_csharp" style="color: inherit; text-decoration: inherit;">External<wbr>Service<wbr>Fabric<wbr>Id</a>
    ...
    <dd>{{% md %}}The backing service fabric resource's id{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the service fabric.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
