...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_disk(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the disk.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($select=diskType)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#createddate_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>Date</a>
    ...
    <dd>{{% md %}}The creation date of the disk.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#diskblobname_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Blob<wbr>Name</a>
    ...
    <dd>{{% md %}}When backed by a blob, the name of the VHD blob without extension.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disksizegib_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Size<wbr>Gi<wbr>B</a>
    ...
    <dd>{{% md %}}The size of the disk in Gibibytes.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#disktype_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Type</a>
    ...
    <dd>{{% md %}}The storage type for the disk (i.e. Standard, Premium).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#diskuri_csharp" style="color: inherit; text-decoration: inherit;">Disk<wbr>Uri</a>
    ...
    <dd>{{% md %}}When backed by a blob, the URI of underlying blob.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#hostcaching_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Caching</a>
    ...
    <dd>{{% md %}}The host caching policy of the disk (i.e. None, ReadOnly, ReadWrite).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#leasedbylabvmid_csharp" style="color: inherit; text-decoration: inherit;">Leased<wbr>By<wbr>Lab<wbr>Vm<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource ID of the VM to which this disk is leased.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#manageddiskid_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Disk<wbr>Id</a>
    ...
    <dd>{{% md %}}When backed by managed disk, this is the ID of the compute disk resource.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#storageaccountid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Id</a>
    ...
    <dd>{{% md %}}When backed by a blob, the storage account where the blob is.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
