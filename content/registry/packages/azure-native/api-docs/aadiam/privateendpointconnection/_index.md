...
title_tag: "azure-native.aadiam.PrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.aadiam.PrivateEndpointConnection resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">PrivateEndpointConnection</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                              ...
                              <span class="nx">private_link_connection_tags</span><span class="p">:</span> <span class="nx">Optional[TagsResourceArgs]</span> = None<span class="p">,</span>
...
<a href="#privateendpoint_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpoint">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aad<wbr>Iam.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Args</a></span>
    </dt>
...
<a href="#privateendpointconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The PrivateEndpointConnection name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="privatelinkconnectiontags_csharp">
<a href="#privatelinkconnectiontags_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Connection<wbr>Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagsresource">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aad<wbr>Iam.<wbr>Inputs.<wbr>Tags<wbr>Resource<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Updated tag information to set into the PrivateLinkConnection instance.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="privatelinkserviceconnectionstate_csharp">
<a href="#privatelinkserviceconnectionstate_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privatelinkserviceconnectionstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aad<wbr>Iam.<wbr>Inputs.<wbr>Private<wbr>Link<wbr>Service<wbr>Connection<wbr>State<wbr>Args</a></span>
    </dt>
...
<a href="#privateendpointconnectionname_go" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The PrivateEndpointConnection name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="privatelinkconnectiontags_go">
<a href="#privatelinkconnectiontags_go" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Connection<wbr>Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagsresource">Tags<wbr>Resource<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Updated tag information to set into the PrivateLinkConnection instance.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privateendpointconnectionname_nodejs" style="color: inherit; text-decoration: inherit;">private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The PrivateEndpointConnection name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="privatelinkconnectiontags_nodejs">
<a href="#privatelinkconnectiontags_nodejs" style="color: inherit; text-decoration: inherit;">private<wbr>Link<wbr>Connection<wbr>Tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagsresource">Tags<wbr>Resource<wbr>Args</a></span>
    </dt>
...
<a href="#private_endpoint_connection_name_python" style="color: inherit; text-decoration: inherit;">private_<wbr>endpoint_<wbr>connection_<wbr>name</a>
    ...
    <dd>{{% md %}}The PrivateEndpointConnection name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="private_link_connection_tags_python">
<a href="#private_link_connection_tags_python" style="color: inherit; text-decoration: inherit;">private_<wbr>link_<wbr>connection_<wbr>tags</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#tagsresource">Tags<wbr>Resource<wbr>Args</a></span>
    </dt>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status<wbr>Approved</dt>
    <dd>Approved</dd><dt>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status<wbr>Pending</dt>
    <dd>Pending</dd><dt>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status<wbr>Rejected</dt>
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#privateendpointserviceconnectionstatus">Pulumi.<wbr>Azure<wbr>Native.<wbr>Aad<wbr>Iam.<wbr>Private<wbr>Endpoint<wbr>Service<wbr>Connection<wbr>Status</a></span>
    </dt>
...
<h4 id="tagsresource">Tags<wbr>Resource</h4>
