...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewOrderItemByName</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">OrderItemByNameArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">OrderItemByName</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#addressdetails_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Details</a>
    ...
    <dd>{{% md %}}Represents shipping and return address for order item{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#orderid_csharp" style="color: inherit; text-decoration: inherit;">Order<wbr>Id</a>
    ...
    <dd>{{% md %}}Id of the order to which order item belongs to{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<h4 id="managementresourcepreferences">Management<wbr>Resource<wbr>Preferences</h4>
...
<dl class="tabular"><dt>Shipped</dt>
    <dd>Shipped{{% md %}}Notification at order item shipped from microsoft datacenter.{{% /md %}}</dd><dt>Delivered</dt>
    <dd>Delivered{{% md %}}Notification at order item delivered to customer.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Notification<wbr>Stage<wbr>Name<wbr>Shipped</dt>
    <dd>Shipped{{% md %}}Notification at order item shipped from microsoft datacenter.{{% /md %}}</dd><dt>Notification<wbr>Stage<wbr>Name<wbr>Delivered</dt>
    <dd>Delivered{{% md %}}Notification at order item delivered to customer.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#hierarchyinformation_csharp" style="color: inherit; text-decoration: inherit;">Hierarchy<wbr>Information</a>
    ...
    <dd>{{% md %}}Hierarchy of the product which uniquely identifies the product{{% /md %}}</dd></dl>
{{% /choosable %}}
