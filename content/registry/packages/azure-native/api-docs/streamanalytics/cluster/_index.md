...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustersku">Pulumi.<wbr>Azure<wbr>Native.<wbr>Stream<wbr>Analytics.<wbr>Inputs.<wbr>Cluster<wbr>Sku<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The SKU of the cluster. This determines the size/capacity of the cluster. Required on PUT (CreateOrUpdate) requests.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<dl class="tabular"><dt>Default</dt>
    <dd>Default{{% md %}}The default SKU.{{% /md %}}</dd></dl>
{{% /choosable %}}
