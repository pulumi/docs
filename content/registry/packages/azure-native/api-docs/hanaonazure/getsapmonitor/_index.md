...
---
title: "getSapMonitor"
title_tag: "azure-native.hanaonazure.getSapMonitor"
meta_desc: "Documentation for the azure-native.hanaonazure.getSapMonitor function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">function </span>getSapMonitor<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetSapMonitorArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetSapMonitorResult</a></span>></span
><span class="k">
function </span>getSapMonitorOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetSapMonitorOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetSapMonitorResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_sap_monitor<span class="p">(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">sap_monitor_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetSapMonitorResult</span
><span class="k">
def </span>get_sap_monitor_output<span class="p">(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                    ...
                    <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetSapMonitorResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>LookupSapMonitor<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupSapMonitorArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupSapMonitorResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetSapMonitor </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetSapMonitorResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetSapMonitorArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetSapMonitorResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetSapMonitorInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#enablecustomeranalytics_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Customer<wbr>Analytics</a>
    ...
    <dd>{{% md %}}The value indicating whether to send analytics to Microsoft{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loganalyticsworkspacearmid_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Analytics<wbr>Workspace<wbr>Arm<wbr>Id</a>
    ...
    <dd>{{% md %}}The ARM ID of the Log Analytics Workspace that is used for monitoring{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loganalyticsworkspaceid_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Analytics<wbr>Workspace<wbr>Id</a>
    ...
    <dd>{{% md %}}The workspace ID of the log analytics workspace to be used for monitoring{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loganalyticsworkspacesharedkey_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Analytics<wbr>Workspace<wbr>Shared<wbr>Key</a>
    ...
    <dd>{{% md %}}The shared key of the log analytics workspace that is used for monitoring{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#monitorsubnet_csharp" style="color: inherit; text-decoration: inherit;">Monitor<wbr>Subnet</a>
    ...
    <dd>{{% md %}}The subnet which the SAP monitor will be deployed in{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
