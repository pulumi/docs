...
><span class="k">def </span>get_pipeline<span class="p">(</span><span class="nx">pipeline_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_pipeline_output<span class="p">(</span><span class="nx">pipeline_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#pipelinename_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the Pipeline resource in ARM.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#bootstrapconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Bootstrap<wbr>Configuration</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#bootstrapconfigurationresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Dev<wbr>Ops.<wbr>Outputs.<wbr>Bootstrap<wbr>Configuration<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Configuration used to bootstrap the Pipeline.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#pipelinetype_csharp" style="color: inherit; text-decoration: inherit;">Pipeline<wbr>Type</a>
    ...
    <dd>{{% md %}}Specifies which CI/CD provider to use. Valid options are 'azurePipeline', 'githubWorkflow'.{{% /md %}}</dd><dt class="property-"
            title="">
