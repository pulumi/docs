...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_rule(</span><span class="nx">namespace_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#rulename_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Name</a>
    ...
    <dd>{{% md %}}The rule name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd>{{% md %}}Represents the filter actions which are allowed for the transformation of a message that have been matched by a filter expression.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#correlationfilter_csharp" style="color: inherit; text-decoration: inherit;">Correlation<wbr>Filter</a>
    ...
    <dd>{{% md %}}Properties of correlationFilter{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#filtertype_csharp" style="color: inherit; text-decoration: inherit;">Filter<wbr>Type</a>
    ...
    <dd>{{% md %}}Filter type that is evaluated against a BrokeredMessage.{{% /md %}}</dd><dt class="property-"
            title="">
