...
aliases:
    - "/docs/reference/pkg/azure-native/PrivateEndpointConnectionByName/"
...
## Create a PrivateEndpointConnectionByName Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<span class="k">def </span><span class="nx">PrivateEndpointConnectionByName</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                                    ...
                                    <span class="nx">properties</span><span class="p">:</span> <span class="nx">Optional[PrivateEndpointConnectionRequestPropertiesArgs]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewPrivateEndpointConnectionByName</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">PrivateEndpointConnectionByNameArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">PrivateEndpointConnectionByName</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The PrivateEndpointConnectionByName resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Private Endpoint Connection Resource Id.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointconnectionrequestproperties">Pulumi.<wbr>Azure<wbr>Native.<wbr>Api<wbr>Management.<wbr>Inputs.<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Request<wbr>Properties<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}The connection state of the private endpoint connection.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="privateendpointconnectionrequestproperties">Private<wbr>Endpoint<wbr>Connection<wbr>Request<wbr>Properties</h4>
