...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_image(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#imagename_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the image.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#extendedlocation_csharp" style="color: inherit; text-decoration: inherit;">Extended<wbr>Location</a>
    ...
    <dd>{{% md %}}The extended location of the Image.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sourcevirtualmachine_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Virtual<wbr>Machine</a>
    ...
    <dd>{{% md %}}The source virtual machine from which Image is created.{{% /md %}}</dd><dt class="property-"
            title="">
