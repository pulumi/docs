...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_dedicated_host_group(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}The expand expression to apply on the operation. The response shows the list of instance view of the dedicated hosts under the dedicated host group.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#hosts_csharp" style="color: inherit; text-decoration: inherit;">Hosts</a>
    ...
    <dd>{{% md %}}A list of references to all dedicated hosts in the dedicated host group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#instanceview_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>View</a>
    ...
    <dd>{{% md %}}The dedicated host group instance view, which has the list of instance view of the dedicated hosts under the dedicated host group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#platformfaultdomaincount_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Fault<wbr>Domain<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of fault domains that the host group can span.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#zones_csharp" style="color: inherit; text-decoration: inherit;">Zones</a>
    ...
    <dd>{{% md %}}Availability Zone to use for this host group. Only single zone is supported. The zone can be assigned only during creation. If not provided, the group supports all zones in the region. If provided, enforces each host in the group to be in the same zone.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#assetid_csharp" style="color: inherit; text-decoration: inherit;">Asset<wbr>Id</a>
    ...
    <dd>{{% md %}}Specifies the unique id of the dedicated physical machine on which the dedicated host resides.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
    ...
    <dd>{{% md %}}The name of the dedicated host.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
