...
---
title: "Environment"
title_tag: "azure-native.labservices.Environment"
...
<span class="k">def </span><span class="nx">Environment</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                ...
                <span class="nx">environment_setting_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                ...
                <span class="nx">resource_sets</span><span class="p">:</span> <span class="nx">Optional[ResourceSetArgs]</span> = None<span class="p">,</span>
...
<a href="#environmentname_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the environment.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcesets_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Sets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceset">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Inputs.<wbr>Resource<wbr>Set<wbr>Args</a></span>
    </dt>
