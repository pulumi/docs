...
title_tag: "azure-native.labservices.getEnvironmentSetting"
meta_desc: "Documentation for the azure-native.labservices.getEnvironmentSetting function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">function </span>getEnvironmentSetting<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetEnvironmentSettingArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetEnvironmentSettingResult</a></span>></span
><span class="k">
function </span>getEnvironmentSettingOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetEnvironmentSettingOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetEnvironmentSettingResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_environment_setting<span class="p">(</span><span class="nx">environment_setting_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                            ...
                            <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetEnvironmentSettingResult</span
><span class="k">
def </span>get_environment_setting_output<span class="p">(</span><span class="nx">environment_setting_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                            <span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                            <span class="nx">lab_account_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                            ...
                            <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetEnvironmentSettingResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>LookupEnvironmentSetting<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupEnvironmentSettingArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupEnvironmentSettingResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEnvironmentSetting </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetEnvironmentSettingResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetEnvironmentSettingArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetEnvironmentSettingResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetEnvironmentSettingInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($select=publishingState)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lastchanged_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Changed</a>
    ...
    <dd>{{% md %}}Time when the template VM was last changed.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#lastpublished_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Published</a>
    ...
    <dd>{{% md %}}Time when the template VM was last sent for publishing.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#publishingstate_csharp" style="color: inherit; text-decoration: inherit;">Publishing<wbr>State</a>
    ...
    <dd>{{% md %}}Describes the readiness of this environment setting{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#resourcesettings_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcesettingsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Outputs.<wbr>Resource<wbr>Settings<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The resource specific settings{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#configurationstate_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>State</a>
    ...
    <dd>{{% md %}}Describes the user's progress in configuring their environment setting{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Describes the environment and its resource settings{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#title_csharp" style="color: inherit; text-decoration: inherit;">Title</a>
    ...
    <dd>{{% md %}}Brief title describing the environment and its resource settings{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}The username of the virtual machine{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#vmresourceid_csharp" style="color: inherit; text-decoration: inherit;">Vm<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}VM resource Id for the environment{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#password_csharp" style="color: inherit; text-decoration: inherit;">Password</a>
    ...
    <dd>{{% md %}}The password of the virtual machine. This will be set to null in GET resource API{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cores_csharp" style="color: inherit; text-decoration: inherit;">Cores</a>
    ...
    <dd>{{% md %}}The translated compute cores of the virtual machine{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
</span>
    ...
    <dd>{{% md %}}The unique id of the resource setting{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#imagename_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the image used to created the environment setting{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#galleryimageresourceid_csharp" style="color: inherit; text-decoration: inherit;">Gallery<wbr>Image<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource id of the gallery image used for creating the virtual machine{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="size_csharp">
...
<a href="#powerstate_csharp" style="color: inherit; text-decoration: inherit;">Power<wbr>State</a>
    ...
    <dd>{{% md %}}The power state of the reference virtual machine.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#rdpauthority_csharp" style="color: inherit; text-decoration: inherit;">Rdp<wbr>Authority</a>
    ...
    <dd>{{% md %}}The RdpAuthority property is a server DNS host name or IP address followed by the service port number for RDP (Remote Desktop Protocol).{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sshauthority_csharp" style="color: inherit; text-decoration: inherit;">Ssh<wbr>Authority</a>
    ...
    <dd>{{% md %}}The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.{{% /md %}}</dd></dl>
{{% /choosable %}}
