...
title_tag: "azure-native.labservices.getGalleryImage"
meta_desc: "Documentation for the azure-native.labservices.getGalleryImage function with examples, input properties, output properties, and supporting types."
layout: api
...
><span class="k">def </span>get_gallery_image<span class="p">(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_gallery_image_output<span class="p">(</span><span class="nx">expand</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#galleryimagename_csharp" style="color: inherit; text-decoration: inherit;">Gallery<wbr>Image<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the gallery Image.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($select=author)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#isenabled_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Indicates whether this gallery image is enabled.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#isoverride_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Override</a>
    ...
    <dd>{{% md %}}Indicates whether this gallery has been overridden for this lab account{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#isplanauthorized_csharp" style="color: inherit; text-decoration: inherit;">Is<wbr>Plan<wbr>Authorized</a>
    ...
    <dd>{{% md %}}Indicates if the plan has been authorized for programmatic deployment.{{% /md %}}</dd><dt class="property-"
            title="">
