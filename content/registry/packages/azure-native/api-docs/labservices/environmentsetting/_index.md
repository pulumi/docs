...
title_tag: "azure-native.labservices.EnvironmentSetting"
meta_desc: "Documentation for the azure-native.labservices.EnvironmentSetting resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/azure-native/EnvironmentSetting/"
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">EnvironmentSetting</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EnvironmentSettingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">EnvironmentSetting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
                       <span class="nx">configuration_state</span><span class="p">:</span> <span class="nx">Optional[Union[str, ConfigurationState]]</span> = None<span class="p">,</span>
                       ...
                       <span class="nx">resource_settings</span><span class="p">:</span> <span class="nx">Optional[ResourceSettingsArgs]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">EnvironmentSetting</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                       <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">EnvironmentSettingArgs</a></span><span class="p">,</span>
                       <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewEnvironmentSetting</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">EnvironmentSettingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">EnvironmentSetting</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">EnvironmentSetting</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">EnvironmentSettingArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">EnvironmentSettingArgs</a></span>
    </dt>
...
The EnvironmentSetting resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#resourcesettings_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Settings</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcesettings">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Inputs.<wbr>Resource<wbr>Settings<wbr>Args</a></span>
    </dt>
...
<a href="#configurationstate_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#configurationstate">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Configuration<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}Describes the user's progress in configuring their environment setting{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Describes the environment and its resource settings{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#environmentsettingname_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Setting<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the environment Setting.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#title_csharp" style="color: inherit; text-decoration: inherit;">Title</a>
    ...
    <dd>{{% md %}}Brief title describing the environment and its resource settings{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#configurationstate_go" style="color: inherit; text-decoration: inherit;">Configuration<wbr>State</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#configurationstate">Configuration<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}Describes the user's progress in configuring their environment setting{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#configuration_state_python" style="color: inherit; text-decoration: inherit;">configuration_<wbr>state</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#configurationstate">Configuration<wbr>State</a></span>
    </dt>
    <dd>{{% md %}}Describes the user's progress in configuring their environment setting{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="configurationstate">Configuration<wbr>State</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Not<wbr>Applicable</dt>
    <dd>NotApplicable{{% md %}}User either hasn't started configuring their template
or they haven't started the configuration process.{{% /md %}}</dd><dt>Completed</dt>
    <dd>Completed{{% md %}}User is finished modifying the template.{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Configuration<wbr>State<wbr>Not<wbr>Applicable</dt>
    <dd>NotApplicable{{% md %}}User either hasn't started configuring their template
or they haven't started the configuration process.{{% /md %}}</dd><dt>Configuration<wbr>State<wbr>Completed</dt>
    <dd>Completed{{% md %}}User is finished modifying the template.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<h4 id="managedlabvmsize">Managed<wbr>Lab<wbr>Vm<wbr>Size</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>Basic</dt>
    <dd>Basic{{% md %}}The base VM size{{% /md %}}</dd><dt>Standard</dt>
    <dd>Standard{{% md %}}The standard or default VM size{{% /md %}}</dd><dt>Performance</dt>
    <dd>Performance{{% md %}}The most performant VM size{{% /md %}}</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Managed<wbr>Lab<wbr>Vm<wbr>Size<wbr>Basic</dt>
    <dd>Basic{{% md %}}The base VM size{{% /md %}}</dd><dt>Managed<wbr>Lab<wbr>Vm<wbr>Size<wbr>Standard</dt>
    <dd>Standard{{% md %}}The standard or default VM size{{% /md %}}</dd><dt>Managed<wbr>Lab<wbr>Vm<wbr>Size<wbr>Performance</dt>
    <dd>Performance{{% md %}}The most performant VM size{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}The username of the virtual machine{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#managedlabvmsize">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Managed<wbr>Lab<wbr>Vm<wbr>Size</a></span>
    </dt>
...
<a href="#size_go" style="color: inherit; text-decoration: inherit;">Size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#managedlabvmsize">Managed<wbr>Lab<wbr>Vm<wbr>Size</a></span>
    </dt>
    <dd>{{% md %}}The size of the virtual machine{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#size_python" style="color: inherit; text-decoration: inherit;">size</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#managedlabvmsize">Managed<wbr>Lab<wbr>Vm<wbr>Size</a></span>
    </dt>
    <dd>{{% md %}}The size of the virtual machine{{% /md %}}</dd></dl>
{{% /choosable %}}
