...
---
title: "getGlobalUserEnvironment"
title_tag: "azure-native.labservices.getGlobalUserEnvironment"
meta_desc: "Documentation for the azure-native.labservices.getGlobalUserEnvironment function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getGlobalUserEnvironment {#using}
...
><span class="k">function </span>getGlobalUserEnvironment<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetGlobalUserEnvironmentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetGlobalUserEnvironmentResult</a></span>></span
><span class="k">
function </span>getGlobalUserEnvironmentOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetGlobalUserEnvironmentOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetGlobalUserEnvironmentResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_global_user_environment<span class="p">(</span><span class="nx">environment_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                ...
                                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetGlobalUserEnvironmentResult</span
><span class="k">
def </span>get_global_user_environment_output<span class="p">(</span><span class="nx">environment_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                ...
                                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetGlobalUserEnvironmentResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>GetGlobalUserEnvironment<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetGlobalUserEnvironmentArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetGlobalUserEnvironmentResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetGlobalUserEnvironment </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetGlobalUserEnvironmentResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetGlobalUserEnvironmentArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetGlobalUserEnvironmentResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetGlobalUserEnvironmentInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#environmentid_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>Id</a>
    ...
    <dd>{{% md %}}The resourceId of the environment{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expand_csharp" style="color: inherit; text-decoration: inherit;">Expand</a>
    ...
    <dd>{{% md %}}Specify the $expand query. Example: 'properties($expand=environment)'{{% /md %}}</dd></dl>
{{% /choosable %}}
...
## getGlobalUserEnvironment Result {#result}
...
<a href="#environment_csharp" style="color: inherit; text-decoration: inherit;">Environment</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#environmentdetailsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Outputs.<wbr>Environment<wbr>Details<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Details of the environment{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description of the Environment{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#environmentstate_csharp" style="color: inherit; text-decoration: inherit;">Environment<wbr>State</a>
    ...
    <dd>{{% md %}}Publishing state of the environment setting Possible values are Creating, Created, Failed{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Resource Id of the environment{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#latestoperationresult_csharp" style="color: inherit; text-decoration: inherit;">Latest<wbr>Operation<wbr>Result</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#latestoperationresultresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Inputs.<wbr>Latest<wbr>Operation<wbr>Result<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The details of the latest operation. ex: status, error{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the Environment{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#passwordlastreset_csharp" style="color: inherit; text-decoration: inherit;">Password<wbr>Last<wbr>Reset</a>
    ...
    <dd>{{% md %}}When the password was last reset on the environment.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}The provisioning state of the environment. This also includes LabIsFull and NotYetProvisioned status.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#totalusage_csharp" style="color: inherit; text-decoration: inherit;">Total<wbr>Usage</a>
    ...
    <dd>{{% md %}}How long the environment has been used by a lab user{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#virtualmachinedetails_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Machine<wbr>Details</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#virtualmachinedetailsresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Lab<wbr>Services.<wbr>Inputs.<wbr>Virtual<wbr>Machine<wbr>Details<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Details of backing DTL virtual machine with compute and network details.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#lastknownpowerstate_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Known<wbr>Power<wbr>State</a>
    ...
    <dd>{{% md %}}Last known compute power state captured in DTL{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}Provisioning state of the Dtl VM{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}Compute VM login user name{{% /md %}}</dd></dl>
{{% /choosable %}}
