...
title_tag: "azure-native.cognitiveservices.getPrivateEndpointConnection"
meta_desc: "Documentation for the azure-native.cognitiveservices.getPrivateEndpointConnection function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#privateendpointconnectionname_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the private endpoint connection associated with the Cognitive Services Account{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#properties_csharp" style="color: inherit; text-decoration: inherit;">Properties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#privateendpointconnectionpropertiesresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Cognitive<wbr>Services.<wbr>Outputs.<wbr>Private<wbr>Endpoint<wbr>Connection<wbr>Properties<wbr>Response</a></span>
    </dt>
...
<a href="#location_csharp" style="color: inherit; text-decoration: inherit;">Location</a>
    ...
    <dd>{{% md %}}The location of the private endpoint connection{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#groupids_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Ids</a>
    ...
    <dd>{{% md %}}The private link resource group ids.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
