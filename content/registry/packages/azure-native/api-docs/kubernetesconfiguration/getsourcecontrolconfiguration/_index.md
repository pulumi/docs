...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getSourceControlConfiguration<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetSourceControlConfigurationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetSourceControlConfigurationResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_source_control_configuration(</span><span class="nx">cluster_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                     ...
                                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetSourceControlConfigurationResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupSourceControlConfiguration<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupSourceControlConfigurationArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupSourceControlConfigurationResult</a></span>, error)</span></code></pre></div>
...
<a href="#sourcecontrolconfigurationname_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Control<wbr>Configuration<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the Source Control Configuration.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#configurationprotectedsettings_csharp" style="color: inherit; text-decoration: inherit;">Configuration<wbr>Protected<wbr>Settings</a>
    ...
    <dd>{{% md %}}Name-value pairs of protected configuration settings for the configuration{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enablehelmoperator_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Helm<wbr>Operator</a>
    ...
    <dd>{{% md %}}Option to enable Helm Operator for this git configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#helmoperatorproperties_csharp" style="color: inherit; text-decoration: inherit;">Helm<wbr>Operator<wbr>Properties</a>
    ...
    <dd>{{% md %}}Properties for Helm operator.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#operatorinstancename_csharp" style="color: inherit; text-decoration: inherit;">Operator<wbr>Instance<wbr>Name</a>
    ...
    <dd>{{% md %}}Instance name of the operator - identifying the specific configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#operatornamespace_csharp" style="color: inherit; text-decoration: inherit;">Operator<wbr>Namespace</a>
    ...
    <dd>{{% md %}}The namespace to which this operator is installed to. Maximum of 253 lower case alphanumeric characters, hyphen and period only.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#operatorparams_csharp" style="color: inherit; text-decoration: inherit;">Operator<wbr>Params</a>
    ...
    <dd>{{% md %}}Any Parameters for the Operator instance in string format.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#operatortype_csharp" style="color: inherit; text-decoration: inherit;">Operator<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of the operator{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#repositoryurl_csharp" style="color: inherit; text-decoration: inherit;">Repository<wbr>Url</a>
    ...
    <dd>{{% md %}}Url of the SourceControl Repository.{{% /md %}}</dd><dt class="property-"
            title="">
