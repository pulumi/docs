...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_share(</span><span class="nx">device_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The share name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#accessprotocol_csharp" style="color: inherit; text-decoration: inherit;">Access<wbr>Protocol</a>
    ...
    <dd>{{% md %}}Access protocol to be used by the share.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#monitoringstatus_csharp" style="color: inherit; text-decoration: inherit;">Monitoring<wbr>Status</a>
    ...
    <dd>{{% md %}}Current monitoring status of the share.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
</span>
...
<a href="#sharestatus_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Status</a>
    ...
    <dd>{{% md %}}Current status of the share.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#azurecontainerinfo_csharp" style="color: inherit; text-decoration: inherit;">Azure<wbr>Container<wbr>Info</a>
    ...
    <dd>{{% md %}}Azure container mapping for the share.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clientaccessrights_csharp" style="color: inherit; text-decoration: inherit;">Client<wbr>Access<wbr>Rights</a>
    ...
    <dd>{{% md %}}List of IP addresses and corresponding access rights on the share(required for NFS protocol).{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#datapolicy_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Policy</a>
    ...
    <dd>{{% md %}}Data policy of the share.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description for the share.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#refreshdetails_csharp" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Details</a>
    ...
    <dd>{{% md %}}Details of the refresh job on this share.{{% /md %}}</dd><dt class="property-"
            title="">
