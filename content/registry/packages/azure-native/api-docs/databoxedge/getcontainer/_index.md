...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_container(</span><span class="nx">container_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                  ...
                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetContainerResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupContainer<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupContainerArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupContainerResult</a></span>, error)</span></code></pre></div>
...
<a href="#containername_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Name</a>
    ...
    <dd>{{% md %}}The container Name{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#containerstatus_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Status</a>
    ...
    <dd>{{% md %}}Current status of the container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#createddatetime_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>Date<wbr>Time</a>
    ...
    <dd>{{% md %}}The UTC time when container got created.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dataformat_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Format</a>
    ...
    <dd>{{% md %}}DataFormat for Container{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#refreshdetails_csharp" style="color: inherit; text-decoration: inherit;">Refresh<wbr>Details</a>
    ...
    <dd>{{% md %}}Details of the refresh job on this container.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
    ...
    <dd>{{% md %}}Container in DataBoxEdge Resource{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
