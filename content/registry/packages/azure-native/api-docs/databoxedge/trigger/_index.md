...
---
title: "Trigger"
title_tag: "azure-native.databoxedge.Trigger"
meta_desc: "Documentation for the azure-native.databoxedge.Trigger resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<p class="resource-deprecated">Deprecated: {{% md %}}Please use one of the variants: FileEventTrigger, PeriodicTimerEventTrigger.{{% /md %}}</p>
...
<span class="k">def </span><span class="nx">Trigger</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">kind</span><span class="p">:</span> <span class="nx">Optional[Union[str, TriggerEventType]]</span> = None<span class="p">,</span>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#triggereventtype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Box<wbr>Edge.<wbr>Trigger<wbr>Event<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}Trigger Kind.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>File<wbr>Event</dt>
    <dd>FileEvent</dd><dt>Periodic<wbr>Timer<wbr>Event</dt>
    <dd>PeriodicTimerEvent</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Trigger<wbr>Event<wbr>Type<wbr>File<wbr>Event</dt>
    <dd>FileEvent</dd><dt>Trigger<wbr>Event<wbr>Type<wbr>Periodic<wbr>Timer<wbr>Event</dt>
    <dd>PeriodicTimerEvent</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>FILE_EVENT</dt>
    <dd>FileEvent</dd><dt>PERIODIC_TIMER_EVENT</dt>
    <dd>PeriodicTimerEvent</dd></dl>
{{% /choosable %}}
## Import
