...
aliases:
    - "/docs/reference/pkg/azure-native/StorageAccount/"
layout: api
---
...
<span class="k">def </span><span class="nx">StorageAccount</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">storage_account_status</span><span class="p">:</span> <span class="nx">Optional[Union[str, StorageAccountStatus]]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewStorageAccount</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">StorageAccountArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">StorageAccount</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#datapolicy_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Policy</a>
    ...
    <dd>{{% md %}}Data policy of the storage Account.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}Description for the storage Account.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storageaccountcredentialid_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Credential<wbr>Id</a>
    ...
    <dd>{{% md %}}Storage Account Credential Id{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#storageaccountname_csharp" style="color: inherit; text-decoration: inherit;">Storage<wbr>Account<wbr>Name</a>
    ...
    <dd>{{% md %}}The StorageAccount name.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="storageaccountstatus">Storage<wbr>Account<wbr>Status</h4>
