...
---
title: "Addon"
title_tag: "azure-native.databoxedge.Addon"
meta_desc: "Documentation for the azure-native.databoxedge.Addon resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
<span class="k">def </span><span class="nx">Addon</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
          ...
          <span class="nx">kind</span><span class="p">:</span> <span class="nx">Optional[Union[str, AddonType]]</span> = None<span class="p">,</span>
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#addontype">Pulumi.<wbr>Azure<wbr>Native.<wbr>Data<wbr>Box<wbr>Edge.<wbr>Addon<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}Addon type.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
{{% choosable language csharp %}}
<dl class="tabular"><dt>Iot<wbr>Edge</dt>
    <dd>IotEdge</dd><dt>Arc<wbr>For<wbr>Kubernetes</dt>
    <dd>ArcForKubernetes</dd></dl>
{{% /choosable %}}

{{% choosable language go %}}
<dl class="tabular"><dt>Addon<wbr>Type<wbr>Iot<wbr>Edge</dt>
    <dd>IotEdge</dd><dt>Addon<wbr>Type<wbr>Arc<wbr>For<wbr>Kubernetes</dt>
    <dd>ArcForKubernetes</dd></dl>
{{% /choosable %}}
...
{{% choosable language python %}}
<dl class="tabular"><dt>IOT_EDGE</dt>
    <dd>IotEdge</dd><dt>ARC_FOR_KUBERNETES</dt>
    <dd>ArcForKubernetes</dd></dl>
{{% /choosable %}}
