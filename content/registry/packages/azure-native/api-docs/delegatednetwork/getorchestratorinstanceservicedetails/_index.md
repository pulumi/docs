...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getOrchestratorInstanceServiceDetails<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetOrchestratorInstanceServiceDetailsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetOrchestratorInstanceServiceDetailsResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_orchestrator_instance_service_details(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                              <span class="nx">resource_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                              <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetOrchestratorInstanceServiceDetailsResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupOrchestratorInstanceServiceDetails<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupOrchestratorInstanceServiceDetailsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupOrchestratorInstanceServiceDetailsResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetOrchestratorInstanceServiceDetails </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetOrchestratorInstanceServiceDetailsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetOrchestratorInstanceServiceDetailsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#apiserverendpoint_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Server<wbr>Endpoint</a>
    ...
    <dd>{{% md %}}K8s APIServer url. Either one of apiServerEndpoint or privateLinkResourceId can be specified{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clusterrootca_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Root<wbr>CA</a>
    ...
    <dd>{{% md %}}RootCA certificate of kubernetes cluster base64 encoded{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}The identity of the orchestrator{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#orchestratorappid_csharp" style="color: inherit; text-decoration: inherit;">Orchestrator<wbr>App<wbr>Id</a>
    ...
    <dd>{{% md %}}AAD ID used with apiserver{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#orchestratortenantid_csharp" style="color: inherit; text-decoration: inherit;">Orchestrator<wbr>Tenant<wbr>Id</a>
    ...
    <dd>{{% md %}}TenantID of server App ID{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privatelinkresourceid_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}private link arm resource id. Either one of apiServerEndpoint or privateLinkResourceId can be specified{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
