...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Target resource group.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}Resource ID of the Cache.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#cachesizegb_csharp" style="color: inherit; text-decoration: inherit;">Cache<wbr>Size<wbr>GB</a>
    ...
    <dd>{{% md %}}The size of this Cache, in GB.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#directoryservicessettings_csharp" style="color: inherit; text-decoration: inherit;">Directory<wbr>Services<wbr>Settings</a>
    ...
    <dd>{{% md %}}Specifies Directory Services settings of the cache.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionsettings_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Settings</a>
    ...
    <dd>{{% md %}}Specifies encryption settings of the cache.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}The identity of the cache, if configured.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networksettings_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Settings</a>
    ...
    <dd>{{% md %}}Specifies network settings of the cache.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#provisioningstate_csharp" style="color: inherit; text-decoration: inherit;">Provisioning<wbr>State</a>
    ...
    <dd>{{% md %}}ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#securitysettings_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Settings</a>
    ...
    <dd>{{% md %}}Specifies security settings of the cache.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}SKU for the Cache.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#subnet_csharp" style="color: inherit; text-decoration: inherit;">Subnet</a>
    ...
    <dd>{{% md %}}Subnet used for the Cache.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
