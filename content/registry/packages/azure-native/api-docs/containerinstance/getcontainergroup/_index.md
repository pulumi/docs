...
<a href="#containergroupname_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the container group.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#containers_csharp" style="color: inherit; text-decoration: inherit;">Containers</a>
    ...
    <dd>{{% md %}}The containers within the container group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#ostype_csharp" style="color: inherit; text-decoration: inherit;">Os<wbr>Type</a>
    ...
    <dd>{{% md %}}The operating system type required by the containers in the container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#diagnostics_csharp" style="color: inherit; text-decoration: inherit;">Diagnostics</a>
    ...
    <dd>{{% md %}}The diagnostic information for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dnsconfig_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Config</a>
    ...
    <dd>{{% md %}}The DNS config information for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#encryptionproperties_csharp" style="color: inherit; text-decoration: inherit;">Encryption<wbr>Properties</a>
    ...
    <dd>{{% md %}}The encryption properties for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}The identity of the container group, if configured.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#imageregistrycredentials_csharp" style="color: inherit; text-decoration: inherit;">Image<wbr>Registry<wbr>Credentials</a>
    ...
    <dd>{{% md %}}The image registry credentials by which the container group is created from.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#initcontainers_csharp" style="color: inherit; text-decoration: inherit;">Init<wbr>Containers</a>
    ...
    <dd>{{% md %}}The init containers for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ipaddress_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}The IP address type of the container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networkprofile_csharp" style="color: inherit; text-decoration: inherit;">Network<wbr>Profile</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containergroupnetworkprofileresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Container<wbr>Instance.<wbr>Outputs.<wbr>Container<wbr>Group<wbr>Network<wbr>Profile<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}The network profile information for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}The SKU for a container group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
