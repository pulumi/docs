...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_app(</span><span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The ARM resource name of the IoT Central application.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The ARM resource identifier.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
    ...
    <dd>{{% md %}}A valid instance SKU.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the application.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#subdomain_csharp" style="color: inherit; text-decoration: inherit;">Subdomain</a>
    ...
    <dd>{{% md %}}The subdomain of the application.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
