...
aliases:
    - "/docs/reference/pkg/azure-native/App/"
layout: api
---
...
<a href="#resourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the resource group that contains the IoT Central application.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="sku_csharp">
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#appskuinfo">Pulumi.<wbr>Azure<wbr>Native.<wbr>Io<wbr>TCentral.<wbr>Inputs.<wbr>App<wbr>Sku<wbr>Info<wbr>Args</a></span>
    </dt>
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the application.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#resourcename_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Name</a>
    ...
    <dd>{{% md %}}The ARM resource name of the IoT Central application.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subdomain_csharp" style="color: inherit; text-decoration: inherit;">Subdomain</a>
    ...
    <dd>{{% md %}}The subdomain of the application.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#template_csharp" style="color: inherit; text-decoration: inherit;">Template</a>
    ...
    <dd>{{% md %}}The ID of the application template, which is a blueprint that defines the characteristics and behaviors of an application. Optional; if not specified, defaults to a blank blueprint and allows the application to be defined from scratch.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The ARM resource name.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<h4 id="appsku">App<wbr>Sku</h4>

{{% choosable language csharp %}}
<dl class="tabular"><dt>F1</dt>
    <dd>F1</dd><dt>S1</dt>
    <dd>S1</dd><dt>ST0</dt>
    <dd>ST0</dd><dt>ST1</dt>
    <dd>ST1</dd><dt>ST2</dt>
...
{{% choosable language go %}}
<dl class="tabular"><dt>App<wbr>Sku<wbr>F1</dt>
    <dd>F1</dd><dt>App<wbr>Sku<wbr>S1</dt>
    <dd>S1</dd><dt>App<wbr>Sku<wbr>ST0</dt>
