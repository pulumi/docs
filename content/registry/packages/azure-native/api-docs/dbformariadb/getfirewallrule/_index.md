...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_firewall_rule(</span><span class="nx">firewall_rule_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#firewallrulename_csharp" style="color: inherit; text-decoration: inherit;">Firewall<wbr>Rule<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the server firewall rule.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#endipaddress_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}The end IP address of the server firewall rule. Must be IPv4 format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#startipaddress_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Ip<wbr>Address</a>
    ...
    <dd>{{% md %}}The start IP address of the server firewall rule. Must be IPv4 format.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
