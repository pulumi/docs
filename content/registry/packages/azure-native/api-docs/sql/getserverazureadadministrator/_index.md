...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_server_azure_ad_administrator(</span><span class="nx">administrator_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                      ...
                                      <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetServerAzureADAdministratorResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupServerAzureADAdministrator<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupServerAzureADAdministratorArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupServerAzureADAdministratorResult</a></span>, error)</span></code></pre></div>
...
<a href="#administratorname_csharp" style="color: inherit; text-decoration: inherit;">Administrator<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of server active directory administrator.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#administratortype_csharp" style="color: inherit; text-decoration: inherit;">Administrator<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of the sever administrator.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#login_csharp" style="color: inherit; text-decoration: inherit;">Login</a>
    ...
    <dd>{{% md %}}Login name of the server administrator.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#sid_csharp" style="color: inherit; text-decoration: inherit;">Sid</a>
    ...
    <dd>{{% md %}}SID (object ID) of the server administrator.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
