...
aliases:
    - "/docs/reference/pkg/azure-native/Server/"
layout: api
---
...
<span class="k">def </span><span class="nx">Server</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
           ...
           <span class="nx">public_network_access</span><span class="p">:</span> <span class="nx">Optional[Union[str, ServerPublicNetworkAccess]]</span> = None<span class="p">,</span>
...
<a href="#administratorlogin_csharp" style="color: inherit; text-decoration: inherit;">Administrator<wbr>Login</a>
    ...
    <dd>{{% md %}}Administrator username for the server. Once created it cannot be changed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#administratorloginpassword_csharp" style="color: inherit; text-decoration: inherit;">Administrator<wbr>Login<wbr>Password</a>
    ...
    <dd>{{% md %}}The administrator login password (required for server creation).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="administrators_csharp">
<a href="#administrators_csharp" style="color: inherit; text-decoration: inherit;">Administrators</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serverexternaladministrator">Pulumi.<wbr>Azure<wbr>Native.<wbr>Sql.<wbr>Inputs.<wbr>Server<wbr>External<wbr>Administrator<wbr>Args</a></span>
    </dt>
...
<a href="#minimaltlsversion_csharp" style="color: inherit; text-decoration: inherit;">Minimal<wbr>Tls<wbr>Version</a>
    ...
    <dd>{{% md %}}Minimal TLS version. Allowed values: '1.0', '1.1', '1.2'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#publicnetworkaccess_csharp" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#serverpublicnetworkaccess">Pulumi.<wbr>Azure<wbr>Native.<wbr>Sql.<wbr>Server<wbr>Public<wbr>Network<wbr>Access</a></span>
    </dt>
    <dd>{{% md %}}Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}The version of the server.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#publicnetworkaccess_go" style="color: inherit; text-decoration: inherit;">Public<wbr>Network<wbr>Access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">string | <a href="#serverpublicnetworkaccess">Server<wbr>Public<wbr>Network<wbr>Access</a></span>
    </dt>
    <dd>{{% md %}}Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#public_network_access_python" style="color: inherit; text-decoration: inherit;">public_<wbr>network_<wbr>access</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">str | <a href="#serverpublicnetworkaccess">Server<wbr>Public<wbr>Network<wbr>Access</a></span>
    </dt>
    <dd>{{% md %}}Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#fullyqualifieddomainname_csharp" style="color: inherit; text-decoration: inherit;">Fully<wbr>Qualified<wbr>Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}The fully qualified domain name of the server.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd>{{% md %}}Kind of sql server. This is metadata used for the Azure portal experience.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#privateendpointconnections_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Endpoint<wbr>Connections</a>
    ...
    <dd>{{% md %}}List of private endpoint connections on a server{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The state of the server.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#workspacefeature_csharp" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Feature</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Whether or not existing server has a workspace created and if it allows connection from workspace{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#workspacefeature_go" style="color: inherit; text-decoration: inherit;">Workspace<wbr>Feature</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#workspacefeature_nodejs" style="color: inherit; text-decoration: inherit;">workspace<wbr>Feature</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#workspace_feature_python" style="color: inherit; text-decoration: inherit;">workspace_<wbr>feature</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<h4 id="serverexternaladministrator">Server<wbr>External<wbr>Administrator</h4>
...
<h4 id="serverpublicnetworkaccess">Server<wbr>Public<wbr>Network<wbr>Access</h4>
...
{{% choosable language go %}}
<dl class="tabular"><dt>Server<wbr>Public<wbr>Network<wbr>Access<wbr>Enabled</dt>
    <dd>Enabled</dd><dt>Server<wbr>Public<wbr>Network<wbr>Access<wbr>Disabled</dt>
    <dd>Disabled</dd></dl>
{{% /choosable %}}
