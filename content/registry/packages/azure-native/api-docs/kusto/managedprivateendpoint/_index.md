...
<a href="#groupid_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Id</a>
    ...
    <dd>{{% md %}}The groupId in which the managed private endpoint is created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#privatelinkresourceid_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The ARM resource ID of the resource for which the managed private endpoint is created.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#managedprivateendpointname_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Private<wbr>Endpoint<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the managed private endpoint.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#privatelinkresourceregion_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Link<wbr>Resource<wbr>Region</a>
    ...
    <dd>{{% md %}}The region of the resource to which the managed private endpoint is created.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
