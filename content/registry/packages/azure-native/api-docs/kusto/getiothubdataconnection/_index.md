...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_iot_hub_data_connection(</span><span class="nx">cluster_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                ...
                                <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetIotHubDataConnectionResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupIotHubDataConnection<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupIotHubDataConnectionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupIotHubDataConnectionResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetIotHubDataConnection </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetIotHubDataConnectionResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetIotHubDataConnectionArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#consumergroup_csharp" style="color: inherit; text-decoration: inherit;">Consumer<wbr>Group</a>
    ...
    <dd>{{% md %}}The iot hub consumer group.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#iothubresourceid_csharp" style="color: inherit; text-decoration: inherit;">Iot<wbr>Hub<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}The resource ID of the Iot hub to be used to create a data connection.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="name_csharp">
...
<a href="#sharedaccesspolicyname_csharp" style="color: inherit; text-decoration: inherit;">Shared<wbr>Access<wbr>Policy<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the share access policy{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#eventsystemproperties_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>System<wbr>Properties</a>
    ...
    <dd>{{% md %}}System properties of the iot hub{{% /md %}}</dd><dt class="property-"
            title="">
