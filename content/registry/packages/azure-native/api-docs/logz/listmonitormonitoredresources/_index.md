...
## Using listMonitorMonitoredResources {#using}
...
><span class="k">function </span>listMonitorMonitoredResources<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">ListMonitorMonitoredResourcesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">ListMonitorMonitoredResourcesResult</a></span>></span
><span class="k">
function </span>listMonitorMonitoredResourcesOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">ListMonitorMonitoredResourcesOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">ListMonitorMonitoredResourcesResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>list_monitor_monitored_resources<span class="p">(</span><span class="nx">monitor_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                     <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>ListMonitorMonitoredResourcesResult</span
><span class="k">
def </span>list_monitor_monitored_resources_output<span class="p">(</span><span class="nx">monitor_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                     <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[ListMonitorMonitoredResourcesResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>ListMonitorMonitoredResources<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">ListMonitorMonitoredResourcesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">ListMonitorMonitoredResourcesResult</a></span>, error)</span
></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">ListMonitorMonitoredResources </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">ListMonitorMonitoredResourcesResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">ListMonitorMonitoredResourcesArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">ListMonitorMonitoredResourcesResult</a></span>> <span class="p">Invoke(</span><span class="nx">ListMonitorMonitoredResourcesInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## listMonitorMonitoredResources Result {#result}
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#monitoredresourceresponse">List&lt;Pulumi.<wbr>Azure<wbr>Native.<wbr>Logz.<wbr>Outputs.<wbr>Monitored<wbr>Resource<wbr>Response&gt;</a></span>
    </dt>
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}The ARM id of the resource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reasonforlogsstatus_csharp" style="color: inherit; text-decoration: inherit;">Reason<wbr>For<wbr>Logs<wbr>Status</a>
    ...
    <dd>{{% md %}}Reason for why the resource is sending logs (or why it is not sending).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#reasonformetricsstatus_csharp" style="color: inherit; text-decoration: inherit;">Reason<wbr>For<wbr>Metrics<wbr>Status</a>
    ...
    <dd>{{% md %}}Reason for why the resource is sending metrics (or why it is not sending).{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sendinglogs_csharp" style="color: inherit; text-decoration: inherit;">Sending<wbr>Logs</a>
    ...
    <dd>{{% md %}}Flag indicating if resource is sending logs to Logz.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sendingmetrics_csharp" style="color: inherit; text-decoration: inherit;">Sending<wbr>Metrics</a>
    ...
    <dd>{{% md %}}Flag indicating if resource is sending metrics to Logz.{{% /md %}}</dd></dl>
{{% /choosable %}}
