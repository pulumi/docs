...
aliases:
    - "/docs/reference/pkg/azure-native/Backup/"
layout: api
---
...
<a href="#backupname_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the backup{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#label_csharp" style="color: inherit; text-decoration: inherit;">Label</a>
    ...
    <dd>{{% md %}}Label for backup{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
