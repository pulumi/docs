...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_backup_schedule(</span><span class="nx">backup_policy_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                        ...
                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetBackupScheduleResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupBackupSchedule<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupBackupScheduleArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupBackupScheduleResult</a></span>, error)</span></code></pre></div>
...
<a href="#backupschedulename_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Schedule<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the backup schedule to be fetched{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#backuptype_csharp" style="color: inherit; text-decoration: inherit;">Backup<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of backup which needs to be taken.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#retentioncount_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of backups to be retained.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schedulerecurrence_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Recurrence</a>
    ...
    <dd>{{% md %}}The schedule recurrence.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#schedulestatus_csharp" style="color: inherit; text-decoration: inherit;">Schedule<wbr>Status</a>
    ...
    <dd>{{% md %}}The schedule status.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#starttime_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The start time of the schedule.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
