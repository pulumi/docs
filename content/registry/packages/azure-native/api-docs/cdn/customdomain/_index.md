...
aliases:
    - "/docs/reference/pkg/azure-native/CustomDomain/"
...
<a href="#hostname_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Name</a>
    ...
    <dd>{{% md %}}The host name of the custom domain. Must be a domain name.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#customdomainname_csharp" style="color: inherit; text-decoration: inherit;">Custom<wbr>Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the custom domain within an endpoint.{{% /md %}}</dd></dl>
{{% /choosable %}}
