...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getWorkloadNetworkDnsService<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetWorkloadNetworkDnsServiceArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetWorkloadNetworkDnsServiceResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_workload_network_dns_service(</span><span class="nx">dns_service_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                     ...
                                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetWorkloadNetworkDnsServiceResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupWorkloadNetworkDnsService<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupWorkloadNetworkDnsServiceArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupWorkloadNetworkDnsServiceResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetWorkloadNetworkDnsService </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetWorkloadNetworkDnsServiceResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetWorkloadNetworkDnsServiceArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#dnsserviceid_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Service<wbr>Id</a>
    ...
    <dd>{{% md %}}NSX DNS Service identifier. Generally the same as the DNS Service's display name{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#defaultdnszone_csharp" style="color: inherit; text-decoration: inherit;">Default<wbr>Dns<wbr>Zone</a>
    ...
    <dd>{{% md %}}Default DNS zone of the DNS Service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}Display name of the DNS Service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#dnsserviceip_csharp" style="color: inherit; text-decoration: inherit;">Dns<wbr>Service<wbr>Ip</a>
    ...
    <dd>{{% md %}}DNS service IP of the DNS Service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#fqdnzones_csharp" style="color: inherit; text-decoration: inherit;">Fqdn<wbr>Zones</a>
    ...
    <dd>{{% md %}}FQDN zones of the DNS Service.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#loglevel_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Level</a>
    ...
    <dd>{{% md %}}DNS Service log level.{{% /md %}}</dd><dt class="property-"
            title="">
