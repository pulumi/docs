...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewAction</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ActionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">Action</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The Action resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#logicappresourceid_csharp" style="color: inherit; text-decoration: inherit;">Logic<wbr>App<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}Logic App Resource Id, /subscriptions/{my-subscription}/resourceGroups/{my-resource-group}/providers/Microsoft.Logic/workflows/{my-workflow-id}.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#triggeruri_csharp" style="color: inherit; text-decoration: inherit;">Trigger<wbr>Uri</a>
    ...
    <dd>{{% md %}}Logic App Callback URL for this specific workflow.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#actionid_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>Id</a>
    ...
    <dd>{{% md %}}Action ID{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="etag_csharp">
