...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getBookmark<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetBookmarkArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetBookmarkResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_bookmark(</span><span class="nx">bookmark_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 <span class="nx">resource_group_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 <span class="nx">workspace_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetBookmarkResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>LookupBookmark<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupBookmarkArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupBookmarkResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetBookmark </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetBookmarkResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetBookmarkArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#bookmarkid_csharp" style="color: inherit; text-decoration: inherit;">Bookmark<wbr>Id</a>
    ...
    <dd>{{% md %}}Bookmark ID{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the bookmark{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#query_csharp" style="color: inherit; text-decoration: inherit;">Query</a>
    ...
    <dd>{{% md %}}The query of the bookmark.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#created_csharp" style="color: inherit; text-decoration: inherit;">Created</a>
    ...
    <dd>{{% md %}}The time the bookmark was created{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#createdby_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By</a>
    ...
    <dd>{{% md %}}Describes a user that created the bookmark{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="etag_csharp">
...
<a href="#eventtime_csharp" style="color: inherit; text-decoration: inherit;">Event<wbr>Time</a>
    ...
    <dd>{{% md %}}The bookmark event time{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#incidentinfo_csharp" style="color: inherit; text-decoration: inherit;">Incident<wbr>Info</a>
    ...
    <dd>{{% md %}}Describes an incident that relates to bookmark{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#labels_csharp" style="color: inherit; text-decoration: inherit;">Labels</a>
    ...
    <dd>{{% md %}}List of labels relevant to this bookmark{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#notes_csharp" style="color: inherit; text-decoration: inherit;">Notes</a>
    ...
    <dd>{{% md %}}The notes of the bookmark{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#queryendtime_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>End<wbr>Time</a>
    ...
    <dd>{{% md %}}The end time for the query{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#queryresult_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>Result</a>
    ...
    <dd>{{% md %}}The query result of the bookmark.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#querystarttime_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>Start<wbr>Time</a>
    ...
    <dd>{{% md %}}The start time for the query{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#updated_csharp" style="color: inherit; text-decoration: inherit;">Updated</a>
    ...
    <dd>{{% md %}}The last time the bookmark was updated{{% /md %}}</dd><dt class="property-"
            title="">
