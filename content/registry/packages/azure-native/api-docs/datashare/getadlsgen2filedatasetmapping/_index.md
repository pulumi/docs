...
---
title: "getADLSGen2FileDataSetMapping"
title_tag: "azure-native.datashare.getADLSGen2FileDataSetMapping"
meta_desc: "Documentation for the azure-native.datashare.getADLSGen2FileDataSetMapping function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getADLSGen2FileDataSetMapping {#using}
...
><span class="k">function </span>getADLSGen2FileDataSetMapping<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetADLSGen2FileDataSetMappingArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetADLSGen2FileDataSetMappingResult</a></span>></span
><span class="k">
function </span>getADLSGen2FileDataSetMappingOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetADLSGen2FileDataSetMappingOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetADLSGen2FileDataSetMappingResult</a></span>></span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">def </span>get_adls_gen2_file_data_set_mapping<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                        ...
                                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetADLSGen2FileDataSetMappingResult</span
><span class="k">
def </span>get_adls_gen2_file_data_set_mapping_output<span class="p">(</span><span class="nx">account_name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                        ...
                                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetADLSGen2FileDataSetMappingResult]</span
></code></pre></div>
{{% /choosable %}}
...
><span class="k">func </span>LookupADLSGen2FileDataSetMapping<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">LookupADLSGen2FileDataSetMappingArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">LookupADLSGen2FileDataSetMappingResult</a></span>, error)</span
></code></pre></div>

&gt; Note: This function is named `LookupADLSGen2FileDataSetMapping` in the Go SDK.

{{% /choosable %}}


{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetADLSGen2FileDataSetMapping </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetADLSGen2FileDataSetMappingResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetADLSGen2FileDataSetMappingArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetADLSGen2FileDataSetMappingResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetADLSGen2FileDataSetMappingInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#datasetmappingname_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Set<wbr>Mapping<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the dataSetMapping.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sharesubscriptionname_csharp" style="color: inherit; text-decoration: inherit;">Share<wbr>Subscription<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the shareSubscription.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
## getADLSGen2FileDataSetMapping Result {#result}
...
<a href="#datasetid_csharp" style="color: inherit; text-decoration: inherit;">Data<wbr>Set<wbr>Id</a>
    ...
    <dd>{{% md %}}The id of the source data set.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#outputtype_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of output file{{% /md %}}</dd></dl>
{{% /choosable %}}
