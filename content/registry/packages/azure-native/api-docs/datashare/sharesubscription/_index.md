...
aliases:
    - "/docs/reference/pkg/azure-native/ShareSubscription/"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewShareSubscription</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">ShareSubscriptionArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">ShareSubscription</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#invitationid_csharp" style="color: inherit; text-decoration: inherit;">Invitation<wbr>Id</a>
    ...
    <dd>{{% md %}}The invitation id.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#sourcesharelocation_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Share<wbr>Location</a>
    ...
    <dd>{{% md %}}Source share location.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#expirationdate_csharp" style="color: inherit; text-decoration: inherit;">Expiration<wbr>Date</a>
    ...
    <dd>{{% md %}}The expiration date of the share subscription.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
