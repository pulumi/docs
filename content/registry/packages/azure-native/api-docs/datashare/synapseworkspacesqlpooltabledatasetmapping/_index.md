...
aliases:
    - "/docs/reference/pkg/azure-native/SynapseWorkspaceSqlPoolTableDataSetMapping/"
layout: api
---
...
class MyStack : Stack
{
    public MyStack()
    {
        var synapseWorkspaceSqlPoolTableDataSetMapping = new AzureNative.DataShare.SynapseWorkspaceSqlPoolTableDataSetMapping("synapseWorkspaceSqlPoolTableDataSetMapping", new AzureNative.DataShare.SynapseWorkspaceSqlPoolTableDataSetMappingArgs
        {
...
## Create a SynapseWorkspaceSqlPoolTableDataSetMapping Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewSynapseWorkspaceSqlPoolTableDataSetMapping</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">SynapseWorkspaceSqlPoolTableDataSetMappingArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">SynapseWorkspaceSqlPoolTableDataSetMapping</span>, error)</span></code></pre></div>
{{% /choosable %}}
...
The SynapseWorkspaceSqlPoolTableDataSetMapping resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#synapseworkspacesqlpooltableresourceid_csharp" style="color: inherit; text-decoration: inherit;">Synapse<wbr>Workspace<wbr>Sql<wbr>Pool<wbr>Table<wbr>Resource<wbr>Id</a>
    ...
    <dd>{{% md %}}Resource id of the Synapse Workspace SQL Pool Table{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
