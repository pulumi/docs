...
<a href="#systemdata_csharp" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountpropertiesresponsesystemdata">Pulumi.<wbr>Azure<wbr>Native.<wbr>Purview.<wbr>Outputs.<wbr>Account<wbr>Properties<wbr>Response<wbr>System<wbr>Data</a></span>
    </dt>
...
External cloud identifier used as part of scanning configuration.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#identity_csharp" style="color: inherit; text-decoration: inherit;">Identity</a>
    ...
    <dd>{{% md %}}Identity Info on the tracked resource{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#managedresourcegroupname_csharp" style="color: inherit; text-decoration: inherit;">Managed<wbr>Resource<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Gets or sets the managed resource group name{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#systemdata_go" style="color: inherit; text-decoration: inherit;">System<wbr>Data</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#accountpropertiesresponsesystemdata">Account<wbr>Properties<wbr>Response<wbr>System<wbr>Data</a></span>
    </dt>
    <dd>{{% md %}}Metadata pertaining to creation and last modification of the resource.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_go">
...
<h4 id="accountpropertiesresponsesystemdata">Account<wbr>Properties<wbr>Response<wbr>System<wbr>Data</h4>
...
<a href="#createdby_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By</a>
    ...
    <dd>{{% md %}}The identity that created the resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#createdbytype_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>By<wbr>Type</a>
    ...
    <dd>{{% md %}}The type of identity that created the resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#lastmodifiedat_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>At</a>
    ...
    <dd>{{% md %}}The timestamp of the last modification the resource (UTC).{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#lastmodifiedby_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Modified<wbr>By</a>
    ...
    <dd>{{% md %}}The identity that last modified the resource.{{% /md %}}</dd><dt class="property-required"
            title="Required">
