...
title_tag: "azure-native.insights.getScheduledQueryRule"
meta_desc: "Documentation for the azure-native.insights.getScheduledQueryRule function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#alertingactionresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Outputs.<wbr>Alerting<wbr>Action<wbr>Response</a> | <a href="#logtometricactionresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Outputs.<wbr>Log<wbr>To<wbr>Metric<wbr>Action<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Action needs to be taken on rule execution.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#source_csharp" style="color: inherit; text-decoration: inherit;">Source</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sourceresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Outputs.<wbr>Source<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Data Source against which rule will Query Data{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
...
<a href="#automitigate_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Mitigate</a>
    ...
    <dd>{{% md %}}The flag that indicates whether the alert should be automatically resolved or not. The default is false.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the Log Search rule.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#displayname_csharp" style="color: inherit; text-decoration: inherit;">Display<wbr>Name</a>
    ...
    <dd>{{% md %}}The display name of the alert rule{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}The flag which indicates whether the Log Search rule is enabled. Value should be true or false{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="schedule_csharp">
<a href="#schedule_csharp" style="color: inherit; text-decoration: inherit;">Schedule</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#scheduleresponse">Pulumi.<wbr>Azure<wbr>Native.<wbr>Insights.<wbr>Outputs.<wbr>Schedule<wbr>Response</a></span>
    </dt>
    <dd>{{% md %}}Schedule (Frequency, Time Window) for rule. Required for action type - AlertingAction{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
