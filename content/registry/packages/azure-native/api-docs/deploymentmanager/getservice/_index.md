...
---
title: "getService"
title_tag: "azure-native.deploymentmanager.getService"
meta_desc: "Documentation for the azure-native.deploymentmanager.getService function with examples, input properties, output properties, and supporting types."
layout: api
...
<a href="#targetlocation_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Location</a>
    ...
    <dd>{{% md %}}The Azure location to which the resources in the service belong to or should be deployed to.{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#targetsubscriptionid_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Subscription<wbr>Id</a>
    ...
    <dd>{{% md %}}The subscription to which the resources in the service belong to or should be deployed to.{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="type_csharp">
