...
The DedicatedCloudNode resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#availabilityzoneid_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone<wbr>Id</a>
    ...
    <dd>{{% md %}}Availability Zone id, e.g. "az1"{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}SKU's id{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}SKU's name{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#nodescount_csharp" style="color: inherit; text-decoration: inherit;">Nodes<wbr>Count</a>
    ...
    <dd>{{% md %}}count of nodes to create{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#placementgroupid_csharp" style="color: inherit; text-decoration: inherit;">Placement<wbr>Group<wbr>Id</a>
    ...
    <dd>{{% md %}}Placement Group id, e.g. "n1"{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#purchaseid_csharp" style="color: inherit; text-decoration: inherit;">Purchase<wbr>Id</a>
    ...
    <dd>{{% md %}}purchase id{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dedicatedcloudnodename_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Cloud<wbr>Node<wbr>Name</a>
    ...
    <dd>{{% md %}}dedicated cloud node name{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sku_csharp" style="color: inherit; text-decoration: inherit;">Sku</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#sku">Pulumi.<wbr>Azure<wbr>Native.<wbr>VMware<wbr>Cloud<wbr>Simple.<wbr>Inputs.<wbr>Sku<wbr>Args</a></span>
    </dt>
...
<a href="#vmwareclustername_csharp" style="color: inherit; text-decoration: inherit;">Vmware<wbr>Cluster<wbr>Name</a>
    ...
    <dd>{{% md %}}VMWare Cluster Name{{% /md %}}</dd></dl>
{{% /choosable %}}
