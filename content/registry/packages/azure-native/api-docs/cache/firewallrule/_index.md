...
---
title: "FirewallRule"
title_tag: "azure-native.cache.FirewallRule"
meta_desc: "Documentation for the azure-native.cache.FirewallRule resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
...
<span class="k">def </span><span class="nx">FirewallRule</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">end_ip</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                 ...
                 <span class="nx">start_ip</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">)</span>
...
<a href="#endip_csharp" style="color: inherit; text-decoration: inherit;">End<wbr>IP</a>
    ...
    <dd>{{% md %}}highest IP address included in the range{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#startip_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>IP</a>
    ...
    <dd>{{% md %}}lowest IP address included in the range{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#rulename_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the firewall rule.{{% /md %}}</dd></dl>
{{% /choosable %}}
