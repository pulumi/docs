...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_project(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bgpconfigs_csharp">
<a href="#bgpconfigs_csharp" style="color: inherit; text-decoration: inherit;">Bgp<wbr>Configs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectbgpconfig">List&lt;Pulumi.<wbr>Equinix<wbr>Metal.<wbr>Outputs.<wbr>Get<wbr>Project<wbr>Bgp<wbr>Config&gt;</a></span>
    </dt>
    <dd>{{% md %}}Optional BGP settings. Refer to [Equinix Metal guide for BGP](https://metal.equinix.com/developers/docs/networking/local-global-bgp/).
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#userids_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Ids</a>
    ...
    <dd>{{% md %}}List of UUIDs of user accounts which belong to this project
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bgpconfigs_go">
<a href="#bgpconfigs_go" style="color: inherit; text-decoration: inherit;">Bgp<wbr>Configs</a>
</span>
        <span class="property-indicator"></span>
...
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bgpconfigs_nodejs">
<a href="#bgpconfigs_nodejs" style="color: inherit; text-decoration: inherit;">bgp<wbr>Configs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectbgpconfig">Get<wbr>Project<wbr>Bgp<wbr>Config[]</a></span>
    </dt>
...
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="bgp_configs_python">
<a href="#bgp_configs_python" style="color: inherit; text-decoration: inherit;">bgp_<wbr>configs</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectbgpconfig">Sequence[Get<wbr>Project<wbr>Bgp<wbr>Config]</a></span>
    </dt>
    <dd>{{% md %}}Optional BGP settings. Refer to [Equinix Metal guide for BGP](https://metal.equinix.com/developers/docs/networking/local-global-bgp/).
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#deploymenttype_csharp" style="color: inherit; text-decoration: inherit;">Deployment<wbr>Type</a>
    ...
    <dd>{{% md %}}`private` or `public`, the `private` is likely to be usable immediately, the `public` will need to be review by Equinix Metal engineers
{{% /md %}}</dd><dt class="property-required"
            title="Required">
