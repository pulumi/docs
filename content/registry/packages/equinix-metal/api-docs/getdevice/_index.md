...
<a href="#metro_csharp" style="color: inherit; text-decoration: inherit;">Metro</a>
    ...
    <dd>{{% md %}}The metro where the device is deployed
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#networks_csharp" style="color: inherit; text-decoration: inherit;">Networks</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdevicenetwork">List&lt;Pulumi.<wbr>Equinix<wbr>Metal.<wbr>Outputs.<wbr>Get<wbr>Device<wbr>Network&gt;</a></span>
    </dt>
