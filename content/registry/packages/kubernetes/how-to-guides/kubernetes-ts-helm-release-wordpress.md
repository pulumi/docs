...
meta_desc: "Wordpress Helm Chart Deployed Using Helm Release Resource how-to guide using ts"
...
<p class="mb-4 flex">
    <a class="flex flex-wrap items-center rounded text-xs text-white bg-blue-600 border-2 border-blue-600 px-2 mr-2 whitespace-no-wrap hover:text-white" style="height: 32px" href="https://github.com/pulumi/examples/tree/master/kubernetes-ts-helm-release-wordpress" target="_blank">
