...
<a href="#items_csharp" style="color: inherit; text-decoration: inherit;">Items</a>
    ...
    <dd>{{% md %}}List of ValidatingWebhookConfiguration.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The name of the admission webhook. Name should be fully qualified, e.g., imagepolicy.kubernetes.io, where "imagepolicy" is the name of the webhook, and kubernetes.io is the name of the organization. Required.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#failurepolicy_csharp" style="color: inherit; text-decoration: inherit;">Failure<wbr>Policy</a>
    ...
    <dd>{{% md %}}FailurePolicy defines how unrecognized errors from the admission endpoint are handled - allowed values are Ignore or Fail. Defaults to Fail.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
Defaults to "Equivalent"{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timeoutseconds_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Seconds</a>
    ...
    <dd>{{% md %}}TimeoutSeconds specifies the timeout for this webhook. After the timeout passes, the webhook call will be ignored or the API call will fail based on the failure policy. The timeout value must be between 1 and 30 seconds. Default to 10 seconds.{{% /md %}}</dd></dl>
{{% /choosable %}}
