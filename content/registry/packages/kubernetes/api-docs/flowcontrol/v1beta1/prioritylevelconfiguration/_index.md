...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfiguration</span><span class="p"></span>
