...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">FlowSchema</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">FlowSchema</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nx">FlowSchema</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_flowcontrol_apiserver_k8s_io.v1beta1.FlowSchemaSpecArgs]</span> = None<span class="p">)</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewFlowSchema</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">FlowSchemaArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">FlowSchema</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">FlowSchema</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">FlowSchemaArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">FlowSchema</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">FlowSchemaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">FlowSchema</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">FlowSchemaArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchema</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">FlowSchema</a></span>
    </dt>
...
The FlowSchema resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd><p><code>spec</code> is the specification of the desired behavior of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_yaml" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowschemaspec">Property Map</a></span>
    </dt>
    <dd><p><code>spec</code> is the specification of the desired behavior of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd><p><code>status</code> is the current status of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_yaml" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowschemastatus">Property Map</a></span>
    </dt>
    <dd><p><code>status</code> is the current status of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p><code>type</code> is the type of flow distinguisher method The supported types are &quot;ByUser&quot; and &quot;ByNamespace&quot;. Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prioritylevelconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Priority<wbr>Level<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd><p><code>priorityLevelConfiguration</code> should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="distinguishermethod_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguishermethod_csharp" style="color: inherit; text-decoration: inherit;">Distinguisher<wbr>Method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Flow<wbr>Distinguisher<wbr>Method</a></span>
    </dt>
    <dd><p><code>distinguisherMethod</code> defines how to compute the flow distinguisher for requests that match this schema. <code>nil</code> specifies that the distinguisher is disabled and thus will always be the empty string.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="matchingprecedence_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matchingprecedence_csharp" style="color: inherit; text-decoration: inherit;">Matching<wbr>Precedence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd><p><code>matchingPrecedence</code> is used to choose among the FlowSchemas that match a given request. The chosen FlowSchema is among those with the numerically lowest (which we take to be logically highest) MatchingPrecedence.  Each MatchingPrecedence value must be ranged in [1,10000]. Note that if the precedence is not specified, it will be set to 1000 as default.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rules_csharp" style="color: inherit; text-decoration: inherit;">Rules</a>
    ...
    <dd><p><code>rules</code> describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prioritylevelconfiguration_go" style="color: inherit; text-decoration: inherit;">Priority<wbr>Level<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationreference">Priority<wbr>Level<wbr>Configuration<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguishermethod_go" style="color: inherit; text-decoration: inherit;">Distinguisher<wbr>Method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Flow<wbr>Distinguisher<wbr>Method</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matchingprecedence_go" style="color: inherit; text-decoration: inherit;">Matching<wbr>Precedence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="prioritylevelconfiguration_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prioritylevelconfiguration_java" style="color: inherit; text-decoration: inherit;">priority<wbr>Level<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationreference">Priority<wbr>Level<wbr>Configuration<wbr>Reference</a></span>
    </dt>
    <dd><p><code>priorityLevelConfiguration</code> should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.</p>
            ...
            title="Optional">
        <span id="distinguishermethod_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguishermethod_java" style="color: inherit; text-decoration: inherit;">distinguisher<wbr>Method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Flow<wbr>Distinguisher<wbr>Method</a></span>
    </dt>
    <dd><p><code>distinguisherMethod</code> defines how to compute the flow distinguisher for requests that match this schema. <code>nil</code> specifies that the distinguisher is disabled and thus will always be the empty string.</p>
            ...
            title="Optional">
        <span id="matchingprecedence_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matchingprecedence_java" style="color: inherit; text-decoration: inherit;">matching<wbr>Precedence</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prioritylevelconfiguration_nodejs" style="color: inherit; text-decoration: inherit;">priority<wbr>Level<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationreference">Priority<wbr>Level<wbr>Configuration<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguishermethod_nodejs" style="color: inherit; text-decoration: inherit;">distinguisher<wbr>Method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Flow<wbr>Distinguisher<wbr>Method</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matchingprecedence_nodejs" style="color: inherit; text-decoration: inherit;">matching<wbr>Precedence</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#priority_level_configuration_python" style="color: inherit; text-decoration: inherit;">priority_<wbr>level_<wbr>configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationreference">Priority<wbr>Level<wbr>Configuration<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguisher_method_python" style="color: inherit; text-decoration: inherit;">distinguisher_<wbr>method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Flow<wbr>Distinguisher<wbr>Method</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matching_precedence_python" style="color: inherit; text-decoration: inherit;">matching_<wbr>precedence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="prioritylevelconfiguration_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prioritylevelconfiguration_yaml" style="color: inherit; text-decoration: inherit;">priority<wbr>Level<wbr>Configuration</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#prioritylevelconfigurationreference">Property Map</a></span>
    </dt>
    <dd><p><code>priorityLevelConfiguration</code> should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="distinguishermethod_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#distinguishermethod_yaml" style="color: inherit; text-decoration: inherit;">distinguisher<wbr>Method</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowdistinguishermethod">Property Map</a></span>
    </dt>
    <dd><p><code>distinguisherMethod</code> defines how to compute the flow distinguisher for requests that match this schema. <code>nil</code> specifies that the distinguisher is disabled and thus will always be the empty string.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="matchingprecedence_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#matchingprecedence_yaml" style="color: inherit; text-decoration: inherit;">matching<wbr>Precedence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#rules_yaml" style="color: inherit; text-decoration: inherit;">rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#policyruleswithsubjects">List<Property Map></a></span>
    </dt>
    <dd><p><code>rules</code> describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
    ...
    <dd><p><code>conditions</code> is a list of the current states of FlowSchema.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_yaml" style="color: inherit; text-decoration: inherit;">conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#flowschemacondition">List<Property Map></a></span>
    </dt>
    <dd><p><code>conditions</code> is a list of the current states of FlowSchema.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>name is the user group that matches, or &quot;*&quot; to match all user groups. See https://github.com/kubernetes/apiserver/blob/master/pkg/authentication/user/user.go for some well-known group names. Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceurls_csharp" style="color: inherit; text-decoration: inherit;">Non<wbr>Resource<wbr>URLs</a>
    ...
    <dd><p><code>nonResourceURLs</code> is a set of url prefixes that a user should have access to and may not be empty. For example:</p>
<ul>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verbs_csharp" style="color: inherit; text-decoration: inherit;">Verbs</a>
    ...
    <dd><p><code>verbs</code> is a list of matching verbs and may not be empty. &quot;*&quot; matches all verbs. If it is present, it must be the only entry. Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subjects_csharp" style="color: inherit; text-decoration: inherit;">Subjects</a>
    ...
    <dd><p>subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="nonresourcerules_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourcerules_csharp" style="color: inherit; text-decoration: inherit;">Non<wbr>Resource<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourcepolicyrule">List&lt;Non<wbr>Resource<wbr>Policy<wbr>Rule&gt;</a></span>
    </dt>
    <dd><p><code>nonResourceRules</code> is a list of NonResourcePolicyRules that identify matching requests according to their verb and the target non-resource URL.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcerules_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Rules</a>
    ...
    <dd><p><code>resourceRules</code> is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of <code>resourceRules</code> and <code>nonResourceRules</code> has to be non-empty.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourcerules_go" style="color: inherit; text-decoration: inherit;">Non<wbr>Resource<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subjects_java" style="color: inherit; text-decoration: inherit;">subjects</a>
    ...
    <dd><p>subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.</p>
            ...
            title="Optional">
        <span id="nonresourcerules_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourcerules_java" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourcepolicyrule">List<Non<wbr>Resource<wbr>Policy<wbr>Rule></a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourcerules_nodejs" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourcepolicyrule">Non<wbr>Resource<wbr>Policy<wbr>Rule[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#non_resource_rules_python" style="color: inherit; text-decoration: inherit;">non_<wbr>resource_<wbr>rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourcepolicyrule">Non<wbr>Resource<wbr>Policy<wbr>Rule]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subjects_yaml" style="color: inherit; text-decoration: inherit;">subjects</a>
    ...
    <dd><p>subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.</p>
            ...
            title="Optional">
        <span id="nonresourcerules_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourcerules_yaml" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Rules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourcepolicyrule">List<Property Map></a></span>
    </dt>
    <dd><p><code>nonResourceRules</code> is a list of NonResourcePolicyRules that identify matching requests according to their verb and the target non-resource URL.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcerules_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Rules</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcepolicyrule">List<Property Map></a></span>
    </dt>
    <dd><p><code>resourceRules</code> is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of <code>resourceRules</code> and <code>nonResourceRules</code> has to be non-empty.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p><code>name</code> is the name of the priority level configuration being referenced Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apigroups_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Groups</a>
    ...
    <dd><p><code>apiGroups</code> is a list of matching API groups and may not be empty. &quot;*&quot; matches all API groups and, if present, must be the only entry. Required.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resources_csharp" style="color: inherit; text-decoration: inherit;">Resources</a>
    ...
    <dd><p><code>resources</code> is a list of matching resources (i.e., lowercase and plural) with, if desired, subresource.  For example, [ &quot;services&quot;, &quot;nodes/status&quot; ].  This list may not be empty. &quot;*&quot; matches all resources and, if present, must be the only entry. Required.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="verbs_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verbs_csharp" style="color: inherit; text-decoration: inherit;">Verbs</a>
    ...
    <dd><p><code>verbs</code> is a list of matching verbs and may not be empty. &quot;*&quot; matches all verbs and, if present, must be the only entry. Required.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="clusterscope_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterscope_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd><p><code>clusterScope</code> indicates whether to match requests that do not specify a namespace (which happens either because the resource is not namespaced or the request targets all namespaces). If this field is omitted or false then the <code>namespaces</code> field must contain a non-empty list.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterscope_go" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verbs_java" style="color: inherit; text-decoration: inherit;">verbs</a>
    ...
    <dd><p><code>verbs</code> is a list of matching verbs and may not be empty. &quot;*&quot; matches all verbs and, if present, must be the only entry. Required.</p>
            ...
            title="Optional">
        <span id="clusterscope_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterscope_java" style="color: inherit; text-decoration: inherit;">cluster<wbr>Scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterscope_nodejs" style="color: inherit; text-decoration: inherit;">cluster<wbr>Scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cluster_scope_python" style="color: inherit; text-decoration: inherit;">cluster_<wbr>scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verbs_yaml" style="color: inherit; text-decoration: inherit;">verbs</a>
    ...
    <dd><p><code>verbs</code> is a list of matching verbs and may not be empty. &quot;*&quot; matches all verbs and, if present, must be the only entry. Required.</p>
            ...
            title="Optional">
        <span id="clusterscope_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#clusterscope_yaml" style="color: inherit; text-decoration: inherit;">cluster<wbr>Scope</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p><code>name</code> is the name of matching ServiceAccount objects, or &quot;*&quot; to match regardless of name. Required.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="namespace_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd><p><code>namespace</code> is the namespace of matching ServiceAccount objects. Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#kind_csharp" style="color: inherit; text-decoration: inherit;">Kind</a>
    ...
    <dd><p><code>kind</code> indicates which one of the other fields is non-empty. Required</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#group_csharp" style="color: inherit; text-decoration: inherit;">Group</a>
    ...
    <dd><p><code>group</code> matches based on user group name.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccount_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Account</a>
    ...
    <dd><p><code>serviceAccount</code> matches ServiceAccounts.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="user_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_csharp" style="color: inherit; text-decoration: inherit;">User</a>
    ...
    <dd><p><code>user</code> matches based on username.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#group_yaml" style="color: inherit; text-decoration: inherit;">group</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#groupsubject">Property Map</a></span>
    </dt>
    <dd><p><code>group</code> matches based on user group name.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#serviceaccount_yaml" style="color: inherit; text-decoration: inherit;">service<wbr>Account</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#serviceaccountsubject">Property Map</a></span>
    </dt>
    <dd><p><code>serviceAccount</code> matches ServiceAccounts.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_yaml" style="color: inherit; text-decoration: inherit;">user</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#usersubject">Property Map</a></span>
    </dt>
    <dd><p><code>user</code> matches based on username.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p><code>name</code> is the username that matches, or &quot;*&quot; to match all usernames. Required.</p>
</dd></dl>
</pulumi-choosable>
</div>
