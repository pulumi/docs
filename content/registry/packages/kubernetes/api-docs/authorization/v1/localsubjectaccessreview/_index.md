...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">LocalSubjectAccessReview</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             ...
                             <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[_authorization_k8s_io.v1.SubjectAccessReviewSpecArgs]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                             <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span><span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewLocalSubjectAccessReview</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> </span><span class="nx"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">LocalSubjectAccessReview</span>, error)</span></code></pre></div>
</pulumi-choosable>
</div>

<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
</pulumi-choosable>
</div>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">LocalSubjectAccessReview</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:authorization.k8s.io/v1:LocalSubjectAccessReview</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">LocalSubjectAccessReview</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">LocalSubjectAccessReviewArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
The LocalSubjectAccessReview resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd><p>Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_yaml" style="color: inherit; text-decoration: inherit;">spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subjectaccessreviewspec">Property Map</a></span>
    </dt>
    <dd><p>Spec holds information about the request being evaluated.  spec.namespace must be equal to the namespace you made the request against.  If empty, it is defaulted.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_yaml" style="color: inherit; text-decoration: inherit;">status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#subjectaccessreviewstatus">Property Map</a></span>
    </dt>
    <dd><p>Status is filled in by the server and indicates whether the request is allowed or not</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_csharp" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="verb_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_csharp" style="color: inherit; text-decoration: inherit;">Verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>Verb is the standard HTTP verb</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_go" style="color: inherit; text-decoration: inherit;">Path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
            ...
            title="Optional">
        <span id="verb_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_go" style="color: inherit; text-decoration: inherit;">Verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_java" style="color: inherit; text-decoration: inherit;">path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
            ...
            title="Optional">
        <span id="verb_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_java" style="color: inherit; text-decoration: inherit;">verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_nodejs" style="color: inherit; text-decoration: inherit;">path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
            ...
            title="Optional">
        <span id="verb_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_nodejs" style="color: inherit; text-decoration: inherit;">verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_python" style="color: inherit; text-decoration: inherit;">path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
            ...
            title="Optional">
        <span id="verb_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_python" style="color: inherit; text-decoration: inherit;">verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#path_yaml" style="color: inherit; text-decoration: inherit;">path</a>
    ...
    <dd><p>Path is the URL path of the request</p>
            ...
            title="Optional">
        <span id="verb_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_yaml" style="color: inherit; text-decoration: inherit;">verb</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#group_csharp" style="color: inherit; text-decoration: inherit;">Group</a>
    ...
    <dd><p>Group is the API Group of the Resource.  &quot;*&quot; means all.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Name is the name of the resource being requested for a &quot;get&quot; or deleted for a &quot;delete&quot;. &quot;&quot; (empty) means all.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="namespace_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd><p>Namespace is the namespace of the action being requested.  Currently, there is no distinction between no namespace and all namespaces &quot;&quot; (empty) is defaulted for LocalSubjectAccessReviews &quot;&quot; (empty) is empty for cluster-scoped resources &quot;&quot; (empty) means &quot;all&quot; for namespace scoped resources from a SubjectAccessReview or SelfSubjectAccessReview</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
    ...
    <dd><p>Resource is one of the existing resource types.  &quot;*&quot; means all.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="subresource_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subresource_csharp" style="color: inherit; text-decoration: inherit;">Subresource</a>
    ...
    <dd><p>Subresource is one of the existing resource types.  &quot;&quot; means none.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="verb_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#verb_csharp" style="color: inherit; text-decoration: inherit;">Verb</a>
    ...
    <dd><p>Verb is a kubernetes resource API verb, like: get, list, watch, create, update, delete, proxy.  &quot;*&quot; means all.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd><p>Version is the API Version of the Resource.  &quot;*&quot; means all.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extra_csharp" style="color: inherit; text-decoration: inherit;">Extra</a>
    ...
    <dd><p>Extra corresponds to the user.Info.GetExtra() method from the authenticator.  Since that is input to the authorizer it needs a reflection here.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_csharp" style="color: inherit; text-decoration: inherit;">Groups</a>
    ...
    <dd><p>Groups is the groups you're testing for.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="nonresourceattributes_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceattributes_csharp" style="color: inherit; text-decoration: inherit;">Non<wbr>Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Non<wbr>Resource<wbr>Attributes</a></span>
    </dt>
    <dd><p>NonResourceAttributes describes information for a non-resource access request</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="resourceattributes_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceattributes_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Resource<wbr>Attributes</a></span>
    </dt>
    <dd><p>ResourceAuthorizationAttributes describes information for a resource access request</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="uid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uid_csharp" style="color: inherit; text-decoration: inherit;">Uid</a>
    ...
    <dd><p>UID information about the requesting user.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="user_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_csharp" style="color: inherit; text-decoration: inherit;">User</a>
    ...
    <dd><p>User is the user you're testing for. If you specify &quot;User&quot; but not &quot;Groups&quot;, then is it interpreted as &quot;What if User were not a member of any groups</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceattributes_go" style="color: inherit; text-decoration: inherit;">Non<wbr>Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Non<wbr>Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceattributes_go" style="color: inherit; text-decoration: inherit;">Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_java" style="color: inherit; text-decoration: inherit;">groups</a>
    ...
    <dd><p>Groups is the groups you're testing for.</p>
            ...
            title="Optional">
        <span id="nonresourceattributes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceattributes_java" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Non<wbr>Resource<wbr>Attributes</a></span>
    </dt>
    <dd><p>NonResourceAttributes describes information for a non-resource access request</p>
            ...
            title="Optional">
        <span id="resourceattributes_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceattributes_java" style="color: inherit; text-decoration: inherit;">resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceattributes_nodejs" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Non<wbr>Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceattributes_nodejs" style="color: inherit; text-decoration: inherit;">resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#non_resource_attributes_python" style="color: inherit; text-decoration: inherit;">non_<wbr>resource_<wbr>attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Non<wbr>Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_attributes_python" style="color: inherit; text-decoration: inherit;">resource_<wbr>attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Resource<wbr>Attributes</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_yaml" style="color: inherit; text-decoration: inherit;">groups</a>
    ...
    <dd><p>Groups is the groups you're testing for.</p>
            ...
            title="Optional">
        <span id="nonresourceattributes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nonresourceattributes_yaml" style="color: inherit; text-decoration: inherit;">non<wbr>Resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#nonresourceattributes">Property Map</a></span>
    </dt>
    <dd><p>NonResourceAttributes describes information for a non-resource access request</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="resourceattributes_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourceattributes_yaml" style="color: inherit; text-decoration: inherit;">resource<wbr>Attributes</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourceattributes">Property Map</a></span>
    </dt>
    <dd><p>ResourceAuthorizationAttributes describes information for a resource access request</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_csharp" style="color: inherit; text-decoration: inherit;">Allowed</a>
    ...
    <dd><p>Allowed is required. True if the action would be allowed, false otherwise.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="denied_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_csharp" style="color: inherit; text-decoration: inherit;">Denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd><p>Denied is optional. True if the action would be denied, otherwise false. If both allowed is false and denied is false, then the authorizer has no opinion on whether to authorize the action. Denied may not be true if Allowed is true.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="evaluationerror_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluationerror_csharp" style="color: inherit; text-decoration: inherit;">Evaluation<wbr>Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>EvaluationError is an indication that some error occurred during the authorization check. It is entirely possible to get an error and be able to continue determine authorization status in spite of it. For instance, RBAC can be missing a role, but enough roles are still present and bound to reason about the request.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#reason_csharp" style="color: inherit; text-decoration: inherit;">Reason</a>
    ...
    <dd><p>Reason is optional.  It indicates why a request was allowed or denied.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_go" style="color: inherit; text-decoration: inherit;">Allowed</a>
    ...
    <dd><p>Allowed is required. True if the action would be allowed, false otherwise.</p>
            ...
            title="Optional">
        <span id="denied_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_go" style="color: inherit; text-decoration: inherit;">Denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluationerror_go" style="color: inherit; text-decoration: inherit;">Evaluation<wbr>Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_java" style="color: inherit; text-decoration: inherit;">allowed</a>
    ...
    <dd><p>Allowed is required. True if the action would be allowed, false otherwise.</p>
            ...
            title="Optional">
        <span id="denied_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_java" style="color: inherit; text-decoration: inherit;">denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
    <dd><p>Denied is optional. True if the action would be denied, otherwise false. If both allowed is false and denied is false, then the authorizer has no opinion on whether to authorize the action. Denied may not be true if Allowed is true.</p>
            ...
            title="Optional">
        <span id="evaluationerror_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluationerror_java" style="color: inherit; text-decoration: inherit;">evaluation<wbr>Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_nodejs" style="color: inherit; text-decoration: inherit;">denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">boolean</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluationerror_nodejs" style="color: inherit; text-decoration: inherit;">evaluation<wbr>Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_python" style="color: inherit; text-decoration: inherit;">denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluation_error_python" style="color: inherit; text-decoration: inherit;">evaluation_<wbr>error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allowed_yaml" style="color: inherit; text-decoration: inherit;">allowed</a>
    ...
    <dd><p>Allowed is required. True if the action would be allowed, false otherwise.</p>
            ...
            title="Optional">
        <span id="denied_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#denied_yaml" style="color: inherit; text-decoration: inherit;">denied</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Boolean</span>
    </dt>
    <dd><p>Denied is optional. True if the action would be denied, otherwise false. If both allowed is false and denied is false, then the authorizer has no opinion on whether to authorize the action. Denied may not be true if Allowed is true.</p>
            ...
            title="Optional">
        <span id="evaluationerror_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#evaluationerror_yaml" style="color: inherit; text-decoration: inherit;">evaluation<wbr>Error</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
