...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:authorization.k8s.io/v1:SelfSubjectAccessReview</span><span class="p"></span>
