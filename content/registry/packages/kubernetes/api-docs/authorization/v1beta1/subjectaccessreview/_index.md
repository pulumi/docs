...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:authorization.k8s.io/v1beta1:SubjectAccessReview</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#user_csharp" style="color: inherit; text-decoration: inherit;">User</a>
    ...
    <dd><p>User is the user you're testing for. If you specify &quot;User&quot; but not &quot;Group&quot;, then is it interpreted as &quot;What if User were not a member of any groups</p>
</dd></dl>
</pulumi-choosable>
</div>
