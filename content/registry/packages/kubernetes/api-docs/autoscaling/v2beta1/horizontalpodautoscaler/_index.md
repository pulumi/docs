...
<span class="k">def </span><span class="nx">HorizontalPodAutoscaler</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                            ...
                            <span class="nx">spec</span><span class="p">:</span> <span class="nx">Optional[HorizontalPodAutoscalerSpecArgs]</span> = None<span class="p">)</span>
<span class=nd>@overload</span>
<span class="k">def </span><span class="nx">HorizontalPodAutoscaler</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                            <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[HorizontalPodAutoscalerInitArgs]</a></span> = None<span class="p">,</span>
...
<code class="language-java" data-lang="java"><span class="k">public </span><span class="nx">HorizontalPodAutoscaler</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">HorizontalPodAutoscalerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">)</span>
<span class="k">public </span><span class="nx">HorizontalPodAutoscaler</span><span class="p">(</span><span class="nx">String</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">HorizontalPodAutoscalerArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">CustomResourceOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
</code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:autoscaling/v2beta1:HorizontalPodAutoscaler</span><span class="p"></span>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">HorizontalPodAutoscaler</a></span>
    </dt>
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">HorizontalPodAutoscalerInitArgs</a></span>
    </dt>
    <dd>The arguments to resource properties.</dd><dt
        class="property-optional" title="Optional">
        <span>opts</span>
...
The HorizontalPodAutoscaler resource accepts the following [input](/docs/intro/concepts/inputs-outputs) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxreplicas_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Replicas</a>
    ...
    <dd><p>maxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up. It cannot be less that minReplicas.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="scaletargetref_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_csharp" style="color: inherit; text-decoration: inherit;">Scale<wbr>Target<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Cross<wbr>Version<wbr>Object<wbr>Reference</a></span>
    </dt>
    <dd><p>scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_csharp" style="color: inherit; text-decoration: inherit;">Metrics</a>
    ...
    <dd><p>metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#minreplicas_csharp" style="color: inherit; text-decoration: inherit;">Min<wbr>Replicas</a>
    ...
    <dd><p>minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down.  It defaults to 1 pod.  minReplicas is allowed to be 0 if the alpha feature gate HPAScaleToZero is enabled and at least one Object or External metric is configured.  Scaling is active as long as at least one metric value is available.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_go" style="color: inherit; text-decoration: inherit;">Scale<wbr>Target<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Cross<wbr>Version<wbr>Object<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxreplicas_java" style="color: inherit; text-decoration: inherit;">max<wbr>Replicas</a>
    ...
    <dd><p>maxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up. It cannot be less that minReplicas.</p>
            ...
            title="Required">
        <span id="scaletargetref_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_java" style="color: inherit; text-decoration: inherit;">scale<wbr>Target<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Cross<wbr>Version<wbr>Object<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_nodejs" style="color: inherit; text-decoration: inherit;">scale<wbr>Target<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Cross<wbr>Version<wbr>Object<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scale_target_ref_python" style="color: inherit; text-decoration: inherit;">scale_<wbr>target_<wbr>ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Cross<wbr>Version<wbr>Object<wbr>Reference</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_python" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricspec">Sequence[Metric<wbr>Spec]</a></span>
    </dt>
    <dd><p>metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxreplicas_yaml" style="color: inherit; text-decoration: inherit;">max<wbr>Replicas</a>
    ...
    <dd><p>maxReplicas is the upper limit for the number of replicas to which the autoscaler can scale up. It cannot be less that minReplicas.</p>
            ...
            title="Required">
        <span id="scaletargetref_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_yaml" style="color: inherit; text-decoration: inherit;">scale<wbr>Target<wbr>Ref</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#crossversionobjectreference">Property Map</a></span>
    </dt>
    <dd><p>scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metrics_yaml" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricspec">List<Property Map></a></span>
    </dt>
    <dd><p>metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd><p>currentReplicas is current number of replicas of pods managed by this autoscaler, as last seen by the autoscaler.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="desiredreplicas_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd><p>desiredReplicas is the desired number of replicas of pods managed by this autoscaler, as last calculated by the autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
    ...
    <dd><p>conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="currentmetrics_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentmetrics_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Metrics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricstatus">List&lt;Metric<wbr>Status&gt;</a></span>
    </dt>
    <dd><p>currentMetrics is the last read state of the metrics used by this autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="lastscaletime_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Scale<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>lastScaleTime is the last time the HorizontalPodAutoscaler scaled the number of pods, used by the autoscaler to control how often the number of pods is changed.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#observedgeneration_csharp" style="color: inherit; text-decoration: inherit;">Observed<wbr>Generation</a>
    ...
    <dd><p>observedGeneration is the most recent generation observed by this autoscaler.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_go" style="color: inherit; text-decoration: inherit;">Current<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_go" style="color: inherit; text-decoration: inherit;">Desired<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentmetrics_go" style="color: inherit; text-decoration: inherit;">Current<wbr>Metrics</a>
</span>
        <span class="property-indicator"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_go" style="color: inherit; text-decoration: inherit;">Last<wbr>Scale<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="currentreplicas_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_java" style="color: inherit; text-decoration: inherit;">current<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
    <dd><p>currentReplicas is current number of replicas of pods managed by this autoscaler, as last seen by the autoscaler.</p>
            ...
            title="Required">
        <span id="desiredreplicas_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_java" style="color: inherit; text-decoration: inherit;">desired<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Integer</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_java" style="color: inherit; text-decoration: inherit;">conditions</a>
    ...
    <dd><p>conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.</p>
            ...
            title="Optional">
        <span id="currentmetrics_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentmetrics_java" style="color: inherit; text-decoration: inherit;">current<wbr>Metrics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricstatus">List<Metric<wbr>Status></a></span>
    </dt>
    <dd><p>currentMetrics is the last read state of the metrics used by this autoscaler.</p>
            ...
            title="Optional">
        <span id="lastscaletime_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_java" style="color: inherit; text-decoration: inherit;">last<wbr>Scale<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_nodejs" style="color: inherit; text-decoration: inherit;">current<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_nodejs" style="color: inherit; text-decoration: inherit;">desired<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentmetrics_nodejs" style="color: inherit; text-decoration: inherit;">current<wbr>Metrics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricstatus">Metric<wbr>Status[]</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_nodejs" style="color: inherit; text-decoration: inherit;">last<wbr>Scale<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#current_replicas_python" style="color: inherit; text-decoration: inherit;">current_<wbr>replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desired_replicas_python" style="color: inherit; text-decoration: inherit;">desired_<wbr>replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_python" style="color: inherit; text-decoration: inherit;">conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#horizontalpodautoscalercondition">Sequence[Horizontal<wbr>Pod<wbr>Autoscaler<wbr>Condition]</a></span>
    </dt>
    <dd><p>conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="current_metrics_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#current_metrics_python" style="color: inherit; text-decoration: inherit;">current_<wbr>metrics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricstatus">Sequence[Metric<wbr>Status]</a></span>
    </dt>
    <dd><p>currentMetrics is the last read state of the metrics used by this autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="last_scale_time_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#last_scale_time_python" style="color: inherit; text-decoration: inherit;">last_<wbr>scale_<wbr>time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="currentreplicas_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_yaml" style="color: inherit; text-decoration: inherit;">current<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
    <dd><p>currentReplicas is current number of replicas of pods managed by this autoscaler, as last seen by the autoscaler.</p>
            ...
            title="Required">
        <span id="desiredreplicas_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_yaml" style="color: inherit; text-decoration: inherit;">desired<wbr>Replicas</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#conditions_yaml" style="color: inherit; text-decoration: inherit;">conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#horizontalpodautoscalercondition">List<Property Map></a></span>
    </dt>
    <dd><p>conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="currentmetrics_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentmetrics_yaml" style="color: inherit; text-decoration: inherit;">current<wbr>Metrics</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#metricstatus">List<Property Map></a></span>
    </dt>
    <dd><p>currentMetrics is the last read state of the metrics used by this autoscaler.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="lastscaletime_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_yaml" style="color: inherit; text-decoration: inherit;">last<wbr>Scale<wbr>Time</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>type is the type of metric source.  It should be one of &quot;ContainerResource&quot;, &quot;External&quot;, &quot;Object&quot;, &quot;Pods&quot; or &quot;Resource&quot;, each mapping to a matching field in the object. Note: &quot;ContainerResource&quot; type is available on when the feature-gate HPAContainerMetrics is enabled</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="containerresource_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Container<wbr>Resource<wbr>Metric<wbr>Source</a></span>
    </dt>
    <dd><p>container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#external_csharp" style="color: inherit; text-decoration: inherit;">External</a>
    ...
    <dd><p>external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_csharp" style="color: inherit; text-decoration: inherit;">Object</a>
    ...
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="pods_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_csharp" style="color: inherit; text-decoration: inherit;">Pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Pods<wbr>Metric<wbr>Source</a></span>
    </dt>
    <dd><p>pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_csharp" style="color: inherit; text-decoration: inherit;">Resource</a>
    ...
    <dd><p>resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_go" style="color: inherit; text-decoration: inherit;">Container<wbr>Resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Container<wbr>Resource<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_go" style="color: inherit; text-decoration: inherit;">Object</a>
    ...
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
            ...
            title="Optional">
        <span id="pods_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_go" style="color: inherit; text-decoration: inherit;">Pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Pods<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_java" style="color: inherit; text-decoration: inherit;">type</a>
    ...
    <dd><p>type is the type of metric source.  It should be one of &quot;ContainerResource&quot;, &quot;External&quot;, &quot;Object&quot;, &quot;Pods&quot; or &quot;Resource&quot;, each mapping to a matching field in the object. Note: &quot;ContainerResource&quot; type is available on when the feature-gate HPAContainerMetrics is enabled</p>
            ...
            title="Optional">
        <span id="containerresource_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_java" style="color: inherit; text-decoration: inherit;">container<wbr>Resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Container<wbr>Resource<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_java" style="color: inherit; text-decoration: inherit;">object</a>
    ...
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
            ...
            title="Optional">
        <span id="pods_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_java" style="color: inherit; text-decoration: inherit;">pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Pods<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_nodejs" style="color: inherit; text-decoration: inherit;">container<wbr>Resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Container<wbr>Resource<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_nodejs" style="color: inherit; text-decoration: inherit;">object</a>
    ...
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
            ...
            title="Optional">
        <span id="pods_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_nodejs" style="color: inherit; text-decoration: inherit;">pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Pods<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#container_resource_python" style="color: inherit; text-decoration: inherit;">container_<wbr>resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Container<wbr>Resource<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_python" style="color: inherit; text-decoration: inherit;">object</a>
    ...
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
            ...
            title="Optional">
        <span id="pods_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_python" style="color: inherit; text-decoration: inherit;">pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Pods<wbr>Metric<wbr>Source</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_yaml" style="color: inherit; text-decoration: inherit;">type</a>
    ...
    <dd><p>type is the type of metric source.  It should be one of &quot;ContainerResource&quot;, &quot;External&quot;, &quot;Object&quot;, &quot;Pods&quot; or &quot;Resource&quot;, each mapping to a matching field in the object. Note: &quot;ContainerResource&quot; type is available on when the feature-gate HPAContainerMetrics is enabled</p>
            ...
            title="Optional">
        <span id="containerresource_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_yaml" style="color: inherit; text-decoration: inherit;">container<wbr>Resource</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricsource">Property Map</a></span>
    </dt>
    <dd><p>container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#external_yaml" style="color: inherit; text-decoration: inherit;">external</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#externalmetricsource">Property Map</a></span>
    </dt>
    <dd><p>external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_yaml" style="color: inherit; text-decoration: inherit;">object</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectmetricsource">Property Map</a></span>
    </dt>
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="pods_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_yaml" style="color: inherit; text-decoration: inherit;">pods</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricsource">Property Map</a></span>
    </dt>
    <dd><p>pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_yaml" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcemetricsource">Property Map</a></span>
    </dt>
    <dd><p>resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd><p>type is the type of metric source.  It will be one of &quot;ContainerResource&quot;, &quot;External&quot;, &quot;Object&quot;, &quot;Pods&quot; or &quot;Resource&quot;, each corresponds to a matching field in the object. Note: &quot;ContainerResource&quot; type is available on when the feature-gate HPAContainerMetrics is enabled</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="containerresource_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_csharp" style="color: inherit; text-decoration: inherit;">Container<wbr>Resource</a>
    ...
    <dd><p>container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="external_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#external_csharp" style="color: inherit; text-decoration: inherit;">External</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#containerresource_yaml" style="color: inherit; text-decoration: inherit;">container<wbr>Resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#containerresourcemetricstatus">Property Map</a></span>
    </dt>
    <dd><p>container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#external_yaml" style="color: inherit; text-decoration: inherit;">external</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#externalmetricstatus">Property Map</a></span>
    </dt>
    <dd><p>external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#object_yaml" style="color: inherit; text-decoration: inherit;">object</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectmetricstatus">Property Map</a></span>
    </dt>
    <dd><p>object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pods_yaml" style="color: inherit; text-decoration: inherit;">pods</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#podsmetricstatus">Property Map</a></span>
    </dt>
    <dd><p>pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resource_yaml" style="color: inherit; text-decoration: inherit;">resource</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#resourcemetricstatus">Property Map</a></span>
    </dt>
    <dd><p>resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the &quot;pods&quot; source.</p>
</dd></dl>
</pulumi-choosable>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
    ...
    <dd><p>target is the described Kubernetes object.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="targetvalue_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetvalue_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Value</a>
    ...
    <dd><p>targetValue is the target value of the metric (as a quantity).</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="averagevalue_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_csharp" style="color: inherit; text-decoration: inherit;">Average<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>averageValue is the target value of the average of the metric across all relevant pods (as a quantity)</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selector_csharp" style="color: inherit; text-decoration: inherit;">Selector</a>
    ...
    <dd><p>selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping When unset, just the metricName will be used to gather metrics.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_go" style="color: inherit; text-decoration: inherit;">Average<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetvalue_java" style="color: inherit; text-decoration: inherit;">target<wbr>Value</a>
    ...
    <dd><p>targetValue is the target value of the metric (as a quantity).</p>
            ...
            title="Optional">
        <span id="averagevalue_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_java" style="color: inherit; text-decoration: inherit;">average<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_nodejs" style="color: inherit; text-decoration: inherit;">average<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#average_value_python" style="color: inherit; text-decoration: inherit;">average_<wbr>value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetvalue_yaml" style="color: inherit; text-decoration: inherit;">target<wbr>Value</a>
    ...
    <dd><p>targetValue is the target value of the metric (as a quantity).</p>
            ...
            title="Optional">
        <span id="averagevalue_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_yaml" style="color: inherit; text-decoration: inherit;">average<wbr>Value</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#averagevalue_csharp" style="color: inherit; text-decoration: inherit;">Average<wbr>Value</a>
    ...
    <dd><p>averageValue is the current value of the average of the metric across all relevant pods (as a quantity)</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="selector_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selector_csharp" style="color: inherit; text-decoration: inherit;">Selector</a>
    ...
    <dd><p>selector is the string-encoded form of a standard kubernetes label selector for the given metric When set in the ObjectMetricSource, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetaveragevalue_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Average<wbr>Value</a>
    ...
    <dd><p>targetAverageValue is the target value of the average of the metric across all relevant pods (as a quantity)</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="selector_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selector_csharp" style="color: inherit; text-decoration: inherit;">Selector</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentaveragevalue_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Average<wbr>Value</a>
    ...
    <dd><p>currentAverageValue is the current value of the average of the metric across all relevant pods (as a quantity)</p>
</dd><dt class="property-required"
            title="Required">
        <span id="metricname_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metricname_csharp" style="color: inherit; text-decoration: inherit;">Metric<wbr>Name</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#selector_csharp" style="color: inherit; text-decoration: inherit;">Selector</a>
    ...
    <dd><p>selector is the string-encoded form of a standard kubernetes label selector for the given metric When set in the PodsMetricSource, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics.</p>
</dd></dl>
</pulumi-choosable>
</div>
