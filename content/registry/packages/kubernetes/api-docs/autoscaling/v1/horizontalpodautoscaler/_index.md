...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
    ...
    <dd>{{% md %}}behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}current information about the autoscaler.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxreplicas_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Replicas</a>
    ...
    <dd>{{% md %}}upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scaletargetref_csharp" style="color: inherit; text-decoration: inherit;">Scale<wbr>Target<wbr>Ref</a>
    ...
    <dd>{{% md %}}reference to scaled resource; horizontal pod autoscaler will learn the current resource consumption and will set the desired number of pods by using its Scale subresource.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetcpuutilizationpercentage_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>CPUUtilization<wbr>Percentage</a>
    ...
    <dd>{{% md %}}target average CPU utilization (represented as a percentage of requested CPU) over all the pods; if not specified the default autoscaling policy will be used.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentreplicas_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>Replicas</a>
    ...
    <dd>{{% md %}}current number of replicas of pods managed by this autoscaler.{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#desiredreplicas_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>Replicas</a>
    ...
    <dd>{{% md %}}desired number of replicas of pods managed by this autoscaler.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#currentcpuutilizationpercentage_csharp" style="color: inherit; text-decoration: inherit;">Current<wbr>CPUUtilization<wbr>Percentage</a>
    ...
    <dd>{{% md %}}current average CPU utilization over all pods, represented as a percentage of requested CPU, e.g. 70 means that an average pod is using now 70% of its requested CPU.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#lastscaletime_csharp" style="color: inherit; text-decoration: inherit;">Last<wbr>Scale<wbr>Time</a>
    ...
    <dd>{{% md %}}last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#observedgeneration_csharp" style="color: inherit; text-decoration: inherit;">Observed<wbr>Generation</a>
    ...
    <dd>{{% md %}}most recent generation observed by this autoscaler.{{% /md %}}</dd></dl>
{{% /choosable %}}
