...
<a href="#fstype_csharp" style="color: inherit; text-decoration: inherit;">Fs<wbr>Type</a>
    ...
    <dd>{{% md %}}Filesystem type to mount. It applies only when the Path is a block device. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". The default value is to auto-select a filesystem if unspecified.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#operator_csharp" style="color: inherit; text-decoration: inherit;">Operator</a>
    ...
    <dd>{{% md %}}Represents a key's relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist. Gt, and Lt.
...
Possible enum values:
 ...
 - `"In"`
 - `"Lt"`
 - `"NotIn"`{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
Possible enum values:
 ...
 - `"Retain"` means the volume will be left in its current phase (Released) for manual reclamation by the administrator. The default policy is Retain.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
