...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:storage.k8s.io/v1:StorageClass</span><span class="p"></span>
