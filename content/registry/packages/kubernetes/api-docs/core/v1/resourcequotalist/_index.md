...
<a href="#operator_csharp" style="color: inherit; text-decoration: inherit;">Operator</a>
    ...
    <dd>{{% md %}}Represents a scope's relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.

Possible enum values:
 - `"DoesNotExist"`
 - `"Exists"`
 - `"In"`
 - `"NotIn"`{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#scopename_csharp" style="color: inherit; text-decoration: inherit;">Scope<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the scope that the selector applies to.
...
Possible enum values:
 ...
 - `"Terminating"` Match all pod objects where spec.activeDeadlineSeconds >=0{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
