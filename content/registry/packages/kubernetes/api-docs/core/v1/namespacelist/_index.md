...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of namespace controller condition.
...
Possible enum values:
 ...
 - `"NamespaceFinalizersRemaining"` contains information about which finalizers are on resources remaining in a namespace.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#phase_csharp" style="color: inherit; text-decoration: inherit;">Phase</a>
    ...
    <dd>{{% md %}}Phase is the current lifecycle phase of the namespace. More info: https://kubernetes.io/docs/tasks/administer-cluster/namespaces/

Possible enum values:
 - `"Active"` means the namespace is available for use in the system
 - `"Terminating"` means the namespace is undergoing graceful termination{{% /md %}}</dd></dl>
{{% /choosable %}}
