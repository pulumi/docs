...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Node address type, one of Hostname, ExternalIP or InternalIP.{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type of node condition.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#phase_csharp" style="color: inherit; text-decoration: inherit;">Phase</a>
    ...
    <dd>{{% md %}}NodePhase is the recently observed lifecycle phase of the node. More info: https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#effect_csharp" style="color: inherit; text-decoration: inherit;">Effect</a>
    ...
    <dd>{{% md %}}Required. The effect of the taint on pods that do not tolerate the taint. Valid effects are NoSchedule, PreferNoSchedule and NoExecute.{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="key_csharp">
