...
<span class="k">def </span><span class="nx">RoleBindingList</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                    ...
                    <span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_rbac_authorization_k8s_io.v1alpha1.RoleBindingArgs]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBindingList</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#apiversion_csharp" style="color: inherit; text-decoration: inherit;">Api<wbr>Version</a>
    ...
    <dd><p>APIVersion holds the API group and version of the referenced subject. Defaults to &quot;v1&quot; for ServiceAccount subjects. Defaults to &quot;rbac.authorization.k8s.io/v1alpha1&quot; for User and Group subjects.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="namespace_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
