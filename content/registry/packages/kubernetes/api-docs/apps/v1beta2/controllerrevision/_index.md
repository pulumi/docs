...
<p class="resource-deprecated">Deprecated:<p>apps/v1beta2/ControllerRevision is deprecated by apps/v1/ControllerRevision and not supported by Kubernetes v1.16+ clusters.</p>
</p>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">kubernetes:apps/v1beta2:ControllerRevision</span><span class="p"></span>
