...
<a href="#revision_csharp" style="color: inherit; text-decoration: inherit;">Revision</a>
    ...
    <dd>{{% md %}}Revision indicates the revision of the state represented by Data.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="data_csharp">
<a href="#data_csharp" style="color: inherit; text-decoration: inherit;">Data</a>
    ...
    <dd>{{% md %}}Data is the serialized representation of the state.{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
