...
---
title: "getDBClusters"
title_tag: "alicloud.adb.getDBClusters"
meta_desc: "Documentation for the alicloud.adb.getDBClusters function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_db_clusters(</span><span class="nx">description</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
<a href="#descriptionregex_csharp" style="color: inherit; text-decoration: inherit;">Description<wbr>Regex</a>
    ...
    <dd>{{% md %}}A regex string to filter results by DBCluster description.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clusters_csharp" style="color: inherit; text-decoration: inherit;">Clusters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdbclusterscluster">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Adb.<wbr>Outputs.<wbr>Get<wbr>DBClusters<wbr>Cluster&gt;</a></span>
    </dt>
...
<a href="#clusters_go" style="color: inherit; text-decoration: inherit;">Clusters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdbclusterscluster">[]Get<wbr>DBClusters<wbr>Cluster</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#clusters_python" style="color: inherit; text-decoration: inherit;">clusters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdbclusterscluster">Sequence[Get<wbr>DBClusters<wbr>Cluster]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<h4 id="getdbclusterscluster">Get<wbr>DBClusters<wbr>Cluster</h4>
...
<a href="#autorenewperiod_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Renew<wbr>Period</a>
    ...
    <dd>{{% md %}}Auto-renewal period of an cluster, in the unit of the month.
...
<a href="#chargetype_csharp" style="color: inherit; text-decoration: inherit;">Charge<wbr>Type</a>
    ...
    <dd>{{% md %}}The payment type of the resource.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#computeresource_csharp" style="color: inherit; text-decoration: inherit;">Compute<wbr>Resource</a>
    ...
    <dd>{{% md %}}The specifications of computing resources in elastic mode. The increase of resources can speed up queries. AnalyticDB for MySQL automatically scales computing resources. For more information, see [Specifications](https://www.alibabacloud.com/help/en/doc-detail/144851.htm).
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dbclusternetworktype_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Cluster<wbr>Network<wbr>Type</a>
    ...
    <dd>{{% md %}}The db cluster network type.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#dtsjobid_csharp" style="color: inherit; text-decoration: inherit;">Dts<wbr>Job<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the data synchronization task in Data Transmission Service (DTS). This parameter is valid only for analytic instances.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#engine_csharp" style="color: inherit; text-decoration: inherit;">Engine</a>
    ...
    <dd>{{% md %}}The engine of the database.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#engineversion_csharp" style="color: inherit; text-decoration: inherit;">Engine<wbr>Version</a>
    ...
    <dd>{{% md %}}The engine version of the database..
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#executorcount_csharp" style="color: inherit; text-decoration: inherit;">Executor<wbr>Count</a>
    ...
    <dd>{{% md %}}The number of nodes. The node resources are used for data computing in elastic mode.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expiretime_csharp" style="color: inherit; text-decoration: inherit;">Expire<wbr>Time</a>
    ...
    <dd>{{% md %}}The time when the cluster expires.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#expired_csharp" style="color: inherit; text-decoration: inherit;">Expired</a>
    ...
    <dd>{{% md %}}Indicates whether the cluster has expired.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
...
<a href="#lockreason_csharp" style="color: inherit; text-decoration: inherit;">Lock<wbr>Reason</a>
    ...
    <dd>{{% md %}}The reason why the cluster is locked.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#maintaintime_csharp" style="color: inherit; text-decoration: inherit;">Maintain<wbr>Time</a>
    ...
    <dd>{{% md %}}The maintenance window of the cluster.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#port_csharp" style="color: inherit; text-decoration: inherit;">Port</a>
    ...
    <dd>{{% md %}}The port that is used to access the cluster.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#rdsinstanceid_csharp" style="color: inherit; text-decoration: inherit;">Rds<wbr>Instance<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of the ApsaraDB RDS instance from which data is synchronized to the cluster. This parameter is valid only for analytic instances.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#securityips_csharp" style="color: inherit; text-decoration: inherit;">Security<wbr>Ips</a>
    ...
    <dd>{{% md %}}List of IP addresses allowed to access all databases of an cluster.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="status_csharp">
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
...
<a href="#vpccloudinstanceid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Cloud<wbr>Instance<wbr>Id</a>
    ...
    <dd>{{% md %}}The vpc cloud instance id.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
