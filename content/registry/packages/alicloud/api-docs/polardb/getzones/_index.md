...
<a href="#multi_csharp" style="color: inherit; text-decoration: inherit;">Multi</a>
    ...
    <dd>{{% md %}}Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch PolarDB instances.
...
<a href="#zones_csharp" style="color: inherit; text-decoration: inherit;">Zones</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzoneszone">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Polar<wbr>DB.<wbr>Outputs.<wbr>Get<wbr>Zones<wbr>Zone&gt;</a></span>
    </dt>
