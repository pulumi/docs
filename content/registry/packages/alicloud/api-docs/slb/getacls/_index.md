...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_acls(</span><span class="nx">ids</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
...
<a href="#entrylists_csharp" style="color: inherit; text-decoration: inherit;">Entry<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getaclsaclentrylist">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Slb.<wbr>Inputs.<wbr>Get<wbr>Acls<wbr>Acl<wbr>Entry<wbr>List&gt;</a></span>
    </dt>
...
<a href="#relatedlisteners_csharp" style="color: inherit; text-decoration: inherit;">Related<wbr>Listeners</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getaclsaclrelatedlistener">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Slb.<wbr>Inputs.<wbr>Get<wbr>Acls<wbr>Acl<wbr>Related<wbr>Listener&gt;</a></span>
    </dt>
...
<a href="#entry_lists_python" style="color: inherit; text-decoration: inherit;">entry_<wbr>lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getaclsaclentrylist">Sequence[Get<wbr>Acls<wbr>Acl<wbr>Entry<wbr>List]</a></span>
    </dt>
    <dd>{{% md %}}A list of entry (IP addresses or CIDR blocks).  Each entry contains two sub-fields as `Entry Block` follows.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#related_listeners_python" style="color: inherit; text-decoration: inherit;">related_<wbr>listeners</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getaclsaclrelatedlistener">Sequence[Get<wbr>Acls<wbr>Acl<wbr>Related<wbr>Listener]</a></span>
    </dt>
    <dd>{{% md %}}A list of listener are attached by the acl.  Each listener contains four sub-fields as `Listener Block` follows.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
