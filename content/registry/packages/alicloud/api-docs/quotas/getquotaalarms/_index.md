...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_quota_alarms(</span><span class="nx">enable_details</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                     ...
                     <span class="nx">quota_alarm_name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                     <span class="nx">quota_dimensions</span><span class="p">:</span> <span class="nx">Optional[Sequence[GetQuotaAlarmsQuotaDimension]]</span> = None<span class="p">,</span>
                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetQuotaAlarmsResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetQuotaAlarms<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetQuotaAlarmsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetQuotaAlarmsResult</a></span>, error)</span></code></pre></div>
...
<a href="#quotadimensions_csharp" style="color: inherit; text-decoration: inherit;">Quota<wbr>Dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getquotaalarmsquotadimension">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Quotas.<wbr>Inputs.<wbr>Get<wbr>Quota<wbr>Alarms<wbr>Quota<wbr>Dimension&gt;</a></span>
    </dt>
...
<a href="#quotadimensions_csharp" style="color: inherit; text-decoration: inherit;">Quota<wbr>Dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getquotaalarmsalarmquotadimension">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Quotas.<wbr>Inputs.<wbr>Get<wbr>Quota<wbr>Alarms<wbr>Alarm<wbr>Quota<wbr>Dimension&gt;</a></span>
    </dt>
    <dd>{{% md %}}The Quota Dimensions.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#quota_dimensions_python" style="color: inherit; text-decoration: inherit;">quota_<wbr>dimensions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getquotaalarmsalarmquotadimension">Sequence[Get<wbr>Quota<wbr>Alarms<wbr>Alarm<wbr>Quota<wbr>Dimension]</a></span>
    </dt>
    <dd>{{% md %}}The Quota Dimensions.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
