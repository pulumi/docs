...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_registry_enterprise_repos(</span><span class="nx">enable_details</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
                                  ...
                                  <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetRegistryEnterpriseReposResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetRegistryEnterpriseRepos<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetRegistryEnterpriseReposArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetRegistryEnterpriseReposResult</a></span>, error)</span></code></pre></div>
...
<a href="#enabledetails_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Details</a>
    ...
    <dd>{{% md %}}Boolean, false by default, only repository attributes are exported. Set to true if tags belong to this repository are needed. See `tags` in attributes.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="ids_csharp">
<a href="#ids_csharp" style="color: inherit; text-decoration: inherit;">Ids</a>
    ...
    <dd>{{% md %}}A list of ids to filter results by repository id.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd>{{% md %}}Name of Container Registry Enterprise Edition namespace where the repositories are located in.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ids_csharp" style="color: inherit; text-decoration: inherit;">Ids</a>
    ...
    <dd>{{% md %}}A list of matched Container Registry Enterprise Edition repositories. Its element is a repository id.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="instanceid_csharp">
<a href="#instanceid_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Id</a>
...
<a href="#repos_csharp" style="color: inherit; text-decoration: inherit;">Repos</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepo">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>CS.<wbr>Outputs.<wbr>Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo&gt;</a></span>
    </dt>
...
<a href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd>{{% md %}}Name of Container Registry Enterprise Edition namespace where repo is located.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="outputfile_csharp">
<a href="#outputfile_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>File</a>
...
<a href="#repos_go" style="color: inherit; text-decoration: inherit;">Repos</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepo">[]Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo</a></span>
    </dt>
    <dd>{{% md %}}A list of matched Container Registry Enterprise Edition namespaces. Each element contains the following attributes:
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#repos_python" style="color: inherit; text-decoration: inherit;">repos</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepo">Sequence[Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo]</a></span>
    </dt>
    <dd>{{% md %}}A list of matched Container Registry Enterprise Edition namespaces. Each element contains the following attributes:
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd>{{% md %}}ID of Container Registry Enterprise Edition repository.
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of Container Registry Enterprise Edition repository.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="namespace_csharp">
<a href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepotag">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>CS.<wbr>Inputs.<wbr>Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo<wbr>Tag&gt;</a></span>
    </dt>
...
<a href="#tags_go" style="color: inherit; text-decoration: inherit;">Tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepotag">[]Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo<wbr>Tag</a></span>
    </dt>
    <dd>{{% md %}}A list of image tags belong to this repository. Each contains several attributes, see `Block Tag`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#tags_python" style="color: inherit; text-decoration: inherit;">tags</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregistryenterprisereposrepotag">Sequence[Get<wbr>Registry<wbr>Enterprise<wbr>Repos<wbr>Repo<wbr>Tag]</a></span>
    </dt>
    <dd>{{% md %}}A list of image tags belong to this repository. Each contains several attributes, see `Block Tag`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
