...
---
title: "getEcsNetworkInterfaces"
title_tag: "alicloud.ecs.getEcsNetworkInterfaces"
meta_desc: "Documentation for the alicloud.ecs.getEcsNetworkInterfaces function with examples, input properties, output properties, and supporting types."
layout: api
...
## Using getEcsNetworkInterfaces {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getEcsNetworkInterfaces<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetEcsNetworkInterfacesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetEcsNetworkInterfacesResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_ecs_network_interfaces(</span><span class="nx">ids</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">,</span>
                               ...
                               <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetEcsNetworkInterfacesResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetEcsNetworkInterfaces<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetEcsNetworkInterfacesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetEcsNetworkInterfacesResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetEcsNetworkInterfaces </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetEcsNetworkInterfacesResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetEcsNetworkInterfacesArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
<a href="#ids_csharp" style="color: inherit; text-decoration: inherit;">Ids</a>
    ...
    <dd>{{% md %}}A list of Network Interface IDs.
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The network interface name.
...
<a href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
    ...
    <dd>{{% md %}}A regex string to filter results by Network Interface name.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#servicemanaged_csharp" style="color: inherit; text-decoration: inherit;">Service<wbr>Managed</a>
    ...
    <dd>{{% md %}}Whether the user of the elastic network card is a cloud product or a virtual vendor.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
## getEcsNetworkInterfaces Result {#result}
...
<a href="#interfaces_csharp" style="color: inherit; text-decoration: inherit;">Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getecsnetworkinterfacesinterface">List&lt;Pulumi.<wbr>Ali<wbr>Cloud.<wbr>Ecs.<wbr>Outputs.<wbr>Get<wbr>Ecs<wbr>Network<wbr>Interfaces<wbr>Interface&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;name&#39; has been deprecated from provider version 1.123.1. New field &#39;network_interface_name&#39; instead{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="nameregex_csharp">
<a href="#nameregex_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Regex</a>
</span>
...
<a href="#privateip_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Ip</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Field &#39;private_ip&#39; has been deprecated from provider version 1.123.1. New field &#39;primary_ip_address&#39; instead{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="resourcegroupid_csharp">
<a href="#resourcegroupid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Id</a>
</span>
...
<a href="#interfaces_go" style="color: inherit; text-decoration: inherit;">Interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getecsnetworkinterfacesinterface">[]Get<wbr>Ecs<wbr>Network<wbr>Interfaces<wbr>Interface</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="names_go">
...
<a href="#interfaces_python" style="color: inherit; text-decoration: inherit;">interfaces</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getecsnetworkinterfacesinterface">Sequence[Get<wbr>Ecs<wbr>Network<wbr>Interfaces<wbr>Interface]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-"
            title="">
...
<h4 id="getecsnetworkinterfacesinterface">Get<wbr>Ecs<wbr>Network<wbr>Interfaces<wbr>Interface</h4>
...
<a href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd>{{% md %}}The description of the ENI.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="id_csharp">
<a href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
...
<a href="#queuenumber_csharp" style="color: inherit; text-decoration: inherit;">Queue<wbr>Number</a>
    ...
    <dd>{{% md %}}Number of network card queues.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="resourcegroupid_csharp">
<a href="#resourcegroupid_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Group<wbr>Id</a>
