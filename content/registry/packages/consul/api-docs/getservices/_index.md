...
---
title: "getServices"
title_tag: "consul.getServices"
meta_desc: "Documentation for the consul.getServices function with examples, input properties, output properties, and supporting types."
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_services(</span><span class="nx">query_options</span><span class="p">:</span> <span class="nx">Optional[Sequence[GetServicesQueryOption]]</span> = None<span class="p">,</span>
...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A map of the tags found for each service.  If more than one service
