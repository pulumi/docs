...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">AclToken</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">AclTokenArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<a href="#accessorid_csharp" style="color: inherit; text-decoration: inherit;">Accessor<wbr>Id</a>
    ...
    <dd>{{% md %}}The uuid of the token. If omitted, Consul will
...
<a href="#local_csharp" style="color: inherit; text-decoration: inherit;">Local</a>
    ...
    <dd>{{% md %}}The flag to set the token local to the current datacenter.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#policies_csharp" style="color: inherit; text-decoration: inherit;">Policies</a>
    ...
    <dd>{{% md %}}The list of policies attached to the token.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
