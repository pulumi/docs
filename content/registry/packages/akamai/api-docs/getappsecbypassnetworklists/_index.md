...
---
title: "getAppSecBypassNetworkLists"
title_tag: "akamai.getAppSecBypassNetworkLists"
meta_desc: "Documentation for the akamai.getAppSecBypassNetworkLists function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
...
## Using getAppSecBypassNetworkLists {#using}

{{< chooser language "typescript,python,go,csharp" / >}}


{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">function </span>getAppSecBypassNetworkLists<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetAppSecBypassNetworkListsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetAppSecBypassNetworkListsResult</a></span>></span></code></pre></div>
{{% /choosable %}}


{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span>get_app_sec_bypass_network_lists(</span><span class="nx">config_id</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
                                     <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> GetAppSecBypassNetworkListsResult</code></pre></div>
{{% /choosable %}}


{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetAppSecBypassNetworkLists<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetAppSecBypassNetworkListsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetAppSecBypassNetworkListsResult</a></span>, error)</span></code></pre></div>
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetAppSecBypassNetworkLists </span><span class="p">{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetAppSecBypassNetworkListsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetAppSecBypassNetworkListsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
{{% /choosable %}}
...
## getAppSecBypassNetworkLists Result {#result}
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="bypassnetworklists_csharp">
<a href="#bypassnetworklists_csharp" style="color: inherit; text-decoration: inherit;">Bypass<wbr>Network<wbr>Lists</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;string&gt;</span>
    </dt>
    <dd>{{% md %}}A list of strings containing the network list IDs.
...
<a href="#json_csharp" style="color: inherit; text-decoration: inherit;">Json</a>
    ...
    <dd>{{% md %}}A JSON-formatted list of information about the bypass network lists.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#outputtext_csharp" style="color: inherit; text-decoration: inherit;">Output<wbr>Text</a>
    ...
    <dd>{{% md %}}A tabular display showing the bypass network list information.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="bypassnetworklists_go">
<a href="#bypassnetworklists_go" style="color: inherit; text-decoration: inherit;">Bypass<wbr>Network<wbr>Lists</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]string</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="bypassnetworklists_nodejs">
<a href="#bypassnetworklists_nodejs" style="color: inherit; text-decoration: inherit;">bypass<wbr>Network<wbr>Lists</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string[]</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="bypass_network_lists_python">
<a href="#bypass_network_lists_python" style="color: inherit; text-decoration: inherit;">bypass_<wbr>network_<wbr>lists</a>
</span>
        <span class="property-indicator"></span>
