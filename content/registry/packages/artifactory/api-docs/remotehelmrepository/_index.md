...
<a href="#state_hardfail_go" style="color: inherit; text-decoration: inherit;">Hard<wbr>Fail</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_helmchartsbaseurl_go">
<a href="#state_helmchartsbaseurl_go" style="color: inherit; text-decoration: inherit;">Helm<wbr>Charts<wbr>Base<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_hardfail_nodejs" style="color: inherit; text-decoration: inherit;">hard<wbr>Fail</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_helmchartsbaseurl_nodejs">
<a href="#state_helmchartsbaseurl_nodejs" style="color: inherit; text-decoration: inherit;">helm<wbr>Charts<wbr>Base<wbr>Url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_hard_fail_python" style="color: inherit; text-decoration: inherit;">hard_<wbr>fail</a>
    ...
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="state_helm_charts_base_url_python">
<a href="#state_helm_charts_base_url_python" style="color: inherit; text-decoration: inherit;">helm_<wbr>charts_<wbr>base_<wbr>url</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<h4 id="remotehelmrepositorycontentsynchronisation">Remote<wbr>Helm<wbr>Repository<wbr>Content<wbr>Synchronisation</h4>
