...
<span class="k">def </span><span class="nx">LoadBalancer</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                 ...
                 <span class="nx">targets</span><span class="p">:</span> <span class="nx">Optional[Sequence[LoadBalancerTargetArgs]]</span> = None<span class="p">)</span>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">network_ip</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">network_zone</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">targets</span><span class="p">:</span> <span class="nx">Optional[Sequence[LoadBalancerTargetArgs]]</span> = None<span class="p">) -&gt;</span> LoadBalancer</code></pre></div>
{{% /choosable %}}
...
<a href="#useprivateip_csharp" style="color: inherit; text-decoration: inherit;">Use<wbr>Private<wbr>Ip</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Does not work. Use the hcloud_load_balancer_target resource instead.{{% /md %}}</p></dd></dl>
{{% /choosable %}}
