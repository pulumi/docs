...
><span class="k">def </span>get_images<span class="p">(</span><span class="nx">most_recent</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_images_output<span class="p">(</span><span class="nx">most_recent</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<a href="#images_csharp" style="color: inherit; text-decoration: inherit;">Images</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getimagesimage">List&lt;Pulumi.<wbr>HCloud.<wbr>Outputs.<wbr>Get<wbr>Images<wbr>Image&gt;</a></span>
    </dt>
    <dd>{{% md %}}(list) List of all matching images. See `data.hcloud_image` for schema.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="mostrecent_csharp">
<a href="#mostrecent_csharp" style="color: inherit; text-decoration: inherit;">Most<wbr>Recent</a>
...
<a href="#selector_csharp" style="color: inherit; text-decoration: inherit;">Selector</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Please use the with_selector property instead.{{% /md %}}</p></dd></dl>
{{% /choosable %}}
