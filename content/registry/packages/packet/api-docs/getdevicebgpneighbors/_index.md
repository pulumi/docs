...
title_tag: "packet.getDeviceBgpNeighbors"
meta_desc: "Documentation for the packet.getDeviceBgpNeighbors function with examples, input properties, output properties, and supporting types."
aliases:
    - "/docs/reference/pkg///"
layout: api
---
