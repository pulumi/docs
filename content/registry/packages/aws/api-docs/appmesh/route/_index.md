...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#weightedtargets_csharp" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Targets</a>
    ...
    <dd><p>The targets that traffic is routed to when a request matches the route.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#virtualnode_csharp" style="color: inherit; text-decoration: inherit;">Virtual<wbr>Node</a>
    ...
    <dd><p>The virtual node to associate with the weighted target. Must be between 1 and 255 characters in length.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#weight_csharp" style="color: inherit; text-decoration: inherit;">Weight</a>
    ...
    <dd><p>The relative weight of the weighted target. An integer between 0 and 100.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#metadatas_csharp" style="color: inherit; text-decoration: inherit;">Metadatas</a>
    ...
    <dd><p>The data to match from the gRPC request.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#methodname_csharp" style="color: inherit; text-decoration: inherit;">Method<wbr>Name</a>
    ...
    <dd><p>The method name to match from the request. If you specify a name, you must also specify a <code>service_name</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefix_csharp" style="color: inherit; text-decoration: inherit;">Prefix</a>
    ...
    <dd><p>The value sent by the client must begin with the specified characters. Must be between 1 and 255 characters in length.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>The name of the route. Must be between 1 and 50 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#match_csharp" style="color: inherit; text-decoration: inherit;">Match</a>
    ...
    <dd><p>The data to match from the request.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#exact_csharp" style="color: inherit; text-decoration: inherit;">Exact</a>
    ...
    <dd><p>The value sent by the client must match the specified value exactly. Must be between 1 and 255 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="prefix_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#prefix_csharp" style="color: inherit; text-decoration: inherit;">Prefix</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#range_csharp" style="color: inherit; text-decoration: inherit;">Range</a>
    ...
    <dd><p>The object that specifies the range of numbers that the value sent by the client must be included in.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#regex_csharp" style="color: inherit; text-decoration: inherit;">Regex</a>
    ...
    <dd><p>The value sent by the client must include the specified characters. Must be between 1 and 255 characters in length.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#suffix_csharp" style="color: inherit; text-decoration: inherit;">Suffix</a>
    ...
    <dd><p>The value sent by the client must end with the specified characters. Must be between 1 and 255 characters in length.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#maxretries_csharp" style="color: inherit; text-decoration: inherit;">Max<wbr>Retries</a>
    ...
    <dd><p>The maximum number of retries.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#headers_csharp" style="color: inherit; text-decoration: inherit;">Headers</a>
    ...
    <dd><p>The client request headers to match on.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#method_csharp" style="color: inherit; text-decoration: inherit;">Method</a>
    ...
    <dd><p>The client request header method to match on. Valid values: <code>GET</code>, <code>HEAD</code>, <code>POST</code>, <code>PUT</code>, <code>DELETE</code>, <code>CONNECT</code>, <code>OPTIONS</code>, <code>TRACE</code>, <code>PATCH</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scheme_csharp" style="color: inherit; text-decoration: inherit;">Scheme</a>
    ...
    <dd><p>The client request header scheme to match on. Valid values: <code>http</code>, <code>https</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#match_csharp" style="color: inherit; text-decoration: inherit;">Match</a>
    ...
    <dd><p>The method and value to match the header value sent with a request. Specify one match method.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#match_csharp" style="color: inherit; text-decoration: inherit;">Match</a>
    ...
    <dd><p>The criteria for determining an HTTP request match.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="retrypolicy_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retrypolicy_csharp" style="color: inherit; text-decoration: inherit;">Retry<wbr>Policy</a>
