...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#domainname_csharp" style="color: inherit; text-decoration: inherit;">Domain<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the registered domain.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#admincontact_csharp" style="color: inherit; text-decoration: inherit;">Admin<wbr>Contact</a>
    ...
    <dd>{{% md %}}Details about the domain administrative contact.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#adminprivacy_csharp" style="color: inherit; text-decoration: inherit;">Admin<wbr>Privacy</a>
    ...
    <dd>{{% md %}}Whether domain administrative contact information is concealed from WHOIS queries. Default: `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autorenew_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Renew</a>
    ...
    <dd>{{% md %}}Whether the domain registration is set to renew automatically. Default: `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameservers_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Servers</a>
    ...
    <dd>{{% md %}}The list of nameservers for the domain.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registrantcontact_csharp" style="color: inherit; text-decoration: inherit;">Registrant<wbr>Contact</a>
    ...
    <dd>{{% md %}}Details about the domain registrant.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registrantprivacy_csharp" style="color: inherit; text-decoration: inherit;">Registrant<wbr>Privacy</a>
    ...
    <dd>{{% md %}}Whether domain registrant contact information is concealed from WHOIS queries. Default: `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#techcontact_csharp" style="color: inherit; text-decoration: inherit;">Tech<wbr>Contact</a>
    ...
    <dd>{{% md %}}Details about the domain technical contact.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#techprivacy_csharp" style="color: inherit; text-decoration: inherit;">Tech<wbr>Privacy</a>
    ...
    <dd>{{% md %}}Whether domain technical contact information is concealed from WHOIS queries. Default: `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#transferlock_csharp" style="color: inherit; text-decoration: inherit;">Transfer<wbr>Lock</a>
    ...
    <dd>{{% md %}}Whether the domain is locked for transfer. Default: `true`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#abusecontactemail_csharp" style="color: inherit; text-decoration: inherit;">Abuse<wbr>Contact<wbr>Email</a>
    ...
    <dd>{{% md %}}Email address to contact to report incorrect contact information for a domain, to report that the domain is being used to send spam, to report that someone is cybersquatting on a domain name, or report some other type of abuse.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#abusecontactphone_csharp" style="color: inherit; text-decoration: inherit;">Abuse<wbr>Contact<wbr>Phone</a>
    ...
    <dd>{{% md %}}Phone number for reporting abuse.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#creationdate_csharp" style="color: inherit; text-decoration: inherit;">Creation<wbr>Date</a>
    ...
    <dd>{{% md %}}The date when the domain was created as found in the response to a WHOIS query.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#expirationdate_csharp" style="color: inherit; text-decoration: inherit;">Expiration<wbr>Date</a>
    ...
    <dd>{{% md %}}The date when the registration for the domain is set to expire.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registrarname_csharp" style="color: inherit; text-decoration: inherit;">Registrar<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the registrar of the domain as identified in the registry.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#registrarurl_csharp" style="color: inherit; text-decoration: inherit;">Registrar<wbr>Url</a>
    ...
    <dd>{{% md %}}Web address of the registrar.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statuslists_csharp" style="color: inherit; text-decoration: inherit;">Status<wbr>Lists</a>
    ...
    <dd>{{% md %}}List of [domain name status codes](https://www.icann.org/resources/pages/epp-status-codes-2014-06-16-en).
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#updateddate_csharp" style="color: inherit; text-decoration: inherit;">Updated<wbr>Date</a>
    ...
    <dd>{{% md %}}The last updated date of the domain as found in the response to a WHOIS query.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#whoisserver_csharp" style="color: inherit; text-decoration: inherit;">Whois<wbr>Server</a>
    ...
    <dd>{{% md %}}The fully qualified name of the WHOIS server that can answer the WHOIS query for the domain.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#addressline1_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Line1</a>
    ...
    <dd>{{% md %}}First line of the contact's address.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#addressline2_csharp" style="color: inherit; text-decoration: inherit;">Address<wbr>Line2</a>
    ...
    <dd>{{% md %}}Second line of contact's address, if any.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="city_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#city_csharp" style="color: inherit; text-decoration: inherit;">City</a>
    ...
    <dd>{{% md %}}The city of the contact's address.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#contacttype_csharp" style="color: inherit; text-decoration: inherit;">Contact<wbr>Type</a>
    ...
    <dd>{{% md %}}Indicates whether the contact is a person, company, association, or public organization. See the [AWS API documentation](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html#Route53Domains-Type-domains_ContactDetail-ContactType) for valid values.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#countrycode_csharp" style="color: inherit; text-decoration: inherit;">Country<wbr>Code</a>
    ...
    <dd>{{% md %}}Code for the country of the contact's address. See the [AWS API documentation](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html#Route53Domains-Type-domains_ContactDetail-CountryCode) for valid values.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#email_csharp" style="color: inherit; text-decoration: inherit;">Email</a>
    ...
    <dd>{{% md %}}Email address of the contact.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extraparams_csharp" style="color: inherit; text-decoration: inherit;">Extra<wbr>Params</a>
    ...
    <dd>{{% md %}}A key-value map of parameters required by certain top-level domains.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="fax_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fax_csharp" style="color: inherit; text-decoration: inherit;">Fax</a>
    ...
    <dd>{{% md %}}Fax number of the contact. Phone number must be specified in the format "+[country dialing code].[number including any area code]".
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#organizationname_csharp" style="color: inherit; text-decoration: inherit;">Organization<wbr>Name</a>
    ...
    <dd>{{% md %}}Name of the organization for contact types other than `PERSON`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#phonenumber_csharp" style="color: inherit; text-decoration: inherit;">Phone<wbr>Number</a>
    ...
    <dd>{{% md %}}The phone number of the contact. Phone number must be specified in the format "+[country dialing code].[number including any area code]".
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The state or province of the contact's city.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#zipcode_csharp" style="color: inherit; text-decoration: inherit;">Zip<wbr>Code</a>
    ...
    <dd>{{% md %}}The zip or postal code of the contact's address.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}The fully qualified host name of the name server.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#glueips_csharp" style="color: inherit; text-decoration: inherit;">Glue<wbr>Ips</a>
    ...
    <dd>{{% md %}}Glue IP addresses of a name server. The list can contain only one IPv4 and one IPv6 address.
{{% /md %}}</dd></dl>
{{% /choosable %}}
