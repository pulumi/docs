...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timeout_csharp" style="color: inherit; text-decoration: inherit;">Timeout</a>
    ...
    <dd><p>The job timeout in minutes. The default is 2880 minutes (48 hours) for <code>glueetl</code> and <code>pythonshell</code> jobs, and null (unlimted) for <code>gluestreaming</code> jobs.</p>
</dd><dt class="property-optional"
            title="Optional">
