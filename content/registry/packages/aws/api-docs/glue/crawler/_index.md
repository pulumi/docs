...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#connectionname_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the connection to use to connect to the Delta table target.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deltatables_csharp" style="color: inherit; text-decoration: inherit;">Delta<wbr>Tables</a>
    ...
    <dd>{{% md %}}A list of the Amazon S3 paths to the Delta tables.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#writemanifest_csharp" style="color: inherit; text-decoration: inherit;">Write<wbr>Manifest</a>
    ...
    <dd>{{% md %}}Specifies whether to write the manifest files to the Delta table path.
{{% /md %}}</dd></dl>
{{% /choosable %}}
