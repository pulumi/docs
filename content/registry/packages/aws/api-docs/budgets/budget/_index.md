...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use the attribute &#34;cost_filter&#34; instead.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#costfilters_csharp" style="color: inherit; text-decoration: inherit;">Cost<wbr>Filters</a>
    ...
    <dd>{{% md %}}A list of CostFilter name/values pair to apply to budget.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
