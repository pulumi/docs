...
## Create a EcsClusterLayer Resource {#create}
{{< chooser language "typescript,python,go,csharp" / >}}
...
The EcsClusterLayer resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ecsclusterarn_csharp" style="color: inherit; text-decoration: inherit;">Ecs<wbr>Cluster<wbr>Arn</a>
    ...
    <dd>{{% md %}}The ECS Cluster ARN of the layer.
...
## Look up an Existing EcsClusterLayer Resource {#look-up}
