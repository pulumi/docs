...
<a href="#cloudwatchconfiguration_csharp" style="color: inherit; text-decoration: inherit;">Cloudwatch<wbr>Configuration</a>
    ...
    <dd>{{% md %}}Will create an EBS volume and connect it to the layer's instances. See Cloudwatch Configuration.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#ebsvolumes_csharp" style="color: inherit; text-decoration: inherit;">Ebs<wbr>Volumes</a>
    ...
    <dd>{{% md %}}Will create an EBS volume and connect it to the layer's instances. See EBS Volume.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#logstreams_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Streams</a>
    ...
    <dd>{{% md %}}A block the specifies how an opsworks logs look like. See Log Streams.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#file_csharp" style="color: inherit; text-decoration: inherit;">File</a>
    ...
    <dd>{{% md %}}Specifies log files that you want to push to CloudWatch Logs. File can point to a specific file or multiple files (by using wild card characters such as /var/log/system.log*).
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#loggroupname_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Group<wbr>Name</a>
    ...
    <dd>{{% md %}}Specifies the destination log group. A log group is created automatically if it doesn't already exist.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#batchcount_csharp" style="color: inherit; text-decoration: inherit;">Batch<wbr>Count</a>
    ...
    <dd>{{% md %}}Specifies the max number of log events in a batch, up to `10000`. The default value is `1000`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#batchsize_csharp" style="color: inherit; text-decoration: inherit;">Batch<wbr>Size</a>
    ...
    <dd>{{% md %}}Specifies the maximum size of log events in a batch, in bytes, up to `1048576` bytes. The default value is `32768` bytes.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#bufferduration_csharp" style="color: inherit; text-decoration: inherit;">Buffer<wbr>Duration</a>
    ...
    <dd>{{% md %}}Specifies the time duration for the batching of log events. The minimum value is `5000` and default value is `5000`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#datetimeformat_csharp" style="color: inherit; text-decoration: inherit;">Datetime<wbr>Format</a>
    ...
    <dd>{{% md %}}Specifies how the timestamp is extracted from logs. For more information, see the CloudWatch Logs Agent Reference (https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AgentReference.html).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#encoding_csharp" style="color: inherit; text-decoration: inherit;">Encoding</a>
    ...
    <dd>{{% md %}}Specifies the encoding of the log file so that the file can be read correctly. The default is `utf_8`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#filefingerprintlines_csharp" style="color: inherit; text-decoration: inherit;">File<wbr>Fingerprint<wbr>Lines</a>
    ...
    <dd>{{% md %}}Specifies the range of lines for identifying a file. The valid values are one number, or two dash-delimited numbers, such as `1`, `2-5`. The default value is `1`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#initialposition_csharp" style="color: inherit; text-decoration: inherit;">Initial<wbr>Position</a>
    ...
    <dd>{{% md %}}Specifies where to start to read data (`start_of_file` or `end_of_file`). The default is `start_of_file`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#multilinestartpattern_csharp" style="color: inherit; text-decoration: inherit;">Multiline<wbr>Start<wbr>Pattern</a>
    ...
    <dd>{{% md %}}Specifies the pattern for identifying the start of a log message.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#timezone_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Zone</a>
    ...
    <dd>{{% md %}}Specifies the time zone of log event time stamps.
{{% /md %}}</dd></dl>
{{% /choosable %}}
