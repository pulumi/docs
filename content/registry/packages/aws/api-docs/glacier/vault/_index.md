...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:glacier:Vault</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#notification_yaml" style="color: inherit; text-decoration: inherit;">notification</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#vaultnotification">Property Map</a></span>
    </dt>
    <dd><p>The notifications for the Vault. Fields documented below.</p>
</dd><dt class="property-optional"
            title="Optional">
