...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:autoscaling:Schedule</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalinggroupname_java" style="color: inherit; text-decoration: inherit;">autoscaling<wbr>Group<wbr>Name</a>
    ...
    <dd><p>The name or Amazon Resource Name (ARN) of the Auto Scaling group.</p>
            ...
            title="Required">
        <span id="scheduledactionname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scheduledactionname_java" style="color: inherit; text-decoration: inherit;">scheduled<wbr>Action<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autoscalinggroupname_yaml" style="color: inherit; text-decoration: inherit;">autoscaling<wbr>Group<wbr>Name</a>
    ...
    <dd><p>The name or Amazon Resource Name (ARN) of the Auto Scaling group.</p>
            ...
            title="Required">
        <span id="scheduledactionname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#scheduledactionname_yaml" style="color: inherit; text-decoration: inherit;">scheduled<wbr>Action<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_recurrence_java" style="color: inherit; text-decoration: inherit;">recurrence</a>
    ...
    <dd><p>The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format.</p>
            ...
            title="Optional">
        <span id="state_scheduledactionname_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scheduledactionname_java" style="color: inherit; text-decoration: inherit;">scheduled<wbr>Action<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_recurrence_yaml" style="color: inherit; text-decoration: inherit;">recurrence</a>
    ...
    <dd><p>The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format.</p>
            ...
            title="Optional">
        <span id="state_scheduledactionname_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_scheduledactionname_yaml" style="color: inherit; text-decoration: inherit;">scheduled<wbr>Action<wbr>Name</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
