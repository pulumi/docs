...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#initialvariantweight_csharp" style="color: inherit; text-decoration: inherit;">Initial<wbr>Variant<wbr>Weight</a>
    ...
    <dd><p>Determines initial traffic distribution among all of the models that you specify in the endpoint configuration. If unspecified, it defaults to 1.0.</p>
</dd><dt class="property-optional"
            title="Optional">
