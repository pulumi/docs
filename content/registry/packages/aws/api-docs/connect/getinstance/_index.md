...
><span class="k">def </span>get_instance<span class="p">(</span><span class="nx">instance_alias</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_instance_output<span class="p">(</span><span class="nx">instance_alias</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
