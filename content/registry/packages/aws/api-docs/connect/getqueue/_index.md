...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Returns information on a specific Queue by name
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#queueid_csharp" style="color: inherit; text-decoration: inherit;">Queue<wbr>Id</a>
    ...
    <dd>{{% md %}}Returns information on a specific Queue by Queue id
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A map of tags assigned to the Queue.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Specifies the description of the Queue. Values are `ENABLED` or `DISABLED`.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outboundflowid_csharp" style="color: inherit; text-decoration: inherit;">Outbound<wbr>Flow<wbr>Id</a>
    ...
    <dd>{{% md %}}Specifies the outbound whisper flow to be used during an outbound call.
{{% /md %}}</dd></dl>
{{% /choosable %}}
