...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A map of tags to assign to the Hours of Operation.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#hoursofoperationarn_csharp" style="color: inherit; text-decoration: inherit;">Hours<wbr>Of<wbr>Operation<wbr>Arn</a>
    ...
    <dd>{{% md %}}(**Deprecated**) The Amazon Resource Name (ARN) of the Hours of Operation.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}use &#39;arn&#39; attribute instead{{% /md %}}</p></dd><dt class="property-"
            title="">
        <span id="hoursofoperationid_csharp">
<a href="#hoursofoperationid_csharp" style="color: inherit; text-decoration: inherit;">Hours<wbr>Of<wbr>Operation<wbr>Id</a>
</span>
