...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}(**Deprecated** use the `enabled` attribute instead) Status of the certificate authority.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}The reported value of the &#34;status&#34; attribute is often inaccurate. Use the resource&#39;s &#34;enabled&#34; attribute to explicitly set status.{{% /md %}}</p></dd><dt class="property-"
            title="">
...
<a href="#state_status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}(**Deprecated** use the `enabled` attribute instead) Status of the certificate authority.
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}The reported value of the &#34;status&#34; attribute is often inaccurate. Use the resource&#39;s &#34;enabled&#34; attribute to explicitly set status.{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
