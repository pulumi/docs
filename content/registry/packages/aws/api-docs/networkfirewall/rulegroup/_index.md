...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#statefulruleoptions_csharp" style="color: inherit; text-decoration: inherit;">Stateful<wbr>Rule<wbr>Options</a>
    ...
    <dd>{{% md %}}A configuration block that defines stateful rule options for the rule group. See Stateful Rule Options below for details.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ruleorder_csharp" style="color: inherit; text-decoration: inherit;">Rule<wbr>Order</a>
    ...
    <dd>{{% md %}}Indicates how to manage the order of the rule evaluation for the rule group. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
