...
e.g., <code>CONTAINS</code>, <code>CONTAINS_WORD</code> or <code>EXACTLY</code>.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#targetstring_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>String</a>
    ...
    <dd><p>The value that you want to search forE.g., <code>HEADER</code>, <code>METHOD</code> or <code>BODY</code>.
See <a href="http://docs.aws.amazon.com/waf/latest/APIReference/API_ByteMatchTuple.html#WAF-Type-ByteMatchTuple-TargetString">docs</a>
for all supported values.</p>
</dd></dl>
</pulumi-choosable>
</div>
