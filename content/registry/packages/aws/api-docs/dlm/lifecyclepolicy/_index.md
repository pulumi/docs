...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retainrule_csharp" style="color: inherit; text-decoration: inherit;">Retain<wbr>Rule</a>
    ...
    <dd>{{% md %}}The retention rule that indicates how long snapshot copies are to be retained in the destination Region. See the `retain_rule` block. Max of 1 per schedule.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#copytags_csharp" style="color: inherit; text-decoration: inherit;">Copy<wbr>Tags</a>
    ...
    <dd>{{% md %}}Whether to copy all user-defined tags from the source snapshot to the cross-region snapshot copy.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#crossregioncopyrules_csharp" style="color: inherit; text-decoration: inherit;">Cross<wbr>Region<wbr>Copy<wbr>Rules</a>
    ...
    <dd>{{% md %}}See the `cross_region_copy_rule` block. Max of 3 per schedule.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#interval_csharp" style="color: inherit; text-decoration: inherit;">Interval</a>
    ...
    <dd>{{% md %}}The amount of time to retain each snapshot. The maximum is 100 years. This is equivalent to 1200 months, 5200 weeks, or 36500 days.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#intervalunit_csharp" style="color: inherit; text-decoration: inherit;">Interval<wbr>Unit</a>
    ...
    <dd>{{% md %}}The unit of time for time-based retention. Valid values: `DAYS`, `WEEKS`, `MONTHS`, or `YEARS`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#encrypted_csharp" style="color: inherit; text-decoration: inherit;">Encrypted</a>
    ...
    <dd>{{% md %}}To encrypt a copy of an unencrypted snapshot if encryption by default is not enabled, enable encryption using this parameter. Copies of encrypted snapshots are encrypted, even if this parameter is false or if encryption by default is not enabled.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#target_csharp" style="color: inherit; text-decoration: inherit;">Target</a>
    ...
    <dd>{{% md %}}The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cmkarn_csharp" style="color: inherit; text-decoration: inherit;">Cmk<wbr>Arn</a>
    ...
    <dd>{{% md %}}The Amazon Resource Name (ARN) of the AWS KMS customer master key (CMK) to use for EBS encryption. If this argument is not specified, the default KMS key for the account is used.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="copytags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#copytags_csharp" style="color: inherit; text-decoration: inherit;">Copy<wbr>Tags</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#deprecaterule_csharp" style="color: inherit; text-decoration: inherit;">Deprecate<wbr>Rule</a>
    ...
    <dd>{{% md %}}The AMI deprecation rule for cross-Region AMI copies created by the rule. See the `deprecate_rule` block.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="retainrule_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retainrule_csharp" style="color: inherit; text-decoration: inherit;">Retain<wbr>Rule</a>
