...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#carriergatewayid_csharp" style="color: inherit; text-decoration: inherit;">Carrier<wbr>Gateway<wbr>Id</a>
    ...
    <dd>{{% md %}}Identifier of a carrier gateway. This attribute can only be used when the VPC contains a subnet which is associated with a Wavelength Zone.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#destinationprefixlistid_csharp" style="color: inherit; text-decoration: inherit;">Destination<wbr>Prefix<wbr>List<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID of a managed prefix list destination.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use network_interface_id instead{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceownerid_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Owner<wbr>Id</a>
    ...
    <dd>{{% md %}}The AWS account ID of the owner of the EC2 instance.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#origin_csharp" style="color: inherit; text-decoration: inherit;">Origin</a>
    ...
    <dd>{{% md %}}How the route was created - `CreateRouteTable`, `CreateRoute` or `EnableVgwRoutePropagation`.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd>{{% md %}}The state of the route - `active` or `blackhole`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
