...
<a href="#availabilityzoneid_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Zone<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of the Availability Zone for the subnet. This argument is not supported in all regions or partitions. If necessary, use `availability_zone` instead.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#enabledns64_csharp" style="color: inherit; text-decoration: inherit;">Enable<wbr>Dns64</a>
    ...
    <dd>{{% md %}}Indicates whether DNS queries made to the Amazon-provided DNS Resolver in this subnet return synthetic IPv6 addresses for IPv4-only destinations.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ipv6native_csharp" style="color: inherit; text-decoration: inherit;">Ipv6Native</a>
    ...
    <dd>{{% md %}}Indicates whether this is an IPv6-only subnet.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#privatednshostnametypeonlaunch_csharp" style="color: inherit; text-decoration: inherit;">Private<wbr>Dns<wbr>Hostname<wbr>Type<wbr>On<wbr>Launch</a>
    ...
    <dd>{{% md %}}The type of hostnames assigned to instances in the subnet at launch.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="state_csharp">
<a href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
