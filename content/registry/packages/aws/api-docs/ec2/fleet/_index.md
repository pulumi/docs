...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#allocationstrategy_csharp" style="color: inherit; text-decoration: inherit;">Allocation<wbr>Strategy</a>
    ...
    <dd><p>How to allocate the target capacity across the Spot pools. Valid values: <code>diversified</code>, <code>lowestPrice</code>. Default: <code>lowestPrice</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
