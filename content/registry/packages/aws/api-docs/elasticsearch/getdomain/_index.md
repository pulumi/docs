...
<a href="#autotuneoptions_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Tune<wbr>Options</a>
    ...
    <dd>{{% md %}}Configuration of the Auto-Tune options of the domain.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#desiredstate_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>State</a>
    ...
    <dd>{{% md %}}The Auto-Tune desired state for the domain.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#maintenanceschedules_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Schedules</a>
    ...
    <dd>{{% md %}}A list of the nested configurations for the Auto-Tune maintenance windows of the domain.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#rollbackondisable_csharp" style="color: inherit; text-decoration: inherit;">Rollback<wbr>On<wbr>Disable</a>
    ...
    <dd>{{% md %}}Whether the domain is set to roll back to default Auto-Tune settings when disabling Auto-Tune.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#durations_csharp" style="color: inherit; text-decoration: inherit;">Durations</a>
    ...
    <dd>{{% md %}}Configuration block for the duration of the Auto-Tune maintenance window.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#startat_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>At</a>
    ...
    <dd>{{% md %}}Date and time at which the Auto-Tune maintenance schedule starts in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
    ...
    <dd>{{% md %}}The unit of time specifying the duration of an Auto-Tune maintenance window.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
