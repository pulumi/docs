...
<a href="#autotuneoptions_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Configuration block for the Auto-Tune options of the domain. Detailed below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#elasticsearchversion_csharp" style="color: inherit; text-decoration: inherit;">Elasticsearch<wbr>Version</a>
    ...
    <dd>{{% md %}}Version of Elasticsearch to deploy. Defaults to `1.5`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#snapshotoptions_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Options</a>
    ...
    <dd>{{% md %}}Configuration block for snapshot related options. Detailed below. DEPRECATED. For domains running Elasticsearch 5.3 and later, Amazon ES takes hourly automated snapshots, making this setting irrelevant. For domains running earlier versions of Elasticsearch, Amazon ES takes daily automated snapshots.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#autotuneoptions_go" style="color: inherit; text-decoration: inherit;">Auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#autotuneoptions_nodejs" style="color: inherit; text-decoration: inherit;">auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#auto_tune_options_python" style="color: inherit; text-decoration: inherit;">auto_<wbr>tune_<wbr>options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#state_autotuneoptions_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#state_autotuneoptions_go" style="color: inherit; text-decoration: inherit;">Auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#state_autotuneoptions_nodejs" style="color: inherit; text-decoration: inherit;">auto<wbr>Tune<wbr>Options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#state_auto_tune_options_python" style="color: inherit; text-decoration: inherit;">auto_<wbr>tune_<wbr>options</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptions">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Args</a></span>
    </dt>
...
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
    ...
    <dd>{{% md %}}Whether to enable node-to-node encryption. If the `node_to_node_encryption` block is not provided then this defaults to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#masteruserarn_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Arn</a>
    ...
    <dd>{{% md %}}ARN for the main user. Only specify if `internal_user_database_enabled` is not set or set to `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#masterusername_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Name</a>
    ...
    <dd>{{% md %}}Main user's username, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#masteruserpassword_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>User<wbr>Password</a>
    ...
    <dd>{{% md %}}Main user's password, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#desiredstate_csharp" style="color: inherit; text-decoration: inherit;">Desired<wbr>State</a>
    ...
    <dd>{{% md %}}The Auto-Tune desired state for the domain. Valid values: `ENABLED` or `DISABLED`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="maintenanceschedules_csharp">
<a href="#maintenanceschedules_csharp" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Schedules</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dd>{{% md %}}Configuration block for Auto-Tune maintenance windows. Can be specified multiple times for each maintenance window. Detailed below.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="rollbackondisable_csharp">
<a href="#rollbackondisable_csharp" style="color: inherit; text-decoration: inherit;">Rollback<wbr>On<wbr>Disable</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}Whether to roll back to default Auto-Tune settings when disabling Auto-Tune. Valid values: `DEFAULT_ROLLBACK` or `NO_ROLLBACK`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#maintenanceschedules_go" style="color: inherit; text-decoration: inherit;">Maintenance<wbr>Schedules</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#rollbackondisable_go" style="color: inherit; text-decoration: inherit;">Rollback<wbr>On<wbr>Disable</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#maintenanceschedules_nodejs" style="color: inherit; text-decoration: inherit;">maintenance<wbr>Schedules</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#domainautotuneoptionsmaintenanceschedule">Domain<wbr>Auto<wbr>Tune<wbr>Options<wbr>Maintenance<wbr>Schedule[]</a></span>
    </dt>
...
<a href="#rollbackondisable_nodejs" style="color: inherit; text-decoration: inherit;">rollback<wbr>On<wbr>Disable</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#maintenance_schedules_python" style="color: inherit; text-decoration: inherit;">maintenance_<wbr>schedules</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#rollback_on_disable_python" style="color: inherit; text-decoration: inherit;">rollback_<wbr>on_<wbr>disable</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#cronexpressionforrecurrence_csharp" style="color: inherit; text-decoration: inherit;">Cron<wbr>Expression<wbr>For<wbr>Recurrence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd>{{% md %}}A cron expression specifying the recurrence pattern for an Auto-Tune maintenance schedule.
...
<a href="#duration_csharp" style="color: inherit; text-decoration: inherit;">Duration</a>
    ...
    <dd>{{% md %}}Configuration block for the duration of the Auto-Tune maintenance window. Detailed below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#startat_csharp" style="color: inherit; text-decoration: inherit;">Start<wbr>At</a>
    ...
    <dd>{{% md %}}Date and time at which to start the Auto-Tune maintenance schedule in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#cronexpressionforrecurrence_go" style="color: inherit; text-decoration: inherit;">Cron<wbr>Expression<wbr>For<wbr>Recurrence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#cronexpressionforrecurrence_nodejs" style="color: inherit; text-decoration: inherit;">cron<wbr>Expression<wbr>For<wbr>Recurrence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#cron_expression_for_recurrence_python" style="color: inherit; text-decoration: inherit;">cron_<wbr>expression_<wbr>for_<wbr>recurrence</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#unit_csharp" style="color: inherit; text-decoration: inherit;">Unit</a>
    ...
    <dd>{{% md %}}The unit of time specifying the duration of an Auto-Tune maintenance window. Valid values: `HOURS`.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#value_csharp" style="color: inherit; text-decoration: inherit;">Value</a>
    ...
    <dd>{{% md %}}An integer specifying the value of the duration of an Auto-Tune maintenance window.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#dedicatedmastercount_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Master<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of dedicated main nodes in the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dedicatedmasterenabled_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Master<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Whether dedicated main nodes are enabled for the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#dedicatedmastertype_csharp" style="color: inherit; text-decoration: inherit;">Dedicated<wbr>Master<wbr>Type</a>
    ...
    <dd>{{% md %}}Instance type of the dedicated main nodes in the cluster.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#warmcount_csharp" style="color: inherit; text-decoration: inherit;">Warm<wbr>Count</a>
    ...
    <dd>{{% md %}}Number of warm nodes in the cluster. Valid values are between `2` and `150`. `warm_count` can be only and must be set when `warm_enabled` is set to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#warmenabled_csharp" style="color: inherit; text-decoration: inherit;">Warm<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Whether to enable warm storage.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#warmtype_csharp" style="color: inherit; text-decoration: inherit;">Warm<wbr>Type</a>
    ...
    <dd>{{% md %}}Instance type for the Elasticsearch cluster's warm nodes. Valid values are `ultrawarm1.medium.elasticsearch`, `ultrawarm1.large.elasticsearch` and `ultrawarm1.xlarge.elasticsearch`. `warm_type` can be only and must be set when `warm_enabled` is set to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#zoneawarenessenabled_csharp" style="color: inherit; text-decoration: inherit;">Zone<wbr>Awareness<wbr>Enabled</a>
    ...
    <dd>{{% md %}}Whether zone awareness is enabled, set to `true` for multi-az deployment. To enable awareness with three Availability Zones, the `availability_zone_count` within the `zone_awareness_config` must be set to `3`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#iops_csharp" style="color: inherit; text-decoration: inherit;">Iops</a>
    ...
    <dd>{{% md %}}Baseline input/output (I/O) performance of EBS volumes attached to data nodes. Applicable only for the Provisioned IOPS EBS volume type.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#volumesize_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Size</a>
    ...
    <dd>{{% md %}}Size of EBS volumes attached to data nodes (in GiB).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#volumetype_csharp" style="color: inherit; text-decoration: inherit;">Volume<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of EBS volumes attached to data nodes.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#kmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Kms<wbr>Key<wbr>Id</a>
    ...
    <dd>{{% md %}}KMS key id to encrypt the Elasticsearch domain with. If not specified then it defaults to using the `aws/es` service KMS key.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#logtype_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of Elasticsearch log. Valid values: `INDEX_SLOW_LOGS`, `SEARCH_SLOW_LOGS`, `ES_APPLICATION_LOGS`, `AUDIT_LOGS`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="enabled_csharp">
<a href="#enabled_csharp" style="color: inherit; text-decoration: inherit;">Enabled</a>
