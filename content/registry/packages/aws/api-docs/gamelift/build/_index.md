...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#operatingsystem_csharp" style="color: inherit; text-decoration: inherit;">Operating<wbr>System</a>
    ...
    <dd>{{% md %}}Operating system that the game server binaries are built to run onE.g., `WINDOWS_2012`, `AMAZON_LINUX` or `AMAZON_LINUX_2`.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#objectversion_csharp" style="color: inherit; text-decoration: inherit;">Object<wbr>Version</a>
    ...
    <dd>{{% md %}}A specific version of the file. If not set, the latest version of the file is retrieved.
{{% /md %}}</dd></dl>
{{% /choosable %}}
