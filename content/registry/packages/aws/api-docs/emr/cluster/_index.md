...
<a href="#logencryptionkmskeyid_go" style="color: inherit; text-decoration: inherit;">Log<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#autoterminationpolicy_nodejs" style="color: inherit; text-decoration: inherit;">auto<wbr>Termination<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#logencryptionkmskeyid_nodejs" style="color: inherit; text-decoration: inherit;">log<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#auto_termination_policy_python" style="color: inherit; text-decoration: inherit;">auto_<wbr>termination_<wbr>policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#log_encryption_kms_key_id_python" style="color: inherit; text-decoration: inherit;">log_<wbr>encryption_<wbr>kms_<wbr>key_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#masterpublicdns_csharp" style="color: inherit; text-decoration: inherit;">Master<wbr>Public<wbr>Dns</a>
    ...
    <dd>{{% md %}}The DNS name of the master node. If the cluster is on a private subnet, this is the private DNS name. On a public subnet, this is the public DNS name.
...
<a href="#state_autoterminationpolicy_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Termination<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#state_logencryptionkmskeyid_csharp" style="color: inherit; text-decoration: inherit;">Log<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_autoterminationpolicy_go" style="color: inherit; text-decoration: inherit;">Auto<wbr>Termination<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#state_logencryptionkmskeyid_go" style="color: inherit; text-decoration: inherit;">Log<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_autoterminationpolicy_nodejs" style="color: inherit; text-decoration: inherit;">auto<wbr>Termination<wbr>Policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#state_logencryptionkmskeyid_nodejs" style="color: inherit; text-decoration: inherit;">log<wbr>Encryption<wbr>Kms<wbr>Key<wbr>Id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a href="#state_auto_termination_policy_python" style="color: inherit; text-decoration: inherit;">auto_<wbr>termination_<wbr>policy</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clusterautoterminationpolicy">Cluster<wbr>Auto<wbr>Termination<wbr>Policy<wbr>Args</a></span>
    </dt>
...
<a href="#state_log_encryption_kms_key_id_python" style="color: inherit; text-decoration: inherit;">log_<wbr>encryption_<wbr>kms_<wbr>key_<wbr>id</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a href="#idletimeout_csharp" style="color: inherit; text-decoration: inherit;">Idle<wbr>Timeout</a>
    ...
    <dd>{{% md %}}Specifies the amount of idle time in seconds after which the cluster automatically terminates. You can specify a minimum of `60` seconds and a maximum of `604800` seconds (seven days).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#targetondemandcapacity_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>On<wbr>Demand<wbr>Capacity</a>
    ...
    <dd>{{% md %}}Target capacity of On-Demand units for the instance fleet, which determines how many On-Demand instances to provision.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#targetspotcapacity_csharp" style="color: inherit; text-decoration: inherit;">Target<wbr>Spot<wbr>Capacity</a>
    ...
    <dd>{{% md %}}Target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#bidpriceaspercentageofondemandprice_csharp" style="color: inherit; text-decoration: inherit;">Bid<wbr>Price<wbr>As<wbr>Percentage<wbr>Of<wbr>On<wbr>Demand<wbr>Price</a>
    ...
    <dd>{{% md %}}Bid price, as a percentage of On-Demand price, for each EC2 Spot instance as defined by `instance_type`. Expressed as a number (for example, 20 specifies 20%). If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="configurations_csharp">
<a href="#configurations_csharp" style="color: inherit; text-decoration: inherit;">Configurations</a>
...
<a href="#weightedcapacity_csharp" style="color: inherit; text-decoration: inherit;">Weighted<wbr>Capacity</a>
    ...
    <dd>{{% md %}}Number of units that a provisioned instance of this type provides toward fulfilling the target capacities defined in `aws.emr.InstanceFleet`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#classification_csharp" style="color: inherit; text-decoration: inherit;">Classification</a>
    ...
    <dd>{{% md %}}Classification within a configuration.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#size_csharp" style="color: inherit; text-decoration: inherit;">Size</a>
    ...
    <dd>{{% md %}}Volume size, in gibibytes (GiB).
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="type_csharp">
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Volume type. Valid options are `gp2`, `io1`, `standard` and `st1`. See [EBS Volume Types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="iops_csharp">
<a href="#iops_csharp" style="color: inherit; text-decoration: inherit;">Iops</a>
    ...
    <dd>{{% md %}}Number of I/O operations per second (IOPS) that the volume supports.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#volumesperinstance_csharp" style="color: inherit; text-decoration: inherit;">Volumes<wbr>Per<wbr>Instance</a>
    ...
    <dd>{{% md %}}Number of EBS volumes with this configuration to attach to each EC2 instance in the instance group (default is 1).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#timeoutaction_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Action</a>
    ...
    <dd>{{% md %}}Action to take when TargetSpotCapacity has not been fulfilled when the TimeoutDurationMinutes has expired; that is, when all Spot instances could not be provisioned within the Spot provisioning timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND`. SWITCH_TO_ON_DEMAND specifies that if no Spot instances are available, On-Demand Instances should be provisioned to fulfill any remaining Spot capacity.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#timeoutdurationminutes_csharp" style="color: inherit; text-decoration: inherit;">Timeout<wbr>Duration<wbr>Minutes</a>
    ...
    <dd>{{% md %}}Spot provisioning timeout period in minutes. If Spot instances are not provisioned within this time period, the TimeOutAction is taken. Minimum value is 5 and maximum value is 1440. The timeout applies only during initial provisioning, when the cluster is first created.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#blockdurationminutes_csharp" style="color: inherit; text-decoration: inherit;">Block<wbr>Duration<wbr>Minutes</a>
    ...
    <dd>{{% md %}}Defined duration for Spot instances (also known as Spot blocks) in minutes. When specified, the Spot instance does not terminate before the defined duration expires, and defined duration pricing for Spot instances applies. Valid values are 60, 120, 180, 240, 300, or 360. The duration period starts as soon as a Spot instance receives its instance ID. At the end of the duration, Amazon EC2 marks the Spot instance for termination and provides a Spot instance termination notice, which gives the instance a two-minute warning before it terminates.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
    ...
    <dd>{{% md %}}VPC subnet id where you want the job flow to launch. Cannot specify the `cc1.4xlarge` instance type for nodes of a job flow launched in an Amazon VPC.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#subnetids_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Ids</a>
    ...
    <dd>{{% md %}}List of VPC subnet id-s where you want the job flow to launch.  Amazon EMR identifies the best Availability Zone to launch instances according to your fleet specifications.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#kdcadminpassword_csharp" style="color: inherit; text-decoration: inherit;">Kdc<wbr>Admin<wbr>Password</a>
    ...
    <dd>{{% md %}}Password used within the cluster for the kadmin service on the cluster-dedicated KDC, which maintains Kerberos principals, password policies, and keytabs for the cluster. This provider cannot perform drift detection of this configuration.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#realm_csharp" style="color: inherit; text-decoration: inherit;">Realm</a>
    ...
    <dd>{{% md %}}Name of the Kerberos realm to which all nodes in a cluster belong. For example, `EC2.INTERNAL`
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#addomainjoinpassword_csharp" style="color: inherit; text-decoration: inherit;">Ad<wbr>Domain<wbr>Join<wbr>Password</a>
    ...
    <dd>{{% md %}}Active Directory password for `ad_domain_join_user`. This provider cannot perform drift detection of this configuration.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#actiononfailure_csharp" style="color: inherit; text-decoration: inherit;">Action<wbr>On<wbr>Failure</a>
    ...
    <dd>{{% md %}}Action to take if the step fails. Valid values: `TERMINATE_JOB_FLOW`, `TERMINATE_CLUSTER`, `CANCEL_AND_WAIT`, and `CONTINUE`
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#hadoopjarstep_csharp" style="color: inherit; text-decoration: inherit;">Hadoop<wbr>Jar<wbr>Step</a>
    ...
    <dd>{{% md %}}JAR file used for the step. See below.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
        <span id="name_csharp">
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
