...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatebody_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Body</a>
    ...
    <dd>{{% md %}}The contents of the signing certificate in PEM-encoded format.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#username_csharp" style="color: inherit; text-decoration: inherit;">User<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the user the signing certificate is for.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}The status you want to assign to the certificate. `Active` means that the certificate can be used for programmatic calls to Amazon Web Services `Inactive` means that the certificate cannot be used.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificateid_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Id</a>
    ...
    <dd>{{% md %}}The ID for the signing certificate.
