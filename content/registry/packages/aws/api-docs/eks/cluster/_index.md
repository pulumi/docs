...
<a href="#rolearn_csharp" style="color: inherit; text-decoration: inherit;">Role<wbr>Arn</a>
    ...
    <dd>{{% md %}}ARN of the IAM role that provides permissions for the Kubernetes control plane to make calls to AWS API operations on your behalf.
...
<a href="#enabledclusterlogtypes_csharp" style="color: inherit; text-decoration: inherit;">Enabled<wbr>Cluster<wbr>Log<wbr>Types</a>
    ...
    <dd>{{% md %}}List of the desired control plane logging to enable. For more information, see [Amazon EKS Control Plane Logging](https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name of the cluster. Must be between 1-100 characters in length. Must begin with an alphanumeric character, and must only contain alphanumeric characters, dashes and underscores (`^[0-9A-Za-z][A-Za-z0-9\-_]+$`).
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a href="#certificateauthorities_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#createdat_csharp" style="color: inherit; text-decoration: inherit;">Created<wbr>At</a>
    ...
    <dd>{{% md %}}Unix epoch timestamp in seconds for when the cluster was created.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#endpoint_csharp" style="color: inherit; text-decoration: inherit;">Endpoint</a>
    ...
    <dd>{{% md %}}Endpoint for your Kubernetes API server.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="id_csharp">
...
<a href="#platformversion_csharp" style="color: inherit; text-decoration: inherit;">Platform<wbr>Version</a>
    ...
    <dd>{{% md %}}Platform version for the cluster.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd>{{% md %}}Status of the EKS cluster. One of `CREATING`, `ACTIVE`, `DELETING`, `FAILED`.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#certificateauthorities_go" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#certificateauthorities_nodejs" style="color: inherit; text-decoration: inherit;">certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustercertificateauthority">Cluster<wbr>Certificate<wbr>Authority[]</a></span>
    </dt>
...
<a href="#certificate_authorities_python" style="color: inherit; text-decoration: inherit;">certificate_<wbr>authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#state_certificateauthorities_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#state_certificateauthorities_go" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#state_certificateauthorities_nodejs" style="color: inherit; text-decoration: inherit;">certificate<wbr>Authorities</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#clustercertificateauthority">Cluster<wbr>Certificate<wbr>Authority<wbr>Args[]</a></span>
    </dt>
...
<a href="#state_certificate_authorities_python" style="color: inherit; text-decoration: inherit;">certificate_<wbr>authorities</a>
</span>
        <span class="property-indicator"></span>
...
<a href="#data_csharp" style="color: inherit; text-decoration: inherit;">Data</a>
    ...
    <dd>{{% md %}}Base64 encoded certificate data required to communicate with your cluster. Add this to the `certificate-authority-data` section of the `kubeconfig` file for your cluster.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#keyarn_csharp" style="color: inherit; text-decoration: inherit;">Key<wbr>Arn</a>
    ...
    <dd>{{% md %}}ARN of the Key Management Service (KMS) customer master key (CMK). The CMK must be symmetric, created in the same region as the cluster, and if the CMK was created in a different account, the user must have access to the CMK. For more information, see [Allowing Users in Other Accounts to Use a CMK in the AWS Key Management Service Developer Guide](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html).
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#ipfamily_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Family</a>
    ...
    <dd>{{% md %}}The IP family used to assign Kubernetes pod and service addresses. Valid values are `ipv4` (default) and `ipv6`. You can only specify an IP family when you create a cluster, changing this value will force a new cluster to be created.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#clustersecuritygroupid_csharp" style="color: inherit; text-decoration: inherit;">Cluster<wbr>Security<wbr>Group<wbr>Id</a>
    ...
    <dd>{{% md %}}Cluster security group that was created by Amazon EKS for the cluster. Managed node groups use this security group for control-plane-to-data-plane communication.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#endpointprivateaccess_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Private<wbr>Access</a>
    ...
    <dd>{{% md %}}Whether the Amazon EKS private API server endpoint is enabled. Default is `false`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#endpointpublicaccess_csharp" style="color: inherit; text-decoration: inherit;">Endpoint<wbr>Public<wbr>Access</a>
    ...
    <dd>{{% md %}}Whether the Amazon EKS public API server endpoint is enabled. Default is `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd>{{% md %}}ID of the VPC associated with your cluster.
{{% /md %}}</dd></dl>
{{% /choosable %}}
