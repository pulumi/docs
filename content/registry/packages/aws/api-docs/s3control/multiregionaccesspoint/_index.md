...
opts=pulumi.ResourceOptions(provider=aws["primary_region"]))
bar_bucket = aws.s3.BucketV2("barBucket", bucket="example-bucket-bar",
opts=pulumi.ResourceOptions(provider=aws["secondary_region"]))
