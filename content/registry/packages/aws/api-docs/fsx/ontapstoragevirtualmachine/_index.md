...
<a href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd>{{% md %}}A map of tags to assign to the storage virtual machine. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#organizationalunitdistinguidshedname_csharp" style="color: inherit; text-decoration: inherit;">Organizational<wbr>Unit<wbr>Distinguidshed<wbr>Name</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}use &#39;organizational_unit_distinguished_name&#39; instead{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
