...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#excludemanagementeventsources_csharp" style="color: inherit; text-decoration: inherit;">Exclude<wbr>Management<wbr>Event<wbr>Sources</a>
    ...
    <dd>{{% md %}}A set of event sources to exclude. Valid values include: `kms.amazonaws.com` and `rdsdata.amazonaws.com`. `include_management_events` must be set to`true` to allow this.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includemanagementevents_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Management<wbr>Events</a>
    ...
    <dd>{{% md %}}Whether to include management events for your trail. Defaults to `true`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#insighttype_csharp" style="color: inherit; text-decoration: inherit;">Insight<wbr>Type</a>
    ...
    <dd>{{% md %}}Type of insights to log on a trail. Valid values are: `ApiCallRateInsight` and `ApiErrorRateInsight`.
{{% /md %}}</dd></dl>
{{% /choosable %}}
