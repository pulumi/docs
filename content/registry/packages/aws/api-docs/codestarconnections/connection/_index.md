...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:codestarconnections:Connection</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostarn_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Arn</a>
    ...
    <dd><p>The Amazon Resource Name (ARN) of the host associated with the connection. Conflicts with <code>provider_type</code></p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>The name of the connection to be created. The name must be unique in the calling AWS account. Changing <code>name</code> will create a new resource.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#providertype_csharp" style="color: inherit; text-decoration: inherit;">Provider<wbr>Type</a>
    ...
    <dd><p>The name of the external provider where your third-party code repository is configured. Valid values are <code>Bitbucket</code>, <code>GitHub</code> or <code>GitHubEnterpriseServer</code>. Changing <code>provider_type</code> will create a new resource. Conflicts with <code>host_arn</code></p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd><p>Map of key-value resource tags to associate with the resource. .If configured with a provider <code>default_tags</code> configuration block present, tags with matching keys will overwrite those defined at the provider-level.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="hostarn_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostarn_java" style="color: inherit; text-decoration: inherit;">host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="hostarn_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#hostarn_yaml" style="color: inherit; text-decoration: inherit;">host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_csharp" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_hostarn_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hostarn_csharp" style="color: inherit; text-decoration: inherit;">Host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_go" style="color: inherit; text-decoration: inherit;">Connection<wbr>Status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_hostarn_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hostarn_go" style="color: inherit; text-decoration: inherit;">Host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_java" style="color: inherit; text-decoration: inherit;">connection<wbr>Status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_hostarn_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hostarn_java" style="color: inherit; text-decoration: inherit;">host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_nodejs" style="color: inherit; text-decoration: inherit;">connection<wbr>Status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_hostarn_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hostarn_nodejs" style="color: inherit; text-decoration: inherit;">host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connection_status_python" style="color: inherit; text-decoration: inherit;">connection_<wbr>status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_host_arn_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_host_arn_python" style="color: inherit; text-decoration: inherit;">host_<wbr>arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_connectionstatus_yaml" style="color: inherit; text-decoration: inherit;">connection<wbr>Status</a>
    ...
    <dd><p>The codestar connection status. Possible values are <code>PENDING</code>, <code>AVAILABLE</code> and <code>ERROR</code>.</p>
            ...
            title="Optional">
        <span id="state_hostarn_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_hostarn_yaml" style="color: inherit; text-decoration: inherit;">host<wbr>Arn</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
