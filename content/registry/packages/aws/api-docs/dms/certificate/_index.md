...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:dms:Certificate</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatepem_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Pem</a>
    ...
    <dd><p>The contents of the .pem X.509 certificate file for the certificate. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#certificatewallet_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Wallet</a>
    ...
    <dd><p>The contents of the Oracle Wallet certificate for use with SSL, provided as a base64-encoded String. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatewallet_csharp" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatewallet_go" style="color: inherit; text-decoration: inherit;">Certificate<wbr>Wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatepem_java" style="color: inherit; text-decoration: inherit;">certificate<wbr>Pem</a>
    ...
    <dd><p>The contents of the .pem X.509 certificate file for the certificate. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</p>
            ...
            title="Optional">
        <span id="state_certificatewallet_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatewallet_java" style="color: inherit; text-decoration: inherit;">certificate<wbr>Wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatewallet_nodejs" style="color: inherit; text-decoration: inherit;">certificate<wbr>Wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificate_wallet_python" style="color: inherit; text-decoration: inherit;">certificate_<wbr>wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatepem_yaml" style="color: inherit; text-decoration: inherit;">certificate<wbr>Pem</a>
    ...
    <dd><p>The contents of the .pem X.509 certificate file for the certificate. Either <code>certificate_pem</code> or <code>certificate_wallet</code> must be set.</p>
            ...
            title="Optional">
        <span id="state_certificatewallet_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_certificatewallet_yaml" style="color: inherit; text-decoration: inherit;">certificate<wbr>Wallet</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
