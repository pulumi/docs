...
{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use the aws_s3_objects data source instead{{% /md %}}</p></dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#bucket_csharp" style="color: inherit; text-decoration: inherit;">Bucket</a>
    ...
    <dd>{{% md %}}{{% /md %}}<p class="property-message">Deprecated: {{% md %}}Use the aws_s3_objects data source instead{{% /md %}}</p></dd><dt class="property-"
            title="">
