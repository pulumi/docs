...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groupname_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the group in which the member will be added.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#membername_csharp" style="color: inherit; text-decoration: inherit;">Member<wbr>Name</a>
    ...
    <dd>{{% md %}}The name of the member to add to the group.
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd>{{% md %}}The namespace. Defaults to `default`. Currently only `default` is supported.
{{% /md %}}</dd></dl>
{{% /choosable %}}
