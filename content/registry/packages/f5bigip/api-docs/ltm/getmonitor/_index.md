...
><span class="k">def </span>get_monitor<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_monitor_output<span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<a href="#partition_csharp" style="color: inherit; text-decoration: inherit;">Partition</a>
    ...
    <dd>{{% md %}}partition of the ltm monitor
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#adaptive_csharp" style="color: inherit; text-decoration: inherit;">Adaptive</a>
    ...
    <dd>{{% md %}}Displays whether adaptive response time monitoring is enabled for this monitor.
...
<a href="#destination_csharp" style="color: inherit; text-decoration: inherit;">Destination</a>
    ...
    <dd>{{% md %}}id will be full path name of ltm monitor.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#interval_csharp" style="color: inherit; text-decoration: inherit;">Interval</a>
    ...
    <dd>{{% md %}}Specifies, in seconds, the frequency at which the system issues the monitor check when either the resource is down or the status of the resource is unknown.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#ipdscp_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Dscp</a>
    ...
    <dd>{{% md %}}Displays the differentiated services code point (DSCP). DSCP is a 6-bit value in the Differentiated Services (DS) field of the IP header.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#manualresume_csharp" style="color: inherit; text-decoration: inherit;">Manual<wbr>Resume</a>
    ...
    <dd>{{% md %}}Displays whether the system automatically changes the status of a resource to Enabled at the next successful monitor check.
{{% /md %}}</dd><dt class="property-"
            title="">
        <span id="mode_csharp">
...
<a href="#reverse_csharp" style="color: inherit; text-decoration: inherit;">Reverse</a>
    ...
    <dd>{{% md %}}Instructs the system to mark the target resource down when the test is successful.
{{% /md %}}</dd><dt class="property-"
            title="">
...
<a href="#transparent_csharp" style="color: inherit; text-decoration: inherit;">Transparent</a>
    ...
    <dd>{{% md %}}Displays whether the monitor operates in transparent mode.
{{% /md %}}</dd><dt class="property-"
            title="">
