...
---
title: "RuleSignon"
title_tag: "okta.policy.RuleSignon"
meta_desc: "Documentation for the okta.policy.RuleSignon resource with examples, input properties, output properties, lookup functions, and supporting types."
aliases:
    - "/docs/reference/pkg/okta/RuleSignon/"
layout: api
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx">RuleSignon</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p">?:</span> <span class="nx"><a href="#inputs">RuleSignonArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class=nd>@overload</span>
<span class="k">def </span><span class="nx">RuleSignon</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               ...
               <span class="nx">factor_sequences</span><span class="p">:</span> <span class="nx">Optional[Sequence[RuleSignonFactorSequenceArgs]]</span> = None<span class="p">,</span>
...
<span class="k">def </span><span class="nx">RuleSignon</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
               <span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="#inputs">Optional[RuleSignonArgs]</a></span> = None<span class="p">,</span>
               <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx">NewRuleSignon</span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx"><a href="#inputs">RuleSignonArgs</a></span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RuleSignon</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx">RuleSignon</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="#inputs">RuleSignonArgs</a></span><span class="p">? </span><span class="nx">args = null<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties"><dt
    ...
    <dd>The unique name of the resource.</dd><dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#inputs">RuleSignonArgs</a></span>
    </dt>
...
The RuleSignon resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#access_csharp" style="color: inherit; text-decoration: inherit;">Access</a>
    ...
    <dd>{{% md %}}Allow or deny access based on the rule conditions: `"ALLOW"`, `"DENY"` or `"CHALLENGE"`. The default is `"ALLOW"`.
...
<a href="#authtype_csharp" style="color: inherit; text-decoration: inherit;">Authtype</a>
    ...
    <dd>{{% md %}}Authentication entrypoint: `"ANY"`, `"LDAP_INTERFACE"` or `"RADIUS"`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#factorsequences_csharp" style="color: inherit; text-decoration: inherit;">Factor<wbr>Sequences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequence">List&lt;Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Auth factor sequences. Should be set if `access = "CHALLENGE"`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#risclevel_csharp" style="color: inherit; text-decoration: inherit;">Risc<wbr>Level</a>
    ...
    <dd>{{% md %}}Risc level: `"ANY"`, `"LOW"`, `"MEDIUM"` or `"HIGH"`. Default is `"ANY"`. It can be also 
...
<a href="#factorsequences_go" style="color: inherit; text-decoration: inherit;">Factor<wbr>Sequences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequence">[]Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Auth factor sequences. Should be set if `access = "CHALLENGE"`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#factor_sequences_python" style="color: inherit; text-decoration: inherit;">factor_<wbr>sequences</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequence">Sequence[Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Auth factor sequences. Should be set if `access = "CHALLENGE"`.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
{{% choosable language nodejs %}}
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">public static </span><span class="nf">get</span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#ID">Input&lt;ID&gt;</a></span><span class="p">,</span> <span class="nx">state</span><span class="p">?:</span> <span class="nx">RuleSignonState</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">): </span><span class="nx">RuleSignon</span></code></pre></div>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">session_persistent</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
        <span class="nx">status</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">users_excludeds</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">) -&gt;</span> RuleSignon</code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span>GetRuleSignon<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">,</span> <span class="nx">id</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#IDInput">IDInput</a></span><span class="p">,</span> <span class="nx">state</span><span class="p"> *</span><span class="nx">RuleSignonState</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx">RuleSignon</span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static </span><span class="nx">RuleSignon</span><span class="nf"> Get</span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.Input-1.html">Input&lt;string&gt;</a></span><span class="p"> </span><span class="nx">id<span class="p">,</span> <span class="nx">RuleSignonState</span><span class="p">? </span><span class="nx">state<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<h4 id="rulesignonfactorsequence">Rule<wbr>Signon<wbr>Factor<wbr>Sequence</h4>
...
<a href="#primarycriteriafactortype_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Criteria<wbr>Factor<wbr>Type</a>
    ...
    <dd>{{% md %}}Primary factor type of the auth section.
...
<a href="#primarycriteriaprovider_csharp" style="color: inherit; text-decoration: inherit;">Primary<wbr>Criteria<wbr>Provider</a>
    ...
    <dd>{{% md %}}Primary provider of the auth section.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#secondarycriterias_csharp" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequencesecondarycriteria">List&lt;Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Secondary<wbr>Criteria&gt;</a></span>
    </dt>
    <dd>{{% md %}}Additional authentication steps.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#secondarycriterias_go" style="color: inherit; text-decoration: inherit;">Secondary<wbr>Criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequencesecondarycriteria">[]Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Secondary<wbr>Criteria</a></span>
    </dt>
    <dd>{{% md %}}Additional authentication steps.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#secondary_criterias_python" style="color: inherit; text-decoration: inherit;">secondary_<wbr>criterias</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rulesignonfactorsequencesecondarycriteria">Sequence[Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Secondary<wbr>Criteria]</a></span>
    </dt>
    <dd>{{% md %}}Additional authentication steps.
{{% /md %}}</dd></dl>
{{% /choosable %}}

<h4 id="rulesignonfactorsequencesecondarycriteria">Rule<wbr>Signon<wbr>Factor<wbr>Sequence<wbr>Secondary<wbr>Criteria</h4>
...
<a href="#factortype_csharp" style="color: inherit; text-decoration: inherit;">Factor<wbr>Type</a>
    ...
    <dd>{{% md %}}Factor type of the additional authentication step.
{{% /md %}}</dd><dt class="property-required"
            title="Required">
...
<a href="#provider_csharp" style="color: inherit; text-decoration: inherit;">Provider</a>
    ...
    <dd>{{% md %}}Provider of the additional authentication step.
{{% /md %}}</dd></dl>
{{% /choosable %}}
