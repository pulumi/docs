...
<span class="k">def </span><span class="nx">Dashboard</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">editable</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">filter</span><span class="p">:</span> <span class="nx">Optional[DashboardFilterArgs]</span> = None<span class="p">,</span>
              <span class="nx">grid_column_count</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
              ...
              <span class="nx">widgets</span><span class="p">:</span> <span class="nx">Optional[Sequence[DashboardWidgetArgs]]</span> = None<span class="p">)</span>
...
<a href="#editable_csharp" style="color: inherit; text-decoration: inherit;">Editable</a>
    ...
    <dd>{{% md %}}Determines who can edit the dashboard in an account. Valid values are all, editable_by_all, editable_by_owner, or
...
<a href="#filter_csharp" style="color: inherit; text-decoration: inherit;">Filter</a>
    ...
    <dd>{{% md %}}A nested block that describes a dashboard filter. Exactly one nested filter block is allowed.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#gridcolumncount_csharp" style="color: inherit; text-decoration: inherit;">Grid<wbr>Column<wbr>Count</a>
    ...
    <dd>{{% md %}}New Relic One supports a 3 column grid or a 12 column grid. New Relic Insights supports a 3 column grid.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
        <span id="icon_csharp">
<a href="#icon_csharp" style="color: inherit; text-decoration: inherit;">Icon</a>
    ...
    <dd>{{% md %}}The icon for the dashboard.
{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#widgets_csharp" style="color: inherit; text-decoration: inherit;">Widgets</a>
    ...
    <dd>{{% md %}}A nested block that describes a visualization. Up to 300 widget blocks are allowed in a dashboard definition.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<a href="#widgets_go" style="color: inherit; text-decoration: inherit;">Widgets</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidget">[]Dashboard<wbr>Widget<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}A nested block that describes a visualization. Up to 300 widget blocks are allowed in a dashboard definition.
{{% /md %}}</dd></dl>
{{% /choosable %}}
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
        <span class="nx">dashboard_url</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">editable</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">filter</span><span class="p">:</span> <span class="nx">Optional[DashboardFilterArgs]</span> = None<span class="p">,</span>
        <span class="nx">grid_column_count</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">icon</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">title</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">visibility</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">widgets</span><span class="p">:</span> <span class="nx">Optional[Sequence[DashboardWidgetArgs]]</span> = None<span class="p">) -&gt;</span> Dashboard</code></pre></div>
{{% /choosable %}}
...
<a href="#comparewiths_csharp" style="color: inherit; text-decoration: inherit;">Compare<wbr>Withs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidgetcomparewith">List&lt;Pulumi.<wbr>New<wbr>Relic.<wbr>Inputs.<wbr>Dashboard<wbr>Widget<wbr>Compare<wbr>With&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metrics_csharp" style="color: inherit; text-decoration: inherit;">Metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidgetmetric">List&lt;Pulumi.<wbr>New<wbr>Relic.<wbr>Inputs.<wbr>Dashboard<wbr>Widget<wbr>Metric&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#compare_withs_python" style="color: inherit; text-decoration: inherit;">compare_<wbr>withs</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidgetcomparewith">Sequence[Dashboard<wbr>Widget<wbr>Compare<wbr>With]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#metrics_python" style="color: inherit; text-decoration: inherit;">metrics</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidgetmetric">Sequence[Dashboard<wbr>Widget<wbr>Metric]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#presentation_csharp" style="color: inherit; text-decoration: inherit;">Presentation</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#dashboardwidgetcomparewithpresentation">Pulumi.<wbr>New<wbr>Relic.<wbr>Inputs.<wbr>Dashboard<wbr>Widget<wbr>Compare<wbr>With<wbr>Presentation</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
