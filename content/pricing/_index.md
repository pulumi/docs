...
faq:
    - category: Pricing
      ...
      items:
        ...
        - question: What can I do with 500 IaC resources per month?
          answer: |
            The Essentials edition includes up to 500 IaC resources to get started with.
            ...
            This is more than enough to get started with production workloads. The Pro edition includes up to 2,000 resources.
      ...
      items:
        ...
        - question: Can I use Pulumi for free?
          answer: |
            ...
            Finally, we offer a 14-day free trial for the Enterprise+ edition. Once the trial is over, you can continue to use the Enterprise+ edition by chatting with sales, or change to the Essentials or Pro edition. After your trial expires, no data will be lost, and there is a grace period.
        - question: What is an organization? What are projects and stacks?
          answer: |
            The Free edition is great for single users with private projects. However, if you are working within a team, you'll typically want to share your projects, for which you need to create an organization. The Essentials edition is designed for teams to collaborate on shared infrastructure projects. The Pro edition offers more sophisticated organization management facilities, including RBAC for advanced policy controls.
        ...
        - question: Can I host Pulumi Cloud in my cloud or datacenter?
          answer: Yes, we offer a self-hosted Pulumi Cloud for companies that have specific data control requirements and want to maintain complete control over hosting Pulumi Cloud. This option is available in the Enterprise+ edition. You can [request a Proof of Concept (PoC)](/product/self-hosted/#self-hosted-trial) to get started.
    ...
    - category: Billing and Support
      ...
      items:
        ...
        - question: When will I be billed for using the Essentials or Pro edition?
        ...
        - question: What payment options do you accept?
          answer: For the Pulumi Essentials edition, you can pay with a credit card (we use Stripe for processing). The Pulumi Pro edition offers additional payment options. Please [contact us](/contact/?form=sales) for those options.
        ...
        - question: How do I get support for Pulumi?
          answer: 12 x 5, 24 x 7 support, professional and advising services, and private Slack channel are available to purchase in the Pro and Enterprise+ editions of Pulumi Cloud. [Contact us](/contact/?form=sales) if you need help or have any questions.
