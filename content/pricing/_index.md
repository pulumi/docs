    ...
    - category: Product
      ...
      items:
        ...
        - question: Can I host Pulumi Cloud in my cloud or datacenter?
          answer: Yes, we offer a self-hosted Pulumi Cloud for companies that have specific data control requirements and want to maintain complete control over hosting Pulumi Cloud. This option is available in Business Critical Edition. The [install guide](/docs/administration/self-hosting/install/) covers every deployment option, from a single-host Docker Compose evaluation to production on AWS, Azure, Google Cloud, and Kubernetes. [Request a Proof of Concept (PoC)](/product/self-hosted/#self-hosted-trial) to get an evaluation license key.
