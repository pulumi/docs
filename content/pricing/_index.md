---
title: Pricing
meta_desc: Compare the Free, Essentials, Pro, and Enterprise editions of Pulumi Cloud.
type: page
layout: pricing
schema_type: product
schema_name: Pulumi
    ...
    - category: Product
      ...
      items:
        ...
        - question: Can I use Pulumi for free?
          answer: |
            Yes. There are two ways to use Pulumi for free.

            First, the Pulumi Cloud Free edition costs nothing and supports one user. It includes automatic state management, Pulumi Deployments, basic Pulumi ESC, unlimited projects and stacks, and unlimited updates and history. It does not limit the number of managed resources. It does not include Pulumi Neo, Resource Search, or Property Search.
