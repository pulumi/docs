...
type: learn
url: /what-is/run-aws-ec2-stop-instances-with-dynamic-credentials/
...
To stop a running instance, run the command using `pulumi env run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, `<your-environment-name>`, and `<your-running-instance-id>` with the names of your own Pulumi organization, environment, and desired EC2 instance ID respectively:

```bash
pulumi env run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws ec2 stop-instances --instance-ids <your-running-instance-id>
```
