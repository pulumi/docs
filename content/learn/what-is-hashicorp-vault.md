---
title: What is HashiCorp Vault? Features, Use Cases & Setup
meta_desc: |
...
type: learn
url: /what-is/what-is-hashicorp-vault/
...
You can wire Vault into that layer with [Pulumi ESC](/docs/pulumi-cloud/esc/)'s [vault-secrets](/docs/esc/providers/secrets/vault-secrets/) provider to dynamically import secrets from HashiCorp Vault into your environments.
