...
type: learn
url: /what-is/resolve-unable-to-locate-credentials/
...
With your environment set up, you can now validate your configuration. Run the `aws s3 ls` command using `pulumi env run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, and `<your-environment-name>` with the names of your own Pulumi organization and environment respectively:
