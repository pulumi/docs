...
type: learn
url: /what-is/run-aws-ec2-start-instances-with-dynamic-credentials/
...
To start a stopped instance, run the command using `pulumi env run` as shown below, making sure to replace `<your-pulumi-org-name>`, `<your-project-name>`, `<your-environment-name>`, and `<your-stopped-instance-id>` with the names of your own Pulumi organization, environment, and desired EC2 instance ID respectively:

```bash
pulumi env run <your-pulumi-org-name>/<your-project-name>/<your-environment-name> -- aws ec2 start-instances --instance-ids <your-stopped-instance-id>
```
