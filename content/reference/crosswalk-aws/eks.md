...
/reference/pkg/nodejs/pulumi/eks/#ClusterOptions). Many common cases are described below.
...
/reference/pkg/nodejs/pulumi/eks/#Cluster-provider) of type `kubernetes.Provider`, already pre-configured.
...
[Pulumi Kubernetes Setup documentation](/quickstart/kubernetes/setup/).
...
/reference/pkg/nodejs/pulumi/kubernetes/#ConfigGroup-transformations) which can be used to ["monkey patch"](
...
/reference/pkg/nodejs/pulumi/aws/ecr/#buildAndPushImage) takes a name and a relative location on disk, and will
