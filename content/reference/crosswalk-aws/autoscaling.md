...
/reference/pkg/nodejs/pulumi/awsx/autoscaling/#AutoScalingGroup).
...
/reference/pkg/nodejs/pulumi/awsx/autoscaling/#TemplateParameters)
...
For full details about what properties are available, refer to [the API Documentation](
/reference/pkg/nodejs/pulumi/awsx/autoscaling/#AutoScalingLaunchConfigurationArgs).
...
/reference/pkg/nodejs/pulumi/awsx/autoscaling/#AutoScalingGroup-scaleOnSchedule) on the `AutoScalingGroup` class:
