...
heading: "CloudFormation Alternative"
subheading: |
...
overview:
    ...
    description: |
        Looking for {Keyword:CloudFormation alternative}? Pulumi Cloud is the smartest and easiest way to automate, secure, and manage everything you run in the cloud using programming languages you know and love.
    ...
    items:
        - title: "Author in any language, deploy to any cloud"
          ...
          button:
            ...
            link: "https://app.pulumi.com/signup?utm_source=gads-cloudformation"
          features:
              - title: Code faster
                description: |
