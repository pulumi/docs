---
meta_desc: Ship infrastructure 3-5x faster with real programming languages. Use TypeScript, Python, Go, or C# instead of YAML.
layout: gads-template
block_external_search_index: true
heading: "Infrastructure as Code"
subheading: |
  Pulumi enables infrastructure and DevOps engineers to build, test, and deploy cloud infrastructure faster.

overview:
  title: Ship Infrastructure 3-5x Faster<br/>With Real Programming Languages
  description: |
    Stop wrestling with YAML and proprietary DSLs. Use TypeScript, Python, Go, or C# to build, test, and deploy cloud infrastructure the way you write application code.

key_features_above:
  items:
    - title: "Write infrastructure like software"
      description: |
        Use familiar languages, IDEs, testing frameworks, and package managers. No learning proprietary syntax.
      icon: code
      color: yellow
