...
key_features_above:
    items:
        - title: "Author in any language, deploy to any cloud"
          ...
          description:
            Author infrastructure as code (IaC) using programming languages you know and love – including TypeScript/JavaScript, Python, Go, C#, Java, and YAML. Deploy to 200+ providers like AWS, Azure, Google Cloud, and Kubernetes.
          features:
              - title: Code faster
                description: |
        ...
        - title: "The fastest and easiest way to use Pulumi IaC at scale"
          ...
          features:
              - title: Pulumi IaC
                icon: code
                description: |
                    Utilize open-source IaC in TypeScript, Python, Go, C#, Java and YAML. Build and distribute reusable components for 200+ cloud & SaaS providers.
              - title: Pulumi ESC
                icon: lock
                description: |
