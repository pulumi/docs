...
layout: template
schema_type: howto
meta_desc: Deploy a serverless application on Google Cloud with Pulumi, Cloud Functions (Gen 2), and Cloud Storage in TypeScript, Python, Go, .NET, YAML, or HCL.
meta_image: meta.png
...
![An architecture diagram of the Google Cloud Serverless Application template](/templates/serverless-application/gcp/architecture.png)
